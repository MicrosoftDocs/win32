...
| Licensing             | Issues [*end-user licenses*](e-gly.md#-rm-end-user-license-gly). The service runs on root certification servers and on licensing servers.                                                                                                                                                                                                              |
| Publishing            | Creates [*issuance licenses*](i-gly.md#-rm-issuance-license-gly) which define the policies that can be enumerated in an end-user license. For more information, see [Creating and Using Issuance Licenses](creating-an-issuance-license.md). The service runs on root certification servers and on licensing servers.                                 |
| Precertification      | Enables a server to request a [*rights account certificate*](r-gly.md#-rm-rights-account-certificate-gly) on behalf of a user. The service runs on root certification servers and on licensing servers.                                                                                                                                                |
