...
|----------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| [**DRMParseUnboundLicense**](/windows/previous-versions/Msdrm/nf-msdrm-drmparseunboundlicense?branch=master)                         | [**DRMCreateBoundLicense**](/windows/previous-versions/Msdrm/nf-msdrm-drmcreateboundlicense?branch=master)                       |
| [**DRMGetUnboundLicenseAttribute**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetunboundlicenseattribute?branch=master)           | [**DRMGetBoundLicenseAttribute**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetboundlicenseattribute?branch=master)           |
| [**DRMGetUnboundLicenseAttributeCount**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetunboundlicenseattributecount?branch=master) | [**DRMGetBoundLicenseAttributeCount**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetboundlicenseattributecount?branch=master) |
| [**DRMGetUnboundLicenseObject**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetunboundlicenseobject?branch=master)                 | [**DRMGetBoundLicenseObject**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetboundlicenseobject?branch=master)                 |
| [**DRMGetUnboundLicenseObjectCount**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetunboundlicenseobjectcount?branch=master)       | [**DRMGetBoundLicenseObjectCount**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetboundlicenseobjectcount?branch=master)       |
| [**DRMCloseQueryHandle**](/windows/previous-versions/Msdrm/nf-msdrm-drmclosequeryhandle?branch=master)                               | [**DRMCloseHandle**](/windows/previous-versions/Msdrm/nf-msdrm-drmclosehandle?branch=master)                                     |



 

The **DRMGetBound\_xxx** and **DRMGetUnbound\_xxx** functions take a parameter that indicates which object to retrieve. After you retrieve the object, you can obtain information about it by calling [**DRMGetBoundLicenseAttribute**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetboundlicenseattribute?branch=master) or [**DRMGetUnboundLicenseAttribute**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetunboundlicenseattribute?branch=master). Not all objects or attributes are required to be present in an XrML certificate, and some (ADDRESS, for example) may have more than one value. Therefore, you should enable robust error trapping, and also call the appropriate **DRMGet\_xxx\_Count** function to determine how many values of an attribute or instances of an object exist.
...
When searching for an object in a license or certificate, the [**DRMGetBoundLicenseObject**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetboundlicenseobject?branch=master) and [**DRMGetUnboundLicenseObject**](/windows/previous-versions/Msdrm/nf-msdrm-drmgetunboundlicenseobject?branch=master) functions only return an object from the top level of the root that was passed in. More deeply nested objects will not be retrieved. Therefore, if passing in a license root object, you cannot attempt to get a right object directly, but must first obtain a work and a rights group.
