...
[*End-user licenses*](e-gly.md#-rm-end-user-license-gly) also use the **RIGHTSLIST** element but can include multiple predefined and custom rights for publishing and consuming content. The following rights are typical.
