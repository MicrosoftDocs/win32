...
An end-user license (EUL) identifies the rights and conditions to consume protected content. A [*rights account certificate*](https://www.bing.com/search?q=*rights account certificate*) and a [*machine certificate*](https://www.bing.com/search?q=*machine certificate*) must exist before your application can request and end-user license. The license can contain the following elements:
