...
After you have added a new [*issuance license*](https://www.bing.com/search?q=*issuance license*) to a file, you can acquire a use license for a requesting user and store it right in the document. That way, the user can view the document immediately, without making an additional call to a server for a use license.
