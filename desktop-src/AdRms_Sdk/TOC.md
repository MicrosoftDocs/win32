...
#### [DRMAddLicense](/windows/previous-versions/Msdrm/nf-msdrm-drmaddlicense?branch=master)
#### [DRMAddRightWithUser](/windows/previous-versions/Msdrm/nf-msdrm-drmaddrightwithuser?branch=master)
#### [DRMAttest](/windows/previous-versions/Msdrm/nf-msdrm-drmattest?branch=master)
#### [DRMCheckSecurity](/windows/previous-versions/Msdrm/nf-msdrm-drmchecksecurity?branch=master)
#### [DRMClearAllRights](/windows/previous-versions/Msdrm/nf-msdrm-drmclearallrights?branch=master)
#### [DRMCloseEnvironmentHandle](/windows/previous-versions/Msdrm/nf-msdrm-drmcloseenvironmenthandle?branch=master)
#### [DRMCloseHandle](/windows/previous-versions/Msdrm/nf-msdrm-drmclosehandle?branch=master)
#### [DRMClosePubHandle](/windows/previous-versions/Msdrm/nf-msdrm-drmclosepubhandle?branch=master)
#### [DRMCloseQueryHandle](/windows/previous-versions/Msdrm/nf-msdrm-drmclosequeryhandle?branch=master)
#### [DRMCloseSession](/windows/previous-versions/Msdrm/nf-msdrm-drmclosesession?branch=master)
#### [DRMConstructCertificateChain](/windows/previous-versions/Msdrm/nf-msdrm-drmconstructcertificatechain?branch=master)
...
#### [DRMCreateEnablingBitsDecryptor](/windows/previous-versions/Msdrm/nf-msdrm-drmcreateenablingbitsdecryptor?branch=master)
#### [DRMCreateEnablingBitsEncryptor](/windows/previous-versions/Msdrm/nf-msdrm-drmcreateenablingbitsencryptor?branch=master)
...
#### [DRMCreateRight](/windows/previous-versions/Msdrm/nf-msdrm-drmcreateright?branch=master)
#### [DRMCreateUser](/windows/previous-versions/Msdrm/nf-msdrm-drmcreateuser?branch=master)
#### [DRMDecode](/windows/previous-versions/Msdrm/nf-msdrm-drmdecode?branch=master)
#### [DRMDeconstructCertificateChain](/windows/previous-versions/Msdrm/nf-msdrm-drmdeconstructcertificatechain?branch=master)
#### [DRMDecrypt](/windows/previous-versions/Msdrm/nf-msdrm-drmdecrypt?branch=master)
#### [DRMDeleteLicense](/windows/previous-versions/Msdrm/nf-msdrm-drmdeletelicense?branch=master)
#### [DRMDuplicateEnvironmentHandle](/windows/previous-versions/Msdrm/nf-msdrm-drmduplicateenvironmenthandle?branch=master)
#### [DRMDuplicateHandle](/windows/previous-versions/Msdrm/nf-msdrm-drmduplicatehandle?branch=master)
#### [DRMDuplicatePubHandle](/windows/previous-versions/Msdrm/nf-msdrm-drmduplicatepubhandle?branch=master)
#### [DRMDuplicateSession](/windows/previous-versions/Msdrm/nf-msdrm-drmduplicatesession?branch=master)
#### [DRMEncode](/windows/previous-versions/Msdrm/nf-msdrm-drmencode?branch=master)
#### [DRMEncrypt](/windows/previous-versions/Msdrm/nf-msdrm-drmencrypt?branch=master)
#### [DRMEnumerateLicense](/windows/previous-versions/Msdrm/nf-msdrm-drmenumeratelicense?branch=master)
#### [DRMGetApplicationSpecificData](/windows/previous-versions/Msdrm/nf-msdrm-drmgetapplicationspecificdata?branch=master)
...
#### [DRMGetCertificateChainCount](/windows/previous-versions/Msdrm/nf-msdrm-drmgetcertificatechaincount?branch=master)
#### [DRMGetClientVersion](/windows/previous-versions/Msdrm/nf-msdrm-drmgetclientversion?branch=master)
#### [DRMGetEnvironmentInfo](/windows/previous-versions/Msdrm/nf-msdrm-drmgetenvironmentinfo?branch=master)
#### [DRMGetInfo](/windows/previous-versions/Msdrm/nf-msdrm-drmgetinfo?branch=master)
#### [DRMGetIntervalTime](/windows/previous-versions/Msdrm/nf-msdrm-drmgetintervaltime?branch=master)
#### [DRMGetIssuanceLicenseInfo](/windows/previous-versions/Msdrm/nf-msdrm-drmgetissuancelicenseinfo?branch=master)
#### [DRMGetIssuanceLicenseTemplate](/windows/previous-versions/Msdrm/nf-msdrm-drmgetissuancelicensetemplate?branch=master)
#### [DRMGetMetaData](/windows/previous-versions/Msdrm/nf-msdrm-drmgetmetadata?branch=master)
#### [DRMGetNameAndDescription](/windows/previous-versions/Msdrm/nf-msdrm-drmgetnameanddescription?branch=master)
#### [DRMGetOwnerLicense](/windows/previous-versions/Msdrm/nf-msdrm-drmgetownerlicense?branch=master)
#### [DRMGetProcAddress](/windows/previous-versions/Msdrm/nf-msdrm-drmgetprocaddress?branch=master)
#### [DRMGetRevocationPoint](/windows/previous-versions/Msdrm/nf-msdrm-drmgetrevocationpoint?branch=master)
#### [DRMGetRightExtendedInfo](/windows/previous-versions/Msdrm/nf-msdrm-drmgetrightextendedinfo?branch=master)
#### [DRMGetRightInfo](/windows/previous-versions/Msdrm/nf-msdrm-drmgetrightinfo?branch=master)
#### [DRMGetSecurityProvider](/windows/previous-versions/Msdrm/nf-msdrm-drmgetsecurityprovider?branch=master)
...
#### [DRMGetSignedIssuanceLicenseEx](/windows/previous-versions/Msdrm/nf-msdrm-drmgetsignedissuancelicenseex?branch=master)
...
#### [DRMGetUsagePolicy](/windows/previous-versions/Msdrm/nf-msdrm-drmgetusagepolicy?branch=master)
#### [DRMGetUserInfo](/windows/previous-versions/Msdrm/nf-msdrm-drmgetuserinfo?branch=master)
#### [DRMGetUserRights](/windows/previous-versions/Msdrm/nf-msdrm-drmgetuserrights?branch=master)
#### [DRMGetUsers](/windows/previous-versions/Msdrm/nf-msdrm-drmgetusers?branch=master)
#### [DRMInitEnvironment](/windows/previous-versions/Msdrm/nf-msdrm-drminitenvironment?branch=master)
#### [DRMIsActivated](/windows/previous-versions/Msdrm/nf-msdrm-drmisactivated?branch=master)
#### [DRMIsWindowProtected](/windows/previous-versions/Msdrm/nf-msdrm-drmiswindowprotected?branch=master)
...
#### [DRMRegisterContent](/windows/previous-versions/Msdrm/nf-msdrm-drmregistercontent?branch=master)
...
#### [DRMRepair](/windows/previous-versions/Msdrm/nf-msdrm-drmrepair?branch=master)
#### [DRMSetApplicationSpecificData](/windows/previous-versions/Msdrm/nf-msdrm-drmsetapplicationspecificdata?branch=master)
#### [DRMSetGlobalOptions](/windows/previous-versions/Msdrm/nf-msdrm-drmsetglobaloptions?branch=master)
#### [DRMSetIntervalTime](/windows/previous-versions/Msdrm/nf-msdrm-drmsetintervaltime?branch=master)
#### [DRMSetMetaData](/windows/previous-versions/Msdrm/nf-msdrm-drmsetmetadata?branch=master)
#### [DRMSetNameAndDescription](/windows/previous-versions/Msdrm/nf-msdrm-drmsetnameanddescription?branch=master)
#### [DRMSetRevocationPoint](/windows/previous-versions/Msdrm/nf-msdrm-drmsetrevocationpoint?branch=master)
#### [DRMSetUsagePolicy](/windows/previous-versions/Msdrm/nf-msdrm-drmsetusagepolicy?branch=master)
#### [DRMVerify](/windows/previous-versions/Msdrm/nf-msdrm-drmverify?branch=master)
...
#### [DRM_ACTSERV_INFO](/windows/previous-versions/Msdrmdefs/ns-msdrmdefs-_drm_actserv_info?branch=master)
#### [DRM_CLIENT_VERSION_INFO](/windows/previous-versions/Msdrmdefs/ns-msdrmdefs-_drm_client_version_info?branch=master)
#### [DRM_LICENSE_ACQ_DATA](/windows/previous-versions/Msdrmdefs/ns-msdrmdefs-_drm_license_acq_data?branch=master)
#### [DRMBOUNDLICENSEPARAMS](/windows/previous-versions/Msdrmdefs/ns-msdrmdefs-_drmboundlicenseparams?branch=master)
#### [DRMID](/windows/previous-versions/Msdrmdefs/ns-msdrmdefs-_drmid?branch=master)
#### [DRMPUBHANDLE](drmpubhandle.md)
### [AD RMS Enumerations](ad-rms-enumerations.md)
#### [DRM_DISTRIBUTION_POINT_INFO](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drm_distribution_point_info?branch=master)
#### [DRM_STATUS_MSG](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drm_status_msg?branch=master)
#### [DRM_USAGEPOLICY_TYPE](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drm_usagepolicy_type?branch=master)
#### [DRMATTESTTYPE](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drmattesttype?branch=master)
#### [DRMENCODINGTYPE](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drmencodingtype?branch=master)
#### [DRMGLOBALOPTIONS](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drmglobaloptions?branch=master)
#### [DRMSECURITYPROVIDERTYPE](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drmsecurityprovidertype?branch=master)
#### [DRMSPECTYPE](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drmspectype?branch=master)
#### [DRMTIMETYPE](/windows/previous-versions/Msdrmdefs/ne-msdrmdefs-_drmtimetype?branch=master)
