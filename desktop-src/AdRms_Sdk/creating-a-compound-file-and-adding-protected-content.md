...
After you have encrypted content, saved it in a file, and obtained a signed [*issuance license*](https://www.bing.com/search?q=*issuance license*), you can create a compound file container. The Active Directory Rights Management Add-on for Internet Explorer interprets the rights specified in the issuance license and allows permitted users to access the protected content.
