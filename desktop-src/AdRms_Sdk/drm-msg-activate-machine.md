...
The **DRM\_MSG\_ACTIVATE\_MACHINE** message is sent to the custom callback function in response to the [**DRMActivate**](/windows/previous-versions/Msdrm/nf-msdrm-drmactivate?branch=master) function being called with the **DRM\_ACTIVATE\_MACHINE** option.
