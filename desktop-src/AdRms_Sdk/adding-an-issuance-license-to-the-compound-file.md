...
In the following example, the signed [*issuance license*](https://www.bing.com/search?q=*issuance license*) is added in a new stream to the compound file. This stream must be called \\006Primary to enable the Microsoft Rights Management Add-on for Internet Explorer to read it.
