...
The following functions require a handle to a secure environment created by calling [**DRMInitEnvironment**](/windows/previous-versions/Msdrm/nf-msdrm-drminitenvironment?branch=master). Therefore, you must create a manifest before calling them.
