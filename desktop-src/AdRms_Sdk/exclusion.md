...
Exclusion is the process of preventing specified users or computers from acquiring new [*issuance licenses*](i-gly.md#-rm-issuance-license-gly), [*end-user licenses*](e-gly.md#-rm-end-user-license-gly), or [*rights account certificates*](r-gly.md#-rm-rights-account-certificate-gly). Exclusion does not affect licenses or certificates that have already been acquired.
