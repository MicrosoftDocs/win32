---
Description: Poorly designed rights management applications and the data protected by them can be vulnerable to both unintended errors and malicious action.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\mbaldwin
ms.assetid: a3f532c7-c893-4b93-bb15-db7c4fa2c8f3
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
title: Required Application Security Standards
