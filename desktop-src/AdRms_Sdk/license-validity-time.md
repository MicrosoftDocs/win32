...
The default validity times for the licenses and certificates that a service issues ([*rights account certificate*](r-gly.md#-rm-rights-account-certificate-gly) (RAC), temporary RAC, [*end-user license*](e-gly.md#-rm-end-user-license-gly), and so on) are set by the issuing service. These values can be changed, up to the maximum allowable time of seven years.
