...
> \[!Important\]  
> In Windows 7, you can perform AES cipher-block chaining (CBC) encryption. One of the key features of CBC is the use of a chaining mechanism that ensures that blocks containing identical plain-text values will not produce identical cipher-text values. See the *wszSymKeyType* parameter of [**DRMGetSignedIssuanceLicense**](/previous-versions/windows/desktop/api/Msdrm/nf-msdrm-drmgetsignedissuancelicense) or [**DRMEncrypt**](/previous-versions/windows/desktop/api/Msdrm/nf-msdrm-drmencrypt) to see how to perform CBC encryption on AD RMS protected content.
