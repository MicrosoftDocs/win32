...
The **DRM\_MSG\_ACQUIRE\_CLIENTLICENSOR** message is sent to the custom callback function in response to the [**DRMAcquireLicense**](/previous-versions/windows/desktop/api/Msdrm/nf-msdrm-drmacquirelicense) function being called with a client session handle.
