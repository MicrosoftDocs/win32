...
4.  Pass the resulting string array into [**DRMConstructCertificateChain**](/previous-versions/windows/desktop/api/Msdrm/nf-msdrm-drmconstructcertificatechain) to create a certificate chain that can be used by an AD RMS-consuming application to acquire a use license.
