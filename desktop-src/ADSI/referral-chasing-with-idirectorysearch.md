...
In a one-level or subtree search, referrals are returned for known, immediately subordinate domain, schema, or configuration containers only; that is, child domains that are direct descendants. For more information, see [Search Scope](https://docs.microsoft.com/windows/desktop/AD/search-scope).
...
For more information about referrals in Active Directory, see [Referrals](https://docs.microsoft.com/windows/desktop/AD/referrals).
