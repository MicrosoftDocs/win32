...
| 0x80005009L | **E\_ADS\_OBJECT\_UNBOUND**           | The specified ADSI object is not bound to a remote resource.          | Call [**GetInfo**](/windows/win32/Iads/nf-iads-iads-getinfo?branch=master) on a newly created object after [**SetInfo**](/windows/win32/Iads/nf-iads-iads-setinfo?branch=master) has been called.                                                                                                                                                                                      |
...
| 0x8000500DL | **E\_ADS\_PROPERTY\_NOT\_FOUND**      | The property cannot be found in the cache.                            | Verify that [**GetInfo**](/windows/win32/Iads/nf-iads-iads-getinfo?branch=master) has been called implicitly or explicitly. If the attribute is an operational attribute, it must be explicitly retrieved with [**GetInfoEx**](/windows/win32/Iads/nf-iads-iads-getinfoex?branch=master) instead of **GetInfo**. If the problem persists, the property has not been set on the server. |
