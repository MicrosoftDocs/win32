...
-   Add your code to a COM object and put this object into a [COM+ application](https://msdn.microsoft.com/library/ms683512(v=VS.85).aspx) (previously called an MTS package). The COM+ application can then be run as a [domain user account](https://docs.microsoft.com/windows/desktop/AD/domain-user-accounts).
