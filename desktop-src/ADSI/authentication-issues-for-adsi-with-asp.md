...
-   Add your code to a COM object and put this object into a [COM+ application](https://msdn.microsoft.com/windows/desktop/82e94acb-e7ce-4423-a720-26ee65d0d7b4) (previously called an MTS package). The COM+ application can then be run as a [domain user account](https://msdn.microsoft.com/library/ms675915).
