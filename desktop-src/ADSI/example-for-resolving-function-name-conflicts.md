...
Be aware that even though IADs1 does not support Func2, an ADSI client recognizes one [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) that supports all the dual and dispatch interfaces in the model. Thus, the ADSI client can directly call Func2 using myInf1.Func2 without resolving which interface supports Func2.
