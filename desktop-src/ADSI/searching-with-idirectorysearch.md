...
2.  Call [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**) to get the [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) pointer.
...
2.  Retrieve the [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) COM Interface with a call to [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**); this operation may have been done in Step 1 during the initial binding.
