...
ADSI, each element of a directory service is represented by an ADSI object, which is a Component Object Model (COM) object that supports the standard COM [**IUnknown**](33f1d79a-33fc-4ce5-a372-e08bda378332) interface as well as the [**IDispatch**](https://msdn.microsoft.com/windows/desktop/ebbff4bc-36b2-4861-9efa-ffa45e013eb5) and [**IADs**](/windows/desktop/api/Iads/nn-iads-iads) interfaces. **IADs** supplies the basic maintenance functions for ADSI objects.
