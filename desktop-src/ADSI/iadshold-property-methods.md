...
The property method of the [**IADsHold**](/windows/win32/Iads/nn-iads-iadshold?branch=master) interface sets the property described in the following table. For more information, see [Interface Property Methods](interface-property-methods.md).
