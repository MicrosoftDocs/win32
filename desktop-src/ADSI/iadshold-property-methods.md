...
keywords: ["IADsHold Property Methods ADSI"]
topic_type:
- apiref
api_name:
...
The property method of the [**IADsHold**](iadshold.md) interface sets the property described in the following table. For more information, see [Interface Property Methods](interface-property-methods.md).
