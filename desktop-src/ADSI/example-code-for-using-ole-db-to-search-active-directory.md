...
There are two query dialects that can be used with the ADSI OLE DB provider, LDAP and SQL. The dialect is specified in the [ICommandText::SetCommandText](https://go.microsoft.com/fwlink/p/?linkid=83900) method with one of the following GUIDs:
