...
keywords: ["extensions ADSI ,late binding support", "ADSI ADSI ,example code Visual Basic ,late binding support", "binding AD ,late binding support"]
---
