...
| "ADSI Flag"        | A set of flags from the [**ADS\_AUTHENTICATION\_ENUM**](/windows/desktop/api/Iads/ne-iads-__midl___midl_itf_ads_0000_0000_0018) enumeration that specify the binding authentication options. The default is zero.                                                                                                                                                                         |
...
| "Chase referrals"   | A value from the [**ADS\_CHASE\_REFERRALS\_ENUM**](/windows/desktop/api/Iads/ne-iads-__midl___midl_itf_ads_0000_0000_0024) that specifies how the search chases referrals. The default is **ADS\_CHASE\_REFERRALS\_NEVER**.For more information about this property, see [Referrals](https://msdn.microsoft.com/library/ms677913).<br/>                                                                                                                                           |
...
| "SearchScope"       | A value from the [**ADS\_SCOPEENUM**](/windows/desktop/api/Iads/ne-iads-__midl___midl_itf_ads_0000_0000_0021) enumeration that specifies the search scope. The default is **ADS\_SCOPE\_SUBTREE**.                                                                                                                                                                                                                                                                  |
