...
| "Chase referrals"   | A value from the [**ADS\_CHASE\_REFERRALS\_ENUM**](/windows/desktop/api/Iads/ne-iads-__midl___midl_itf_ads_0000_0000_0024) that specifies how the search chases referrals. The default is **ADS\_CHASE\_REFERRALS\_NEVER**.For more information about this property, see [Referrals](https://docs.microsoft.com/windows/desktop/AD/referrals).<br/>                                                                                                                                           |
