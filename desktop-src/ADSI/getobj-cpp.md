...
| **GetNamespaceObject**              | Validate and [**CoCreateInstance**](7295a55b-12c7-4ed0-a7a4-9ecee16afdec) an example namespace object.                                                                                                                                                                                                           |
...
| **GetSchemaObject**                 | Validate and open the appropriate schema object type. Then create the correct one, and retrieve the [**IUnknown**](33f1d79a-33fc-4ce5-a372-e08bda378332) interface pointer on it.                                                                                                                                        |
