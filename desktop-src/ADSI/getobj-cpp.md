...
| **GetNamespaceObject**              | Validate and [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**) an example namespace object.                                                                                                                                                                                                           |
...
| **GetSchemaObject**                 | Validate and open the appropriate schema object type. Then create the correct one, and retrieve the [**IUnknown**](https://www.bing.com/search?q=**IUnknown**) interface pointer on it.                                                                                                                                        |
