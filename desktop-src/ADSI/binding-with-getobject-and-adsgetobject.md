...
In languages that do not directly support automation, such as C or C++, ADSI provides the [**ADsGetObject**](/windows/desktop/api/Adshlp/nf-adshlp-adsgetobject) function to bind to directory service objects. Alternatively, the [**MkParseDisplayName**](https://msdn.microsoft.com/windows/desktop/ada46dd3-e2c5-4ff5-89bd-3805f98b247b) and [**MkParseDisplayNameEx**](https://www.bing.com/search?q=**MkParseDisplayNameEx**) functions can be used to achieve the same result as **GetObject**.
