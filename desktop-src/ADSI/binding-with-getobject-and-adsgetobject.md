...
In languages that do not directly support automation, such as C or C++, ADSI provides the [**ADsGetObject**](/windows/desktop/api/Adshlp/nf-adshlp-adsgetobject) function to bind to directory service objects. Alternatively, the [**MkParseDisplayName**](https://www.bing.com/search?q=**MkParseDisplayName**) and [**MkParseDisplayNameEx**](https://www.bing.com/search?q=**MkParseDisplayNameEx**) functions can be used to achieve the same result as **GetObject**.
