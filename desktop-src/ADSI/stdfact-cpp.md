...
In the example provider component, a code example showing the standard [**IClassFactory**](https://www.bing.com/search?q=**IClassFactory**) implementation is in Stdfact.cpp. For more information, see **IClassFactory**.
