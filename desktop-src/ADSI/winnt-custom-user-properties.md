...
| **UserFlags**       | Integer      | User Flag defined in [**ADS\_USER\_FLAG\_ENUM**](/windows/desktop/api/Iads/ne-iads-ads_user_flag). For an example of how to use UserFlags, see [Password Never Expires (WinNT Provider)](winnt-password-never-expires.md)                                                                                                                                                             |
