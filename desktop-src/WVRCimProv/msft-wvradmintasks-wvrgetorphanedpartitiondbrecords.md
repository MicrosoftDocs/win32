...
keywords: ["WvrGetOrphanedPartitionDbRecords method", "WvrGetOrphanedPartitionDbRecords method, MSFT_WvrAdminTasks class", "MSFT_WvrAdminTasks class, WvrGetOrphanedPartitionDbRecords method"]
---
