---
title: GetPartnership method of the MSFT\_WvrAdminTasks class
description: Retrieves a replication partnership.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f7594cab-8f35-4fe9-8f36-1ca4fcd44782'
ms.prod: 'windows-server-dev'
ms.technology:
- 'storage-replica'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetPartnership method", "GetPartnership method, MSFT_WvrAdminTasks class", "MSFT_WvrAdminTasks class, GetPartnership method"]
topic_type:
- apiref
api_name:
- MSFT_WvrAdminTasks.GetPartnership
api_location:
- WvrCimProv.dll
api_type:
- COM
...
# GetPartnership method of the MSFT\_WvrAdminTasks class
