...
keywords:
- SmapiQueryReplicatedPartitions method
- SmapiQueryReplicatedPartitions method, MSFT_WvrAdminTasks class
- MSFT_WvrAdminTasks class, SmapiQueryReplicatedPartitions method
ms.date: 05/31/2018
ms.topic: article
