...
keywords: ["SetPartnershipSetSourcePartnership method", "SetPartnershipSetSourcePartnership method, MSFT_WvrAdminTasks class", "MSFT_WvrAdminTasks class, SetPartnershipSetSourcePartnership method"]
topic_type:
- apiref
api_name:
