...
keywords: ["GetGroupFromPartnership method", "GetGroupFromPartnership method, MSFT_WvrAdminTasks class", "MSFT_WvrAdminTasks class, GetGroupFromPartnership method"]
topic_type:
- apiref
api_name:
