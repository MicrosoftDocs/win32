...
The following are privacy levels that equate to rules for accepting, conditionally accepting, or not accepting cookies. These levels correspond to the privacy preference levels set on the Privacy tab in Internet Options. See [Privacy in Internet Explorer 6](iesecurity-Privacy_IE6) for detailed definitions.
...
User-defined. See [How to Create a Customized Privacy Import File](iesecurity-PrivacyImportXML) to understand how to set custom privacy settings.
