...
| [**INTERNET\_FLAG\_FROM\_CACHE**](api-flags.md#internet-flag-from-cache)[**INTERNET\_FLAG\_FORMS\_SUBMIT**](api-flags.md#internet-flag-forms-submit) | Does not make network requests. All entities are returned from the cache. If the requested item is not in the cache, a suitable error, such as ERROR\_FILE\_NOT\_FOUND, is returned. Only the [**InternetOpen**](/windows/win32/Wininet/nf-wininet-internetopena?branch=master) function uses this flag.                                                                                                                                                                                                       |
...
| [**INTERNET\_FLAG\_NO\_UI**](api-flags.md#internet-flag-no-ui)                                                                                        | Disables the cookie dialog box. This flag can be used by [**HttpOpenRequest**](/windows/win32/Wininet/nf-wininet-httpopenrequesta?branch=master) and [**InternetOpenUrl**](/windows/win32/Wininet/nf-wininet-internetopenurla?branch=master) (HTTP requests only).                                                                                                                                                                                                                                                                                          |
...
| [**INTERNET\_FLAG\_PRAGMA\_NOCACHE**](api-flags.md#internet-flag-pragma-nocache)                                                                      | Forces the request to be resolved by the origin server, even if a cached copy exists on the proxy. The [**InternetOpenUrl**](/windows/win32/Wininet/nf-wininet-internetopenurla?branch=master) function (on HTTP and HTTPS requests only) and [**HttpOpenRequest**](/windows/win32/Wininet/nf-wininet-httpopenrequesta?branch=master) function use this flag.                                                                                                                                                                                               |
...
|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CommitUrlCacheEntryA**](/windows/win32/Wininet/nf-wininet-commiturlcacheentrya?branch=master)               | Caches data in the specified file in the cache storage and associates it with the given URL.                                                                  |
| [**CommitUrlCacheEntryW**](/windows/win32/Wininet/nf-wininet-commiturlcacheentryw?branch=master)               | Caches data in the specified file in the cache storage and associates it with the given URL.                                                                  |
| [**CreateUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-createurlcacheentrya?branch=master)                 | Allocates the requested cache storage and creates a local file name for saving the cache entry that corresponds to the source name.                           |
| [**CreateUrlCacheGroup**](/windows/win32/Wininet/nf-wininet-createurlcachegroup?branch=master)                 | Generates a cache group identification.                                                                                                                       |
| [**DeleteUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-deleteurlcacheentry?branch=master)                 | Removes the file associated with the source name from the cache, if the file exists.                                                                          |
| [**DeleteUrlCacheGroup**](/windows/win32/Wininet/nf-wininet-deleteurlcachegroup?branch=master)                 | Releases a **GROUPID** and any associated state in the cache index file.                                                                                      |
| [**FindCloseUrlCache**](/windows/win32/Wininet/nf-wininet-findcloseurlcache?branch=master)                     | Closes the specified enumeration handle.                                                                                                                      |
| [**FindFirstUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findfirsturlcacheentrya?branch=master)           | Begins the enumeration of the cache.                                                                                                                          |
| [**FindFirstUrlCacheEntryEx**](/windows/win32/Wininet/nf-wininet-findfirsturlcacheentryexa?branch=master)       | Begins a filtered enumeration of the cache.                                                                                                                   |
| [**FindNextUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findnexturlcacheentrya?branch=master)             | Retrieves the next entry in the cache.                                                                                                                        |
| [**FindNextUrlCacheEntryEx**](/windows/win32/Wininet/nf-wininet-findnexturlcacheentryexa?branch=master)         | Retrieves the next entry in a filtered cache enumeration.                                                                                                     |
| [**GetUrlCacheEntryInfo**](/windows/win32/Wininet/nf-wininet-geturlcacheentryinfoa?branch=master)               | Retrieves information about a cache entry.                                                                                                                    |
| [**GetUrlCacheEntryInfoEx**](/windows/win32/Wininet/nf-wininet-geturlcacheentryinfoexa?branch=master)           | Searches for the URL after translating any cached redirections that would be applied in offline mode by [**HttpSendRequest**](/windows/win32/Wininet/nf-wininet-httpsendrequesta?branch=master).           |
| [**ReadUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-readurlcacheentrystream?branch=master)         | Reads the cached data from a stream that has been opened using [**RetrieveUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentrystreama?branch=master).                            |
| [**RetrieveUrlCacheEntryFile**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentryfilea?branch=master)     | Retrieves a cache entry from the cache in the form of a file.                                                                                                 |
| [**RetrieveUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentrystreama?branch=master) | Provides the most efficient and implementation-independent way of accessing the cache data.                                                                   |
| [**SetUrlCacheEntryGroup**](/windows/win32/Wininet/nf-wininet-seturlcacheentrygroup?branch=master)             | Adds or removes entries from a cache group.                                                                                                                   |
| [**SetUrlCacheEntryInfo**](/windows/win32/Wininet/nf-wininet-seturlcacheentryinfoa?branch=master)               | Sets the specified members of the [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure.                                                |
| [**UnlockUrlCacheEntryFile**](/windows/win32/Wininet/nf-wininet-unlockurlcacheentryfile?branch=master)         | Unlocks the cache entry that was locked when the file was retrieved for use from the cache by [**RetrieveUrlCacheEntryFile**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentryfilea?branch=master). |
| [**UnlockUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-unlockurlcacheentrystream?branch=master)     | Closes the stream that has been retrieved using [**RetrieveUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentrystreama?branch=master).                                           |
...
The [**FindFirstUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findfirsturlcacheentrya?branch=master) and [**FindNextUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findnexturlcacheentrya?branch=master) functions enumerate the information stored in the cache. [**FindFirstUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findfirsturlcacheentrya?branch=master) starts the enumeration by taking a search pattern, a buffer, and a buffer size to create a handle and return the first cache entry. [**FindNextUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findnexturlcacheentrya?branch=master) takes the handle created by [**FindFirstUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findfirsturlcacheentrya?branch=master), a buffer, and a buffer size to return the next cache entry.

Both functions store an [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure in the buffer. The size of this structure varies for each entry. If the buffer size passed to either function is insufficient, the function fails and [**GetLastError**](https://msdn.microsoft.com/library/windows/desktop/ms679360) returns ERROR\_INSUFFICIENT\_BUFFER. The buffer size variable contains the buffer size that was needed to retrieve that cache entry. A buffer of the size indicated by the buffer size variable should be allocated, and the function should be called again with the new buffer.

The [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure contains the structure size, URL of the cached information, local file name, cache entry type, use count, hit rate, size, last modified time, expiration, last access, last synchronized time, header information, header information size, and file name extension.

The [**FindFirstUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-findfirsturlcacheentrya?branch=master) function takes a search pattern, a buffer that stores the [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure, and the buffer size. Currently, only the default search pattern, which returns all cache entries, is implemented.

After the cache is enumerated, the application should call [**FindCloseUrlCache**](/windows/win32/Wininet/nf-wininet-findcloseurlcache?branch=master) to close the cache enumeration handle.
...
The [**GetUrlCacheEntryInfo**](/windows/win32/Wininet/nf-wininet-geturlcacheentryinfoa?branch=master) function lets you retrieve the [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure for the specified URL. This structure contains the structure size, URL of the cached information, local file name, cache entry type, use count, hit rate, size, last modified time, expiration, last access, last synchronized time, header information, header information size, and file name extension.

[**GetUrlCacheEntryInfo**](/windows/win32/Wininet/nf-wininet-geturlcacheentryinfoa?branch=master) accepts a URL, a buffer for an [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure, and the buffer size. If the URL is found, the information is copied into the buffer. Otherwise, the function fails and [**GetLastError**](https://msdn.microsoft.com/library/windows/desktop/ms679360) returns ERROR\_FILE\_NOT\_FOUND. If the buffer size is insufficient to store the cache entry information, the function fails and [**GetLastError**](https://msdn.microsoft.com/library/windows/desktop/ms679360) returns ERROR\_INSUFFICIENT\_BUFFER. The size required to retrieve the information is stored in the buffer size variable.

[**GetUrlCacheEntryInfo**](/windows/win32/Wininet/nf-wininet-geturlcacheentryinfoa?branch=master) does not do any URL parsing, so a URL that contains an anchor (\#) will not be found in the cache, even if the resource is cached. For example, if the URL "http://example.com/example.htm\#sample" is passed, the function returns ERROR\_FILE\_NOT\_FOUND even if "http://example.com/example.htm" is in the cache.
...
An application uses the [**CreateUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-createurlcacheentrya?branch=master) and [**CommitUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-commiturlcacheentrya?branch=master) functions to create a cache entry.

[**CreateUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-createurlcacheentrya?branch=master) accepts the URL, expected file size, and file name extension. The function then creates a local file name for saving the cache entry that corresponds to the URL and file name extension.

Using the local file name, write the data into the local file. After the data has been written to the local file, the application should call [**CommitUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-commiturlcacheentrya?branch=master).

[**CommitUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-commiturlcacheentrya?branch=master) accepts the URL, local file name, expiration, last modified time, cache entry type, header information, header information size, and file name extension. The function then caches data in the file specified in the cache storage and associates it with the given URL.

The following example uses the local file name, created by a previous call to [**CreateUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-createurlcacheentrya?branch=master), stored in the text box, **IDC\_LocalFile**, to store the text from the text box, **IDC\_CacheDump**, in the cache entry. After the data has been written to the file using **fopen**, **fprintf**, and **fclose**, the entry is committed using [**CommitUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-commiturlcacheentrya?branch=master).
...
The [**DeleteUrlCacheEntry**](/windows/win32/Wininet/nf-wininet-deleteurlcacheentry?branch=master) function takes a URL and removes the cache file associated with it. If the cache file does not exist, the function fails and [**GetLastError**](https://msdn.microsoft.com/library/windows/desktop/ms679360) returns ERROR\_FILE\_NOT\_FOUND. If the cache file is currently locked or in use, the function fails and [**GetLastError**](https://msdn.microsoft.com/library/windows/desktop/ms679360) returns ERROR\_ACCESS\_DENIED. The file is deleted when unlocked.

### Retrieving Cache Entry Files

For applications that require the file name of a resource, use the [**RetrieveUrlCacheEntryFile**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentryfilea?branch=master) and [**UnlockUrlCacheEntryFile**](/windows/win32/Wininet/nf-wininet-unlockurlcacheentryfile?branch=master) functions. Applications that do not require the file name should use the [**RetrieveUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentrystreama?branch=master), [**ReadUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-readurlcacheentrystream?branch=master), and [**UnlockUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-unlockurlcacheentrystream?branch=master) functions to retrieve the information in the cache.

[**RetrieveUrlCacheEntryStream**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentrystreama?branch=master) does not do any URL parsing, so a URL that contains an anchor (\#) will not be found in the cache, even if the resource is cached. For example, if the URL "http://example.com/example.htm\#sample" is passed, the function returns ERROR\_FILE\_NOT\_FOUND even if "http://example.com/example.htm" is in the cache.

[**RetrieveUrlCacheEntryFile**](/windows/win32/Wininet/nf-wininet-retrieveurlcacheentryfilea?branch=master) accepts a URL, a buffer that stores the [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure, and the buffer size. The function is retrieved and locked for the caller.

After the information in the file has been used, the application should call [**UnlockUrlCacheEntryFile**](/windows/win32/Wininet/nf-wininet-unlockurlcacheentryfile?branch=master) to unlock the file.

### Cache Groups

To create a cache group, the [**CreateUrlCacheGroup**](/windows/win32/Wininet/nf-wininet-createurlcachegroup?branch=master) function must be called to generate a **GROUPID** for the cache group. Entries can be added to the cache group by supplying the cache entry's URL and the INTERNET\_CACHE\_GROUP\_ADD flag to the [**SetUrlCacheEntryGroup**](/windows/win32/Wininet/nf-wininet-seturlcacheentrygroup?branch=master) function. To remove a cache entry from a group, pass the cache entry's URL and the INTERNET\_CACHE\_GROUP\_REMOVE flag to [**SetUrlCacheEntryGroup**](/windows/win32/Wininet/nf-wininet-seturlcacheentrygroup?branch=master).

The [**FindFirstUrlCacheEntryEx**](/windows/win32/Wininet/nf-wininet-findfirsturlcacheentryexa?branch=master) and [**FindNextUrlCacheEntryEx**](/windows/win32/Wininet/nf-wininet-findnexturlcacheentryexa?branch=master) functions can be used to enumerate the entries in a specified cache group. After the enumeration is complete, the function should call [**FindCloseUrlCache**](/windows/win32/Wininet/nf-wininet-findcloseurlcache?branch=master).

## Handling Structures with Variable Size Information

The cache can contain variable size information for each URL stored. This is reflected in the [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) structure. When the cache functions return this structure, they create a buffer that is always the size of [**INTERNET\_CACHE\_ENTRY\_INFO**](/windows/win32/Wininet/ns-wininet-_internet_cache_entry_infoa?branch=master) plus any variable size information. If a pointer member is not **NULL**, it points to the memory area immediately after the structure. While copying the buffer returned by a function into another buffer, the pointer members should be fixed to point to the appropriate place in the new buffer, as the following example shows.
