...
A custom interface can use the [**InternetSetOption**](/windows/desktop/api/Wininet/nf-wininet-internetsetoptiona) function to set the [INTERNET\_OPTION\_PASSWORD](https://www.bing.com/search?q=INTERNET\_OPTION\_PASSWORD) and [INTERNET\_OPTION\_USERNAME](https://www.bing.com/search?q=INTERNET\_OPTION\_USERNAME) values and then resend the request to the server.
...
A custom interface can use the [**InternetSetOption**](/windows/desktop/api/Wininet/nf-wininet-internetsetoptiona) function to set the [INTERNET\_OPTION\_PROXY\_PASSWORD](https://www.bing.com/search?q=INTERNET\_OPTION\_PROXY\_PASSWORD) and [INTERNET\_OPTION\_PROXY\_USERNAME](https://www.bing.com/search?q=INTERNET\_OPTION\_PROXY\_USERNAME) values and then resend the request to the proxy.
...
For any customized function that adds its own WWW-Authenticate or Proxy-Authenticate headers, the [INTERNET\_FLAG\_NO\_AUTH](https://www.bing.com/search?q=INTERNET\_FLAG\_NO\_AUTH) flag should be set to disable authentication.
