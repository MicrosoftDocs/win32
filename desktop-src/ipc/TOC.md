...
##### [CreateMailslot](/windows/win32/content/Winbase/nf-winbase-createmailslota?branch=dev)
##### [GetMailslotInfo](/windows/win32/content/Winbase/nf-winbase-getmailslotinfo?branch=dev)
##### [SetMailslotInfo](/windows/win32/content/Winbase/nf-winbase-setmailslotinfo?branch=dev)
...
##### [CallNamedPipe](/windows/win32/content/Winbase/nf-winbase-callnamedpipea?branch=dev)
##### [ConnectNamedPipe](/windows/win32/content/Winbase/?branch=dev)
##### [CreateNamedPipe](/windows/win32/content/Winbase/nf-winbase-createnamedpipea?branch=dev)
##### [CreatePipe](/windows/win32/content/Winbase/?branch=dev)
##### [DisconnectNamedPipe](/windows/win32/content/Winbase/?branch=dev)
##### [GetNamedPipeClientComputerName](/windows/win32/content/Winbase/nf-winbase-getnamedpipeclientcomputernamea?branch=dev)
##### [GetNamedPipeClientProcessId](/windows/win32/content/Winbase/nf-winbase-getnamedpipeclientprocessid?branch=dev)
##### [GetNamedPipeClientSessionId](/windows/win32/content/Winbase/nf-winbase-getnamedpipeclientsessionid?branch=dev)
##### [GetNamedPipeHandleState](/windows/win32/content/Winbase/nf-winbase-getnamedpipehandlestatea?branch=dev)
##### [GetNamedPipeInfo](/windows/win32/content/Winbase/?branch=dev)
##### [GetNamedPipeServerProcessId](/windows/win32/content/Winbase/nf-winbase-getnamedpipeserverprocessid?branch=dev)
##### [GetNamedPipeServerSessionId](/windows/win32/content/Winbase/nf-winbase-getnamedpipeserversessionid?branch=dev)
##### [PeekNamedPipe](/windows/win32/content/Winbase/?branch=dev)
##### [SetNamedPipeHandleState](/windows/win32/content/Winbase/?branch=dev)
##### [TransactNamedPipe](/windows/win32/content/Winbase/?branch=dev)
##### [WaitNamedPipe](/windows/win32/content/Winbase/nf-winbase-waitnamedpipea?branch=dev)
