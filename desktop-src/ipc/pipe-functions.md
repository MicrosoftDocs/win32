...
|----------------------------------|----------------------------|
| [**CreatePipe**](https://msdn.microsoft.com/en-us/library/Aa365152(v=VS.85).aspx) | Creates an anonymous pipe. |
...
| [**ConnectNamedPipe**](https://msdn.microsoft.com/en-us/library/Aa365146(v=VS.85).aspx)                             | Enables a named pipe server process to wait for a client process to connect to an instance of a named pipe.                                                                                                                         |
...
| [**DisconnectNamedPipe**](https://msdn.microsoft.com/en-us/library/Aa365166(v=VS.85).aspx)                       | Disconnects the server end of a named pipe instance from a client process.                                                                                                                                                          |
...
| [**GetNamedPipeInfo**](https://msdn.microsoft.com/en-us/library/Aa365445(v=VS.85).aspx)                             | Retrieves information about the specified named pipe.                                                                                                                                                                               |
...
| [**PeekNamedPipe**](https://msdn.microsoft.com/en-us/library/Aa365779(v=VS.85).aspx)                                   | Copies data from a named or anonymous pipe into a buffer without removing it from the pipe.                                                                                                                                         |
| [**SetNamedPipeHandleState**](https://msdn.microsoft.com/en-us/library/Aa365787(v=VS.85).aspx)               | Sets the read mode and the blocking mode of the specified named pipe.                                                                                                                                                               |
| [**TransactNamedPipe**](https://msdn.microsoft.com/en-us/library/Aa365790(v=VS.85).aspx)                           | Combines the functions that write a message to and read a message from the specified named pipe into a single network operation.                                                                                                    |
