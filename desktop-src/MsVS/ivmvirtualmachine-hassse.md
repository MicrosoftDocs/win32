...
keywords: ["HasSSE property Virtual Server", "HasSSE property Virtual Server , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual Server , HasSSE property", "HasSSE property Virtual Server , VMVirtualMachine class", "VMVirtualMachine class Virtual Server , HasSSE property"]
topic_type:
- apiref
api_name:
