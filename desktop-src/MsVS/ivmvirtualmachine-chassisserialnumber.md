...
keywords:
- ChassisSerialNumber property Virtual Server
- ChassisSerialNumber property Virtual Server , IVMVirtualMachine interface
- IVMVirtualMachine interface Virtual Server , ChassisSerialNumber property
topic_type:
- apiref
api_name:
