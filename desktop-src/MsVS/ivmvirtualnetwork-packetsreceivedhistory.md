...
keywords: ["PacketsReceivedHistory property Virtual Server", "PacketsReceivedHistory property Virtual Server , IVMVirtualNetwork interface", "IVMVirtualNetwork interface Virtual Server , PacketsReceivedHistory property", "PacketsReceivedHistory property Virtual Server , VMVirtualNetwork class", "VMVirtualNetwork class Virtual Server , PacketsReceivedHistory property"]
topic_type:
- apiref
api_name:
