...
keywords:
- ParallelPorts property Virtual Server
- ParallelPorts property Virtual Server , IVMVirtualMachine interface
- IVMVirtualMachine interface Virtual Server , ParallelPorts property
- ParallelPorts property Virtual Server , VMVirtualMachine class
- VMVirtualMachine class Virtual Server , ParallelPorts property
topic_type:
- apiref
api_name:
