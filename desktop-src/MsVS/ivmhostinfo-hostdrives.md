...
keywords: ["HostDrives property Virtual Server", "HostDrives property Virtual Server , IVMHostInfo interface", "IVMHostInfo interface Virtual Server , HostDrives property", "HostDrives property Virtual Server , VMHostInfo interface", "VMHostInfo interface Virtual Server , HostDrives property"]
topic_type:
- apiref
api_name:
