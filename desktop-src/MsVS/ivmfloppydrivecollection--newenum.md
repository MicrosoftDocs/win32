...
keywords: ["_NewEnum property Virtual Server", "_NewEnum property Virtual Server , IVMFloppyDriveCollection interface", "IVMFloppyDriveCollection interface Virtual Server , _NewEnum property"]
topic_type:
- apiref
api_name:
