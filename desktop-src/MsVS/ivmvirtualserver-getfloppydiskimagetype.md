...
keywords: ["GetFloppyDiskImageType method Virtual Server", "GetFloppyDiskImageType method Virtual Server , IVMVirtualServer interface", "IVMVirtualServer interface Virtual Server , GetFloppyDiskImageType method"]
topic_type:
- apiref
api_name:
