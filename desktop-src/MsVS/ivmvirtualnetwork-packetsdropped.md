...
keywords:
- PacketsDropped property Virtual Server
- PacketsDropped property Virtual Server , IVMVirtualNetwork interface
- IVMVirtualNetwork interface Virtual Server , PacketsDropped property
- PacketsDropped property Virtual Server , VMVirtualNetwork class
- VMVirtualNetwork class Virtual Server , PacketsDropped property
topic_type:
- apiref
api_name:
