...
keywords: ["Description property Virtual Server", "Description property Virtual Server , IVMTask interface", "IVMTask interface Virtual Server , Description property", "Description property Virtual Server , VMTask interface", "VMTask interface Virtual Server , Description property"]
topic_type:
- apiref
api_name:
- IVMTask.Description
