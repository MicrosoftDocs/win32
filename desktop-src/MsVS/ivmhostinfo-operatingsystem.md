...
keywords: ["OperatingSystem property Virtual Server", "OperatingSystem property Virtual Server , IVMHostInfo interface", "IVMHostInfo interface Virtual Server , OperatingSystem property", "OperatingSystem property Virtual Server , VMHostInfo interface", "VMHostInfo interface Virtual Server , OperatingSystem property"]
topic_type:
- apiref
api_name:
