...
keywords: ["OnReset method Virtual Server", "OnReset method Virtual Server , IVMVirtualMachineEvents interface", "IVMVirtualMachineEvents interface Virtual Server , OnReset method"]
topic_type:
- apiref
api_name:
