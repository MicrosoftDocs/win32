...
- apiref
api_name:
- IVMRCClientControl.AdminDisplay
- VMRCClientControl.AdminDisplay
api_location:
...
The **AdminDisplay** method displays the control's administrative information screen.

## Syntax


```C++
HRESULT AdminDisplay();
```
