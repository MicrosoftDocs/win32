...
Both the [**IVMKeyboard**](ivmkeyboard.md) and [**IVMRCClientControl**](ivmrcclientcontrol.md) interfaces use these key identifiers to simulate individual keystrokes or in creating key sequence strings.
...
[**IVMKeyboard::TypeKeySequence**](ivmkeyboard-typekeysequence.md)
</dt> <dt>

[**IVMRCClientControl**](ivmrcclientcontrol.md)
</dt> <dt>

[**IVMRCClientControl::SendKeySequence**](ivmrcclientcontrol-sendkeysequence.md)
</dt> </dl>
