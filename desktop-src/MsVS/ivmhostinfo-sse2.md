...
keywords: ["SSE2 property Virtual Server", "SSE2 property Virtual Server , IVMHostInfo interface", "IVMHostInfo interface Virtual Server , SSE2 property", "SSE2 property Virtual Server , VMHostInfo interface", "VMHostInfo interface Virtual Server , SSE2 property"]
topic_type:
- apiref
api_name:
- IVMHostInfo.SSE2
