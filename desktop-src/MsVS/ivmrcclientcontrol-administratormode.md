...
keywords:
- AdministratorMode property Virtual Server
- AdministratorMode property Virtual Server , IVMRCClientControl interface
- IVMRCClientControl interface Virtual Server , AdministratorMode property
- AdministratorMode property Virtual Server , VMRCClientControl interface
- VMRCClientControl interface Virtual Server , AdministratorMode property
topic_type:
- apiref
api_name:
