...
keywords: ["PacketsSent property Virtual Server", "PacketsSent property Virtual Server , IVMVirtualNetwork interface", "IVMVirtualNetwork interface Virtual Server , PacketsSent property", "PacketsSent property Virtual Server , VMVirtualNetwork class", "VMVirtualNetwork class Virtual Server , PacketsSent property"]
topic_type:
- apiref
api_name:
