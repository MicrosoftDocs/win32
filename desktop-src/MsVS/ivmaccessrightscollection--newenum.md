...
keywords: ["_NewEnum property Virtual Server", "_NewEnum property Virtual Server , IVMAccessRightsCollection interface", "IVMAccessRightsCollection interface Virtual Server , _NewEnum property"]
topic_type:
- apiref
api_name:
