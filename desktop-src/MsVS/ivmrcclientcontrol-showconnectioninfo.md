...
- apiref
api_name:
- IVMRCClientControl.ShowConnectionInfo
- VMRCClientControl.ShowConnectionInfo
api_location:
...
The **ShowConnectionInfo** method displays the control's connection information screen.

## Syntax


```C++
HRESULT ShowConnectionInfo();
```
