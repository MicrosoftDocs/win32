...
keywords: ["DNSServers property Virtual Server", "DNSServers property Virtual Server , IVMDHCPVirtualNetworkServer interface", "IVMDHCPVirtualNetworkServer interface Virtual Server , DNSServers property", "DNSServers property Virtual Server , VMDHCPVirtualNetworkServer interface", "VMDHCPVirtualNetworkServer interface Virtual Server , DNSServers property"]
topic_type:
- apiref
api_name:
