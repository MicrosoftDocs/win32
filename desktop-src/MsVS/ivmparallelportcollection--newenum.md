...
keywords: ["_NewEnum property Virtual Server", "_NewEnum property Virtual Server , IVMParallelPortCollection interface", "IVMParallelPortCollection interface Virtual Server , _NewEnum property"]
topic_type:
- apiref
api_name:
