...
keywords: ["_NewEnum property Virtual Server", "_NewEnum property Virtual Server , IVMHardDiskConnectionCollection interface", "IVMHardDiskConnectionCollection interface Virtual Server , _NewEnum property"]
topic_type:
- apiref
api_name:
