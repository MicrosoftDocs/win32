...
keywords:
- PhysicalProcessorCount property Virtual Server
- PhysicalProcessorCount property Virtual Server , IVMHostInfo interface
- IVMHostInfo interface Virtual Server , PhysicalProcessorCount property
- PhysicalProcessorCount property Virtual Server , VMHostInfo interface
- VMHostInfo interface Virtual Server , PhysicalProcessorCount property
topic_type:
- apiref
api_name:
