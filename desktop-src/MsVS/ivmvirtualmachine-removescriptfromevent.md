...
keywords: ["RemoveScriptFromEvent method Virtual Server", "RemoveScriptFromEvent method Virtual Server , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual Server , RemoveScriptFromEvent method"]
topic_type:
- apiref
api_name:
