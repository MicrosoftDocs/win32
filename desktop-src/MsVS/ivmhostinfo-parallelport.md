...
keywords:
- ParallelPort property Virtual Server
- ParallelPort property Virtual Server , IVMHostInfo interface
- IVMHostInfo interface Virtual Server , ParallelPort property
- ParallelPort property Virtual Server , VMHostInfo interface
- VMHostInfo interface Virtual Server , ParallelPort property
topic_type:
- apiref
api_name:
