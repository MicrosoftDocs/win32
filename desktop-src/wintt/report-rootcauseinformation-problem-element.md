...
Contains the list of root causes that the troubleshooting pack can detect.
...
The **RootCauseInformation** element is defined by the [**Problem**](report-problem-complextype.md) complex type.
