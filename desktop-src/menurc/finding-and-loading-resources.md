...
Memory associated with resources loaded through [**FindResource**](/windows/desktop/api/Winbase/nf-winbase-findresourcea) and [**LoadResource**](https://msdn.microsoft.com/en-us/library/ms648046(v=VS.85).aspx) will be released once the module has been unloaded by a call to [**FreeLibrary**](https://msdn.microsoft.com/library/windows/desktop/ms683152). Any resources which remain unloaded at application termination will be automatically released by the system.
