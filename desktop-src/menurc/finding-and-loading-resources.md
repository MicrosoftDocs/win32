...
| [**LoadImage**](/windows/desktop/api/Winuser/nf-winuser-loadimagea)               | Loads an icon, cursor, or bitmap.        | [**DestroyIcon**](/windows/desktop/api/Winuser/nf-winuser-destroyicon), [**DestroyCursor**](/windows/desktop/api/Winuser/nf-winuser-destroycursor), [**DeleteObject**](https://msdn.microsoft.com/library/windows/desktop/dd183539) |
...
Memory associated with resources loaded through [**FindResource**](/windows/desktop/api/Winbase/nf-winbase-findresourcea) and [**LoadResource**](/windows/desktop/api/Winbase/) will be released once the module has been unloaded by a call to [**FreeLibrary**](https://msdn.microsoft.com/library/windows/desktop/ms683152). Any resources which remain unloaded at application termination will be automatically released by the system.
