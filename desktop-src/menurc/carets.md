...
| [**GetCaretPos**](/windows/desktop/api/Winuser/nf-winuser-getcaretpos)             | Copies the caret's position to the specified [**POINT**](https://msdn.microsoft.com/library/windows/desktop/dd162805) structure. <br/>                                                                                                                                                                    |
