...
| [**GetCaretPos**](/windows/desktop/api/Winuser/nf-winuser-getcaretpos)             | Copies the caret's position to the specified [**POINT**](https://docs.microsoft.com/previous-versions//dd162805(v=vs.85)) structure. <br/>                                                                                                                                                                    |
