...
RC can generate separate resource files for applications that have both language-neutral and language-specific resources. Developers can use a [resource configuration file](https://msdn.microsoft.com/library/windows/desktop/dd319101) or set command-line options to select which resource types and items are non-localizable resources of the [language-neutral (LN) file](https://msdn.microsoft.com/library/windows/desktop/dd319070) and which are localizable resources of language-specific MUI files. For more information, see the [Multilingual User Interface](https://msdn.microsoft.com/library/windows/desktop/dd319073).
...
**Windows Server 2003 and Windows XP/2000:** This option is not available without also using the [**LoadMUILibrary**](https://msdn.microsoft.com/library/windows/desktop/dd318709) and [**FreeMUILibrary**](https://msdn.microsoft.com/library/windows/desktop/dd318067) functions on an updated system.
...
For more information, see [Language Identifiers](https://msdn.microsoft.com/library/windows/desktop/dd318691).
...
[Multilingual User Interface](https://msdn.microsoft.com/library/windows/desktop/dd319073)
</dt> </dl>
