...
keywords: ["WM_MENUGETOBJECT message Menus and Other Resources"]
topic_type:
- apiref
api_name:
- WM_MENUGETOBJECT
...
A pointer to a [**MENUGETOBJECTINFO**](menugetobjectinfo.md) structure.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| <dl> <dt>**MNGO\_NOERROR**</dt> <dt>0x00000001</dt> </dl>     | An interface pointer was returned in the **pvObj** member of [**MENUGETOBJECTINFO**](menugetobjectinfo.md)<br/> |
