...
The button styles are described in the following topic: [Button Styles](_win32_button_styles).
...
The combo box control styles are described in the following topic: [Combo Box Styles](_win32_combo_box_styles).
...
The edit control styles are described in the following topic: [Edit Control Styles](_win32_edit_control_styles).
...
The list box control styles are described in the following topic: [List Box Styles](_win32_list_box_styles).
...
The scroll bar styles are described in the following topic: [Scroll Bar Control Styles](_win32_scroll_bar_control_styles).
...
The static control styles are described in the following topic: [Static Control Styles](_win32_static_control_styles).
