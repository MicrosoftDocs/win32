...
The button styles are described in the following topic: [Button Styles](https://www.bing.com/search?q=Button+Styles).
...
The combo box control styles are described in the following topic: [Combo Box Styles](https://www.bing.com/search?q=Combo+Box+Styles).
...
The edit control styles are described in the following topic: [Edit Control Styles](https://www.bing.com/search?q=Edit+Control+Styles).
...
The list box control styles are described in the following topic: [List Box Styles](https://www.bing.com/search?q=List+Box+Styles).
...
The scroll bar styles are described in the following topic: [Scroll Bar Control Styles](https://www.bing.com/search?q=Scroll+Bar+Control+Styles).
...
The static control styles are described in the following topic: [Static Control Styles](https://www.bing.com/search?q=Static+Control+Styles).
