...
<td>Changes the cursor to a question mark with a pointer. If the user then clicks a control in the dialog box, the control receives a [<strong>WM_HELP</strong>](https://www.bing.com/search?q=<strong>WM_HELP</strong>) message.<br/></td>
</tr>
<tr class="odd">
