...
<td>Changes the cursor to a question mark with a pointer. If the user then clicks a control in the dialog box, the control receives a [<strong>WM_HELP</strong>](_win32_WM_HELP) message.<br/></td>
</tr>
<tr class="odd">
