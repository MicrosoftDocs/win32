...
The name **DIALOG** can also be used as the class-name parameter to the [**CreateWindow**](_win32_createwindow_cpp) function to create a window with dialog-box attributes.
...
[Using Dialog Boxes](_win32_Using_Dialog_Boxes)
</dt> <dt>
...
[**CreateDialog**](_win32_createdialog_cpp)
</dt> <dt>

[**CreateWindow**](_win32_createwindow_cpp)
</dt> <dt>

[**DialogBox**](_win32_dialogbox_cpp)
</dt> <dt>
