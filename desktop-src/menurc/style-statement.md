...
For a list of window styles, see [Window Styles](https://msdn.microsoft.com/library/windows/desktop/ms632600). For a list of dialog box styles, see [Dialog Box Template Styles](https://www.bing.com/search?q=Dialog Box Template Styles). If you use the window or dialog box style values, you must include Windows.h.
