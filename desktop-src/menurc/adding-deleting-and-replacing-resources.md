...
Sometimes, an application must copy resources from another file. [Updating Resources](https://www.bing.com/search?q=Updating Resources) shows an example of obtaining the resource data and its size from a file.
