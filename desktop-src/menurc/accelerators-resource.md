...
The [**TranslateAccelerator**](_win32_translateaccelerator_cpp) function is used to translate accelerator messages from the application queue into [**WM\_COMMAND**](_win32_wm_command_cpp) or [**WM\_SYSCOMMAND**](_win32_wm_syscommand_cpp) messages.
...
[Using Keyboard Accelerators](_win32_Using_Keyboard_Accelerators_cpp)
</dt> <dt>

[**TranslateAccelerator**](_win32_translateaccelerator_cpp)
</dt> <dt>
