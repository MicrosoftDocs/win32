...
keywords: ["MrmCreateResourceIndexer function Menus and Other Resources"]
topic_type:
- apiref
api_name:
...
Creates a resource indexer, used to generate package resource index (PRI) files for a UWP app. For more info, and scenario-based walkthroughs of how to use these APIs, see [Package resource indexing (PRI) APIs and custom build systems](https://docs.microsoft.com/windows/uwp/app-resources/pri-apis-custom-build-systems).
