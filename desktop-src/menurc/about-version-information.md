...
You can add version information to any files that can have Windows resources, such as DLLs, executable files, or .fon font files. To add the information, create a [VERSIONINFO Resource](https://msdn.microsoft.com/library/windows/desktop/aa381058) and use the resource compiler to compile the resource.
