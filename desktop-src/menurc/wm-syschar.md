...
keywords: ["WM_SYSCHAR message Menus and Other Resources"]
topic_type:
- apiref
api_name:
- WM_SYSCHAR
...
[**TranslateAccelerator**](translateaccelerator.md)
</dt> <dt>
