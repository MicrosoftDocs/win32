...
The language for the resource or set of resources. Set the value for this member with the optional [LANGUAGE](_Tools_LANGUAGE_Statement) resource definition statement. The parameters are constants from the Winnt.h file.
...
A user-defined version number for the resource data that tools can use to read and write resource files. Set this value with the optional [VERSION](_Tools_VERSION_Statement) resource definition statement.
...
[CHARACTERISTICS Statement](_Tools_CHARACTERISTICS_Statement)
</dt> <dt>

[LANGUAGE Statement](_Tools_LANGUAGE_Statement)
</dt> <dt>
