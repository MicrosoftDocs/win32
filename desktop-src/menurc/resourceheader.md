...
The language for the resource or set of resources. Set the value for this member with the optional [LANGUAGE](https://www.bing.com/search?q=LANGUAGE) resource definition statement. The parameters are constants from the Winnt.h file.
...
A user-defined version number for the resource data that tools can use to read and write resource files. Set this value with the optional [VERSION](https://www.bing.com/search?q=VERSION) resource definition statement.
...
Specifies user-defined information about the resource that tools can use to read and write resource files. Set this value with the optional [CHARACTERISTICS](https://www.bing.com/search?q=CHARACTERISTICS) resource definition statement.
