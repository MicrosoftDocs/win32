...
description: Defines the ID and file of an applications message table resource. Message tables are special string resources used in event logging and with the FormatMessage function. The file contains a binary message table generated by the message compiler, MC.EXE.
...
Defines the ID and file of an application's message table resource. Message tables are special string resources used in event logging and with the [**FormatMessage**](https://msdn.microsoft.com/library/windows/desktop/ms679351) function. The file contains a binary message table generated by the message compiler, MC.EXE.
