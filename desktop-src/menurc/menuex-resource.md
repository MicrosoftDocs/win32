...
-   Use of the **MFT\_\*** type flags and **MFS\_\*** state flags. For more information on these flags, see the [**MENUITEMINFO**](_win32_menuiteminfo_str) structure.
...
Numeric expression indicating the identifier used to identify the menu during [**WM\_HELP**](_win32_wm_help) processing.
...
[Using Menus](_win32_Using_Menus)
</dt> <dt>
