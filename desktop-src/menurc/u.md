...
The device-independent bitmap (DIB) header is not a [**BITMAPCOREHEADER**](_win32_bitmapcoreheader_str) or [**BITMAPINFOHEADER**](_win32_bitmapinfoheader_str) structure.
