...
keywords: ["WM_CONTEXTMENU message Menus and Other Resources"]
topic_type:
- apiref
api_name:
- WM_CONTEXTMENU
...
A window can process this message by displaying a shortcut menu using the [**TrackPopupMenu**](trackpopupmenu.md) or [**TrackPopupMenuEx**](trackpopupmenuex.md) functions. To obtain the horizontal and vertical positions, use the following code.
...
[**TrackPopupMenu**](trackpopupmenu.md)
</dt> <dt>

[**TrackPopupMenuEx**](trackpopupmenuex.md)
</dt> <dt>
