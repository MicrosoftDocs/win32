...
| [**WM\_GETTITLEBARINFOEX**](wm-gettitlebarinfoex.md) | Sent to request extended title bar information. A window receives this message through its [**WindowProc**](https://docs.microsoft.com/previous-versions/windows/desktop/legacy/ms633573(v=vs.85)) function.<br/>                                  |
...
| Name                                                       | Description                                                                                                                                                     |
|------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**MDINEXTMENU**](/windows/desktop/api/Winuser/ns-winuser-tagmdinextmenu)                         | Contains information about the menu to be activated. <br/>                                                                                                |
| [**MENUBARINFO**](/windows/desktop/api/Winuser/ns-winuser-tagmenubarinfo)                         | Contains menu bar information.<br/>                                                                                                                       |
...
| [**MENUGETOBJECTINFO**](/windows/desktop/api/Winuser/ns-winuser-tagmenugetobjectinfo)             | Contains information about the menu that the mouse cursor is on.<br/>                                                                                     |
| [**MENUINFO**](/windows/desktop/api/Winuser/ns-winuser-tagmenuinfo)                               | Contains information about a menu.<br/>                                                                                                                   |
| [**MENUITEMINFO**](/windows/desktop/api/Winuser/ns-winuser-tagmenuiteminfoa)                       | Contains information about a menu item. <br/>                                                                                                             |
...
| [**TPMPARAMS**](/windows/desktop/api/Winuser/ns-winuser-tagtpmparams)                             | Contains extended parameters for the [**TrackPopupMenuEx**](/windows/desktop/api/Winuser/nf-winuser-trackpopupmenuex) function.<br/>                                                          |
