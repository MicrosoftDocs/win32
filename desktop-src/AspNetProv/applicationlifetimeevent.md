...
The event type class for the **ApplicationLifetimeEvent** event.
...
``` syntax
[Dynamic, EventType(73), EventLevel(5), EventVersion(1), EventTypeName("ApplicationLifetimeEvent")]
...
The **ApplicationLifetimeEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **ApplicationLifetimeEvent** class has these properties.
