---
Description: The event type class for the RoleManagerBegin event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 66bdc2d3-a15a-48a7-9095-8a936efe1de7
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetRoleManagerBegin class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetRoleManagerBegin class

The event type class for the **RoleManagerBegin** event.
...
``` syntax
[dynamic, EventType(48), EventLevel(4), EventTypeName("RoleManagerBegin")]
...
The **AspNetRoleManagerBegin** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetRoleManagerBegin** class has these properties.
