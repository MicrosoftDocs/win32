---
Description: The event type class for the PagePreInitEnter event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 22c70244-459a-40f4-8744-39fd5a09c9dd
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetPagePreInitEnter class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetPagePreInitEnter class

The event type class for the **PagePreInitEnter** event.
...
``` syntax
[dynamic, EventType(22), EventLevel(5), EventTypeName("PagePreInitEnter")]
...
The **AspNetPagePreInitEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPagePreInitEnter** class has these properties.
