...
The event type class for the **PagePreRenderEnter** event.
...
``` syntax
[dynamic, EventType(36), EventLevel(5), EventTypeName("PagePreRenderEnter")]
...
The **AspNetPagePreRenderEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPagePreRenderEnter** class has these properties.
