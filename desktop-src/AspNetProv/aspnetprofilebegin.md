---
Description: 'The event type class for the ProfileBegin event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'adc57dd0-a050-4924-a95d-309cc482bd29'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetProfileBegin class
---

# AspNetProfileBegin class

The event type class for the **ProfileBegin** event.
...
``` syntax
[dynamic, EventType(44), EventLevel(4), EventTypeName("ProfileBegin")]
...
The **AspNetProfileBegin** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetProfileBegin** class has these properties.
