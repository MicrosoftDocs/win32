---
Description: The event type class for the AuthenticationFailureAuditEvent event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: e663b585-c311-4bc8-a8ac-bdd23a719274
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AuthenticationFailureAuditEvent class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AuthenticationFailureAuditEvent class

The event type class for the **AuthenticationFailureAuditEvent** event.
...
``` syntax
[Dynamic, EventType(83), EventLevel(3), EventVersion(1), EventTypeName("AuthenticationFailureAuditEvent")]
...
The **AuthenticationFailureAuditEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AuthenticationFailureAuditEvent** class has these properties.
