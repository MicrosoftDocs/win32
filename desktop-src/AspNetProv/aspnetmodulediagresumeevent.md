...
The event type class for the **DiagnosticTraceResume** event.
...
``` syntax
[dynamic, EventType(69), EventLevel(5), EventVersion(0), EventTypeName("DiagnosticTraceResume")]
...
The **AspNetModuleDiagResumeEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagResumeEvent** class has these properties.
