---
Description: 'The event type class for the PageLoadViewstateLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'ec1cdfe2-38af-4833-8743-2bec86a2ffde'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPageLoadViewstateLeave class
---

# AspNetPageLoadViewstateLeave class

The event type class for the **PageLoadViewstateLeave** event.
...
``` syntax
[dynamic, EventType(27), EventLevel(5), EventTypeName("PageLoadViewstateLeave")]
...
The **AspNetPageLoadViewstateLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageLoadViewstateLeave** class has these properties.
