...
The event type class for the **CompileLeave** event.
...
``` syntax
[dynamic, EventType(17), EventLevel(5), EventTypeName("CompileLeave")]
...
The **AspNetCompileLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetCompileLeave** class has these properties.
