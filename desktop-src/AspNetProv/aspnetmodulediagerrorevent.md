---
Description: The event type class for the DiagnosticTraceError event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 3af78203-8e78-495d-9eac-a1fa5d95213d
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetModuleDiagErrorEvent class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetModuleDiagErrorEvent class

The event type class for the **DiagnosticTraceError** event.
...
``` syntax
[dynamic, EventType(62), EventLevel(3), EventVersion(0), EventTypeName("DiagnosticTraceError")]
...
The **AspNetModuleDiagErrorEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagErrorEvent** class has these properties.
