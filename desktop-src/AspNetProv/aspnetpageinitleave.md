...
The event type class for the **PageInitLeave** event.
...
``` syntax
[dynamic, EventType(25), EventLevel(5), EventTypeName("PageInitLeave")]
...
The **AspNetPageInitLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageInitLeave** class has these properties.
