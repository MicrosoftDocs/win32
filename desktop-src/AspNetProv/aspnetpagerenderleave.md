---
Description: The event type class for the PageRenderLeave event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: a7b7b980-d840-4afc-9644-397f090edaee
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetPageRenderLeave class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetPageRenderLeave class

The event type class for the **PageRenderLeave** event.
...
``` syntax
[dynamic, EventType(41), EventLevel(5), EventTypeName("PageRenderLeave")]
...
The **AspNetPageRenderLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageRenderLeave** class has these properties.
