---
Description: 'The event type class for the PagePostDataChangedLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'cf39fa21-b370-4d0a-b096-7eb316f61b59'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPagePostDataChangedLeave class
---

# AspNetPagePostDataChangedLeave class

The event type class for the **PagePostDataChangedLeave** event.
...
``` syntax
[dynamic, EventType(33), EventLevel(5), EventTypeName("PagePostDataChangedLeave")]
...
The **AspNetPagePostDataChangedLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPagePostDataChangedLeave** class has these properties.
