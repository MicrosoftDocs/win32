---
Description: The event type class for the PageInitEnter event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 67c68de4-86f4-45d2-b003-4f8c017cc021
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetPageInitEnter class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# AspNetPageInitEnter class

The event type class for the **PageInitEnter** event.
...
``` syntax
[dynamic, EventType(24), EventLevel(5), EventTypeName("PageInitEnter")]
...
The **AspNetPageInitEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageInitEnter** class has these properties.
