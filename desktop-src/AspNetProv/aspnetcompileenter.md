---
Description: 'The event type class for the CompileEnter event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '91997b30-b102-4fb5-8ba1-fb85ec60a278'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetCompileEnter class
---

# AspNetCompileEnter class

The event type class for the **CompileEnter** event.
...
``` syntax
[dynamic, EventType(16), EventLevel(5), EventTypeName("CompileEnter")]
...
The **AspNetCompileEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetCompileEnter** class has these properties.
