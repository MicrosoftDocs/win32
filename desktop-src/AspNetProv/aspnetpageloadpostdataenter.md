---
Description: The event type class for the PageLoadPostDataEnter event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: ee50b601-c570-46d2-95e6-1825896101e2
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetPageLoadPostDataEnter class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetPageLoadPostDataEnter class

The event type class for the **PageLoadPostDataEnter** event.
...
``` syntax
[dynamic, EventType(28), EventLevel(5), EventTypeName("PageLoadPostDataEnter")]
...
The **AspNetPageLoadPostDataEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageLoadPostDataEnter** class has these properties.
