...
The event type class for the **MapHandlerLeave** event.
...
``` syntax
[dynamic, EventType(13), EventLevel(5), EventTypeName("MapHandlerLeave")]
...
The **AspNetMapHandlerLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetMapHandlerLeave** class has these properties.
