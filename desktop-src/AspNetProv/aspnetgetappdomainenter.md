---
Description: The event type class for the GetAppDomainEnter event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 6f289c23-200b-4269-b0fa-de7e277d8827
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetGetAppDomainEnter class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# AspNetGetAppDomainEnter class

The event type class for the **GetAppDomainEnter** event.
...
``` syntax
[dynamic, EventType(5), EventLevel(5), EventTypeName("GetAppDomainEnter")]
...
The **AspNetGetAppDomainEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetGetAppDomainEnter** class has these properties.
