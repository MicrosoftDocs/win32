---
Description: 'The event type class for the ParseEnter event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'bef39cc4-9e3c-4f93-82d4-35d29a0bf5e6'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetParseEnter class
---

# AspNetParseEnter class

The event type class for the **ParseEnter** event.
...
``` syntax
[dynamic, EventType(14), EventLevel(5), EventTypeName("ParseEnter")]
...
The **AspNetParseEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetParseEnter** class has these properties.
