...
The event type class for the **DiagnosticTraceTransfer** event.
...
``` syntax
[dynamic, EventType(70), EventLevel(5), EventVersion(0), EventTypeName("DiagnosticTraceTransfer")]
...
The **AspNetModuleDiagTransferEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagTransferEvent** class has these properties.
