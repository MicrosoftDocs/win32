...
The event type class for the **StartHandler** event.
...
``` syntax
[dynamic, EventType(8), EventLevel(5), EventTypeName("StartHandler")]
...
The **AspNetStartHandler** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetStartHandler** class has these properties.
