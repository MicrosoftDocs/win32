---
Description: 'The event type class for the SessionStatePartitionEnd event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '06432e9e-13bf-401c-99a3-aac201fca9f8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetSessionStatePartitionEnd class
---

# AspNetSessionStatePartitionEnd class

The event type class for the **SessionStatePartitionEnd** event.
...
``` syntax
[dynamic, EventType(21), EventLevel(5), EventTypeName("SessionStatePartitionEnd")]
...
The **AspNetSessionStatePartitionEnd** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetSessionStatePartitionEnd** class has these properties.
