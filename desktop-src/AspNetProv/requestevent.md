---
Description: The event type class for the RequestEvent event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 6dff08f4-607c-4b37-81a0-dc837f2742a6
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: RequestEvent class
ms.date: 05/31/2018
ms.topic: article
...
The event type class for the **RequestEvent** event.
...
``` syntax
[Dynamic, EventType(74), EventLevel(5), EventVersion(1), EventTypeName("RequestEvent")]
...
The **RequestEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **RequestEvent** class has these properties.
