---
Description: The event type class for the RequestDequeued event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 27ba7b91-a3d1-4788-87ec-5d16d9fbcbab
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetRequestDequeued class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# AspNetRequestDequeued class

The event type class for the **RequestDequeued** event.
...
``` syntax
[dynamic, EventType(4), EventLevel(4), EventTypeName("RequestDequeued")]
...
The **AspNetRequestDequeued** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetRequestDequeued** class has these properties.
