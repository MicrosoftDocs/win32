...
The event type class for the **ProfileEnd** event.
...
``` syntax
[dynamic, EventType(45), EventLevel(4), EventTypeName("ProfileEnd")]
...
The **AspNetProfileEnd** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetProfileEnd** class has these properties.
