...
The event type class for the **TraceContextWarning** event.
...
``` syntax
[dynamic, EventType(59), EventLevel(3), EventVersion(0), EventTypeName("TraceContextWarning")]
...
The **AspNetPageTraceWarnEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageTraceWarnEvent** class has these properties.
