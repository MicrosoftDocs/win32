---
Description: 'The event type class for the PageLoadLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '303dcb5c-6d94-4084-8329-a9fa0fe40229'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPageLoadLeave class
---

# AspNetPageLoadLeave class

The event type class for the **PageLoadLeave** event.
...
``` syntax
[dynamic, EventType(31), EventLevel(5), EventTypeName("PageLoadLeave")]
...
The **AspNetPageLoadLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageLoadLeave** class has these properties.
