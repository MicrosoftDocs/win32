---
Description: 'The event type class for the DiagnosticTraceVerbose event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'c1d1ca8a-45ab-4275-ac31-ebd9788be5ad'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetModuleDiagVerboseEvent class
---

# AspNetModuleDiagVerboseEvent class

The event type class for the **DiagnosticTraceVerbose** event.
...
``` syntax
[dynamic, EventType(65), EventLevel(5), EventVersion(0), EventTypeName("DiagnosticTraceVerbose")]
...
The **AspNetModuleDiagVerboseEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagVerboseEvent** class has these properties.
