---
Description: 'The event type class for the PipelineModuleLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'd16668df-9ae5-47cc-93a4-ac928a416989'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPipelineModuleLeave class
---

# AspNetPipelineModuleLeave class

The event type class for the **PipelineModuleLeave** event.
...
``` syntax
[dynamic, EventType(11), EventLevel(5), EventTypeName("PipelineModuleLeave")]
...
The **AspNetPipelineModuleLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPipelineModuleLeave** class has these properties.
