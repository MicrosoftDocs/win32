---
Description: 'The event type class for the EndHandler event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '8e01c6a3-997d-4195-9df0-c072c333c257'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetEndHandler class
---

# AspNetEndHandler class

The event type class for the **EndHandler** event.
...
``` syntax
[dynamic, EventType(9), EventLevel(5), EventTypeName("EndHandler")]
...
The **AspNetEndHandler** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetEndHandler** class has these properties.
