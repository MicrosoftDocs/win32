---
Description: The event type class for the RoleManagerEnd event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: b9e8a77a-9a11-4766-972e-edfa56af86b1
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetRoleManagerEnd class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetRoleManagerEnd class

The event type class for the **RoleManagerEnd** event.
...
``` syntax
[dynamic, EventType(49), EventLevel(4), EventTypeName("RoleManagerEnd")]
...
The **AspNetRoleManagerEnd** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetRoleManagerEnd** class has these properties.
