---
Description: 'The event type class for the PagePreRenderLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'a8d8217e-d7d7-4e97-b30f-8b08a71cf063'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPagePreRenderLeave class
---

# AspNetPagePreRenderLeave class

The event type class for the **PagePreRenderLeave** event.
...
``` syntax
[dynamic, EventType(37), EventLevel(5), EventTypeName("PagePreRenderLeave")]
...
The **AspNetPagePreRenderLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPagePreRenderLeave** class has these properties.
