---
Description: 'The event type class for the WebEventRaiseEnd event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '9aa4a1bd-60e2-45b4-a146-d50f96c018da'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetWebEventRaiseEnd class
---

# AspNetWebEventRaiseEnd class

The event type class for the **WebEventRaiseEnd** event.
...
``` syntax
[dynamic, EventType(51), EventLevel(5), EventTypeName("WebEventRaiseEnd")]
...
The **AspNetWebEventRaiseEnd** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetWebEventRaiseEnd** class has these properties.
