---
Description: The event type class for the RequestQueued event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 7b4c47fe-81c1-407b-ab68-1f1b37a505e9
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetRequestQueued class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# AspNetRequestQueued class

The event type class for the **RequestQueued** event.
...
``` syntax
[dynamic, EventType(3), EventLevel(4), EventTypeName("RequestQueued")]
...
The **AspNetRequestQueued** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetRequestQueued** class has these properties.
