...
The event type class for the **PagePostDataChangedEnter** event.
...
``` syntax
[dynamic, EventType(32), EventLevel(5), EventTypeName("PagePostDataChangedEnter")]
...
The **AspNetPagePostDataChangedEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPagePostDataChangedEnter** class has these properties.
