---
Description: The parent class from which all intrinsic ASP.NET event trace classes are derived.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: a3cb076d-069e-4065-acf6-8a2c69478b94
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetTraceEvent class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetTraceEvent class
...
``` syntax
[dynamic, Guid("{06A01367-79D3-4594-8EB3-C721603C4679}")]
...
The **AspNetTraceEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetTraceEvent** class has these properties.
