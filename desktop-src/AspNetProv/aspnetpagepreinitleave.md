---
Description: 'The event type class for the PagePreInitLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '65095031-c588-4b42-97d0-0031ebf4a893'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPagePreInitLeave class
---

# AspNetPagePreInitLeave class

The event type class for the **PagePreInitLeave** event.
...
``` syntax
[dynamic, EventType(23), EventLevel(5), EventTypeName("PagePreInitLeave")]
...
The **AspNetPagePreInitLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPagePreInitLeave** class has these properties.
