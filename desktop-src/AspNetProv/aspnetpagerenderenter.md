---
Description: 'The event type class for the PageRenderEnter event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '2429bf2b-683f-47db-851a-a2b2e0a3ebf7'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPageRenderEnter class
---

# AspNetPageRenderEnter class

The event type class for the **PageRenderEnter** event.
...
``` syntax
[dynamic, EventType(40), EventLevel(5), EventTypeName("PageRenderEnter")]
...
The **AspNetPageRenderEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageRenderEnter** class has these properties.
