---
Description: The event type class for the DiagnosticTraceStart event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 528fea2e-c194-45c0-8087-3ba8856c57c3
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetModuleDiagStartEvent class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# AspNetModuleDiagStartEvent class

The event type class for the **DiagnosticTraceStart** event.
...
``` syntax
[dynamic, EventType(66), EventLevel(5), EventVersion(0), EventTypeName("DiagnosticTraceStart")]
...
The **AspNetModuleDiagStartEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagStartEvent** class has these properties.
