...
The event type class for the **TraceContextWrite** event.TraceContext Write Trace
...
``` syntax
[dynamic, EventType(60), EventLevel(5), EventVersion(0), EventTypeName("TraceContextWrite")]
...
The **AspNetPageTraceWriteEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageTraceWriteEvent** class has these properties.
