---
Description: The event type class for the Start event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 0821a54a-9f60-44b2-848b-ff4e0cc71f3b
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetStart class
...
The event type class for the **Start** event.
...
``` syntax
[dynamic, EventType(1), EventLevel(0), EventTypeName("Start")]
...
The **AspNetStart** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetStart** class has these properties.
...
Qualifiers: **WmiDataId** (3), **StringTermination** ("NullTerminated")
</dt> </dl>
...
Qualifiers: **WmiDataId** (5), **StringTermination** ("NullTerminated")
</dt> </dl>
