...
The event type class for the **WebEventDeliverEnd** event.WebEventDeliverEnd
...
``` syntax
[dynamic, EventType(53), EventLevel(5), EventTypeName("WebEventDeliverEnd")]
...
The **AspNetWebEventDeliverEnd** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetWebEventDeliverEnd** class has these properties.
