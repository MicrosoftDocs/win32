---
Description: The event type class for the PageLoadEnter event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: ec840fb3-3d71-402b-8a21-434143c526eb
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetPageLoadEnter class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# AspNetPageLoadEnter class

The event type class for the **PageLoadEnter** event.
...
``` syntax
[dynamic, EventType(30), EventLevel(5), EventTypeName("PageLoadEnter")]
...
The **AspNetPageLoadEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageLoadEnter** class has these properties.
