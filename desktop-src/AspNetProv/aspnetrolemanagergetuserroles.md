---
Description: The event type class for the RoleManagerGetUserRoles event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 9954036c-f30b-4918-9d50-711048c07df7
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetRoleManagerGetUserRoles class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetRoleManagerGetUserRoles class

The event type class for the **RoleManagerGetUserRoles** event.
...
``` syntax
[dynamic, EventType(47), EventLevel(4), EventTypeName("RoleManagerGetUserRoles")]
...
The **AspNetRoleManagerGetUserRoles** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetRoleManagerGetUserRoles** class has these properties.
