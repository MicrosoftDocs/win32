---
Description: 'The event type class for the ParseLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '69cf7d25-153a-4ab0-a0e1-70979c06a107'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetParseLeave class
---

# AspNetParseLeave class

The event type class for the **ParseLeave** event.
...
``` syntax
[dynamic, EventType(15), EventLevel(5), EventTypeName("ParseLeave")]
...
The **AspNetParseLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetParseLeave** class has these properties.
