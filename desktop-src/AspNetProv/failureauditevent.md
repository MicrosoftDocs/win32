---
Description: The parent class from which all failure audit event trace classes are derived.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 01214fae-aadb-4f5c-b7be-fe1246b2e584
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: FailureAuditEvent class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# FailureAuditEvent class

The parent class from which all failure audit event trace classes are derived.
...
``` syntax
[Dynamic, EventType(81), EventLevel(4), EventVersion(1), EventTypeName("FailureAuditEvent")]
...
The **FailureAuditEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **FailureAuditEvent** class has these properties.
