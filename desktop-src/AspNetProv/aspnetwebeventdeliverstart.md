---
Description: The event type class for the WebEventDeliverStart event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: e7af0054-016a-42df-99f5-6558fec8e2d7
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetWebEventDeliverStart class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetWebEventDeliverStart class

The event type class for the **WebEventDeliverStart** event.
...
``` syntax
[dynamic, EventType(52), EventLevel(5), EventTypeName("WebEventDeliverStart")]
...
The **AspNetWebEventDeliverStart** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetWebEventDeliverStart** class has these properties.
