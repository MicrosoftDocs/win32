---
Description: 'The event type class for the MapHandlerEnter event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '8a0047b1-ca50-4d26-80e4-60f0759be578'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetMapHandlerEnter class
---

# AspNetMapHandlerEnter class

The event type class for the **MapHandlerEnter** event.
...
``` syntax
[dynamic, EventType(12), EventLevel(5), EventTypeName("MapHandlerEnter")]
...
The **AspNetMapHandlerEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetMapHandlerEnter** class has these properties.
