...
The event type class for the **DiagnosticTraceWarning** event.
...
``` syntax
[dynamic, EventType(63), EventLevel(3), EventVersion(0), EventTypeName("DiagnosticTraceWarning")]
...
The **AspNetModuleDiagWarningEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagWarningEvent** class has these properties.
