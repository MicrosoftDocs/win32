---
Description: 'The parent class from which all extrinsic ASP.NET management event trace classes are derived.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'd8013909-dbce-46a8-8ffd-dd32f5f9d43a'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: ManagementEvent class
---

# ManagementEvent class

The parent class from which all extrinsic ASP.NET management event trace classes are derived.
...
``` syntax
[Dynamic, EventType(72), EventLevel(5), EventVersion(1), EventTypeName("ManagementEvent")]
...
The **ManagementEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **ManagementEvent** class has these properties.
