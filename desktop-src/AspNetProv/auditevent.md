---
Description: 'The parent class from which all audit event trace classes are derived.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '5a9ce8da-dcc2-4420-90d6-92a14b857bc8'
...
The parent class from which all audit event trace classes are derived.
...
``` syntax
[Dynamic, EventType(79), EventLevel(4), EventVersion(1), EventTypeName("AuditEvent")]
...
The **AuditEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AuditEvent** class has these properties.
