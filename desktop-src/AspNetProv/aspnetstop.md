---
Description: 'The event type class for the End event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '02298077-ecad-412e-86e5-6a78a86804ad'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetStop class
---

# AspNetStop class

The event type class for the **End** event.
...
``` syntax
[dynamic, EventType(2), EventLevel(0), EventTypeName("End")]
...
The **AspNetStop** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetStop** class has these properties.
