---
Description: 'The event type class for the PageLoadPostDataLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '7d4779e0-15cf-40a6-80a0-f8ff8e91ef2a'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPageLoadPostDataLeave class
---
