---
Description: The event type class for the DiagnosticTraceStop event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 9334e6ec-52a7-45ce-a40d-178dc02ff1ac
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetModuleDiagStopEvent class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetModuleDiagStopEvent class

The event type class for the **DiagnosticTraceStop** event.
...
``` syntax
[dynamic, EventType(67), EventLevel(5), EventVersion(0), EventTypeName("DiagnosticTraceStop")]
...
The **AspNetModuleDiagStopEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagStopEvent** class has these properties.
