...
The event type class for the **RoleManagerIsUserInRole** event.
...
``` syntax
[dynamic, EventType(46), EventLevel(4), EventTypeName("RoleManagerIsUserInRole")]
...
The **AspNetRoleManagerIsUserInRole** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetRoleManagerIsUserInRole** class has these properties.
