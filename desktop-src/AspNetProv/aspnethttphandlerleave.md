---
Description: 'The event type class for the HttpHandlerLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '5efa6fed-f88f-47e0-9fa6-7ebfeedecacc'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetHttpHandlerLeave class
---

# AspNetHttpHandlerLeave class

The event type class for the **HttpHandlerLeave** event.
...
``` syntax
[dynamic, EventType(19), EventLevel(4), EventTypeName("HttpHandlerLeave")]
...
The **AspNetHttpHandlerLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetHttpHandlerLeave** class has these properties.
