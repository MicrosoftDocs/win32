...
The event type class for the **PageRaisePostbackEnter** event.
...
``` syntax
[dynamic, EventType(34), EventLevel(5), EventTypeName("PageRaisePostbackEnter")]
...
The **AspNetPageRaisePostbackEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageRaisePostbackEnter** class has these properties.
