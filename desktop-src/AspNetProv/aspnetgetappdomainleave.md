---
Description: The event type class for the GetAppDomainLeave event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 5636362d-43c6-4a74-a74e-5a900e542705
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetGetAppDomainLeave class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetGetAppDomainLeave class

The event type class for the **GetAppDomainLeave** event.
...
``` syntax
[dynamic, EventType(6), EventLevel(5), EventTypeName("GetAppDomainLeave")]
...
The **AspNetGetAppDomainLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetGetAppDomainLeave** class has these properties.
