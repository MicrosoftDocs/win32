---
Description: The event type class for the DiagnosticTraceCritical event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: cf477b03-350c-41ce-99cb-3c483342a849
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetModuleDiagCriticalEvent class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# AspNetModuleDiagCriticalEvent class

The event type class for the **DiagnosticTraceCritical** event.
...
``` syntax
[dynamic, EventType(61), EventLevel(1), EventVersion(0), EventTypeName("DiagnosticTraceCritical")]
...
The **AspNetModuleDiagCriticalEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagCriticalEvent** class has these properties.
