...
The event type class for the **AppDomainEnter** event.
...
``` syntax
[dynamic, EventType(7), EventLevel(5), EventTypeName("AppDomainEnter")]
...
The **AspNetAppDomainEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetAppDomainEnter** class has these properties.
