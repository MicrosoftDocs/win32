...
The parent class from which all Base Error Event trace classes are derived.
...
``` syntax
[Dynamic, EventType(76), EventLevel(3), EventVersion(1), EventTypeName("BaseErrorEvent")]
...
The **BaseErrorEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **BaseErrorEvent** class has these properties.
