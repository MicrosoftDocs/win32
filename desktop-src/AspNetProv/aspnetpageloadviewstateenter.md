---
Description: 'The event type class for the PageLoadViewstateEnter event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'c9539aeb-8de8-4ed1-a430-792cde07f482'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPageLoadViewstateEnter class
---

# AspNetPageLoadViewstateEnter class

The event type class for the **PageLoadViewstateEnter** event.
...
``` syntax
[dynamic, EventType(26), EventLevel(5), EventTypeName("PageLoadViewstateEnter")]
...
The **AspNetPageLoadViewstateEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageLoadViewstateEnter** class has these properties.
