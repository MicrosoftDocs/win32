---
Description: 'The event type class for the HttpHandlerEnter event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '4e9dc844-78c8-4a28-9936-dba55f28855e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetHttpHandlerEnter class
---

# AspNetHttpHandlerEnter class

The event type class for the **HttpHandlerEnter** event.
...
``` syntax
[dynamic, EventType(18), EventLevel(4), EventTypeName("HttpHandlerEnter")]
...
The **AspNetHttpHandlerEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetHttpHandlerEnter** class has these properties.
