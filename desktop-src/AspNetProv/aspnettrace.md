...
ms.assetid: f9555cf5-ae47-4d95-b5f6-15a6b5035677
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetTrace class
ms.date: 05/31/2018
ms.topic: article
...
The **AspNetTrace** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetTrace** class has these properties.
