---
Description: The event type class for the DiagnosticTraceSuspend event.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 976d0f36-61b2-4615-bea7-80080651fc41
ms.prod: windows-server-dev
ms.technology:
- asp.net
- windows-management-instrumentation
ms.tgt_platform: multiple
title: AspNetModuleDiagSuspendEvent class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AspNetModuleDiagSuspendEvent class

The event type class for the **DiagnosticTraceSuspend** event.
...
``` syntax
[dynamic, EventType(68), EventLevel(5), EventVersion(0), EventTypeName("DiagnosticTraceSuspend")]
...
The **AspNetModuleDiagSuspendEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetModuleDiagSuspendEvent** class has these properties.
