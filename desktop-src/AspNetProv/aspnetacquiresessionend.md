---
Description: 'The event type class for the SessionDataEnd event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'ec47eee7-f253-4900-9e50-7464a241d905'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetAcquireSessionEnd class
---

# AspNetAcquireSessionEnd class

The event type class for the **SessionDataEnd** event.
...
``` syntax
[dynamic, EventType(43), EventLevel(4), EventTypeName("SessionDataEnd")]
...
The **AspNetAcquireSessionEnd** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetAcquireSessionEnd** class has these properties.
