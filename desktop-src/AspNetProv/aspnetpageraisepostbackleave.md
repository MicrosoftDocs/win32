---
Description: 'The event type class for the PageRaisePostbackLeave event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'c7991b5d-b36c-402b-a915-e57f874342e6'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetPageRaisePostbackLeave class
---

# AspNetPageRaisePostbackLeave class

The event type class for the **PageRaisePostbackLeave** event.
...
``` syntax
[dynamic, EventType(35), EventLevel(5), EventTypeName("PageRaisePostbackLeave")]
...
The **AspNetPageRaisePostbackLeave** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPageRaisePostbackLeave** class has these properties.
