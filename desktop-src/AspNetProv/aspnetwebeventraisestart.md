...
The event type class for the **WebEventRaiseStart** event.
...
``` syntax
[dynamic, EventType(50), EventLevel(5), EventTypeName("WebEventRaiseStart")]
...
The **AspNetWebEventRaiseStart** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetWebEventRaiseStart** class has these properties.
...
The name of the class that raised the event
