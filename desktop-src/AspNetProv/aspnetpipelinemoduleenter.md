...
The event type class for the **PipelineModuleEnter** event.
...
``` syntax
[dynamic, EventType(10), EventLevel(5), EventTypeName("PipelineModuleEnter")]
...
The **AspNetPipelineModuleEnter** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetPipelineModuleEnter** class has these properties.
