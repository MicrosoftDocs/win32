---
Description: 'The event type class for the SessionStatePartitionStart event.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '73787b28-0efa-4e2e-9854-4570fa72f2af'
ms.prod: 'windows-server-dev'
ms.technology:
- 'asp.net'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: AspNetSessionStatePartitionStart class
---

# AspNetSessionStatePartitionStart class

The event type class for the **SessionStatePartitionStart** event.
...
``` syntax
[dynamic, EventType(20), EventLevel(5), EventTypeName("SessionStatePartitionStart")]
...
The **AspNetSessionStatePartitionStart** class has these types of members:

-   [Properties](#properties)

### Properties

The **AspNetSessionStatePartitionStart** class has these properties.
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (8), **Max** (16)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (1)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (3)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (11)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (9)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (14), **Pointer**
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (15)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (12), **Max** (16)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (13)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (2)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (6), **Pointer**
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (7)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (4)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (5)
</dt> </dl>
...
Qualifiers: [**WmiDataId**](etw.event_tracing_mof_qualifiers) (10)
</dt> </dl>
