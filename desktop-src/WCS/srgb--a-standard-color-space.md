...
When no input color space is specified, by default WCS 1.0 uses the sRGB color space as the input color space for [color mapping](c.md#-color-wcs-1-0-glossary-color-mapping-gloss).
