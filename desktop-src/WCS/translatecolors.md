...
The **TranslateColors** function translates an array of colors from the source [color space](c.md#-color-wcs-1-0-glossary-color-space-gloss) to the destination color space as defined by a color transform.
