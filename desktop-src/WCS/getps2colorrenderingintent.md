...
The **GetPS2ColorRenderingIntent** function retrieves the PostScript Level 2 color [rendering intent](r.md#-color-wcs-1-0-glossary-rendering-intent-gloss) from an ICC color profile.
