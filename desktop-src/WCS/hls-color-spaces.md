...
HLS [color spaces](https://www.bing.com/search?q=color spaces) are also widely used by artists. Its color components are hue, lightness, and saturation (chroma).
...
[Saturation](https://www.bing.com/search?q=Saturation) in the HLS model is a measure of the "purity" of a hue. As saturation is decreased, the hue becomes more gray. A saturation value of zero results in a gray-scale value.
