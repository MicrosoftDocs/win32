...
HLS [color spaces](c.md#-color-wcs-1-0-glossary-color-space-gloss) are also widely used by artists. Its color components are hue, lightness, and saturation (chroma).
...
[Saturation](s.md#-color-wcs-1-0-glossary-saturation-gloss) in the HLS model is a measure of the "purity" of a hue. As saturation is decreased, the hue becomes more gray. A saturation value of zero results in a gray-scale value.
