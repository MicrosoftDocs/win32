...
The **CreateMultiProfileTransform** function accepts an array of profiles or a single [device link profile](https://www.bing.com/search?q=device link profile) and creates a color transform that applications can use to perform color mapping.
