...
keywords: ["CheckColors function Windows Color System"]
topic_type:
- apiref
api_name:
- CheckColors
...
The **CheckColors** function determines whether the colors in an array lie within the output [gamut](g.md#-color-wcs-1-0-glossary-gamut-gloss) of a specified transform.
...
Pointer to an array of *nColors* [**COLOR**](color.md#-color-the-color-structure) structures to translate.
