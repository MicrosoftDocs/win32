...
The CMY and CMYK [color spaces](c.md#-color-wcs-1-0-glossary-color-space-gloss) are often used in color printing. A CMY color space uses cyan, magenta, and yellow (CMY) as its [primary colors](p.md#-color-wcs-1-0-glossary-primary-colors-gloss). Red, green, and blue are the secondary colors.
