...
The CMY and CMYK [color spaces](https://www.bing.com/search?q=color spaces) are often used in color printing. A CMY color space uses cyan, magenta, and yellow (CMY) as its [primary colors](https://www.bing.com/search?q=primary colors). Red, green, and blue are the secondary colors.
