...
The **SetupColorMatching** function creates a Color Management dialog box that lets the user choose whether to enable color management, and if so, provides control over the color profiles used and over the [rendering intent](r.md#-color-wcs-1-0-glossary-rendering-intent-gloss).
