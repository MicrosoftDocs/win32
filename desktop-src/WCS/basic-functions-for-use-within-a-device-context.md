...
The following WCS functions deliver basic [color mapping](https://www.bing.com/search?q=color mapping) capabilities within device contexts. They are useful to all applications that need to implement color management with low overhead and minimal user intervention.
