...
The **CreateProfileFromLogColorSpace** function converts a logical [color space](https://www.bing.com/search?q=color space) to a [device profile](https://www.bing.com/search?q=device profile).
