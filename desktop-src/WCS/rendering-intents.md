...
Called perceptual intent in the ICC specification clause 4.9, a Picture intent causes the full [gamut](https://www.bing.com/search?q=gamut) of the image to be compressed or expanded to fill the gamut of the destination device, so that gray balance is preserved but colorimetric accuracy may not be preserved.
...
The ICC specification clause 4.12 calls the Graphic intent a [saturation](https://www.bing.com/search?q=saturation) intent. It preserves the chroma of colors in the image at the possible expense of [hue](https://www.bing.com/search?q=hue) and [lightness](https://www.bing.com/search?q=lightness).
...
Proof intent does not preserve the [white point](https://www.bing.com/search?q=white point).
...
For example, the whitest white of a paper is more yellow than the whitest white of a computer monitor. An image converted into the [gamut](https://www.bing.com/search?q=gamut) of the printer using match intent would result in all colors being converted and matched into the gamut of the printer. The white point of the image is not moved to match the white point of the printer. Therefore, the distance of the colors to the white point may change. This produces an image that is less visually disconcerting to the user, but is also a less accurate rendition of printer output.
