...
The **SetStandardColorSpaceProfile** function registers a specified profile for a given standard [color space](https://www.bing.com/search?q=color space). The profile can be queried using [**GetStandardColorSpaceProfile**](getstandardcolorspaceprofile.md).
