...
Like most [color spaces](https://www.bing.com/search?q=color spaces), the RGB color space is normalized. That is, all color values are restricted to the range of zero to one inclusive. So black is (0.0, 0.0, 0.0), and white is (1.0, 1.0, 1.0).

In the RGB color space, the [primary colors](https://www.bing.com/search?q=primary colors) are red, green, and blue. The secondary colors are cyan, yellow, and magenta.
