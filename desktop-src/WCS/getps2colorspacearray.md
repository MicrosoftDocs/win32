...
keywords: ["GetPS2ColorSpaceArray function Windows Color System"]
topic_type:
- apiref
api_name:
...
The **GetPS2ColorSpaceArray** function retrieves the PostScript Level 2 [color space](c.md#-color-wcs-1-0-glossary-color-space-gloss) array from an ICC color profile.
