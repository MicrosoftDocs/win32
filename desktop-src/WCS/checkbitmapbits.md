...
The **CheckBitmapBits** function checks whether the pixels in a specified bitmap lie within the output [gamut](g.md#-color-wcs-1-0-glossary-gamut-gloss) of a specified transform.
