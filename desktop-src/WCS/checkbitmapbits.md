...
The **CheckBitmapBits** function checks whether the pixels in a specified bitmap lie within the output [gamut](https://www.bing.com/search?q=gamut) of a specified transform.
