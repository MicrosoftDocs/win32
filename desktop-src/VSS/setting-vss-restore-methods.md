...
These specifications, referred to either as [*restore methods*](https://www.bing.com/search?q=*restore methods*) or original [*restore targets*](https://www.bing.com/search?q=*restore targets*), can be modified during restore by writers setting new restore targets or by requesters restoring to new locations (see [Non-Default Backup and Restore Locations](non-default-backup-and-restore-locations.md)).
