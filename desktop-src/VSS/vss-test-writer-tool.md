...
This example will cause the writer to fail during the [*Freeze*](vssgloss-f.md#base-vssgloss-freeze) event. [**IVssBackupComponents::GatherWriterStatus**](/windows/desktop/api/VsBackup/nf-vsbackup-ivssbackupcomponents-gatherwriterstatus) will report the writer failure to be VSS\_E\_WRITERERROR\_NONRETRYABLE.
