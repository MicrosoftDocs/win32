...
title: N (Volume Shadow Copy Service)
ms.topic: glossary
ms.date: 05/31/2018
---
...
A path that only a requester can specify if it requires a file to be restored to a new location. This should not be confused with alternate location mapping. See also [*alternate location mapping*](vssgloss-a.md).
