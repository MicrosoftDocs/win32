...
For an introduction to VSS for system administrators, see [Volume Shadow Copy Service](https://go.microsoft.com/fwlink/p/?linkid=182657) in the TechNet Library.
...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Windows Vista and later            | VSS is available in the Microsoft Windows Software Development Kit (SDK). You can install the SDK for Windows 7 and Windows Server 2008 R2 from the [Windows Download Center](https://go.microsoft.com/fwlink/p/?linkid=139812). You can also download the [ISO version](https://go.microsoft.com/fwlink/p/?linkid=160664) of the SDK from the Windows Download Center. Previous versions of the SDK can be downloaded from the [Windows SDK Download Page](https://go.microsoft.com/fwlink/p/?linkid=133546). |
| Windows Server 2003 and Windows XP | VSS is available in the Volume Shadow Copy Service 7.2 SDK, which you can download from the [Windows Download Center](https://go.microsoft.com/fwlink/p/?linkid=84081). Note that the 64-bit vssapi.lib files in the directories under the Win2003\\Obj directory can be used for the 64-bit versions of Windows Server 2003 and Windows XP.                                                                                                                                                                 |
