...
3.  Import the shadow copy using the [**IVssBackupComponents::ImportSnapshots**](ivssbackupcomponents-importsnapshots.md) method.
4.  Break the shadow copy using the [**IVssBackupComponents::BreakSnapshotSet**](ivssbackupcomponents-breaksnapshotset.md) method.
