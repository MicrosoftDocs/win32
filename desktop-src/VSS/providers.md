...
[*Providers*](https://www.bing.com/search?q=*Providers*) manage running volumes and create the shadow copies of them on demand.
...
One shadow copy provider, the [*system provider*](https://www.bing.com/search?q=*system provider*), is supplied as a default part of a Windows operating system installation. Currently, the system provider is a particular instance of a software provider. However, this may change in the future.
