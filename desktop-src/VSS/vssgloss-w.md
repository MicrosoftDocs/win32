...
To support this coordination, a writer must implement an instance of a class derived from the abstract base class **CVssWriter** to communicate with the VSS infrastructure. See also [*shadow copy*](https://www.bing.com/search?q=*shadow copy*).
...
Once constructed, the Writer Metadata Document should be viewed as a read-only object. It can be saved to disk. See also [*Backup Components Document*](https://www.bing.com/search?q=*Backup Components Document*), [*explicit component inclusion*](https://www.bing.com/search?q=*explicit component inclusion*), [*implicit component inclusion*](https://www.bing.com/search?q=*implicit component inclusion*).
