...
Writers can fine-tune the performance of various types of backup at the [*file set*](vssgloss-f.md#base-vssgloss-file-set) level by indicating through a file specification backup type, indicated by a bit mask or bitwise OR of the members of the [**VSS\_FILE\_SPEC\_BACKUP\_TYPE**](vss-file-spec-backup-type.md) enumeration.
...
The values of [**VSS\_FILE\_SPEC\_BACKUP\_TYPE**](vss-file-spec-backup-type.md) that indicate shadow copy requirement are:
...
The values of [**VSS\_FILE\_SPEC\_BACKUP\_TYPE**](vss-file-spec-backup-type.md) that indicate the requirement to back up a file are:
