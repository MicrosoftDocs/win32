...
The capacity to implement backup operations by modifying subsections of the files involved, rather than working with the entire files. See also [*directed targeting*](vssgloss-d.md#base-vssgloss-directed-targeting).
...
A VSS event indicating that a shadow copy has been completed. See also [*shadow copy*](vssgloss-s.md#base-vssgloss-shadow-copy).
...
A VSS event indicating that writers should take steps to prepare for an upcoming shadow copy operation. See also [*shadow copy*](vssgloss-s.md#base-vssgloss-shadow-copy).
...
An operating system object that intercepts and manages I/O requests to create and represent volume shadow copies to the file system. See also [*hardware provider*](vssgloss-h.md#base-vssgloss-hardware-based-provider), [*software provider*](vssgloss-s.md#base-vssgloss-software-based-provider).
