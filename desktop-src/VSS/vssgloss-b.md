...
Indicates the point at which a writer is notified of a freeze by VSS. Writers that are initialized as back-end level applications are notified after writers initialized as front-end level applications and prior to those initialized as system-level applications. See also [*application level*](https://www.bing.com/search?q=*application level*), [*front-end level applications*](https://www.bing.com/search?q=*front-end level applications*), [*system-level applications*](https://www.bing.com/search?q=*system-level applications*), [*writer*](https://www.bing.com/search?q=*writer*).
...
A Backup Components Document can be saved to disk. See also [*explicit component inclusion*](https://www.bing.com/search?q=*explicit component inclusion*), [*implicit component inclusion*](https://www.bing.com/search?q=*implicit component inclusion*).
