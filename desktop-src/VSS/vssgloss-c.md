...
A group of files, defined by a writer, that must be handled as a unit during backup and restore operations. See also [*database component*](https://www.bing.com/search?q=*database component*), [*file group component*](https://www.bing.com/search?q=*file group component*).
...
A mode in which a backup or restore operation makes use of a writer's component information. See also [*selectable component*](https://www.bing.com/search?q=*selectable component*).
