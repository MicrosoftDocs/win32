...
-   Nonselectable-for-backup subcomponents are always [*included implicitly*](https://www.bing.com/search?q=*included implicitly*) in the backup. This means that metadata for these components is not part of the Backup Components Document.
