...
title: T (Volume Shadow Copy Service)
ms.topic: glossary
ms.date: 05/31/2018
---
...
A VSS event issued by VSS indicating that a shadow copy freeze has completed. It is used to remove a writer's preparations for a freeze. See also [*freeze*](vssgloss-f.md), [*shadow copy*](vssgloss-s.md).
...
A shadow copy that can be moved from one system to another. Typically, a transportable shadow copy is not surfaced locally. See also [*surfaced shadow copy*](vssgloss-s.md).
