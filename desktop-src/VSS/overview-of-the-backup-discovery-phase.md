...
Because the [**IVssWMFiledesc**](/windows/desktop/api/VsWriter/nl-vswriter-ivsswmfiledesc) object can use wildcard characters to hold file location information, it may be necessary to use functions such as [**FindFirstFile**](https://msdn.microsoft.com/en-us/library/Aa364418(v=VS.85).aspx), [**FindFirstFileEx**](https://msdn.microsoft.com/en-us/library/Aa364419(v=VS.85).aspx), and [**FindNextFile**](https://msdn.microsoft.com/en-us/library/Aa364428(v=VS.85).aspx).
