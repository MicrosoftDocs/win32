...
These documents, the [*Writer Metadata Document*](https://www.bing.com/search?q=*Writer Metadata Document*) and the [*Backup Components Document*](https://www.bing.com/search?q=*Backup Components Document*), respectively, are used as the basis for writer and requester communication and coordination during backup and restore activities.
