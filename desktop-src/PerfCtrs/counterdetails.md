...
-   **CounterType:** The counter type. For a list of counter types and their formulas, see the Counter Types section of the [Windows Server 2003 Deployment Kit](Http://go.microsoft.com/fwlink/p/?linkid=84422).
