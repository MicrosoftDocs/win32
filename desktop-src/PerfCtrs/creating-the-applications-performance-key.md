...
For additional registry values that you can create, such as specifying time out values for the [**OpenPerformanceData**](openperformancedata.md) and [**CollectPerformanceData**](collectperformancedata.md) functions, see [Creating Other Registry Entries](creating-other-registry-entries.md).
