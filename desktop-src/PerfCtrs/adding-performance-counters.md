...
To view a performance object, its functions, and its counters, use the [extensible counter list utility](/previous-versions/windows/it-pro/windows-server-2003/cc737958(v=ws.10)) (Exctrlst.exe). The utility is included with the Support Tools for Windows Server 2003 and Windows XP.
