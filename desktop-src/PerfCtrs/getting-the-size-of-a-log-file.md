...
[**PdhGetLogFileSize**](/windows/win32/Pdh/nf-pdh-pdhgetlogfilesize?branch=master) returns the size, in bytes, of the specified log file. Use this function when you need to allocate memory for a buffer that will receive the contents of the log file.
