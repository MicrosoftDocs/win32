...
keywords: ["GetRecordCount method", "GetRecordCount method, Win32_ReliabilityStabilityMetrics class", "Win32_ReliabilityStabilityMetrics class, GetRecordCount method"]
topic_type:
- apiref
api_name:
