...
``` syntax
[UMLPackagePath("CIM::Interop"), Indication, dynamic, provider("MsDtcWmi_EventProvider"), Version("2.22.1"), AMENDMENT]
class CIM_Error
{
  uint16 ErrorType;
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_Error.Message", "CIM\_Error.MessageArguments")
</dt> </dl>
...
A string that defines the **ErrorSourceFormat** value when **ErrorSourceFormat** is set to **Other** (1).
...
A free-form string that describes the **ErrorType** value when it is set to **Other** (1).
...
A free-form string that describes the probable cause of the error, when the **ProbableCause** property is set to **Other** (1).
