...
|------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| [**IPortableDeviceDispatchFactory**](/windows/desktop/api/PortableDeviceApi/nn-portabledeviceapi-iportabledevicedispatchfactory) | Represents a factory that can instantiate a WPD Automation **Device** object. |
