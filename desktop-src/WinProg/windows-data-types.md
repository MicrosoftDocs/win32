...
<td>A handle to an [accelerator table](_win32_keyboard_accelerators_cpp).<br/> This type is declared in WinDef.h as follows:<br/> <code>typedef HANDLE HACCEL;</code><br/></td>
</tr>
<tr class="even">
...
<td><p>A handle to a [color space](_color_color_spaces).</p>
<p>This type is declared in WinDef.h as follows:</p>
...
<td><p>A handle to a [cursor](_win32_cursors_cpp).</p>
<p>This type is declared in WinDef.h as follows:</p>
...
<td><p>A handle to a [menu](_win32_menus_cpp).</p>
<p>This type is declared in WinDef.h as follows:</p>
...
<td><p>The return codes used by COM interfaces. For more information, see [Structure of the COM Error Codes](_com_Structure_of_COM_Error_Codes). To test an <strong>HRESULT</strong> value, use the [<strong>FAILED</strong>](_com_FAILED) and [<strong>SUCCEEDED</strong>](_com_SUCCEEDED) macros.</p>
<p>This type is declared in WinNT.h as follows:</p>
...
<td><p>A handle to a [window](_win32_windows_cpp).</p>
<p>This type is declared in WinDef.h as follows:</p>
