...
Some functions have generic return types or parameters. For example, the [**SendMessage**](_win32_sendmessage_cpp) function returns data that may be any number of types, depending on the context. When you see any of these functions in your source code, make sure that you use the correct type cast and that it is as specific as possible. The following list is an example of these functions.
