...
The **Win32\_NetworkAdapterSetting** association [WMI class](wmi.retrieving_a_class) relates a network adapter and its configuration settings.
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("Element"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_NetworkAdapter")
</dt> </dl>
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("Setting"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_NetworkAdapterConfiguration")
</dt> </dl>
...
For information on how to use association classes, see [ASSOCIATORS OF Statement](wmi.associators_of_statement).
