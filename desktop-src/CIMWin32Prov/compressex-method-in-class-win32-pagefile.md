...
title: CompressEx method of the Win32\_PageFile class
ms.date: 05/31/2018
ms.topic: article
...
The **CompressEx** [WMI class](https://msdn.microsoft.com/library/aa393244) method compresses the logical paging file (or directory) specified in the object path (this method is an extended version of the [**Compress**](compress-method-in-class-win32-directory.md) method).
