...
The **SetDNSSuffixSearchOrder** [WMI class](https://msdn.microsoft.com/library/aa393244) static method uses an array of string elements to set the suffix search order.
