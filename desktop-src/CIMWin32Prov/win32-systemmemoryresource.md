...
The **Win32\_SystemMemoryResource** abstract [WMI class](wmi.retrieving_a_class) represents a system memory resource on a computer system running Windows.
...
Qualifiers: [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**MappingStrings**](wmi.standard_qualifiers) ("MIF.DMTF\|Memory Mapped I/O\|001.1")
</dt> </dl>
