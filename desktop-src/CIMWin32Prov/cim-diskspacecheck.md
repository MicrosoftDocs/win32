...
The **CIM\_DiskSpaceCheck** class has these types of members:
...
The **CIM\_DiskSpaceCheck** class has these methods.



| Method                                                      | Description                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-diskspacecheck.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_DiskSpaceCheck** class has these properties.
...
Qualifiers: [**ModelCorrespondence**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM\_FileSystem**](cim-filesystem.md).**AvailableSpace** "), [**units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("kilobytes")
</dt> </dl>
