...
The **Win32\_USBController** [WMI class](https://msdn.microsoft.com/en-us/library/Aa393244(v=VS.85).aspx) manages the capabilities of a universal serial bus (USB) controller.
