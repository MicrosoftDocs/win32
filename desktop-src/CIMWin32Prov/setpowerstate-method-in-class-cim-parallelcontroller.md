---
description: SetPowerState method of the CIM_ParallelController class - The SetPowerState method sets the desired power state for a logical device and when a device should be put into that state.
ms.assetid: 1bb89be1-f5bb-40a3-9e78-fbb069d38a17
ms.tgt_platform: multiple
title: SetPowerState method of the CIM_ParallelController class
ms.topic: reference
ms.date: 05/31/2018
topic_type: 
- APIRef
...
# SetPowerState method of the CIM\_ParallelController class
...
[CIM\_ParallelController](setpowerstate-method-in-class-cim-parallelcontroller.md)
</dt> <dt>
