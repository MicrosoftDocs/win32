...
title: RenewDHCPLeaseAll method of the Win32\_NetworkAdapterConfiguration class
...
The **RenewDHCPLeaseAll** [WMI class](https://msdn.microsoft.com/library/aa393244) static method renews the IP addresses on all DHCP-enabled network adapters.
