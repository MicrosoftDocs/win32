...
title: SetDNSServerSearchOrder method of the Win32\_NetworkAdapterConfiguration class
...
The **SetDNSServerSearchOrder** [WMI class](https://msdn.microsoft.com/library/aa393244) method uses an array of string elements to set the server search order.
