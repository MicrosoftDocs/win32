---
Description: The CIM\_ManagementController class relates to the capabilities and management of a management controller.
audience: developer
...
title: CIM\_ManagementController class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# CIM\_ManagementController class

The **CIM\_ManagementController** class relates to the capabilities and management of a management controller.
...
The **CIM\_ManagementController** class has these types of members:
...
The **CIM\_ManagementController** class has these methods.



| Method                                                                          | Description                                                                                                                              |
|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-managementcontroller.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-managementcontroller.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_ManagementController** class has these properties.
...
The **CIM\_ManagementController** class is derived from [**CIM\_Controller**](cim-controller.md).
