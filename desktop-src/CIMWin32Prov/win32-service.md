...
The **Win32\_Service** [WMI class](wmi.retrieving_a_class) represents a service on a computer system running Windows.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS**](base.service_status_str)\|dwControlsAccepted\|SERVICE\_ACCEPT\_PAUSE\_CONTINUE"), [**DisplayName**](wmi.standard_qualifiers) ("Service Accepts Pause")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS**](base.service_status_str)\|dwControlsAccepted\|SERVICE\_ACCEPT\_STOP"), [**DisplayName**](wmi.standard_qualifiers) ("Service Accepts Stop")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS**](base.service_status_str)\|dwCheckPoint"), [**DisplayName**](wmi.standard_qualifiers) ("Check Point Count")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_DELAYED\_AUTO\_START\_INFO**](base.service_delayed_auto_start_info)\|fDelayedAutostart"), [**DisplayName**](wmi.standard_qualifiers) ("Delayed Auto-Start")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**QUERY\_SERVICE\_CONFIG**](base.query_service_config_str)\|dwServiceType\|SERVICE\_INTERACTIVE\_PROCESS"), [**DisplayName**](wmi.standard_qualifiers) ("Interacts With Desktop")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**QUERY\_SERVICE\_CONFIG**](base.query_service_config_str)\|lpDisplayName"), [**DisplayName**](wmi.standard_qualifiers) ("Display Name")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**QUERY\_SERVICE\_CONFIG**](base.query_service_config_str)\|dwErrorControl"), [**DisplayName**](wmi.standard_qualifiers) ("Severity Of Startup Failure")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS**](base.service_status_str)\|dwWin32ExitCode"), [**DisplayName**](wmi.standard_qualifiers) ("Exit Code")
</dt> </dl>
...
Qualifiers: [**Key**](wmi.key_qualifier)
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**QUERY\_SERVICE\_CONFIG**](base.query_service_config_str)\|lpBinaryPathName"), [**DisplayName**](wmi.standard_qualifiers) ("File Path Name")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS\_PROCESS**](base.service_status_process_str)\|dwProcessId"), [**DisplayName**](wmi.standard_qualifiers) ("Process Id")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS**](base.service_status_str)\|dwServiceSpecificExitCode"), [**DisplayName**](wmi.standard_qualifiers) ("Server Specific Exit Code")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**QUERY\_SERVICE\_CONFIG**](base.query_service_config_str)\|dwServiceType"), [**DisplayName**](wmi.standard_qualifiers) ("Service Type")
</dt> </dl>
...
Qualifiers: [**DisplayName**](wmi.standard_qualifiers) ("Started")
</dt> </dl>
...
Qualifiers: [**DisplayName**](wmi.standard_qualifiers) ("Start Mode")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**QUERY\_SERVICE\_CONFIG**](base.query_service_config_str)\|lpServiceStartName"), [**DisplayName**](wmi.standard_qualifiers) ("Starting Account Name")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS**](base.service_status_str)\|dwCurrentState "), [**DisplayName**](wmi.standard_qualifiers) ("State")
</dt> </dl>
...
Qualifiers: [**Propagated**](wmi.standard_qualifiers) ("[**CIM\_System**](cim-system.md).**CreationClassName**"), [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**DisplayName**](wmi.standard_qualifiers) ("System Class Name")
</dt> </dl>
...
Qualifiers: [**Propagated**](wmi.standard_qualifiers) ("[**CIM\_System**](cim-system.md).**Name**"), [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**DisplayName**](wmi.standard_qualifiers) ("System Name")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**QUERY\_SERVICE\_CONFIG**](base.query_service_config_str)\|dwTagId"), [**DisplayName**](wmi.standard_qualifiers) ("Tag Id")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Service Structures\|[**SERVICE\_STATUS**](base.service_status_str)\|dwWaitHint"), [**DisplayName**](wmi.standard_qualifiers) ("Estimated Wait Time")
</dt> </dl>
...
A user connecting from a remote computer must have the **SC\_MANAGER\_CONNECT** privilege enabled to be able to enumerate this class. For more information, see [Service Security and Access Rights](base.service_security_and_access_rights).
...
[WMI Tasks: Services](wmi.wmi_tasks__services)
</dt> </dl>
