...
The **Win32\_StartupCommand** [WMI class](wmi.retrieving_a_class) represents a command that runs automatically when a user logs onto the computer system.
...
Qualifiers: [**key**](wmi.key_qualifier), [**MappingStrings**](wmi.standard_qualifiers) ("Win32Registry\|SOFTWARE\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Run")
</dt> </dl>
...
Qualifiers: [**key**](wmi.key_qualifier), [**MappingStrings**](wmi.standard_qualifiers) ("Win32Registry\|\\\\SOFTWARE\\\\MICROSOFT\\\\WINDOWS\\\\CURRENTVERSION\\\\Windows")
</dt> </dl>
...
Qualifiers: [**key**](wmi.key_qualifier), [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|File Structures\|[**WIN32\_FIND\_DATA**](fs.win32_find_data_str)\|cFileName")
</dt> </dl>
...
Qualifiers: [**key**](wmi.key_qualifier), [**MappingStrings**](wmi.standard_qualifiers) ("WMI")
</dt> </dl>
...
The calling process that uses this class must have the **SE\_RESTORE\_NAME** privilege on the computer in which the registry resides. For example, if you enumerate this class on the local computer, the account under which your application runs must have this privilege. For more information, see [Executing Privileged Operations](wmi.executing_privileged_operations).

You can change the registry values where **Win32\_StartupCommand** obtains data by calling the WMI [System Registry Provider](regprov.system_registry_provider) methods in script or in C++. For more information, see [Modifying the System Registry](wmi.modifying_the_system_registry).
