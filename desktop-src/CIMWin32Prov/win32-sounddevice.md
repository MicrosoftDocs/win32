...
The **Win32\_SoundDevice** [WMI class](wmi.retrieving_a_class) represents the properties of a sound device on a computer system running Windows.
...
The **Win32\_SoundDevice** class has these types of members:
...
The **Win32\_SoundDevice** class has these methods.



| Method            | Description                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Not implemented. To implement this method, see the [**Reset**](reset-method-in-class-cim-controller.md) method in [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                 |
| **SetPowerState** | Not implemented. To implement this method, see the [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) method in [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
...
The **Win32\_SoundDevice** class has these properties.
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("DeviceId"), [**Key**](wmi.key_qualifier), [**MaxLen**](wmi.standard_qualifiers) (260), [**MappingStrings**](wmi.standard_qualifiers) ("Win32Registry\|SYSTEM\\\\CurrentControlSet\\\\control\\\\MediaResources\\\\wave\|DeviceID")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Multimedia Structures\|[**WAVEOUTCAPS**](multimedia.waveoutcaps)\|szPname")
</dt> </dl>
...
The **Win32\_SoundDevice** class is derived from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
