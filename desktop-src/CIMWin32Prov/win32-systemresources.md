...
The **Win32\_SystemResources** association [WMI class](wmi.retrieving_a_class) relates a system resource and the computer system it resides on.
...
Qualifiers: [**key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("PartComponent"), [**MappingStrings**](wmi.standard_qualifiers) ("CIM\|CIM\_SystemResource")
</dt> </dl>
