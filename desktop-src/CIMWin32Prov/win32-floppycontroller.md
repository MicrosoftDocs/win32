...
The **Win32\_FloppyController** [WMI class](https://docs.microsoft.com/windows/desktop/WmiSdk/retrieving-a-class) represents the capabilities and management capacity of a floppy disk drive controller.
...
The **Win32\_FloppyController** class has these types of members:
...
The **Win32\_FloppyController** class has these methods.
...
The **Win32\_FloppyController** class has these properties.
...
Maximum number of directly addressable entities that this controller supports. A value of 0 (zero) should be used if the number is unknown.
...
The **Win32\_FloppyController** class is derived from [**CIM\_Controller**](cim-controller.md) which derives from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
