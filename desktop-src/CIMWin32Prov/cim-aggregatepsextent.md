...
title: CIM\_AggregatePSExtent class
ms.date: 05/31/2018
ms.topic: article
...
The **CIM\_AggregatePSExtent** class has these types of members:
...
The **CIM\_AggregatePSExtent** class has these methods.



| Method                                                                       | Description                                                                                                                                |
|:-----------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-aggregatepsextent.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepsextent.md) | Defines the desired power state for a logical device and when the device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_AggregatePSExtent** class has these properties.
...
The **CIM\_AggregatePSExtent** class is derived from [**CIM\_StorageExtent**](cim-storageextent.md).
