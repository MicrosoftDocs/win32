---
Description: The Win32\_ProgramGroupOrItem abstract WMI class represents a logical grouping of programs on the users Start\\Programs menu. It contains program groups and program group items.
audience: developer
...
The **Win32\_ProgramGroupOrItem** abstract [WMI class](wmi.retrieving_a_class) represents a logical grouping of programs on the user's **Start\\Programs** menu. It contains program groups and program group items.
