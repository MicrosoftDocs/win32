...
The **Win32\_Bus** [WMI class](https://msdn.microsoft.com/library/aa393244) represents a physical bus as seen by a computer running a Windows operating system. Any instance of a Windows bus is a descendant (or member) of this class.
...
The **Win32\_Bus** class has these types of members:
...
The **Win32\_Bus** class has these methods.



| Method            | Description                                                                                                                                                                                                      |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Not implemented. To implement this method, see the [**Reset**](reset-method-in-class-cim-controller.md) method in [**CIM\_LogicalDevice**](cim-logicaldevice.md) for documentation.<br/>                 |
| **SetPowerState** | Not implemented. To implement this method, see the [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) method in [**CIM\_LogicalDevice**](cim-logicaldevice.md) for documentation.<br/> |
...
The **Win32\_Bus** class has these properties.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("Win32API\|cHwRes\|INTERFACE\_TYPE")
</dt> </dl>

Type of the physical bus. This value will be one of the values in the **INTERFACE\_TYPE** enumeration defined in Bus.h.
...
Unique name that identifies the bus.
...
The **Win32\_Bus** class is derived from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
