---
Description: The SetPowerState method of the CIM\_Display class sets the desired power state for a logical device and when a device should be put into that state.
audience: developer
...
title: SetPowerState method of the CIM\_Display class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# SetPowerState method of the CIM\_Display class
...
[CIM\_Display](setpowerstate-method-in-class-cim-display.md)
</dt> <dt>
