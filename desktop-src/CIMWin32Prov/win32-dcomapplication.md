...
title: 'Win32\_DCOMApplication class'
---

# Win32\_DCOMApplication class

The **Win32\_DCOMApplication** [WMI class](https://msdn.microsoft.com/library/aa393244) represents the properties of a DCOM application.
...
The **Win32\_DCOMApplication** class has these types of members:

-   [Properties](#properties)

### Properties

The **Win32\_DCOMApplication** class has these properties.
...
The **Win32\_DCOMApplication** class is derived from [**Win32\_COMApplication**](win32-comapplication.md).
...
[**Win32\_COMApplication**](win32-comapplication.md)
</dt> <dt>
