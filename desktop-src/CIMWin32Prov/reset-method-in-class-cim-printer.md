...
title: Reset method of the CIM\_Printer class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# Reset method of the CIM\_Printer class

The **Reset** method of the CIM\_Printer class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_Printer](reset-method-in-class-cim-printer.md)
</dt> <dt>
