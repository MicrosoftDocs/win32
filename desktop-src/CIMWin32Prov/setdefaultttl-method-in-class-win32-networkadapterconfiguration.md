...
title: SetDefaultTTL method of the Win32\_NetworkAdapterConfiguration class
...
The **SetDefaultTTL** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to set the default Time to Live (TTL) value in the header of outgoing IP packets.
