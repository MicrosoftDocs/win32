...
The **Win32\_ShortcutFile** [WMI class](wmi.retrieving_a_class) represents files that are shortcuts to other files, directories, and commands.
...
Bitmask that represents the access rights required to access or perform specific operations on the file. For bit values, see [**File and Directory Access Rights Constants**](wmi.file_and_directory_access_rights_constants).
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|\_beginthreadex")
</dt> </dl>
