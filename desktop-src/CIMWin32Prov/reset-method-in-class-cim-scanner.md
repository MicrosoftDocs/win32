...
title: Reset method of the CIM\_Scanner class
...
# Reset method of the CIM\_Scanner class

The **Reset** method of the CIM\_Scanner class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_Scanner](reset-method-in-class-cim-scanner.md)
</dt> <dt>
