...
The **SetForwardBufferMemory** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to specify how much memory IP allocates to store packet data in the router packet queue.
