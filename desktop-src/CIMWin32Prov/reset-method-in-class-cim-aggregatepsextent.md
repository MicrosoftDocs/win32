...
title: Reset method of the CIM\_AggregatePSExtent class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Reset method of the CIM\_AggregatePSExtent class

The **Reset** method of the CIM\_AggregatePSExtent class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_AggregatePSExtent](reset-method-in-class-cim-aggregatepsextent.md)
</dt> <dt>
