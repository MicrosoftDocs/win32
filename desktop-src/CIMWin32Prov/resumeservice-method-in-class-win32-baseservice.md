...
title: ResumeService method of the Win32\_BaseService class
ms.date: 05/31/2018
ms.topic: article
...
The **ResumeService** [WMI class](https://msdn.microsoft.com/library/aa393244) method attempts to place the service in the resumed state.
