...
title: 'UserControlService method of the Win32\_BaseService class'
---

# UserControlService method of the Win32\_BaseService class

The [WMI class](https://msdn.microsoft.com/library/aa393244) method attempts to send a user-defined control code to a service.
