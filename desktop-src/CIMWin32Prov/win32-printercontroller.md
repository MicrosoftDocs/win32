...
title: Win32\_PrinterController class
ms.date: 05/31/2018
ms.topic: article
...
The **Win32\_PrinterController** association [WMI class](wmi.retrieving_a_class) relates a printer and the local device to which the printer is connected. Note that this class only returns instances for local printers.
