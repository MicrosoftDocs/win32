...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Functions\|[**CreateProcess**](base.createprocess)\|dwCreationFlags")
</dt> </dl>
...
The primary thread of the new process is created in a suspended state and does not run until the [**ResumeThread**](base.resumethread) method is called.
...
This new process is the root process of a new process group. The process group includes all of the processes that are descendants of this root process. The process identifier of the new process group is the same as the process identifier that is returned in the **ProcessID** property of the [**Win32\_Process**](win32-process.md) class. Process groups are used by the [**GenerateConsoleCtrlEvent**](base.generateconsolectrlevent) method to enable the sending of either a CTRL+C signal or a CTRL+BREAK signal to a group of console processes.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32Registry\|HKEY\_CURRENT\_USER\\\\Environment")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|dwFillAttribute")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**JOBOBJECT\_BASIC\_LIMIT\_INFORMATION**](base.jobobject_basic_limit_information_str)\|PriorityClass")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|wShowWindow")
</dt> </dl>
...
Sets the show state based on the **SW\_\*** value that is specified in the [**STARTUPINFO**](base.startupinfo_str) structure passed to the [**CreateProcess**](base.createprocess) function by the program that starts the application.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|lpTitle")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|lpDesktop")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|dwX")
</dt> </dl>

The X offset of the upper left corner of a window if a new window is created—in pixels. The offsets are from the upper left corner of the screen. For GUI processes, the specified position is used the first time the new process calls [**CreateWindow**](_win32_createwindow_cpp) to create an overlapped window if the *X* parameter of **CreateWindow** is **CW\_USEDEFAULT**.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|XCountChars")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|dwXSize")
</dt> </dl>

Pixel width of a window if a new window is created. For GUI processes, this is only used the first time the new process calls [**CreateWindow**](_win32_createwindow_cpp) to create an overlapped window if the nWidth parameter of **CreateWindow** is **CW\_USEDEFAULT**.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|dwY")
</dt> </dl>

Pixel offset of the upper-left corner of a window if a new window is created. The offsets are from the upper-left corner of the screen. For GUI processes, the specified position is used the first time the new process calls [**CreateWindow**](_win32_createwindow_cpp) to create an overlapped window if the *y* parameter of **CreateWindow** is **CW\_USEDEFAULT**.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|YCountChars")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**STARTUPINFO**](base.startupinfo_str)\|dwYSize")
</dt> </dl>

Pixel height of a window if a new window is created. For GUI processes, this is used only the first time the new process calls [**CreateWindow**](_win32_createwindow_cpp) to create an overlapped window if the *nWidth* parameter of **CreateWindow** is **CW\_USEDEFAULT**.
...
[**\_\_ProviderHostQuotaConfiguration**](wmi.__providerhostquotaconfiguration)
</dt> <dt>
