...
The **Win32\_SCSIControllerDevice** association [WMI class](wmi.retrieving_a_class) relates a small computer system interface (SCSI) controller and the logical device (disk drive) connected to it.
...
Qualifiers: [**Key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("Antecedent"), [**MappingStrings**](wmi.standard_qualifiers) ("CIM\|Win32\_SCSIController")
</dt> </dl>
