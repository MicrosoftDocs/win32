...
The **Pause** [WMI class](https://docs.microsoft.com/windows/desktop/WmiSdk/retrieving-a-class) method pauses the print queue. No jobs can print until the queue is resumed.
