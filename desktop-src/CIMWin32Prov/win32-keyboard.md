...
The **Win32\_Keyboard** [WMI class](https://docs.microsoft.com/windows/desktop/WmiSdk/retrieving-a-class) represents a keyboard installed on a computer system running Windows.
...
The **Win32\_Keyboard** class has these types of members:
...
The **Win32\_Keyboard** class has these methods.



| Method            | Description                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Not implemented. To implement this method, see the [**Reset**](reset-method-in-class-cim-controller.md) method in [**CIM\_Keyboard**](cim-keyboard.md) for documentation.<br/>                 |
| **SetPowerState** | Not implemented. To implement this method, see the [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) method in [**CIM\_Keyboard**](cim-keyboard.md) for documentation.<br/> |
...
The **Win32\_Keyboard** class has these properties.
...
Qualifiers: [**Override**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceId"), [**Key**](https://docs.microsoft.com/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
This property is inherited from [**CIM\_Keyboard**](cim-keyboard.md).
...
The following VBScript sample lists the keyboard properties.
