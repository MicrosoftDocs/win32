...
title: 'Reset method of the CIM\_FlatPanel class'
---

# Reset method of the CIM\_FlatPanel class

The **Reset** method of the CIM\_FlatPanel class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_FlatPanel](reset-method-in-class-cim-flatpanel.md)
</dt> <dt>
