...
title: CIM\_OSVersionCheck class
ms.date: 05/31/2018
ms.topic: article
...
The **CIM\_OSVersionCheck** class has these types of members:
...
The **CIM\_OSVersionCheck** class has these methods.



| Method                                                      | Description                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-osversioncheck.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_OSVersionCheck** class has these properties.
...
Qualifiers: [**maxlen**](https://msdn.microsoft.com/library/aa393650) (64), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**Version**")
</dt> </dl>
