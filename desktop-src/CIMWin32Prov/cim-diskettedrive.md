...
Array of free-form strings that provide detailed explanations for access device features indicated in the **Capabilities** array.
...
The **CIM\_DisketteDrive** class is derived from [**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).

WMI does not implement this class. For classes derived from **CIM\_DisketteDrive**, see [Win32 Classes](win32-provider.md).
