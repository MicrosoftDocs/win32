...
title: CIM\_MultiStateSensor class
...
The **CIM\_MultiStateSensor** class represents a multi-member set of binary sensors where each binary sensor reports a Boolean result.
...
The **CIM\_MultiStateSensor** class has these types of members:
...
The **CIM\_MultiStateSensor** class has these methods.



| Method                                                                      | Description                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-multistatesensor.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-multistatesensor.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_MultiStateSensor** class has these properties.
...
The **CIM\_MultiStateSensor** class is derived from [**CIM\_Sensor**](cim-sensor.md).
