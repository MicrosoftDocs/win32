...
The **CIM\_Keyboard** class has these types of members:
...
The **CIM\_Keyboard** class has these methods.



| Method                                                              | Description                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-keyboard.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-keyboard.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_Keyboard** class has these properties.
...
Free-form string that supplies information about the error recorded in the **LastErrorCode** property and corrective actions to take.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|System Hardware Security\|001.2")
</dt> </dl>
...
The **CIM\_Keyboard** class is derived from [**CIM\_UserDevice**](cim-userdevice.md).

WMI does not implement this class. For classes derived from **CIM\_Keyboard**, see [Win32 Classes](win32-provider.md).
