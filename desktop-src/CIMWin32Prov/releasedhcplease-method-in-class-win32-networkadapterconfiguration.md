...
title: ReleaseDHCPLease method of the Win32\_NetworkAdapterConfiguration class
...
# ReleaseDHCPLease method of the Win32\_NetworkAdapterConfiguration class

The **ReleaseDHCPLease** [WMI class](https://msdn.microsoft.com/library/aa393244) method releases the IP address bound to a specific DHCP-enabled network adapter.
