...
The **Win32\_MappedLogicalDisk** [WMI class](https://msdn.microsoft.com/library/aa393244) represents network storage devices that are mapped as logical disks on the computer system.
...
For more information on using **Win32\_MappedLogicalDisk**, see [How Can I Determine Which Drives are Mapped to Network Shares?](http://blogs.technet.com/b/heyscriptingguy/archive/2005/10/27/how-can-i-determine-which-drives-are-mapped-to-network-shares.aspx)
