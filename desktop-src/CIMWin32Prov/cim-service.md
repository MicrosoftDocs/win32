...
# CIM_Service class (CIMWin32 WMI Providers)
...
| Method                                                           | Description                                                                                 |
|:-----------------------------------------------------------------|:--------------------------------------------------------------------------------------------|
| [**StartService**](startservice-method-in-class-cim-service.md) | Attempts to put the service into its start-up state. Not implemented by WMI.<br/>     |
| [**StopService**](stopservice-method-in-class-cim-service.md)   | Class method that puts the service in the stopped state. Not implemented by WMI.<br/> |
...
The **CIM\_Service** class is derived from [**CIM\_LogicalDevice**](cim-logicaldevice.md).

WMI does not implement this class. For WMI classes that are derived from **CIM\_Service**, see [Win32 Classes](win32-provider.md).
