...
The **CIM\_ClusteringService** class represents the functionality provided by a cluster. For example, failover functionality can be modeled as a service of a failover cluster.
...
| Method                                                                     | Description                                                                                                |
|:---------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------|
| [**AddNode**](addnode-method-in-class-cim-clusteringservice.md)           | Class method that brings a new computer system into a cluster. Not implemented by WMI.<br/>          |
| [**EvictNode**](evictnode-method-in-class-cim-clusteringservice.md)       | Class method that removes a computer system from a cluster. Not implemented by WMI.<br/>             |
| [**StartService**](startservice-method-in-class-cim-clusteringservice.md) | Class method that attempts to place the service into its startup state. Not implemented by WMI.<br/> |
| [**StopService**](stopservice-method-in-class-cim-clusteringservice.md)   | Class method that places the service in the stopped state. Not implemented by WMI.<br/>              |
...
The **CIM\_ClusteringService** class is derived from [**CIM\_Service**](cim-service.md).
