...
The **Win32\_NetworkLoginProfile** [WMI class](wmi.retrieving_a_class) represents the network login information of a specific user on a computer system running Windows. This includes, but is not limited to password status, access privileges, disk quotas, and logon directory paths.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_acct\_expires")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_auth\_flags"), [**BitValues**](wmi.standard_qualifiers) ("Printer", "Communication", "Server", "Accounts")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Functions\|NetUserEnum")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_code\_page")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_comment")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_country\_code")
</dt> </dl>
...
The account is currently locked out. For [**NetUserSetInfo**](netmgmt.netusersetinfo), this value can be cleared to unlock a previously locked account. This value cannot be used to lock a previously unlocked account.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_full\_name")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_home\_dir")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_home\_dir\_drive")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_last\_logoff")
</dt> </dl>

User last logged off the system. This value is calculated from the number of seconds elapsed since 00:00:00, January 1, 1970. A value of " \*\*\*\*\*\*\*\*\*\*\*\*\*\*.\*\*\*\*\*\*+\*\*\* " means that the last logoff time is unknown. The format of this value is yyyymmddhhmmss.mmmmmm sutc. For information about translating this property into your local time, see [WMI Tasks: Dates and Times](wmi.wmi_tasks__dates_and_times).
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_last\_logon")
</dt> </dl>
...
Qualifiers: [**MaxLen**](wmi.standard_qualifiers) (147), [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_logon\_hours")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_logon\_server")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_max\_storage"), [**Units**](wmi.standard_qualifiers) ("bytes")
</dt> </dl>
...
Qualifiers: [**key**](wmi.key_qualifier), [**MaxLen**](wmi.standard_qualifiers) (256), [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_name")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_num\_logons")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_parms")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_password\_age")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_MODALS\_INFO\_0**](netmgmt.user_modals_info_0_str)\|usrmod0\_max\_passwd\_age")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_primary\_group\_id")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_priv")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_profile")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_script\_path")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_units\_per\_week")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_usr\_comment")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_user\_id")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_flags")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Network Management Structures\|[**USER\_INFO\_3**](netmgmt.user_info_3_str)\|usri3\_workstations")
</dt> </dl>
...
The calling process that uses this class must have the **SE\_RESTORE\_NAME** privilege on the computer in which the registry resides. For more information, see [Executing Privileged Operations](wmi.executing_privileged_operations).
