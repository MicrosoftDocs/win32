...
The **CIM\_RemoveDirectoryAction** class removes directories for software elements.
...
The **CIM\_RemoveDirectoryAction** class has these types of members:
...
The **CIM\_RemoveDirectoryAction** class has these methods.



| Method                                                             | Description                                                   |
|:-------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-removedirectoryaction.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_RemoveDirectoryAction** class has these properties.
...
If **TRUE**, the directory must be empty to be removed.
...
The **CIM\_RemoveDirectoryAction** class is derived from [**CIM\_DirectoryAction**](cim-directoryaction.md).
