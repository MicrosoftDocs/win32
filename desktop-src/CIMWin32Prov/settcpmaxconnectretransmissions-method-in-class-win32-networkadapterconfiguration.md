...
The **SetTcpMaxConnectRetransmissions** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to set the number of attempts TCP will retransmit a connect request before aborting.
