...
title: 'ChangeSecurityPermissionsEx method of the Win32\_Directory class'
---
...
If **true**, the change of ownership is applied recursively to files and directories within the directory specified by the [**CIM\_LogicalFile**](cim-logicalfile.md) instance. For file instances, the *Recursive* input parameter is ignored. This parameter is optional.
