...
An abstract base class for the preinstalled, calculated data classes. An example of such a class is [**Win32\_PerfFormattedData\_PerfDisk\_LogicalDisk**](wmi.win32_perfformatteddata_perfdisk_logicaldisk). These classes contain calculated values provided by the high-performance [Formatted Performance Data Provider](wmi.formatted_performance_data_provider).
