...
The **Win32\_IDEController** [WMI class](https://docs.microsoft.com/windows/desktop/WmiSdk/retrieving-a-class) manages the capabilities of an integrated device electronics (IDE) controller device.
