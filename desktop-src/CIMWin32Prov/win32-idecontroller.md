...
title: 'Win32\_IDEController class'
---

# Win32\_IDEController class

The **Win32\_IDEController** [WMI class](https://msdn.microsoft.com/library/aa393244) manages the capabilities of an integrated device electronics (IDE) controller device.
