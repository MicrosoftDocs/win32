...
title: 'Reset method of the CIM\_TapeDrive class'
---

# Reset method of the CIM\_TapeDrive class

The **Reset** method of the CIM\_TapeDrive class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_TapeDrive](reset-method-in-class-cim-tapedrive.md)
</dt> <dt>
