...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/en-us/library/Aa393650(v=VS.85).aspx) ("Win32API\|Power Management Events")
</dt> </dl>
...
The **Win32\_PowerManagementEvent** class is derived from [**\_\_ExtrinsicEvent**](https://msdn.microsoft.com/en-us/library/Aa394646(v=VS.85).aspx).
...
[**\_\_ExtrinsicEvent**](https://msdn.microsoft.com/en-us/library/Aa394646(v=VS.85).aspx)
</dt> <dt>
