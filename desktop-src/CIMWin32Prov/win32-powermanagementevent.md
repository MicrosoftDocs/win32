...
The **Win32\_PowerManagementEvent** [WMI class](wmi.retrieving_a_class) represents power management events resulting from power state changes. These state changes are associated with either the Advanced Power Management (APM) or the Advanced Configuration and Power Interface (ACPI) system management protocols.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Power Management Events")
</dt> </dl>
...
This property is inherited from [**\_\_Event**](wmi.__event).
...
The **Win32\_PowerManagementEvent** class is derived from [**\_\_ExtrinsicEvent**](wmi.__extrinsicevent).
...
[**\_\_ExtrinsicEvent**](wmi.__extrinsicevent)
</dt> <dt>
