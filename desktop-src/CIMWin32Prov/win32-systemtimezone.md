...
The **Win32\_SystemTimeZone** association [WMI class](wmi.retrieving_a_class) relates a computer system and a time zone.
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("Setting"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_TimeZone")
</dt> </dl>
