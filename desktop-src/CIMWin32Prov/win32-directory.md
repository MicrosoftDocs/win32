...
The **Win32\_Directory** [WMI class](https://msdn.microsoft.com/library/aa393244) represents a directory entry on a computer system running Windows. A directory is a type of file that logically groups data files and provides path information for the grouped files. Example: C:\\TEMP. **Win32\_Directory** does not include directories of network drives.
...
Bitmask that represents the access rights required to access or perform specific operations on the directory. For bit values, see [**File and Directory Access Rights Constants**](https://msdn.microsoft.com/library/aa822867).
...
Date that the file system object was created. For more information on working with WMI date and time formats, see [WMI Tasks: Dates and Times](https://msdn.microsoft.com/library/aa394590).
...
Date the file was last accessed. For more information on working with WMI date and time formats, see [WMI Tasks: Dates and Times](https://msdn.microsoft.com/library/aa394590).
...
Date the file was last modified. For more information on working with WMI date and time formats, see [WMI Tasks: Dates and Times](https://msdn.microsoft.com/library/aa394590).
