...
title: CIM\_CreateDirectoryAction class
...
The **CIM\_CreateDirectoryAction** class has these types of members:
...
The **CIM\_CreateDirectoryAction** class has these methods.



| Method                                                             | Description                                                                                                                                  |
|:-------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-createdirectoryaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific. Not implemented by WMI.<br/> |
...
The **CIM\_CreateDirectoryAction** class has these properties.
...
Name of the directory to which the action applies.

This property is inherited from [**CIM\_DirectoryAction**](cim-directoryaction.md).
...
The **CIM\_CreateDirectoryAction** class is derived from [**CIM\_DirectoryAction**](cim-directoryaction.md).

WMI does not implement this class. For classes derived from **CIM\_CreateDirectoryAction**, see [Win32 Classes](win32-provider.md).
