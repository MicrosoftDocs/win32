...
The **Win32\_VolumeChangeEvent** [WMI class](wmi.retrieving_a_class) represents a local drive event that results from the addition of a drive letter or mounted drive on the computer system. Network drives are not currently supported.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32APIDevice Management Messages\|WM\_DEVICECHANGE\|wParam", "Win32APIDevice Management Messages\|WM\_SETTINGCHANGE")
</dt> </dl>
