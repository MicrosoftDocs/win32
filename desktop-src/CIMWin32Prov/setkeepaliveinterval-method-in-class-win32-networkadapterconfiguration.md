...
title: 'SetKeepAliveInterval method of the Win32\_NetworkAdapterConfiguration class'
---

# SetKeepAliveInterval method of the Win32\_NetworkAdapterConfiguration class

The **SetKeepAliveInterval** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to set the interval separating Keep Alive Retransmissions until a response is received.
