...
The **Win32\_HeatPipe** [WMI class](https://msdn.microsoft.com/library/aa393244) represents the properties of a heat pipe cooling device.
...
The **Win32\_HeatPipe** class has these types of members:
...
The **Win32\_HeatPipe** class has these methods.



| Method            | Description                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Not implemented. To implement this method, see the [**Reset**](reset-method-in-class-cim-controller.md) method in [**CIM\_HeatPipe**](cim-heatpipe.md) for documentation.<br/>                 |
| **SetPowerState** | Not implemented. To implement this method, see the [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) method in [**CIM\_HeatPipe**](cim-heatpipe.md) for documentation.<br/> |
...
The **Win32\_HeatPipe** class has these properties.
...
The **Win32\_HeatPipe** class is derived from [**CIM\_HeatPipe**](cim-heatpipe.md).
