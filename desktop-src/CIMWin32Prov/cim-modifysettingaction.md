...
title: CIM\_ModifySettingAction class
...
The **CIM\_ModifySettingAction** class represents the information for modifying a specific setting file, for a specific entry, with a specific value.
...
The **CIM\_ModifySettingAction** class has these types of members:
...
The **CIM\_ModifySettingAction** class has these methods.



| Method                                                           | Description                                                 |
|:-----------------------------------------------------------------|:------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-modifysettingaction.md) | Takes a specific action. Not implemented by WMI.<br/> |
...
The **CIM\_ModifySettingAction** class has these properties.
...
Type of action to perform on the specified setting entry. Additions are assumed to be case sensitive; however, removals are assumed to be case insensitive.

<dt>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>**Create** (0)
...
<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>**Delete** (1)
...
<span id="Append"></span><span id="append"></span><span id="APPEND"></span>**Append** (2)


</dt> <dd>

Appends to the end of the specified entry.
...
Removes the value from the specified entry.
...
Value to add, append, or to replace the specified setting.
...
File name of the setting file entry to modify.
...
Section key of the setting entry to modify.
...
The **CIM\_ModifySettingAction** class is derived from [**CIM\_Action**](cim-action.md).
