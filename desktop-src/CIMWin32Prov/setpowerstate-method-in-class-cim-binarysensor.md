...
title: SetPowerState method of the CIM\_BinarySensor class
...
# SetPowerState method of the CIM\_BinarySensor class

The **SetPowerState** method sets the desired power state for a logical device and when the device should be put into that state.
...
[CIM\_BinarySensor](setpowerstate-method-in-class-cim-binarysensor.md)
</dt> <dt>
