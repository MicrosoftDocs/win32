...
The **Win32\_SystemAccount** [WMI class](wmi.retrieving_a_class) represents a system account. The system account is used by the operating system and services. There are many services and processes within Windows that need the capability to logon internally, for example, during a Windows installation. The system account was designed for that purpose.
...
Qualifiers: [**Fixed**](wmi.standard_wmi_qualifiers), [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Access Control Enumeration Types\|SID\_NAME\_USE")
</dt> </dl>
