---
Description: Compresses the logical paging file (or directory) specified in the object path.
ms.assetid: ebc69c9d-5a86-462b-9362-1ae02869ffa2
ms.tgt_platform: multiple
title: Compress method of the Win32_PageFile class
ms.topic: article
ms.date: 05/31/2018
topic_type: 
- APIRef
...
# Compress method of the Win32\_PageFile class

The **Compress** [WMI class](https://docs.microsoft.com/windows/desktop/WmiSdk/retrieving-a-class) method compresses the logical paging file (or directory) specified in the object path.
