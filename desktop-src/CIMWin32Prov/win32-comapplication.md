...
title: Win32\_COMApplication class
...
The **Win32\_COMApplication** abstract [WMI class](https://msdn.microsoft.com/library/aa393244) represents a Component Object Model (COM) application. In this context, a COM application is a logical grouping of COM classes.
...
The **Win32\_COMApplication** class has these types of members:

-   [Properties](#properties)

### Properties

The **Win32\_COMApplication** class has these properties.
...
The **Win32\_COMApplication** class is derived from [**CIM\_LogicalElement**](cim-logicalelement.md).
