...
The **EnableDNS** [WMI class](https://msdn.microsoft.com/library/aa393244) static method enables the Domain Name System (DNS) for service.

This topic uses the Managed Object Format (MOF) syntax. For more information about using this method, see [Calling a Method](https://msdn.microsoft.com/library/aa384832).
...
Represents an organization name followed by a period and an extension that indicates the type of organization.
