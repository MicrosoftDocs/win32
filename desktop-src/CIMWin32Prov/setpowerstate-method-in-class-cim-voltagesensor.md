...
title: 'SetPowerState method of the CIM\_VoltageSensor class'
---

# SetPowerState method of the CIM\_VoltageSensor class
...
[CIM\_VoltageSensor](setpowerstate-method-in-class-cim-voltagesensor.md)
</dt> <dt>
