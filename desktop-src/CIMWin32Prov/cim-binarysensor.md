...
The **CIM\_BinarySensor** class has these types of members:
...
The **CIM\_BinarySensor** class has these methods.



| Method                                                                  | Description                                                                                                                                |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-binarysensor.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-binarysensor.md) | Defines the desired power state for a logical device and when the device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_BinarySensor** class has these properties.
...
Description of a 'False' value from the binary sensor. This information can be displayed to a user.
...
Description of a 'True' value from the binary sensor. This information can be displayed to a user.
...
The **CIM\_BinarySensor** class is derived from [**CIM\_Sensor**](cim-sensor.md).
