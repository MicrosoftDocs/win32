...
title: Reset method of the CIM\_NumericSensor class
...
# Reset method of the CIM\_NumericSensor class

The **Reset** method of the CIM\_NumericSensor class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_NumericSensor](reset-method-in-class-cim-numericsensor.md)
</dt> <dt>
