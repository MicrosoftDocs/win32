...
title: EnableDHCP method of the Win32\_NetworkAdapterConfiguration class
...
The **EnableDHCP** [WMI class](https://msdn.microsoft.com/library/aa393244) method enables the Dynamic Host Configuration Protocol (DHCP) for service with this network adapter. DHCP allows IP addresses to be dynamically allocated.
