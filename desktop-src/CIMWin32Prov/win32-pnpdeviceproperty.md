---
Description: The base type for classes representing a property returned by the Win32\_PnPEntityGetDeviceProperties Method.
audience: developer
...
title: Win32\_PnPDeviceProperty class
ms.date: 05/31/2018
ms.topic: article
...
The base type for classes representing a property returned by the [**Win32\_PnPEntity**](win32-pnpentity.md)::[**GetDeviceProperties**](getdeviceproperties-win32-pnpentity.md) Method.
...
The **Win32\_PnPDeviceProperty** class has these types of members:

-   [Properties](#properties)

### Properties

The **Win32\_PnPDeviceProperty** class has these properties.
