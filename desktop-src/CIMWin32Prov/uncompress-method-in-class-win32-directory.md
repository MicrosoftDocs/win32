...
title: Uncompress method of the Win32\_Directory class
...
The **Uncompress** [WMI class](https://msdn.microsoft.com/library/aa393244) method uncompresses the logical directory entry file (or directory) specified in the object path.
