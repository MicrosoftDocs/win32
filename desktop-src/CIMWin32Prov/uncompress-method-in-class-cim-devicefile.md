...
The **Uncompress** method uncompressed the logical device file (or directory) specified in the object path. This method is inherited from [**CIM\_LogicalFile**](cim-logicalfile.md).
...
[CIM\_DeviceFile](uncompress-method-in-class-cim-devicefile.md)
</dt> <dt>
