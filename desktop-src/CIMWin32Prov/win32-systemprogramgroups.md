...
The **Win32\_SystemProgramGroups** association [WMI class](wmi.retrieving_a_class) relates a computer system and a logical program group.
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("Setting"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_LogicalProgramGroup")
</dt> </dl>
