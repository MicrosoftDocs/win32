---
Description: Gets the security descriptor that controls who is allowed to configure a DCOM application.
audience: developer
...
title: GetConfigurationSecurityDescriptor method of the Win32\_DCOMApplicationSetting class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# GetConfigurationSecurityDescriptor method of the Win32\_DCOMApplicationSetting class

The **GetConfigurationSecurityDescriptor** WMI method gets the security descriptor that controls who is allowed to configure a DCOM application. The security descriptor is a instance of the [**Win32\_SecurityDescriptor**](https://msdn.microsoft.com/library/aa394402) class. The account running the script or application that calls this method must have the **SeSecurityPrivilege** and **SeRestorePrivilege** privileges. For more information, see [Changing Access Security on Securable Objects](https://msdn.microsoft.com/library/aa384905).
