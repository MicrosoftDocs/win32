---
Description: The CIM\_FileAction class allows the author to locate files that already exist on a users computer, and then move or copy those files to a new location.
audience: developer
...
The **CIM\_FileAction** class has these types of members:
...
The **CIM\_FileAction** class has these methods.



| Method                                                  | Description                                                   |
|:--------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-fileaction.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_FileAction** class has these properties.
...
WMI does not implement this class. For classes derived from **CIM\_FileAction**, see [Win32 Classes](win32-provider.md).
