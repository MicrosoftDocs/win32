...
title: Copy method of the CIM\_DataFile class
...
# Copy method of the CIM\_DataFile class
...
The **Copy** method in [**CIM\_DataFile**](cim-datafile.md) is implemented by WMI.
...
[CIM\_DataFile](copy-method-in-class-cim-datafile.md)
</dt> <dt>
