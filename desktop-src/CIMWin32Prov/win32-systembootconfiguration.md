...
The **Win32\_SystemBootConfiguration** association [WMI class](wmi.retrieving_a_class) relates a computer system and its boot configuration.
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("Setting"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_BootConfiguration")
</dt> </dl>
