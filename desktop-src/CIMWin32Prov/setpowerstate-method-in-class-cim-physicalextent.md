---
Description: 'The SetPowerState method of the CIM\_PhysicalExtent class sets the desired power state for a logical device and when a device should be put into that state.'
audience: developer
...
title: 'SetPowerState method of the CIM\_PhysicalExtent class'
---

# SetPowerState method of the CIM\_PhysicalExtent class
...
[CIM\_PhysicalExtent](setpowerstate-method-in-class-cim-physicalextent.md)
</dt> <dt>
