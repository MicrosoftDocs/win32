---
Description: The SetSpeed method requests that the fan speed be set to the value specified in the methods input parameter.
audience: developer
...
title: SetSpeed method of the CIM\_Fan class
ms.date: 05/31/2018
ms.topic: article
