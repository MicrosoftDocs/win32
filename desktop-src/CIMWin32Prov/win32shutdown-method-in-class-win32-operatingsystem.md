...
The **Win32Shutdown**   [WMI class](https://msdn.microsoft.com/windows/desktop/cfe4bcca-692e-45cd-a840-93ebfe4ae267) method provides the full set of shutdown options supported by Win32 operating systems. These include logoff, shutdown, reboot, and forcing a logoff, shutdown, or reboot.

This topic uses Managed Object Format (MOF) syntax. For more information about using this method, see [Calling a Method](https://msdn.microsoft.com/windows/desktop/7a1eda93-014e-4067-b6d0-361a3d2fd1df).
...
[Executing Privileged Operations Using VBScript](https://msdn.microsoft.com/windows/desktop/65b923d5-5244-498d-9644-d4978fb84f85)
</dt> </dl>
