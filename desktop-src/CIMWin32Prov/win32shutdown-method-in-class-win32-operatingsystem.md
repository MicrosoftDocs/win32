...
The **Win32Shutdown**   [WMI class](wmi.retrieving_a_class) method provides the full set of shutdown options supported by Win32 operating systems. These include logoff, shutdown, reboot, and forcing a logoff, shutdown, or reboot.

This topic uses Managed Object Format (MOF) syntax. For more information about using this method, see [Calling a Method](wmi.calling_a_method).
...
Returns zero (0) to indicate success. Any other number indicates an error. For error codes, see [**WMI Error Constants**](wmi.wmi_error_constants) or [**WbemErrorEnum**](wmi.wbemerrorenum). For general **HRESULT** values, see [System Error Codes](base.system_error_codes).
...
[Executing Privileged Operations Using VBScript](wmi.executing_privileged_operations_using_vbscript)
</dt> </dl>
