...
The **Win32\_Printer** [WMI class](wmi.retrieving_a_class) represents a device connected to a computer running on a Microsoft Windows operating system that can produce a printed image or text on paper or other medium.
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.RequiredJobSheets")
</dt> </dl>
...
Qualifiers: [**ArrayType**](wmi.standard_qualifiers) ("Indexed"), [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).CapabilityDescriptions", "CIM\_PrintJob.Finishing", "CIM\_PrintService.Capabilities")
</dt> </dl>
...
Qualifiers: [**ArrayType**](wmi.standard_qualifiers) ("Indexed"), [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**Capabilities**")
</dt> </dl>
...
Qualifiers: [**ArrayType**](wmi.standard_qualifiers) ("Indexed"), [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.CharSet"), [**MappingStrings**](wmi.standard_qualifiers) ("MIB.IETF\|Printer-MIB.prtLocalizationCharacterSet")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**Capabilities**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**CharSetsSupported**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).LanguagesSupported", "**CIM\_Printer**.**CurrentMimeType**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**CurrentLanguage**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**NaturalLanguagesSupported**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**PaperTypesAvailable**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).LanguagesSupported", "**CIM\_Printer**.**DefaultMimeType**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**DefaultLanguage**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**ErrorInformation**"), [**MappingStrings**](wmi.standard_qualifiers) ("MIB.IETF\|Printer-MIB.hrPrinterDetectedErrorState")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).**DetectedErrorState**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.HorizontalResolution"), [**Units**](wmi.standard_qualifiers) ("pixels per inch")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("MIB.IETF\|Printer-MIB.prtInterpreterLangFamily"), [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).MimeTypesSupported", "CIM\_PrintJob.Language", "CIM\_PrintService.LanguagesSupported")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("MIB.IETF\|Printer-MIB.prtMarkerMarkTech")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.Copies")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.NumberUp")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.JobSize"), [**Units**](wmi.standard_qualifiers) ("kilobytes")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](wmi.standard_qualifiers) ("[**CIM\_Printer**](cim-printer.md).LanguagesSupported", "CIM\_PrintJob.MimeTypes", "CIM\_PrintService.MimeTypesSupported")
</dt> </dl>
...
Qualifiers: [**ArrayType**](wmi.standard_qualifiers) ("Indexed"), [**MappingStrings**](wmi.standard_qualifiers) ("MIB.IETF\|Printer-MIB.prtLocalizationLanguage"), [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.NaturalLanguage")
</dt> </dl>
...
Qualifiers: [**ArrayType**](wmi.standard_qualifiers) ("Indexed"), [**ModelCorrespondence**](wmi.standard_qualifiers) ("CIM\_PrintJob.RequiredPaperType", "CIM\_PrintService.PaperTypesAvailable"), [**MappingStrings**](wmi.standard_qualifiers) ("MIB.IETF\|Printer-MIB.prtInputMediaName")
</dt> </dl>
...
Qualifiers: [**Deprecated**](wmi.standard_wmi_qualifiers)
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("MIB.IETF\|Printer-MIB.hrPrinterStatus")
</dt> </dl>
...
The **Win32\_Printer** class is derived from [**CIM\_Printer**](cim-printer.md). Before calling [**SWbemObject.Put\_**](wmi.swbemobject_put_) or [**IWbemServices::PutInstance**](wmi.iwbemservices_putinstance) for a **Win32\_Printer** instance, the **SeLoadDriverPrivilege** privilege (**wbemPrivilegeLoadDriver** for Visual Basic and LoadDriver for scripting monikers) must be enabled. For more information, see [**Privilege Constants**](wmi.privilege_constants) and [Executing Privileged Operations](wmi.executing_privileged_operations). The following VBScript code example shows how to enable the **SetLoadDriverPrivilege** privilege in script.
...
[WMI Tasks: Printers and Printing](wmi.wmi_tasks__printers_and_printing)
</dt> </dl>
