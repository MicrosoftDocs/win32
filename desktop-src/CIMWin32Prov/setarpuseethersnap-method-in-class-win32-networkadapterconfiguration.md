...
title: SetArpUseEtherSNAP method of the Win32\_NetworkAdapterConfiguration class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# SetArpUseEtherSNAP method of the Win32\_NetworkAdapterConfiguration class

The **SetArpUseEtherSNAP** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to enable ethernet packets to use 802.3 SNAP encoding.
