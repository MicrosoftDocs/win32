...
The **Win32\_SystemSystemDriver** association [WMI class](wmi.retrieving_a_class) relates a computer system and a system driver running on that computer system.
...
Qualifiers: [**key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("PartComponent"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_SystemDriver")
</dt> </dl>
