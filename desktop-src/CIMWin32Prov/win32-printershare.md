...
The **Win32\_PrinterShare** association [WMI class](wmi.retrieving_a_class) relates a local printer and the share that represents it as it is viewed over a network.
...
Qualifiers: [**Key**](wmi.standard_qualifiers)
</dt> </dl>
