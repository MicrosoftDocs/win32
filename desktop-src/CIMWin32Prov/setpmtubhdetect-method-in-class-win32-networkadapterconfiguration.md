...
title: SetPMTUBHDetect method of the Win32\_NetworkAdapterConfiguration class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# SetPMTUBHDetect method of the Win32\_NetworkAdapterConfiguration class

The **SetPMTUBHDetect** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to enable the detection of Black Hole routers while doing Path MTU Discovery.
...
A Black Hole router does not return the Internet Control Message Protocol (ICMP) Destination Unreachable messages when it needs to fragment an IP datagram with the Don't Fragment bit set. TCP depends on receiving these messages to perform Path MTU Discovery.
