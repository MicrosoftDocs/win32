...
The **Win32\_ShareToDirectory** association [WMI class](wmi.retrieving_a_class) relates a shared resource on the computer system and the directory to which it is mapped.
...
Qualifiers: [**key**](wmi.key_qualifier), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_Share")
</dt> </dl>
...
Qualifiers: [**key**](wmi.key_qualifier), [**MappingStrings**](wmi.standard_qualifiers) ("CIM\|CIM\_Directory")
</dt> </dl>
