...
title: SetTcpMaxDataRetransmissions method of the Win32\_NetworkAdapterConfiguration class
...
The **SetTcpMaxDataRetransmissions** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to set the number of times TCP retransmits an individual data segment before aborting the connection.
