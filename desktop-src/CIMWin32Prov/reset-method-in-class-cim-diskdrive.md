...
The **Reset** method of the CIM\_DiskDrive class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_DiskDrive](reset-method-in-class-cim-diskdrive.md)
</dt> <dt>
