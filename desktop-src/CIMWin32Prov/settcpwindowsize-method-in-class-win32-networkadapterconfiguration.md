...
The **SetTcpWindowSize** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to set the maximum TCP Receive Window size offered by the system.
