...
title: CompressEx method of the Win32\_ShortcutFile class
...
The **CompressEx** [WMI class](https://msdn.microsoft.com/library/aa393244) method compresses the logical shortcut file (or directory) specified in the object path (this method is an extended version of the [**Compress**](compress-method-in-class-win32-directory.md) method).
...
Name of the file or directory where the [**CompressEx**](compressex-method-in-class-win32-directory.md) method failed. This parameter will be **NULL** if the method succeeds.
