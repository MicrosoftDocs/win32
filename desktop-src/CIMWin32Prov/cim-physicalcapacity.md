---
Description: The CIM\_PhysicalCapacity class is an abstract class that represents a physical elements minimum and maximum requirements and its ability to support different types of hardware.
audience: developer
...
title: CIM\_PhysicalCapacity class
ms.date: 05/31/2018
ms.topic: article
