---
Description: The CIM\_BootSAP class represents the access points of a boot service.
audience: developer
...
The **CIM\_BootSAP** class represents the access points of a boot service.
...
The **CIM\_BootSAP** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_BootSAP** class has these properties.
...
Qualifiers: [**Propagated**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_System**](cim-system.md).**Name**"), [**CIM\_Key**](https://msdn.microsoft.com/library/aa393651), [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (256)
</dt> </dl>
...
The **CIM\_BootSAP** class is derived from [**CIM\_ServiceAccessPoint**](cim-serviceaccesspoint.md).
