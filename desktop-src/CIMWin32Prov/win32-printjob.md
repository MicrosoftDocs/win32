...
The **Win32\_PrintJob** [WMI class](wmi.retrieving_a_class) represents a print job generated by a Windows application. Any unit of work generated by the print command of an application that is running on a computer running on a Windows operating system is a descendant or member of this class.
...
Qualifiers: [**Units**](wmi.standard_qualifiers) (Tenths of a millimeter.)
</dt> </dl>
