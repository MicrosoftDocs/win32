...
The **Win32\_PCMCIAController** [WMI class](wmi.retrieving_a_class) manages the capabilities of a Personal Computer Memory Card Interface Adapter (PCMCIA of a PC Card) controller device.
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("DeviceId"), [**Key**](wmi.key_qualifier), [**MappingStrings**](wmi.standard_qualifiers) ("WMI")
</dt> </dl>
