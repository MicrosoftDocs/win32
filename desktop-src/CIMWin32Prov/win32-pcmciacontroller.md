...
title: Win32\_PCMCIAController class
...
The **Win32\_PCMCIAController** [WMI class](https://msdn.microsoft.com/windows/desktop/cfe4bcca-692e-45cd-a840-93ebfe4ae267) manages the capabilities of a Personal Computer Memory Card Interface Adapter (PCMCIA of a PC Card) controller device.
...
The **Win32\_PCMCIAController** class has these types of members:
...
The **Win32\_PCMCIAController** class has these methods.



| Method            | Description                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Not implemented. To implement this method, see the [**Reset**](reset-method-in-class-cim-controller.md) method in [**CIM\_PCMCIAController**](cim-pcmciacontroller.md).<br/>                 |
| **SetPowerState** | Not implemented. To implement this method, see the [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) method in [**CIM\_PCMCIAController**](cim-pcmciacontroller.md).<br/> |
...
The **Win32\_PCMCIAController** class has these properties.
...
Qualifiers: [**Override**](https://msdn.microsoft.com/windows/desktop/671ea769-f68d-4788-96f5-c4f86ab3b00e) ("DeviceId"), [**Key**](https://msdn.microsoft.com/windows/desktop/838d295f-e812-4e46-99a4-d2714a0ae8dc), [**MappingStrings**](https://msdn.microsoft.com/windows/desktop/671ea769-f68d-4788-96f5-c4f86ab3b00e) ("WMI")
</dt> </dl>

Unique identifier of this device with other peripherals using the Plug and Play BIOS. This property is derived from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
This property is inherited from [**CIM\_PCMCIAController**](cim-pcmciacontroller.md).
...
This property is inherited from [**CIM\_Controller**](cim-controller.md). The values are shown in the following list.
...
The **Win32\_PCMCIAController** class is derived from [**CIM\_PCMCIAController**](cim-pcmciacontroller.md).
