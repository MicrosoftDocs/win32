...
title: DeleteEx method of the Win32\_Directory class
...
The **DeleteEx** [WMI class](https://msdn.microsoft.com/library/aa393244) method will delete the logical file (or directory) specified in the object path. **DeleteEx** is an extended version of the [**Delete**](delete-method-in-class-win32-directory.md) method.
