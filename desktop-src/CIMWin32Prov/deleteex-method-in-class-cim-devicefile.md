---
description: DeleteEx method of the CIM_DeviceFile class - The DeleteEx method deletes the logical file (or directory) specified in the object path. This method is an extended version of the Delete method and is inherited from CIM\_LogicalFile.
...
# DeleteEx method of the CIM\_DeviceFile class

The **DeleteEx** method deletes the logical file (or directory) specified in the object path. This method is an extended version of the [**Delete**](delete-method-in-class-cim-devicefile.md) method and is inherited from [**CIM\_LogicalFile**](cim-logicalfile.md).
...
[CIM\_DeviceFile](deleteex-method-in-class-cim-devicefile.md)
</dt> <dt>
