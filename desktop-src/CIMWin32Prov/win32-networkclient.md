...
The **Win32\_NetworkClient** [WMI class](wmi.retrieving_a_class) represents a network client on a Windows system. Any computer system on the network with a client relationship to the system is a descendant (or member) of this class.
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32Registry\|SYSTEM\\\\CurrentControlSet\\\\Services\\\\LanmanWorkstation\\\\NetworkProvider\|Mfg")
</dt> </dl>
...
Qualifiers: [**key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("Name"), [**MappingStrings**](wmi.standard_qualifiers) ("Win32Registry\|SYSTEM\\\\CurrentControlSet\\\\Services\\\\LanmanWorkstation\\\\NetworkProvider\|Name")
</dt> </dl>
