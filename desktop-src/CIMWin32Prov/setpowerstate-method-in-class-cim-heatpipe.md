---
Description: The SetPowerState method of the CIM\_HeatPipe class sets the desired power state for a logical device and when a device should be put into that state.
audience: developer
...
[CIM\_HeatPipe](setpowerstate-method-in-class-cim-heatpipe.md)
</dt> <dt>
