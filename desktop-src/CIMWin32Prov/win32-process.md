...
The **Win32\_Process** [WMI class](wmi.retrieving_a_class) represents a process on an operating system.
...
Qualifiers: [**DisplayName**](wmi.standard_qualifiers) ("Command Line To Start Process")
</dt> </dl>
...
Qualifiers: [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**MaxLen**](wmi.standard_qualifiers) (256), [**DisplayName**](wmi.standard_qualifiers) ("Class Name")
</dt> </dl>
...
Qualifiers: [**Fixed**](wmi.standard_wmi_qualifiers), [**DisplayName**](wmi.standard_qualifiers) ("CreationDate")
</dt> </dl>
...
Qualifiers: [**Propagated**](wmi.standard_qualifiers) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**CSCreationClassName**"), [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**MaxLen**](wmi.standard_qualifiers) (256), [**DisplayName**](wmi.standard_qualifiers) ("Computer System Class Name")
</dt> </dl>
...
Qualifiers: [**Propagated**](wmi.standard_qualifiers) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**CSName**"), [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**MaxLen**](wmi.standard_qualifiers) (256), [**DisplayName**](wmi.standard_qualifiers) ("Computer System Name")
</dt> </dl>
...
Qualifiers: [**Privileges**](wmi.standard_wmi_qualifiers) ("SeDebugPrivilege"), [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Tool Help Structures\|[**MODULEENTRY32**](toolhelp.moduleentry32_str)\|szExePath"), [**DisplayName**](wmi.standard_qualifiers) ("Executable Path")
</dt> </dl>
...
Qualifiers: [**DisplayName**](wmi.standard_qualifiers) ("Execution State")
</dt> </dl>
...
Qualifiers: [**Key**](wmi.key_qualifier), [**MaxLen**](wmi.standard_qualifiers) (256), [**DisplayName**](wmi.standard_qualifiers) ("Handle")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|HandleCount"), [**DisplayName**](wmi.standard_qualifiers) ("Handle Count")
</dt> </dl>
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("KernelModeTime"), [**Units**](wmi.standard_qualifiers) ("100 nanoseconds")
</dt> </dl>
...
Qualifiers: [**Privileges**](wmi.standard_wmi_qualifiers) ("SeDebugPrivilege"), [**MappingStrings**](wmi.standard_qualifiers) ("Win32\|WINNT.H\|QUOTA\_LIMITS\|MaximumWorkingSetSize"), [**DisplayName**](wmi.standard_qualifiers) ("Maximum Working Set Size"), [**Units**](wmi.standard_qualifiers) ("kilobytes")
</dt> </dl>
...
Qualifiers: [**Privileges**](wmi.standard_wmi_qualifiers) ("SeDebugPrivilege"), [**MappingStrings**](wmi.standard_qualifiers) ("Win32\|WINNT.H\|QUOTA\_LIMITS\|MinimumWorkingSetSize"), [**DisplayName**](wmi.standard_qualifiers) ("Minimum Working Set Size"), [**Units**](wmi.standard_qualifiers) ("kilobytes")
</dt> </dl>
...
Qualifiers: [**Propagated**](wmi.standard_qualifiers) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**CreationClassName**"), [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**MaxLen**](wmi.standard_qualifiers) (256), [**DisplayName**](wmi.standard_qualifiers) ("Operating System Class Name")
</dt> </dl>
...
Qualifiers: [**Propagated**](wmi.standard_qualifiers) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**Name**"), [**CIM\_Key**](wmi.standard_wmi_qualifiers), [**MaxLen**](wmi.standard_qualifiers) (256), [**DisplayName**](wmi.standard_qualifiers) ("Operating System Name")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|SYSTEM\_PROCESS\_INFORMATION\|OtherOperationCount"), [**DisplayName**](wmi.standard_qualifiers) ("Other Operation Count")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|SYSTEM\_PROCESS\_INFORMATION\|OtherTransferCount"), [**DisplayName**](wmi.standard_qualifiers) ("Other Transfer Count"), [**Units**](wmi.standard_qualifiers) ("bytes")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|PageFaultCount"), [**DisplayName**](wmi.standard_qualifiers) ("Number Of Page Faults")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|PagefileUsage"), [**DisplayName**](wmi.standard_qualifiers) ("Page File Usage"), [**Units**](wmi.standard_qualifiers) ("kilobytes")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|InheritedFromUniqueProcessId"), [**DisplayName**](wmi.standard_qualifiers) ("Parent Process Id")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|PeakPagefileUsage"), [**DisplayName**](wmi.standard_qualifiers) ("Peak Page File Usage"), [**Units**](wmi.standard_qualifiers) ("kilobytes")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|PeakVirtualSize"), [**DisplayName**](wmi.standard_qualifiers) ("Peak Virual Address Space Usage"), [**Units**](wmi.standard_qualifiers) ("bytes")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|PeakWorkingSetSize"), [**DisplayName**](wmi.standard_qualifiers) ("Peak Working Set Size"), [**Units**](wmi.standard_qualifiers) ("kilobytes")
</dt> </dl>
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("Priority"), [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|BasePriority"), [**DisplayName**](wmi.standard_qualifiers) ("Priority")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|PrivatePageCount"), [**DisplayName**](wmi.standard_qualifiers) ("Private Page Count")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|[**PROCESS\_INFORMATION**](base.process_information_str)\|dwProcessId "), [**DisplayName**](wmi.standard_qualifiers) ("Process Id")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|QuotaNonPagedPoolUsage"), [**DisplayName**](wmi.standard_qualifiers) ("Non-Paged Pool Usage Quota")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|QuotaPagedPoolUsage"), [**DisplayName**](wmi.standard_qualifiers) ("Paged Pool Usage Quota")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|QuotaPeakNonPagedPoolUsage"), [**DisplayName**](wmi.standard_qualifiers) ("Peak Non-Paged Pool Usage Quota")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|QuotaPeakPagedPoolUsage"), [**DisplayName**](wmi.standard_qualifiers) ("Peak Paged Pool Usage Quota")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|SYSTEM\_PROCESS\_INFORMATION\|ReadOperationCount"), [**DisplayName**](wmi.standard_qualifiers) ("Read Operation Count")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|SYSTEM\_PROCESS\_INFORMATION\|ReadTransferCount"), [**DisplayName**](wmi.standard_qualifiers) ("Read Transfer Count"), [**Units**](wmi.standard_qualifiers) ("bytes")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|SessionId"), [**DisplayName**](wmi.standard_qualifiers) ("Session Id")
</dt> </dl>
...
Qualifiers: [**DisplayName**](wmi.standard_qualifiers) ("Termination Date")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|NumberOfThreads"), [**DisplayName**](wmi.standard_qualifiers) ("Thread Count")
</dt> </dl>
...
Qualifiers: [**Override**](wmi.standard_qualifiers) ("UserModeTime"), [**Units**](wmi.standard_qualifiers) ("100 nanoseconds")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process Status\|SYSTEM\_PROCESS\_INFORMATION\|VirtualSize"), [**DisplayName**](wmi.standard_qualifiers) ("Virtual Address Space Usage"), [**Units**](wmi.standard_qualifiers) ("bytes")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Functions\|GetProcessVersion"), [**DisplayName**](wmi.standard_qualifiers) ("Windows Version")
</dt> </dl>
...
Qualifiers: [**DisplayName**](wmi.standard_qualifiers) ("Working Set Size"), [**Units**](wmi.standard_qualifiers) ("bytes")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|SYSTEM\_PROCESS\_INFORMATION\|WriteOperationCount"), [**DisplayName**](wmi.standard_qualifiers) ("Write Operation Count")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|Process and Thread Structures\|SYSTEM\_PROCESS\_INFORMATION\|WriteTransferCount"), [**DisplayName**](wmi.standard_qualifiers) ("Write Transfer Count"), [**Units**](wmi.standard_qualifiers) ("bytes")
</dt> </dl>
...
The **Win32\_Process** class is derived from [**CIM\_Process**](cim-process.md). The calling process that uses this class must have the **SE\_RESTORE\_NAME** privilege on the computer in which the registry resides. For more information, see [Executing Privileged Operations](wmi.executing_privileged_operations).
...
You can monitor process performance with the [**Win32\_PerfFormattedData\_PerfProc\_Process**](wmi.win32_perfformatteddata_perfproc_process) class and a WMI refresher object, such as [**SWbemRefresher**](wmi.swbemrefresher). For more information, see [Monitoring Performance Data](wmi.monitoring_performance_data).
...
In the [Example: Calling a Provider Method](wmi.example__calling_a_provider_method) topic, the code uses C++ to call **Win32\_Process** to create a process.
...
[WMI Tasks: Processes](wmi.wmi_tasks__processes)
</dt> </dl>
