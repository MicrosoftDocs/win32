...
title: 'Compress method of the Win32\_ShortcutFile class'
---

# Compress method of the Win32\_ShortcutFile class

The **Compress** [WMI class](https://msdn.microsoft.com/library/aa393244) method compresses the logical shortcut file (or directory) specified in the object path.
