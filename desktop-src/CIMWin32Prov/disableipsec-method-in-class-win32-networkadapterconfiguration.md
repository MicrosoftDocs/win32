...
title: DisableIPSec method of the Win32\_NetworkAdapterConfiguration class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# DisableIPSec method of the Win32\_NetworkAdapterConfiguration class

The **DisableIPSec** [WMI class](https://msdn.microsoft.com/library/aa393244) method is used to disable Internet Protocol security (IPsec) on this TCP/IP-enabled network adapter.
...
The following VBScript sample disables the IP Security on a computer. Note that the actual call to DisableIPSec is commented out, for safety purposes.
