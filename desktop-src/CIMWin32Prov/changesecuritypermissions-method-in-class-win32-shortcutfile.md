---
Description: Changes the security permissions for the logical shortcut file specified in the object path.
audience: developer
...
title: ChangeSecurityPermissions method of the Win32\_ShortcutFile class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# ChangeSecurityPermissions method of the Win32\_ShortcutFile class
...
Actual security privilege to be modified. For example, to change the owner and DACL security, use:
