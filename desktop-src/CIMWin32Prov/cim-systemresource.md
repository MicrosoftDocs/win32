...
title: CIM\_SystemResource class
ms.date: 05/31/2018
ms.topic: article
...
The **CIM\_SystemResource** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_SystemResource** class has these properties.
...
The **CIM\_SystemResource** class is derived from [**CIM\_LogicalElement**](cim-logicalelement.md).

WMI does not implement this class. For WMI classes derived from **CIM\_SystemResource**, see [Win32 Classes](win32-provider.md).
