...
The **CIM\_PowerSupply** class represents the capabilities and management of the power supply logical device.
...
The **CIM\_PowerSupply** class has these types of members:
...
The **CIM\_PowerSupply** class has these methods.



| Method                                                                 | Description                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-powersupply.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-powersupply.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_PowerSupply** class has these properties.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.15")
</dt> </dl>

Voltage range that is currently in use. If the supply is not currently drawing power, the value 6 ("Neither") can be specified. This information is necessary in the case of an uninterruptible power supply (UPS), a subclass of **CIM\_PowerSupply**.
...
If **TRUE**, the power supply is a switching (versus linear) supply.
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("hertz")
</dt> </dl>

Frequency (in hertz) at the high-end of the power supply's input frequency range 1. A value of 0 implies DC.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.17"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("hertz")
</dt> </dl>

Frequency (in hertz) at the low-end of the power supply's input frequency range 1. A value of 0 implies DC.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.8"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("millivolts")
</dt> </dl>

High voltage of input voltage range 1 for the power supply, in millivolts. A value of 0 denotes "Unknown".
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.7"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("millivolts")
</dt> </dl>

Low voltage of input voltage range 1 for the power supply, in millivolts. A value of 0 denotes "Unknown".
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.20"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("hertz")
</dt> </dl>

Frequency (in hertz) at the high-end of the power supply's input frequency range 2. A value of 0 implies DC.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.19"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("hertz")
</dt> </dl>

Frequency (in hertz) at the low-end of the power supply's input frequency range 2. A value of 0 implies DC.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.12"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("millivolts")
</dt> </dl>

High voltage of input voltage range 2 for the power supply, in millivolts. A value of 0 denotes "Unknown".
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.11"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("millivolts")
</dt> </dl>

Low voltage of input voltage range 2 for this power supply, in Millivolts. A value of 0 denotes "Unknown".
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.21"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("milliwatts")
</dt> </dl>

Total output power of the power supply, in milliwatts. A value of 0 denotes "Unknown".
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Power Supply\|002.16")
</dt> </dl>

Type of input voltage range switching implemented in the power supply.
...
The **CIM\_PowerSupply** class is derived from [**CIM\_LogicalDevice**](cim-logicaldevice.md).

WMI does not implement this class. For WMI classed derived from **CIM\_PowerSupply**, see [Win32 Classes](win32-provider.md).
