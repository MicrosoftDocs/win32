...
title: SetDeadGWDetect method of the Win32\_NetworkAdapterConfiguration class
...
# SetDeadGWDetect method of the Win32\_NetworkAdapterConfiguration class

The **SetDeadGWDetect** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to enable dead gateway detection.
