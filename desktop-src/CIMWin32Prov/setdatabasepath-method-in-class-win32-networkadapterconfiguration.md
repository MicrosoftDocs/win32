...
The **SetDatabasePath** [WMI class](https://msdn.microsoft.com/library/aa393244) static method sets the path to the standard Internet database files (HOSTS, LMHOSTS, NETWORKS, and PROTOCOLS).
