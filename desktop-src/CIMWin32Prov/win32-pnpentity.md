...
The **Win32\_PnPEntity** [WMI class](https://msdn.microsoft.com/windows/desktop/cfe4bcca-692e-45cd-a840-93ebfe4ae267) represents the properties of a Plug and Play device. Plug and Play entities are shown as entries in the Device Manager located in Control Panel.
...
The **Win32\_PnPEntity** class has these types of members:
...
The **Win32\_PnPEntity** class has these methods.



| Method                                                             | Description                                                                                                                                                                                    |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Disable**](disable-win32-pnpentity.md)                         | Disables this Plug and Play device.<br/>                                                                                                                                                 |
| [**Enable**](enable-win32-pnpentity.md)                           | Enables this Plug and Play device.<br/>                                                                                                                                                  |
| [**GetDeviceProperties**](getdeviceproperties-win32-pnpentity.md) | Gets the specified properties of this Plug and Play device.<br/>                                                                                                                         |
...
The **Win32\_PnPEntity** class has these properties.
...
For more information, see the [Windows Driver Kit](https://msdn.microsoft.com/en-us/windows/hardware/gg487428).
...
The **SetPowerState** method is supported. This method is found on the parent [**CIM\_LogicalDevice**](cim-logicaldevice.md) class and can be implemented. For more information, see [Designing Managed Object Format (MOF) Classes](https://msdn.microsoft.com/windows/desktop/20ef6b88-2aaa-4e86-bc4a-bebc34069672).
...
The **Win32\_PnPEntity** class is derived from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[Connecting to WMI on a Remote Computer](https://msdn.microsoft.com/windows/desktop/16b00ee3-f721-4912-9e8e-2fdbc897a813)
</dt> <dt>
