...
The **Win32\_PnPEntity** [WMI class](wmi.retrieving_a_class) represents the properties of a Plug and Play device. Plug and Play entities are shown as entries in the Device Manager located in Control Panel.
...
The **SetPowerState** method is supported. This method is found on the parent [**CIM\_LogicalDevice**](cim-logicaldevice.md) class and can be implemented. For more information, see [Designing Managed Object Format (MOF) Classes](wmi.designing_managed_object_format__mof__classes).
...
[Connecting to WMI on a Remote Computer](wmi.connecting_to_wmi_on_a_remote_computer)
</dt> <dt>
