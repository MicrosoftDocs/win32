...
title: 'InterrogateService method of the Win32\_BaseService class'
---

# InterrogateService method of the Win32\_BaseService class

The **InterrogateService** [WMI class](https://msdn.microsoft.com/library/aa393244) method requests that the service update its state to the service manager.
