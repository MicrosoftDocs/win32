...
**Win32\_Perf** defines the required timestamp and frequency properties used in the [**CounterType**](wmi.countertype_qualifier) algorithms for the performance counter classes.
