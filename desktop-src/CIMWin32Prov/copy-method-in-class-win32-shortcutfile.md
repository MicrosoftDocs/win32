...
The **Copy** [WMI class](https://msdn.microsoft.com/library/aa393244) method copies the logical shortcut file or directory specified in the object path to the location specified by the input parameter. A copy is not supported if overwriting an existing logical file is required.
...
Returns value of 0 (zero) if the file was successfully copied, and any other number to indicate an error.
