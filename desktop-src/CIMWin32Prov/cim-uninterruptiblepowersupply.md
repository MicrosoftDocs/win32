...
The **CIM\_UninterruptiblePowerSupply** class has these types of members:
...
The **CIM\_UninterruptiblePowerSupply** class has these methods.



| Method                                                                                | Description                                                                                                                              |
|:--------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-uninterruptiblepowersupply.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-uninterruptiblepowersupply.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_UninterruptiblePowerSupply** class has these properties.
...
Input voltage range is currently in use. If the supply is not currently drawing power, the value 6 ("Neither") can be specified. This information is necessary in the case of a UPS, a subclass of [**CIM\_PowerSupply**](cim-powersupply.md).

This property is inherited from [**CIM\_PowerSupply**](cim-powersupply.md).
...
Qualifiers: [**MappingStrings**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("MIF.DMTF\|UPS Battery\|001.4"), [**Units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("percent")
</dt> </dl>

Percentage estimate of the remaining full charge for a UPS that uses battery technology.
...
Qualifiers: [**MappingStrings**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("MIF.DMTF\|UPS Battery\|001.3"), [**Units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Estimated time, in minutes, until the battery, generator, or other power source is depleted under the present load conditions if the utility power is off, or is lost and remains off.
...
If **TRUE**, the power supply is a switching (rather than linear) supply.
...
Frequency, in hertz, at the high-end of the power supply's input frequency range 1. A value of 0 (zero) implies DC.
...
Frequency, in hertz, at the low-end of the power supply's input frequency range 1. A value of 0 (zero) implies DC.
...
Qualifiers: [**Override**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageHigh"), [**Units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

If the voltage, in millivolts, rises above the value specified by the **Range1InputVoltageHigh** property, the UPS will compensate by trimming the voltage. A value of 0 (zero) indicates that the voltage at which trimming occurs is unknown.
...
Qualifiers: [**Override**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageLow"), [**Units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

If the voltage, in millivolts, drops below the value specified by the **Range1InputVoltageLow** property, the UPS will compensate by boosting the voltage using its power sources. A value of 0 indicates that the voltage at which boosting occurs is unknown.
...
Frequency, in hertz, at the high-end of the power supply's input frequency range 2. A value of 0 (zero) implies DC.
...
Qualifiers: [**Override**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageHigh"), [**Units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

If the voltage, in millivolts, rises above the value specified by the **Range2InputVoltageHigh** property, the UPS will compensate by trimming the voltage. A value of 0 (zero) indicates that the voltage at which trimming occurs is unknown.
...
Qualifiers: [**Override**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageLow"), [**Units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

If the voltage, in millivolts, drops below the value specified by the **Range2InputVoltageLow** property, the UPS will compensate by boosting the voltage using its power sources. A value of 0 (zero) indicates that the voltage at which boosting occurs is unknown.
...
Qualifiers: [**MappingStrings**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("MIF.DMTF\|UPS Battery\|001.1")
</dt> </dl>

Indication of the capacity remaining in the UPS's batteries, generator, or other source.
...
Remaining estimated minutes of run-time is greater than the UPS's defined low-power state (typically, two minutes).

</dd> <dt>

<span id="Low"></span><span id="low"></span><span id="LOW"></span>

<span id="Low"></span><span id="low"></span><span id="LOW"></span>**Low** (3)


</dt> <dd>

Remaining estimated minutes of run-time is less than or equal to the UPS's defined low-power state.

</dd> <dt>

<span id="Depleted"></span><span id="depleted"></span><span id="DEPLETED"></span>

<span id="Depleted"></span><span id="depleted"></span><span id="DEPLETED"></span>**Depleted** (4)


</dt> <dd>

The UPS will be unable to sustain the present load when the utility power is lost (including the possibility that the utility power is currently absent).
...
Qualifiers: [**MappingStrings**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("MIF.DMTF\|UPS Battery\|001.2"), [**Units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("seconds")
</dt> </dl>

Elapsed time, in seconds, since the UPS last switched to battery power, generator, or other power source. Or, the time since the UPS was last restarted, whichever is less. If the UPS is online, 0 (zero) will be returned.
...
Total output power of the power supply, in milliwatts. A value of 0 (zero) denotes unknown.
...
The **CIM\_UninterruptiblePowerSupply** class is derived from [**CIM\_PowerSupply**](cim-powersupply.md).

WMI does not implement this class. For WMI classes derived from **CIM\_UninterruptiblePowerSupply**, see [Win32 Classes](win32-provider.md).
