...
The **CIM\_USBHub** class has these types of members:
...
The **CIM\_USBHub** class has these methods.



| Method                                                            | Description                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**GetDescriptor**](getdescriptor-method-in-class-cim-usbhub.md) | Returns the USB device descriptor. Not implemented by WMI.<br/>                                                                    |
| [**Reset**](reset-method-in-class-cim-usbhub.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbhub.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_USBHub** class has these properties.
...
This property is inherited from [**CIM\_USBDevice**](cim-usbdevice.md).
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_USBDevice**](cim-usbdevice.md).**CurrentConfigValue**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_USBDevice**](cim-usbdevice.md).**CurrentAlternateSettings**")
</dt> </dl>

Configuration currently selected for the device. If this value is 0 (zero), the device is unconfigured.
...
The **CIM\_USBHub** class is derived from [**CIM\_USBDevice**](cim-usbdevice.md).

WMI does not implement this class. For WMI classes derived from **CIM\_USBHub**, see [Win32 Classes](win32-provider.md).
