...
The **Win32\_SystemLoadOrderGroups** association [WMI class](wmi.retrieving_a_class) relates a computer system and a load order group.
...
Qualifiers: [**key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("PartComponent"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_LoadOrderGroup")
</dt> </dl>
