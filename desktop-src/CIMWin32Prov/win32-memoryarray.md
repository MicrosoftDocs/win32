...
The **Win32\_MemoryArray** [WMI class](https://docs.microsoft.com/windows/desktop/WmiSdk/retrieving-a-class) represents the properties of the computer system memory array and mapped addresses.
...
The **Win32\_MemoryArray** class has these types of members:
...
The **Win32\_MemoryArray** class has these methods.



| Method            | Description                                                                                                                                                                                                        |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Not implemented. To implement this method, see the [**Reset**](reset-method-in-class-cim-controller.md) method in [**Win32\_SMBIOSMemory**](win32-smbiosmemory.md) for documentation.<br/>                 |
| **SetPowerState** | Not implemented. To implement this method, see the [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) method in [**Win32\_SMBIOSMemory**](win32-smbiosmemory.md) for documentation.<br/> |
...
The **Win32\_MemoryArray** class has these properties.
...
This value comes from the **Memory Array Mapped Address** structure in the SMBIOS version information. For SMBIOS versions 2.1 thru 2.6 the value comes from the **Ending Address** member. For SMBIOS version 2.7+ the value comes from the **Extended Ending Address** member.
...
Type of error that occurred most recently. The values 12-14, which indicate whether an error is correctable, are not used with this property, but this information is found in the **CorrectableError** property.
...
This property is inherited from [**CIM\_StorageExtent**](cim-storageextent.md). The values are:

<dl> <dd>"Other"</dd> <dd>"Unknown"</dd> <dd>"None"</dd> <dd>"Parity"</dd> <dd>"Single-bit ECC"</dd> <dd>"Multi-bit ECC"</dd> <dd>"CRC"</dd> </dl>
...
This value comes from the **Memory Array Mapped Address** structure in the SMBIOS version information. For SMBIOS versions 2.1 thru 2.6 the value comes from the **Starting Address** member. For SMBIOS version 2.7+ the value comes from the **Extended Starting Address** member.
...
The **Win32\_MemoryArray** class is derived from [**Win32\_SMBIOSMemory**](win32-smbiosmemory.md).
