...
title: CIM\_InfraredController class
...
The **CIM\_InfraredController** class has these types of members:
...
The **CIM\_InfraredController** class has these methods.



| Method                                                                        | Description                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-infraredcontroller.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_InfraredController** class has these properties.
...
Date and time the controller was last reset, which could mean the controller was powered down or reinitialized.
...
The **CIM\_InfraredController** class is derived from [**CIM\_Controller**](cim-controller.md).

WMI does not implement this class. For classes derived from **CIM\_InfraredController**, see [Win32 Classes](win32-provider.md).
