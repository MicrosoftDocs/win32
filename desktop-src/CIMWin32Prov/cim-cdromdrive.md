...
The **CIM\_CDROMDrive** class has these types of members:
...
The **CIM\_CDROMDrive** class has these methods.
...
The **CIM\_CDROMDrive** class has these properties.
...
The **CIM\_CDROMDrive** class is derived from [**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).

WMI does not implement this class. For more information about classes derived from **CIM\_CDROMDrive**, see [Win32 Classes](win32-provider.md).
