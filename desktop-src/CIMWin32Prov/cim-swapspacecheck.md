...
title: 'CIM\_SwapSpaceCheck class'
---
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**TotalSwapSpaceSize**"), [**units**](https://msdn.microsoft.com/library/aa393650) ("kilobytes")
</dt> </dl>
