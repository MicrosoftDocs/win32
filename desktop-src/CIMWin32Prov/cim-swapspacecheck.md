...
The **CIM\_SwapSpaceCheck** class has these types of members:
...
The **CIM\_SwapSpaceCheck** class has these methods.



| Method                                                      | Description                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-swapspacecheck.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_SwapSpaceCheck** class has these properties.
...
Qualifiers: [**ModelCorrespondence**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**TotalSwapSpaceSize**"), [**units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("kilobytes")
</dt> </dl>

Minimum swap-space size, in kilobytes, that must be available on the target system.
