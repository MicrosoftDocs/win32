...
The **Win32\_Fan** [WMI class](https://msdn.microsoft.com/library/aa393244) represents the properties of a fan device in the computer system. For example, the CPU cooling fan.
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("revolutions per minute")
</dt> </dl>
