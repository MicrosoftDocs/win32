...
The **CIM\_FlatPanel** class represents the capabilities and management of the flat panel logical device.
...
The **CIM\_FlatPanel** class has these types of members:
...
The **CIM\_FlatPanel** class has these methods.



| Method                                                               | Description                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-flatpanel.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-flatpanel.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_FlatPanel** class has these properties.
...
Enumeration that describes the type of flat panel display.
...
<span id="Passive_Matrix_LCD"></span><span id="passive_matrix_lcd"></span><span id="PASSIVE_MATRIX_LCD"></span>**Passive Matrix LCD** (2)
...
<span id="Active_Matrix_LCD"></span><span id="active_matrix_lcd"></span><span id="ACTIVE_MATRIX_LCD"></span>**Active Matrix LCD** (3)
...
<span id="Field_Emission_Display"></span><span id="field_emission_display"></span><span id="FIELD_EMISSION_DISPLAY"></span>**Field Emission Display** (5)
...
<span id="Electro_Luminescent_Display"></span><span id="electro_luminescent_display"></span><span id="ELECTRO_LUMINESCENT_DISPLAY"></span>**Electro Luminescent Display** (6)
...
<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>**Gas Plasma** (7)
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("pixels")
</dt> </dl>
...
Description of the display illumination type.
...
Scan mode that indicates single or dual scan, for example.
...
If **TRUE**, the flat panel supports color display.
...
The **CIM\_FlatPanel** class is derived from [**CIM\_Display**](cim-display.md).
