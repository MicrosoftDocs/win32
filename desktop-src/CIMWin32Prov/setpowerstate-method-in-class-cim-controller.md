...
title: SetPowerState method of the CIM_Controller class
ms.topic: article
ms.date: 05/31/2018
topic_type: 
- APIRef
...
This method is currently not implemented by WMI. To use this method, you must implement it in your own provider. For more information, see [Creating WMI Providers](https://msdn.microsoft.com/library/cc512238).
...
[CIM\_Controller](setpowerstate-method-in-class-cim-controller.md)
</dt> <dt>
