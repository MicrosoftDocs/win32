...
title: SetIPUseZeroBroadcast method of the Win32\_NetworkAdapterConfiguration class
...
The **SetIPUseZeroBroadcast** [WMI class](https://msdn.microsoft.com/library/aa393244) static method is used to set IP zero broadcast usage.
