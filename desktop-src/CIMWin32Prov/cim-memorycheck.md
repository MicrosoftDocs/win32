...
The **CIM\_MemoryCheck** class specifies a condition for the minimum amount of memory that must be available on a system. The amount is specified in the **MemorySize** property. Details of the checks are compared with the value of the **FreePhysicalMemory** property of the [**CIM\_OperatingSystem**](cim-operatingsystem.md) object referenced by a [**CIM\_InstalledOS**](cim-installedos.md) association for the [**CIM\_ComputerSystem**](cim-computersystem.md) object that describes the environment. When the value of the **FreePhysicalMemory** property is greater than or equal to the value specified in **MemorySize**, the condition is satisfied.
...
The **CIM\_MemoryCheck** class has these types of members:
...
The **CIM\_MemoryCheck** class has these methods.



| Method                                                   | Description                                                   |
|:---------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-memorycheck.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_MemoryCheck** class has these properties.
...
Qualifiers: [**ModelCorrespondence**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM\_OperatingSystem**](cim-operatingsystem.md).**FreePhysicalMemory**"), [**units**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("kilobytes")
</dt> </dl>

Amount of memory that needs to exist on a computer system for a software element to execute properly.
...
The **CIM\_MemoryCheck** class is inherited from [**CIM\_Check**](cim-check.md).
