...
title: Rename method of the Win32\_CodecFile class
ms.date: 05/31/2018
ms.topic: article
...
The **Rename** [WMI class](https://msdn.microsoft.com/library/aa393244) method renames the codec file specified in the object path. A rename is not supported if the destination is on another drive or if overwriting an existing logical file is required.
...
Returns an integer value of 0 (zero) if the file was successfully renamed, and any other number to indicate an error.
