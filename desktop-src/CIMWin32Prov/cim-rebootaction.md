...
The **CIM\_RebootAction** class has these types of members:
...
The **CIM\_RebootAction** class has these methods.



| Method                                                    | Description                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-rebootaction.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_RebootAction** class has these properties.
