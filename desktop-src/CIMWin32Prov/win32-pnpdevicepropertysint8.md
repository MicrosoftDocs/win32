...
title: Win32\_PnPDevicePropertySint8 class
...
Represents a PnP device property of type **Sint8**.
...
The **Win32\_PnPDevicePropertySint8** class has these types of members:

-   [Properties](#properties)

### Properties

The **Win32\_PnPDevicePropertySint8** class has these properties.
