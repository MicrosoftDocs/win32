...
title: CIM\_RedundancyGroup class
...
The **CIM\_RedundancyGroup** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_RedundancyGroup** class has these properties.
...
The **CIM\_RedundancyGroup** class is derived from [**CIM\_LogicalElement**](cim-logicalelement.md).
