...
The **CIM\_ExtraCapacityGroup** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_ExtraCapacityGroup** class has these properties.
...
The **CIM\_ExtraCapacityGroup** class is derived from [**CIM\_RedundancyGroup**](cim-redundancygroup.md).
