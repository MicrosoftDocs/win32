...
title: 'Uncompress method of the Win32\_PageFile class'
---

# Uncompress method of the Win32\_PageFile class

The **Uncompress** [WMI class](https://msdn.microsoft.com/library/aa393244) method uncompresses the logical paging file (or directory) specified in the object path.
