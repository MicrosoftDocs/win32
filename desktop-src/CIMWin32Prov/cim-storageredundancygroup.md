...
title: 'CIM\_StorageRedundancyGroup class'
---
...
The **CIM\_StorageRedundancyGroup** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_StorageRedundancyGroup** class has these properties.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Redundancy Group\|001.2")
</dt> </dl>
...
The **CIM\_StorageRedundancyGroup** class is derived from [**CIM\_RedundancyGroup**](cim-redundancygroup.md).
