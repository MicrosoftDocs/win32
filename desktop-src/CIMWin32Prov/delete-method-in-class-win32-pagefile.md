...
title: Delete method of the Win32\_PageFile class
...
The **Delete** [WMI class](https://msdn.microsoft.com/library/aa393244) method deletes the logical paging file (or directory) specified in the object path.
