---
Description: Uncompresses the logical data file (or directory) that is specified in the object path. This method is inherited from CIM\_LogicalFile.
audience: developer
...
title: Uncompress method of the CIM\_DataFile class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# Uncompress method of the CIM\_DataFile class

The **Uncompress** method uncompresses the logical data file (or directory) that is specified in the object path. This method is inherited from [**CIM\_LogicalFile**](cim-logicalfile.md).
...
The **Uncompress** method in [**CIM\_DataFile**](cim-datafile.md) is implemented by WMI.
...
[**CIM\_DataFile**](uncompress-method-in-class-cim-datafile.md)
</dt> <dt>
