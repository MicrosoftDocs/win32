...
The **Win32\_SystemNetworkConnections** association [WMI class](wmi.retrieving_a_class) relates a network connection and the computer system on which it resides.
...
Qualifiers: [**key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("PartComponent"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_NetworkConnection")
</dt> </dl>
