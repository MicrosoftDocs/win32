...
title: ChangeSecurityPermissionsEx method of the Win32\_PageFile class
...
# ChangeSecurityPermissionsEx method of the Win32\_PageFile class
...
Change the system access control (SACL) list of the logical file.
...
If **true**, the change of ownership is applied recursively to files and directories in the directory specified by the [**CIM\_LogicalFile**](cim-logicalfile.md) instance.
...
The name specified is not valid.
