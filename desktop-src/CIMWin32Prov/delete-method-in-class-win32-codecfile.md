...
title: 'Delete method of the Win32\_CodecFile class'
---

# Delete method of the Win32\_CodecFile class

The **Delete** [WMI class](https://msdn.microsoft.com/library/aa393244) method deletes the logical audio or video codec file (or directory) specified in the object path.
