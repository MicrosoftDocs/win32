...
> [!Note]  
> *Password* must use a high authentication level, not less than **RPC\_C\_AUTHN\_LEVEL\_PKT\_PRIVACY**, when connecting to Winmgmt or [**CoSetProxyBlanket**](https://www.bing.com/search?q=**CoSetProxyBlanket**) on the [**IWbemServices**](https://msdn.microsoft.com/library/aa392093) pointer. If local to Winmgmt, this is not a concern.
