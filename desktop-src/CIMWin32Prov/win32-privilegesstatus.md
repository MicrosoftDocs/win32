...
The **Win32\_PrivilegesStatus** [WMI class](wmi.retrieving_a_class) reports information about privileges required to complete an operation. It may be returned when an operation failed or when a partially populated instance has been returned.
...
This property is inherited from [**\_\_ExtendedStatus**](wmi.__extendedstatus).
...
Operation that takes place at the time of a failure or anomaly. Typically, Windows Management Instrumentation (WMI) sets this property to the name of a COM API for WMI method such as the following: [**IWbemServices::CreateInstanceEnum**](wmi.iwbemservices_createinstanceenum).
...
Qualifiers: [**MappingStrings**](wmi.standard_qualifiers) ("Win32API\|AccessControl\|Windows NT Privileges")
</dt> </dl>
...
This property is inherited from [**\_\_NotifyStatus**](wmi.__notifystatus).

</dd> </dl>

## Remarks

The **Win32\_PrivilegesStatus** class is derived from [**\_\_ExtendedStatus**](wmi.__extendedstatus).
...
[**\_\_ExtendedStatus**](wmi.__extendedstatus)
</dt> </dl>
