...
The **Reset** method of the CIM\_PointingDevice class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_PointingDevice](reset-method-in-class-cim-pointingdevice.md)
</dt> <dt>
