...
title: Reset method of the CIM\_UserDevice class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Reset method of the CIM\_UserDevice class

The **Reset** method of the CIM\_UserDevice class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_UserDevice](reset-method-in-class-cim-userdevice.md)
</dt> <dt>
