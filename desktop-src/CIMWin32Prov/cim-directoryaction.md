...
title: CIM\_DirectoryAction class
...
The **CIM\_DirectoryAction** class has these types of members:
...
The **CIM\_DirectoryAction** class has these methods.



| Method                                                       | Description                                                                  |
|:-------------------------------------------------------------|:-----------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-directoryaction.md) | Takes a particular action. This method is not implemented by WMI.<br/> |
...
The **CIM\_DirectoryAction** class has these properties.
