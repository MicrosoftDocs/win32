...
The **CIM\_HeatPipe** class represents the capabilities and management of a heat pipe cooling device.
...
The **CIM\_HeatPipe** class has these types of members:
...
The **CIM\_HeatPipe** class has these methods.



| Method                                                              | Description                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-heatpipe.md)                 | Requests a reset of the logical device. Not implemented by WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-heatpipe.md) | Defines the desired power state for a logical device and when a device should be put into that state. Not implemented by WMI.<br/> |
...
The **CIM\_HeatPipe** class has these properties.
...
The **CIM\_HeatPipe** class is derived from [**CIM\_CoolingDevice**](cim-coolingdevice.md).

WMI does not implement this class. For classes derived from **CIM\_HeatPipe**, see [Win32 Classes](win32-provider.md).
