...
title: Uncompress method of the Win32\_ShortcutFile class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Uncompress method of the Win32\_ShortcutFile class

The **Uncompress** [WMI class](https://msdn.microsoft.com/library/aa393244) method uncompresses the logical shortcut file (or directory) specified in the object path.
