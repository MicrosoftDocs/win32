...
title: CompressEx method of the Win32\_CodecFile class
...
# CompressEx method of the Win32\_CodecFile class

The **CompressEx** [WMI class](https://msdn.microsoft.com/library/aa393244) method compresses the logical codec file (or directory) specified in the object path (this method is an extended version of the [**Compress**](compress-method-in-class-win32-directory.md) method).
...
Returns an value of 0 (zero) if the file was successfully compressed, and any other number to indicate an error.
