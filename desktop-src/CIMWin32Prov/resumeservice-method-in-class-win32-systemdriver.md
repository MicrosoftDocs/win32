...
title: ResumeService method of the Win32\_SystemDriver class
...
The **ResumeService** [WMI class](https://msdn.microsoft.com/library/aa393244) method attempts to place the service managed by the system driver in the resumed state.
