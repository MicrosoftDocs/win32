...
title: CIM\_ExecuteProgram class
ms.date: 05/31/2018
ms.topic: article
...
The **CIM\_ExecuteProgram** class represents files that can be executed on the system where the software element is installed.
...
The **CIM\_ExecuteProgram** class has these types of members:
...
The **CIM\_ExecuteProgram** class has these methods.



| Method                                                      | Description                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-executeprogram.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_ExecuteProgram** class has these properties.
...
String that can be invoked on a system command line.
