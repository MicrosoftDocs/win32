---
description: The SetPowerState method of the CIM\_DisketteDrive class sets the desired power state for a logical device and when a device should be put into that state.
...
WMI does not implement this class. For classes derived from [**CIM\_DisketteDrive**](cim-diskettedrive.md), see [Win32 Classes](win32-provider.md).
...
[CIM\_DisketteDrive](setpowerstate-method-in-class-cim-diskettedrive.md)
</dt> <dt>
