...
In C++, set the authentication at **RPC\_C\_AUTHN\_LEVEL\_PKT\_PRIVACY** either in [**CoInitializeSecurity**](https://www.bing.com/search?q=**CoInitializeSecurity**), for the entire process, or in [**CoSetProxyBlanket**](https://www.bing.com/search?q=**CoSetProxyBlanket**), for a connection to the [**IWbemServices**](https://msdn.microsoft.com/library/aa392093) proxy. For more information, see [Setting Authentication Using C++](https://msdn.microsoft.com/library/aa393608) and [Setting the Security on IWbemServices and Other Proxies](https://msdn.microsoft.com/library/aa393620).
