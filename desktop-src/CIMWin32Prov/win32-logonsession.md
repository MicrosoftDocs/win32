...
The **Win32\_LogonSession** [WMI class](https://msdn.microsoft.com/library/aa393244)describes the logon session or sessions associated with a user logged on to a computer system running Windows.
