...
The **CIM\_Action** class has these types of members:
...
The **CIM\_Action** class has these methods.



| Method                                              | Description                                                   |
|:----------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-action.md) | Takes a particular action. Not implemented by WMI.<br/> |
...
The **CIM\_Action** class has these properties.
...
Indicates whether a particular **CIM\_Action** object is part of a sequence of actions to transition the current software element to its next state, such as "Install", or to remove the current software element, such as "Uninstall".
...
WMI does not implement this class. See [Win32 Classes](win32-provider.md) for classes derived from **CIM\_Action**.
