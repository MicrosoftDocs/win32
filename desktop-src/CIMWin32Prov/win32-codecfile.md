...
The **Win32\_CodecFile** [WMI class](https://msdn.microsoft.com/library/aa393244) represents the audio or video codec installed on the computer system. Codecs convert one media format type to another, typically a compressed format to an uncompressed format. The name "codec" is derived from a combination of compress and decompress. For example, a codec can convert a compressed format, such as MS-ADPCM, to an uncompressed format such as PCM, which most audio hardware can play directly.
...
Bitmask that represents the access rights required to access or perform specific operations on the codec file. For bit values, see [**File and Directory Access Rights Constants**](https://msdn.microsoft.com/library/aa822867).
...
Qualifiers: [**Override**](https://msdn.microsoft.com/library/aa393650) (Description), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("Win32Registry\|System\\\\CurrentControlSet\\\\control\\\\MediaResources\\\\icm\|Description")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("Win32Registry\|SOFTWARE\\\\Microsoft\\\\Windows NT\\\\CurrentVersion\\\\drivers.desc")
</dt> </dl>
