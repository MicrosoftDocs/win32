...
The **Win32\_DesktopMonitor** [WMI class](https://msdn.microsoft.com/library/aa393244) represents the type of monitor or display device attached to the computer system.
...
The **Win32\_DesktopMonitor** class has these types of members:
...
The **Win32\_DesktopMonitor** class has these methods.



| Method            | Description                                                                                                                                                                                                        |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Reset**         | Not implemented. To implement this method, see the [**Reset**](reset-method-in-class-cim-controller.md) method in [**CIM\_DesktopMonitor**](cim-desktopmonitor.md) for documentation.<br/>                 |
| **SetPowerState** | Not implemented. To implement this method, see the [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) method in [**CIM\_DesktopMonitor**](cim-desktopmonitor.md) for documentation.<br/> |
...
The **Win32\_DesktopMonitor** class has these properties.
...
This property is inherited from [**CIM\_DesktopMonitor**](cim-desktopmonitor.md).
...
Qualifiers: [**Key**](https://msdn.microsoft.com/library/aa392157), [**Override**](https://msdn.microsoft.com/library/aa393650) ("DeviceId"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("Win32API\|Windows GDI\|HMONITOR")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("Win32API\|Device Context Functions\|[**GetDeviceCaps**](https://msdn.microsoft.com/library/windows/desktop/dd144877)"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("pixels per logical inch")
</dt> </dl>
