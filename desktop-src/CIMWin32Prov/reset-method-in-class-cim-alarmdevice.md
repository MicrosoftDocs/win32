...
title: 'Reset method of the CIM\_AlarmDevice class'
---

# Reset method of the CIM\_AlarmDevice class

The **Reset** method of the [**CIM\_AlarmDevice**](cim-alarmdevice.md) class requests a logical device reset. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_AlarmDevice](reset-method-in-class-cim-alarmdevice.md)
</dt> <dt>
