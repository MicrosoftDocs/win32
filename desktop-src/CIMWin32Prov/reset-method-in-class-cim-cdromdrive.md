...
title: Reset method of the CIM\_CDROMDrive class
...
# Reset method of the CIM\_CDROMDrive class

The **Reset** method of the CIM\_CDROMDrive class requests a reset of the logical device. This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).
...
[CIM\_CDROMDrive](reset-method-in-class-cim-cdromdrive.md)
</dt> <dt>
