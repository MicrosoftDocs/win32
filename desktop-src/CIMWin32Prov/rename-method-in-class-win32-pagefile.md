...
The **Rename** [WMI class](https://msdn.microsoft.com/library/aa393244) method renames the paging file specified in the object path. A rename is not supported if the destination is on another drive or if overwriting an existing logical file is required.
