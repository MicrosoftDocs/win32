...
The **Win32\_SystemDevices** association [WMI class](wmi.retrieving_a_class) relates a computer system and a logical device installed on that system.
...
Qualifiers: [**key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("PartComponent"), [**MappingStrings**](wmi.standard_qualifiers) ("CIM\|CIM\_LogicalDevice")
</dt> </dl>
