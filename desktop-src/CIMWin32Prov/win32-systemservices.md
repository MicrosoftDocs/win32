...
The **Win32\_SystemServices** association [WMI class](wmi.retrieving_a_class) relates a computer system and a service program that exists on the system.
...
Qualifiers: [**key**](wmi.key_qualifier), [**Override**](wmi.standard_qualifiers) ("PartComponent"), [**MappingStrings**](wmi.standard_qualifiers) ("WMI\|Win32\_Service")
</dt> </dl>
