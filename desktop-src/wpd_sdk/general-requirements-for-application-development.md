...
To create a Windows Portable Devices application, you must have the [Windows Software Development Kit (SDK)](https://developer.microsoft.com/en-us/windows/downloads) installed on your computer. The required headers and libraries appear in the following list.
