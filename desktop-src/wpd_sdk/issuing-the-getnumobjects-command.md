...
The example in this section invokes the **GetNumObjects** MTP command. (For a complete description of this command and its parameters, see the [MTP specification](http://go.microsoft.com/fwlink/p/?linkid=179917).)
