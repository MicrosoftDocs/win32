...
The example in this section invokes the **GetDevicePropValue** MTP command to retrieve the **BatteryLevel** device property. (For a complete description of this command and its parameters, see the [MTP specification](http://go.microsoft.com/fwlink/p/?linkid=179917).)
