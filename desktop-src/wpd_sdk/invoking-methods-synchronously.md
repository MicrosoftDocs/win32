...
The **InvokeMethods** method invokes the [**IPortableDeviceService::Methods**](iportabledeviceservice-capabilities.md) method to retrieve an [**IPortableDeviceServiceMethods**](iportabledeviceservicecapabilities.md) interface. Using this interface, it invokes the **BeginSync** and **EndSync** methods by calling the [**IPortableDeviceServiceMethods::Invoke**](iportabledeviceservicecapabilities-getsupportedmethods.md) method. Each time it calls **Invoke**, the application supplies the REFGUID for the method that is invoked.
