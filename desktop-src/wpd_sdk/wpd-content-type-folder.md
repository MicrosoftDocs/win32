...
| [WPD\_OBJECT\_HINT\_LOCATION\_DISPLAY\_NAME](miscellaneous-properties.md#wpd-object-hint-location-display-name)      | Recommended if the object is identified as a hint location.                                                                                                                   |
| [WPD\_OBJECT\_CAN\_DELETE](object-properties.md)                                                                     | Required if the object cannot be deleted.                                                                                                                                     |
| [WPD\_OBJECT\_LANGUAGE\_LOCALE](object-properties.md)                                                                | Optional.                                                                                                                                                                     |
| [WPD\_FOLDER\_CONTENT\_TYPES\_ALLOWED](miscellaneous-properties.md#wpd-folder-content-types-allowed)                 | Optional. If not included, the folder can accept any content types. If included, and the collection is empty, the application cannot create child objects within that folder. |
