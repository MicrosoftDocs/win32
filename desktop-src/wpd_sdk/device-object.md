...
|-----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| [WPD\_OBJECT\_ID](object-properties.md#wpd-object-id)                                                                | Required. The value is **WPD\_DEVICE\_OBJECT\_ID**.                                                         |
| [WPD\_OBJECT\_PARENT\_ID](object-properties.md#wpd-object-parent-id)                                                 | Required. The value is an empty string.                                                                     |
...
| [WPD\_OBJECT\_ISHIDDEN](object-properties.md#wpd-object-ishidden)                                                    | Required if the device object should not be shown to the user.                                              |
| [WPD\_OBJECT\_REFERENCES](object-properties.md#wpd-object-references)                                                | Required if the device object has references to other objects.                                              |
...
| [WPD\_DEVICE\_POWER\_LEVEL](device-properties.md#wpd-device-power-level)                                             | Recommended if the device has a battery.                                                                    |
...
| [WPD\_DEVICE\_SUPPORTS\_NON\_CONSUMABLE](device-properties.md#wpd-device-supports-non-consumable)                    | Required if the device supports non-consumable objects; that is, if it can be used for simple data storage. |
...
| [WPD\_DEVICE\_SUPPORTED\_DRM\_SCHEME](device-properties.md#wpd-device-supported-drm-scheme)                          | Recommended if the device supports Digital Rights Management (DRM).                                         |
...
| [WPD\_DEVICE\_FUNCTIONAL\_UNIQUE\_ID](device-properties.md#wpd-device-functional-unique-id)                          | Optional.                                                                                                   |
| [WPD\_DEVICE\_MODEL\_UNIQUE\_ID](device-properties.md#wpd-device-model-unique-id)                                    | Optional.                                                                                                   |
| [WPD\_DEVICE\_TRANSPORT](device-properties.md#wpd-device-transport)                                                  | Recommended.                                                                                                |
| [WPD\_DEVICE\_USE\_DEVICE\_STAGE](device-properties.md#wpd-device-use-device-stage)                                  | Optional.                                                                                                   |
| [WPD\_FUNCTIONAL\_OBJECT\_CATEGORY](device-properties.md#wpd-functional-object-category)                             | Required.                                                                                                   |
