...
| **WPD\_VIDEO\_FOURCC\_CODE**                     | **VT\_DWORD**  | The registered FourCC code that indicates the codec that was used for the video file. For a listing of FourCC formats, see the article [Registered FOURCC Codes and WAVE Formats](http://go.microsoft.com/fwlink/p/?linkid=22281) on the MSDN Web site. |
