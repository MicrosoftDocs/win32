...
| **WPD\_VIDEO\_FOURCC\_CODE**                     | **VT\_DWORD**  | The registered FourCC code that indicates the codec that was used for the video file. For a listing of FourCC formats, see [FOURCC codes](/windows/win32/directshow/fourcc-codes). |
