...
| **WPD\_AUDIO\_FORMAT\_CODE**     | **VT\_UI4** | The registered WAVE format code number. For a listing of registered WAVE formats, see the article [Registered FOURCC Codes and WAVE Formats](http://go.microsoft.com/fwlink/p/?linkid=22281) on the MSDN Web site. |
