...
1.  Register the server role by calling the [**UalRegisterProduct**](/previous-versions/windows/desktop/api/Ual/nf-ual-ualregisterproduct) function. Call this function either at application setup or at first launch.
2.  Allocate and populate a [**UAL\_DATA\_BLOB**](/previous-versions/windows/desktop/api/Ual/ns-ual-tagual_data_blob) structure.
3.  Start a UAL session by calling the [**UalStart**](/previous-versions/windows/desktop/api/Ual/nf-ual-ualstart) function. Call this function each time the application starts.
4.  Call the [**UalInstrument**](/previous-versions/windows/desktop/api/Ual/nf-ual-ualinstrument) function to log user access.
5.  Call the [**UalStop**](/previous-versions/windows/desktop/api/Ual/nf-ual-ualstop) function to stop the UAL session and clean up resources.
