...
keywords: ["name property Windows Media Player", "name property Windows Media Player , IWMPPlaylist interface", "IWMPPlaylist interface Windows Media Player , name property"]
topic_type:
- apiref
api_name:
- IWMPPlaylist.name
