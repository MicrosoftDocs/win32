...
Much of your work with **Media** objects involves metadata about the content of the media item, called the attributes. The topic [Media Item Attributes](media-item-attributes.md) describes how to read and change attribute values. In addition to this topic, see the [Windows Media Metadata Usage Guidelines](http://msdn.microsoft.com/library/ms867702.aspx) on the Microsoft website for more information about the attributes and their use.
