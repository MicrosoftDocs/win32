...
keywords: ["setDeleted method Windows Media Player", "setDeleted method Windows Media Player , IWMPMediaCollection interface", "IWMPMediaCollection interface Windows Media Player , setDeleted method"]
topic_type:
- apiref
api_name:
