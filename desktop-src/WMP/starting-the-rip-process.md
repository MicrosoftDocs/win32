...
After you have retrieved the ripping interface as explained in the previous section, start the ripping process by calling [IWMPCdromRip::startRip](/windows/win32/wmp/nf-wmp-iwmpcdromrip-startrip?branch=master).
...
You can stop the ripping operation by calling [IWMPCdromRip::stopRip](/windows/win32/wmp/nf-wmp-iwmpcdromrip-stoprip?branch=master).
