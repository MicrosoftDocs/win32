...
keywords: ["Windows Media Player online stores,reference", "online stores,reference", "type 1 online stores,reference", "reference for type 1 online stores"]
---
...
| [IWMPContentContainer Interface](iwmpcontentcontainer.md)                                 | Provides reference pages for methods that the online store's plug-in calls to inspect a content container. A content container represents a set of media items to be downloaded or purchased. Implemented by Windows Media Player. |
| [IWMPContentContainerList Interface](iwmpcontentcontainerlist.md)                         | Provides reference pages for methods that the online store's plug-in calls to inspect a list of content containers. Implemented by Windows Media Player.                                                                           |
| [IWMPContentPartner Interface](iwmpcontentpartner.md)                                     | Provides reference pages for methods that Windows Media Player calls to get information from the online store and to notify the online store about the user's actions. Implemented by the online store's plug-in.                  |
| [IWMPContentPartnerCallback Interface](iwmpcontentpartnercallback.md)                     | Provides reference pages for methods that the online store's plug-in calls to notify Windows Media Player about the completion of asynchronous operations. Implemented by Windows Media Player.                                    |
