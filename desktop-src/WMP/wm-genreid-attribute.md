...
ID3 version 2 is a tagging convention that was originally designed for MP3. For more information, see the [ID3 organization's website](http://go.microsoft.com/fwlink/p/?linkid=4467).
