...
For more info about the possible values for the media class attributes, see the [Windows Media Metadata Usage Guidelines](http://msdn.microsoft.com/library/ms867702.aspx).
