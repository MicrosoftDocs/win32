...
For more info about the possible values for the media class attributes, see the [Windows Media Metadata Usage Guidelines](https://msdn.microsoft.com/library/ms867702.aspx).
