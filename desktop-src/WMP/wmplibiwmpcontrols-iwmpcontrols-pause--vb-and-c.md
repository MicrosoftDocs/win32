...
keywords: ["pause method Windows Media Player", "pause method Windows Media Player , IWMPControls interface", "IWMPControls interface Windows Media Player , pause method"]
topic_type:
- apiref
api_name:
- IWMPControls.pause
...
<tbody>
<tr class="odd">
<td><pre><code>Public Sub pause()
Implements IWMPControls.pause</code></pre></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><pre><code>Public Sub pauseButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles pauseButton.Click
