...
keywords: ["durationString property Windows Media Player", "durationString property Windows Media Player , IWMPMedia interface", "IWMPMedia interface Windows Media Player , durationString property"]
topic_type:
- apiref
api_name:
