...
keywords: ["cancelNavigate method Windows Media Player", "cancelNavigate method Windows Media Player , External class", "External class Windows Media Player , cancelNavigate method"]
topic_type:
- apiref
api_name:
...
2.  The Player calls the plug-in's [GetTemplate](iwmpcontentpartner-gettemplate.md) method to determine which discovery page to display next. The Player stores the URL of the new discovery page but does not display the new discovery page at this time.
