...
keywords: ["PositionChange event Windows Media Player", "PositionChange event Windows Media Player , Player class", "Player class Windows Media Player , PositionChange event"]
topic_type:
- apiref
api_name:
