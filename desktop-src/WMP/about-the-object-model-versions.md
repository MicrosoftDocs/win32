...
Where a new or updated interface is also exposed as an object, only the object is listed. To locate the interface, refer to the [Object Model Reference for C++](object-model-reference-for-c.md). Usually, you will simply need to add the IWMP prefix to the object name. If a new interface extends an existing one, you may need to look for the latest version number. For example, Windows Media Player 9 Series introduced new properties and methods available from the [**Settings**](settings-object.md) object. In C++, these are available through the [**IWMPSettings2**](/windows/desktop/api/wmp/nn-wmp-iwmpsettings2) interface, which extends [**IWMPSettings**](/windows/desktop/api/wmp/nn-wmp-iwmpsettings).
...
-   [**IWMPEvents::PlayerDockedStateChange Event**](/windows/desktop/api/wmp/nf-wmp-iwmpevents-playerdockedstatechange)
-   [**IWMPEvents::PlayerReconnect Event**](/windows/desktop/api/wmp/nf-wmp-iwmpevents-playerreconnect)
-   [**IWMPEvents::SwitchedToControl Event**](/windows/desktop/api/wmp/nf-wmp-iwmpevents-switchedtocontrol)
-   [**IWMPEvents::SwitchedToPlayerApplication Event**](/windows/desktop/api/wmp/nf-wmp-iwmpevents-switchedtoplayerapplication)
-   [**IWMPPlayerServices Interface**](/windows/desktop/api/wmp/nn-wmp-iwmpplayerservices)
-   [**IWMPRemoteMediaServices Interface**](/windows/desktop/api/wmp/nn-wmp-iwmpremotemediaservices)
-   [**IWMPSkinManager Interface**](/windows/desktop/api/wmp/nn-wmp-iwmpskinmanager)
...
-   [**IWMPGraphCreation Interface**](/windows/desktop/api/wmpservices/nn-wmpservices-iwmpgraphcreation)
-   [**IWMPPlayerServices2 Interface**](/windows/desktop/api/wmp/nn-wmp-iwmpplayerservices2)
...
-   [**WMPDeviceStatus Enumeration**](/windows/desktop/api/wmp/ne-wmp-wmpdevicestatus)
-   [**WMPSyncState Enumeration**](/windows/desktop/api/wmp/ne-wmp-wmpsyncstate)
...
-   [**IWMPRenderConfig Interface**](/windows/desktop/api/wmprealestate/nn-wmprealestate-iwmprenderconfig)
...
-   [**WMPBurnFormat Enumeration**](/windows/desktop/api/wmp/ne-wmp-wmpburnformat)
-   [**WMPBurnState Enumeration**](/windows/desktop/api/wmp/ne-wmp-wmpburnstate)
-   [**WMPLibraryType Enumeration**](/windows/desktop/api/wmp/ne-wmp-wmplibrarytype)
-   [**WMPRipState Enumeration**](/windows/desktop/api/wmp/ne-wmp-wmpripstate)

## Added for Windows Media Player 12

-   [**IWMPAudioRenderConfig Interface**](/windows/desktop/api/wmprealestate/nn-wmprealestate-iwmpaudiorenderconfig)
-   [**IWMPEvents4 Interface**](/windows/desktop/api/wmp/nn-wmp-iwmpevents4)
-   [**IWMPLibrary2 Interface**](/windows/desktop/api/wmp/nn-wmp-iwmplibrary2)
-   [**IWMPSyncDevice3 Interface**](/windows/desktop/api/wmp/nn-wmp-iwmpsyncdevice3)
