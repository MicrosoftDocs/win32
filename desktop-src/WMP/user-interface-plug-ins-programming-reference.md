...
keywords: ["Windows Media Player,plug-ins", "Windows Media Player,user interface plug-ins", "Windows Media Player plug-ins,programming reference", "plug-ins,programming reference", "user interface plug-ins,programming reference", "UI plug-ins,programming reference", "reference for plug-ins"]
---
...
| Section                                                  | Description                                                                                                   |
|----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|
| [WMPNotifyPluginAddRemove](wmpnotifypluginaddremove.md) | An independent function used to notify Windows Media Player that a plug-in has been installed or uninstalled. |
| [IWMPPluginUI Interface](iwmppluginui.md)               | An interface to UI plug-ins.                                                                                  |
