...
You must submit your visualization for code signing so that the user can decide whether to trust your visualization before they install it. For information about code signing, see [Introduction to Code Signing](_inet_Introduction_to_Code_Signing).
