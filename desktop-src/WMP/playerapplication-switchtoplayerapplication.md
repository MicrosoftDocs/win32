...
- PlayerApplication class Windows Media Player , switchToPlayerApplication method
topic_type:
- apiref
api_name:
- PlayerApplication.switchToPlayerApplication
api_location:
- wmp.dll
api_type:
- COM
...
# PlayerApplication.switchToPlayerApplication method
