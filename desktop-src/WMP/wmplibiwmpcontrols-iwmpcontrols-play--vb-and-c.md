...
keywords: ["play method Windows Media Player", "play method Windows Media Player , IWMPControls interface", "IWMPControls interface Windows Media Player , play method"]
topic_type:
- apiref
api_name:
- IWMPControls.play
