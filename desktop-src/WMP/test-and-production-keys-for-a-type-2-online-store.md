...
You can use your test and production stores in any way you find useful. Typically, however, the distinction is as follows:
...
For detailed information about where to put your production and test keys in the user's registry, see [Registry Keys and Entries for a Type 2 Online Store](registry-keys-and-entries-for-a-type-2-online-store.md).
