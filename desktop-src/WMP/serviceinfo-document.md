...
| [ButtonTip](buttontip-element.md)           | Specifies the tooltip that is displayed when the user points to a task pane button.Type 1: optional<br/> Type 2 Music: optional<br/> Type 2 Commerce: optional<br/>                                                                                         |
