...
keywords: ["setItemInfo method Windows Media Player", "setItemInfo method Windows Media Player , Media class", "Media class Windows Media Player , setItemInfo method"]
topic_type:
- apiref
api_name:
- Media.setItemInfo
