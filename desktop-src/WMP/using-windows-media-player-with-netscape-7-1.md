...
For more information about using the Windows Media Player control with Netscape 7.1, see the [Netscape website](http://devedge-temp.mozilla.org/viewsource/2003/windows-media-in-netscape/index_en.html).

For more information about the Gecko ActiveX component, see the [StreamingMedia.com website](http://www.streamingmedia.com/article.asp?id=8584).
