...
For example, if the URL for the HTMLView webpage is http://www.proseware.com/html/HTMLView.htm and the URL for the **BaseURL** attribute is specified as http://www.proseware.com, the HTMLView webpage displays without prompting the user.
