...
keywords: ["getItemInfoByAtom method Windows Media Player", "getItemInfoByAtom method Windows Media Player , IWMPMedia interface", "IWMPMedia interface Windows Media Player , getItemInfoByAtom method"]
topic_type:
- apiref
api_name:
...
<tbody>
<tr class="odd">
<td><pre><code>Public Function getItemInfoByAtom( _
  ByVal lAtom As System.Int32 _
) As System.String
Implements IWMPMedia.getItemInfoByAtom</code></pre></td>
</tr>
</tbody>
</table>
