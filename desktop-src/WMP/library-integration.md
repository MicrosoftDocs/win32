...
keywords: ["Windows Media Player online stores,library integration", "online stores,library integration", "type 1 online stores,library integration", "Windows Media Player online stores,task panes", "online stores,task panes", "type 1 online stores,task panes", "Windows Media Player,task panes", "Windows Media Player library,integrating", "library,integrating"]
---
...
Windows Media Player retrieves an icon for each of the online store's custom tree nodes by calling [IWMPContentPartner::GetItemInfo](iwmpcontentpartner-getiteminfo.md), passing CPListIDIcon in the *bstrInfoName* parameter.
