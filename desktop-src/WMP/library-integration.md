...
Windows Media Player retrieves an icon for each of the online store's custom tree nodes by calling [IWMPContentPartner::GetItemInfo](/windows/win32/contentpartner/nf-contentpartner-iwmpcontentpartner-getiteminfo?branch=master), passing CPListIDIcon in the *bstrInfoName* parameter.
