...
keywords: ["currentPositionTimecode property Windows Media Player", "currentPositionTimecode property Windows Media Player , IWMPControls3 interface", "IWMPControls3 interface Windows Media Player , currentPositionTimecode property"]
topic_type:
- apiref
api_name:
