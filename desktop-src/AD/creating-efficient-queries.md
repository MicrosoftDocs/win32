...
| Class vs. Category    | The statement "objectClass=xyz" refers to directory objects in which "xyz" represents any class in the object class hierarchy, whereas "objectCategory=xyz", refers to those directory objects in which "xyz" identifies a specific class in the object class hierarchy. The [**objectClass**](https://msdn.microsoft.com/library/ms679012) property can take multiple values, whereas [**objectCategory**](https://msdn.microsoft.com/library/ms679011) takes a single value and is, thus, better suited for type matching of objects in a directory search.<br/>                                                                                                                                                                                          |
