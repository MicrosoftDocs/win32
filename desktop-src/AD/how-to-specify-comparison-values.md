...
The following code example shows a filter that specifies a **creationTime** set to a [**FILETIME**](https://msdn.microsoft.com/library/windows/desktop/ms724284) of "1999-12-31 23:59:59 (UTC/GMT)":
