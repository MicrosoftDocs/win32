...
description: Both the clients account and the services account must be in Windows 2000 native or mixed-mode domains because Kerberos services are not available in downlevel domains.
audience: developer
