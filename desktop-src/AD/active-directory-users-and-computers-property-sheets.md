...
2.  Create an OLE COM object that is derived from [**IDataObject**](https://www.bing.com/search?q=**IDataObject**). This data object must support the following data formats:
...
2.  Convert each class identifier string into a **CLSID** using the [**CLSIDFromString**](https://www.bing.com/search?q=**CLSIDFromString**) function.
