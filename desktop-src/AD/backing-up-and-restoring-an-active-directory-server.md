...
keywords: ["Active Directory Domain Services, using, backing up and restoring"]
---
...
For more information about backing up and restoring Certificate Services, see [Using the Certificate Services Backup and Restore Functions](https://msdn.microsoft.com/library/windows/desktop/aa388174).
