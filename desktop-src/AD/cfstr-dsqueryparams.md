...
The **CFSTR\_DSQUERYPARAMS** clipboard format is supported by the [**IDataObject**](https://www.bing.com/search?q=**IDataObject**) provided by the [**ICommonQuery::OpenQueryWindow**](/windows/desktop/api/Cmnquery/) method. The **CFSTR\_DSQUERYPARAMS** clipboard format provides a global memory handle (**HGLOBAL**) that contains a [**DSQUERYPARAMS**](/windows/desktop/api/Dsquery/ns-dsquery-dsqueryparams) structure.
...
[**IDataObject**](https://www.bing.com/search?q=**IDataObject**)
</dt> <dt>
