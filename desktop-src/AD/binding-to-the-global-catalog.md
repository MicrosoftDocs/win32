...
3.  Use the object in the container to perform the search. In C/C++, call [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**) to get an [**IDirectorySearch**](https://msdn.microsoft.com/library/aa746362) pointer on the object so that you can use the **IDirectorySearch** interface to perform the search. In Visual Basic, use the object returned from the enumeration in your ADO query.
