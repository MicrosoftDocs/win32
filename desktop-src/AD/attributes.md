...
A user object also has constructed attributes that are not stored in the directory, but are calculated by the domain controller, such as [**canonicalName**](https://msdn.microsoft.com/library/ms675436) and [**allowedAttributes**](https://msdn.microsoft.com/library/ms675217).
