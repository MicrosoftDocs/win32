...
keywords: ["WM_ADSPROP_NOTIFY_CHANGE message Active Directory"]
topic_type:
- apiref
api_name:
...
# WM\_ADSPROP\_NOTIFY\_CHANGE message

The **WM\_ADSPROP\_NOTIFY\_CHANGE** message is used internally by the notification object.
