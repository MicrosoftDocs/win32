...
1.  Call the [**GetComputerObjectName**](https://docs.microsoft.com/windows/desktop/api/secext/nf-secext-getcomputerobjectnamea) function to get the distinguished name (DN) in the directory of the computer object for the local computer.
...
To get the DNS or NetBIOS name of the local computer, call the [**GetComputerNameEx**](https://docs.microsoft.com/windows/desktop/api/sysinfoapi/nf-sysinfoapi-getcomputernameexa) function.
