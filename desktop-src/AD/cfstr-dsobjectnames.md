...
The **CFSTR\_DSOBJECTNAMES** clipboard format is supported by the [**IDataObject**](https://www.bing.com/search?q=**IDataObject**) provided by the [**ICommonQuery::OpenQueryWindow**](/windows/desktop/api/Cmnquery/) method. The **CFSTR\_DSOBJECTNAMES** clipboard format provides a global memory handle (**HGLOBAL**) that contains [**DSOBJECTNAMES**](/windows/desktop/api/Dsclient/ns-dsclient-dsobjectnames) structure.
