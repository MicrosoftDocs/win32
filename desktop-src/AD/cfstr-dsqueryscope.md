...
The **CFSTR\_DSQUERYSCOPE** clipboard format is supported by the [**IDataObject**](https://www.bing.com/search?q=**IDataObject**) provided by the [**ICommonQuery::OpenQueryWindow**](/windows/desktop/api/Cmnquery/) method. The **CFSTR\_DSQUERYSCOPE** clipboard format provides a global memory handle (**HGLOBAL**) that contains a string that specifies the query scope.
