...
The following C++ code example can be used to implement the [**IShellExtInit**](_win32_ishellextinit_cpp) methods.
...
The following C++ code example can be used to implement the [**IShellPropSheetExt**](_win32_ishellpropsheetext_cpp) methods.
