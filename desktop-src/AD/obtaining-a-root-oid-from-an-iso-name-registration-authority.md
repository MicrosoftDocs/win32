...
ms.date: 06/12/2025
# customer intent: As a Windows developer, I want to know how to obtain a root object identifier (OID) from an International Standards Organization (ISO) Name Registration Authority so that I can register my organization name and receive a root OID for administering my OID space.
---
...
[ANSI website](https://www.ansi.org/membership/member-categories)

[ISO website](https://www.iso.org/about/members)
