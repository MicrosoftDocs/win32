...
-   Creates a buffer.
-   Uses the [**IDirectoryObject**](https://msdn.microsoft.com/library/aa746355) interface to get the security descriptor of the specified object.
-   Copies the security descriptor to the buffer.
-   Returns a pointer to a [**SECURITY\_DESCRIPTOR**](https://msdn.microsoft.com/library/windows/desktop/aa379561) structure that contains the security descriptor data.
