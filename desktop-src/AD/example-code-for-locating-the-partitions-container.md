...
keywords: ["Example Code for Locating the Partitions Container AD", "Application Directory Partitions AD , Example Code for Locating the Partitions Container"]
---
...
The following C/C++ code example gets the distinguished name of the Partitions container by searching the configuration container for the [**crossRefContainer**](https://msdn.microsoft.com/library/ms682150) object.
...
The following Visual Basic Scripting Edition code example gets the distinguished name of the Partitions container by searching the configuration container for the [**crossRefContainer**](https://msdn.microsoft.com/library/ms682150) object.
...
The following C# code example gets the distinguished name of the Partitions container by searching the configuration container for the [**crossRefContainer**](https://msdn.microsoft.com/library/ms682150) object. This example uses C# with System.DirectoryServices.
...
The following Visual Basic .NET code example gets the distinguished name of the Partition container by searching the configuration container for the [**crossRefContainer**](https://msdn.microsoft.com/library/ms682150) object. This example uses Visual Basic .NET with System.DirectoryServices.
