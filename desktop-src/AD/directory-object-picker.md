...
1.  Call the [**CoCreateInstance**](https://msdn.microsoft.com/en-us/library/ms686615(v=VS.85).aspx) or [**CoCreateInstanceEx**](https://msdn.microsoft.com/en-us/library/ms680701(v=VS.85).aspx) function to create an instance of the [**IDsObjectPicker**](/windows/desktop/api/Objsel/nn-objsel-idsobjectpicker) interface.
