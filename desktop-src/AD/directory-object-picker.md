...
1.  Call the [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**) or [**CoCreateInstanceEx**](https://www.bing.com/search?q=**CoCreateInstanceEx**) function to create an instance of the [**IDsObjectPicker**](/windows/desktop/api/Objsel/nn-objsel-idsobjectpicker) interface.
