...
The code example uses the [**IDirectorySearch**](https://msdn.microsoft.com/library/aa746362) interface to search from the root of the domain partition. Before calling the [**ExecuteSearch**](https://msdn.microsoft.com/library/aa746365) method, the example calls the [**SetSearchPreference**](https://msdn.microsoft.com/library/aa746372) method to specify the **ADS\_SEARCHPREF\_SEARCH\_SCOPE**, **ADS\_SEARCHPREF\_DIRSYNC**, and **ADS\_SEARCHPREF\_TOMBSTONE** search preferences. The scope must specify a subtree search. With the **ADS\_SEARCHPREF\_DIRSYNC** search preference, specify an [**ADS\_PROV\_SPECIFIC**](https://msdn.microsoft.com/library/aa772283) structure that contains the length of the cookie and a pointer to it.
