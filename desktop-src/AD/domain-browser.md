...
An instance of the [**IDsBrowseDomainTree**](/windows/desktop/api/Dsclient/) interface is created by calling [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**) with the **CLSID\_DsDomainTreeBrowser** class identifier as shown below.
