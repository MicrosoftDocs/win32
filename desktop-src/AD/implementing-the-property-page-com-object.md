...
After the property sheet extension COM object is instantiated, the [**IShellExtInit::Initialize**](https://www.bing.com/search?q=**IShellExtInit::Initialize**) method is called. **IShellExtInit::Initialize** supplies the property sheet extension with an [**IDataObject**](8a002deb-2727-456c-8078-a9b0d5893ed4) object that contains data that pertains to the directory object that the property sheet applies.
...
The [**IDataObject**](8a002deb-2727-456c-8078-a9b0d5893ed4) pointer can be saved by the extension by incrementing the reference count of the **IDataObject**. This interface must be released when no longer required.
