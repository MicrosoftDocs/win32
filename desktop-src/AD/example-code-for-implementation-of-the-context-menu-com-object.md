...
The following code example can be used to implement the [**IShellExtInit**](_win32_ishellextinit_cpp) methods.
...
The following code example can be used to implement the [**IContextMenu**](_win32_icontextmenu_cpp) methods.
