...
keywords:
- CQPM_RELEASE message Active Directory
topic_type:
- apiref
api_name:
- CQPM_RELEASE
...
# CQPM\_RELEASE message

The **CQPM\_RELEASE** message is sent to the [**CQPageProc**](/windows/win32/Cmnquery/nc-cmnquery-lpcqpageproc?branch=master) callback function of a query form extension page when the page is about to be unloaded.
