...
keywords: ["Active Directory examples Active Directory , setting an ACE on a directory object"]
---
...
For more information, and the **schemaIDGUID** of a predefined attribute or class, see the attribute or class reference page in the [Active Directory Schema](https://msdn.microsoft.com/library/ms675085) reference. For more information, and a code example that can be used to obtain a **schemaIDGUID** programmatically, see [Reading attributeSchema and classSchema Objects](reading-attributeschema-and-classschema-objects.md).
