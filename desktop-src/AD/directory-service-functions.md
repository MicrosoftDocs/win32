...
keywords: ["Directory Service Functions"]
---
...
-   [**DsAddressToSiteNames**](dsaddresstositenames.md)
-   [**DsAddressToSiteNamesEx**](dsaddresstositenamesex.md)
-   [**DsDeregisterDnsHostRecords**](dsderegisterdnshostrecords.md)
-   [**DsEnumerateDomainTrusts**](dsenumeratedomaintrusts.md)
-   [**DsGetDcClose**](dsgetdcclose.md)
-   [**DsGetDcName**](dsgetdcname.md)
-   [**DsGetDcNext**](dsgetdcnext.md)
-   [**DsGetDcOpen**](dsgetdcopen.md)
-   [**DsGetDcSiteCoverage**](dsgetdcsitecoverage.md)
-   [**DsGetForestTrustInformationW**](dsgetforesttrustinformationw.md)
-   [**DsGetSiteName**](dsgetsitename.md)
-   [**DsMergeForestTrustInformationW**](dsmergeforesttrustinformationw.md)
-   [**DsRoleFreeMemory**](dsrolefreememory.md)
-   [**DsRoleGetPrimaryDomainInformation**](dsrolegetprimarydomaininformation.md)
-   [**DsValidateSubnetName**](dsvalidatesubnetname.md)

The DC locator, [**DsGetDcName**](dsgetdcname.md), is implemented by the Netlogon service. Each DC registers its DNS name on the DNS server and its NetBIOS name using a transport-specific mechanism, for example, in WINS. The DC locator looks up the name, then sends a datagram to, or pings, the DC that registered the name. For NetBIOS domain names, the datagram is a mailslot message. For DNS domain names, the datagram is an LDAP UDP search. Each such DC responds indicating that it is currently operational. The first DC to respond is returned to the caller.
...
To find the name of the site containing the client, use the [**DsGetSiteName**](dsgetsitename.md) function. The names of the objects in the Configuration/Sites/Subnet container must be valid subnet names. The [**DsValidateSubnetName**](dsvalidatesubnetname.md) function indicates whether a specified subnet name is valid.
