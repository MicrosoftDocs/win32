...
For example, an RPC Service can publish its endpoints in the directory using standard RPC APIs (such as [**RpcNsBindingExport**](https://msdn.microsoft.com/library/windows/desktop/aa375813)). Clients connect to the service by looking up the desired endpoint in the directory ( [**RpcNsBindingLookupBegin**](https://msdn.microsoft.com/library/windows/desktop/aa375839), [**RpcNsBindingLookupNext**](https://msdn.microsoft.com/library/windows/desktop/aa375845), and so on) and binding to it.
