...
<td style="text-align: left;">The defined length of the [<strong>CYPHER_BLOCK</strong>](/previous-versions/windows/desktop/api/MsChapp/ns-mschapp-_cypher_block) structure, in bytes.
<blockquote>
[!Note]<br />
