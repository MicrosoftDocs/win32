---
Description: CIM\_AdminDomain represents a group of systems that are administered as a single entity based on a common user, user group, or policy.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 5beec53c-0ac1-4b04-980e-aca334b37246
...
``` syntax
[UMLPackagePath("CIM::Core::CoreElements"), Version("2.10.0"), AMENDMENT]
...
| Method                                                           | Description                                                                                                                                                                                              |
|:-----------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-admindomain-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md) class.<br/> |
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (64), [**Override**](https://msdn.microsoft.com/library/aa393650) ("NameFormat"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_AdminDomain.Name")
</dt> </dl>
