...
The **MSFT\_IPAM\_ServerInventory** class has these types of members:
...
The **MSFT\_IPAM\_ServerInventory** class has these methods.



| Method                                                                                   | Description                                                                 |
|:-----------------------------------------------------------------------------------------|:----------------------------------------------------------------------------|
| [**AddIpamServerInventory**](addipamserverinventory-msft-ipam-serverinventory.md)       | Adds an infrastructure server to the IPAM server inventory.<br/>      |
| [**RemoveIpamServerInventory**](removeipamserverinventory-msft-ipam-serverinventory.md) | Deletes an infrastructure server from the IPAM server inventory.<br/> |
| [**SetIpamServerInventory**](setipamserverinventory-msft-ipam-serverinventory.md)       | Updates an infrastructure server in the IPAM server inventory.<br/>   |
...
The **MSFT\_IPAM\_ServerInventory** class has these properties.
...
Indicates whether IPAM was able to retrieve data from the server.
...
<span id="Not_started"></span><span id="not_started"></span><span id="NOT_STARTED"></span>
...
Indicates if IPAM can access the audit share on the DHCP server.
...
<span id="Not_Checked"></span><span id="not_checked"></span><span id="NOT_CHECKED"></span>
...
<span id="Unblocked"></span><span id="unblocked"></span><span id="UNBLOCKED"></span>
...
Indicates whether IPAM can make RPC (Remote Procedure Call) calls to the DHCP server.
...
Indicates whether IPAM can make RPC calls to the DNS server.
...
Indicates whether IPAM can access event logs on the DHCP server.
...
InstanceID is used to opaquely and uniquely identify an instance of this class within the scope of the instantiating Namespace. Various subclasses of this class may override this property to make it required, or a key. Such subclasses may also modify the preferred algorithms for ensuring uniqueness that are defined below.
...
Indicates whether IPAM can access the managed server.
...
An array that contains the IPv4 addresses assigned to the server.
...
An array that contains the IPv6 addresses assigned to the server.
...
<span id="Managed"></span><span id="managed"></span><span id="MANAGED"></span>

<span id="Managed"></span><span id="managed"></span><span id="MANAGED"></span>**Managed** (1)
...
<span id="Unmanaged"></span><span id="unmanaged"></span><span id="UNMANAGED"></span>

<span id="Unmanaged"></span><span id="unmanaged"></span><span id="UNMANAGED"></span>**Unmanaged** (2)
...
Provides a current status value for the operational condition of the element and can be used for providing more detail with respect to the value of *EnabledState*. It can also provide the transitional states when an element is transitioning from one state to another, such as when an element transitions between EnabledState and RequestedState, as well as other transitional conditions.
...
The operating system that the server is running.
...
The recommended action to take if the server becomes unreachable.
...
The **GUID** that uniquely identifies the server.
...
The service availability status of the server.
...
<span id="Changed"></span><span id="changed"></span><span id="CHANGED"></span>
...
<span id="Dc"></span><span id="dc"></span><span id="DC"></span>**Dc** (1)
...
<span id="Dns"></span><span id="dns"></span><span id="DNS"></span>**Dns** (2)
...
<span id="Nps"></span><span id="nps"></span><span id="NPS"></span>**Nps** (4)
...
A string indicating the current status of the object. Various operational and non-operational statuses are defined. This property is deprecated in lieu of *OperationalStatus*, which includes the same semantics in its enumeration.
