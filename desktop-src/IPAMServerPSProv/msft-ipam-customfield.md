...
The **MSFT\_IPAM\_CustomField** class has these types of members:
...
The **MSFT\_IPAM\_CustomField** class has these methods.



| Method                                                               | Description                                           |
|:---------------------------------------------------------------------|:------------------------------------------------------|
| [**AddCustomField**](addcustomfield-msft-ipam-customfield.md)       | Adds a new custom metadata field to IPAM.<br/>  |
| [**RemoveCustomField**](removecustomfield-msft-ipam-customfield.md) | Deletes a custom metadata field from IPAM.<br/> |
| [**RenameCustomField**](renamecustomfield-msft-ipam-customfield.md) | Renames a custom metadata field in IPAM.<br/>   |
...
The **MSFT\_IPAM\_CustomField** class has these properties.
...
Indicates whether the metadata field is user defined or built-in.
...
Data type: **MSFT\_IPAM\_CustomValue** array
</dt> <dt>

Access type: Read-only
</dt> <dt>

Qualifiers: [**EmbeddedInstance**](https://msdn.microsoft.com/library/aa393650) ("[**MSFT\_IPAM\_CustomValue**](msft-ipam-customvalue.md)")
</dt> </dl>

An array that contains the custom value objects that define the possible values for the metadata field.
...
An array that contains the names of the possible values for the metadata field.
...
**True** if the metadata field can only take values from an enumerated set of values; otherwise, **false**.
...
Name of the custom metadata field.
