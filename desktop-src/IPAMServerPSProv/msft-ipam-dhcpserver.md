...
The **MSFT\_IPAM\_DhcpServer** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_IPAM\_DhcpServer** class has these properties.
...
Access scope path for this DhcpServer.

</dd> <dt>

**AllowMacAddressFilters**
</dt> <dd> <dl> <dt>
...
DHCP server allow filter status for MAC Addresses.
...
DHCP server database path.

</dd> <dt>

**DenyMacAddressFilters**
</dt> <dd> <dl> <dt>
...
DHCP server deny filter status for MAC Addresses.
...
Name of the domain this server belongs to.
...
Name of the forest this server belongs to.
...
Number of IPv4 active leases on this server.
...
Indicates the IPv4 addresses currently assigned to this server.
...
Number of IPv6 active leases on this server.
...
Indicates the IPv6 addresses currently assigned to this server.
...
Whether the access scope for this DhcpServer is inherited from parent.
...
The latest date and time when Dhcp server was last refreshed.
...
Number of IPv4 scopes configured on this server.
...
Number of IPv6 scopes configured on this server.
...
DHCP server policy activation state.
...
Indicates Server status last retrieved for the role.

The possible values are.

<dt>

<span id="NotChecked"></span><span id="notchecked"></span><span id="NOTCHECKED"></span>
...
<span id="StartPending"></span><span id="startpending"></span><span id="STARTPENDING"></span>
...
<span id="StopPending"></span><span id="stoppending"></span><span id="STOPPENDING"></span>
...
<span id="ContinuePending"></span><span id="continuepending"></span><span id="CONTINUEPENDING"></span>
...
<span id="PausePending"></span><span id="pausepending"></span><span id="PAUSEPENDING"></span>
...
<span id="NotReachable"></span><span id="notreachable"></span><span id="NOTREACHABLE"></span>
...
Fully qualified domain name of the Dhcp server.
...
DHCP server IPv6 stateless logging status.
...
DHCP server Stateless purge interval.
