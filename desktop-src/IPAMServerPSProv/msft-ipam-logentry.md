---
Description: 'Describes a log entry for a synchronization error between IPAM an external system.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'f1eeb579-766e-4953-883c-c47179f6b768'
ms.prod: 'windows-server-dev'
ms.technology:
- 'internet-protocol-address-management'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: 'MSFT\_IPAM\_LogEntry class'
---

# MSFT\_IPAM\_LogEntry class
...
class MSFT_IPAM_LogEntry : CIM_LogEntry
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSFT\_IPAM\_LogEntry** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_IPAM\_LogEntry** class has these properties.
...
The category of error event.

The possible values are:

<dt>

<span id="SubnetSynchronizationError"></span><span id="subnetsynchronizationerror"></span><span id="SUBNETSYNCHRONIZATIONERROR"></span>

<span id="SubnetSynchronizationError"></span><span id="subnetsynchronizationerror"></span><span id="SUBNETSYNCHRONIZATIONERROR"></span>**SubnetSynchronizationError** (0)


</dt> <dd>

A subnet synchronization error.

</dd> <dt>

<span id="RangeSynchronizationError"></span><span id="rangesynchronizationerror"></span><span id="RANGESYNCHRONIZATIONERROR"></span>

<span id="RangeSynchronizationError"></span><span id="rangesynchronizationerror"></span><span id="RANGESYNCHRONIZATIONERROR"></span>**RangeSynchronizationError** (1)


</dt> <dd>

A range synchronization error.

</dd> <dt>

<span id="AddressSynchronizationError"></span><span id="addresssynchronizationerror"></span><span id="ADDRESSSYNCHRONIZATIONERROR"></span>

<span id="AddressSynchronizationError"></span><span id="addresssynchronizationerror"></span><span id="ADDRESSSYNCHRONIZATIONERROR"></span>**AddressSynchronizationError** (2)


</dt> <dd>

An address synchronization error.
