---
Description: Represents a DNS server.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 6031481b-f545-4d13-a9e6-88ecf7d34933
ms.prod: windows-server-dev
ms.technology:
- internet-protocol-address-management
- windows-management-instrumentation
ms.tgt_platform: multiple
title: MSFT\_IPAM\_DnsServer class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# MSFT\_IPAM\_DnsServer class
...
class MSFT_IPAM_DnsServer : CIM_LogicalElement
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSFT\_IPAM\_DnsServer** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_IPAM\_DnsServer** class has these properties.
...
Access scope path for this DnsServer.
...
Whether the access scope for this DnsServer is inherited from parent.
...
The latest date and time when DNS server was last refreshed.
