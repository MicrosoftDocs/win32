...
Represents a collection of protocol endpoints that are of the same class type and can communicate with each other. In addition, **CIM\_ConnectivityCollection** can contain systems, users, and managed elements that are related to the protocol endpoints. A connectivity collection is hosted by an admin domain or computer system.
...
The **CIM\_ConnectivityCollection** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_ConnectivityCollection** class has these properties.
