...
The **MSFT\_IPAM\_Address** class has these types of members:
...
The **MSFT\_IPAM\_Address** class has these methods.



| Method                                                                     | Description                                                                                                                                                                                         |
|:---------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AddAddress**](addaddress-msft-ipam-address.md)                         | Adds a new IP address to IPAM.<br/>                                                                                                                                                           |
| [**BulkAddOrUpdateAddress**](bulkaddorupdateaddress-msft-ipam-address.md) | Adds or updates a set of IP address objects in IPAM.<br/>                                                                                                                                     |
| [**BulkDeleteAddress**](bulkdeleteaddress-msft-ipam-address.md)           | Deletes a set of IP addresses from IPAM.<br/>                                                                                                                                                 |
| [**ExportAddress**](exportaddress-msft-ipam-address.md)                   | Exports a set of IP addresses from IPAM to a CSV file.<br/>                                                                                                                                   |
| [**FindIpamFreeAddress**](findipamfreeaddress-msft-ipam-address.md)       | Retrieves an array of IP addresses from a range of IP addresses in IPAM that are not assigned to a device.<br/>                                                                               |
| [**ImportAddress**](importaddress-msft-ipam-address.md)                   | Imports a set of IP addresses from a CSV file to IPAM.<br/>                                                                                                                                   |
| [**RequestStateChange**](msft-ipam-address-requeststatechange.md)         | Requests the specified change to the state of the IP address object.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) class.<br/> |
...
The **MSFT\_IPAM\_Address** class has these properties.
...
The scope of the IP address, such as public or private.
...
The address space associated with the IP Address.
...
The ID of the address space associated with this IP Address.
...
<span id="IPV4"></span><span id="ipv4"></span>
...
<span id="IPV6"></span><span id="ipv6"></span>
...
The asset tag for the device associated with the IP address.
...
The latest date and time on which the IP address was assigned to a device.
...
The identifier of the client node assigned to the IP address. This identifier is used by DHCP server to identify client nodes on a network.
...
The customer address of the IP Address. This property only contains a value when the **NetworkType** property is set to Customer ("3").
...
The type of device to which this IP address is assigned. The value must be a valid built in or custom field device type. The default value is "Host".
...
The synchronization status of a reservation for the IP address.
...
<span id="NotAttempted"></span><span id="notattempted"></span><span id="NOTATTEMPTED"></span>
...
<span id="CreateSuccess"></span><span id="createsuccess"></span><span id="CREATESUCCESS"></span>
...
<span id="CreateFailure"></span><span id="createfailure"></span><span id="CREATEFAILURE"></span>
...
<span id="DeleteSuccess"></span><span id="deletesuccess"></span><span id="DELETESUCCESS"></span>
...
<span id="DeleteFailure"></span><span id="deletefailure"></span><span id="DELETEFAILURE"></span>
...
The synchronization status of a DNS host record for the IP address.
...
The synchronization status of a reverse DNS record for the IP address.
...
The DHCP unique identifier for the device associated with this IP address. This is used by the clients to get an IPv6 address from a DHCP server.
...
**True** if the address is a duplicate; otherwise **false**.
...
Indicates the and time on which an IP address expires. IPAM displays an alert when an IP address expires, and does not automatically reclaim expired addresses.
...
Indicates whether the IP address is expired.
...
<span id="Alert"></span><span id="alert"></span><span id="ALERT"></span>
...
The Identity association identifier (IAID) for the device associated with this IP address.
...
Specifies the usage state of the IP address. By default the address will be marked as 'In-Use'. Custom values can also be defined for this field.
...
The IP address range associated with the IP address.
...
The latest date and time on which any property of this IP Address was modified.
...
Indicates whether the address is a virtual address.
...
The provider address space of the IP address. This property only contains a value when the **NetworkType** property is set to Provider ("2") or NonVirtualized ("1").
...
The description of the DHCP reservation for the IP address.
...
The user defined unique name of the DHCP reservation for the IP address.
...
The ID of DHCP scope for the DHCP reservation.

</dd> <dt>

**ReservationScopeName**
</dt> <dd> <dl> <dt>
...
The name of DHCP scope for the DHCP reservation.
...
The DHCP server on which to create the reservation.
...
This specifies the protocols supported by the reservation.
...
The serial number of the device associated with the IP address.
