...
Requests the specified state change.
...
Invoking the RequestStateChange method multiple times before each operation is complete, can result in earlier requests being overwritten or lost.
