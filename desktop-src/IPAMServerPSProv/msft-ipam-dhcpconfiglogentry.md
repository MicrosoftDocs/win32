---
Description: 'Describes a log entry for a DHCP configuration event in IPAM.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'c7506308-e439-4fd8-af7a-8e38d7f99cfa'
ms.prod: 'windows-server-dev'
ms.technology:
- 'internet-protocol-address-management'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: 'MSFT\_IPAM\_DhcpConfigLogEntry class'
---

# MSFT\_IPAM\_DhcpConfigLogEntry class
...
class MSFT_IPAM_DhcpConfigLogEntry : CIM_LogEntry
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSFT\_IPAM\_DhcpConfigLogEntry** class has these types of members:
...
The **MSFT\_IPAM\_DhcpConfigLogEntry** class has these methods.



| Method                                                                                            | Description                                                                               |
|:--------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------|
| [**RemoveDhcpConfigurationEvent**](removedhcpconfigurationevent-msft-ipam-dhcpconfiglogentry.md) | Deletes all DHCP configuration events that occurred before the specified date.<br/> |
...
The **MSFT\_IPAM\_DhcpConfigLogEntry** class has these properties.
...
The pre-defined keywords associated with the event data.
...
The name of the user that made the configuration change.
