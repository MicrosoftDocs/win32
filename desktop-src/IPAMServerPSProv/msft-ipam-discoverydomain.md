---
Description: 'Manages a domain of IP address infrastructure servers for IPAM, including the domain's discovery settings. The discovery settings allow IPAM to discover IP address infrastructure servers on the domain.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: 'b7ba132b-c19a-4e24-b4de-9315f07cbd6b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'internet-protocol-address-management'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: 'MSFT\_IPAM\_DiscoveryDomain class'
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# MSFT\_IPAM\_DiscoveryDomain class
...
class MSFT_IPAM_DiscoveryDomain : CIM_AdminDomain
{
  string   InstanceID;
  string   Caption;
  string   Description;
  ...
  boolean  DiscoverDc;
  boolean  DiscoverDns;
  boolean  DiscoverDhcp;
};
```

## Members

The **MSFT\_IPAM\_DiscoveryDomain** class has these types of members:
...
The **MSFT\_IPAM\_DiscoveryDomain** class has these methods.



| Method                                                                     | Description                                                                                                              |
|:---------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------|
| [**Add**](add-msft-ipam-discoverydomain.md)                               | Adds an Active Directory domain to the IPAM database that is used to discover IP infrastructure servers.<br/>      |
| [**Modify**](modify-msft-ipam-discoverydomain.md)                         | Updates the IPAM discovery settings for a domain.<br/>                                                             |
| [**Remove**](remove-msft-ipam-discoverydomain.md)                         | Deletes an Active Directory domain from the IPAM database that is used to discover IP infrastructure servers.<br/> |
| [**RequestStateChange**](msft-ipam-discoverydomain-requeststatechange.md) | Requests the specified state change to a domain in IPAM.<br/>                                                      |
...
The **MSFT\_IPAM\_DiscoveryDomain** class has these properties.
...
Qualifiers: [**Override**](https://msdn.microsoft.com/library/aa393650) (Name), [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (256), [**key**](https://msdn.microsoft.com/library/aa392157)
</dt> </dl>

Domain name to be added to the list of domains where IPAM will automatically discover IP infrastructure servers.
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (64), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_AdminDomain.Name")
</dt> </dl>
