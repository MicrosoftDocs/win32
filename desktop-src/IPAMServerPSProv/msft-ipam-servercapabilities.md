...
The **MSFT\_IPAM\_ServerCapabilities** class has these types of members:
...
The **MSFT\_IPAM\_ServerCapabilities** class has these methods.



| Method                                                                              | Description                                                |
|:------------------------------------------------------------------------------------|:-----------------------------------------------------------|
| [**DisableIpamCapability**](disableipamcapability-msft-ipam-servercapabilities.md) | Disables an optional feature on an IPAM Server.<br/> |
| [**EnableIpamCapability**](enableipamcapability-msft-ipam-servercapabilities.md)   | Enables an optional feature on an IPAM Server.<br/>  |
...
The **MSFT\_IPAM\_ServerCapabilities** class has these properties.
