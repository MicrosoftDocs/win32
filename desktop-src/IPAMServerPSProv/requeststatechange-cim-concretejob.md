...
The timeout period required by the client when waiting for the state transition. A "0" or **null** value indicates that the client does not have a timeout requirement for this state transition.
