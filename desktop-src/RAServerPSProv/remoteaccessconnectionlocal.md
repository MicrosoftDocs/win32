...
- RemoteAccessConnectionLocal.ClientIPv4Address
- RemoteAccessConnectionLocal.ClientIPv6Address
- RemoteAccessConnectionLocal.HostName
- RemoteAccessConnectionLocal.ClientExternalAddress
- RemoteAccessConnectionLocal.TunnelType
- RemoteAccessConnectionLocal.TransitionTechnology
- RemoteAccessConnectionLocal.ConnectionStartTime
- RemoteAccessConnectionLocal.ConnectionDuration
- RemoteAccessConnectionLocal.TotalBytesIn
- RemoteAccessConnectionLocal.TotalBytesOut
- RemoteAccessConnectionLocal.ConnectionType
- RemoteAccessConnectionLocal.HealthStatus
- RemoteAccessConnectionLocal.AuthMethod
api_location:
