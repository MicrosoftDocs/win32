...
- apiref
api_name:
- RemoteAccessMonitoringConnectionLocal
- RemoteAccessMonitoringConnectionLocal.ClientIPv4Address
- RemoteAccessMonitoringConnectionLocal.ClientIPv6Address
- RemoteAccessMonitoringConnectionLocal.HostName
- RemoteAccessMonitoringConnectionLocal.ClientExternalAddress
- RemoteAccessMonitoringConnectionLocal.TunnelType
- RemoteAccessMonitoringConnectionLocal.TransitionTechnology
- RemoteAccessMonitoringConnectionLocal.ConnectionStartTime
- RemoteAccessMonitoringConnectionLocal.ConnectionDuration
- RemoteAccessMonitoringConnectionLocal.TotalBytesIn
- RemoteAccessMonitoringConnectionLocal.TotalBytesOut
- RemoteAccessMonitoringConnectionLocal.ConnectionType
- RemoteAccessMonitoringConnectionLocal.HealthStatus
- RemoteAccessMonitoringConnectionLocal.AuthMethod
- RemoteAccessMonitoringConnectionLocal.UserActivityState
- RemoteAccessMonitoringConnectionLocal.Bandwidth
- RemoteAccessMonitoringConnectionLocal.UserName
api_location:
...
The **RemoteAccessMonitoringConnectionLocal** class has these types of members:

-   [Properties](#properties)

### Properties

The **RemoteAccessMonitoringConnectionLocal** class has these properties.
