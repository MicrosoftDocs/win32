...
api_name:
- MSFT_WmiError
- MSFT_WmiError.ErrorType
- MSFT_WmiError.OtherErrorType
- MSFT_WmiError.OwningEntity
- MSFT_WmiError.MessageID
- MSFT_WmiError.Message
- MSFT_WmiError.MessageArguments
- MSFT_WmiError.PerceivedSeverity
- MSFT_WmiError.ProbableCause
- MSFT_WmiError.ProbableCauseDescription
- MSFT_WmiError.RecommendedActions
- MSFT_WmiError.ErrorSource
- MSFT_WmiError.ErrorSourceFormat
- MSFT_WmiError.OtherErrorSourceFormat
- MSFT_WmiError.CIMStatusCode
- MSFT_WmiError.CIMStatusCodeDescription
- MSFT_WmiError.error_Code
- MSFT_WmiError.error_Category
- MSFT_WmiError.error_Type
- MSFT_WmiError.error_WindowsErrorMessage
api_location:
...
A Windows error object that encapsulates what is in CIM\_Error as well as includes error code, errorCategory, errorMessage and errorType.
...
``` syntax
[Indication, Exception, UMLPackagePath("CIM::Interop"), dynamic, provider("RAServerPSProvider"), AMENDMENT]
...
The **MSFT\_WmiError** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiError** class has these properties.
