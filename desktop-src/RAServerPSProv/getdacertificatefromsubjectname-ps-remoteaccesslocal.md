...
keywords: ["GetDACertificateFromSubjectName method", "GetDACertificateFromSubjectName method, PS_RemoteAccessLocal class", "PS_RemoteAccessLocal class, GetDACertificateFromSubjectName method"]
topic_type:
- apiref
api_name:
