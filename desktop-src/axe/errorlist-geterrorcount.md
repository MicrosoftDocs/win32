...
keywords:
- GetErrorCount method Access Execution Engine
- GetErrorCount method Access Execution Engine , ErrorList interface
- ErrorList interface Access Execution Engine , GetErrorCount method
topic_type:
- apiref
api_name:
