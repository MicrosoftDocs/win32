...
keywords: ["ToUInt32 method Access Execution Engine", "ToUInt32 method Access Execution Engine , Parameter interface", "Parameter interface Access Execution Engine , ToUInt32 method"]
topic_type:
- apiref
api_name:
- Parameter.ToUInt32
...
Managed code uses the [**Parameter.ToUInt32**](axe-parameter_touint32_om) method.
