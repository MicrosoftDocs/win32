...
keywords:
- GetLinkValue method Access Execution Engine
- GetLinkValue method Access Execution Engine , Link interface
- Link interface Access Execution Engine , GetLinkValue method
topic_type:
- apiref
api_name:
- Link.GetLinkValue
