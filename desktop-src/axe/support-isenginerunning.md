...
keywords: ["IsEngineRunning method Access Execution Engine", "IsEngineRunning method Access Execution Engine , Support interface", "Support interface Access Execution Engine , IsEngineRunning method"]
topic_type:
- apiref
api_name:
...
Managed code uses the [**Support.EngineRunning**](axe-support_enginerunning_om) property.
