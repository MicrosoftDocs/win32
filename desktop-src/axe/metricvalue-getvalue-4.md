...
description: Returns the value of the MetricValue for a type LONGLONG value.
ms.assetid: '33695B69-6154-4C79-9320-26ABD3267402'
...
Returns the value of the **MetricValue** for a type **LONGLONG** value.
