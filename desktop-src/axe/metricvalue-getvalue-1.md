...
description: Returns the value of the MetricValue for a type LPCWSTR value.
ms.assetid: '718F0439-58A5-4810-B55B-8D7C4D4EE6C5'
...
Returns the value of the **MetricValue** for a type **LPCWSTR** value.
