...
keywords: ["AddCategory method Access Execution Engine", "AddCategory method Access Execution Engine , Issue interface", "Issue interface Access Execution Engine , AddCategory method"]
topic_type:
- apiref
api_name:
- Issue.AddCategory
