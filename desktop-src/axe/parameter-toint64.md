...
keywords:
- ToInt64 method Access Execution Engine
- ToInt64 method Access Execution Engine , Parameter interface
- Parameter interface Access Execution Engine , ToInt64 method
topic_type:
- apiref
api_name:
- Parameter.ToInt64
...
Managed code uses the [**Parameter.ToInt64**](https://www.bing.com/search?q=**Parameter.ToInt64**) method.
