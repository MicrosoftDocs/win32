...
keywords:
- GetActivityDescription method Access Execution Engine
- GetActivityDescription method Access Execution Engine , Activity interface
- Activity interface Access Execution Engine , GetActivityDescription method
topic_type:
- apiref
api_name:
