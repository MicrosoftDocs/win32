...
keywords: ["ToUInt16 method Access Execution Engine", "ToUInt16 method Access Execution Engine , Parameter interface", "Parameter interface Access Execution Engine , ToUInt16 method"]
topic_type:
- apiref
api_name:
- Parameter.ToUInt16
...
Managed code uses the [**Parameter.ToUInt16**](axe-parameter_touint16_om) method.
