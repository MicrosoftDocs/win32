---
title: Parameter ToUInt16 method
description: Retrieve the value of the parameter as a specific data type.
ms.assetid: F6C265E7-0EA7-4F4D-93F5-71BB461BA93E
keywords:
- ToUInt16 method Access Execution Engine
- ToUInt16 method Access Execution Engine , Parameter interface
- Parameter interface Access Execution Engine , ToUInt16 method
topic_type:
- apiref
api_name:
- Parameter.ToUInt16
...
Managed code uses the [**Parameter.ToUInt16**](https://www.bing.com/search?q=**Parameter.ToUInt16**) method.
