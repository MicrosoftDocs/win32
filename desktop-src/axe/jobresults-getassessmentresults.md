...
keywords: ["GetAssessmentResults method Access Execution Engine", "GetAssessmentResults method Access Execution Engine , JobResults interface", "JobResults interface Access Execution Engine , GetAssessmentResults method"]
topic_type:
- apiref
api_name:
