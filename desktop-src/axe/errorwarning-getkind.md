...
keywords:
- GetKind method Access Execution Engine
- GetKind method Access Execution Engine , ErrorWarning interface
- ErrorWarning interface Access Execution Engine , GetKind method
topic_type:
- apiref
api_name:
