...
description: Returns the value of the MetricValue for a type UINT value.
ms.assetid: DC11CBB0-80D0-48B5-8C26-2DBF1E579541
keywords:
...
Returns the value of the **MetricValue** for a type **UINT** value.
