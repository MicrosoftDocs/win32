...
| [**GROUP\_AFFINITY**](/windows-hardware/drivers/ddi/content/miniport/ns-miniport-_group_affinity)<br/>                        | The **GROUP\_AFFINITY** structure specifies a group number and the processor [affinity](wdkgloss.a#wdkgloss-affinity) within that group.<br/>                                                                             |
