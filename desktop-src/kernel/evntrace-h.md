...
| Topic                                                         | Description                                                                                                                                                                                                                                                                                                                                                                  |
|---------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EVENT\_TRACE\_HEADER**](event-trace-header.md)<br/> | The **EVENT\_TRACE\_HEADER** structure is used to pass a WMI event to the WMI event logger. It is overlaid on the [**WNODE\_HEADER**](wnode-header.md) portion of the [**WNODE\_EVENT\_ITEM**](wnode-event-item.md) passed to [**IoWMIWriteEvent**](iowmiwriteevent.md). Information contained in the **EVENT\_TRACE\_HEADER** is written to the WMI log file.<br/> |
