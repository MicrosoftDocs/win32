...
The **EVENT\_TRACE\_HEADER** structure is used to pass a WMI event to the WMI event logger. It is overlaid on the [**WNODE\_HEADER**](/windows-hardware/drivers/ddi/content/wmistr/ns-wmistr-_wnode_header?branch=master) portion of the [**WNODE\_EVENT\_ITEM**](/windows-hardware/drivers/ddi/content/wmistr/ns-wmistr-tagwnode_event_item?branch=master) passed to [**IoWMIWriteEvent**](/windows-hardware/drivers/ddi/content/Wdm/nf-wdm-iowmiwriteevent?branch=master). Information contained in the **EVENT\_TRACE\_HEADER** is written to the WMI log file.
...
Provides information about the contents of this structure. For information about **EVENT\_TRACE\_HEADER** **Flags** values, see the **Flags** description in [**WNODE\_HEADER**](/windows-hardware/drivers/ddi/content/wmistr/ns-wmistr-_wnode_header?branch=master).
...
[**WNODE\_EVENT\_ITEM**](/windows-hardware/drivers/ddi/content/wmistr/ns-wmistr-tagwnode_event_item?branch=master)
</dt> <dt>

[**WNODE\_HEADER**](/windows-hardware/drivers/ddi/content/wmistr/ns-wmistr-_wnode_header?branch=master)
</dt> </dl>
