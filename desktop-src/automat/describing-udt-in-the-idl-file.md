...
After you have generated your header file, you must fetch the [**IRecordInfo**](irecordinfo.md) interface if you intend to pass a safearray of UDTs . For more information on passing a safearray of UDTs, see [Fetching the IRecordInfo Interface](fetching-the-irecordinfo-interface.md) or [Passing Safearray of UDTs](passing-safearray-of-udts.md).
