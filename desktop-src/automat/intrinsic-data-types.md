...
| [**BSTR**](bstr.md)         | Length-prefixed string, as described in [Dispatch Interface and API Functions](https://msdn.microsoft.com/windows/desktop/75BFF268-BD85-49C4-B761-B557F4B1C588).       |
| [**CURRENCY**](https://www.bing.com/search?q=**CURRENCY**) | 8-byte, fixed-point number.                                                                                                 |
| **DATE**                     | 64-bit floating-point fractional number of days since December 30, 1899.                                                    |
| [**DECIMAL**](https://www.bing.com/search?q=**DECIMAL**)   | 96-bit unsigned binary integer scaled by a variable power of 10. Provides a size and scale for a number.                    |
| **SCODE**                    | Built-in error type that corresponds to VT\_ERROR. Essentially identical to an HRESULT.                                     |
| [**VARIANT**](/previous-versions/windows/desktop/api/OaIdl/ns-oaidl-tagvariant)   | One of the variant data types as described in [Dispatch Interface and API Functions](https://msdn.microsoft.com/windows/desktop/75BFF268-BD85-49C4-B761-B557F4B1C588). |
...
Not all of the above types can be marshaled by Automation to another process or thread. The list of types that can be marshaled are called Automation compatible types, and are listed under the [oleautomation](https://msdn.microsoft.com/windows/desktop/335E8F55-C313-423E-A301-8EF6A38C5B05) attribute description.
