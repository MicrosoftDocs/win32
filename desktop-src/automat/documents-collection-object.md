...
| **\_NewEnum**<br/>   | VT\_DISPATCH<br/> | A special property that returns an enumerator object that implements [**IEnumVARIANT**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-ienumvariant). Required.<br/> |
