...
4.  Manipulate the object through the methods and properties exposed in its [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) interface.

5.  Terminate the object by invoking the appropriate method in its [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) interface, or by releasing all references to the object.

6.  Uninitialize OLE.

The following table shows the minimum set of functions necessary to manipulate a remote object through [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch).
...
| **QueryInterface**<br/>                               | Checks whether [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) has been implemented for the object. If so, returns a pointer to the **IDispatch** implementation.<br/>          | **IUnknown**<br/>                   |
| [**GetIDsOfNames**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-getidsofnames)<br/> | Returns dispatch identifiers (DISPIDs) for properties and methods and their parameters.<br/>                                                                   | [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch)<br/> |
| [**Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke)<br/>               | Invokes a method, or sets or gets a property of the remote object.<br/>                                                                                        | [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch)<br/> |
| **Release**<br/>                                      | Decrements the reference count for an **IUnknown** or [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) object.<br/>                                                              | **IUnknown**<br/>                   |
...
In this example, the [**Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke) function is a general-purpose function that calls [IDispatch::Invoke](https://msdn.microsoft.com/windows/desktop/964ADE8E-9D8A-4D32-BD47-AA678912A54D) to invoke a property or method of an ActiveX object. As arguments, it accepts the object's [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) implementation, the name of the member to invoke, flags that control the invocation, and a variable list of the member's arguments. It can be found in the Browse sample in the file Invhelp.cpp.

Using the object's [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) implementation and the name of the member, it calls [**GetIDsOfNames**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-getidsofnames) to get the DISPID of the requested member. The member's DISPID must be used later, in the call to [**Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke).

The invocation flags specify whether a method, PROPERTYPUT, or PROPERTYGET function is being invoked. The helper function simply passes these flags directly to [**Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke).
...
After filling the DISPPARAMS structure, the [**Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke) helper function initializes pvRet, a variant in which [IDispatch::Invoke](https://msdn.microsoft.com/windows/desktop/964ADE8E-9D8A-4D32-BD47-AA678912A54D) returns a value from the method or property. The following is the actual call to **Invoke**:
...
The variable pdisp is a pointer to the object's [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) interface. DISPID indicates the method or property being invoked. The value IID\_NULL must be specified for all [IDispatch::Invoke](https://msdn.microsoft.com/windows/desktop/964ADE8E-9D8A-4D32-BD47-AA678912A54D) calls, and LOCALE\_USER\_DEFAULT is a constant denoting the default locale identifier (LCID) for the current user. In the final two arguments, pexcepinfo and pnArgErr, [**Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke) can return error information.
...
For more information, including how to pass optional arguments, see [IDispatch::Invoke](https://msdn.microsoft.com/windows/desktop/964ADE8E-9D8A-4D32-BD47-AA678912A54D) and [Dispatch Interface and API Functions](https://msdn.microsoft.com/windows/desktop/75BFF268-BD85-49C4-B761-B557F4B1C588).
