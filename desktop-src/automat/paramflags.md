...
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="PARAMFLAG_NONE"></span><span id="paramflag_none"></span><dl> <dt>**PARAMFLAG\_NONE**</dt> <dt>0</dt> </dl>                            | Whether the parameter passes or receives information is unspecified. [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) interfaces can use this flag. <br/>                                                                                                 |
