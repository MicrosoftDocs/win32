...
[**Invoke**](idispatch-invoke.md) returns DISP\_E\_MEMBERNOTFOUND if one of the following conditions occurs:
...
This code from the Lines sample file Lines.cpp implements the [**Invoke**](idispatch-invoke.md) member function for the CLines class.
...
[**DispInvoke**](dispinvoke.md)
</dt> <dt>

[**DispGetParam**](dispgetparam.md)
</dt> <dt>

[**ITypeInfo::Invoke**](itypeinfo-invoke.md)
</dt> <dt>

[**IDispatch**](idispatch.md)
</dt> </dl>
