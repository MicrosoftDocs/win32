...
Indicates that the class does not support creation at the top level (for example, through [**ITypeInfo::CreateInstance**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-itypeinfo-createinstance) or CoCreateInstance). An object of such a class is usually obtained through a method call on another object.
