...
| Describes interfaces.<br/>                                         | \[attributes\] [dispinterface](dispinterface.md)<br/> | An interface describing the methods and properties for an object that must be accessed through [**IDispatch::Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke).<br/>                                      |
|                                                                          | \[attributes\] [interface](interface.md)<br/>         | An interface describing the methods and properties for an object that can be accessed through VTBL entries or possibly also through [**IDispatch::Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke).<br/> |
