...
1.  Implement the **IUnknown**, [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch), and virtual function table (VTBL) interfaces for the objects.
...
| Topic                                                                             | Description                                                                                                                                                                                                                                                                              |
|-----------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Initializing Exposed Objects](initializing-exposed-objects.md)<br/>       | To initialize OLE and exposed objects, use [**OleInitialize**](https://msdn.microsoft.com/library/windows/desktop/ms690134), [**CoRegisterClassObject**](https://msdn.microsoft.com/library/windows/desktop/ms693407), and [**RegisterActiveObject**](/previous-versions/windows/desktop/api/OleAuto/nf-oleauto-registeractiveobject).<br/>                                                                          |
...
| [Releasing OLE and Objects](releasing-ole-and-objects.md)<br/>             | To release OLE and the exposed objects, use the [**RevokeActiveObject**](/previous-versions/windows/desktop/api/OleAuto/nf-oleauto-revokeactiveobject), [**CoRevokeClassObject**](https://msdn.microsoft.com/library/windows/desktop/ms688650), and [OLEUninitialize](https://msdn.microsoft.com/windows/desktop/B2A8233F-7E1B-4C54-9363-7478C40C3830) functions.<br/>                                                  |
...
| [Returning Objects](returning-objects.md)<br/>                             | To return an object from a property or method, the application should return a pointer to the object's implementation of the [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) interface.<br/>                                                                                                        |
