...
1.  Implement the **IUnknown**, [**IDispatch**](/windows/previous-versions/oaidl/nn-oaidl-idispatch?branch=master), and virtual function table (VTBL) interfaces for the objects.
...
| Topic                                                                             | Description                                                                                                                                                                                                                                                                              |
|-----------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Initializing Exposed Objects](initializing-exposed-objects.md)<br/>       | To initialize OLE and exposed objects, use [**OleInitialize**](https://msdn.microsoft.com/library/windows/desktop/ms690134), [**CoRegisterClassObject**](https://msdn.microsoft.com/library/windows/desktop/ms693407), and [**RegisterActiveObject**](/windows/previous-versions/OleAuto/nf-oleauto-registeractiveobject?branch=master).<br/>                                                                          |
...
| [Releasing OLE and Objects](releasing-ole-and-objects.md)<br/>             | To release OLE and the exposed objects, use the [**RevokeActiveObject**](/windows/previous-versions/OleAuto/nf-oleauto-revokeactiveobject?branch=master), [**CoRevokeClassObject**](https://msdn.microsoft.com/library/windows/desktop/ms688650), and [OLEUninitialize](B2A8233F-7E1B-4C54-9363-7478C40C3830) functions.<br/>                                                  |
...
| [Returning Objects](returning-objects.md)<br/>                             | To return an object from a property or method, the application should return a pointer to the object's implementation of the [**IDispatch**](/windows/previous-versions/oaidl/nn-oaidl-idispatch?branch=master) interface.<br/>                                                                                                        |
