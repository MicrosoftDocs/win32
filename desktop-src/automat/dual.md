...
Identifies an interface that exposes properties and methods through [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) and directly through the VTBL.
...
A dual interface provides for both the speed of direct VTBL binding and the flexibility of [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch) binding. For this reason, dual interfaces are recommended whenever possible.
