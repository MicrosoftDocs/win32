...
Identifies an interface that exposes properties and methods through [**IDispatch**](idispatch.md) and directly through the VTBL.
...
A dual interface provides for both the speed of direct VTBL binding and the flexibility of [**IDispatch**](idispatch.md) binding. For this reason, dual interfaces are recommended whenever possible.
