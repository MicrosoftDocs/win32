...
-   [dual](1D39D64C-E23A-4249-A167-4369D5BD2B65) interface, event sinks receive events through [**IDispatch**](idispatch.md).

-   [VTBL](glossary.md) interface, event sinks receive events through VTBL.

-   [dispinterface](E8C18AE5-3D9E-4DFF-AA20-B5ACC723EACF), event sinks receive events through [**IDispatch**](idispatch.md).
