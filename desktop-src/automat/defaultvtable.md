...
The [default](50501057-73E9-40CF-BE7C-411F78E3B084) interface is an interface or dispinterface that is the default source interface. If the interface is a:

-   [dual](1D39D64C-E23A-4249-A167-4369D5BD2B65) interface, event sinks receive events through [**IDispatch**](/windows/previous-versions/oaidl/nn-oaidl-idispatch?branch=master).

-   [VTBL](glossary.md) interface, event sinks receive events through VTBL.

-   [dispinterface](E8C18AE5-3D9E-4DFF-AA20-B5ACC723EACF), event sinks receive events through [**IDispatch**](/windows/previous-versions/oaidl/nn-oaidl-idispatch?branch=master).
