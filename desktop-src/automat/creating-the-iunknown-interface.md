...
-   [QueryInterface](https://msdn.microsoft.com/windows/desktop/54D5FF80-18DB-43F2-B636-F93AC053146D) — Identifies which OLE interfaces the object supports.

-   [AddRef](https://msdn.microsoft.com/windows/desktop/B4316EFD-73D4-4995-B898-8025A316BA63) — Increments a member variable that tracks the number of references to the object.

-   [Release](https://msdn.microsoft.com/windows/desktop/4B494C6F-F0EE-4C35-AE45-ED956F40DC7A) — Decrements the member variable that tracks the instances of the object. If an object has zero references, **Release** frees the object.
