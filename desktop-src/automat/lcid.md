...
[**ITypeInfo::Invoke**](/previous-versions/windows/desktop/api/oaidl/nf-oaidl-itypeinfo-invoke) passes the LCID of the type information into the lcidparameter. Parameters with this attribute are not displayed in user-oriented browsers.
