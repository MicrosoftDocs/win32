...
When an application is started with the **/Automation** switch, it should initialize its Application object as the active object by calling [**RegisterActiveObject**](registeractiveobject.md) after it initializes OLE.
...
| Topic                                                           | Description                                                                           |
|-----------------------------------------------------------------|---------------------------------------------------------------------------------------|
| [**GetActiveObject**](getactiveobject.md)<br/>           | Retrieves a pointer to a running object that has been registered with OLE.<br/> |
| [**RegisterActiveObject**](registeractiveobject.md)<br/> | Registers an object as the active object for its class.<br/>                    |
| [**RevokeActiveObject**](revokeactiveobject.md)<br/>     | Ends an object's status as active.<br/>                                         |
