...
When an application is started with the **/Automation** switch, it should initialize its Application object as the active object by calling [**RegisterActiveObject**](/previous-versions/windows/desktop/api/OleAuto/nf-oleauto-registeractiveobject) after it initializes OLE.
...
| Topic                                                           | Description                                                                           |
|-----------------------------------------------------------------|---------------------------------------------------------------------------------------|
| [**GetActiveObject**](/previous-versions/windows/desktop/api/OleAuto/nf-oleauto-getactiveobject)<br/>           | Retrieves a pointer to a running object that has been registered with OLE.<br/> |
| [**RegisterActiveObject**](/previous-versions/windows/desktop/api/OleAuto/nf-oleauto-registeractiveobject)<br/> | Registers an object as the active object for its class.<br/>                    |
| [**RevokeActiveObject**](/previous-versions/windows/desktop/api/OleAuto/nf-oleauto-revokeactiveobject)<br/>     | Ends an object's status as active.<br/>                                         |
