...
The universally unique ID associated with the proxy/stub implementation of the interface, used internally by OLE for interprocess communication. ActiveX objects use the proxy/stub implementation of [**IDispatch**](/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch).
