...
description: Updates a share's security descriptor to grant accounts permission to access a share.
audience: developer
...
keywords: ["GrantAccess method SMB", "GrantAccess method SMB , MSFT_SmbShare class", "MSFT_SmbShare class SMB , GrantAccess method"]
topic_type:
- apiref
api_name:
