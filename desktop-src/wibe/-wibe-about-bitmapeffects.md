...
Bitmap effects ([**IMILBitmapEffect**](/previous-versions/windows/desktop/api/Mileffects/nn-mileffects-imilbitmapeffect) object) are simple pixel processing operations. A bitmap effect takes a [IWICBitmapSource Interface](http://msdn.microsoft.com/library/ms736175(VS.85).aspx) as an input and produces a new IWICBitmapSource Interface after applying the effect, such as a blur or drop shadow.
