...
Proxy function for the [**GetMetadataQueryReader**](-wic-codec-iwicbitmapframedecode-getmetadataqueryreader.md) method.
...
A pointer that receives a pointer to an [**IWICMetadataQueryReader**](-wic-codec-iwicmetadataqueryreader.md).
