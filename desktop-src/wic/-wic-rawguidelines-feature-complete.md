...
<tbody>
<tr class="odd">
<td>[<strong>IWICBitmapDecoder</strong>](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapdecoder)</td>
<td>Decoders</td>
...
<tr class="even">
<td>[<strong>IWICBitmapFrameDecode</strong>](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapframedecode)</td>
<td>Decoders</td>
...
<tr class="odd">
<td>[<strong>IWICMetadataBlockReader</strong>](/windows/desktop/api/Wincodecsdk/nn-wincodecsdk-iwicmetadatablockreader)</td>
<td>Decoders</td>
...
<tr class="even">
<td>[<strong>IWICBitmapSourceTransform</strong>](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapsourcetransform)</td>
<td>Decoders</td>
...
<tr class="odd">
<td>[<strong>IWICDevelopRaw</strong>](/windows/desktop/api/Wincodec/nn-wincodec-iwicdevelopraw)</td>
<td>Decoders</td>
...
<tr class="even">
<td>[<strong>IWICBitmapEncoder</strong>](/windows/desktop/api/wincodec/nn-wincodec-iwicbitmapencoder)</td>
<td>Encoders</td>
...
<tr class="odd">
<td>[<strong>IWICBitmapFrameEncode</strong>](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapframeencode)</td>
<td>Encoders</td>
...
<tr class="even">
<td>[<strong>IWICMetadataBlockWriter</strong>](/windows/desktop/api/Wincodecsdk/nn-wincodecsdk-iwicmetadatablockwriter)</td>
<td>Encoders</td>
