...
Note that the DDS format supports any valid [**DXGI\_FORMAT**](direct3ddxgi.dxgi_format) value. However, the WIC DDS codec only supports decoding and encoding files containing the following formats:
