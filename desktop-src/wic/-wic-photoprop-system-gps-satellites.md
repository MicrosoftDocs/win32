...
The photo metadata policy for the [System.GPS.Satellites](http://msdn.microsoft.com/en-us/library/bb760580(VS.85).aspx) property.
...
[System.GPS.Satellites](http://msdn.microsoft.com/en-us/library/bb760580(VS.85).aspx)
</dt> </dl>
