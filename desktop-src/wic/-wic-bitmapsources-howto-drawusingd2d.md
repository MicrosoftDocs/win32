...
3.  Create an [ID2D1RenderTarget](http://msdn.microsoft.com/en-us/library/dd371766(VS.85).aspx) object for rendering to a window handle.
    ...
    For more information render targets, see the Direct2D [Render Targets Overview](http://msdn.microsoft.com/en-us/library/dd371766(VS.85).aspx).

4.  Create an [ID2D1Bitmap](http://msdn.microsoft.com/en-us/library/dd756755(VS.85).aspx) object using the [ID2D1RenderTarget::CreateBitmapFromWicBitmap](http://msdn.microsoft.com/en-us/library/dd742779(VS.85).aspx) method.
...
5.  Draw the [ID2D1Bitmap](http://msdn.microsoft.com/en-us/library/dd756755(VS.85).aspx) using D2D [ID2D1RenderTarget::DrawBitmap](http://msdn.microsoft.com/en-us/library/dd742844(VS.85).aspx) method.
