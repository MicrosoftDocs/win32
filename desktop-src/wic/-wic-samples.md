...
| [Simple imaging sample](https://code.msdn.microsoft.com/Simple-Imaging-Sample-a2dec2b0)                                  | Demonstrates using the [**Windows.Graphics.Imaging**](https://www.bing.com/search?q=**Windows.Graphics.Imaging**) namespace to edit and save images and image properties.       |
