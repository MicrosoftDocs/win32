...
| [Simple imaging sample](https://code.msdn.microsoft.com/Simple-Imaging-Sample-a2dec2b0)                                  | Demonstrates using the [**Windows.Graphics.Imaging**](w_graph_img.windows_graphics_imaging) namespace to edit and save images and image properties.       |
