...
| [Simple imaging sample](https://code.msdn.microsoft.com/Simple-Imaging-Sample-a2dec2b0)                                  | Demonstrates using the [**Windows.Graphics.Imaging**](https://msdn.microsoft.com/en-us/library/BR226400(v=Win.10).aspx) namespace to edit and save images and image properties.       |
