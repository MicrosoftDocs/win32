...
The photo metadata policy for the [System.GPS.ImgDirection](http://msdn.microsoft.com/en-us/library/bb760535(VS.85).aspx) property.
...
[System.GPS.ImgDirection](http://msdn.microsoft.com/en-us/library/bb760535(VS.85).aspx)
</dt> </dl>
