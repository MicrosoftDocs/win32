...
The GIF encoder does not support any basic WIC options and does not provide custom encoder options. If an encoder option is in the [**IPropertyBag2**](_inet_IPropertyBag2_Interface) option list, it is ignored.
