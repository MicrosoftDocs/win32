...
The GIF encoder does not support any basic WIC options and does not provide custom encoder options. If an encoder option is in the [**IPropertyBag2**](https://www.bing.com/search?q=**IPropertyBag2**) option list, it is ignored.
