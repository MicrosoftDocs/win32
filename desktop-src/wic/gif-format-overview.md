...
The GIF encoder does not support any basic WIC options and does not provide custom encoder options. If an encoder option is in the [**IPropertyBag2**](c74297d0-919d-4cf5-b8f9-5bdbe5111df9) option list, it is ignored.
