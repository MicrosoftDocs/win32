...
The photo metadata policy for the [System.GPS.LongitudeRef](http://msdn.microsoft.com/en-us/library/bb760572(VS.85).aspx) property.
...
[System.GPS.LongitudeRef](http://msdn.microsoft.com/en-us/library/bb760572(VS.85).aspx)
</dt> </dl>
