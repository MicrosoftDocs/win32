...
Flags used to by [**IWICDevelopRawNotificationCallback**](/windows/win32/Wincodec/nn-wincodec-iwicdeveloprawnotificationcallback?branch=master) to indicate which members have changed.
