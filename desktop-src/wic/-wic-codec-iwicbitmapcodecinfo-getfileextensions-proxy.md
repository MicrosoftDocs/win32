...
title: IWICBitmapCodecInfo\_GetFileExtensions\_Proxy function
ms.date: 05/31/2018
ms.topic: article
...
Proxy function for the [**GetFileExtensions**](/windows/win32/Wincodec/nf-wincodec-iwicbitmapcodecinfo-getfileextensions?branch=master) method.
