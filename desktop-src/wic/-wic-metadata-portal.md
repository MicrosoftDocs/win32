...
| [People Tagging Overview](-wic-people-tagging.md)<br/>                                      | This topic introduces the new Extensible Metadata Platform (XMP) schema and the Windows 7 photo property [System.Photo.PeopleNames](http://msdn.microsoft.com/en-us/library/dd391582(VS.85).aspx) that enables the tagging of individuals in a digital photo.<br/> |
