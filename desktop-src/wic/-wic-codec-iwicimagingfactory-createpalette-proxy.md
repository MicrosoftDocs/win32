...
Proxy function for the [**CreatePalette**](/windows/win32/Wincodec/nf-wincodec-iwicimagingfactory-createpalette?branch=master) method.
...
A pointer that receives a pointer to a new [**IWICPalette**](/windows/win32/Wincodec/nn-wincodec-iwicpalette?branch=master).
