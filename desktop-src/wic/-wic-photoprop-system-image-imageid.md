...
The photo metadata policy for the [System.Image.ImageID](http://msdn.microsoft.com/en-us/library/bb787464(VS.85).aspx) property.
...
[System.Image.ImageID](http://msdn.microsoft.com/en-us/library/bb787464(VS.85).aspx)
</dt> </dl>
