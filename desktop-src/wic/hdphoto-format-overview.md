...
HD Photo does not support this encoder option. This value is ignored if present in the [**IPropertyBag2**](https://www.bing.com/search?q=**IPropertyBag2**) parameter list.
