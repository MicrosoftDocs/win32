...
If an encoder option is present in the [**IPropertyBag2**](_inet_IPropertyBag2_Interface) option list that the codec does not support, it is ignored.
...
HD Photo does not support this encoder option. This value is ignored if present in the [**IPropertyBag2**](_inet_IPropertyBag2_Interface) parameter list.
