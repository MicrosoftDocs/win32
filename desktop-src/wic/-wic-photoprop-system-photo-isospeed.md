...
The photo metadata policy for the [System.Photo.ISOSpeed](http://msdn.microsoft.com/en-us/library/bb760464(VS.85).aspx) property.
...
[System.Photo.ISOSpeed](http://msdn.microsoft.com/en-us/library/bb760464(VS.85).aspx)
</dt> </dl>
