...
The photo metadata policy for the [System.GPS.LatitudeRef](http://msdn.microsoft.com/en-us/library/bb760543(VS.85).aspx) property.
...
[System.GPS.LatitudeRef](http://msdn.microsoft.com/en-us/library/bb760543(VS.85).aspx)
</dt> </dl>
