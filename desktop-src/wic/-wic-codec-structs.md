...
| [**WICDdsFormatInfo**](/windows/desktop/api/Wincodec/ns-wincodec-wicddsformatinfo)<br/>                        | Specifies the [**DXGI\_FORMAT**](https://msdn.microsoft.com/library/windows/desktop/bb173059) and block information of a DDS format.<br/>                  |
| [**WICDdsParameters**](/windows/desktop/api/Wincodec/ns-wincodec-wicddsparameters)<br/>                        | Specifies the DDS image dimension, [**DXGI\_FORMAT**](https://msdn.microsoft.com/library/windows/desktop/bb173059) and alpha mode of contained data.<br/>  |
