...
To set encoding properties, use the [**IPropertyBag2**](c74297d0-919d-4cf5-b8f9-5bdbe5111df9) interface. For more information, see the [Encoding Overview](-wic-creating-encoder.md).
