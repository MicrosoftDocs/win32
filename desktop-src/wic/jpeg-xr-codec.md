...
To set encoding properties, use the [**IPropertyBag2**](_inet_IPropertyBag2_Interface) interface. For more information, see the [Encoding Overview](-wic-creating-encoder.md).
