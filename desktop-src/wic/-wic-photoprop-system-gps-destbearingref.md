...
The photo metadata policy for the [System.GPS.DestBearingRef](http://msdn.microsoft.com/en-us/library/bb787490(VS.85).aspx) property.
...
[System.GPS.DestBearingRef](http://msdn.microsoft.com/en-us/library/bb787490(VS.85).aspx)
</dt> </dl>
