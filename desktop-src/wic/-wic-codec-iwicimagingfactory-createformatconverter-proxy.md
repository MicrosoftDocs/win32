...
Proxy function for the [**CreateFormatConverter**](/windows/win32/Wincodec/nf-wincodec-iwicimagingfactory-createformatconverter?branch=master) method.
...
A pointer that receives a pointer to a new [**IWICFormatConverter**](/windows/win32/Wincodec/nn-wincodec-iwicformatconverter?branch=master).
