...
keywords:
- Data Deduplication API Data Deduplication API , what's new
...
[**IDedupBackupSupport**](/previous-versions/windows/desktop/api/DdpBackup/nn-ddpbackup-idedupbackupsupport) interface  
Changed methods:  
<dl>
