...
Default RSVP filter style settings can be overridden through the use of the [**RSVP\_RESERVE\_INFO**](rsvp-reserve-info.md) object by specifying one of the following values in the **Style** member of the **RSVP\_RESERVE\_INFO** object, along with required **flowdescriptors**.
...
To do this, specify RSVP\_FIXED\_FILTER\_STYLE in the Style member of the [**RSVP\_RESERVE\_INFO**](rsvp-reserve-info.md) object, followed by a list of multiple flowdescriptors. So for n explicitly identified sources, the **NumFlowDesc** member of the **RSVP\_RESERVE\_INFO** object is set to n, and the **FlowDescList** member of the **RSVP\_RESERVE\_INFO** object is set to n sender addresses/ports.
