...
The GUID\_QOS\_STATISTICS\_BUFFER structure is actually an array of [**PS\_COMPONENT\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_component_stats) structures, which in turn serve as a container structure, holding one of the five following structures in its **Stats** member:

-   [**PS\_ADAPTER\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_adapter_stats)
-   [**PS\_FLOW\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_flow_stats)
-   [**PS\_CONFORMER\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_conformer_stats)
-   [**PS\_SHAPER\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_shaper_stats)
-   [**PS\_DRRSEQ\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_drrseq_stats)
...
| GUID\_QOS\_STATISTICS\_BUFFER         | See the following. | P/I, P/F | Yes       | No            | Statistics collected for flow or interface. The GUID\_QOS\_STATISTICS\_BUFFER structure is actually an array of [**PS\_COMPONENT\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_component_stats) structures, as described in the preceding.                                  |
...
In the GUID\_QOS\_STATISTICS\_BUFFER GUID described in the table above, you must pass in a buffer that is large enough to hold all returned [**PS\_COMPONENT\_STATS**](/previous-versions/windows/desktop/api/Ntddpsch/ns-ntddpsch-_ps_component_stats) structures.
