...
The GUID\_QOS\_STATISTICS\_BUFFER structure is actually an array of [**PS\_COMPONENT\_STATS**](ps-component-stats.md) structures, which in turn serve as a container structure, holding one of the five following structures in its **Stats** member:

-   [**PS\_ADAPTER\_STATS**](ps-adapter-stats.md)
-   [**PS\_FLOW\_STATS**](ps-flow-stats.md)
-   [**PS\_CONFORMER\_STATS**](ps-conformer-stats.md)
-   [**PS\_SHAPER\_STATS**](ps-shaper-stats.md)
-   [**PS\_DRRSEQ\_STATS**](ps-drrseq-stats.md)
...
| GUID\_QOS\_STATISTICS\_BUFFER         | See the following. | P/I, P/F | Yes       | No            | Statistics collected for flow or interface. The GUID\_QOS\_STATISTICS\_BUFFER structure is actually an array of [**PS\_COMPONENT\_STATS**](ps-component-stats.md) structures, as described in the preceding.                                  |
...
In the GUID\_QOS\_STATISTICS\_BUFFER GUID described in the table above, you must pass in a buffer that is large enough to hold all returned [**PS\_COMPONENT\_STATS**](ps-component-stats.md) structures.
