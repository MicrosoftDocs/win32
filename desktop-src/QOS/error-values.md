...
| GQOS\_MTU                                                   | The Maximum Transmission Unit (MTU) in [**FLOWSPEC**](/previous-versions/windows/desktop/api/Qos/ns-qos-_flowspec) is too large.        | Adjust the packet size and retry the operation.                  |
...
| GQOS\_POLICY\_CRAZY\_FLOWSPEC                               | Policy error: invalid [**FLOWSPEC**](/previous-versions/windows/desktop/api/Qos/ns-qos-_flowspec).                                      | Check the [**FLOWSPEC**](/previous-versions/windows/desktop/api/Qos/ns-qos-_flowspec) structure.                |
