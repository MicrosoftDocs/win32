...
-   QOS parameters, through the use of the ReceivingFlowspec member of the [**QOS**](/windows/win32/Winsock2/ns-winsock2-_qualityofservice?branch=master) structure. Receiving applications generally provide such QOS parameters in a call to the [**WSAConnect**](https://msdn.microsoft.com/library/windows/desktop/ms741559) or [**WSAJoinLeaf**](https://msdn.microsoft.com/library/windows/desktop/ms741628) functions, or in a call to the WSAIoctl(SIO\_SET\_QOS) function/opcode pair.
