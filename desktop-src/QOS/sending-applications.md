...
-   QOS parameters in the form of a **SendingFlowspec** (a member of the [**QOS**](/windows/desktop/api/Winsock2/ns-winsock2-_qualityofservice) structure). This enables RSVP to generate its sender Tspec object.
...
Application programmers can also choose to use unconnected UDP sockets using **WSAIoctl**(SIO\_SET\_QOS) by specifying a [**QOS\_DESTADDR**](/previous-versions/windows/desktop/api/Qossp/ns-qossp-_qos_destaddr) object in the [ProviderSpecific](the-providerspecific-buffer.md) buffer of the [**QOS**](/windows/desktop/api/Winsock2/ns-winsock2-_qualityofservice) structure. In this scenario, the session information is derived from the **QOS\_DESTADDR** object.

> [!Note]  
> Note for unconnected UDP sockets  An application may choose to use unconnected UDP sockets by specifying a [**QOS\_DESTADDR**](/previous-versions/windows/desktop/api/Qossp/ns-qossp-_qos_destaddr) object in the [ProviderSpecific](the-providerspecific-buffer.md) buffer of the [**QOS**](/windows/desktop/api/Winsock2/ns-winsock2-_qualityofservice) structure. In this case, the session information is derived from the **QOS\_DESTADDR** object.
