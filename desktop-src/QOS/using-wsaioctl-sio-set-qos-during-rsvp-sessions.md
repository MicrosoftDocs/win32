...
-   Provide the RSVP SP with the destination address by issuing a [**QOS\_DESTADDR**](/previous-versions/windows/desktop/api/Qossp/ns-qossp-_qos_destaddr) object in the [ProviderSpecific](the-providerspecific-buffer.md) buffer.
