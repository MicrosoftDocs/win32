...
keywords:
- Quality of Service QOS , tasks, using WSAIoctl
ms.date: 05/31/2018
ms.topic: article
...
-   Provide the RSVP SP with the destination address by issuing a [**QOS\_DESTADDR**](/windows/previous-versions/Qossp/ns-qossp-_qos_destaddr?branch=master) object in the [ProviderSpecific](the-providerspecific-buffer.md) buffer.
