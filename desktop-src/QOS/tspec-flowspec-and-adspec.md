...
-   The [**FLOWSPEC**](/previous-versions/windows/desktop/api/Qos/ns-qos-_flowspec) specifies requested QOS parameters, and is used by the receiver in RESV messages.
...
The RSVP Tspec derives its parameters from the **SendingFlowspec** member of a [**QOS**](/windows/desktop/api/Winsock2/ns-winsock2-_qualityofservice) structure (SendingFlowspec is of type [**FLOWSPEC**](/previous-versions/windows/desktop/api/Qos/ns-qos-_flowspec)).
...
The RSVP Rspec specifies requested QOS parameters, and is used by the receiver in RESV messages to transmit requested reservation parameters only when GUARANTEED service is specified by the application. The Rspec derives its parameters from the ReceivingFlowspec member of a [**QOS**](/windows/desktop/api/Winsock2/ns-winsock2-_qualityofservice) structure (ReceivingFlowspec is of type [**FLOWSPEC**](/previous-versions/windows/desktop/api/Qos/ns-qos-_flowspec)).
