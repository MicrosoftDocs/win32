...
keywords: ["get_ImageProperties method", "get_ImageProperties method, ISystemMediaTransportControlsDisplayUpdater interface", "ISystemMediaTransportControlsDisplayUpdater interface, get_ImageProperties method"]
topic_type:
- apiref
api_name:
...
Type: **[**IImageDisplayProperties**](winrt-iimagedisplayproperties)\*\***
