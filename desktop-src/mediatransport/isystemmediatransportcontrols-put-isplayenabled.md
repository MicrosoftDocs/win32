...
keywords:
- put_IsPlayEnabled method
- put_IsPlayEnabled method, ISystemMediaTransportControls interface
- ISystemMediaTransportControls interface, put_IsPlayEnabled method
topic_type:
- apiref
api_name:
