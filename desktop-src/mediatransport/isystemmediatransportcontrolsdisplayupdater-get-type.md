...
keywords: ["get_Type method", "get_Type method, ISystemMediaTransportControlsDisplayUpdater interface", "ISystemMediaTransportControlsDisplayUpdater interface, get_Type method"]
topic_type:
- apiref
api_name:
