...
| [**get\_DisplayUpdater**](https://msdn.microsoft.com/library/windows/desktop/dn892321)             | Gets the display updater for the [**ISystemMediaTransportControls**](https://www.bing.com/search?q=**ISystemMediaTransportControls**) which enables updating the information displayed about the currently playing media item.<br/> |
