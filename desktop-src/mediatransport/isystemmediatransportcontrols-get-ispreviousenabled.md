...
keywords:
- get_IsPreviousEnabled method
- get_IsPreviousEnabled method, ISystemMediaTransportControls interface
- ISystemMediaTransportControls interface, get_IsPreviousEnabled method
topic_type:
- apiref
api_name:
