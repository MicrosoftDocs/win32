...
keywords: ["put_IsPauseEnabled method", "put_IsPauseEnabled method, ISystemMediaTransportControls interface", "ISystemMediaTransportControls interface, put_IsPauseEnabled method"]
topic_type:
- apiref
api_name:
