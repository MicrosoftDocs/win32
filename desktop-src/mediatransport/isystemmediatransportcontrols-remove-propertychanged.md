...
The registration token for the event handler. The token is obtained from the [**add\_PropertyChanged**](https://www.bing.com/search?q=**add\_PropertyChanged**) method.
