...
keywords:
- get_IsFastForwardEnabled method
- get_IsFastForwardEnabled method, ISystemMediaTransportControls interface
- ISystemMediaTransportControls interface, get_IsFastForwardEnabled method
topic_type:
- apiref
api_name:
