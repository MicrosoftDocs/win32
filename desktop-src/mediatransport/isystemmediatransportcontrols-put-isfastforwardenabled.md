...
keywords:
- put_IsFastForwardEnabled method
- put_IsFastForwardEnabled method, ISystemMediaTransportControls interface
- ISystemMediaTransportControls interface, put_IsFastForwardEnabled method
topic_type:
- apiref
api_name:
