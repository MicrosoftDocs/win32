...
keywords: ["get_Thumbnail method", "get_Thumbnail method, ISystemMediaTransportControlsDisplayUpdater interface", "ISystemMediaTransportControlsDisplayUpdater interface, get_Thumbnail method"]
topic_type:
- apiref
api_name:
