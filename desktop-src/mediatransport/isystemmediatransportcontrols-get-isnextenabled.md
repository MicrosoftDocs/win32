...
keywords:
- get_IsNextEnabled method
- get_IsNextEnabled method, ISystemMediaTransportControls interface
- ISystemMediaTransportControls interface, get_IsNextEnabled method
topic_type:
- apiref
api_name:
