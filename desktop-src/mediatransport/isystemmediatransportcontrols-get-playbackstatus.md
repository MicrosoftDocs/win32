...
keywords:
- get_PlaybackStatus method
- get_PlaybackStatus method, ISystemMediaTransportControls interface
- ISystemMediaTransportControls interface, get_PlaybackStatus method
topic_type:
- apiref
api_name:
