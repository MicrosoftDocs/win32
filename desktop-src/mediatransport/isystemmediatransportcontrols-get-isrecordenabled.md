...
keywords: ["get_IsRecordEnabled method", "get_IsRecordEnabled method, ISystemMediaTransportControls interface", "ISystemMediaTransportControls interface, get_IsRecordEnabled method"]
topic_type:
- apiref
api_name:
