...
> [!Note]  
> Topics located on a Web site, intranet, or other location may not be available to users who do not have Internet or network access.

 

## What do you want to do?

-   [Assign a location to a table of contents or index entry](to-assign-an-alternate-location-for-a-contents-or-index-entry.md)
