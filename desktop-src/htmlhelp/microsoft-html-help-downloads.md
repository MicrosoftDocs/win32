...
All HTML Help downloads are now available from the [Microsoft.com Download Center](http://www.microsoft.com/downloads/search.aspx?displaylang=en).

> [!Note]  
> The latest version of the HTML Help technology is 1.4, as is the SDK. The latest version of HTML Help *Workshop* is 1.3. As of June 2009 there is no HTML Help Workshop 1.4.

 

**HTML Help Workshop**

[Download Htmlhelp.exe](http://go.microsoft.com/fwlink/p/?linkid=14188)

A Japanese version of HTML Help Workshop is also available:

[Download Htmlhelpj.exe](http://go.microsoft.com/fwlink/p/?linkid=14582)

**HTML Help documentation**

[Download HelpDocs.zip](http://go.microsoft.com/fwlink/p/?linkid=14581)
...
[The end-user license agreement (EULA)](html-help-end-user-license-agreement.md) is part of the HTML Help download. You can view the agreement before you download the product.
...
> \[!Important\]  
> Close any open instances of HTML Help Workshop before reinstalling or updating to a new version. If you do not, the HTML Help ActiveX control may be registered incorrectly.
...
-   Windows XP and 2000 users can get updates from [Microsoft Windows Update](http://windowsupdate.microsoft.com).
-   Windows ME users can get updates from [Windows ME Update](http://www.microsoft.com/windowsme/update/default.asp).
-   Windows 98 users can get updates from the [811630 Security Update page](http://www.microsoft.com/windows98/downloads/contents/WUCritical/q811630/default.asp).
