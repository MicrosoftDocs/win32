...
The HTML Help Viewer is the standard three-pane help window in which a compiled help (.chm) file appears. Each pane of the Help Viewer can be manipulated through an [**HH\_WINTYPE**](/previous-versions/windows/desktop/api/HtmlHelp/ns-htmlhelp-taghh_wintype) structure.
