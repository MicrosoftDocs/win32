...
You can use an ALink to jump to topics in the same or other help files. The ALink target list will appear in a **Topics Found** dialog box when the user clicks the link. You can change this so that the [target list appears on a pop-up menu](to-have-alink-or-klink-target-topics-appear-on-a-pop-up-menu.md). For detailed information about ALinks, see the [HTML Help ActiveX control reference](alink.md).

## Related topics

<dl> <dt>

[Work with Alinks](working-with-alinks.md)
</dt> </dl>
