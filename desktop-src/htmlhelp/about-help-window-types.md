...
Pop-up windows are based on an [**HH\_POPUP**](/previous-versions/windows/desktop/api/HtmlHelp/ns-htmlhelp-taghh_popup) structure and include the following default properties:
