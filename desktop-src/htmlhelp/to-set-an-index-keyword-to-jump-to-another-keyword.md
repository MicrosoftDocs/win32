...
1.  Open an index (.hhk) file, click the keyword you want to jump to another index keyword, and then click **Edit Selection**.
...
4.  In the **File or URL** box, type the keyword you want to jump to, and then click **OK**.
