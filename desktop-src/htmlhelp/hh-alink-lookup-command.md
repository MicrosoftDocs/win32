...
| *pszFile*                                                          | *dwData*                                                          |
|--------------------------------------------------------------------|-------------------------------------------------------------------|
| Specifies the compiled help (.chm) file that contains ALink names. | Points to an [**HH\_AKLINK**](/previous-versions/windows/desktop/api/HtmlHelp/ns-htmlhelp-taghh_aklink) structure. |
