...
-   [HTML topic files](create-html-topic-files.md), which contain the text that appears on each page in your help system or Web site.
-   [Graphics and multimedia files](about-graphics-and-multimedia-files.md), which contain links to graphic, sound, video, animation, and other multimedia files.
-   [Help project files](create-a-help-project.md), which contain information about the location of your topic, graphic, and other files.
-   [Contents files](create-a-table-of-contents-file.md), which contain the information that appears in the table of contents for your help system or Web site.
-   [Index files](create-an-index-file.md), which contain the information that appears in the index for your help system or Web site.
