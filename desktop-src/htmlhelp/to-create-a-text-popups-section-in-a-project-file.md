...
1.  Open a project (.hhp) file, and then click **HTML Help API Information**. 

    |                        |                                                                                                                          |
    |------------------------|--------------------------------------------------------------------------------------------------------------------------|
    | ![](images/sb-api.gif) | Adds or removes map, alias and text pop-up files that are used by the program calling into the HtmlHelp API. <br/> |
