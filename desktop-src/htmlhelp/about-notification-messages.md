...
HTML Help sends notification messages from help windows that have the following [**HH\_WINTYPE**](/previous-versions/windows/desktop/api/HtmlHelp/ns-htmlhelp-taghh_wintype) property settings:
