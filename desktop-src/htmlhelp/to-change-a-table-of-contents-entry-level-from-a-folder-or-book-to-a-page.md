...
1.  Open the contents file, and then select the entry you want to change to a folder or book.
...
You can also use this procedure to change a page to a folder or book.
