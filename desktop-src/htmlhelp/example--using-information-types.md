...
-   Your software is broken into components. However, not all components are included when you ship your software and its documentation to other countries/regions. You can define information types to display only those topics for the components that are shipped.
