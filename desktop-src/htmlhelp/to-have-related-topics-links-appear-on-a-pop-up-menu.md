...
1.  Open the HTML file in which you want to have the Related Topics links appear on a pop-up menu.
...
5.  Select the **Display on a pop-up menu** check box, and then follow the instructions on your screen.

## Notes

-   Topics appear in a **Topics Found** dialog box by default.
-   For more information about Related Topics, see the [HTML Help ActiveX control reference](related-topics.md).
