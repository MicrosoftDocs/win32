...
Bookmarks refer to links that are in the middle of an HTML file. You can also [link to a bookmark in another topic file](to-link-to-a-bookmark-in-another-html-file.md).
