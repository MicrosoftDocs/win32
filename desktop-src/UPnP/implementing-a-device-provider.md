...
To implement a device provider, create an object that exposes the [**IUPnPDeviceProvider**](iupnpdeviceprovider.md) interface. This object must be registered with the device host using the [**IUPnPRegistrar::RegisterDeviceProvider**](iupnpregistrar-registerdeviceprovider.md) method. This method takes the following parameters:
