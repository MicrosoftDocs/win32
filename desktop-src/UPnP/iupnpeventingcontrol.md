...
This interface is obtained by calling **QueryInterface** on the same object that provides an implementation of the [IUPnPDeviceFinder](/windows/win32/api/upnp/nn-upnp-iupnpdevicefinder) interface, after which [DisableServiceEventing](iupnpeventingcontrol-disableserviceeventing.md) can be called on it.
