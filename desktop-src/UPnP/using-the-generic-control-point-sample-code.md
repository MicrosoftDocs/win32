...
The sample code for the Control Point API with UPnP technology supplied in the [Windows SDK](http://go.microsoft.com/fwlink/p/?linkid=147890) includes a Generic Control Point application. The sample code is provided in both Visual Basic and Visual C++.
