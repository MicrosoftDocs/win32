...
Device error codes are specified in [UPnP Device Architecture version 1.0](http://www.upnp.org/resources/documents.asp). The constants mentioned in this topic are defined in the files Upnp.h and Upnp.idl.
