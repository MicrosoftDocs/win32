...
| Feature                                                          | Description                                                                                                                                                                                                                                                                                                                                                                   |
|------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**IUPnPRemoteEndpointInfo**](iupnpremoteendpointinfo.md)       | This new interface allows a hosted device to obtain information about a requester (that is, a control point) and the request. It includes three methods, each of which provides a different type of information.                                                                                                                                                              |
| [Implementing Device Behavior](implementing-device-behavior.md) | This topic includes a new section that explains how to obtain endpoint information by using the new [**IUPnPRemoteEndpointInfo**](iupnpremoteendpointinfo.md) interface.                                                                                                                                                                                                     |
