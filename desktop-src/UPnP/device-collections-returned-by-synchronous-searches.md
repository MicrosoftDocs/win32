...
The first step is to request a new enumerator for the collection using the [**\_NewEnum**](https://msdn.microsoft.com/en-us/library/Aa381613(v=VS.85).aspx) property. This returns an enumerator as the [**IUnknown**](https://msdn.microsoft.com/en-us/library/ms680509(v=VS.85).aspx) interface. The sample code invokes [**IUnknown::QueryInterface**](https://msdn.microsoft.com/en-us/library/ms682521(v=VS.85).aspx) to obtain the [**IEnumVARIANT**](https://msdn.microsoft.com/en-us/library/ms221053(v=VS.71).aspx) interface. The sample code then sets the enumerator to the beginning of the collection by invoking the [**IEnumVARIANT::Reset**](https://msdn.microsoft.com/en-us/library/ms220975(v=VS.71).aspx) method. Finally, the sample code invokes the [**IEnumVARIANT::Next**](https://msdn.microsoft.com/en-us/library/ms221369(v=VS.71).aspx) method to traverse the collection. The device objects in the collection are contained within **VARIANT** structures. These structures contain pointers to [**IDispatch**](https://msdn.microsoft.com/en-us/library/ms221608(v=VS.71).aspx) interfaces on the device objects. To obtain the [**IUPnPDevice**](/windows/desktop/api/Upnp/nn-upnp-iupnpdevice) interface, the sample code invokes **QueryInterface** on the **IDispatch** interface.
