...
keywords: ["GetDataByFqdn method Software Inventory Logging", "GetDataByFqdn method Software Inventory Logging , MsftSil_GuestTasks class", "MsftSil_GuestTasks class Software Inventory Logging , GetDataByFqdn method"]
topic_type:
- apiref
api_name:
