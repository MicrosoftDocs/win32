...
keywords: ["GetDataByVmGuid method Software Inventory Logging", "GetDataByVmGuid method Software Inventory Logging , MsftSil_GuestTasks class", "MsftSil_GuestTasks class Software Inventory Logging , GetDataByVmGuid method"]
topic_type:
- apiref
api_name:
