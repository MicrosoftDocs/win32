...
When an application calls the [**SRSetRestorePoint**](srsetrestorepoint.md) function, it can provide any text as a description for the restore point; however, the following table shows the recommended description text.
