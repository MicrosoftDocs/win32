...
| <span id="RecordTypeAclInline"></span><span id="recordtypeaclinline"></span><span id="RECORDTYPEACLINLINE"></span><dl> <dt>**RecordTypeAclInline**</dt> <dt>6</dt> </dl>     | The data is an ACL. The data format is a [**SECURITY\_DESCRIPTOR**](https://msdn.microsoft.com/library/windows/desktop/aa379561) structure. <br/> This value cannot be larger than 8,192 bytes. To specify a value larger than 8,192 bytes, use the **RecordTypeAclFile** member.<br/>                |
