...
The following example uses the [**GetSystemInfo**](/windows/win32/Winbase/?branch=master) function to obtain hardware information such as the OEM identifier, processor type, page size, and so on. The example displays the information in the console.
