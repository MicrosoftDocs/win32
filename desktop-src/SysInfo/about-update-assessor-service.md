...
> [!NOTE]
> Your code must have administrator privileges to call the Waas Assessment API. For more details about developing applications that require administrator privileges, see [this article](https://docs.microsoft.com/windows/win32/secauthz/developing-applications-that-require-administrator-privilege).
