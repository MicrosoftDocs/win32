...
The **HKEY\_CLASSES\_ROOT** (**HKCR**) key contains file name extension associations and COM class registration information such as [ProgIDs](https://www.bing.com/search?q=ProgIDs), [CLSIDs](https://www.bing.com/search?q=CLSIDs), and [IIDs](https://www.bing.com/search?q=IIDs). It is primarily intended for compatibility with the registry in 16-bit Windows.
