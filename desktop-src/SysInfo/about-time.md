...
|-----------------|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| System          | [**SYSTEMTIME**](https://msdn.microsoft.com/en-us/library/ms724950(v=VS.85).aspx)                                     | Year, month, day, hour, second, and millisecond, taken from the internal hardware clock.                                            |
| Local           | [**SYSTEMTIME**](https://msdn.microsoft.com/en-us/library/ms724950(v=VS.85).aspx) or [**FILETIME**](https://msdn.microsoft.com/en-us/library/ms724284(v=VS.85).aspx) | A system time or file time converted to the system's local time zone.                                                               |
| File            | [**FILETIME**](https://msdn.microsoft.com/en-us/library/ms724284(v=VS.85).aspx)                                         | The number of 100-nanosecond intervals since January 1, 1601.                                                                       |
