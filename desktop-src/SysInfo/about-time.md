...
|-----------------|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| System          | [**SYSTEMTIME**](/windows/win32/Winbase/?branch=master)                                     | Year, month, day, hour, second, and millisecond, taken from the internal hardware clock.                                            |
| Local           | [**SYSTEMTIME**](/windows/win32/Winbase/?branch=master) or [**FILETIME**](filetime-str.md) | A system time or file time converted to the system's local time zone.                                                               |
