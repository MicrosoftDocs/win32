...
|-----------------|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| System          | [**SYSTEMTIME**](/windows/desktop/api/Winbase/)                                     | Year, month, day, hour, second, and millisecond, taken from the internal hardware clock.                                            |
| Local           | [**SYSTEMTIME**](/windows/desktop/api/Winbase/) or [**FILETIME**](https://www.bing.com/search?q=**FILETIME**) | A system time or file time converted to the system's local time zone.                                                               |
| File            | [**FILETIME**](https://www.bing.com/search?q=**FILETIME**)                                         | The number of 100-nanosecond intervals since January 1, 1601.                                                                       |
