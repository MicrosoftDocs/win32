...
To obtain the full version number for the operating system, call the [**GetFileVersionInfo**](_win32_getfileversioninfo_cpp) function on one of the system DLLs, such as Kernel32.dll, then call [**VerQueryValue**](_win32_verqueryvalue_cpp) to obtain the \\\\StringFileInfo\\\\&lt;lang&gt;&lt;codepage&gt;\\\\ProductVersion subblock of the file version information.
