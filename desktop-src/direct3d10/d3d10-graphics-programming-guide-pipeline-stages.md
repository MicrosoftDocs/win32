...
-   [Input-Assembler Stage](https://msdn.microsoft.com/windows/desktop/71141a5e-2d79-4b02-8370-c0cbc8618908) - The input-assembler stage is responsible for supplying data (triangles, lines and points) to the pipeline.
...
-   [Stream-Output Stage](https://msdn.microsoft.com/windows/desktop/f902dc93-9612-481b-a6bd-073e924a4c79) - The stream-output stage is designed for streaming primitive data from the pipeline to memory on its way to the rasterizer. Data can be streamed out and/or passed into the rasterizer. Data streamed out to memory can be recirculated back into the pipeline as input data or read-back from the CPU.
-   [Rasterizer Stage](https://msdn.microsoft.com/windows/desktop/efd3f819-7c63-4e1a-9923-8e7198354ec6) - The rasterizer is responsible for clipping primitives, preparing primitives for the pixel shader and determining how to invoke pixel shaders.
