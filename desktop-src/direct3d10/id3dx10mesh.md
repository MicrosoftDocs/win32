...
| [**GenerateGSAdjacency**](id3dx10mesh-generategsadjacency.md)                           | Adds adjacency data to the mesh's index buffer. When the mesh is to be sent to a geometry shader that takes adjacency data, it is necessary for the mesh's index buffer to contain adjacency data.<br/>                                                                                                                       |
