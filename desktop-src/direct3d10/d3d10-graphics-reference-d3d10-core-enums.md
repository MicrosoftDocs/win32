...
| [**D3D10\_REGISTER\_COMPONENT\_TYPE**](https://msdn.microsoft.com/en-us/library/Bb172409(v=VS.85).aspx) | The register component types, usually used in [**D3D10\_SIGNATURE\_PARAMETER\_DESC**](/windows/desktop/api/D3D10Shader/ns-d3d10shader-_d3d10_signature_parameter_desc).                          |
| [**D3D10\_RESOURCE\_RETURN\_TYPE**](https://msdn.microsoft.com/en-us/library/Bb172413(v=VS.85).aspx)       | The return type of a resource. See [**D3D10\_SHADER\_INPUT\_BIND\_DESC**](/windows/desktop/api/D3D10Shader/ns-d3d10shader-_d3d10_shader_input_bind_desc).                                        |
