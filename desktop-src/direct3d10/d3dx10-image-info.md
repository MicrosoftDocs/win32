...
A value from the [**DXGI\_FORMAT**](https://msdn.microsoft.com/VS|directx_sdk|~\dxgi_format.htm) enumerated type that most closely describes the data in the original image.
