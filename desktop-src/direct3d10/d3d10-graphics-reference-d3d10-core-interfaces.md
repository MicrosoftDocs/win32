...
| [**ID3D10InputLayout Interface**](/windows/desktop/api/D3D10/)             | Accesses pipeline-input data from memory.           |
...
| [**ID3D10Include Interface**](/windows/desktop/api/D3D10Shader/)           | Provides user-overridable methods for handling include files when loading an effect. |
...
| [**ID3D10Predicate Interface**](/windows/desktop/api/D3D10/)       | Determines whether geometry should be processed.                                     |
