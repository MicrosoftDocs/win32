...
To reinterpret ‘f’ as the type of ‘u’, use [memcpy](http://msdn.microsoft.com/en-us/library/dswaw1wk.aspx):
...
In the preceding reinterpretation, the underlying value of the data doesn’t change; [memcpy](http://msdn.microsoft.com/en-us/library/dswaw1wk.aspx) reinterprets the float as an unsigned integer.
