...
-   The ability to process entire primitives in the new [geometry-shader stage](direct3d10.d3d10_graphics_programming_guide_shader_stages).
-   The ability to output pipeline-generated vertex data to memory using the [stream-output stage](direct3d10.d3d10_graphics_programming_guide_output_stream_stage).
...
-   Full HLSL integration - All Direct3D 10 shaders are written in HLSL and implemented with the [common-shader core](direct3dhlsl.dx_graphics_hlsl_common_core).
