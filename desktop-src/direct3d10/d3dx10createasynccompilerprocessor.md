...
Address of a pointer to the compiled effect (see [**ID3D10Blob Interface**](id3d10blob.md)).
...
Address of a pointer to compile errors (see [**ID3D10Blob Interface**](id3d10blob.md)).
