...
-   [Building Windows 8 Blog Post – Building the next generation file system for Windows: ReFS](http://go.microsoft.com/fwlink/p/?LinkId=325504)
-   [Application Compatibility and ReFS](http://go.microsoft.com/?linkid=9797693)
