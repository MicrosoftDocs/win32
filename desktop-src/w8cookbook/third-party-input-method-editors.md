...
IMEs that are malicious or that do not follow the Windows 8 IME Guidelines can be removed from the system by using Windows Defender. For more info about malicious IMEs, see the article on [Third-party IMEs in Windows 8](https://msdn.microsoft.com/library/windows/apps/hh967426).
