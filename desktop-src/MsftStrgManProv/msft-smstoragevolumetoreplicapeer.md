---
title: MSFT\_SMStorageVolumeToReplicaPeer class
description: Represents an association between a storage volume and a replica peer.
audience: developer
...
- apiref
api_name:
- MSFT_SMStorageVolumeToReplicaPeer
- MSFT_SMStorageVolumeToReplicaPeer.WhenSynced
- MSFT_SMStorageVolumeToReplicaPeer.SyncMaintained
- MSFT_SMStorageVolumeToReplicaPeer.CopyState
- MSFT_SMStorageVolumeToReplicaPeer.CopyStateDescription
- MSFT_SMStorageVolumeToReplicaPeer.RequestedCopyState
- MSFT_SMStorageVolumeToReplicaPeer.SyncType
- MSFT_SMStorageVolumeToReplicaPeer.SyncTypeDescription
- MSFT_SMStorageVolumeToReplicaPeer.Mode
- MSFT_SMStorageVolumeToReplicaPeer.ModeDescription
- MSFT_SMStorageVolumeToReplicaPeer.ProgressStatus
- MSFT_SMStorageVolumeToReplicaPeer.ProgressStatusDescription
- MSFT_SMStorageVolumeToReplicaPeer.PercentSynced
- MSFT_SMStorageVolumeToReplicaPeer.WhenEstablished
- MSFT_SMStorageVolumeToReplicaPeer.WhenSynchronized
- MSFT_SMStorageVolumeToReplicaPeer.WhenActivated
- MSFT_SMStorageVolumeToReplicaPeer.WhenDeactivated
- MSFT_SMStorageVolumeToReplicaPeer.WhenSuspended
- MSFT_SMStorageVolumeToReplicaPeer.CopyType
- MSFT_SMStorageVolumeToReplicaPeer.CopyTypeDescription
- MSFT_SMStorageVolumeToReplicaPeer.ReplicaType
- MSFT_SMStorageVolumeToReplicaPeer.ReplicaTypeDescription
- MSFT_SMStorageVolumeToReplicaPeer.SyncState
- MSFT_SMStorageVolumeToReplicaPeer.SyncStateDescription
- MSFT_SMStorageVolumeToReplicaPeer.CopyPriority
- MSFT_SMStorageVolumeToReplicaPeer.CopyPriorityDescription
- MSFT_SMStorageVolumeToReplicaPeer.CopyMethodology
- MSFT_SMStorageVolumeToReplicaPeer.CopyMethodologyDescription
- MSFT_SMStorageVolumeToReplicaPeer.RecoveryPointObjective
- MSFT_SMStorageVolumeToReplicaPeer.Parent
- MSFT_SMStorageVolumeToReplicaPeer.Child
api_location:
- StorageService.dll
api_type:
- DllExport
...
The **MSFT\_SMStorageVolumeToReplicaPeer** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_SMStorageVolumeToReplicaPeer** class has these properties.
...
The [**MSFT\_SMStorageVolume**](msft-smstoragevolume.md) object that represents the storage volume in the association.
