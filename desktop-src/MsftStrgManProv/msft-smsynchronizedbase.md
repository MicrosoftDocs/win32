---
title: MSFT\_SMSynchronizedBase class
description: A base class for objects that represent the synchronization status of a storage object.
audience: developer
...
- MSFT_SMSynchronizedBase.WhenSynced
- MSFT_SMSynchronizedBase.SyncMaintained
- MSFT_SMSynchronizedBase.CopyState
- MSFT_SMSynchronizedBase.CopyStateDescription
- MSFT_SMSynchronizedBase.RequestedCopyState
- MSFT_SMSynchronizedBase.SyncType
- MSFT_SMSynchronizedBase.SyncTypeDescription
- MSFT_SMSynchronizedBase.Mode
- MSFT_SMSynchronizedBase.ModeDescription
- MSFT_SMSynchronizedBase.ProgressStatus
- MSFT_SMSynchronizedBase.ProgressStatusDescription
- MSFT_SMSynchronizedBase.PercentSynced
- MSFT_SMSynchronizedBase.WhenEstablished
- MSFT_SMSynchronizedBase.WhenSynchronized
- MSFT_SMSynchronizedBase.WhenActivated
- MSFT_SMSynchronizedBase.WhenDeactivated
- MSFT_SMSynchronizedBase.WhenSuspended
- MSFT_SMSynchronizedBase.CopyType
- MSFT_SMSynchronizedBase.CopyTypeDescription
api_location:
- StorageService.dll
api_type:
- DllExport
...
The **MSFT\_SMSynchronizedBase** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_SMSynchronizedBase** class has these properties.
