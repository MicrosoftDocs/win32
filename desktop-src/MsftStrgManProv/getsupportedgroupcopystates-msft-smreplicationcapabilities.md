...
keywords:
- GetSupportedGroupCopyStates method
- GetSupportedGroupCopyStates method, MSFT_SMReplicationCapabilities class
- MSFT_SMReplicationCapabilities class, GetSupportedGroupCopyStates method
topic_type:
- apiref
api_name:
