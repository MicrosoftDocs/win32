---
title: GetSupportedGroupCopyStates method of the MSFT\_SMReplicationCapabilities class
description: Retrieves the supported replication group copy states for the specified replication type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '3f533de3-f27d-42bb-8df5-2931d7d2e5b9'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetSupportedGroupCopyStates method", "GetSupportedGroupCopyStates method, MSFT_SMReplicationCapabilities class", "MSFT_SMReplicationCapabilities class, GetSupportedGroupCopyStates method"]
topic_type:
- apiref
api_name:
- MSFT_SMReplicationCapabilities.GetSupportedGroupCopyStates
api_location:
- StorageService.dll
api_type:
- COM
...
# GetSupportedGroupCopyStates method of the MSFT\_SMReplicationCapabilities class
