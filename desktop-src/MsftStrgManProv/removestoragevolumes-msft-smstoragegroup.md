---
title: RemoveStorageVolumes method of the MSFT\_SMStorageGroup class
description: Removes the specified logical units from the storage group.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'af02c48b-7728-4739-9ba2-88e6f0e0af60'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RemoveStorageVolumes method", "RemoveStorageVolumes method, MSFT_SMStorageGroup class", "MSFT_SMStorageGroup class, RemoveStorageVolumes method"]
topic_type:
- apiref
api_name:
- MSFT_SMStorageGroup.RemoveStorageVolumes
api_location:
- StorageService.dll
api_type:
- COM
...
# RemoveStorageVolumes method of the MSFT\_SMStorageGroup class

Removes the specified logical units from the storage group.

## Syntax


```mof
Uint32 RemoveStorageVolumes(
  [in]            String                LUNames[],
