---
title: CreateStorageGroup method of the MSFT\_SMSystem class
...
- apiref
api_name:
- MSFT_SMSystem.CreateStorageGroup
api_location:
- StorageService.dll
api_type:
- COM
...
Name to be assigned to the StorageGroup.
