---
title: MSFT\_SMStorageArrivalEvent class
...
ms.assetid: '60c186f1-d7ac-42ef-b18d-ceec43bbb09b'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_SMStorageArrivalEvent class", "MSFT_SMStorageArrivalEvent class, described"]
topic_type:
- apiref
api_name:
- MSFT_SMStorageArrivalEvent
- MSFT_SMStorageArrivalEvent.StorageSubsystemObjectId
- MSFT_SMStorageArrivalEvent.SourceInstance
- MSFT_SMStorageArrivalEvent.Description
- MSFT_SMStorageArrivalEvent.EventTime
- MSFT_SMStorageArrivalEvent.PerceivedSeverity
- MSFT_SMStorageArrivalEvent.SourceClassName
api_location:
- StorageService.dll
api_type:
- DllExport
...
# MSFT\_SMStorageArrivalEvent class
...
class MSFT_SMStorageArrivalEvent : MSFT_SMStorageEvent
{
...
The **MSFT\_SMStorageArrivalEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_SMStorageArrivalEvent** class has these properties.
