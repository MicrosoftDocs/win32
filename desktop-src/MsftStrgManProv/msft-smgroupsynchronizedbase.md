---
title: MSFT\_SMGroupSynchronizedBase class
description: Represents the synchronization status of a replication group.
audience: developer
...
- apiref
api_name:
- MSFT_SMGroupSynchronizedBase
- MSFT_SMGroupSynchronizedBase.WhenSynced
- MSFT_SMGroupSynchronizedBase.SyncMaintained
- MSFT_SMGroupSynchronizedBase.CopyState
- MSFT_SMGroupSynchronizedBase.CopyStateDescription
- MSFT_SMGroupSynchronizedBase.RequestedCopyState
- MSFT_SMGroupSynchronizedBase.SyncType
- MSFT_SMGroupSynchronizedBase.SyncTypeDescription
- MSFT_SMGroupSynchronizedBase.Mode
- MSFT_SMGroupSynchronizedBase.ModeDescription
- MSFT_SMGroupSynchronizedBase.ProgressStatus
- MSFT_SMGroupSynchronizedBase.ProgressStatusDescription
- MSFT_SMGroupSynchronizedBase.PercentSynced
- MSFT_SMGroupSynchronizedBase.WhenEstablished
- MSFT_SMGroupSynchronizedBase.WhenSynchronized
- MSFT_SMGroupSynchronizedBase.WhenActivated
- MSFT_SMGroupSynchronizedBase.WhenDeactivated
- MSFT_SMGroupSynchronizedBase.WhenSuspended
- MSFT_SMGroupSynchronizedBase.CopyType
- MSFT_SMGroupSynchronizedBase.CopyTypeDescription
- MSFT_SMGroupSynchronizedBase.RelationshipName
- MSFT_SMGroupSynchronizedBase.ConsistencyEnabled
- MSFT_SMGroupSynchronizedBase.ConsistencyType
- MSFT_SMGroupSynchronizedBase.ConsistencyState
- MSFT_SMGroupSynchronizedBase.ConsistencyStatus
api_location:
- StorageService.dll
api_type:
- DllExport
...
The **MSFT\_SMGroupSynchronizedBase** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_SMGroupSynchronizedBase** class has these properties.
