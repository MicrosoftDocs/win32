---
title: AddInitiator method of the MSFT\_SMStorageGroup class
description: Adds an Initiator ID to a storage group.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'c1beba04-4547-4a45-983a-3b806c37dd19'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["AddInitiator method", "AddInitiator method, MSFT_SMStorageGroup class", "MSFT_SMStorageGroup class, AddInitiator method"]
topic_type:
- apiref
api_name:
- MSFT_SMStorageGroup.AddInitiator
api_location:
- StorageService.dll
api_type:
- COM
...
# AddInitiator method of the MSFT\_SMStorageGroup class
