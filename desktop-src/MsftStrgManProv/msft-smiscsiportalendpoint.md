---
title: MSFT\_SMiSCSIPortalEndpoint class
description: Represents an endpoint of an iSCSI portal.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 6dbadfea-5786-4627-bcd8-e781a7939264
ms.prod: windows-server-dev
ms.technology: windows-management-instrumentation
ms.tgt_platform: multiple
keywords:
- MSFT_SMiSCSIPortalEndpoint class
- MSFT_SMiSCSIPortalEndpoint class, described
topic_type:
- apiref
api_name:
- MSFT_SMiSCSIPortalEndpoint
- MSFT_SMiSCSIPortalEndpoint.ObjectId
- MSFT_SMiSCSIPortalEndpoint.Identifier
- MSFT_SMiSCSIPortalEndpoint.IPv4Address
- MSFT_SMiSCSIPortalEndpoint.IPv6Address
- MSFT_SMiSCSIPortalEndpoint.SubnetMask
- MSFT_SMiSCSIPortalEndpoint.IPEndpointOpStatus
- MSFT_SMiSCSIPortalEndpoint.PortNumber
- MSFT_SMiSCSIPortalEndpoint.TCPEndpointOpStatus
api_location:
- StorageService.dll
api_type:
- DllExport
...
# MSFT\_SMiSCSIPortalEndpoint class
...
The **MSFT\_SMiSCSIPortalEndpoint** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_SMiSCSIPortalEndpoint** class has these properties.
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_IPProtocolEndpoint.IPv4Address")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_IPProtocolEndpoint.IPv6Address")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_TCPProtocolEndpoint.PortNumber")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_IPProtocolEndpoint.SubnetMask")
</dt> </dl>
