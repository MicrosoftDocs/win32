...
keywords: ["GetReplicationSettings method", "GetReplicationSettings method, MSFT_SMReplicationGroup class", "MSFT_SMReplicationGroup class, GetReplicationSettings method"]
topic_type:
- apiref
api_name:
