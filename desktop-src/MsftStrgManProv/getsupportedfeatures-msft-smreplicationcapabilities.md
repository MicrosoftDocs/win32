...
keywords: ["GetSupportedFeatures method", "GetSupportedFeatures method, MSFT_SMReplicationCapabilities class", "MSFT_SMReplicationCapabilities class, GetSupportedFeatures method"]
topic_type:
- apiref
api_name:
