...
keywords:
- GetSupportedGroupOperations method
- GetSupportedGroupOperations method, MSFT_SMReplicationCapabilities class
- MSFT_SMReplicationCapabilities class, GetSupportedGroupOperations method
topic_type:
- apiref
api_name:
