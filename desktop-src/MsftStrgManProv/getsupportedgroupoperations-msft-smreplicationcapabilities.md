---
title: GetSupportedGroupOperations method of the MSFT\_SMReplicationCapabilities class
description: Retrieves the supported replication group operations for the specified replication type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '474cdf0a-9690-4a47-af72-6a813cbc0696'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetSupportedGroupOperations method", "GetSupportedGroupOperations method, MSFT_SMReplicationCapabilities class", "MSFT_SMReplicationCapabilities class, GetSupportedGroupOperations method"]
topic_type:
- apiref
api_name:
- MSFT_SMReplicationCapabilities.GetSupportedGroupOperations
api_location:
- StorageService.dll
api_type:
- COM
...
# GetSupportedGroupOperations method of the MSFT\_SMReplicationCapabilities class
