---
title: RemoveTargetPorts method of the MSFT\_SMStorageGroup class
description: Removes the specified target ports from the storage group.
audience: developer
...
- apiref
api_name:
- MSFT_SMStorageGroup.RemoveTargetPorts
api_location:
- StorageService.dll
api_type:
- COM
...
Removes the specified target ports from the storage group.
...
**StorageService: Error TargetPortID(s) Required** (40010)
</dt> <dt>

**StorageService: PortsPerView is not set to MultiplePorts. Unable to remove TargetPorts** (40085)
</dt> <dt>
...
**StorageService: Unable to find associated MaskingGroup** (40112)
</dt> <dt>

**StorageService: Operation is not supported for a provider that implements GroupMaskingAndMapping Profile** (40119)
</dt> <dt>
