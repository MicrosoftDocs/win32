...
For information about how to use the LSA to logon and authenticate users, see [LSA Authentication](https://msdn.microsoft.com/library/windows/desktop/aa378326).
