...
| [**SCESVC\_INFO\_TYPE**](/windows/desktop/api/Scesvc/ne-scesvc-scesvc_info_type)               | Enumeration is used by [**PFSCE\_QUERY\_INFO**](https://msdn.microsoft.com/en-us/library/ms721890(v=VS.85).aspx) and [**PFSCE\_SET\_INFO**](https://msdn.microsoft.com/en-us/library/ms721892(v=VS.85).aspx) to indicate the type of information requested from or passed to the security database.                                                 |
