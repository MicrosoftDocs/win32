...
|--------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**SCE\_ENUMERATION\_CONTEXT**](sce-enumeration-context.md) | Used by the [**PFSCE\_QUERY\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_query_info) function to navigate through the security database.                                                                                                                                              |
| [**SCE\_HANDLE**](sce-handle.md)                            | Used by [**PFSCE\_QUERY\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_query_info) and [**PFSCE\_SET\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_set_info) to pass information between the attachment and the security database.                                                                                 |
...
| [**SCESVC\_INFO\_TYPE**](/windows/desktop/api/Scesvc/ne-scesvc-_scesvc_info_type)               | Enumeration is used by [**PFSCE\_QUERY\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_query_info) and [**PFSCE\_SET\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_set_info) to indicate the type of information requested from or passed to the security database.                                                 |
