...
The **SCESTATUS** data type is used by the Security Configuration tool set API to return information about the results of a function call. For more information about the defined status code values, see [Attachment Return Values](https://www.bing.com/search?q=Attachment Return Values).
