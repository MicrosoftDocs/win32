...
The **SCE\_ENUMERATION\_CONTEXT** data type is an opaque handle provided by the Security Configuration tool set. It is used by the [**PFSCE\_QUERY\_INFO**](pfsce-query-info.md) function to navigate through the security database.
