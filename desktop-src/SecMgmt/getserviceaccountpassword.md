...
If the function fails, the return value is an NTSTATUS code. For more information, see [LSA Policy Function Return Values](https://www.bing.com/search?q=LSA Policy Function Return Values).
