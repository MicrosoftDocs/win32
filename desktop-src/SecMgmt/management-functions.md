...
|-----------------------------------------------------------|---------------------------------------------------------------------------------------------|
| [**PFSCE\_FREE\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_free_info)<br/>   | Used to free memory allocated by these support functions.<br/>                        |
| [**PFSCE\_LOG\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_log_info)<br/>     | Used to log message to the configuration log file or analysis log file.<br/>          |
| [**PFSCE\_QUERY\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_query_info)<br/> | Used to query the configuration and analysis information for a specific service.<br/> |
| [**PFSCE\_SET\_INFO**](/windows/desktop/api/Scesvc/nc-scesvc-pfsce_set_info)<br/>     | Used to set configuration and analysis information for a specific service.<br/>       |
