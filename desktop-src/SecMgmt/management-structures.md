...
| [**TRUSTED\_DOMAIN\_INFORMATION\_BASIC**](https://msdn.microsoft.com/en-us/library/ms722475(v=VS.85).aspx) | Information about a trusted domain. This structure is identical to [**LSA\_TRUST\_INFORMATION**](/windows/desktop/api/lsalookup/ns-lsalookup-lsa_trust_information).                  |
