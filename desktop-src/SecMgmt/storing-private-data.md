...
The following example creates a local private data object. Note that the function InitLsaString converts a [*Unicode*](https://msdn.microsoft.com/library/windows/desktop/ms721629#-security-unicode-gly) string to an [**LSA\_UNICODE\_STRING**](lsa-unicode-string.md) structure. The code for this function is shown in [Using LSA Unicode Strings](using-lsa-unicode-strings.md).
