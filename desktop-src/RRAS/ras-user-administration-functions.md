...
To obtain a list of current users on a particular domain, use the [**NetQueryDisplayInformation**](https://msdn.microsoft.com/en-us/library/Aa370610(v=VS.85).aspx) function. The prototype for this function is in the lmaccess.h header file.
