...
To obtain a list of current users on a particular domain, use the [**NetQueryDisplayInformation**](https://www.bing.com/search?q=**NetQueryDisplayInformation**) function. The prototype for this function is in the lmaccess.h header file.
