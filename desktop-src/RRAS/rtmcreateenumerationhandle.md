...
If the function fails, or no routes exist with the specified criteria, the return value is **NULL**. Call [**GetLastError**](https://www.bing.com/search?q=**GetLastError**) to obtain more information.
