...
Then use the name of the user account server in a call to the [**NetQueryDisplayInformation**](https://www.bing.com/search?q=**NetQueryDisplayInformation**) function to enumerate the users in the user account database.
...
[**GetComputerName**](https://www.bing.com/search?q=**GetComputerName**)
</dt> <dt>
