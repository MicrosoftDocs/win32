...
Then use the name of the user account server in a call to the [**NetQueryDisplayInformation**](_win32_netquerydisplayinformation) function to enumerate the users in the user account database.
...
[**GetComputerName**](_win32_getcomputername)
</dt> <dt>
