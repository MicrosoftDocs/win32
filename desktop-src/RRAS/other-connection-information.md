...
The members of the [**RASDIALPARAMS**](https://msdn.microsoft.com/library/Aa377238(v=VS.85).aspx) structure can also specify the following connection information.
...
For the callback number and the domain, the [**RASDIALPARAMS**](https://msdn.microsoft.com/library/Aa377238(v=VS.85).aspx) members can either indicate that RAS should use the information in the phone-book entry, or it can provide information that overrides the phone-book data.
