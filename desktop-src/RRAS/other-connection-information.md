...
The members of the [**RASDIALPARAMS**](/windows/desktop/api/Ras/) structure can also specify the following connection information.
...
For the callback number and the domain, the [**RASDIALPARAMS**](/windows/desktop/api/Ras/) members can either indicate that RAS should use the information in the phone-book entry, or it can provide information that overrides the phone-book data.
