...
The RAS client application should not assume the connection operation is complete after calling [**RasHangUp**](rashangup.md). It should wait for one of the preceding conditions before exiting.
