...
If the return value is zero, either no routes are available, or the operation failed. Call [**GetLastError**](https://www.bing.com/search?q=**GetLastError**) to obtain more information.
