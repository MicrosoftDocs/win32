...
| <dl> <dt>**FALSE**</dt> </dl>                        | There is no route to the specified network, or the operation failed. Call [**GetLastError**](https://msdn.microsoft.com/en-us/library/ms679360(v=VS.85).aspx) to obtain more information:<br/> |
