...
| <dl> <dt>**FALSE**</dt> </dl>                        | There is no route to the specified network, or the operation failed. Call [**GetLastError**](https://www.bing.com/search?q=**GetLastError**) to obtain more information:<br/> |
