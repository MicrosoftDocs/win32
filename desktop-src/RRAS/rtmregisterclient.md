...
A **NULL** handle indicates that the routing table manager was unable to register the client. Call [**GetLastError**](https://www.bing.com/search?q=**GetLastError**) to obtain the reason for the failure.
...
[**GetLastError**](https://www.bing.com/search?q=**GetLastError**)
</dt> <dt>
