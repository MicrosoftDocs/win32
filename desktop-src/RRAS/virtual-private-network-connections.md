...
The **szLocalPhoneNumber** member of the [**RASENTRY**](https://msdn.microsoft.com/en-us/library/Aa377274(v=VS.85).aspx) structure for the VPN connection should contain either the DNS name or IP address of the destination VPN server.
