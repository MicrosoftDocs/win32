...
The **szLocalPhoneNumber** member of the [**RASENTRY**](/windows/desktop/api/Ras/) structure for the VPN connection should contain either the DNS name or IP address of the destination VPN server.
