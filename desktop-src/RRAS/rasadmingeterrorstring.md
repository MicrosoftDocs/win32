...
If the function fails, the return value is an error code. This value can be a last error value set by the [**LoadLibrary**](https://www.bing.com/search?q=**LoadLibrary**), [**GlobalAlloc**](https://www.bing.com/search?q=**GlobalAlloc**), or [**LoadString**](https://www.bing.com/search?q=**LoadString**) functions; or it can be one of the following error codes.
...
[**GlobalAlloc**](https://www.bing.com/search?q=**GlobalAlloc**)
</dt> <dt>
