...
If the function fails, the return value is an error code. This value can be a last error value set by the [**LoadLibrary**](_win32_loadlibrary), [**GlobalAlloc**](_win32_globalalloc), or [**LoadString**](_win32_loadstring) functions; or it can be one of the following error codes.
...
[**LoadLibrary**](_win32_loadlibrary)
</dt> <dt>

[**GlobalAlloc**](_win32_globalalloc)
</dt> <dt>
