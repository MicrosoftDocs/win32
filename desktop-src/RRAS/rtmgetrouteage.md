...
| <dl> <dt>**INFINITE**</dt> </dl> | The content of the route structure is invalid. In this case, a call to [**GetLastError**](https://www.bing.com/search?q=**GetLastError**) returns ERROR\_INVALID\_PARAMETER.<br/> |
