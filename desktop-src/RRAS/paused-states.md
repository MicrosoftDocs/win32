...
By default, paused state support is disabled. RAS clients that want to support paused states must set the RDEOPTS\_PausedStates flag in the [**RASDIALEXTENSIONS**](https://msdn.microsoft.com/en-us/library/Aa377029(v=VS.85).aspx) structure passed as a parameter to [**RasDial**](/windows/desktop/api/Ras/nf-ras-rasdiala).
...
-   The user's input in the appropriate members of the [**RASDIALPARAMS**](https://msdn.microsoft.com/en-us/library/Aa377238(v=VS.85).aspx) structure. Other members of the **RASDIALPARAMS** structure should have the same information as specified in the original [**RasDial**](/windows/desktop/api/Ras/nf-ras-rasdiala) call.
