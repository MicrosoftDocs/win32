...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Obtain a handle to an enumeration using the [**MgmGroupEnumerationStart**](mgmgroupenumerationstart.md) function.                                                         | Return a handle.                                                                                                                                                                                                                                                                                             |
| Obtain one or more groups using the [**MgmGroupEnumerationGetNext**](mgmgroupenumerationgetnext.md) function.                                                             | Return as many groups as fit in the buffer supplied by the client. If no groups can be returned in the supplied buffer, return ERROR\_INSUFFICIENT\_BUFFER and the size of the buffer that is needed to return one group.<br/> Return ERROR\_NO\_MORE\_ITEMS when there are no more groups.<br/> |
| If ERROR\_INSUFFICIENT\_BUFFER is received, call the [**MgmGroupEnumerationGetNext**](mgmgroupenumerationgetnext.md) function again using a buffer of the size indicated. |                                                                                                                                                                                                                                                                                                              |
| Continue calling the [**MgmGroupEnumerationGetNext**](mgmgroupenumerationgetnext.md) function until ERROR\_NO\_MORE\_ITEMS is received.                                   |                                                                                                                                                                                                                                                                                                              |
| End the enumeration process using the [**MgmGroupEnumerationEnd**](mgmgroupenumerationend.md) function.                                                                   | Destroy the handle.                                                                                                                                                                                                                                                                                          |
