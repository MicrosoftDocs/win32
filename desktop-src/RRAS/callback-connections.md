...
A user assigned the Set By Caller privilege can choose to connect either with or without a callback. The [**RasDial**](/windows/desktop/api/Ras/nf-ras-rasdiala) call uses the **szCallbackNumber** member of the [**RASDIALPARAMS**](/windows/desktop/api/Ras/) structure to indicate the choice.
