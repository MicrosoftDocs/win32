...
The name of the home provider for the given SIM/Device. For more information, see the documentation for the v1 [**HomeProviderName**](../mbn/schema_homeprovidername_mbnprofile_element.md) element.
