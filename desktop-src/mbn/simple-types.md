---
Description: The Mobile Broadband Profile Schema v4 defines the following simple types. All of these types are in the namespace http://www.microsoft.com/networking/WWAN/profile/v4.
...
The Mobile Broadband Profile Schema v4 defines the following simple types. All of these types are in the namespace `http://www.microsoft.com/networking/WWAN/profile/v4`.
