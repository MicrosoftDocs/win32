...
| [**RequestStateChange**](msft-dnsclient-requeststatechange.md) | Initiates a requests to change the state of a DNS client. <br/> This method is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/cc136818).<br/> |
...
Gets a value that indicates the ability of the DNS client to communicate with the underlying [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218) object.
...
Default value: "2". This property is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/cc136818).
