...
To save the process snapshot, first get a process snapshot by using the [**PssCaptureSnapshot**](psscapturesnapshot.md) function.
...
The following example creates a constant that contains capture flag values. For more information, see the [**PSS\_CAPTURE\_FLAGS**](pss-capture-flags.md) enumeration.
...
After this function saves the process snapshot information, use the [**PssFreeSnapshot**](pssfreesnapshot.md) function to release the resource, as in the following example:
...
[**PSS\_CAPTURE\_FLAGS**](pss-capture-flags.md)
</dt> <dt>
...
[**PssCaptureSnapshot**](psscapturesnapshot.md)
</dt> <dt>

[**PssFreeSnapshot**](pssfreesnapshot.md)
</dt> </dl>
