...
-   A CLSID that points to your COM component that implements [**INotificationActivationCallback**](/previous-versions/windows/desktop/api/NotificationActivationCallback/nn-notificationactivationcallback-inotificationactivationcallback).
...
Once you have overwritten the [**INotificationActivationCallback**](/previous-versions/windows/desktop/api/NotificationActivationCallback/nn-notificationactivationcallback-inotificationactivationcallback) interface in your COM component, you will need to tell COM how to start your app when it is necessary. In order to do this, you will need to update the registry. The following line will modify the registry
