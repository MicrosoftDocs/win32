...
2.  If you implemented the [**EVT\_SUBSCRIBE\_CALLBACK**](/windows/desktop/api/WinEvt/nc-winevt-evt_subscribe_callback) function, your callback will receive events that begin after the bookmarked event.
