...
2.  If you implemented the [**EVT\_SUBSCRIBE\_CALLBACK**](https://msdn.microsoft.com/en-us/library/Aa385577(v=VS.85).aspx) function, your callback will receive events that begin after the bookmarked event.
