...
| [**Binary (EventDataType)**](eventschema-binary-eventdatatype-element.md)                                 | A binary data blob for events that are written using [Event Logging](https://msdn.microsoft.com/library/windows/desktop/aa363652).<br/>                                                                                                   |
