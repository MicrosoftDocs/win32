...
| EventSourceName   | string                                              | The name of the event source that published the event (if the event source is from the legacy [Event Logging](https://msdn.microsoft.com/library/windows/desktop/aa363652) API).<br/>                                                                                                                                                      |
