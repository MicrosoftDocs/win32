...
This section discusses how to deal with network unreliability when using RPC, and explains how RPC-level APIs translate into network activity. The section refers only to the [**ncacn\_ip\_tcp**](https://msdn.microsoft.com/library/windows/desktop/aa367104) and [**ncacn\_http**](https://msdn.microsoft.com/library/windows/desktop/aa367103) protocol sequences.
