...
In the preceding example, the call to [**GetQueuedCompletionStatus**](https://msdn.microsoft.com/library/windows/desktop/aa364986) waits indefinitely until the asynchronous remote procedure call completes.
