...
OSF-DCE standard language for specifying the interface for remote procedure calls. See also [*MIDL*](https://www.bing.com/search?q=*MIDL*).
...
Connectionless network-layer communications protocol. See also [*datagram*](https://www.bing.com/search?q=*datagram*).
...
Novell NetWare communication protocol that uses [*datagram*](https://www.bing.com/search?q=*datagram*) sockets to route information packets over local area networks and wide area networks.
