...
To get the information in a binding handle, pass the handle to [**RpcBindingToStringBinding**](/windows/win32/Rpcdce/nf-rpcdce-rpcbindingtostringbinding?branch=master). It returns the binding information as a string. For every call to **RpcBindingToStringBinding**, you must have a corresponding call to the function [**RpcStringFree**](/windows/win32/Rpcdce/nf-rpcdce-rpcstringfree?branch=master).

You can call the function [**RpcStringBindingParse**](/windows/win32/Rpcdce/nf-rpcdce-rpcstringbindingparse?branch=master) to parse the string you obtain from [**RpcBindingToStringBinding**](/windows/win32/Rpcdce/nf-rpcdce-rpcbindingtostringbinding?branch=master). This function allocates strings to contain the information it parses. If you do not want it to parse a particular piece of binding information, pass a **NULL** as the value of that parameter. Be sure to call [**RpcStringFree**](/windows/win32/Rpcdce/nf-rpcdce-rpcstringfree?branch=master) for each of the strings it allocates.
