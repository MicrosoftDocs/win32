...
For related information, see [Procedures Used with Most Security Packages and Protocols](https://msdn.microsoft.com/library/windows/desktop/aa378824) in the Platform Software Development Kit (SDK).
