...
-   The first SCHANNEL principal name form is the [*msstd*](m-glos.md#-rpc-msstd-glos) form. Names in msstd form generally follow the pattern msstd:servername@serverdomain.com. This is referred to as an email name property. If the certificate contains an email name property, and it contains the at sign (@), the principal name is msstd:email name. Otherwise it must contain the common name property. Internal backslashes are doubled, just as in string bindings.
-   The second SCHANNEL principal name form is the [*fullsic*](f-glos.md#-rpc-fullsic-glos) form. This is a series of RFC1779-compliant names bounded by angle brackets and separated by backslashes. It typically follows the pattern fullsic:\\&lt;\\Authority\\SubAuthority\\.....\\Person&gt; or fullsic:\\&lt;\\Authority\\SubAuthority\\.....\\ServerProgram&gt;.
