...
For COM, the [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**) function is an established method of checking whether a server supports an interface; hence, the situations where a client can talk to an old or a new version of an interface can be easily resolved.
