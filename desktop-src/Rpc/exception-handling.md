...
The [**RpcTryFinally**](rpctryfinally.md) / [**RpcFinally**](/windows/desktop/api/Rpc/) / [**RpcEndFinally**](/windows/desktop/api/Rpc/) structure is equivalent to the Windows **try-finally** statement. The RPC exception construct [**RpcTryExcept**](rpctryexcept.md) / [**RpcExcept**](/windows/desktop/api/Rpc/nf-rpc-rpcexcept) / [**RpcEndExcept**](/windows/desktop/api/Rpc/) is equivalent to the Windows **try-except** statement.
