...
Simplest pointer type. A reference pointer always points to valid storage and that storage does not change (although the contents may change). A reference pointer cannot be aliased. The \[ [ref](https://msdn.microsoft.com/library/windows/desktop/aa367153)\] attribute designates a reference pointer. See also [*unique pointer*](u-glos.md#-rpc-unique-pointer-glos) and [*full pointer*](f-glos.md#-rpc-full-pointer-glos).
