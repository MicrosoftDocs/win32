...
Unique or full pointers that are \[ [out](https://docs.microsoft.com/windows/desktop/Midl/out-idl)\]-only are not accepted by the MIDL compiler. Such specifications cause the MIDL compiler to generate an error message.
...
Rather than \[**out**, [unique](https://docs.microsoft.com/windows/desktop/Midl/unique)\] or \[**out**, [ptr](https://docs.microsoft.com/windows/desktop/Midl/ptr)\] pointers, use \[**in**, **out**, **unique**\] or \[**in**, **out**, **ptr**\] pointers, or use another level of indirection such as a reference pointer that points to the valid unique or full pointer.
