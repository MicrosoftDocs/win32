...
Array whose range of transmitted elements is determined at run time by another parameter, structure, or expression. See also [*conformant array*](https://www.bing.com/search?q=*conformant array*) and [*open array*](https://www.bing.com/search?q=*open array*).
