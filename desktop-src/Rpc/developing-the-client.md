...
keywords: ["Remote Procedure Call RPC , tasks, developing the client"]
---
...
If you do not compile your IDL file in OSF compatibility mode ([**/osf**](https://msdn.microsoft.com/library/windows/desktop/aa367357)), your client program must provide a function for allocating memory and a function for deallocating it. For Windows 2000 and later versions, the recommended mode is [**/Oicf**](https://msdn.microsoft.com/library/windows/desktop/aa367352). For details, see [How Memory Is Allocated and Deallocated](how-memory-is-allocated-and-deallocated.md), and [Pointers and Memory Allocation](pointers-and-memory-allocation.md).
