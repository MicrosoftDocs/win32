...
Banyan Vines [*connection-oriented*](https://www.bing.com/search?q=*connection-oriented*) communication protocol for routing information packets over local area networks.
...
Novell NetWare [*connection-oriented*](https://www.bing.com/search?q=*connection-oriented*) communication protocol for routing information packets over local area networks and wide area networks.
...
Process of marshaling data to (encoding) and unmarshaling data from (decoding) buffers that you control. This is in contrast to traditional RPC usage, where the stubs and the RPC runtime control the marshaling buffers. Also called pickling. See also [*procedure serialization*](https://www.bing.com/search?q=*procedure serialization*), [*type serialization*](https://www.bing.com/search?q=*type serialization*).
...
MIDL-generated C-language source code that contains all the functions necessary for the server application to handle remote requests using local procedure calls. See also [*client stub*](https://www.bing.com/search?q=*client stub*).
...
Established relationship between a client application and a server application. See also [*bind*](https://www.bing.com/search?q=*bind*), [*binding handle*](https://www.bing.com/search?q=*binding handle*).
...
Static identity tracking specifies that the RPC run-time uses the security credentials in the client's binding handle for all RPC calls. See also [*dynamic identity tracking*](https://www.bing.com/search?q=*dynamic identity tracking*).
...
Character string that consists of the object [*UUID*](https://www.bing.com/search?q=*UUID*), [*protocol sequence*](https://www.bing.com/search?q=*protocol sequence*), [*network address*](https://www.bing.com/search?q=*network address*), [*endpoint*](https://www.bing.com/search?q=*endpoint*), and endpoint options, all of which can be used to create a [*binding handle*](https://www.bing.com/search?q=*binding handle*) to the specified server.
