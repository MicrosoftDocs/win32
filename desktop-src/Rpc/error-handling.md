...
| Client calls [**RpcAsyncCompleteCall**](/windows/desktop/api/Rpcasync/nf-rpcasync-rpcasynccompletecall) before the [**in**](https://msdn.microsoft.com/library/windows/desktop/aa367051) pipes are drained. | Call fails with the appropriate pipe-filling error code.                                                   |
