...
-   [**RpcEndExcept**](https://msdn.microsoft.com/en-US/library/Aa375629(v=VS.80).aspx)
...
-   [**RpcExceptionCode**](https://msdn.microsoft.com/en-US/library/Aa375695(v=VS.80).aspx)
