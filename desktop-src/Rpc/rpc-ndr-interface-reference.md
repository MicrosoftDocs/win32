...
-   [**NdrCStdStubBuffer\_Release**](https://msdn.microsoft.com/en-US/library/Aa374242(v=VS.80).aspx)
-   [**NdrCStdStubBuffer2\_Release**](https://msdn.microsoft.com/en-US/library/Aa374240(v=VS.80).aspx)
