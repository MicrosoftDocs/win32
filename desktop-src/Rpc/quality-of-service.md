...
The version number field of the [**RPC\_SECURITY\_QOS**](/windows/desktop/api/Rpcdce/ns-rpcdce-_rpc_security_qos) structure should always be set to RPC\_C\_SECURITY\_QOS\_VERSION.
