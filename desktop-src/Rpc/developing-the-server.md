...
If you do not compile your IDL file in Open Software Foundation (OSF) compatibility mode ([**/osf**](https://msdn.microsoft.com/library/windows/desktop/aa367357)), your server program must provide a function for allocating memory and a function for deallocating it. For Windows 2000 and later versions of Windows, the recommended mode is [**/Oicf**](https://msdn.microsoft.com/library/windows/desktop/aa367352). For details, see [How Memory Is Allocated and Deallocated](how-memory-is-allocated-and-deallocated.md), and [Pointers and Memory Allocation](pointers-and-memory-allocation.md).
