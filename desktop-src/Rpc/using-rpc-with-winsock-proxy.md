...
Ordinarily, for datagram-packet transfers, the RPC transport DLL bypasses the [**sendto**](https://msdn.microsoft.com/library/windows/desktop/ms740148) and [**recvfrom**](https://msdn.microsoft.com/library/windows/desktop/ms740120) functions provided in Wsock32.dll, and communicates directly with the underlying device driver. This improves the speed of packet transfers but makes Winsock Proxy features unavailable to the application.
