...
| 4        | The default is \[ [ptr](https://msdn.microsoft.com/library/windows/desktop/aa367149)\] in DCE-compatibility mode, or \[ [unique](https://msdn.microsoft.com/library/windows/desktop/aa367294)\] in Microsoft-extensions mode. |
