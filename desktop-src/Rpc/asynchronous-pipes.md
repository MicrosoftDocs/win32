...
> [!Note]  
> Pipe parameters can only be passed by reference. Even if the IDL file shows [pipe](https://docs.microsoft.com/windows/desktop/Midl/pipe) parameters being passed by value, the generated stubs will accept pipe parameters by reference only.
