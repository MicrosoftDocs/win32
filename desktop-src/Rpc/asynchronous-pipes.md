...
> [!Note]  
> Pipe parameters can only be passed by reference. Even if the IDL file shows [pipe](https://msdn.microsoft.com/library/windows/desktop/aa367140) parameters being passed by value, the generated stubs will accept pipe parameters by reference only.
