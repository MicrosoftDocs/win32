...
> [!Note]  
> Multidimensional sized arrays and pointers trigger a switch to [**–Oicf**](https://docs.microsoft.com/windows/desktop/Midl/-oi).
...
The robust\_flags<2> field has been added for Windows 2000 to support [**/robust**](https://docs.microsoft.com/windows/desktop/Midl/-robust), such as the denial-of-attacks feature. The following flags are defined on the first byte:
