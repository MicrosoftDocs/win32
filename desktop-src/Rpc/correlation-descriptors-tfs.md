...
> [!Note]  
> Multidimensional sized arrays and pointers trigger a switch to [**–Oicf**](https://msdn.microsoft.com/library/windows/desktop/aa367352).
...
The robust\_flags<2&gt; field has been added for Windows 2000 to support [**/robust**](https://msdn.microsoft.com/library/windows/desktop/aa367363), such as the denial-of-attacks feature. The following flags are defined on the first byte:
