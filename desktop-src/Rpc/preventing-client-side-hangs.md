...
> [!Note]  
> Call time outs work only on the [**ncacn\_ip\_tcp**](https://msdn.microsoft.com/library/windows/desktop/aa367104) and [**ncacn\_http**](https://msdn.microsoft.com/library/windows/desktop/aa367103) protocol sequences.
