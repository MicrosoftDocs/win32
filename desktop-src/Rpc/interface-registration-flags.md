...
The following constants are used in the *Flags* parameter of the [**RpcServerRegisterIf2**](/windows/win32/Rpcdce/nf-rpcdce-rpcserverregisterif2?branch=master) and [**RpcServerRegisterIfEx**](/windows/win32/Rpcdce/nf-rpcdce-rpcserverregisterifex?branch=master) functions.
