...
The following constants are used in the *Flags* parameter of the [**RpcServerRegisterIf2**](rpcserverregisterif2.md) and [**RpcServerRegisterIfEx**](rpcserverregisterifex.md) functions.
