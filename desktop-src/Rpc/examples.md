...
keywords: ["Remote Procedure Call RPC , examples"]
---
...
-   DATA directory contains four programs: DUNION illustrates discriminated (nonencapsulated) unions; INOUT demonstrates [\[in\]](https://msdn.microsoft.com/library/windows/desktop/aa367051), [\[out\]](https://msdn.microsoft.com/library/windows/desktop/aa367136) parameters; REPAS demonstrates the [represent\_as](https://msdn.microsoft.com/library/windows/desktop/aa367154) attribute; XMIT demonstrates the [transmit\_as](https://msdn.microsoft.com/library/windows/desktop/aa367286) attribute.
...
-   HANDLES directory contains three programs, AUTO, CXHNDL, USRDEF, which demonstrate [auto\_handle](https://msdn.microsoft.com/library/windows/desktop/aa366736), \[context\_handle\], and generic (user-defined) handles, respectively.
