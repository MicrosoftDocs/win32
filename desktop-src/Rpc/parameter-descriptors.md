...
As mentioned previously, [**–Oi**](https://msdn.microsoft.com/library/windows/desktop/aa367352) and **–Oif** style parameter descriptors exist.
...
[**Simple –Oi**](https://msdn.microsoft.com/library/windows/desktop/aa367352)
...
-   The **IsByValue** bit is set for compound types being sent by value, but is not set for simple types, regardless of whether the argument is a pointer. The compound types for which it is set are structures, unions, [**transmit\_as**](https://msdn.microsoft.com/library/windows/desktop/aa367286), [**represent\_as**](https://msdn.microsoft.com/library/windows/desktop/aa367154), [**wire\_marshal**](https://msdn.microsoft.com/library/windows/desktop/aa367309) and SAFEARRAY. In general, the bit was introduced for the benefit of the main interpreter loop in the [**–Oicf**](https://msdn.microsoft.com/library/windows/desktop/aa367352) interpreter, to ensure the nonsimple arguments (referred to as compound type arguments) are properly dereferenced. This bit was never used in previous versions of the interpreter.
