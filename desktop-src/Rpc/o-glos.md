...
Parameter containing data that the server application is transmitting to the client application. The \[ [out](https://msdn.microsoft.com/library/windows/desktop/aa367136)\] attribute designates an output parameter.
