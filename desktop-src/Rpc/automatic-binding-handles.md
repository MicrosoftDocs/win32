...
You specify the use of auto handles by including the \[[**auto\_handle**](https://msdn.microsoft.com/library/windows/desktop/aa366736)\] attribute in the ACF. The time-stamp example uses the following ACF:
