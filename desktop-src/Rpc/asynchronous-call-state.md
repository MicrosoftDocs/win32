...
| A     | Abort the call | Call [**RpcAsyncAbortCall**](rpcasyncabortcall.md)Go to End<br/>                                                                                                                                             |
| Comp  | Completion     | Issue [**RpcAsyncCompleteCall**](rpcasynccompletecall.md)Go to End<br/>                                                                                                                                      |
| End   |                |                                                                                                                                                                                                                     |
