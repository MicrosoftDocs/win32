...
Additionally, the use of the **\[**[strict\_context\_handle](https://msdn.microsoft.com/library/windows/desktop/aa367167)**\]** and **\[**[type\_strict\_context\_handle](https://msdn.microsoft.com/library/windows/desktop/aa367291)**\]**attributes are recommended to ensure the RPC run time creates a context handle on one interface that can be passed as an argument only to methods of that interface. Doing so will prevent server failures that occur when context handles are opened and passed between different interfaces that exist within the same process.

## Related topics

<dl> <dt>

[strict\_context\_handle](https://msdn.microsoft.com/library/windows/desktop/aa367167)
</dt> <dt>

[type\_strict\_context\_handle](https://msdn.microsoft.com/library/windows/desktop/aa367291)
</dt> </dl>
