...
For more information about UI Automation, see [Windows Automation API: UI Automation](entry_uiauto_win32).
...
If you create applications that use Direct3D, the [DirectX SDK](http://go.microsoft.com/fwlink/p/?linkid=147678) (http://go.microsoft.com/fwlink/p/?linkid=147678) is required.

For more information about Direct3D, see [Direct3D](http://go.microsoft.com/fwlink/p/?linkid=167634) (http://go.microsoft.com/fwlink/p/?linkid=167634).
...
For more information about XPS Document APIs, please see the [XPS Document Programming Guide.](xps-xps_programming_guide)
...
For more information about the Ribbon framework, see [Introducing the Windows Ribbon Framework](scenicintent_introduction).
...
For more information about Windows Portable Devices, see [Windows Portable Devices](http://go.microsoft.com/fwlink/p/?linkid=147737) (http://go.microsoft.com/fwlink/p/?linkid=147737).
...
For editions of Windows 7 and Windows Vista that do not have Microsoft Windows Media Player installed by default (the N and KN editions), you must install the [Windows Media Format 11 SDK]( http://go.microsoft.com/fwlink/p/?linkid=167698) (http://go.microsoft.com/fwlink/p/?linkid=167698) to enable WPD functionality. For more information, see the [Knowledge Base article](http://go.microsoft.com/fwlink/p/?linkid=158715) (http://go.microsoft.com/fwlink/p/?linkid=158715), which was originally published as a resolution for Windows Vista.
...
[Knowledge Base article about the Platform Update for Windows Vista (KB 971644)](http://go.microsoft.com/fwlink/p/?linkid=160189)
</dt> </dl>
