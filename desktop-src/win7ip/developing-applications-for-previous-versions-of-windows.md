...
For an example of an installer that demonstrates how to use the [Windows Update Agent API](https://msdn.microsoft.com/library/windows/desktop/aa387099), see [Direct3D 11 Deployment for Game Developers](https://msdn.microsoft.com/en-us/library/Ee416644(v=VS.85).aspx) in the [DirectX SDK](https://go.microsoft.com/fwlink/p/?linkid=147678) (https://go.microsoft.com/fwlink/p/?linkid=147678).
