...
If you create applications that use Direct3D, the [DirectX SDK](https://msdn.microsoft.com/directx/aa937788.aspx) (http://msdn.microsoft.com/en-us/directx/aa937788.aspx) is required for creating applications that use APIs supported by the Platform Update for Windows Vista and the Platform Update for Windows Server 2008.
...
For more information about how to obtain updates from Windows Update see the [Knowledge Base article about the Platform Update for Windows Vista (KB 971644)](https://support.microsoft.com/kb/971644) (http://support.microsoft.com/kb/971644).
