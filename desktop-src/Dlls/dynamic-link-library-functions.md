...
| [**FreeLibraryAndExitThread**](https://msdn.microsoft.com/en-us/library/ms683153(v=VS.85).aspx)   | Decrements the reference count of a loaded DLL by one, and then calls [**ExitThread**](https://msdn.microsoft.com/library/windows/desktop/ms682659) to terminate the calling thread.                       |
