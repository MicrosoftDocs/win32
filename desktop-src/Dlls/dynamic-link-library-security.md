...
-   Wherever possible, specify a fully qualified path when using the [**LoadLibrary**](loadlibrary.md), [**LoadLibraryEx**](loadlibraryex.md), [**CreateProcess**](https://msdn.microsoft.com/library/windows/desktop/ms682425), or [**ShellExecute**](https://msdn.microsoft.com/library/windows/desktop/bb762153) functions.
-   Use the LOAD\_LIBRARY\_SEARCH flags with the [**LoadLibraryEx**](loadlibraryex.md) function, or use these flags with the [**SetDefaultDllDirectories**](setdefaultdlldirectories.md) function to establish a DLL search order for a process and then use the [**AddDllDirectory**](adddlldirectory.md) or [**SetDllDirectory**](setdlldirectory.md) functions to modify the list. For more information, see [Dynamic-Link Library Search Order](dynamic-link-library-search-order.md).
...
-   On systems with [KB2533623](http://go.microsoft.com/fwlink/p/?linkid=217865) installed, use the LOAD\_LIBRARY\_SEARCH flags with the [**LoadLibraryEx**](loadlibraryex.md) function, or use these flags with the [**SetDefaultDllDirectories**](setdefaultdlldirectories.md) function to establish a DLL search order for a process and then use the [**AddDllDirectory**](adddlldirectory.md) or [**SetDllDirectory**](setdlldirectory.md) functions to modify the list. For more information, see [Dynamic-Link Library Search Order](dynamic-link-library-search-order.md).
