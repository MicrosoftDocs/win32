...
|-----------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ChangeServiceConfig**](/windows/desktop/api/Winsvc/nf-winsvc-changeserviceconfiga)<br/>   | Changes the configuration parameters of a service. This function supports managed service accounts and virtual accounts. For more information, see [Service Accounts Step-by-Step Guide](http://go.microsoft.com/fwlink/p/?linkid=147314).<br/>                                      |
