...
-   Service status (see the [**SERVICE\_STATUS**](/windows/win32/Winsvc/ns-winsvc-_service_status?branch=master) structure) <dl> Type  
    Current state  
