...
| [**ServiceMain**](https://msdn.microsoft.com/en-us/library/ms685138(v=VS.85).aspx)                                   | An application-defined function that serves as the starting point for a service.                                                      |
