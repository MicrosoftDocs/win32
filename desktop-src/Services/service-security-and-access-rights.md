...
| **SC\_MANAGER\_CREATE\_SERVICE** (0x0002)      | Required to call the [**CreateService**](/windows/win32/Winsvc/nf-winsvc-createservicea?branch=master) function to create a service object and add it to the database.                                                                                                                                                                                                                                              |
| **SC\_MANAGER\_CONNECT** (0x0001)              | Required to connect to the service control manager.                                                                                                                                                                                                                                                                                                                      |
| **SC\_MANAGER\_ENUMERATE\_SERVICE** (0x0004)   | Required to call the [**EnumServicesStatus**](/windows/win32/Winsvc/nf-winsvc-enumservicesstatusa?branch=master) or [**EnumServicesStatusEx**](/windows/win32/Winsvc/nf-winsvc-enumservicesstatusexa?branch=master) function to list the services that are in the database.<br/> Required to call the [**NotifyServiceStatusChange**](/windows/win32/Winsvc/nf-winsvc-notifyservicestatuschangea?branch=master) function to receive notification when any service is created or deleted.<br/> |
| **SC\_MANAGER\_LOCK** (0x0008)                 | Required to call the [**LockServiceDatabase**](/windows/win32/Winsvc/nf-winsvc-lockservicedatabase?branch=master) function to acquire a lock on the database.                                                                                                                                                                                                                                                      |
| **SC\_MANAGER\_MODIFY\_BOOT\_CONFIG** (0x0020) | Required to call the [**NotifyBootConfigStatus**](/windows/win32/Winsvc/nf-winsvc-notifybootconfigstatus?branch=master) function.                                                                                                                                                                                                                                                                                  |
| **SC\_MANAGER\_QUERY\_LOCK\_STATUS** (0x0010)  | Required to call the [**QueryServiceLockStatus**](/windows/win32/Winsvc/nf-winsvc-queryservicelockstatusa?branch=master) function to retrieve the lock status information for the database.                                                                                                                                                                                                                         |
...
A process with the correct access rights can open a handle to the SCM that can be used in the [**OpenService**](/windows/win32/Winsvc/nf-winsvc-openservicea?branch=master), [**EnumServicesStatusEx**](/windows/win32/Winsvc/nf-winsvc-enumservicesstatusexa?branch=master), and [**QueryServiceLockStatus**](/windows/win32/Winsvc/nf-winsvc-queryservicelockstatusa?branch=master) functions. Only processes with Administrator privileges are able to open handles to the SCM that can be used by the [**CreateService**](/windows/win32/Winsvc/nf-winsvc-createservicea?branch=master) and [**LockServiceDatabase**](/windows/win32/Winsvc/nf-winsvc-lockservicedatabase?branch=master) functions.
...
When a process uses the [**OpenSCManager**](/windows/win32/Winsvc/nf-winsvc-openscmanagera?branch=master) function to open a handle to a database of installed services, it can request access rights. The system performs a security check against the security descriptor for the SCM before granting the requested access rights.
...
| **SERVICE\_CHANGE\_CONFIG** (0x0002)        | Required to call the [**ChangeServiceConfig**](/windows/win32/Winsvc/nf-winsvc-changeserviceconfiga?branch=master) or [**ChangeServiceConfig2**](/windows/win32/Winsvc/nf-winsvc-changeserviceconfig2a?branch=master) function to change the service configuration. Because this grants the caller the right to change the executable file that the system runs, it should be granted only to administrators.                                                              |
| **SERVICE\_ENUMERATE\_DEPENDENTS** (0x0008) | Required to call the [**EnumDependentServices**](/windows/win32/Winsvc/nf-winsvc-enumdependentservicesa?branch=master) function to enumerate all the services dependent on the service.                                                                                                                                                                                                                                         |
| **SERVICE\_INTERROGATE** (0x0080)           | Required to call the [**ControlService**](/windows/win32/Winsvc/nf-winsvc-controlservice?branch=master) function to ask the service to report its status immediately.                                                                                                                                                                                                                                                          |
| **SERVICE\_PAUSE\_CONTINUE** (0x0040)       | Required to call the [**ControlService**](/windows/win32/Winsvc/nf-winsvc-controlservice?branch=master) function to pause or continue the service.                                                                                                                                                                                                                                                                             |
| **SERVICE\_QUERY\_CONFIG** (0x0001)         | Required to call the [**QueryServiceConfig**](/windows/win32/Winsvc/nf-winsvc-queryserviceconfiga?branch=master) and [**QueryServiceConfig2**](/windows/win32/Winsvc/nf-winsvc-queryserviceconfig2a?branch=master) functions to query the service configuration.                                                                                                                                                                                                           |
| **SERVICE\_QUERY\_STATUS** (0x0004)         | Required to call the [**QueryServiceStatus**](/windows/win32/Winsvc/nf-winsvc-queryservicestatus?branch=master) or [**QueryServiceStatusEx**](/windows/win32/Winsvc/nf-winsvc-queryservicestatusex?branch=master) function to ask the service control manager about the status of the service.<br/> Required to call the [**NotifyServiceStatusChange**](/windows/win32/Winsvc/nf-winsvc-notifyservicestatuschangea?branch=master) function to receive notification when a service changes status.<br/> |
| **SERVICE\_START** (0x0010)                 | Required to call the [**StartService**](/windows/win32/Winsvc/nf-winsvc-startservicea?branch=master) function to start the service.                                                                                                                                                                                                                                                                                             |
| **SERVICE\_STOP** (0x0020)                  | Required to call the [**ControlService**](/windows/win32/Winsvc/nf-winsvc-controlservice?branch=master) function to stop the service.                                                                                                                                                                                                                                                                                          |
| **SERVICE\_USER\_DEFINED\_CONTROL**(0x0100) | Required to call the [**ControlService**](/windows/win32/Winsvc/nf-winsvc-controlservice?branch=master) function to specify a user-defined control code.                                                                                                                                                                                                                                                                       |
...
| **DELETE**                   | Required to call the [**DeleteService**](/windows/win32/Winsvc/nf-winsvc-deleteservice?branch=master) function to delete the service.                                                                                                                                                                                                                                                                                                                                                  |
...
The SCM creates a service object's security descriptor when the service is installed by the [**CreateService**](/windows/win32/Winsvc/nf-winsvc-createservicea?branch=master) function. The default security descriptor of a service object grants the following access.
...
When a process uses the [**OpenService**](/windows/win32/Winsvc/nf-winsvc-openservicea?branch=master) function, the system checks the requested access rights against the security descriptor for the service object.
...
When [**EnumServicesStatusEx function**](/windows/win32/Winsvc/nf-winsvc-enumservicesstatusexa?branch=master) is called, if the caller does not have the **SERVICE\_QUERY\_STATUS** access right to a service, the service is silently omitted from the list of services returned to the client.
