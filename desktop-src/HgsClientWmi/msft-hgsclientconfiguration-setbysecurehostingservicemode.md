...
keywords: ["SetBySecureHostingServiceMode method", "SetBySecureHostingServiceMode method, MSFT_HgsClientConfiguration interface", "MSFT_HgsClientConfiguration interface, SetBySecureHostingServiceMode method"]
topic_type:
- apiref
api_name:
