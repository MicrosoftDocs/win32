...
keywords: ["EncryptDataWithKeyProtector method", "EncryptDataWithKeyProtector method, MSFT_HgsKeyProtectorOperations interface", "MSFT_HgsKeyProtectorOperations interface, EncryptDataWithKeyProtector method"]
topic_type:
- apiref
api_name:
