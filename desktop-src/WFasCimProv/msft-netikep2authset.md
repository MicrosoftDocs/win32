...
The **MSFT\_NetIKEP2AuthSet** class has these types of members:
...
The **MSFT\_NetIKEP2AuthSet** class has these methods.



| Method                                                  | Description                 |
|:--------------------------------------------------------|:----------------------------|
| [**CloneObject**](cloneobject-msft-netikep2authset.md) | Copy this set.<br/>   |
| [**Rename**](rename-msft-netikep2authset.md)           | Rename this set.<br/> |
...
The **MSFT\_NetIKEP2AuthSet** class has these properties.
