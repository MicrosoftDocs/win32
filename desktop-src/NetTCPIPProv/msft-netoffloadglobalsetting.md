...
Whether to turn on TCP chimney offload. For information on TCP chimney offload, see [TCP Chimney Offload](https://msdn.microsoft.com/library/windows/hardware/ff567874).
...
Whether to turn on packet coalescing filters. For information about packet coalescing, see [NDIS Packet Coalescing](https://msdn.microsoft.com/library/windows/hardware/hh451601).
...
Whether to turn on receive side scaling (RSS). For more information about RSS, see [Receive Side Scaling](https://msdn.microsoft.com/library/windows/hardware/ff567236).
...
Whether to turn on TCP/IP task offload. For information about TCP/IP task offload, see [TCP/IP Task Offload](https://msdn.microsoft.com/library/windows/hardware/ff570925).
...
[Receive Side Scaling](https://msdn.microsoft.com/library/windows/hardware/ff567236)
</dt> <dt>

[Receive Segment Coalescing](https://msdn.microsoft.com/library/windows/hardware/jj853324)
</dt> <dt>

[TCP Chimney Offload](https://msdn.microsoft.com/library/windows/hardware/ff567874)
</dt> <dt>

[TCP/IP Task Offload](https://msdn.microsoft.com/library/windows/hardware/ff570925)
</dt> <dt>
