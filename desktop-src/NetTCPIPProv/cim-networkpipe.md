...
# CIM\_NetworkPipe class

Represents the state and management of a connection or trail between endpoints.

This object is different than the association between the endpoints ([**CIM\_ActiveConnection**](https://msdn.microsoft.com/library/cc136779)) since the emphasis is NOT on the endpoints but on the management of the pipe itself - its state, configuration, etc. Network pipes are defined in the context of a network and represent the 'transfer of information . . . between . . . endpoints'. These concepts are aligned with the definition of the Pipe object in ITU's M.3100 specification.
...
The **CIM\_NetworkPipe** class has these types of members:
...
The **CIM\_NetworkPipe** class has these properties.
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_EnabledLogicalElement.OtherEnabledState"), [**Override**](https://msdn.microsoft.com/library/aa393650) ("EnabledState")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_EnabledLogicalElement.EnabledState"), [**Override**](https://msdn.microsoft.com/library/aa393650) ("RequestedState")
</dt> </dl>
