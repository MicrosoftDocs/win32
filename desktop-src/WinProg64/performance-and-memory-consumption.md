...
If the application has the [**IMAGE\_FILE\_LARGE\_ADDRESS\_AWARE**](https://docs.microsoft.com/windows/desktop/api/dbghelp/ns-dbghelp-_loaded_image) flag set in the image header, each 32-bit application receives 4 GB of virtual address space in the WOW64 environment. If the **IMAGE\_FILE\_LARGE\_ADDRESS\_AWARE** flag is not set, each 32-bit application receives 2 GB of virtual address space in the WOW64 environment.
