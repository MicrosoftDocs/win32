...
-   Write tracking. The [**GetWriteWatch**](https://docs.microsoft.com/windows/desktop/api/memoryapi/nf-memoryapi-getwritewatch) and [**ResetWriteWatch**](https://docs.microsoft.com/windows/desktop/api/memoryapi/nf-memoryapi-resetwritewatch) functions are implemented in the kernel using native page-size granularity, which means the WOW64 4 KB page simulation cannot determine which simulated 4 KB pages are written within the underlying 8 KB page.
-   [Address Windowing Extensions (AWE)](https://docs.microsoft.com/windows/desktop/Memory/address-windowing-extensions). The AWE functions operate on page numbers, and there is no way to map 64-bit page numbers to 32-bit page numbers.
...
-   The [**ReadFileScatter**](https://docs.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-readfilescatter) and [**WriteFileGather**](https://docs.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-writefilegather) functions are not supported.

## x64 and ARM64 Support

The native page size is 4 KB. Therefore, the following are supported:

-   The [**GetWriteWatch**](https://docs.microsoft.com/windows/desktop/api/memoryapi/nf-memoryapi-getwritewatch) and [**ResetWriteWatch**](https://docs.microsoft.com/windows/desktop/api/memoryapi/nf-memoryapi-resetwritewatch) functions are supported.
-   The [**ReadFileScatter**](https://docs.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-readfilescatter) and [**WriteFileGather**](https://docs.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-writefilegather) functions are supported.
...
[Memory Limits for Windows Releases](https://docs.microsoft.com/windows/desktop/Memory/memory-limits-for-windows-releases)
</dt> <dt>

[4GT RAM Tuning](https://docs.microsoft.com/windows/desktop/Memory/4-gigabyte-tuning)
</dt> </dl>
