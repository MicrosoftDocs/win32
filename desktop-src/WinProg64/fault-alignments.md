...
On x64 and ARM64 systems, any alignment faults are handled by a combination of hardware and software. For best performance, all access to memory should be properly aligned. In addition, unaligned [interlocked variable access](https://msdn.microsoft.com/library/windows/desktop/ms684122) should be avoided on ARM64, as these operations are not atomic-safe.
