...
The [**SetWindowsHookEx**](_win32_setwindowshookex_cpp) function can be used to inject a DLL into another process if the following conditions are met:
...
For more information, see [**SetWindowsHookEx**](_win32_setwindowshookex_cpp).
