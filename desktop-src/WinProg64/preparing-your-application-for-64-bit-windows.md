...
Note that the 64-bit MIDL supports the [**/Oicf**](https://msdn.microsoft.com/library/windows/desktop/aa367352) and [**/Os**](https://msdn.microsoft.com/library/windows/desktop/aa367356) optimization modes only.
