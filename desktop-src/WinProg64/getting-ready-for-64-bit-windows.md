...
keywords: ["64-bit Windows programming guide 64-bit Windows Programming , getting ready"]
---

# Getting Ready for 64-bit Windows

A key goal of the 64-bit version of Windows is to make it easy for developers to use a single source-code base for their 32-bit and 64-bit applications. This overview describes how to make your source code support both 32-bit and 64-bit computing. Familiarity with existing [Windows data types](https://msdn.microsoft.com/library/windows/desktop/aa383751) will help.
