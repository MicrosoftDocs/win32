...
The [64-bit Windows Installer](https://msdn.microsoft.com/library/windows/desktop/aa372855) can seamlessly install 32-bit MSI-based applications on 64-bit Windows. For older applications that use a 16-bit stub to launch a 32-bit installation engine, 64-bit Windows recognizes specific 16-bit installer programs and substitutes a ported 32-bit version.
