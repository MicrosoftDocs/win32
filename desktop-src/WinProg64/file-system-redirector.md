...
**Windows Server 2003 and Windows XP:** Applications should use the [**SHGetSpecialFolderPath**](https://www.bing.com/search?q=**SHGetSpecialFolderPath**) function to determine the %ProgramFiles% directory name.
