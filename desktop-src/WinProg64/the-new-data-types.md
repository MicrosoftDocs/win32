...
All of these data types are declared in BaseTsd.h. For more information, including definitions of these data types, see [Windows Data Types](https://msdn.microsoft.com/library/windows/desktop/aa383751).
