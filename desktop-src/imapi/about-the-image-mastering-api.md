...
keywords: ["Image Mastering API IMAPI ,described"]
---
...
Applications use the [**IDiscMaster**](idiscmaster.md) interface to perform the following tasks:
