...
<ul>
<li>An update offering multi-boot support via the [<strong>IFileSystemImage2</strong>](/windows/desktop/api/imapi2fs/nn-imapi2fs-ifilesystemimage2) interface was introduced in Windows Vista with Service Pack 1 (SP1) and Windows Server 2008.<br/></li>
...
-   With the [Windows Feature Pack for Storage](http://go.microsoft.com/fwlink/p/?linkid=141659), burn verification options have been made available with a property accessed via [**IBurnVerification**](/windows/desktop/api/imapi2/nn-imapi2-iburnverification).
