...
The application must enable the SE\_SHUTDOWN\_NAME privilege before calling [**InitiateSystemShutdown**](/windows/desktop/api/Winreg/nf-winreg-initiatesystemshutdowna). For more information, see [Privileges](https://msdn.microsoft.com/en-us/library/Aa379306(v=VS.85).aspx).
