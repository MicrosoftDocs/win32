...
Service applications receive shutdown notifications in their handler routines. To register a service control handler, use the [**RegisterServiceCtrlHandlerEx**](https://msdn.microsoft.com/library/ms685058(v=VS.85).aspx) function.
