...
The application need not call the [**DestroyWindow**](_win32_destroywindow_cpp) or [**PostQuitMessage**](_win32_postquitmessage_cpp) function when the session is ending.
...
[**DestroyWindow**](_win32_destroywindow_cpp)
</dt> <dt>

[**PostQuitMessage**](_win32_postquitmessage_cpp)
</dt> <dt>
