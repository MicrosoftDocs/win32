...
-   Applications that must block shutdown should use the new [**ShutdownBlockReasonCreate**](/windows/win32/Winuser/nf-winuser-shutdownblockreasoncreate?branch=master) function to register a string that explains the reason to the user. The user can decide whether to continue or cancel shutdown.
