...
Applications should respect the user's intentions and return **TRUE**. By default, the [**DefWindowProc**](_win32_defwindowproc_cpp) function returns **TRUE** for this message.
...
Service applications can use the [**RegisterServiceCtrlHandlerEx**](base.registerservicectrlhandlerex) function to receive shutdown notifications in a handler routine.
