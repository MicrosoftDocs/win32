...
The system also sends the CTRL\_LOGOFF\_EVENT control signal to every process during a log-off operation. A console application can register a [**HandlerRoutine**](https://www.bing.com/search?q=**HandlerRoutine**) to process these messages.
