---
title: IMimeMessageTree SetOption method
description: Sets the value of an IMimeMessageTree option.
ms.assetid: '01b3a615-b1d9-47df-9d65-3df23300a697'
keywords: ["SetOption method Windows Mail (formerly Outlook Express)", "SetOption method Windows Mail (formerly Outlook Express) , IMimeMessageTree interface", "IMimeMessageTree interface Windows Mail (formerly Outlook Express) , SetOption method"]
topic_type:
- apiref
api_name:
- IMimeMessageTree.SetOption
api_location:
- Inetcomm.dll
api_type:
- COM
...
# IMimeMessageTree::SetOption method

Sets the value of an [**IMimeMessageTree**](oe-imimemessagetree.md) option.
