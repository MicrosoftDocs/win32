...
keywords:
- GetAddressTypes method Windows Mail (formerly Outlook Express)
- GetAddressTypes method Windows Mail (formerly Outlook Express) , IMimeMessage interface
- IMimeMessage interface Windows Mail (formerly Outlook Express) , GetAddressTypes method
topic_type:
- apiref
api_name:
