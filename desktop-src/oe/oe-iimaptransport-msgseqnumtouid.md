...
keywords: ["MsgSeqNumToUID method Windows Mail (formerly Outlook Express)", "MsgSeqNumToUID method Windows Mail (formerly Outlook Express) , IIMAPTransport interface", "IIMAPTransport interface Windows Mail (formerly Outlook Express) , MsgSeqNumToUID method"]
topic_type:
- apiref
api_name:
