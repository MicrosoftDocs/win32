...
keywords: ["GetRowOrdinal method Windows Mail (formerly Outlook Express)", "GetRowOrdinal method Windows Mail (formerly Outlook Express) , IDatabase interface", "IDatabase interface Windows Mail (formerly Outlook Express) , GetRowOrdinal method"]
topic_type:
- apiref
api_name:
