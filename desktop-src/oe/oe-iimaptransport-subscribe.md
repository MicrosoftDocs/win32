...
keywords:
- Subscribe method Windows Mail (formerly Outlook Express)
- Subscribe method Windows Mail (formerly Outlook Express) , IIMAPTransport interface
- IIMAPTransport interface Windows Mail (formerly Outlook Express) , Subscribe method
topic_type:
- apiref
api_name:
