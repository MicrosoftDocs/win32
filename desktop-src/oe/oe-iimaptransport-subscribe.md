---
title: IIMAPTransport Subscribe method
description: Sends the SUBSCRIBE command to the Internet Message Access Protocol (IMAP) server.
ms.assetid: 'f1fd99e9-a2ad-45ab-9595-9ea720a3a266'
keywords: ["Subscribe method Windows Mail (formerly Outlook Express)", "Subscribe method Windows Mail (formerly Outlook Express) , IIMAPTransport interface", "IIMAPTransport interface Windows Mail (formerly Outlook Express) , Subscribe method"]
topic_type:
- apiref
api_name:
- IIMAPTransport.Subscribe
api_location:
- Inetcomm.dll
api_type:
- COM
...
# IIMAPTransport::Subscribe method

\[**IIMAPTransport::Subscribe** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the SUBSCRIBE command to the Internet Message Access Protocol (IMAP) server.
