...
keywords: ["SplitMessage method Windows Mail (formerly Outlook Express)", "SplitMessage method Windows Mail (formerly Outlook Express) , IMimeMessage interface", "IMimeMessage interface Windows Mail (formerly Outlook Express) , SplitMessage method"]
topic_type:
- apiref
api_name:
