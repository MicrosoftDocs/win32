...
keywords: ["InitNew method Windows Mail (formerly Outlook Express)", "InitNew method Windows Mail (formerly Outlook Express) , ISMTPTransport interface", "ISMTPTransport interface Windows Mail (formerly Outlook Express) , InitNew method"]
topic_type:
- apiref
api_name:
