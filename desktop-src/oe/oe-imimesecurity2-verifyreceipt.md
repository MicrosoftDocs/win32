...
keywords: ["VerifyReceipt method Windows Mail (formerly Outlook Express)", "VerifyReceipt method Windows Mail (formerly Outlook Express) , IMimeSecurity2 interface", "IMimeSecurity2 interface Windows Mail (formerly Outlook Express) , VerifyReceipt method"]
topic_type:
- apiref
api_name:
