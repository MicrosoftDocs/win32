...
keywords:
- OpenStream method Windows Mail (formerly Outlook Express)
- OpenStream method Windows Mail (formerly Outlook Express) , IDatabase interface
- IDatabase interface Windows Mail (formerly Outlook Express) , OpenStream method
topic_type:
- apiref
api_name:
