...
keywords: ["SMIME_SECURITY_LABEL structure Windows Mail (formerly Outlook Express)", "PSMIME_SECURITY_LABEL structure pointer Windows Mail (formerly Outlook Express)"]
topic_type:
- apiref
api_name:
