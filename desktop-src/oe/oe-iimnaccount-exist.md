...
keywords: ["Exist method Windows Mail (formerly Outlook Express)", "Exist method Windows Mail (formerly Outlook Express) , IImnAccount interface", "IImnAccount interface Windows Mail (formerly Outlook Express) , Exist method"]
topic_type:
- apiref
api_name:
- IImnAccount.Exist
