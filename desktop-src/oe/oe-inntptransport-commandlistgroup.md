...
keywords:
- CommandLISTGROUP method Windows Mail (formerly Outlook Express)
- CommandLISTGROUP method Windows Mail (formerly Outlook Express) , INNTPTransport interface
- INNTPTransport interface Windows Mail (formerly Outlook Express) , CommandLISTGROUP method
topic_type:
- apiref
api_name:
