...
keywords:
- GetSrc method Windows Mail (formerly Outlook Express)
- GetSrc method Windows Mail (formerly Outlook Express) , IMimeEditTag interface
- IMimeEditTag interface Windows Mail (formerly Outlook Express) , GetSrc method
topic_type:
- apiref
api_name:
- IMimeEditTag.GetSrc
