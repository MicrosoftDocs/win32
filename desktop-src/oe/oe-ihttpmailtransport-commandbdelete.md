...
keywords: ["CommandBDELETE method Windows Mail (formerly Outlook Express)", "CommandBDELETE method Windows Mail (formerly Outlook Express) , IHTTPMailTransport interface", "IHTTPMailTransport interface Windows Mail (formerly Outlook Express) , CommandBDELETE method"]
topic_type:
- apiref
api_name:
