...
keywords: ["GetCriteria method Windows Mail (formerly Outlook Express)", "GetCriteria method Windows Mail (formerly Outlook Express) , IOECriteria interface", "IOECriteria interface Windows Mail (formerly Outlook Express) , GetCriteria method"]
topic_type:
- apiref
api_name:
