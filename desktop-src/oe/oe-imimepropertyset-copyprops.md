...
keywords: ["CopyProps method Windows Mail (formerly Outlook Express)", "CopyProps method Windows Mail (formerly Outlook Express) , IMimePropertySet interface", "IMimePropertySet interface Windows Mail (formerly Outlook Express) , CopyProps method"]
topic_type:
- apiref
api_name:
