...
keywords: ["CommandMKCOL method Windows Mail (formerly Outlook Express)", "CommandMKCOL method Windows Mail (formerly Outlook Express) , IHTTPMailTransport interface", "IHTTPMailTransport interface Windows Mail (formerly Outlook Express) , CommandMKCOL method"]
topic_type:
- apiref
api_name:
