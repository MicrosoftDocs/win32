...
keywords: ["GetRecipient method Windows Mail (formerly Outlook Express)", "GetRecipient method Windows Mail (formerly Outlook Express) , IMimeSecurity2 interface", "IMimeSecurity2 interface Windows Mail (formerly Outlook Express) , GetRecipient method"]
topic_type:
- apiref
api_name:
