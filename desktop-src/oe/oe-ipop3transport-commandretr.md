...
\[**IPOP3Transport::CommandRETR** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the RETR command to the server for the specified message or messages.
