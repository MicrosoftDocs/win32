...
keywords: ["Init method Windows Mail (formerly Outlook Express)", "Init method Windows Mail (formerly Outlook Express) , IFontCache interface", "IFontCache interface Windows Mail (formerly Outlook Express) , Init method"]
topic_type:
- apiref
api_name:
- IFontCache.Init
