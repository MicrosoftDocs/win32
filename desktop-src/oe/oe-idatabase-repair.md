...
keywords: ["Repair method Windows Mail (formerly Outlook Express)", "Repair method Windows Mail (formerly Outlook Express) , IDatabase interface", "IDatabase interface Windows Mail (formerly Outlook Express) , Repair method"]
topic_type:
- apiref
api_name:
- IDatabase.Repair
