...
- DeleteProp method Windows Mail (formerly Outlook Express) , IMimeMessage interface
- IMimeMessage interface Windows Mail (formerly Outlook Express) , DeleteProp method
topic_type:
- apiref
api_name:
