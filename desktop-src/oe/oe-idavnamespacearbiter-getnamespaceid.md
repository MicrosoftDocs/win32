...
keywords: ["GetNamespaceID method Windows Mail (formerly Outlook Express)", "GetNamespaceID method Windows Mail (formerly Outlook Express) , IDAVNamespaceArbiter interface", "IDAVNamespaceArbiter interface Windows Mail (formerly Outlook Express) , GetNamespaceID method"]
topic_type:
- apiref
api_name:
