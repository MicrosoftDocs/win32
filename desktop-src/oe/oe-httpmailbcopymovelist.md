...
keywords: ["HTTPMAILBCOPYMOVELIST structure Windows Mail (formerly Outlook Express)", "LPHTTPMAILBCOPYMOVELIST structure pointer Windows Mail (formerly Outlook Express)"]
topic_type:
- apiref
api_name:
