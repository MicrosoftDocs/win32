...
- GetParentWindow method Windows Mail (formerly Outlook Express) , IHTTPMailCallback interface
- IHTTPMailCallback interface Windows Mail (formerly Outlook Express) , GetParentWindow method
topic_type:
- apiref
api_name:
