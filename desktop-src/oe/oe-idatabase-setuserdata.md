...
keywords:
- SetUserData method Windows Mail (formerly Outlook Express)
- SetUserData method Windows Mail (formerly Outlook Express) , IDatabase interface
- IDatabase interface Windows Mail (formerly Outlook Express) , SetUserData method
topic_type:
- apiref
api_name:
