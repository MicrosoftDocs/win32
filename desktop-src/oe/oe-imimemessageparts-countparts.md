...
keywords:
- CountParts method Windows Mail (formerly Outlook Express)
- CountParts method Windows Mail (formerly Outlook Express) , IMimeMessageParts interface
- IMimeMessageParts interface Windows Mail (formerly Outlook Express) , CountParts method
topic_type:
- apiref
api_name:
