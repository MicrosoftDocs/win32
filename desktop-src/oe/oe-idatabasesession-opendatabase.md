...
keywords: ["OpenDatabase method Windows Mail (formerly Outlook Express)", "OpenDatabase method Windows Mail (formerly Outlook Express) , IDatabaseSession interface", "IDatabaseSession interface Windows Mail (formerly Outlook Express) , OpenDatabase method"]
topic_type:
- apiref
api_name:
