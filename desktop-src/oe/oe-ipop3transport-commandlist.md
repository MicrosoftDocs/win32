...
\[**IPOP3Transport::CommandLIST** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the LIST command to the server for the specified message or messages.
...
Specifies a **DWORD** that contains the ID of the message for which to get size information. This parameter can be **NULL** when the *cmdtype* is [**POP3CMD\_GET\_MARKED**](oe-pop3cmdtype.md) or **POP3CMD\_GET\_ALL**.
