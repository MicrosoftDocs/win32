...
keywords: ["GetFont method Windows Mail (formerly Outlook Express)", "GetFont method Windows Mail (formerly Outlook Express) , IFontCache interface", "IFontCache interface Windows Mail (formerly Outlook Express) , GetFont method"]
topic_type:
- apiref
api_name:
- IFontCache.GetFont
