...
keywords: ["CompactAll method Windows Mail (formerly Outlook Express)", "CompactAll method Windows Mail (formerly Outlook Express) , IStoreNamespace interface", "IStoreNamespace interface Windows Mail (formerly Outlook Express) , CompactAll method"]
topic_type:
- apiref
api_name:
