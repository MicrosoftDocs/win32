...
keywords:
- CommandMOVE method Windows Mail (formerly Outlook Express)
- CommandMOVE method Windows Mail (formerly Outlook Express) , IHTTPMailTransport interface
- IHTTPMailTransport interface Windows Mail (formerly Outlook Express) , CommandMOVE method
topic_type:
- apiref
api_name:
