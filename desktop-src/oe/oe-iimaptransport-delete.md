...
\[**IIMAPTransport::Delete** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the DELETE command to the Internet Message Access Protocol (IMAP) server.
