...
keywords:
- Unsubscribe method Windows Mail (formerly Outlook Express)
- Unsubscribe method Windows Mail (formerly Outlook Express) , IIMAPTransport interface
- IIMAPTransport interface Windows Mail (formerly Outlook Express) , Unsubscribe method
topic_type:
- apiref
api_name:
