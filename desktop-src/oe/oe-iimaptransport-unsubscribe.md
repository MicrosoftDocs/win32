---
title: IIMAPTransport Unsubscribe method
description: Sends the UNSUBSCRIBE command to the Internet Message Access Protocol (IMAP) server.
ms.assetid: '54cf2f9f-e9a6-4267-8f5f-3850e40faa5b'
keywords: ["Unsubscribe method Windows Mail (formerly Outlook Express)", "Unsubscribe method Windows Mail (formerly Outlook Express) , IIMAPTransport interface", "IIMAPTransport interface Windows Mail (formerly Outlook Express) , Unsubscribe method"]
topic_type:
- apiref
api_name:
- IIMAPTransport.Unsubscribe
api_location:
- Inetcomm.dll
api_type:
- COM
...
# IIMAPTransport::Unsubscribe method

\[**IIMAPTransport::Unsubscribe** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the UNSUBSCRIBE command to the Internet Message Access Protocol (IMAP) server.
