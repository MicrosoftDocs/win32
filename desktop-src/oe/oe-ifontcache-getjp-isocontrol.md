...
keywords: ["GetJP_ISOControl method Windows Mail (formerly Outlook Express)", "GetJP_ISOControl method Windows Mail (formerly Outlook Express) , IFontCache interface", "IFontCache interface Windows Mail (formerly Outlook Express) , GetJP_ISOControl method"]
topic_type:
- apiref
api_name:
