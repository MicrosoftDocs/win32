...
\[**IImnAccount::DoImportWizard** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Creates a wizard for importing an account.
...
Specifies the **CLSID** of the account object to import.
