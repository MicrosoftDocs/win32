...
keywords: ["GenerateXML method Windows Mail (formerly Outlook Express)", "GenerateXML method Windows Mail (formerly Outlook Express) , IPropFindRequest interface", "IPropFindRequest interface Windows Mail (formerly Outlook Express) , GenerateXML method"]
topic_type:
- apiref
api_name:
