...
keywords:
- GetURL method Windows Mail (formerly Outlook Express)
- GetURL method Windows Mail (formerly Outlook Express) , IMimeWebDocument interface
- IMimeWebDocument interface Windows Mail (formerly Outlook Express) , GetURL method
topic_type:
- apiref
api_name:
