...
keywords: ["SaveReg method Windows Mail (formerly Outlook Express)", "SaveReg method Windows Mail (formerly Outlook Express) , IOECriteria interface", "IOECriteria interface Windows Mail (formerly Outlook Express) , SaveReg method"]
topic_type:
- apiref
api_name:
- IOECriteria.SaveReg
