...
keywords:
- GetActions method Windows Mail (formerly Outlook Express)
- GetActions method Windows Mail (formerly Outlook Express) , IOEActions interface
- IOEActions interface Windows Mail (formerly Outlook Express) , GetActions method
topic_type:
- apiref
api_name:
