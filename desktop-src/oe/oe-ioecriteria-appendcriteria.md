...
keywords: ["AppendCriteria method Windows Mail (formerly Outlook Express)", "AppendCriteria method Windows Mail (formerly Outlook Express) , IOECriteria interface", "IOECriteria interface Windows Mail (formerly Outlook Express) , AppendCriteria method"]
topic_type:
- apiref
api_name:
