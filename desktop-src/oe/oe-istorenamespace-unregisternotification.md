...
- UnregisterNotification method Windows Mail (formerly Outlook Express) , IStoreNamespace interface
- IStoreNamespace interface Windows Mail (formerly Outlook Express) , UnregisterNotification method
topic_type:
- apiref
api_name:
