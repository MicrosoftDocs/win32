...
keywords: ["GetDefaultAccount method Windows Mail (formerly Outlook Express)", "GetDefaultAccount method Windows Mail (formerly Outlook Express) , IImnAccountManager interface", "IImnAccountManager interface Windows Mail (formerly Outlook Express) , GetDefaultAccount method"]
topic_type:
- apiref
api_name:
