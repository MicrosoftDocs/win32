---
title: IIMAPTransport Close method
description: Sends the CLOSE command to the Internet Message Access Protocol (IMAP) server.
ms.assetid: 'c1f79d7c-23cf-4e4d-9faf-3d49789d30dc'
keywords: ["Close method Windows Mail (formerly Outlook Express)", "Close method Windows Mail (formerly Outlook Express) , IIMAPTransport interface", "IIMAPTransport interface Windows Mail (formerly Outlook Express) , Close method"]
topic_type:
- apiref
api_name:
- IIMAPTransport.Close
api_location:
- Inetcomm.dll
api_type:
- COM
...
# IIMAPTransport::Close method

\[**IIMAPTransport::Close** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the CLOSE command to the Internet Message Access Protocol (IMAP) server.
