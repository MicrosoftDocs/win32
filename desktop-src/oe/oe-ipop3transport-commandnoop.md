...
keywords:
- CommandNOOP method Windows Mail (formerly Outlook Express)
- CommandNOOP method Windows Mail (formerly Outlook Express) , IPOP3Transport interface
- IPOP3Transport interface Windows Mail (formerly Outlook Express) , CommandNOOP method
topic_type:
- apiref
api_name:
