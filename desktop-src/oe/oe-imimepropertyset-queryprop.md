...
- QueryProp method Windows Mail (formerly Outlook Express) , IMimePropertySet interface
- IMimePropertySet interface Windows Mail (formerly Outlook Express) , QueryProp method
topic_type:
- apiref
api_name:
