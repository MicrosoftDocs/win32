---
title: IIMAPTransport Store method
description: Sends the STORE command to the Internet Message Access Protocol (IMAP) server.
ms.assetid: 'df067550-128f-40bf-bb35-d8defc82a7fa'
keywords: ["Store method Windows Mail (formerly Outlook Express)", "Store method Windows Mail (formerly Outlook Express) , IIMAPTransport interface", "IIMAPTransport interface Windows Mail (formerly Outlook Express) , Store method"]
topic_type:
- apiref
api_name:
- IIMAPTransport.Store
api_location:
- Inetcomm.dll
api_type:
- COM
...
# IIMAPTransport::Store method

\[**IIMAPTransport::Store** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the STORE command to the Internet Message Access Protocol (IMAP) server.
...
Specifies an [**IRangeList**](oe-irangelist.md) object that represents the range of messages to store.
