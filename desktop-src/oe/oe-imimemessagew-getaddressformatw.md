...
keywords:
- GetAddressFormatW method Windows Mail (formerly Outlook Express)
- GetAddressFormatW method Windows Mail (formerly Outlook Express) , IMimeMessageW interface
- IMimeMessageW interface Windows Mail (formerly Outlook Express) , GetAddressFormatW method
topic_type:
- apiref
api_name:
