...
- SetWindow method Windows Mail (formerly Outlook Express) , INNTPTransport2 interface
- INNTPTransport2 interface Windows Mail (formerly Outlook Express) , SetWindow method
topic_type:
- apiref
api_name:
