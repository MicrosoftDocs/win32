...
keywords: ["SetCriteria method Windows Mail (formerly Outlook Express)", "SetCriteria method Windows Mail (formerly Outlook Express) , IOECriteria interface", "IOECriteria interface Windows Mail (formerly Outlook Express) , SetCriteria method"]
topic_type:
- apiref
api_name:
