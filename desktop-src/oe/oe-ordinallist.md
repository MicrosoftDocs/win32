...
keywords: ["ORDINALLIST structure Windows Mail (formerly Outlook Express)", "ORGINALLIST structure Windows Mail (formerly Outlook Express)", "LPORDINALLIST structure pointer Windows Mail (formerly Outlook Express)"]
topic_type:
- apiref
api_name:
- ORGINALLIST
