...
keywords:
- Advise method Windows Mail (formerly Outlook Express)
- Advise method Windows Mail (formerly Outlook Express) , IImnAccountManager interface
- IImnAccountManager interface Windows Mail (formerly Outlook Express) , Advise method
topic_type:
- apiref
api_name:
