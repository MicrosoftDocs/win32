...
keywords: ["HTTPCONTACTIDLIST structure Windows Mail (formerly Outlook Express)", "LPHTTPCONTACTIDLIST structure pointer Windows Mail (formerly Outlook Express)"]
topic_type:
- apiref
api_name:
- HTTPCONTACTIDLIST
