...
keywords: ["HTTPMEMBERERRORLIST structure Windows Mail (formerly Outlook Express)", "LPHTTPMEMBERERRORLIST structure pointer Windows Mail (formerly Outlook Express)"]
topic_type:
- apiref
api_name:
- HTTPMEMBERERRORLIST
