...
keywords:
- GetMessageType method Windows Mail (formerly Outlook Express)
- GetMessageType method Windows Mail (formerly Outlook Express) , IMimeSecurity interface
- IMimeSecurity interface Windows Mail (formerly Outlook Express) , GetMessageType method
topic_type:
- apiref
api_name:
