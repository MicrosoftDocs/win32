...
keywords: ["Validate method Windows Mail (formerly Outlook Express)", "Validate method Windows Mail (formerly Outlook Express) , IOERule interface", "IOERule interface Windows Mail (formerly Outlook Express) , Validate method"]
topic_type:
- apiref
api_name:
- IOERule.Validate
