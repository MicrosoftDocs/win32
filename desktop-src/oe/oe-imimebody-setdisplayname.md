...
keywords:
- SetDisplayName method Windows Mail (formerly Outlook Express)
- SetDisplayName method Windows Mail (formerly Outlook Express) , IMimeBody interface
- IMimeBody interface Windows Mail (formerly Outlook Express) , SetDisplayName method
topic_type:
- apiref
api_name:
