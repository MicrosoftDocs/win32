...
keywords: ["GetRootMoniker method Windows Mail (formerly Outlook Express)", "GetRootMoniker method Windows Mail (formerly Outlook Express) , IMimeMessage interface", "IMimeMessage interface Windows Mail (formerly Outlook Express) , GetRootMoniker method"]
topic_type:
- apiref
api_name:
