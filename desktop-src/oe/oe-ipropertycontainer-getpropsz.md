...
keywords: ["GetPropSz method Windows Mail (formerly Outlook Express)", "GetPropSz method Windows Mail (formerly Outlook Express) , IPropertyContainer interface", "IPropertyContainer interface Windows Mail (formerly Outlook Express) , GetPropSz method"]
topic_type:
- apiref
api_name:
