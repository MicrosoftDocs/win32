...
keywords: ["Delete method Windows Mail (formerly Outlook Express)", "Delete method Windows Mail (formerly Outlook Express) , IImnAccount interface", "IImnAccount interface Windows Mail (formerly Outlook Express) , Delete method"]
topic_type:
- apiref
api_name:
- IImnAccount.Delete
