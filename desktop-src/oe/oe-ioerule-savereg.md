...
keywords: ["SaveReg method Windows Mail (formerly Outlook Express)", "SaveReg method Windows Mail (formerly Outlook Express) , IOERule interface", "IOERule interface Windows Mail (formerly Outlook Express) , SaveReg method"]
topic_type:
- apiref
api_name:
- IOERule.SaveReg
