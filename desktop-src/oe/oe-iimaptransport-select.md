...
keywords:
- Select method Windows Mail (formerly Outlook Express)
- Select method Windows Mail (formerly Outlook Express) , IIMAPTransport interface
- IIMAPTransport interface Windows Mail (formerly Outlook Express) , Select method
topic_type:
- apiref
api_name:
