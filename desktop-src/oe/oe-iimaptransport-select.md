---
title: IIMAPTransport Select method
description: Sends the SELECT command to the Internet Message Access Protocol (IMAP) server.
ms.assetid: '9587102e-95b7-4a43-90e4-ebe6ef32b05e'
keywords: ["Select method Windows Mail (formerly Outlook Express)", "Select method Windows Mail (formerly Outlook Express) , IIMAPTransport interface", "IIMAPTransport interface Windows Mail (formerly Outlook Express) , Select method"]
topic_type:
- apiref
api_name:
- IIMAPTransport.Select
api_location:
- Inetcomm.dll
api_type:
- COM
...
# IIMAPTransport::Select method

\[**IIMAPTransport::Select** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the SELECT command to the Internet Message Access Protocol (IMAP) server.
