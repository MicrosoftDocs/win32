...
keywords:
- FindFolders method Windows Mail (formerly Outlook Express)
- FindFolders method Windows Mail (formerly Outlook Express) , IHTTPMailTransport interface
- IHTTPMailTransport interface Windows Mail (formerly Outlook Express) , FindFolders method
topic_type:
- apiref
api_name:
