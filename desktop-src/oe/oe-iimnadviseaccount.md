...
keywords: ["IImnAdviseAccount interface Windows Mail (formerly Outlook Express)", "IImnAdviseAccount interface Windows Mail (formerly Outlook Express) , described"]
topic_type:
- apiref
api_name:
- IImnAdviseAccount
