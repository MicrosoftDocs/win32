...
keywords: ["BatchUnlock method Windows Mail (formerly Outlook Express)", "BatchUnlock method Windows Mail (formerly Outlook Express) , IStoreFolder interface", "IStoreFolder interface Windows Mail (formerly Outlook Express) , BatchUnlock method"]
topic_type:
- apiref
api_name:
