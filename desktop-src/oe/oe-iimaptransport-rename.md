...
\[**IIMAPTransport::Rename** is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions.\]

Sends the RENAME command to the Internet Message Access Protocol (IMAP) server.
...
Specifies an **LPCSTR** that contains the current IMAP-compliant mailbox name.

</dd> <dt>

*lpszNewMailboxName* \[in\]
</dt> <dd>

Type: **LPCSTR**

Specifies an **LPCSTR** that contains the new IMAP-compliant mailbox name as a multibyte string.
