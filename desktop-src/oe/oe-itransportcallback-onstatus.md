...
keywords: ["OnStatus method Windows Mail (formerly Outlook Express)", "OnStatus method Windows Mail (formerly Outlook Express) , ITransportCallback interface", "ITransportCallback interface Windows Mail (formerly Outlook Express) , OnStatus method"]
topic_type:
- apiref
api_name:
