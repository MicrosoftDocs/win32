...
- GetState method Windows Mail (formerly Outlook Express) , IOECriteria interface
- IOECriteria interface Windows Mail (formerly Outlook Express) , GetState method
topic_type:
- apiref
api_name:
