...
keywords: ["GetFlags method Windows Mail (formerly Outlook Express)", "GetFlags method Windows Mail (formerly Outlook Express) , IMimeMessageTree interface", "IMimeMessageTree interface Windows Mail (formerly Outlook Express) , GetFlags method"]
topic_type:
- apiref
api_name:
