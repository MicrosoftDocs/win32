...
keywords:
- Clear method Windows Mail (formerly Outlook Express)
- Clear method Windows Mail (formerly Outlook Express) , IRangeList interface
- IRangeList interface Windows Mail (formerly Outlook Express) , Clear method
topic_type:
- apiref
api_name:
- IRangeList.Clear
