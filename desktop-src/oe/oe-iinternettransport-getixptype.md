...
keywords: ["GetIXPType method Windows Mail (formerly Outlook Express)", "GetIXPType method Windows Mail (formerly Outlook Express) , IInternetTransport interface", "IInternetTransport interface Windows Mail (formerly Outlook Express) , GetIXPType method"]
topic_type:
- apiref
api_name:
