...
keywords: ["HTTPMAILBCOPYMOVE structure Windows Mail (formerly Outlook Express)", "LPHTTPMAILBCOPYMOVE structure pointer Windows Mail (formerly Outlook Express)"]
topic_type:
- apiref
api_name:
- HTTPMAILBCOPYMOVE
