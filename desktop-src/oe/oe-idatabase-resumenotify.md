...
keywords:
- ResumeNotify method Windows Mail (formerly Outlook Express)
- ResumeNotify method Windows Mail (formerly Outlook Express) , IDatabase interface
- IDatabase interface Windows Mail (formerly Outlook Express) , ResumeNotify method
topic_type:
- apiref
api_name:
