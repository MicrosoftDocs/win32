---
title: WINBIO\_VERSION structure
...
keywords: ["WINBIO_VERSION structure Windows Biometric Framework API", "PWINBIO_VERSION structure pointer Windows Biometric Framework API"]
topic_type:
- apiref
api_name:
- WINBIO_VERSION
