...
| [**SensorAdapterFinishCapture**](/windows/desktop/api/Winbio_adapter/nc-winbio_adapter-pibio_sensor_finish_capture_fn)<br/>                     | Retrieves a value that indicates whether the sensor indicator is on or off.<br/>                                                                                       |
