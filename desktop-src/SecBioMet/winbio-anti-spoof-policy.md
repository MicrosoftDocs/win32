...
keywords: ["WINBIO_ANTI_SPOOF_POLICY structure Windows Biometric Framework API", "PWINBIO_ANTI_SPOOF_POLICY structure pointer Windows Biometric Framework API"]
topic_type:
- apiref
api_name:
...
[**WinBioSetProperty**](winbiosetproperty.md)
</dt> </dl>
