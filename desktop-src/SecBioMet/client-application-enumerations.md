...
| [**WINBIO\_ASYNC\_NOTIFICATION\_METHOD**](/windows/win32/Winbio/ne-winbio-_winbio_async_notification_method?branch=master)<br/> | Defines constants that specify how completion notifications for asynchronous operations are to be delivered to the client application.<br/> |
