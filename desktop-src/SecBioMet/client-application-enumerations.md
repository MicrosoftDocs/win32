...
keywords: ["Windows Biometric Framework API Windows Biometric Framework API , client application enumerations"]
---
...
| [**WINBIO\_ASYNC\_NOTIFICATION\_METHOD**](winbio-async-notification-method.md)<br/> | Defines constants that specify how completion notifications for asynchronous operations are to be delivered to the client application.<br/> |
