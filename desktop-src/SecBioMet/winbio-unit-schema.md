...
The **WINBIO\_UNIT\_SCHEMA** structure describes the capabilities of a biometric unit. It is used by the [**WinBioEnumBiometricUnits**](/windows/win32/Winbio/nf-winbio-winbioenumbiometricunits?branch=master) function.
