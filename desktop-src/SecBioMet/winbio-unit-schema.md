...
keywords: ["WINBIO_UNIT_SCHEMA structure Windows Biometric Framework API", "PWINBIO_UNIT_SCHEMA structure pointer Windows Biometric Framework API"]
topic_type:
- apiref
api_name:
- WINBIO_UNIT_SCHEMA
...
The **WINBIO\_UNIT\_SCHEMA** structure describes the capabilities of a biometric unit. It is used by the [**WinBioEnumBiometricUnits**](winbioenumbiometricunits.md) function.
...
[**WinBioEnumBiometricUnits**](winbioenumbiometricunits.md)
</dt> </dl>
