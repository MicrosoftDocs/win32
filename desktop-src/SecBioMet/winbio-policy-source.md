---
title: WINBIO\_POLICY\_SOURCE enumeration
...
keywords: ["WINBIO_POLICY_SOURCE enumeration Windows Biometric Framework API", "PWINBIO_POLICY_SOURCE enumeration pointer Windows Biometric Framework API"]
topic_type:
- apiref
api_name:
