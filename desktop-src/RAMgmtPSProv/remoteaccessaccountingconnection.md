...
- apiref
api_name:
- RemoteAccessAccountingConnection
- RemoteAccessAccountingConnection.ClientIPv4Address
- RemoteAccessAccountingConnection.ClientIPv6Address
- RemoteAccessAccountingConnection.HostName
- RemoteAccessAccountingConnection.ClientExternalAddress
- RemoteAccessAccountingConnection.TunnelType
- RemoteAccessAccountingConnection.TransitionTechnology
- RemoteAccessAccountingConnection.ConnectionStartTime
- RemoteAccessAccountingConnection.ConnectionDuration
- RemoteAccessAccountingConnection.TotalBytesIn
- RemoteAccessAccountingConnection.TotalBytesOut
- RemoteAccessAccountingConnection.ConnectionType
- RemoteAccessAccountingConnection.HealthStatus
- RemoteAccessAccountingConnection.AuthMethod
- RemoteAccessAccountingConnection.UserName
- RemoteAccessAccountingConnection.SessionId
api_location:
...
The **RemoteAccessAccountingConnection** class has these types of members:

-   [Properties](#properties)

### Properties

The **RemoteAccessAccountingConnection** class has these properties.
