...
- RemoteAccessConnection.ClientIPv4Address
- RemoteAccessConnection.ClientIPv6Address
- RemoteAccessConnection.HostName
- RemoteAccessConnection.ClientExternalAddress
- RemoteAccessConnection.TunnelType
- RemoteAccessConnection.TransitionTechnology
- RemoteAccessConnection.ConnectionStartTime
- RemoteAccessConnection.ConnectionDuration
- RemoteAccessConnection.TotalBytesIn
- RemoteAccessConnection.TotalBytesOut
- RemoteAccessConnection.ConnectionType
- RemoteAccessConnection.HealthStatus
- RemoteAccessConnection.AuthMethod
api_location:
