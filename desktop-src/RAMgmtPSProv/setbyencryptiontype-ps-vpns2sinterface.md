---
title: SetByEncryptionType method of the PS\_VpnS2SInterface class
description: Modifies parameters in an S2S Interface. If the interface is already connected, the changes take effect after disconnection.
audience: developer
ms.assetid: '4bd210b4-58ee-4a22-909d-90293c13efde'
ms.prod: 'windows-server-dev'
ms.technology:
- 'remote-access'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetByEncryptionType method", "SetByEncryptionType method, PS_VpnS2SInterface class", "PS_VpnS2SInterface class, SetByEncryptionType method"]
topic_type:
- apiref
api_name:
- PS_VpnS2SInterface.SetByEncryptionType
api_location:
...
# SetByEncryptionType method of the PS\_VpnS2SInterface class

Modifies parameters in an S2S Interface. If the interface is already connected, the changes take effect after disconnection.
...
Number of times the connection is retried. Specify 0 for an unlimited number of retries.
