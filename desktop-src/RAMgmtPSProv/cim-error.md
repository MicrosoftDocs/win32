...
audience: developer
ms.assetid: 7dee0e77-c706-4cfb-834d-5e68642a53bd
...
``` syntax
[Indication, Exception, UMLPackagePath("CIM::Interop"), dynamic, provider("RAMgmtPSProvider"), Version("2.22.1"), AMENDMENT]
class CIM_Error
{
  uint16 ErrorType;
