---
title: VpnS2SMultiTenantCustomInterface class
description: Represents a custom site-to-site (S2S) VPN interface for a multi-tenant gateway.
audience: developer
ms.assetid: '5131dedb-d9a4-46e7-aea8-cff6e9177570'
ms.prod: 'windows-server-dev'
ms.technology:
- 'remote-access'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["VpnS2SMultiTenantCustomInterface class", "VpnS2SMultiTenantCustomInterface class, described"]
topic_type:
- apiref
api_name:
- VpnS2SMultiTenantCustomInterface
- VpnS2SMultiTenantCustomInterface.Protocol
- VpnS2SMultiTenantCustomInterface.Destination
- VpnS2SMultiTenantCustomInterface.AdminStatus
- VpnS2SMultiTenantCustomInterface.InterfaceType
- VpnS2SMultiTenantCustomInterface.RetryInterval
- VpnS2SMultiTenantCustomInterface.SADataSizeForRenegotiation
- VpnS2SMultiTenantCustomInterface.SALifeTime
- VpnS2SMultiTenantCustomInterface.IPv6Subnet
- VpnS2SMultiTenantCustomInterface.IPv4Subnet
- VpnS2SMultiTenantCustomInterface.Name
- VpnS2SMultiTenantCustomInterface.UserName
- VpnS2SMultiTenantCustomInterface.Certificate
- VpnS2SMultiTenantCustomInterface.NetworkOutageTime
- VpnS2SMultiTenantCustomInterface.NumberOfTries
- VpnS2SMultiTenantCustomInterface.PromoteAlternate
- VpnS2SMultiTenantCustomInterface.AuthenticationMethod
- VpnS2SMultiTenantCustomInterface.ResponderAuthenticationMethod
- VpnS2SMultiTenantCustomInterface.EapMethod
- VpnS2SMultiTenantCustomInterface.InternalIPv4
- VpnS2SMultiTenantCustomInterface.InternalIPv6
- VpnS2SMultiTenantCustomInterface.IdleDisconnect
- VpnS2SMultiTenantCustomInterface.LastError
- VpnS2SMultiTenantCustomInterface.UnReachabilityReasons
- VpnS2SMultiTenantCustomInterface.ConnectionState
- VpnS2SMultiTenantCustomInterface.IPv4TriggerFilter
- VpnS2SMultiTenantCustomInterface.IPv4TriggerFilterAction
- VpnS2SMultiTenantCustomInterface.PostConnectionIPv4Subnet
- VpnS2SMultiTenantCustomInterface.IPv6TriggerFilter
- VpnS2SMultiTenantCustomInterface.IPv6TriggerFilterAction
- VpnS2SMultiTenantCustomInterface.PostConnectionIPv6Subnet
- VpnS2SMultiTenantCustomInterface.Persistent
- VpnS2SMultiTenantCustomInterface.InitiateConfigPayload
- VpnS2SMultiTenantCustomInterface.EnableQoS
- VpnS2SMultiTenantCustomInterface.TxBandwidthKbps
- VpnS2SMultiTenantCustomInterface.RxBandwidthKbps
- VpnS2SMultiTenantCustomInterface.SourceIpAddress
- VpnS2SMultiTenantCustomInterface.MMSALifeTime
- VpnS2SMultiTenantCustomInterface.LocalVpnTrafficSelector
- VpnS2SMultiTenantCustomInterface.RemoteVpnTrafficSelector
- VpnS2SMultiTenantCustomInterface.LastDisconnectReason
- VpnS2SMultiTenantCustomInterface.EncryptionMethod
- VpnS2SMultiTenantCustomInterface.IntegrityCheckMethod
- VpnS2SMultiTenantCustomInterface.CipherTransformConstants
- VpnS2SMultiTenantCustomInterface.DHGroup
- VpnS2SMultiTenantCustomInterface.AuthenticationTransformConstants
- VpnS2SMultiTenantCustomInterface.PfsGroup
- VpnS2SMultiTenantCustomInterface.CustomPolicy
- VpnS2SMultiTenantCustomInterface.RoutingDomain
- VpnS2SMultiTenantCustomInterface.RadiusAttributeClass
api_location:
...
# VpnS2SMultiTenantCustomInterface class
...
class VpnS2SMultiTenantCustomInterface : VpnS2SCustomInterface
{
  string             Protocol;
  string             Destination[];
  boolean            AdminStatus;
...
The **VpnS2SMultiTenantCustomInterface** class has these types of members:

-   [Properties](#properties)

### Properties

The **VpnS2SMultiTenantCustomInterface** class has these properties.
...
This property is inherited from [**VpnS2SCustomInterface**](vpns2scustominterface.md).
