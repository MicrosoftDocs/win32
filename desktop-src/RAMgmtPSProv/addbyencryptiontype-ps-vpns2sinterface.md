---
title: AddByEncryptionType method of the PS\_VpnS2SInterface class
description: Creates an S2S Interface with the specified parameters.
audience: developer
ms.assetid: 'a082d603-24d4-452e-9974-a0048f6c4ce2'
ms.prod: 'windows-server-dev'
ms.technology:
- 'remote-access'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["AddByEncryptionType method", "AddByEncryptionType method, PS_VpnS2SInterface class", "PS_VpnS2SInterface class, AddByEncryptionType method"]
topic_type:
- apiref
api_name:
- PS_VpnS2SInterface.AddByEncryptionType
api_location:
...
# AddByEncryptionType method of the PS\_VpnS2SInterface class
...
he bandwidth limit for outgoing traffic to the VPN interface, in kbps.
...
Number of kilobytes that are allowed to transfer using a SA. After the transfer, the SA will be renegotiated.
