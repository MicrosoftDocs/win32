...
api_name:
- RemoteAccessDA
- RemoteAccessDA.InternetInterface
- RemoteAccessDA.InternalInterface
- RemoteAccessDA.SslCertificate
- RemoteAccessDA.DAStatus
- RemoteAccessDA.VpnStatus
- RemoteAccessDA.VpnS2SStatus
- RemoteAccessDA.LoadBalancing
- RemoteAccessDA.SstpProxyStatus
- RemoteAccessDA.RoutingStatus
- RemoteAccessDA.UseHttp
- RemoteAccessDA.DAConfiguration
api_location:
...
A [**DirectAccessConfiguration**](directaccessconfiguration.md) embedded instance
