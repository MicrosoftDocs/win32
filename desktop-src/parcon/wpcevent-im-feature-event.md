...
title: WPCEVENT\_IM\_FEATURE event
ms.date: 05/31/2018
ms.topic: article
...
A value of the [**WPCFLAG\_IM\_FEATURE**](/windows/win32/Wpcevent/ne-wpcevent-tagwpcflag_im_feature?branch=master) enumeration that indicates information about the features accessed during an instant messaging interaction.
