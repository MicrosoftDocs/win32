...
title: WPCEVENT\_IM\_LEAVE event
ms.date: 05/31/2018
ms.topic: article
...
A value of the [**WPCFLAG\_IM\_LEAVE**](/windows/win32/Wpcevent/ne-wpcevent-tagwpcflag_im_leave_flag?branch=master) enumeration that indicates information about when a participant leaves the instant messaging interaction.
