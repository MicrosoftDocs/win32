...
title: WPCEVENT\_MEDIA\_PLAYBACK event
ms.date: 05/31/2018
ms.topic: article
...
A value of the [**WPC\_MEDIA\_TYPE**](/windows/win32/Wpcevent/ne-wpcevent-tagwpc_media_type?branch=master) enumeration that indicates information about the type of media file accessed.
...
A value of the [**WPC\_MEDIA\_EXPLICIT**](/windows/win32/Wpcevent/ne-wpcevent-tagwpc_media_explicit_type?branch=master) enumeration that indicates information about the explicit rating of the media file.
