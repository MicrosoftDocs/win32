...
A value of the [**WPC\_MEDIA\_TYPE**](wpc-media-type.md) enumeration that indicates information about the type of media file accessed.
...
A value of the [**WPC\_MEDIA\_EXPLICIT**](wpc-media-explicit.md) enumeration that indicates information about the explicit rating of the media file.
