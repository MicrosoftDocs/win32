...
This parameter can be one or more of the following [**ExportListOptions**](/windows/desktop/api/MmcObj/ne-mmcobj-exportlistoptions) values. These flags can be combined using a bitwise OR operation.
