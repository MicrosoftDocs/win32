...
The **MMCN\_CUTORMOVE** notification message is sent to the snap-in's [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) after items owned by the snap-in have been cut or moved.
