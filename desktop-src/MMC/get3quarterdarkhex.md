---
title: SysColorCtrl.Get3QuarterDarkHex method
description: The Get3QuarterDarkHex method derives a \ 0034;darker \ 0034; color by calculating a color that is blended 75 between a given color and black. The derived color will be a blend of 25 of the given color and 75 black. It is returned as a hexadecimal value.
audience: developer
...
- apiref
api_name:
- SysColorCtrl.Get3QuarterDarkHex
api_location:
- Cic.dll
api_type:
- COM
...
The **Get3QuarterDarkHex** method derives a "darker" color by calculating a color that is blended 75% between a given color and black. The derived color will be a blend of 25% of the given color and 75% black. It is returned as a hexadecimal value.

## Syntax


```VB
SysColorCtrl.Get3QuarterDarkHex( _
  ByVal pszFrom, _
  ByVal pszFormat _
)
```
