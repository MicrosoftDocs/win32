---
title: RMT\_OC\_RRAS clipboard format
...
ms.assetid: '576f0238-9041-4f4d-88e4-8098a603056c'
ms.prod: 'windows-server-dev'
ms.technology: 'microsoft-management-console'
ms.tgt_platform: multiple
keywords: ["RMT_OC_RRAS clipboard format MMC"]
topic_type:
- apiref
api_name:
- RMT_OC_RRAS
...
# RMT\_OC\_RRAS clipboard format
