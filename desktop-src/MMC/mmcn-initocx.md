...
The [**IUnknown**](_com_iunknown) to the OCX, the result pane. This is the same **IUnknown** you would get from [**IConsole::QueryResultView**](iconsole2-queryresultview.md).
