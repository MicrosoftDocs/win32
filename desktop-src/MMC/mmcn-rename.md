...
The **MMCN\_RENAME** notification message is sent to either the snap-in's [**IComponentData**](/windows/desktop/api/Mmc/nn-mmc-icomponentdata) or [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) implementation depending on the type of item (scope or result) that must be renamed.
