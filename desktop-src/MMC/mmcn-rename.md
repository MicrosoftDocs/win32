...
description: The MMCN\_RENAME notification message is sent to either the snap-ins IComponentData or IComponent implementation depending on the type of item (scope or result) that must be renamed.
audience: developer
