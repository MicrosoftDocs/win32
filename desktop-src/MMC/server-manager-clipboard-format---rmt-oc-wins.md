---
title: RMT\_OC\_WINS clipboard format
...
ms.assetid: '2f3a03ef-e170-400c-b067-26c330aff812'
ms.prod: 'windows-server-dev'
ms.technology: 'microsoft-management-console'
ms.tgt_platform: multiple
keywords: ["RMT_OC_WINS clipboard format MMC"]
topic_type:
- apiref
api_name:
- RMT_OC_WINS
...
# RMT\_OC\_WINS clipboard format
