...
description: The Application property returns the object that represents the documents parent application. This property is read-only.
audience: developer
...
keywords:
- Application property MMC
- Application property MMC , Document object
- Document object MMC , Application property
- Application property MMC , Document interface
- Document interface MMC , Application property
topic_type:
- apiref
api_name:
