...
keywords: ["CreateProperties method MMC", "CreateProperties method MMC , Document object", "Document object MMC , CreateProperties method", "CreateProperties method MMC , Document interface", "Document interface MMC , CreateProperties method"]
topic_type:
- apiref
api_name:
