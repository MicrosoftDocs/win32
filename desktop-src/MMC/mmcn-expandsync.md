...
The **MMCN\_EXPANDSYNC** notification message is sent to the snap-in's [**IComponentData**](/windows/desktop/api/Mmc/nn-mmc-icomponentdata) implementation when MMC requires a scope item to be expanded synchronously.
...
A pointer to an [**MMC\_EXPANDSYNC\_STRUCT**](/windows/desktop/api/Mmc/ns-mmc-_mmc_expandsync_struct) structure.
