...
The **MMCN\_COLUMN\_CLICK** notification message is sent to the snap-in's [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) implementation when the user clicks a list view column header.
