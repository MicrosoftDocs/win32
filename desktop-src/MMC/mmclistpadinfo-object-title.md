...
The returned property is the string specified in the szTitle member of [**MMC\_LISTPAD\_INFO**](/windows/desktop/api/Mmc/ns-mmc-_mmc_listpad_info) returned in the [**IExtendTaskPad::GetListPadInfo**](/windows/desktop/api/Mmc/nf-mmc-iextendtaskpad-getlistpadinfo) method of the snap-in.
