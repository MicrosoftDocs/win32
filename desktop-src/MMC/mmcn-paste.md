...
The **MMCN\_PASTE** notification message is sent to a snap-in's [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) implementation to tell the snap-in's scope item to paste the selected result items.
