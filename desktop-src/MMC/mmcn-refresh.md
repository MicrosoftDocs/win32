...
The **MMCN\_REFRESH** notification message is sent to a snap-in's [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) implementation when the refresh verb is selected. Refresh can be invoked through the context menu, through the toolbar, or by pressing F5.
