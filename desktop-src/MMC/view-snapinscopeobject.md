...
keywords:
- SnapinScopeObject method MMC
- SnapinScopeObject method MMC , View object
- View object MMC , SnapinScopeObject method
- SnapinScopeObject method MMC , View interface
- View interface MMC , SnapinScopeObject method
topic_type:
- apiref
api_name:
