...
Extension snap-ins are COM in-process DLLs that implement and expose MMC interfaces such as [**IExtendContextMenu**](/windows/desktop/api/Mmc/nn-mmc-iextendcontextmenu) and [**IExtendControlbar**](/windows/desktop/api/Mmc/nn-mmc-iextendcontrolbar).
