...
-   Call the MMC [**IDisplayHelp**](/windows/desktop/api/Mmc/nn-mmc-idisplayhelp) interface to properly display context-sensitive Help in the merged MMC HTML Help collections file.
-   Start Help to ensure that [**ISnapInHelp2**](/windows/desktop/api/Mmc/nn-mmc-isnapinhelp2) is implemented to give MMC the name of your Help file.
