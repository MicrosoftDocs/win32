...
An **MMC\_COOKIE** value is provided by a snap-in, and is passed by MMC to methods such as [**IComponent::QueryDataObject**](/windows/desktop/api/Mmc/nf-mmc-icomponent-querydataobject).
