...
MMC 2.0 supports [Multilingual User Interface](https://www.bing.com/search?q=Multilingual User Interface) systems by allowing a snap-in to use online Help files created for the user's specific language. If the user's language is not U.S. English, then MMC 2.0 searches for the online Help file based on the following location.
...
The name of the online Help file, as provided by the snap-in when MMC calls the [**ISnapinHelp2::GetHelpTopic**](https://www.bing.com/search?q=**ISnapinHelp2::GetHelpTopic**) method.
