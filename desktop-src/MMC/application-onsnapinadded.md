...
keywords:
- OnSnapInAdded event MMC
- OnSnapInAdded event MMC , Application object
- Application object MMC , OnSnapInAdded event
- OnSnapInAdded event MMC , AppEvents interface
- AppEvents interface MMC , OnSnapInAdded event
topic_type:
- apiref
api_name:
