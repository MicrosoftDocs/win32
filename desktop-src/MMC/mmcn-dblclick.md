...
The **MMCN\_DBLCLICK** notification message is sent to the snap-in's [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) implementation when a user double-clicks a mouse button on a list view item or on a scope item in the result pane.
