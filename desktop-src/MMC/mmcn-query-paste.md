...
The **MMCN\_QUERY\_PASTE** notification message is sent to a snap-in's [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) implementation to verify that the snap-in can paste the items from the given data object.
