...
The returned property is the string specified in the **szHelpString** member of the [**MMC\_TASK**](/windows/desktop/api/Mmc/ne-mmc-_mmc_task_display_type) structure returned in the **IEnumTASK::Next** method.
