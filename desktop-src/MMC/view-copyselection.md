...
description: The CopySelection method copies the selected items data object to the clipboard.
audience: developer
...
keywords:
- CopySelection method MMC
- CopySelection method MMC , View object
- View object MMC , CopySelection method
- CopySelection method MMC , View interface
- View interface MMC , CopySelection method
topic_type:
- apiref
api_name:
- View.CopySelection
