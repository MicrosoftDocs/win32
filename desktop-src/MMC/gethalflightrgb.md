---
title: SysColorCtrl.GetHalfLightRGB method
description: The GetHalfLlightRGB method derives a \ 0034;lighter \ 0034; color by calculating a color that is blended 50 between a given color and white. It is returned as an RGB value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '6f74847d-2a9a-409a-a3ff-3f5e49c9a5e6'
ms.prod: 'windows-server-dev'
ms.technology: 'microsoft-management-console'
ms.tgt_platform: multiple
keywords: ["GetHalfLightRGB method MMC", "GetHalfLightRGB method MMC , SysColorCtrl class", "SysColorCtrl class MMC , GetHalfLightRGB method"]
topic_type:
- apiref
api_name:
- SysColorCtrl.GetHalfLightRGB
api_location:
- Cic.dll
api_type:
- COM
