...
keywords: ["MMCN_SHOW message MMC"]
topic_type:
- apiref
api_name:
- MMCN_SHOW
...
The **MMCN\_SHOW** notification message is sent to the snap-in's [**IComponent**](icomponent.md) implementation when a scope item is selected or deselected.
