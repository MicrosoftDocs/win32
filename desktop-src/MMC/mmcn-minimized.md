...
keywords: ["MMCN_MINIMIZED message MMC"]
topic_type:
- apiref
api_name:
- MMCN_MINIMIZED
...
The **MMCN\_MINIMIZED** notification message is sent to the snap-in's [**IComponent**](icomponent.md) implementation when a window for which it owns the result pane is being minimized or maximized.
