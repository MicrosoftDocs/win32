...
The **MMCN\_PRINT** notification message is sent to the snap-in's [**IComponent**](/windows/desktop/api/Mmc/nn-mmc-icomponent) implementation when the user clicks the **Print** button or selects the **Print** menu item. The snap-in must print the appropriate item or data.
