---
title: SysColorCtrl.GetQuarterDarkHex method
description: The GetQuarterDarkHex method derives a \ 0034;darker \ 0034; color by calculating a color that is blended 25 between a given color and black. The derived color will be a blend of 75 of the given color and 25 black. It is returned as a hexadecimal value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f9ba301d-8a79-4a12-8755-014e9f7be82d'
ms.prod: 'windows-server-dev'
ms.technology: 'microsoft-management-console'
ms.tgt_platform: multiple
keywords: ["GetQuarterDarkHex method MMC", "GetQuarterDarkHex method MMC , SysColorCtrl class", "SysColorCtrl class MMC , GetQuarterDarkHex method"]
topic_type:
- apiref
api_name:
- SysColorCtrl.GetQuarterDarkHex
api_location:
- Cic.dll
api_type:
- COM
...
# SysColorCtrl.GetQuarterDarkHex method

The **GetQuarterDarkHex** method derives a "darker" color by calculating a color that is blended 25% between a given color and black. The derived color will be a blend of 75% of the given color and 25% black. It is returned as a hexadecimal value.

## Syntax


```VB
SysColorCtrl.GetQuarterDarkHex( _
  ByVal pszFrom, _
  ByVal pszFormat _
)
```
