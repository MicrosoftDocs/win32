---
title: RMT\_OC\_FSRM clipboard format
...
ms.assetid: '11705702-c052-4ca1-8e63-08a3f4d3f31c'
ms.prod: 'windows-server-dev'
ms.technology: 'microsoft-management-console'
ms.tgt_platform: multiple
keywords: ["RMT_OC_FSRM clipboard format MMC"]
topic_type:
- apiref
api_name:
- RMT_OC_FSRM
...
# RMT\_OC\_FSRM clipboard format
