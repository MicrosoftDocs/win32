...
keywords:
- ActiveView property MMC
- ActiveView property MMC , Document object
- Document object MMC , ActiveView property
- ActiveView property MMC , Document interface
- Document interface MMC , ActiveView property
topic_type:
- apiref
api_name:
- Document.ActiveView
