...
keywords:
- Memento property MMC
- Memento property MMC , View object
- View object MMC , Memento property
- Memento property MMC , View interface
- View interface MMC , Memento property
topic_type:
- apiref
api_name:
- View.Memento
