...
Additionally, the **View** object serves as the [**external object**](https://www.bing.com/search?q=**external object**) when an MMC snap-in hosts Microsoft Internet Explorer browser components.
