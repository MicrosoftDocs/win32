...
| 1<br/>    | The image displayed for the task or background is the symbol specified by an [**MMC\_TASK\_DISPLAY\_SYMBOL**](/windows/win32/Mmc/ns-mmc-_mmc_task_display_symbol?branch=master) structure.<br/>                                                                                                                                         |
