...
| 1<br/>    | The image displayed for the task or background is the symbol specified by an [**MMC\_TASK\_DISPLAY\_SYMBOL**](/windows/desktop/api/Mmc/ns-mmc-_mmc_task_display_symbol) structure.<br/>                                                                                                                                         |
