...
1.  Create a context menu extension snap-in. The snap-in must implement and expose the [**IExtendContextMenu**](/windows/desktop/api/Mmc/nn-mmc-iextendcontextmenu) interface. For more information about creating a context extension snap-in, see [Extending a Primary Snap-in's Context Menu](extending-a-primary-snap-ins-context-menu.md).
