...
The Text property is the string specified in the **szText** member of the [**MMC\_TASK**](mmc-task.md) structure returned in the [**IEnumTASK::Next**](ienumtask-next.md) method.
