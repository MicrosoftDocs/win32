...
This parameter can be one or more of the following [**ViewOptions**](/windows/desktop/api/MmcObj/ne-mmcobj-viewoptions) enumeration types. These flags can be combined using a bitwise OR operation.
