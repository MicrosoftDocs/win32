...
Optional properties to be used by the snap-in. The snap-in must implement the [**ISnapinProperties**](/windows/desktop/api/Mmcobj/nn-mmcobj-isnapinproperties) interface for the *Properties* parameter to be useful. The *Properties* parameter can be created by the [**Document.CreateProperties**](document-createproperties.md) method.
