...
| [**Tbsi\_Create\_Attestation\_From\_Log**](/windows/desktop/api/Tbs/)<br/> | Creates an attestation by extracting a TrustPoint from a TCG log.<br/>                                                                                |
...
| [**Tbsi\_Get\_TCG\_Logs**](/windows/desktop/api/Tbs/)<br/>                                | Get one or more Windows Boot Configuration Logs (WBCL), also referred to as the TCG logs.<br/>                                                        |
