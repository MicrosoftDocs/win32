...
| <span id="TBS_E_PROVISIONING_INCOMPLETE"></span><span id="tbs_e_provisioning_incomplete"></span><dl> <dt>**TBS\_E\_PROVISIONING\_INCOMPLETE**</dt> <dt>2150121493 (0x80284015)</dt> </dl>     | The TPM provisioning did not complete. For more information on completing the provisioning, call the [**Win32\_Tpm**](https://docs.microsoft.com/windows/desktop/SecProv/win32-tpm) WMI method for provisioning the TPM ('Provision') and check the returned information.<br/> |
