...
keywords: ["SetNamespaceFolderTarget method", "SetNamespaceFolderTarget method, MSFT_DfsNamespaceFolderTarget class", "MSFT_DfsNamespaceFolderTarget class, SetNamespaceFolderTarget method"]
topic_type:
- apiref
api_name:
