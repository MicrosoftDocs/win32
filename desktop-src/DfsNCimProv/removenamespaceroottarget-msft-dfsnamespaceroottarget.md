...
keywords: ["RemoveNamespaceRootTarget method", "RemoveNamespaceRootTarget method, MSFT_DfsNamespaceRootTarget class", "MSFT_DfsNamespaceRootTarget class, RemoveNamespaceRootTarget method"]
topic_type:
- apiref
api_name:
