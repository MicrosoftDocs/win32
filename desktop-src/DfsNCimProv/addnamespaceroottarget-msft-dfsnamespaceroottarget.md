---
title: AddNamespaceRootTarget method of the MSFT\_DfsNamespaceRootTarget class
description: Adds a new target for a DFS namespace (DFS-N) root.
audience: developer
...
- apiref
api_name:
- MSFT_DfsNamespaceRootTarget.AddNamespaceRootTarget
api_location:
- DfsNCimProv.dll
api_type:
- COM
