...
keywords: ["GetNamespaceAccessRights method", "GetNamespaceAccessRights method, MSFT_DfsNamespaceAccess class", "MSFT_DfsNamespaceAccess class, GetNamespaceAccessRights method"]
topic_type:
- apiref
api_name:
