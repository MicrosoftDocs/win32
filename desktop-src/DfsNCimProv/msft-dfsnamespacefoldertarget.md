---
title: MSFT\_DfsNamespaceFolderTarget class
description: Represents the target of a DFS folder.
audience: developer
...
- MSFT_DfsNamespaceFolderTarget.NamespacePath
- MSFT_DfsNamespaceFolderTarget.ReferralPriorityRank
- MSFT_DfsNamespaceFolderTarget.State
- MSFT_DfsNamespaceFolderTarget.TargetPath
- MSFT_DfsNamespaceFolderTarget.ReferralPriorityClass
api_location:
- DfsNCimProv.dll
api_type:
- DllExport
...
The **MSFT\_DfsNamespaceFolderTarget** class has these types of members:
...
The **MSFT\_DfsNamespaceFolderTarget** class has these methods.



| Method                                                                                           | Description                                                        |
|:-------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------|
| [**AddNamespaceFolderTarget**](addnamespacefoldertarget-msft-dfsnamespacefoldertarget.md)       | Adds a new target for a DFS folder.<br/>                     |
| [**GetNamespaceFolderTarget**](getnamespacefoldertarget-msft-dfsnamespacefoldertarget.md)       | Retrieves the properties of the target of a DFS folder.<br/> |
| [**RemoveNamespaceFolderTarget**](removenamespacefoldertarget-msft-dfsnamespacefoldertarget.md) | Removes a target of a DFS folder.<br/>                       |
| [**SetNamespaceFolderTarget**](setnamespacefoldertarget-msft-dfsnamespacefoldertarget.md)       | Modifies the properties of the target of a DFS folder.<br/>  |
...
The **MSFT\_DfsNamespaceFolderTarget** class has these properties.
...
Gets or sets the priority class of the target of a DFS folder. The default value is "Normal".
