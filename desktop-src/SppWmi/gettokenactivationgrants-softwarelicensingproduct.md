...
keywords:
- GetTokenActivationGrants method Windows Management Instrumentation
- GetTokenActivationGrants method Windows Management Instrumentation , SoftwareLicensingProduct class
- SoftwareLicensingProduct class Windows Management Instrumentation , GetTokenActivationGrants method
topic_type:
- apiref
api_name:
