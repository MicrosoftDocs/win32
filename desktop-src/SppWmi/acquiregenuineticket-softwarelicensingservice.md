...
keywords: ["AcquireGenuineTicket method Windows Management Instrumentation", "AcquireGenuineTicket method Windows Management Instrumentation , SoftwareLicensingService class", "SoftwareLicensingService class Windows Management Instrumentation , AcquireGenuineTicket method"]
topic_type:
- apiref
api_name:
