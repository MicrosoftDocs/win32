---
title: ClearKeyManagementServiceListeningPort method of the SoftwareLicensingService class
...
- apiref
api_name:
- SoftwareLicensingService.ClearKeyManagementServiceListeningPort
api_location:
- SppWmi.dll
api_type:
- COM
...
Clears any previously specified listening port. This method applies to KMS hosts only.
