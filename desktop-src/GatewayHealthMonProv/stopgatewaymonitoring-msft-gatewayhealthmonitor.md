---
title: StopGatewayMonitoring method of the MSFT\_GatewayHealthMonitor class
description: Stops the gateway health monitoring agent.
audience: developer
...
- apiref
api_name:
- MSFT_GatewayHealthMonitor.StopGatewayMonitoring
api_location:
...
Stops the gateway health monitoring agent.

## Syntax


```mof
uint32 StopGatewayMonitoring();
```
