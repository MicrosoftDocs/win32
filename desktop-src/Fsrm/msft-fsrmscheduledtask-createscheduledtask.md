...
**Windows Server 2008 R2 and Windows Server 2008:** To schedule a task use the [**IFsrmReportScheduler**](/previous-versions/windows/desktop/api/FsrmReports/nn-fsrmreports-ifsrmreportscheduler) interface.
