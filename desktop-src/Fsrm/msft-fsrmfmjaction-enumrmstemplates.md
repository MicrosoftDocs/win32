...
keywords: ["EnumRmsTemplates method File Server Resource Manager", "EnumRmsTemplates method File Server Resource Manager , MSFT_FSRMFMJAction class", "MSFT_FSRMFMJAction class File Server Resource Manager , EnumRmsTemplates method"]
topic_type:
- apiref
api_name:
