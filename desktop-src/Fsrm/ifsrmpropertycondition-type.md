...
The comparison operator used to compare the value of the specified classification property in the file to the property condition's value. For possible values, see the [**FsrmPropertyConditionType**](/previous-versions/windows/desktop/api/Fsrm/ne-fsrmenums-_fsrmpropertyconditiontype) enumeration.
