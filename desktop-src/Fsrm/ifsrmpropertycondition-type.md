...
keywords: ["Type property File Server Resource Manager", "Type property File Server Resource Manager , IFsrmPropertyCondition interface", "IFsrmPropertyCondition interface File Server Resource Manager , Type property"]
topic_type:
- apiref
api_name:
...
The comparison operator used to compare the value of the specified classification property in the file to the property condition's value. For possible values, see the [**FsrmPropertyConditionType**](fsrmpropertyconditiontype.md) enumeration.
