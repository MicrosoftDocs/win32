...
keywords: ["SendTestEmail method File Server Resource Manager", "SendTestEmail method File Server Resource Manager , MSFT_FSRMSettings class", "MSFT_FSRMSettings class File Server Resource Manager , SendTestEmail method"]
topic_type:
- apiref
api_name:
