...
For general information about battery saver, see [battery saver (in the hardware component guidelines)](https://msdn.microsoft.com/windows/hardware/commercialize/design/component-guidelines/battery-saver).
