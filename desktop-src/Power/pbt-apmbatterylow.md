...
**PBT_APMBATTERYLOW** is available for use in the operating systems specified in the Requirements section. Support for this event was removed in Windows Vista. Use [PBT\_APMPOWERSTATUSCHANGE](pbt-apmpowerstatuschange.md) instead.\]
