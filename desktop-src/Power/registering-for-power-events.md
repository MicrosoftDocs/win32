...
-   A service receives a call to the [*HandlerEx*](https://msdn.microsoft.com/library/windows/desktop/ms683241) callback function it registered by calling the [**RegisterServiceCtrlHandlerEx**](https://msdn.microsoft.com/library/windows/desktop/ms685058) function. The *lpEventData* parameter sent to the *HandlerEx* callback function points to a [**POWERBROADCAST\_SETTING**](/windows/desktop/api/WinUser/ns-winuser-powerbroadcast_setting) structure.
