...
> [!Note]  
> Devices that support [Modern Standby](https://msdn.microsoft.com/library/windows/hardware/mt282515) mode only allow the **Balanced** power plan. **Modern Standby** is the newer, more streamlined solution to power settings management.
