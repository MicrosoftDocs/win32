...
-   [Download New Items as They are Created](-wiaaut-shared-samples.md#download-new-items-as-they-are-created)
-   [Use VideoPreview Control in HTML](-wiaaut-shared-samples.md#use-videopreview-control-in-html)
-   [Implement a Web Camera ASP Page](-wiaaut-shared-samples.md#implement-a-web-camera-asp-page)
-   [Implement a Windows Script Host Script that Runs Automatically](-wiaaut-shared-samples.md#implement-a-windows-script-host-script-that-runs-automatically)
