...
description: Retrieves the specified item in the collection by position.
ms.assetid: 23356146-2723-4996-8a98-428e5315c130
keywords:
- Item property WIA Automation
- Item property WIA Automation , Items object
- Items object WIA Automation , Item property
topic_type:
- apiref
api_name:
- Items.Item
