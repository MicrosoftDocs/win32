...
For additional example code, see [ARGB Filter: Create a Modified Version of an Image](https://www.bing.com/search?q=ARGB Filter: Create a Modified Version of an Image).
