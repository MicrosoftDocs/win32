...
For more example code, see [List all Available Devices by Name and DeviceID](https://www.bing.com/search?q=List all Available Devices by Name and DeviceID) in Shared Samples.
