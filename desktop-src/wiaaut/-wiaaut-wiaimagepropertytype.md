...
For example code, see [Display all ImageFile Properties](-wiaaut-shared-samples.md#display-all-imagefile-properties) and [Exif Filter: Write a New Title Tag to an Image](-wiaaut-howto-use-filters.md#exif-filter-write-a-new-title-tag-to-an-image).
