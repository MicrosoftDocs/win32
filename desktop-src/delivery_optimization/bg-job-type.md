...
The **BG\_JOB\_TYPE** enumeration defines constant values that specify the type of transfer job, such as download.
...
<span id="BG_JOB_TYPE_DOWNLOAD"></span><span id="bg_job_type_download"></span>**BG\_JOB\_TYPE\_DOWNLOAD**
</dt> <dd>
