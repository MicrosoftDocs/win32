...
keywords: ["IDeliveryOptimizationJob interface", "IDeliveryOptimizationJob interface, described"]
topic_type:
- apiref
api_name:
...
The **IDeliveryOptimizationJob** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **IDeliveryOptimizationJob** also has these types of members:
...
| IID<br/>                      | IID\_IDeliveryOptimizationJob is defined as EE2584CF-A69C-4848-B633-2649962B3EF7<br/>         |
