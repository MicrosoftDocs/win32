...
Array of one or more [**BG_FILE_RANGE**](https://msdn.microsoft.com/library/windows/desktop/aa362802) structures that specify the ranges to download. Do not specify duplicate or overlapping ranges.
