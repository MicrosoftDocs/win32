...
Array of one or more [**BG_FILE_RANGE**](https://docs.microsoft.com/windows/desktop/api/bits2_0/ns-bits2_0-_bg_file_range) structures that specify the ranges to download. Do not specify duplicate or overlapping ranges.
