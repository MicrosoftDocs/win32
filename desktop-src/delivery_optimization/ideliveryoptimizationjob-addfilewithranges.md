...
Array of one or more [**BG\_FILE\_RANGE**](https://msdn.microsoft.com/library/windows/desktop/aa362802) structures that specify the ranges to download. Do not specify duplicate or overlapping ranges.
...
Size of the file in bytes. Pass in **DO\_UNKNOWN\_FILE\_SIZE** if size is not known to the caller application.
