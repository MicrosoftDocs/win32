...
Null-terminated string that contains the display name that identifies the job. More than one job can have the same display name. Call the [**CoTaskMemFree**](https://www.bing.com/search?q=**CoTaskMemFree**) function to free *ppDisplayName* when done.
...
|----------------------------------------------------------------------------------------------|--------------------------------------------------------------|
| <dl> <dt>****S\_OK****</dt> </dl>     | Display name was successfully retrieved.<br/>          |
| <dl> <dt>**E\_INVALIDARG**</dt> </dl> | The *ppDisplayName* parameter cannot be **NULL**.<br/> |
