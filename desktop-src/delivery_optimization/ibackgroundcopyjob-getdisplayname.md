...
Null-terminated string that contains the display name that identifies the job. More than one job can have the same display name. Call the [**CoTaskMemFree**](_com_cotaskmemfree) function to free *ppDisplayName* when done.
