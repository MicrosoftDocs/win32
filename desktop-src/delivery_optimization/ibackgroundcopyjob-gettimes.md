...
Contains job-related time stamps. For available time stamps, see the [**BG\_JOB\_TIMES**](bg-job-times.md) structure.
...
|------------------------------------------------------------------------------------------|-----------------------------------------------------|
| <dl> <dt>****S\_OK****</dt> </dl> | Time stamps were successfully retrieved.<br/> |
