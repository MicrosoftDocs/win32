...
Null-terminated string that contains the remote name of the file to transfer. The name is fully qualified. Call the [**CoTaskMemFree**](_com_cotaskmemfree) function to free *ppName* when done.
