...
Null-terminated string that contains the remote name of the file to transfer. The name is fully qualified. Call the [**CoTaskMemFree**](https://www.bing.com/search?q=**CoTaskMemFree**) function to free *ppName* when done.
