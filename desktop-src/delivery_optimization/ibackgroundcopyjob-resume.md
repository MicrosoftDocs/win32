...
|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| <dl> <dt>****S\_OK****</dt> </dl>             | Job was successfully restarted.<br/>                                                           |
| <dl> <dt>**DO\_E\_EMPTY**</dt> </dl>          | There are no files to transfer.<br/>                                                           |
...
If a job that is in the BG\_JOB\_STATE\_TRANSIENT\_ERROR or BG\_JOB\_STATE\_ERROR state, call the **Resume** method to restart the job after you fix the error.
