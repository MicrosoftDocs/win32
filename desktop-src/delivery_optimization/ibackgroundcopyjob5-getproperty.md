...
keywords: ["GetProperty method", "GetProperty method, IBackgroundCopyJob5 interface", "IBackgroundCopyJob5 interface, GetProperty method"]
topic_type:
- apiref
api_name:
...
The ID of the property that is being obtained specified as a [**BITS\_JOB\_PROPERTY\_ID**](bits-job-property-id.md) enum value.
...
The property value returned as a BITS\_JOB\_PROPERTY\_VALUE union.
