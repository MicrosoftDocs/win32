...
The **BG\_FILE\_PROGRESS** structure provides file-related progress information, such as the number of bytes transferred.
...
Size of the file in bytes. If DO cannot determine the size of the file (for example, if the file or server does not exist), the value is DO\_UNKNOWN\_FILE\_SIZE.
...
[**BG\_JOB\_PROGRESS**](bg-job-progress.md)
</dt> <dt>
