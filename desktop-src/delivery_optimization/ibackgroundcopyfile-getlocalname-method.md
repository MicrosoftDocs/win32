...
Null-terminated string that contains the name of the file on the client. The name is fully qualified. Call the [**CoTaskMemFree**](_com_cotaskmemfree) function to free *ppName* when done.
