...
The ID of the property that is being set specified as a [**BITS\_JOB\_PROPERTY\_ID**](bits-job-property-id.md) enum value.
...
The value of the property that is being set. In order to hold a value whose type is appropriate to the property, this value is specified via the [**BITS\_JOB\_PROPERTY\_VALUE**](bits-job-property-value-.md) union that is composed of all the known property types.
...
| IID<br/>                      | IID\_IBackgroundCopyJob5 is defined as E847030C-BBBA-4657-AF6D-484AA42BF1FE<br/>              |
