...
This value is returned when using the enum property ID **BITS\_JOB\_PROPERTY\_ID\_COST\_FLAGS** and is applied as the [transfer policy](https://www.bing.com/search?q=transfer policy) on the DO job.
