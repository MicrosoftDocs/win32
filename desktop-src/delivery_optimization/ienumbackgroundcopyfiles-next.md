...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------------|
| <dl> <dt>****S\_OK****</dt> </dl> | Successfully returned the number of requested elements.<br/> |
| <dl> <dt>**S\_FALSE**</dt> </dl>  | Returned less than the number of requested elements.<br/>    |
