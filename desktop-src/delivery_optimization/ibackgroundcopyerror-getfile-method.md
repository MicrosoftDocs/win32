...
|------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| <dl> <dt>****S\_OK****</dt> </dl>                   | Successfully retrieved an interface pointer to the file object.<br/>                                     |
| <dl> <dt>**DO\_E\_FILE\_NOT\_AVAILABLE**</dt> </dl> | The error is not associated with a local or remote file. The *ppFile* parameter is set to **NULL**.<br/> |
