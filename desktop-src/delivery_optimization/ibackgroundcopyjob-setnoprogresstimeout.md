...
If DO does not make progress during the retry period, it moves the state of the job from BG\_JOB\_STATE\_TRANSIENT\_ERROR to BG\_JOB\_STATE\_ERROR. If you request error notification, DO then calls your [**JobError**](https://www.bing.com/search?q=**JobError**) callback.
