...
Type of transfer being performed. For a list of transfer types, see the [**BG\_JOB\_TYPE**](bg-job-type.md) enumeration.
...
|------------------------------------------------------------------------------------------|------------------------------------------------------|
| <dl> <dt>****S\_OK****</dt> </dl> | Transfer type was successfully retrieved.<br/> |
