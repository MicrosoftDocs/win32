...
The **BITS\_FILE\_PROPERTY\_ID** enumeration specifies values that define ID values corresponding to **BackgroundCopyFile** properties.
...
<span id="BITS_FILE_PROPERTY_ID_HTTP_RESPONSE_HEADERS"></span><span id="bits_file_property_id_http_response_headers"></span>**BITS\_FILE\_PROPERTY\_ID\_HTTP\_RESPONSE\_HEADERS**
</dt> <dd>
