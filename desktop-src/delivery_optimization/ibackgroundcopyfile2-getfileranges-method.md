...
Array of [**BG\_FILE\_RANGE**](bg-file-range.md) structures that specify the ranges to download. When done, call the [**CoTaskMemFree**](https://www.bing.com/search?q=**CoTaskMemFree**) function to free *Ranges*.
...
| <dl> <dt>**S\_FALSE**</dt> </dl>  | No ranges were specified or the job is an upload or upload-reply job. *RangeCount* is set to zero and *Ranges* is set to **NULL**.<br/> |
...
| IID<br/>                      | IID\_IBackgroundCopyFile2 is defined as 83e81b93-0873-474d-8a8c-f2018b1a939c<br/>             |
