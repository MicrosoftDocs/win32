...
Array of [**BG\_FILE\_RANGE**](bg-file-range.md) structures that specify the ranges to download. When done, call the [**CoTaskMemFree**](_com_cotaskmemfree) function to free *Ranges*.
