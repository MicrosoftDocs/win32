...
| <span id="BG_NOTIFY_DISABLE"></span><span id="bg_notify_disable"></span><dl> <dt>**BG_NOTIFY_DISABLE**</dt> </dl>                             | Event notification is disabled. If set, Delivery Optimization ignores the other flags.<br/> |
