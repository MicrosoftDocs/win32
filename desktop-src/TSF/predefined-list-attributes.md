...
The following values identify list attributes obtained with the [ITfContext::GetAppProperty](https://msdn.microsoft.com/library/windows/desktop/ms538788) method. The data format and contents of each property type are included.
