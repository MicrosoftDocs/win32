...
keywords: ["Predefined Language Bar Items Text Services Framework"]
topic_type:
- apiref
api_name:
...
The following [**GUID**](https://msdn.microsoft.com/library/windows/desktop/ms629015) values identify the predefined language bar items. These values are used with [**GetItem**](itflangbaritemmgr-getitem.md) to obtain a specific language bar item.
...
[ITfLangBarItemMgr::GetItem](https://msdn.microsoft.com/library/windows/desktop/ms628728)
</dt> </dl>
