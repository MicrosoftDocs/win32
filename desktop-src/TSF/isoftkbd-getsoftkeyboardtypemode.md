...
keywords: ["GetSoftKeyboardTypeMode method Text Services Framework", "GetSoftKeyboardTypeMode method Text Services Framework , ISoftKbd interface", "ISoftKbd interface Text Services Framework , GetSoftKeyboardTypeMode method"]
topic_type:
- apiref
api_name:
