...
The TS\_ATTR\_\* constants are used to obtain and change the values of document attributes. These constants form possible values of bitfield flags in [ITextStoreACP](/windows/win32/Textstor/nn-textstor-itextstoreacp?branch=master) and [ITextStoreAnchor](/windows/win32/Textstor/nn-textstor-itextstoreanchor?branch=master) methods.
...
| <span id="TS_ATTR_FIND_WANT_OFFSET"></span><span id="ts_attr_find_want_offset"></span><dl> <dt>**TS\_ATTR\_FIND\_WANT\_OFFSET**</dt> <dt>( 0x2 )</dt> </dl> | Return the number of characters between the start character or anchor position (**acpStart** in [ITextStoreACP::FindNextAttrTransition](/windows/win32/Textstor/nf-textstor-itextstoreacp-findnextattrtransition?branch=master) or **paStart** in [ITextStoreAnchor::FindNextAttrTransition](/windows/win32/Textstor/nf-textstor-itextstoreanchor-findnextattrtransition?branch=master) ) and the position at which an attribute transition occurs.<br/> |
| <span id="TS_ATTR_FIND_UPDATESTART"></span><span id="ts_attr_find_updatestart"></span><dl> <dt>**TS\_ATTR\_FIND\_UPDATESTART**</dt> <dt>( 0x4 )</dt> </dl>  | Used by [ITextStoreAnchor::FindNextAttrTransition](/windows/win32/Textstor/nf-textstor-itextstoreanchor-findnextattrtransition?branch=master) to position the input anchor at the next attribute transition, if one is found. Otherwise the input anchor is not modified.<br/>                                                                                                                             |
| <span id="TS_ATTR_FIND_WANT_VALUE"></span><span id="ts_attr_find_want_value"></span><dl> <dt>**TS\_ATTR\_FIND\_WANT\_VALUE**</dt> <dt>( 0x8 )</dt> </dl>    | Load supported document attribute values into the [TS\_ATTRVAL](/windows/win32/Textstor/ns-textstor-ts_attrval?branch=master) structure.<br/>                                                                                                                                                                                                                                                              |
| <span id="TS_ATTR_FIND_WANT_END"></span><span id="ts_attr_find_want_end"></span><dl> <dt>**TS\_ATTR\_FIND\_WANT\_END**</dt> <dt>( 0x10 )</dt> </dl>         | Used by [ITextStoreACP::RequestAttrsTransitioningAtPosition](/windows/win32/Textstor/nf-textstor-itextstoreacp-requestattrstransitioningatposition?branch=master) and [ITextStoreAnchor::RequestAttrsTransitioningAtPosition](/windows/win32/Textstor/nf-textstor-itextstoreanchor-requestattrstransitioningatposition?branch=master) to obtain the document attribute values that end at the specified character or anchor position.<br/>               |
