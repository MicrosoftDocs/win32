...
A text service inserts an embedded object into a context by calling [ITfRange::InsertEmbedded](https://docs.microsoft.com/windows/desktop/api/msctf/nf-msctf-itfrange-insertembedded) or [ITfInsertAtSelection::InsertEmbeddedAtSelection](https://docs.microsoft.com/windows/desktop/api/msctf/nf-msctf-itfinsertatselection-insertembeddedatselection). The text service must supply the embedded IDataObject.
