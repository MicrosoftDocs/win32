...
keywords: ["GetSoftKeyboardPosSize method Text Services Framework", "GetSoftKeyboardPosSize method Text Services Framework , ISoftKbd interface", "ISoftKbd interface Text Services Framework , GetSoftKeyboardPosSize method"]
topic_type:
- apiref
api_name:
...
Pointer to a buffer in which this method retrieves a [POINT](https://msdn.microsoft.com/library/windows/desktop/dd162805) structure indicating the coordinates of the upper left position of the soft keyboard.
