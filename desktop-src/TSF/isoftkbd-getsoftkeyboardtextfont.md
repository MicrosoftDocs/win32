...
keywords: ["GetSoftKeyboardTextFont method Text Services Framework", "GetSoftKeyboardTextFont method Text Services Framework , ISoftKbd interface", "ISoftKbd interface Text Services Framework , GetSoftKeyboardTextFont method"]
topic_type:
- apiref
api_name:
