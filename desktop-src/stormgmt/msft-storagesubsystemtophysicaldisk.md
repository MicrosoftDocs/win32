...
keywords: ["MSFT_StorageSubSystemToPhysicalDisk class Windows Storage Management API", "MSFT_StorageSubSystemToPhysicalDisk class Windows Storage Management API , described"]
topic_type:
- apiref
api_name:
