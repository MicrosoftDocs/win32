...
keywords: ["MSFT_TargetPortToTargetPortal class Windows Storage Management API", "MSFT_TargetPortToTargetPortal class Windows Storage Management API , described"]
topic_type:
- apiref
api_name:
