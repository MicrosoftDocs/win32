...
keywords: ["SetSecurityDescriptor method Windows Storage Management API", "SetSecurityDescriptor method Windows Storage Management API , MSFT_StoragePool class", "MSFT_StoragePool class Windows Storage Management API , SetSecurityDescriptor method"]
topic_type:
- apiref
api_name:
