...
keywords: ["GetSecurityDescriptor method Windows Storage Management API", "GetSecurityDescriptor method Windows Storage Management API , MSFT_StorageSubSystem class", "MSFT_StorageSubSystem class Windows Storage Management API , GetSecurityDescriptor method"]
topic_type:
- apiref
api_name:
