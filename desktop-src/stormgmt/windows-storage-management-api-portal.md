...
Storage subsystem manufacturers can support Windows-based storage management for their products by implementing a Storage Management Provider (SMP). For more information, see [How to Implement a Storage Management Provider](http://go.microsoft.com/fwlink/p/?linkid=257447).

The Windows Storage Management API supersedes the [Virtual Disk Service](https://msdn.microsoft.com/library/windows/desktop/bb986750) API beginning with the Windows 8 and Windows Server 2012 operating systems.
