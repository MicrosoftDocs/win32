...
keywords: ["MSFT_InitiatorIdToVirtualDisk class Windows Storage Management API", "MSFT_InitiatorIdToVirtualDisk class Windows Storage Management API , described"]
topic_type:
- apiref
api_name:
