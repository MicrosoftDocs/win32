...
keywords: ["Online method Windows Storage Management API", "Online method Windows Storage Management API , MSFT_Disk class", "MSFT_Disk class Windows Storage Management API , Online method"]
topic_type:
- apiref
api_name:
- MSFT_Disk.Online
