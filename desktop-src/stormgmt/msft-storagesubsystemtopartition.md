...
keywords: ["MSFT_StorageSubSystemToPartition class Windows Storage Management API", "MSFT_StorageSubSystemToPartition class Windows Storage Management API , described"]
topic_type:
- apiref
api_name:
