...
keywords: ["RevokeAccess method Windows Storage Management API", "RevokeAccess method Windows Storage Management API , MSFT_FileShare class", "MSFT_FileShare class Windows Storage Management API , RevokeAccess method"]
topic_type:
- apiref
api_name:
