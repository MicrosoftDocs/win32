...
keywords: ["MSFT_SoftError_NotAuthenticated class Windows Storage Management API", "MSFT_SoftError_NotAuthenticated class Windows Storage Management API , described"]
topic_type:
- apiref
api_name:
