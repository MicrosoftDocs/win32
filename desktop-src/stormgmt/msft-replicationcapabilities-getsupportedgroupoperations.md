...
keywords: ["GetSupportedGroupOperations method Windows Storage Management API", "GetSupportedGroupOperations method Windows Storage Management API , MSFT_ReplicationCapabilities class", "MSFT_ReplicationCapabilities class Windows Storage Management API , GetSupportedGroupOperations method"]
topic_type:
- apiref
api_name:
