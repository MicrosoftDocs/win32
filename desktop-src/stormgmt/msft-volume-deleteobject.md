...
keywords: ["DeleteObject method Windows Storage Management API", "DeleteObject method Windows Storage Management API , MSFT_Volume class", "MSFT_Volume class Windows Storage Management API , DeleteObject method"]
topic_type:
- apiref
api_name:
