...
keywords: ["MSFT_StoragePoolToVirtualDisk class Windows Storage Management API", "MSFT_StoragePoolToVirtualDisk class Windows Storage Management API , described"]
topic_type:
- apiref
api_name:
