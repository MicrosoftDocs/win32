...
keywords: ["MSFT_StorageSubSystemToTargetPortal class Windows Storage Management API", "MSFT_StorageSubSystemToTargetPortal class Windows Storage Management API , described"]
topic_type:
- apiref
api_name:
