...
<table><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><thead><tr class="header"><th style="text-align: left;">Method</th><th style="text-align: left;">Description</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;">[<strong>RequestResult</strong>](https://msdn.microsoft.com/library/windows/desktop/mt432791)</td><td style="text-align: left;"><p>A callback function used to notify the host of results from an action (for example, capture a frame) that it requested.</p></td></tr></tbody></table>
