...
<table><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><thead><tr class="header"><th style="text-align: left;">Method</th><th style="text-align: left;">Description</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;">[<strong>RequestOfflineAnalysisReportAvailabilityAsync</strong>](https://msdn.microsoft.com/library/windows/desktop/mt432705)</td><td style="text-align: left;"><p>Requests to cache offline analysis report of the specified frames.</p></td></tr></tbody></table>
