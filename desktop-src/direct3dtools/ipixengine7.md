...
<table><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><thead><tr class="header"><th style="text-align: left;">Method</th><th style="text-align: left;">Description</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;">[<strong>InitEngineAsync</strong>](https://msdn.microsoft.com/library/windows/desktop/mt432774)</td><td style="text-align: left;"><p>Asynchronously passes resources to the engine, such as strings for error messages.</p></td></tr><tr class="even"><td style="text-align: left;">[<strong>SetPlaybackEndpointAsync</strong>](https://msdn.microsoft.com/library/windows/desktop/mt432775)</td><td style="text-align: left;"><p>Asynchronously sets the endpoint address used to connect to a remote engine.</p></td></tr></tbody></table>
