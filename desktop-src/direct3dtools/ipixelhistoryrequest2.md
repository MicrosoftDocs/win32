...
<table><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><thead><tr class="header"><th style="text-align: left;">Method</th><th style="text-align: left;">Description</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;">[<strong>RequestIntersections</strong>](https://msdn.microsoft.com/library/windows/desktop/mt432742)</td><td style="text-align: left;"><p>Requests a list of events that cause a change in the specified pixel, render target / UAV, and frame.</p></td></tr><tr class="even"><td style="text-align: left;">[<strong>RequestPrimitives</strong>](https://msdn.microsoft.com/library/windows/desktop/mt432743)</td><td style="text-align: left;"><p>Requests a list of primitives from a particular intersection. For more information, see the RequestIntersections member function.</p></td></tr></tbody></table>
