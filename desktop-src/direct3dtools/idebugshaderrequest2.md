...
<table><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><thead><tr class="header"><th style="text-align: left;">Method</th><th style="text-align: left;">Description</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;">[<strong>BeginDebugShader</strong>](https://msdn.microsoft.com/library/windows/desktop/mt422662)</td><td style="text-align: left;"><p>Requests to start debugging the specified list of instructions.</p></td></tr><tr class="even"><td style="text-align: left;">[<strong>GenerateInstructions</strong>](https://msdn.microsoft.com/library/windows/desktop/mt422663)</td><td style="text-align: left;"><p>Requests to generate shader trace instructions in a debug request. Trace-based debugging occurs on the CPU (warp) instead of the GPU.</p></td></tr></tbody></table>
