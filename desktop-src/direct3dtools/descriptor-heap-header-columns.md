---
description: An enum used to indicate a column header in the Descriptor heap viewer.
...
An enum used to indicate a column header in the Descriptor heap viewer
