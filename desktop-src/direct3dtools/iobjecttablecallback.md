...
The **IObjectTableCallback** interface inherits from the [**IUnknown**](https://docs.microsoft.com/windows/desktop/api/unknwn/nn-unknwn-iunknown) interface. **IObjectTableCallback** also has these types of members:
