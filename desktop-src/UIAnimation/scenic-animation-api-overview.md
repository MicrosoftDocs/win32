...
-   An animation manager object, [**UIAnimationManager**](/windows/desktop/api/UIAnimation/), for creating animation objects and controlling animations
-   Animation variables and storyboards
-   A foundational library, [**UIAnimationTransitionLibrary**](/windows/desktop/api/UIAnimation/), of ready-to-use transitions
-   A timer object, [**UIAnimationTimer**](/windows/desktop/api/UIAnimation/), for determining the current time and, optionally, for driving animation
