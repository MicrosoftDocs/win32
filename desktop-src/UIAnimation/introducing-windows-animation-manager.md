...
The following example code is taken from ManagerEventHandler.h from the Windows Animation samples [Application-Driven Animation](application-driven-animation-sample.md) and [Grid Layout](https://msdn.microsoft.com/library/windows/desktop/dd940512). It defines the manager event handler.
...
[**UIAnimationManager**](/windows/desktop/api/UIAnimation/)
</dt> <dt>

[**UIAnimationTimer**](/windows/desktop/api/UIAnimation/)
</dt> <dt>
