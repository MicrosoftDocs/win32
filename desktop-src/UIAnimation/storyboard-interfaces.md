...
| [**IUIAnimationStoryboard2**](/windows/desktop/api/uianimation/nn-uianimation-iuianimationstoryboard2)<br/>                                 | Defines a storyboard, which contains a group of transitions that are synchronized relative to one another.<br/> |
