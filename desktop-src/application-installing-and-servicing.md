...
| [Packaging, deployment, and query of Windows Store apps](https://docs.microsoft.com/windows/desktop/appxpkg/appx-portal)<br/>                                       | Programmatically create app packages, and install, update, query, and uninstall Windows Store apps.<br/>                                                                                                                                                                                                                                                  |
