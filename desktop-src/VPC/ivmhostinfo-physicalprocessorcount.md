...
keywords: ["PhysicalProcessorCount property Virtual PC", "PhysicalProcessorCount property Virtual PC , IVMHostInfo interface", "IVMHostInfo interface Virtual PC , PhysicalProcessorCount property"]
topic_type:
- apiref
api_name:
