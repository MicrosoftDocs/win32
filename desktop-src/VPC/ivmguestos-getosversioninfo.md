...
keywords: ["GetOsVersionInfo method Virtual PC", "GetOsVersionInfo method Virtual PC , IVMGuestOS interface", "IVMGuestOS interface Virtual PC , GetOsVersionInfo method"]
topic_type:
- apiref
api_name:
