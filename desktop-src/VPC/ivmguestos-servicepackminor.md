...
keywords: ["ServicePackMinor property Virtual PC", "ServicePackMinor property Virtual PC , IVMGuestOS interface", "IVMGuestOS interface Virtual PC , ServicePackMinor property"]
topic_type:
- apiref
api_name:
