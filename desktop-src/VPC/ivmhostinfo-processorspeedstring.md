...
keywords: ["ProcessorSpeedString property Virtual PC", "ProcessorSpeedString property Virtual PC , IVMHostInfo interface", "IVMHostInfo interface Virtual PC , ProcessorSpeedString property"]
topic_type:
- apiref
api_name:
