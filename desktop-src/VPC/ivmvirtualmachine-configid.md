...
keywords: ["ConfigID property Virtual PC", "ConfigID property Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , ConfigID property"]
topic_type:
- apiref
api_name:
...
Retrieves the unique identifier for the virtual machine.
