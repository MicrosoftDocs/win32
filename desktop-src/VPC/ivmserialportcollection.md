...
keywords: ["IVMSerialPortCollection interface Virtual PC", "IVMSerialPortCollection interface Virtual PC , described"]
topic_type:
- apiref
api_name:
...
The **IVMSerialPortCollection** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IVMSerialPortCollection** also has these types of members:
