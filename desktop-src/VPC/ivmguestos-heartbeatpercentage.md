...
keywords: ["HeartbeatPercentage property Virtual PC", "HeartbeatPercentage property Virtual PC , IVMGuestOS interface", "IVMGuestOS interface Virtual PC , HeartbeatPercentage property"]
topic_type:
- apiref
api_name:
