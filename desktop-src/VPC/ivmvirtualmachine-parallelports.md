...
keywords:
- ParallelPorts property Virtual PC
- ParallelPorts property Virtual PC , IVMVirtualMachine interface
- IVMVirtualMachine interface Virtual PC , ParallelPorts property
topic_type:
- apiref
api_name:
