...
keywords: ["OnConfigurationChanged method Virtual PC", "OnConfigurationChanged method Virtual PC , IVMVirtualMachineEvents interface", "IVMVirtualMachineEvents interface Virtual PC , OnConfigurationChanged method"]
topic_type:
- apiref
api_name:
