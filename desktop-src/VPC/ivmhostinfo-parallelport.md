...
keywords: ["ParallelPort property Virtual PC", "ParallelPort property Virtual PC , IVMHostInfo interface", "IVMHostInfo interface Virtual PC , ParallelPort property"]
topic_type:
- apiref
api_name:
