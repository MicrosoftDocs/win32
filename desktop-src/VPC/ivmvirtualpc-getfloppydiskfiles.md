---
title: IVMVirtualPC GetFloppyDiskFiles method
description: Retrieves an array of known virtual floppy disk files.
ms.assetid: 'c40f2780-eb84-4e0c-a493-1d1e5706cc8b'
keywords: ["GetFloppyDiskFiles method Virtual PC", "GetFloppyDiskFiles method Virtual PC , IVMVirtualPC interface", "IVMVirtualPC interface Virtual PC , GetFloppyDiskFiles method"]
topic_type:
- apiref
api_name:
