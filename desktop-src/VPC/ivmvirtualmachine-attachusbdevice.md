...
keywords: ["AttachUSBDevice method Virtual PC", "AttachUSBDevice method Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , AttachUSBDevice method"]
topic_type:
- apiref
api_name:
