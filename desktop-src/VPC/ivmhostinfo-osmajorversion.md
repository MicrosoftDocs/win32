...
keywords: ["OSMajorVersion property Virtual PC", "OSMajorVersion property Virtual PC , IVMHostInfo interface", "IVMHostInfo interface Virtual PC , OSMajorVersion property"]
topic_type:
- apiref
api_name:
