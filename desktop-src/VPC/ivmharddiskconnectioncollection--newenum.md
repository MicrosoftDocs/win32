...
keywords: ["_NewEnum property Virtual PC", "_NewEnum property Virtual PC , IVMHardDiskConnectionCollection interface", "IVMHardDiskConnectionCollection interface Virtual PC , _NewEnum property"]
topic_type:
- apiref
api_name:
