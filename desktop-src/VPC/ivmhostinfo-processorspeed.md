...
keywords: ["ProcessorSpeed property Virtual PC", "ProcessorSpeed property Virtual PC , IVMHostInfo interface", "IVMHostInfo interface Virtual PC , ProcessorSpeed property"]
topic_type:
- apiref
api_name:
