...
keywords: ["OnReset method Virtual PC", "OnReset method Virtual PC , IVMVirtualMachineEvents interface", "IVMVirtualMachineEvents interface Virtual PC , OnReset method"]
topic_type:
- apiref
api_name:
