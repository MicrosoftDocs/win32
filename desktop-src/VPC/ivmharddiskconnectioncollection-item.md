...
keywords: ["Item property Virtual PC", "Item property Virtual PC , IVMHardDiskConnectionCollection interface", "IVMHardDiskConnectionCollection interface Virtual PC , Item property"]
topic_type:
- apiref
api_name:
