...
keywords: ["ServicePackMajor property Virtual PC", "ServicePackMajor property Virtual PC , IVMGuestOS interface", "IVMGuestOS interface Virtual PC , ServicePackMajor property"]
topic_type:
- apiref
api_name:
...
# IVMGuestOS::ServicePackMajor property
