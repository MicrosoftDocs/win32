...
keywords: ["UndoHardDisk property Virtual PC", "UndoHardDisk property Virtual PC , IVMHardDiskConnection interface", "IVMHardDiskConnection interface Virtual PC , UndoHardDisk property"]
topic_type:
- apiref
api_name:
