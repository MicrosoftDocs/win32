...
keywords: ["AddNetworkAdapter method Virtual PC", "AddNetworkAdapter method Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , AddNetworkAdapter method"]
topic_type:
- apiref
api_name:
