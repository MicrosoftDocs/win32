...
keywords: ["LogicalProcessorCount property Virtual PC", "LogicalProcessorCount property Virtual PC , IVMHostInfo interface", "IVMHostInfo interface Virtual PC , LogicalProcessorCount property"]
topic_type:
- apiref
api_name:
