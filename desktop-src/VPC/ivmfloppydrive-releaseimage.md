...
keywords: ["ReleaseImage method Virtual PC", "ReleaseImage method Virtual PC , IVMFloppyDrive interface", "IVMFloppyDrive interface Virtual PC , ReleaseImage method"]
topic_type:
- apiref
api_name:
