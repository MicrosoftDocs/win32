...
keywords: ["IVMDVDDriveEvents interface Virtual PC", "IVMDVDDriveEvents interface Virtual PC , described"]
topic_type:
- apiref
api_name:
- IVMDVDDriveEvents
...
The **IVMDVDDriveEvents** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IVMDVDDriveEvents** also has these types of members:
