...
keywords: ["FloppyDrives property Virtual PC", "FloppyDrives property Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , FloppyDrives property"]
topic_type:
- apiref
api_name:
