...
keywords: ["PercentCompleted property Virtual PC", "PercentCompleted property Virtual PC , IVMTask interface", "IVMTask interface Virtual PC , PercentCompleted property"]
topic_type:
- apiref
api_name:
