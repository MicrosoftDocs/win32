...
keywords: ["GetFloppyDiskImageType method Virtual PC", "GetFloppyDiskImageType method Virtual PC , IVMVirtualPC interface", "IVMVirtualPC interface Virtual PC , GetFloppyDiskImageType method"]
topic_type:
- apiref
api_name:
