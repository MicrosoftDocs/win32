...
keywords: ["MergeUndoDisks method Virtual PC", "MergeUndoDisks method Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , MergeUndoDisks method"]
topic_type:
- apiref
api_name:
