...
keywords: ["HostDriveLetter property Virtual PC", "HostDriveLetter property Virtual PC , IVMFloppyDrive interface", "IVMFloppyDrive interface Virtual PC , HostDriveLetter property"]
topic_type:
- apiref
api_name:
