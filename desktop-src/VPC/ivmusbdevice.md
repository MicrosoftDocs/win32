...
keywords: ["IVMUSBDevice interface Virtual PC", "IVMUSBDevice interface Virtual PC , described"]
topic_type:
- apiref
api_name:
- IVMUSBDevice
...
The **IVMUSBDevice** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IVMUSBDevice** also has these types of members:
