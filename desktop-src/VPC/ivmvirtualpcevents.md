...
keywords: ["IVMVirtualPCEvents interface Virtual PC", "IVMVirtualPCEvents interface Virtual PC , described"]
topic_type:
- apiref
api_name:
- IVMVirtualPCEvents
...
The **IVMVirtualPCEvents** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IVMVirtualPCEvents** also has these types of members:
