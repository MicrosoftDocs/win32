...
keywords: ["Display property Virtual PC", "Display property Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , Display property"]
topic_type:
- apiref
api_name:
...
Retrieves the video display for the virtual machine.
...
The [**IVMDisplay**](ivmdisplay.md) object.
