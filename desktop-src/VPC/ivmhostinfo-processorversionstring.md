...
keywords:
- ProcessorVersionString property Virtual PC
- ProcessorVersionString property Virtual PC , IVMHostInfo interface
- IVMHostInfo interface Virtual PC , ProcessorVersionString property
topic_type:
- apiref
api_name:
