...
keywords: ["OnGuestLogoff method Virtual PC", "OnGuestLogoff method Virtual PC , IVMVirtualMachineEvents interface", "IVMVirtualMachineEvents interface Virtual PC , OnGuestLogoff method"]
topic_type:
- apiref
api_name:
