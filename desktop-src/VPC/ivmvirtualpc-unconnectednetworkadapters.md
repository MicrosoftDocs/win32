...
keywords:
- UnconnectedNetworkAdapters property Virtual PC
- UnconnectedNetworkAdapters property Virtual PC , IVMVirtualPC interface
- IVMVirtualPC interface Virtual PC , UnconnectedNetworkAdapters property
topic_type:
- apiref
api_name:
