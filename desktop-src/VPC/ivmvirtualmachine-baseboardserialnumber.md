...
keywords: ["BaseBoardSerialNumber property Virtual PC", "BaseBoardSerialNumber property Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , BaseBoardSerialNumber property"]
topic_type:
- apiref
api_name:
