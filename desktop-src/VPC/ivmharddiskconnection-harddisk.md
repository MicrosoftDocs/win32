...
keywords: ["HardDisk property Virtual PC", "HardDisk property Virtual PC , IVMHardDiskConnection interface", "IVMHardDiskConnection interface Virtual PC , HardDisk property"]
topic_type:
- apiref
api_name:
