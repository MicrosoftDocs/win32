...
keywords: ["OnGuestShutdown method Virtual PC", "OnGuestShutdown method Virtual PC , IVMVirtualMachineEvents interface", "IVMVirtualMachineEvents interface Virtual PC , OnGuestShutdown method"]
topic_type:
- apiref
api_name:
