...
keywords: ["IVMUSBDeviceCollection interface Virtual PC", "IVMUSBDeviceCollection interface Virtual PC , described"]
topic_type:
- apiref
api_name:
...
The **IVMUSBDeviceCollection** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IVMUSBDeviceCollection** also has these types of members:
