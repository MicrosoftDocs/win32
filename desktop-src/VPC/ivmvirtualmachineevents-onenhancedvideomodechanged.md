...
keywords: ["OnEnhancedVideoModeChanged method Virtual PC", "OnEnhancedVideoModeChanged method Virtual PC , IVMVirtualMachineEvents interface", "IVMVirtualMachineEvents interface Virtual PC , OnEnhancedVideoModeChanged method"]
topic_type:
- apiref
api_name:
