...
keywords: ["OnEventLogged method Virtual PC", "OnEventLogged method Virtual PC , IVMVirtualPCEvents interface", "IVMVirtualPCEvents interface Virtual PC , OnEventLogged method"]
topic_type:
- apiref
api_name:
