...
keywords: ["DiscardSavedState method Virtual PC", "DiscardSavedState method Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , DiscardSavedState method"]
topic_type:
- apiref
api_name:
