...
keywords: ["Has3DNow property Virtual PC", "Has3DNow property Virtual PC , IVMVirtualMachine interface", "IVMVirtualMachine interface Virtual PC , Has3DNow property"]
topic_type:
- apiref
api_name:
