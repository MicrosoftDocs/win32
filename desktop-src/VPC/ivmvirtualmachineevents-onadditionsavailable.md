...
keywords: ["OnAdditionsAvailable method Virtual PC", "OnAdditionsAvailable method Virtual PC , IVMVirtualMachineEvents interface", "IVMVirtualMachineEvents interface Virtual PC , OnAdditionsAvailable method"]
topic_type:
- apiref
api_name:
