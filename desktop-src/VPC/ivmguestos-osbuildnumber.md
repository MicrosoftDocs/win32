...
keywords: ["OSBuildNumber property Virtual PC", "OSBuildNumber property Virtual PC , IVMGuestOS interface", "IVMGuestOS interface Virtual PC , OSBuildNumber property"]
topic_type:
- apiref
api_name:
