...
keywords: ["IVMVirtualNetwork interface Virtual PC", "IVMVirtualNetwork interface Virtual PC , described"]
topic_type:
- apiref
api_name:
- IVMVirtualNetwork
...
| [**MediaType**](ivmvirtualnetwork-mediatype.md)<br/>             | Read-only<br/> | Determines whether the virtual network instance is wireless or not.<br/> |
