...
keywords: ["_NewEnum property Virtual PC", "_NewEnum property Virtual PC , IVMParallelPortCollection interface", "IVMParallelPortCollection interface Virtual PC , _NewEnum property"]
topic_type:
- apiref
api_name:
