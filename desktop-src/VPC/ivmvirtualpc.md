...
keywords: ["IVMVirtualPC interface Virtual PC", "IVMVirtualPC interface Virtual PC , described"]
topic_type:
- apiref
api_name:
- IVMVirtualPC
...
The **IVMVirtualPC** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IVMVirtualPC** also has these types of members:
