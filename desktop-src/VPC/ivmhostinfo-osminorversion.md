...
keywords: ["OSMinorVersion property Virtual PC", "OSMinorVersion property Virtual PC , IVMHostInfo interface", "IVMHostInfo interface Virtual PC , OSMinorVersion property"]
topic_type:
- apiref
api_name:
...
Retrieves the minor version of the operating system running on the host machine.
