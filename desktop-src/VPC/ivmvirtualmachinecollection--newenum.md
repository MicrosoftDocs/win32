...
keywords: ["_NewEnum property Virtual PC", "_NewEnum property Virtual PC , IVMVirtualMachineCollection interface", "IVMVirtualMachineCollection interface Virtual PC , _NewEnum property"]
topic_type:
- apiref
api_name:
