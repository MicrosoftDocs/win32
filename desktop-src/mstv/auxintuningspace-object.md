...
|                           |                                                                                                  |
|---------------------------|--------------------------------------------------------------------------------------------------|
| Interfaces                | [**IAuxInTuningSpace**](/previous-versions/windows/desktop/api/tuner/), [**IAuxInTuningSpace2**](/previous-versions/windows/desktop/api/tuner/nn-tuner-iauxintuningspace2) |
...
Tune request objects created by this tuning space support the [**ITuneRequest**](/previous-versions/windows/desktop/api/tuner/nn-tuner-itunerequest) and [**IChannelTuneRequest**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ichanneltunerequest) interfaces. The channel number indicates the input source:
