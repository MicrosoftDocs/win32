...
Defines flags for the [**IBDAComparable**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ibdacomparable) interface.
...
[**IBDAComparable**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ibdacomparable)
</dt> </dl>
