...
To play a media file with the Video Control, pass the file name to the [**IMSVidCtl::View**](/previous-versions/windows/desktop/api/msvidctl/nf-msvidctl-imsvidctl-view) method:
