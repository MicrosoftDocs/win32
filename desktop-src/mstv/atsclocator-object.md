...
|                           |                                      |
|---------------------------|--------------------------------------|
| Interfaces                | [**IATSCLocator**](/previous-versions/windows/desktop/api/tuner/nn-tuner-iatsclocator) |
...
The most important information in this object is the physical channel, which can be obtained by calling the [**IATSCLocator::get\_PhysicalChannel**](/previous-versions/windows/desktop/api/tuner/nf-tuner-iatsclocator-get_physicalchannel) method.
