...
Specifies the channel list record number, indexed from zero. Call the [**GetCountOfLists**](/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getcountoflists) method to get the number of channel list records in the logical channel descriptor.
...
Specifies the service record number, indexed from zero. Call the [**GetListCountOfRecords**](/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistcountofrecords) method to get the number of service records in the logical channel descriptor.
...
[**GetCountOfLists**](/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getcountoflists)
</dt> <dt>

[**GetListCountOfRecords**](/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistcountofrecords)
</dt> </dl>
