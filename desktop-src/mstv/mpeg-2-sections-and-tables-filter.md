...
\[This filter is no longer available for use as of Windows 7. Instead, use the [**IPSITables**](/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-ipsitables) interface to get program specific information (PSI) tables from an MPEG-2 transport stream.\]
...
|                                            |                                                                                                                             |
|--------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| Filter Interfaces                          | [**IBaseFilter**](https://msdn.microsoft.com/library/windows/desktop/dd389526), [**IMpeg2Data**](/previous-versions/windows/desktop/api/Mpeg2data/nn-mpeg2data-impeg2data)                                                      |
