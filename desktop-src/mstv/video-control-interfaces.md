...
|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|
| [**IBroadcastEventEx**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ibroadcasteventex)                                   | Extended version of **IBroadcastEvent**.                                                                      |
| [**IBroadcastEvent**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ibroadcastevent)                                       | Enables an object to receive events from another object without setting up a direct connection point.         |
...
| [**IMSVidCtl**](/previous-versions/windows/desktop/api/msvidctl/nn-msvidctl-imsvidctl)                                                   | Provides the primary interface for the Video Control.                                                         |
