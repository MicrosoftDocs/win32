...
The **RecComp** object creates new content recordings by concatenating existing recordings.
...
| Interface | [**IStreamBufferRecComp**](/previous-versions/windows/desktop/api/Sbe/nn-sbe-istreambufferreccomp) |
