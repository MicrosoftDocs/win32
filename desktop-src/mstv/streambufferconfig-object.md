...
The **StreamBufferConfig** object configures the Stream Buffer Engine. It enables an application to set the location, number, and size of the temporary backing files.
