...
3.  Query the recording attributes object for [**IStreamBufferRecordingAttribute**](/previous-versions/windows/desktop/api/Sbe/nn-sbe-istreambufferrecordingattribute) interface.
