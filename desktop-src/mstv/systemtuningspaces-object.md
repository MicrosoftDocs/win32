...
|                           |                                                        |
|---------------------------|--------------------------------------------------------|
| Interfaces                | [**ITuningSpaceContainer**](/windows/previous-versions/tuner/nn-tuner-ituningspacecontainer?branch=master) |
