...
|                           |                                                        |
|---------------------------|--------------------------------------------------------|
| Interfaces                | [**ITuningSpaceContainer**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ituningspacecontainer) |
