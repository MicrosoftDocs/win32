...
Call the [**IMSVidCtl::get\_VideoRendererActive**](imsvidctl-get-videorendereractive.md) method. This method returns a pointer to the [**IMSVidVideoRenderer**](/windows/desktop/api/segment/nn-segment-imsvidvideorenderer) interface on the video renderer device.
