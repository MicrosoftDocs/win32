...
|                                            |                                                                                                                                                              |
|--------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Filter interfaces                          | [**IBaseFilter**](https://msdn.microsoft.com/library/windows/desktop/dd389526), [**IBroadcastEvent**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ibroadcastevent), [**IETFilter**](/previous-versions/windows/desktop/api/EncDec/nn-encdec-ietfilter), [**IETFilterConfig**](/previous-versions/windows/desktop/api/EncDec/nn-encdec-ietfilterconfig) |
