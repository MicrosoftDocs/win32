...
|                                            |                                                                                                                                                              |
|--------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Filter interfaces                          | [**IBaseFilter**](https://msdn.microsoft.com/library/windows/desktop/dd389526), [**IDTFilter**](/previous-versions/windows/desktop/api/EncDec/nn-encdec-idtfilter), [**IDTFilterConfig**](/previous-versions/windows/desktop/api/EncDec/nn-encdec-idtfilterconfig), [**IBroadcastEvent**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ibroadcastevent) |
