...
|--------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| STREAMBUFFER\_EC\_CONTENT\_BECOMING\_STALE | The Stream Buffer Source has lagged behind the Stream Buffer Sink by more than a pre-set number of backing files. For more information, see [**IStreamBufferConfigure::GetBackingFileCount**](istreambufferconfigure-getbackingfilecount.md).                                                                                                                                 |
...
| SBE2\_STREAM\_DESC\_EVENT (Windows 7)      | An SBE2 stream has been updated. The event data is in a [**DVR\_STREAM\_DESC**](dvr-stream-desc.md) structure.                                                                                                                                                                                                                                                                |
