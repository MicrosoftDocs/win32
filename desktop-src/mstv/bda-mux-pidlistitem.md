...
keywords: ["BDA_MUX_PIDLISTITEM structure Microsoft TV Technologies", "PBDA_MUX_PIDLISTITEM structure pointer Microsoft TV Technologies"]
topic_type:
- apiref
api_name:
- BDA_MUX_PIDLISTITEM
...
Specifies a packet identifier (PID) for the [**IBDA\_MUX**](ibda-mux.md) interface.
