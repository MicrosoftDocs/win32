...
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|--------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Filter Interfaces                          | [**IBaseFilter**](https://msdn.microsoft.com/library/windows/desktop/dd389526), [**IBDA\_EthernetFilter**](/windows/desktop/api/bdaiface/nn-bdaiface-ibda_ethernetfilter), [**IBDA\_NetworkProvider**](/windows/desktop/api/bdaiface/nn-bdaiface-ibda_networkprovider), [**IBDA\_TIF\_REGISTRATION**](/previous-versions/windows/desktop/api/bdatif/nn-bdatif-ibda_tif_registration), [**IBDA\_IPV4Filter**](/windows/desktop/api/bdaiface/nn-bdaiface-ibda_ipv4filter), [**IBDA\_IPV6Filter**](/windows/desktop/api/bdaiface/nn-bdaiface-ibda_ipv6filter), [**IFrequencyMap**](/windows/desktop/api/bdaiface/nn-bdaiface-ifrequencymap), [**IMPEG2\_TIF\_CONTROL**](/previous-versions/windows/desktop/api/Bdatif/nn-bdatif-impeg2_tif_control), [**IScanningTuner**](/previous-versions/windows/desktop/api/tuner/nn-tuner-iscanningtuner), [**ITuner**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ituner) |
...
The Network Provider acts as the default tuner in a BDA filter graph, by exposing the [**ITuner**](/previous-versions/windows/desktop/api/tuner/nn-tuner-ituner) interface. No signals or data actually pass through this filter. It works closely with the Transport Information Filter (TIF) and the [MPEG-2 Demultiplexer](https://msdn.microsoft.com/library/windows/desktop/dd390715) to acquire transport streams and route the elementary stream to the appropriate downstream filters.
