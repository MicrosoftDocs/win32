...
-   [**IDigitalCableLocator**](/previous-versions/windows/desktop/api/tuner/)
-   [**IDigitalCableTuneRequest**](/previous-versions/windows/desktop/api/tuner/nn-tuner-idigitalcabletunerequest)
-   [**IEncoderAPI**](/windows/desktop/api/Strmif/nn-strmif-iencoderapi)
-   [**IScanningTuner**](/previous-versions/windows/desktop/api/tuner/nn-tuner-iscanningtuner)
