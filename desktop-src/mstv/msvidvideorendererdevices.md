...
To obtain this collection, call the [**IMSVidCtl::get\_VideoRenderersAvailable**](/previous-versions/windows/desktop/api/msvidctl/nf-msvidctl-imsvidctl-get_videorenderersavailable) method. In practice, this collection will only contain a single object, representing the Video Mixing Renderer filter.
