...
| [**EnumUILanguagesProc**](https://msdn.microsoft.com/library/Dd317835(v=VS.85).aspx)                       | An application-defined function used with the [**EnumUILanguages**](/windows/desktop/api/Winnls/nf-winnls-enumuilanguagesa) function.                      |
