...
Sent to an application to provide commands and request information. A window receives this message through its [**WindowProc**](_win32_windowproc_cpp) function.
