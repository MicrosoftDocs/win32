...
Pointer to a buffer containing a [**LOGFONT**](gdi.logfont) structure. The application fills in the values for the current composition window.

</dd> </dl>

## Return Value

Returns a nonzero value if the application fills in the [**LOGFONT**](gdi.logfont) structure. Otherwise, the command returns 0.
