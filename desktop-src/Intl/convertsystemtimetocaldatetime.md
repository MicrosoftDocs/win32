...
Deprecated. Converts a specified [**SYSTEMTIME**](https://msdn.microsoft.com/en-us/library/ms724950(v=VS.85).aspx) structure to a [**CALDATETIME**](caldatetime.md) structure.
...
Pointer to the [**SYSTEMTIME**](https://msdn.microsoft.com/en-us/library/ms724950(v=VS.85).aspx) structure to convert.
