...
Deprecated. Converts a specified [**SYSTEMTIME**](base.systemtime_str) structure to a [**CALDATETIME**](caldatetime.md) structure.
...
Pointer to the [**SYSTEMTIME**](base.systemtime_str) structure to convert.
