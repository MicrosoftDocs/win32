...
| **Function**             | [**GetThreadLocale**](/windows/desktop/api/Winnls/nf-winnls-getthreadlocale)                                                                                                                    | [**GetKeyboardLayout**](https://msdn.microsoft.com/library/ms646296(v=VS.85).aspx)                                                     | [**GetSystemDefaultUILanguage**](/windows/desktop/api/Winnls/nf-winnls-getsystemdefaultuilanguage)                                                                                                                                                                                                                                                                                                                               |
...
To set and retrieve the input language value, the application calls [**LoadKeyboardLayout**](https://msdn.microsoft.com/library/ms646305(v=VS.85).aspx) and [**GetKeyboardLayout**](https://msdn.microsoft.com/library/ms646296(v=VS.85).aspx), respectively. Users can add and remove input languages through the **Languages** tab in the regional and language options portion of the Control Panel.
