...
| **Function**             | [**GetThreadLocale**](/windows/desktop/api/Winnls/nf-winnls-getthreadlocale)                                                                                                                    | [**GetKeyboardLayout**](https://www.bing.com/search?q=**GetKeyboardLayout**)                                                     | [**GetSystemDefaultUILanguage**](/windows/desktop/api/Winnls/nf-winnls-getsystemdefaultuilanguage)                                                                                                                                                                                                                                                                                                                               |
...
To set and retrieve the input language value, the application calls [**LoadKeyboardLayout**](https://www.bing.com/search?q=**LoadKeyboardLayout**) and [**GetKeyboardLayout**](https://www.bing.com/search?q=**GetKeyboardLayout**), respectively. Users can add and remove input languages through the **Languages** tab in the regional and language options portion of the Control Panel.
