...
The predefined locale identifiers supported by NLS are defined in the [National Language Support (NLS) API Reference](https://msdn.microsoft.com/library/cc233982.aspx).
