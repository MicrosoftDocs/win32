...
The application can get information about the open status by using the [**ImmGetOpenStatus**](immgetopenstatus.md) function.
...
[**ImmGetOpenStatus**](immgetopenstatus.md)
</dt> <dt>
