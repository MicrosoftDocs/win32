...
The function returns 0 if it does not succeed. To get extended error information, the application can call [**GetLastError**](base.getlasterror), which can return one of the following error codes:
