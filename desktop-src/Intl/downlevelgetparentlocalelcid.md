...
Returns the parent locale identifier if successful, or 0 otherwise. To get extended error information, the application can call [**GetLastError**](base.getlasterror), which can return one of the following error codes:
