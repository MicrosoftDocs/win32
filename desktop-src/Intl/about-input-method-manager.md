...
> [!Note]  
> The IMM performs similar operations to those of the [Text Services Framework](https://msdn.microsoft.com/windows/desktop/ecc34b2e-89e8-48a8-8a8e-442d2145fe24), used by applications that communicate with text services.
