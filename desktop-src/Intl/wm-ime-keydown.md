...
Sent to an application by the IME to notify the application of a key press and to keep message order. A window receives this message through its [**WindowProc**](_win32_windowproc_cpp) function.
...
An application can process this message or pass it to the [**DefWindowProc**](_win32_defwindowproc_cpp) function to generate a matching [**WM\_KEYDOWN**](_win32_wm_keydown_cpp) message.
