...
This topic describes the calendar type information (CALTYPE data type) used in the [**EnumCalendarInfo**](enumcalendarinfo.md), [**EnumCalendarInfoEx**](enumcalendarinfoex.md), [**EnumCalendarInfoExEx**](enumcalendarinfoexex.md), [**GetCalendarInfo**](getcalendarinfo.md), and [**GetCalendarInfoEx**](getcalendarinfoex.md) functions. Some of these values are also used by the [**SetCalendarInfo**](setcalendarinfo.md) function.
