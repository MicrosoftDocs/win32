...
Applications that use mostly plain text, that is, text that uses the same typeface, weight, color, and so on, have traditionally written text and measured line lengths using standard text functions, such as [**TextOut**](https://msdn.microsoft.com/windows/desktop/0c437ff8-3893-4dc3-827b-fa9ce4bcd7e6), [**ExtTextOut**](https://msdn.microsoft.com/windows/desktop/74f8fcb8-8ad4-47f2-a330-fa56713bdb37), [**TabbedTextOut**](https://msdn.microsoft.com/windows/desktop/1cb78a75-752d-4e06-afdf-cd797f209114), [**DrawText**](https://msdn.microsoft.com/windows/desktop/fe412280-d797-4abd-8a29-107a9cd96145), and [**GetTextExtentExPoint**](https://msdn.microsoft.com/windows/desktop/b873a059-5aa3-47d0-b109-7acd542c7d79). These functions support processing for complex scripts and fine typography effects. For more information, see [Fonts and Text](https://msdn.microsoft.com/windows/desktop/9944baa9-8e50-40b9-9650-78b0b1d7643a).
...
-   Your application should save characters in a buffer and display a whole line of text at one time instead of, for example, calling [**ExtTextOut**](https://msdn.microsoft.com/windows/desktop/74f8fcb8-8ad4-47f2-a330-fa56713bdb37) on each character as it is typed in by the user. This mechanism allows the advanced text shaping modules to use context to reorder and generate [glyphs](https://www.bing.com/search?q=glyphs) correctly.
-   The application should use [**GetTextExtentExPoint**](https://msdn.microsoft.com/windows/desktop/b873a059-5aa3-47d0-b109-7acd542c7d79) to determine line length, instead of computing line lengths from cached character widths, since the width of a glyph can vary by context.
...
Along with the Rich Edit interfaces, applications can use the Rich Edit [**TextOut**](https://msdn.microsoft.com/windows/desktop/0c437ff8-3893-4dc3-827b-fa9ce4bcd7e6) function to automatically parse, shape, position, and break lines. For more information, see [Rich Edit Controls](https://www.bing.com/search?q=Rich Edit Controls).
