...
The following example calls [**ScriptGetProperties**](scriptgetproperties.md) to find out if the script of each of several successive [items](uniscribe-glossary.md) requires glyph shaping.
