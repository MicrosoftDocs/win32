...
On Windows Vista and later, the application loads the resource module using a call to [**LoadLibrary**](base.loadlibrary) or [**LoadLibraryEx**](base.loadlibraryex). The recommended operation is to call this function with both flags specified. The following is an example of application code that loads a module based on system language settings.
