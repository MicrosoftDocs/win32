...
title: IMN\_SETCONVERSIONMODE notification code
ms.date: 05/31/2018
ms.topic: article
...
The application can get information about the conversion mode by using the [**ImmGetConversionStatus**](/windows/win32/Imm/nf-imm-immgetconversionstatus?branch=master) function.
