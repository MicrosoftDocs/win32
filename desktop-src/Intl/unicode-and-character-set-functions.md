...
| [**BytesToUnicode**](https://msdn.microsoft.com/library/Dd317724(v=VS.85).aspx)                       | Do not use.                                                                                                           |
| [**NlsDllCodePageTranslation**](/windows/desktop/api/Gb18030/nf-gb18030-nlsdllcodepagetranslation) | Do not use.                                                                                                           |
| [**UnicodeToBytes**](https://msdn.microsoft.com/library/Dd374082(v=VS.85).aspx)                       | Do not use.                                                                                                           |
