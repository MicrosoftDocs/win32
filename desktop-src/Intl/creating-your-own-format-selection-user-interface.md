...
Please see [Options for Displaying Text](https://msdn.microsoft.com/en-us/goglobal/bb688137.aspx#eph) for the explanation and advantages of each of these options. It is then up to you to decide which is the best option for your application, based on the application's complexity and its design features.
