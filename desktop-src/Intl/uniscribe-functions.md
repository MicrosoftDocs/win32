...
| [**ScriptString\_pSize**](/windows/desktop/api/Usp10/nf-usp10-scriptstring_psize)                      | Returns a pointer to a [**SIZE**](https://msdn.microsoft.com/library/Dd145106(v=VS.85).aspx) structure for an analyzed string.                                                                                                     |
