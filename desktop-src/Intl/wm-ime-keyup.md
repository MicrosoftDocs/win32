...
Sent to an application by the IME to notify the application of a key release and to keep message order. A window receives this message through its [**WindowProc**](_win32_windowproc_cpp) function.
...
An application can process this message or pass it to the [**DefWindowProc**](_win32_defwindowproc_cpp) function to generate a matching [**WM\_KEYUP**](_win32_wm_keyup_cpp) message.
