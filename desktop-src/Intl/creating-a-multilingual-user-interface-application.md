...
This tutorial begins with the monolingual version of the Hello MUI application. The application assumes the use of the C++ programming language, wide character strings, and the [**MessageBoxW**](_win32_MessageBox) function for output.
...
For more about .rc file structure and syntax, see [About Resource Files](tools.about_resource_files).
