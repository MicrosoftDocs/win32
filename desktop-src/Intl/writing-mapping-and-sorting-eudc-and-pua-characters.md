...
Applications write end-user-defined characters (EUDCs) and private use area (PUA) characters to the screen or printer just as they write other characters, by using output functions such as [TextOut](https://msdn.microsoft.com/windows/desktop/0c437ff8-3893-4dc3-827b-fa9ce4bcd7e6) and [ExtTextOut](https://msdn.microsoft.com/windows/desktop/74f8fcb8-8ad4-47f2-a330-fa56713bdb37). These functions automatically retrieve character information from EUDC or PUA character fonts if EUDC is enabled. For more information, see [End-User\_Defined and Private Use Area Characters](end-user-defined-characters.md).
