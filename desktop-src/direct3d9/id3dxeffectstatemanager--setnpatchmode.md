...
Break the surface into this number of subdivisions. This is the same as the number used by [**IDirect3DDevice9::SetNPatchMode**](idirect3ddevice9--setnpatchmode.md).
...
-   The dynamic effect state call (such as [**IDirect3DDevice9::SetNPatchMode**](idirect3ddevice9--setnpatchmode.md)) will fail.
