...
[HDRLighting Sample](https://msdn.microsoft.com/windows/desktop/3c93e4a0-ea17-b0a9-f47e-0ada3fc66b4e) is a SDK sample that demonstrates HDR lighting.
...
Reinhard, Erik, Mike Stark, Peter Shirley, and James Ferwerda. ["Photographic Tone Reproduction for Digital Images"](http://go.microsoft.com/?linkid=9742320). ACM Transactions on Graphics (TOG), Proceedings of the 29th Annual Conference on Computer Graphics and Interactive Techniques (SIGGRAPH), pp. 267-276. New York, NY: ACM Press, 2002.
