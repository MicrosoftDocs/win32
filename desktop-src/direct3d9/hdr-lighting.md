...
Reinhard, Erik, Mike Stark, Peter Shirley, and James Ferwerda. ["Photographic Tone Reproduction for Digital Images"](https://go.microsoft.com/?linkid=9742320). ACM Transactions on Graphics (TOG), Proceedings of the 29th Annual Conference on Computer Graphics and Interactive Techniques (SIGGRAPH), pp. 267-276. New York, NY: ACM Press, 2002.
