...
Mesh creation options; this is a combination of one or more [**D3DXMESH**](direct3d9.d3dxmesh) flags. The mesh creation options are equivalent to the options parameter required by [**D3DXCreateMesh**](d3dxcreatemesh.md).
