...
Combination of one or more flags from the [**D3DXMESH**](direct3d9.d3dxmesh) enumeration that specify creation options for the mesh.
...
See [**FindResource**](menurc.findresource) to find out more about the Module, Name and Type parameters.
