...
-   To associate a user-interface control with an effect parameter, use a [UI Annotation](ui-annotation.md). These annotations include: [SasUiMax](https://www.bing.com/search?q=SasUiMax), [SasUiMin](https://www.bing.com/search?q=SasUiMin), [SasUiSteps](https://www.bing.com/search?q=SasUiSteps), [SasUiStepsPower](https://www.bing.com/search?q=SasUiStepsPower), and [SasUiStride](https://www.bing.com/search?q=SasUiStride).
...
-   When data is transferred between the host application and an effect (or vice versa), [Casting and Conversion](casting-and-conversion.md) will occur when the types do not exactly match. This section specifies how data is written when the source and target types differ. In addition, use [ParameterValueModifiers](https://www.bing.com/search?q=ParameterValueModifiers) to modify how the host application should interpret data read from the effect parameter. These annotations include: [SasNormalize](https://www.bing.com/search?q=SasNormalize) and [SasUnits](https://www.bing.com/search?q=SasUnits).
