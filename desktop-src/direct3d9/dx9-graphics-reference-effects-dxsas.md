...
-   To associate a user-interface control with an effect parameter, use a [UI Annotation](ui-annotation.md). These annotations include: [SasUiMax](ui-annotation.md#sasuimax), [SasUiMin](ui-annotation.md#sasuimin), [SasUiSteps](ui-annotation.md#sasuisteps), [SasUiStepsPower](ui-annotation.md#sasuistepspower), and [SasUiStride](ui-annotation.md#sasuistride).
...
-   When data is transferred between the host application and an effect (or vice versa), [Casting and Conversion](casting-and-conversion.md) will occur when the types do not exactly match. This section specifies how data is written when the source and target types differ. In addition, use [ParameterValueModifiers](casting-and-conversion.md#parameter-value-modifiers) to modify how the host application should interpret data read from the effect parameter. These annotations include: [SasNormalize](casting-and-conversion.md#sasnormalize) and [SasUnits](casting-and-conversion.md#sasunits).
