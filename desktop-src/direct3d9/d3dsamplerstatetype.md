...
Texture-address mode for the u coordinate. The default is D3DTADDRESS\_WRAP. For more information, see [**D3DTEXTUREADDRESS**](direct3d9.d3dtextureaddress).
...
Texture-address mode for the v coordinate. The default is D3DTADDRESS\_WRAP. For more information, see [**D3DTEXTUREADDRESS**](direct3d9.d3dtextureaddress).
...
Texture-address mode for the w coordinate. The default is D3DTADDRESS\_WRAP. For more information, see [**D3DTEXTUREADDRESS**](direct3d9.d3dtextureaddress).
...
Magnification filter of type [**D3DTEXTUREFILTERTYPE**](direct3d9.d3dtexturefiltertype). The default value is D3DTEXF\_POINT.
...
Minification filter of type [**D3DTEXTUREFILTERTYPE**](direct3d9.d3dtexturefiltertype). The default value is D3DTEXF\_POINT.
...
Mipmap filter to use during minification. See [**D3DTEXTUREFILTERTYPE**](direct3d9.d3dtexturefiltertype). The default value is D3DTEXF\_NONE.
