---
description: ID3DXCompressedAnimationSet::GetPlaybackType method - Gets the type of the animation set playback loop.
...
- kbSyntax
api_name: 
- ID3DXCompressedAnimationSet.GetPlaybackType
api_type: 
- COM
api_location: 
- d3dx9.lib
...
# ID3DXCompressedAnimationSet::GetPlaybackType method
