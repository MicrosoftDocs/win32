...
Creates the first constant (in register src2) for the [sincos - ps](direct3dhlsl.sincos___ps) pixel shader instruction.
...
Returns the first constant needed by [sincos - ps](direct3dhlsl.sincos___ps).
