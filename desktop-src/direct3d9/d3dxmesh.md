...
Use the [**D3DPOOL\_SYSTEMMEM**](direct3d9.d3dpool) usage flag for vertex buffers.
...
Use the [**D3DPOOL\_MANAGED**](direct3d9.d3dpool) usage flag for vertex buffers.
...
Use the [**D3DPOOL\_SYSTEMMEM**](direct3d9.d3dpool) usage flag for index buffers.
...
Use the [**D3DPOOL\_MANAGED**](direct3d9.d3dpool) usage flag for index buffers.
