...
The **ID3DXFont** interface inherits from the [**IUnknown**](com.iunknown) interface. **ID3DXFont** also has these types of members:
...
| [**GetTextMetrics**](id3dxfont--gettextmetrics.md)       | Retrieves font characteristics that are identified in a [**TEXTMETRIC**](gdi.textmetric) structure. This method supports ANSI and Unicode compiler settings.<br/>                                                                       |
