...
Before creating a device with the [**IDirect3D9::CreateDevice**](/windows/desktop/api) method, you need to determine if full-scene antialiasing is supported. Do this by calling the [**IDirect3D9::CheckDeviceMultiSampleType**](/windows/desktop/api) method as shown in the code example below.
...
The last step is to enable multisampling antialiasing by calling the [**IDirect3DDevice9::SetRenderState**](/windows/desktop/api) method and setting the D3DRS\_MULTISAMPLEANTIALIAS to **TRUE**. After setting this value to **TRUE**, any rendering that you do will have multisampling applied to it. You might want to enable and disable multisampling, depending on what you are rendering.
