...
-   [**IDirect3D9**](/windows/desktop/api)
-   [**IDirect3DBaseTexture9**](/windows/desktop/api)
-   [**IDirect3DCubeTexture9**](/windows/desktop/api)
-   [**IDirect3DDevice9**](/windows/desktop/api)
-   [**IDirect3DIndexBuffer9**](/windows/desktop/api)
