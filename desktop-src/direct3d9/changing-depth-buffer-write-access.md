...
You can disable depth buffer writes in C++ by calling the [**IDirect3DDevice9::SetRenderState**](idirect3ddevice9--setrenderstate.md) method with the State parameter set to D3DRS\_ZWRITEENABLE and the Value parameter set to 0.
