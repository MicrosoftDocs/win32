...
-   The dynamic effect state call (such as [**IDirect3DDevice9::SetVertexShaderConstantF**](/windows/desktop/api/d3d9helper/nf-d3d9-idirect3ddevice9-setvertexshaderconstantf)) will fail.
