...
**OnResetDevice** should be called each time the device is reset (using [**Reset**](/windows/desktop/api/d3d9helper/nf-d3d9-idirect3ddevice9-reset)), before any other methods are called. This is a good place to re-acquire video-memory resources and capture state blocks.
