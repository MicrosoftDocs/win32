...
<td>0x00000002L</td>
<td>Microsoft Windows Hardware Quality Labs (WHQL) driver testing. This is a time-consuming test requiring a one-second or two-second time penalty. This constant is used by the WHQLLevel member of [<strong>D3DADAPTER_IDENTIFIER9</strong>](d3dadapter-identifier9.md).<br/> 
<table>
<tbody>
<tr class="odd">
