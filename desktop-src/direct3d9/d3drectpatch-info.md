...
Member of the [**D3DBASISTYPE**](direct3d9.d3dbasistype) enumerated type, defining the basis type for the rectangular high-order patch.
...
Member of the [**D3DDEGREETYPE**](direct3d9.d3ddegreetype) enumerated type, defining the degree for the rectangular patch.
