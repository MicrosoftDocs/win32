...
When [**IDirect3DDevice9::ProcessVertices**](idirect3ddevice9--processvertices.md) fails due to an incompatible destination vertex buffer FVF code, the expected code is printed to the debug output (debug builds only).
