...
When [**IDirect3DDevice9::ProcessVertices**](https://msdn.microsoft.com/library/Bb174424(v=VS.85).aspx) fails due to an incompatible destination vertex buffer FVF code, the expected code is printed to the debug output (debug builds only).
