...
The following call to the [**IDirect3D9::CreateDevice**](/windows/win32/d3d9helper/nf-d3d9-idirect3d9-createdevice?branch=master) method creates a device that then creates a depth buffer.
...
To create a new depth buffer surface, use the [**IDirect3DDevice9::CreateDepthStencilSurface**](/windows/win32/d3d9helper/nf-d3d9-idirect3ddevice9-createdepthstencilsurface?branch=master) method.

To set a new depth-buffer surface for the device, use the [**IDirect3DDevice9::SetDepthStencilSurface**](/windows/win32/d3d9helper/nf-d3d9-idirect3ddevice9-setdepthstencilsurface?branch=master) method.
