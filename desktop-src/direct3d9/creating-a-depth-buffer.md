...
The following call to the [**IDirect3D9::CreateDevice**](idirect3d9--createdevice.md) method creates a device that then creates a depth buffer.
...
To create a new depth buffer surface, use the [**IDirect3DDevice9::CreateDepthStencilSurface**](idirect3ddevice9--createdepthstencilsurface.md) method.

To set a new depth-buffer surface for the device, use the [**IDirect3DDevice9::SetDepthStencilSurface**](idirect3ddevice9--setdepthstencilsurface.md) method.
