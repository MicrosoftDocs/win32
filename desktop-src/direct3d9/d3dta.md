...
Texture argument constants are used as values for the following members of the [**D3DTEXTURESTAGESTATETYPE**](direct3d9.d3dtexturestagestatetype) enumerated type:
