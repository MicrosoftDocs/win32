...
For more information about the differences between shader versions, see [Pixel Shader Differences](https://msdn.microsoft.com/VS|directx_sdk|~\dx9_graphics_reference_asm_ps_differences.htm).
