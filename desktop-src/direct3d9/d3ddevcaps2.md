...
| D3DDEVCAPS2\_CAN\_STRETCHRECT\_FROM\_TEXTURES   | Device supports [**StretchRect**](/windows/desktop/api/d3d9helper/nf-d3d9-idirect3ddevice9-stretchrect) using a texture as the source.                                                                                                                       |
