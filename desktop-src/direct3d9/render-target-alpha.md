...
-   srcBlendOp is one of the blend factors in [**D3DBLEND**](direct3d9.d3dblend).
-   BlendOp is one of the blend factors in [**D3DBLENDOP**](direct3d9.d3dblendop).
-   alpha<sub>rt</sub> is the render-target alpha value.
-   destBlendOp is one of the blend factors in [**D3DBLEND**](direct3d9.d3dblend).
