...
The **ID3DXSaveUserData** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/ms680509(v=VS.85).aspx) interface. **ID3DXSaveUserData** also has these types of members:
