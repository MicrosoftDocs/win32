...
C++ applications update the depth-buffering state with the D3DRS\_ZENABLE render state, using a member of the [**D3DZBUFFERTYPE**](https://msdn.microsoft.com/VS|directx_sdk|~\d3dzbuffertype.htm) enumeration to specify the new state value.
