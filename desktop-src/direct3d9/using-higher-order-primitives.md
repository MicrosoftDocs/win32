...
[**IDirect3DDevice9::DrawTriPatch**](/windows/desktop/api/d3d9helper/nf-d3d9-idirect3ddevice9-drawtripatch) is similar to [**IDirect3DDevice9::DrawRectPatch**](/windows/desktop/api/d3d9helper/nf-d3d9-idirect3ddevice9-drawrectpatch) except that it draws a triangular high-order patch.
