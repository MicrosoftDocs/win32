...
| .dds           | DirectDraw Surface file format. Stores textures, volume textures, and cubic environment maps, with or without mipmap levels, and with or without pixel compression. See [DDS](direct3ddxgi.dx_graphics_dds).                                                                                                                                       |
...
See [Types of Bitmaps](gdiplus._gdiplus_Types_of_Bitmaps_about) for more information on some of these formats.
