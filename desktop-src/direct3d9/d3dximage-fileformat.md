...
| .dds           | DirectDraw Surface file format. Stores textures, volume textures, and cubic environment maps, with or without mipmap levels, and with or without pixel compression. See [DDS](https://www.bing.com/search?q=DDS).                                                                                                                                       |
...
See [Types of Bitmaps](https://msdn.microsoft.com/en-us/library/ms536393(v=VS.85).aspx) for more information on some of these formats.
