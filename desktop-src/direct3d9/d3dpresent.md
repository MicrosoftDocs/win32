...
<td style="text-align: left;">A presentation cannot be scheduled by a hal device. If this flag is set in a call to [<strong>Present</strong>](/windows/desktop/api), and the hardware is busy processing or waiting for a vertical sync interval, then Present will return D3DERR_WASSTILLDRAWING to indicate that the blit operation is incomplete.<br/></td>
</tr>
<tr class="odd">
