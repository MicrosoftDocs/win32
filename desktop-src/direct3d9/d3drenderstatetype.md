...
Depth-buffering state as one member of the [**D3DZBUFFERTYPE**](direct3d9.d3dzbuffertype) enumerated type. Set this state to D3DZB\_TRUE to enable z-buffering, D3DZB\_USEW to enable w-buffering, or D3DZB\_FALSE to disable depth buffering.
...
One or more members of the [**D3DFILLMODE**](direct3d9.d3dfillmode) enumerated type. The default value is D3DFILL\_SOLID.
...
One or more members of the [**D3DSHADEMODE**](direct3d9.d3dshademode) enumerated type. The default value is D3DSHADE\_GOURAUD.
...
One member of the [**D3DBLEND**](direct3d9.d3dblend) enumerated type. The default value is D3DBLEND\_ONE.
...
One member of the [**D3DBLEND**](direct3d9.d3dblend) enumerated type. The default value is D3DBLEND\_ZERO.
...
Specifies how back-facing triangles are culled, if at all. This can be set to one member of the [**D3DCULL**](direct3d9.d3dcull) enumerated type. The default value is D3DCULL\_CCW.
...
One member of the [**D3DCMPFUNC**](direct3d9.d3dcmpfunc) enumerated type. The default value is D3DCMP\_LESSEQUAL. This member enables an application to accept or reject a pixel, based on its distance from the camera.
...
One member of the [**D3DCMPFUNC**](direct3d9.d3dcmpfunc) enumerated type. The default value is D3DCMP\_ALWAYS. This member enables an application to accept or reject a pixel, based on its alpha value.
...
The fog formula to be used for pixel fog. Set to one of the members of the [**D3DFOGMODE**](direct3d9.d3dfogmode) enumerated type. The default value is D3DFOG\_NONE. For more information about pixel fog, see [Pixel Fog (Direct3D 9)](pixel-fog.md).
...
Stencil operation to perform if the stencil test fails. Values are from the [**D3DSTENCILOP**](direct3d9.d3dstencilop) enumerated type. The default value is D3DSTENCILOP\_KEEP.
...
Stencil operation to perform if the stencil test passes and the depth test (z-test) fails. Values are from the [**D3DSTENCILOP**](direct3d9.d3dstencilop) enumerated type. The default value is D3DSTENCILOP\_KEEP.
...
Stencil operation to perform if both the stencil and the depth (z) tests pass. Values are from the [**D3DSTENCILOP**](direct3d9.d3dstencilop) enumerated type. The default value is D3DSTENCILOP\_KEEP.
...
Comparison function for the stencil test. Values are from the [**D3DCMPFUNC**](direct3d9.d3dcmpfunc) enumerated type. The default value is D3DCMP\_ALWAYS.
...
Fog formula to be used for vertex fog. Set to one member of the [**D3DFOGMODE**](direct3d9.d3dfogmode) enumerated type. The default value is D3DFOG\_NONE.
...
Diffuse color source for lighting calculations. Valid values are members of the [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) enumerated type. The default value is D3DMCS\_COLOR1. The value for this render state is used only if the D3DRS\_COLORVERTEX render state is set to **TRUE**.
...
Specular color source for lighting calculations. Valid values are members of the [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) enumerated type. The default value is D3DMCS\_COLOR2.
...
Ambient color source for lighting calculations. Valid values are members of the [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) enumerated type. The default value is D3DMCS\_MATERIAL.
...
Emissive color source for lighting calculations. Valid values are members of the [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) enumerated type. The default value is D3DMCS\_MATERIAL.
...
Number of matrices to use to perform geometry blending, if any. Valid values are members of the [**D3DVERTEXBLENDFLAGS**](direct3d9.d3dvertexblendflags) enumerated type. The default value is D3DVBF\_DISABLE.
...
Sets whether patch edges will use float style tessellation. Possible values are defined by the [**D3DPATCHEDGESTYLE**](direct3d9.d3dpatchedgestyle) enumerated type. The default value is D3DPATCHEDGE\_DISCRETE.
...
Value used to select the arithmetic operation applied when the alpha blending render state, D3DRS\_ALPHABLENDENABLE, is set to **TRUE**. Valid values are defined by the [**D3DBLENDOP**](direct3d9.d3dblendop) enumerated type. The default value is D3DBLENDOP\_ADD.
...
N-patch position interpolation degree. The values can be D3DDEGREE\_CUBIC (default) or D3DDEGREE\_LINEAR. For more information, see [**D3DDEGREETYPE**](direct3d9.d3ddegreetype).
...
N-patch normal interpolation degree. The values can be D3DDEGREE\_LINEAR (default) or D3DDEGREE\_QUADRATIC. For more information, see [**D3DDEGREETYPE**](direct3d9.d3ddegreetype).
...
Stencil operation to perform if CCW stencil test fails. Values are from the [**D3DSTENCILOP**](direct3d9.d3dstencilop) enumerated type. The default value is D3DSTENCILOP\_KEEP.
...
Stencil operation to perform if CCW stencil test passes and z-test fails. Values are from the [**D3DSTENCILOP**](direct3d9.d3dstencilop) enumerated type. The default value is D3DSTENCILOP\_KEEP.
...
Stencil operation to perform if both CCW stencil and z-tests pass. Values are from the [**D3DSTENCILOP**](direct3d9.d3dstencilop) enumerated type. The default value is D3DSTENCILOP\_KEEP.
...
The comparison function. CCW stencil test passes if ((ref & mask) stencil function (stencil & mask)) is **TRUE**. Values are from the [**D3DCMPFUNC**](direct3d9.d3dcmpfunc) enumerated type. The default value is D3DCMP\_ALWAYS.
...
One member of the [**D3DBLEND**](direct3d9.d3dblend) enumerated type. This value is ignored unless D3DRS\_SEPARATEALPHABLENDENABLE is **TRUE**. The default value is D3DBLEND\_ONE.
...
One member of the [**D3DBLEND**](direct3d9.d3dblend) enumerated type. This value is ignored unless D3DRS\_SEPARATEALPHABLENDENABLE is **TRUE**. The default value is D3DBLEND\_ZERO.
...
Valid values are defined by the [**D3DBLENDOP**](direct3d9.d3dblendop) enumerated type. The default value is D3DBLENDOP\_ADD.
