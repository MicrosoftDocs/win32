...
3.  Choose the fog formula to use by setting the D3DRS\_FOGTABLEMODE render state to the corresponding member of the [**D3DFOGMODE**](https://msdn.microsoft.com/VS|directx_sdk|~\d3dfogmode.htm) enumerated type.
