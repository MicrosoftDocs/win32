...
| <span id="type"></span><span id="TYPE"></span>*type*<br/>                      | Any valid [Reference for HLSL](direct3dhlsl.dx_graphics_hlsl_reference) type.<br/>                                                                        |
...
Parameters can be initialized to any valid [Reference for HLSL](direct3dhlsl.dx_graphics_hlsl_reference) expression that reduces to a literal value.
