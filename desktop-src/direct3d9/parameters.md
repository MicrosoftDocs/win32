...
| <span id="type"></span><span id="TYPE"></span>*type*<br/>                      | Any valid [Reference for HLSL](https://msdn.microsoft.com/VS|directx_sdk|~\dx_graphics_hlsl_reference.htm) type.<br/>                                                                        |
...
Parameters can be initialized to any valid [Reference for HLSL](https://msdn.microsoft.com/VS|directx_sdk|~\dx_graphics_hlsl_reference.htm) expression that reduces to a literal value.
