...
The **ID3DXConstantTable** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/en-us/library/ms680509(v=VS.85).aspx) interface. **ID3DXConstantTable** also has these types of members:
