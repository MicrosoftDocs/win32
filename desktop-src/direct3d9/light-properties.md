...
Usually material colors are used for lighting. However, you can specify that material colors-emissive, ambient, diffuse, and specular-are to be overridden by diffuse or specular vertex colors. This is done by calling [**SetRenderState**](https://msdn.microsoft.com/library/Bb174454(v=VS.85).aspx) and setting the device state variables listed in the following table.
