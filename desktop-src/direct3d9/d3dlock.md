...
| D3DLOCK\_DONOTWAIT         | Allows an application to gain back CPU cycles if the driver cannot lock the surface immediately. If this flag is set and the driver cannot lock the surface immediately, the lock call will return D3DERR\_WASSTILLDRAWING. This flag can only be used when locking a surface created using [**CreateOffscreenPlainSurface**](idirect3ddevice9--createoffscreenplainsurface.md), [**CreateRenderTarget**](idirect3ddevice9--createrendertarget.md), or [**CreateDepthStencilSurface**](idirect3ddevice9--createdepthstencilsurface.md). This flag can also be used with a back buffer.            |
...
[**LockRect**](idirect3dcubetexture9--lockrect.md)
</dt> <dt>

[**Lock**](idirect3dindexbuffer9--lock.md)
</dt> <dt>

[**LockRect**](idirect3dsurface9--lockrect.md)
</dt> <dt>

[**LockRect**](idirect3dtexture9--lockrect.md)
</dt> <dt>

[**Lock**](idirect3dvertexbuffer9--lock.md)
</dt> <dt>

[**LockBox**](idirect3dvolume9--lockbox.md)
</dt> <dt>

[**LockBox**](idirect3dvolumetexture9--lockbox.md)
</dt> <dt>
