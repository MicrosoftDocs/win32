...
title: ID3DXEffectStateManagerSetPixelShaderConstantI method
ms.date: 05/31/2018
ms.topic: article
...
-   The dynamic effect state call (such as [**IDirect3DDevice9::SetPixelShaderConstantI**](/windows/win32/d3d9helper/nf-d3d9-idirect3ddevice9-setpixelshaderconstanti?branch=master)) will fail.
