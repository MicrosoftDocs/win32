...
Describes swapchain statistics relating to [**PresentEx**](/windows/win32/d3d9/nf-d3d9-idirect3ddevice9ex-presentex?branch=master) calls.
...
Type: **[**LARGE\_INTEGER**](winprog.large_integer_str)**

</dd> <dd>

The scheduler's last sampled machine time, obtained by calling [**QueryPerformanceCounter**](winmsg.queryperformancecounter).
