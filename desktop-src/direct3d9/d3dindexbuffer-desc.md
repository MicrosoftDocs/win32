...
Member of the [**D3DRESOURCETYPE**](direct3d9.d3dresourcetype) enumerated type, identifying this resource as an index buffer.
...
Member of the [**D3DPOOL**](direct3d9.d3dpool) enumerated type, specifying the class of memory allocated for this index buffer.
