...
| LightEnable\[n\]       | bool   | **TRUE** or **FALSE**. See the bEnable argument in [**LightEnable**](/windows/win32/d3d9helper/nf-d3d9-idirect3ddevice9-lightenable?branch=master).            |
...
| LightType\[n\]         | dword  | Same value as the array of up to n [**D3DLIGHTTYPE**](direct3d9.d3dlighttype) values without the D3DLIGHT\_ prefix. |
...
<td>bool</td>
<td>True or False. Same values as D3DRS_ALPHABLENDENABLE in [<strong>D3DRENDERSTATETYPE</strong>](direct3d9.d3drenderstatetype).</td>
</tr>
<tr class="odd">
<td>AlphaFunc</td>
<td>dword</td>
<td>Same values as [<strong>D3DCMPFUNC</strong>](direct3d9.d3dcmpfunc) without the D3DCMP_ prefix. See D3DRS_ALPHAFUNC.</td>
</tr>
<tr class="even">
<td>AlphaRef</td>
<td>dword</td>
...
<td>BlendOp</td>
<td>dword</td>
<td>Same values as [<strong>D3DBLENDOP</strong>](direct3d9.d3dblendop) without the D3DBLENDOP_ prefix.</td>
</tr>
<tr class="odd">
...
<td>DestBlend</td>
<td>dword</td>
<td>Same values as [<strong>D3DBLEND</strong>](direct3d9.d3dblend) without the D3DBLEND_ prefix.</td>
</tr>
<tr class="even">
<td>DitherEnable</td>
<td>bool</td>
...
<td>FillMode</td>
<td>dword</td>
<td>Same values as [<strong>D3DFILLMODE</strong>](direct3d9.d3dfillmode) without the D3DFILL_ prefix.</td>
</tr>
<tr class="even">
<td>LastPixel</td>
<td>dword</td>
...
<td>ShadeMode</td>
<td>dword</td>
<td>Same values as [<strong>D3DSHADEMODE</strong>](direct3d9.d3dshademode) without the D3DSHADE_ prefix.</td>
</tr>
<tr class="even">
...
<td>StencilFunc</td>
<td>dword</td>
<td>Same values as [<strong>D3DCMPFUNC</strong>](direct3d9.d3dcmpfunc) without the D3DCMP_ prefix. See D3DRS_STENCILFUNC.</td>
</tr>
<tr class="odd">
<td>StencilMask</td>
<td>dword</td>
...
<td>ZEnable</td>
<td>dword</td>
<td>Same values as [<strong>D3DZBUFFERTYPE</strong>](direct3d9.d3dzbuffertype) without the D3DZB_ prefix.</td>
</tr>
<tr class="odd">
<td>ZFunc</td>
<td>dword</td>
<td>Same values as [<strong>D3DCMPFUNC</strong>](direct3d9.d3dcmpfunc) without the D3DCMP_ prefix. See D3DRS_ZFUNC.</td>
</tr>
<tr class="even">
<td>ZWriteEnable</td>
<td>bool</td>
...
| AmbientMaterialSource    | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) without the D3DMCS\_ prefix. See D3DRS\_AMBIENTMATERIALSOURCE.  |
...
| CullMode                 | dword  | Same values as [**D3DCULL**](direct3d9.d3dcull) without the D3DCULL\_ prefix.                                                                 |
| DiffuseMaterialSource    | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) without the D3DMCS\_ prefix. See D3DRS\_DIFFUSEMATERIALSOURCE.  |
| EmissiveMaterialSource   | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) without the D3DMCS\_ prefix. See D3DRS\_EMISSIVEMATERIALSOURCE. |
...
| FogTableMode             | dword  | Same values as [**D3DFOGMODE**](direct3d9.d3dfogmode). See D3DRS\_FOGTABLEMODE in [**D3DRENDERSTATETYPE**](direct3d9.d3drenderstatetype).     |
| FogVertexMode            | dword  | Same values as [**D3DFOGMODE**](direct3d9.d3dfogmode) without the D3DFOG\_ prefix.                                                            |
...
| PatchSegments            | float  | Same values as nSegments in [**SetNPatchMode**](/windows/win32/d3d9helper/nf-d3d9-idirect3ddevice9-setnpatchmode?branch=master).                                                         |
...
| SpecularMaterialSource   | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](direct3d9.d3dmaterialcolorsource) without the D3DMCS\_ prefix. See D3DRS\_SPECULARMATERIALSOURCE. |
| TweenFactor              | float  | Same values as D3DRS\_TWEENFACTOR.                                                                                                            |
| VertexBlend              | dword  | Same values as [**D3DVERTEXBLENDFLAGS**](direct3d9.d3dvertexblendflags) without the D3DVBF\_ prefix. See D3DRS\_VERTEXBLEND.                  |
...
| AddressU\[16\]      | dword                        | Same values as [**D3DTEXTUREADDRESS**](direct3d9.d3dtextureaddress) without the D3DTADDRESS\_ prefix. See D3DSAMP\_ADDRESSU.      |
| AddressV\[16\]      | dword                        | Same values as [**D3DTEXTUREADDRESS**](direct3d9.d3dtextureaddress) without the D3DTADDRESS\_ prefix. See D3DSAMP\_ADDRESSV.      |
| AddressW\[16\]      | dword                        | Same values as [**D3DTEXTUREADDRESS**](direct3d9.d3dtextureaddress) without the D3DTADDRESS\_ prefix. See D3DSAMP\_ADDRESSW.      |
| BorderColor\[16\]   | [**D3DCOLOR**](d3dcolor.md) | Same values as [**D3DTEXTUREFILTERTYPE**](direct3d9.d3dtexturefiltertype) without the D3DTEXF\_ prefix. See D3DSAMP\_BORDERCOLOR. |
| MagFilter\[16\]     | dword                        | Same values as [**D3DTEXTUREFILTERTYPE**](direct3d9.d3dtexturefiltertype) without the D3DTEXF\_ prefix. See D3DSAMP\_MAGFILTER.   |
...
| AlphaOp\[8\]               | dword | Same as [**D3DTEXTUREOP**](direct3d9.d3dtextureop) without the D3DTOP\_ prefix. See D3DTSS\_ALPHAOP.                                                      |
...
| ColorOp\[8\]               | dword | Same as [**D3DTEXTUREOP**](direct3d9.d3dtextureop) without the D3DTOP\_ prefix. See D3DTSS\_COLOROP.                                                      |
...
| TextureTransformFlags\[8\] | dword | Same values as [**D3DTEXTURETRANSFORMFLAGS**](direct3d9.d3dtexturetransformflags) values without the D3DTTFF\_ prefix. See D3DTSS\_TEXTURETRANSFORMFLAGS. |
...
| TextureTransform\[8\] | float4x4 | A 4x4 matrix of floats. Same values as [**D3DTRANSFORMSTATETYPE**](direct3d9.d3dtransformstatetype) without the D3DTS\_ prefix. |
