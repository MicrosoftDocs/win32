...
| LightEnable\[n\]       | bool   | **TRUE** or **FALSE**. See the bEnable argument in [**LightEnable**](https://msdn.microsoft.com/library/Bb174421(v=VS.85).aspx).            |
...
| LightType\[n\]         | dword  | Same value as the array of up to n [**D3DLIGHTTYPE**](https://msdn.microsoft.com/en-us/library/Bb172567(v=VS.85).aspx) values without the D3DLIGHT\_ prefix. |
...
<td>bool</td>
<td>True or False. Same values as D3DRS_ALPHABLENDENABLE in <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3drenderstatetype"><strong>D3DRENDERSTATETYPE</strong></a>.</td>
</tr>
<tr class="odd">
<td>AlphaFunc</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dcmpfunc"><strong>D3DCMPFUNC</strong></a> without the D3DCMP_ prefix. See D3DRS_ALPHAFUNC.</td>
</tr>
<tr class="even">
<td>AlphaRef</td>
<td>dword</td>
...
<td>BlendOp</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dblendop"><strong>D3DBLENDOP</strong></a> without the D3DBLENDOP_ prefix.</td>
</tr>
<tr class="odd">
...
<td>DestBlend</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dblend"><strong>D3DBLEND</strong></a> without the D3DBLEND_ prefix.</td>
</tr>
<tr class="even">
<td>DitherEnable</td>
<td>bool</td>
...
<td>FillMode</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dfillmode"><strong>D3DFILLMODE</strong></a> without the D3DFILL_ prefix.</td>
</tr>
<tr class="even">
<td>LastPixel</td>
<td>dword</td>
...
<td>ShadeMode</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dshademode"><strong>D3DSHADEMODE</strong></a> without the D3DSHADE_ prefix.</td>
</tr>
<tr class="even">
...
<td>StencilFunc</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dcmpfunc"><strong>D3DCMPFUNC</strong></a> without the D3DCMP_ prefix. See D3DRS_STENCILFUNC.</td>
</tr>
<tr class="odd">
<td>StencilMask</td>
<td>dword</td>
...
<td>ZEnable</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dzbuffertype"><strong>D3DZBUFFERTYPE</strong></a> without the D3DZB_ prefix.</td>
</tr>
<tr class="odd">
<td>ZFunc</td>
<td>dword</td>
<td>Same values as <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dcmpfunc"><strong>D3DCMPFUNC</strong></a> without the D3DCMP_ prefix. See D3DRS_ZFUNC.</td>
</tr>
<tr class="even">
<td>ZWriteEnable</td>
<td>bool</td>
...
| AmbientMaterialSource    | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](https://msdn.microsoft.com/en-us/library/Bb172572(v=VS.85).aspx) without the D3DMCS\_ prefix. See D3DRS\_AMBIENTMATERIALSOURCE.  |
...
| CullMode                 | dword  | Same values as [**D3DCULL**](https://msdn.microsoft.com/en-us/library/Bb172529(v=VS.85).aspx) without the D3DCULL\_ prefix.                                                                 |
| DiffuseMaterialSource    | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](https://msdn.microsoft.com/en-us/library/Bb172572(v=VS.85).aspx) without the D3DMCS\_ prefix. See D3DRS\_DIFFUSEMATERIALSOURCE.  |
| EmissiveMaterialSource   | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](https://msdn.microsoft.com/en-us/library/Bb172572(v=VS.85).aspx) without the D3DMCS\_ prefix. See D3DRS\_EMISSIVEMATERIALSOURCE. |
...
| FogTableMode             | dword  | Same values as [**D3DFOGMODE**](https://msdn.microsoft.com/en-us/library/Bb172557(v=VS.85).aspx). See D3DRS\_FOGTABLEMODE in [**D3DRENDERSTATETYPE**](https://msdn.microsoft.com/en-us/library/Bb172599(v=VS.85).aspx).     |
| FogVertexMode            | dword  | Same values as [**D3DFOGMODE**](https://msdn.microsoft.com/en-us/library/Bb172557(v=VS.85).aspx) without the D3DFOG\_ prefix.                                                            |
...
| PatchSegments            | float  | Same values as nSegments in [**SetNPatchMode**](https://msdn.microsoft.com/library/Bb174438(v=VS.85).aspx).                                                         |
...
| SpecularMaterialSource   | dword  | Same values as [**D3DMATERIALCOLORSOURCE**](https://msdn.microsoft.com/en-us/library/Bb172572(v=VS.85).aspx) without the D3DMCS\_ prefix. See D3DRS\_SPECULARMATERIALSOURCE. |
| TweenFactor              | float  | Same values as D3DRS\_TWEENFACTOR.                                                                                                            |
| VertexBlend              | dword  | Same values as [**D3DVERTEXBLENDFLAGS**](https://msdn.microsoft.com/en-us/library/Bb172628(v=VS.85).aspx) without the D3DVBF\_ prefix. See D3DRS\_VERTEXBLEND.                  |
...
| AddressU\[16\]      | dword                        | Same values as [**D3DTEXTUREADDRESS**](https://msdn.microsoft.com/en-us/library/Bb172614(v=VS.85).aspx) without the D3DTADDRESS\_ prefix. See D3DSAMP\_ADDRESSU.      |
| AddressV\[16\]      | dword                        | Same values as [**D3DTEXTUREADDRESS**](https://msdn.microsoft.com/en-us/library/Bb172614(v=VS.85).aspx) without the D3DTADDRESS\_ prefix. See D3DSAMP\_ADDRESSV.      |
| AddressW\[16\]      | dword                        | Same values as [**D3DTEXTUREADDRESS**](https://msdn.microsoft.com/en-us/library/Bb172614(v=VS.85).aspx) without the D3DTADDRESS\_ prefix. See D3DSAMP\_ADDRESSW.      |
| BorderColor\[16\]   | [**D3DCOLOR**](d3dcolor.md) | Same values as [**D3DTEXTUREFILTERTYPE**](https://msdn.microsoft.com/en-us/library/Bb172615(v=VS.85).aspx) without the D3DTEXF\_ prefix. See D3DSAMP\_BORDERCOLOR. |
| MagFilter\[16\]     | dword                        | Same values as [**D3DTEXTUREFILTERTYPE**](https://msdn.microsoft.com/en-us/library/Bb172615(v=VS.85).aspx) without the D3DTEXF\_ prefix. See D3DSAMP\_MAGFILTER.   |
...
| AlphaOp\[8\]               | dword | Same as [**D3DTEXTUREOP**](https://msdn.microsoft.com/en-us/library/Bb172616(v=VS.85).aspx) without the D3DTOP\_ prefix. See D3DTSS\_ALPHAOP.                                                      |
...
| ColorOp\[8\]               | dword | Same as [**D3DTEXTUREOP**](https://msdn.microsoft.com/en-us/library/Bb172616(v=VS.85).aspx) without the D3DTOP\_ prefix. See D3DTSS\_COLOROP.                                                      |
...
| TextureTransformFlags\[8\] | dword | Same values as [**D3DTEXTURETRANSFORMFLAGS**](https://msdn.microsoft.com/en-us/library/Bb172618(v=VS.85).aspx) values without the D3DTTFF\_ prefix. See D3DTSS\_TEXTURETRANSFORMFLAGS. |
...
| TextureTransform\[8\] | float4x4 | A 4x4 matrix of floats. Same values as [**D3DTRANSFORMSTATETYPE**](https://msdn.microsoft.com/en-us/library/Bb172619(v=VS.85).aspx) without the D3DTS\_ prefix. |
