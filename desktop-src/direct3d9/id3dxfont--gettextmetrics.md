...
Retrieves font characteristics that are identified in a [**TEXTMETRIC**](gdi.textmetric) structure. This method supports ANSI and Unicode compiler settings.
...
Type: **[**TEXTMETRIC**](gdi.textmetric)\***

Pointer to a [**TEXTMETRIC**](gdi.textmetric) structure, which contains font properties.
