...
| Type ([**D3DRENDERSTATETYPE**](direct3d9.d3drenderstatetype)) | Value                                                                                                             |
|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
...
| Stage Identifier | Type ([**D3DTEXTURESTAGESTATETYPE**](direct3d9.d3dtexturestagestatetype)) | Value            |
|------------------|---------------------------------------------------------------------------|------------------|
...
| Sampler Stage Index | Type ([**D3DSAMPLERSTATETYPE**](direct3d9.d3dsamplerstatetype)) | Value                                                                                                          |
|---------------------|-----------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
