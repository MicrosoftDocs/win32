...
For more information about the differences between shader versions, see [Vertex Shader Differences](direct3dhlsl.dx9_graphics_reference_asm_vs_differences).
