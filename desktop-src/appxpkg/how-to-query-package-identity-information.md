...
description: Learn how to get info from the app package manifest for a packaged Windows app using the packaging API.
...
Learn how to get info from the app package manifest for a packaged Windows app using the [packaging API](interfaces.md).
