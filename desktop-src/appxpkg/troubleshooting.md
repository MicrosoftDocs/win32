...
<td>0x80073CFA</td>
<td>Package removal failed.<br/> You may get this error for failures that occur during package uninstall.<br/> For more info, see [<strong>RemovePackageAsync</strong>](https://msdn.microsoft.com/library/windows/apps/dn278489).<br/></td>
</tr>
<tr class="odd">
...
<td>0x80073D05</td>
<td>An error occurred while deleting the package's previously existing application data.<br/> You can get this error if the [simulator](81b69bf8-ec87-4bb6-9ad4-1fa7b7802d16) is running. Close the simulator. You can also get this error if there are files open in the app data (for example, if you have a log file open in a text editor).<br/></td>
</tr>
<tr class="even">
...
<td>0x800B0109</td>
<td>A certificate chain processed, but terminated in a root certificate which isn't trusted by the trust provider.<br/> See [Signing a package](2e783ec5-7803-4aa3-bd70-a4db567fc3d3).<br/></td>
</tr>
<tr class="even">
<td><strong>CERT_E_CHAINING</strong></td>
<td>0x800B010A</td>
<td>A certificate chain couldn't be built to a trusted root certification authority.<br/> See [Signing a package](2e783ec5-7803-4aa3-bd70-a4db567fc3d3).<br/></td>
</tr>
<tr class="odd">
<td><strong>APPX_E_INVALID_</strong> <br/> <strong>SIP_CLIENT_DATA</strong> <br/></td>
<td>0x80080209</td>
<td>The [<strong>SIP_SUBJECTINFO</strong>](https://msdn.microsoft.com/library/windows/desktop/bb736434)structure used to sign the package didn't contain the required data<br/></td>
</tr>
<tr class="even">
