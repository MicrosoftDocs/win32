...
| <strong>ERROR_INSTALL_DRIVE_</strong><br /><strong>NOT_FOUND</strong><br /> | 0x80073D3F | The drive referenced during package deployment couldn't be found. If you previously set apps to install on an external or secondary drive, make sure it's connected and accessible. You can change the default install location in <strong>Settings</strong> &gt; <strong>System</strong> &gt; <strong>Storage</strong> &gt; <strong>Change where new content is saved</strong>.<br /> | 
