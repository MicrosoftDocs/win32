...
description: Use these APIs to create, deploy, and query app packages for UWP apps.
...
Use these APIs in your desktop apps to create, consume, deploy, or query app packages for UWP apps:
