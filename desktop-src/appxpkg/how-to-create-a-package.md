...
description: Learn how to create an app package for a UWP app using the packaging API.
...
Learn how to create an app package for a UWP app using the [packaging API](interfaces.md).
