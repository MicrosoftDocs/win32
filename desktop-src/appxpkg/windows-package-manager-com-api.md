...
# Windows Package Manager COM API

Applies to Windows 10, and implemented in the mobile device family. For more information about Windows Package Manager, please work with your Microsoft Account Team representative.
...
The API consists of the following coclass.

-   PMSvc. CLSID: {B9E511FC-E364-497A-A1-21-B7-B3-61-2C-ED-CE}

PMSvc implements the following interfaces.
