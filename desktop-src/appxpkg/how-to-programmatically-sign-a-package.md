...
-   Windows 8 introduces the [**SignerSignEx2**](https://docs.microsoft.com/windows/desktop/SecCrypto/signersignex2) function. Use **SignerSignEx2** when you sign Windows Store app packages.
