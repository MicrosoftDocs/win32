...
| **PACKAGE_FILTER_ALL_LOADED**<br>0x00000000<br> | Process all packages in the dependency graph.<br> This is equivalent to **PACKAGE_FILTER_HEAD**, **PACKAGE_FILTER_DIRECT**.<br>**Note**<br>**PACKAGE_FILTER_ALL_LOADED** may be altered or unavailable for releases after Windows 8.1. Instead, use **PACKAGE_FILTER_HEAD**, **PACKAGE_FILTER_DIRECT**.<br> | 
