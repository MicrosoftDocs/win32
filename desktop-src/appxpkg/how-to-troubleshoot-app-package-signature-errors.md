...
If the 465 error didn't occur, see general [Troubleshooting packaging, deployment, and query of packaged Windows apps](troubleshooting.md). Otherwise, refer to this table for common error codes that can show up in the error string for error event 465:
...
| 0x800B0100 | TRUST\_E\_NOSIGNATURE                 | The app package is unsigned.                                                                                         | Only signed packaged Windows app packages can be deployed. For info about signing an app package, see [How to sign an app package using SignTool](how-to-sign-a-package-using-signtool.md).                  |
...
[Troubleshooting packaging, deployment, and query of packaged Windows apps](troubleshooting.md)
</dt> <dt>
