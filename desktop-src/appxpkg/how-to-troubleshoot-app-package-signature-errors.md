...
|------------|---------------------------------------|----------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0x80073CF0 | ERROR\_INSTALL\_OPEN\_PACKAGE\_FAILED | The app package could not be opened.                                                                                 | This error typically indicates a problem with the package. You need to build and sign the package again. For more info, see [Using App Packager](https://www.bing.com/search?q=Using App Packager). |
| 0x80080205 | APPX\_E\_INVALID\_BLOCKMAP            | The app package has been tampered with or has an invalid block map.                                                  | The package is corrupted. You need to build and sign the package again. For more info, see [Using App Packager](https://www.bing.com/search?q=Using App Packager).                                  |
