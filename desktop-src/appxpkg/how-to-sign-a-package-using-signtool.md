...
<td>The app package is corrupt and needs to be rebuilt to generate a new block map. For more info about creating an app package, see creating an app package with [app packager](make-appx-package--makeappx-exe-.md) or [Creating an app package with Visual Studio 2012](7a045d20-86ae-49a6-abb2-f264bf179cd6).</td>
</tr>
</tbody>
</table>
...
[Signing a package in Visual Studio 2012](2e783ec5-7803-4aa3-bd70-a4db567fc3d3)
</dt> <dt>
