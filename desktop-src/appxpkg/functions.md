...
description: Learn about the package query API, which you can use to get info about the app packages installed on the system. Each app package contains the files that constitute a packaged Windows app, and a manifest file that describes the software to Windows.
...
Learn about the package query API, which you can use to get info about the app packages installed on the system. Each app package contains the files that constitute a packaged Windows app, and a manifest file that describes the software to Windows.
