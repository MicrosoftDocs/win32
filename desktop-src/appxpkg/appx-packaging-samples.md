...
description: These samples demonstrate the packaging, deployment, and query APIs for packaged Windows apps.
...
These samples demonstrate the packaging, deployment, and query APIs for packaged Windows apps.
...
The following is a sample packaged Windows app that uses the Windows Runtime query API:
