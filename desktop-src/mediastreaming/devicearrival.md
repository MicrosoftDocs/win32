...
To handle notifications from this event, register a [**DeviceControllerFinderHandler**](/windows/win32/mfidl/?branch=master) event handler function using the [**add\_DeviceArrival**](idevicecontroller-add-devicearrival.md) method. To unregister the event handler, use the [**remove\_DeviceArrival**](idevicecontroller-remove-devicearrival.md) method.
