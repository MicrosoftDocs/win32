...
keywords: ["Type property Media Streaming API", "Type property Media Streaming API , BasicDevice interface", "BasicDevice interface Media Streaming API , Type property"]
topic_type:
- apiref
api_name:
- BasicDevice.Type
