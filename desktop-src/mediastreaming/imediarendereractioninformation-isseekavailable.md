...
Retrieves a value that indicates whether the DMR is currently accepting the [**SeekAsync**](imediarenderer-seekasync.md) method.
...
A boolean value that is **True** if the DMR is currently accepting the [**SeekAsync**](imediarenderer-seekasync.md) method and **False** if it is not.
