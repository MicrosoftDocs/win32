...
| [**ConnectionStatus**](https://www.bing.com/search?q=**ConnectionStatus**)                              | Returns an enumeration value indicating whether the device is currently on-line, off-line or sleeping but wakeable.<br/> |
...
| [**Icons**](ibasicdevice-icons.md)                                                    | Returns a vector of [**IDeviceIcon**](https://www.bing.com/search?q=**IDeviceIcon**) interfaces.<br/>                                                  |
