...
keywords: ["IsPlayAvailable method Media Streaming API", "IsPlayAvailable method Media Streaming API , IMediaRendererActionInformation interface", "IMediaRendererActionInformation interface Media Streaming API , IsPlayAvailable method"]
topic_type:
- apiref
api_name:
