...
keywords: ["IsVideoSupported property Media Streaming API", "IsVideoSupported property Media Streaming API , ActiveBasicDevice interface", "ActiveBasicDevice interface Media Streaming API , IsVideoSupported property"]
topic_type:
- apiref
api_name:
