...
| Topic                                                                                   | Description                                                                                                                                                                                                                                                                                                                                                                         |
|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ActiveBasicDevice**](activebasicdevice.md)<br/>                               | Implements the [**IActiveBasicDevice**](iactivebasicdevice.md) interface that represents an active Digital Living Network Alliance (DLNA) device.<br/>                                                                                                                                                                                                                       |
...
| [**DevicePair**](devicepair.md)<br/>                                             | Implements the [**IDevicePair**](idevicepair.md) interface that represents a pair of [**ActiveBasicDevice**](activebasicdevice.md) objects which is comprised of a renderer and a server.<br/>                                                                                                                                                                              |
