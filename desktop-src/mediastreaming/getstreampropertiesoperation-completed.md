...
Gets or sets an event handler that is invoked when the asynchronous operation started by [**GetStreamPropertiesAsync**](streamselector-getstreampropertiesasync.md) is completed.
