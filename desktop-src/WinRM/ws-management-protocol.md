...
The WS-Management protocol provides a standard for constructing XML [*messages*](https://www.bing.com/search?q=*messages*) using various web service standards such as [*WS-Addressing*](https://www.bing.com/search?q=*WS-Addressing*) and [*WS-Transfer*](https://www.bing.com/search?q=*WS-Transfer*). These standards define XML schemas for web service messages. The messages refer to a [*resource*](https://www.bing.com/search?q=*resource*) using a [*resource URI*](https://www.bing.com/search?q=*resource URI*). The WS-Management protocol adds a set of definitions for management operations and values. For example, WS-Transfer defines the Get, Put, Create, and Delete operations for a resource. WS-Management protocol adds Rename, Partial Get, and Partial Put.

The messages follow the conventions of [*Simple Object Access Protocol (SOAP)*](https://www.bing.com/search?q=*Simple Object Access Protocol (SOAP)*) which is used by all web service protocols.
