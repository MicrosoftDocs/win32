...
While [*Windows Management Instrumentation (WMI)*](https://www.bing.com/search?q=*Windows Management Instrumentation (WMI)*) is the primary source of management data for Windows-based operating systems, other sources of management schema also exist.
...
-   WinRM configuration URIs
    ...
    This group of URIs are configuration operations for the WinRM[*listener*](https://www.bing.com/search?q=*listener*) configuration.
...
-   [*System Event Log*](https://www.bing.com/search?q=*System Event Log*) (SEL) URIs
