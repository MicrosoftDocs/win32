---
title: IWSManEnumerator Properties
...
# IWSManEnumerator Properties

The [**IWSManEnumerator**](/windows/desktop/api/WSManDisp/nn-wsmandisp-iwsmanenumerator) interface exposes the following properties.
