...
The [*resource URI*](https://www.bing.com/search?q=*resource URI*) prefix is different depending on which XML schema describes the resource.

## Prefixes

If you access a [*CIM*](https://www.bing.com/search?q=*CIM*) 2.1 class, such as [**CIM\_DataFile**](https://msdn.microsoft.com/library/aa387236), the prefix of the URI differs from the prefix for a CIM 2.9 class, such as **CIM\_AdminDomain**. CIM 2.1 classes are documented in the [CIM Classes](https://msdn.microsoft.com/library/aa386179) section of Windows Management Instrumentation (WMI).
