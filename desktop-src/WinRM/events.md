...
You can create subscriptions by using the Wecutil.exe command-line tool. For more information about how to use this tool, at a command prompt type **wecutil /?**. For more information about the Event Collector service, see [Windows Event Collector](https://msdn.microsoft.com/library/bb427443).
