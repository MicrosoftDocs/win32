...
##### [WSMAN_SHELL_COMPLETION_FUNCTION](https://msdn.microsoft.com/en-us/library/Dd891185(v=VS.85).aspx)
...
##### [WSMAN_PLUGIN_AUTHORIZE_OPERATION](https://msdn.microsoft.com/en-us/library/Dd891165(v=VS.85).aspx)
##### [WSMAN_PLUGIN_AUTHORIZE_QUERY_QUOTA](https://msdn.microsoft.com/en-us/library/Dd891166(v=VS.85).aspx)
##### [WSMAN_PLUGIN_AUTHORIZE_RELEASE_CONTEXT](https://msdn.microsoft.com/en-us/library/Dd891167(v=VS.85).aspx)
##### [WSMAN_PLUGIN_AUTHORIZE_USER](https://msdn.microsoft.com/en-us/library/Dd891168(v=VS.85).aspx)
...
##### [WSMAN_PLUGIN_SIGNAL](https://msdn.microsoft.com/en-us/library/Dd891177(v=VS.85).aspx)
