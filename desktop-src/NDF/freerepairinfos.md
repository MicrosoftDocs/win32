...
keywords: ["FreeRepairInfos function NDF"]
topic_type:
- apiref
api_name:
- FreeRepairInfos
...
The **FreeRepairInfos** function deallocates the memory allocated internally to an array of [**RepairInfo**](repairinfo.md) structures. This function calls [**CoTaskMemFree**](https://msdn.microsoft.com/library/windows/desktop/ms680722) to deallocate memory.
