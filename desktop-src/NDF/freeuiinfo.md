...
keywords: ["FreeUiInfo function NDF"]
topic_type:
- apiref
api_name:
- FreeUiInfo
...
The **FreeUiInfo** function deallocates the memory allocated internally to a [**UiInfo**](uiinfo.md) structure. This function calls [**CoTaskMemFree**](https://msdn.microsoft.com/library/windows/desktop/ms680722) to deallocate memory.
