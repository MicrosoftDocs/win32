...
keywords: ["FreeRepairInfoExs function NDF"]
topic_type:
- apiref
api_name:
- FreeRepairInfoExs
...
The **FreeRepairInfoExs** function deallocates the memory allocated internally to an array of [**RepairInfoEx**](repairinfoex.md) structures. This function calls [**CoTaskMemFree**](https://msdn.microsoft.com/library/windows/desktop/ms680722) to deallocate memory.
...
Type: **[**RepairInfoEx**](repairinfoex.md)\***
