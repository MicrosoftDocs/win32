...
keywords: ["QueryCount property Indexing Service", "QueryCount property Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , QueryCount property"]
topic_type:
- apiref
api_name:
- ICatAdm.QueryCount
