...
keywords: ["CatalogName property Indexing Service", "CatalogName property Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , CatalogName property"]
topic_type:
- apiref
api_name:
- ICatAdm.CatalogName
