...
keywords: ["CiScope property Indexing Service", "CiScope property Indexing Service , IixssoQuery interface", "IixssoQuery interface Indexing Service , CiScope property"]
topic_type:
- apiref
api_name:
- IixssoQuery.CiScope
