...
| *PropertyVarType* | Data type of the cached property. For a list of the correspondence between numeric and symbolic variant types, see the [**PROPVARIANT structure.**](https://www.bing.com/search?q=**PROPVARIANT structure.**)                                                                                           |
