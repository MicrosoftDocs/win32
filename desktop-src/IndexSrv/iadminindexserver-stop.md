...
Any failure encountered when trying to stop Indexing Service results in the creation of an error object. A call to this method does not return until the Indexing Service has finished shutting down.
