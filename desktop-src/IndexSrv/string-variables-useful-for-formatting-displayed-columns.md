...
The variables in the following table, like those in the table in [Variables in Forms and in .Idq Files](variables-in-forms-and-in-idq-files.md), can be set in the .idq file. They cannot be referred to in the .htx file and can format only those columns whose type is vector or safe array.
