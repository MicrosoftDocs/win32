...
keywords: ["PersistentIndexCount property Indexing Service", "PersistentIndexCount property Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , PersistentIndexCount property"]
topic_type:
- apiref
api_name:
- ICatAdm.PersistentIndexCount
- ICatAdm.get_PersistentIndexCount
api_location:
- Ciodm.dll
api_type:
- COM
