...
keywords:
- PersistentIndexCount property Indexing Service
- PersistentIndexCount property Indexing Service , ICatAdm interface
- ICatAdm interface Indexing Service , PersistentIndexCount property
topic_type:
- apiref
api_name:
