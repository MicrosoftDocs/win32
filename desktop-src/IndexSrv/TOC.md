...
#### [CIState](/windows/win32/content/Ntquery/nf-ntquery-cistate?branch=dev)
...
#### [IPhraseSink](/windows/win32/content/Indexsrv/nn-indexsrv-iphrasesink?branch=dev)
##### [PutPhrase Method](/windows/win32/content/Indexsrv/nf-indexsrv-iphrasesink-putphrase?branch=dev)
...
#### [IStemmer](/windows/win32/content/Indexsrv/nn-indexsrv-istemmer?branch=dev)
##### [GenerateWordForms Method](/windows/win32/content/Indexsrv/nf-indexsrv-istemmer-generatewordforms?branch=dev)
...
##### [DBCOMMANDOPENUM](/windows/win32/content/cmdtree/ne-cmdtree-dbcommandopenum?branch=dev)
##### [DBCOMMANDREUSEENUM](/windows/win32/content/cmdtree/ne-cmdtree-dbcommandreuseenum?branch=dev)
##### [DBKINDENUM](dbkindenum.md)
##### [DBVALUEKINDENUM](/windows/win32/content/cmdtree/ne-cmdtree-dbvaluekindenum?branch=dev)
#### [Error Messages](error-messages.md)
#### [Interfaces](interfaces-oledb.md)
##### [ICommandTree](/windows/win32/content/cmdtree/nn-cmdtree-icommandtree?branch=dev)
###### [FindErrorNodes](/windows/win32/content/cmdtree/nf-cmdtree-icommandtree-finderrornodes?branch=dev)
###### [FreeCommandTree](/windows/win32/content/cmdtree/nf-cmdtree-icommandtree-freecommandtree?branch=dev)
###### [GetCommandTree](/windows/win32/content/cmdtree/nf-cmdtree-icommandtree-getcommandtree?branch=dev)
###### [SetCommandTree](/windows/win32/content/cmdtree/nf-cmdtree-icommandtree-setcommandtree?branch=dev)
##### [IQuery](/windows/win32/content/cmdtree/nn-cmdtree-iquery?branch=dev)
