...
| Indexing (Filtering) | Includes developing [IFilter](ifilter.md) implementations for custom file types and selecting features of standard filter implementations. Also includes [IWordBreaker](iwordbreaker.md) implementations that allow Indexing Service to incorporate documents in their native languages and locales into the index. |
