...
| [IFilter](ifilter.md)<br/>                  | [Init](ifilter-init.md)<br/> [GetChunk](ifilter-getchunk.md)<br/> [GetText](ifilter-gettext.md)<br/> [GetValue](ifilter-getvalue.md)<br/> [BindRegion](ifilter-bindregion.md)<br/>                                              |
