...
-   [Persistent Handlers](persistent-handlers.md). A brief description of how you bind to an [**IFilter**](/windows/desktop/api/Filter/nn-filter-ifilter) implementation to call its methods and properties.
