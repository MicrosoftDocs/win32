...
The IFiltTst.exe program runs several tests to validate an [**IFilter**](ifilter.md) interface implementation. You invoke IFiltTst from the command line as follows:
