...
keywords: ["AddScopeToQuery method Indexing Service", "AddScopeToQuery method Indexing Service , IixssoUtil interface", "IixssoUtil interface Indexing Service , AddScopeToQuery method"]
topic_type:
- apiref
api_name:
- IixssoUtil.AddScopeToQuery
api_location:
- Ixsso.dll
api_type:
- COM
