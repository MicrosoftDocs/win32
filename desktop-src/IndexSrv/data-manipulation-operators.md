...
The following topics describe the semantics of the data manipulation operators, including their inputs and outputs:

-   [Constants, Identifiers, Names, and Parameters](constants--identifiers--names--and-parameters.md)
-   [Constructors and Coercion perators](constructors-and-coercion-operators.md)
