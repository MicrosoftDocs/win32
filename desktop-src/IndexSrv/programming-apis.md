...
| <span id="_idxs_activex_data_objects_api"></span><span id="_IDXS_ACTIVEX_DATA_OBJECTS_API"></span>Microsoft ActiveX Data Objects (ADO) | An intermediate-level API for querying Indexing Service. It provides an [automation layer](dasdkadooverview) between the OLE DB Provider and automation languages for accessing Indexing Service data.                                                                                                                                                                                             |
