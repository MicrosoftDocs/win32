...
keywords:
- IsRunning method Indexing Service
- IsRunning method Indexing Service , IAdminIndexServer interface
- IAdminIndexServer interface Indexing Service , IsRunning method
topic_type:
- apiref
api_name:
