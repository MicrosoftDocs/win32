...
keywords: ["ForceMasterMerge method Indexing Service", "ForceMasterMerge method Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , ForceMasterMerge method"]
topic_type:
- apiref
api_name:
- ICatAdm.ForceMasterMerge
api_location:
- Ciodm.dll
api_type:
- COM
