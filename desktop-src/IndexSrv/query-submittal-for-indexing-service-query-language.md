...
| [OLE DB Helper](programming-apis.md#-idxs-ole-db-helper-api)       | Specifying a value from the [ISQLANG\_\* constants](isqlang-constants.md) for the *ulDialect* parameter of a [**CITextToFullTreeEx**](/windows/desktop/api/Ntquery/nf-ntquery-citexttofulltreeex) or [**CITextToSelectTreeEx**](/windows/desktop/api/Ntquery/nf-ntquery-citexttoselecttreeex) function call that constructs a query. |
