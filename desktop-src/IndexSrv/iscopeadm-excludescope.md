...
keywords: ["ExcludeScope property Indexing Service", "ExcludeScope property Indexing Service , IScopeAdm interface", "IScopeAdm interface Indexing Service , ExcludeScope property"]
topic_type:
- apiref
api_name:
