...
This section describes the construction of filters for Indexing Service. The following topics discuss the significant aspects of realizing the required dynamic-link library (DLL) structure for an [IFilter](/windows/desktop/api/Filter/nn-filter-ifilter) interface implementation.
