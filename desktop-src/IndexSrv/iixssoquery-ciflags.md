...
keywords: ["CiFlags property Indexing Service", "CiFlags property Indexing Service , IixssoQuery interface", "IixssoQuery interface Indexing Service , CiFlags property"]
topic_type:
- apiref
api_name:
- IixssoQuery.CiFlags
