...
Indexing Service uses the [**IFilter**](/windows/desktop/api/Filter/nn-filter-ifilter) interface to scan documents for text and property information. This section includes the following topics:
