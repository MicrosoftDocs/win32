...
Indexing Service uses the [**IFilter**](/windows/win32/Filter/nn-filter-ifilter?branch=master) interface to scan documents for text and property information. This section includes the following topics:
