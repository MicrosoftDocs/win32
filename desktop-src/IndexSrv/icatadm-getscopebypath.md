...
keywords: ["GetScopeByPath method Indexing Service", "GetScopeByPath method Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , GetScopeByPath method"]
topic_type:
- apiref
api_name:
