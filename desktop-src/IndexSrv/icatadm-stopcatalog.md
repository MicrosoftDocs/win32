...
keywords: ["StopCatalog method Indexing Service", "StopCatalog method Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , StopCatalog method"]
topic_type:
- apiref
api_name:
- ICatAdm.StopCatalog
