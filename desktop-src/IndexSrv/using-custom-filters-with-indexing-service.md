...
This section describes the use of the [**IFilter**](ifilter.md) interface to produce custom filters for other specific file formats. It contains the following sections:
...
For an overview of how the [**IFilter**](ifilter.md) interface regards documents and their properties, see [Properties of Documents](properties-of-documents.md). In particular, for a synopsis and example of how the **IFilter** interface processes a document, see [Property Filtering](property-filtering.md).
