...
This section describes the use of the [**IFilter**](/windows/desktop/api/Filter/nn-filter-ifilter) interface to produce custom filters for other specific file formats. It contains the following sections:
