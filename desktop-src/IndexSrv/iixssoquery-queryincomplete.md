---
title: IixssoQuery QueryIncomplete property
description: Warns when the Indexing Service could not resolve the query because of a very complicated regular expression query, or some prefix query that matched too many terms in an index.
ms.assetid: '0915250f-6e15-49b8-982c-e7ac88764dce'
keywords: ["QueryIncomplete property Indexing Service", "QueryIncomplete property Indexing Service , IixssoQuery interface", "IixssoQuery interface Indexing Service , QueryIncomplete property"]
topic_type:
- apiref
api_name:
- IixssoQuery.QueryIncomplete
- IixssoQuery.get_QueryIncomplete
api_location:
- Ixsso.dll
api_type:
- COM
