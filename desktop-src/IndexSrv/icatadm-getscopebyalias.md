...
keywords: ["GetScopeByAlias method Indexing Service", "GetScopeByAlias method Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , GetScopeByAlias method"]
topic_type:
- apiref
api_name:
