...
keywords: ["IndexSize property Indexing Service", "IndexSize property Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , IndexSize property"]
topic_type:
- apiref
api_name:
- ICatAdm.IndexSize
