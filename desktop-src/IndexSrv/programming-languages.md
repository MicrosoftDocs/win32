...
| IDA+HTX, IDQ+HTX                                    | Used with Hypertext Markup Language (HTML), the [Internet Data Administration](writing-internet-data-administration-scripts.md) (IDA) and Internet Data Query (IDQ) files specify administrative tasks and query tasks, respectively. [HTML extension](html-extension-files.md) (HTX) files format the results. |
