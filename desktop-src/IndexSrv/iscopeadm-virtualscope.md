...
keywords: ["VirtualScope property Indexing Service", "VirtualScope property Indexing Service , IScopeAdm interface", "IScopeAdm interface Indexing Service , VirtualScope property"]
topic_type:
- apiref
api_name:
