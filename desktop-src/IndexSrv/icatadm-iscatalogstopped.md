...
keywords: ["IsCatalogStopped method Indexing Service", "IsCatalogStopped method Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , IsCatalogStopped method"]
topic_type:
- apiref
api_name:
