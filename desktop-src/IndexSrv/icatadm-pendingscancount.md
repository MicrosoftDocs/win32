...
keywords: ["PendingScanCount property Indexing Service", "PendingScanCount property Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , PendingScanCount property"]
topic_type:
- apiref
api_name:
