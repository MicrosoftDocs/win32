...
keywords:
- UniqueKeyCount property Indexing Service
- UniqueKeyCount property Indexing Service , ICatAdm interface
- ICatAdm interface Indexing Service , UniqueKeyCount property
topic_type:
- apiref
api_name:
