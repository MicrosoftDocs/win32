...
The following samples are examples of managing Indexing Service. The table gives the name of the sample and the tool, language, and API that the sample illustrates. Selecting the name of a sample takes you to a detailed reference for that sample.
