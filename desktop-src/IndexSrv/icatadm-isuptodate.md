...
keywords: ["IsUpToDate property Indexing Service", "IsUpToDate property Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , IsUpToDate property"]
topic_type:
- apiref
api_name:
- ICatAdm.IsUpToDate
