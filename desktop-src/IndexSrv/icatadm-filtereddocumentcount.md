...
keywords: ["FilteredDocumentCount property Indexing Service", "FilteredDocumentCount property Indexing Service , ICatAdm interface", "ICatAdm interface Indexing Service , FilteredDocumentCount property"]
topic_type:
- apiref
api_name:
