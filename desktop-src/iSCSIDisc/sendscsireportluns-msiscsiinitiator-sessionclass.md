...
The [**SendScsiReportLuns**](/previous-versions/windows/desktop/api/Iscsidsc/nf-iscsidsc-sendscsireportluns) method sends the Report LUN command to the target associated with the specified session.
