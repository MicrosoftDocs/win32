...
This [**MSIscsiInitiator\_TargetAddress**](iscsidisc.msisciinitiator_targetaddress) structure describes the characteristics of the SCSI address mapped to a target by the operation system.
