...
The name of the initiator instance that the iSCSI initiator service uses to send [SendTargets](https://www.bing.com/search?q=SendTargets) requests to the target portal. If no instance name is specified, the iSCSI initiator service chooses the initiator instance.
