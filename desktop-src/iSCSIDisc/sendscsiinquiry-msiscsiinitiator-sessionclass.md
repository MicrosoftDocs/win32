...
The [**SendScsiInquiry**](/previous-versions/windows/desktop/api/Iscsidsc/nf-iscsidsc-sendscsiinquiry) method sends SCSI inquiry command to the specified Logical Unit Number (LUN).
