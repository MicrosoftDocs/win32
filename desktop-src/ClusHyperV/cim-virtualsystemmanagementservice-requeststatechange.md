---
title: RequestStateChange method of the CIM\_VirtualSystemManagementService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '6872b53b-e35a-40c6-ab4c-d7b88608a479'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_VirtualSystemManagementService class", "CIM_VirtualSystemManagementService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_VirtualSystemManagementService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_VirtualSystemManagementService class
