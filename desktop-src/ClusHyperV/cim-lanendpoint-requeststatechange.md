...
ms.assetid: '0e104dfa-e044-4aef-b437-4c8a8d2f31e8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_LANEndpoint class", "CIM_LANEndpoint class, RequestStateChange method"]
topic_type:
- apiref
api_name:
