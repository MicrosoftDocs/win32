---
title: SetPowerState method of the CIM\_ProtocolController class
...
ms.assetid: '224869b7-3f9b-4439-b1b4-5b2c06adf264'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_ProtocolController class", "CIM_ProtocolController class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_ProtocolController.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_ProtocolController class
