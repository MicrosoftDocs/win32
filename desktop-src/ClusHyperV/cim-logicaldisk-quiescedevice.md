---
title: QuiesceDevice method of the CIM\_LogicalDisk class
...
ms.assetid: '9e24647b-4770-4fe3-bc27-0640c6566496'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_LogicalDisk class", "CIM_LogicalDisk class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_LogicalDisk.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_LogicalDisk class
