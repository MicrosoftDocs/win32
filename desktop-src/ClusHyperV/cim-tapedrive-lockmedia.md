---
title: LockMedia method of the CIM\_TapeDrive class
description: Represents a device that can use media to store and retrieve data.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '2f541807-83d9-4009-9b1e-ccc760144857'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["LockMedia method", "LockMedia method, CIM_TapeDrive class", "CIM_TapeDrive class, LockMedia method"]
topic_type:
- apiref
api_name:
- CIM_TapeDrive.LockMedia
api_location:
- VMMS.exe
api_type:
- COM
...
# LockMedia method of the CIM\_TapeDrive class
