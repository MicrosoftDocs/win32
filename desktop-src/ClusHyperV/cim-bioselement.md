...
- CIM_BIOSElement.CommunicationStatus
- CIM_BIOSElement.DetailedStatus
- CIM_BIOSElement.OperatingStatus
- CIM_BIOSElement.PrimaryStatus
...
The manufacturer and operating system type when the **TargetOperatingSystem** property is set to 1 (other).
