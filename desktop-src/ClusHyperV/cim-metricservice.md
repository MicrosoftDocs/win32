---
title: CIM\_MetricService class
description: Manages metrics for managed elements.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '6a16b8d3-0cf1-47aa-87fb-2b815ae24694'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_MetricService class", "CIM_MetricService class, described"]
topic_type:
- apiref
api_name:
- CIM_MetricService
- CIM_MetricService.InstanceID
- CIM_MetricService.Caption
- CIM_MetricService.Description
- CIM_MetricService.ElementName
- CIM_MetricService.InstallDate
- CIM_MetricService.OperationalStatus
- CIM_MetricService.StatusDescriptions
- CIM_MetricService.Status
- CIM_MetricService.HealthState
- CIM_MetricService.CommunicationStatus
- CIM_MetricService.DetailedStatus
- CIM_MetricService.OperatingStatus
- CIM_MetricService.PrimaryStatus
- CIM_MetricService.EnabledState
- CIM_MetricService.OtherEnabledState
- CIM_MetricService.RequestedState
- CIM_MetricService.EnabledDefault
- CIM_MetricService.TimeOfLastStateChange
- CIM_MetricService.AvailableRequestedStates
- CIM_MetricService.TransitioningToState
- CIM_MetricService.SystemCreationClassName
- CIM_MetricService.SystemName
- CIM_MetricService.CreationClassName
- CIM_MetricService.Name
- CIM_MetricService.PrimaryOwnerName
- CIM_MetricService.PrimaryOwnerContact
- CIM_MetricService.StartMode
- CIM_MetricService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
> [!Note]  
> For each metric managed by a metric service, there must be a [**CIM\_ServiceAffectsElement**](cim-serviceaffectselement.md) instance that associates the metric with the metric service. In addition, the **AffectsElement** property of the **CIM\_ServiceAffectsElement** instance must be set to "5" (manages).
...
``` syntax
[Abstract, Version("2.23.0"), UMLPackagePath("CIM::Metrics::BaseMetric")]
...
| [**RequestStateChange**](cim-metricservice-requeststatechange.md)       | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
...
| [**StartService**](cim-metricservice-startservice.md)                   | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-metricservice-stopservice.md)                     | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
The **CIM\_MetricService** class has these properties.
