...
ms.assetid: '69e72e9b-f4c5-4000-8ec3-22f2dc8515b3'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_StorageExtent class", "CIM_StorageExtent class, RequestStateChange method"]
topic_type:
- apiref
api_name:
