---
title: EnableDevice method of the CIM\_Display class
...
ms.assetid: 'b94e42dd-1f8a-4d98-8cb5-e2104678dee6'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_Display class", "CIM_Display class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_Display.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_Display class
