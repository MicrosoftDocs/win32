...
ms.assetid: 'dc463006-0a65-4bb4-bb5c-bc35ee24503d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_NetworkPort class", "CIM_NetworkPort class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
