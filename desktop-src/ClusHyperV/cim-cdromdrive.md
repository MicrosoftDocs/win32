...
ms.assetid: a9956c8b-b3c2-48ba-8ac0-62b09085c7c1
...
- CIM_CDROMDrive class, described
topic_type:
- apiref
api_name:
- CIM_CDROMDrive
- CIM_CDROMDrive.InstanceID
- CIM_CDROMDrive.Caption
- CIM_CDROMDrive.Description
- CIM_CDROMDrive.ElementName
- CIM_CDROMDrive.InstallDate
- CIM_CDROMDrive.Name
- CIM_CDROMDrive.OperationalStatus
- CIM_CDROMDrive.StatusDescriptions
- CIM_CDROMDrive.Status
- CIM_CDROMDrive.HealthState
- CIM_CDROMDrive.CommunicationStatus
- CIM_CDROMDrive.DetailedStatus
- CIM_CDROMDrive.OperatingStatus
- CIM_CDROMDrive.PrimaryStatus
- CIM_CDROMDrive.EnabledState
- CIM_CDROMDrive.OtherEnabledState
- CIM_CDROMDrive.RequestedState
- CIM_CDROMDrive.EnabledDefault
- CIM_CDROMDrive.TimeOfLastStateChange
- CIM_CDROMDrive.AvailableRequestedStates
- CIM_CDROMDrive.TransitioningToState
...
- CIM_CDROMDrive.OtherIdentifyingInfo
- CIM_CDROMDrive.PowerOnHours
- CIM_CDROMDrive.TotalPowerOnHours
- CIM_CDROMDrive.IdentifyingDescriptions
- CIM_CDROMDrive.AdditionalAvailability
- CIM_CDROMDrive.MaxQuiesceTime
...
- CIM_CDROMDrive.MediaIsLocked
- CIM_CDROMDrive.Security
- CIM_CDROMDrive.LastCleaned
- CIM_CDROMDrive.MaxAccessTime
- CIM_CDROMDrive.UncompressedDataRate
- CIM_CDROMDrive.LoadTime
- CIM_CDROMDrive.UnloadTime
- CIM_CDROMDrive.MountCount
- CIM_CDROMDrive.TimeOfLastMount
- CIM_CDROMDrive.TotalMountTime
- CIM_CDROMDrive.UnitsDescription
- CIM_CDROMDrive.MaxUnitsBeforeCleaning
- CIM_CDROMDrive.UnitsUsed
api_location:
- VMMS.exe
api_type:
- DllExport
...
| Method                                                          | Description                                                                                                                                                                                                                                                                                                                                             |
|:----------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-cdromdrive-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**LockMedia**](cim-cdromdrive-lockmedia.md)                   | Locks and unlocks removable media in a media access device.<br/> This method is inherited from [**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).<br/>                                                                                                                                                                                |
| [**OnlineDevice**](cim-cdromdrive-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-cdromdrive-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-cdromdrive-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-cdromdrive-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-cdromdrive-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-cdromdrive-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-cdromdrive-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
