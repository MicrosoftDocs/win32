...
ms.assetid: '967b98b0-10b7-48e2-b2e8-ba43eae623f8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_ResourcePoolConfigurationService class", "CIM_ResourcePoolConfigurationService class, described"]
topic_type:
- apiref
api_name:
- CIM_ResourcePoolConfigurationService
- CIM_ResourcePoolConfigurationService.InstanceID
- CIM_ResourcePoolConfigurationService.Caption
- CIM_ResourcePoolConfigurationService.Description
- CIM_ResourcePoolConfigurationService.ElementName
- CIM_ResourcePoolConfigurationService.InstallDate
- CIM_ResourcePoolConfigurationService.OperationalStatus
- CIM_ResourcePoolConfigurationService.StatusDescriptions
- CIM_ResourcePoolConfigurationService.Status
- CIM_ResourcePoolConfigurationService.HealthState
- CIM_ResourcePoolConfigurationService.CommunicationStatus
- CIM_ResourcePoolConfigurationService.DetailedStatus
- CIM_ResourcePoolConfigurationService.OperatingStatus
- CIM_ResourcePoolConfigurationService.PrimaryStatus
- CIM_ResourcePoolConfigurationService.EnabledState
- CIM_ResourcePoolConfigurationService.OtherEnabledState
- CIM_ResourcePoolConfigurationService.RequestedState
- CIM_ResourcePoolConfigurationService.EnabledDefault
- CIM_ResourcePoolConfigurationService.TimeOfLastStateChange
- CIM_ResourcePoolConfigurationService.AvailableRequestedStates
- CIM_ResourcePoolConfigurationService.TransitioningToState
- CIM_ResourcePoolConfigurationService.SystemCreationClassName
- CIM_ResourcePoolConfigurationService.SystemName
- CIM_ResourcePoolConfigurationService.CreationClassName
- CIM_ResourcePoolConfigurationService.Name
- CIM_ResourcePoolConfigurationService.PrimaryOwnerName
- CIM_ResourcePoolConfigurationService.PrimaryOwnerContact
- CIM_ResourcePoolConfigurationService.StartMode
- CIM_ResourcePoolConfigurationService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
| [**RequestStateChange**](cim-resourcepoolconfigurationservice-requeststatechange.md)                           | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](cim-resourcepoolconfigurationservice-startservice.md)                                       | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-resourcepoolconfigurationservice-stopservice.md)                                         | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
The **CIM\_ResourcePoolConfigurationService** class has these properties.
