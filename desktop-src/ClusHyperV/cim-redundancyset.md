---
title: CIM\_RedundancySet class
description: A collection of managed elements that provides redundancy.
audience: developer
...
api_name:
- CIM_RedundancySet
- CIM_RedundancySet.Caption
- CIM_RedundancySet.Description
- CIM_RedundancySet.ElementName
- CIM_RedundancySet.InstanceID
- CIM_RedundancySet.RedundancyStatus
- CIM_RedundancySet.TypeOfSet
- CIM_RedundancySet.MinNumberNeeded
- CIM_RedundancySet.MaxNumberSupported
- CIM_RedundancySet.VendorIdentifyingInfo
- CIM_RedundancySet.OtherTypeOfSet
...
The **CIM\_RedundancySet** class has these types of members:
...
The **CIM\_RedundancySet** class has these methods.



| Method                                         | Description                                                       |
|:-----------------------------------------------|:------------------------------------------------------------------|
| [**Failover**](cim-redundancyset-failover.md) | Forces a failover from one managed element to another.<br/> |
...
The **CIM\_RedundancySet** class has these properties.
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_RedundancySet**.**OtherLoadBalanceAlgorithm**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_RedundancySet**.**LoadBalanceAlgorithm**")
</dt> </dl>
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_RedundancySet**.**TypeOfSet**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_RedundancySet**.**MinNumberNeeded**")
</dt> </dl>
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_RedundancySet**.**OtherTypeOfSet**")
</dt> </dl>
