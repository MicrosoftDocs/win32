...
ms.assetid: 'e57b9e1d-2876-46c3-9a46-a137f6147e59'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_VirtualSystemMigrationService class", "CIM_VirtualSystemMigrationService class, described"]
topic_type:
- apiref
api_name:
- CIM_VirtualSystemMigrationService
- CIM_VirtualSystemMigrationService.InstanceID
- CIM_VirtualSystemMigrationService.Caption
- CIM_VirtualSystemMigrationService.Description
- CIM_VirtualSystemMigrationService.ElementName
- CIM_VirtualSystemMigrationService.InstallDate
- CIM_VirtualSystemMigrationService.OperationalStatus
- CIM_VirtualSystemMigrationService.StatusDescriptions
- CIM_VirtualSystemMigrationService.Status
- CIM_VirtualSystemMigrationService.HealthState
- CIM_VirtualSystemMigrationService.CommunicationStatus
- CIM_VirtualSystemMigrationService.DetailedStatus
- CIM_VirtualSystemMigrationService.OperatingStatus
- CIM_VirtualSystemMigrationService.PrimaryStatus
- CIM_VirtualSystemMigrationService.EnabledState
- CIM_VirtualSystemMigrationService.OtherEnabledState
- CIM_VirtualSystemMigrationService.RequestedState
- CIM_VirtualSystemMigrationService.EnabledDefault
- CIM_VirtualSystemMigrationService.TimeOfLastStateChange
- CIM_VirtualSystemMigrationService.AvailableRequestedStates
- CIM_VirtualSystemMigrationService.TransitioningToState
- CIM_VirtualSystemMigrationService.SystemCreationClassName
- CIM_VirtualSystemMigrationService.SystemName
- CIM_VirtualSystemMigrationService.CreationClassName
- CIM_VirtualSystemMigrationService.Name
- CIM_VirtualSystemMigrationService.PrimaryOwnerName
- CIM_VirtualSystemMigrationService.PrimaryOwnerContact
- CIM_VirtualSystemMigrationService.StartMode
- CIM_VirtualSystemMigrationService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
| [**RequestStateChange**](cim-virtualsystemmigrationservice-requeststatechange.md)                                         | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](cim-virtualsystemmigrationservice-startservice.md)                                                     | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-virtualsystemmigrationservice-stopservice.md)                                                       | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
The **CIM\_VirtualSystemMigrationService** class has these properties.
