---
title: RequestStateChange method of the CIM\_Controller class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '1d5a64a8-cdc4-4a4b-8499-20eedf2d0087'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_Controller class", "CIM_Controller class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_Controller.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_Controller class
