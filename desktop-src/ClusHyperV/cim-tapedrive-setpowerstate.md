---
title: SetPowerState method of the CIM\_TapeDrive class
...
ms.assetid: '727fd8b9-24df-4a5c-829a-95ddac696c0d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_TapeDrive class", "CIM_TapeDrive class, SetPowerState method"]
topic_type:
- apiref
api_name:
