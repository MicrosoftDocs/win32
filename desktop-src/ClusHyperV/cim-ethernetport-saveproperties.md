...
ms.assetid: '35620b42-8f6e-4b6c-8540-ff4eec92f31e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SaveProperties method", "SaveProperties method, CIM_EthernetPort class", "CIM_EthernetPort class, SaveProperties method"]
topic_type:
- apiref
api_name:
