...
description: Represents a service that manages snapshots of virtual machine collections.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'd61fd59e-1b50-46c8-8f09-ca4e42ee2ddd'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_CollectionSnapshotService class", "Msvm_CollectionSnapshotService class, described"]
topic_type:
- apiref
api_name:
- Msvm_CollectionSnapshotService
- Msvm_CollectionSnapshotService.InstanceID
- Msvm_CollectionSnapshotService.Caption
- Msvm_CollectionSnapshotService.Description
- Msvm_CollectionSnapshotService.ElementName
- Msvm_CollectionSnapshotService.InstallDate
- Msvm_CollectionSnapshotService.OperationalStatus
- Msvm_CollectionSnapshotService.StatusDescriptions
- Msvm_CollectionSnapshotService.Status
- Msvm_CollectionSnapshotService.HealthState
- Msvm_CollectionSnapshotService.CommunicationStatus
- Msvm_CollectionSnapshotService.DetailedStatus
- Msvm_CollectionSnapshotService.OperatingStatus
- Msvm_CollectionSnapshotService.PrimaryStatus
- Msvm_CollectionSnapshotService.EnabledState
- Msvm_CollectionSnapshotService.OtherEnabledState
- Msvm_CollectionSnapshotService.RequestedState
- Msvm_CollectionSnapshotService.EnabledDefault
- Msvm_CollectionSnapshotService.TimeOfLastStateChange
- Msvm_CollectionSnapshotService.AvailableRequestedStates
- Msvm_CollectionSnapshotService.TransitioningToState
- Msvm_CollectionSnapshotService.SystemCreationClassName
- Msvm_CollectionSnapshotService.SystemName
- Msvm_CollectionSnapshotService.CreationClassName
- Msvm_CollectionSnapshotService.Name
- Msvm_CollectionSnapshotService.PrimaryOwnerName
- Msvm_CollectionSnapshotService.PrimaryOwnerContact
- Msvm_CollectionSnapshotService.StartMode
- Msvm_CollectionSnapshotService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
| [**ConvertToReferencePoint**](msvm-collectionsnapshotservice-converttoreferencepoint.md) | Converts a snapshot of a virtual system collection to a reference point collection.<br/>                                                                                                 |
| [**CreateSnapshot**](msvm-collectionsnapshotservice-createsnapshot.md)                   | Creates a snapshot of a virtual system collection.<br/>                                                                                                                                  |
| [**DestroySnapshot**](msvm-collectionsnapshotservice-destroysnapshot.md)                 | Deletes a snapshot of a virtual system collection.<br/>                                                                                                                                  |
| [**ExportSnapshot**](msvm-collectionsnapshotservice-exportsnapshot.md)                   | Exports a snapshot of a virtual system collection to a file.<br/>                                                                                                                        |
| [**RequestStateChange**](msvm-collectionsnapshotservice-requeststatechange.md)           | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](msvm-collectionsnapshotservice-startservice.md)                       | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](msvm-collectionsnapshotservice-stopservice.md)                         | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
The **Msvm\_CollectionSnapshotService** class has these properties.
