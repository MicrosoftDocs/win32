...
ms.assetid: 'c84324b2-f80c-4b0b-8db5-a8585f179905'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_TapeDrive class", "CIM_TapeDrive class, described"]
topic_type:
- apiref
api_name:
- CIM_TapeDrive
- CIM_TapeDrive.InstanceID
- CIM_TapeDrive.Caption
- CIM_TapeDrive.Description
- CIM_TapeDrive.ElementName
- CIM_TapeDrive.InstallDate
- CIM_TapeDrive.Name
- CIM_TapeDrive.OperationalStatus
- CIM_TapeDrive.StatusDescriptions
- CIM_TapeDrive.Status
- CIM_TapeDrive.HealthState
- CIM_TapeDrive.CommunicationStatus
- CIM_TapeDrive.DetailedStatus
- CIM_TapeDrive.OperatingStatus
- CIM_TapeDrive.PrimaryStatus
- CIM_TapeDrive.EnabledState
- CIM_TapeDrive.OtherEnabledState
- CIM_TapeDrive.RequestedState
- CIM_TapeDrive.EnabledDefault
- CIM_TapeDrive.TimeOfLastStateChange
- CIM_TapeDrive.AvailableRequestedStates
- CIM_TapeDrive.TransitioningToState
...
- CIM_TapeDrive.OtherIdentifyingInfo
- CIM_TapeDrive.PowerOnHours
- CIM_TapeDrive.TotalPowerOnHours
- CIM_TapeDrive.IdentifyingDescriptions
- CIM_TapeDrive.AdditionalAvailability
- CIM_TapeDrive.MaxQuiesceTime
...
- CIM_TapeDrive.MediaIsLocked
- CIM_TapeDrive.Security
- CIM_TapeDrive.LastCleaned
- CIM_TapeDrive.MaxAccessTime
- CIM_TapeDrive.UncompressedDataRate
- CIM_TapeDrive.LoadTime
- CIM_TapeDrive.UnloadTime
- CIM_TapeDrive.MountCount
- CIM_TapeDrive.TimeOfLastMount
- CIM_TapeDrive.TotalMountTime
- CIM_TapeDrive.UnitsDescription
- CIM_TapeDrive.MaxUnitsBeforeCleaning
- CIM_TapeDrive.UnitsUsed
...
The **CIM\_TapeDrive** class has these methods.



| Method                                                         | Description                                                                                                                                                                                                                                                                                                                                             |
|:---------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-tapedrive-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**LockMedia**](cim-tapedrive-lockmedia.md)                   | Locks and unlocks removable media in a media access device.<br/> This method is inherited from [**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).<br/>                                                                                                                                                                                |
| [**OnlineDevice**](cim-tapedrive-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-tapedrive-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-tapedrive-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-tapedrive-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-tapedrive-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-tapedrive-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-tapedrive-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
