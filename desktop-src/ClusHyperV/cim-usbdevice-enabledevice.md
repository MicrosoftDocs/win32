---
title: EnableDevice method of the CIM\_USBDevice class
...
ms.assetid: 'cd49c4b5-2b1b-4ca2-8911-97ef75d4d44e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_USBDevice class", "CIM_USBDevice class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_USBDevice.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_USBDevice class
