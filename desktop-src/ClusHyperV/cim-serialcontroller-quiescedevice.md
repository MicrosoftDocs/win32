---
title: QuiesceDevice method of the CIM\_SerialController class
...
ms.assetid: '01cbd284-decf-4aa4-bfc7-8ff1efff296e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_SerialController class", "CIM_SerialController class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_SerialController.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_SerialController class
