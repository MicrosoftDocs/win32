...
description: Represents the virtualization service that manages virtual machines on a single host system.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '64fb9a8a-32b1-4c59-854b-ac175490814e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class, described"]
topic_type:
- apiref
api_name:
...
To retrieve information about individual VMs, use [**Msvm\_ComputerSystem**](msvm-computersystem.md) and [**Msvm\_PlannedComputerSystem**](https://msdn.microsoft.com/library/windows/desktop/hh850187) classes.
...
| Method                                                                                                                 | Description                                                                                                                                                                                                                                |
|:-----------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AddBootSourceSettings**](msvm-virtualsystemmanagementservice-addbootsourcesettings.md)                             | Adds boot sources to a stateful virtual machine configuration.<br/>                                                                                                                                                                  |
| [**AddFeatureSettings**](msvm-virtualsystemmanagementservice-addfeaturesettings.md)                                   | Adds feature settings to the configuration of an ethernet connection on a virtual machine.<br/>                                                                                                                                      |
| [**AddFibreChannelChap**](msvm-virtualsystemmanagementservice-addfibrechannelchap.md)                                 | Adds DH-CHAP parameters to a synthetic fibre channel port in a VM.<br/>                                                                                                                                                              |
...
| [**AddKvpItems**](msvm-virtualsystemmanagementservice-addkvpitems.md)                                                 | Adds key-value pairs to a virtual machine.<br/>                                                                                                                                                                                      |
| [**AddResourceSettings**](msvm-virtualsystemmanagementservice-addresourcesettings.md)                                 | Adds resources settings to a virtual machine configuration. When this method is applied to a stateful virtual machine configuration, the resources are also added to the active virtual machine.<br/>                                |
...
| [**DefinePlannedSystem**](msvm-virtualsystemmanagementservice-defineplannedsystem.md)                                 | Defines a planned virtual machine.<br/>                                                                                                                                                                                              |
| [**DefineSystem**](msvm-virtualsystemmanagementservice-definesystem.md)                                               | Defines a virtual machine.<br/>                                                                                                                                                                                                      |
| [**DestroySystem**](msvm-virtualsystemmanagementservice-destroysystem.md)                                             | Deletes a virtual machine.<br/>                                                                                                                                                                                                      |
...
| [**ExportSystemDefinition**](msvm-virtualsystemmanagementservice-exportsystemdefinition.md)                           | Exports a virtual machine, or a snapshot of a virtual computer system to a file.<br/>                                                                                                                                                |
| [**FormatError**](msvm-virtualsystemmanagementservice-formaterror.md)                                                 | Retrieves a formatted error message for an array of [**Msvm\_Error**](msvm-error.md) instances.<br/>                                                                                                                                |
| [**GenerateWwpn**](msvm-virtualsystemmanagementservice-generatewwpn.md)                                               | Creates a range of World Wide Port Names (WWPN) from a [**Msvm\_VirtualSystemManagementServiceSettingData**](msvm-virtualsystemmanagementservicesettingdata.md) instance.<br/>                                                      |
| [**GetCurrentWwpnFromGenerator**](msvm-virtualsystemmanagementservice-getcurrentwwpnfromgenerator.md)                 | Retrieves the current World Wide Port Name (WWPN) from the GenerateWwpn method.<br/>                                                                                                                                                 |
| [**GetDefinitionFileSummaryInformation**](msvm-virtualsystemmanagementservice-getdefinitionfilesummaryinformation.md) | Returns virtual machine summary information for an array of virtual machine definition files.<br/>                                                                                                                                   |
| [**GetSizeOfSystemFiles**](msvm-virtualsystemmanagementservice-getsizeofsystemfiles.md)                               | Retrieves the total size of the system files for a virtual machine or for a virtual machine snapshot.<br/>                                                                                                                           |
| [**GetSummaryInformation**](msvm-virtualsystemmanagementservice-getsummaryinformation.md)                             | Returns summary information for VMs and VM snapshots.<br/>                                                                                                                                                                           |
| [**GetVirtualSystemThumbnailImage**](msvm-virtualsystemmanagementservice-getvirtualsystemthumbnailimage.md)           | Retrieves the thumbnail image, in raw RGB 565 format, of a virtual machine or virtual machine snapshot.<br/>                                                                                                                         |
| [**ImportSnapshotDefinitions**](msvm-virtualsystemmanagementservice-importsnapshotdefinitions.md)                     | Creates snapshots for each snapshot definition files of a planned virtual machine.<br/>                                                                                                                                              |
| [**ImportSystemDefinition**](msvm-virtualsystemmanagementservice-importsystemdefinition.md)                           | Creates a new planned virtual machine based on a virtual machine definition.<br/>                                                                                                                                                    |
| [**ModifyDiskMergeSettings**](msvm-virtualsystemmanagementservice-modifydiskmergesettings.md)                         | Modifies setting data for the disk merge function.<br/>                                                                                                                                                                              |
| [**ModifyFeatureSettings**](msvm-virtualsystemmanagementservice-modifyfeaturesettings.md)                             | Modifies the feature settings of an ethernet connection of a virtual machine.<br/>                                                                                                                                                   |
| [**ModifyGuestServiceSettings**](msvm-virtualsystemmanagementservice-modifyguestservicesettings.md)                   | Modifies guest service settings for a virtual machine.<br/>                                                                                                                                                                          |
| [**ModifyKvpItems**](msvm-virtualsystemmanagementservice-modifykvpitems.md)                                           | Modifies key-value pairs on a virtual machine.<br/>                                                                                                                                                                                  |
| [**ModifyResourceSettings**](msvm-virtualsystemmanagementservice-modifyresourcesettings.md)                           | Adds resources settings to a virtual machine configuration.<br/>                                                                                                                                                                     |
| [**ModifyServiceSettings**](msvm-virtualsystemmanagementservice-modifyservicesettings.md)                             | Modifies the setting data for the service.<br/>                                                                                                                                                                                      |
...
| [**ModifySystemSettings**](msvm-virtualsystemmanagementservice-modifysystemsettings.md)                               | Modifies virtual machine settings.<br/>                                                                                                                                                                                              |
| [**RealizePlannedSystem**](msvm-virtualsystemmanagementservice-realizeplannedsystem.md)                               | Validates the configuration of a planned virtual machine and converts it new virtual machine.<br/>                                                                                                                                   |
| [**RemoveBootSourceSettings**](msvm-virtualsystemmanagementservice-removebootsourcesettings.md)                       | Removes virtual resource settings from a virtual machine configuration.<br/>                                                                                                                                                         |
| [**RemoveFeatureSettings**](msvm-virtualsystemmanagementservice-removefeaturesettings.md)                             | Removes feature settings from an ethernet connection on a virtual machine.<br/>                                                                                                                                                      |
| [**RemoveFibreChannelChap**](msvm-virtualsystemmanagementservice-removefibrechannelchap.md)                           | Removes DH-CHAP settings from a synthetic fibre channel port in a virtual machine.<br/>                                                                                                                                              |
...
| [**RemoveKvpItems**](msvm-virtualsystemmanagementservice-removekvpitems.md)                                           | Removes key-value pairs from a virtual machine.<br/>                                                                                                                                                                                 |
| [**RemoveResourceSettings**](msvm-virtualsystemmanagementservice-removeresourcesettings.md)                           | Removes virtual resource settings from a virtual machine configuration.<br/>                                                                                                                                                         |
...
| [**RequestStateChange**](msvm-virtualsystemmanagementservice-requeststatechange.md)                                   | Requests a state change for the element.<br/>                                                                                                                                                                                        |
| [**SetGuestNetworkAdapterConfiguration**](msvm-virtualsystemmanagementservice-setguestnetworkadapterconfiguration.md) | Configures the network adapters in a guest operating system.<br/>                                                                                                                                                                    |
| [**SetInitialMachineConfigurationData**](msvm-virtualsystemmanagementservice-setinitialmachineconfigurationdata.md)   | Sets the initial machine configuration data for a virtual machine.<br/>                                                                                                                                                              |
| [**StartService**](msvm-virtualsystemmanagementservice-startservice.md)                                               | Starts the virtual machine management service.<br/>                                                                                                                                                                                  |
| [**StopService**](msvm-virtualsystemmanagementservice-stopservice.md)                                                 | Stops the virtual machine management service.<br/>                                                                                                                                                                                   |
| [**TestNetworkConnection**](msvm-virtualsystemmanagementservice-testnetworkconnection.md)                             | Tests the network connectivity of a virtual machine in a Windows Network Virtualization environment.<br/>                                                                                                                            |
| [**UpgradeSystemVersion**](msvm-virtualsystemmanagementservice-upgradesystemversion.md)                               | Upgrades a virtual machine.<br/>                                                                                                                                                                                                     |
| [**ValidatePlannedSystem**](msvm-virtualsystemmanagementservice-validateplannedsystem.md)                             | Validates a planned system.<br/>                                                                                                                                                                                                     |
