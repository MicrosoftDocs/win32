...
ms.assetid: 'eb6c14a3-b27e-4808-99c1-8f90eca3fed0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_SerialController class", "CIM_SerialController class, described"]
topic_type:
- apiref
api_name:
- CIM_SerialController
- CIM_SerialController.InstanceID
- CIM_SerialController.Caption
- CIM_SerialController.Description
- CIM_SerialController.ElementName
- CIM_SerialController.InstallDate
- CIM_SerialController.Name
- CIM_SerialController.OperationalStatus
- CIM_SerialController.StatusDescriptions
- CIM_SerialController.Status
- CIM_SerialController.HealthState
- CIM_SerialController.CommunicationStatus
- CIM_SerialController.DetailedStatus
- CIM_SerialController.OperatingStatus
- CIM_SerialController.PrimaryStatus
- CIM_SerialController.EnabledState
- CIM_SerialController.OtherEnabledState
- CIM_SerialController.RequestedState
- CIM_SerialController.EnabledDefault
- CIM_SerialController.TimeOfLastStateChange
- CIM_SerialController.AvailableRequestedStates
- CIM_SerialController.TransitioningToState
...
- CIM_SerialController.OtherIdentifyingInfo
- CIM_SerialController.PowerOnHours
- CIM_SerialController.TotalPowerOnHours
- CIM_SerialController.IdentifyingDescriptions
- CIM_SerialController.AdditionalAvailability
- CIM_SerialController.MaxQuiesceTime
- CIM_SerialController.TimeOfLastReset
- CIM_SerialController.ProtocolSupported
- CIM_SerialController.MaxNumberControlled
- CIM_SerialController.ProtocolDescription
...
``` syntax
[Abstract, Version("2.10.0"), UMLPackagePath("CIM::Device::Controller")]
...
The **CIM\_SerialController** class has these methods.



| Method                                                                | Description                                                                                                                                                                                                                                                                                                                                             |
|:----------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-serialcontroller-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-serialcontroller-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-serialcontroller-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-serialcontroller-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-serialcontroller-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-serialcontroller-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-serialcontroller-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-serialcontroller-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Serial Ports\|004.7"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_SerialController**.**CapabilityDescriptions**")
</dt> </dl>
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_SerialController**.**Capabilities**")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bits per Second"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Serial Ports\|004.6"), **PUnit** ("bit / second")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Serial Ports\|004.9")
</dt> </dl>
