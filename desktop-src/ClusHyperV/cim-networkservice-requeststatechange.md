---
title: RequestStateChange method of the CIM\_NetworkService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '0013e5ab-dadb-4000-b28c-5024dc7c7795'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_NetworkService class", "CIM_NetworkService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_NetworkService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_NetworkService class
