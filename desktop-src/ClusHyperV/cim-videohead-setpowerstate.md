---
title: SetPowerState method of the CIM\_VideoHead class
...
ms.assetid: 'db3017ef-c580-415e-97fc-ace7479abcb8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_VideoHead class", "CIM_VideoHead class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_VideoHead.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_VideoHead class
