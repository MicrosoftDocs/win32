...
description: Represents a collection of virtual machines.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '12db40b2-d1da-4e2f-a052-70d6c9647d50'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_VirtualSystemCollection class", "Msvm_VirtualSystemCollection class, described"]
topic_type:
- apiref
api_name:
- Msvm_VirtualSystemCollection
- Msvm_VirtualSystemCollection.InstanceID
- Msvm_VirtualSystemCollection.Caption
- Msvm_VirtualSystemCollection.Description
