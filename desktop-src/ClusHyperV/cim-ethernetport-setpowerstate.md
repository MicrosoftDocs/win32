---
title: SetPowerState method of the CIM\_EthernetPort class
...
ms.assetid: '19b0c353-98e8-4a37-98a4-71c246a24aac'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_EthernetPort class", "CIM_EthernetPort class, SetPowerState method"]
topic_type:
- apiref
api_name:
...
# SetPowerState method of the CIM\_EthernetPort class
