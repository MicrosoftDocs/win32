...
ms.assetid: 'b9f46168-9b9c-49ab-8a15-48f17750c83e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_DesktopMonitor class", "CIM_DesktopMonitor class, described"]
topic_type:
- apiref
api_name:
- CIM_DesktopMonitor
- CIM_DesktopMonitor.InstanceID
- CIM_DesktopMonitor.Caption
- CIM_DesktopMonitor.Description
- CIM_DesktopMonitor.ElementName
- CIM_DesktopMonitor.InstallDate
- CIM_DesktopMonitor.Name
- CIM_DesktopMonitor.OperationalStatus
- CIM_DesktopMonitor.StatusDescriptions
- CIM_DesktopMonitor.Status
- CIM_DesktopMonitor.HealthState
- CIM_DesktopMonitor.CommunicationStatus
- CIM_DesktopMonitor.DetailedStatus
- CIM_DesktopMonitor.OperatingStatus
- CIM_DesktopMonitor.PrimaryStatus
- CIM_DesktopMonitor.EnabledState
- CIM_DesktopMonitor.OtherEnabledState
- CIM_DesktopMonitor.RequestedState
- CIM_DesktopMonitor.EnabledDefault
- CIM_DesktopMonitor.TimeOfLastStateChange
- CIM_DesktopMonitor.AvailableRequestedStates
- CIM_DesktopMonitor.TransitioningToState
...
- CIM_DesktopMonitor.OtherIdentifyingInfo
- CIM_DesktopMonitor.PowerOnHours
- CIM_DesktopMonitor.TotalPowerOnHours
- CIM_DesktopMonitor.IdentifyingDescriptions
- CIM_DesktopMonitor.AdditionalAvailability
- CIM_DesktopMonitor.MaxQuiesceTime
...
The **CIM\_DesktopMonitor** class has these methods.



| Method                                                              | Description                                                                                                                                                                                                                                                                                                                                             |
|:--------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-desktopmonitor-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-desktopmonitor-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-desktopmonitor-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-desktopmonitor-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-desktopmonitor-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-desktopmonitor-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-desktopmonitor-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-desktopmonitor-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("MegaHertz"), **PUnit** ("hertz \* 10^6")
</dt> </dl>
