---
title: RequestStateChange method of the CIM\_VirtualSystemMigrationService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'b686e4e0-6e6d-45c1-93f9-a58bf8ea80e3'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_VirtualSystemMigrationService class", "CIM_VirtualSystemMigrationService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_VirtualSystemMigrationService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_VirtualSystemMigrationService class
