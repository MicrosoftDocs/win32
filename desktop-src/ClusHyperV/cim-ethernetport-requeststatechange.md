...
ms.assetid: '11e20d1d-8c54-45dd-b324-da7e32919e3a'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_EthernetPort class", "CIM_EthernetPort class, RequestStateChange method"]
topic_type:
- apiref
api_name:
