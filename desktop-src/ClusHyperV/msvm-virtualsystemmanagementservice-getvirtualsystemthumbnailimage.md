...
keywords: ["GetVirtualSystemThumbnailImage method", "GetVirtualSystemThumbnailImage method, Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class, GetVirtualSystemThumbnailImage method"]
topic_type:
- apiref
api_name:
