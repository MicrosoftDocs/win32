...
ms.assetid: '0130849f-2afb-46ea-9656-f4ff0ab229fe'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_Controller class", "CIM_Controller class, described"]
topic_type:
- apiref
api_name:
- CIM_Controller
- CIM_Controller.InstanceID
- CIM_Controller.Caption
- CIM_Controller.Description
- CIM_Controller.ElementName
- CIM_Controller.InstallDate
- CIM_Controller.Name
- CIM_Controller.OperationalStatus
- CIM_Controller.StatusDescriptions
- CIM_Controller.Status
- CIM_Controller.HealthState
- CIM_Controller.CommunicationStatus
- CIM_Controller.DetailedStatus
- CIM_Controller.OperatingStatus
- CIM_Controller.PrimaryStatus
- CIM_Controller.EnabledState
- CIM_Controller.OtherEnabledState
- CIM_Controller.RequestedState
- CIM_Controller.EnabledDefault
- CIM_Controller.TimeOfLastStateChange
- CIM_Controller.AvailableRequestedStates
- CIM_Controller.TransitioningToState
...
- CIM_Controller.OtherIdentifyingInfo
- CIM_Controller.PowerOnHours
- CIM_Controller.TotalPowerOnHours
- CIM_Controller.IdentifyingDescriptions
- CIM_Controller.AdditionalAvailability
- CIM_Controller.MaxQuiesceTime
...
A superclass for miscellaneous control-related devices that provide a classic bus master interface. The controller class is an abstraction for devices with a single protocol stack, and exist to control communications (data, control, and reset) to downstream devices. Some examples of controllers are USB controllers and serial controllers. The [**CIM\_ProtocolController**](cim-protocolcontroller.md) class models more complex interface controllers such as SCSI.
...
The **CIM\_Controller** class has these methods.



| Method                                                          | Description                                                                                                                                                                                                                                                                                                                                                                 |
|:----------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-controller-enabledevice.md)             | This method is deprecated. Instead, use the [**RequestStateChange**](cim-controller-requeststatechange.md) method.<br/> **Deprecated description:** Enables or disables the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-controller-onlinedevice.md)             | This method is deprecated. Instead, use the [**RequestStateChange**](cim-controller-requeststatechange.md) method.<br/> **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-controller-quiescedevice.md)           | This method is deprecated. Instead, use the [**RequestStateChange**](cim-controller-requeststatechange.md) method.<br/> **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-controller-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                              |
| [**Reset**](cim-controller-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                                             |
| [**RestoreProperties**](cim-controller-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                     |
| [**SaveProperties**](cim-controller-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                               |
| [**SetPowerState**](cim-controller-setpowerstate.md)           | This method is deprecated. Instead, use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> **Deprecated description:** Sets the power state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                |
...
Indicates the possible values for the *RequestedState* parameter of the [**RequestStateChange**](cim-logicaldevice-requeststatechange.md) method.
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Bus Port\|004.3"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_Controller**.**ProtocolSupported**")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Bus Port\|004.2", "MIF.DMTF\|Disks\|003.3"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_Controller**.**ProtocolDescription**")
</dt> </dl>
