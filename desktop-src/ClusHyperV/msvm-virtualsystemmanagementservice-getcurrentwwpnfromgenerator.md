...
- GetCurrentWwpnFromGenerator method, Msvm_VirtualSystemManagementService class
- Msvm_VirtualSystemManagementService class, GetCurrentWwpnFromGenerator method
topic_type:
- apiref
api_name:
