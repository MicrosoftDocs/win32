---
title: SetPowerState method of the CIM\_FCPort class
...
ms.assetid: '1db1d95c-dea6-458e-9075-e9e4907f78d4'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_FCPort class", "CIM_FCPort class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_FCPort.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_FCPort class
