...
ms.assetid: 3dcd9c02-144f-42ee-aac3-d5605e9cabca
...
- CIM_ComputerSystem.CommunicationStatus
- CIM_ComputerSystem.DetailedStatus
- CIM_ComputerSystem.OperatingStatus
- CIM_ComputerSystem.PrimaryStatus
...
- CIM_ComputerSystem.AvailableRequestedStates
- CIM_ComputerSystem.TransitioningToState
...
Represents a collection that provides computing capabilities and consists of [**CIM\_ManagedSystemElement**](cim-managedsystemelement.md) objects. The collection may provide aggregation for one or more of the following elements:

-   [**CIM\_FileSystem**](https://msdn.microsoft.com/library/aa387273)
-   [**CIM\_OperatingSystem**](https://msdn.microsoft.com/library/aa387937)
-   [**CIM\_Processor**](cim-processor.md)
-   [**CIM\_Memory**](cim-memory.md) (volatile and non-volatile Storage)
...
| Method                                                              | Description                                                                                                                                                                                                          |
|:--------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-computersystem-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md) class.<br/>             |
| [**SetPowerState**](cim-computersystem-setpowerstate.md)           | This method is deprecated. Instead, use the **RequestPowerStateChange** method in the **CIM\_PowerManagementService** class.<br/> **Deprecated description:** Sets the power state of the computer.<br/> |
