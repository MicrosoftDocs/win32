...
ms.assetid: '0080a2bc-d0ca-4bbf-a079-2b8372528df9'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_VirtualSystemSnapshotService class", "CIM_VirtualSystemSnapshotService class, described"]
topic_type:
- apiref
api_name:
- CIM_VirtualSystemSnapshotService
- CIM_VirtualSystemSnapshotService.InstanceID
- CIM_VirtualSystemSnapshotService.Caption
- CIM_VirtualSystemSnapshotService.Description
- CIM_VirtualSystemSnapshotService.ElementName
- CIM_VirtualSystemSnapshotService.InstallDate
- CIM_VirtualSystemSnapshotService.OperationalStatus
- CIM_VirtualSystemSnapshotService.StatusDescriptions
- CIM_VirtualSystemSnapshotService.Status
- CIM_VirtualSystemSnapshotService.HealthState
- CIM_VirtualSystemSnapshotService.CommunicationStatus
- CIM_VirtualSystemSnapshotService.DetailedStatus
- CIM_VirtualSystemSnapshotService.OperatingStatus
- CIM_VirtualSystemSnapshotService.PrimaryStatus
- CIM_VirtualSystemSnapshotService.EnabledState
- CIM_VirtualSystemSnapshotService.OtherEnabledState
- CIM_VirtualSystemSnapshotService.RequestedState
- CIM_VirtualSystemSnapshotService.EnabledDefault
- CIM_VirtualSystemSnapshotService.TimeOfLastStateChange
- CIM_VirtualSystemSnapshotService.AvailableRequestedStates
- CIM_VirtualSystemSnapshotService.TransitioningToState
- CIM_VirtualSystemSnapshotService.SystemCreationClassName
- CIM_VirtualSystemSnapshotService.SystemName
- CIM_VirtualSystemSnapshotService.CreationClassName
- CIM_VirtualSystemSnapshotService.Name
- CIM_VirtualSystemSnapshotService.PrimaryOwnerName
- CIM_VirtualSystemSnapshotService.PrimaryOwnerContact
- CIM_VirtualSystemSnapshotService.StartMode
- CIM_VirtualSystemSnapshotService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
| [**RequestStateChange**](cim-virtualsystemsnapshotservice-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](cim-virtualsystemsnapshotservice-startservice.md)             | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-virtualsystemsnapshotservice-stopservice.md)               | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
The **CIM\_VirtualSystemSnapshotService** class has these properties.
