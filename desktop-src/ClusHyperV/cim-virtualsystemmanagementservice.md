...
ms.assetid: '04a2b704-e0a9-405d-a6ab-35da4821c951'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_VirtualSystemManagementService class", "CIM_VirtualSystemManagementService class, described"]
topic_type:
- apiref
api_name:
- CIM_VirtualSystemManagementService
- CIM_VirtualSystemManagementService.InstanceID
...
- CIM_VirtualSystemManagementService.CommunicationStatus
- CIM_VirtualSystemManagementService.DetailedStatus
- CIM_VirtualSystemManagementService.OperatingStatus
- CIM_VirtualSystemManagementService.PrimaryStatus
...
- CIM_VirtualSystemManagementService.AvailableRequestedStates
- CIM_VirtualSystemManagementService.TransitioningToState
...
| [**RequestStateChange**](cim-virtualsystemmanagementservice-requeststatechange.md)         | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](cim-virtualsystemmanagementservice-startservice.md)                     | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-virtualsystemmanagementservice-stopservice.md)                       | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
Indicates the possible values for the *RequestedState* parameter of the [**RequestStateChange**](cim-service-requeststatechange.md) method.
