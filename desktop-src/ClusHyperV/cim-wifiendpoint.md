...
api_name:
- CIM_WiFiEndpoint
- CIM_WiFiEndpoint.InstanceID
- CIM_WiFiEndpoint.Caption
- CIM_WiFiEndpoint.ElementName
- CIM_WiFiEndpoint.InstallDate
- CIM_WiFiEndpoint.StatusDescriptions
- CIM_WiFiEndpoint.Status
- CIM_WiFiEndpoint.HealthState
- CIM_WiFiEndpoint.CommunicationStatus
- CIM_WiFiEndpoint.DetailedStatus
- CIM_WiFiEndpoint.OperatingStatus
- CIM_WiFiEndpoint.PrimaryStatus
- CIM_WiFiEndpoint.OtherEnabledState
- CIM_WiFiEndpoint.RequestedState
- CIM_WiFiEndpoint.EnabledDefault
- CIM_WiFiEndpoint.AvailableRequestedStates
- CIM_WiFiEndpoint.TransitioningToState
- CIM_WiFiEndpoint.SystemCreationClassName
- CIM_WiFiEndpoint.SystemName
- CIM_WiFiEndpoint.CreationClassName
- CIM_WiFiEndpoint.Description
- CIM_WiFiEndpoint.OperationalStatus
- CIM_WiFiEndpoint.EnabledState
- CIM_WiFiEndpoint.TimeOfLastStateChange
- CIM_WiFiEndpoint.Name
- CIM_WiFiEndpoint.NameFormat
- CIM_WiFiEndpoint.ProtocolType
- CIM_WiFiEndpoint.OtherTypeDescription
- CIM_WiFiEndpoint.LANType
- CIM_WiFiEndpoint.OtherLANType
- CIM_WiFiEndpoint.MACAddress
- CIM_WiFiEndpoint.AliasAddresses
- CIM_WiFiEndpoint.GroupAddresses
- CIM_WiFiEndpoint.MaxDataSize
...
The **CIM\_WiFiEndpoint** class has these methods.



| Method                                                            | Description                                                                                                                                                                                    |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-wifiendpoint-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
