---
title: SetPowerState method of the CIM\_Memory class
...
ms.assetid: '586b4e8b-5679-46fe-9eb9-28532e7af343'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_Memory class", "CIM_Memory class, SetPowerState method"]
topic_type:
- apiref
api_name:
...
# SetPowerState method of the CIM\_Memory class
