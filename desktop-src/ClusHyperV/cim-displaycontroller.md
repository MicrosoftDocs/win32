...
- CIM_DisplayController.InstanceID
- CIM_DisplayController.Caption
- CIM_DisplayController.ElementName
- CIM_DisplayController.InstallDate
- CIM_DisplayController.Name
- CIM_DisplayController.OperationalStatus
- CIM_DisplayController.StatusDescriptions
- CIM_DisplayController.Status
- CIM_DisplayController.HealthState
- CIM_DisplayController.CommunicationStatus
- CIM_DisplayController.DetailedStatus
- CIM_DisplayController.OperatingStatus
- CIM_DisplayController.PrimaryStatus
- CIM_DisplayController.EnabledState
- CIM_DisplayController.OtherEnabledState
- CIM_DisplayController.RequestedState
- CIM_DisplayController.EnabledDefault
- CIM_DisplayController.TimeOfLastStateChange
- CIM_DisplayController.AvailableRequestedStates
- CIM_DisplayController.TransitioningToState
- CIM_DisplayController.SystemCreationClassName
- CIM_DisplayController.SystemName
- CIM_DisplayController.CreationClassName
- CIM_DisplayController.DeviceID
- CIM_DisplayController.PowerManagementSupported
- CIM_DisplayController.PowerManagementCapabilities
- CIM_DisplayController.Availability
- CIM_DisplayController.StatusInfo
- CIM_DisplayController.LastErrorCode
- CIM_DisplayController.ErrorDescription
- CIM_DisplayController.ErrorCleared
- CIM_DisplayController.OtherIdentifyingInfo
- CIM_DisplayController.PowerOnHours
- CIM_DisplayController.TotalPowerOnHours
- CIM_DisplayController.IdentifyingDescriptions
- CIM_DisplayController.AdditionalAvailability
- CIM_DisplayController.MaxQuiesceTime
- CIM_DisplayController.TimeOfLastReset
- CIM_DisplayController.ProtocolSupported
- CIM_DisplayController.MaxNumberControlled
- CIM_DisplayController.ProtocolDescription
...
The **CIM\_DisplayController** class has these methods.



| Method                                                                 | Description                                                                                                                                                                                                                                                                                                                                             |
|:-----------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-displaycontroller-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-displaycontroller-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-displaycontroller-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-displaycontroller-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-displaycontroller-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-displaycontroller-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-displaycontroller-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-displaycontroller-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_DisplayController**.**CapabilityDescriptions**")
</dt> </dl>
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_DisplayController**.**AcceleratorCapabilities**")
</dt> </dl>
...
Qualifiers: [**Override**](https://msdn.microsoft.com/library/aa393650) ("Description"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.18")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_DisplayController**.**VideoArchitecture**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_DisplayController**.**VideoMemoryType**")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.6"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_DisplayController**.**OtherVideoMemoryType**")
</dt> </dl>
