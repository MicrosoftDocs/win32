...
keywords: ["DefineSystem method", "DefineSystem method, CIM_VirtualSystemManagementService class", "CIM_VirtualSystemManagementService class, DefineSystem method"]
topic_type:
- apiref
api_name:
