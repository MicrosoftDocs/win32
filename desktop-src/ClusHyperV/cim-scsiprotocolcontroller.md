...
ms.assetid: c1b10be7-2ed4-4f59-b082-0646067764da
...
- CIM_SCSIProtocolController class, described
topic_type:
- apiref
api_name:
- CIM_SCSIProtocolController
- CIM_SCSIProtocolController.InstanceID
- CIM_SCSIProtocolController.Caption
- CIM_SCSIProtocolController.Description
- CIM_SCSIProtocolController.ElementName
- CIM_SCSIProtocolController.InstallDate
- CIM_SCSIProtocolController.Name
- CIM_SCSIProtocolController.OperationalStatus
- CIM_SCSIProtocolController.StatusDescriptions
- CIM_SCSIProtocolController.Status
- CIM_SCSIProtocolController.HealthState
- CIM_SCSIProtocolController.CommunicationStatus
- CIM_SCSIProtocolController.DetailedStatus
- CIM_SCSIProtocolController.OperatingStatus
- CIM_SCSIProtocolController.PrimaryStatus
- CIM_SCSIProtocolController.EnabledState
- CIM_SCSIProtocolController.OtherEnabledState
- CIM_SCSIProtocolController.RequestedState
- CIM_SCSIProtocolController.EnabledDefault
- CIM_SCSIProtocolController.TimeOfLastStateChange
- CIM_SCSIProtocolController.AvailableRequestedStates
- CIM_SCSIProtocolController.TransitioningToState
- CIM_SCSIProtocolController.SystemCreationClassName
- CIM_SCSIProtocolController.SystemName
- CIM_SCSIProtocolController.CreationClassName
- CIM_SCSIProtocolController.DeviceID
- CIM_SCSIProtocolController.PowerManagementSupported
- CIM_SCSIProtocolController.PowerManagementCapabilities
- CIM_SCSIProtocolController.Availability
- CIM_SCSIProtocolController.StatusInfo
- CIM_SCSIProtocolController.LastErrorCode
- CIM_SCSIProtocolController.ErrorDescription
- CIM_SCSIProtocolController.ErrorCleared
- CIM_SCSIProtocolController.OtherIdentifyingInfo
- CIM_SCSIProtocolController.PowerOnHours
- CIM_SCSIProtocolController.TotalPowerOnHours
- CIM_SCSIProtocolController.IdentifyingDescriptions
- CIM_SCSIProtocolController.AdditionalAvailability
- CIM_SCSIProtocolController.MaxQuiesceTime
- CIM_SCSIProtocolController.MaxUnitsControlled
...
``` syntax
[Abstract, Version("2.8.1000"), UMLPackagePath("CIM::Device::ProtocolController")]
...
The **CIM\_SCSIProtocolController** class has these methods.



| Method                                                                      | Description                                                                                                                                                                                                                                                                                                                                             |
|:----------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-scsiprotocolcontroller-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-scsiprotocolcontroller-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-scsiprotocolcontroller-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-scsiprotocolcontroller-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-scsiprotocolcontroller-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-scsiprotocolcontroller-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-scsiprotocolcontroller-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-scsiprotocolcontroller-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
This property is inherited from [**CIM\_ProtocolController**](cim-protocolcontroller.md).
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_SCSIProtocolController**.**Name**", "**CIM\_SCSIProtocolController**.**OtherNameFormat**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_SCSIProtocolController**.**Name**", "**CIM\_SCSIProtocolController**.**NameFormat**")
</dt> </dl>
