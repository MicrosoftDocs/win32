...
ms.assetid: '038b5af6-11fe-4db7-ae6b-9af02e3122cb'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_SoftwareElement class", "CIM_SoftwareElement class, described"]
topic_type:
- apiref
api_name:
- CIM_SoftwareElement
- CIM_SoftwareElement.InstanceID
...
- CIM_SoftwareElement.CommunicationStatus
- CIM_SoftwareElement.DetailedStatus
- CIM_SoftwareElement.OperatingStatus
- CIM_SoftwareElement.PrimaryStatus
