...
ms.assetid: 'b61bff3f-6ce3-438a-a1de-fa0919d7206f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_Service class", "CIM_Service class, RequestStateChange method"]
topic_type:
- apiref
api_name:
