---
title: RequestStateChange method of the CIM\_Processor class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ce84e905-7306-48d8-b849-0f90c68b92fd'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_Processor class", "CIM_Processor class, RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_Processor class
