...
description: Represents the virtual system migration service. The service migrates virtual machines and virtual machine storage from one virtualization platform to another.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ddb3f5f1-b8e2-4449-9111-d79cd9e5ce99'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_VirtualSystemMigrationService class", "Msvm_VirtualSystemMigrationService class, described"]
topic_type:
- apiref
api_name:
...
| Method                                                                                                                      | Description                                                                                                                                                                                                                |
|:----------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AddNetworkSettings**](msvm-virtualsystemmigrationservice-addnetworksettings.md)                                         | Adds migration network settings for the virtual system migration service.<br/>                                                                                                                                       |
| [**CheckSystemCompatibilityInfo**](msvm-virtualsystemmigrationservice-checksystemcompatibilityinfo.md)                     | Verifies whether a computer system is able to host the specified virtual machine.<br/>                                                                                                                               |
| [**CheckVirtualSystemIsMigratable**](msvm-virtualsystemmigrationservice-checkvirtualsystemismigratable.md)                 | Determines whether the specified virtual system can be migrated.<br/>                                                                                                                                                |
| [**CheckVirtualSystemIsMigratableToHost**](msvm-virtualsystemmigrationservice-checkvirtualsystemismigratabletohost.md)     | Verifies whether a pending virtual system migration to a host is likely to succeed.<br/> This method is inherited from [**CIM\_VirtualSystemMigrationService**](cim-virtualsystemmigrationservice.md).<br/>   |
| [**CheckVirtualSystemIsMigratableToSystem**](msvm-virtualsystemmigrationservice-checkvirtualsystemismigratabletosystem.md) | Verifies whether a pending virtual system migration to a system is likely to succeed.<br/> This method is inherited from [**CIM\_VirtualSystemMigrationService**](cim-virtualsystemmigrationservice.md).<br/> |
| [**GetSystemCompatibilityInfo**](msvm-virtualsystemmigrationservice-getsystemcompatibilityinfo.md)                         | Generates an opaque BLOB of data that contains compatibility information for the specified system.<br/>                                                                                                              |
| [**GetSystemCompatibilityVectors**](msvm-virtualsystemmigrationservice-getsystemcompatibilityvectors.md)                   | Gets a list of [**Msvm\_CompatibilityVector**](https://msdn.microsoft.com/library/windows/desktop/dn280574) instances that can be used to check for virtual machine to host compatibility.<br/>                                                  |
| [**MigrateVirtualSystemToHost**](msvm-virtualsystemmigrationservice-migratevirtualsystemtohost.md)                         | Migrates a virtual system or the storage of a virtual system to a destination host specified by a hostname.<br/>                                                                                                     |
| [**MigrateVirtualSystemToSystem**](msvm-virtualsystemmigrationservice-migratevirtualsystemtosystem.md)                     | Migrates a virtual system to target system.<br/> This method is inherited from [**CIM\_VirtualSystemMigrationService**](cim-virtualsystemmigrationservice.md).<br/>                                           |
| [**ModifyNetworkSettings**](msvm-virtualsystemmigrationservice-modifynetworksettings.md)                                   | Modifies migration network subnets of the virtual system migration service.<br/>                                                                                                                                     |
| [**ModifyServiceSettings**](msvm-virtualsystemmigrationservice-modifyservicesettings.md)                                   | Modifies the setting data for the migration service.<br/>                                                                                                                                                            |
| [**RemoveNetworkSettings**](msvm-virtualsystemmigrationservice-removenetworksettings.md)                                   | Removes migration network subnets from the virtual system migration service.<br/>                                                                                                                                    |
| [**RequestStateChange**](msvm-virtualsystemmigrationservice-requeststatechange.md)                                         | Requests a state change for the virtual system migration service.<br/>                                                                                                                                               |
| [**StartService**](msvm-virtualsystemmigrationservice-startservice.md)                                                     | Starts the virtual system migration service.<br/>                                                                                                                                                                    |
| [**StopService**](msvm-virtualsystemmigrationservice-stopservice.md)                                                       | Stops the virtual system migration service.<br/>                                                                                                                                                                     |
...
The current number of in-flight storage migrations that are managed by the virtual system migration service.
...
The current number of in-flight virtual system migrations that are managed by the virtual system migration service.
...
An array that contains the IP addresses of the host that can be used for virtual system migration.
