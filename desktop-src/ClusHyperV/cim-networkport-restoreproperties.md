...
ms.assetid: '687cff89-5afc-4765-b313-1806e8232cfa'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RestoreProperties method", "RestoreProperties method, CIM_NetworkPort class", "CIM_NetworkPort class, RestoreProperties method"]
topic_type:
- apiref
api_name:
