---
title: CIM\_DVDDrive class
description: Represents a DVD drive.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '01c25968-d351-436d-9d2e-21a066c260b2'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_DVDDrive class", "CIM_DVDDrive class, described"]
topic_type:
- apiref
api_name:
- CIM_DVDDrive
- CIM_DVDDrive.InstanceID
- CIM_DVDDrive.Caption
- CIM_DVDDrive.Description
- CIM_DVDDrive.ElementName
- CIM_DVDDrive.InstallDate
- CIM_DVDDrive.Name
- CIM_DVDDrive.OperationalStatus
- CIM_DVDDrive.StatusDescriptions
- CIM_DVDDrive.Status
- CIM_DVDDrive.HealthState
- CIM_DVDDrive.CommunicationStatus
- CIM_DVDDrive.DetailedStatus
- CIM_DVDDrive.OperatingStatus
- CIM_DVDDrive.PrimaryStatus
- CIM_DVDDrive.EnabledState
- CIM_DVDDrive.OtherEnabledState
- CIM_DVDDrive.RequestedState
- CIM_DVDDrive.EnabledDefault
- CIM_DVDDrive.TimeOfLastStateChange
- CIM_DVDDrive.AvailableRequestedStates
- CIM_DVDDrive.TransitioningToState
- CIM_DVDDrive.SystemCreationClassName
- CIM_DVDDrive.SystemName
- CIM_DVDDrive.CreationClassName
- CIM_DVDDrive.DeviceID
- CIM_DVDDrive.PowerManagementSupported
- CIM_DVDDrive.PowerManagementCapabilities
- CIM_DVDDrive.Availability
- CIM_DVDDrive.StatusInfo
- CIM_DVDDrive.LastErrorCode
- CIM_DVDDrive.ErrorDescription
- CIM_DVDDrive.ErrorCleared
- CIM_DVDDrive.OtherIdentifyingInfo
- CIM_DVDDrive.PowerOnHours
- CIM_DVDDrive.TotalPowerOnHours
- CIM_DVDDrive.IdentifyingDescriptions
- CIM_DVDDrive.AdditionalAvailability
- CIM_DVDDrive.MaxQuiesceTime
- CIM_DVDDrive.Capabilities
- CIM_DVDDrive.CapabilityDescriptions
- CIM_DVDDrive.ErrorMethodology
- CIM_DVDDrive.CompressionMethod
- CIM_DVDDrive.NumberOfMediaSupported
- CIM_DVDDrive.MaxMediaSize
- CIM_DVDDrive.DefaultBlockSize
- CIM_DVDDrive.MaxBlockSize
- CIM_DVDDrive.MinBlockSize
- CIM_DVDDrive.NeedsCleaning
- CIM_DVDDrive.MediaIsLocked
- CIM_DVDDrive.Security
- CIM_DVDDrive.LastCleaned
- CIM_DVDDrive.MaxAccessTime
- CIM_DVDDrive.UncompressedDataRate
- CIM_DVDDrive.LoadTime
- CIM_DVDDrive.UnloadTime
- CIM_DVDDrive.MountCount
- CIM_DVDDrive.TimeOfLastMount
- CIM_DVDDrive.TotalMountTime
- CIM_DVDDrive.UnitsDescription
- CIM_DVDDrive.MaxUnitsBeforeCleaning
- CIM_DVDDrive.UnitsUsed
...
The **CIM\_DVDDrive** class has these methods.



| Method                                                        | Description                                                                                                                                                                                                                                                                                                                                             |
|:--------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-dvddrive-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**LockMedia**](cim-dvddrive-lockmedia.md)                   | Locks and unlocks removable media in a media access device.<br/> This method is inherited from [**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).<br/>                                                                                                                                                                                |
| [**OnlineDevice**](cim-dvddrive-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-dvddrive-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-dvddrive-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-dvddrive-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-dvddrive-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-dvddrive-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-dvddrive-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Storage Devices\|001.9", "MIF.DMTF\|Storage Devices\|001.11", "MIF.DMTF\|Storage Devices\|001.12", "MIF.DMTF\|Disks\|003.7", "MIF.DMTF\|Host Disk\|001.2", "MIF.DMTF\|Host Disk\|001.4"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).**CapabilityDescriptions**")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("KiloBytes per Second"), **PUnit** ("byte / second \* 10^3")
</dt> </dl>
