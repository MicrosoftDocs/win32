---
title: RequestStateChange method of the CIM\_UserDevice class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ceb4ffdb-865d-48e1-b33d-fdbd5fa43e8b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_UserDevice class", "CIM_UserDevice class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_UserDevice.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_UserDevice class
