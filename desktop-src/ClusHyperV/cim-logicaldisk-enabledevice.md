---
title: EnableDevice method of the CIM\_LogicalDisk class
...
ms.assetid: 'a426655a-9f6f-415c-aab6-c53aa1652630'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_LogicalDisk class", "CIM_LogicalDisk class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_LogicalDisk.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_LogicalDisk class
