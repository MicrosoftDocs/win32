...
ms.assetid: '13a27bb6-6342-4830-80bd-a81c48ff6c03'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_DisketteDrive class", "CIM_DisketteDrive class, described"]
topic_type:
- apiref
api_name:
- CIM_DisketteDrive
- CIM_DisketteDrive.InstanceID
- CIM_DisketteDrive.Caption
- CIM_DisketteDrive.Description
- CIM_DisketteDrive.ElementName
- CIM_DisketteDrive.InstallDate
- CIM_DisketteDrive.Name
- CIM_DisketteDrive.OperationalStatus
- CIM_DisketteDrive.StatusDescriptions
- CIM_DisketteDrive.Status
- CIM_DisketteDrive.HealthState
- CIM_DisketteDrive.CommunicationStatus
- CIM_DisketteDrive.DetailedStatus
- CIM_DisketteDrive.OperatingStatus
- CIM_DisketteDrive.PrimaryStatus
- CIM_DisketteDrive.EnabledState
- CIM_DisketteDrive.OtherEnabledState
- CIM_DisketteDrive.RequestedState
- CIM_DisketteDrive.EnabledDefault
- CIM_DisketteDrive.TimeOfLastStateChange
- CIM_DisketteDrive.AvailableRequestedStates
- CIM_DisketteDrive.TransitioningToState
...
- CIM_DisketteDrive.OtherIdentifyingInfo
- CIM_DisketteDrive.PowerOnHours
- CIM_DisketteDrive.TotalPowerOnHours
- CIM_DisketteDrive.IdentifyingDescriptions
- CIM_DisketteDrive.AdditionalAvailability
- CIM_DisketteDrive.MaxQuiesceTime
...
- CIM_DisketteDrive.MediaIsLocked
- CIM_DisketteDrive.Security
- CIM_DisketteDrive.LastCleaned
- CIM_DisketteDrive.MaxAccessTime
- CIM_DisketteDrive.UncompressedDataRate
- CIM_DisketteDrive.LoadTime
- CIM_DisketteDrive.UnloadTime
- CIM_DisketteDrive.MountCount
- CIM_DisketteDrive.TimeOfLastMount
- CIM_DisketteDrive.TotalMountTime
- CIM_DisketteDrive.UnitsDescription
- CIM_DisketteDrive.MaxUnitsBeforeCleaning
- CIM_DisketteDrive.UnitsUsed
api_location:
- VMMS.exe
api_type:
- DllExport
...
The **CIM\_DisketteDrive** class has these types of members:
...
The **CIM\_DisketteDrive** class has these methods.



| Method                                                             | Description                                                                                                                                                                                                                                                                                                                                             |
|:-------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-diskettedrive-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**LockMedia**](cim-diskettedrive-lockmedia.md)                   | Locks and unlocks removable media in a media access device.<br/> This method is inherited from [**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).<br/>                                                                                                                                                                                |
| [**OnlineDevice**](cim-diskettedrive-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-diskettedrive-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-diskettedrive-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-diskettedrive-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-diskettedrive-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-diskettedrive-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-diskettedrive-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
The **CIM\_DisketteDrive** class has these properties.
