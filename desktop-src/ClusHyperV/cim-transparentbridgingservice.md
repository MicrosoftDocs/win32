...
ms.assetid: 'bf3c227a-8795-4ae0-afc7-2f6fbc74a451'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_TransparentBridgingService class", "CIM_TransparentBridgingService class, described"]
topic_type:
- apiref
api_name:
- CIM_TransparentBridgingService
- CIM_TransparentBridgingService.InstanceID
- CIM_TransparentBridgingService.Caption
- CIM_TransparentBridgingService.Description
- CIM_TransparentBridgingService.ElementName
- CIM_TransparentBridgingService.InstallDate
- CIM_TransparentBridgingService.OperationalStatus
- CIM_TransparentBridgingService.StatusDescriptions
- CIM_TransparentBridgingService.Status
- CIM_TransparentBridgingService.HealthState
- CIM_TransparentBridgingService.CommunicationStatus
- CIM_TransparentBridgingService.DetailedStatus
- CIM_TransparentBridgingService.OperatingStatus
- CIM_TransparentBridgingService.PrimaryStatus
- CIM_TransparentBridgingService.EnabledState
- CIM_TransparentBridgingService.OtherEnabledState
- CIM_TransparentBridgingService.RequestedState
- CIM_TransparentBridgingService.EnabledDefault
- CIM_TransparentBridgingService.TimeOfLastStateChange
- CIM_TransparentBridgingService.AvailableRequestedStates
- CIM_TransparentBridgingService.TransitioningToState
- CIM_TransparentBridgingService.SystemCreationClassName
- CIM_TransparentBridgingService.SystemName
- CIM_TransparentBridgingService.CreationClassName
- CIM_TransparentBridgingService.Name
- CIM_TransparentBridgingService.PrimaryOwnerName
- CIM_TransparentBridgingService.PrimaryOwnerContact
- CIM_TransparentBridgingService.StartMode
- CIM_TransparentBridgingService.Started
- CIM_TransparentBridgingService.Keywords
- CIM_TransparentBridgingService.ServiceURL
- CIM_TransparentBridgingService.StartupConditions
- CIM_TransparentBridgingService.StartupParameters
- CIM_TransparentBridgingService.ProtocolType
- CIM_TransparentBridgingService.OtherProtocolType
...
The **CIM\_TransparentBridgingService** class has these methods.



| Method                                                                          | Description                                                                                                                                                                                    |
|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-transparentbridgingservice-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](cim-transparentbridgingservice-startservice.md)             | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-transparentbridgingservice-stopservice.md)               | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
This property is inherited from [**CIM\_ForwardingService**](cim-forwardingservice.md).
