...
ms.assetid: '42082a1f-2358-479b-a88d-758b7a615c89'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_VideoHead class", "CIM_VideoHead class, described"]
topic_type:
- apiref
api_name:
- CIM_VideoHead
- CIM_VideoHead.InstanceID
- CIM_VideoHead.Caption
- CIM_VideoHead.Description
- CIM_VideoHead.ElementName
- CIM_VideoHead.InstallDate
- CIM_VideoHead.Name
- CIM_VideoHead.OperationalStatus
- CIM_VideoHead.StatusDescriptions
- CIM_VideoHead.Status
- CIM_VideoHead.HealthState
- CIM_VideoHead.CommunicationStatus
- CIM_VideoHead.DetailedStatus
- CIM_VideoHead.OperatingStatus
- CIM_VideoHead.PrimaryStatus
- CIM_VideoHead.EnabledState
- CIM_VideoHead.OtherEnabledState
- CIM_VideoHead.RequestedState
- CIM_VideoHead.EnabledDefault
- CIM_VideoHead.TimeOfLastStateChange
- CIM_VideoHead.AvailableRequestedStates
- CIM_VideoHead.TransitioningToState
- CIM_VideoHead.SystemCreationClassName
- CIM_VideoHead.SystemName
- CIM_VideoHead.CreationClassName
- CIM_VideoHead.DeviceID
- CIM_VideoHead.PowerManagementSupported
- CIM_VideoHead.PowerManagementCapabilities
- CIM_VideoHead.Availability
- CIM_VideoHead.StatusInfo
- CIM_VideoHead.LastErrorCode
- CIM_VideoHead.ErrorDescription
- CIM_VideoHead.ErrorCleared
- CIM_VideoHead.OtherIdentifyingInfo
- CIM_VideoHead.PowerOnHours
- CIM_VideoHead.TotalPowerOnHours
- CIM_VideoHead.IdentifyingDescriptions
- CIM_VideoHead.AdditionalAvailability
- CIM_VideoHead.MaxQuiesceTime
...
``` syntax
[Experimental, Abstract, Version("2.10.0"), UMLPackagePath("CIM::Device::Controller")]
...
The **CIM\_VideoHead** class has these methods.



| Method                                                         | Description                                                                                                                                                                                                                                                                                                                                             |
|:---------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-videohead-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-videohead-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-videohead-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-videohead-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-videohead-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-videohead-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-videohead-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-videohead-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bits"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.12"), **PUnit** ("bit")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Pixels"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.11"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_VideoHeadResolution.HorizontalResolution"), **PUnit** ("pixel")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_VideoHeadResolution.NumberOfColors")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.14")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.13")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Hertz"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.15"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_VideoHeadResolution.RefreshRate"), **PUnit** ("hertz")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.8"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_VideoHead**.**OtherCurrentScanMode**, CIM\_VideoHeadResolution.ScanMode")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Pixels"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.10"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_VideoHeadResolution.VerticalResolution"), **PUnit** ("pixel")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Hertz"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.5"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_VideoHeadResolution.MaxRefreshRate"), **PUnit** ("hertz")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Hertz"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Video\|004.4"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_VideoHeadResolution.MinRefreshRate"), **PUnit** ("hertz")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_VideoHead**.**CurrentScanMode**, CIM\_VideoHeadResolution.OtherScanMode")
</dt> </dl>
