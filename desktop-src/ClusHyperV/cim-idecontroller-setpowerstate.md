---
title: SetPowerState method of the CIM\_IDEController class
...
ms.assetid: 'aac2f151-3be6-4afb-8689-f301e694dce3'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_IDEController class", "CIM_IDEController class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_IDEController.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_IDEController class
