...
description: Represents a collection of collections.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'c98f0333-1932-4cbe-bd63-4e4e2af4ac42'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_ManagementCollection class", "Msvm_ManagementCollection class, described"]
topic_type:
- apiref
api_name:
- Msvm_ManagementCollection
- Msvm_ManagementCollection.InstanceID
- Msvm_ManagementCollection.Caption
- Msvm_ManagementCollection.Description
