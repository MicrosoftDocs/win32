...
ms.assetid: '91573eb8-d3bf-426c-b34d-e53aa7e43f42'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RestoreProperties method", "RestoreProperties method, CIM_SCSIProtocolController class", "CIM_SCSIProtocolController class, RestoreProperties method"]
topic_type:
- apiref
api_name:
