---
title: OnlineDevice method of the CIM\_CDROMDrive class
...
ms.assetid: '555a496c-e8b4-4566-a8cc-e34e7bd25b49'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_CDROMDrive class", "CIM_CDROMDrive class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_CDROMDrive.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_CDROMDrive class
