---
title: RequestStateChange method of the CIM\_SerialController class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ae4f7f2f-d27a-4081-9ef6-ec26e5d1623b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_SerialController class", "CIM_SerialController class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_SerialController.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_SerialController class
