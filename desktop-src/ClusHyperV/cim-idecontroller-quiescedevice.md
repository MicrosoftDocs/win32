---
title: QuiesceDevice method of the CIM\_IDEController class
...
ms.assetid: 'd8ea2c9e-88c3-4d8a-a81c-d016a15eeffa'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_IDEController class", "CIM_IDEController class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_IDEController.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_IDEController class
