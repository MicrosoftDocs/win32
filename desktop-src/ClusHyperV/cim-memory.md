...
ms.assetid: 38950430-0d17-4d6d-b55a-87f15b61e535
...
keywords:
- CIM_Memory class
- CIM_Memory class, described
topic_type:
- apiref
api_name:
- CIM_Memory
- CIM_Memory.InstanceID
- CIM_Memory.Caption
- CIM_Memory.Description
- CIM_Memory.ElementName
- CIM_Memory.InstallDate
- CIM_Memory.OperationalStatus
- CIM_Memory.StatusDescriptions
- CIM_Memory.Status
- CIM_Memory.HealthState
- CIM_Memory.CommunicationStatus
- CIM_Memory.DetailedStatus
- CIM_Memory.OperatingStatus
- CIM_Memory.PrimaryStatus
- CIM_Memory.EnabledState
- CIM_Memory.OtherEnabledState
- CIM_Memory.RequestedState
- CIM_Memory.EnabledDefault
- CIM_Memory.TimeOfLastStateChange
- CIM_Memory.AvailableRequestedStates
- CIM_Memory.TransitioningToState
...
- CIM_Memory.OtherIdentifyingInfo
- CIM_Memory.PowerOnHours
- CIM_Memory.TotalPowerOnHours
- CIM_Memory.IdentifyingDescriptions
- CIM_Memory.AdditionalAvailability
- CIM_Memory.MaxQuiesceTime
- CIM_Memory.DataOrganization
- CIM_Memory.Purpose
- CIM_Memory.Access
- CIM_Memory.BlockSize
- CIM_Memory.NumberOfBlocks
- CIM_Memory.ConsumableBlocks
- CIM_Memory.IsBasedOnUnderlyingRedundancy
- CIM_Memory.SequentialAccess
- CIM_Memory.ExtentStatus
- CIM_Memory.NoSinglePointOfFailure
- CIM_Memory.DataRedundancy
- CIM_Memory.PackageRedundancy
- CIM_Memory.DeltaReservation
- CIM_Memory.Primordial
- CIM_Memory.Name
- CIM_Memory.NameFormat
- CIM_Memory.NameNamespace
- CIM_Memory.OtherNameNamespace
- CIM_Memory.OtherNameFormat
- CIM_Memory.Volatile
...
``` syntax
[Abstract, Version("2.8.0"), UMLPackagePath("CIM::Device::Memory")]
...
The **CIM\_Memory** class has these methods.



| Method                                                      | Description                                                                                                                                                                                                                                                                                                                                             |
|:------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-memory-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-memory-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-memory-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-memory-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-memory-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-memory-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-memory-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-memory-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("CIM\_MemoryError.AdditionalErrorData"), **OctetString**, [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Memory Device\|005.18", "MIF.DMTF\|Physical Memory Array\|001.13")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Operational State\|006.5", "MIB.IETF\|HOST-RESOURCES-MIB.hrDeviceStatus", "MIF.DMTF\|Host Device\|001.5"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_LogicalDevice**](cim-logicaldevice.md).**AdditionalAvailability**")
</dt> </dl>

**Deprecated description:** Contains the availability of the logical device.

This property is deprecated. Instead we recommend that you use the **CIM\_PowerManagementCapabilities** class.
...
The maximum number of blocks, that are available for use when layering [**CIM\_StorageExtent**](cim-storageextent.md) using the [**CIM\_BasedOn**](cim-basedon.md) class association. This property only has meaning when the storage extent is referenced in the **Antecedent** property in a **CIM\_BasedOn** object.
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("KiloBytes"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Memory Array Mapped Addresses\|001.4", "MIF.DMTF\|Memory Device Mapped Addresses\|001.5"), **PUnit** ("byte \* 10^3")
</dt> </dl>
...
This property is deprecated. Instead we recommend that you use the **OperationalStatus** property from the **CIM\_ManagedSystemElement** class.
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("CIM\_MemoryError.ErrorData"), **OctetString**, [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Physical Memory Array\|001.12")
</dt> </dl>
...
This property is deprecated. Instead we recommend that you use the **ErrorDescription** property from the **CIM\_DeviceErrorData** class.
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("CIM\_MemoryError.ErrorInfo"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Memory Device\|005.12", "MIF.DMTF\|Physical Memory Array\|001.8"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_Memory**.**OtherErrorDescription**")
</dt> </dl>
...
Qualifiers: [**Override**](https://msdn.microsoft.com/library/aa393650) ("ErrorMethodology"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Physical Memory Array\|001.7")
</dt> </dl>
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("CIM\_MemoryError.ErrorResolution"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bytes"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Memory Device\|005.21", "MIF.DMTF\|Physical Memory Array\|001.15"), **PUnit** ("byte")
</dt> </dl>
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("CIM\_MemoryError.ErrorTransferSize"), [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bits"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Physical Memory Array\|001.11"), **PUnit** ("bit")
</dt> </dl>
...
**true** if the underlying storage extents are members of a [**CIM\_StorageRedundancyGroup**](https://msdn.microsoft.com/library/aa388497); otherwise, **false**.
...
This property is deprecated. Instead we recommend that you use the **LastErrorCode** property from the**CIM\_DeviceErrorData** class.
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("CIM\_MemoryError.OtherErrorDescription"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_Memory**.**ErrorInfo**")
</dt> </dl>
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (256), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_LogicalDevice**](cim-logicaldevice.md).**IdentifyingDescriptions**")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("KiloBytes"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Memory Array Mapped Addresses\|001.3", "MIF.DMTF\|Memory Device Mapped Addresses\|001.4"), **PUnit** ("byte \* 10^3")
</dt> </dl>
