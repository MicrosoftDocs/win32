---
title: SetPowerState method of the CIM\_PointingDevice class
...
ms.assetid: '262edc28-575f-401b-ac54-713c9e0c9968'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_PointingDevice class", "CIM_PointingDevice class, SetPowerState method"]
topic_type:
- apiref
api_name:
...
# SetPowerState method of the CIM\_PointingDevice class
