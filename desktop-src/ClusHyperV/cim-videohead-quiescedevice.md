---
title: QuiesceDevice method of the CIM\_VideoHead class
...
ms.assetid: 'c7be585d-ca9a-4248-b3d7-e1a9fad65487'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_VideoHead class", "CIM_VideoHead class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_VideoHead.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_VideoHead class
