---
title: SetPowerState method of the CIM\_WiFiPort class
...
ms.assetid: '8088e580-922f-4a2c-8fb3-2e0d271a88cf'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_WiFiPort class", "CIM_WiFiPort class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_WiFiPort.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_WiFiPort class
