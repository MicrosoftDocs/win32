---
title: OnlineDevice method of the CIM\_SerialController class
...
ms.assetid: '790be9d8-1769-4332-8454-e022826148fc'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_SerialController class", "CIM_SerialController class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_SerialController.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_SerialController class
