---
title: EnableDevice method of the CIM\_VideoHead class
...
ms.assetid: 'e624c770-8fba-4308-a8dc-aa3068e0b5f0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_VideoHead class", "CIM_VideoHead class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_VideoHead.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_VideoHead class
