...
description: This method is deprecated. Instead we recommend that you use the SetPowerState property of the CIM\_PowerManagementService class.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f70f6d91-ada9-4a39-8806-530500ed55c4'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_LogicalPort class", "CIM_LogicalPort class, SetPowerState method"]
topic_type:
- apiref
api_name:
