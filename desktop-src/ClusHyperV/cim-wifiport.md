...
ms.assetid: '4a77c841-b963-47aa-a513-cd6e4e0273c2'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_WiFiPort class", "CIM_WiFiPort class, described"]
topic_type:
- apiref
api_name:
- CIM_WiFiPort
- CIM_WiFiPort.InstanceID
- CIM_WiFiPort.Caption
- CIM_WiFiPort.Description
- CIM_WiFiPort.ElementName
- CIM_WiFiPort.InstallDate
- CIM_WiFiPort.Name
- CIM_WiFiPort.OperationalStatus
- CIM_WiFiPort.StatusDescriptions
- CIM_WiFiPort.Status
- CIM_WiFiPort.HealthState
- CIM_WiFiPort.CommunicationStatus
- CIM_WiFiPort.DetailedStatus
- CIM_WiFiPort.OperatingStatus
- CIM_WiFiPort.PrimaryStatus
- CIM_WiFiPort.EnabledState
- CIM_WiFiPort.OtherEnabledState
- CIM_WiFiPort.RequestedState
- CIM_WiFiPort.EnabledDefault
- CIM_WiFiPort.TimeOfLastStateChange
- CIM_WiFiPort.AvailableRequestedStates
- CIM_WiFiPort.TransitioningToState
- CIM_WiFiPort.SystemCreationClassName
- CIM_WiFiPort.SystemName
- CIM_WiFiPort.CreationClassName
- CIM_WiFiPort.DeviceID
- CIM_WiFiPort.PowerManagementSupported
- CIM_WiFiPort.PowerManagementCapabilities
- CIM_WiFiPort.Availability
- CIM_WiFiPort.StatusInfo
- CIM_WiFiPort.LastErrorCode
- CIM_WiFiPort.ErrorDescription
- CIM_WiFiPort.ErrorCleared
- CIM_WiFiPort.OtherIdentifyingInfo
- CIM_WiFiPort.PowerOnHours
- CIM_WiFiPort.TotalPowerOnHours
- CIM_WiFiPort.IdentifyingDescriptions
- CIM_WiFiPort.AdditionalAvailability
- CIM_WiFiPort.MaxQuiesceTime
- CIM_WiFiPort.RequestedSpeed
- CIM_WiFiPort.UsageRestriction
- CIM_WiFiPort.OtherPortType
- CIM_WiFiPort.OtherNetworkPortType
- CIM_WiFiPort.PortNumber
- CIM_WiFiPort.LinkTechnology
- CIM_WiFiPort.OtherLinkTechnology
- CIM_WiFiPort.FullDuplex
- CIM_WiFiPort.AutoSense
- CIM_WiFiPort.SupportedMaximumTransmissionUnit
- CIM_WiFiPort.ActiveMaximumTransmissionUnit
- CIM_WiFiPort.Speed
...
``` syntax
[Abstract, Version("2.22.0"), UMLPackagePath("CIM::Device::Ports")]
...
The **CIM\_WiFiPort** class has these methods.



| Method                                                        | Description                                                                                                                                                                                                                                                                                                                                             |
|:--------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-wifiport-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-wifiport-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-wifiport-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-wifiport-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-wifiport-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-wifiport-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-wifiport-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-wifiport-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
