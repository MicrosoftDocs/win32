...
description: Represents a service that manages reference points of virtual system collections.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 1697dbbb-f696-4931-b25e-e3185f44d1dc
...
- Msvm_CollectionReferencePointService class, described
topic_type:
- apiref
api_name:
- Msvm_CollectionReferencePointService
- Msvm_CollectionReferencePointService.InstanceID
- Msvm_CollectionReferencePointService.Caption
- Msvm_CollectionReferencePointService.Description
- Msvm_CollectionReferencePointService.ElementName
- Msvm_CollectionReferencePointService.InstallDate
- Msvm_CollectionReferencePointService.OperationalStatus
- Msvm_CollectionReferencePointService.StatusDescriptions
- Msvm_CollectionReferencePointService.Status
- Msvm_CollectionReferencePointService.HealthState
- Msvm_CollectionReferencePointService.CommunicationStatus
- Msvm_CollectionReferencePointService.DetailedStatus
- Msvm_CollectionReferencePointService.OperatingStatus
- Msvm_CollectionReferencePointService.PrimaryStatus
- Msvm_CollectionReferencePointService.EnabledState
- Msvm_CollectionReferencePointService.OtherEnabledState
- Msvm_CollectionReferencePointService.RequestedState
- Msvm_CollectionReferencePointService.EnabledDefault
- Msvm_CollectionReferencePointService.TimeOfLastStateChange
- Msvm_CollectionReferencePointService.AvailableRequestedStates
- Msvm_CollectionReferencePointService.TransitioningToState
- Msvm_CollectionReferencePointService.SystemCreationClassName
- Msvm_CollectionReferencePointService.SystemName
- Msvm_CollectionReferencePointService.CreationClassName
- Msvm_CollectionReferencePointService.Name
- Msvm_CollectionReferencePointService.PrimaryOwnerName
- Msvm_CollectionReferencePointService.PrimaryOwnerContact
- Msvm_CollectionReferencePointService.StartMode
- Msvm_CollectionReferencePointService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
| [**DestroyReferencePoint**](msvm-collectionreferencepointservice-destroyreferencepoint.md) | Deletes a reference point collection.<br/>                                                                                                                                               |
| [**ExportReferencePoint**](msvm-collectionreferencepointservice-exportreferencepoint.md)   | Exports a reference point collection to a file.<br/>                                                                                                                                     |
| [**RemoveAssociatedData**](msvm-collectionreferencepointservice-removeassociateddata.md)   | Removes the data log associated with a reference point.<br/>                                                                                                                             |
| [**RequestStateChange**](msvm-collectionreferencepointservice-requeststatechange.md)       | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](msvm-collectionreferencepointservice-startservice.md)                   | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](msvm-collectionreferencepointservice-stopservice.md)                     | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
The **Msvm\_CollectionReferencePointService** class has these properties.
