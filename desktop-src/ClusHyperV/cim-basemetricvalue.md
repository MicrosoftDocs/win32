...
ms.assetid: '68af2681-6900-499a-8630-e9c72d5d3fe7'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_BaseMetricValue class", "CIM_BaseMetricValue class, described"]
topic_type:
- apiref
api_name:
- CIM_BaseMetricValue
- CIM_BaseMetricValue.Caption
- CIM_BaseMetricValue.Description
- CIM_BaseMetricValue.ElementName
...
Since the gathering of metric information can involve large quantities of information there may be many instances of this class. The use of this class as an instrumentation source may be inefficient unless the rate of metrics are known. The length of time a **CIM\_BaseMetricValue** instance exists after the metric information is captured without being defined, and is implementation dependent.

Most metric data values change over time. There are two ways of mapping this data into **CIM\_BaseMetricValue** objects. The value for the next point in time may use the same object and just change its properties (such as the value or timestamp), or the existing objects remain unchanged and a new object is created for the new point in time. The first method is typically used for snapshot data and the second method for historical data. The method used, is indicated by the **Volatile** property.
...
``` syntax
[Abstract, Version("2.19.0"), UMLPackagePath("CIM::Metrics::BaseMetric")]
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_BaseMetricDefinition**](cim-basemetricdefinition.md).**TimeScope**", "**CIM\_BaseMetricValue**.**TimeStamp**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_BaseMetricDefinition**](cim-basemetricdefinition.md).**TimeScope**", "**CIM\_BaseMetricValue**.**Duration**")
</dt> </dl>
