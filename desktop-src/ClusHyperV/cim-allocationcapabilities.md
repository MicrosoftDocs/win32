...
ms.assetid: '0f353dff-c991-447c-bc07-b2d8da04fcb0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_AllocationCapabilities class", "CIM_AllocationCapabilities class, described"]
topic_type:
- apiref
api_name:
- CIM_AllocationCapabilities
- CIM_AllocationCapabilities.Caption
- CIM_AllocationCapabilities.Description
- CIM_AllocationCapabilities.InstanceID
- CIM_AllocationCapabilities.ElementName
...
The **CIM\_AllocationCapabilities** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_AllocationCapabilities** class has these properties.
...
<span id="Specific"></span><span id="specific"></span><span id="SPECIFIC"></span>**Specific** (2)
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_AllocationCapabilities**.**OtherResourceType**", "[**CIM\_ResourceAllocationSettingData**](cim-resourceallocationsettingdata.md).**ResourceType**")
</dt> </dl>
