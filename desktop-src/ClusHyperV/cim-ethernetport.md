...
ms.assetid: '103afd3f-8e59-4afd-9964-d613f575ebf5'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_EthernetPort class", "CIM_EthernetPort class, described"]
topic_type:
- apiref
api_name:
- CIM_EthernetPort
- CIM_EthernetPort.InstanceID
...
- CIM_EthernetPort.CommunicationStatus
- CIM_EthernetPort.DetailedStatus
- CIM_EthernetPort.OperatingStatus
- CIM_EthernetPort.PrimaryStatus
...
- CIM_EthernetPort.AvailableRequestedStates
- CIM_EthernetPort.TransitioningToState
...
| Method                                                            | Description                                                                                                                                                                                                                                                                                                                                             |
|:------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-ethernetport-enabledevice.md)             | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> **Deprecated description:** Enables or disables the logical device.<br/>                                                                     |
| [**OnlineDevice**](cim-ethernetport-onlinedevice.md)             | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> |
| [**QuiesceDevice**](cim-ethernetport-quiescedevice.md)           | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/>                            |
| [**RequestStateChange**](cim-ethernetport-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-ethernetport-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-ethernetport-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-ethernetport-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-ethernetport-setpowerstate.md)           | Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> **Deprecated description:** Sets the power state of the logical device.<br/>                                                  |
