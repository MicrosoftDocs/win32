---
title: SetPowerState method of the CIM\_CDROMDrive class
...
ms.assetid: 'aa297fc7-757b-42c5-92dc-55ba002207e9'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_CDROMDrive class", "CIM_CDROMDrive class, SetPowerState method"]
topic_type:
- apiref
api_name:
...
# SetPowerState method of the CIM\_CDROMDrive class
