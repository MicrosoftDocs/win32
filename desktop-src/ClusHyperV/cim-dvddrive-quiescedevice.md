---
title: QuiesceDevice method of the CIM\_DVDDrive class
...
ms.assetid: '4c2411b1-b391-41a0-a540-8892a5ef9af4'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_DVDDrive class", "CIM_DVDDrive class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_DVDDrive.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_DVDDrive class
