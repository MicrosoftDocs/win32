...
keywords: ["CheckVirtualSystemIsMigratableToHost method", "CheckVirtualSystemIsMigratableToHost method, CIM_VirtualSystemMigrationService class", "CIM_VirtualSystemMigrationService class, CheckVirtualSystemIsMigratableToHost method"]
topic_type:
- apiref
api_name:
