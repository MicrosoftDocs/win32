---
title: RequestStateChange method of the Msvm\_CollectionReplicationService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '88c658ea-35ee-4585-9fe7-ce7a41bd27ea'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, Msvm_CollectionReplicationService class", "Msvm_CollectionReplicationService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- Msvm_CollectionReplicationService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the Msvm\_CollectionReplicationService class
