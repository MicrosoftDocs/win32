---
title: SetPowerState method of the CIM\_DesktopMonitor class
...
ms.assetid: '74ddf4cc-8daf-41ed-a2c4-6fa24f12a8d5'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_DesktopMonitor class", "CIM_DesktopMonitor class, SetPowerState method"]
topic_type:
- apiref
api_name:
...
# SetPowerState method of the CIM\_DesktopMonitor class
