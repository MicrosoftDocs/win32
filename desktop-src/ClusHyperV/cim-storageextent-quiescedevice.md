...
ms.assetid: '0388b726-66ef-4320-934c-7007dd9a3829'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_StorageExtent class", "CIM_StorageExtent class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
