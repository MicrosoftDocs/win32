...
ms.assetid: b333d65f-2b06-4838-aa1f-022b25f69200
...
- CIM_System.CommunicationStatus
- CIM_System.DetailedStatus
- CIM_System.OperatingStatus
- CIM_System.PrimaryStatus
...
- CIM_System.AvailableRequestedStates
- CIM_System.TransitioningToState
...
Indicates the possible values for the *RequestedState* parameter of the [**RequestStateChange**](cim-system-requeststatechange.md) method.
