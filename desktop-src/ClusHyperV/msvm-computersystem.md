...
ms.assetid: '4e465667-b93b-4045-9a7a-b8ca01b826a7'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_ComputerSystem class", "Msvm_ComputerSystem class, described"]
topic_type:
- apiref
api_name:
- Msvm_ComputerSystem
...
| Method                                                                                         | Description                                                                                                                                                                                                                                                                                                      |
|:-----------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**InjectNonMaskableInterrupt**](msvm-computersystem-injectnonmaskableinterrupt.md)           | Injects a non-maskable interrupt into the virtual machine.<br/>                                                                                                                                                                                                                                            |
| [**RequestReplicationStateChange**](msvm-computersystem-requestreplicationstatechange.md)     | Requests a state change to the replication of the computer system.<br/>                                                                                                                                                                                                                                    |
| [**RequestReplicationStateChangeEx**](msvm-computersystem-requestreplicationstatechangeex.md) | Requests a state change to the replication of the computer system.<br/>                                                                                                                                                                                                                                    |
| [**RequestStateChange**](msvm-computersystem-requeststatechange.md)                           | Requests a state change on the computer system.<br/>                                                                                                                                                                                                                                                       |
| [**SetPowerState**](msvm-computersystem-setpowerstate.md)                                     | This method is deprecated. Instead, use the **RequestPowerStateChange** method in the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_ComputerSystem**](cim-computersystem.md).<br/> **Deprecated description:** Sets the power state of the computer.<br/> |
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("[**Msvm\_ReplicationRelationship**](https://msdn.microsoft.com/library/windows/desktop/dn280621).**FailedOverReplicationType**")
</dt> </dl>

The type of failover that was performed for the virtual machine.
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_System**](cim-system.md).**OtherIdentifyingInfo**")
</dt> </dl>
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("[**Msvm\_ReplicationRelationship**](https://msdn.microsoft.com/library/windows/desktop/dn280621).**LastApplicationConsistentReplicationTime**")
</dt> </dl>

The time when the last application consistent replication is received for recovery of the virtual machine.
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("[**Msvm\_ReplicationRelationship**](https://msdn.microsoft.com/library/windows/desktop/dn280621).**LastReplicationTime**")
</dt> </dl>

The time when the last replication was received for recovery of the virtual machine.
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("[**Msvm\_ReplicationRelationship**](https://msdn.microsoft.com/library/windows/desktop/dn280621).**LastReplicationType**")
</dt> </dl>
...
The time when the last successful backup has completed for the virtual machine.
...
The number of non-uniform memory access (NUMA) nodes of the computer system. When **Msvm\_ComputerSystem** represents the hosting computer system, this property contains the count of physical NUMA nodes. When **Msvm\_ComputerSystem** represents a virtual computer system, this property contains the number of virtual NUMA nodes that are presented to the guest OS through the ACPI System Resource Affinity Table (SRAT).
...
Qualifiers: [**ArrayType**](https://msdn.microsoft.com/library/aa393650) ("Indexed"), [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (256), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_System**](cim-system.md).**IdentifyingDescriptions**")
</dt> </dl>
...
This property is deprecated. Instead, use the **PowerChangeCapabilities** method in the **CIM\_PowerManagementCapabilitiesCIM\_PowerManagementService** class.
...
The identifier of the process in which this virtual machine is running. This value can be used to uniquely identify the instance of Vmwp.exe on the system that is running the virtual machine.
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("[**Msvm\_ReplicationRelationship**](https://msdn.microsoft.com/library/windows/desktop/dn280621).**ReplicationHealth**")
</dt> </dl>
...
The replication type for the virtual machine.
...
Qualifiers: [**Deprecated**](https://msdn.microsoft.com/library/aa393651) ("[**Msvm\_ReplicationRelationship**](https://msdn.microsoft.com/library/windows/desktop/dn280621).**ReplicationState**")
</dt> </dl>

The replication state of the virtual machine.
...
Hardware reset is not supported.
