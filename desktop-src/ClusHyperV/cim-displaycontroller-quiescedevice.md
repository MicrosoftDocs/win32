---
title: QuiesceDevice method of the CIM\_DisplayController class
...
ms.assetid: 'ea8ce5ef-e560-40d5-b757-630dc9e3ff4f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_DisplayController class", "CIM_DisplayController class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_DisplayController.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_DisplayController class
