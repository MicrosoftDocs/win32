...
ms.assetid: 'a0ba71e2-935f-4a16-b2a7-21c214abd60c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RestoreProperties method", "RestoreProperties method, CIM_EthernetPort class", "CIM_EthernetPort class, RestoreProperties method"]
topic_type:
- apiref
api_name:
