---
title: OnlineDevice method of the CIM\_LogicalDisk class
...
ms.assetid: '808e08ee-4631-4304-a531-81373e0a489f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_LogicalDisk class", "CIM_LogicalDisk class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_LogicalDisk.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_LogicalDisk class
