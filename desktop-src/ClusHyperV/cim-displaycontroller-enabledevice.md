---
title: EnableDevice method of the CIM\_DisplayController class
...
ms.assetid: '31163a2b-3ff4-4fc9-b66c-4cdb3201ab4a'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_DisplayController class", "CIM_DisplayController class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_DisplayController.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_DisplayController class
