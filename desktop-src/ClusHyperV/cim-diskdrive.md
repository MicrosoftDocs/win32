---
title: CIM\_DiskDrive class
description: Represents a disk drive.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'a80dbaf4-c4b1-468f-a005-1401f8282b20'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_DiskDrive class", "CIM_DiskDrive class, described"]
topic_type:
- apiref
api_name:
- CIM_DiskDrive
- CIM_DiskDrive.InstanceID
- CIM_DiskDrive.Caption
- CIM_DiskDrive.Description
- CIM_DiskDrive.ElementName
- CIM_DiskDrive.InstallDate
- CIM_DiskDrive.Name
- CIM_DiskDrive.OperationalStatus
- CIM_DiskDrive.StatusDescriptions
- CIM_DiskDrive.Status
- CIM_DiskDrive.HealthState
- CIM_DiskDrive.CommunicationStatus
- CIM_DiskDrive.DetailedStatus
- CIM_DiskDrive.OperatingStatus
- CIM_DiskDrive.PrimaryStatus
- CIM_DiskDrive.EnabledState
- CIM_DiskDrive.OtherEnabledState
- CIM_DiskDrive.RequestedState
- CIM_DiskDrive.EnabledDefault
- CIM_DiskDrive.TimeOfLastStateChange
- CIM_DiskDrive.AvailableRequestedStates
- CIM_DiskDrive.TransitioningToState
...
- CIM_DiskDrive.OtherIdentifyingInfo
- CIM_DiskDrive.PowerOnHours
- CIM_DiskDrive.TotalPowerOnHours
- CIM_DiskDrive.IdentifyingDescriptions
- CIM_DiskDrive.AdditionalAvailability
- CIM_DiskDrive.MaxQuiesceTime
...
- CIM_DiskDrive.MediaIsLocked
- CIM_DiskDrive.Security
- CIM_DiskDrive.LastCleaned
- CIM_DiskDrive.MaxAccessTime
- CIM_DiskDrive.UncompressedDataRate
- CIM_DiskDrive.LoadTime
- CIM_DiskDrive.UnloadTime
- CIM_DiskDrive.MountCount
- CIM_DiskDrive.TimeOfLastMount
- CIM_DiskDrive.TotalMountTime
- CIM_DiskDrive.UnitsDescription
- CIM_DiskDrive.MaxUnitsBeforeCleaning
- CIM_DiskDrive.UnitsUsed
api_location:
- VMMS.exe
api_type:
- DllExport
...
The **CIM\_DiskDrive** class has these types of members:
...
The **CIM\_DiskDrive** class has these methods.



| Method                                                         | Description                                                                                                                                                                                                                                                                                                                                             |
|:---------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-diskdrive-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**LockMedia**](cim-diskdrive-lockmedia.md)                   | Locks and unlocks removable media in a media access device.<br/> This method is inherited from [**CIM\_MediaAccessDevice**](cim-mediaaccessdevice.md).<br/>                                                                                                                                                                                |
| [**OnlineDevice**](cim-diskdrive-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-diskdrive-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-diskdrive-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-diskdrive-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-diskdrive-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-diskdrive-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-diskdrive-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
The **CIM\_DiskDrive** class has these properties.
