---
title: RequestStateChange method of the CIM\_PointingDevice class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '4ed675c3-46d5-49b2-8c95-c785db20507d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_PointingDevice class", "CIM_PointingDevice class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_PointingDevice.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_PointingDevice class
