---
title: RequestStateChange method of the CIM\_IDEController class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'aab0250c-2090-481e-8310-2b62752cbe13'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_IDEController class", "CIM_IDEController class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_IDEController.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_IDEController class
