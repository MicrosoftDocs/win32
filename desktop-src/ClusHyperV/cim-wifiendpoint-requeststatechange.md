---
title: RequestStateChange method of the CIM\_WiFiEndpoint class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '4a57a0a2-13d6-4da5-89e4-e0a43b3e8f5f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_WiFiEndpoint class", "CIM_WiFiEndpoint class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_WiFiEndpoint.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_WiFiEndpoint class
