---
title: RequestStateChange method of the CIM\_SwitchService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'da43c1f2-492c-4cc0-bb3e-6ae26fefb596'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_SwitchService class", "CIM_SwitchService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_SwitchService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_SwitchService class
