...
ms.assetid: '544c54f4-f3b2-4015-8db2-e571952ccec9'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_StorageExtent class", "CIM_StorageExtent class, EnableDevice method"]
topic_type:
- apiref
api_name:
