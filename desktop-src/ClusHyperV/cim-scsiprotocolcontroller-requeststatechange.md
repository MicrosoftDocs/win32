...
ms.assetid: '9a06b95b-3199-4e2c-bea9-62e277b80c18'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_SCSIProtocolController class", "CIM_SCSIProtocolController class, RequestStateChange method"]
topic_type:
- apiref
api_name:
