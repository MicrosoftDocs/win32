---
title: SetPowerState method of the CIM\_DisplayController class
...
ms.assetid: 'e58eb487-4597-43e2-8885-d998fb0620a4'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_DisplayController class", "CIM_DisplayController class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_DisplayController.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_DisplayController class
