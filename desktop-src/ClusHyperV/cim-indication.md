...
api_name:
- CIM_Indication
- CIM_Indication.SECURITY_DESCRIPTOR
- CIM_Indication.TIME_CREATED
...
To receive an indication, a subscriber must create the following instances for the notification:

-   **CIM\_IndicationFilter**
-   **CIM\_ListenerDestination**
