...
keywords: ["ModifyDiskMergeSettings method", "ModifyDiskMergeSettings method, Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class, ModifyDiskMergeSettings method"]
topic_type:
- apiref
api_name:
