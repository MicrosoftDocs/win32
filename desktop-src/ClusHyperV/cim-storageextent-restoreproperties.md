...
ms.assetid: 'fcaaa578-cbc4-48b6-948c-44439da0803f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RestoreProperties method", "RestoreProperties method, CIM_StorageExtent class", "CIM_StorageExtent class, RestoreProperties method"]
topic_type:
- apiref
api_name:
