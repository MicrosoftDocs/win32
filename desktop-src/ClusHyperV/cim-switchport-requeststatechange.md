---
title: RequestStateChange method of the CIM\_SwitchPort class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '35694ced-4f94-4d7c-b54d-e4a2b58a759d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_SwitchPort class", "CIM_SwitchPort class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_SwitchPort.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_SwitchPort class
