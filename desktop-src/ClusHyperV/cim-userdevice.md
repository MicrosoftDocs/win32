...
ms.assetid: 'bf76fc87-975b-4401-a645-cee6d63ebff8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_UserDevice class", "CIM_UserDevice class, described"]
topic_type:
- apiref
api_name:
- CIM_UserDevice
- CIM_UserDevice.InstanceID
- CIM_UserDevice.Caption
- CIM_UserDevice.Description
- CIM_UserDevice.ElementName
- CIM_UserDevice.InstallDate
- CIM_UserDevice.Name
- CIM_UserDevice.OperationalStatus
- CIM_UserDevice.StatusDescriptions
- CIM_UserDevice.Status
- CIM_UserDevice.HealthState
- CIM_UserDevice.CommunicationStatus
- CIM_UserDevice.DetailedStatus
- CIM_UserDevice.OperatingStatus
- CIM_UserDevice.PrimaryStatus
- CIM_UserDevice.EnabledState
- CIM_UserDevice.OtherEnabledState
- CIM_UserDevice.RequestedState
- CIM_UserDevice.EnabledDefault
- CIM_UserDevice.TimeOfLastStateChange
- CIM_UserDevice.AvailableRequestedStates
- CIM_UserDevice.TransitioningToState
...
- CIM_UserDevice.OtherIdentifyingInfo
- CIM_UserDevice.PowerOnHours
- CIM_UserDevice.TotalPowerOnHours
- CIM_UserDevice.IdentifyingDescriptions
- CIM_UserDevice.AdditionalAvailability
- CIM_UserDevice.MaxQuiesceTime
...
The **CIM\_UserDevice** class has these methods.



| Method                                                          | Description                                                                                                                                                                                                                                                                                                                                             |
|:----------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-userdevice-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-userdevice-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-userdevice-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-userdevice-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-userdevice-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-userdevice-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-userdevice-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-userdevice-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
