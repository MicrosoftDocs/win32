---
title: OnlineDevice method of the CIM\_DVDDrive class
...
ms.assetid: '6f5627d7-a017-4a8f-8314-5449d582490f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_DVDDrive class", "CIM_DVDDrive class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_DVDDrive.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_DVDDrive class
