...
ms.assetid: '4948a3f0-006e-4368-bee9-27eb21d5521c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_Display class", "CIM_Display class, SetPowerState method"]
topic_type:
- apiref
api_name:
