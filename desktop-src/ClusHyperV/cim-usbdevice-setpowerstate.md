---
title: SetPowerState method of the CIM\_USBDevice class
...
ms.assetid: '315d1118-53e3-4201-803e-51733c7006f9'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_USBDevice class", "CIM_USBDevice class, SetPowerState method"]
topic_type:
- apiref
api_name:
...
# SetPowerState method of the CIM\_USBDevice class
