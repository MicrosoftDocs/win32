---
title: RequestStateChange method of the CIM\_USBDevice class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ed662c06-a956-45b5-abf4-5445a3343dca'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_USBDevice class", "CIM_USBDevice class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_USBDevice.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_USBDevice class
