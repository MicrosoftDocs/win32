...
api_name:
- CIM_VLANEndpoint
- CIM_VLANEndpoint.InstanceID
- CIM_VLANEndpoint.Caption
- CIM_VLANEndpoint.ElementName
- CIM_VLANEndpoint.InstallDate
- CIM_VLANEndpoint.StatusDescriptions
- CIM_VLANEndpoint.Status
- CIM_VLANEndpoint.HealthState
- CIM_VLANEndpoint.CommunicationStatus
- CIM_VLANEndpoint.DetailedStatus
- CIM_VLANEndpoint.OperatingStatus
- CIM_VLANEndpoint.PrimaryStatus
- CIM_VLANEndpoint.OtherEnabledState
- CIM_VLANEndpoint.RequestedState
- CIM_VLANEndpoint.EnabledDefault
- CIM_VLANEndpoint.AvailableRequestedStates
- CIM_VLANEndpoint.TransitioningToState
- CIM_VLANEndpoint.SystemCreationClassName
- CIM_VLANEndpoint.SystemName
- CIM_VLANEndpoint.CreationClassName
- CIM_VLANEndpoint.Description
- CIM_VLANEndpoint.OperationalStatus
- CIM_VLANEndpoint.EnabledState
- CIM_VLANEndpoint.TimeOfLastStateChange
- CIM_VLANEndpoint.Name
- CIM_VLANEndpoint.NameFormat
- CIM_VLANEndpoint.ProtocolType
- CIM_VLANEndpoint.ProtocolIFType
- CIM_VLANEndpoint.OtherTypeDescription
...
The **CIM\_VLANEndpoint** class has these methods.



| Method                                                            | Description                                                                                                                                                                                    |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-vlanendpoint-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
...
The endpoint will never be placed in a trunking mode.

</dd> <dt>

<span id="802.1q"></span><span id="802.1Q"></span>

<span id="802.1Q"></span>**802.1q** (3)
...
The result of the negotiation between this interface and its neighbor.
