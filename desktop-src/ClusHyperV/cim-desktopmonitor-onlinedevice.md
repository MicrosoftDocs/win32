---
title: OnlineDevice method of the CIM\_DesktopMonitor class
...
ms.assetid: 'edef8d9c-c913-4979-8299-8c4ef6c7a40a'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_DesktopMonitor class", "CIM_DesktopMonitor class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_DesktopMonitor.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_DesktopMonitor class
