...
keywords: ["RemoveBootSourceSettings method", "RemoveBootSourceSettings method, Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class, RemoveBootSourceSettings method"]
topic_type:
- apiref
api_name:
