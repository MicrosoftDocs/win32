---
title: OnlineDevice method of the CIM\_VideoHead class
...
ms.assetid: '17ce3e89-f7a2-4ca2-9a59-da855aa346b0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_VideoHead class", "CIM_VideoHead class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_VideoHead.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_VideoHead class
