---
title: RequestStateChange method of the CIM\_DisketteDrive class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '384fa4d8-964b-40a2-82bd-a266254fc335'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_DisketteDrive class", "CIM_DisketteDrive class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_DisketteDrive.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_DisketteDrive class
