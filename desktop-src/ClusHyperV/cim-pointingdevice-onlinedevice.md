---
title: OnlineDevice method of the CIM\_PointingDevice class
...
ms.assetid: '1b6b3ad9-5151-47dd-972f-7ad5d954aba8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_PointingDevice class", "CIM_PointingDevice class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_PointingDevice.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_PointingDevice class
