...
ms.assetid: '10029e91-6e3b-45ac-828b-27a61393a1b2'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_LogicalDisk class", "CIM_LogicalDisk class, described"]
topic_type:
- apiref
api_name:
- CIM_LogicalDisk
- CIM_LogicalDisk.InstanceID
...
- CIM_LogicalDisk.StatusDescriptions
- CIM_LogicalDisk.Status
- CIM_LogicalDisk.HealthState
- CIM_LogicalDisk.CommunicationStatus
- CIM_LogicalDisk.DetailedStatus
- CIM_LogicalDisk.OperatingStatus
- CIM_LogicalDisk.PrimaryStatus
- CIM_LogicalDisk.EnabledState
- CIM_LogicalDisk.OtherEnabledState
- CIM_LogicalDisk.RequestedState
- CIM_LogicalDisk.EnabledDefault
- CIM_LogicalDisk.TimeOfLastStateChange
- CIM_LogicalDisk.AvailableRequestedStates
- CIM_LogicalDisk.TransitioningToState
...
- CIM_LogicalDisk.PowerOnHours
- CIM_LogicalDisk.TotalPowerOnHours
- CIM_LogicalDisk.IdentifyingDescriptions
- CIM_LogicalDisk.AdditionalAvailability
- CIM_LogicalDisk.MaxQuiesceTime
- CIM_LogicalDisk.DataOrganization
...
- CIM_LogicalDisk.IsBasedOnUnderlyingRedundancy
- CIM_LogicalDisk.SequentialAccess
...
- CIM_LogicalDisk.OtherNameNamespace
- CIM_LogicalDisk.OtherNameFormat
...
``` syntax
[Abstract, Version("2.15.0"), UMLPackagePath("CIM::Device::StorageExtents")]
...
| Method                                                           | Description                                                                                                                                                                                                                                                                                                                                             |
|:-----------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-logicaldisk-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-logicaldisk-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-logicaldisk-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-logicaldisk-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-logicaldisk-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-logicaldisk-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-logicaldisk-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-logicaldisk-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
