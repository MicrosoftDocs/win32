---
title: RequestStateChange method of the Msvm\_CollectionManagementService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '9c0c3b25-c6d0-481e-813e-83a5244e9296'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, Msvm_CollectionManagementService class", "Msvm_CollectionManagementService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- Msvm_CollectionManagementService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the Msvm\_CollectionManagementService class
