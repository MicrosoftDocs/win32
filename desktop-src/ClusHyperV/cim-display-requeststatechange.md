---
title: RequestStateChange method of the CIM\_Display class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '91d25d7e-a27d-4129-8fe0-53b1eb691f6b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_Display class", "CIM_Display class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_Display.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_Display class
