---
title: QuiesceDevice method of the CIM\_PointingDevice class
...
ms.assetid: 'd76a0c8a-b4ba-46c0-8eeb-80fa0e78410b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_PointingDevice class", "CIM_PointingDevice class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_PointingDevice.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_PointingDevice class
