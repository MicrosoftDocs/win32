...
ms.assetid: '09c4b99a-5c91-476e-a55e-b149b921e37b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_LogicalPort class", "CIM_LogicalPort class, RequestStateChange method"]
topic_type:
- apiref
api_name:
