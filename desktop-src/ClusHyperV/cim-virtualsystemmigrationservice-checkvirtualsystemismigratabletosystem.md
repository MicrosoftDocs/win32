...
- CheckVirtualSystemIsMigratableToSystem method, CIM_VirtualSystemMigrationService class
- CIM_VirtualSystemMigrationService class, CheckVirtualSystemIsMigratableToSystem method
topic_type:
- apiref
api_name:
