...
ms.assetid: 'b1e4bfc6-e071-4aa4-8519-6b83b9cace03'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_NetworkService class", "CIM_NetworkService class, described"]
topic_type:
- apiref
api_name:
- CIM_NetworkService
- CIM_NetworkService.InstanceID
- CIM_NetworkService.Caption
- CIM_NetworkService.Description
- CIM_NetworkService.ElementName
- CIM_NetworkService.InstallDate
- CIM_NetworkService.OperationalStatus
- CIM_NetworkService.StatusDescriptions
- CIM_NetworkService.Status
- CIM_NetworkService.HealthState
- CIM_NetworkService.CommunicationStatus
- CIM_NetworkService.DetailedStatus
- CIM_NetworkService.OperatingStatus
- CIM_NetworkService.PrimaryStatus
- CIM_NetworkService.EnabledState
- CIM_NetworkService.OtherEnabledState
- CIM_NetworkService.RequestedState
- CIM_NetworkService.EnabledDefault
- CIM_NetworkService.TimeOfLastStateChange
- CIM_NetworkService.AvailableRequestedStates
- CIM_NetworkService.TransitioningToState
- CIM_NetworkService.SystemCreationClassName
- CIM_NetworkService.SystemName
- CIM_NetworkService.CreationClassName
- CIM_NetworkService.Name
- CIM_NetworkService.PrimaryOwnerName
- CIM_NetworkService.PrimaryOwnerContact
- CIM_NetworkService.StartMode
- CIM_NetworkService.Started
...
> [!Note]  
> Deprecated description: Represents a service that manages network functionality.
...
``` syntax
[Deprecated("CIM_Service"), Abstract, Version("2.7.0"), UMLPackagePath("CIM::Network::RoutingForwarding")]
...
The **CIM\_NetworkService** class has these methods.



| Method                                                              | Description                                                                                                                                                                                    |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-networkservice-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](cim-networkservice-startservice.md)             | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-networkservice-stopservice.md)               | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
