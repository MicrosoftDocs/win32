---
title: RequestStateChange method of the CIM\_FCPort class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ea5a4ccd-9b7e-43db-9d2c-e79f5079219c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_FCPort class", "CIM_FCPort class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_FCPort.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_FCPort class
