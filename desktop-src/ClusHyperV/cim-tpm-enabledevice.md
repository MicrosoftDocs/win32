---
title: EnableDevice method of the CIM\_TPM class
...
ms.assetid: 'b6fb8b62-7ad7-4d1f-a270-fcfa5974fdff'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_TPM class", "CIM_TPM class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_TPM.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_TPM class
