---
title: RequestStateChange method of the CIM\_TapeDrive class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '8cb63bd6-0d56-435a-8682-cef0fffc20d8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_TapeDrive class", "CIM_TapeDrive class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_TapeDrive.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_TapeDrive class
