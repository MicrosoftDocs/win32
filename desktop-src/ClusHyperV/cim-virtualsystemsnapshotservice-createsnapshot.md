...
keywords: ["CreateSnapshot method", "CreateSnapshot method, CIM_VirtualSystemSnapshotService class", "CIM_VirtualSystemSnapshotService class, CreateSnapshot method"]
topic_type:
- apiref
api_name:
