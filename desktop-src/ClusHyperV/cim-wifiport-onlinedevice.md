---
title: OnlineDevice method of the CIM\_WiFiPort class
...
ms.assetid: 'cae088d1-b0e8-487b-9f06-1c57107a8cc5'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_WiFiPort class", "CIM_WiFiPort class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_WiFiPort.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_WiFiPort class
