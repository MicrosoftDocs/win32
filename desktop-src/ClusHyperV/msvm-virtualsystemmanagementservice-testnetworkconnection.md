...
keywords: ["TestNetworkConnection method", "TestNetworkConnection method, Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class, TestNetworkConnection method"]
topic_type:
- apiref
api_name:
