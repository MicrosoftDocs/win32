---
title: SetPowerState method of the CIM\_UserDevice class
...
ms.assetid: '3148c407-bd17-49ef-90ed-1d1a91405938'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_UserDevice class", "CIM_UserDevice class, SetPowerState method"]
topic_type:
- apiref
api_name:
