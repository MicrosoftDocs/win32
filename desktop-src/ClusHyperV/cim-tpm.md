...
ms.assetid: 'f32d0ade-83f6-4585-8998-4998313565da'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_TPM class", "CIM_TPM class, described"]
topic_type:
- apiref
api_name:
- CIM_TPM
...
- CIM_TPM.InstallDate
- CIM_TPM.Name
- CIM_TPM.OperationalStatus
- CIM_TPM.StatusDescriptions
- CIM_TPM.Status
- CIM_TPM.HealthState
- CIM_TPM.CommunicationStatus
- CIM_TPM.DetailedStatus
- CIM_TPM.OperatingStatus
- CIM_TPM.PrimaryStatus
- CIM_TPM.EnabledState
- CIM_TPM.OtherEnabledState
- CIM_TPM.RequestedState
- CIM_TPM.EnabledDefault
- CIM_TPM.TimeOfLastStateChange
- CIM_TPM.AvailableRequestedStates
- CIM_TPM.TransitioningToState
- CIM_TPM.SystemCreationClassName
- CIM_TPM.SystemName
- CIM_TPM.CreationClassName
- CIM_TPM.DeviceID
- CIM_TPM.PowerManagementSupported
- CIM_TPM.PowerManagementCapabilities
- CIM_TPM.Availability
- CIM_TPM.StatusInfo
- CIM_TPM.LastErrorCode
- CIM_TPM.ErrorDescription
- CIM_TPM.ErrorCleared
- CIM_TPM.OtherIdentifyingInfo
- CIM_TPM.PowerOnHours
- CIM_TPM.TotalPowerOnHours
- CIM_TPM.IdentifyingDescriptions
- CIM_TPM.AdditionalAvailability
- CIM_TPM.MaxQuiesceTime
...
``` syntax
[Experimental, Abstract, Version("2.21.0"), UMLPackagePath("CIM::Device::TPM")]
...
| [**EnableDevice**](cim-tpm-enabledevice.md)                   | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> **Deprecated description:** Enables or disables the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-tpm-onlinedevice.md)                   | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-tpm-quiescedevice.md)                 | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-tpm-requeststatechange.md)       | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
...
| [**Reset**](cim-tpm-reset.md)                                 | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-tpm-restoreproperties.md)         | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-tpm-saveproperties.md)               | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-tpm-setpowerstate.md)                 | Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> **Deprecated description:** Sets the power state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_TPM**.**RequestTPMStateChange**, CIM\_TPMCapabilities.RequestedTPMStatesSupported")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("TPM.TCG\|Part 2 v1dot2\|Section 5.3\|version\|revMajor")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("TPM.TCG\|Part 2 v1dot2\|Section 21.6\|TPM\_CAP\_VERSION\_INFO\|tpmVendorID")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("TPM.TCG\|Part 2 v1.2.TCG\|Section 21.6\|TPM\_CAP\_VERSION\_INFO\|vendorSpecific")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("TPM.TCG\|Part 2 v1dot2\|Section 5.3\|version\|revMinor")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("TPM.TCG\|Part 2 v1dot2\|Section 5.3\|version\|major", "TSS.TCG\|Level 1 v1.2\|Section 2.3.2.18")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("TPM.TCG\|Part 2 v1dot2\|Section 5.3\|version\|minor", "TSS.TCG\|Level 1 v1.2\|Section 2.3.2.18")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("TPM.TCG\|Part 1 v1dot2\|Section 9.4", "TPM.TCG\|Part 2 v1dot2\|Section 7.1\|TPM\_PERMANENT\_FLAGS"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_TPM**.**RequestTPMStateChange**", "**CIM\_TPM**.**TransitioningToTPMState**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_TPM**.**RequestTPMStateChange**", "**CIM\_TPM**.**TPMState**")
</dt> </dl>
...
<span id="DTMF_Reserved"></span><span id="dtmf_reserved"></span><span id="DTMF_RESERVED"></span>
