---
title: RevertTestReplicaCollection method of the Msvm\_CollectionReplicationService class
description: Destroys the test replica collection for a replica collection.
audience: developer
...
- apiref
api_name:
- Msvm_CollectionReplicationService.RevertTestReplicaCollection
api_location:
- VMMS.exe
api_type:
- COM
...
Destroys the test replica collection for a replica collection.
...
A reference to the [**CIM\_CollectionOfMSEs**](cim-collectionofmses.md) replica collection instance for which the associated test replica collection is to be removed.
