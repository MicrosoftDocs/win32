...
ms.assetid: '69fa13eb-bb12-44ac-af4a-ec7ae8f5b1ec'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_EthernetPort class", "CIM_EthernetPort class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
