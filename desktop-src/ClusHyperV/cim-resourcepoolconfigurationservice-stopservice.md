...
keywords: ["StopService method", "StopService method, CIM_ResourcePoolConfigurationService class", "CIM_ResourcePoolConfigurationService class, StopService method"]
topic_type:
- apiref
api_name:
