...
keywords:
- CancelResynchronize method
- CancelResynchronize method, Msvm_CollectionReplicationService class
- Msvm_CollectionReplicationService class, CancelResynchronize method
topic_type:
- apiref
api_name:
