---
title: RequestStateChange method of the CIM\_TransparentBridgingService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'af1696fc-44b8-4476-9bdc-bc1850e204e8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_TransparentBridgingService class", "CIM_TransparentBridgingService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_TransparentBridgingService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_TransparentBridgingService class
