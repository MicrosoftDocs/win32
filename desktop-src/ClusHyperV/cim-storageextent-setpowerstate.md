...
ms.assetid: '3df04fe5-22ca-45c5-ac16-86190dc4d118'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_StorageExtent class", "CIM_StorageExtent class, SetPowerState method"]
topic_type:
- apiref
api_name:
