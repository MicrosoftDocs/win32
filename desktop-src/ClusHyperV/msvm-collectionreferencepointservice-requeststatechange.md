---
title: RequestStateChange method of the Msvm\_CollectionReferencePointService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'c8e37325-be3f-4230-ad66-bb7fd2347a4f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, Msvm_CollectionReferencePointService class", "Msvm_CollectionReferencePointService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- Msvm_CollectionReferencePointService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the Msvm\_CollectionReferencePointService class
