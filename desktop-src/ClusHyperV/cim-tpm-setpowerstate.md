---
title: SetPowerState method of the CIM\_TPM class
...
ms.assetid: 'ca177fe1-f693-4fdc-a0e9-6f792ecd7e5f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_TPM class", "CIM_TPM class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_TPM.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_TPM class
