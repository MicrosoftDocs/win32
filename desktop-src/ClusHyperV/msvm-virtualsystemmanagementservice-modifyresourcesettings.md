...
keywords: ["ModifyResourceSettings method", "ModifyResourceSettings method, Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class, ModifyResourceSettings method"]
topic_type:
- apiref
api_name:
