...
ms.assetid: '3e57caf4-62d8-4c1e-b7d8-4d294720cb81'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_ResourceAllocationFromPool class", "CIM_ResourceAllocationFromPool class, described"]
topic_type:
- apiref
api_name:
...
``` syntax
[Association, Abstract, Version("2.22.0"), UMLPackagePath("CIM::System::Resource")]
