---
title: Msvm\_CollectionReplicationService class
description: Manages the replication service for collection of virtual machines.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '2877ec70-0722-4b7c-bc31-cd4d9aac58a6'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_CollectionReplicationService class", "Msvm_CollectionReplicationService class, described"]
topic_type:
- apiref
api_name:
- Msvm_CollectionReplicationService
- Msvm_CollectionReplicationService.InstanceID
- Msvm_CollectionReplicationService.Caption
- Msvm_CollectionReplicationService.Description
- Msvm_CollectionReplicationService.ElementName
- Msvm_CollectionReplicationService.InstallDate
- Msvm_CollectionReplicationService.OperationalStatus
- Msvm_CollectionReplicationService.StatusDescriptions
- Msvm_CollectionReplicationService.Status
- Msvm_CollectionReplicationService.HealthState
- Msvm_CollectionReplicationService.CommunicationStatus
- Msvm_CollectionReplicationService.DetailedStatus
- Msvm_CollectionReplicationService.OperatingStatus
- Msvm_CollectionReplicationService.PrimaryStatus
- Msvm_CollectionReplicationService.EnabledState
- Msvm_CollectionReplicationService.OtherEnabledState
- Msvm_CollectionReplicationService.RequestedState
- Msvm_CollectionReplicationService.EnabledDefault
- Msvm_CollectionReplicationService.TimeOfLastStateChange
- Msvm_CollectionReplicationService.AvailableRequestedStates
- Msvm_CollectionReplicationService.TransitioningToState
- Msvm_CollectionReplicationService.SystemCreationClassName
- Msvm_CollectionReplicationService.SystemName
- Msvm_CollectionReplicationService.CreationClassName
- Msvm_CollectionReplicationService.Name
- Msvm_CollectionReplicationService.PrimaryOwnerName
- Msvm_CollectionReplicationService.PrimaryOwnerContact
- Msvm_CollectionReplicationService.StartMode
- Msvm_CollectionReplicationService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
# Msvm\_CollectionReplicationService class
...
class Msvm_CollectionReplicationService : CIM_Service
{
  string   InstanceID;
  string   Caption;
  string   Description;
...
The **Msvm\_CollectionReplicationService** class has these types of members:
...
The **Msvm\_CollectionReplicationService** class has these methods.



| Method                                                                                                     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|:-----------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CancelInitialReplication**](msvm-collectionreplicationservice-cancelinitialreplication.md)             | Cancels the initial replication for the VM collection.<br/>                                                                                                                                                                                                                                                                                                                                                                                       |
| [**CancelResynchronize**](msvm-collectionreplicationservice-cancelresynchronize.md)                       | Cancels the resynchronize operation for the VM collection.<br/>                                                                                                                                                                                                                                                                                                                                                                                   |
| [**CancelUpdateDiskSet**](msvm-collectionreplicationservice-cancelupdatediskset.md)                       | Cancels Update Disk Set operation for the VM collection.<br/>                                                                                                                                                                                                                                                                                                                                                                                     |
| [**CommitFailover**](msvm-collectionreplicationservice-commitfailover.md)                                 | Commits the recovery snapshot that InitiateFailover has used for failover.<br/>                                                                                                                                                                                                                                                                                                                                                                   |
| [**CreateReplicationRelationship**](msvm-collectionreplicationservice-createreplicationrelationship.md)   | Creates new replication relationship for collection of virtual machines.<br/>                                                                                                                                                                                                                                                                                                                                                                     |
| [**GetReplicationStatistics**](msvm-collectionreplicationservice-getreplicationstatistics.md)             | Retrieves replication statistics associated with virtual system collection.<br/>                                                                                                                                                                                                                                                                                                                                                                  |
| [**InitiateFailover**](msvm-collectionreplicationservice-initiatefailover.md)                             | Sets the failover for collection to application or crash consistent image.<br/>                                                                                                                                                                                                                                                                                                                                                                   |
| [**InitiatePlannedFailover**](msvm-collectionreplicationservice-initiateplannedfailover.md)               | Initiates planned failover (synced replication) for a group of virtual machines.<br/>                                                                                                                                                                                                                                                                                                                                                             |
| [**ModifyReplicationSettings**](msvm-collectionreplicationservice-modifyreplicationsettings.md)           | Updates replication setting data for a group of virtual machines.<br/>                                                                                                                                                                                                                                                                                                                                                                            |
| [**PrepareForReverseReplication**](msvm-collectionreplicationservice-prepareforreversereplication.md)     | Prepares the collection for reverse replication from a failed-over recovery collection.<br/>                                                                                                                                                                                                                                                                                                                                                      |
| [**RemoveReplicationRelationship**](msvm-collectionreplicationservice-removereplicationrelationship.md)   | Removes the collection replication relationship. This does not clean up the recovery server collection.<br/>                                                                                                                                                                                                                                                                                                                                      |
| [**RequestStateChange**](msvm-collectionreplicationservice-requeststatechange.md)                         | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                                                                                                          |
| [**ResetReplicationStatistics**](msvm-collectionreplicationservice-resetreplicationstatistics.md)         | Resets replication statistics associated with virtual system collection.<br/>                                                                                                                                                                                                                                                                                                                                                                     |
| [**ResumeReplication**](msvm-collectionreplicationservice-resumereplication.md)                           | Resumes replication for the VM collection.<br/>                                                                                                                                                                                                                                                                                                                                                                                                   |
| [**Resynchronize**](msvm-collectionreplicationservice-resynchronize.md)                                   | Resynchronizes the specified Virtual System Collection.<br/>                                                                                                                                                                                                                                                                                                                                                                                      |
| [**ReverseReplicationRelationship**](msvm-collectionreplicationservice-reversereplicationrelationship.md) | Reverses replication for the recovery collection using the collection replication setting specified. This API requires the collection that is a recovery collection in failover committed state.<br/>                                                                                                                                                                                                                                             |
| [**RevertFailover**](msvm-collectionreplicationservice-revertfailover.md)                                 | Undo the current failover for the collection. After this operation [**InitiateFailover**](msvm-collectionreplicationservice-initiatefailover.md) can be called again.<br/> This operation will work only for the collection which is in failed over state after using [**InitiateFailover**](msvm-collectionreplicationservice-initiatefailover.md).<br/>                                                                                 |
| [**RevertPlannedFailover**](msvm-collectionreplicationservice-revertplannedfailover.md)                   | Undo the current planned failover for the collection. After this operation [**InitiatePlannedFailover**](msvm-collectionreplicationservice-initiateplannedfailover.md) can be called again.<br/> This operation will work only for the collection which is in **PreparedForPlannedFailover** or **FailoverInitiated** state after using [**InitiatePlannedFailover**](msvm-collectionreplicationservice-initiateplannedfailover.md).<br/> |
| [**RevertTestReplicaCollection**](msvm-collectionreplicationservice-reverttestreplicacollection.md)       | Destroys the test replica collection for a replica collection.<br/>                                                                                                                                                                                                                                                                                                                                                                               |
| [**StartReplication**](msvm-collectionreplicationservice-startreplication.md)                             | Starts the replication service for a group of virtual machines.<br/>                                                                                                                                                                                                                                                                                                                                                                              |
| [**StartService**](msvm-collectionreplicationservice-startservice.md)                                     | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                                                                                                                                                                                                                                                                            |
| [**StopService**](msvm-collectionreplicationservice-stopservice.md)                                       | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                                                                                                                                                                                                                                                                             |
| [**SuspendReplication**](msvm-collectionreplicationservice-suspendreplication.md)                         | Suspends replication for the VM collection.<br/>                                                                                                                                                                                                                                                                                                                                                                                                  |
| [**TestReplicaCollection**](msvm-collectionreplicationservice-testreplicacollection.md)                   | Creates the test collection for the replicated virtual system collection.<br/> User can select the recovery point from which the test collection should be created.<br/>                                                                                                                                                                                                                                                                    |
...
The **Msvm\_CollectionReplicationService** class has these properties.
