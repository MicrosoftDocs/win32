---
title: RequestStateChange method of the CIM\_LogicalDisk class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '6114aa06-63c6-4043-a20b-0805ecce5a6d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_LogicalDisk class", "CIM_LogicalDisk class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_LogicalDisk.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_LogicalDisk class
