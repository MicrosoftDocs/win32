...
api_name:
- CIM_SwitchService
- CIM_SwitchService.InstanceID
- CIM_SwitchService.Caption
- CIM_SwitchService.Description
- CIM_SwitchService.ElementName
- CIM_SwitchService.InstallDate
- CIM_SwitchService.OperationalStatus
- CIM_SwitchService.StatusDescriptions
- CIM_SwitchService.Status
- CIM_SwitchService.HealthState
- CIM_SwitchService.CommunicationStatus
- CIM_SwitchService.DetailedStatus
- CIM_SwitchService.OperatingStatus
- CIM_SwitchService.PrimaryStatus
- CIM_SwitchService.EnabledState
- CIM_SwitchService.OtherEnabledState
- CIM_SwitchService.RequestedState
- CIM_SwitchService.EnabledDefault
- CIM_SwitchService.TimeOfLastStateChange
- CIM_SwitchService.AvailableRequestedStates
- CIM_SwitchService.TransitioningToState
- CIM_SwitchService.SystemCreationClassName
- CIM_SwitchService.SystemName
- CIM_SwitchService.CreationClassName
- CIM_SwitchService.Name
- CIM_SwitchService.PrimaryOwnerName
- CIM_SwitchService.PrimaryOwnerContact
- CIM_SwitchService.StartMode
- CIM_SwitchService.Started
- CIM_SwitchService.Keywords
- CIM_SwitchService.ServiceURL
- CIM_SwitchService.StartupConditions
- CIM_SwitchService.StartupParameters
- CIM_SwitchService.ProtocolType
- CIM_SwitchService.OtherProtocolType
...
The **CIM\_SwitchService** class has these methods.



| Method                                                             | Description                                                                                                                                                                                    |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-switchservice-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](cim-switchservice-startservice.md)             | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](cim-switchservice-stopservice.md)               | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (32), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIB.IETF\|BRIDGE-MIB.dot1dBaseBridgeAddress"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_SwitchService**.**BridgeAddressType**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_SwitchService**.**BridgeAddress**")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIB.IETF\|BRIDGE-MIB.dot1dBaseType")
</dt> </dl>
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIB.IETF\|BRIDGE-MIB.dot1dBaseNumPorts")
</dt> </dl>
