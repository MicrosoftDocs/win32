---
title: Msvm\_RegisteredProfile class
description: Used to advertise implementation conformance to a profile.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '1ec9ef48-5d62-4451-b33a-1eddd6941b5c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_RegisteredProfile class", "Msvm_RegisteredProfile class, described"]
topic_type:
- apiref
api_name:
...
This property is inherited from [**CIM\_RegisteredProfile**](https://msdn.microsoft.com/library/mt164290).
...
This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt126793).
