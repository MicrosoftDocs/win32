---
title: RequestStateChange method of the CIM\_ResourcePoolConfigurationService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'da55dcae-7e90-4bea-97d2-ef584c613e8e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_ResourcePoolConfigurationService class", "CIM_ResourcePoolConfigurationService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_ResourcePoolConfigurationService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_ResourcePoolConfigurationService class
