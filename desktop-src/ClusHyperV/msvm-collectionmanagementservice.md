...
description: Manages CIM\_CollectionOfMSEs objects on a Hyper-V host.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '526d80f2-aafa-41bf-adbc-e99500551009'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_CollectionManagementService class", "Msvm_CollectionManagementService class, described"]
topic_type:
- apiref
api_name:
- Msvm_CollectionManagementService
- Msvm_CollectionManagementService.InstanceID
- Msvm_CollectionManagementService.Caption
- Msvm_CollectionManagementService.Description
- Msvm_CollectionManagementService.ElementName
- Msvm_CollectionManagementService.InstallDate
- Msvm_CollectionManagementService.OperationalStatus
- Msvm_CollectionManagementService.StatusDescriptions
- Msvm_CollectionManagementService.Status
- Msvm_CollectionManagementService.HealthState
- Msvm_CollectionManagementService.CommunicationStatus
- Msvm_CollectionManagementService.DetailedStatus
- Msvm_CollectionManagementService.OperatingStatus
- Msvm_CollectionManagementService.PrimaryStatus
- Msvm_CollectionManagementService.EnabledState
- Msvm_CollectionManagementService.OtherEnabledState
- Msvm_CollectionManagementService.RequestedState
- Msvm_CollectionManagementService.EnabledDefault
- Msvm_CollectionManagementService.TimeOfLastStateChange
- Msvm_CollectionManagementService.AvailableRequestedStates
- Msvm_CollectionManagementService.TransitioningToState
- Msvm_CollectionManagementService.SystemCreationClassName
- Msvm_CollectionManagementService.SystemName
- Msvm_CollectionManagementService.CreationClassName
- Msvm_CollectionManagementService.Name
- Msvm_CollectionManagementService.PrimaryOwnerName
- Msvm_CollectionManagementService.PrimaryOwnerContact
- Msvm_CollectionManagementService.StartMode
- Msvm_CollectionManagementService.Started
api_location:
- VMMS.exe
api_type:
- DllExport
...
| Method                                                                            | Description                                                                                                                                                                                    |
|:----------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AddMember**](msvm-collectionmanagementservice-addmember.md)                   | Adds a managed element to a [**CIM\_CollectionOfMSEs**](cim-collectionofmses.md) object.<br/>                                                                                           |
...
| [**DestroyCollection**](msvm-collectionmanagementservice-destroycollection.md)   | Deletes a [**CIM\_CollectionOfMSEs**](cim-collectionofmses.md) object.<br/>                                                                                                             |
| [**RemoveMember**](msvm-collectionmanagementservice-removemember.md)             | Removes a managed element from a [**CIM\_CollectionOfMSEs**](cim-collectionofmses.md) object.<br/>                                                                                      |
| [**RemoveMemberById**](msvm-collectionmanagementservice-removememberbyid.md)     | Removes a managed element from a [**CIM\_CollectionOfMSEs**](cim-collectionofmses.md) object.<br/>                                                                                      |
| [**RenameCollection**](msvm-collectionmanagementservice-renamecollection.md)     | Updates the **ElementName** property of a [**CIM\_CollectionOfMSEs**](cim-collectionofmses.md) object.<br/>                                                                             |
| [**RequestStateChange**](msvm-collectionmanagementservice-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](msvm-collectionmanagementservice-startservice.md)             | Starts the collection management service.<br/>                                                                                                                                           |
| [**StopService**](msvm-collectionmanagementservice-stopservice.md)               | Stops the collection management service.<br/>                                                                                                                                            |
...
The **Msvm\_CollectionManagementService** class has these properties.
