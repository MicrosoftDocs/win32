...
ms.assetid: '9db97c12-db90-441e-9204-acb152b2c608'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_Processor class", "CIM_Processor class, described"]
topic_type:
- apiref
api_name:
- CIM_Processor
- CIM_Processor.InstanceID
...
- CIM_Processor.CommunicationStatus
- CIM_Processor.DetailedStatus
- CIM_Processor.OperatingStatus
- CIM_Processor.PrimaryStatus
...
- CIM_Processor.AvailableRequestedStates
- CIM_Processor.TransitioningToState
...
``` syntax
[Abstract, Version("2.24.1"), UMLPackagePath("CIM::Device::Processor")]
...
| Method                                                         | Description                                                                                                                                                                                                                                                                                                                                                                                     |
|:---------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-processor-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the [**RequestStateChange**](cim-processor-requeststatechange.md) method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-processor-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the [**RequestStateChange**](cim-processor-requeststatechange.md) method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-processor-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the [**RequestStateChange**](cim-processor-requeststatechange.md) method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-processor-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                                                  |
| [**Reset**](cim-processor-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                                                                 |
| [**RestoreProperties**](cim-processor-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**SaveProperties**](cim-processor-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                                   |
| [**SetPowerState**](cim-processor-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                          |
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bits"), **PUnit** ("bit")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("MegaHertz"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Processor\|017.6"), **PUnit** ("hertz \* 10^6")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Percent"), [**Gauge**](https://msdn.microsoft.com/library/aa393650), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIB.IETF\|HOST-RESOURCES-MIB.hrProcessorLoad"), **PUnit** ("percent")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("MegaHertz"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Processor\|017.5"), **PUnit** ("hertz \* 10^6")
</dt> </dl>
