...
keywords: ["DestroySnapshot method", "DestroySnapshot method, Msvm_CollectionSnapshotService class", "Msvm_CollectionSnapshotService class, DestroySnapshot method"]
topic_type:
- apiref
api_name:
