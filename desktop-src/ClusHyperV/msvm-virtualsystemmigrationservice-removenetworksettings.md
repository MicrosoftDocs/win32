...
ms.assetid: 'bbf06290-891f-4a75-b84e-233b98f15466'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RemoveNetworkSettings method", "RemoveNetworkSettings method, Msvm_VirtualSystemMigrationService class", "Msvm_VirtualSystemMigrationService class, RemoveNetworkSettings method"]
topic_type:
- apiref
api_name:
...
An array of embedded instances of the [**Msvm\_VirtualSystemMigrationNetworkSettingData**](https://msdn.microsoft.com/library/windows/desktop/hh859780) class that represent the network subnets to be removed.
