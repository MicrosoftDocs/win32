---
title: QuiesceDevice method of the CIM\_Display class
...
ms.assetid: '448fa104-3d94-4256-aacb-45a3e3cc41a9'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_Display class", "CIM_Display class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_Display.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_Display class
