---
title: EnableDevice method of the CIM\_DiskDrive class
...
ms.assetid: '837adf31-8f83-41cd-a0c2-8474da3fb631'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_DiskDrive class", "CIM_DiskDrive class, EnableDevice method"]
topic_type:
- apiref
api_name:
...
# EnableDevice method of the CIM\_DiskDrive class
