---
title: OnlineDevice method of the CIM\_DiskDrive class
...
ms.assetid: 'a530995f-2e59-4495-932b-69ffa6ae7136'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_DiskDrive class", "CIM_DiskDrive class, OnlineDevice method"]
topic_type:
- apiref
api_name:
...
# OnlineDevice method of the CIM\_DiskDrive class
