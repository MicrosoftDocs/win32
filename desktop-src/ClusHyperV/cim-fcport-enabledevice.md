---
title: EnableDevice method of the CIM\_FCPort class
...
ms.assetid: 'a293e2d9-de73-4d05-b64b-cfd70049d4a7'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_FCPort class", "CIM_FCPort class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_FCPort.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_FCPort class
