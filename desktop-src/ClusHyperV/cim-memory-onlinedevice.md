---
title: OnlineDevice method of the CIM\_Memory class
...
ms.assetid: '52514804-75a0-4afb-8dba-a37479f08a2d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_Memory class", "CIM_Memory class, OnlineDevice method"]
topic_type:
- apiref
api_name:
...
# OnlineDevice method of the CIM\_Memory class
