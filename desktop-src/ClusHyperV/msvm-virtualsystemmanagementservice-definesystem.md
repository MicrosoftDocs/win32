...
keywords: ["DefineSystem method", "DefineSystem method, Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class, DefineSystem method"]
topic_type:
- apiref
api_name:
