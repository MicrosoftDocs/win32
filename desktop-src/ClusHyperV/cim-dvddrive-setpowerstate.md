---
title: SetPowerState method of the CIM\_DVDDrive class
...
ms.assetid: '1741d033-8f97-4994-8c6a-bd967af21d1c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_DVDDrive class", "CIM_DVDDrive class, SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_DVDDrive.SetPowerState
api_location:
- VMMS.exe
api_type:
- COM
...
# SetPowerState method of the CIM\_DVDDrive class
