...
ms.assetid: '0b912fbc-c8b0-4a41-a092-c1c04726583b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_StorageExtent class", "CIM_StorageExtent class, OnlineDevice method"]
topic_type:
- apiref
api_name:
