---
title: OnlineDevice method of the CIM\_TapeDrive class
...
ms.assetid: 'e57fbed1-7250-4d25-8556-d398314cec8f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_TapeDrive class", "CIM_TapeDrive class, OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_TapeDrive.OnlineDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# OnlineDevice method of the CIM\_TapeDrive class
