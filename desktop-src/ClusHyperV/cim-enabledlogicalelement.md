...
ms.assetid: '59ab25ca-85c5-4316-8b1a-279c84c7b337'
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_EnabledLogicalElement**.**RequestStateChange**", "[**CIM\_EnabledLogicalElementCapabilities**](cim-enabledlogicalelementcapabilities.md).**RequestedStatesSupported**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_EnabledLogicalElement**.**PrimaryStatus**", "[**CIM\_ManagedSystemElement**](cim-managedsystemelement.md).**HealthState**")
</dt> </dl>
