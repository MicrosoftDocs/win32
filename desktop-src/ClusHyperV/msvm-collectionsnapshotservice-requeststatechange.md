---
title: RequestStateChange method of the Msvm\_CollectionSnapshotService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f0207a62-9e9c-4af6-a935-a41d96564da1'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, Msvm_CollectionSnapshotService class", "Msvm_CollectionSnapshotService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- Msvm_CollectionSnapshotService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the Msvm\_CollectionSnapshotService class
