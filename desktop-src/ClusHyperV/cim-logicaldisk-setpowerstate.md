...
ms.assetid: '046dfdaf-de6f-4857-ac1b-c75b8a942418'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_LogicalDisk class", "CIM_LogicalDisk class, SetPowerState method"]
topic_type:
- apiref
api_name:
