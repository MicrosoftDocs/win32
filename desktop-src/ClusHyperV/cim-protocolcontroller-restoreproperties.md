...
ms.assetid: '0f47e14d-17be-426f-a922-f2e4ba699e60'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RestoreProperties method", "RestoreProperties method, CIM_ProtocolController class", "CIM_ProtocolController class, RestoreProperties method"]
topic_type:
- apiref
api_name:
