---
title: QuiesceDevice method of the CIM\_ProtocolController class
...
ms.assetid: 'd9fd35cf-e343-4934-bb59-565fb36ee6a5'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method", "QuiesceDevice method, CIM_ProtocolController class", "CIM_ProtocolController class, QuiesceDevice method"]
topic_type:
- apiref
api_name:
- CIM_ProtocolController.QuiesceDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# QuiesceDevice method of the CIM\_ProtocolController class
