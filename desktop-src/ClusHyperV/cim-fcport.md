...
ms.assetid: '02cd8676-27ef-4d52-8242-a18492757c8b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_FCPort class", "CIM_FCPort class, described"]
topic_type:
- apiref
api_name:
- CIM_FCPort
- CIM_FCPort.InstanceID
- CIM_FCPort.Caption
- CIM_FCPort.Description
- CIM_FCPort.ElementName
- CIM_FCPort.InstallDate
- CIM_FCPort.Name
- CIM_FCPort.OperationalStatus
- CIM_FCPort.StatusDescriptions
- CIM_FCPort.Status
- CIM_FCPort.HealthState
- CIM_FCPort.CommunicationStatus
- CIM_FCPort.DetailedStatus
- CIM_FCPort.OperatingStatus
- CIM_FCPort.PrimaryStatus
- CIM_FCPort.EnabledState
- CIM_FCPort.OtherEnabledState
- CIM_FCPort.RequestedState
- CIM_FCPort.EnabledDefault
- CIM_FCPort.TimeOfLastStateChange
- CIM_FCPort.AvailableRequestedStates
- CIM_FCPort.TransitioningToState
- CIM_FCPort.SystemCreationClassName
- CIM_FCPort.SystemName
- CIM_FCPort.CreationClassName
- CIM_FCPort.DeviceID
- CIM_FCPort.PowerManagementSupported
- CIM_FCPort.PowerManagementCapabilities
- CIM_FCPort.Availability
- CIM_FCPort.StatusInfo
- CIM_FCPort.LastErrorCode
- CIM_FCPort.ErrorDescription
- CIM_FCPort.ErrorCleared
- CIM_FCPort.OtherIdentifyingInfo
- CIM_FCPort.PowerOnHours
- CIM_FCPort.TotalPowerOnHours
- CIM_FCPort.IdentifyingDescriptions
- CIM_FCPort.AdditionalAvailability
- CIM_FCPort.MaxQuiesceTime
- CIM_FCPort.MaxSpeed
- CIM_FCPort.RequestedSpeed
- CIM_FCPort.UsageRestriction
- CIM_FCPort.OtherPortType
- CIM_FCPort.Speed
- CIM_FCPort.OtherNetworkPortType
- CIM_FCPort.PortNumber
- CIM_FCPort.LinkTechnology
- CIM_FCPort.OtherLinkTechnology
- CIM_FCPort.PermanentAddress
- CIM_FCPort.NetworkAddresses
- CIM_FCPort.FullDuplex
- CIM_FCPort.AutoSense
- CIM_FCPort.SupportedMaximumTransmissionUnit
- CIM_FCPort.ActiveMaximumTransmissionUnit
- CIM_FCPort.PortType
...
``` syntax
[Abstract, Version("2.10.0"), UMLPackagePath("CIM::Device::FC")]
...
The **CIM\_FCPort** class has these methods.



| Method                                                      | Description                                                                                                                                                                                                                                                                                                                                             |
|:------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-fcport-enabledevice.md)             | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> **Deprecated description:** Enables or disables the logical device.<br/>                                                                     |
| [**OnlineDevice**](cim-fcport-onlinedevice.md)             | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> |
| [**QuiesceDevice**](cim-fcport-quiescedevice.md)           | This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/>                            |
| [**RequestStateChange**](cim-fcport-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-fcport-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-fcport-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-fcport-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-fcport-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (64), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Network Adapter 802 Port\|001.3")
</dt> </dl>
...
The **OtherPortType** property describes the port type.
...
Port may negotiate to become either an expansion port
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bits per Second"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_LogicalPort**](cim-logicalport.md).**Speed**"), **PUnit** ("bit / second")
</dt> </dl>
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bits per Second"), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIB.IETF\|MIB-II.ifSpeed", "MIF.DMTF\|Network Adapter 802 Port\|001.5"), **PUnit** ("bit / second")
</dt> </dl>
