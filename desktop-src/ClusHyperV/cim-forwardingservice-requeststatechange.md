---
title: RequestStateChange method of the CIM\_ForwardingService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '7479cb46-f6d4-451a-91d3-ad14de8b22d7'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_ForwardingService class", "CIM_ForwardingService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_ForwardingService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_ForwardingService class
