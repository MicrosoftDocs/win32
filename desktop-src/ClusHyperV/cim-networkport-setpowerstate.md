...
ms.assetid: '57d5c325-c98b-42ad-82d2-144e86a0853a'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_NetworkPort class", "CIM_NetworkPort class, SetPowerState method"]
topic_type:
- apiref
api_name:
