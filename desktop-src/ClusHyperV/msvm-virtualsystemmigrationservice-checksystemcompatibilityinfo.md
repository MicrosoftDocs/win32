...
keywords: ["CheckSystemCompatibilityInfo method", "CheckSystemCompatibilityInfo method, Msvm_VirtualSystemMigrationService class", "Msvm_VirtualSystemMigrationService class, CheckSystemCompatibilityInfo method"]
topic_type:
- apiref
api_name:
