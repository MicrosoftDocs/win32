...
ms.assetid: '0f526a5b-aced-4b59-bbf7-fe3fc74eb4a0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_SerialController class", "CIM_SerialController class, SetPowerState method"]
topic_type:
- apiref
api_name:
