...
ms.assetid: '392cf457-232c-4710-8c91-d07d6f44d33b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_Display class", "CIM_Display class, described"]
topic_type:
- apiref
api_name:
- CIM_Display
- CIM_Display.InstanceID
- CIM_Display.Caption
- CIM_Display.Description
- CIM_Display.ElementName
- CIM_Display.InstallDate
- CIM_Display.Name
- CIM_Display.OperationalStatus
- CIM_Display.StatusDescriptions
- CIM_Display.Status
- CIM_Display.HealthState
- CIM_Display.CommunicationStatus
- CIM_Display.DetailedStatus
- CIM_Display.OperatingStatus
- CIM_Display.PrimaryStatus
- CIM_Display.EnabledState
- CIM_Display.OtherEnabledState
- CIM_Display.RequestedState
- CIM_Display.EnabledDefault
- CIM_Display.TimeOfLastStateChange
- CIM_Display.AvailableRequestedStates
- CIM_Display.TransitioningToState
...
- CIM_Display.OtherIdentifyingInfo
- CIM_Display.PowerOnHours
- CIM_Display.TotalPowerOnHours
- CIM_Display.IdentifyingDescriptions
- CIM_Display.AdditionalAvailability
- CIM_Display.MaxQuiesceTime
...
| Method                                                       | Description                                                                                                                                                                                                                                                                                                                                             |
|:-------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-display-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-display-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-display-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-display-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-display-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-display-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-display-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-display-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
