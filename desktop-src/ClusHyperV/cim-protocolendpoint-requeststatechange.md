...
ms.assetid: '5d1d4ee2-2db2-4d2e-a225-d4fe7fa052fc'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_ProtocolEndpoint class", "CIM_ProtocolEndpoint class, RequestStateChange method"]
topic_type:
- apiref
api_name:
