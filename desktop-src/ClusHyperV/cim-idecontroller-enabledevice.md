---
title: EnableDevice method of the CIM\_IDEController class
...
ms.assetid: 'fa75c1ee-2079-4f6c-8237-0efb5e4c07d8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_IDEController class", "CIM_IDEController class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_IDEController.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_IDEController class
