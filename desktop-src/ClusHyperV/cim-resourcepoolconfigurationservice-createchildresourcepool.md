...
keywords: ["CreateChildResourcePool method", "CreateChildResourcePool method, CIM_ResourcePoolConfigurationService class", "CIM_ResourcePoolConfigurationService class, CreateChildResourcePool method"]
topic_type:
- apiref
api_name:
