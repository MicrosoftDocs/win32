---
title: EnableDevice method of the CIM\_CDROMDrive class
...
ms.assetid: 'e747749c-21c9-492e-983a-fa0ffaa04c46'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_CDROMDrive class", "CIM_CDROMDrive class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_CDROMDrive.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_CDROMDrive class
