---
title: RequestStateChange method of the CIM\_MetricService class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ee0efb90-7b17-43ee-8cec-8bb3b03f251c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_MetricService class", "CIM_MetricService class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_MetricService.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_MetricService class
