---
title: RequestStateChange method of the CIM\_CDROMDrive class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f49e5f36-9bc3-4595-8977-4bf8a3ebc153'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_CDROMDrive class", "CIM_CDROMDrive class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_CDROMDrive.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_CDROMDrive class
