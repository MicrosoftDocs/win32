---
title: RequestStateChange method of the CIM\_VideoHead class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '39dcb8fb-7af6-42f7-9960-426b0d854d65'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_VideoHead class", "CIM_VideoHead class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_VideoHead.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_VideoHead class
