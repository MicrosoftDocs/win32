---
title: RequestStateChange method of the CIM\_DesktopMonitor class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '9215fa5b-b46e-4975-873b-9507f585471c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_DesktopMonitor class", "CIM_DesktopMonitor class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_DesktopMonitor.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_DesktopMonitor class
