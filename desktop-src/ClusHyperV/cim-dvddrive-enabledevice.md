---
title: EnableDevice method of the CIM\_DVDDrive class
...
ms.assetid: '0cfd71e2-9ba7-4124-b62e-7275041d61d3'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method", "EnableDevice method, CIM_DVDDrive class", "CIM_DVDDrive class, EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_DVDDrive.EnableDevice
api_location:
- VMMS.exe
api_type:
- COM
...
# EnableDevice method of the CIM\_DVDDrive class
