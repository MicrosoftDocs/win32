...
ms.assetid: 'df680fe8-3b50-4a8f-ae21-d36a165dc606'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_NetworkPort class", "CIM_NetworkPort class, OnlineDevice method"]
topic_type:
- apiref
api_name:
