---
title: RequestStateChange method of the CIM\_WiFiPort class
description: Requests the specified change to the state of the element.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '8b3c5841-9cce-44c1-8c58-2fa2115fa3e0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_WiFiPort class", "CIM_WiFiPort class, RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_WiFiPort.RequestStateChange
api_location:
- VMMS.exe
api_type:
- COM
...
# RequestStateChange method of the CIM\_WiFiPort class
