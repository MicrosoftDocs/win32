...
description: Represents a service that manages snapshots of virtual machines.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '63879fca-bb65-4c5f-bf55-f74d5d862fca'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Msvm_VirtualSystemSnapshotService class", "Msvm_VirtualSystemSnapshotService class, described"]
topic_type:
- apiref
api_name:
...
| Method                                                                                       | Description                                                                                                  |
|:---------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------|
| [**ApplySnapshot**](msvm-virtualsystemsnapshotservice-applysnapshot.md)                     | Applies a virtual machine snapshot to the virtual machine that it was created from.<br/>               |
| [**ClearSnapshotState**](msvm-virtualsystemsnapshotservice-clearsnapshotstate.md)           | Clears the save state from a virtual machine snapshot.<br/>                                            |
| [**ConvertToReferencePoint**](msvm-virtualsystemsnapshotservice-converttoreferencepoint.md) | Converts a virtual machine snapshot to a reference point.<br/>                                         |
| [**CreateSnapshot**](msvm-virtualsystemsnapshotservice-createsnapshot.md)                   | Creates a snapshot of a virtual machine.<br/>                                                          |
| [**DestroySnapshot**](msvm-virtualsystemsnapshotservice-destroysnapshot.md)                 | Deletes a virtual system snapshot.<br/>                                                                |
| [**DestroySnapshotTree**](msvm-virtualsystemsnapshotservice-destroysnapshottree.md)         | Deletes a tree that contains snapshots of a virtual machine.<br/>                                      |
| [**RequestStateChange**](msvm-virtualsystemsnapshotservice-requeststatechange.md)           | Requests a state change for the virtual system snapshot service.<br/>                                  |
| [**StartService**](msvm-virtualsystemsnapshotservice-startservice.md)                       | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/> |
| [**StopService**](msvm-virtualsystemsnapshotservice-stopservice.md)                         | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>  |
