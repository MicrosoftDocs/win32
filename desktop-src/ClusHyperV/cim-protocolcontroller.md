...
ms.assetid: '0a0b371e-639b-4994-a098-be84b5361eae'
ms.prod: 'windows-server-dev'
ms.technology:
- 'failover-cluster-hyperv'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_ProtocolController class", "CIM_ProtocolController class, described"]
topic_type:
- apiref
api_name:
- CIM_ProtocolController
- CIM_ProtocolController.InstanceID
- CIM_ProtocolController.Caption
- CIM_ProtocolController.Description
- CIM_ProtocolController.ElementName
- CIM_ProtocolController.InstallDate
- CIM_ProtocolController.Name
- CIM_ProtocolController.OperationalStatus
- CIM_ProtocolController.StatusDescriptions
- CIM_ProtocolController.Status
- CIM_ProtocolController.HealthState
- CIM_ProtocolController.CommunicationStatus
- CIM_ProtocolController.DetailedStatus
- CIM_ProtocolController.OperatingStatus
- CIM_ProtocolController.PrimaryStatus
- CIM_ProtocolController.EnabledState
- CIM_ProtocolController.OtherEnabledState
- CIM_ProtocolController.RequestedState
- CIM_ProtocolController.EnabledDefault
- CIM_ProtocolController.TimeOfLastStateChange
- CIM_ProtocolController.AvailableRequestedStates
- CIM_ProtocolController.TransitioningToState
- CIM_ProtocolController.SystemCreationClassName
- CIM_ProtocolController.SystemName
- CIM_ProtocolController.CreationClassName
- CIM_ProtocolController.DeviceID
- CIM_ProtocolController.PowerManagementSupported
- CIM_ProtocolController.PowerManagementCapabilities
- CIM_ProtocolController.Availability
- CIM_ProtocolController.StatusInfo
- CIM_ProtocolController.LastErrorCode
- CIM_ProtocolController.ErrorDescription
- CIM_ProtocolController.ErrorCleared
- CIM_ProtocolController.OtherIdentifyingInfo
- CIM_ProtocolController.PowerOnHours
- CIM_ProtocolController.TotalPowerOnHours
- CIM_ProtocolController.IdentifyingDescriptions
- CIM_ProtocolController.AdditionalAvailability
- CIM_ProtocolController.MaxQuiesceTime
...
Represents a group of controllers that control the operation and function of devices that initiate protocols. Simpler bus and device controllers are modeled using the [**CIM\_Controller**](cim-controller.md) class.
...
``` syntax
[Abstract, Version("2.8.0"), UMLPackagePath("CIM::Device::ProtocolController")]
...
The **CIM\_ProtocolController** class has these methods.



| Method                                                                  | Description                                                                                                                                                                                                                                                                                                                                             |
|:------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](cim-protocolcontroller-enabledevice.md)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](cim-protocolcontroller-onlinedevice.md)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](cim-protocolcontroller-quiescedevice.md)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](cim-protocolcontroller-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](cim-protocolcontroller-reset.md)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](cim-protocolcontroller-restoreproperties.md)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](cim-protocolcontroller-saveproperties.md)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](cim-protocolcontroller-setpowerstate.md)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
