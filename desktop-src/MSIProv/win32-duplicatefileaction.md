...
- Win32_DuplicateFileAction.ActionID
- Win32_DuplicateFileAction.Caption
- Win32_DuplicateFileAction.DeleteAfterCopy
- Win32_DuplicateFileAction.Description
- Win32_DuplicateFileAction.Destination
- Win32_DuplicateFileAction.Direction
- Win32_DuplicateFileAction.FileKey
- Win32_DuplicateFileAction.Name
- Win32_DuplicateFileAction.SoftwareElementID
- Win32_DuplicateFileAction.SoftwareElementState
- Win32_DuplicateFileAction.Source
- Win32_DuplicateFileAction.TargetOperatingSystem
- Win32_DuplicateFileAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
The **Win32\_DuplicateFileAction** [WMI class](https://msdn.microsoft.com/library/aa393244) represents a file that is duplicated at install time, either to a different directory than the original file, or to the same directory, but with a different name.
...
The **Win32\_DuplicateFileAction** class has these types of members:
...
The **Win32\_DuplicateFileAction** class has these methods.



| Method                                                             | Description                                                                                                          |
|:-------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-duplicatefileaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_DuplicateFileAction** class has these properties.
...
| <span id="4"></span><dl> <dt>**4**</dt> </dl> | Run<br/>         |
...
The **Win32\_DuplicateFileAction** class is derived from [**CIM\_CopyFileAction**](https://msdn.microsoft.com/library/aa387233).
