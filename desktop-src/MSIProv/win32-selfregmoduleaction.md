...
- Win32_SelfRegModuleAction.ActionID
- Win32_SelfRegModuleAction.Caption
- Win32_SelfRegModuleAction.Cost
- Win32_SelfRegModuleAction.Description
- Win32_SelfRegModuleAction.Direction
- Win32_SelfRegModuleAction.File
- Win32_SelfRegModuleAction.Name
- Win32_SelfRegModuleAction.SoftwareElementID
- Win32_SelfRegModuleAction.SoftwareElementState
- Win32_SelfRegModuleAction.TargetOperatingSystem
- Win32_SelfRegModuleAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
The **Win32\_SelfRegModuleAction** [WMI class](https://msdn.microsoft.com/library/aa393244) represents modules that are processed at install time (SelfReg modules). A common form of this processing is the registration of a DLL.
...
The **Win32\_SelfRegModuleAction** class has these types of members:
...
The **Win32\_SelfRegModuleAction** class has these methods.



| Method                                                             | Description                                                                                                          |
|:-------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-selfregmoduleaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_SelfRegModuleAction** class has these properties.
...
Cost, in bytes, to register the module.
...
File identifier of a [**Win32\_FileSpecification**](win32-filespecification.md) instance associated with this SelfReg module action.
...
The **Win32\_SelfRegModuleAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
