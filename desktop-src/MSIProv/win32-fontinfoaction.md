...
- Win32_FontInfoAction.ActionID
- Win32_FontInfoAction.Caption
- Win32_FontInfoAction.Description
- Win32_FontInfoAction.Direction
- Win32_FontInfoAction.File
- Win32_FontInfoAction.FontTitle
- Win32_FontInfoAction.Name
- Win32_FontInfoAction.SoftwareElementID
- Win32_FontInfoAction.SoftwareElementState
- Win32_FontInfoAction.TargetOperatingSystem
- Win32_FontInfoAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
The **Win32\_FontInfoAction** [WMI class](https://msdn.microsoft.com/library/aa393244) represents fonts which have been registered with the system at the same time that the associated software element was installed.
...
The **Win32\_FontInfoAction** class has these types of members:
...
The **Win32\_FontInfoAction** class has these methods.



| Method                                                        | Description                                                                                                          |
|:--------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-fontinfoaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_FontInfoAction** class has these properties.
...
File identifier of a [**Win32\_FileSpecification**](win32-filespecification.md) instance that represents this font file.
...
Font name. If **NULL**, the installer registers the font after reading the correct font title from the font file for TrueType Fonts and TrueType Collections.
...
The **Win32\_FontInfoAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
