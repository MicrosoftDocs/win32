...
- Win32_EnvironmentSpecification.Caption
- Win32_EnvironmentSpecification.CheckID
- Win32_EnvironmentSpecification.CheckMode
- Win32_EnvironmentSpecification.Description
- Win32_EnvironmentSpecification.Environment
- Win32_EnvironmentSpecification.Name
- Win32_EnvironmentSpecification.SoftwareElementID
- Win32_EnvironmentSpecification.SoftwareElementState
- Win32_EnvironmentSpecification.TargetOperatingSystem
- Win32_EnvironmentSpecification.Value
- Win32_EnvironmentSpecification.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
The **Win32\_EnvironmentSpecification** [WMI class](https://msdn.microsoft.com/library/aa393244) contains information about any environment variables that must be registered for their associated products installation.
...
The **Win32\_EnvironmentSpecification** class has these types of members:
...
The **Win32\_EnvironmentSpecification** class has these methods.



| Method                                                                  | Description                                                                                                                                                                                            |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-environmentspecification.md) | Evaluates a particular check. The details of how the method evaluates a particular check in a CIM context are described by the nonabstract [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206) subclasses.<br/> |
...
The **Win32\_EnvironmentSpecification** class has these properties.
...
Condition is expected to exist in the environment. When **TRUE**, the condition is expected to exist (for example, a file is expected to be on a system), so the [**Invoke**](invoke-method-in-class-win32-environmentspecification.md) method is expected to return **TRUE**.
...
Value for this environment as a formatted string.
...
The **Win32\_EnvironmentSpecification** class is derived from [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206).
