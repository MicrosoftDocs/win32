---
title: Win32\_PublishComponentAction class
description: The Win32\_PublishComponentAction WMI class manages the advertisement of the components that may be faulted by other products with the system.
ms.assetid: '7ed36f5c-328a-4b70-82cd-d10156a54721'
keywords: ["Win32_PublishComponentAction class", "Win32_PublishComponentAction class, described"]
topic_type:
- apiref
api_name:
- Win32_PublishComponentAction
- Win32_PublishComponentAction.ActionID
- Win32_PublishComponentAction.AppData
- Win32_PublishComponentAction.Caption
- Win32_PublishComponentAction.ComponentID
- Win32_PublishComponentAction.Description
- Win32_PublishComponentAction.Direction
- Win32_PublishComponentAction.Name
- Win32_PublishComponentAction.Qual
- Win32_PublishComponentAction.SoftwareElementID
- Win32_PublishComponentAction.SoftwareElementState
- Win32_PublishComponentAction.TargetOperatingSystem
- Win32_PublishComponentAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
# Win32\_PublishComponentAction class

The **Win32\_PublishComponentAction** [WMI class](https://msdn.microsoft.com/library/aa393244) manages the advertisement of the components that may be faulted by other products with the system. In the Advertise mode, the action publishes the all components for which the corresponding feature is enabled. Otherwise, the action publishes components for which the corresponding feature is currently selected to be installed.
...
The **Win32\_PublishComponentAction** class has these types of members:
...
The **Win32\_PublishComponentAction** class has these methods.



| Method                                                                | Description                                                                                                          |
|:----------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-publishcomponentaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_PublishComponentAction** class has these properties.
...
Qualified component of this instance. The string is commonly parsed by the application and can be displayed to the user.
...
Software element identifier of the software element associated with this action.
...
Qualifier for the **ComponentID** property. A qualifier is used to distinguish multiple forms of the same software element, such as a software element that is implemented in multiple languages.
...
The **Win32\_PublishComponentAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
