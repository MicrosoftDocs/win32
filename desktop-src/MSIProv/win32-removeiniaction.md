---
title: Win32\_RemoveIniAction class
description: The Win32\_RemoveIniAction WMI class deletes whatever .INI file information that the application requires.
ms.assetid: '4bd36dfa-d7a9-4d65-95b5-fcaa5fbf2fe4'
keywords: ["Win32_RemoveIniAction class", "Win32_RemoveIniAction class, described"]
topic_type:
- apiref
api_name:
- Win32_RemoveIniAction
- Win32_RemoveIniAction.Action
- Win32_RemoveIniAction.ActionID
- Win32_RemoveIniAction.Caption
- Win32_RemoveIniAction.Description
- Win32_RemoveIniAction.Direction
- Win32_RemoveIniAction.Key
- Win32_RemoveIniAction.Name
- Win32_RemoveIniAction.Section
- Win32_RemoveIniAction.SoftwareElementID
- Win32_RemoveIniAction.SoftwareElementState
- Win32_RemoveIniAction.TargetOperatingSystem
- Win32_RemoveIniAction.Value
- Win32_RemoveIniAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
# Win32\_RemoveIniAction class

The **Win32\_RemoveIniAction** [WMI class](https://msdn.microsoft.com/library/aa393244) deletes whatever .INI file information that the application requires. The deletion of the information is gated by the component class. A .INI value is deleted if the corresponding component has been set to be installed either locally or run from source.
...
The **Win32\_RemoveIniAction** class has these types of members:
...
The **Win32\_RemoveIniAction** class has these methods.



| Method                                                         | Description                                                                                                          |
|:---------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-removeiniaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_RemoveIniAction** class has these properties.
...
| Value                                                                                                                                            | Meaning                                     |
|--------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| <span id="0x002__2_"></span><span id="0X002__2_"></span><dl> <dt>**0x002 (2)**</dt> </dl> | Deletes .ini entry.<br/>              |
| <span id="0x004__4_"></span><span id="0X004__4_"></span><dl> <dt>**0x004 (4)**</dt> </dl> | Deletes a tag from a .ini entry.<br/> |
...
The **Win32\_RemoveIniAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
