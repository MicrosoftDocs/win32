---
title: Win32\_SoftwareElementCondition class
description: The Win32\_SoftwareElementCondition WMI class represents conditional checks that must be evaluated to TRUE before their associated Win32\_SoftwareElement component can be installed.
ms.assetid: '5c655f11-8d30-47fd-b928-0ae04a87fd4a'
keywords: ["Win32_SoftwareElementCondition class", "Win32_SoftwareElementCondition class, described"]
topic_type:
- apiref
api_name:
- Win32_SoftwareElementCondition
- Win32_SoftwareElementCondition.Caption
- Win32_SoftwareElementCondition.CheckID
- Win32_SoftwareElementCondition.CheckMode
- Win32_SoftwareElementCondition.Condition
- Win32_SoftwareElementCondition.Description
- Win32_SoftwareElementCondition.Name
- Win32_SoftwareElementCondition.SoftwareElementID
- Win32_SoftwareElementCondition.SoftwareElementState
- Win32_SoftwareElementCondition.TargetOperatingSystem
- Win32_SoftwareElementCondition.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
# Win32\_SoftwareElementCondition class

The **Win32\_SoftwareElementCondition** [WMI class](https://msdn.microsoft.com/library/aa393244) represents conditional checks that must be evaluated to **TRUE** before their associated [**Win32\_SoftwareElement**](win32-softwareelement.md) component can be installed.
...
The **Win32\_SoftwareElementCondition** class has these types of members:
...
The **Win32\_SoftwareElementCondition** class has these methods.



| Method                                                                  | Description                                                                                                                                                                                             |
|:------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-softwareelementcondition.md) | Evaluates a particular check. The details of how the method evaluates a particular check in a CIM context are described by the non-abstract [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206) subclasses.<br/> |
...
The **Win32\_SoftwareElementCondition** class has these properties.
...
Condition is expected to exist in the environment. When **TRUE**, the condition is expected to exist (for example, a file is expected to be on a system), so the [**Invoke**](invoke-method-in-class-win32-softwareelementcondition.md) method is expected to return **TRUE**.
...
Conditional statement which evaluates to **TRUE** or **FALSE** to determine whether the associated software element should is installed.
...
String representing the description of the object.
...
The **Win32\_SoftwareElementCondition** class is derived from [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206).
