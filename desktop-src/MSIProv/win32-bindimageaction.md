...
- Win32_BindImageAction.ActionID
- Win32_BindImageAction.Caption
- Win32_BindImageAction.Description
- Win32_BindImageAction.Direction
- Win32_BindImageAction.File
- Win32_BindImageAction.Name
- Win32_BindImageAction.Path
- Win32_BindImageAction.SoftwareElementID
- Win32_BindImageAction.SoftwareElementState
- Win32_BindImageAction.TargetOperatingSystem
- Win32_BindImageAction.Version
api_location:
- MsiProv.dll
api_type:
- DllExport
...
The **Win32\_BindImageAction** [WMI class](https://msdn.microsoft.com/library/aa393244) binds each executable file that must be bound to the DLLs imported by it. The files are bound by computing the virtual address of each function imported from all DLLs. The computed virtual address is then saved in the importing image's Import Address Table (IAT). The action works on each file installed locally.
...
The **Win32\_BindImageAction** class has these types of members:
...
The **Win32\_BindImageAction** class has these methods.



| Method                                                         | Description                                                                                                          |
|:---------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-bindimageaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_BindImageAction** class has these properties.
...
File identifier of a [**Win32\_FileSpecification**](win32-filespecification.md) instance for which this action applies (must be a valid binary file.)
...
List of semicolon-delimited paths to be searched to find the imported DLLs. The property value is usually a list of [**Win32\_Property**](win32-property.md) instances, with each **Win32\_Property.Name** value enclosed inside square brackets (\[ \]).
...
The **Win32\_BindImageAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
