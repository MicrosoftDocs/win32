---
title: Win32\_ODBCTranslatorSpecification class
description: The Win32\_ODBCTranslatorSpecification WMI class represents any ODBC translator that is included as part of a product's installation.
ms.assetid: '1b53fe06-657a-4246-82ad-23d8b66d16fd'
keywords: ["Win32_ODBCTranslatorSpecification class", "Win32_ODBCTranslatorSpecification class, described"]
topic_type:
- apiref
api_name:
- Win32_ODBCTranslatorSpecification
- Win32_ODBCTranslatorSpecification.Caption
- Win32_ODBCTranslatorSpecification.CheckID
- Win32_ODBCTranslatorSpecification.CheckMode
- Win32_ODBCTranslatorSpecification.Description
- Win32_ODBCTranslatorSpecification.File
- Win32_ODBCTranslatorSpecification.Name
- Win32_ODBCTranslatorSpecification.SetupFile
- Win32_ODBCTranslatorSpecification.SoftwareElementID
- Win32_ODBCTranslatorSpecification.SoftwareElementState
- Win32_ODBCTranslatorSpecification.TargetOperatingSystem
- Win32_ODBCTranslatorSpecification.Translator
- Win32_ODBCTranslatorSpecification.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
# Win32\_ODBCTranslatorSpecification class

The **Win32\_ODBCTranslatorSpecification** [WMI class](https://msdn.microsoft.com/library/aa393244) represents any ODBC translator that is included as part of a product's installation.
...
The **Win32\_ODBCTranslatorSpecification** class has these types of members:
...
The **Win32\_ODBCTranslatorSpecification** class has these methods.



| Method                                                                     | Description                                                                                                                                                                                            |
|:---------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-odbctranslatorspecification.md) | Evaluates a particular check. The details of how the method evaluates a particular check in a CIM context are described by the nonabstract [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206) subclasses.<br/> |
...
The **Win32\_ODBCTranslatorSpecification** class has these properties.
...
Whether the condition is expected to exist in the environment. When **TRUE**, the condition is expected to exist (for example, a file is expected to be on a system), so the [**Invoke**](invoke-method-in-class-win32-odbctranslatorspecification.md) method is expected to return **TRUE**.
...
File identifier of the [**Win32\_FileSpecification**](win32-filespecification.md) instance representing this translator.
...
File identifier of the [**Win32\_FileSpecification**](win32-filespecification.md) instance representing this translator's setup DLL.
...
The **Win32\_ODBCTranslatorSpecification** class is derived from [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206).
