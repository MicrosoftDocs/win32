---
title: Win32\_MIMEInfoAction class
description: The Win32\_MIMEInfoAction WMI class registers the MIME-related registry information with the system.
ms.assetid: 'fcf2f143-70e4-4bae-8683-02156a5cf5f9'
keywords: ["Win32_MIMEInfoAction class", "Win32_MIMEInfoAction class, described"]
topic_type:
- apiref
api_name:
- Win32_MIMEInfoAction
- Win32_MIMEInfoAction.ActionID
- Win32_MIMEInfoAction.Caption
- Win32_MIMEInfoAction.CLSID
- Win32_MIMEInfoAction.ContentType
- Win32_MIMEInfoAction.Description
- Win32_MIMEInfoAction.Direction
- Win32_MIMEInfoAction.Extension
- Win32_MIMEInfoAction.Name
- Win32_MIMEInfoAction.SoftwareElementID
- Win32_MIMEInfoAction.SoftwareElementState
- Win32_MIMEInfoAction.TargetOperatingSystem
- Win32_MIMEInfoAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
The **Win32\_MIMEInfoAction** class has these types of members:
...
The **Win32\_MIMEInfoAction** class has these methods.



| Method                                                        | Description                                                                                                          |
|:--------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-mimeinfoaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_MIMEInfoAction** class has these properties.
...
COM server CLSID that is associated with the MIME content.
...
Identifier for the MIME content. It is commonly written in the form of type/format.
...
Server extension that is to be associated with the MIME content, without the dot.
...
The **Win32\_MIMEInfoAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
