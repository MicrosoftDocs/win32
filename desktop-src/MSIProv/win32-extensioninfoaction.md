...
- Win32_ExtensionInfoAction.ActionID
- Win32_ExtensionInfoAction.Argument
- Win32_ExtensionInfoAction.Caption
- Win32_ExtensionInfoAction.Command
- Win32_ExtensionInfoAction.Description
- Win32_ExtensionInfoAction.Direction
- Win32_ExtensionInfoAction.Extension
- Win32_ExtensionInfoAction.MIME
- Win32_ExtensionInfoAction.Name
- Win32_ExtensionInfoAction.ProgID
- Win32_ExtensionInfoAction.ShellNew
- Win32_ExtensionInfoAction.ShellNewValue
- Win32_ExtensionInfoAction.SoftwareElementID
- Win32_ExtensionInfoAction.SoftwareElementState
- Win32_ExtensionInfoAction.TargetOperatingSystem
- Win32_ExtensionInfoAction.Verb
- Win32_ExtensionInfoAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
The **Win32\_ExtensionInfoAction** [WMI class](https://msdn.microsoft.com/library/aa393244) manages the registration of extension-related information with the system. The action registers the extension servers for which the corresponding feature is currently selected to be uninstalled.
...
The **Win32\_ExtensionInfoAction** class has these types of members:
...
The **Win32\_ExtensionInfoAction** class has these methods.



| Method                                                             | Description                                                                                                          |
|:-------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-extensioninfoaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_ExtensionInfoAction** class has these properties.
...
The **Win32\_ExtensionInfoAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
