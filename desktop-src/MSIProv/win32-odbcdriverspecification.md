---
title: Win32\_ODBCDriverSpecification class
description: The Win32\_ODBCDriverSpecification WMI class represents any ODBC driver that is to be installed as part of a particular product.
ms.assetid: '12e2d8cd-24ff-47bd-8776-4b7a0bc2e195'
keywords: ["Win32_ODBCDriverSpecification class", "Win32_ODBCDriverSpecification class, described"]
topic_type:
- apiref
api_name:
- Win32_ODBCDriverSpecification
- Win32_ODBCDriverSpecification.Caption
- Win32_ODBCDriverSpecification.CheckID
- Win32_ODBCDriverSpecification.CheckMode
- Win32_ODBCDriverSpecification.Description
- Win32_ODBCDriverSpecification.Driver
- Win32_ODBCDriverSpecification.File
- Win32_ODBCDriverSpecification.Name
- Win32_ODBCDriverSpecification.SetupFile
- Win32_ODBCDriverSpecification.SoftwareElementID
- Win32_ODBCDriverSpecification.SoftwareElementState
- Win32_ODBCDriverSpecification.TargetOperatingSystem
- Win32_ODBCDriverSpecification.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
# Win32\_ODBCDriverSpecification class

The **Win32\_ODBCDriverSpecification** [WMI class](https://msdn.microsoft.com/library/aa393244) represents any ODBC driver that is to be installed as part of a particular product.
...
The **Win32\_ODBCDriverSpecification** class has these types of members:
...
The **Win32\_ODBCDriverSpecification** class has these methods.



| Method                                                                 | Description                                                                                                                                                                                             |
|:-----------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-odbcdriverspecification.md) | Evaluates a particular check. The details of how the method evaluates a particular check in a CIM context are described by the non-abstract [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206) subclasses.<br/> |
...
The **Win32\_ODBCDriverSpecification** class has these properties.
...
Whether the condition is expected to exist in the environment. When **TRUE**, the condition is expected to exist (for example, a file is expected to be on a system), so the [**Invoke**](invoke-method-in-class-win32-odbcdriverspecification.md) method is expected to return **TRUE**.
...
String that represents the token name for the driver within its package.
...
File identifier (FileID) of the [**Win32\_FileSpecification**](win32-filespecification.md) instance representing this driver.
...
File identifier (FileID) of the [**Win32\_FileSpecification**](win32-filespecification.md) instance representing this driver's setup DLL.
...
The **Win32\_ODBCDriverSpecification** class is derived from [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206).
