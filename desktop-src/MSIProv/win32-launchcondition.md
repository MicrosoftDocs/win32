...
- Win32_LaunchCondition.Caption
- Win32_LaunchCondition.CheckID
- Win32_LaunchCondition.CheckMode
- Win32_LaunchCondition.Condition
- Win32_LaunchCondition.Description
- Win32_LaunchCondition.Name
- Win32_LaunchCondition.SoftwareElementID
- Win32_LaunchCondition.SoftwareElementState
- Win32_LaunchCondition.TargetOperatingSystem
- Win32_LaunchCondition.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
The **Win32\_LaunchCondition** [WMI class](https://msdn.microsoft.com/library/aa393244) contains a list of conditions, all of which must be satisfied for the action to succeed.
...
The **Win32\_LaunchCondition** class has these types of members:
...
The **Win32\_LaunchCondition** class has these methods.



| Method                                                         | Description                                                                                                                                                                                            |
|:---------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-launchcondition.md) | Evaluates a particular check. The details of how the method evaluates a particular check in a CIM context are described by the nonabstract [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206) subclasses.<br/> |
...
The **Win32\_LaunchCondition** class has these properties.
...
Condition is expected to exist in the environment. When **TRUE**, the condition is expected to exist (for example, a file is expected to be on a system), so the [**Invoke**](invoke-method-in-class-win32-launchcondition.md) method is expected to return **TRUE**.
...
Condition that must evaluate to **TRUE** for installation to begin.
...
The **Win32\_LaunchCondition** class is derived from [**CIM\_Check**](https://msdn.microsoft.com/library/aa387206).
