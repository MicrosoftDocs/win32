---
title: Win32\_TypeLibraryAction class
description: The Win32\_TypeLibraryAction schema WMI class registers type libraries with the system. The action works on each file referenced which is triggered to be installed.
ms.assetid: '20e2608a-eb43-4df2-9be9-54a0ab270580'
keywords: ["Win32_TypeLibraryAction class", "Win32_TypeLibraryAction class, described"]
topic_type:
- apiref
api_name:
- Win32_TypeLibraryAction
- Win32_TypeLibraryAction.ActionID
- Win32_TypeLibraryAction.Caption
- Win32_TypeLibraryAction.Cost
- Win32_TypeLibraryAction.Description
- Win32_TypeLibraryAction.Direction
- Win32_TypeLibraryAction.Language
- Win32_TypeLibraryAction.LibID
- Win32_TypeLibraryAction.Name
- Win32_TypeLibraryAction.SoftwareElementID
- Win32_TypeLibraryAction.SoftwareElementState
- Win32_TypeLibraryAction.TargetOperatingSystem
- Win32_TypeLibraryAction.Version
api_location:
- Msiprov.dll
api_type:
- DllExport
...
# Win32\_TypeLibraryAction class

The **Win32\_TypeLibraryAction** schema [WMI class](https://msdn.microsoft.com/library/aa393244) registers type libraries with the system. The action works on each file referenced which is triggered to be installed.
...
The **Win32\_TypeLibraryAction** class has these types of members:
...
The **Win32\_TypeLibraryAction** class has these methods.



| Method                                                           | Description                                                                                                          |
|:-----------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-win32-typelibraryaction.md) | Takes a particular action. The details of how the method performs the action are implementation-specific.<br/> |
...
The **Win32\_TypeLibraryAction** class has these properties.
...
Cost, in bytes, associated with the registration of the type library.
...
| Value                                                                                                | Meaning              |
|------------------------------------------------------------------------------------------------------|----------------------|
| <span id="0"></span><dl> <dt>**0**</dt> </dl> | Install<br/>   |
| <span id="1"></span><dl> <dt>**1**</dt> </dl> | Uninstall<br/> |
...
GUID that identifies the library.
...
The **Win32\_TypeLibraryAction** class is derived from [**CIM\_Action**](https://msdn.microsoft.com/library/aa386541).
