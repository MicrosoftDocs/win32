...
The [**SnmpGetLastError**](/windows/win32/Winsnmp/nf-winsnmp-snmpgetlasterror?branch=master) function can return a general error code after a WinSNMP function fails. The following table lists the WinSNMP common error codes.



| Error code                | Meaning                                                                                                                                                                                                        | Recommended action                                                                                                                                                                                                                                                                                                                                                                    |
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMPAPI\_NOT\_INITIALIZED | The [**SnmpStartup**](/windows/win32/Winsnmp/nf-winsnmp-snmpstartup?branch=master) function did not complete successfully either since program execution began, or since a call to the [**SnmpCleanup**](/windows/win32/Winsnmp/nf-winsnmp-snmpcleanup?branch=master) function completed successfully. | The application should call [**SnmpGetLastError**](/windows/win32/Winsnmp/nf-winsnmp-snmpgetlasterror?branch=master) before it calls any other WinSNMP API function when [**SnmpStartup**](/windows/win32/Winsnmp/nf-winsnmp-snmpstartup?branch=master) fails. The [**SnmpGetLastError**](/windows/win32/Winsnmp/nf-winsnmp-snmpgetlasterror?branch=master) function returns extended error information about the failure of [**SnmpStartup**](/windows/win32/Winsnmp/nf-winsnmp-snmpstartup?branch=master).                                                          |
| SNMPAPI\_ALLOC\_ERROR     | The application specified an invalid pointer, or an error occurred during memory allocation. The Microsoft WinSNMP implementation could not obtain sufficient resources to execute the request.                | The application should provide valid memory pointers for all output parameters. It should free resources, reduce resource requirements, or facilitate a graceful shutdown. A graceful shutdown includes multiple calls to the [**SnmpClose**](/windows/win32/Winsnmp/nf-winsnmp-snmpclose?branch=master) function, one for each open WinSNMP session. It also includes a call to the [**SnmpCleanup**](/windows/win32/Winsnmp/nf-winsnmp-snmpcleanup?branch=master) function. |
