...
An application can set the retransmission mode with a call to the [**SnmpSetRetransmitMode**](snmpsetretransmitmode.md) function. The new retransmission mode applies to subsequent calls to the [**SnmpSendMsg**](snmpsendmsg.md) function.
