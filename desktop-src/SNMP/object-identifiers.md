...
The WinSNMP programming environment uses the [**smiOID**](smioid-str.md) structure to manage object identifiers. The format of the object identifier array in an **smiOID** structure is one subidentifier per array element.
