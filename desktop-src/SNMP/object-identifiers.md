...
The WinSNMP programming environment uses the [**smiOID**](/windows/win32/Winsnmp/ns-winsnmp-smioid?branch=master) structure to manage object identifiers. The format of the object identifier array in an **smiOID** structure is one subidentifier per array element.
