...
| [**AsnCounter64**](https://msdn.microsoft.com/en-us/library/Aa377953(v=VS.85).aspx)               | Contains a 64-bit counter that is specified by two values describing its low-order and high-order bits. |
