...
| <span id="SNMP_EXTENSION_SET_TEST"></span><span id="snmp_extension_set_test"></span><dl> <dt>**SNMP\_EXTENSION\_SET\_TEST**</dt> </dl>                                                                           | Validate the values of the specified variables. This operation maximizes the probability of a successful write operation during the COMMIT request. For more information, see the [**SnmpExtensionQueryEx**](/windows/win32/Snmp/nf-snmp-snmpextensionqueryex?branch=master) function.<br/> |
