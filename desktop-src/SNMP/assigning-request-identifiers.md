...
A WinSNMP application can call the [**SnmpCreatePdu**](/windows/win32/Winsnmp/nf-winsnmp-snmpcreatepdu?branch=master) function or the [**SnmpSetPduData**](/windows/win32/Winsnmp/nf-winsnmp-snmpsetpdudata?branch=master) function to assign an application-generated request identifier to a PDU. The application must pass the value in the *request\_id* parameter.

An application can request that the Microsoft WinSNMP implementation generate and assign a request identifier to a PDU by passing zero in the *request\_id* parameter of the [**SnmpCreatePdu**](/windows/win32/Winsnmp/nf-winsnmp-snmpcreatepdu?branch=master) function. The application can retrieve the assigned request identifier with a call to the [**SnmpGetPduData**](/windows/win32/Winsnmp/nf-winsnmp-snmpgetpdudata?branch=master) function.

To assign a request identifier equal to a specific value, including zero, the application must pass that value in the *request\_id* parameter of the [**SnmpSetPduData**](/windows/win32/Winsnmp/nf-winsnmp-snmpsetpdudata?branch=master) function.
