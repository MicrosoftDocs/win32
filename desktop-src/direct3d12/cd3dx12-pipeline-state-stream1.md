...
keywords: ["CD3DX12_PIPELINE_STATE_STREAM1 structure"]
topic_type:
- apiref
api_name:
...
[**CD3DX12\_PIPELINE\_STATE\_STREAM**](direct3d12-cd3dx12_graphics_pipeline_state_stream) supports the Windows 10 Fall Creators Update, but doesn't support subobject types added in Windows 10 Fall Creators update, such as for view instancing. To support the new subobject types, use CD3DX12\_PIPELINE\_STATE\_STREAM1 instead.
