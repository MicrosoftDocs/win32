...
The TensorFlow with DirectML preview on native Windows works starting with Windows 10 Version 1709 (Build 16299 or higher). You can check your build version number by running `winver` via the**Run** command.
