...
| [Readback Data Through Buffers](readback-data-using-heaps.md)<br/>                    | Reading back data from the GPU, such as capturing a screen shot, involves the use of the Readback heap. <br/>                                                                                                                                                                                                                                                                                                     |
