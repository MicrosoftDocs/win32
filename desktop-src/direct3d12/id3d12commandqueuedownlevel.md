...
This interface can be accessed via **QueryInterface** off of a [Direct3D 12 command queue](/windows/desktop/api/d3d12/nn-d3d12-id3d12commandqueue) when using [Direct3D 12 on Windows 7](http://aka.ms/d3d12on7). It provides a Windows-7-specific present mechanism.
