...
keywords:
- CD3DX12_PIPELINE_STATE_STREAM_DS structure
topic_type:
- apiref
api_name:
...
Creates a new instance of a CD3DX12\_PIPELINE\_STATE\_STREAM\_DS, initialized with a subobject type of **D3D12\_PIPELINE\_STATE\_SUBOBJECT\_TYPE\_DS** and subobject data copied from *i*, a [**D3D12\_SHADER\_BYTECODE**](/windows/win32/D3D12/ns-d3d12-d3d12_shader_bytecode?branch=master) structure.
