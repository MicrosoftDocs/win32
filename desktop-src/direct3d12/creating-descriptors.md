...
Refer to the [**DXGI\_FORMAT**](https://msdn.microsoft.com/library/windows/desktop/bb173059) enum. Typically for an index buffer the following define might be used:
