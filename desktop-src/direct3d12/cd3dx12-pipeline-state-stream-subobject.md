...
Creates a new CD3DX12\_PIPELINE\_STATE\_STREAM\_SUBOBJECT template instance, initialized with a subobject type of [**D3D12\_PIPELINE\_STATE\_SUBOBJECT\_TYPE**](https://msdn.microsoft.com/library/windows/desktop/mt492580) and subobject data copied from *i*. Both the subobject type and subobject data type are given as template parameters, **Type** and **InnerStructType**, respectively. For more information, see Remarks below.
