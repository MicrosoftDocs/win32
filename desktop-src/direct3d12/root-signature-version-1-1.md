...
-   [Static and Volatile Flags](#static-and-volatile-flags)
    -   [DESCRIPTORS\_VOLATILE](#descriptors-volatile)
    -   [DATA\_VOLATILE](#data-volatile)
    -   [DATA\_STATIC\_WHILE\_SET\_AT\_EXECUTE](#data-static-while-set-at-execute)
    -   [DATA\_STATIC](#data-static-while-set-at-execute)
