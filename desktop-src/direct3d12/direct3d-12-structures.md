...
| [**D3D12_FEATURE_DATA_D3D12_OPTIONS10**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_data_d3d12_options10). Indicates whether or not the SUM combiner can be used, and whether or not *SV_ShadingRate* can be set from a mesh shader. |
| [**D3D12_FEATURE_DATA_D3D12_OPTIONS11**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_data_d3d12_options11). Indicates whether or not 64-bit integer atomics on resources in descriptor heaps are supported. |
...
| [**D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPE_COUNT**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_data_protected_resource_session_type_count). Indicates a count of protected resource session types. |
| [**D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPES**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_data_protected_resource_session_types). Indicates a list of protected resource session types. |
