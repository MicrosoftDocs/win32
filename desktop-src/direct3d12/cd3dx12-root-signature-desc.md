...
A helper structure to enable easy initialization of a [**D3D12\_ROOT\_SIGNATURE\_DESC**](/windows/win32/D3D12/ns-d3d12-d3d12_root_signature_desc?branch=master) structure.
...
Creates a new instance of a CD3DX12\_ROOT\_SIGNATURE\_DESC, initialized with the contents of another [**D3D12\_ROOT\_SIGNATURE\_DESC**](/windows/win32/D3D12/ns-d3d12-d3d12_root_signature_desc?branch=master) structure.
...
[**D3D12\_ROOT\_PARAMETER**](/windows/win32/D3D12/ns-d3d12-d3d12_root_parameter?branch=master)\* \_pParameters

(opt) UINT numStaticSamplers = 0

(opt) [**D3D12\_STATIC\_SAMPLER\_DESC**](/windows/win32/d3d12/ns-d3d12-d3d12_static_sampler_desc?branch=master)\* \_pStaticSamplers = NULL

(opt) [**D3D12\_ROOT\_SIGNATURE\_FLAGS**](/windows/win32/D3D12/ne-d3d12-d3d12_root_signature_flags?branch=master) flags = D3D12\_ROOT\_SIGNATURE\_FLAG\_NONE
...
[**D3D12\_ROOT\_SIGNATURE\_DESC**](/windows/win32/D3D12/ns-d3d12-d3d12_root_signature_desc?branch=master) &desc
...
[**D3D12\_ROOT\_SIGNATURE\_DESC**](/windows/win32/D3D12/ns-d3d12-d3d12_root_signature_desc?branch=master)
</dt> <dt>
