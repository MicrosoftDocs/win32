...
| [Advanced Shader Delivery](advanced-shader-delivery.md) | Advanced Shader Delivery precompiles Direct3D 12 shaders in the cloud and delivers them at download time, reducing first-launch load times, in-game shader compilation stutter, and power consumption. |
