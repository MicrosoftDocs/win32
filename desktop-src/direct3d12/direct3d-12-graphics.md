...
| Topic                                                                        | Description                                                                                                                                                                                      |
|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Direct3D 12 Programming Guide](directx-12-programming-guide.md)<br/> | Direct3D 12 provides an API and platform that allows apps to take advantage of the graphics and computing capabilities of PCs equipped with one or more Direct3D 12-compatible GPUs. <br/> |
| [Direct3D 12 Reference](direct3d-12-reference.md)<br/>                | This section covers APIs for Direct3D 12-based graphics programming. <br/>                                                                                                                 |
| [Direct3D 12 Glossary](directx-12-glossary.md)<br/>                   | These terms are distinctive of Direct3D 12. <br/>                                                                                                                                          |
