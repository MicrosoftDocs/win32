...
For more information on inheritance, refer to the **Graphics pipeline state inheritance** section of [Managing Graphics Pipeline State in Direct3D 12](https://www.bing.com/search?q=Managing Graphics Pipeline State in Direct3D 12).
