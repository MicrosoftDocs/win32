---
title: CD3DX12\_PIPELINE\_STATE\_STREAM\_VS structure
...
keywords: ["CD3DX12_PIPELINE_STATE_STREAM_VS structure"]
topic_type:
- apiref
api_name:
...
Creates a new instance of a CD3DX12\_PIPELINE\_STATE\_STREAM\_VS, initialized with a subobject type of **D3D12\_PIPELINE\_STATE\_SUBOBJECT\_TYPE\_VS** and subobject data copied from *i*, a [**D3D12\_SHADER\_BYTECODE**](d3d12-shader-bytecode.md) structure.
