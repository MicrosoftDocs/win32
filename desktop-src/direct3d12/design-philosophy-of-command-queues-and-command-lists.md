...
1. Apps now own how rendering calls are grouped into graphics processing unit (GPU) work items. This enables re-use.  
1. Apps now explicitly control when work is submitted to the GPU . This enables items 1 and 2.  
