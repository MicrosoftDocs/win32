...
Most apps will use only the interfaces at the top of the hierarchy, and not directly use the inherited interfaces; [**ID3D12Pageable**](/windows/desktop/api/D3D12/), [**ID3D12DeviceChild**](/windows/desktop/api/D3D12/nn-d3d12-id3d12devicechild), [**ID3D12Object**](/windows/desktop/api/D3D12/nn-d3d12-id3d12object) and [**ID3D12CommandList**](/windows/desktop/api/D3D12/nn-d3d12-id3d12commandlist).
