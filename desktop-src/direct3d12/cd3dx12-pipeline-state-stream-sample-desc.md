...
Creates a new instance of a CD3DX12\_PIPELINE\_STATE\_STREAM\_SAMPLE\_DESC, initialized with a subobject type of **D3D12\_PIPELINE\_STATE\_SUBOBJECT\_TYPE\_SAMPLE\_DESC** and subobject data copied from *i*, a [**DXGI\_SAMPLE\_DESC**](direct3d12-dxgi_sample_desc) structure.
...
Implicit conversion to a [**DXGI\_SAMPLE\_DESC**](direct3d12-dxgi_sample_desc) structure.
