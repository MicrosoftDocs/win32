...
| [**IDMLDevice1**](/windows/desktop/direct3d12/directml/nn-directml-idmldevice1) | Represents a DirectML device, which is used to create operators, binding tables, command recorders, and other objects. |
