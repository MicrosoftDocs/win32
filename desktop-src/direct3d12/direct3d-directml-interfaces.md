...
| [**IDMLDeviceChild**](/windows/desktop/api/directml/nn-directml-idmldevicechild) | An interface implemented by all objects created from the DirectML device. |
