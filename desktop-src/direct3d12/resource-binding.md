...
| [Capability Querying](capability-querying.md)<br/>                                                 | Applications can discover the level of support for resource binding, and many other features, via the [**ID3D12Device::CheckFeatureSupport**](id3d12device-checkfeaturesupport.md) call. <br/>                                                                                                                                                                                                                                                                                                                                                                     |
