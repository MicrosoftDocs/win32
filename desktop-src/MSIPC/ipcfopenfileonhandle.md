...
description: Gets an IPCF\_FILE\_HANDLE associated with an encrypted file which can be used to access and modify that files data.
audience: developer
...
keywords:
- IpcfOpenFileOnHandle function Active Directory Rights Management Services SDK 2.0
topic_type:
- apiref
api_name:
