---
title: Client
description: This topic describes the purpose and function of the Rights Management Service Client 2.1.
audience: developer
...
For more information, see the [TechNet documentation on the RMS Client 2.0](https://TechNet.Microsoft.Com/library/jj159267(WS.10).aspx).
