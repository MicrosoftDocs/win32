---
title: IpcfGetEncryptedFilePathFromStream function
description: Used to get the expected, encrypted, absolute file path.
audience: developer
author: REDMOND\\bruceper
manager: REDMOND\\mbaldwin
ms.assetid: '132E55DD-47D4-4133-A6C7-76EA28F81587'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
keywords: ["IpcfGetEncryptedFilePathFromStream function Active Directory Rights Management Services SDK 2.0"]
topic_type:
- apiref
api_name:
...
# IpcfGetEncryptedFilePathFromStream function
