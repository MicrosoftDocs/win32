...
> [!Note]  
> A filter handler is an implementation of the [**IFilter**](-search-ifilter.md) interface.
...
|------------------------------------------|-----------------------------|-----------------------------------------------------------------------------------------------------------|
| **89BCB740-6119-101A-BCB7-00DD010655AF** | Application                 | The [**IFilter**](-search-ifilter.md) interface GUID is a registry key constant for all filter handlers. |
