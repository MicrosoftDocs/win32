...
Note that for majority of full text matching scenarios, it is highly recommended to use the newer and better tuned FREETEXT predicate. The CONTAINS predicate exists for backward compatibility, and should be used only on a need-basis for specific use cases.
