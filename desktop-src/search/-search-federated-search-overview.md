...
-   The [OpenSearch](-search-sample-opensearch.md) code sample, available on [Code Gallery](http://go.microsoft.com/fwlink/p/?linkid=155658) and the [Windows 7 SDK](http://go.microsoft.com/fwlink/p/?linkid=129787), demonstrates how to create a federated search service using the [OpenSearch](http://go.microsoft.com/fwlink/p/?linkid=147911) protocol, and an OpenSearch Descriptor (.osdx) file (a search connector).
-   For a video demonstration of creating an [OpenSearch](http://go.microsoft.com/fwlink/p/?linkid=147911) web service for a SQL database, see [Windows 7: Empower Users to Find, Visualize and Organize their Data with Libraries and the Explorer](http://go.microsoft.com/fwlink/p/?linkid=147942).
-   If you are writing a client-side [OpenSearch](http://go.microsoft.com/fwlink/p/?linkid=147911) provider, see:
    -   The [OpenSearch Developer How To Guide](http://www.opensearch.org/Documentation/Developer_how_to_guide) for more information on connecting to a client-side provider by using a proprietary data store's protocols or APIs.
...
-   See the [Microsoft Download Center](http://www.microsoft.com/DOWNLOADS/en/default.aspx) website for the following downloadable resource: Search Server 2008 Sample: Federated Search Connector Sample.
