...
| [propertyStore](search-schema-sconn-propertystore.md)                                 | Specifies the location of an XML-based [**IPropertyStore**](https://msdn.microsoft.com/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) for this search connector. The **IPropertyStore** supports the search connector's open metadata. |
