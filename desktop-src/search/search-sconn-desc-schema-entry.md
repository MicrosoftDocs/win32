...
| [propertyStore](search-schema-sconn-propertystore.md)                                 | Specifies the location of an XML-based [**IPropertyStore**](properties.IPropertyStore) for this search connector. The **IPropertyStore** supports the search connector's open metadata. |
