...
As of Windows 8, DateTime properties (like [System.DateModified](properties.props_System_DateModified)) support the canonical date and time format specified by [ISO-8601](http://go.microsoft.com/fwlink/p/?linkid=107369), optionally including the UTC time zone.
...
-   AQS queries can be limited to specific types of files, which are known as file kinds. For more information, see [File Types and Associations](http://msdn.microsoft.com/en-us/library/cc144104(VS.85).aspx). For property reference documentation, see [System.Kind](shell.props_System_Kind), and [System.KindText](shell.props_System_KindText).
