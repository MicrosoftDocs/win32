...
Different handlers have some commonality. In Windows Vista and later, all handlers must use one of the following interfaces to initialize the handler: [**IInitializeWithStream**](shell.IInitializeWithStream), [**IInitializeWithItem**](shell.IInitializeWithItem), or [**IItinitializeWithFile**](shell.IInitializeWithFile).
...
| Adding clipboard formats for the data object ([**IDataObject**](com.idataobject)) of an item (Data objects are used in drag-and-drop and copy/paste scenarios.) | Data object handler              | [Creating Data Handlers](shell.data_handlers)                                                                                                                                                          |
| Adding verbs for an item that are commonly displayed in a shortcut menu                                                                                         | Shortcut menu handler            | [Creating Context Menu Handlers](shell.context_menu_handlers)<br/> [Customizing a Shortcut Menu Using Dynamic Verbs](shell.shortcut_menu_using_dynamic_verbs)<br/>                         |
| Associating a file type with a specific icon                                                                                                                    | Icon handler                     | [Creating Icon Handlers](shell.icon_handlers)                                                                                                                                                          |
| Creating property sheets with UI pictures and controls that permit custom interaction with a file type                                                          | Property sheet handler           | [Property Sheet Handlers](shell.propsheet_handlers)                                                                                                                                                    |
| Enabling an item type to support drag-and-drop and copy/paste scenarios                                                                                         | Drop handler                     | [Transferring Shell Objects with Drag-and-Drop and the Clipboard](shell.dragdrop)                                                                                                                      |
...
| Previewing a simplified view of the Shell item in the Windows Explorer preview pane                                                                             | Preview handler                  | [Preview Handlers](shell.Preview_Handlers)                                                                                                                                                             |
| Supplying pop-up text when a mouse hovers over a UI object                                                                                                      | Infotip handler                  | [Creating Shell Extension Handlers](shell.handlers) (Infotip Customization)                                                                                                                            |
| Supplying a static image to represent a Shell item                                                                                                              | Thumbnail handler                | [Thumbnail Handlers](shell.Thumbnail_Providers)                                                                                                                                                        |
...
| Handler                | Interfaces                                                                                                                                                                                                                                                                                                                                                                |
|------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Drop handler           | [**IDropTarget**](com.idroptarget), [**IDropTargetHelper**](shell.IDropTargetHelper), [**IPersistFile**](com.ipersistfile), [**IShellExtInit**](shell.IShellExtInit)                                                                                                                                                                                                      |
| Data object handler    | [**IDataObject**](com.idataobject), [**IPersistFile**](com.ipersistfile)                                                                                                                                                                                                                                                                                                  |
| Filter handler         | [**IFilter**](-search-ifilter.md)<br/>                                                                                                                                                                                                                                                                                                                             |
| Icon handler           | [**IExtractIcon**](shell.IExtractIcon)<br/> Optional: [**IPersist**](com.ipersist), [**IPersistFile**](com.ipersistfile)<br/>                                                                                                                                                                                                                                 |
...
For more information about creating handlers, see [Creating Shell Extension Handlers](shell.handlers). For more information about properties, see [Windows Property System](properties.windows_property_system).
...
-   For information about creating a Shell data source, see [Implementing the Basic Folder Object Interfaces](shell.nse_implement).
-   For data sources that need to use the Shell Default System Folder View Object (DefView), see [Implementing a Folder View](lwef.nse_folderview), [**SHCreateShellFolderView**](shell.SHCreateShellFolderView) function, and [**SFV\_CREATE**](shell.SFV_CREATE) structure. Data sources that use the Shell Default System Folder View Object (DefView) must implement the following set of interfaces: [**IShellFolder**](shell.IShellFolder), [**IShellFolder2**](shell.IShellFolder2), [**IPersistFolder**](shell.IPersistFolder), [**IPersistFolder2**](shell.IPersistFolder2), and (optionally) [**IPersistFolder3**](shell.IPersistFolder3). If your **IShellFolder** implementation does not use **SHCreateShellFolderView** to create the DefView, the Shell view object may need [**IFolderView**](shell.IFolderView).
-   [**ISearchFolderItemFactory**](shell.ISearchFolderItemFactory) is the primary interface for consumers of the Shell data source known as DBFolder. For more information about DBFolder, see the description of the STR\_PARSE\_WITH\_PROPERTIES constant in [**Bind Context String Keys**](shell.STR_constants). See also [Association Arrays](shell.fa_associationarray) and [**IPropertySystem::GetPropertyDescriptionListFromString**](properties.IPropertySystem_GetPropertyDescriptionListFromString).
