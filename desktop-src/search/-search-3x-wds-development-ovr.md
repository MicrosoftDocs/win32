...
| Adding clipboard formats for the data object ([**IDataObject**](https://msdn.microsoft.com/en-us/library/ms688421(v=VS.85).aspx)) of an item (Data objects are used in drag-and-drop and copy/paste scenarios.) | Data object handler              | [Creating Data Handlers](https://www.bing.com/search?q=Creating+Data+Handlers)                                                                                                                                                          |
...
For more information about creating handlers, see [Creating Shell Extension Handlers](https://msdn.microsoft.com/en-us/library/Cc144067(v=VS.85).aspx). For more information about properties, see [Windows Property System](https://www.bing.com/search?q=Windows+Property+System).
