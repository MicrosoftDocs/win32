...
The **IWordSink** interface inherits from the [**IUnknown**](com.iunknown) interface. **IWordSink** also has these types of members:
...
[**IWordBreaker**](search._search_iwordbreaker) implementations receive a pointer to the **IWordSink** object in the [**IWordBreaker::BreakText**](search._search_iwordbreaker_breaktext) method.
