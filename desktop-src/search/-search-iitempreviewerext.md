...
The **IItemPreviewerExt** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/33f1d79a-33fc-4ce5-a372-e08bda378332) interface. **IItemPreviewerExt** also has these types of members:
