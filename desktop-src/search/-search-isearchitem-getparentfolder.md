...
On return, contains the address of a pointer to the folder that contains the current URL. [IShellFolder Interface](http://msdn.microsoft.com/en-us/library/bb775075(VS.85).aspx) is exposed by all Shell namespace folder objects, and its methods are used to manage folders.
