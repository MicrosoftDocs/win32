...
Windows Search supports the standard OLE-DB property DBPROP\_COMMANDTIMEOUT of the [DBPROPSET\_ROWSET](http://msdn.microsoft.com/en-us/library/ms691738.aspx) property set.
