...
-   For information on OLE DB, see [OLE DB Programming Overview](vcconOverviewOLEDBProgramming). For information on the .NET Framework Data Provider for OLE DB, see the [System.Data.OleDb Namespace](http://msdn.microsoft.com/en-us/library/system.data.oledb(VS.71).aspx).
...
-   For information on how to create and modify search folders, see [**ISearchFolderItemFactory Interface**](_shell_ISearchFolderItemFactory).
