...
The following table lists the results that the gatherer receives from a filter ([**IFilter**](-search-ifilter.md)) and property handler ([**IPropertyStore**](properties.IPropertyStore)) during the indexing process.



|                            | [**IFilter**](-search-ifilter.md) | [**IPropertyStore**](properties.IPropertyStore) |
|----------------------------|------------------------------------|-------------------------------------------------|
| Allow write                | No                                 | Yes                                             |
