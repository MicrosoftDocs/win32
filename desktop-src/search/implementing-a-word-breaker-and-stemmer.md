...
The stemmer uses the [IWordFormSink](/windows/win32/Indexsrv/nn-indexsrv-iwordformsink?branch=master) object to gather the list of alternative words. [**IWordFormSink::PutWord**](iwordformsink-putword.md) generates the final word from the stemmer. In all cases, this final word is the same as the input word from [**IStemmer::GenerateWordForms**](/windows/win32/Indexsrv/nf-indexsrv-istemmer-generatewordforms?branch=master). For example, given the word "swim," the stemmer generates the following word forms: "swimming," "swimmer," "swims," "swam," and "swum," through calls to [**IWordFormSink::PutAltWord**](iwordformsink-putphrase.md). The stemmer generates "swim" through **IWordFormSink::PutWord**.
