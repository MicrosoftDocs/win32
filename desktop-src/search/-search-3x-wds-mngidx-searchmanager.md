...
| [**GetIndexerVersion**](/windows/desktop/api/Searchapi/nf-searchapi-isearchmanager-getindexerversion)       | Returns the version of the indexer in two integers: major version and minor version. For example, the major version number for Windows Vista Search and Windows Search 3.0 on Windows XP is "3" and the minor version number is "0". |
| [**GetIndexerVersionStr**](/windows/desktop/api/Searchapi/nf-searchapi-isearchmanager-getindexerversionstr) | Returns the complete version number of the indexer as a string: for example, "03.00.5824.280".                                                                                                                                       |
