...
-   [IEnumSearchScopeRules](https://msdn.microsoft.com/en-us/library/bb266499(VS.85).aspx)
-   [**ISearchCrawlScopeManager**](/windows/desktop/api/Searchapi/nn-searchapi-isearchcrawlscopemanager)
-   [ISearchCrawlScopeManager2](https://msdn.microsoft.com/en-us/library/dd797832(VS.85).aspx)
...
-   [ISearchItem](https://msdn.microsoft.com/en-us/library/dd756722(VS.85).aspx)
