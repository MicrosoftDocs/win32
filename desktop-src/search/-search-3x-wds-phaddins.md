...
-   To extend the Shell with file type handlers, see [Creating Shell Extension Handlers](https://msdn.microsoft.com/en-us/library/Cc144067(VS.85).aspx).
-   For conceptual information on filter handlers, see [Developing Filter Handlers](-search-ifilter-conceptual.md).
-   For information about creating handlers, see [Introduction to File Associations](https://msdn.microsoft.com/en-us/library/cc144104(VS.85).aspx), [Registering Shell Extensions](https://msdn.microsoft.com/en-us/library/cc144110(VS.85).aspx), [Creating Shell Extension Handlers](https://msdn.microsoft.com/en-us/library/Cc144067(VS.85).aspx), [Context Menu](https://msdn.microsoft.com/en-us/library/cc144169(VS.85).aspx), and [Preview Handlers](https://msdn.microsoft.com/en-us/library/Cc144143(VS.85).aspx).
...
-   In Windows 7 and later, SharePoint Search Server 2008 and MOSS 2007 SP2 also support federated search. For more information about federated search and Search Server 2008 deployment with Office SharePoint Server 2007, see [Federated Search \[Search Server 2008\]](https://msdn.microsoft.com/en-us/library/bb931109.aspx).
-   To create a Shell data store, see [Implementing the Basic Folder Object Interfaces](https://msdn.microsoft.com/en-us/library/cc144093(VS.85).aspx).
...
-   For Shell code samples, see [Shell SDK Samples](https://msdn.microsoft.com/en-us/library/dd940376(VS.85).aspx).
