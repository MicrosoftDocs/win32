...
| Scope      | Identifies locations to include or exclude in the search.                                                                 | Either a path or a [known folder ID](https://msdn.microsoft.com/library/Bb761758(VS.85).aspx) of the location to be included or excluded. This element can also specify whether the search should include/exclude child paths (a shallow or deep search). |
