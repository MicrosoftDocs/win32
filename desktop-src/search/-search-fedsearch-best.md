...
Best practices for working with [OpenSearch](http://go.microsoft.com/fwlink/p/?linkid=147911) in Windows 7 are as follows:
...
-   If you know the file name extension, map it to the [System.FileExtension](http://msdn.microsoft.com/en-us/library/bb760699(VS.85).aspx) Windows Shell property. Using file name extensions is a better way to identify a file type than MIME type.
...
-   Provide a URL to the parent folder, container, or webpage by mapping a custom element URL value to the [System.ItemFolderPathDisplay](http://msdn.microsoft.com/en-us/library/bb760776(VS.85).aspx) Windows Shell property.
...
-   For the **description** element:
    ...
    -   Do not include HTML formatting. The [OpenSearch](http://go.microsoft.com/fwlink/p/?linkid=147911) provider removes the formatting, which might result in less than desirable results for your description.
