...
-   [**DOT11\_MAC\_ADDRESS**](dot11-mac-address-type.md)
-   [**DOT11\_NETWORK**](/windows/desktop/api/wlanapi/ns-wlanapi-_dot11_network)
-   [**DOT11\_NETWORK\_LIST**](/windows/desktop/api/wlanapi/ns-wlanapi-_dot11_network_list)
-   [**DOT11\_SSID**](dot11-ssid.md)
-   [**NDIS\_OBJECT\_HEADER**](ndis-object-header.md)
-   [**ONEX\_AUTH\_PARAMS**](/windows/desktop/api/dot1x/ns-dot1x-_onex_auth_params)
-   [**ONEX\_CONNECTION\_PROFILE**](onex-connection-profile.md)
-   [**ONEX\_EAP\_ERROR**](/windows/desktop/api/dot1x/ns-dot1x-_onex_eap_error)
-   [**ONEX\_RESULT\_UPDATE\_DATA**](/windows/desktop/api/dot1x/ns-dot1x-_onex_result_update_data)
-   [**ONEX\_STATUS**](/windows/desktop/api/dot1x/ns-dot1x-_onex_status)
-   [**ONEX\_VARIABLE\_BLOB**](/windows/desktop/api/dot1x/ns-dot1x-_onex_variable_blob)
-   [**WLAN\_ASSOCIATION\_ATTRIBUTES**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_association_attributes)
-   [**WLAN\_AUTH\_CIPHER\_PAIR\_LIST**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_auth_cipher_pair_list)
-   [**WLAN\_AVAILABLE\_NETWORK**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_available_network)
-   [**WLAN\_AVAILABLE\_NETWORK\_LIST**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_available_network_list)
-   [**WLAN\_BSS\_ENTRY**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_bss_entry)
-   [**WLAN\_BSS\_LIST**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_bss_list)
-   [**WLAN\_CONNECTION\_ATTRIBUTES**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_connection_attributes)
-   [**WLAN\_CONNECTION\_NOTIFICATION\_DATA**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_connection_notification_data)
-   [**WLAN\_CONNECTION\_PARAMETERS**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_connection_parameters)
-   [**WLAN\_COUNTRY\_OR\_REGION\_STRING\_LIST**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_country_or_region_string_list)
...
-   [**WLAN\_INTERFACE\_INFO**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_interface_info)
...
-   [**WLAN\_PROFILE\_INFO\_LIST**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_profile_info_list)
-   [**WLAN\_RADIO\_STATE**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_radio_state)
-   [**WLAN\_RATE\_SET**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_rate_set)
-   [**WLAN\_RAW\_DATA**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_raw_data)
-   [**WLAN\_RAW\_DATA\_LIST**](/windows/desktop/api/wlanapi/ns-wlanapi-_wlan_raw_data_list)
