...
The EAPHost configuration used in this wireless profile sample was derived from the [EAP-TLS Connection Properties](eaphost.eap-tls_connection_properties) sample.
