...
If the **WZCEapolGetInterfaceParams** returns ERROR\_SUCCESS, the caller should call [**LocalFree**](https://msdn.microsoft.com/windows/desktop/a0393983-cb43-4dfa-91a6-d82a5fb8de12) to release the internal buffers allocated for the data returned once this information is no longer needed.
