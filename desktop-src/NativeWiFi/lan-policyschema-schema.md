...
The root element of a LAN policy profile is the [**LANPolicy**](lan-policyschema-lanpolicy-element.md) element. Each profile has exactly one root element. All LAN\_policy elements are in the namespace `http://www.microsoft.com/networking/LAN/policy/v1`.
