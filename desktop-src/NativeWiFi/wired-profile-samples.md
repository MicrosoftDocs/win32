...
You can add a profile to the profile store using the **netsh** command-line utility. For more information, see [Netsh Commands for Wired Local Area Network (LAN)](Http://go.microsoft.com/fwlink/p/?linkid=120965).
