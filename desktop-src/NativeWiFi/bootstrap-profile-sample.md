...
This sample is configured to use Wi-Fi Protected Access 2 security running in Enterprise mode (WPA2-Enterprise). Other security types can be used as long as the authentication method is PEAP-MSCHAPv2.
