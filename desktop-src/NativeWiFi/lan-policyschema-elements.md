...
A wired (LAN) policy profile contains the following schema elements. All of the named elements are in the namespace `http://www.microsoft.com/networking/LAN/policy/v1`.
