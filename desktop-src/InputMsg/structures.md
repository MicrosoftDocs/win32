...
| [**TOUCHPREDICTIONPARAMETERS**](/windows/win32/Winuser/ns-winuser-tagtouchpredictionparameters?branch=master)<br/> | Contains hardware input details that can be used to predict touch targets and help compensate for hardware latency when processing touch and gesture input that contains distance and velocity data.<br/>                                                                                                                                                       |
