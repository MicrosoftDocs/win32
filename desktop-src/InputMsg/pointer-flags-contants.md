...
Values that can appear in the **pointerFlags** field of the [**POINTER\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_info) structure.
...
[**POINTER\_BUTTON\_CHANGE\_TYPE**](/windows/desktop/api/winuser/ne-winuser-tagpointer_button_change_type)
</dt> </dl>
