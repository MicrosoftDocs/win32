...
Values that can appear in the **penMask** field of the [**POINTER\_PEN\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_pen_info) structure.
...
**pressure** of the [**POINTER\_PEN\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_pen_info) structure is valid.
...
**rotation** of the [**POINTER\_PEN\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_pen_info) structure is valid.
...
**tiltX** of the [**POINTER\_PEN\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_pen_info) structure is valid.
...
**tiltY** of the [**POINTER\_PEN\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_pen_info) structure is valid.
