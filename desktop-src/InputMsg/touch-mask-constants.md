...
Values that can appear in the **touchMask** field of the [**POINTER\_TOUCH\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_touch_info) structure.
...
**rcContact** of the [**POINTER\_TOUCH\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_touch_info) structure is valid.
...
**orientation** of the [**POINTER\_TOUCH\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_touch_info) structure is valid.
...
**pressure** of the [**POINTER\_TOUCH\_INFO**](/windows/desktop/api/Winuser/ns-winuser-tagpointer_touch_info) structure is valid.
