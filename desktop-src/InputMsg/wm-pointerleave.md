...
-   [**IS\_POINTER\_INRANGE\_WPARAM**](/windows/desktop/api/Winuser/nf-winuser-is_pointer_inrange_wparam)(wParam): indicates whether this message was generated by a pointer that has not left detection range. This flag is not set when the pointer leaves the detection range of the window.
...
|-----------------------------------------------|-------------------------------------------------------------------|------------------------------------------------------|
| A hovering pointer crosses window boundaries. | [**IS\_POINTER\_INRANGE\_WPARAM**](/windows/desktop/api/Winuser/nf-winuser-is_pointer_inrange_wparam) | Window outside of whose boundary the pointer moved.  |
