...
| Topic                                                                          | Description                                                                        |
|--------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [**POINTER\_BUTTON\_CHANGE\_TYPE**](/windows/desktop/api/winuser/ne-winuser-tagpointer_button_change_type)<br/> | Identifies a change in the state of a button associated with a pointer.<br/> |
| [**POINTER\_INPUT\_TYPE**](/windows/desktop/api/winuser/ne-winuser-tagpointer_input_type)<br/>             | Lists the pointer input types.<br/>                                          |
