...
| [**DDFLIPVIDEOPORTINFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddflipvideoportinfo)<br/>                   | The DDFLIPVIDEOPORTINFO structure contains the [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object and surface information. <br/>                                                                        |
| [**DDGETCURRENTAUTOFLIPININFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddgetcurrentautoflipininfo)<br/>     | The DDGETCURRENTAUTOFLIPININFO structure contains the [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object information. <br/>                                                                             |
...
| [**DDGETPOLARITYININFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddgetpolarityininfo)<br/>                   | The DDGETPOLARITYININFO structure contains the [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object information. <br/>                                                                                    |
| [**DDGETPOLARITYOUTINFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddgetpolarityoutinfo)<br/>                 | The DDGETPOLARITYOUTINFO structure contains the polarity information of the [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object. <br/>                                                                   |
| [**DDGETPREVIOUSAUTOFLIPININFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddgetpreviousautoflipininfo)<br/>   | The DDGETPREVIOUSAUTOFLIPININFO structure provides the [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object information. <br/>                                                                            |
...
| [**DDSETSTATEININFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddsetstateininfo)<br/>                         | The DDSETSTATEININFO structure contains the surface and [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object information. <br/>                                                                           |
| [**DDSETSTATEOUTINFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddsetstateoutinfo)<br/>                       | The DDSETSTATEOUTINFO structure contains the state information for the [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object. <br/>                                                                        |
| [**DDSKIPNEXTFIELDINFO**](/windows/desktop/api/dxmini/ns-dxmini-_ddskipnextfieldinfo)<br/>                   | The DDSKIPNEXTFIELDINFO structure contains the skip information for the [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object. <br/>                                                                       |
...
| [**DDVIDEOPORTDATA**](/windows/desktop/api/dxmini/ns-dxmini-ddvideoportdata)<br/>                           | The DDVIDEOPORTDATA structure is used by DirectDraw to represent a [video port extensions (VPE)](https://www.bing.com/search?q=video port extensions (VPE)) object to the kernel-mode video miniport driver. <br/>                                   |
