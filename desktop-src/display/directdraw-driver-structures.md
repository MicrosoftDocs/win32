...
This section describes the Microsoft DirectDraw driver structures supported on Microsoft Windows. These structures are used by display drivers that offer DirectDraw support. [DirectDraw](https://www.bing.com/search?q=DirectDraw) lists the header files that define the DirectDraw structures described in this section.
