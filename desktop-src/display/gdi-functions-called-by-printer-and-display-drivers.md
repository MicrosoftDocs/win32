...
[GDI Support for Graphics Drivers](https://www.bing.com/search?q=GDI+Support+for+Graphics+Drivers) lists the include files that contain declarations for the functions described in this section.
