...
| Topic                               | Description                                                                                                      |
|-------------------------------------|------------------------------------------------------------------------------------------------------------------|
| [**POINT**](point.md)<br/>   | The POINT structure defines the x- and y-coordinates of a point.<br/>                                      |
| [**POINTL**](pointl.md)<br/> | The POINTL structure defines the x- and y-coordinates of a point.<br/>                                     |
| [**POINTS**](points.md)<br/> | The POINTS structure defines the x- and y-coordinates of a point.<br/>                                     |
| [**RECT**](rect.md)<br/>     | The RECT structure defines a rectangle by the coordinates of its upper-left and lower-right corners.<br/>  |
| [**RECTL**](rectl.md)<br/>   | The RECTL structure defines a rectangle by the coordinates of its upper-left and lower-right corners.<br/> |
| [**SIZE**](size.md)<br/>     | The SIZE structure defines the width and height of a rectangle.<br/>                                       |
