...
The address of a [*hosted service*](https://www.bing.com/search?q=*hosted service*). The service information is derived from the relationship metadata provided by the device. PROPVARIANT type VT\_LPWSTR \| VT\_VECTOR.
...
The [*devnode*](https://www.bing.com/search?q=*devnode*). PROPVARIANT type VT\_BOOL.
