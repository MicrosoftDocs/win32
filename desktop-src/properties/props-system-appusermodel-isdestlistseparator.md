...
Inserts a separator in the **Tasks** section of a Jump List. Set this property on an [**IShellLink**](shell.IShellLink) object and pass it to [**ICustomDestinationList::AddUserTasks**](shell.ICustomDestinationList_AddUserTasks).
