...
If [System.ItemPathDisplay](https://msdn.microsoft.com/library/Bb760776(v=VS.85).aspx) is VT\_EMPTY, then this property should also be empty. Otherwise, it should be derived appropriately by the data source from System.ItemPathDisplay.
