...
Container for one or many individual [propertyDescription](shell.propdesc_schema_propertyDescription) elements. A .propdesc property description schema file should contain at least one [propertyDescriptionList](shell.propdesc_schema_propertyDescriptionList) element.
...
|---------------------------------------|------------------------------------------------------------------|
| [schema](shell.propdesc_schema_entry) | [propertyDescription](shell.propdesc_schema_propertyDescription) |
...
The [propertyDescriptionList](shell.propdesc_schema_propertyDescriptionList) should not be confused with "property lists" and [**IPropertyDescriptionList**](shell.IPropertyDescriptionList), which are completely separate.
