...
For compatibility with ratings systems that use values between 1 and 5, see the property [System.SimpleRating](shell.props_System_SimpleRating). Note, however, that System.SimpleRating is not used in the Windows Vista Shell.

The following table describes what the star rating system used in the Shell UI means in terms of the [System.Rating](shell.props_System_Rating) value.
...
When a user rates an item by choosing a star rating value in the UI, actual [System.Rating](shell.props_System_Rating) values are assigned as shown in this table:
...
If your file has a [System.SimpleRating](shell.props_System_SimpleRating) value rather than a [System.Rating](shell.props_System_Rating) value, use the table below to convert and specify values for System.Rating.
...
If your file has both [System.Rating](shell.props_System_Rating) and [System.SimpleRating](shell.props_System_SimpleRating) persisted values, always use the System.Rating value when it is directly requested, without reference to System.SimpleRating.
