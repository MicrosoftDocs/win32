...
The [**IShellFolder::GetAttributesOf**](https://msdn.microsoft.com/library/Bb775068(v=VS.85).aspx) flags for the target of a link, with SFGAO\_PKEYSFGAOMASK attributes masked out.
