...
Specifies whether the link path in [System.Link.TargetParsingPath](https://msdn.microsoft.com/library/Bb787436(v=VS.85).aspx) is verified. These values are defined.
