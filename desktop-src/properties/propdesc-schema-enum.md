...
Used to assign enumerated text to discrete values. Any number of these elements may exist under an [enumeratedList](shell.propdesc_schema_enumeratedList). Programmatically, these are represented as IPropertyEnumType objects, whose [**IPropertyEnumType::GetEnumType**](shell.IPropertyEnumType_GetEnumType) method returns PET\_DISCRETEVALUE.
...
|--------------------------------------------------------|----------------|
| [enumeratedList](shell.propdesc_schema_enumeratedList) | none           |
