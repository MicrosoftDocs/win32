...
Assigns enumeration text to a range of values. Each [enumRange](shell.propdesc_schema_enumRange) element specifies a minimum value, and extends until the next element minimum value, or until there are no more enumRange elements.
