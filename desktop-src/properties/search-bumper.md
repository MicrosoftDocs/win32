...
| [System.Search.UrlToIndex](https://msdn.microsoft.com/en-us/library/Bb760177(v=VS.85).aspx)<br/>                                           | Emitted by a container [**IFilter**](https://www.bing.com/search?q=**IFilter**) for each child URL within the container. The children are eventually crawled by the indexer if they are within scope.<br/>                                                                                                                                                                                |
