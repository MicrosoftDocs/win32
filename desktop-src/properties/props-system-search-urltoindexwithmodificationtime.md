...
This [System.Search.UrlToIndexWithModificationTime](shell.props_System_Search_UrlToIndexWithModificationTime) property is the same as the [System.Search.UrlToIndex](shell.props_System_Search_UrlToIndex) property, except that you also pass in the last modified time of the document. If the last modified time matches, the indexer assumes that the document is already indexed and throws away the notification. This property is a vector with two elements, a **VT\_LPWSTR** value that contains the URL and a **VT\_FILETIME** value that contains the last modified time.

[System.Search.UrlToIndexWithModificationTime](shell.props_System_Search_UrlToIndexWithModificationTime) was called PID\_GTHR\_DIRLINK\_WITH\_TIME in earlier versions of the Windows operating system.
...
[System.Search.UrlToIndex](shell.props_System_Search_UrlToIndex)
</dt> <dt>
