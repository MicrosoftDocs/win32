...
For compatibility with the Windows Vista Shell rating system, your property handler should also populate the [System.Rating](shell.props_System_Rating) property with the mapping as described for that property.

Use the following table to convert from [System.Rating](shell.props_System_Rating) to [System.SimpleRating](shell.props_System_SimpleRating).
