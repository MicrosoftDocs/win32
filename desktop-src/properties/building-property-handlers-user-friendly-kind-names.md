...
-   For reference documentation about properties, see [System.Kind](shell.props_System_Kind) and [System.KindText](shell.props_System_KindText).
-   For more information about creating new or using existing file types, see [File Types](shell.fa_file_types).
