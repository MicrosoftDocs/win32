...
> \[!Important\]  
> If an item emits **TRUE** for this property, each of its child items must emit the [System.Search.IsFullyContained](https://www.bing.com/search?q=System.Search.IsFullyContained) property as **TRUE** to prevent those items from being deleted from the index.
