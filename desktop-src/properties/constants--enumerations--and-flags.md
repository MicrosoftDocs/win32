...
| Topic                                                                              | Contents                                                                                                                                                                                                                                                                                                                                                                                   |
|------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GETPROPERTYSTOREFLAGS**](/windows/desktop/api/Propsys/ne-propsys-getpropertystoreflags)                             | Indicates flags that modify the property store object retrieved by methods that create a property store, such as [**IShellItem2::GetPropertyStore**](https://msdn.microsoft.com/706b2551-a9b0-4368-babb-e54cea6d297e) or [**IPropertyStoreFactory::GetPropertyStore**](https://www.bing.com/search?q=**IPropertyStoreFactory::GetPropertyStore**).<br/>                                                                                        |
...
| [**PROPVAR\_COMPARE\_UNIT**](https://www.bing.com/search?q=**PROPVAR\_COMPARE\_UNIT**)                           | These flags are associated with certain [**PROPVARIANT**](https://msdn.microsoft.com/e86cc279-826d-4767-8d96-fc8280060ea1) structure comparisons.<br/>                                                                                                                                                                                                                                                                               |
