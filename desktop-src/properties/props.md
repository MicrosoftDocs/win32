...
-   [Image](properties.props_system_imageparsingname)
-   [GPS](gps-bumper.md)
...
For more information on the use of canonical properties in queries, see [Using Advanced Query Syntax Programmatically](search._search_3x_AdvancedQuerySyntax).
