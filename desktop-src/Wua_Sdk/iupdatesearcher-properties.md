...
| [**ServerSelection**](/windows/desktop/api/Wuapi/nf-wuapi-iupdatesearcher-get_serverselection)                                          | Gets and sets a [**ServerSelection**](/windows/desktop/api/wuapicommon/ne-wuapicommon-tagserverselection) value that indicates the server to search for updates.                                                                                                                            |
