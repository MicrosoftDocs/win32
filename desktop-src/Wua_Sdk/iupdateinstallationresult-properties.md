...
| [**ResultCode**](/windows/desktop/api/Wuapi/nf-wuapi-iupdateinstallationresult-get_resultcode)         | Gets an [**OperationResultCode**](/windows/desktop/api/Wuapi/ne-wuapi-tagoperationresultcode) value that specifies the result of an operation on an update.          |
