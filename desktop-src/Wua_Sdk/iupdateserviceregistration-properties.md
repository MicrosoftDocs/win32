...
| [**RegistrationState**](/windows/desktop/api/Wuapi/nf-wuapi-iupdateserviceregistration-get_registrationstate)                     | Gets an [**UpdateServiceRegistrationState**](/windows/desktop/api/Wuapi/ne-wuapi-tagupdateserviceregistrationstate) value that indicates the current state of the service registration. |
