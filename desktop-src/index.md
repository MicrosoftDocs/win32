        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Get started</h3>
                        <p></p>Follow our instructions to set up your development computer and learn how to create desktop apps for Windows 10 that use the Win32 API.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <p>Learn how to use the Win32 API for a specific Windows feature or technology in your desktop apps.</p>
                  </div>
                </div>
            </div>
        </div>
