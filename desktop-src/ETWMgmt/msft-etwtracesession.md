---
title: MSFT\_EtwTraceSession class
description: Represents a running Event Tracing for Windows (ETW) trace session.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'de18e970-fea4-452e-8db8-454aee144a65'
ms.prod: 'windows-server-dev'
ms.technology:
- 'event-tracing'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_EtwTraceSession class", "MSFT_EtwTraceSession class, described"]
topic_type:
- apiref
api_name:
- MSFT_EtwTraceSession
- MSFT_EtwTraceSession.InstanceID
- MSFT_EtwTraceSession.Caption
- MSFT_EtwTraceSession.Description
- MSFT_EtwTraceSession.ElementName
- MSFT_EtwTraceSession.InstallDate
- MSFT_EtwTraceSession.OperationalStatus
- MSFT_EtwTraceSession.StatusDescriptions
- MSFT_EtwTraceSession.Status
- MSFT_EtwTraceSession.HealthState
- MSFT_EtwTraceSession.CommunicationStatus
- MSFT_EtwTraceSession.DetailedStatus
- MSFT_EtwTraceSession.OperatingStatus
- MSFT_EtwTraceSession.PrimaryStatus
- MSFT_EtwTraceSession.Name
- MSFT_EtwTraceSession.LogFileMode
- MSFT_EtwTraceSession.BufferSize
- MSFT_EtwTraceSession.MinimumBuffers
- MSFT_EtwTraceSession.MaximumBuffers
- MSFT_EtwTraceSession.FlushTimer
- MSFT_EtwTraceSession.ClockType
- MSFT_EtwTraceSession.MaximumFileSize
- MSFT_EtwTraceSession.LocalFilePath
api_location:
...
# MSFT\_EtwTraceSession class

Represents a running Event Tracing for Windows (ETW) trace session.
...
The **MSFT\_EtwTraceSession** class has these types of members:
...
The **MSFT\_EtwTraceSession** class has these methods.



| Method                                    | Description                                                                         |
|:------------------------------------------|:------------------------------------------------------------------------------------|
| [**Send**](send-msft-etwtracesession.md) | Sends the log file of the specified ETW trace session to a remote share.<br/> |
...
The **MSFT\_EtwTraceSession** class has these properties.
...
<span id="Performance_counter_value__high_resolution_"></span><span id="performance_counter_value__high_resolution_"></span><span id="PERFORMANCE_COUNTER_VALUE__HIGH_RESOLUTION_"></span>

<span id="Performance_counter_value__high_resolution_"></span><span id="performance_counter_value__high_resolution_"></span><span id="PERFORMANCE_COUNTER_VALUE__HIGH_RESOLUTION_"></span>**Performance counter value (high resolution)** (1)
...
<span id="System_timer"></span><span id="system_timer"></span><span id="SYSTEM_TIMER"></span>

<span id="System_timer"></span><span id="system_timer"></span><span id="SYSTEM_TIMER"></span>**System timer** (2)
...
<span id="CPU_cycle_counter"></span><span id="cpu_cycle_counter"></span><span id="CPU_CYCLE_COUNTER"></span>

<span id="CPU_cycle_counter"></span><span id="cpu_cycle_counter"></span><span id="CPU_CYCLE_COUNTER"></span>**CPU cycle counter** (3)
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (1024), [**key**](https://msdn.microsoft.com/library/aa392157)
</dt> </dl>
...
[Event Tracing Management WMI Provider](event-tracing-management-wmi-provider-portal.md)
</dt> </dl>
