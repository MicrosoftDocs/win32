---
title: MSFT\_AutologgerConfig class
description: Represents a configuration for an autologger session.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ed1bdc8d-f3d8-40f4-aaee-615ad0d20f7e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'event-tracing'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_AutologgerConfig class", "MSFT_AutologgerConfig class, described"]
topic_type:
- apiref
api_name:
- MSFT_AutologgerConfig
- MSFT_AutologgerConfig.InstanceID
- MSFT_AutologgerConfig.Caption
- MSFT_AutologgerConfig.Description
- MSFT_AutologgerConfig.ElementName
- MSFT_AutologgerConfig.InstallDate
- MSFT_AutologgerConfig.OperationalStatus
- MSFT_AutologgerConfig.StatusDescriptions
- MSFT_AutologgerConfig.Status
- MSFT_AutologgerConfig.HealthState
- MSFT_AutologgerConfig.CommunicationStatus
- MSFT_AutologgerConfig.DetailedStatus
- MSFT_AutologgerConfig.OperatingStatus
- MSFT_AutologgerConfig.PrimaryStatus
- MSFT_AutologgerConfig.Name
- MSFT_AutologgerConfig.BufferSize
- MSFT_AutologgerConfig.ClockType
- MSFT_AutologgerConfig.DisableRealtimePersistence
- MSFT_AutologgerConfig.FileCount
- MSFT_AutologgerConfig.LocalFilePath
- MSFT_AutologgerConfig.FileMax
- MSFT_AutologgerConfig.FlushTimer
- MSFT_AutologgerConfig.Guid
- MSFT_AutologgerConfig.LogFileMode
- MSFT_AutologgerConfig.MaximumFileSize
- MSFT_AutologgerConfig.MaximumBuffers
- MSFT_AutologgerConfig.MinimumBuffers
- MSFT_AutologgerConfig.Start
- MSFT_AutologgerConfig.InitStatus
api_location:
...
The **MSFT\_AutologgerConfig** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_AutologgerConfig** class has these properties.
...
The size of each buffer, in kilobytes. Should be less than one megabyte.
...
System timer. The system time provides a low-resolution (10 milliseconds) time stamp but is less resource-intensive to retrieve than the query performance counter.
...
"1" to disable real time persistence; otherwise, "0".
...
The serial number used to increment the log file name if the **FileMax** property is specified.
...
The maximum number of log file instances to create.
...
Indicates how often, in seconds, the trace buffers are forcibly flushed.
...
The autologger ID of the configuration.
...
The startup status of the autologger; otherwise, a win32 error code.
...
The full path to the trace event log file. The default value is "%SystemRoot%\\\\System32\\\\LogFiles\\\\WMI\\\\*&lt;Name.extension&gt;*".
...
The logging mode to use for trace sessions.
...
The maximum size for the trace event log file, in MB, before a new one created. The default value is 100 MB.
...
Name of new autologger session configuration.
...
The action for the configuration to perform at startup.
