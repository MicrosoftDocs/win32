---
title: MSFT\_EtwTraceProvider class
description: Represents an Event Tracing for Windows (ETW) trace provider.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '122a83b9-b43e-4c67-89f0-eb1985083234'
ms.prod: 'windows-server-dev'
ms.technology:
- 'event-tracing'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_EtwTraceProvider class", "MSFT_EtwTraceProvider class, described"]
topic_type:
- apiref
api_name:
- MSFT_EtwTraceProvider
- MSFT_EtwTraceProvider.InstanceID
- MSFT_EtwTraceProvider.Caption
- MSFT_EtwTraceProvider.Description
- MSFT_EtwTraceProvider.ElementName
- MSFT_EtwTraceProvider.InstallDate
- MSFT_EtwTraceProvider.OperationalStatus
- MSFT_EtwTraceProvider.StatusDescriptions
- MSFT_EtwTraceProvider.Status
- MSFT_EtwTraceProvider.HealthState
- MSFT_EtwTraceProvider.CommunicationStatus
- MSFT_EtwTraceProvider.DetailedStatus
- MSFT_EtwTraceProvider.OperatingStatus
- MSFT_EtwTraceProvider.PrimaryStatus
- MSFT_EtwTraceProvider.Name
- MSFT_EtwTraceProvider.Guid
- MSFT_EtwTraceProvider.AutologgerName
- MSFT_EtwTraceProvider.SessionName
- MSFT_EtwTraceProvider.Level
- MSFT_EtwTraceProvider.MatchAnyKeyword
- MSFT_EtwTraceProvider.MatchAllKeyword
- MSFT_EtwTraceProvider.Property
api_location:
...
The **MSFT\_EtwTraceProvider** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_EtwTraceProvider** class has these properties.
