...
description: The CIM\_ManagedSystemElement class is the base class for the system element hierarchy. Any distinguishable component of a system is a candidate for inclusion in this class.
audience: developer
...
The **CIM\_ManagedSystemElement** class is the base class for the system element hierarchy. Any distinguishable component of a system is a candidate for inclusion in this class. Examples of system components include:
