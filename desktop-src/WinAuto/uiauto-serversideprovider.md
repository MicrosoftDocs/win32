...
-   [**UIA\_BoundingRectanglePropertyId**](https://www.bing.com/search?q=**UIA\_BoundingRectanglePropertyId**)
-   [**UIA\_ClickablePointPropertyId**](https://www.bing.com/search?q=**UIA\_ClickablePointPropertyId**)
-   [**UIA\_ProcessIdPropertyId**](https://www.bing.com/search?q=**UIA\_ProcessIdPropertyId**)
-   [**UIA\_ClassNamePropertyId**](https://www.bing.com/search?q=**UIA\_ClassNamePropertyId**)
-   [**UIA\_HasKeyboardFocusPropertyId**](https://www.bing.com/search?q=**UIA\_HasKeyboardFocusPropertyId**)
-   [**UIA\_IsEnabledPropertyId**](https://www.bing.com/search?q=**UIA\_IsEnabledPropertyId**)
-   [**UIA\_IsKeyboardFocusablePropertyId**](https://www.bing.com/search?q=**UIA\_IsKeyboardFocusablePropertyId**)
-   [**UIA\_IsPasswordPropertyId**](https://www.bing.com/search?q=**UIA\_IsPasswordPropertyId**)
-   [**UIA\_NamePropertyId**](https://www.bing.com/search?q=**UIA\_NamePropertyId**)
-   [**UIA\_RuntimeIdPropertyId**](https://www.bing.com/search?q=**UIA\_RuntimeIdPropertyId**)
...
The purpose of an event is to notify the client of something taking place in the UI. Providers should raise an event regardless of whether the change was triggered by user input or by a client application using UI Automation. For example, the event identified by [**UIA\_Invoke\_InvokedEventId**](https://www.bing.com/search?q=**UIA\_Invoke\_InvokedEventId**) should be raised whenever the control is invoked, either through direct user input or by the client application calling [**IUIAutomationInvokePattern::Invoke**](/windows/desktop/api/UIAutomationClient/nf-uiautomationclient-iuiautomationinvokepattern-invoke).
...
> [!Note]  
> Similar to implementing reference counting in COM programming, it is important for UI Automation providers to treat the [**IRawElementProviderAdviseEvents::AdviseEventAdded**](/windows/desktop/api/UIAutomationCore/nf-uiautomationcore-irawelementprovideradviseevents-adviseeventadded) and [**AdviseEventRemoved**](/windows/desktop/api/UIAutomationCore/nf-uiautomationcore-irawelementprovideradviseevents-adviseeventremoved) methods like the [**IUnknown::AddRef**](https://msdn.microsoft.com/library/windows/desktop/ms691379) and [**Release**](https://msdn.microsoft.com/library/windows/desktop/ms682317) methods of the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. As long as **AdviseEventAdded** has been called more times than **AdviseEventRemoved** for a specific event or property, the provider should continue to raise corresponding events, because some clients are still listening. Alternatively, UI Automation providers can use the [**UiaClientsAreListening**](/windows/desktop/api/UIAutomationCoreApi/nf-uiautomationcoreapi-uiaclientsarelistening) function to determine whether at least one client is listening and, if so, raise all appropriate events.
