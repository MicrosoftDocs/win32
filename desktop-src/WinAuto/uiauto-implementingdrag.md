...
-   The element must fire property-changed events for the **DropEffect** ([**UIA\_DragDropEffectPropertyId**](https://www.bing.com/search?q=**UIA\_DragDropEffectPropertyId**)) and **DropEffects** ([**UIA\_DragDropEffectsPropertyId**](https://www.bing.com/search?q=**UIA\_DragDropEffectsPropertyId**)) properties when they change. Property-changed events for the other properties are allowed, but can be inferred from the required **DragStart** ([**UIA\_Drag\_DragStartEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragStartEventId**)), **DragCancel** ([**UIA\_Drag\_DragCancelEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragCancelEventId**)), and **DragComplete** ([**UIA\_Drag\_DragCompleteEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragCompleteEventId**)) events.
-   
...
| [**UIA\_Drag\_DragStartEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragStartEventId**)       | Event       | None                                                                          |
| [**UIA\_Drag\_DragCancelEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragCancelEventId**)     | Event       | None                                                                          |
| [**UIA\_Drag\_DragCompleteEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragCompleteEventId**) | Event       | None                                                                          |
