...
According to the COM specification, the lifetime of a remote object is governed by the lifetime of the apartment where the [CoCreateInstance](http://go.microsoft.com/fwlink/p/?linkid=144398) function is called to create the object. When the original apartment shuts down, the remote object is also released.
...
[INFO: Descriptions and Workings of OLE Threading Models](http://go.microsoft.com/fwlink/p/?linkid=151464)
</dt> </dl>
