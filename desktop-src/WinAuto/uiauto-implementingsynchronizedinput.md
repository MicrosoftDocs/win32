...
Describes guidelines and conventions for implementing [**ISynchronizedInputProvider**](/windows/win32/UIAutomationCore/nn-uiautomationcore-isynchronizedinputprovider?branch=master), including information about properties and methods. The **SynchronizedInput** control pattern enables Microsoft UI Automation client applications to direct the mouse or keyboard input to a specific UI element.
...
-   When the [**ISynchronizedInputProvider::StartListening**](/windows/win32/UIAutomationCore/nf-uiautomationcore-isynchronizedinputprovider-startlistening?branch=master) method is called, the UI Automation provider should start checking for input of the specified type, and then take one of the following actions:
...
-   When the element receives the input, or when the [**ISynchronizedInputProvider::Cancel**](/windows/win32/UIAutomationCore/nf-uiautomationcore-isynchronizedinputprovider-cancel?branch=master) method is called, the provider stops checking input and continues as normal.
-   If [**ISynchronizedInputProvider::StartListening**](/windows/win32/UIAutomationCore/nf-uiautomationcore-isynchronizedinputprovider-startlistening?branch=master) is called when the provider is already listening for input, the provider should return [**UIA\_E\_INVALIDOPERATION**](uiauto-error-codes.md#uia-e-invalidoperation).

## Required Members for **ISynchronizedInputProvider**

The following properties, methods, and events are required for implementing the [**ISynchronizedInputProvider**](/windows/win32/UIAutomationCore/nn-uiautomationcore-isynchronizedinputprovider?branch=master) interface.



| Required members                                                                         | Member type | Notes |
|------------------------------------------------------------------------------------------|-------------|-------|
| [**StartListening**](/windows/win32/UIAutomationCore/nf-uiautomationcore-isynchronizedinputprovider-startlistening?branch=master)               | Method      | None  |
| [**Cancel**](/windows/win32/UIAutomationCore/nf-uiautomationcore-isynchronizedinputprovider-cancel?branch=master)                               | Method      | None  |
