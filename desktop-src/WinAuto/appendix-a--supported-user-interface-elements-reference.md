...
| SysDateTimePick32 (versions 5 and 6) | Date and/or time picker                                 | Version 6 of this control in Windows Vista has a native [**IAccessible**](iaccessible.md) implementation.                                                                                                           |
...
| SysMonthCal32 (versions 5 and 6)     | Month calendar                                          | Version 6 of this control in Windows Vista has a native [**IAccessible**](iaccessible.md) implementation.                                                                                                           |
