...
| ScrollBar                            | Scroll bars                                             | [**EVENT\_OBJECT\_CONTENTSCROLLED**](event-constants.md#event-object-contentscrolled) is a new event for control that have scrolling functionality but do not include a standard scroll bar as part of the control. |
...
| SysDateTimePick32 (versions 5 and 6) | Date and/or time picker                                 | Version 6 of this control in Windows Vista has a native [**IAccessible**](/windows/win32/oleacc/nn-oleacc-iaccessible?branch=master) implementation.                                                                                                           |
...
| SysMonthCal32 (versions 5 and 6)     | Month calendar                                          | Version 6 of this control in Windows Vista has a native [**IAccessible**](/windows/win32/oleacc/nn-oleacc-iaccessible?branch=master) implementation.                                                                                                           |
