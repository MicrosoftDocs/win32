...
| ScrollBar                            | Scroll bars                                             | [**EVENT\_OBJECT\_CONTENTSCROLLED**](https://www.bing.com/search?q=**EVENT\_OBJECT\_CONTENTSCROLLED**) is a new event for control that have scrolling functionality but do not include a standard scroll bar as part of the control. |
