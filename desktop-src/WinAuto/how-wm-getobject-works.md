...
-   If the window does not handle the [**WM\_GETOBJECT**](wm-getobject.md) message, the [DefWindowProc](https://go.microsoft.com/fwlink/p/?linkid=178230) function returns zero.
