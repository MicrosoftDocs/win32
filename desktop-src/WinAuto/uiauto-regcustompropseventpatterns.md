...
3.  Use the [**CoCreateInstance**](https://msdn.microsoft.com/library/windows/desktop/ms686615) function to create an instance of the [**CUIAutomationRegistrar**](https://msdn.microsoft.com/en-us/library/Ff384837(v=VS.85).aspx) object and retrieve a pointer to the object's [**IUIAutomationRegistrar**](/windows/desktop/api/UIAutomationCore/nn-uiautomationcore-iuiautomationregistrar) interface.
...
2.  Use the [**CoCreateInstance**](https://msdn.microsoft.com/library/windows/desktop/ms686615) function to create an instance of the [**CUIAutomationRegistrar**](https://msdn.microsoft.com/en-us/library/Ff384837(v=VS.85).aspx) object and retrieve a pointer to the object's [**IUIAutomationRegistrar**](/windows/desktop/api/UIAutomationCore/nn-uiautomationcore-iuiautomationregistrar) interface.
