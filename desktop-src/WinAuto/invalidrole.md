...
An element is reporting an invalid MSAA role. For example, the [**get\_accRole**](iaccessible-iaccessible--get-accrole.md) method returns an integer value that does not map to a valid object role constant (such as ROLE\_SYSTEM\_LISTITEM).
