...
When you implement the [Drag](https://msdn.microsoft.com/library/windows/desktop/hh707348) control pattern for a draggable element, you need to decide whether to implement the *source/target* dragging style, or the *source-only* dragging style.
...
-   The source raises the DragStart ([**UIA\_Drag\_DragStartEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragStartEventId**)) event.
...
-   The target raises the DragEnter ([**UIA\_DropTarget\_DragEnterEventId**](https://www.bing.com/search?q=**UIA\_DropTarget\_DragEnterEventId**)) event.

  
When the drag operation leaves a target region:

-   The target raises the DragLeave ([**UIA\_DropTarget\_DragLeaveEventId**](https://www.bing.com/search?q=**UIA\_DropTarget\_DragLeaveEventId**)) event.

  
When the user releases the dragged item over a non-target:

-   The source raises the DragCancel ([**UIA\_Drag\_DragCancelEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragCancelEventId**)) event.
...
-   The source raises the DragComplete ([**UIA\_Drag\_DragCompleteEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragCompleteEventId**)) event.
-   The source sets the [**IDragProvider::IsGrabbed**](/windows/desktop/api/UIAutomationCore/nf-uiautomationcore-idragprovider-get_isgrabbed) property to **FALSE**.
...
-   The target raises the Dropped ([**UIA\_DropTarget\_DroppedEventId**](https://www.bing.com/search?q=**UIA\_DropTarget\_DroppedEventId**)) event.
...
-   The master source element raises the DragStart ([**UIA\_Drag\_DragStartEventId**](https://www.bing.com/search?q=**UIA\_Drag\_DragStartEventId**)) event.
