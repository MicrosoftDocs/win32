...
To implement [**IAccessible**](iaccessible.md), server developers must follow this basic process.

1.  Create accessible objects by implementing the [**IAccessible**](iaccessible.md) properties and methods for your custom user interface elements and for your application's client. Be sure to provide a dual interface that supports both **IAccessible** and [**IDispatch**](idispatch-interface.md) so that clients written in Microsoft Visual Basic and various scripting languages can get information about the objects.
2.  Call [**NotifyWinEvent**](notifywinevent.md) to notify clients of changes to your custom user interface elements.
