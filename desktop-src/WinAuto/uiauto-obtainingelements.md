...
For a code example that shows how to find a know element, see [Finding an Element by Name](https://www.bing.com/search?q=Finding an Element by Name).
...
For a code example that shows how to find elements in a subtree, see [Finding Related Elements](https://www.bing.com/search?q=Finding Related Elements).
