...
| [**get\_accParent**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accparent)               | The **Parent** property is a window ( [**ROLE\_SYSTEM\_LIST**](https://www.bing.com/search?q=**ROLE\_SYSTEM\_LIST**) ) that surrounds the control and has the same window class name as the control.                                                      |
| [**get\_accRole**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accrole)                   | The **Role** property is [**ROLE\_SYSTEM\_COLUMNHEADER**](https://www.bing.com/search?q=**ROLE\_SYSTEM\_COLUMNHEADER**).                                                                                                                                  |
| [**get\_accState**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accstate)                 | The value for the **State** property is always [**STATE\_SYSTEM\_READONLY**](https://www.bing.com/search?q=**STATE\_SYSTEM\_READONLY**) and can also include [**STATE\_SYSTEM\_INVISIBLE**](https://www.bing.com/search?q=**STATE\_SYSTEM\_INVISIBLE**). |
