...
The element supports either [**IUIAutomationDragPattern**](uiauto-iuiautomationdragpattern.md) or [**IUIAutomationDropTargetPattern**](uiauto-iuiautomationdroptargetpattern.md), but does not have a valid [**DropEffect**](uiauto-idragprovider-dropeffect.md) property set.
...
-   The element, or its parent, has not created the [**DropEffect**](uiauto-idragprovider-dropeffect.md) or [**DropEffects**](uiauto-idragprovider-dropeffects.md) an incorrectly assigned name or label.
