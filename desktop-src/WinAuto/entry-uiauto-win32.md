...
For information about UI Automation for managed code, please see [Accessibility](http://go.microsoft.com/fwlink/p/?linkid=132102) in the .NET Framework Developer's Guide section of MSDN.
...
For more information about both updates, see [Platform Update for Windows Vista](win7ip-platform_update_for_windows_vista_portal).
