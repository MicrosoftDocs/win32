...
The ATOM range is reserved for event IDs that are allocated at runtime through the UI Automation extensibility API. Do not use the values from the ATOM range for any other purpose. Using the [**GlobalAddAtom**](https://msdn.microsoft.com/library/windows/desktop/ms649060) function with a string GUID is the recommended method of allocating WinEvents from the ATOM range.
...
[Accessibility Interoperability Alliance](http://go.microsoft.com/fwlink/p/?linkid=147043)
</dt> </dl>
