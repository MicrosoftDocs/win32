...
<td>The <strong>Parent</strong> property of the title bar is the main application window ( [<strong>ROLE_SYSTEM_WINDOW</strong>](https://www.bing.com/search?q=<strong>ROLE_SYSTEM_WINDOW</strong>) ) that has the same application-defined window class name as the title bar.</td>
</tr>
<tr class="odd">
<td><strong>get_accRole</strong></td>
<td>The <strong>Role</strong> property is [<strong>ROLE_SYSTEM_TITLEBAR</strong>](https://www.bing.com/search?q=<strong>ROLE_SYSTEM_TITLEBAR</strong>). The child buttons in the title bar have the <strong>Role</strong> property [<strong>ROLE_SYSTEM_PUSHBUTTON</strong>](https://www.bing.com/search?q=<strong>ROLE_SYSTEM_PUSHBUTTON</strong>).</td>
</tr>
<tr class="even">
<td><strong>get_accState</strong></td>
<td>The <strong>State</strong> property for the title bar and the child buttons can be a combination of one or more of the following [values](object-state-constants.md): [<strong>STATE_SYSTEM_FOCUSABLE</strong>](https://www.bing.com/search?q=<strong>STATE_SYSTEM_FOCUSABLE</strong>) | [<strong>STATE_SYSTEM_INVISIBLE</strong>](https://www.bing.com/search?q=<strong>STATE_SYSTEM_INVISIBLE</strong>) | [<strong>STATE_SYSTEM_OFFSCREEN</strong>](https://www.bing.com/search?q=<strong>STATE_SYSTEM_OFFSCREEN</strong>) | [<strong>STATE_SYSTEM_UNAVAILABLE</strong>](https://www.bing.com/search?q=<strong>STATE_SYSTEM_UNAVAILABLE</strong>) | [<strong>STATE_SYSTEM_PRESSED</strong>](https://www.bing.com/search?q=<strong>STATE_SYSTEM_PRESSED</strong>)<br/></td>
</tr>
<tr class="odd">
...
-   Although an application's title bar has the **State** property flag [**STATE\_SYSTEM\_FOCUSABLE**](https://www.bing.com/search?q=**STATE\_SYSTEM\_FOCUSABLE**), it never has the **State** flag [**STATE\_SYSTEM\_FOCUSED**](https://www.bing.com/search?q=**STATE\_SYSTEM\_FOCUSED**). Setting focus to a title bar object focuses the application window.
