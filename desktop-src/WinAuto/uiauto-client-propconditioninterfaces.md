...
| [**IUIAutomationCondition**](/windows/desktop/api/UIAutomationClient/)<br/>                 | This is the primary interface for conditions used in filtering when searching for elements in the UI Automation tree.<br/>                                   |
