...
| [**get\_accParent**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accparent)         | The **Parent** property is a window ( [**ROLE\_SYSTEM\_WINDOW**](https://www.bing.com/search?q=**ROLE\_SYSTEM\_WINDOW**) ) that surrounds the pop-up menu and has the same **Name** property and window class name as the pop-up menu .                                                                                                                                                                                                                                                      |
| [**get\_accRole**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accrole)             | The **Role** property is [**ROLE\_SYSTEM\_MENUPOPUP**](https://www.bing.com/search?q=**ROLE\_SYSTEM\_MENUPOPUP**).                                                                                                                                                                                                                                                                                                                                                                           |
...
-   Pop-up menu objects do not trigger [**EVENT\_OBJECT\_CREATE**](https://www.bing.com/search?q=**EVENT\_OBJECT\_CREATE**) and [**EVENT\_OBJECT\_DESTROY**](https://www.bing.com/search?q=**EVENT\_OBJECT\_DESTROY**) events.
-   Multi-column menus do not support the [**NAVDIR\_LEFT**](https://www.bing.com/search?q=**NAVDIR\_LEFT**) or [**NAVDIR\_RIGHT**](https://www.bing.com/search?q=**NAVDIR\_RIGHT**) flags of the [**accNavigate**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-accnavigate) method.
-   The events [**EVENT\_SYSTEM\_MENUPOPUPSTART**](https://www.bing.com/search?q=**EVENT\_SYSTEM\_MENUPOPUPSTART**) and [**EVENT\_SYSTEM\_MENUPOPUPEND**](https://www.bing.com/search?q=**EVENT\_SYSTEM\_MENUPOPUPEND**) are not sent consistently. This is a known issue and is being addressed.
