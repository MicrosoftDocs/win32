...
| [**get\_accParent**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accparent)         | The **Parent** property is a window ( [**ROLE\_SYSTEM\_WINDOW**](object-roles.md#role-system-window) ) that surrounds the pop-up menu and has the same **Name** property and window class name as the pop-up menu .                                                                                                                                                                                                                                                      |
| [**get\_accRole**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accrole)             | The **Role** property is [**ROLE\_SYSTEM\_MENUPOPUP**](object-roles.md#role-system-menupopup).                                                                                                                                                                                                                                                                                                                                                                           |
...
-   Multi-column menus do not support the [**NAVDIR\_LEFT**](navigation-constants.md#navdir-left) or [**NAVDIR\_RIGHT**](navigation-constants.md#navdir-right) flags of the [**accNavigate**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-accnavigate) method.
