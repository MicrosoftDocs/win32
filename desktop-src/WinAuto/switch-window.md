...
| [**get\_accRole**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accrole)                   | The switch window object itself has a **Role** property of "window \[32771\]". Also, each application icon in the switch window has the **Role** property [**ROLE\_SYSTEM\_LISTITEM**](object-roles.md#role-system-listitem). |
| [**get\_accState**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accstate)                 | The switch window object itself does not support the **State** property. The **State** value for the list view items is [**STATE\_SYSTEM\_FOCUSABLE**](object-state-constants.md#state-system-focusable).                     |
