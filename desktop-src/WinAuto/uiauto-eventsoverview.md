...
| Notification          | Raised when an app calls the [**UiaRaiseNotificationEvent**](https://www.bing.com/search?q=**UiaRaiseNotificationEvent**) function. [**NotificationKind**](https://msdn.microsoft.com/en-us/library/Mt812119(v=VS.85).aspx) indicates the type of the notification.                                                                                                                                                                                                                                                 |
