...
| Notification          | Raised when an app calls the [**UiaRaiseNotificationEvent**](https://www.bing.com/search?q=**UiaRaiseNotificationEvent**) function. [**NotificationKind**](https://www.bing.com/search?q=**NotificationKind**) indicates the type of the notification.                                                                                                                                                                                                                                                 |
