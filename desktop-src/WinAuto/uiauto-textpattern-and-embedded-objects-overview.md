...
When moving through a document by [**TextUnit\_Line**](https://www.bing.com/search?q=**TextUnit\_Line**), if the text range enters an embedded table, each line of text in a cell should be treated as a line.
