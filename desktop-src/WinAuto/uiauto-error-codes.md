...
| <span id="UIA_E_NOCLICKABLEPOINT"></span><span id="uia_e_noclickablepoint"></span><dl> <dt>**UIA\_E\_NOCLICKABLEPOINT**</dt> <dt>0x80040202</dt> </dl>                   | Indicates that the [**GetClickablePoint**](uiauto-iuiautomationelement-getclickablepoint.md) method was called on an element that has no clickable point.<br/>                                                                                    |
