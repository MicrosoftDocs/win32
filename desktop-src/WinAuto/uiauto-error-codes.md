...
| <span id="UIA_E_ELEMENTNOTENABLED"></span><span id="uia_e_elementnotenabled"></span><dl> <dt>**UIA\_E\_ELEMENTNOTENABLED**</dt> <dt>0x80040200</dt> </dl>                | Indicates that a method that requires an enabled element, such as [**Select**](/windows/win32/UIAutomationCore/nf-uiautomationcore-iselectionitemprovider-select?branch=master) or [**Expand**](/windows/win32/UIAutomationCore/nf-uiautomationcore-iexpandcollapseprovider-expand?branch=master), was called on an element that was disabled. <br/>             |
...
| <span id="UIA_E_NOCLICKABLEPOINT"></span><span id="uia_e_noclickablepoint"></span><dl> <dt>**UIA\_E\_NOCLICKABLEPOINT**</dt> <dt>0x80040202</dt> </dl>                   | Indicates that the [**GetClickablePoint**](/windows/win32/UIAutomationClient/nf-uiautomationclient-iuiautomationelement-getclickablepoint?branch=master) method was called on an element that has no clickable point.<br/>                                                                                    |
...
| <span id="UIA_E_TIMEOUT"></span><span id="uia_e_timeout"></span><dl> <dt>**UIA\_E\_TIMEOUT**</dt> <dt>0x</dt> </dl>                                                      | Indicates that the time allotted for a process or operation has expired.<br/>                                                                                                                                                                      |
