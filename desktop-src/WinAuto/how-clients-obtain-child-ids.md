...
-   Call [**AccessibleChildren**](accessiblechildren.md). This function retrieves an array of [**VARIANT**](variant-structure.md) structures.
...
-   Collect the child IDs by calling the parent object's [**IAccessible::accNavigate**](iaccessible-iaccessible--accnavigate.md) method.
