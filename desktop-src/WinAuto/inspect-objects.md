...
| Raw View                     | Presents the [raw view](https://www.bing.com/search?q=raw view) of the UI Automation tree or MSAA tree in the **Tree** view.                                                                                                             |
| Control View                 | Presents the [control view](https://www.bing.com/search?q=control view) of the UI Automation tree in the **Tree** view. Available in UI Automation mode only.                                                                            |
| Content View                 | Presents the [content view](https://www.bing.com/search?q=content view) of the UI Automation tree in the **Tree** view. Available in UI Automation mode only.                                                                            |
