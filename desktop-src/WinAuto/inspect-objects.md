...
| Content View                 | Presents the [content view](uiauto-treeoverview.md#content-view) of the UI Automation tree in the **Tree** view. Available in UI Automation mode only.                                                                            |
