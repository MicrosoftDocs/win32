...
The element supports either [**IUIAutomationDragPattern**](uiauto-iuiautomationdragpattern.md) or [**IUIAutomationDropTargetPattern**](uiauto-iuiautomationdroptargetpattern.md), but does not have a valid Name set.
