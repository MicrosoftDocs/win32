...
|-------------------------------------------------------------------------------------------------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**UIA\_ControlTypePropertyId**](https://www.bing.com/search?q=**UIA\_ControlTypePropertyId**)           | **Menu**   |                                                                                                                                                                         |
| [**UIA\_IsContentElementPropertyId**](https://www.bing.com/search?q=**UIA\_IsContentElementPropertyId**) | TRUE       | The menu control is always included in the content view of the UI Automation tree.                                                                                      |
| [**UIA\_IsControlElementPropertyId**](https://www.bing.com/search?q=**UIA\_IsControlElementPropertyId**) | TRUE       | The menu control is always included in the control view of the UI Automation tree.                                                                                      |
| [**UIA\_LabeledByPropertyId**](https://www.bing.com/search?q=**UIA\_LabeledByPropertyId**)               | NULL       | No label is anticipated with a typical menu control.                                                                                                                    |
| [**UIA\_NamePropertyId**](https://www.bing.com/search?q=**UIA\_NamePropertyId**)                         | See notes. | The menu control does not require a **Name** property to be set, or it could have the same name as the associated control, such as a menu item that opened the submenu. |
...
Menu controls must raise the [**UIA\_MenuOpenedEventId**](https://www.bing.com/search?q=**UIA\_MenuOpenedEventId**) event when they appear on the screen. The **UIA\_MenuOpenedEventId** event will include the text of the control. The [**UIA\_MenuClosedEventId**](https://www.bing.com/search?q=**UIA\_MenuClosedEventId**) event must be raised when a menu disappears from the screen.
...
| [**UIA\_MenuClosedEventId**](https://www.bing.com/search?q=**UIA\_MenuClosedEventId**)                                                              |                                                                                                                            |
| [**UIA\_MenuOpenedEventId**](https://www.bing.com/search?q=**UIA\_MenuOpenedEventId**)                                                              |                                                                                                                            |
