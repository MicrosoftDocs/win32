...
This section describes the verification log messages for UI Accessibility Checker (AccChecker).

## In this section

-   [AccessibleObjectFromPointReturnedNullIAccessible](accessibleobjectfrompointreturnednulliaccessible.md)
-   [AccessibleObjectFromPointReturnedNot\_S\_OK](accessibleobjectfrompointreturnednot-s-ok.md)
...
-   [AccNavigate\_ReturnedElementWithIncorrectParent](accnavigate-returnedelementwithincorrectparent.md)
