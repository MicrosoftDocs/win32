...
| [**get\_accName**](/windows/desktop/api/Oleacc/nf-oleacc-iaccessible-get_accname)                         | Sends the [**WM\_GETTEXT**](https://docs.microsoft.com/windows/desktop/winmsg/wm-gettext) message to retrieve the window text.                                                                                                                                                                                                                                                                                                                                                                                |
