...
If a window returns 0, clients may need to use [**RealGetWindowClass**](_win32_RealGetWindowClass) or [**GetClassName**](_win32_GetClassName). You can use these functions to determine the type of control based on class name.
