...
If a window returns 0, clients may need to use [**RealGetWindowClass**](8db247bf-b253-4a50-8a80-47385b756b38) or [**GetClassName**](039dd7cd-07cf-4c8a-9287-365d54da2f43). You can use these functions to determine the type of control based on class name.
