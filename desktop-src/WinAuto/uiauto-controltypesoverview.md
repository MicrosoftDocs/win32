...
If your control does not meet the specifications for a particular control type, use [**UIA\_CustomControlTypeId**](https://www.bing.com/search?q=**UIA\_CustomControlTypeId**) as the control type ID, and completely describe the control by using the relevant control patterns and properties. You can also set the [**UIA\_LocalizedControlTypePropertyId**](https://www.bing.com/search?q=**UIA\_LocalizedControlTypePropertyId**) property to a string that best describes the type of your control.
...
-   [SemanticZoom Control Type](https://msdn.microsoft.com/library/windows/desktop/hh920984)
