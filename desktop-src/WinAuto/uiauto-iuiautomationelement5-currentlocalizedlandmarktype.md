---
title: IUIAutomationElement5 CurrentLocalizedLandmarkType property
...
keywords:
- CurrentLocalizedLandmarkType property Windows Accessibility
- CurrentLocalizedLandmarkType property Windows Accessibility , IUIAutomationElement5 interface
- IUIAutomationElement5 interface Windows Accessibility , CurrentLocalizedLandmarkType property
topic_type:
- apiref
api_name:
...
# IUIAutomationElement5::CurrentLocalizedLandmarkType property
...
A string containing the current localized landmark type for the automation element.
