...
| [**WINEVENTPROC**](/windows/desktop/api/Winuser/)<br/>   | Used to declare a pointer to an application-defined callback function that the system calls in response to events that are generated by an accessible object.<br/> |
