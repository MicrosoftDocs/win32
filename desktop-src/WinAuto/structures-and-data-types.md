...
| Topic                                             | Description                                                                                                                                                              |
|---------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**MSAAMENUINFO**](/windows/desktop/api/Oleacc/ns-oleacc-tagmsaamenuinfo)<br/>   | Used by server developers to expose the names of owner-drawn menu items.<br/>                                                                                      |
| [**HWINEVENTHOOK**](hwineventhook.md)<br/> | Used to declare a window event hook function.<br/>                                                                                                                 |
| [**WINEVENTPROC**](https://msdn.microsoft.com/en-us/library/Dd373882(v=VS.85).aspx)<br/>   | Used to declare a pointer to an application-defined callback function that the system calls in response to events that are generated by an accessible object.<br/> |
