...
In this scenario, the server responds to an [**OBJID\_CLIENT**](object-identifiers.md#objid-client) request using the same [**IAccessible**](/windows/win32/oleacc/nn-oleacc-iaccessible?branch=master) interface pointer each time.
