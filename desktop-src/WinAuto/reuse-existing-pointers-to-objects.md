...
In this scenario, the server responds to an [**OBJID\_CLIENT**](https://www.bing.com/search?q=**OBJID\_CLIENT**) request using the same [**IAccessible**](/windows/desktop/api/oleacc/nn-oleacc-iaccessible) interface pointer each time.
