...
In this scenario, the server responds to an [**OBJID\_CLIENT**](object-identifiers.md#objid-client) request using the same [**IAccessible**](iaccessible.md) interface pointer each time.
