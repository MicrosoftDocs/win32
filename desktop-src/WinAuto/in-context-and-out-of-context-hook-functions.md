...
When registering a hook function with [**SetWinEventHook**](setwineventhook.md), clients specify whether the hook function is *in-context* or *out-of-context*. These terms describe the memory location of the hook function relative to the server's address space.
