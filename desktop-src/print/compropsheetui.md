...
The COMPROPSHEETUI structure is used as an input parameter to CPSUI's [**ComPropSheet**](compropsheet.md) function, if the function code is [**CPSFUNC\_ADD\_PCOMPROPSHEETUI**](https://www.bing.com/search?q=**CPSFUNC\_ADD\_PCOMPROPSHEETUI**). All structure members must be supplied by the caller of *ComPropSheet*.
