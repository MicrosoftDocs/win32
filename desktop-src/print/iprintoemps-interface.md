...
The **IPrintOemPS** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintOemPS** also has these types of members:
...
| [**IPrintOemPS::DevMode**](iprintoemps-devmode.md)                               | The `IPrintOemPS::DevMode` method, provided by rendering plug-ins for Pscript5, performs operations on private [**DEVMODEW**](display.devmodew) members.<br/>                                                                                                      |
