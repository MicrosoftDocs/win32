...
The **IPartResourceDictionary** interface is the abstraction for an XPS resource dictionary.

## Members

The **IPartResourceDictionary** interface inherits from [IPartBase](ipartbase.md) but does not have additional members.
