---
Description: The IPrintOemPrintTicketProviderConvertDevModeToPrintTicket method converts a DEVMODEW structure into a print ticket.
ms.assetid: b2e029b7-32c0-4cef-8388-9d30aa5610d3
title: IPrintOemPrintTicketProviderConvertDevModeToPrintTicket method
ms.date: 05/31/2018
ms.topic: article
...
The `IPrintOemPrintTicketProvider::ConvertDevModeToPrintTicket` method converts a [**DEVMODEW**](display.devmodew) structure into a print ticket.
...
The size, in bytes, of the input [**DEVMODEW**](display.devmodew) structure. The size includes both the public and private portions of this structure.
...
The core driver calls the `IPrintTicketProvider::ConvertDevModeToPrintTicket` method with an input print ticket that is populated with public and Unidrv-private or Pscript5-private features. The plug-in is free to set [**DEVMODEW**](display.devmodew) settings in the public part or in the plug-in's private part, based on settings in the input print ticket. In addition to setting new DEVMODEW items, the plug-in can modify existing settings in the public portion of the DEVMODEW structure.
