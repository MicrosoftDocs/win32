...
Caller-supplied pointer to a [**DEVMODEW**](display.devmodew) structure that is passed to the print processor or printer driver.
...
**dwJobNumberOfCopies** = **dmCopies** member of [**DEVMODEW**](display.devmodew)
