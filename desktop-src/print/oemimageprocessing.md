...
This function is obsolete for Windows XP and later. It is supported only for earlier Unidrv plug-ins. Use [**IPrintOemUni::ImageProcessing**](iprintoemuni-imageprocessing.md).
