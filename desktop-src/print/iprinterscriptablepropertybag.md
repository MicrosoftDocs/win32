...
The **IPrinterScriptablePropertyBag** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrinterScriptablePropertyBag** also has these types of members:
