...
This function is obsolete for Windows XP and later. It is supported only for earlier plug-ins. Use [**IPrintOemPS::ResetPDEV**](iprintoemps-resetpdev.md) (Pscript) or [**IPrintOemUni::ResetPDEV**](iprintoemuni-resetpdev.md) (Unidrv).
