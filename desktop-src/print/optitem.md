...
The OPTITEM structure is used by CPSUI applications (including printer interface DLLs) for describing one [property sheet option](print.property_sheet_options) on a property sheet page, if the page is described by a [**COMPROPSHEETUI**](compropsheetui.md) structure.
...
(Printer interface DLLs for [*Unidrv*](wdkgloss.u#wdkgloss-unidrv) and [*Pscript*](wdkgloss.p#wdkgloss-pscript) use this member to supply a pointer to a [**USERDATA**](userdata.md) structure. [User interface plug-ins](print.user_interface_plug_ins) can reference this structure.)
...
This union indicates the option's currently selected parameter value. Its usage is dependent on the [CPSUI option type](print.cpsui_option_types).
...
For option values that are stored in a printer's DEVMODE structure, the **DMPubID** member must identify the option. For each **DMPubID** value that is used, a printer interface DLL must specify the [CPSUI option type](print.cpsui_option_types) listed in the following table.



| DMPubID Value                     | Required CPSUI Option Type                                                                                                  |
|-----------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| DMPUB\_COLOR<br/>           | [**TVOT\_2STATES**](print.tvot_2states)<br/>                                                                          |
| DMPUB\_COPIES\_COLLATE<br/> | [**TVOT\_UDARROW**](print.tvot_udarrow) plus [**EXTCHKBOX**](extchkbox.md) (See comments following this table.)<br/> |
| DMPUB\_DEFSOURCE<br/>       | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
| DMPUB\_DITHERTYPE<br/>      | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
| DMPUB\_DUPLEX<br/>          | [**TVOT\_2STATES**](print.tvot_2states) or [**TVOT\_3STATES**](print.tvot_3states)<br/>                               |
| DMPUB\_FORMNAME<br/>        | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
| DMPUB\_ICMINTENT<br/>       | [**TVOT\_2STATES**](print.tvot_2states) or [**TVOT\_3STATES**](print.tvot_3states)<br/>                               |
| DMPUB\_ICMMETHOD<br/>       | [**TVOT\_2STATES**](print.tvot_2states) or [**TVOT\_3STATES**](print.tvot_3states)<br/>                               |
| DMPUB\_MEDIATYPE<br/>       | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
| DMPUB\_NUP<br/>             | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
| DMPUB\_ORIENTATION<br/>     | [**TVOT\_2STATES**](print.tvot_2states) or [**TVOT\_3STATES**](print.tvot_3states)<br/>                               |
| DMPUB\_OUTPUTBIN<br/>       | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
| DMPUB\_PAGEORDER<br/>       | [**TVOT\_2STATES**](print.tvot_2states) or [**TVOT\_3STATES**](print.tvot_3states)<br/>                               |
| DMPUB\_PRINTQUALITY<br/>    | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
| DMPUB\_QUALITY<br/>         | [**TVOT\_2STATES**](print.tvot_2states) or [**TVOT\_3STATES**](print.tvot_3states)<br/>                               |
| DMPUB\_SCALE<br/>           | [**TVOT\_UDARROW**](print.tvot_udarrow)<br/>                                                                          |
| DMPUB\_TTOPTION<br/>        | [**TVOT\_LISTBOX**](print.tvot_listbox)<br/>                                                                          |
