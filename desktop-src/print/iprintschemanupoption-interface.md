...
The **IPrintSchemaNUpOption** interface inherits from [**IPrintSchemaOption**](iprintschemaoption-interface.md). **IPrintSchemaNUpOption** also has these types of members:

-   [Properties](#properties)

### Properties

The **IPrintSchemaNUpOption** interface has these properties.



| Property                                                                | Access type          | Description                                    |
|:------------------------------------------------------------------------|:---------------------|:-----------------------------------------------|
| [**PagesPerSheet**](iprintschemanupoption-pagespersheet.md)<br/> | Read-only<br/> | Gets the number of pages per sheet.<br/> |
