...
This section describes the functions that are defined by printer interface DLLs to support the Microsoft XPS Document Converter (MXDC). Function prototypes are provided in Mxdc.h.
