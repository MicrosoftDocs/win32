...
The **IPrinterScriptablePropertyBag2** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrinterScriptablePropertyBag2** also has these types of members:
