...
For Western device fonts, the **fwdAveCharWidth** member of the [**IFIMETRICS**](display.ifimetrics) structure is used for determining single-byte character widths, if the character widths are not specified using a WIDTHTABLE structure.
