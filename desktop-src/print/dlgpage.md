...
The CPSUI-supplied identifiers refer to templates that can display [CPSUI option types](print.cpsui_option_types). The page size for those templates is 252 by 216 dialog box units. For more information, see [CPSUI-Supplied Pages and Templates](print.cpsui_supplied_pages_and_templates).
