...
The **GdiGetDevmodeForPage** function returns [**DEVMODEW**](display.devmodew) structures for the specified and previous pages of a print job.
...
Caller-supplied number of the page for which [**DEVMODEW**](display.devmodew) contents are to be returned.
