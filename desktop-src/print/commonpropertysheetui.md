...
3.  If the user modifies page values, a [page event callback](print.page_event_callbacks) notifies the application of the changes.
...
For more information about the sequence of operation, see [Using CPSUI with Printer Drivers](print.using_cpsui_with_printer_drivers), in the section entitled [CPSUI](print.common_property_sheet_user_interface).
