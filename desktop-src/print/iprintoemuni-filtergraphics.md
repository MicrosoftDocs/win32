...
`IPrintOemUni::FilterGraphics` method is called by Unidrv's [*DrvSendPage*](display.drvsendpage) function. If you want to implement `IPrintOemUni::FilterGraphics`, you must not completely override Unidrv's **DrvSendPage** or [**DrvNextBand**](display.drvnextband) functions.
...
For more information about customizing Unidrv's rendering operations, see [Unidrv-Specific Customized Rendering](print.unidrv_specific_customized_rendering).
...
[**DrvNextBand**](display.drvnextband)
</dt> <dt>
