...
| <dl> <dt>**E\_INVALIDARG**</dt> </dl>  | The method attempted to query for a nonexistent attribute.<br/> The *pdevobj* parameter pointed to an invalid driver context object.<br/>                                                         |
...
For more information, see [Using GetGlobalAttribute](print.using_getglobalattribute).
