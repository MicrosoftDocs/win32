...
We recommend that the driver preserve the state of the intent option in the driver's private [**DEVMODEW**](display.devmodew) structure when it converts a print ticket to a DEVMODEW, and then from a DEVMODEW back to a print ticket.
