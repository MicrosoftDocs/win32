...
For more information about halftoning, see [Customized Halftoning](print.customized_halftoning) and [Option Attributes for the Halftone Feature](print.option_attributes_for_the_halftone_feature).
