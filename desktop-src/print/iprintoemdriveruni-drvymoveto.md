...
The `IPrintOemDriverUni::DrvYMoveTo` method is provided by the Unidrv driver so that a [rendering plug-in](https://www.bing.com/search?q=rendering+plug-in) can notify the driver of cursor y-position changes.
