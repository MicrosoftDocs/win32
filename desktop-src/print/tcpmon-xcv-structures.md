...
This section describes the structures that are defined for use in TCPMON Xcv communication. For more information, see [TCPMON Xcv Interface](print.tcpmon_xcv_interface).

This section includes:

<dl>

[**CONFIG\_INFO\_DATA\_1**](config-info-data-1.md)  
[**DELETE\_PORT\_DATA\_1**](delete-port-data-1.md)  
