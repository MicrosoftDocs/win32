...
The **IPrinterExtensionEvent** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/windows/desktop/33f1d79a-33fc-4ce5-a372-e08bda378332) interface. **IPrinterExtensionEvent** also has these types of members:

-   [Methods](#methods)

### Methods

The **IPrinterExtensionEvent** interface has these methods.



| Method                                                                                | Description                                           |
|:--------------------------------------------------------------------------------------|:------------------------------------------------------|
| [**OnDriverEvent**](iprinterextensionevent-ondriverevent.md)                         | Called when a driver event occurs.<br/>         |
| [**OnPrinterQueuesEnumerated**](iprinterextensionevent-onprinterqueuesenumerated.md) | Called when printer queues are enumerated.<br/> |
