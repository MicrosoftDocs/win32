...
The **IPrintOemDriverPS** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintOemDriverPS** also has these types of members:

-   [Methods](#methods)

### Methods

The **IPrintOemDriverPS** interface has these methods.
...
| [**DrvWriteSpoolBuf**](iprintoemdriverps-drvwritespoolbuf.md)       | The `IPrintOemDriverPS::DrvWriteSpoolBuf` method is provided by the Pscript5 driver so that [rendering plug-ins](print.rendering_plug_ins) can send printer data to the spooler.<br/>                    |
