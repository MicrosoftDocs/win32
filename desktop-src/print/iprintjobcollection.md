...
The **IPrintJobCollection** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintJobCollection** also has these types of members:
...
**IPrintJobCollection** also helps to make it possible to perform job management from a UWP device app or from a printer extension. For more information, see [Job Management](print.job_management).
