...
The run mode parameter. If this parameter is TRUE, the printer extension is run as a modal window. If this parameter is FALSE, the printer extension is not run as a modal window.
