...
This section describes the methods defined for the [IPrintCorePS2 COM Interface](print.iprintcoreps2_com_interface). Method prototypes are defined in prcomoem.h.

## Members

The **IPrintCorePS2** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintCorePS2** also has these types of members:
...
| Method                                                           | Description                                                                                                                                                                              |
|:-----------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**DrvWriteSpoolBuf**](iprintcoreps2-drvwritespoolbuf.md)       | The `IPrintCorePS2::DrvWriteSpoolBuf` method is provided by the Pscript5 driver so that a [rendering plug-in](print.rendering_plug_ins) can send printer data to the spooler.<br/> |
