...
Pointer to a [**DEVMODEW**](display.devmodew) structure passed to either CreateIC or CreateDC (both described in the Microsoft Windows SDK documentation). This member can be **NULL**.
