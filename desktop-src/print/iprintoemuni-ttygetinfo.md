...
The *pOutputBuf* parameter points to a DWORD in which the method should return the number of resource IDs of the [*UFMs*](https://www.bing.com/search?q=*UFMs*) for 10, 12, and 17 CPI fonts. To actually obtain these resource IDs, perform a query using OEMTTY\_INFO\_UFM\_IDS.
