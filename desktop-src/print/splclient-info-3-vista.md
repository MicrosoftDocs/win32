...
Contains a super-set of the information in both a [**SPLCLIENT\_INFO\_1**](https://www.bing.com/search?q=**SPLCLIENT\_INFO\_1**) and **SPLCLIENT\_INFO\_2** structure. It also contains additional information needed by the provider.
...
Reserved. Used for compatibility with the [**SPLCLIENT\_INFO\_1**](https://www.bing.com/search?q=**SPLCLIENT\_INFO\_1**) structure.
