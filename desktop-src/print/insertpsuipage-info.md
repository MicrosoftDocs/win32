...
The INSERTPSUIPAGE\_INFO structure is used as an input parameter to CPSUI's [**ComPropSheet**](compropsheet.md) function, if the function code is [**CPSFUNC\_INSERT\_PSUIPAGE**](print.cpsfunc_insert_psuipage). All member values must be supplied by the **ComPropSheet** caller.
...
CPSUI creates a new [group parent](print.group_parent).
...
(This is equivalent to calling [**ComPropSheet**](compropsheet.md) with a function code of [**CPSFUNC\_ADD\_HPROPSHEETPAGE**](print.cpsfunc_add_hpropsheetpage).)
...
(This is equivalent to calling [**ComPropSheet**](compropsheet.md) with a function code of [**CPSFUNC\_ADD\_PCOMPROPSHEETUI**](print.cpsfunc_add_pcompropsheetui).)
...
(This is equivalent to calling [**ComPropSheet**](compropsheet.md) with a function code of [**CPSFUNC\_ADD\_PFNPROPSHEETUI**](print.cpsfunc_add_pfnpropsheetui).)
...
(This is equivalent to calling [**ComPropSheet**](compropsheet.md) with a function code of [**CPSFUNC\_ADD\_PROPSHEETPAGE**](print.cpsfunc_add_propsheetpage).)
