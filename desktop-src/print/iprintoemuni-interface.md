...
| [**DisableDriver**](iprintoemuni-disabledriver.md)                   | The `IPrintOemuNI::DisableDriver` method allows a rendering plug-in for [*Unidrv*](https://msdn.microsoft.com/0a51fa2b-3d09-4a5f-9fff-40604877a414) to free resources that were allocated by the plug-in's [**IPrintOemUni::EnableDriver**](iprintoemuni-enabledriver.md) method.<br/>        |
| [**DisablePDEV**](iprintoemuni-disablepdev.md)                       | The `IPrintOemUni::DisablePDEV` method allows a rendering plug-in for [*Unidrv*](https://msdn.microsoft.com/0a51fa2b-3d09-4a5f-9fff-40604877a414) to delete the private PDEV structure that was allocated by its [**IPrintOemUni::EnablePDEV**](iprintoemuni-enablepdev.md) method.<br/>      |
...
| [**DownloadFontHeader**](iprintoemuni-downloadfontheader.md)         | The `IPrintOemUni::DownloadFontHeader` method allows a rendering plug-in for [*Unidrv*](https://msdn.microsoft.com/0a51fa2b-3d09-4a5f-9fff-40604877a414) to send a font's header information to a printer.<br/>                                                                                |
| [**DriverDMS**](iprintoemuni-driverdms.md)                           | The `IPrintOemUni::DriverDMS` method allows a rendering plug-in for [*Unidrv*](https://msdn.microsoft.com/0a51fa2b-3d09-4a5f-9fff-40604877a414) to indicate that it uses a device-managed drawing surface.<br/>                                                                                |
| [**EnableDriver**](iprintoemuni-enabledriver.md)                     | The `IPrintOemUni::EnableDriver` method allows a rendering plug-in for [*Unidrv*](https://msdn.microsoft.com/0a51fa2b-3d09-4a5f-9fff-40604877a414) to hook out some graphics DDI functions.<br/>                                                                                               |
| [**EnablePDEV**](iprintoemuni-enablepdev.md)                         | The `IPrintOemUni::EnablePDEV` method allows a rendering plug-in for [*Unidrv*](https://msdn.microsoft.com/0a51fa2b-3d09-4a5f-9fff-40604877a414) to create its own PDEV structure.<br/>                                                                                                        |
