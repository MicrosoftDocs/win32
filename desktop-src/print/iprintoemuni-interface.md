...
The **IPrintOemUni** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintOemUni** also has these types of members:
...
| [**DevMode**](iprintoemuni-devmode.md)                               | The `IPrintOemUni::DevMode` method, provided by rendering plug-ins for Unidrv, performs operations on private [**DEVMODEW**](display.devmodew) members.<br/>                                                                                                              |
