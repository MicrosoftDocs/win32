...
The **IPrinterExtensionAsyncOperation** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrinterExtensionAsyncOperation** also has these types of members:
...
**IPrinterExtensionAsyncOperation** also helps to make it possible to perform device maintenance from a UWP device app or from a printer extension. For more information, see [Device Maintenance](print.device_maintenance).
