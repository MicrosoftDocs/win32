...
| <dl> <dt>**E\_INVALIDARG**</dt> </dl>  | The string pointed to by *pszFeatureKeyword* was not a recognized feature.<br/> The *poemuiobj* parameter pointed to an invalid context object.<br/> The stickiness of the feature did not match that of the context object pointed to by *peomuiobj*. (See [Replacing Driver-Supplied Property Sheet Pages](print.replacing_driver_supplied_property_sheet_pages).)<br/> |
