...
`IPrintTicketProvider::ValidatePrintTicket` should return S\_NO\_CONFLICT or S\_CONFLICT\_RESOLVED if the operation succeeds. Otherwise, this method should return a standard COM error code.
