...
Print providers should call `RouterAllocPrinterNotifyInfo` to allocate the PRINTER\_NOTIFY\_INFO structure and the PRINTER\_NOTIFY\_INFO\_DATA structure array that the provider's [**RefreshPrinterChangeNotification**](https://www.bing.com/search?q=**RefreshPrinterChangeNotification**) function must supply.
