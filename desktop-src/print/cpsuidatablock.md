...
The CPSUIDATABLOCK structure is used as a parameter for the [**ComPropSheet**](compropsheet.md) function, if the function code is [**CPSFUNC\_SET\_DATABLOCK**](https://www.bing.com/search?q=**CPSFUNC\_SET\_DATABLOCK**) or [**CPSFUNC\_QUERY\_DATABLOCK**](https://www.bing.com/search?q=**CPSFUNC\_QUERY\_DATABLOCK**).
