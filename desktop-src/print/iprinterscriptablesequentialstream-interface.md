...
The **IPrinterScriptableSequentialStream** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrinterScriptableSequentialStream** also has these types of members:
