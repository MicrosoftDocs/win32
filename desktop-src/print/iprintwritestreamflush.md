...
The **IPrintWriteStreamFlush** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintWriteStreamFlush** also has these types of members:
...
| Method                                                | Description                                                                                                                                                       |
|:------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**FlushData**](iprintwritestreamflush-flushdata.md) | The FlushData method flushes buffered data to a data stream while leaving the stream open, allowing the caller to write additional data to the stream.<br/> |
