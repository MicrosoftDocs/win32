...
Caller-supplied handle. This handle must have been previously received as the *hNotify* input to the print provider's [**FindFirstPrinterChangeNotification**](https://www.bing.com/search?q=**FindFirstPrinterChangeNotification**) function.
