...
The `IPrintOemDriverUni::DrvWriteSpoolBuf` method is provided by the Unidrv driver so that a [rendering plug-in](print.rendering_plug_ins) can send printer data to the spooler.
