...
The `IPrintOemUni::DisableDriver` method, provided by rendering plug-ins for Unidrv, performs the same types of operations as the [**DrvDisableDriver**](display.drvdisabledriver) function that is exported by Unidrv's printer graphics DLL.
