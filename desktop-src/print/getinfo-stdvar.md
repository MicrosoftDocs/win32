...
Specifies the [standard variables](print.standard_variables) for which a value should be returned. Supplied by the [*UNIFONTOBJ\_GetInfo*](unifontobj-getinfo.md) caller. Valid values are contained in the following table.
...
For more information about [standard variables](print.standard_variables), see [Microsoft Universal Printer Driver](print.microsoft_universal_printer_driver).
