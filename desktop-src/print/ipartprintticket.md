...
The **IPartPrintTicket** interface is the abstraction for a print ticket in an XPS document.

## Members

The **IPartPrintTicket** interface inherits from [IPartBase](ipartbase.md) but does not have additional members.
