---
Description: A printer interface DLLs DrvDevicePropertySheets function is responsible for creating property sheet pages that describe a printers properties.
...
All [printer interface DLLs](print.printer_interface_dll) must provide a **DrvDevicePropertySheets** function, which is defined using the [**PFNPROPSHEETUI**](pfnpropsheetui.md) function type. The function's purpose is to call the [**ComPropSheet**](compropsheet.md) function, provided by [CPSUI](print.common_property_sheet_user_interface), to specify a property sheet page containing user-modifiable properties for the printer.
