---
Description: The IPrintCorePS2EnumOptions method enumerates the available options of a specific feature.
ms.assetid: 2a861450-0bc5-432b-bf5d-9a9761c22ea1
title: IPrintCorePS2EnumOptions method
ms.date: 05/31/2018
ms.topic: article
...
| <dl> <dt>**E\_INVALIDARG**</dt> </dl>  | The string pointed to by *pszFeatureKeyword* is not a recognized feature.<br/> The *pdevobj* parameter pointed to an invalid driver context object.<br/>                                                                                                  |
