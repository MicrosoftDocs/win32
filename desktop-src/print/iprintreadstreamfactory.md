...
The **IPrintReadStreamFactory** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintReadStreamFactory** also has these types of members:
...
| Method                                                                          | Description                                                  |
|:--------------------------------------------------------------------------------|:-------------------------------------------------------------|
| [**IPrintReadStreamFactory::GetStream**](iprintreadstreamfactory-getstream.md) | The `GetStream` method gets the stream interface.<br/> |
