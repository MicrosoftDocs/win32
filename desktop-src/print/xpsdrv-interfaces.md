...
This section describes the programming interfaces that are provided for vendor-supplied customization of XPSDrv driver functionality. The following sections are included:
