...
| DOCUMENTEVENT\_RESETDCPRE<br/>                                                    | *pvIn* contains the address of a pointer to the [**DEVMODEW**](https://msdn.microsoft.com/b2369876-9a79-40c8-8d27-c8b9d8e68e6b) structure supplied by the caller of **ResetDC** (described in the Windows SDK documentation).<br/>                                                           |
