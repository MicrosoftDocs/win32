...
The **IPrintPipelineProgressReport** interface inherits from the [**IUnknown**](com.iunknown) interface. **IPrintPipelineProgressReport** also has these types of members:
