...
This function is obsolete for Windows XP and later. It is supported only for earlier plug-ins. For UI plug-ins, use [**IPrintOemUI::DevMode**](iprintoemui-devmode.md); for Pscript plug-ins, use [**IPrintOemPS::DevMode**](iprintoemps-devmode.md); for Unidrv plug-ins, use [**IPrintOemUni::DevMode**](iprintoemuni-devmode.md).
