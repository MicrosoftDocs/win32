...
| DOCUMENTEVENT\_RESETDCPRE<br/>                                                   | *pvIn* contains the address of a pointer to a [**DEVMODEW**](display.devmodew) structure supplied by the caller of **ResetDC** (described in the Microsoft Windows SDK documentation).<br/>                                                   |
