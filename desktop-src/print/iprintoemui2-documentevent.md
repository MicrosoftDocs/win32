...
| DOCUMENTEVENT\_RESETDCPRE<br/>                                                   | *pvIn* contains the address of a pointer to a [**DEVMODEW**](https://www.bing.com/search?q=**DEVMODEW**) structure supplied by the caller of **ResetDC** (described in the Microsoft Windows SDK documentation).<br/>                                                   |
