...
This function is obsolete for Windows XP and later. It is supported only for earlier plug-ins. Use [**IPrintOemUI::DocumentPropertySheets**](iprintoemui-documentpropertysheets.md) instead.
