...
When an application calls CPSUI's [**ComPropSheet**](compropsheet.md) function, specifying a function code of [**CPSFUNC\_SET\_RESULT**](https://www.bing.com/search?q=**CPSFUNC\_SET\_RESULT**), CPSUI calls all registered [**PFNPROPSHEETUI**](pfnpropsheetui.md)-typed functions, specifying a reason of PROPSHEETUI\_REASON\_SET\_RESULT. When specifying this reason, CPSUI also supplies a SETRESULT\_INFO structure.
