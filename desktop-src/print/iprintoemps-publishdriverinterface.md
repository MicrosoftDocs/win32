...
Caller-supplied pointer to the **IUnknown** interface of the driver's [IPrintCorePS2 COM Interface](print.iprintcoreps2_com_interface), [IPrintOemDriverPS COM Interface](print.iprintoemdriverps_com_interface), or [IPrintCoreHelperPS Interface](iprintcorehelperps-interface.md).
