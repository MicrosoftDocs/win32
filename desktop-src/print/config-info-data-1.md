...
The [**XcvData**](https://www.bing.com/search?q=**XcvData**) function uses a CONFIG\_INFO\_DATA\_1 structure when it obtains configuration data for a particular port.
