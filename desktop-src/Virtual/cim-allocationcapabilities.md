...
The **CIM\_AllocationCapabilities** class has these methods.



| Method                                                                      | Description                                                                                            |
|:----------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------|
| [**CreateGoalSettings**](cim-allocationcapabilities-creategoalsettings.md) | TBD<br/> This method is inherited from [**CIM\_Capabilities**](cim-capabilities.md).<br/> |
