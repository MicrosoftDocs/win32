---
title: RequestStateChange method of the Msvm\_NetworkJob class
description: Requests the specified state change to a concrete job.
ms.assetid: '8193d4ad-fecd-4bc5-beae-d499825d3613'
keywords: ["RequestStateChange method Hyper-V", "RequestStateChange method Hyper-V , Msvm_NetworkJob class", "Msvm_NetworkJob class Hyper-V , RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the Msvm\_NetworkJob class
