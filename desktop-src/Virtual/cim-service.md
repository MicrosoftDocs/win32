...
ms.assetid: 'a2379c39-984e-40c3-9f42-a1e4b970b6aa'
keywords: ["CIM_Service class Hyper-V", "CIM_Service class Hyper-V , described"]
topic_type:
- apiref
api_name:
- CIM_Service
...
- CIM_Service.ElementName
- CIM_Service.InstallDate
- CIM_Service.OperationalStatus
- CIM_Service.StatusDescriptions
- CIM_Service.Status
- CIM_Service.HealthState
- CIM_Service.EnabledState
- CIM_Service.OtherEnabledState
- CIM_Service.RequestedState
- CIM_Service.EnabledDefault
- CIM_Service.TimeOfLastStateChange
