...
| Method                                                                | Description                                                                                                                                                                                    |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**BroadcastReset**](https://www.bing.com/search?q=**BroadcastReset**)         | This method is not supported.<br/> This method is inherited from [**CIM\_ProtocolEndpoint**](cim-protocolendpoint.md).<br/>                                                       |
