...
ms.assetid: '98c1648b-0a37-4a25-a0f6-b1318992c333'
keywords: ["CIM_PointingDevice class Hyper-V", "CIM_PointingDevice class Hyper-V , described"]
topic_type:
- apiref
api_name:
- CIM_PointingDevice
...
- CIM_PointingDevice.ElementName
- CIM_PointingDevice.InstallDate
- CIM_PointingDevice.Name
- CIM_PointingDevice.OperationalStatus
- CIM_PointingDevice.StatusDescriptions
- CIM_PointingDevice.Status
- CIM_PointingDevice.HealthState
- CIM_PointingDevice.EnabledState
- CIM_PointingDevice.OtherEnabledState
- CIM_PointingDevice.RequestedState
- CIM_PointingDevice.EnabledDefault
- CIM_PointingDevice.TimeOfLastStateChange
...
- CIM_PointingDevice.OtherIdentifyingInfo
- CIM_PointingDevice.PowerOnHours
- CIM_PointingDevice.TotalPowerOnHours
- CIM_PointingDevice.IdentifyingDescriptions
- CIM_PointingDevice.AdditionalAvailability
- CIM_PointingDevice.MaxQuiesceTime
- CIM_PointingDevice.LocationIndicator
...
The **CIM\_PointingDevice** class has these methods.



| Method                                                                  | Description                                                                                                                                                                                                                                                                                                                                             |
|:------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](virtual-cim_pointingdevice_enabledevice)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](virtual-cim_pointingdevice_onlinedevice)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](virtual-cim_pointingdevice_quiescedevice)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](virtual-cim_pointingdevice_requeststatechange) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](virtual-cim_pointingdevice_reset)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](virtual-cim_pointingdevice_restoreproperties)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](virtual-cim_pointingdevice_saveproperties)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](virtual-cim_pointingdevice_setpowerstate)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
