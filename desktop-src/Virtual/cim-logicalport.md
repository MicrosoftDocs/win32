...
| Method                                                               | Description                                                                                                                                                                                                                                                                                                                                                                      |
|:---------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](https://www.bing.com/search?q=**EnableDevice**)             | This method is deprecated. Instead, use the [**RequestStateChange**](https://www.bing.com/search?q=**RequestStateChange**) method.<br/> **Deprecated description:** Enables or disables the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](https://www.bing.com/search?q=**OnlineDevice**)             | This method is deprecated. Instead, use the [**RequestStateChange**](https://www.bing.com/search?q=**RequestStateChange**) method.<br/> **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](https://www.bing.com/search?q=**QuiesceDevice**)           | This method is deprecated. Instead, use the [**RequestStateChange**](https://www.bing.com/search?q=**RequestStateChange**) method.<br/> **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
...
| [**SetPowerState**](https://www.bing.com/search?q=**SetPowerState**)           | This method is deprecated. Instead, use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> **Deprecated description:** Sets the power state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
