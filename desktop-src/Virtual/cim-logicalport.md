...
ms.assetid: '783268b6-a7ff-49a9-b877-3eb6d6476b9c'
keywords: ["CIM_LogicalPort class Hyper-V", "CIM_LogicalPort class Hyper-V , described"]
topic_type:
- apiref
api_name:
- CIM_LogicalPort
...
- CIM_LogicalPort.LocationIndicator
...
The abstraction of a port or connection point of a device. This object should be instantiated when the port has independent management characteristics from the device that contains the port. A fibre channel port and a USB port are examples of a logical port.
...
| Method                                                               | Description                                                                                                                                                                                                                                                                                                                                                                      |
|:---------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](virtual-cim_logicalport_enabledevice)             | This method is deprecated. Instead, use the [**RequestStateChange**](virtual-cim_logicalport_requeststatechange) method.<br/> **Deprecated description:** Enables or disables the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](virtual-cim_logicalport_onlinedevice)             | This method is deprecated. Instead, use the [**RequestStateChange**](virtual-cim_logicalport_requeststatechange) method.<br/> **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](virtual-cim_logicalport_quiescedevice)           | This method is deprecated. Instead, use the [**RequestStateChange**](virtual-cim_logicalport_requeststatechange) method.<br/> **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](virtual-cim_logicalport_requeststatechange) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                                   |
| [**Reset**](virtual-cim_logicalport_reset)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                                                  |
| [**RestoreProperties**](virtual-cim_logicalport_restoreproperties)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                          |
| [**SaveProperties**](virtual-cim_logicalport_saveproperties)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                    |
| [**SetPowerState**](virtual-cim_logicalport_setpowerstate)           | This method is deprecated. Instead, use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> **Deprecated description:** Sets the power state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
...
Qualifiers: [**Units**](https://msdn.microsoft.com/library/aa393650) ("Bits per Second"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("**CIM\_LogicalPort**.**Speed**")
</dt> </dl>
