...
ms.assetid: d56670b1-ca41-4f61-8df9-67771cccc3c9
keywords:
- CIM_ComputerSystem class Hyper-V
- CIM_ComputerSystem class Hyper-V , described
topic_type:
- apiref
api_name:
- CIM_ComputerSystem
...
| Method                                                                  | Description                                                                                                                                                                                                          |
|:------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](https://www.bing.com/search?q=**RequestStateChange**) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md) class.<br/>             |
...
Additional data, beyond the Name, that could be used to identify a computer system.D
