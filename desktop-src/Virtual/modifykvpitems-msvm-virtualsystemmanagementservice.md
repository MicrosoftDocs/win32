...
ms.assetid: '548afb3b-643f-4cd9-abda-9f7a9ca56252'
keywords: ["ModifyKvpItems method Hyper-V", "ModifyKvpItems method Hyper-V , Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class Hyper-V , ModifyKvpItems method"]
topic_type:
- apiref
api_name:
...
The following C# sample modifies key-value pairs on a virtual system. The referenced utilities can be found in [Common Utilities for the Virtualization Samples](common-utilities-for-the-virtualization-samples.md).
...
[**ModifyKvpItems (V2)**](https://msdn.microsoft.com/library/windows/desktop/hh850096)
</dt> <dt>
