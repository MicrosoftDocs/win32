...
ms.assetid: '610dd3c3-978a-41cd-aaf4-17a41d1fc123'
keywords: ["CIM_VirtualSystemManagementService class Hyper-V", "CIM_VirtualSystemManagementService class Hyper-V , described"]
topic_type:
- apiref
api_name:
- CIM_VirtualSystemManagementService
- CIM_VirtualSystemManagementService.PlanVirtualSystem
- CIM_VirtualSystemManagementService.InstantiateVirtualSystem
- CIM_VirtualSystemManagementService.CloneVirtualSystem
- CIM_VirtualSystemManagementService.Caption
- CIM_VirtualSystemManagementService.Description
- CIM_VirtualSystemManagementService.ElementName
- CIM_VirtualSystemManagementService.InstallDate
- CIM_VirtualSystemManagementService.OperationalStatus
- CIM_VirtualSystemManagementService.StatusDescriptions
- CIM_VirtualSystemManagementService.Status
- CIM_VirtualSystemManagementService.HealthState
- CIM_VirtualSystemManagementService.EnabledState
- CIM_VirtualSystemManagementService.OtherEnabledState
- CIM_VirtualSystemManagementService.RequestedState
- CIM_VirtualSystemManagementService.EnabledDefault
- CIM_VirtualSystemManagementService.TimeOfLastStateChange
- CIM_VirtualSystemManagementService.SystemCreationClassName
- CIM_VirtualSystemManagementService.SystemName
- CIM_VirtualSystemManagementService.CreationClassName
- CIM_VirtualSystemManagementService.Name
- CIM_VirtualSystemManagementService.PrimaryOwnerName
- CIM_VirtualSystemManagementService.PrimaryOwnerContact
- CIM_VirtualSystemManagementService.StartMode
- CIM_VirtualSystemManagementService.Started
api_location:
- Root\virtualization
api_type:
- Schema
...
| Method                                                                                                  | Description                                                                                                                                                                                    |
|:--------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ApplyVirtualSystemSnapshot**](cim-virtualsystemmanagementservice-applyvirtualsystemsnapshot.md)     | Applies the specified snapshot to the virtual computer system. <br/>                                                                                                                     |
| **CloneVirtualSystem**                                                                                  | This method is not supported.<br/>                                                                                                                                                       |
| [**CreateVirtualSystemSnapshot**](cim-virtualsystemmanagementservice-createvirtualsystemsnapshot.md)   | Creates a new snapshot for the virtual computer system. <br/>                                                                                                                            |
| [**DefineVirtualSystem**](cim-virtualsystemmanagementservice-definevirtualsystem.md)                   | Defines the specified virtual system.<br/>                                                                                                                                               |
| [**DestroyVirtualSystem**](cim-virtualsystemmanagementservice-destroyvirtualsystem.md)                 | Destroys the specified virtual system.<br/>                                                                                                                                              |
| [**ExportVirtualSystem**](cim-virtualsystemmanagementservice-exportvirtualsystem.md)                   | This method has been deprecated.<br/>                                                                                                                                                    |
| [**ImportVirtualSystem**](cim-virtualsystemmanagementservice-importvirtualsystem.md)                   | This method has been deprecated.<br/>                                                                                                                                                    |
| **InstantiateVirtualSystem**                                                                            | This method is not supported.<br/>                                                                                                                                                       |
| [**ModifyVirtualSystem**](cim-virtualsystemmanagementservice-modifyvirtualsystem.md)                   | Modifies the setting data for an existing virtual computer system. <br/>                                                                                                                 |
| [**ModifyVirtualSystemResources**](cim-virtualsystemmanagementservice-modifyvirtualsystemresources.md) | Modifies the setting data for existing resources on a virtual computer system. <br/>                                                                                                     |
| **PlanVirtualSystem**                                                                                   | This method is not supported.<br/>                                                                                                                                                       |
| [**RemoveVirtualSystemSnapshot**](cim-virtualsystemmanagementservice-removevirtualsystemsnapshot.md)   | Deletes an existing snapshot from the virtual computer system. <br/>                                                                                                                     |
| [**RequestStateChange**](virtual-cim_virtualsystemmanagementservice_requeststatechange)                 | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
| [**StartService**](virtual-cim_virtualsystemmanagementservice_startservice)                             | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                   |
| [**StopService**](virtual-cim_virtualsystemmanagementservice_stopservice)                               | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                    |
...
The **CIM\_VirtualSystemManagementService** class has these properties.
