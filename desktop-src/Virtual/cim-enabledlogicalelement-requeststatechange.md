...
ms.assetid: '3b7f31b7-0a95-41ba-bf69-905033ca13bb'
keywords: ["RequestStateChange method Hyper-V", "RequestStateChange method Hyper-V , CIM_EnabledLogicalElement class", "CIM_EnabledLogicalElement class Hyper-V , RequestStateChange method"]
topic_type:
- apiref
api_name:
