...
- Msvm_DiskDrive.LocationIndicator
...
A short textual description (one-line string) of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and it is always set to "Disk Drive".
...
The name of the class or subclass used in the creation of an instance. This property is inherited from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) and it is set to "Msvm\_DiskDrive".
...
The default block size, in bytes, for the device. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901) and it is set to 512.
...
A textual description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and it is always set to "Microsoft Virtual Hard Drive" for virtual hard disk drives, or "Microsoft Physical Hard Drive" for pass-through hard disk drives.
...
A user-friendly name for the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and it is set to "Hard Drive" by default.
...
A free-form string that describes the types of error detection and correction supported by this device. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901) and it is set to "None".
...
The date and time when the device was last cleaned. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901) and it is set to **NULL**.
...
The maximum block size, in bytes, for media accessed by the device. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901) and it is set to 512 for virtual hard disk drives, variable for pass-through drives.
...
The maximum size, in kilobytes, of media supported by this device. Kilobytes are interpreted as the number of bytes multiplied by 1000 (not the number of bytes multiplied by 1024). This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901) and it is set to 2,000,000,000 for virtual hard disk drives, variable for pass-through drives.
...
If **TRUE**, the media is locked in the device and cannot be ejected. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901) and it is set to **TRUE**.
...
The minimum block size, in bytes, for media accessed by the device. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901) and it is set to 512.
...
Access to the **Msvm\_DiskDrive** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://msdn.microsoft.com/library/aa826699).
...
[**CIM\_DiskDrive**](https://msdn.microsoft.com/library/aa387254)
</dt> <dt>
