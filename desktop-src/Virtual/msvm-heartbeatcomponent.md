...
ms.assetid: '1ef8772d-0ea3-4afd-a9e3-630864cb762a'
keywords: ["Msvm_HeartbeatComponent class Hyper-V", "Msvm_HeartbeatComponent class Hyper-V , described"]
topic_type:
- apiref
api_name:
...
- Msvm_HeartbeatComponent.LocationIndicator
...
A short textual description (one- line string) of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and is always set to "Heartbeat".
...
The scoping system's creation class name. This property is inherited from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) and is always set to "Msvm\_HeartbeatComponent".
...
A textual description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and is always set to "Microsoft Heartbeat Service".
...
A user-friendly name for the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and it is set to "Heartbeat".
...
The label by which the object is known. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898) and is always set to "Heartbeat".
...
The current state the logical device. This property is inherited from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) but is not used.
...
[**Msvm\_HeartbeatComponent (V2)**](https://msdn.microsoft.com/library/windows/desktop/hh850157)
</dt> <dt>
