...
ms.assetid: 'ab4045ed-1ea6-47eb-bf86-46837a9094e2'
keywords: ["OnlineDevice method Hyper-V", "OnlineDevice method Hyper-V , CIM_LogicalDevice class", "CIM_LogicalDevice class Hyper-V , OnlineDevice method"]
topic_type:
- apiref
api_name:
