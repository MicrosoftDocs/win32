...
- apiref
api_name:
- Msvm_VirtualSystemManagementService.ImportVirtualSystemEx
api_location:
- Root\Virtualization
api_type:
- COM
...
An instance of the [**Msvm\_VirtualSystemImportSettingData**](msvm-virtualsystemimportsettingdata.md) class returned from the [**GetVirtualSystemImportSettingData**](msvm-virtualsystemmanagementservice-getvirtualsystemimportsettingdata.md) method that represents the virtual computer system to be imported.
...
For more examples demonstrating the **ImportVirtualSystemEx** method, see [Importing Virtual Machines](importing-virtual-machines.md).
