...
description: Represents the virtual processor in a virtual computer system.
ms.assetid: '5ff89f00-0be1-402b-8b89-e842617f0949'
keywords: ["Msvm_Processor class Hyper-V", "Msvm_Processor class Hyper-V , described"]
topic_type:
- apiref
api_name:
- Msvm_Processor
...
- Msvm_Processor.LocationIndicator
- Msvm_Processor.Role
...
- Msvm_Processor.Characteristics
...
class Msvm_Processor : CIM_Processor
{
  ...
  string   Description = "Microsoft Virtual Processor";
  ...
  string   Role = "Virtual Processor";
  uint16   Family;
  string   OtherFamilyDescription;
  uint16   UpgradeMethod = 6;
...
The processor address width, in bits. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978) and the value is either 32 or 64, depending on the characteristics of the virtual machine.
...
Describes the bit architecture of the processor. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978). Valid values for this array are:
...
<span id="DMTF_Reserved"></span><span id="dmtf_reserved"></span><span id="DMTF_RESERVED"></span>**DMTF Reserved** (1)
...
<span id="64-bit_Capable"></span><span id="64-bit_capable"></span><span id="64-BIT_CAPABLE"></span>**64-bit Capable** (2)
...
<span id="32-bit_Capable"></span><span id="32-bit_capable"></span><span id="32-BIT_CAPABLE"></span>**32-bit Capable** (3)
...
The current status of the processor. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978) and it is always set to 1 (CPU Enabled).
...
The maximum speed of the physical processor, taking into account the capacity for the virtual processor. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978).
...
The processor data width, in bits. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978) and the value is either 32 or 64, depending on the characteristics of the virtual machine.
...
A textual description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and it is always set to "Microsoft Virtual Processor".
...
An address or other identifying information to uniquely name the logical device. This property is inherited from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) and it is always set to "Microsoft:*GUID*\\*device specific data*".
...
A user-friendly name for the object. This property allows each instance to define a user-friendly name in addition to its key properties, identity data, and description information. Note that the [**Name**](https://msdn.microsoft.com/library/aa387898) property of the **CIM\_ManagedSystemElement** class is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where [**Name**](msvm-keyboard.md) exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the **Name** and **ElementName** properties. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/cc136871) and it is always set to "Processor".
...
An administrator's default or startup configuration for the Enabled State of an element. This property is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) and it is always set to 5 (Enabled).
...
The enabled and disabled states of an element. This property is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) and it is always set to 5 (Enabled).
...
The external bus clock speed of the underlying physical processor. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978).
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("MIF.DMTF\|Processor\|017.3"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Processor**](cim-processor.md).**OtherFamilyDescription**")
</dt> </dl>

The processor family of the underlying physical processor. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978).
...
The date and time when the virtual system was created. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898).
...
The current percentage of the total processing power being consumed by the virtual system. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978).
...
The recorded history of percentage of the total processing power being consumed by the virtual system. This is an array containing samples.
...
The maximum clock speed, in megahertz, of the virtual processor. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978).
...
The label by which the object is known. When subclassed, this property can be overridden to be a key property. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898) and it is always set to "*GUID*".
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (64), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Processor**](cim-processor.md).**Family**")
</dt> </dl>

A description of the processor family type. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978) and it is always set to **NULL**.
...
The last requested or desired state for the element. This property is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) and it is always set to 5 (Not Applicable).
...
A free-form string that describes the role of the processor. For example, "Central Processor" or "Math Processor". This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978) and it is always set to "Virtual Processor".
...
Strings that describe the various **OperationalStatus** array values. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898) and it is always set to "OK".
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Processor**](cim-processor.md).**Family**")
</dt> </dl>

The revision level of the processor within the processor family of the underlying physical processor. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978).
...
The creation class name of the scoping system. This property is inherited from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) and it is set to "Msvm\_ComputerSystem".
...
A globally unique identifier for the processor. This identifier can only be unique within a processor family. This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978) and it is always set to **NULL**.
...
The CPU socket information, which includes data on how to upgrade the processor (if upgrades are supported). This property is inherited from [**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978) and it is always set to 6 (None).

</dd> </dl>

## Remarks

Access to the **Msvm\_Processor** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://msdn.microsoft.com/library/aa826699).
...
[**CIM\_Processor**](https://msdn.microsoft.com/library/aa387978)
</dt> <dt>
