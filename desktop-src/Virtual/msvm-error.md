...
The operation cannot be carried out on this class since it has instances.
...
There are instances of this class.
...
The destination for the asynchronous response is not valid.
...
There was a timeout due to an invalid operation.
...
The pull operation was abandoned.
...
The Web-Based Enterprise Management (WBEM) server limits have been exceeded (such as memory or connections).
...
Qualifiers: [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("DSP0201.DMTF\|ERROR.DESCRIPTION\|2.2"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Error**](cim-error.md).**CIMStatusCode**")
</dt> </dl>

A free-form string containing a user-readable description of the **CIMStatusCode** property. This description may extend, but must be consistent with, the definition of **CIMStatusCode**. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Error**](cim-error.md).**ErrorSourceFormat**")
</dt> </dl>
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Error**](cim-error.md).**ErrorSource**", "**CIM\_Error**.**OtherErrorSourceFormat**")
</dt> </dl>

The format of the **ErrorSource** property is interpretable based on the value of this property. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938) and is set to 0.
...
Primary classification of the error. The following values are defined. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).
...
An error associated with the communication between endpoints.
...
An error caused by a failure that results in reduced functionality or performance.
...
An error caused by a software or processing fault.
...
An error caused by an equipment or hardware failure.
...
An error related to facility, or other environmental considerations.
...
An error caused by security violations, detection of viruses, and similar issues.
...
An error caused by a failure to allocate sufficient resources to complete the operation.
...
An error caused by a failure to access a required resource.
...
An error caused by an unsupported request.
...
An array containing the dynamic content of the message. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).
...
An opaque string that uniquely identifies, within the scope of the **OwningEntity**, the format of the message. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Error**](cim-error.md).**ErrorType**")
</dt> </dl>

A free-form string that describes the **ErrorType** when 1, (Other), is specified as the **ErrorType**. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).
...
Qualifiers: [**Required**](https://msdn.microsoft.com/library/aa393650), [**MappingStrings**](https://msdn.microsoft.com/library/aa393650) ("Recommendation.ITU\|X733.Probable cause", "Recommendation.ITU\|M3100.probableCause", "ITU-IANA-ALARM-TC"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Error**](cim-error.md).**ProbableCauseDescription**")
</dt> </dl>

An enumerated value that describes the probable cause of the error. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).
...
<span id="Material_Supply_Exhausted"></span><span id="material_supply_exhausted"></span><span id="MATERIAL_SUPPLY_EXHAUSTED"></span>**Material Supply Exhausted** (31)
...
<span id="Login_Attempts_Failed"></span><span id="login_attempts_failed"></span><span id="LOGIN_ATTEMPTS_FAILED"></span>**Login Attempts Failed** (60)
...
<span id="Battery_Discharging"></span><span id="battery_discharging"></span><span id="BATTERY_DISCHARGING"></span>**Battery Discharging** (91)
...
<span id="Protecting_Resource_Failure"></span><span id="protecting_resource_failure"></span><span id="PROTECTING_RESOURCE_FAILURE"></span>**Protecting Resource Failure** (115)
...
<span id="Unexpected_Information"></span><span id="unexpected_information"></span><span id="UNEXPECTED_INFORMATION"></span>**Unexpected Information** (130)
...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**CIM\_Error**](cim-error.md).**ProbableCause**")
</dt> </dl>

A free-form string that describes the probable cause of the error. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).
...
A free-form string that describes recommended actions to take to resolve the error. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/mt445938).

</dd> </dl>

## Remarks

Access to the **Msvm\_Error** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://msdn.microsoft.com/library/aa826699).
...
[**CIM\_Error**](https://msdn.microsoft.com/library/mt445938)
</dt> <dt>
