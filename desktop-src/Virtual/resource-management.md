...
-   Shared Resource: Represents the resources of the host that are, or are capable of being shared among multiple virtual systems. [**Msvm\_Processor**](msvm-processor.md) is an example of a shared resource.
