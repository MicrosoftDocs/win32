...
description: Manages the virtual media (.vhd, .iso, or .vfd files) for a virtual machine.
ms.assetid: 'cef90f58-5d59-474d-ae4a-d0bd76f0b17e'
keywords: ["Msvm_ImageManagementService class Hyper-V", "Msvm_ImageManagementService class Hyper-V , described"]
topic_type:
- apiref
api_name:
...
| Method                                                                                                     | Description                                                                                                                                                                                                                                                                                                |
|:-----------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CompactVirtualHardDisk**](compactvirtualharddisk-msvm-imagemanagementservice.md)                       | Compacts a dynamic virtual hard disk file. Compacting is the process of unallocating unused portions of the virtual hard disk.<br/>                                                                                                                                                                  |
| [**ConvertVirtualHardDisk**](convertvirtualharddisk-msvm-imagemanagementservice.md)                       | Converts the type of an existing virtual hard disk.<br/>                                                                                                                                                                                                                                             |
| [**CreateDifferencingVirtualHardDisk**](createdifferencingvirtualharddisk-msvm-imagemanagementservice.md) | Creates a differencing .vhd file.<br/>                                                                                                                                                                                                                                                               |
| [**CreateDynamicVirtualHardDisk**](createdynamicvirtualharddisk-msvm-imagemanagementservice.md)           | Creates a dynamically expanding virtual hard disk (.vhd) file.<br/>                                                                                                                                                                                                                                  |
| [**CreateFixedVirtualHardDisk**](createfixedvirtualharddisk-msvm-imagemanagementservice.md)               | Creates a fixed-sized .vhd file.<br/>                                                                                                                                                                                                                                                                |
| [**CreateVirtualFloppyDisk**](createvirtualfloppydisk-msvm-imagemanagementservice.md)                     | Creates a virtual floppy disk (.vfd) file.<br/>                                                                                                                                                                                                                                                      |
| [**ExpandVirtualHardDisk**](expandvirtualharddisk-msvm-imagemanagementservice.md)                         | Expands an existing virtual hard disk (.vhd) file. If the disk image is already attached to the virtual machine, it will send notifications to the running virtual machine about disk expansion.<br/>                                                                                                |
| [**GetVirtualHardDiskInfo**](getvirtualharddiskinfo-msvm-imagemanagementservice.md)                       | Retrieves information about the virtual hard disk files.<br/>                                                                                                                                                                                                                                        |
| [**MergeVirtualHardDisk**](mergevirtualharddisk-msvm-imagemanagementservice.md)                           | Merges a differencing virtual hard disk file with its parents. This function will also update any local virtual machines which depend on the files being merged. If the user executing this function does not have permission to update the all virtual machines, then this function will fail.<br/> |
| [**Mount**](mount-msvm-imagemanagementservice.md)                                                         | Mounts a virtual disk image file in loopback mode.<br/>                                                                                                                                                                                                                                              |
| [**ReconnectParentVirtualHardDisk**](reconnectparentvirtualharddisk-msvm-imagemanagementservice.md)       | Fixes broken links between parent and child disk image files.<br/>                                                                                                                                                                                                                                   |
| [**RequestStateChange**](virtual-cim_service_requeststatechange)                                           | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                             |
| [**StartService**](msvm-imagemanagementservice-startservice.md)                                           | Starts the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                                                                                                                               |
| [**StopService**](msvm-imagemanagementservice-stopservice.md)                                             | Stops the service.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>                                                                                                                                                                                                |
| [**Unmount**](unmount-msvm-imagemanagementservice.md)                                                     | Unmounts an existing virtual disk image file in loopback mode. Use the [**Unmount**](msvm-mountedstorageimage-unmount.md) method of the [**Msvm\_MountedStorageImage**](msvm-mountedstorageimage.md) class instead.<br/>                                                                           |
