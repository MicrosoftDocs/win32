...
ms.assetid: 'd39e5597-e304-4425-be8b-64a57c93f159'
keywords: ["CIM_ProtocolController class Hyper-V", "CIM_ProtocolController class Hyper-V , described"]
topic_type:
- apiref
api_name:
...
- CIM_ProtocolController.LocationIndicator
...
| Method                                                                      | Description                                                                                                                                                                                                                                                                                                                                             |
|:----------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](virtual-cim_protocolcontroller_enabledevice)             | **Deprecated description:** Enables or disables the logical device.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](virtual-cim_protocolcontroller_onlinedevice)             | **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](virtual-cim_protocolcontroller_quiescedevice)           | **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is deprecated. Instead we recommend that you use the **RequestStateChange** method.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](virtual-cim_protocolcontroller_requeststatechange) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                          |
| [**Reset**](virtual-cim_protocolcontroller_reset)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                         |
| [**RestoreProperties**](virtual-cim_protocolcontroller_restoreproperties)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                 |
| [**SaveProperties**](virtual-cim_protocolcontroller_saveproperties)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                           |
| [**SetPowerState**](virtual-cim_protocolcontroller_setpowerstate)           | **Deprecated description:** Sets the power state of the logical device.<br/> Instead we recommend that you use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                  |
