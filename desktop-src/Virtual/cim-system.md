...
ms.assetid: 'bc022ff9-7346-494d-b4bb-41e1299c403b'
keywords: ["CIM_System class Hyper-V", "CIM_System class Hyper-V , described"]
topic_type:
- apiref
api_name:
- CIM_System
...
| Method                                                          | Description                                                                                                                                                                                              |
|:----------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](virtual-cim_system_requeststatechange) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md) class.<br/> |
