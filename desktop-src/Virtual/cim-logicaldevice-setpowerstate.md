...
ms.assetid: '4daa0aba-e1f7-452f-82a3-856a7b3a3051'
keywords: ["SetPowerState method Hyper-V", "SetPowerState method Hyper-V , CIM_LogicalDevice class", "CIM_LogicalDevice class Hyper-V , SetPowerState method"]
topic_type:
- apiref
api_name:
