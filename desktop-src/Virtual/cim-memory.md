...
The maximum number of blocks, that are available for use when layering [**CIM\_StorageExtent**](cim-storageextent.md) using the [**CIM\_BasedOn**](https://www.bing.com/search?q=**CIM\_BasedOn**) class association. This property only has meaning when the storage extent is referenced in the **Antecedent** property in a **CIM\_BasedOn** object.
