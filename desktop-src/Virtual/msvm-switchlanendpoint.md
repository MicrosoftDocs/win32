...
- Msvm_SwitchLANEndpoint.RequestStateChange
- Msvm_SwitchLANEndpoint.BroadcastReset
- Msvm_SwitchLANEndpoint.Caption
- Msvm_SwitchLANEndpoint.ElementName
- Msvm_SwitchLANEndpoint.InstallDate
- Msvm_SwitchLANEndpoint.Status
- Msvm_SwitchLANEndpoint.HealthState
- Msvm_SwitchLANEndpoint.OtherEnabledState
- Msvm_SwitchLANEndpoint.RequestedState
- Msvm_SwitchLANEndpoint.SystemCreationClassName
- Msvm_SwitchLANEndpoint.SystemName
- Msvm_SwitchLANEndpoint.CreationClassName
- Msvm_SwitchLANEndpoint.Description
- Msvm_SwitchLANEndpoint.OperationalStatus
- Msvm_SwitchLANEndpoint.EnabledState
- Msvm_SwitchLANEndpoint.TimeOfLastStateChange
- Msvm_SwitchLANEndpoint.Name
- Msvm_SwitchLANEndpoint.NameFormat
- Msvm_SwitchLANEndpoint.ProtocolType
- Msvm_SwitchLANEndpoint.OtherTypeDescription
- Msvm_SwitchLANEndpoint.BroadcastResetSupported
- Msvm_SwitchLANEndpoint.LANID
- Msvm_SwitchLANEndpoint.LANType
- Msvm_SwitchLANEndpoint.OtherLANType
- Msvm_SwitchLANEndpoint.MACAddress
- Msvm_SwitchLANEndpoint.AliasAddresses
- Msvm_SwitchLANEndpoint.GroupAddresses
- Msvm_SwitchLANEndpoint.MaxDataSize
- Msvm_SwitchLANEndpoint.ProtocolIFType
- Msvm_SwitchLANEndpoint.StatusDescriptions
- Msvm_SwitchLANEndpoint.EnabledDefault
- Msvm_SwitchLANEndpoint.Connected
api_location:
- Root\Virtualization
api_type:
- Schema
...
The **Msvm\_SwitchLANEndpoint** class has these types of members:
...
The **Msvm\_SwitchLANEndpoint** class has these methods.
...
The **Msvm\_SwitchLANEndpoint** class has these properties.
...
Other unicast addresses that may be used to communicate with the LANEndpoint. This property is inherited from [**CIM\_LANEndpoint**](https://msdn.microsoft.com/library/cc136865) and is not used.
...
The name of the class or the subclass used in the creation of an instance. This property is inherited from [**CIM\_ServiceAccessPoint**](https://msdn.microsoft.com/library/aa388447) and is always set to "Msvm\_SwitchLANEndpoint".
...
The multicast addresses to which the LANEndpoint listens. This property is inherited from [**CIM\_LANEndpoint**](https://msdn.microsoft.com/library/cc136865) and is not used.
...
An indication of the kind of technology used on the LAN. This property is inherited from [**CIM\_LANEndpoint**](https://msdn.microsoft.com/library/cc136865) and is not used.
...
The principal unicast address used in communication with the LANEndpoint. This property is inherited from [**CIM\_LANEndpoint**](https://msdn.microsoft.com/library/cc136865).
...
Limited to Layer 2-related and reserved values for this subclass of [**CIM\_ProtocolEndpoint**](https://msdn.microsoft.com/library/mt432264). This property is inherited from **CIM\_ProtocolEndpoint**.
...
Access to the **Msvm\_SwitchLANEndpoint** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://msdn.microsoft.com/library/aa826699).
