...
Retrieves the thumbnail image of an existing virtual system.
...
A reference to the [**CIM\_VirtualSystemSettingData**](https://msdn.microsoft.com/library/cc136954) instance whose thumbnail image is to be retrieved. This instance may represent either the current instantiation of the virtual computer system, or an instance of a virtual computer system snapshot.
...
This method returns values in raw RGB 565 format.
...
The following C# sample retrieves the thumbnail image of a virtual system. The referenced utilities can be found in [Common Utilities for the Virtualization Samples](common-utilities-for-the-virtualization-samples.md).
...
{
    class GetVirtualSystemThumbnailImageClass
    {
        ...
        static void GetVirtualSystemThumbnailImage(string vmName)
        {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Usage: GetVirtualSystemThumbnailImage vmName");
                return;
            }
            GetVirtualSystemThumbnailImage(args[0]);
        }
    }
}
```
...
The following VBScript sample retrieves the thumbnail image of a virtual system.
