...
ms.assetid: 'ff4f3bc1-12c6-4abb-afa3-033d97fb8f02'
keywords: ["CIM_Controller class Hyper-V", "CIM_Controller class Hyper-V , described"]
topic_type:
- apiref
api_name:
- CIM_Controller
...
- CIM_Controller.LocationIndicator
...
| Method                                                              | Description                                                                                                                                                                                                                                                                                                                                                                     |
|:--------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](virtual-cim_controller_enabledevice)             | This method is deprecated. Instead, use the [**RequestStateChange**](virtual-cim_controller_requeststatechange) method.<br/> **Deprecated description:** Enables or disables the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                     |
| [**OnlineDevice**](virtual-cim_controller_onlinedevice)             | This method is deprecated. Instead, use the [**RequestStateChange**](virtual-cim_controller_requeststatechange) method.<br/> **Deprecated description:** Brings the logical device online so it can accept requests, or offline so it can no longer accept requests.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/> |
| [**QuiesceDevice**](virtual-cim_controller_quiescedevice)           | This method is deprecated. Instead, use the [**RequestStateChange**](virtual-cim_controller_requeststatechange) method.<br/> **Deprecated description:** Temporarily suspends activity on the logical device, or re-enables the activity.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                            |
| [**RequestStateChange**](virtual-cim_controller_requeststatechange) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                                  |
| [**Reset**](virtual-cim_controller_reset)                           | Resets the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                                                 |
| [**RestoreProperties**](virtual-cim_controller_restoreproperties)   | Restores a previous configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                         |
| [**SaveProperties**](virtual-cim_controller_saveproperties)         | Saves the configuration and state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                                                                                                                                                                   |
| [**SetPowerState**](virtual-cim_controller_setpowerstate)           | This method is deprecated. Instead, use the **SetPowerState** property of the **CIM\_PowerManagementService** class.<br/> **Deprecated description:** Sets the power state of the logical device.<br/> This method is inherited from [**CIM\_LogicalDevice**](cim-logicaldevice.md).<br/>                                                                    |
