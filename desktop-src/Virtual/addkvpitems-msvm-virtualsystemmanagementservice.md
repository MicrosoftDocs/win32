...
keywords:
- AddKvpItems method Hyper-V
- AddKvpItems method Hyper-V , Msvm_VirtualSystemManagementService class
- Msvm_VirtualSystemManagementService class Hyper-V , AddKvpItems method
topic_type:
- apiref
api_name:
