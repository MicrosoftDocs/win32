...
keywords: ["AddKvpItems method Hyper-V", "AddKvpItems method Hyper-V , Msvm_VirtualSystemManagementService class", "Msvm_VirtualSystemManagementService class Hyper-V , AddKvpItems method"]
topic_type:
- apiref
api_name:
...
An optional parameter for monitoring progress of the operation represented by an instance of the [**CIM\_ConcreteJob**](https://msdn.microsoft.com/library/cc136808) class, which is used if the method could not be executed synchronously. If the operation is executing asynchronously, the return value is 4096.
...
The following C# sample adds key-value pairs to a virtual system. The referenced utilities can be found in [Common Utilities for the Virtualization Samples](common-utilities-for-the-virtualization-samples.md).
