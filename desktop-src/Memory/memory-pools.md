...
The handles for [kernel objects](https://msdn.microsoft.com/windows/desktop/3e3288dd-155a-41d0-9d43-5f49ed4c4a9d) are stored in the paged pool, so the number of handles you can create is based on available memory.
