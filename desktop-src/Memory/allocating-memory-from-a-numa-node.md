...
The following sample code demonstrates the use of the NUMA functions [**GetNumaHighestNodeNumber**](base.getnumahighestnodenumber), [**GetNumaProcessorNode**](base.getnumaprocessornode), and [**VirtualAllocExNuma**](virtualallocexnuma.md). It also demonstrates the use of the [**QueryWorkingSetEx**](base.queryworkingsetex) function to retrieve the NUMA node on which pages are allocated.
...
[NUMA Support](base.numa_support)
</dt> </dl>
