...
| [**CopyMemory**](/windows/desktop/api/WinBase/)                                                 | Copies a block of memory from one location to another.                                                                                                 |
| [**CreateMemoryResourceNotification**](https://www.bing.com/search?q=**CreateMemoryResourceNotification**)     | Creates a memory resource notification object.                                                                                                         |
| [**FillMemory**](https://www.bing.com/search?q=**FillMemory**)                                                 | Fills a block of memory with a specified value.                                                                                                        |
| [**GetLargePageMinimum**](https://www.bing.com/search?q=**GetLargePageMinimum**)                               | Retrieves the minimum size of a large page.                                                                                                            |
| [**GetPhysicallyInstalledSystemMemory**](/windows/desktop/api/WinBase/) | Retrieves the amount of RAM that is physically installed on the computer.                                                                              |
| [**GetSystemFileCacheSize**](https://www.bing.com/search?q=**GetSystemFileCacheSize**)                         | Retrieves the current size limits for the working set of the system cache.                                                                             |
| [**GetWriteWatch**](https://www.bing.com/search?q=**GetWriteWatch**)                                           | Retrieves the addresses of the pages that have been written to in a region of virtual memory.                                                          |
| [**GlobalMemoryStatusEx**](/windows/desktop/api/WinBase/)                             | Obtains information about the system's current usage of both physical and virtual memory.                                                              |
| [**MoveMemory**](/windows/desktop/api/WinBase/nf-srbhelper-srbmovememory)                                                 | Moves a block of memory from one location to another.                                                                                                  |
| [**QueryMemoryResourceNotification**](https://www.bing.com/search?q=**QueryMemoryResourceNotification**)       | Retrieves the state of the specified memory resource object.                                                                                           |
...
| [**ResetWriteWatch**](https://www.bing.com/search?q=**ResetWriteWatch**)                                       | Resets the write-tracking state for a region of virtual memory.                                                                                        |
...
| [**SecureZeroMemory**](/windows/desktop/api/WinBase/)                                     | Fills a block of memory with zeros.                                                                                                                    |
| [**SetSystemFileCacheSize**](https://www.bing.com/search?q=**SetSystemFileCacheSize**)                         | Limits the size of the working set for the file system cache.                                                                                          |
| [**ZeroMemory**](/windows/desktop/api/WinBase/nf-minitape-rtlzeromemory)                                                 | Fills a block of memory with zeros.                                                                                                                    |
...
| [**FlushViewOfFile**](https://www.bing.com/search?q=**FlushViewOfFile**)                   | Writes to the disk a byte range within a mapped view of a file.                                                                                                                    |
| [**GetMappedFileName**](https://www.bing.com/search?q=**GetMappedFileName**)              | Checks whether the specified address is within a memory-mapped file in the address space of the specified process. If so, the function returns the name of the memory-mapped file. |
| [**MapViewOfFile**](https://www.bing.com/search?q=**MapViewOfFile**)                       | Maps a view of a file mapping into the address space of a calling process.                                                                                                         |
| [**MapViewOfFile2**](https://www.bing.com/search?q=**MapViewOfFile2**)                     | Maps a view of a file or a pagefile-backed section into the address space of the specified process.                                                                                |
| [**MapViewOfFileEx**](https://www.bing.com/search?q=**MapViewOfFileEx**)                   | Maps a view of a file mapping into the address space of a calling process. A caller can optionally specify a suggested memory address for the view.                                |
...
| [**MapViewOfFileNuma2**](https://www.bing.com/search?q=**MapViewOfFileNuma2**)             | Maps a view of a file or a pagefile-backed section into the address space of the specified process.                                                                                |
| [**OpenFileMapping**](/windows/desktop/api/WinBase/nf-winbase-openfilemappinga)                   | Opens a named file mapping object.                                                                                                                                                 |
| [**UnmapViewOfFile**](https://www.bing.com/search?q=**UnmapViewOfFile**)                   | Unmaps a mapped view of a file from the calling process's address space.                                                                                                           |
| [**UnmapViewOfFile2**](https://www.bing.com/search?q=**UnmapViewOfFile2**)                 | Unmaps a previously mapped view of a file or a pagefile-backed section.                                                                                                            |
...
| Function                                                           | Description                                                                                                           |
|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| [**AllocateUserPhysicalPages**](https://www.bing.com/search?q=**AllocateUserPhysicalPages**)     | Allocates physical memory pages to be mapped and unmapped within any AWE region of the process.                       |
| [**FreeUserPhysicalPages**](https://www.bing.com/search?q=**FreeUserPhysicalPages**)             | Frees physical memory pages previously allocated with [**AllocateUserPhysicalPages**](https://www.bing.com/search?q=**AllocateUserPhysicalPages**). |
| [**MapUserPhysicalPages**](https://www.bing.com/search?q=**MapUserPhysicalPages**)               | Maps previously allocated physical memory pages at the specified address within an AWE region.                        |
...
| Function                                                               | Description                                                                                                                                                                               |
|------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**DiscardVirtualMemory**](https://www.bing.com/search?q=**DiscardVirtualMemory**)                   | Discards the memory contents of a range of memory pages, without decommitting the memory. The contents of discarded memory is undefined and must be rewritten by the application.         |
| [**OfferVirtualMemory**](https://www.bing.com/search?q=**OfferVirtualMemory**)                       | Indicates that the data contained in a range of memory pages is no longer needed by the application and can be discarded by the system if necessary.                                      |
| [**PrefetchVirtualMemory**](https://www.bing.com/search?q=**PrefetchVirtualMemory**)                 | Prefetches virtual address ranges into physical memory.                                                                                                                                   |
...
| [**ReclaimVirtualMemory**](https://www.bing.com/search?q=**ReclaimVirtualMemory**)                   | Reclaims a range of memory pages that were offered to the system with [**OfferVirtualMemory**](https://www.bing.com/search?q=**OfferVirtualMemory**).                                                                   |
| [**VirtualAlloc**](https://www.bing.com/search?q=**VirtualAlloc**)                                   | Reserves or commits a region of pages in the virtual address space of the calling process.                                                                                                |
| [**VirtualAllocEx**](https://www.bing.com/search?q=**VirtualAllocEx**)                               | Reserves or commits a region of pages in the virtual address space of the specified process.                                                                                              |
| [**VirtualAllocExNuma**](https://www.bing.com/search?q=**VirtualAllocExNuma**)                       | Reserves or commits a region of memory within the virtual address space of the specified process, and specifies the NUMA node for the physical memory.                                    |
...
| [**VirtualFree**](https://www.bing.com/search?q=**VirtualFree**)                                     | Releases or decommits a region of pages within the virtual address space of the calling process.                                                                                          |
| [**VirtualFreeEx**](https://www.bing.com/search?q=**VirtualFreeEx**)                                 | Releases or decommits a region of memory within the virtual address space of a specified process.                                                                                         |
| [**VirtualLock**](https://www.bing.com/search?q=**VirtualLock**)                                     | Locks the specified region of the process's virtual address space into physical memory.                                                                                                   |
| [**VirtualProtect**](https://www.bing.com/search?q=**VirtualProtect**)                               | Changes the access protection on a region of committed pages in the virtual address space of the calling process.                                                                         |
| [**VirtualProtectEx**](https://www.bing.com/search?q=**VirtualProtectEx**)                           | Changes the access protection on a region of committed pages in the virtual address space of the calling process.                                                                         |
...
| [**VirtualQuery**](https://www.bing.com/search?q=**VirtualQuery**)                                   | Provides information about a range of pages in the virtual address space of the calling process.                                                                                          |
| [**VirtualQueryEx**](https://www.bing.com/search?q=**VirtualQueryEx**)                               | Provides information about a range of pages in the virtual address space of the calling process.                                                                                          |
| [**VirtualUnlock**](https://www.bing.com/search?q=**VirtualUnlock**)                                 | Unlocks a specified range of pages in the virtual address space of a process.                                                                                                             |
...
| [**GlobalDiscard**](/windows/desktop/api/WinBase/nf-winbase-globaldiscard), [**LocalDiscard**](https://www.bing.com/search?q=**LocalDiscard**) | Discards the specified global memory block.                                                                                                                              | Not applicable.                                                                |
...
| Function                                                                         | Description                                                                                                                                                                                        |
|----------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [*BadMemoryCallbackRoutine*](/windows/desktop/api/WinBase/)                       | An application-defined function registered with the [**RegisterBadMemoryNotification**](https://www.bing.com/search?q=**RegisterBadMemoryNotification**) function that is called when one or more bad memory pages are detected. |
| [**GetMemoryErrorHandlingCapabilities**](https://www.bing.com/search?q=**GetMemoryErrorHandlingCapabilities**) | Gets the memory error handling capabilities of the system.                                                                                                                                         |
| [**RegisterBadMemoryNotification**](https://www.bing.com/search?q=**RegisterBadMemoryNotification**)           | Registers a bad memory notification that is called when one or more bad memory pages are detected.                                                                                                 |
| [**UnregisterBadMemoryNotification**](https://www.bing.com/search?q=**UnregisterBadMemoryNotification**)       | Closes the specified bad memory notification handle.                                                                                                                                               |
...
The following function can return incorrect information and should not be used. Use the [**GlobalMemoryStatusEx**](/windows/desktop/api/WinBase/) function instead:
