...
The handle of the heap where the memory was allocated. This is the heap handle an app passed to the [**AllocateHeap**](security.allocateheap) function when the memory was allocated.
