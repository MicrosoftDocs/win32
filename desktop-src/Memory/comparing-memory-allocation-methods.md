...
-   [**CoTaskMemAlloc**](https://www.bing.com/search?q=**CoTaskMemAlloc**)
...
-   **malloc**
-   **new**
-   [**VirtualAlloc**](https://www.bing.com/search?q=**VirtualAlloc**)
...
The [**VirtualAlloc**](https://www.bing.com/search?q=**VirtualAlloc**) function allows you to specify additional options for memory allocation. However, its allocations use a page granularity, so using **VirtualAlloc** can result in higher memory usage.
...
The [**CoTaskMemAlloc**](https://www.bing.com/search?q=**CoTaskMemAlloc**) function has the advantage of working well in either C, C++, or Visual Basic. It is also the only way to share memory in a COM-based application, since MIDL uses **CoTaskMemAlloc** and [**CoTaskMemFree**](https://www.bing.com/search?q=**CoTaskMemFree**) to marshal memory.
