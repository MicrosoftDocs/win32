...
<tbody>
<tr class="odd">
<td>[<strong>_TrackMouseEvent</strong>](https://msdn.microsoft.com/en-us/library/ms646266(v=VS.85).aspx)<br/></td>
<td>Posts messages when the mouse pointer leaves a window or hovers over a window for a specified amount of time. This function calls [<strong>TrackMouseEvent</strong>](https://msdn.microsoft.com/en-us/library/ms646265(v=VS.85).aspx) if it exists, otherwise it emulates it.<br/></td>
</tr>
<tr class="even">
<td>[<strong>DragDetect</strong>](https://msdn.microsoft.com/en-us/library/ms646256(v=VS.85).aspx)<br/></td>
...
<tr class="odd">
<td>[<strong>GetCapture</strong>](https://msdn.microsoft.com/en-us/library/ms646257(v=VS.85).aspx)<br/></td>
...
<tr class="even">
<td>[<strong>GetDoubleClickTime</strong>](https://msdn.microsoft.com/en-us/library/ms646258(v=VS.85).aspx)<br/></td>
...
<tr class="odd">
<td>[<strong>GetMouseMovePointsEx</strong>](https://msdn.microsoft.com/en-us/library/ms646259(v=VS.85).aspx)<br/></td>
<td>Retrieves a history of up to 64 previous coordinates of the mouse or pen.<br/></td>
</tr>
<tr class="even">
<td>[<strong>mouse_event</strong>](https://msdn.microsoft.com/en-us/library/ms646260(v=VS.85).aspx)<br/></td>
<td>The [<strong>mouse_event</strong>](https://msdn.microsoft.com/en-us/library/ms646260(v=VS.85).aspx) function synthesizes mouse motion and button clicks.<br/>
<blockquote>
[!Note]<br />
This function has been superseded. Use [<strong>SendInput</strong>](https://msdn.microsoft.com/en-us/library/ms646310(v=VS.85).aspx) instead.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
<td>[<strong>ReleaseCapture</strong>](https://msdn.microsoft.com/en-us/library/ms646261(v=VS.85).aspx)<br/></td>
...
<tr class="even">
<td>[<strong>SetCapture</strong>](https://msdn.microsoft.com/en-us/library/ms646262(v=VS.85).aspx)<br/></td>
<td>Sets the mouse capture to the specified window belonging to the current thread.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>SetDoubleClickTime</strong>](https://msdn.microsoft.com/en-us/library/ms646263(v=VS.85).aspx)<br/></td>
...
<tr class="even">
<td>[<strong>SwapMouseButton</strong>](https://msdn.microsoft.com/en-us/library/ms646264(v=VS.85).aspx)<br/></td>
<td>Reverses or restores the meaning of the left and right mouse buttons. <br/></td>
</tr>
<tr class="odd">
<td>[<strong>TrackMouseEvent</strong>](https://msdn.microsoft.com/en-us/library/ms646265(v=VS.85).aspx)<br/></td>
<td>Posts messages when the mouse pointer leaves a window or hovers over a window for a specified amount of time.<br/>
<blockquote>
[!Note]<br />
The [<strong>_TrackMouseEvent</strong>](https://msdn.microsoft.com/en-us/library/ms646266(v=VS.85).aspx) function calls [<strong>TrackMouseEvent</strong>](https://msdn.microsoft.com/en-us/library/ms646265(v=VS.85).aspx) if it exists, otherwise <strong>_TrackMouseEvent</strong> emulates <strong>TrackMouseEvent</strong>.
</blockquote>
<br/></td>
</tr>
</tbody>
