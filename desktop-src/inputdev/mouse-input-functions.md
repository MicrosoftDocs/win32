...
<tbody>
<tr class="odd">
<td>[<strong>_TrackMouseEvent</strong>](-trackmouseevent.md)<br/></td>
<td>Posts messages when the mouse pointer leaves a window or hovers over a window for a specified amount of time. This function calls [<strong>TrackMouseEvent</strong>](trackmouseevent.md) if it exists, otherwise it emulates it.<br/></td>
</tr>
<tr class="even">
<td>[<strong>DragDetect</strong>](dragdetect.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetCapture</strong>](getcapture.md)<br/></td>
...
<tr class="even">
<td>[<strong>GetDoubleClickTime</strong>](getdoubleclicktime.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetMouseMovePointsEx</strong>](getmousemovepointsex.md)<br/></td>
<td>Retrieves a history of up to 64 previous coordinates of the mouse or pen.<br/></td>
</tr>
<tr class="even">
<td>[<strong>mouse_event</strong>](mouse-event.md)<br/></td>
<td>The [<strong>mouse_event</strong>](mouse-event.md) function synthesizes mouse motion and button clicks.<br/>
<blockquote>
[!Note]<br />
This function has been superseded. Use [<strong>SendInput</strong>](sendinput.md) instead.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
<td>[<strong>ReleaseCapture</strong>](releasecapture.md)<br/></td>
...
<tr class="even">
<td>[<strong>SetCapture</strong>](setcapture.md)<br/></td>
<td>Sets the mouse capture to the specified window belonging to the current thread.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>SetDoubleClickTime</strong>](setdoubleclicktime.md)<br/></td>
...
<tr class="even">
<td>[<strong>SwapMouseButton</strong>](swapmousebutton.md)<br/></td>
<td>Reverses or restores the meaning of the left and right mouse buttons. <br/></td>
</tr>
<tr class="odd">
<td>[<strong>TrackMouseEvent</strong>](trackmouseevent.md)<br/></td>
<td>Posts messages when the mouse pointer leaves a window or hovers over a window for a specified amount of time.<br/>
<blockquote>
[!Note]<br />
The [<strong>_TrackMouseEvent</strong>](-trackmouseevent.md) function calls [<strong>TrackMouseEvent</strong>](trackmouseevent.md) if it exists, otherwise <strong>_TrackMouseEvent</strong> emulates <strong>TrackMouseEvent</strong>.
</blockquote>
<br/></td>
</tr>
</tbody>
