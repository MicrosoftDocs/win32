...
The return value of the [**DefWindowProc**](https://msdn.microsoft.com/library/windows/desktop/ms633572) function is one of the following values, indicating the position of the cursor hot spot.
...
| <dl> <dt>**HTERROR**</dt> <dt>-2</dt> </dl>       | On the screen background or on a dividing line between windows (same as **HTNOWHERE**, except that the [**DefWindowProc**](https://msdn.microsoft.com/library/windows/desktop/ms633572) function produces a system beep to indicate an error).<br/> |
