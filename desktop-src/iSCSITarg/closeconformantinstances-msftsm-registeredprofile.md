...
keywords: ["CloseConformantInstances method iSCSI Software Target API", "CloseConformantInstances method iSCSI Software Target API , MSFTSM_RegisteredProfile class", "MSFTSM_RegisteredProfile class iSCSI Software Target API , CloseConformantInstances method"]
topic_type:
- apiref
api_name:
