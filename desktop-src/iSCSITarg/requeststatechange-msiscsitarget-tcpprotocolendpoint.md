---
title: RequestStateChange method of the MSISCSITARGET\_TCPProtocolEndpoint class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '3b830fe9-2e7b-49e6-91b8-fceffec18b48'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSISCSITARGET_TCPProtocolEndpoint class", "MSISCSITARGET_TCPProtocolEndpoint class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_TCPProtocolEndpoint.RequestStateChange
api_location:
...
# RequestStateChange method of the MSISCSITARGET\_TCPProtocolEndpoint class
