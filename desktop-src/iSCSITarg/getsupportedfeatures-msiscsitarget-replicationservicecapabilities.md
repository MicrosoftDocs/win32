---
title: GetSupportedFeatures method of the MSISCSITARGET\_ReplicationServiceCapabilities class
description: Retrieves the supported features for a specified replication type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '4620b4d1-c48d-4c81-bb4b-69135f2e8ab0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetSupportedFeatures method iSCSI Software Target API", "GetSupportedFeatures method iSCSI Software Target API , MSISCSITARGET_ReplicationServiceCapabilities class", "MSISCSITARGET_ReplicationServiceCapabilities class iSCSI Software Target API , GetSupportedFeatures method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_ReplicationServiceCapabilities.GetSupportedFeatures
api_location:
...
# GetSupportedFeatures method of the MSISCSITARGET\_ReplicationServiceCapabilities class
...
<span id="Multihop_requires_advance_notice"></span><span id="multihop_requires_advance_notice"></span><span id="MULTIHOP_REQUIRES_ADVANCE_NOTICE"></span>
