---
title: GetSupportedListOperations method of the MSISCSITARGET\_ReplicationServiceCapabilities class
description: Retrieves a list of supported operations that can be performed by using the ModifyListSynchronization method on a specified replication type and association type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'bd0a8c2e-9216-4088-8a2f-3f0ba17a3701'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetSupportedListOperations method iSCSI Software Target API", "GetSupportedListOperations method iSCSI Software Target API , MSISCSITARGET_ReplicationServiceCapabilities class", "MSISCSITARGET_ReplicationServiceCapabilities class iSCSI Software Target API , GetSupportedListOperations method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_ReplicationServiceCapabilities.GetSupportedListOperations
api_location:
...
# GetSupportedListOperations method of the MSISCSITARGET\_ReplicationServiceCapabilities class

Retrieves a list of supported operations that can be performed by using the [**ModifyListSynchronization**](modifylistsynchronization-msiscsitarget-replicationservice.md) method on a specified replication type and association type.
...
uint32 GetSupportedListOperations(
  ...
  [in, optional] uint16 SynchronizationType,
...
*SynchronizationType* \[in, optional\]
</dt> <dd>

Specifies the requested association type. If **NULL**, the [**MSISCSITARGET\_StorageSynchronized**](msiscsitarget-storagesynchronized.md) class is assumed.
...
On return, contains a list of the supported group operations.
...
Activates consistency if not already enabled. If consistency is already enabled, this operation has no effect.
...
Same as **Fracture**; however, steps are taken to ensure the target elements are consistent. For example, stops changes to the source elements, waits for copy operations between source and target elements to stop, and then splits the source and target groups or elements.
...
[**ModifyListSynchronization**](modifylistsynchronization-msiscsitarget-replicationservice.md)
</dt> </dl>
