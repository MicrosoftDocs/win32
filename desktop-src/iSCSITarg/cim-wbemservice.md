---
title: CIM\_WBEMService class
description: An abstract class for WBEM services such as the ObjectManager (CIM Server), Providers, protocol adapters, or other pluggable components.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '3997fa21-cc5b-4878-8159-fad8c869146c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_WBEMService class iSCSI Software Target API", "CIM_WBEMService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_WBEMService
- CIM_WBEMService.Caption
- CIM_WBEMService.Description
- CIM_WBEMService.ElementName
- CIM_WBEMService.InstallDate
- CIM_WBEMService.OperationalStatus
- CIM_WBEMService.StatusDescriptions
- CIM_WBEMService.Status
- CIM_WBEMService.HealthState
- CIM_WBEMService.EnabledState
- CIM_WBEMService.OtherEnabledState
- CIM_WBEMService.RequestedState
- CIM_WBEMService.EnabledDefault
- CIM_WBEMService.TimeOfLastStateChange
- CIM_WBEMService.SystemCreationClassName
- CIM_WBEMService.SystemName
- CIM_WBEMService.CreationClassName
- CIM_WBEMService.Name
- CIM_WBEMService.PrimaryOwnerName
- CIM_WBEMService.PrimaryOwnerContact
- CIM_WBEMService.StartMode
- CIM_WBEMService.Started
api_location:
...
# CIM\_WBEMService class

An abstract class for WBEM services such as the ObjectManager (CIM Server), Providers, protocol adapters, or other pluggable components. A type of CIM\_Service that provides associated capabilities and details about the communication capabilities, namespaces, etc. for a specific WBEMService.
...
``` syntax
[Abstract, Version("2.6.0"), UMLPackagePath("CIM::Interop")]
...
The **CIM\_WBEMService** class has these types of members:
...
The **CIM\_WBEMService** class has these properties.
