---
title: SetPowerState method of the CIM\_StorageExtent class
...
ms.assetid: '079c96ae-3d95-4a23-a241-76f78d0e2248'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method iSCSI Software Target API", "SetPowerState method iSCSI Software Target API , CIM_StorageExtent class", "CIM_StorageExtent class iSCSI Software Target API , SetPowerState method"]
topic_type:
- apiref
api_name:
...
# SetPowerState method of the CIM\_StorageExtent class
