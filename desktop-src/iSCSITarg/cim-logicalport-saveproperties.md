...
ms.assetid: '85930ed1-72b2-4646-85fb-e21aab10f0b4'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SaveProperties method iSCSI Software Target API", "SaveProperties method iSCSI Software Target API , CIM_LogicalPort class", "CIM_LogicalPort class iSCSI Software Target API , SaveProperties method"]
topic_type:
- apiref
api_name:
