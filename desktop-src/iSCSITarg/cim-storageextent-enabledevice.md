---
title: EnableDevice method of the CIM\_StorageExtent class
...
ms.assetid: '85e6afc7-313c-496f-82bb-8bfc262ec198'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method iSCSI Software Target API", "EnableDevice method iSCSI Software Target API , CIM_StorageExtent class", "CIM_StorageExtent class iSCSI Software Target API , EnableDevice method"]
topic_type:
- apiref
api_name:
...
# EnableDevice method of the CIM\_StorageExtent class
