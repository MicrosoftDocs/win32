---
title: RequestStateChange method of the CIM\_StorageExtent class
...
ms.assetid: '016ee3f6-bc44-42d9-aa44-a237d53ea868'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_StorageExtent class", "CIM_StorageExtent class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_StorageExtent class
