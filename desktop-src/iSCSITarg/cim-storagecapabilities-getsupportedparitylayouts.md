...
keywords: ["GetSupportedParityLayouts method iSCSI Software Target API", "GetSupportedParityLayouts method iSCSI Software Target API , CIM_StorageCapabilities class", "CIM_StorageCapabilities class iSCSI Software Target API , GetSupportedParityLayouts method"]
topic_type:
- apiref
api_name:
