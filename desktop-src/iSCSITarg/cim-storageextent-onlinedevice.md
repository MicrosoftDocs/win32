---
title: OnlineDevice method of the CIM\_StorageExtent class
...
ms.assetid: '2e249fd3-c733-4c33-af2e-3fb1f97ed6d7'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method iSCSI Software Target API", "OnlineDevice method iSCSI Software Target API , CIM_StorageExtent class", "CIM_StorageExtent class iSCSI Software Target API , OnlineDevice method"]
topic_type:
- apiref
api_name:
...
# OnlineDevice method of the CIM\_StorageExtent class
