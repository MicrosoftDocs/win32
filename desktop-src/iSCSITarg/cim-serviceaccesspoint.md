...
ms.assetid: 'c26b968a-2243-4e06-97c4-dbc01a20e18c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_ServiceAccessPoint class iSCSI Software Target API", "CIM_ServiceAccessPoint class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
...
``` syntax
[Abstract, Version("2.10.0"), UMLPackagePath("CIM::Core::Service")]
