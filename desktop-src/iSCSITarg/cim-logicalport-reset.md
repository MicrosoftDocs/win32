...
ms.assetid: '281ed4e1-79f8-41ff-8e46-525d6440731d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["Reset method iSCSI Software Target API", "Reset method iSCSI Software Target API , CIM_LogicalPort class", "CIM_LogicalPort class iSCSI Software Target API , Reset method"]
topic_type:
- apiref
api_name:
