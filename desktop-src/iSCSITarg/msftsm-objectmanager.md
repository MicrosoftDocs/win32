---
title: MSFTSM\_ObjectManager class
description: Defines the capabilities of the CIM\_Server in which this MSFTSM\_ObjectManager instance exists.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f3b1c9b6-b93b-4a3d-979d-df512459f98d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFTSM_ObjectManager class iSCSI Software Target API", "MSFTSM_ObjectManager class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSFTSM_ObjectManager
- MSFTSM_ObjectManager.Caption
- MSFTSM_ObjectManager.InstallDate
- MSFTSM_ObjectManager.OperationalStatus
- MSFTSM_ObjectManager.StatusDescriptions
- MSFTSM_ObjectManager.Status
- MSFTSM_ObjectManager.HealthState
- MSFTSM_ObjectManager.EnabledState
- MSFTSM_ObjectManager.OtherEnabledState
- MSFTSM_ObjectManager.RequestedState
- MSFTSM_ObjectManager.EnabledDefault
- MSFTSM_ObjectManager.TimeOfLastStateChange
- MSFTSM_ObjectManager.SystemCreationClassName
- MSFTSM_ObjectManager.SystemName
- MSFTSM_ObjectManager.CreationClassName
- MSFTSM_ObjectManager.PrimaryOwnerName
- MSFTSM_ObjectManager.PrimaryOwnerContact
- MSFTSM_ObjectManager.StartMode
- MSFTSM_ObjectManager.Started
- MSFTSM_ObjectManager.GatherStatisticalData
- MSFTSM_ObjectManager.Name
- MSFTSM_ObjectManager.ElementName
- MSFTSM_ObjectManager.Description
api_location:
...
# MSFTSM\_ObjectManager class

Defines the capabilities of the **CIM\_Server** in which this **MSFTSM\_ObjectManager** instance exists. Details that are related to communicating with the **MSFTSM\_ObjectManager** are described in **CIM\_CommunicationMechanism** instances that are associated to the object manager through the [**MSFTSM\_CommMechanismForManager**](msftsm-commmechanismformanager.md) association.
...
class MSFTSM_ObjectManager : CIM_ObjectManager
{
  string   Caption;
...
The **MSFTSM\_ObjectManager** class has these types of members:
...
The **MSFTSM\_ObjectManager** class has these methods.



| Method                                                                | Description                                                                                                                                                                                                                                                                |
|:----------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](requeststatechange-msftsm-objectmanager.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) class.<br/>                                                                   |
| [**StartService**](startservice-msftsm-objectmanager.md)             | Places the service in the started state. This method is deprecated. Instead, use the [**RequestStateChange**](requeststatechange-msftsm-objectmanager.md) method.<br/> This method is inherited from the [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442) class.<br/> |
| [**StopService**](stopservice-msftsm-objectmanager.md)               | Places the service in the stopped state. This method is deprecated. Instead, use the [**RequestStateChange**](requeststatechange-msftsm-objectmanager.md) method.<br/> This method is inherited from the [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442) class.<br/> |
...
The **MSFTSM\_ObjectManager** class has these properties.
...
This property is inherited from [**CIM\_ObjectManager**](cim-objectmanager.md).
