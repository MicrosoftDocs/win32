---
title: CIM\_AuthenticationService class
description: Verifies users' identities through some means.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'c42691f8-916a-43db-b9ef-2c038bdbca2b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_AuthenticationService class iSCSI Software Target API", "CIM_AuthenticationService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_AuthenticationService
- CIM_AuthenticationService.Caption
- CIM_AuthenticationService.Description
- CIM_AuthenticationService.ElementName
- CIM_AuthenticationService.InstallDate
- CIM_AuthenticationService.OperationalStatus
- CIM_AuthenticationService.StatusDescriptions
- CIM_AuthenticationService.Status
- CIM_AuthenticationService.HealthState
- CIM_AuthenticationService.EnabledState
- CIM_AuthenticationService.OtherEnabledState
- CIM_AuthenticationService.RequestedState
- CIM_AuthenticationService.EnabledDefault
- CIM_AuthenticationService.TimeOfLastStateChange
- CIM_AuthenticationService.SystemCreationClassName
- CIM_AuthenticationService.SystemName
- CIM_AuthenticationService.CreationClassName
- CIM_AuthenticationService.Name
- CIM_AuthenticationService.PrimaryOwnerName
- CIM_AuthenticationService.PrimaryOwnerContact
- CIM_AuthenticationService.StartMode
- CIM_AuthenticationService.Started
api_location:
...
# CIM\_AuthenticationService class
...
``` syntax
[Version("2.8.0"), UMLPackagePath("CIM::User::SecurityServices")]
...
The **CIM\_AuthenticationService** class has these types of members:
...
The **CIM\_AuthenticationService** class has these methods.



| Method                                                                     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|:---------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-authenticationservice-requeststatechange.md) | Requests that the state of the element be changed to the value specified in the RequestedState parameter. When the requested state change takes place, the EnabledState and RequestedState of the element will be the same. Invoking the RequestStateChange method multiple times could result in earlier requests being overwritten or lost. If 0 is returned, then the task completed successfully and the use of ConcreteJob was not required. If 4096 (0x1000) is returned, then the task will take some time to complete, ConcreteJob will be created, and its reference returned in the output parameter Job. Any other return code indicates an error condition.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                                                                                                                                                                        |
| [**StartService**](cim-authenticationservice-startservice.md)             | The StartService method places the Service in the started state. Note that the function of this method overlaps with the RequestedState property. RequestedState was added to the model to maintain a record (such as a persisted value) of the last state request. Invoking the StartService method should set the RequestedState property appropriately. The method returns an integer value of 0 if the Service was successfully started, 1 if the request is not supported, and any other number to indicate an error. In a subclass, the set of possible return codes could be specified using a ValueMap qualifier on the method. The strings to which the ValueMap contents are translated can also be specified in the subclass as a Values array qualifier. Note: The semantics of this method overlap with the RequestStateChange method that is inherited from EnabledLogicalElement. This method is maintained because it has been widely implemented, and its simple "start" semantics are convenient to use.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/> |
| [**StopService**](cim-authenticationservice-stopservice.md)               | The StopService method places the Service in the stopped state. Note that the function of this method overlaps with the RequestedState property. RequestedState was added to the model to maintain a record (such as a persisted value) of the last state request. Invoking the StopService method should set the RequestedState property appropriately. The method returns an integer value of 0 if the Service was successfully stopped, 1 if the request is not supported, and any other number to indicate an error. In a subclass, the set of possible return codes could be specified using a ValueMap qualifier on the method. The strings to which the ValueMap contents are translated can also be specified in the subclass as a Values array qualifier. Note: The semantics of this method overlap with the RequestStateChange method that is inherited from EnabledLogicalElement. This method is maintained because it has been widely implemented, and its simple "stop" semantics are convenient to use.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>    |
...
The **CIM\_AuthenticationService** class has these properties.
