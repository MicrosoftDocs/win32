...
ms.assetid: '13379b9e-85f9-4e37-b8b1-856bb6462a36'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SaveProperties method iSCSI Software Target API", "SaveProperties method iSCSI Software Target API , CIM_LogicalDevice class", "CIM_LogicalDevice class iSCSI Software Target API , SaveProperties method"]
topic_type:
- apiref
api_name:
