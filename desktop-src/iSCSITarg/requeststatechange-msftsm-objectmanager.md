...
- RequestStateChange method iSCSI Software Target API , MSFTSM_ObjectManager class
- MSFTSM_ObjectManager class iSCSI Software Target API , RequestStateChange method
topic_type:
- apiref
api_name:
