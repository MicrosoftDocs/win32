---
title: RequestStateChange method of the MSFTSM\_ObjectManager class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f3c7fff5-34c7-48f6-acf8-b9c098330784'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSFTSM_ObjectManager class", "MSFTSM_ObjectManager class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSFTSM_ObjectManager.RequestStateChange
api_location:
...
# RequestStateChange method of the MSFTSM\_ObjectManager class
