---
title: RequestStateChange method of the MSFTSM\_System class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '51ba5e29-cc30-4f08-b61e-a857d6ebd010'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSFTSM_System class", "MSFTSM_System class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSFTSM_System.RequestStateChange
api_location:
...
# RequestStateChange method of the MSFTSM\_System class
