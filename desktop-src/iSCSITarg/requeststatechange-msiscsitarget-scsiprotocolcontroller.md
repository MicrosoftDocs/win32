---
title: RequestStateChange method of the MSISCSITARGET\_SCSIProtocolController class
...
- apiref
api_name:
- MSISCSITARGET_SCSIProtocolController.RequestStateChange
api_location:
...
Requests that the state of the element be changed to the specified value. To invoke this method multiple times could cause earlier requests to be overwritten or lost.
