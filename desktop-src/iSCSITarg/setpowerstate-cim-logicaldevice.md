...
keywords: ["SetPowerState method iSCSI Software Target API", "SetPowerState method iSCSI Software Target API , CIM_LogicalDevice class", "CIM_LogicalDevice class iSCSI Software Target API , SetPowerState method"]
topic_type:
- apiref
api_name:
