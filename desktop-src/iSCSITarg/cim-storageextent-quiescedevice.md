---
title: QuiesceDevice method of the CIM\_StorageExtent class
...
ms.assetid: 'f7e0040b-1158-4f6f-83b3-a5e008dfc8b1'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method iSCSI Software Target API", "QuiesceDevice method iSCSI Software Target API , CIM_StorageExtent class", "CIM_StorageExtent class iSCSI Software Target API , QuiesceDevice method"]
topic_type:
- apiref
api_name:
...
# QuiesceDevice method of the CIM\_StorageExtent class
