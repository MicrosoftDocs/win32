---
title: MSFTSMNET\_IPProtocolEndpoint class
description: Represents a protocol endpoint that is dedicated to running the IP protocol.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '3892e4fa-5bc9-4417-9845-0c6232b2e3b2'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFTSMNET_IPProtocolEndpoint class iSCSI Software Target API", "MSFTSMNET_IPProtocolEndpoint class iSCSI Software Target API , described"]
---

# MSFTSMNET\_IPProtocolEndpoint class
...
The **MSFTSMNET\_IPProtocolEndpoint** class has these types of members:
...
The **MSFTSMNET\_IPProtocolEndpoint** class has these methods.



| Method                                                                        | Description                                                                                                                                                                                              |
|:------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](requeststatechange-msftsmnet-ipprotocolendpoint.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) class.<br/> |
...
The **MSFTSMNET\_IPProtocolEndpoint** class has these properties.
