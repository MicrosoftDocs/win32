---
title: MSISCSITARGET\_StorageSynchronized class
description: Associates two storage objects in a replication relationship.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '15824009-2716-4601-8da8-d9868efaf1a3'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_StorageSynchronized class iSCSI Software Target API", "MSISCSITARGET_StorageSynchronized class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_StorageSynchronized
- MSISCSITARGET_StorageSynchronized.WhenSynced
- MSISCSITARGET_StorageSynchronized.SyncMaintained
- MSISCSITARGET_StorageSynchronized.CopyState
- MSISCSITARGET_StorageSynchronized.Mode
- MSISCSITARGET_StorageSynchronized.PercentSynced
- MSISCSITARGET_StorageSynchronized.ProgressStatus
- MSISCSITARGET_StorageSynchronized.RequestedCopyState
- MSISCSITARGET_StorageSynchronized.SyncType
- MSISCSITARGET_StorageSynchronized.WhenActivated
- MSISCSITARGET_StorageSynchronized.WhenDeactivated
- MSISCSITARGET_StorageSynchronized.WhenEstablished
- MSISCSITARGET_StorageSynchronized.WhenSuspended
- MSISCSITARGET_StorageSynchronized.WhenSynchronized
- MSISCSITARGET_StorageSynchronized.CopyRecoveryMode
- MSISCSITARGET_StorageSynchronized.FailedCopyStopsHostIO
- MSISCSITARGET_StorageSynchronized.SystemElement
- MSISCSITARGET_StorageSynchronized.SyncedElement
- MSISCSITARGET_StorageSynchronized.CopyType
- MSISCSITARGET_StorageSynchronized.ReplicaType
- MSISCSITARGET_StorageSynchronized.SyncState
- MSISCSITARGET_StorageSynchronized.CopyPriority
- MSISCSITARGET_StorageSynchronized.CopyMethodology
- MSISCSITARGET_StorageSynchronized.UndiscoveredElement
- MSISCSITARGET_StorageSynchronized.ReadOnly
api_location:
...
# MSISCSITARGET\_StorageSynchronized class
...
The **MSISCSITARGET\_StorageSynchronized** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSISCSITARGET\_StorageSynchronized** class has these properties.
...
This property is inherited from [**CIM\_StorageSynchronized**](cim-storagesynchronized.md).
