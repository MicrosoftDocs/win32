---
title: MSFTSM\_SoftwareIdentity class
description: Provides descriptive information about a software component for asset tracking or installation dependency management or both.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '963a45c2-0509-492c-ae0b-42da5eea2d21'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFTSM_SoftwareIdentity class iSCSI Software Target API", "MSFTSM_SoftwareIdentity class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSFTSM_SoftwareIdentity
- MSFTSM_SoftwareIdentity.Caption
- MSFTSM_SoftwareIdentity.Description
- MSFTSM_SoftwareIdentity.ElementName
- MSFTSM_SoftwareIdentity.InstallDate
- MSFTSM_SoftwareIdentity.Name
- MSFTSM_SoftwareIdentity.OperationalStatus
- MSFTSM_SoftwareIdentity.StatusDescriptions
- MSFTSM_SoftwareIdentity.Status
- MSFTSM_SoftwareIdentity.HealthState
- MSFTSM_SoftwareIdentity.InstanceID
- MSFTSM_SoftwareIdentity.MajorVersion
- MSFTSM_SoftwareIdentity.MinorVersion
- MSFTSM_SoftwareIdentity.RevisionNumber
- MSFTSM_SoftwareIdentity.BuildNumber
- MSFTSM_SoftwareIdentity.VersionString
- MSFTSM_SoftwareIdentity.TargetOperatingSystems
- MSFTSM_SoftwareIdentity.Manufacturer
- MSFTSM_SoftwareIdentity.Languages
- MSFTSM_SoftwareIdentity.Classifications
- MSFTSM_SoftwareIdentity.ClassificationDescriptions
- MSFTSM_SoftwareIdentity.SerialNumber
- MSFTSM_SoftwareIdentity.ReleaseDate
api_location:
...
# MSFTSM\_SoftwareIdentity class

Provides descriptive information about a software component for asset tracking or installation dependency management or both. The **MSFTSM\_SoftwareIdentity** class does not by itself indicate the installation or other status information about the software.
...
The **MSFTSM\_SoftwareIdentity** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFTSM\_SoftwareIdentity** class has these properties.
...
This property is inherited from [**CIM\_SoftwareIdentity**](cim-softwareidentity.md).
