...
keywords: ["SetPowerState method iSCSI Software Target API", "SetPowerState method iSCSI Software Target API , MSISCSITARGET_SCSIProtocolController class", "MSISCSITARGET_SCSIProtocolController class iSCSI Software Target API , SetPowerState method"]
topic_type:
- apiref
api_name:
