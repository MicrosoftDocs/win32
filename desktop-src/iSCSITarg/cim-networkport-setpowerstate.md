...
ms.assetid: 'bf1fd077-5b37-4afb-80f0-1d6281bc1897'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method iSCSI Software Target API", "SetPowerState method iSCSI Software Target API , CIM_NetworkPort class", "CIM_NetworkPort class iSCSI Software Target API , SetPowerState method"]
topic_type:
- apiref
api_name:
