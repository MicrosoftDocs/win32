...
keywords: ["MSISCSITARGET_ProtocolControllerMaskingCapabilities class iSCSI Software Target API", "MSISCSITARGET_ProtocolControllerMaskingCapabilities class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
