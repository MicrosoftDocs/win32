---
title: RequestStateChange method of the MSISCSITARGET\_iSCSIProtocolEndpoint class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'd17fd404-68d3-4057-886b-94a92d2387cd'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSISCSITARGET_iSCSIProtocolEndpoint class", "MSISCSITARGET_iSCSIProtocolEndpoint class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_iSCSIProtocolEndpoint.RequestStateChange
api_location:
...
# RequestStateChange method of the MSISCSITARGET\_iSCSIProtocolEndpoint class
