...
ms.assetid: '24466582-8071-4663-bccb-4f2d32e8c4ac'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_ManagedSystemElement class iSCSI Software Target API", "CIM_ManagedSystemElement class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
