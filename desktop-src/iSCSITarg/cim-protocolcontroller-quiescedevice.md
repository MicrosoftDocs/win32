...
ms.assetid: 'af21cad4-891d-4e9d-aed3-a76bb355a0e0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method iSCSI Software Target API", "QuiesceDevice method iSCSI Software Target API , CIM_ProtocolController class", "CIM_ProtocolController class iSCSI Software Target API , QuiesceDevice method"]
topic_type:
- apiref
api_name:
