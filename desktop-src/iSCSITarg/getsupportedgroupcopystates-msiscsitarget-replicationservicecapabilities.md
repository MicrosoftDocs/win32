---
title: GetSupportedGroupCopyStates method of the MSISCSITARGET\_ReplicationServiceCapabilities class
description: Retrieves the supported replication group copy states for a specified replication type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '6e07c192-22f0-410f-bdf4-cb7bb2f21dcd'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetSupportedGroupCopyStates method iSCSI Software Target API", "GetSupportedGroupCopyStates method iSCSI Software Target API , MSISCSITARGET_ReplicationServiceCapabilities class", "MSISCSITARGET_ReplicationServiceCapabilities class iSCSI Software Target API , GetSupportedGroupCopyStates method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_ReplicationServiceCapabilities.GetSupportedGroupCopyStates
api_location:
...
# GetSupportedGroupCopyStates method of the MSISCSITARGET\_ReplicationServiceCapabilities class

Retrieves the supported replication group copy states for a specified replication type.
