...
- GetSupportedGroupCopyStates method iSCSI Software Target API , MSISCSITARGET_ReplicationServiceCapabilities class
- MSISCSITARGET_ReplicationServiceCapabilities class iSCSI Software Target API , GetSupportedGroupCopyStates method
topic_type:
- apiref
api_name:
