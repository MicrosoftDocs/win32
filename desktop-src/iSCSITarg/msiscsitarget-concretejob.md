---
title: MSISCSITARGET\_ConcreteJob class
description: Represents a generic unit of work that can be instantiated, such as a batch or a print job.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'bac55970-ca9b-4710-b42b-f3e2bd079163'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_ConcreteJob class iSCSI Software Target API", "MSISCSITARGET_ConcreteJob class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_ConcreteJob
- MSISCSITARGET_ConcreteJob.Caption
- MSISCSITARGET_ConcreteJob.Description
- MSISCSITARGET_ConcreteJob.ElementName
- MSISCSITARGET_ConcreteJob.InstallDate
- MSISCSITARGET_ConcreteJob.OperationalStatus
- MSISCSITARGET_ConcreteJob.StatusDescriptions
- MSISCSITARGET_ConcreteJob.Status
- MSISCSITARGET_ConcreteJob.HealthState
- MSISCSITARGET_ConcreteJob.JobStatus
- MSISCSITARGET_ConcreteJob.TimeSubmitted
- MSISCSITARGET_ConcreteJob.ScheduledStartTime
- MSISCSITARGET_ConcreteJob.StartTime
- MSISCSITARGET_ConcreteJob.ElapsedTime
- MSISCSITARGET_ConcreteJob.JobRunTimes
- MSISCSITARGET_ConcreteJob.RunMonth
- MSISCSITARGET_ConcreteJob.RunDay
- MSISCSITARGET_ConcreteJob.RunDayOfWeek
- MSISCSITARGET_ConcreteJob.RunStartInterval
- MSISCSITARGET_ConcreteJob.LocalOrUtcTime
- MSISCSITARGET_ConcreteJob.UntilTime
- MSISCSITARGET_ConcreteJob.Notify
- MSISCSITARGET_ConcreteJob.Owner
- MSISCSITARGET_ConcreteJob.Priority
- MSISCSITARGET_ConcreteJob.PercentComplete
- MSISCSITARGET_ConcreteJob.DeleteOnCompletion
- MSISCSITARGET_ConcreteJob.ErrorCode
- MSISCSITARGET_ConcreteJob.ErrorDescription
- MSISCSITARGET_ConcreteJob.RecoveryAction
- MSISCSITARGET_ConcreteJob.OtherRecoveryAction
- MSISCSITARGET_ConcreteJob.InstanceID
- MSISCSITARGET_ConcreteJob.Name
- MSISCSITARGET_ConcreteJob.JobState
- MSISCSITARGET_ConcreteJob.TimeOfLastStateChange
- MSISCSITARGET_ConcreteJob.TimeBeforeRemoval
api_location:
...
# MSISCSITARGET\_ConcreteJob class
...
The **MSISCSITARGET\_ConcreteJob** class has these types of members:
...
The **MSISCSITARGET\_ConcreteJob** class has these methods.



| Method                                                                     | Description                                                                                                                                                                                                                                                                                                                                                   |
|:---------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetError**](geterror-msiscsitarget-concretejob.md)                     | Returns a [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671) instance if the **MSISCSITARGET\_ConcreteJob** instance fails or is terminated by a client.<br/> This method is inherited from the [**CIM\_ConcreteJob**](https://msdn.microsoft.com/library/cc136808) class.<br/>                                                                                                              |
| [**KillJob**](killjob-msiscsitarget-concretejob.md)                       | Kills this job and any underlying processes, and removes any associations containing this job. This method is deprecated, instead use the **RequestStateChange** method to distinguish between an orderly shutdown and an immediate shutdown without cleanup.<br/> This method is inherited from the [**CIM\_Job**](https://msdn.microsoft.com/library/aa387873) class.<br/> |
| [**RequestStateChange**](requeststatechange-msiscsitarget-concretejob.md) | Requests that the state of the job be changed to the specified value. The allowed transitions are job and vendor specific.<br/> This method is inherited from the [**CIM\_ConcreteJob**](https://msdn.microsoft.com/library/cc136808) class.<br/>                                                                                                                         |
...
The **MSISCSITARGET\_ConcreteJob** class has these properties.
