...
ms.assetid: '1397bf39-acdc-43d4-8aed-cae40ae20de6'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_EnabledLogicalElement class iSCSI Software Target API", "CIM_EnabledLogicalElement class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_EnabledLogicalElement
- CIM_EnabledLogicalElement.Caption
- CIM_EnabledLogicalElement.Description
- CIM_EnabledLogicalElement.ElementName
- CIM_EnabledLogicalElement.InstallDate
- CIM_EnabledLogicalElement.Name
- CIM_EnabledLogicalElement.OperationalStatus
- CIM_EnabledLogicalElement.StatusDescriptions
- CIM_EnabledLogicalElement.Status
- CIM_EnabledLogicalElement.HealthState
...
``` syntax
[Abstract, Version("2.14.0"), UMLPackagePath("CIM::Core::CoreElements")]
