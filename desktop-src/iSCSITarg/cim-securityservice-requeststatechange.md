---
title: RequestStateChange method of the CIM\_SecurityService class
...
ms.assetid: '9c9bb40c-785c-49b5-8528-49c62bd7cdb0'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_SecurityService class", "CIM_SecurityService class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_SecurityService class
