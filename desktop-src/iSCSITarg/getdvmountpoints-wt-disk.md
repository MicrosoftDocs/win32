...
keywords: ["GetDVMountPoints method iSCSI Software Target API", "GetDVMountPoints method iSCSI Software Target API , WT_Disk class", "WT_Disk class iSCSI Software Target API , GetDVMountPoints method"]
topic_type:
- apiref
api_name:
