---
title: RequestStateChange method of the CIM\_EthernetPort class
...
ms.assetid: '865e3f86-b590-49c7-95da-c0baf3dd5316'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_EthernetPort class", "CIM_EthernetPort class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_EthernetPort class
