---
title: CIM\_StorageConfigurationCapabilities class
description: A subclass of Capabilities that defines the Capabilities of a StorageConfigurationService.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f426e814-629c-484c-ac69-c92b8850390f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_StorageConfigurationCapabilities class iSCSI Software Target API", "CIM_StorageConfigurationCapabilities class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_StorageConfigurationCapabilities
- CIM_StorageConfigurationCapabilities.Caption
- CIM_StorageConfigurationCapabilities.Description
...
- CIM_StorageConfigurationCapabilities.InitialReplicationState
...
# CIM\_StorageConfigurationCapabilities class
...
The **CIM\_StorageConfigurationCapabilities** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_StorageConfigurationCapabilities** class has these properties.
