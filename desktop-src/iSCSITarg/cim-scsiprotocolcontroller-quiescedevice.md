...
ms.assetid: '7e9631a2-b0f9-4be8-9aa1-3efdddffd1a1'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["QuiesceDevice method iSCSI Software Target API", "QuiesceDevice method iSCSI Software Target API , CIM_SCSIProtocolController class", "CIM_SCSIProtocolController class iSCSI Software Target API , QuiesceDevice method"]
topic_type:
- apiref
api_name:
