...
Specifies how long the instance persists. If **True**, the instance must persist across the management server reboot. If **NULL**, the value is based on the default value of the class in the Managed Object Format (MOF). Use the [CimSession](https://msdn.microsoft.com/library/microsoft.management.infrastructure.cimsession.aspx).[**ModifyInstance**](Microsoft.Management.Infrastructure.CimSession.ModifyInstance) method to change the value after the instance is created.
