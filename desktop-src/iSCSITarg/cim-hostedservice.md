...
description: CIM\_HostedService is an association between a Service and the System on which the functionality is located.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '8efe036c-7757-43e7-be4d-b463ef2d8efa'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_HostedService class iSCSI Software Target API", "CIM_HostedService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_HostedService
