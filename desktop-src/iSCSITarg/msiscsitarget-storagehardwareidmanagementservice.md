---
title: MSISCSITARGET\_StorageHardwareIDManagementService class
description: Provides methods for manipulating instances of MSISCSITARGET\_StorageHardwareID and manipulating the trust of these IDs in the underlying storage system.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '8cd50b61-3365-41fc-a99a-b5150c6d3b8e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_StorageHardwareIDManagementService class iSCSI Software Target API", "MSISCSITARGET_StorageHardwareIDManagementService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_StorageHardwareIDManagementService
- MSISCSITARGET_StorageHardwareIDManagementService.Caption
- MSISCSITARGET_StorageHardwareIDManagementService.Description
- MSISCSITARGET_StorageHardwareIDManagementService.ElementName
- MSISCSITARGET_StorageHardwareIDManagementService.InstallDate
- MSISCSITARGET_StorageHardwareIDManagementService.OperationalStatus
- MSISCSITARGET_StorageHardwareIDManagementService.StatusDescriptions
- MSISCSITARGET_StorageHardwareIDManagementService.Status
- MSISCSITARGET_StorageHardwareIDManagementService.HealthState
- MSISCSITARGET_StorageHardwareIDManagementService.EnabledState
- MSISCSITARGET_StorageHardwareIDManagementService.OtherEnabledState
- MSISCSITARGET_StorageHardwareIDManagementService.RequestedState
- MSISCSITARGET_StorageHardwareIDManagementService.EnabledDefault
- MSISCSITARGET_StorageHardwareIDManagementService.TimeOfLastStateChange
- MSISCSITARGET_StorageHardwareIDManagementService.SystemCreationClassName
- MSISCSITARGET_StorageHardwareIDManagementService.SystemName
- MSISCSITARGET_StorageHardwareIDManagementService.CreationClassName
- MSISCSITARGET_StorageHardwareIDManagementService.Name
- MSISCSITARGET_StorageHardwareIDManagementService.PrimaryOwnerName
- MSISCSITARGET_StorageHardwareIDManagementService.PrimaryOwnerContact
- MSISCSITARGET_StorageHardwareIDManagementService.StartMode
- MSISCSITARGET_StorageHardwareIDManagementService.Started
api_location:
...
# MSISCSITARGET\_StorageHardwareIDManagementService class

Provides methods for manipulating instances of [**MSISCSITARGET\_StorageHardwareID**](msiscsitarget-storagehardwareid.md) and manipulating the trust of these IDs in the underlying storage system.
...
class MSISCSITARGET_StorageHardwareIDManagementService : CIM_StorageHardwareIDManagementService
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSISCSITARGET\_StorageHardwareIDManagementService** class has these types of members:
...
The **MSISCSITARGET\_StorageHardwareIDManagementService** class has these methods.



| Method                                                                                                            | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|:------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AddHardwareIDsToCollection**](addhardwareidstocollection-msiscsitarget-storagehardwareidmanagementservice.md) | Creates **CIM\_MemberOfCollection** instances to associate specified hardware IDs to a specified collection.<br/> This method is inherited from [**CIM\_StorageHardwareIDManagementService**](cim-storagehardwareidmanagementservice.md).<br/>                                                                                                                                                                                                                                                          |
| [**CreateGatewayPathID**](creategatewaypathid-msiscsitarget-storagehardwareidmanagementservice.md)               | Creates a **CIM\_GatewayPathID** instance and the [**MSISCSITARGET\_ConcreteDependency**](msiscsitarget-concretedependency.md) association between the new instance and the **MSISCSITARGET\_StorageHardwareIDManagementService** service.<br/> This method is inherited from [**CIM\_StorageHardwareIDManagementService**](cim-storagehardwareidmanagementservice.md).<br/>                                                                                                                           |
| [**CreateHardwareIDCollection**](createhardwareidcollection-msiscsitarget-storagehardwareidmanagementservice.md) | Creates a **CIM\_SystemSpecificCollection** instance and associates a group of [**MSISCSITARGET\_StorageHardwareID**](msiscsitarget-storagehardwareid.md) instances to it by using **CIM\_MemberOfCollection** associations.<br/> This method is inherited from [**CIM\_StorageHardwareIDManagementService**](cim-storagehardwareidmanagementservice.md).<br/>                                                                                                                                         |
| [**CreateStorageHardwareID**](createstoragehardwareid-msiscsitarget-storagehardwareidmanagementservice.md)       | Creates a [**MSISCSITARGET\_StorageHardwareID**](msiscsitarget-storagehardwareid.md) instance and creates the [**MSISCSITARGET\_ConcreteDependency**](msiscsitarget-concretedependency.md) association between the new instance and the **MSISCSITARGET\_StorageHardwareIDManagementService** service.<br/> This method overrides the method inherited from the [**CIM\_StorageHardwareIDManagementService**](cim-storagehardwareidmanagementservice.md) class.<br/>                                  |
| [**DeleteStorageHardwareID**](deletestoragehardwareid-msiscsitarget-storagehardwareidmanagementservice.md)       | Deletes a specified [**MSISCSITARGET\_StorageHardwareID**](msiscsitarget-storagehardwareid.md) instance and deletes the associations that are no longer needed, including [**MSISCSITARGET\_ConcreteDependency**](msiscsitarget-concretedependency.md) and [**MSISCSITARGET\_AuthorizedSubject**](msiscsitarget-authorizedsubject.md).<br/> This method overrides the method inherited from the [**CIM\_StorageHardwareIDManagementService**](cim-storagehardwareidmanagementservice.md) class.<br/> |
| [**RequestStateChange**](requeststatechange-msiscsitarget-storagehardwareidmanagementservice.md)                 | Requests that the state of the element is changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063).<br/>                                                                                                                                                                                                                                                                                                                       |
| [**StartService**](startservice-msiscsitarget-storagehardwareidmanagementservice.md)                             | Places the service in the started state. Deprecated. Instead, use the [**RequestStateChange**](requeststatechange-msiscsitarget-storagehardwareidmanagementservice.md) method.<br/> This method is inherited from [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442).<br/>                                                                                                                                                                                                                                        |
| [**StopService**](stopservice-msiscsitarget-storagehardwareidmanagementservice.md)                               | Places the service in the stopped state. Deprecated, instead use the [**RequestStateChange**](requeststatechange-msiscsitarget-storagehardwareidmanagementservice.md) method.<br/> This method is inherited from [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442).<br/>                                                                                                                                                                                                                                         |
...
The **MSISCSITARGET\_StorageHardwareIDManagementService** class has these properties.
