---
title: CIM\_iSCSIConnection class
...
api_name:
- CIM_iSCSIConnection
- CIM_iSCSIConnection.Caption
- CIM_iSCSIConnection.Description
- CIM_iSCSIConnection.ElementName
- CIM_iSCSIConnection.InstallDate
- CIM_iSCSIConnection.Name
- CIM_iSCSIConnection.OperationalStatus
- CIM_iSCSIConnection.StatusDescriptions
- CIM_iSCSIConnection.Status
- CIM_iSCSIConnection.HealthState
- CIM_iSCSIConnection.OtherEnabledState
- CIM_iSCSIConnection.EnabledDefault
- CIM_iSCSIConnection.TimeOfLastStateChange
- CIM_iSCSIConnection.InstanceID
- CIM_iSCSIConnection.Directionality
- CIM_iSCSIConnection.AggregationBehavior
- CIM_iSCSIConnection.EnabledState
- CIM_iSCSIConnection.RequestedState
- CIM_iSCSIConnection.ConnectionID
- CIM_iSCSIConnection.MaxReceiveDataSegmentLength
- CIM_iSCSIConnection.MaxTransmitDataSegmentLength
...
The **CIM\_iSCSIConnection** class has these types of members:
...
The **CIM\_iSCSIConnection** class has these properties.
