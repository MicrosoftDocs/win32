...
- SetPowerState method iSCSI Software Target API , CIM_SCSIProtocolController class
- CIM_SCSIProtocolController class iSCSI Software Target API , SetPowerState method
topic_type:
- apiref
api_name:
