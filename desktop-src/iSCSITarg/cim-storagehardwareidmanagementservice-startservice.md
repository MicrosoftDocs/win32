---
title: StartService method of the CIM\_StorageHardwareIDManagementService class
description: The StartService method places the Service in the started state.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '0232a65e-1d51-4347-a77e-6bbd20892702'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["StartService method iSCSI Software Target API", "StartService method iSCSI Software Target API , CIM_StorageHardwareIDManagementService class", "CIM_StorageHardwareIDManagementService class iSCSI Software Target API , StartService method"]
topic_type:
- apiref
api_name:
- CIM_StorageHardwareIDManagementService.StartService
api_location:
...
# StartService method of the CIM\_StorageHardwareIDManagementService class
