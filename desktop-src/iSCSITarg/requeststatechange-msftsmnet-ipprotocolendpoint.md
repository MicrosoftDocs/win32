---
title: RequestStateChange method of the MSFTSMNET\_IPProtocolEndpoint class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'bf294f9f-e500-411a-8165-890a5482c338'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSFTSMNET_IPProtocolEndpoint class", "MSFTSMNET_IPProtocolEndpoint class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSFTSMNET_IPProtocolEndpoint.RequestStateChange
api_location:
...
# RequestStateChange method of the MSFTSMNET\_IPProtocolEndpoint class
