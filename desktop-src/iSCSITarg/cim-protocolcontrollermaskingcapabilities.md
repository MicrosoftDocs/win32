...
keywords: ["CIM_ProtocolControllerMaskingCapabilities class iSCSI Software Target API", "CIM_ProtocolControllerMaskingCapabilities class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
