---
title: CIM\_iSCSIConfigurationService class
description: The iSCSIConfigurationService provides methods that allow a client to manipulate iSCSIProtocolEndpoints in an iSCSI Node.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'c80a3c7e-edce-43d8-aa18-fb65d49f3090'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_iSCSIConfigurationService class iSCSI Software Target API", "CIM_iSCSIConfigurationService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_iSCSIConfigurationService
- CIM_iSCSIConfigurationService.Caption
- CIM_iSCSIConfigurationService.Description
- CIM_iSCSIConfigurationService.ElementName
- CIM_iSCSIConfigurationService.InstallDate
- CIM_iSCSIConfigurationService.OperationalStatus
- CIM_iSCSIConfigurationService.StatusDescriptions
- CIM_iSCSIConfigurationService.Status
- CIM_iSCSIConfigurationService.HealthState
- CIM_iSCSIConfigurationService.EnabledState
- CIM_iSCSIConfigurationService.OtherEnabledState
- CIM_iSCSIConfigurationService.RequestedState
- CIM_iSCSIConfigurationService.EnabledDefault
- CIM_iSCSIConfigurationService.TimeOfLastStateChange
- CIM_iSCSIConfigurationService.SystemCreationClassName
- CIM_iSCSIConfigurationService.SystemName
- CIM_iSCSIConfigurationService.CreationClassName
- CIM_iSCSIConfigurationService.Name
- CIM_iSCSIConfigurationService.PrimaryOwnerName
- CIM_iSCSIConfigurationService.PrimaryOwnerContact
- CIM_iSCSIConfigurationService.StartMode
- CIM_iSCSIConfigurationService.Started
api_location:
...
# CIM\_iSCSIConfigurationService class
...
The **CIM\_iSCSIConfigurationService** class has these types of members:
...
The **CIM\_iSCSIConfigurationService** class has these methods.



| Method                                                                                           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|:-------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**BindiSCSIProtocolEndPoint**](cim-iscsiconfigurationservice-bindiscsiprotocolendpoint.md)     | This method provides for modification of an existing iSCSIProtocolEndpoint by associating a TCPProtocolEndpoint representing an Target NetworkPortal or an IPProtocolEndpoint instance representing an Initiator NetworkPortal to the iSCSIProtocolEndpoint. The association is persisted as an instance of BindsTo. The selected Portal endpoint must be from the same SystemSpecificCollection, which represents a Portal Group, as the endpoints currently bound to the iSCSIProtocolEndpoint. This action is intended to be reversed by the use of the intrinsic method 'DeleteInstance'.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [**CreateiSCSINode**](cim-iscsiconfigurationservice-createiscsinode.md)                         | This method creates an iSCSI Node in the form of an instance of SCSIProtocolController. As part of the creation process a SystemDevice association is created between the new SCSIProtocolController and the scoping Network Entity (CIM\_ComputerSystem) hosting this service.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [**CreateiSCSIProtocolEndpoint**](cim-iscsiconfigurationservice-createiscsiprotocolendpoint.md) | This method creates an iSCSI Port in the form of an instance of iSCSIProtocolEndpoint. As part of the creation process the iSCSIProtocolEndpoint is 'bound to' the underlying TCP or IP ProtocolEndpoints which are specified as inputs by creating instances of the BindsTo association between the new instance and those instances. In addition, an instance of SAPAvailableForElement is created between the specified SCSIProtocolController and the new instance of iSCSIProtocolEndpoint.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [**DeleteiSCSINode**](cim-iscsiconfigurationservice-deleteiscsinode.md)                         | This method deletes an instance of SCSIProtocolController respresenting an iSCSI Node. If Sessions are active on iSCSIProtocolEndpoints belonging to this node an error will be returned. If no Sessions are active the scoped iSCSIProtocolEndpoints will be deleted.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [**DeleteiSCSIProtocolEndpoint**](cim-iscsiconfigurationservice-deleteiscsiprotocolendpoint.md) | The method deletes an instance of iSCSIProtocolEndpoint and all associations in which this iSCSIProtocolEndpoint is referenced.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [**RequestStateChange**](cim-iscsiconfigurationservice-requeststatechange.md)                   | Requests that the state of the element be changed to the value specified in the RequestedState parameter. When the requested state change takes place, the EnabledState and RequestedState of the element will be the same. Invoking the RequestStateChange method multiple times could result in earlier requests being overwritten or lost. If 0 is returned, then the task completed successfully and the use of ConcreteJob was not required. If 4096 (0x1000) is returned, then the task will take some time to complete, ConcreteJob will be created, and its reference returned in the output parameter Job. Any other return code indicates an error condition.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                                                                                                                                                                        |
| [**StartService**](cim-iscsiconfigurationservice-startservice.md)                               | The StartService method places the Service in the started state. Note that the function of this method overlaps with the RequestedState property. RequestedState was added to the model to maintain a record (such as a persisted value) of the last state request. Invoking the StartService method should set the RequestedState property appropriately. The method returns an integer value of 0 if the Service was successfully started, 1 if the request is not supported, and any other number to indicate an error. In a subclass, the set of possible return codes could be specified using a ValueMap qualifier on the method. The strings to which the ValueMap contents are translated can also be specified in the subclass as a Values array qualifier. Note: The semantics of this method overlap with the RequestStateChange method that is inherited from EnabledLogicalElement. This method is maintained because it has been widely implemented, and its simple "start" semantics are convenient to use.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/> |
| [**StopService**](cim-iscsiconfigurationservice-stopservice.md)                                 | The StopService method places the Service in the stopped state. Note that the function of this method overlaps with the RequestedState property. RequestedState was added to the model to maintain a record (such as a persisted value) of the last state request. Invoking the StopService method should set the RequestedState property appropriately. The method returns an integer value of 0 if the Service was successfully stopped, 1 if the request is not supported, and any other number to indicate an error. In a subclass, the set of possible return codes could be specified using a ValueMap qualifier on the method. The strings to which the ValueMap contents are translated can also be specified in the subclass as a Values array qualifier. Note: The semantics of this method overlap with the RequestStateChange method that is inherited from EnabledLogicalElement. This method is maintained because it has been widely implemented, and its simple "stop" semantics are convenient to use.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>    |
...
The **CIM\_iSCSIConfigurationService** class has these properties.
