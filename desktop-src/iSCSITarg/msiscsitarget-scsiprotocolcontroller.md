---
title: MSISCSITARGET\_SCSIProtocolController class
description: Groups controllers that are used to control the operation and function of devices that instantiate the SCSI protocol.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '80a84e77-73bd-4ab7-97c3-259d21cd9e69'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_SCSIProtocolController class iSCSI Software Target API", "MSISCSITARGET_SCSIProtocolController class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_SCSIProtocolController
- MSISCSITARGET_SCSIProtocolController.Caption
- MSISCSITARGET_SCSIProtocolController.Description
- MSISCSITARGET_SCSIProtocolController.ElementName
- MSISCSITARGET_SCSIProtocolController.InstallDate
- MSISCSITARGET_SCSIProtocolController.Name
- MSISCSITARGET_SCSIProtocolController.OperationalStatus
- MSISCSITARGET_SCSIProtocolController.StatusDescriptions
- MSISCSITARGET_SCSIProtocolController.Status
- MSISCSITARGET_SCSIProtocolController.HealthState
- MSISCSITARGET_SCSIProtocolController.EnabledState
- MSISCSITARGET_SCSIProtocolController.OtherEnabledState
- MSISCSITARGET_SCSIProtocolController.RequestedState
- MSISCSITARGET_SCSIProtocolController.EnabledDefault
- MSISCSITARGET_SCSIProtocolController.TimeOfLastStateChange
- MSISCSITARGET_SCSIProtocolController.SystemCreationClassName
- MSISCSITARGET_SCSIProtocolController.SystemName
- MSISCSITARGET_SCSIProtocolController.CreationClassName
- MSISCSITARGET_SCSIProtocolController.DeviceID
- MSISCSITARGET_SCSIProtocolController.PowerManagementSupported
- MSISCSITARGET_SCSIProtocolController.PowerManagementCapabilities
- MSISCSITARGET_SCSIProtocolController.Availability
- MSISCSITARGET_SCSIProtocolController.StatusInfo
- MSISCSITARGET_SCSIProtocolController.LastErrorCode
- MSISCSITARGET_SCSIProtocolController.ErrorDescription
- MSISCSITARGET_SCSIProtocolController.ErrorCleared
- MSISCSITARGET_SCSIProtocolController.OtherIdentifyingInfo
- MSISCSITARGET_SCSIProtocolController.PowerOnHours
- MSISCSITARGET_SCSIProtocolController.TotalPowerOnHours
- MSISCSITARGET_SCSIProtocolController.IdentifyingDescriptions
- MSISCSITARGET_SCSIProtocolController.AdditionalAvailability
- MSISCSITARGET_SCSIProtocolController.MaxQuiesceTime
- MSISCSITARGET_SCSIProtocolController.MaxUnitsControlled
- MSISCSITARGET_SCSIProtocolController.NameFormat
- MSISCSITARGET_SCSIProtocolController.OtherNameFormat
api_location:
...
# MSISCSITARGET\_SCSIProtocolController class
...
class MSISCSITARGET_SCSIProtocolController : CIM_SCSIProtocolController
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSISCSITARGET\_SCSIProtocolController** class has these types of members:
...
The **MSISCSITARGET\_SCSIProtocolController** class has these methods.



| Method                                                                                | Description                                                                                                                                                                                                                                      |
|:--------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**EnableDevice**](enabledevice-msiscsitarget-scsiprotocolcontroller.md)             | Requests that the logical device be enabled or disabled.<br/> This method is inherited from the [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) class.<br/>                                                                     |
| [**OnlineDevice**](onlinedevice-msiscsitarget-scsiprotocolcontroller.md)             | Requests that the logical device be taken online or offline.<br/> This method is inherited from the [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) class.<br/>                                                                 |
| [**QuiesceDevice**](quiescedevice-msiscsitarget-scsiprotocolcontroller.md)           | Requests that the logical device cleanly cease all current activity or resume activity.<br/> This method is inherited from the [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) class.<br/>                                      |
| [**RequestStateChange**](requeststatechange-msiscsitarget-scsiprotocolcontroller.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) class.<br/>                                         |
| [**Reset**](reset-msiscsitarget-scsiprotocolcontroller.md)                           | Requests a reset of the logical device.<br/> This method is inherited from the [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) class.<br/>                                                                                      |
| [**RestoreProperties**](restoreproperties-msiscsitarget-scsiprotocolcontroller.md)   | Requests that the device return its configuration, setup, and/or state information to a previous state from a backing store.<br/> This method is inherited from the [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) class.<br/> |
| [**SaveProperties**](saveproperties-msiscsitarget-scsiprotocolcontroller.md)         | Requests that the device capture its current configuration, setup, and/or state information in a backing store.<br/> This method is inherited from the [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) class.<br/>              |
| [**SetPowerState**](setpowerstate-msiscsitarget-scsiprotocolcontroller.md)           | Sets the power state of the device.<br/> This method is inherited from the [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884) class.<br/>                                                                                          |
...
The **MSISCSITARGET\_SCSIProtocolController** class has these properties.
...
This property is inherited from [**CIM\_SCSIProtocolController**](cim-scsiprotocolcontroller.md).
