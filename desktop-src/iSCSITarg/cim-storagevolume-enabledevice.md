---
title: EnableDevice method of the CIM\_StorageVolume class
...
ms.assetid: '2ff48aa4-fd13-49a6-a9a1-9adba09be972'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["EnableDevice method iSCSI Software Target API", "EnableDevice method iSCSI Software Target API , CIM_StorageVolume class", "CIM_StorageVolume class iSCSI Software Target API , EnableDevice method"]
topic_type:
- apiref
api_name:
- CIM_StorageVolume.EnableDevice
api_location:
...
# EnableDevice method of the CIM\_StorageVolume class
