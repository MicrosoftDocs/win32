---
title: DeleteProtocolController method of the CIM\_ControllerConfigurationService class
...
ms.assetid: 'fe3172fa-c2ae-47fd-9c17-9bec3582b9a8'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["DeleteProtocolController method iSCSI Software Target API", "DeleteProtocolController method iSCSI Software Target API , CIM_ControllerConfigurationService class", "CIM_ControllerConfigurationService class iSCSI Software Target API , DeleteProtocolController method"]
topic_type:
- apiref
api_name:
- CIM_ControllerConfigurationService.DeleteProtocolController
api_location:
...
# DeleteProtocolController method of the CIM\_ControllerConfigurationService class
