---
title: MSFTSM\_System class
description: Represents an entity that consists of component parts. The entity operates as a functional whole. Systems are top-level objects in the CIM hierarchy.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'df6c8155-8efb-43c6-b3d7-cad61959291b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFTSM_System class iSCSI Software Target API", "MSFTSM_System class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSFTSM_System
- MSFTSM_System.Caption
- MSFTSM_System.Description
- MSFTSM_System.ElementName
- MSFTSM_System.InstallDate
- MSFTSM_System.OperationalStatus
- MSFTSM_System.StatusDescriptions
- MSFTSM_System.Status
- MSFTSM_System.HealthState
- MSFTSM_System.EnabledState
- MSFTSM_System.OtherEnabledState
- MSFTSM_System.RequestedState
- MSFTSM_System.EnabledDefault
- MSFTSM_System.TimeOfLastStateChange
- MSFTSM_System.CreationClassName
- MSFTSM_System.Name
- MSFTSM_System.NameFormat
- MSFTSM_System.PrimaryOwnerName
- MSFTSM_System.PrimaryOwnerContact
- MSFTSM_System.Roles
- MSFTSM_System.OtherIdentifyingInfo
- MSFTSM_System.IdentifyingDescriptions
api_location:
...
The **MSFTSM\_System** class has these types of members:
...
The **MSFTSM\_System** class has these methods.



| Method                                                         | Description                                                                                                                                                                                    |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](requeststatechange-msftsm-system.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
...
The **MSFTSM\_System** class has these properties.
