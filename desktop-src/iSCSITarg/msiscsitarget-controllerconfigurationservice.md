...
keywords:
- MSISCSITARGET_ControllerConfigurationService class iSCSI Software Target API
- MSISCSITARGET_ControllerConfigurationService class iSCSI Software Target API , described
topic_type:
- apiref
api_name:
