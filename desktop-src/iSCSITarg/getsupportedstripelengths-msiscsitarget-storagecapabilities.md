...
keywords: ["GetSupportedStripeLengths method iSCSI Software Target API", "GetSupportedStripeLengths method iSCSI Software Target API , MSISCSITARGET_StorageCapabilities class", "MSISCSITARGET_StorageCapabilities class iSCSI Software Target API , GetSupportedStripeLengths method"]
topic_type:
- apiref
api_name:
