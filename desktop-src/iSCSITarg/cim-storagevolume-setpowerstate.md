---
title: SetPowerState method of the CIM\_StorageVolume class
...
ms.assetid: '660bfbb2-bb02-477e-b264-60a818d71007'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method iSCSI Software Target API", "SetPowerState method iSCSI Software Target API , CIM_StorageVolume class", "CIM_StorageVolume class iSCSI Software Target API , SetPowerState method"]
topic_type:
- apiref
api_name:
- CIM_StorageVolume.SetPowerState
api_location:
...
# SetPowerState method of the CIM\_StorageVolume class
