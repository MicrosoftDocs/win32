---
title: OnlineDevice method of the CIM\_StorageVolume class
...
ms.assetid: '528749f1-e932-498a-8ca5-2d4ae90c71de'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method iSCSI Software Target API", "OnlineDevice method iSCSI Software Target API , CIM_StorageVolume class", "CIM_StorageVolume class iSCSI Software Target API , OnlineDevice method"]
topic_type:
- apiref
api_name:
- CIM_StorageVolume.OnlineDevice
api_location:
...
# OnlineDevice method of the CIM\_StorageVolume class
