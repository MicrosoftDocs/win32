...
keywords: ["RestoreProperties method iSCSI Software Target API", "RestoreProperties method iSCSI Software Target API , CIM_StorageExtent class", "CIM_StorageExtent class iSCSI Software Target API , RestoreProperties method"]
topic_type:
- apiref
api_name:
