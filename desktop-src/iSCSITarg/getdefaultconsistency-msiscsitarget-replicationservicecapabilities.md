---
title: GetDefaultConsistency method of the MSISCSITARGET\_ReplicationServiceCapabilities class
description: Retrieves the default consistency value for a specified replication type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '7dc433ba-14e8-40e8-9f0b-7af7f9dabff9'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetDefaultConsistency method iSCSI Software Target API", "GetDefaultConsistency method iSCSI Software Target API , MSISCSITARGET_ReplicationServiceCapabilities class", "MSISCSITARGET_ReplicationServiceCapabilities class iSCSI Software Target API , GetDefaultConsistency method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_ReplicationServiceCapabilities.GetDefaultConsistency
api_location:
...
# GetDefaultConsistency method of the MSISCSITARGET\_ReplicationServiceCapabilities class

Retrieves the default consistency value for a specified replication type.
...
On return, indicates the default consistency value.
