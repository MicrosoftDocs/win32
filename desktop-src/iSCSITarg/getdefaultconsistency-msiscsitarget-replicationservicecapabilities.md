...
keywords:
- GetDefaultConsistency method iSCSI Software Target API
- GetDefaultConsistency method iSCSI Software Target API , MSISCSITARGET_ReplicationServiceCapabilities class
- MSISCSITARGET_ReplicationServiceCapabilities class iSCSI Software Target API , GetDefaultConsistency method
topic_type:
- apiref
api_name:
