---
title: RequestStateChange method of the MSISCSITARGET\_ReplicationService class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '59f3cd28-974b-49bf-93cc-8494195362a2'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSISCSITARGET_ReplicationService class", "MSISCSITARGET_ReplicationService class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_ReplicationService.RequestStateChange
api_location:
...
# RequestStateChange method of the MSISCSITARGET\_ReplicationService class
