---
title: CIM\_iSCSIProtocolEndpoint class
description: This is an iSCSI-specific SCSIProtocolEndpoint. ConnectionType MUST be 'iSCSI'.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '9ca98230-5925-477c-b571-4cfa7c9d4532'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_iSCSIProtocolEndpoint class iSCSI Software Target API", "CIM_iSCSIProtocolEndpoint class iSCSI Software Target API , described"]
---

# CIM\_iSCSIProtocolEndpoint class
...
The **CIM\_iSCSIProtocolEndpoint** class has these types of members:
...
The **CIM\_iSCSIProtocolEndpoint** class has these properties.
...
Qualifiers: [**Required**](https://msdn.microsoft.com/library/aa393650), [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (13)
</dt> </dl>
...
Qualifiers: [**Override**](https://msdn.microsoft.com/library/aa393650) ("Name"), [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (256), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_SCSIProtocolEndpoint.ConnectionType", "CIM\_SCSIProtocolEndpoint.OtherConnectionType")
</dt> </dl>
