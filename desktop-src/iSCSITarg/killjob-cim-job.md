...
keywords: ["KillJob method iSCSI Software Target API", "KillJob method iSCSI Software Target API , CIM_Job class", "CIM_Job class iSCSI Software Target API , KillJob method"]
topic_type:
- apiref
api_name:
- CIM_Job.KillJob
