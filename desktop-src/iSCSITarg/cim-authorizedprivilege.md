...
description: Base class for all types of activities which are granted or denied to a Role or an Identity.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '4bd2ae6c-4644-4ca0-a286-f5185e766dcb'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_AuthorizedPrivilege class iSCSI Software Target API", "CIM_AuthorizedPrivilege class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
...
- CIM_AuthorizedPrivilege.RepresentsAuthorizationRights
api_location:
