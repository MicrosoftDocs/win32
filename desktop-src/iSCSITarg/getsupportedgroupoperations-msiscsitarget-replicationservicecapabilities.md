---
title: GetSupportedGroupOperations method of the MSISCSITARGET\_ReplicationServiceCapabilities class
description: Retrieves the operations that can be performed by the MSISCSITARGET\_ReplicationService.ModifyReplicaSynchronization method for a specified replication type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'badaea89-1888-48b2-9eec-c4b0c3f2b33c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["GetSupportedGroupOperations method iSCSI Software Target API", "GetSupportedGroupOperations method iSCSI Software Target API , MSISCSITARGET_ReplicationServiceCapabilities class", "MSISCSITARGET_ReplicationServiceCapabilities class iSCSI Software Target API , GetSupportedGroupOperations method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_ReplicationServiceCapabilities.GetSupportedGroupOperations
api_location:
...
# GetSupportedGroupOperations method of the MSISCSITARGET\_ReplicationServiceCapabilities class

Retrieves the operations that can be performed by the [**MSISCSITARGET\_ReplicationService**](msiscsitarget-replicationservice.md).[**ModifyReplicaSynchronization**](modifyreplicasynchronization-msiscsitarget-replicationservice.md) method for a specified replication type.
...
On return, contains the supported group operations.
...
Deactivates consistency if it is enabled. If consistency was not enabled, this operation has no effect.
...
This value can be used during a backup cycle to enable one of the objects to be copied while the other object remains in production.
...
Dissolves a snapshot and return the space that it used back to the storage pool.
