...
keywords: ["GetSupportedGroupOperations method iSCSI Software Target API", "GetSupportedGroupOperations method iSCSI Software Target API , CIM_ReplicationServiceCapabilities class", "CIM_ReplicationServiceCapabilities class iSCSI Software Target API , GetSupportedGroupOperations method"]
topic_type:
- apiref
api_name:
