---
title: RequestStateChange method of the CIM\_IdentityManagementService class
...
ms.assetid: '67d52a9c-b000-457a-a615-e76486b85d84'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_IdentityManagementService class", "CIM_IdentityManagementService class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_IdentityManagementService class
