---
title: MSFTSM\_ComputerSystem class
description: Represents an entity that consists of component parts. The entity operates as a functional whole to provide computing capabilities. Systems are top-level objects in the CIM hierarchy.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'c78d0962-9278-4008-ae38-ab006d7d9e2b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFTSM_ComputerSystem class iSCSI Software Target API", "MSFTSM_ComputerSystem class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSFTSM_ComputerSystem
- MSFTSM_ComputerSystem.Caption
- MSFTSM_ComputerSystem.Description
- MSFTSM_ComputerSystem.ElementName
- MSFTSM_ComputerSystem.InstallDate
- MSFTSM_ComputerSystem.OperationalStatus
- MSFTSM_ComputerSystem.StatusDescriptions
- MSFTSM_ComputerSystem.Status
- MSFTSM_ComputerSystem.HealthState
- MSFTSM_ComputerSystem.EnabledState
- MSFTSM_ComputerSystem.OtherEnabledState
- MSFTSM_ComputerSystem.RequestedState
- MSFTSM_ComputerSystem.EnabledDefault
- MSFTSM_ComputerSystem.TimeOfLastStateChange
- MSFTSM_ComputerSystem.CreationClassName
- MSFTSM_ComputerSystem.Name
- MSFTSM_ComputerSystem.PrimaryOwnerName
- MSFTSM_ComputerSystem.PrimaryOwnerContact
- MSFTSM_ComputerSystem.Roles
- MSFTSM_ComputerSystem.OtherIdentifyingInfo
- MSFTSM_ComputerSystem.IdentifyingDescriptions
- MSFTSM_ComputerSystem.NameFormat
- MSFTSM_ComputerSystem.Dedicated
- MSFTSM_ComputerSystem.OtherDedicatedDescriptions
- MSFTSM_ComputerSystem.ResetCapability
- MSFTSM_ComputerSystem.PowerManagementCapabilities
api_location:
...
class MSFTSM_ComputerSystem : CIM_ComputerSystem
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSFTSM\_ComputerSystem** class has these types of members:
...
The **MSFTSM\_ComputerSystem** class has these methods.



| Method                                                                 | Description                                                                                                                                                                                                                                                              |
|:-----------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](requeststatechange-msftsm-computersystem.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                           |
| [**RescanExtents**](rescanextents-msftsm-computersystem.md)           | Discovers newly added and newly removed storage extents such as Windows disks.<br/> This method is inherited from the [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219) class.<br/>                                                                     |
| [**SetPowerState**](setpowerstate-msftsm-computersystem.md)           | Sets the power state of the computer. This method is deprecated. Instead, use the **SetPowerState** method in the associated power management service class.<br/> This method is inherited from [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219).<br/> |
...
The **MSFTSM\_ComputerSystem** class has these properties.
