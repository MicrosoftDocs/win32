---
title: MSISCSITARGET\_StorageConfigurationService class
description: Enables the active management of a storage server. It enables jobs to be started for the creation, modification, and deletion of storage objects, for example the MSISCSITARGET\_StoragePool and MSISCSITARGET\_StorageVolume instances.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '635b973c-2975-4299-b07f-93624843646d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_StorageConfigurationService class iSCSI Software Target API", "MSISCSITARGET_StorageConfigurationService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_StorageConfigurationService
- MSISCSITARGET_StorageConfigurationService.Caption
- MSISCSITARGET_StorageConfigurationService.Description
- MSISCSITARGET_StorageConfigurationService.ElementName
- MSISCSITARGET_StorageConfigurationService.InstallDate
- MSISCSITARGET_StorageConfigurationService.OperationalStatus
- MSISCSITARGET_StorageConfigurationService.StatusDescriptions
- MSISCSITARGET_StorageConfigurationService.Status
- MSISCSITARGET_StorageConfigurationService.HealthState
- MSISCSITARGET_StorageConfigurationService.EnabledState
- MSISCSITARGET_StorageConfigurationService.OtherEnabledState
- MSISCSITARGET_StorageConfigurationService.RequestedState
- MSISCSITARGET_StorageConfigurationService.EnabledDefault
- MSISCSITARGET_StorageConfigurationService.TimeOfLastStateChange
- MSISCSITARGET_StorageConfigurationService.SystemCreationClassName
- MSISCSITARGET_StorageConfigurationService.SystemName
- MSISCSITARGET_StorageConfigurationService.CreationClassName
- MSISCSITARGET_StorageConfigurationService.Name
- MSISCSITARGET_StorageConfigurationService.PrimaryOwnerName
- MSISCSITARGET_StorageConfigurationService.PrimaryOwnerContact
- MSISCSITARGET_StorageConfigurationService.StartMode
- MSISCSITARGET_StorageConfigurationService.Started
api_location:
...
# MSISCSITARGET\_StorageConfigurationService class

Enables the active management of a storage server. It enables jobs to be started for the creation, modification, and deletion of storage objects, for example the [**MSISCSITARGET\_StoragePool**](msiscsitarget-storagepool.md) and [**MSISCSITARGET\_StorageVolume**](msiscsitarget-storagevolume.md) instances.
...
class MSISCSITARGET_StorageConfigurationService : CIM_StorageConfigurationService
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSISCSITARGET\_StorageConfigurationService** class has these types of members:
...
The **MSISCSITARGET\_StorageConfigurationService** class has these methods.



| Method                                                                                                                         | Description                                                                                                                                                                                                                                                                                                                                                                                          |
|:-------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AttachOrModifyReplica**](attachormodifyreplica-msiscsitarget-storageconfigurationservice.md)                               | Creates or modifies a [**MSISCSITARGET\_StorageSynchronized**](msiscsitarget-storagesynchronized.md) relationship between two existing storage objects.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                         |
| [**AttachReplica**](attachreplica-msiscsitarget-storageconfigurationservice.md)                                               | Creates a [**MSISCSITARGET\_StorageSynchronized**](msiscsitarget-storagesynchronized.md) relationship between two existing storage objects.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                     |
| [**CreateOrModifyElementFromElements**](createormodifyelementfromelements-msiscsitarget-storageconfigurationservice.md)       | Creates or modifies a specified storage element by using specified [**CIM\_StorageExtent**](https://msdn.microsoft.com/library/aa388496) instances.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                               |
| [**CreateOrModifyElementFromStoragePool**](createormodifyelementfromstoragepool-msiscsitarget-storageconfigurationservice.md) | Starts a job to create or modify a specified element, for example, a [**MSISCSITARGET\_StorageVolume**](msiscsitarget-storagevolume.md) instance from a [**MSISCSITARGET\_StoragePool**](msiscsitarget-storagepool.md) instance.<br/> This method overrides the method inherited from the **CIM\_StorageConfigurationService** class.<br/>                                             |
| [**CreateOrModifyReplicationPipe**](createormodifyreplicationpipe-msiscsitarget-storageconfigurationservice.md)               | Establishes a peer-to-peer connection that is represented by a **CIM\_NetworkPipe** element and two [**CIM\_ProtocolEndpoint**](https://msdn.microsoft.com/library/cc136899) elements.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                              |
| [**CreateOrModifyStoragePool**](createormodifystoragepool-msiscsitarget-storageconfigurationservice.md)                       | Creates or modifies a [**MSISCSITARGET\_StoragePool**](msiscsitarget-storagepool.md) instance, or starts a job to do so.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                                        |
| [**CreateReplica**](createreplica-msiscsitarget-storageconfigurationservice.md)                                               | Creates a new storage object, which is a replica of the specified source storage object.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                                                                         |
| [**CreateReplicationBuffer**](createreplicationbuffer-msiscsitarget-storageconfigurationservice.md)                           | Creates a replication buffer that buffers asynchronous write operations for remote mirror pairs. The buffer is a [**CIM\_Memory**](https://msdn.microsoft.com/library/aa387904) instance with an [**CIM\_AssociatedMemory**](https://msdn.microsoft.com/library/aa387183) association to a hosting system or replication network pipe.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/> |
| [**DeleteStoragePool**](deletestoragepool-msiscsitarget-storageconfigurationservice.md)                                       | Deletes or starts a job to delete a [**MSISCSITARGET\_StoragePool**](msiscsitarget-storagepool.md) instance.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                                                    |
| [**GetElementsBasedOnUsage**](getelementsbasedonusage-msiscsitarget-storageconfigurationservice.md)                           | Retrieves elements that meet the specified usage. The criteria can be available only, in use only, or both.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                                                      |
| [**ModifySynchronization**](modifysynchronization-msiscsitarget-storageconfigurationservice.md)                               | Modifies the synchronization association between two storage objects.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                                                                                            |
| [**RequestStateChange**](requeststatechange-msiscsitarget-storageconfigurationservice.md)                                     | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) class.<br/>                                                                                                                                                                                             |
| [**RequestUsageChange**](requestusagechange-msiscsitarget-storageconfigurationservice.md)                                     | Requests a change in the usage of a specified element<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                                                                                                            |
| [**ReturnToStoragePool**](returntostoragepool-msiscsitarget-storageconfigurationservice.md)                                   | Starts a job to delete an element that was previously created from a [**MSISCSITARGET\_StoragePool**](msiscsitarget-storagepool.md) and returns the freed space to the storage pool.<br/> This method overrides the method inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                          |
| [**ScsiScan**](scsiscan-msiscsitarget-storageconfigurationservice.md)                                                         | Requests the system to re-scan SCSI devices for changes in their configuration.<br/> This method is inherited from the **CIM\_StorageConfigurationService** class.<br/>                                                                                                                                                                                                                  |
| [**StartService**](startservice-msiscsitarget-storageconfigurationservice.md)                                                 | Places the service in the started state. Deprecated. Instead, use the [**RequestStateChange**](requeststatechange-msiscsitarget-storageconfigurationservice.md) method.<br/>                                                                                                                                                                                                                  |
| [**StopService**](stopservice-msiscsitarget-storageconfigurationservice.md)                                                   | Places the service in the stopped state. Deprecated. Instead, use the [**RequestStateChange**](requeststatechange-msiscsitarget-storageconfigurationservice.md) method.<br/>                                                                                                                                                                                                                  |
...
The **MSISCSITARGET\_StorageConfigurationService** class has these properties.
