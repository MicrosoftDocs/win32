---
title: RequestStateChange method of the CIM\_NetworkPort class
...
ms.assetid: 'b5149988-3d58-4687-b5e4-8e7be68edf0e'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_NetworkPort class", "CIM_NetworkPort class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_NetworkPort class
