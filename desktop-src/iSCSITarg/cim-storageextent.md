...
description: StorageExtent describes the capabilities and management of the various media that exist to store data and allow data retrieval.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'fae681fa-57c6-4e92-b998-9f597f60e7fa'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_StorageExtent class iSCSI Software Target API", "CIM_StorageExtent class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_StorageExtent
...
- CIM_StorageExtent.ElementName
- CIM_StorageExtent.InstallDate
- CIM_StorageExtent.OperationalStatus
- CIM_StorageExtent.StatusDescriptions
- CIM_StorageExtent.Status
- CIM_StorageExtent.HealthState
- CIM_StorageExtent.EnabledState
- CIM_StorageExtent.OtherEnabledState
- CIM_StorageExtent.RequestedState
- CIM_StorageExtent.EnabledDefault
- CIM_StorageExtent.TimeOfLastStateChange
...
- CIM_StorageExtent.OtherIdentifyingInfo
- CIM_StorageExtent.PowerOnHours
- CIM_StorageExtent.TotalPowerOnHours
- CIM_StorageExtent.IdentifyingDescriptions
- CIM_StorageExtent.AdditionalAvailability
- CIM_StorageExtent.MaxQuiesceTime
...
``` syntax
[Abstract, Version("2.13.0"), UMLPackagePath("CIM::Core::StorageExtent")]
