...
ms.assetid: '52ab9001-895c-4674-a3ab-9a7bd8777878'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method iSCSI Software Target API", "SetPowerState method iSCSI Software Target API , CIM_LogicalPort class", "CIM_LogicalPort class iSCSI Software Target API , SetPowerState method"]
topic_type:
- apiref
api_name:
