---
title: RequestStateChange method of the MSFTSM\_ComputerSystem class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'd8bff15e-ed60-4dae-bcf7-ad5b5267fb6c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSFTSM_ComputerSystem class", "MSFTSM_ComputerSystem class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSFTSM_ComputerSystem.RequestStateChange
api_location:
...
# RequestStateChange method of the MSFTSM\_ComputerSystem class
