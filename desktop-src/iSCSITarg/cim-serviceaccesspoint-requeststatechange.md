...
ms.assetid: '120d4e2d-80e2-40b4-ba52-bfb98682b779'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_ServiceAccessPoint class", "CIM_ServiceAccessPoint class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
