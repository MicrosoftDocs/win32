---
title: MSISCSITARGET\_iSCSICapabilities class
description: Describes the capabilities of an iSCSI Network Entity.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '5c3f8f3a-416e-4580-a682-69d9c7d749c6'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_iSCSICapabilities class iSCSI Software Target API", "MSISCSITARGET_iSCSICapabilities class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_iSCSICapabilities
- MSISCSITARGET_iSCSICapabilities.Caption
- MSISCSITARGET_iSCSICapabilities.Description
- MSISCSITARGET_iSCSICapabilities.InstanceID
- MSISCSITARGET_iSCSICapabilities.ElementName
- MSISCSITARGET_iSCSICapabilities.MinimumSpecificationVersionSupported
- MSISCSITARGET_iSCSICapabilities.MaximumSpecificationVersionSupported
- MSISCSITARGET_iSCSICapabilities.AuthenticationMethodsSupported
api_location:
...
# MSISCSITARGET\_iSCSICapabilities class

Describes the capabilities of an iSCSI Network Entity.

An instance of this class will be associated to an instance of [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219) that represents the Network Entity by using a [**CIM\_ElementCapabilities**](https://msdn.microsoft.com/library/cc150669) instance. These capability properties are associated to a Network Entity/Computer System since they affect all login negotiations on all **CIM\_iSCSI\_ProtocolEndpoints** aggregated to the system.
...
class MSISCSITARGET_iSCSICapabilities : CIM_iSCSICapabilities
{
  string Caption;
  string Description;
  string InstanceID;
...
The **MSISCSITARGET\_iSCSICapabilities** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSISCSITARGET\_iSCSICapabilities** class has these properties.
...
This property is inherited from [**CIM\_iSCSICapabilities**](cim-iscsicapabilities.md).
...
[**CIM\_ElementCapabilities**](https://msdn.microsoft.com/library/cc150669)
</dt> <dt>
