---
title: CIM\_StorageHardwareIDManagementService class
...
ms.assetid: 'a613a869-624a-4612-98e7-429ea6f3120c'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_StorageHardwareIDManagementService class iSCSI Software Target API", "CIM_StorageHardwareIDManagementService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_StorageHardwareIDManagementService
- CIM_StorageHardwareIDManagementService.Caption
- CIM_StorageHardwareIDManagementService.Description
- CIM_StorageHardwareIDManagementService.ElementName
- CIM_StorageHardwareIDManagementService.InstallDate
- CIM_StorageHardwareIDManagementService.OperationalStatus
- CIM_StorageHardwareIDManagementService.StatusDescriptions
- CIM_StorageHardwareIDManagementService.Status
- CIM_StorageHardwareIDManagementService.HealthState
- CIM_StorageHardwareIDManagementService.EnabledState
- CIM_StorageHardwareIDManagementService.OtherEnabledState
- CIM_StorageHardwareIDManagementService.RequestedState
- CIM_StorageHardwareIDManagementService.EnabledDefault
- CIM_StorageHardwareIDManagementService.TimeOfLastStateChange
- CIM_StorageHardwareIDManagementService.SystemCreationClassName
- CIM_StorageHardwareIDManagementService.SystemName
- CIM_StorageHardwareIDManagementService.CreationClassName
- CIM_StorageHardwareIDManagementService.Name
- CIM_StorageHardwareIDManagementService.PrimaryOwnerName
- CIM_StorageHardwareIDManagementService.PrimaryOwnerContact
- CIM_StorageHardwareIDManagementService.StartMode
- CIM_StorageHardwareIDManagementService.Started
api_location:
...
# CIM\_StorageHardwareIDManagementService class
...
``` syntax
[Version("2.14.0"), UMLPackagePath("CIM::User::StorageHardwareID")]
...
The **CIM\_StorageHardwareIDManagementService** class has these types of members:
...
The **CIM\_StorageHardwareIDManagementService** class has these methods.



| Method                                                                                                  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|:--------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AddHardwareIDsToCollection**](cim-storagehardwareidmanagementservice-addhardwareidstocollection.md) | Create MemberOfCollection instances between the specified Collection and the StorageHardwareIDs. This method allows the client to make a request of a specific Service instance to create the associations. When these capabilities are standardized in CIM/WBEM, this method can be deprecated and intrinsic methods used.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [**CreateGatewayPathID**](cim-storagehardwareidmanagementservice-creategatewaypathid.md)               | This method creates a CIM\_GatewayPathID and the association CIM\_ConcreteDependency between this service and the new GatewayPathID.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [**CreateHardwareIDCollection**](cim-storagehardwareidmanagementservice-createhardwareidcollection.md) | Create a group of StorageHardwareIDs as a new instance of SystemSpecificCollection. This is useful to define a set of authorized subjects that can access volumes in a disk array. This method allows the client to make a request of a specific Service instance to create the collection and provide the appropriate class name. When these capabilities are standardized in CIM/WBEM, this method can be deprecated and intrinsic methods used. In addition to creating the collection, this method causes the creation of the HostedCollection association (to this service's scoping system) and MemberOfCollection association to members of the IDs parameter.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [**CreateStorageHardwareID**](cim-storagehardwareidmanagementservice-createstoragehardwareid.md)       | This method creates a CIM\_StorageHardwareID, it creates the association CIM\_ConcreteDependency between this service and the new CIM\_StorageHardwareID.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [**DeleteStorageHardwareID**](cim-storagehardwareidmanagementservice-deletestoragehardwareid.md)       | This method deletes a named CIM\_StorageHardwareID, and also tears down the associations that are no longer needed, including CIM\_ConcreteDependency and CIM\_AuthorizedSubject.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [**RequestStateChange**](cim-storagehardwareidmanagementservice-requeststatechange.md)                 | Requests that the state of the element be changed to the value specified in the RequestedState parameter. When the requested state change takes place, the EnabledState and RequestedState of the element will be the same. Invoking the RequestStateChange method multiple times could result in earlier requests being overwritten or lost. If 0 is returned, then the task completed successfully and the use of ConcreteJob was not required. If 4096 (0x1000) is returned, then the task will take some time to complete, ConcreteJob will be created, and its reference returned in the output parameter Job. Any other return code indicates an error condition.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/>                                                                                                                                                                                                                                                                                                                        |
| [**StartService**](cim-storagehardwareidmanagementservice-startservice.md)                             | The StartService method places the Service in the started state. Note that the function of this method overlaps with the RequestedState property. RequestedState was added to the model to maintain a record (such as a persisted value) of the last state request. Invoking the StartService method should set the RequestedState property appropriately. The method returns an integer value of 0 if the Service was successfully started, 1 if the request is not supported, and any other number to indicate an error. In a subclass, the set of possible return codes could be specified using a ValueMap qualifier on the method. The strings to which the ValueMap contents are translated can also be specified in the subclass as a Values array qualifier. Note: The semantics of this method overlap with the RequestStateChange method that is inherited from EnabledLogicalElement. This method is maintained because it has been widely implemented, and its simple "start" semantics are convenient to use.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/> |
| [**StopService**](cim-storagehardwareidmanagementservice-stopservice.md)                               | The StopService method places the Service in the stopped state. Note that the function of this method overlaps with the RequestedState property. RequestedState was added to the model to maintain a record (such as a persisted value) of the last state request. Invoking the StopService method should set the RequestedState property appropriately. The method returns an integer value of 0 if the Service was successfully stopped, 1 if the request is not supported, and any other number to indicate an error. In a subclass, the set of possible return codes could be specified using a ValueMap qualifier on the method. The strings to which the ValueMap contents are translated can also be specified in the subclass as a Values array qualifier. Note: The semantics of this method overlap with the RequestStateChange method that is inherited from EnabledLogicalElement. This method is maintained because it has been widely implemented, and its simple "stop" semantics are convenient to use.<br/> This method is inherited from [**CIM\_Service**](cim-service.md).<br/>    |
...
The **CIM\_StorageHardwareIDManagementService** class has these properties.
