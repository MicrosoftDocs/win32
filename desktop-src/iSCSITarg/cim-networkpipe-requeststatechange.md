...
ms.assetid: '6831c730-916b-40d4-a134-d4e8a2030c8b'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_NetworkPipe class", "CIM_NetworkPipe class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- CIM_NetworkPipe.RequestStateChange
api_location:
...
# RequestStateChange method of the CIM\_NetworkPipe class
