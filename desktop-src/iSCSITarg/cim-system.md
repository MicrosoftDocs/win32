...
description: CIM\_System represents an entity made up of component parts (defined by the SystemComponent relationship), that operates as a 'functional whole'.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '7f9ad264-1680-4685-a685-e2a5731e9769'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_System class iSCSI Software Target API", "CIM_System class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_System
...
``` syntax
[Abstract, Version("2.15.0"), UMLPackagePath("CIM::Core::CoreElements")]
