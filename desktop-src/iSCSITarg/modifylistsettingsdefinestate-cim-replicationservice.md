---
title: ModifyListSettingsDefineState method of the CIM\_ReplicationService class
description: Modify (or start a job to modify) a list of SettingsDefineState associations.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '82f800b1-5218-46ac-8060-23d839ce0bb2'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["ModifyListSettingsDefineState method iSCSI Software Target API", "ModifyListSettingsDefineState method iSCSI Software Target API , CIM_ReplicationService class", "CIM_ReplicationService class iSCSI Software Target API , ModifyListSettingsDefineState method"]
topic_type:
- apiref
api_name:
- CIM_ReplicationService.ModifyListSettingsDefineState
api_location:
...
# ModifyListSettingsDefineState method of the CIM\_ReplicationService class
