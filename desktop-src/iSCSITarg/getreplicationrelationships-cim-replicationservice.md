...
keywords:
- GetReplicationRelationships method iSCSI Software Target API
- GetReplicationRelationships method iSCSI Software Target API , CIM_ReplicationService class
- CIM_ReplicationService class iSCSI Software Target API , GetReplicationRelationships method
topic_type:
- apiref
api_name:
