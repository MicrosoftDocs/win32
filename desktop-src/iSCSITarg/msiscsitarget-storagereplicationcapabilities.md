---
title: MSISCSITARGET\_StorageReplicationCapabilities class
description: Defines the replication capabilities of an associated instance of the MSISCSITARGET\_StorageConfigurationService class.
audience: developer
...
- apiref
api_name:
- MSISCSITARGET_StorageReplicationCapabilities
- MSISCSITARGET_StorageReplicationCapabilities.Caption
- MSISCSITARGET_StorageReplicationCapabilities.Description
- MSISCSITARGET_StorageReplicationCapabilities.InstanceID
- MSISCSITARGET_StorageReplicationCapabilities.ElementName
- MSISCSITARGET_StorageReplicationCapabilities.SupportedSynchronizationType
- MSISCSITARGET_StorageReplicationCapabilities.SupportedAsynchronousActions
- MSISCSITARGET_StorageReplicationCapabilities.SupportedSynchronousActions
- MSISCSITARGET_StorageReplicationCapabilities.InitialReplicationState
- MSISCSITARGET_StorageReplicationCapabilities.SupportedSpecializedElements
- MSISCSITARGET_StorageReplicationCapabilities.SupportedModifyOperations
- MSISCSITARGET_StorageReplicationCapabilities.ReplicaHostAccessibility
- MSISCSITARGET_StorageReplicationCapabilities.HostAccessibleState
- MSISCSITARGET_StorageReplicationCapabilities.SpaceLimitSupported
- MSISCSITARGET_StorageReplicationCapabilities.SpaceReservationSupported
- MSISCSITARGET_StorageReplicationCapabilities.LocalMirrorSnapshotSupported
- MSISCSITARGET_StorageReplicationCapabilities.RemoteMirrorSnapshotSupported
- MSISCSITARGET_StorageReplicationCapabilities.IncrementalDeltasSupported
- MSISCSITARGET_StorageReplicationCapabilities.PersistentReplicasSupported
- MSISCSITARGET_StorageReplicationCapabilities.BidirectionalConnectionsSupported
- MSISCSITARGET_StorageReplicationCapabilities.MaximumReplicasPerSource
- MSISCSITARGET_StorageReplicationCapabilities.MaximumPortsPerConnection
- MSISCSITARGET_StorageReplicationCapabilities.MaximumConnectionsPerPort
- MSISCSITARGET_StorageReplicationCapabilities.MaximumPeerConnections
- MSISCSITARGET_StorageReplicationCapabilities.MaximumLocalReplicationDepth
- MSISCSITARGET_StorageReplicationCapabilities.MaximumRemoteReplicationDepth
- MSISCSITARGET_StorageReplicationCapabilities.InitialSynchronizationDefault
- MSISCSITARGET_StorageReplicationCapabilities.ReplicationPriorityDefault
- MSISCSITARGET_StorageReplicationCapabilities.LowSpaceWarningThresholdDefault
- MSISCSITARGET_StorageReplicationCapabilities.SpaceLimitWarningThresholdDefault
- MSISCSITARGET_StorageReplicationCapabilities.RemoteReplicationServicePointAccess
- MSISCSITARGET_StorageReplicationCapabilities.AlternateReplicationServicePointAccess
- MSISCSITARGET_StorageReplicationCapabilities.DeltaReplicaPoolAccess
- MSISCSITARGET_StorageReplicationCapabilities.RemoteBufferElementType
- MSISCSITARGET_StorageReplicationCapabilities.RemoteBufferHost
- MSISCSITARGET_StorageReplicationCapabilities.RemoteBufferLocation
- MSISCSITARGET_StorageReplicationCapabilities.RemoteBufferSupported
- MSISCSITARGET_StorageReplicationCapabilities.UseReplicationBufferDefault
- MSISCSITARGET_StorageReplicationCapabilities.PeerConnectionProtocol
api_location:
...
Defines the replication capabilities of an associated instance of the [**MSISCSITARGET\_StorageConfigurationService**](msiscsitarget-storageconfigurationservice.md) class.
...
The **MSISCSITARGET\_StorageReplicationCapabilities** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSISCSITARGET\_StorageReplicationCapabilities** class has these properties.
...
This property is inherited from [**CIM\_StorageReplicationCapabilities**](cim-storagereplicationcapabilities.md).
