---
title: RequestStateChange method of the MSISCSITARGET\_StorageConfigurationService class
description: Requests that the state of the element be changed to the specified value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '5f6ca954-1015-4298-b308-1f2a06c8c372'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , MSISCSITARGET_StorageConfigurationService class", "MSISCSITARGET_StorageConfigurationService class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_StorageConfigurationService.RequestStateChange
api_location:
...
# RequestStateChange method of the MSISCSITARGET\_StorageConfigurationService class

Requests that the state of the element be changed to the specified value. To invoke this method multiple times could result in earlier requests to be overwritten or lost.
