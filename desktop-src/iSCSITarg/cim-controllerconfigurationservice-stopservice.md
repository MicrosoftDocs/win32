---
title: StopService method of the CIM\_ControllerConfigurationService class
description: The StopService method places the Service in the stopped state.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '17aa2fa6-c8d3-46cd-a541-acbe98458cae'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["StopService method iSCSI Software Target API", "StopService method iSCSI Software Target API , CIM_ControllerConfigurationService class", "CIM_ControllerConfigurationService class iSCSI Software Target API , StopService method"]
topic_type:
- apiref
api_name:
- CIM_ControllerConfigurationService.StopService
api_location:
...
# StopService method of the CIM\_ControllerConfigurationService class
