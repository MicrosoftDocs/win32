...
keywords:
- NewDiffWTDisk method iSCSI Software Target API
- NewDiffWTDisk method iSCSI Software Target API , WT_Disk class
- WT_Disk class iSCSI Software Target API , NewDiffWTDisk method
topic_type:
- apiref
api_name:
