...
ms.assetid: 'da9cba21-a17c-4b5e-a5f6-edd6c6e2df40'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_EthernetPort class iSCSI Software Target API", "CIM_EthernetPort class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- CIM_EthernetPort
