...
keywords:
- Create method iSCSI Software Target API
- Create method iSCSI Software Target API , WT_Snapshot class
- WT_Snapshot class iSCSI Software Target API , Create method
topic_type:
- apiref
api_name:
- WT_Snapshot.Create
