---
title: RequestStateChange method of the CIM\_AuthenticationService class
...
ms.assetid: 'f27e5671-47d1-4de3-96cf-80521bd546c4'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method iSCSI Software Target API", "RequestStateChange method iSCSI Software Target API , CIM_AuthenticationService class", "CIM_AuthenticationService class iSCSI Software Target API , RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_AuthenticationService class
