---
title: MSISCSITARGET\_iSCSISession class
description: Represents a network pipe between initiator and target MSISCSITARGET\_iSCSIProtocolEndpoint instances.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'a78af7eb-e208-429b-bbf6-72b228c37a4d'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_iSCSISession class iSCSI Software Target API", "MSISCSITARGET_iSCSISession class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_iSCSISession
- MSISCSITARGET_iSCSISession.Caption
- MSISCSITARGET_iSCSISession.Description
- MSISCSITARGET_iSCSISession.ElementName
- MSISCSITARGET_iSCSISession.InstallDate
- MSISCSITARGET_iSCSISession.Name
- MSISCSITARGET_iSCSISession.OperationalStatus
- MSISCSITARGET_iSCSISession.StatusDescriptions
- MSISCSITARGET_iSCSISession.Status
- MSISCSITARGET_iSCSISession.HealthState
- MSISCSITARGET_iSCSISession.OtherEnabledState
- MSISCSITARGET_iSCSISession.EnabledDefault
- MSISCSITARGET_iSCSISession.TimeOfLastStateChange
- MSISCSITARGET_iSCSISession.InstanceID
- MSISCSITARGET_iSCSISession.AggregationBehavior
- MSISCSITARGET_iSCSISession.EnabledState
- MSISCSITARGET_iSCSISession.RequestedState
- MSISCSITARGET_iSCSISession.Directionality
- MSISCSITARGET_iSCSISession.SessionType
- MSISCSITARGET_iSCSISession.TSIH
- MSISCSITARGET_iSCSISession.EndPointName
- MSISCSITARGET_iSCSISession.CurrentConnections
- MSISCSITARGET_iSCSISession.InitialR2T
- MSISCSITARGET_iSCSISession.ImmediateData
- MSISCSITARGET_iSCSISession.MaxOutstandingR2T
- MSISCSITARGET_iSCSISession.MaxUnsolicitedFirstDataBurstLength
- MSISCSITARGET_iSCSISession.MaxDataBurstLength
- MSISCSITARGET_iSCSISession.DataSequenceInOrder
- MSISCSITARGET_iSCSISession.DataPDUInOrder
- MSISCSITARGET_iSCSISession.ErrorRecoveryLevel
- MSISCSITARGET_iSCSISession.MaxConnectionsPerSession
- MSISCSITARGET_iSCSISession.DefaultTimeToWait
- MSISCSITARGET_iSCSISession.DefaultTimeToRetain
- MSISCSITARGET_iSCSISession.SystemName
api_location:
...
# MSISCSITARGET\_iSCSISession class

Represents a network pipe between initiator and target [**MSISCSITARGET\_iSCSIProtocolEndpoint**](msiscsitarget-iscsiprotocolendpoint.md) instances. Only an iSCSI initiator can create an iSCSI session, while an iSCSI target must accept or reject a session request.
...
The **MSISCSITARGET\_iSCSISession** class has these types of members:
...
The **MSISCSITARGET\_iSCSISession** class has these methods.



| Method                                                                      | Description                                                                                                                                                                                              |
|:----------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](requeststatechange-msiscsitarget-iscsisession.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063) class.<br/> |
...
The **MSISCSITARGET\_iSCSISession** class has these properties.
...
This property is inherited from [**CIM\_iSCSISession**](cim-iscsisession.md).
