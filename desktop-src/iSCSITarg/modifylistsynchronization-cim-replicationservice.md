---
title: ModifyListSynchronization method of the CIM\_ReplicationService class
description: Modify (or start a job to modify) an array of synchronization associations between two storage objects or replication groups.
audience: developer
...
- apiref
api_name:
- CIM_ReplicationService.ModifyListSynchronization
api_location:
