---
title: MSISCSITARGET\_iSCSIConfigurationService class
description: Enables a client to manipulate MSISCSITARGET\_iSCSIProtocolEndpoint instances that represent Internet SCSI (iSCSI) ports in an iSCSI node.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f58afa2d-829c-4718-80ce-75db7ce66548'
ms.prod: 'windows-server-dev'
ms.technology:
- 'iscsi-target'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSISCSITARGET_iSCSIConfigurationService class iSCSI Software Target API", "MSISCSITARGET_iSCSIConfigurationService class iSCSI Software Target API , described"]
topic_type:
- apiref
api_name:
- MSISCSITARGET_iSCSIConfigurationService
- MSISCSITARGET_iSCSIConfigurationService.Caption
- MSISCSITARGET_iSCSIConfigurationService.Description
- MSISCSITARGET_iSCSIConfigurationService.ElementName
- MSISCSITARGET_iSCSIConfigurationService.InstallDate
- MSISCSITARGET_iSCSIConfigurationService.OperationalStatus
- MSISCSITARGET_iSCSIConfigurationService.StatusDescriptions
- MSISCSITARGET_iSCSIConfigurationService.Status
- MSISCSITARGET_iSCSIConfigurationService.HealthState
- MSISCSITARGET_iSCSIConfigurationService.EnabledState
- MSISCSITARGET_iSCSIConfigurationService.OtherEnabledState
- MSISCSITARGET_iSCSIConfigurationService.RequestedState
- MSISCSITARGET_iSCSIConfigurationService.EnabledDefault
- MSISCSITARGET_iSCSIConfigurationService.TimeOfLastStateChange
- MSISCSITARGET_iSCSIConfigurationService.SystemCreationClassName
- MSISCSITARGET_iSCSIConfigurationService.SystemName
- MSISCSITARGET_iSCSIConfigurationService.CreationClassName
- MSISCSITARGET_iSCSIConfigurationService.Name
- MSISCSITARGET_iSCSIConfigurationService.PrimaryOwnerName
- MSISCSITARGET_iSCSIConfigurationService.PrimaryOwnerContact
- MSISCSITARGET_iSCSIConfigurationService.StartMode
- MSISCSITARGET_iSCSIConfigurationService.Started
api_location:
...
# MSISCSITARGET\_iSCSIConfigurationService class

Enables a client to manipulate [**MSISCSITARGET\_iSCSIProtocolEndpoint**](msiscsitarget-iscsiprotocolendpoint.md) instances that represent Internet SCSI (iSCSI) ports in an iSCSI node. An instance of this service is contained within the scope of a [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219) instance that represents the network entity. The capabilities of this service are defined in the companion class **CIM\_iSCSIConfigurationCapabilities**.
...
``` syntax
[Dynamic, Provider("MSiSCSITargetProv"), Experimental, Version("1.0.0")]
class MSISCSITARGET_iSCSIConfigurationService : CIM_iSCSIConfigurationService
{
  string   Caption;
  string   Description;
  string   ElementName;
...
The **MSISCSITARGET\_iSCSIConfigurationService** class has these types of members:
...
The **MSISCSITARGET\_iSCSIConfigurationService** class has these methods.



| Method                                                                                                     | Description                                                                                                                                                                                                                                                                                                                                                                                     |
|:-----------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**BindiSCSIProtocolEndPoint**](bindiscsiprotocolendpoint-msiscsitarget-iscsiconfigurationservice.md)     | Modifies an existing [**MSISCSITARGET\_iSCSIProtocolEndpoint**](msiscsitarget-iscsiprotocolendpoint.md) instance by associating a Target Network Port or an Initiator Network Port to the **MSISCSITARGET\_iSCSIProtocolEndpoint** instance.<br/> This method is inherited from [**CIM\_iSCSIConfigurationService**](cim-iscsiconfigurationservice.md) .<br/>                     |
| [**CreateiSCSINode**](createiscsinode-msiscsitarget-iscsiconfigurationservice.md)                         | Creates a [**CIM\_SCSIProtocolController**](https://msdn.microsoft.com/library/cc136905) instance that represents an iSCSI node. This method also creates a [**CIM\_SystemDevice**](https://msdn.microsoft.com/library/aa388509) instance that associates the new SCSI Protocol Controller (SPC) to the [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219) instance that represents the hosting network entity.<br/> |
| [**CreateiSCSIProtocolEndpoint**](createiscsiprotocolendpoint-msiscsitarget-iscsiconfigurationservice.md) | Creates an iSCSI port in the form of an [**MSISCSITARGET\_iSCSIProtocolEndpoint**](msiscsitarget-iscsiprotocolendpoint.md) instance.<br/> This method is inherited from [**CIM\_iSCSIConfigurationService**](cim-iscsiconfigurationservice.md) .<br/>                                                                                                                             |
| [**DeleteiSCSINode**](deleteiscsinode-msiscsitarget-iscsiconfigurationservice.md)                         | Deletes an instance of [**CIM\_SCSIProtocolController**](https://msdn.microsoft.com/library/cc136905) that represents an iSCSI node.<br/>                                                                                                                                                                                                                                                              |
| [**DeleteiSCSIProtocolEndpoint**](deleteiscsiprotocolendpoint-msiscsitarget-iscsiconfigurationservice.md) | Deletes an instance of the [**MSISCSITARGET\_iSCSIProtocolEndpoint**](msiscsitarget-iscsiprotocolendpoint.md) class and all associations in which it is referenced.<br/> This method is inherited from [**CIM\_iSCSIConfigurationService**](cim-iscsiconfigurationservice.md) .<br/>                                                                                              |
| [**RequestStateChange**](requeststatechange-msiscsitarget-iscsiconfigurationservice.md)                   | Requests that the state of the element is changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/mt446063).<br/>                                                                                                                                                                                                  |
| [**StartService**](startservice-msiscsitarget-iscsiconfigurationservice.md)                               | Places the Service in the started state. Deprecated, instead use the [**RequestStateChange**](https://msdn.microsoft.com/library/dn441028) method.<br/> This method is inherited from [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442).<br/>                                                                                                                       |
| [**StopService**](stopservice-msiscsitarget-iscsiconfigurationservice.md)                                 | Places the Service in the stopped state. Deprecated, instead use the [**RequestStateChange**](https://msdn.microsoft.com/library/dn441028) method.<br/> This method is inherited from [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442).<br/>                                                                                                                       |
...
The **MSISCSITARGET\_iSCSIConfigurationService** class has these properties.
