...
keywords:
- MSISCSITARGET_iSCSIConfigurationService class iSCSI Software Target API
- MSISCSITARGET_iSCSIConfigurationService class iSCSI Software Target API , described
topic_type:
- apiref
api_name:
