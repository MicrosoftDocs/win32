...
keywords:
- Gadget Platform,about
- Gadget Platform,Introduction
- Gadget Platform,Sidebar
- Gadget Platform,Security
- Gadget Platform,HighDPI
- Gadget Platform,System.Gadget.onDock
- Gadget Platform,events
- Sidebar,Gadget Platform
- Windows Gadget Platform,about
- Windows Gadget Platform,Introduction
- Windows Gadget Platform,Sidebar
- Gadgets,what's new
- Gadgets Gallery
