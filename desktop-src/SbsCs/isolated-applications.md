...
Isolated applications are self-describing applications installed with [manifests](manifests.md). Isolated applications can use both [private assemblies](https://msdn.microsoft.com/library/windows/desktop/aa370850) and [shared assemblies](https://msdn.microsoft.com/library/windows/desktop/aa371839).
