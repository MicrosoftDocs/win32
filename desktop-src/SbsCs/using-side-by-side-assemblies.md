...
3.  Enter attribute values in the [*DEF-context assemblyIdentity*](https://www.bing.com/search?q=*DEF-context assemblyIdentity*) subelement of the application manifest that uniquely defines the application. For more information about the DEF-context **assemblyIdentity**, see [Application Manifests](application-manifests.md).
4.  If the assembly contains any dependent assemblies, enter attribute values into the corresponding [*REF-context assemblyIdentity*](https://www.bing.com/search?q=*REF-context assemblyIdentity*) subelements of the application manifest. For more information about the REF-context **assemblyIdentity**, see [Application Manifests](application-manifests.md).
...
6.  [Shared assemblies](https://msdn.microsoft.com/library/windows/desktop/aa371839) should be installed using the [Windows Installer](https://www.bing.com/search?q=Windows Installer) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for Side-by-side Sharing on Windows XP?](https://www.bing.com/search?q=How Do I Install Win32 Assemblies for Side-by-side Sharing on Windows XP?).
7.  [Private assemblies](https://msdn.microsoft.com/library/windows/desktop/aa370850) can be installed using the [Windows Installer](https://www.bing.com/search?q=Windows Installer) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for the Private Use of an Application on Windows XP?](https://www.bing.com/search?q=How Do I Install Win32 Assemblies for the Private Use of an Application on Windows XP?). You can also use any other installer to copy a private assembly and its manifest into the same folder as the application's executable file.
