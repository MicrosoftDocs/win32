...
6.  [Shared assemblies](https://msdn.microsoft.com/library/windows/desktop/aa371839) should be installed using the [Windows Installer](https://msdn.microsoft.com/windows/desktop/c90b8cbe-d7a1-44ad-ae65-80115bd55e4f) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for Side-by-side Sharing on Windows XP?](https://msdn.microsoft.com/windows/desktop/1234e904-fc7f-4eb7-8c50-0c959bbf5261).
7.  [Private assemblies](https://msdn.microsoft.com/library/windows/desktop/aa370850) can be installed using the [Windows Installer](https://msdn.microsoft.com/windows/desktop/c90b8cbe-d7a1-44ad-ae65-80115bd55e4f) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for the Private Use of an Application on Windows XP?](https://msdn.microsoft.com/windows/desktop/2d4bc2be-cce6-45e6-b6a7-7ff96d28eb96). You can also use any other installer to copy a private assembly and its manifest into the same folder as the application's executable file.
