...
6.  [Shared assemblies](https://msdn.microsoft.com/library/windows/desktop/aa371839) should be installed using the [Windows Installer](https://msdn.microsoft.com/en-us/library/Cc185688(v=VS.85).aspx) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for Side-by-side Sharing on Windows XP?](https://msdn.microsoft.com/en-us/library/Aa369532(v=VS.85).aspx).
7.  [Private assemblies](https://msdn.microsoft.com/library/windows/desktop/aa370850) can be installed using the [Windows Installer](https://msdn.microsoft.com/en-us/library/Cc185688(v=VS.85).aspx) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for the Private Use of an Application on Windows XP?](https://msdn.microsoft.com/en-us/library/Aa369534(v=VS.85).aspx). You can also use any other installer to copy a private assembly and its manifest into the same folder as the application's executable file.
