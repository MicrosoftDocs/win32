...
6.  [Shared assemblies](https://msdn.microsoft.com/library/windows/desktop/aa371839) should be installed using the [Windows Installer](_msi_windows_installer_start_page) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for Side-by-side Sharing on Windows XP?](_msi_how_do_i_install_win32_assemblies_for_side_by_side_sharing_on_windows_xp).
7.  [Private assemblies](https://msdn.microsoft.com/library/windows/desktop/aa370850) can be installed using the [Windows Installer](_msi_windows_installer_start_page) version 2.0. Author a Windows Installer package as described in [How Do I Install Win32 Assemblies for the Private Use of an Application on Windows XP?](_msi_how_do_i_install_win32_assemblies_for_the_private_use_of_an_application_on_windows_xp). You can also use any other installer to copy a private assembly and its manifest into the same folder as the application's executable file.
