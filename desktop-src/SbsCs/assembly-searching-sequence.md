...
If an isolated application specifies an assembly dependency, side-by-side first searches for the assembly among the [shared assemblies](https://msdn.microsoft.com/library/windows/desktop/aa371839) in the WinSxS folder. If the required assembly is not found, side-by-side then searches for a private assembly installed in a folder of the application's directory structure.

[Private assemblies](https://msdn.microsoft.com/library/windows/desktop/aa370850) may be deployed in the following locations in the application's directory structure:
