...
The active or negotiated maximum transmission unit (MTU) that can be supported. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
A Boolean that indicates whether the network port is capable of automatically determining the speed or other communications characteristics of the attached network media. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
Availability and status of the device. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
Short textual description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218).
...
Win32 Configuration Manager error code. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
If **TRUE**, the device is using a user-defined configuration. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
Name of the class or subclass used in the creation of an instance. When used with other key properties of the class, this property allows all instances of the class and its subclasses to be uniquely identified. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
Textual description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218).
...
Address or other identifying information to uniquely name the logical device. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
If **TRUE**, the error reported in the **LastErrorCode** property is now cleared. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
Free-form string that supplies information about the error recorded in the **LastErrorCode** property and corrective actions to perform. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
Boolean that indicates that the port is operating in full duplex mode. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
Last error code reported by the logical device. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
An enumeration of the types of links. When set to 1 ("Other"), the related property **OtherLinkTechnology** contains a string description of the type of link. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
The maximum bandwidth, in bits per second, of the port. This property inherits from [**CIM\_LogicalPort**](https://msdn.microsoft.com/library/cc136869).
...
An array of strings that indicates the network addresses for the port. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
A string value that describes **LinkTechnology** when it is set to 1, "Other". This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
Note: The use of this property is deprecated in lieu of CIM\_LogicalPort.PortType. Deprecated description: The type of module, when PortType is set to 1 ("Other".) This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
Describes the type of module, when **PortType** is set to 1 ("Other"). This property inherits from [**CIM\_LogicalPort**](https://msdn.microsoft.com/library/cc136869).
...
The network address that is hardcoded into a port. This hardcoded address can be changed using a firmware upgrade or a software configuration. When this change is made, the field should be updated at the same time. **PermanentAddress** should be left blank if no hardcoded address exists for the network adapter. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
Indicates the Win32 Plug and Play device identifier of the logical device. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
Network ports are often numbered relative to either a logical module or a network element. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
Array of the specific power-related capabilities of a logical device. This property is inherited from **CIM\_LogicalDevice**. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
The requested bandwidth, in bits per second, of the port. The actual bandwidth is reported in the **Speed** property. This property inherits from [**CIM\_LogicalPort**](https://msdn.microsoft.com/library/cc136869).
...
The bandwidth, in bits per second, of the port. This property inherits from [**CIM\_LogicalPort**](https://msdn.microsoft.com/library/cc136869).
...
State of the logical device. If this property does not apply to the logical device, the value 5 ("Not Applicable") should be used. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
The maximum transmission unit (MTU) that can be supported. This property inherits from [**CIM\_NetworkPort**](https://msdn.microsoft.com/library/mt432235).
...
Scoping system's creation class name. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
Scoping system's name. This property inherits from [**CIM\_LogicalDevice**](https://msdn.microsoft.com/library/aa387884).
...
The **MSFT\_NetAdapter** class is commonly used with the [Network Adapter Cmdlets](https://technet.microsoft.com/library/jj134956.aspx).
