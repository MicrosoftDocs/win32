...
| Method                                                                                  | Description                                                  |
|:----------------------------------------------------------------------------------------|:-------------------------------------------------------------|
| [**GetByInstanceID**](https://msdn.microsoft.com/library/hh872313) | Gets a list of VMQ queues of the network adapter.<br/> |
| [**GetByName**](https://msdn.microsoft.com/library/hh872319)             | Gets a list of VMQ queues of the network adapter.<br/> |
