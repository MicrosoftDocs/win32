...
Associates a network adapter with its Large Send Offload (LSO) data.
...
The **MSFT\_NetAdapterLsoElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterLsoElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterLsoSettingData**
</dt> <dt>
...
The LSO setting data for the network adapter.
