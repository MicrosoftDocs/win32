...
Represents a virtual Fibre Channel switch. Each switch is associated with one physical Fibre Channel port to which many synthetic Fibre Channel ports can be connected. The switch itself is not highly configurable and acts mostly as a placeholder.
...
The **Msvm\_VirtualFcSwitch** class has these types of members:
...
The **Msvm\_VirtualFcSwitch** class has these methods.



| Method                                                                | Description                              |
|:----------------------------------------------------------------------|:-----------------------------------------|
| [**RequestStateChange**](msvm-virtualfcswitch-requeststatechange.md) | Requests a state change.<br/>      |
...
The **Msvm\_VirtualFcSwitch** class has these properties.
...
The name of the class or subclass that is used in the creation of an instance. This property is inherited from [**CIM\_System**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-system).
...
The label by which the object is known. This property is inherited from [**CIM\_System**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-system).
...
This property is inherited from [**CIM\_ComputerSystem**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-computersystem).
