...
The following C# sample retrieves and displays physical and virtual network information for the specified switch. This code is taken from the [Hyper-V networking sample](http://go.microsoft.com/fwlink/p/?LinkID=268398).
