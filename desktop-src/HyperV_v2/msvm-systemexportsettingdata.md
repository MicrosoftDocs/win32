...
Indicates if the referenced setting is currently being used in the operation of the element, or that this information is unknown. This property is inherited from [**CIM\_ElementSettingData**](https://msdn.microsoft.com/library/mt446053).
...
Indicates if the referenced setting is a default setting for the element, or that this information is unknown. This property is inherited from [**CIM\_ElementSettingData**](https://msdn.microsoft.com/library/mt446053).
...
Reference to the virtual machine. This property is inherited from [**CIM\_ElementSettingData**](https://msdn.microsoft.com/library/mt446053).
...
Reference to the export setting data for the virtual machine. This property is inherited from [**CIM\_ElementSettingData**](https://msdn.microsoft.com/library/mt446053).
