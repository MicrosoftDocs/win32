...
Represents the definition aspects of a metric. The **Msvm\_BaseMetricDefinition** class should be associated with the [**CIM\_ManagedElements**](https://msdn.microsoft.com/library/mt432218) to which it applies.
