...
A string that describes the types of error detection and correction supported by this device. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901), and it is set to "None".
...
**True** if the media is locked in the device and cannot be ejected; otherwise, **False**. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901), and it is set to **True**.
...
**True** if the media access device needs cleaning; otherwise, **False**. This property is inherited from [**CIM\_MediaAccessDevice**](https://msdn.microsoft.com/library/aa387901), and it is set to **False**.
