...
Reference to the virtual machine or virtual device. This property is inherited from [**CIM\_ElementSettingData**](https://msdn.microsoft.com/library/mt446053).
...
Reference to the snapshotted settings for the virtual machine or virtual device. This property is inherited from [**CIM\_ElementSettingData**](https://msdn.microsoft.com/library/mt446053).
