...
The virtual key code of the key to release. For the list for virtual-key codes, see [**Virtual-Key Codes**](https://msdn.microsoft.com/library/Dd375731(v=VS.85).aspx).
