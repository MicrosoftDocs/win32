...
Represents the configured state of the guest service interface component. This class derives from the [**CIM\_ResourceAllocationSettingData**](https://msdn.microsoft.com/library/mt146214) class.
