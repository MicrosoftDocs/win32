...
A reference to a [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219) instance that represents the virtual machine for which the replication settings should be modified.
