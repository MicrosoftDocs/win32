---
description: RequestStateChange method of the Msvm_EmulatedEthernetPort class - Requests a state change.
...
# RequestStateChange method of the Msvm\_EmulatedEthernetPort class
