...
| [**RequestStateChange**](msvm-serialport-requeststatechange.md) | Requests a state change.<br/>      |
| [**Reset**](msvm-serialport-reset.md)                           | Resets the virtual device.<br/>    |
...
The enabled state of the element. It can also indicate the transitions between these requested states. This property is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/cc136818).
...
This property is inherited from [**CIM\_LogicalPort**](https://msdn.microsoft.com/library/cc136869).
...
The requested bandwidth of the port, in bits-per-second. This property is inherited from [**CIM\_LogicalPort**](https://msdn.microsoft.com/library/cc136869).
