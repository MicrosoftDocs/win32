...
title: 'Msvm\_EthernetSwitchPortProfileSettingData class'
---
...
A short description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Ethernet Switch Port Profile Settings".
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (127), **WmiDataId** (12), **InterfaceVersion** (1), **InterfaceRevision** (0)
</dt> </dl>
...
A description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Represents the port profile settings.".
...
A display name for the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Ethernet Switch Port Profile Settings".
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (38), **WmiDataId** (6), **InterfaceVersion** (1), **InterfaceRevision** (0)
</dt> </dl>
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (38), **WmiDataId** (2), **InterfaceVersion** (1), **InterfaceRevision** (0)
</dt> </dl>
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (127), **WmiDataId** (1), **InterfaceVersion** (1), **InterfaceRevision** (0)
</dt> </dl>
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (38), **WmiDataId** (4), **InterfaceVersion** (1), **InterfaceRevision** (0)
</dt> </dl>
...
Qualifiers: [**MaxLen**](https://msdn.microsoft.com/library/aa393650) (127), **WmiDataId** (3), **InterfaceVersion** (1), **InterfaceRevision** (0)
</dt> </dl>
