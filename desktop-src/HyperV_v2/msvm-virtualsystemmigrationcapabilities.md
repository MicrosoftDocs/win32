...
Qualifiers: [**Override**](https://msdn.microsoft.com/library/aa393650) ("AsynchronousMethodsSupported")
</dt> </dl>
...
A short description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Migration Capabilities".
...
A description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Virtual System Migration Capabilities".
