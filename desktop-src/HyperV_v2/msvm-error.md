...
A string containing a user-readable description of the **CIMStatusCode** property. This description may extend, but must be consistent with, the definition of **CIMStatusCode**. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
...
The format of the **ErrorSource** property is interpretable based on the value of this property. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671), and it is always set to 0.
...
Primary classification of the error. The following values are defined. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
...
An array containing the dynamic content of the message. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
...
An opaque string that uniquely identifies, within the scope of the **OwningEntity**, the format of the message. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
...
A string that describes the **ErrorType** when 1, (Other), is specified as the **ErrorType**. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
...
An enumerated value that describes the probable cause of the error. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
...
A string that describes the probable cause of the error. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
...
A string that describes recommended actions to take to resolve the error. This property is inherited from [**CIM\_Error**](https://msdn.microsoft.com/library/cc150671).
