...
title: 'ModifyServiceSettings method of the Msvm\_TerminalService class'
---

# ModifyServiceSettings method of the Msvm\_TerminalService class
...
A string representation of the [**Msvm\_TerminalServiceSettingData**](msvm-terminalservicesettingdata.md) class that contains the modified setting data for the service.
