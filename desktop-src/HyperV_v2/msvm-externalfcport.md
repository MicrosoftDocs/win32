...
title: Msvm\_ExternalFcPort class
ms.date: 05/31/2018
ms.topic: article
...
The **Msvm\_ExternalFcPort** class has these types of members:
...
The **Msvm\_ExternalFcPort** class has these methods.
...
| [**RequestStateChange**](msvm-externalfcport-requeststatechange.md) | Requests a state change<br/>       |
| [**Reset**](msvm-externalfcport-reset.md)                           | Resets the virtual device.<br/>    |
...
The **Msvm\_ExternalFcPort** class has these properties.
...
If this property is **True**, this Fibre Channel port can be connected to the switches and thus can provide connectivity to a virtual machine. If this property is **False**, then this port cannot be used by the virtual machine Fibre Channel architecture.
...
The world wide node name for this Fibre Channel port.
...
The world wide port name for this Fibre Channel port.
