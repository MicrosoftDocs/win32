---
description: RequestStateChange method of the Msvm_TerminalService class - Requests a state change.
...
# RequestStateChange method of the Msvm\_TerminalService class
