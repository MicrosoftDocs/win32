...
Qualifiers: [**Override**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("OperationalStatus"), [**ArrayType**](https://docs.microsoft.com/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed")
</dt> </dl>
...
Access to the **Msvm\_ResourcePool** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://docs.microsoft.com/windows/desktop/WmiSdk/user-account-control-and-wmi).
...
[**Msvm\_ResourcePool (V1)**](https://docs.microsoft.com/previous-versions/windows/desktop/virtual/msvm-resourcepool)
</dt> <dt>
