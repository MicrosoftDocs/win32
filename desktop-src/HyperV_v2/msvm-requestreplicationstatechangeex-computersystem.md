...
A string representation of an embedded instance of the [**Msvm\_ReplicationRelationship**](msvm-replicationrelationship.md) class that defines the replication relationship for state change request. This parameter is optional. When it's unspecified, the request runs on the primary replication relationship.
