...
An abstract class that represents settings for a specific feature of a system or component.
...
The **Msvm\_FeatureSettingData** class has these types of members:

-   [Properties](#properties)

### Properties

The **Msvm\_FeatureSettingData** class has these properties.
