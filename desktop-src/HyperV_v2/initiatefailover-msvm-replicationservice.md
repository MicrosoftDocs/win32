...
A reference to a [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219) instance that represents the virtual machine for which to initiate a failover.
...
A reference to a [**CIM\_VirtualSystemSettingData**](https://msdn.microsoft.com/library/cc136954) instance that represents the snapshot used for the failover. If this parameter is **Null**, the failover is to be performed to the latest point in time.
