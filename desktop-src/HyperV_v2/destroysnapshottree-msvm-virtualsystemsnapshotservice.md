...
A [**CIM\_VirtualSystemSettingData**](https://msdn.microsoft.com/library/cc136954) reference that represents the virtual machine snapshot tree to destroy.
...
[**RemoveVirtualSystemSnapshotTree (V1)**](https://msdn.microsoft.com/library/cc160712)
</dt> </dl>
