---
description: RequestStateChange method of the Msvm_IDEController class - Requests a state change.
...
# RequestStateChange method of the Msvm\_IDEController class
