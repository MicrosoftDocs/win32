...
| Method                                                           | Description                                                                          |
|:-----------------------------------------------------------------|:-------------------------------------------------------------------------------------|
| [**GetError**](cim-concretejob-geterror.md)                     | Retrieves error information for the operational status of a concrete job.<br/> |
| [**RequestStateChange**](cim-concretejob-requeststatechange.md) | Requests the specified state change to a concrete job.<br/>                    |
