...
The **Msvm\_Physical3dGraphicsProcessor** class has these types of members:
...
The **Msvm\_Physical3dGraphicsProcessor** class has these methods.
...
The **Msvm\_Physical3dGraphicsProcessor** class has these properties.
