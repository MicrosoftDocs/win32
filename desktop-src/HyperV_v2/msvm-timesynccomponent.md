...
| [**RequestStateChange**](msvm-timesynccomponent-requeststatechange.md) | Requests a state change.<br/>      |
| [**Reset**](msvm-timesynccomponent-reset.md)                           | Resets the component.<br/>         |
...
An administrator's default or startup configuration for the **EnabledState** of an element. This property is inherited from [**CIM\_EnabledLogicalElement**](https://docs.microsoft.com/previous-versions//cc136818(v=vs.85)).
...
The enabled and disabled states of an element. This property is inherited from [**CIM\_EnabledLogicalElement**](https://docs.microsoft.com/previous-versions//cc136818(v=vs.85)) and is either set to 2 (Enabled) or 3 (Disabled).
...
Access to the **Msvm\_TimeSyncComponent** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://docs.microsoft.com/windows/desktop/WmiSdk/user-account-control-and-wmi).
