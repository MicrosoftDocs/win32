...
The buffering and other capabilities of the serial controller that might be inherent in the chip hardware. This property is inherited from [**CIM\_SerialController**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-serialcontroller).
...
An array of free-form strings that provides more detailed explanations for any of the serial controller features that are indicated in the **Capabilities** array. This property is inherited from [**CIM\_SerialController**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-serialcontroller).
...
The maximum baud rate, in bits per second, that is supported by the serial controller. This property is inherited from [**CIM\_SerialController**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-serialcontroller).
...
The enabled or disabled state of the element when the **EnabledState** property is set to 1 (Other). This property must be set to **Null** when **EnabledState** is any value other than 1. This property is inherited from [**CIM\_EnabledLogicalElement**](https://docs.microsoft.com/previous-versions//cc136818(v=vs.85)).
...
The operational security for the controller. This property is inherited from [**CIM\_SerialController**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-serialcontroller).
...
The last time the controller was powered on. This property is inherited from [**CIM\_Controller**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-controller).
...
Access to the **Msvm\_SerialController** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://docs.microsoft.com/windows/desktop/WmiSdk/user-account-control-and-wmi).
...
[**CIM\_SerialController**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-serialcontroller)
</dt> <dt>
