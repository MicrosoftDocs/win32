...
Qualifiers: [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("[**Msvm\_VirtualSystemMigrationSettingData**](msvm-virtualsystemmigrationsettingdata.md).**MigrationType**")
</dt> </dl>
...
Describes the recovery action to be taken for an unsuccessfully run job. This property is inherited from [**CIM\_Job**](https://msdn.microsoft.com/library/aa387873).
