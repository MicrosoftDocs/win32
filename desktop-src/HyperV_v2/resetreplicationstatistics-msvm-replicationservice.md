...
title: ResetReplicationStatistics method of the Msvm\_ReplicationService class
ms.date: 05/31/2018
ms.topic: article
...
A reference to an instance of the [**CIM\_ComputerSystem**](https://msdn.microsoft.com/library/aa387219) class that represents the virtual machine to reset the replication statistics for.
