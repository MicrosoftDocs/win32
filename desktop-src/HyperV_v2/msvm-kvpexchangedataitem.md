...
| <dl> <dt>"OSEditionId"</dt> </dl>                | A string representing the edition (SKU) of the guest virtual machine operating system. For a list of possible values, see the [**GetProductInfo**](https://msdn.microsoft.com/library/windows/desktop/ms724358) function.<br/>                                                                                                                                                                                                                                                                                                                                    |
