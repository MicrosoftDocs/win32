...
The number of bits used to display each pixel. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
The current number of horizontal pixels. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
The number of colors supported at the current resolutions. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
If in character mode, the number of columns for this display controller. Otherwise, 0. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
If in character mode, the number of rows for this video controller. Otherwise, 0. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
The current refresh rate, in hertz. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
The current scan mode. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
The current number of vertical pixels. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
This property is inherited from [**CIM\_LogicalDevice**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-logicaldevice), and it is set to "Microsoft:*GUID*\\Head\\*Index*".
...
The maximum refresh rate of the display controller, in hertz. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
The minimum refresh rate of the video controller, in hertz. This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)).
...
The current scan mode when the instance's **CurrentScanMode** property is 1 (Other). This property is inherited from [**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85)) and it is set to **Null**.
...
The last requested or desired state for the element. The actual state of the element is represented by **EnabledState**. This property is inherited from [**CIM\_EnabledLogicalElement**](https://docs.microsoft.com/previous-versions//cc136818(v=vs.85)).
...
A string that specifies the current status of the object. This property is inherited from [**CIM\_ManagedSystemElement**](https://docs.microsoft.com/windows/desktop/CIMWin32Prov/cim-managedsystemelement), but it is not used.
...
Access to the **Msvm\_VideoHead** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](https://docs.microsoft.com/windows/desktop/WmiSdk/user-account-control-and-wmi).
...
[**CIM\_VideoHead**](https://docs.microsoft.com/previous-versions//cc136948(v=vs.85))
</dt> <dt>
