...
A reference to a [**CIM\_VirtualSystemSettingData**](https://msdn.microsoft.com/library/cc136954) object that represents the affected virtual machine configuration.
...
An array of strings that contain one embedded instance of the [**CIM\_ResourceAllocationSettingData**](https://msdn.microsoft.com/library/mt146214) class that describes the virtual aspects of a virtual resource to be added to the virtual machine.
