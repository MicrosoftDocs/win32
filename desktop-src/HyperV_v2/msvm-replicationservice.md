...
The **Msvm\_ReplicationService** class has these types of members:
...
The **Msvm\_ReplicationService** class has these methods.
...
| [**SetAuthorizationEntry**](setauthorizationentry-msvm-replicationservice.md)                         | Sets the replication authorization entry for a virtual machine.<br/>                                                                                                                                                                                                                    |
| [**SetFailoverNetworkAdapterSettings**](setfailovernetworkadaptersettings-msvm-replicationservice.md) | Configures the network adapter's IP settings to be applied to a virtual machine after a failover.<br/>                                                                                                                                                                                  |
| [**StartReplication**](startreplication-msvm-replicationservice.md)                                   | Starts the replication of a virtual machine.<br/>                                                                                                                                                                                                                                       |
| [**StartService**](msvm-replicationservice-startservice.md)                                           | Starts the service.<br/>                                                                                                                                                                                                                                                                |
| [**StopService**](msvm-replicationservice-stopservice.md)                                             | Stops the service.<br/>                                                                                                                                                                                                                                                                 |
| [**TestReplicaSystem**](testreplicasystem-msvm-replicationservice.md)                                 | Creates a new replica of a virtual machine with the specified snapshot for testing purposes.<br/>                                                                                                                                                                                       |
| [**TestReplicationConnection**](testreplicationconnection-msvm-replicationservice.md)                 | Verifies if the replication can be enabled from the current host system to the specified recovery system.<br/>                                                                                                                                                                          |
...
The **Msvm\_ReplicationService** class has these properties.
...
Indicates the possible values for the *RequestedState* parameter. This property is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/cc136818), and it is always set to **Null**.
...
A short description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Hyper-V Replica Service".
...
The name of the class or subclass used in the creation of an instance. This property is inherited from [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442), and it is always set to "Msvm\_ReplicationService".
...
A description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Replication Service".
...
The enabled and disabled states of an element. It can also indicate the transitions between these requested states. This property is inherited from [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/cc136818), and it is always set to 2 (Enabled).
...
Uniquely identifies an instance of this class. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to **Null**.
...
The label by which the object is known. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898), and it is always set to "replicasvc".
...
An array that contains the current statuses of the object. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898). The value at index zero will be one of the following values.



| Value                                                                                                                                                                                                               | Meaning                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| <span id="OK"></span><span id="ok"></span><dl> <dt>**OK**</dt> <dt>2</dt> </dl>                                  | The replication service is operating normally.<br/>                                                                     |
| <span id="Error"></span><span id="error"></span><span id="ERROR"></span><dl> <dt>**Error**</dt> <dt>6</dt> </dl> | One or more replication network listeners are not running. Verify that the replication service settings are valid.<br/> |
...
The last requested or desired state for the element. The actual state of the element is represented by **EnabledState**. This property is provided to compare the last requested and current states for an element. A particular instance of the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/cc136818) class might not support the **RequestedState** property. If this occurs, the value 12 ("Not Applicable") is used. This property is inherited from **CIM\_EnabledLogicalElement**, and it is always set to 12 (Not Applicable).
...
Indicates the status of the element. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898), and it is always set to "OK".
