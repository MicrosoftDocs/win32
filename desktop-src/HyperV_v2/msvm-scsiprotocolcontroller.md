...
The maximum number of units that can be controlled by or accessed through this protocol controller. This property is inherited from [**CIM\_ProtocolController**](https://msdn.microsoft.com/library/mt432251).
...
Identifies how the name of the SCSI protocol controller is selected. This property is inherited from [**CIM\_SCSIProtocolController**](https://msdn.microsoft.com/library/mt432251).
...
A string that describes how the protocol controller is identified when the **NameFormat** is 1 (Other). This property is inherited from [**CIM\_SCSIProtocolController**](https://msdn.microsoft.com/library/mt432251).
