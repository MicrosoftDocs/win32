...
Access to the **Msvm\_TerminalConnection** class might be restricted by UAC Filtering. For more information, see [User Account Control and WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
...
[**CIM\_EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85))
</dt> <dt>
