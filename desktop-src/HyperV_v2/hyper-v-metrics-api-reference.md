...
| [**Msvm\_MetricDefForME**](msvm-metricdefforme.md)<br/>                           | Defines the association between an [**Msvm\_BaseMetricDefinition**](msvm-basemetricdefinition.md) and a [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218) to define metrics for the latter. The metrics definition is given context by the ManagedElement, which is why the definition is dependent on the element.<br/> |
