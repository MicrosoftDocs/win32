...
A description of the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Service for creating, manipulating, and managing virtual machines".
...
A display name for the object. This property is inherited from [**CIM\_ManagedElement**](https://msdn.microsoft.com/library/mt432218), and it is always set to "Hyper-V Virtual System Management Service".
...
The label by which the object is known. This property is inherited from [**CIM\_ManagedSystemElement**](https://msdn.microsoft.com/library/aa387898), and it is always set to "vmms".
...
[**Msvm\_VirtualSystemManagementService (V1)**](https://msdn.microsoft.com/library/cc136940)
</dt> <dt>
