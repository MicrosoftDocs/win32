...
Describes the synthetic 3-D GPU service.
...
The **Msvm\_Synthetic3DService** class has these types of members:
...
The **Msvm\_Synthetic3DService** class has these methods.



| Method                                                                                     | Description                                                         |
|:-------------------------------------------------------------------------------------------|:--------------------------------------------------------------------|
| [**DisableGPUForVirtualization**](disablegpuforvirtualization-msvm-synthetic3dservice.md) | Disables a physical GPU for virtualization.<br/>              |
| [**EnableGPUForVirtualization**](enablegpuforvirtualization-msvm-synthetic3dservice.md)   | Enables a physical GPU for virtualization.<br/>               |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-synthetic3dservice.md)             | Modifies the setting data for the synthetic 3-D service.<br/> |
...
The **Msvm\_Synthetic3DService** class has these properties.
...
The last requested or desired state for the element. The actual state of the element is represented by **EnabledState**. This property is provided to compare the last requested and current enabled or disabled states. A particular instance of the [**CIM\_EnabledLogicalElement**](https://msdn.microsoft.com/library/cc136818) class might not support the **RequestStateChange** method. If this occurs, the value 12 (Not Applicable) is used. This property is inherited from **CIM\_EnabledLogicalElement**.
