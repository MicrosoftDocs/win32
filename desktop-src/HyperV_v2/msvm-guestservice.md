...
**Msvm\_GuestService** is the abstract base class for services in the guest that can be accessed from the host. This class derives from the [**CIM\_Service**](https://msdn.microsoft.com/library/aa388442) class.
