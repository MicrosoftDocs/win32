...
Adds an authorization entry to a recovery server. These entries are used for authorizing connections to the recovery server.
...
A string representation of an instance of the [**Msvm\_ReplicationAuthorizationSettingData**](msvm-replicationauthorizationsettingdata.md) class that defines the authorization entry to be added.
