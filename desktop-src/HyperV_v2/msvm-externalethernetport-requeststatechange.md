---
description: RequestStateChange method of the Msvm_ExternalEthernetPort class - Requests a state change.
...
# RequestStateChange method of the Msvm\_ExternalEthernetPort class
