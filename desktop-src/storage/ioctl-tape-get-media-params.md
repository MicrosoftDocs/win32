...
description: Returns information about the medias total and remaining capacity, its block size, the number of partitions, and whether it is write-protected.
