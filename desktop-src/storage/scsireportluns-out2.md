...
description: The ScsiReportLuns\_OUT structure is used to report the output parameter data of the ScsiReportLuns WMI method to the WMI client.
ms.assetid: 93663b88-e750-4280-b5c1-798cc0f848b7
keywords:
- ScsiReportLuns_OUT structure Storage Devices
- PScsiReportLuns_OUT structure pointer Storage Devices
topic_type:
- apiref
api_name:
- ScsiReportLuns_OUT
...
The ScsiReportLuns\_OUT structure is used to report the output parameter data of the [**ScsiReportLuns**](https://msdn.microsoft.com/library/windows/hardware/ff564911) WMI method to the WMI client.
...
The WMI tool suite generates a declaration of the ScsiReportLuns\_OUT structure in *Hbapiwmi.h* when it compiles the [MSFC\_HBAAdapterMethods WMI Class](https://msdn.microsoft.com/library/windows/hardware/ff562506).
