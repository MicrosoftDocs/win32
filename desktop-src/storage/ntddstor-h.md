...
<td>Describes diagnostic data about the storage driver stack. The <strong>STORAGE_DIAGNOSTIC_DATA</strong> structure is provided in the output buffer of an [<strong>IOCTL_STORAGE_DIAGNOSTIC</strong>](https://www.bing.com/search?q=<strong>IOCTL_STORAGE_DIAGNOSTIC</strong>) request.<br/></td>
</tr>
<tr class="even">
...
<td>Describes a diagnostic request about the storage driver stack. The <strong>STORAGE_DIAGNOSTIC_REQUEST</strong> structure is provided in the input buffer of an [<strong>IOCTL_STORAGE_DIAGNOSTIC</strong>](https://www.bing.com/search?q=<strong>IOCTL_STORAGE_DIAGNOSTIC</strong>) request.<br/></td>
</tr>
<tr class="odd">
