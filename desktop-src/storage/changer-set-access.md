...
description: The CHANGER\_SET\_ACCESS structure is used in conjunction with theIOCTL\_CHANGER\_SET\_ACCESS request to set the state of the devices import/export port (IEport), door, or keypad.
