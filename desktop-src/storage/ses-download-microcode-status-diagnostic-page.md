...
keywords:
- SES_DOWNLOAD_MICROCODE_STATUS_DIAGNOSTIC_PAGE structure Storage Devices
...
Indicates the number of download microcode status descriptors in *Descriptors*, not including the primary [**SES\_DOWNLOAD\_MICROCODE\_STATUS\_DESCRIPTOR**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_STATUS\_DESCRIPTOR**). This value shall be set to the same value as the *NumberOfSecondarySubEnclosures* field in the [**SES\_CONFIGURATION\_DIAGNOSTIC\_PAGE**](ses-configuration-diagnostic-page.md) structure.
...
Contains a [**SES\_DOWNLOAD\_MICROCODE\_STATUS\_DESCRIPTOR**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_STATUS\_DESCRIPTOR**) for each download microcode operation where status is being reported.
