...
keywords: ["STORAGE_DIAGNOSTIC_DATA structure Storage Devices", "PSTORAGE_DIAGNOSTIC_DATA structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
...
Describes diagnostic data about the storage driver stack. The **STORAGE\_DIAGNOSTIC\_DATA** structure is provided in the output buffer of an [**IOCTL\_STORAGE\_DIAGNOSTIC**](storage-ioctl_storage_diagnostic) request.
