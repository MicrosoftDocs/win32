...
description: The HBA\_GetEventBuffer routine retrieves the indicated number of events, if available, from the HBA's event queue.
ms.assetid: '0f06b154-7d85-4a60-b354-bd61fbc597dc'
keywords: ["HBA_GetEventBuffer routine Storage Devices"]
topic_type:
- apiref
api_name:
- HBA_GetEventBuffer
