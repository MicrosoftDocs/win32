...
description: HwScsiEnableInterruptsCallback is called after a miniport driver's HwScsiInterrupt routine disables interrupts on the HBA and calls ScsiPortNotification with the NotificationTypeCallEnableInterrupts.
ms.assetid: 'b62709b2-aa90-4bb1-9c17-edb3b489b696'
keywords: ["HwScsiEnableInterruptsCallback routine Storage Devices", "PHW_INTERRUPT"]
topic_type:
- apiref
api_name:
