...
keywords: ["WINDOWS_BLOCK_DEVICE_TOKEN_LIMITS_DESCRIPTOR structure Storage Devices", "PWINDOWS_BLOCK_DEVICE_TOKEN_LIMITS_DESCRIPTOR structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
