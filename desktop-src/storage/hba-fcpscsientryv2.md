...
keywords: ["HBA_FcpScsiEntryV2 structure Storage Devices", "HBA_FCPSCSIENTRYV2 structure Storage Devices", "PHBA_FCPSCSIENTRYV2 structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
- HBA_FCPSCSIENTRYV2
