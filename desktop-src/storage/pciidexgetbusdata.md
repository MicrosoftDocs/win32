...
description: The PciIdeXGetBusData routine retrieves data from the location specified by ConfigDataOffset within the device's PCI configuration space.
ms.assetid: 'bc233c05-9412-4bdb-9466-481bf53aff6c'
keywords: ["PciIdeXGetBusData routine Storage Devices"]
topic_type:
- apiref
api_name:
- PciIdeXGetBusData
