...
description: The UFS (Universal Flash Storage) data type. Describes the type of UFS specific data that's to be queried during an IOCTL\_STORAGE\_QUERY\_PROPERTY request.
ms.assetid: 'A4324FAD-A925-4D65-9697-9CC2878DBE0B'
keywords: ["STORAGE_PROTOCOL_UFS_DATA_TYPE enumeration Storage Devices"]
topic_type:
- apiref
api_name:
