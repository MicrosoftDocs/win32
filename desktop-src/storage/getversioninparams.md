...
keywords: ["GETVERSIONINPARAMS structure Storage Devices", "PGETVERSIONINPARAMS structure pointer Storage Devices", "LPGETVERSIONINPARAMS structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
- GETVERSIONINPARAMS
