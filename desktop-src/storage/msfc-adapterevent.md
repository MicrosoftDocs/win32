...
description: The MSFC\_AdapterEvent structure is used by HBA miniport drivers that support the T11 committees Fibre Channel HBA API specification to report adapter events to WMI clients that have registered to be notified of these events.
