...
The **STOR\_POFX\_DEVICE\_V2** structure describes the power attributes of a storage device to the power management framework (PoFx). This structure is similar to [**STOR\_POFX\_DEVICE**](stor-pofx-device.md) but contains additional timeout settings.
...
| <span id="STOR_POFX_DEVICE_FLAG_IDLE_TIMEOUT"></span><span id="stor_pofx_device_flag_idle_timeout"></span><dl> <dt>**STOR\_POFX\_DEVICE\_FLAG\_IDLE\_TIMEOUT**</dt> </dl>        | The timeout value in **UnitMinIdleTimeoutInMS** or **AdapterIdleTimeoutInMS** is used for the D3 idle timeout.<br/>                                                                                                                  |
