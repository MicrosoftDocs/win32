...
| <dl> <dt>0x13</dt> </dl>          | Download microcode operation complete with no error. The enclosure services process (e.g., an attached enclosure services process) begins using the new microcode after either processing a [**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**) specifying the activate deferred microcode mode, hard reset, or power on.<br/> |
...
| <dl> <dt>0x00</dt> </dl>          | Processed a [**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**) with the *Mode* field set to 0x0F (i.e., activate deferred microcode), if there is no deferred microcode.<br/>                                                                                                                                                 |
...
Indicates the maximum size in bytes of the microcode image that the enclosure services process accepts. The image may be delivered using one or more [**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**).
...
Indicates the next value that the enclosure services process expects in the *BufferId* field in [**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**).
...
Indicates the next value that the enclosure services process expects in the *BufferOffset* field in [**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**). If the enclosure services process accepts arbitrary *BufferOffset* values, then it shall set *ExpectedBufferOffset* to 0xFFFFFFFF.
...
[**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**](https://www.bing.com/search?q=**SES\_DOWNLOAD\_MICROCODE\_CONTROL\_DIAGNOSTIC\_PAGE**)
</dt> </dl>
