...
keywords: ["SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR structure Storage Devices", "PSES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
