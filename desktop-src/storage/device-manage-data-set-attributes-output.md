...
keywords: ["DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT structure Storage Devices", "PDEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
