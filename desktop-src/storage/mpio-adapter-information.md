...
description: The MPIO\_ADAPTER\_INFORMATION structure contains information that pertains to MPIO's view of a path.
ms.assetid: 'bcf159a7-75a5-46aa-897a-2c5eb00f51d8'
keywords: ["MPIO_ADAPTER_INFORMATION structure Storage Devices", "PMPIO_ADAPTER_INFORMATION structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
