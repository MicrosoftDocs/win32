...
description: The DSM\_QueryLBPolicy\_V2 structure is used to query a LUNs current load balance policy. It is basically the same as the DSM\_QueryLBPolicy structure except that it returns the load balance information by using the DSM\_Load\_Balance\_Policy\_V2 structure.
ms.assetid: f02f3442-e9c2-4f60-833d-e470de62118e
keywords:
- DSM_QueryLBPolicy_V2 structure Storage Devices
- PDSM_QueryLBPolicy_V2 structure pointer Storage Devices
topic_type:
- apiref
api_name:
