...
keywords: ["IOCTL_STORAGE_GET_PHYSICAL_ELEMENT_STATUS control code Storage Devices"]
topic_type:
- apiref
api_name:
...
A pointer to an input buffer that receives a [**PHYSICAL\_ELEMENT\_STATUS\_REQUEST**](storage-physical_element_status_request) structure which defines the starting element to look for the physical element status of a device.
...
A pointer to an output buffer that contains a [**PHYSICAL\_ELEMENT\_STATUS**](storage-physical_element_status) structure which defines the physical element status from a device.
...
[**PHYSICAL\_ELEMENT\_STATUS**](storage-physical_element_status)
</dt> <dt>

[**PHYSICAL\_ELEMENT\_STATUS\_REQUEST**](storage-physical_element_status_request)
</dt> </dl>
