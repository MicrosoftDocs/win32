---
title: IOCTL\_DVD\_END\_SESSION control code
...
keywords: ["IOCTL_DVD_END_SESSION control code Storage Devices"]
topic_type:
- apiref
api_name:
...
# IOCTL\_DVD\_END\_SESSION control code
