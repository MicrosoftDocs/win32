...
description: Returns information about the physical disks geometry (media type, number of cylinders, tracks per cylinder, sectors per track, and bytes per sector).
ms.assetid: 571308bc-1e8e-437a-8819-8b28251a3f03
keywords:
- IOCTL_DISK_GET_DRIVE_GEOMETRY control code Storage Devices
topic_type:
- apiref
api_name:
