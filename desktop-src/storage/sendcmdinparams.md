...
keywords: ["SENDCMDINPARAMS structure Storage Devices", "PSENDCMDINPARAMS structure pointer Storage Devices", "LPSENDCMDINPARAMS structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
- SENDCMDINPARAMS
