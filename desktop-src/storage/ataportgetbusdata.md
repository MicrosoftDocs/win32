...
description: The AtaPortGetBusData routine retrieves data from the location that is specified by ConfigDataOffset within the devices PCI configuration space.Note The ATA port driver and ATA miniport driver models may be altered or unavailable in the future.
ms.assetid: bfff10ab-7e15-4db3-b808-947d61844bc0
keywords:
- AtaPortGetBusData routine Storage Devices
topic_type:
- apiref
api_name:
- AtaPortGetBusData
