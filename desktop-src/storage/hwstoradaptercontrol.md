...
description: A miniport drivers HwStorAdapterControl routine is called to perform synchronous operations to control the state or behavior of an adapter, such as stopping or restarting the HBA for power management.
ms.assetid: e1944f1b-97db-4ac2-848e-e69359c09589
keywords:
- HwStorAdapterControl routine Storage Devices
- HW_ADAPTER_CONTROL
topic_type:
- apiref
api_name:
