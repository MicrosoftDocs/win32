...
description: The CHANGER\_SET\_POSITION structure is used in conjunction with theIOCTL\_CHANGER\_SET\_POSITION request to set the changer's robotic transport mechanism to the specified element address.
ms.assetid: '1c71473a-98db-41a1-9ca5-ce59f345b5f7'
keywords: ["CHANGER_SET_POSITION structure Storage Devices", "PCHANGER_SET_POSITION structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
