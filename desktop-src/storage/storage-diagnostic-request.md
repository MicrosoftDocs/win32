...
keywords:
- STORAGE_DIAGNOSTIC_REQUEST structure Storage Devices
- PSTORAGE_DIAGNOSTIC_REQUEST structure pointer Storage Devices
topic_type:
- apiref
api_name:
...
Describes a diagnostic request about the storage driver stack. The **STORAGE\_DIAGNOSTIC\_REQUEST** structure is provided in the input buffer of an [**IOCTL\_STORAGE\_DIAGNOSTIC**](https://www.bing.com/search?q=**IOCTL\_STORAGE\_DIAGNOSTIC**) request.
