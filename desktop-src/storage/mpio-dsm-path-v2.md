...
description: The MPIO\_DSM\_Path\_V2 structure is used to represent the DSMs definition of a path. It is a superset of the previously existing MPIO\_DSM\_Path class.
ms.assetid: 8ebbb4c0-c761-42a5-a41a-9d661a6126d9
keywords:
- MPIO_DSM_Path_V2 structure Storage Devices
- PMPIO_DSM_Path_V2 structure pointer Storage Devices
topic_type:
- apiref
api_name:
- MPIO_DSM_Path_V2
