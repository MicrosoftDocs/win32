...
keywords: ["HBA_PortStatistics structure Storage Devices", "HBA_PORTSTATISTICS structure Storage Devices", "PHBA_PORTSTATISTICS structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
- HBA_PORTSTATISTICS
