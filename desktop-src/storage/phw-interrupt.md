...
description: The PHW\_INTERRUPT routine prototype declares the miniport driver's interrupt handler routine.
ms.assetid: 'd61892c6-f6ca-4077-909e-a21076375e5a'
keywords: ["( PHW_INTERRUPT) callback function Storage Devices"]
topic_type:
- apiref
api_name:
- ( PHW_INTERRUPT)
