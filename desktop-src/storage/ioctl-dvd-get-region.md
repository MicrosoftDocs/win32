...
description: Returns Region Playback Control (RPC) information for a DVD device, such as whether the player supports the RPC2 standard, the current region code of the player, and the remaining number of times the players region code can be changed by the user.
ms.assetid: 2c3d6962-1d72-47e7-aa7c-226e5a3aa3d4
keywords:
- IOCTL_DVD_GET_REGION control code Storage Devices
topic_type:
- apiref
api_name:
