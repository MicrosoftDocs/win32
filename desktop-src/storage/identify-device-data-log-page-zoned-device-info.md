...
keywords: ["IDENTIFY_DEVICE_DATA_LOG_PAGE_ZONED_DEVICE_INFO structure Storage Devices", "PIDENTIFY_DEVICE_DATA_LOG_PAGE_ZONED_DEVICE_INFO structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
