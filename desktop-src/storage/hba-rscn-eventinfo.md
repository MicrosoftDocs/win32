...
keywords: ["HBA_RSCN_EventInfo structure Storage Devices", "HBA_RSCN_EVENTINFO structure Storage Devices", "PHBA_RSCN_EVENTINFO structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
- HBA_RSCN_EVENTINFO
