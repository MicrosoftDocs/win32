...
keywords: ["FEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE structure Storage Devices", "PFEATURE_DATA_DVD_RW_RESTRICTED_OVERWRITE structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
