---
title: IOCTL\_AACS\_READ\_MEDIA\_ID control code
...
keywords: ["IOCTL_AACS_READ_MEDIA_ID control code Storage Devices"]
topic_type:
- apiref
api_name:
...
# IOCTL\_AACS\_READ\_MEDIA\_ID control code
...
The buffer at **Irp-&gt;AssociatedIrp.SystemBuffer** contains the value of type [**AACS\_MEDIA\_ID**](aacs-media-id.md) that specifies the media ID.

## Output Buffer Length

Length of a [**AACS\_MEDIA\_ID**](aacs-media-id.md).
