...
description: The PciIdeXSetBusData routine stores data in Buffer at an offset specified in ConfigDataOffset within the device's PCI configuration space.
ms.assetid: '1fd23ba3-aae6-4ae6-9e5c-1f896e3a6198'
keywords: ["PciIdeXSetBusData routine Storage Devices"]
topic_type:
- apiref
api_name:
- PciIdeXSetBusData
