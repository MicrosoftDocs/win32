...
description: The MPIO\_DSM\_Path structure is used to represent the DSM's definition of a path.
ms.assetid: '17338526-d682-4d11-89b9-730b1a275870'
keywords: ["MPIO_DSM_Path structure Storage Devices", "PMPIO_DSM_Path structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
- MPIO_DSM_Path
