...
description: Sets the changers robotic transport mechanism to the specified element address, typically to optimize moving or exchanging media by positioning the transport beforehand.
ms.assetid: cd4f5872-d2cb-42ee-b78c-6b7d48d41e34
keywords:
- IOCTL_CHANGER_SET_POSITION control code Storage Devices
topic_type:
- apiref
api_name:
