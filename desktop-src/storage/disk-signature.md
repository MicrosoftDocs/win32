...
description: DISK\_SIGNATURE contains the disk signature information for a disks partition table.
ms.assetid: f3fdb436-53b6-4fb3-8746-1f852f7d928a
keywords:
- DISK_SIGNATURE structure Storage Devices
- PDISK_SIGNATURE structure pointer Storage Devices
topic_type:
- apiref
api_name:
- DISK_SIGNATURE
