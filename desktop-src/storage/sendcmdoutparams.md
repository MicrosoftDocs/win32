...
keywords: ["SENDCMDOUTPARAMS structure Storage Devices", "PSENDCMDOUTPARAMS structure pointer Storage Devices", "LPSENDCMDOUTPARAMS structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
- SENDCMDOUTPARAMS
