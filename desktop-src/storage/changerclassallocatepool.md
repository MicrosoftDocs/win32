...
keywords: ["ChangerClassAllocatePool function Storage Devices"]
topic_type:
- apiref
api_name:
...
Indicates the type of pool memory to allocate. See [**POOL\_TYPE**](https://msdn.microsoft.com/library/windows/hardware/ff559707) for a list of types.
