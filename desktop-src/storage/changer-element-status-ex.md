...
<span id="ELEMENT_STATUS_FULL"></span><span id="element_status_full"></span>
...
The element contains a piece of media. This flag is valid if **ElementType** in the **Element** member is **ChangerDrive**, **ChangerSlot**, or **ChangerTransport**. If **ElementType** is **ChangerIEPort**, this flag is valid only if CHANGER\_REPORT\_IEPORT\_STATE is also set in **Features0** of [**GET\_CHANGER\_PARAMETERS**](get-changer-parameters.md).

</dd> <dt>

<span id="ELEMENT_STATUS_IMPEXP"></span><span id="element_status_impexp"></span>
...
<span id="ELEMENT_STATUS_EXCEPT"></span><span id="element_status_except"></span>
...
<span id="ELEMENT_STATUS_ACCESS"></span><span id="element_status_access"></span>
...
<span id="ELEMENT_STATUS_EXENAB"></span><span id="element_status_exenab"></span>
...
<span id="ELEMENT_STATUS_INENAB"></span><span id="element_status_inenab"></span>
...
<span id="ELEMENT_STATUS_LUN_VALID"></span><span id="element_status_lun_valid"></span>
...
<span id="ELEMENT_STATUS_ID_VALID"></span><span id="element_status_id_valid"></span>
...
<span id="ELEMENT_STATUS_NOT_BUS"></span><span id="element_status_not_bus"></span>
...
<span id="ELEMENT_STATUS_PRODUCT_DATA"></span><span id="element_status_product_data"></span>

<span id="ELEMENT_STATUS_PRODUCT_DATA"></span><span id="element_status_product_data"></span>**ELEMENT\_STATUS\_PRODUCT\_DATA**
...
<span id="ELEMENT_STATUS_INVERT"></span><span id="element_status_invert"></span>
...
<span id="ELEMENT_STATUS_SVALID"></span><span id="element_status_svalid"></span>
...
<span id="ELEMENT_STATUS_PVOLTAG"></span><span id="element_status_pvoltag"></span>
...
<span id="ELEMENT_STATUS_AVOLTAG"></span><span id="element_status_avoltag"></span>
...
<span id="ERROR_LABEL_UNREADABLE"></span><span id="error_label_unreadable"></span>
...
<span id="ERROR_LABEL_QUESTIONABLE"></span><span id="error_label_questionable"></span>
...
<span id="ERROR_SLOT_NOT_PRESENT"></span><span id="error_slot_not_present"></span>
...
<span id="ERROR_DRIVE_NOT_INSTALLED"></span><span id="error_drive_not_installed"></span>
...
<span id="ERROR_TRAY_MALFUNCTION"></span><span id="error_tray_malfunction"></span>
...
<span id="ERROR_UNHANDLED_ERROR"></span><span id="error_unhandled_error"></span>
...
Contains the vendor ID. This identifier must be no larger than VENDOR\_ID\_LENGTH bytes.
...
Contains the product ID. This identifier must be no larger than PRODUCT\_ID\_LENGTH bytes.
...
Contains the serial number. This identifier must be no larger than SERIAL\_NUMBER\_LENGTH bytes.

</dd> </dl>

## Remarks

The [**ChangerGetElementStatus**](changergetelementstatus.md) routine returns status information in this structure if vendor, product, or serial number information is needed. Otherwise, **ChangerGetElementStatus** returns status information in the [**CHANGER\_ELEMENT\_STATUS**](changer-element-status.md) structure.
