...
description: The MSFC\_EventBuffer structure is used in conjunction with the GetEventBuffer method to retrieve the next events in the HBAs event queue.
ms.assetid: 7d41c092-251e-4f93-b5be-ff989b37196b
keywords:
- MSFC_EventBuffer structure Storage Devices
- PMSFC_EventBuffer structure pointer Storage Devices
topic_type:
- apiref
api_name:
- MSFC_EventBuffer
