...
keywords: ["RECEIVE_TOKEN_INFORMATION_RESPONSE_HEADER structure Storage Devices", "PRECEIVE_TOKEN_INFORMATION_RESPONSE_HEADER structure pointer Storage Devices"]
topic_type:
- apiref
api_name:
