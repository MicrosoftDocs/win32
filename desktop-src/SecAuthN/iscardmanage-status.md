...
title: ISCardManageStatus method
ms.date: 05/31/2018
ms.topic: article
...
The **Status** method gets the current status of the [*smart card*](security.s_gly#-security-smart-card-gly) or [*reader*](security.r_gly#-security-reader-gly).
