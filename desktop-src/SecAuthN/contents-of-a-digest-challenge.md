...
|-------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| realm             | An implementation-defined hint to the client about which [*credentials*](https://docs.microsoft.com/windows/desktop/SecGloss/c-gly) are required. The client should display this information to the user if it is prompting for credentials.                                                  |
...
| opaque            | Contains a reference for the [*security context*](https://docs.microsoft.com/windows/desktop/SecGloss/s-gly) that is being established. For more information, see [Maintaining the Security Context Between Connections](maintaining-the-security-context-between-connections.md). |
