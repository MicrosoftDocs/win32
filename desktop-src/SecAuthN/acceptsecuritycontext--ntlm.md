...
A pointer to a [**SecBufferDesc**](secbufferdesc.md) structure generated by a client call to [**InitializeSecurityContext (NTLM)**](initializesecuritycontext--ntlm.md) that contains the input buffer descriptor.
