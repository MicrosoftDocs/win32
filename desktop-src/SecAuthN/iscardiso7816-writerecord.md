...
The **WriteRecord** method constructs an [*application protocol data unit*](https://www.bing.com/search?q=*application protocol data unit*) (APDU) command that initiates one of the following operations:
