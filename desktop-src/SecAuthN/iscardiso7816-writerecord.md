...
The **WriteRecord** method constructs an [*application protocol data unit*](security.a_gly#-security-application-protocol-data-unit-gly) (APDU) command that initiates one of the following operations:
