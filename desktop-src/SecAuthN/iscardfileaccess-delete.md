...
title: ISCardFileAccessDelete method
ms.date: 05/31/2018
ms.topic: article
...
The **Delete** method deletes a file at a given location within the [*smart card*](security.s_gly#-security-smart-card-gly) file system.
