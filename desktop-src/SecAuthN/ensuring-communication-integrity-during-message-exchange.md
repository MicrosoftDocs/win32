...
After a [*security context*](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-context-gly) is established, the application can use the [message support](https://www.bing.com/search?q=message support) functions to transmit tamper-resistant messages.
