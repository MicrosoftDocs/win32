...
The **QueryContextAttributes (NTLM)** function enables a transport application to query the NTLM security package for certain [*attributes*](security.a_gly#-security-attribute-gly) of a security [*context*](security.c_gly#-security-context-gly).
