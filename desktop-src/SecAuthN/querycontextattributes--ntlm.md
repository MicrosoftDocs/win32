---
Description: 'Enables a transport application to query the NTLM security package for certain attributes of a security context.'
...
The **QueryContextAttributes (NTLM)** function enables a transport application to query the NTLM [*security package*](security.s_gly#-security-security-package-gly) for certain [*attributes*](security.a_gly#-security-attribute-gly) of a security [*context*](security.c_gly#-security-context-gly).
