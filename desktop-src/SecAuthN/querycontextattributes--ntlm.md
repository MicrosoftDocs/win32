---
description: Enables a transport application to query the NTLM [*security package*](../secgloss/s-gly.md) for certain attributes of a [security context](../secgloss/s-gly.md).
...
The **QueryContextAttributes (NTLM)** function enables a transport application to query the NTLM [*security package*](../secgloss/s-gly.md) for certain [*attributes*](../secgloss/a-gly.md#_security_attribute_gly) of a [security context](../secgloss/s-gly.md).
