...
1.  The application on the client side of the connection sends [*credentials*](security.c_gly#-security-credentials-gly) to the server using the SSPI function [**InitializeSecurityContext (General)**](/windows/desktop/api/Sspi/).
