...
As in other implementations of the [*Kerberos protocol*](security.k_gly#-security-kerberos-protocol-gly), the KDC is a single process that provides two services:
