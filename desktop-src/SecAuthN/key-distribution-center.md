...
As in other implementations of the [*Kerberos protocol*](https://msdn.microsoft.com/en-us/library/ms721590(v=VS.85).aspx), the KDC is a single process that provides two services:
