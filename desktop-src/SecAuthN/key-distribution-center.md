...
As in other implementations of the [*Kerberos protocol*](https://www.bing.com/search?q=*Kerberos protocol*), the KDC is a single process that provides two services:
