...
The following functions manage the [*smart card database*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50), updating the database by using a specified [*resource manager context*](https://msdn.microsoft.com/ce589e18-02ac-42c2-b76b-776deb686bbd).

> [!Note]  
> Database security is maintained by placing access restrictions on the database, rather than by adding security mechanisms to the [*smart card subsystem*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50).
...
| Topic                                                            | Description                                                                                                                                                             |
|------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**SCardAddReaderToGroup**](/windows/desktop/api/Winscard/nf-winscard-scardaddreadertogroupa)           | Add a [*reader*](https://msdn.microsoft.com/ce589e18-02ac-42c2-b76b-776deb686bbd) to a [*reader group*](https://msdn.microsoft.com/ce589e18-02ac-42c2-b76b-776deb686bbd). |
