...
| 3             | The [*service principal name*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx) (SPN) of the target server. | **SECBUFFER\_TARGET\_HOST** \| **SECBUFFER\_READONLY**      |
...
Supply buffer zero only. For compatibility with other SSPs, you may call [**InitializeSecurityContext (Digest)**](https://msdn.microsoft.com/en-us/library/Aa375505(v=VS.85).aspx) without a valid server challenge. In this case the *pInput* parameter should be set to **NULL**.
