...
[Cryptography API: Next Generation](https://msdn.microsoft.com/windows/desktop/eaad88a1-4e1d-4246-9560-8eef60f8b70f) (CNG) provides functions that query, add, remove, and prioritize the cipher suites that a provider supports. Changes made by using these functions take effect immediately and do not require restarting an active server.
...
Call the [**BCryptEnumContextFunctions**](https://msdn.microsoft.com/windows/desktop/81bdfd47-7001-4e63-a8b3-33dae99f2c66) function to list the cipher suites that a provider supports in order of priority.

The following example demonstrates how to use the [**BCryptEnumContextFunctions**](https://msdn.microsoft.com/windows/desktop/81bdfd47-7001-4e63-a8b3-33dae99f2c66) function to list supported cipher suites.
...
Call the [**BCryptAddContextFunction**](https://msdn.microsoft.com/windows/desktop/4f5b6db0-775d-42de-b9d9-a99fb11c89f2) and [**BCryptRemoveContextFunction**](https://msdn.microsoft.com/windows/desktop/b8b1df66-f66f-4efc-9c8e-fca32e0278c5) functions to add and remove cipher suites from the list of supported cipher suites.

When adding a cipher suite, set the value of the *dwPosition* parameter of the [**BCryptAddContextFunction**](https://msdn.microsoft.com/windows/desktop/4f5b6db0-775d-42de-b9d9-a99fb11c89f2) function to **CRYPT\_PRIORITY\_TOP** to add it to the top of the prioritized list, or to **CRYPT\_PRIORITY\_BOTTOM** to add it to the bottom of the list.
