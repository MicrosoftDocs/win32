...
For more information, see [Blog on using Fiddler web debugger with Windows Store apps](https://blogs.msdn.microsoft.com/b/fiddler/archive/2011/12/10/fiddler-windows-8-apps-enable-loopback-network-isolation-exemption.aspx).
