...
The **ListCardInterfaces** method retrieves the identifiers (GUIDs) of all the interfaces supported for the specified [*smart card*](https://www.bing.com/search?q=*smart card*).
...
To retrieve the [*primary service provider*](https://www.bing.com/search?q=*primary service provider*) of the smart card, call [**GetProviderCardId**](iscarddatabase-getprovidercardid.md).
