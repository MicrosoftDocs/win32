...
The **ListCardInterfaces** method retrieves the identifiers (GUIDs) of all the interfaces supported for the specified [*smart card*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx).
...
To retrieve the [*primary service provider*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx) of the smart card, call [**GetProviderCardId**](iscarddatabase-getprovidercardid.md).
