...
The following functions connect to and communicate with a specific [*smart card*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx). I/O operations to the card use a buffer for sending or receiving data and a structure that contains protocol control information. The protocol control information structure always begins with an [**SCARD\_IO\_REQUEST**](scard-io-request.md) structure.
...
| [**SCardBeginTransaction**](/windows/desktop/api/Winscard/nf-winscard-scardbegintransaction) | Start a [*transaction*](https://msdn.microsoft.com/en-us/library/ms721627(v=VS.85).aspx), blocking other applications from accessing a card.                                                                                            |
...
| [**SCardTransmit**](/windows/desktop/api/Winscard/nf-winscard-scardtransmit)                 | Requests service and receives data back from a card using [*T=0*](https://msdn.microsoft.com/en-us/library/ms721627(v=VS.85).aspx), [*T=1*](https://msdn.microsoft.com/en-us/library/ms721627(v=VS.85).aspx), and raw protocols. |
