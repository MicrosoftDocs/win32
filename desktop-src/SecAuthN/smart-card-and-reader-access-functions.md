...
The following functions connect to and communicate with a specific [*smart card*](https://www.bing.com/search?q=*smart card*). I/O operations to the card use a buffer for sending or receiving data and a structure that contains protocol control information. The protocol control information structure always begins with an [**SCARD\_IO\_REQUEST**](scard-io-request.md) structure.
...
| [**SCardBeginTransaction**](/windows/desktop/api/Winscard/nf-winscard-scardbegintransaction) | Start a [*transaction*](https://www.bing.com/search?q=*transaction*), blocking other applications from accessing a card.                                                                                            |
...
| [**SCardTransmit**](/windows/desktop/api/Winscard/nf-winscard-scardtransmit)                 | Requests service and receives data back from a card using [*T=0*](https://www.bing.com/search?q=*T=0*), [*T=1*](https://www.bing.com/search?q=*T=1*), and raw protocols. |
