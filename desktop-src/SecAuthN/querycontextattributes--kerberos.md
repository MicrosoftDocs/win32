...
The **QueryContextAttributes (Kerberos)** function enables a transport application to query the Kerberos [*security package*](security.s_gly#-security-security-package-gly) for certain [*attributes*](security.a_gly#-security-attribute-gly) of a [*security context*](security.s_gly#-security-security-context-gly).
