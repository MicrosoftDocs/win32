---
Description: Enables a transport application to query the Kerberos [*security package*](https://docs.microsoft.com/windows/win32/secgloss/s-gly) for certain attributes of a [*security context*](https://docs.microsoft.com/windows/win32/secgloss/s-gly).
