---
description: Learn about TLS cipher suites in Windows 10 v22H2. Cipher suites can only be negotiated for TLS versions which support them.
title: TLS Cipher Suites in Windows 10 v22H2
ms.topic: article
ms.date: 07/13/2023
---

# TLS Cipher Suites in Windows 10 v22H2
...
For Windows 10, version v22H2, the following cipher suites are enabled and in this priority order by default using the Microsoft Schannel Provider:
