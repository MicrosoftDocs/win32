...
Applications interested in receiving advance and after-the-fact notification of connection events must supply a DLL that exports two functions, [**AddConnectNotify**](addconnectnotify.md) and [**CancelConnectNotify**](cancelconnectnotify.md).
