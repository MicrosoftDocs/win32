...
The **GetProviderCardId** method retrieves the identifier (GUID) of the [*primary service provider*](security.p_gly#-security-primary-service-provider-gly) for the specified [*smart card*](security.s_gly#-security-smart-card-gly).
