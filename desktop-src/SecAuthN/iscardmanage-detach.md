...
title: ISCardManageDetach method
ms.date: 05/31/2018
ms.topic: article
...
The **Detach** method releases the attachment to a particular [*smart card*](security.s_gly#-security-smart-card-gly) or [*reader*](security.r_gly#-security-reader-gly) allocated by [**AttachByHandle**](iscardmanage-attachbyhandle.md) and [**AttachByIFD**](iscardmanage-attachbyifd.md) respectively.
