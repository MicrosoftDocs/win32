...
The **Detach** method releases the attachment to a particular [*smart card*](https://www.bing.com/search?q=*smart card*) or [*reader*](https://www.bing.com/search?q=*reader*) allocated by [**AttachByHandle**](iscardmanage-attachbyhandle.md) and [**AttachByIFD**](iscardmanage-attachbyifd.md) respectively.
