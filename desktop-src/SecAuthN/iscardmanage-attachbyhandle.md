...
The **AttachByHandle** method creates a communication link to a [*smart card*](https://www.bing.com/search?q=*smart card*) (ICC) using a handle returned by the smart card [*resource manager*](https://www.bing.com/search?q=*resource manager*).
...
To attach a [*reader*](https://www.bing.com/search?q=*reader*) call [**AttachByIFD**](iscardmanage-attachbyifd.md).
...
In addition to the COM error codes listed above, this interface may return a smart card error code if a smart card function was called to complete the request. For information about smart card error codes, see [Smart Card Return Values](https://www.bing.com/search?q=Smart Card Return Values).
