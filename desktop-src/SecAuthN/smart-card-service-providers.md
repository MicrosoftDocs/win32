...
Smart Card Service Providers (SCSP) provide access to [*Smart Card*](https://msdn.microsoft.com/library/ms721625(v=VS.85).aspx) capabilities. They can provide access to a single capability, such as the base service providers provided by the Smart Card SDK, or they can provide access to several capabilities to accomplish a more complex task.
