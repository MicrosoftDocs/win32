...
| <span id="WLX_SAS_TYPE_SC_INSERT"></span><span id="wlx_sas_type_sc_insert"></span><dl> <dt>**WLX\_SAS\_TYPE\_SC\_INSERT**</dt> </dl>                      | Indicates that a [*smart card*](https://www.bing.com/search?q=*smart card*) has been inserted into a compatible device.<br/> |
