...
[*Winlogon*](https://www.bing.com/search?q=*Winlogon*), the [*GINA*](https://www.bing.com/search?q=*GINA*), and network providers are the parts of the interactive logon model. The interactive logon procedure is normally controlled by Winlogon, MSGina.dll, and network providers. To change the interactive logon procedure, MSGina.dll can be replaced with a customized GINA DLL.

To work with Winlogon, the GINA, and network providers, you should have a firm knowledge of the Windows security architecture, especially with regard to [*tokens*](https://www.bing.com/search?q=*tokens*), [*authentication packages*](https://www.bing.com/search?q=*authentication packages*), and related matters.
...
For information about the authentication model supported by Windows and for details about the [*Local Security Authority*](https://www.bing.com/search?q=*Local Security Authority*) (LSA) services and [*authentication package*](https://www.bing.com/search?q=*authentication package*) interfaces, see [LSA Authentication](lsa-authentication.md).

For information about the aspects of the Local Security Authority that relate to the administration of security policy, which includes trust relationships with other computers and domains, assignment of privileges, audit generation control, system accessibility, and other similar topics, see [LSA Policy](https://msdn.microsoft.com/windows/desktop/16c0a7cb-77c9-4c2d-ba82-e7b8edfbb3a2).
...
| [Interaction Between Winlogon and GINA](interaction-between-winlogon-and-gina.md) | The state of Winlogon determines which GINA function is called to process any given [*secure attention sequence*](https://www.bing.com/search?q=*secure attention sequence*) (SAS) event.<br/> |
