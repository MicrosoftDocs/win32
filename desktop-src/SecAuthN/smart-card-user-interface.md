...
The smart card [*user interface*](https://www.bing.com/search?q=*user interface*) (UI) is a single [*common dialog box*](https://www.bing.com/search?q=*common dialog box*) that lets the user specify or search for a smart card to open (that is, connect to and use in an application).
