---
Description: The Microsoft Digest challenge is generated by the servers initial call to the AcceptSecurityContext (Digest) function.
...
Context requirements are specified as flags passed to the *fContextReq* parameter of the [**AcceptSecurityContext (Digest)**](/windows/win32/Sspi/?branch=master) function. The flags affect the security context's quality of protection by controlling the qop directive in the challenge.
