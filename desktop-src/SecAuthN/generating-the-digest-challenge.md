...
The output from the initial call to the [**AcceptSecurityContext (Digest)**](https://msdn.microsoft.com/en-us/library/Aa374600(v=VS.85).aspx) [*function*](https://docs.microsoft.com/windows/desktop/SecGloss/c-gly) is a security buffer that contains a token that is sent to the client with an HTTP 401 response (Access Denied).
