...
A pointer to a [**SecBufferDesc**](secbufferdesc.md) structure generated by a client call to [**InitializeSecurityContext (Digest)**](initializesecuritycontext--digest-.md) that contains the input buffer descriptor.
