---
description: Learn about TLS cipher suites in Windows 11. Cipher suites can only be negotiated for TLS versions which support them.
title: TLS Cipher Suites in Windows 11.
ms.topic: reference
ms.date: 06/26/2024
---
...
| TLS\_RSA\_WITH\_3DES\_EDE\_CBC\_SHA                                                           | No                           | TLS 1.2, TLS 1.1, TLS 1.0               |
...
| TLS\_DHE\_DSS\_WITH\_3DES\_EDE\_CBC\_SHA                                                    | No                           | TLS 1.2, TLS 1.1, TLS 1.0, SSL 3.0      |
