...
| response           | A value computed according to the Digest Access specification ([RFC 2617](http://go.microsoft.com/fwlink/p/?linkid=84049)). An accurate response is conclusive proof that the user's password is known on the client side. |
