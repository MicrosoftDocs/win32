...
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| username           | The account name of the [*security principal*](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-principal-gly) requesting the resource.                                                                  |
...
| response           | A value computed according to the Digest Access specification ([RFC 2617](https://go.microsoft.com/fwlink/p/?linkid=84049)). An accurate response is conclusive proof that the user's password is known on the client side. |
