...
-   An application can call [**SCardConnect**](/windows/win32/Winscard/nf-winscard-scardconnecta?branch=master) to connect to a card that resides in a given reader. This is the simplest way to establish communication with a smart card.
