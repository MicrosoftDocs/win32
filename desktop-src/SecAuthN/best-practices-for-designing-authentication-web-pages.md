...
-   [Security Best Practices for C++](http://msdn.microsoft.com/en-us/library/k3a3hzw7.aspx)
-   [Patterns & Practices Security Guidance for Applications](http://msdn.microsoft.com/en-us/library/ff650760.aspx)
