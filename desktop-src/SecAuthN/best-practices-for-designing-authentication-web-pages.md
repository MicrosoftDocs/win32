...
-   [Security Best Practices for C++](https://msdn.microsoft.com/en-us/library/k3a3hzw7.aspx)
-   [Patterns & Practices Security Guidance for Applications](https://msdn.microsoft.com/en-us/library/ff650760.aspx)
