...
The **AttachByIFD** method creates a communication link to a [*reader*](https://www.bing.com/search?q=*reader*), using a supplied display name for the reader.
...
To attach a [*smart card*](https://www.bing.com/search?q=*smart card*) call [**AttachByHandle**](iscardmanage-attachbyhandle.md).
