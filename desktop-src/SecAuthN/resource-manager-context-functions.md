...
| Topic                                                  | Description                                                                                                                                          |
|--------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**SCardEstablishContext**](/windows/win32/Winscard/nf-winscard-scardestablishcontext?branch=master) | Establishes a context for accessing the [*smart card database*](security.s_gly#-security-smart-card-database-gly). |
| [**SCardReleaseContext**](/windows/win32/Winscard/nf-winscard-scardreleasecontext?branch=master)     | Closes an established context.                                                                                                                       |
