...
The **get\_CardHandle** method retrieves the handle for a connected [*smart card*](security.s_gly#-security-smart-card-gly). This method returns (\*pHandle) == **NULL** if not connected.
