...
The **get\_CardHandle** method retrieves the handle for a connected [*smart card*](https://www.bing.com/search?q=*smart card*). This method returns (\*pHandle) == **NULL** if not connected.
