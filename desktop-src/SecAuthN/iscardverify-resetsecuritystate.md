...
The **ResetSecurityState** method resets the current [*security context*](https://www.bing.com/search?q=*security context*) of the [*smart card*](https://www.bing.com/search?q=*smart card*).
...
To re-enable the [*security context*](https://www.bing.com/search?q=*security context*) without resetting, call [**Unblock**](/windows/desktop/api/mbnapi/).
