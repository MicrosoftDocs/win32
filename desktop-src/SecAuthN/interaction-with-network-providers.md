...
A [*GINA*](https://msdn.microsoft.com/en-us/library/ms721584(v=VS.85).aspx) does not have to provide this information to network providers. If a **NULL** pointer is passed instead of a valid structure pointer, the network providers will prompt the user for information.
