...
The **ISCardTypeConv** interface provides the methods needed to support the users of the other [*smart card*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx) COM interfaces. This interface is provided for backward compatibility only and should no longer be used.

## Members

The **ISCardTypeConv** interface inherits from the [**IDispatch**](https://msdn.microsoft.com/en-us/library/ms221608(v=VS.71).aspx) interface. **ISCardTypeConv** also has these types of members:
