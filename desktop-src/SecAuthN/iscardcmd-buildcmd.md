...
title: ISCardCmdBuildCmd method
ms.date: 05/31/2018
ms.topic: article
...
The **BuildCmd** method constructs a valid command [*application protocol data unit*](security.a_gly#-security-application-protocol-data-unit-gly) (APDU) for transmission to a [*smart card*](security.s_gly#-security-smart-card-gly).
