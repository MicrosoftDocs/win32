...
Because it functions as an AP, a custom SSP/AP [*security package*](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-package-gly) must provide implementations for all of the [Functions Implemented by Authentication Packages](https://www.bing.com/search?q=Functions Implemented by Authentication Packages).

To provide integrated security support, a custom SSP/AP security package must provide implementations for the [Functions implemented by SSP/APs](https://www.bing.com/search?q=Functions implemented by SSP/APs). [LSA Functions Called by SSP/APs](https://www.bing.com/search?q=LSA Functions Called by SSP/APs) describes the support functions available to the SSP/AP developers that want to interact with the LSA.
