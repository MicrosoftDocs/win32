...
User [*credentials*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) are required by Microsoft Digest; both client and server must present valid credentials before they can establish a [*security context*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) for message exchange. Credentials handles are used to obtain and present credentials.
...
To get a handle to the credentials required by Microsoft Digest, call the [**AcquireCredentialsHandle**](/windows/desktop/api/Sspi/) function.
