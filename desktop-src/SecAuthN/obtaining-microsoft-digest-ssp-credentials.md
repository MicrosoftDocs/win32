...
User [*credentials*](https://www.bing.com/search?q=*credentials*) are required by Microsoft Digest; both client and server must present valid credentials before they can establish a [*security context*](https://www.bing.com/search?q=*security context*) for message exchange. Credentials handles are used to obtain and present credentials.
