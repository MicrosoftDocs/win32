...
Examples that use these functions after a [*security context*](https://www.bing.com/search?q=*security context*) has been established are demonstrated in the following sections:
