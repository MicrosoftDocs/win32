---
Description: The ISCardDatabase interface provides the methods for performing the smart card resource managers database operations.
...
The **ISCardDatabase** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **ISCardDatabase** also has these types of members:
