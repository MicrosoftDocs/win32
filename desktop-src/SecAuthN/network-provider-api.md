...
The [*Multiple Provider Router*](https://msdn.microsoft.com/4c4402e9-7455-4868-978f-3899a8fd86c1) (MPR) handles communication with all of the various network providers on the system and presents an integrated network to the user.
