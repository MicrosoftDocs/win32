...
The **QueryContextAttributes (Negotiate)** function enables a transport application to query the Negotiate security package for certain [*attributes*](security.a_gly#-security-attribute-gly) of a security context.
