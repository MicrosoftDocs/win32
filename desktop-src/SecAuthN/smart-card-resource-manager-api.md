...
The [*resource manager API*](security.r_gly#-security-resource-manager-api-gly) provides the following functionality.
...
| [Smart Card and Reader Access Functions](smart-card-and-reader-access-functions.md)<br/>     | Connect to and communicate with a smart card, including transferring data using [*T=0*](security.t_gly#-security-t-0-protocol-gly), [*T=1*](security.t_gly#-security-t-1-protocol-gly), and raw protocols.<br/> |
