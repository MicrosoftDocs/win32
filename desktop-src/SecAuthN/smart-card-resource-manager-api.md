...
The [*resource manager API*](https://www.bing.com/search?q=*resource manager API*) provides the following functionality.
...
| [Smart Card and Reader Access Functions](smart-card-and-reader-access-functions.md)<br/>     | Connect to and communicate with a smart card, including transferring data using [*T=0*](https://www.bing.com/search?q=*T=0*), [*T=1*](https://www.bing.com/search?q=*T=1*), and raw protocols.<br/> |
