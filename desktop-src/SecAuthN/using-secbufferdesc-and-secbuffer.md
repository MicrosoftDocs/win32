...
Communication often involves potentially large amounts of data or data of unknown length. Sending and receiving data is done in similar or identical fashion in both of these cases. To deal with unknown length and potentially large amounts of data, SSPI communication is done using two structures, [**SecBufferDesc**](secbufferdesc.md) and [**SecBuffer**](secbuffer.md).

A [**SecBufferDesc**](secbufferdesc.md) structure is a container for an array of [**SecBuffer**](secbuffer.md) structures. A **SecBufferDesc** structure has the following members:

-   Version number
-   Number of [**SecBuffer**](secbuffer.md) elements
-   Address of the array of [**SecBuffer**](secbuffer.md) structures

A [**SecBuffer**](secbuffer.md) structure contains the following three members:

-   Number of bytes in the buffer
-   Type of information contained in the data item
-   The bytes themselves

A whole SSPI message often consists of an array of [**SecBuffer**](secbuffer.md) structures.
