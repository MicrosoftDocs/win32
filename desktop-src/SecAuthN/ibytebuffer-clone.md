...
When successful, points to the location of an [**IByteBuffer**](ibytebuffer.md) pointer to the new stream object. When you have finished using the **IByteBuffer** pointer, release it by calling the [**IUnknown::Release**](https://www.bing.com/search?q=**IUnknown::Release**) function. If an error occurs, this parameter is **NULL**.
