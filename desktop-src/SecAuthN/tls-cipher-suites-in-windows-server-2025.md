---
description: Learn about TLS cipher suites in Windows Server 2025 and later. Cipher suites can only be negotiated for TLS versions which support them.
title: TLS Cipher Suites in Windows Server 2025 and later
ms.topic: reference
ms.date: 08/18/2025
---

# TLS Cipher Suites in Windows Server 2025 and later
...
For Windows Server 2025 and later, the following cipher suites are enabled and in this priority order by default using the Microsoft Schannel Provider:
