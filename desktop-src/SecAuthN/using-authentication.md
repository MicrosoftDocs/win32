...
| [Protecting the Automatic Logon Password](protecting-the-automatic-logon-password.md) | Information about storing the automatic logon password by using the [**LsaStorePrivateData**](security.lsastoreprivatedata) function                                              |
