...
The **UnlockScard** method releases exclusive access to the [*smart card*](https://msdn.microsoft.com/library/ms721625(v=VS.85).aspx).
...
Indicates what should be done with the card in the connected [*reader*](https://msdn.microsoft.com/library/ms721604(v=VS.85).aspx).
