...
| <span id="SECPKG_ATTR_CERT_TRUST_STATUS"></span><span id="secpkg_attr_cert_trust_status"></span><dl> <dt>**SECPKG\_ATTR\_CERT\_TRUST\_STATUS**</dt> <dt>0x80000084</dt> </dl>                        | The *pBuffer* parameter contains a pointer to a [**CERT\_TRUST\_STATUS**](https://docs.microsoft.com/en-us/windows/win32/api/wincrypt/ns-wincrypt-cert_trust_status) structure that specifies trust information about the certificate.<br/> This attribute is supported only on the client.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| <span id="SECPKG_ATTR_CREDS"></span><span id="secpkg_attr_creds"></span><dl> <dt>**SECPKG\_ATTR\_CREDS**</dt> <dt>0x80000080</dt> </dl>                                                              | The *pBuffer* parameter contains a pointer to a [**SecPkgContext\_ClientCreds**](https://docs.microsoft.com/en-us/windows/win32/api/credssp/ns-credssp-secpkgcontext_clientcreds) structure that specifies client credentials.<br/> The client credentials can be either user name and password or user name and smart card PIN.<br/> This attribute is supported only on the server.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
[**SecPkgContext\_ClientCreds**](https://docs.microsoft.com/en-us/windows/win32/api/credssp/ns-credssp-secpkgcontext_clientcreds)
</dt> <dt>
