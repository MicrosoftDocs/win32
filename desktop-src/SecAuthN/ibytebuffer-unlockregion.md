---
Description: Removes the access restriction on a range of bytes previously restricted by using IByteBufferLockRegion.
ms.assetid: f2a1162e-7fc7-4a55-befb-0b017edb9fe2
title: IByteBufferUnlockRegion method
ms.date: 05/31/2018
ms.topic: article
