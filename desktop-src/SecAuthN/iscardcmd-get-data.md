...
The **get\_Data** method retrieves the data field from the [*application protocol data unit*](https://msdn.microsoft.com/0baaa937-f635-4500-8dcd-9dbbd6f4cd02) (APDU), placing it in a byte buffer object.
