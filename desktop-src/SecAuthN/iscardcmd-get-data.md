...
The **get\_Data** method retrieves the data field from the [*application protocol data unit*](https://msdn.microsoft.com/en-us/library/ms721532(v=VS.85).aspx) (APDU), placing it in a byte buffer object.
