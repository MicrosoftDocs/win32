...
The **LockSCard** method claims exclusive access to the [*smart card*](https://www.bing.com/search?q=*smart card*).
...
In addition to the COM error code listed above, this interface may return a smart card error code if a smart card function was called to complete the request. For more information, see [Smart Card Return Values](https://www.bing.com/search?q=Smart Card Return Values).
