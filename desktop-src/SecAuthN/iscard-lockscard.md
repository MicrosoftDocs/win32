...
The **LockSCard** method claims exclusive access to the [*smart card*](security.s_gly#-security-smart-card-gly).
...
In addition to the COM error code listed above, this interface may return a smart card error code if a smart card function was called to complete the request. For more information, see [Smart Card Return Values](authentication-return-values.md#smart-card-return-values).
