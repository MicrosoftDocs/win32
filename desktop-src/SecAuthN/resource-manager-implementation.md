...
The [*resource manager*](https://www.bing.com/search?q=*resource manager*) runs as a trusted service in a single process. All requests for [*smart card*](https://www.bing.com/search?q=*smart card*) access are made to the resource manager, which routes them to the [*reader*](https://www.bing.com/search?q=*reader*) that contains the targeted card.
