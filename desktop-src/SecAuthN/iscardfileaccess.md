...
The following interface definition is provided as a standard that can be followed when developing a [*smart card*](https://www.bing.com/search?q=*smart card*) [*service provider*](https://www.bing.com/search?q=*service provider*).
...
The **ISCardFileAccess** interface inherits from the [**IDispatch**](https://msdn.microsoft.com/windows/desktop/ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **ISCardFileAccess** also has these types of members:
