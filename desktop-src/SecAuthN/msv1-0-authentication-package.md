...
Microsoft provides the MSV1\_0 [*authentication package*](https://msdn.microsoft.com/0baaa937-f635-4500-8dcd-9dbbd6f4cd02) for local machine logons that do not require custom authentication. The [*Local Security Authority*](https://msdn.microsoft.com/65dd9a04-fc7c-4179-95ff-dac7dad4668f) (LSA) calls the MSV1\_0 authentication package to process logon data collected by the [*GINA*](https://msdn.microsoft.com/c9567a5b-bd56-4ae1-9eac-af0bb5a6842a) for the [*Winlogon*](https://msdn.microsoft.com/031c898b-3b4d-4b29-811a-112da37b5e3d) logon process. The MSV1\_0 package checks the local security accounts manager (SAM) database to determine whether the logon data belongs to a valid [*security principal*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) and then returns the result of the logon attempt to the LSA.
...
If the domain controller is not available, and the LSA contains cached [*credentials*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) for the user, the local instance of MSV1\_0 can authenticate the user using the cached logon data.
...
The MSV1\_0 authentication package defines a [*primary credentials*](https://msdn.microsoft.com/2fe6cfd3-8a2e-4dbe-9fb8-332633daa97a) key/string value pair. The primary credentials string holds the credentials derived from the data provided at logon time. It includes the user name and both case-sensitive and case-insensitive forms of the user's password.
