...
A string buffer that represents the credential key. The string buffer must be allocated by the function by using the [**AllocateLsaHeap**](allocatelsaheap.md) function.
...
|-----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <dl> <dt>STATUS\_INVALID\_PARAMETER</dt> </dl>     | A parameter is not valid. *LogonId* and *AuthBuffer* are both **NULL** or both non-**NULL**, or *AuthBuffer* contains a [**SEC\_WINNT\_AUTH\_IDENTITY\_EX2**](sec-winnt-auth-identity-ex2.md) structure that is not valid.<br/> |
