...
A string buffer that represents the credential key. The string buffer must be allocated by the function by using the [**AllocateLsaHeap**](/windows/desktop/api/Ntsecpkg/nc-ntsecpkg-lsa_allocate_lsa_heap) function.
...
|-----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <dl> <dt>STATUS\_INVALID\_PARAMETER</dt> </dl>     | A parameter is not valid. *LogonId* and *AuthBuffer* are both **NULL** or both non-**NULL**, or *AuthBuffer* contains a [**SEC\_WINNT\_AUTH\_IDENTITY\_EX2**](/windows/desktop/api/Sspi/ns-sspi-_sec_winnt_auth_identity_ex2) structure that is not valid.<br/> |
