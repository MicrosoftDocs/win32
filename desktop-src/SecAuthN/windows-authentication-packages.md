...
MSV1\_0 is an example of a Windows [*authentication package*](https://msdn.microsoft.com/0baaa937-f635-4500-8dcd-9dbbd6f4cd02). The MSV1\_0 package accepts a user name and a [*hashed*](https://msdn.microsoft.com/4165b820-30fc-477e-a690-81109f161323) password, which it looks up in the [*Security Accounts Manager*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) (SAM) database. Depending on the results of the lookup, the MSV1\_0 authentication package accepts or rejects the authentication attempt.
