...
MSV1\_0 is an example of a Windows [*authentication package*](https://msdn.microsoft.com/library/ms721532(v=VS.85).aspx). The MSV1\_0 package accepts a user name and a [*hashed*](https://msdn.microsoft.com/library/ms721586(v=VS.85).aspx) password, which it looks up in the [*Security Accounts Manager*](https://msdn.microsoft.com/library/ms721625(v=VS.85).aspx) (SAM) database. Depending on the results of the lookup, the MSV1\_0 authentication package accepts or rejects the authentication attempt.
