...
title: ISCardCmd::put_Data method
ms.topic: reference
ms.date: 05/31/2018
topic_type: 
- APIRef
...
The **put\_Data** method sets the data field in the [*application protocol data unit*](https://msdn.microsoft.com/en-us/library/ms721532(v=VS.85).aspx) (APDU).
