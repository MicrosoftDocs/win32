...
The **WriteBinary** method constructs an [*application protocol data unit*](https://www.bing.com/search?q=*application protocol data unit*) (APDU) command that writes binary values into an elementary file.
