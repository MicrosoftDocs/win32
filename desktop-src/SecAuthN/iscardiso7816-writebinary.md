...
title: ISCardISO7816WriteBinary method
ms.date: 05/31/2018
ms.topic: article
...
The **WriteBinary** method constructs an [*application protocol data unit*](security.a_gly#-security-application-protocol-data-unit-gly) (APDU) command that writes binary values into an elementary file.
