...
-   [**NPLogonNotify**](nplogonnotify.md)
-   [**NPPasswordChangeNotify**](nppasswordchangenotify.md)

To restore notifications to the [**NPLogonNotify**](nplogonnotify.md) and [**NPPasswordChangeNotify**](nppasswordchangenotify.md) functions for smart card logon, create a registry entry called **SmartCardLogonNotify** as a **DWORD**, and set it to 1:
