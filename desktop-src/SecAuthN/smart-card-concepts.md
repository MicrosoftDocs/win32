...
This section covers two basic interactions between [*users*](security.u_gly#-security-user-gly) (and applications) and [*smart cards*](security.s_gly#-security-smart-card-gly). This section does not attempt to describe all possible ways a user might interact with a smart card.
...
| [Relation to Other Services](relation-to-other-services.md)                       | How the [*smart card subsystem*](security.s_gly#-security-smart-card-subsystem-gly) works with other services available in the Microsoft Internet Security Framework and how other parts of the Microsoft Internet Security Framework use the *smart card subsystem*.<br/> |
