...
This section covers two basic interactions between [*users*](https://www.bing.com/search?q=*users*) (and applications) and [*smart cards*](https://www.bing.com/search?q=*smart cards*). This section does not attempt to describe all possible ways a user might interact with a smart card.
...
| [Relation to Other Services](relation-to-other-services.md)                       | How the [*smart card subsystem*](https://www.bing.com/search?q=*smart card subsystem*) works with other services available in the Microsoft Internet Security Framework and how other parts of the Microsoft Internet Security Framework use the *smart card subsystem*.<br/> |
