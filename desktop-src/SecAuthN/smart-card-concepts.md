...
This section covers two basic interactions between [*users*](https://msdn.microsoft.com/264f6cb6-36c6-4cdb-b7bb-a5dbd332adcb) (and applications) and [*smart cards*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50). This section does not attempt to describe all possible ways a user might interact with a smart card.
...
| [Relation to Other Services](relation-to-other-services.md)                       | How the [*smart card subsystem*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) works with other services available in the Microsoft Internet Security Framework and how other parts of the Microsoft Internet Security Framework use the *smart card subsystem*.<br/> |
