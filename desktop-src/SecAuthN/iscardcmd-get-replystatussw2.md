...
The **get\_ReplyStatusSW2** method retrieves the [*reply APDU*](security.r_gly#-security-reply-apdu-gly) SW2 status byte.
...
The following example shows how to retrieve the SW2 status byte of the [*reply APDU*](security.r_gly#-security-reply-apdu-gly). The example assumes that pISCardCmd is a valid pointer to an instance of the [**ISCardCmd**](iscardcmd.md) interface.
