...
The **Clear** method clears the [*application protocol data unit*](https://www.bing.com/search?q=*application protocol data unit*) (APDU) and [*reply APDU*](https://www.bing.com/search?q=*reply APDU*) message buffers.
