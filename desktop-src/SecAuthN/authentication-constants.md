...
|-------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| CREDUI\_MAX\_MESSAGE\_LENGTH<br/>         | Maximum number of characters for the **pszMessageText** member of a [**CREDUI\_INFO**](credui-info.md) structure.<br/> |
| CREDUI\_MAX\_CAPTION\_LENGTH<br/>         | Maximum number of characters for the **pszCaptionText** member of a [**CREDUI\_INFO**](credui-info.md) structure.<br/> |
...
| Value                                                              | Description                                                                                                                          |
|--------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| [**WLX\_LOGON\_OPTION\_XXX**](wlx-logon-option-xxx.md)<br/> | Contains predefined logon options. It is used by the *dwOptions* parameter of [**WlxLoggedOutSAS**](wlxloggedoutsas.md).<br/> |
