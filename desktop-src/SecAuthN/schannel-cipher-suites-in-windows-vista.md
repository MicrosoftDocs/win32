...
[*Key exchange algorithms*](https://msdn.microsoft.com/en-us/library/ms721590(v=VS.85).aspx) protect information required to create shared keys. These algorithms are asymmetric ([*public key algorithms*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx)) and perform well for relatively small amounts of data.

Bulk encryption algorithms encrypt messages exchanged between clients and servers. These algorithms are [*symmetric*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx) and perform well for large amounts of data.

[Message authentication](message-authentication-codes-in-schannel.md) algorithms generate message [*hashes*](https://msdn.microsoft.com/en-us/library/ms721586(v=VS.85).aspx) and signatures that ensure the [*integrity*](https://msdn.microsoft.com/en-us/library/ms721588(v=VS.85).aspx) of a message.

Developers specify these elements by using [**ALG\_ID**](https://msdn.microsoft.com/en-us/library/Aa375549(v=VS.85).aspx) data types. For more information, see [Specifying Schannel Ciphers and Cipher Strengths](specifying-schannel-ciphers-and-cipher-strengths.md).
