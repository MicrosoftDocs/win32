...
| "3des"       | The [*triple DES*](https://msdn.microsoft.com/library/windows/desktop/ms721627#-security-triple-des-gly) cipher in [*CBC*](https://msdn.microsoft.com/library/windows/desktop/ms721572#-security-cipher-block-chaining-gly) mode with EDE with the same key for each E stage (two keys mode). Total key length is 112 bits. |
| "rc4-56"     | The RC4 cipher with a 56-bit key.                                                                                                                                                                                                                                                              |
| "rc4-40"     | The RC4 cipher with a 40-bit key.                                                                                                                                                                                                                                                              |
| "des"        | The [*Data Encryption Standard*](https://msdn.microsoft.com/library/windows/desktop/ms721573#-security-data-encryption-standard-gly) (DES) cipher in [*cipher block chaining*](https://msdn.microsoft.com/library/windows/desktop/ms721572#-security-cipher-block-chaining-gly) (CBC) mode with a 56-bit key. |
