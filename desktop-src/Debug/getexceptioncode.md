...
The exception code returned is the code generated by a hardware exception, or the code specified in the [**RaiseException**](https://msdn.microsoft.com/library/ms680552(v=VS.85).aspx) function for a software generated exception.
