...
SymStore (symstore.exe) is a tool for creating symbol stores. It is included in the [Debugging Tools for Windows](/windows-hardware/drivers/debugger/) package.
