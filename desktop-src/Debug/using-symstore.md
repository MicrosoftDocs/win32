...
SymStore (symstore.exe) is a tool for creating symbol stores. It is included in the [Debugging Tools for Windows](https://go.microsoft.com/fwlink/p/?linkid=84137) package.
