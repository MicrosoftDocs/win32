...
The **\_\_finally** block is executed whenever the flow of control leaves the **\_\_try** block. However, the **\_\_finally** block is not executed if you call any of the following functions within the **\_\_try** block: [**ExitProcess**](https://msdn.microsoft.com/windows/desktop/c26dbf15-62e8-4892-b7c5-2e6c085e4cd5), [**ExitThread**](https://msdn.microsoft.com/windows/desktop/e7f6d054-c535-4521-a3b4-800a9174732f), or **abort**.
