...
See [Internet Error Codes](wininet.wininet_errors) and WinInet.h.
...
Failed to determine SSPI principal name for ISAKMP/ERROR\_IPSEC\_IKE service ([**QueryCredentialsAttributes**](security.querycredentialsattributes)).
...
The caller of [**SetMonitorColorTemperature**](monitor.setmonitorcolortemperature) specified a color temperature that the current monitor did not support. This error implies that the monitor violated the MCCS 2.0 or MCCS 2.0 Revision 1 specification.
