...
#### [Beep](https://msdn.microsoft.com/en-us/library/ms679277(v=VS.85).aspx)
#### [CaptureStackBackTrace](https://msdn.microsoft.com/en-us/library/Bb204633(v=VS.85).aspx)
#### [FatalAppExit](https://msdn.microsoft.com/en-us/library/ms679336(v=VS.85).aspx)
...
#### [GetErrorMode](https://msdn.microsoft.com/en-us/library/ms679355(v=VS.85).aspx)
#### [GetLastError](https://msdn.microsoft.com/en-us/library/ms679360(v=VS.85).aspx)
#### [GetThreadErrorMode](https://msdn.microsoft.com/en-us/library/Dd553629(v=VS.85).aspx)
...
#### [RtlNtStatusToDosErrorNoTeb](https://msdn.microsoft.com/en-us/library/Dn934204(v=VS.85).aspx)
...
#### [SetErrorMode](https://msdn.microsoft.com/en-us/library/ms680621(v=VS.85).aspx)
#### [SetLastError](https://msdn.microsoft.com/en-us/library/ms680627(v=VS.85).aspx)
#### [SetLastErrorEx](/windows/desktop/api/Winuser/nf-winuser-setlasterrorex)
#### [SetThreadErrorMode](https://msdn.microsoft.com/en-us/library/Dd553630(v=VS.85).aspx)
...
#### [ContinueDebugEvent](https://msdn.microsoft.com/en-us/library/ms679285(v=VS.85).aspx)
#### [DebugActiveProcess](https://msdn.microsoft.com/en-us/library/ms679295(v=VS.85).aspx)
#### [DebugActiveProcessStop](https://msdn.microsoft.com/en-us/library/ms679296(v=VS.85).aspx)
#### [DebugBreak](https://msdn.microsoft.com/en-us/library/ms679297(v=VS.85).aspx)
...
#### [GetThreadContext](https://msdn.microsoft.com/en-us/library/ms679362(v=VS.85).aspx)
...
#### [SetThreadContext](https://msdn.microsoft.com/en-us/library/ms680632(v=VS.85).aspx)
#### [WaitForDebugEvent](https://msdn.microsoft.com/en-us/library/ms681423(v=VS.85).aspx)
#### [WaitForDebugEventEx](https://msdn.microsoft.com/en-us/library/Mt171594(v=VS.85).aspx)
...
#### [RaiseFailFastException](https://msdn.microsoft.com/en-us/library/Dd941688(v=VS.85).aspx)
...
### [PWAITCHAINCALLBACK](https://msdn.microsoft.com/en-us/library/ms681421(v=VS.85).aspx)
