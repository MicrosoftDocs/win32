...
The guarded body of code can be a block of code, a set of nested blocks, or an entire procedure or function. Whenever the guarded body is executed, the block of termination code will be executed. The only exception to this is when the thread terminates during execution of the guarded body (for example, if the [**ExitThread**](https://msdn.microsoft.com/windows/desktop/e7f6d054-c535-4521-a3b4-800a9174732f) or [**ExitProcess**](https://msdn.microsoft.com/windows/desktop/c26dbf15-62e8-4892-b7c5-2e6c085e4cd5) function is called from within the guarded body).
