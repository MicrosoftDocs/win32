...
To add a vectored continue handler, use the [**AddVectoredContinueHandler**](/windows/desktop/api/WinBase/) function. To remove this handler, use the [**RemoveVectoredContinueHandler**](/windows/desktop/api/WinBase/) function.

To add a vectored exception handler, use the [**AddVectoredExceptionHandler**](/windows/desktop/api/WinBase/) function. To remove this handler, use the [**RemoveVectoredExceptionHandler**](/windows/desktop/api/WinBase/) function.
