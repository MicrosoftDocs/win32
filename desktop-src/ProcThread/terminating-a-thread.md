...
-   Create an event object using the [**CreateEvent**](https://msdn.microsoft.com/windows/desktop/1f6d946e-c74c-4599-ac3d-b709216a0900) function.
-   Create the threads.
-   Each thread monitors the event state by calling the [**WaitForSingleObject**](https://msdn.microsoft.com/windows/desktop/e37ebff7-b44e-469d-81ab-7a6bd1a0c822) function. Use a wait time-out interval of zero.
-   Each thread terminates its own execution when the event is set to the signaled state ([**WaitForSingleObject**](https://msdn.microsoft.com/windows/desktop/e37ebff7-b44e-469d-81ab-7a6bd1a0c822) returns WAIT\_OBJECT\_0).
