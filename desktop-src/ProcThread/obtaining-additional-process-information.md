...
-   To retrieve the [**STARTUPINFO**](https://msdn.microsoft.com/en-us/library/ms686331(v=VS.85).aspx) structure specified when the current process was created, use the [**GetStartupInfo**](/windows/desktop/api/WinBase/nf-winbase-getstartupinfoa) function.
-   To obtain the version information from the executable header, use the [**GetProcessVersion**](https://msdn.microsoft.com/en-us/library/ms683224(v=VS.85).aspx) function.
