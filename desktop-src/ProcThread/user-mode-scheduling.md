...
A UMS worker thread is created by calling [**CreateRemoteThreadEx**](https://msdn.microsoft.com/en-us/library/Dd405484(v=VS.85).aspx) with the PROC\_THREAD\_ATTRIBUTE\_UMS\_THREAD attribute and specifying a UMS thread context and a completion list.
