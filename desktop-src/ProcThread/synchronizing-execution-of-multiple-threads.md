...
The state of each of these objects is either signaled or not signaled. When you specify a handle to any of these objects in a call to one of the [wait functions](https://msdn.microsoft.com/windows/desktop/9c66c71d-fdfd-42ae-895c-2fc842b5bc7a), the execution of the calling thread is blocked until the state of the specified object becomes signaled.
...
For more information, see [Synchronization](https://msdn.microsoft.com/windows/desktop/3e85e61c-d4df-49dd-aa86-1bbd682e375e).
