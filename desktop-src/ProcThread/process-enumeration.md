...
You can also filter processes by user account, regardless of the enumeration function, by calling [**OpenProcess**](openprocess.md), [**OpenProcessToken**](security.openprocesstoken), and [**GetTokenInformation**](security.gettokeninformation) with **TokenUser**. However, you cannot open a process that is protected by a security descriptor unless you have been granted access.
