...
To create a job object, use the [**CreateJobObject**](createjobobject.md) function. When the job is created, no processes are associated with the job.
...
You can specify a security descriptor for a job object when you call the [**CreateJobObject**](createjobobject.md) function. For more information, see [Job Object Security and Access Rights](job-object-security-and-access-rights.md).

## Managing Processes in Jobs

After a process is associated with a job, by default any child processes it creates using [**CreateProcess**](createprocess.md) are also associated with the job. (Child processes created using [**Win32\_Process.Create**](cimwin32.create_method_in_class_win32_process) are not associated with the job.) This default behavior can be changed by setting the extended limit JOB\_OBJECT\_LIMIT\_BREAKAWAY\_OK or JOB\_OBJECT\_LIMIT\_SILENT\_BREAKAWAY\_OK for the job.
...
To determine if a process is running in a job, use the [**IsProcessInJob**](isprocessinjob.md) function.
...
-   [**JOBOBJECT\_BASIC\_LIMIT\_INFORMATION**](jobobject-basic-limit-information-str.md)
-   [**JOBOBJECT\_BASIC\_UI\_RESTRICTIONS**](jobobject-basic-ui-restrictions-str.md)
-   [**JOBOBJECT\_CPU\_RATE\_CONTROL\_INFORMATION**](jobobject-cpu-rate-control-information.md)
-   [**JOBOBJECT\_EXTENDED\_LIMIT\_INFORMATION**](jobobject-extended-limit-information-str.md)
-   [**JOBOBJECT\_NOTIFICATION\_LIMIT\_INFORMATION**](jobobject-notification-limit-information.md)
...
-   [**JOBOBJECT\_BASIC\_ACCOUNTING\_INFORMATION**](jobobject-basic-accounting-information-str.md)
-   [**JOBOBJECT\_BASIC\_AND\_IO\_ACCOUNTING\_INFORMATION**](jobobject-basic-and-io-accounting-information-str.md)
...
To obtain a handle for an existing job object, use the [**OpenJobObject**](openjobobject.md) function and specify the name given to the object when it was created. Only named job objects can be opened.
