...
It is ideal to use TLS in a dynamic-link library (DLL). For an example, see [Using Thread Local Storage in a Dynamic Link Library](base.using_thread_local_storage_in_a_dynamic_link_library).

## Related topics

<dl> <dt>

[Thread Local Storage (Visual C++)](http://go.microsoft.com/fwlink/p/?linkid=148620)
</dt> <dt>

[Using Thread Local Storage](using-thread-local-storage.md)
</dt> <dt>

[Using Thread Local Storage in a Dynamic Link Library](base.using_thread_local_storage_in_a_dynamic_link_library)
</dt> </dl>
