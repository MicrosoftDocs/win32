...
To retrieve a copy of the environment block for a given user, use the [**CreateEnvironmentBlock**](https://www.bing.com/search?q=**CreateEnvironmentBlock**) function.
