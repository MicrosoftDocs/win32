...
|-----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CreateRemoteThreadEx**](/windows/desktop/api/WinBase/nf-processthreadsapi-createremotethreadex)<br/>                         | Creates a thread that runs in the virtual address space of another process and optionally specifies extended attributes such as processor group affinity.<br/> |
...
| [**GetCurrentProcessorNumberEx**](/windows/desktop/api/WinBase/nf-processthreadsapi-getcurrentprocessornumberex)<br/>           | Retrieves the processor group and number of the logical processor in which the calling thread is running.<br/>                                                 |
| [**GetLogicalProcessorInformationEx**](/windows/desktop/api/WinBase/)<br/> | Retrieves information about the relationships of logical processors and related hardware.<br/>                                                                 |
...
| [**GetNumaNodeProcessorMaskEx**](/windows/desktop/api/WinBase/)<br/>             | Retrieves the processor mask for the specified NUMA node as a USHORT value.<br/>                                                                               |
...
| [**GetNumaProximityNodeEx**](/windows/desktop/api/WinBase/)<br/>                     | Retrieves the node number as a USHORT value for the specified proximity identifier.<br/>                                                                       |
| [**GetProcessGroupAffinity**](/windows/desktop/api/WinBase/)<br/>                   | Retrieves the processor group affinity of the specified process.<br/>                                                                                          |
| [**GetProcessorSystemCycleTime**](/windows/desktop/api/WinBase/)<br/>           | Retrieves the cycle time each processor in the specified group spent executing deferred procedure calls (DPCs) and interrupt service routines (ISRs).<br/>     |
| [**GetThreadGroupAffinity**](/windows/desktop/api/WinBase/)<br/>                     | Retrieves the processor group affinity of the specified thread.<br/>                                                                                           |
| [**GetThreadIdealProcessorEx**](/windows/desktop/api/WinBase/nf-processthreadsapi-getthreadidealprocessorex)<br/>               | Retrieves the processor number of the ideal processor for the specified thread.<br/>                                                                           |
| [**QueryIdleProcessorCycleTimeEx**](/windows/desktop/api/WinBase/nf-realtimeapiset-queryidleprocessorcycletimeex)<br/>       | Retrieves the accumulated cycle time for the idle thread on each logical processor in the specified processor group. <br/>                                     |
| [**SetThreadGroupAffinity**](/windows/desktop/api/WinBase/)<br/>                     | Sets the processor group affinity for the specified thread.<br/>                                                                                               |
| [**SetThreadIdealProcessorEx**](/windows/desktop/api/WinBase/nf-processthreadsapi-setthreadidealprocessorex)<br/>               | Sets the ideal processor for the specified thread and optionally retrieves the previous ideal processor.<br/>                                                  |
...
| Function                                                                              | Description                                                                                                    |
|---------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| [**QueryThreadpoolStackInformation**](/windows/desktop/api/WinBase/nf-threadpoolapiset-querythreadpoolstackinformation)<br/> | Retrieves the stack reserve and commit sizes for threads in the specified thread pool.<br/>              |
...
| [**SetThreadpoolStackInformation**](/windows/desktop/api/WinBase/nf-threadpoolapiset-setthreadpoolstackinformation)<br/>     | Sets the stack reserve and commit sizes for new threads in the specified thread pool. <br/>              |
