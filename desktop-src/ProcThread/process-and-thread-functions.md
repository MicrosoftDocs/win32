...
| [**CreateProcessAsUser**](https://www.bing.com/search?q=**CreateProcessAsUser**)                       | Creates a new process and its primary thread. The new process runs in the security context of the user represented by the specified token.                                                    |
...
| [**FreeEnvironmentStrings**](/windows/desktop/api/WinBase/)                 | Frees a block of environment strings.                                                                                                                                                         |
| [**GetCommandLine**](/windows/desktop/api/WinBase/)                                 | Retrieves the command-line string for the current process.                                                                                                                                    |
...
| [**GetEnvironmentStrings**](/windows/desktop/api/WinBase/)                   | Retrieves the environment block for the current process.                                                                                                                                      |
...
| [**GetProcessGroupAffinity**](/windows/desktop/api/WinBase/)               | Retrieves the processor group affinity of the specified process.                                                                                                                              |
...
| [**GetProcessPriorityBoost**](https://www.bing.com/search?q=**GetProcessPriorityBoost**)               | Retrieves the priority boost control state of the specified process.                                                                                                                          |
| [**GetProcessShutdownParameters**](https://www.bing.com/search?q=**GetProcessShutdownParameters**)     | Retrieves shutdown parameters for the currently calling process.                                                                                                                              |
...
| [**GetProcessorSystemCycleTime**](/windows/desktop/api/WinBase/)       | Retrieves the cycle time each processor in the specified group spent executing deferred procedure calls (DPCs) and interrupt service routines (ISRs).                                         |
...
| [**NeedCurrentDirectoryForExePath**](/windows/desktop/api/WinBase/) | Determines whether the current directory should be included in the search path for the specified executable.                                                                                  |
...
| [**SetProcessInformation**](https://www.bing.com/search?q=**SetProcessInformation**)                   | Sets information for the specified process.                                                                                                                                                   |
...
| [**SetProcessPriorityBoost**](https://www.bing.com/search?q=**SetProcessPriorityBoost**)               | Disables the ability of the system to temporarily boost the priority of the threads of the specified process.                                                                                 |
...
|------------------------------------------------------|-------------------------------------------------------|
| Function                                             | Description                                           |
| [**QueryProtectedPolicy**](https://www.bing.com/search?q=**QueryProtectedPolicy**) | Queries the value associated with a protected policy. |
| [**SetProtectedPolicy**](https://www.bing.com/search?q=**SetProtectedPolicy**)     | Sets a protected policy.                              |
...
| [**GetThreadGroupAffinity**](/windows/desktop/api/WinBase/)           | Retrieves the processor group affinity of the specified thread.                                                                                           |
...
| [**GetThreadInformation**](https://www.bing.com/search?q=**GetThreadInformation**)               | Retrieves information about the specified thread.                                                                                                         |
| [**GetThreadIOPendingFlag**](https://www.bing.com/search?q=**GetThreadIOPendingFlag**)           | Determines whether a specified thread has any I/O requests pending.                                                                                       |
...
| [**SetThreadGroupAffinity**](/windows/desktop/api/WinBase/)           | Sets the processor group affinity for the specified thread.                                                                                               |
| [**SetThreadIdealProcessor**](https://www.bing.com/search?q=**SetThreadIdealProcessor**)         | Specifies a preferred processor for a thread.                                                                                                             |
...
| [**SetThreadInformation**](https://www.bing.com/search?q=**SetThreadInformation**)               | Sets information for the specified thread.                                                                                                                |
...
| [**ThreadProc**](/windows/desktop/api/WinBase/)                                   | An application-defined function that serves as the starting address for a thread.                                                                         |
...
| Function                                                       | Description                                                                                          |
|----------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| [**AssignProcessToJobObject**](https://www.bing.com/search?q=**AssignProcessToJobObject**)   | Associates a process with an existing job object.                                                    |
| [**CreateJobObject**](/windows/desktop/api/WinBase/nf-winbase-createjobobjecta)                     | Creates or opens a job object.                                                                       |
| [**IsProcessInJob**](/windows/desktop/api/WinBase/)                       | Determines whether the process is running in the specified job.                                      |
| [**OpenJobObject**](/windows/desktop/api/WinBase/nf-winbase-openjobobjecta)                         | Opens an existing job object.                                                                        |
| [**QueryInformationJobObject**](https://www.bing.com/search?q=**QueryInformationJobObject**) | Retrieves limit and job state information from the job object.                                       |
| [**SetInformationJobObject**](https://www.bing.com/search?q=**SetInformationJobObject**)     | Set limits for a job object.                                                                         |
| [**TerminateJobObject**](https://www.bing.com/search?q=**TerminateJobObject**)               | Terminates all processes currently associated with the job.                                          |
...
| [**CreateThreadpoolWork**](https://www.bing.com/search?q=**CreateThreadpoolWork**)                                       | Creates a new work object.                                                                                                                                                                                                                          |
...
| [**SetThreadpoolThreadMaximum**](https://www.bing.com/search?q=**SetThreadpoolThreadMaximum**)                           | Sets the maximum number of threads that the specified thread pool can allocate to process callbacks.                                                                                                                                                |
...
| [**FiberProc**](https://www.bing.com/search?q=**FiberProc**)                           | An application-defined function used with the [**CreateFiber**](/windows/desktop/api/WinBase/nf-winbase-createfiber) function.                   |
| [**FlsAlloc**](/windows/desktop/api/WinBase/)                             | Allocates a fiber local storage (FLS) index.                                                                 |
| [**FlsFree**](/windows/desktop/api/WinBase/)                               | Releases an FLS index.                                                                                       |
| [**FlsGetValue**](/windows/desktop/api/WinBase/)                       | Retrieves the value in the calling fiber's FLS slot for a specified FLS index.                               |
| [**FlsSetValue**](/windows/desktop/api/WinBase/)                       | Stores a value in the calling fiber's FLS slot for a specified FLS index.                                    |
| [**IsThreadAFiber**](/windows/desktop/api/WinBase/)                 | Determines whether the current thread is a fiber.                                                            |
...
| [**GetNumaNodeProcessorMaskEx**](/windows/desktop/api/WinBase/)         | Retrieves the processor mask for the specified NUMA node as a USHORT value.                                                                            |
