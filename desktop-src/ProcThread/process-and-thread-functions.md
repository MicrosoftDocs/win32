...
| Function                                                                 | Description                                                                                                                                                                                   |
|--------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CreateProcess**](/windows/desktop/api)                                   | Creates a new process and its primary thread.                                                                                                                                                 |
...
| [**ExitProcess**](/windows/desktop/api)                                       | Ends the calling process and all its threads.                                                                                                                                                 |
| [**FlushProcessWriteBuffers**](/windows/desktop/api)             | Flushes the write queue of each processor that is running a thread of the current process.                                                                                                    |
...
| [**GetCurrentProcess**](/windows/desktop/api)                           | Retrieves a pseudo handle for the current process.                                                                                                                                            |
| [**GetCurrentProcessId**](/windows/desktop/api)                       | Retrieves the process identifier of the calling process.                                                                                                                                      |
| [**GetCurrentProcessorNumber**](/windows/desktop/api)           | Retrieves the number of the processor the current thread was running on during the call to this function.                                                                                     |
...
| [**GetExitCodeProcess**](/windows/desktop/api)                         | Retrieves the termination status of the specified process.                                                                                                                                    |
...
| [**GetPriorityClass**](/windows/desktop/api)                             | Retrieves the priority class for the specified process.                                                                                                                                       |
...
| [**GetProcessHandleCount**](/windows/desktop/api)                   | Retrieves the number of open handles that belong to the specified process.                                                                                                                    |
| [**GetProcessId**](/windows/desktop/api)                                     | Retrieves the process identifier of the specified process.                                                                                                                                    |
| [**GetProcessIdOfThread**](/windows/desktop/api)                     | Retrieves the process identifier of the process associated with the specified thread.                                                                                                         |
...
| [**GetProcessTimes**](/windows/desktop/api)                               | Retrieves timing information about for the specified process.                                                                                                                                 |
| [**GetProcessVersion**](/windows/desktop/api)                           | Retrieves the major and minor version numbers of the system on which the specified process expects to run.                                                                                    |
...
| [**GetProcessWorkingSetSizeEx**](/windows/desktop/api)         | Retrieves the minimum and maximum working set sizes of the specified process.                                                                                                                 |
...
| [**GetStartupInfo**](/windows/desktop/api/WinBase/nf-winbase-getstartupinfoa)                                 | Retrieves the contents of the [**STARTUPINFO**](/windows/desktop/api) structure that was specified when the calling process was created.                                                       |
...
| [**OpenProcess**](/windows/desktop/api)                                       | Opens an existing local process object.                                                                                                                                                       |
...
| [**QueryProcessAffinityUpdateMode**](/windows/desktop/api) | Retrieves the affinity update mode of the specified process.                                                                                                                                  |
| [**QueryProcessCycleTime**](/windows/desktop/api)                   | Retrieves the sum of the cycle time of all threads of the specified process.                                                                                                                  |
...
| [**SetPriorityClass**](/windows/desktop/api)                             | Sets the priority class for the specified process.                                                                                                                                            |
...
| [**SetProcessAffinityUpdateMode**](/windows/desktop/api)     | Sets the affinity update mode of the specified process.                                                                                                                                       |
...
| [**SetProcessShutdownParameters**](/windows/desktop/api)     | Sets shutdown parameters for the currently calling process.                                                                                                                                   |
...
| [**SetProcessWorkingSetSizeEx**](/windows/desktop/api)         | Sets the minimum and maximum working set sizes for the specified process.                                                                                                                     |
| [**TerminateProcess**](/windows/desktop/api)                             | Terminates the specified process and all of its threads.                                                                                                                                      |
...
| [**CreateRemoteThread**](/windows/desktop/api)                   | Creates a thread that runs in the virtual address space of another process.                                                                               |
| [**CreateRemoteThreadEx**](/windows/desktop/api)               | Creates a thread that runs in the virtual address space of another process and optionally specifies extended attributes such as processor group affinity. |
| [**CreateThread**](/windows/desktop/api)                               | Creates a thread to execute within the virtual address space of the calling process.                                                                      |
| [**ExitThread**](/windows/desktop/api)                                   | Ends the calling thread.                                                                                                                                  |
| [**GetCurrentThread**](/windows/desktop/api)                       | Retrieves a pseudo handle for the current thread.                                                                                                         |
| [**GetCurrentThreadId**](/windows/desktop/api)                   | Retrieves the thread identifier of the calling thread.                                                                                                    |
| [**GetExitCodeThread**](/windows/desktop/api)                     | Retrieves the termination status of the specified thread.                                                                                                 |
...
| [**GetThreadId**](/windows/desktop/api)                                 | Retrieves the thread identifier of the specified thread.                                                                                                  |
| [**GetThreadIdealProcessorEx**](/windows/desktop/api)     | Retrieves the processor number of the ideal processor for the specified thread.                                                                           |
...
| [**GetThreadPriority**](/windows/desktop/api)                     | Retrieves the priority value for the specified thread.                                                                                                    |
| [**GetThreadPriorityBoost**](/windows/desktop/api)           | Retrieves the priority boost control state of the specified thread.                                                                                       |
| [**GetThreadTimes**](/windows/desktop/api)                           | Retrieves timing information for the specified thread.                                                                                                    |
| [**OpenThread**](/windows/desktop/api)                                   | Opens an existing thread object.                                                                                                                          |
| [**QueryIdleProcessorCycleTime**](/windows/desktop/api) | Retrieves the cycle time for the idle thread of each processor in the system.                                                                             |
| [**QueryThreadCycleTime**](/windows/desktop/api)               | Retrieves the cycle time for the specified thread.                                                                                                        |
| [**ResumeThread**](/windows/desktop/api)                               | Decrements a thread's suspend count.                                                                                                                      |
...
| [**SetThreadIdealProcessorEx**](/windows/desktop/api)     | Sets the ideal processor for the specified thread and optionally retrieves the previous ideal processor.                                                  |
...
| [**SetThreadPriority**](/windows/desktop/api)                     | Sets the priority value for the specified thread.                                                                                                         |
| [**SetThreadPriorityBoost**](/windows/desktop/api)           | Disables the ability of the system to temporarily boost the priority of a thread.                                                                         |
| [**SetThreadStackGuarantee**](/windows/desktop/api)         | Sets the stack guarantee for the calling thread.                                                                                                          |
| [**Sleep**](/windows/desktop/api)                                             | Suspends the execution of the current thread for a specified interval.                                                                                    |
| [**SleepEx**](/windows/desktop/api)                                         | Suspends the current thread until the specified condition is met.                                                                                         |
| [**SuspendThread**](/windows/desktop/api)                             | Suspends the specified thread.                                                                                                                            |
| [**SwitchToThread**](/windows/desktop/api)                           | Causes the calling thread to yield execution to another thread that is ready to run on the current processor.                                             |
| [**TerminateThread**](/windows/desktop/api)                         | Terminates a thread.                                                                                                                                      |
...
| [**TlsAlloc**](/windows/desktop/api)                                       | Allocates a thread local storage (TLS) index.                                                                                                             |
| [**TlsFree**](/windows/desktop/api)                                         | Releases a TLS index.                                                                                                                                     |
| [**TlsGetValue**](/windows/desktop/api)                                 | Retrieves the value in the calling thread's TLS slot for a specified TLS index.                                                                           |
| [**TlsSetValue**](/windows/desktop/api)                                 | Stores a value in the calling thread's TLS slot for a specified TLS index.                                                                                |
...
| Function                                                                       | Description                                                                                          |
|--------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| [**DeleteProcThreadAttributeList**](/windows/desktop/api)         | Deletes the specified list of attributes for process and thread creation.                            |
| [**InitializeProcThreadAttributeList**](/windows/desktop/api) | Initializes the specified list of attributes for process and thread creation.                        |
| [**UpdateProcThreadAttribute**](/windows/desktop/api)                 | Updates the specified attribute in the specified list of attributes for process and thread creation. |
...
| [**IsWow64Process**](/windows/desktop/api)         | Determines whether the specified process is running under WOW64.                                                                       |
...
| Function                                                                                   | Description                                                                                                                                                                                                                                         |
|--------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CallbackMayRunLong**](/windows/desktop/api)                                           | Indicates that the callback may not return quickly.                                                                                                                                                                                                 |
| [**CancelThreadpoolIo**](/windows/desktop/api)                                           | Cancels the notification from the [**StartThreadpoolIo**](/windows/desktop/api) function.                                                                                                                                                          |
| [**CloseThreadpool**](/windows/desktop/api)                                                 | Closes the specified thread pool.                                                                                                                                                                                                                   |
| [**CloseThreadpoolCleanupGroup**](/windows/desktop/api)                         | Closes the specified cleanup group.                                                                                                                                                                                                                 |
| [**CloseThreadpoolCleanupGroupMembers**](/windows/desktop/api)           | Releases the members of the specified cleanup group, waits for all callback functions to complete, and optionally cancels any outstanding callback functions.                                                                                       |
| [**CloseThreadpoolIo**](/windows/desktop/api)                                             | Releases the specified I/O completion object.                                                                                                                                                                                                       |
| [**CloseThreadpoolTimer**](/windows/desktop/api)                                       | Releases the specified timer object.                                                                                                                                                                                                                |
| [**CloseThreadpoolWait**](/windows/desktop/api)                                         | Releases the specified wait object.                                                                                                                                                                                                                 |
| [**CloseThreadpoolWork**](/windows/desktop/api)                                         | Releases the specified work object.                                                                                                                                                                                                                 |
| [**CreateThreadpool**](/windows/desktop/api)                                               | Allocates a new pool of threads to execute callbacks.                                                                                                                                                                                               |
| [**CreateThreadpoolCleanupGroup**](/windows/desktop/api)                       | Creates a cleanup group that applications can use to track one or more thread pool callbacks.                                                                                                                                                       |
| [**CreateThreadpoolIo**](/windows/desktop/api)                                           | Creates a new I/O completion object.                                                                                                                                                                                                                |
| [**CreateThreadpoolTimer**](/windows/desktop/api)                                     | Creates a new timer object.                                                                                                                                                                                                                         |
| [**CreateThreadpoolWait**](/windows/desktop/api)                                       | Creates a new wait object.                                                                                                                                                                                                                          |
...
| [**DisassociateCurrentThreadFromCallback**](/windows/desktop/api)     | Removes the association between the currently executing callback function and the object that initiated the callback. The current thread will no longer count as executing a callback on behalf of the object.                                      |
| [**FreeLibraryWhenCallbackReturns**](/windows/desktop/api)                   | Specifies the DLL that the thread pool will unload when the current callback completes.                                                                                                                                                             |
...
| [**IsThreadpoolTimerSet**](/windows/desktop/api)                                       | Determines whether the specified timer object is currently set.                                                                                                                                                                                     |
| [**LeaveCriticalSectionWhenCallbackReturns**](/windows/desktop/api) | Specifies the critical section that the thread pool will release when the current callback completes.                                                                                                                                               |
| [**QueryThreadpoolStackInformation**](/windows/desktop/api)                 | Retrieves the stack reserve and commit sizes for threads in the specified thread pool.                                                                                                                                                              |
| [**ReleaseMutexWhenCallbackReturns**](/windows/desktop/api)                 | Specifies the mutex that the thread pool will release when the current callback completes.                                                                                                                                                          |
| [**ReleaseSemaphoreWhenCallbackReturns**](/windows/desktop/api)         | Specifies the semaphore that the thread pool will release when the current callback completes.                                                                                                                                                      |
| [**SetEventWhenCallbackReturns**](/windows/desktop/api)                         | Specifies the event that the thread pool will set when the current callback completes.                                                                                                                                                              |
...
| [**SetThreadpoolStackInformation**](/windows/desktop/api)                     | Sets the stack reserve and commit sizes for new threads in the specified thread pool.                                                                                                                                                               |
...
| [**SetThreadpoolThreadMinimum**](/windows/desktop/api)                           | Sets the minimum number of threads that the specified thread pool must make available to process callbacks.                                                                                                                                         |
...
| [**SetThreadpoolTimer**](/windows/desktop/api)                                           | Sets the timer object. A worker thread calls the timer object's callback after the specified timeout expires.                                                                                                                                       |
| [**SetThreadpoolWait**](/windows/desktop/api)                                             | Sets the wait object. A worker thread calls the wait object's callback function after the handle becomes signaled or after the specified timeout expires.                                                                                           |
...
| [**StartThreadpoolIo**](/windows/desktop/api)                                             | Notifies the thread pool that I/O operations may possibly begin for the specified I/O completion object. A worker thread calls the I/O completion object's callback function after the operation completes on the file handle bound to this object. |
| [**SubmitThreadpoolWork**](/windows/desktop/api)                                       | Posts a work object to the thread pool. A worker thread calls the work object's callback function.                                                                                                                                                  |
...
| [**TrySubmitThreadpoolCallback**](/windows/desktop/api)                         | Requests that a thread pool worker thread call the specified callback function.                                                                                                                                                                     |
| [**WaitForThreadpoolIoCallbacks**](/windows/desktop/api)                       | Waits for outstanding I/O completion callbacks to complete and optionally cancels pending callbacks that have not yet started to execute.                                                                                                           |
| [**WaitForThreadpoolTimerCallbacks**](/windows/desktop/api)                 | Waits for outstanding timer callbacks to complete and optionally cancels pending callbacks that have not yet started to execute.                                                                                                                    |
| [**WaitForThreadpoolWaitCallbacks**](/windows/desktop/api)                   | Waits for outstanding wait callbacks to complete and optionally cancels pending callbacks that have not yet started to execute.                                                                                                                     |
| [**WaitForThreadpoolWorkCallbacks**](/windows/desktop/api)                   | Waits for outstanding work callbacks to complete and optionally cancels pending callbacks that have not yet started to execute.                                                                                                                     |
...
| [**GetCurrentProcessorNumber**](/windows/desktop/api)               | Retrieves the number of the processor the current thread was running on during the call to this function.            |
| [**GetCurrentProcessorNumberEx**](/windows/desktop/api)           | Retrieves the processor group and number of the logical processor in which the calling thread is running.            |
| [**GetLogicalProcessorInformation**](https://msdn.microsoft.com/en-us/library/ms683194(v=VS.85).aspx)     | Retrieves information about logical processors and related hardware.                                                 |
...
| [**QueryIdleProcessorCycleTime**](/windows/desktop/api)           | Retrieves the cycle time for the idle thread of each processor in the system.                                        |
| [**QueryIdleProcessorCycleTimeEx**](/windows/desktop/api)       | Retrieves the accumulated cycle time for the idle thread on each logical processor in the specified processor group. |
