...
| [Microsoft TV Technologies](https://msdn.microsoft.com/library/Dd695086(v=VS.85).aspx)<br/>                                      | Supports digital television, recorded TV (.wtv) files, and OpenCable Unidirectional Cable Receiver (OCUR) devices.<br/>                                                                                                      |
| [Windows Media Center Software Development Kit](https://msdn.microsoft.com/library/Aa286546(v=MSDN.10).aspx)<br/>                                          | Using the Windows Media Center Software Development Kit (SDK), developers can create rich media applications and services for use with mouse, keyboard, and remote control on a Media Center PC.<br/>                        |
