...
Identifies the attendee who is sending the data. To get the attendee, use the identifier when accessing the [**Item Property of IRDPSRAPIAttendeeManager**](/windows/desktop/api/RdpEncomAPI/nf-rdpencomapi-irdpsrapiattendeemanager-get_item).
...
Applications use this notification to determine when to send data to the clients. After a call to [**IRDPSRAPIVirtualChannel::SendData**](/windows/desktop/api/RdpEncomAPI/nf-rdpencomapi-irdpsrapivirtualchannel-senddata) fails with **E\_PENDING**, applications should stop sending data until they receive this notification.
