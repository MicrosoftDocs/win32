...
The window whose property values changed. Query the **IDispatch** interface for the [**IRDPSRAPIWindow**](/windows/desktop/api/RdpEncomAPI/nn-rdpencomapi-irdpsrapiwindow) interface that you use to retrieve information about the window.
