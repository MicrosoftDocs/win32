...
keywords: ["OnWindowUpdate event RDP"]
topic_type:
- apiref
api_name:
- OnWindowUpdate
...
The window whose property values changed. Query the **IDispatch** interface for the [**IRDPSRAPIWindow**](irdpsrapiwindow.md) interface that you use to retrieve information about the window.
