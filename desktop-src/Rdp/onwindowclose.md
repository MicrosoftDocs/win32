...
The sharable top-level window that closed. Query the **IDispatch** interface for the [**IRDPSRAPIWindow**](/windows/desktop/api/RdpEncomAPI/nn-rdpencomapi-irdpsrapiwindow) interface that you use to retrieve information about the window.
