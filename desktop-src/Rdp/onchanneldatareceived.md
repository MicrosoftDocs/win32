...
Identifies the attendee who sent the data. To get the attendee, use the identifier when accessing the [**Item Property of IRDPSRAPIAttendeeManager**](/windows/desktop/api/RdpEncomAPI/nf-rdpencomapi-irdpsrapiattendeemanager-get_item).
