...
The only objects that can be co-created are the [**RDPSession**](/windows/desktop/api/RdpEncomAPI/) object for creating a sharer instance, and the **RDPViewer** object for creating a viewer instance. All other objects are created and accessed through the methods of these objects.
