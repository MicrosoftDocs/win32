...
For more information, see [Windows Controls](http://go.microsoft.com/fwlink/p/?linkid=191602).
...
For more information, see [Visual Styles](http://go.microsoft.com/fwlink/p/?linkid=191603).
...
For more information, see [Windows Ribbon Framework](http://go.microsoft.com/fwlink/p/?linkid=191604).
...
For more information, see [Windows Animation Manager](http://go.microsoft.com/fwlink/p/?linkid=191764).
...
For more information, see [Desktop Window Manager](http://go.microsoft.com/fwlink/p/?linkid=186246).
...
For more information, see [Windows Automation API](http://go.microsoft.com/fwlink/p/?linkid=191766).
...
For more information, see [Microsoft Speech API (SAPI) 5.4](http://go.microsoft.com/fwlink/p/?linkid=187202).
...
For more information, see [Magnification API](http://go.microsoft.com/fwlink/p/?linkid=191771).
...
For more information, see [Resource Compiler](http://go.microsoft.com/fwlink/p/?linkid=191774).

## User Interface Technologies for Managed Applications

This section describes the Microsoft technologies for developing UIs for managed Windows applications that run in the context of the .NET Framework. For more information, see [.NET Development](http://go.microsoft.com/fwlink/p/?linkid=188982).
...
For more information, see [Windows Presentation Foundation](http://go.microsoft.com/fwlink/p/?linkid=145035).
...
For more information, see [Microsoft Silverlight](http://go.microsoft.com/fwlink/p/?linkid=110063).
...
For more information, see [Prototyping with SketchFlow](http://go.microsoft.com/fwlink/p/?linkid=191570).
...
For more information, see [UI Automation for Managed Applications](http://go.microsoft.com/fwlink/p/?linkid=132102).
