...
|--------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| [**EapCredentialType**](/previous-versions/windows/desktop/api/eaptypes/ns-eaptypes-_eapcredential)                         | Defines the EAP credential types and the appropriate credentials.                                                          |
