...
After creating a vertex buffer in memory, the transform uses the [**CreateVertexBuffer**](https://msdn.microsoft.com/library/Hh404471(v=VS.85).aspx) method on the containing effect's [**ID2D1EffectContext**](https://msdn.microsoft.com/library/Hh404459(v=VS.85).aspx) object to pass that data to the GPU. Again, see the [D2DCustomEffects SDK sample](https://go.microsoft.com/fwlink/p/?LinkId=620531) for a sample implementation.
...
The above code can be used as a starting point for a vertex shader. It merely passes through the input image without performing any transforms. Again, see the [D2DCustomEffects SDK sample](https://go.microsoft.com/fwlink/p/?LinkId=620531) for a fully-implemented vertex shader-based transform.
...
[D2DCustomEffects SDK sample](https://go.microsoft.com/fwlink/p/?LinkId=620531)
</dt> </dl>
