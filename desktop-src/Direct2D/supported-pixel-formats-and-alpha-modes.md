...
When you use the [**CreateBitmapFromWicBitmap**](/windows/desktop/api/d2d1/) method to create a bitmap from a WIC bitmap, or when you use the [**CreateSharedBitmap**](/windows/desktop/api/d2d1/) method with an [**IWICBitmapLock**](https://www.bing.com/search?q=**IWICBitmapLock**), the WIC source must be in a format supported by Direct2D.
