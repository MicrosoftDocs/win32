...
> [!Note]  
> Starting with Windows 8, you can use the [**CreateBitmapBrush**](/windows/desktop/api/D2d1_1/) method on the [**ID2D1DeviceContext**](/windows/desktop/api/D2d1_1/) interface to create a [**ID2D1BitmapBrush**](/windows/desktop/api/d2d1/) instead of a **ID2D1BitmapBrush**. **ID2D1BitmapBrush** adds high-quality scaling modes to the bitmap brush.

 

![screen shot of a square filled with a plant bitmap](images/brushes-ovw-bitmap.png)

1.  Declare a variable of type [**ID2D1BitmapBrush**](/windows/desktop/api/d2d1/).
    ```C++
