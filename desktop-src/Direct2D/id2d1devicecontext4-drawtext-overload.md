...
| Method                                                                                                                                                                                                  | Description                                                   |
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------|
| [**DrawText(WCHAR\*, UINT32, IDWriteTextFormat\*, D2D1\_RECT\_F\*, ID2D1Brush\*, ID2D1SvgGlyphStyle\*, UINT32, D2D1\_DRAW\_TEXT\_OPTIONS, DWRITE\_MEASURING\_MODE)**](id2d1devicecontext4-drawtext.md) | Draws the text within the given layout rectangle.<br/>  |
| [**DrawText(WCHAR\*, UINT32, IDWriteTextFormat\*, D2D1\_RECT\_F&, ID2D1Brush\*, ID2D1SvgGlyphStyle\*, UINT32, D2D1\_DRAW\_TEXT\_OPTIONS, DWRITE\_MEASURING\_MODE)**](id2d1devicecontext4-drawtext.md)  | Draws the text within the given layout rectangle. <br/> |
...
[**ID2D1DeviceContext4**](id2d1devicecontext4.md)
</dt> </dl>
