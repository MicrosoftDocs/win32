...
2.  Call [**ID2D1RenderTarget::PushAxisAlignedClip**](/windows/win32/d2d1/?branch=master) to specify a rectangle. The rendering commands are clipped to the rectangle.

3.  Paint the original image.
4.  Call [**ID2D1RenderTarget::PopAxisAlignedClip**](/windows/win32/d2d1/?branch=master) to remove the last axis-aligned clip from the render target.
...
To create the clipped image, create a rectangle structure as the clipping area. Call [**PushAxisAlignedClip**](/windows/win32/d2d1/?branch=master) with the clipping area and paint the original image. Call [**PopAxisAlignedClip**](/windows/win32/d2d1/?branch=master) to remove the clip from the render target. The following code shows how to do this.
