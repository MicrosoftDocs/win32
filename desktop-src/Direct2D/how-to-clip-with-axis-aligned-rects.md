...
2.  Call [**ID2D1RenderTarget::PushAxisAlignedClip**](/windows/desktop/api/d2d1/) to specify a rectangle. The rendering commands are clipped to the rectangle.

3.  Paint the original image.
4.  Call [**ID2D1RenderTarget::PopAxisAlignedClip**](/windows/desktop/api/d2d1/) to remove the last axis-aligned clip from the render target.
...
To create the clipped image, create a rectangle structure as the clipping area. Call [**PushAxisAlignedClip**](/windows/desktop/api/d2d1/) with the clipping area and paint the original image. Call [**PopAxisAlignedClip**](/windows/desktop/api/d2d1/) to remove the clip from the render target. The following code shows how to do this.
