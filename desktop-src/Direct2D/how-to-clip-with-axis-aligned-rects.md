...
2.  Call [**ID2D1RenderTarget::PushAxisAlignedClip**](id2d1rendertarget-pushaxisalignedclip-ref-d2d-rect-f-d2d1-antialias-mode.md) to specify a rectangle. The rendering commands are clipped to the rectangle.

3.  Paint the original image.
4.  Call [**ID2D1RenderTarget::PopAxisAlignedClip**](id2d1rendertarget-popaxisalignedclip.md) to remove the last axis-aligned clip from the render target.
...
To create the clipped image, create a rectangle structure as the clipping area. Call [**PushAxisAlignedClip**](id2d1rendertarget-pushaxisalignedclip-ref-d2d-rect-f-d2d1-antialias-mode.md) with the clipping area and paint the original image. Call [**PopAxisAlignedClip**](id2d1rendertarget-popaxisalignedclip.md) to remove the clip from the render target. The following code shows how to do this.
