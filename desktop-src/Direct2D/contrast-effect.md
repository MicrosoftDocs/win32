...
The properties for the contrast effect are defined by the [**D2D1\_CONTRAST\_PROP**](/windows/win32/d2d1effects_2/ne-d2d1effects_2-d2d1_contrast_prop?branch=master) enumeration.
