...
| [**D2D1CreateFactory(D2D1\_FACTORY\_TYPE,REFIID,void\*\*)**](/windows/desktop/api/d2d1/)<br/>                                                               | Creates a factory object that can be used to create Direct2D resources.<br/>                                               |
...
| [**operator\* (const D2D1\_MATRIX\_3X2\_F&,const D2D1\_MATRIX\_3X2\_F&)**](/windows/desktop/api/windowsnumerics.inl/nf-d2d1helper-operator)<br/>                               | Multiplies two matrices and returns the result.<br/>                                                                       |
...
| [**GetType**](/windows/desktop/api/d2d1_1/nf-d2d1effecthelpers-gettype)<br/>                                                                                                                                                         | Retrieves the type of the given property.<br/>                                                                             |
