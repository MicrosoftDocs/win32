...
| [**operator\* (const D2D1\_MATRIX\_3X2\_F&,const D2D1\_MATRIX\_3X2\_F&)**](https://msdn.microsoft.com/en-us/library/Dd372318(v=VS.85).aspx)<br/>                               | Multiplies two matrices and returns the result.<br/>                                                                       |
