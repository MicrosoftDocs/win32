...
This how-to topic describes how to transform a geometry by calling [**CreateTransformedGeometry**](https://msdn.microsoft.com/library/Dd371307(v=VS.85).aspx).

**To transform a geometry**

1.  Declare an [**ID2D1TransformedGeometry**](https://msdn.microsoft.com/library/Dd372252(v=VS.85).aspx) variable.
2.  Call the [**CreateTransformedGeometry**](https://msdn.microsoft.com/library/Dd371307(v=VS.85).aspx) method to create a transformed geometry.
