...
4.  Call [**ID2D1Factory::SetAntialiasMode**](id2d1rendertarget-setantialiasmode.md) to set antialias mode on the render target to D2D1\_ANTIALIAS\_MODE\_ALIASED for [**ID2D1Factory::FillOpacityMask**](id2d1rendertarget-fillopacitymask.md) to work.
5.  Call [**FillOpacityMask**](id2d1rendertarget-fillopacitymask-ptr-id2d1bitmap-ptr-id2d1brush-ref-d2d-rect-f-ref-d2d-rect-f-d2d1-gamma.md) with the bitmap mask and the bitmap brush on the render target to fill the clip.
...
It then calls [**SetAntialiasMode**](id2d1rendertarget-setantialiasmode.md) to set the antialias mode. Call [**FillOpacityMask**](id2d1rendertarget-fillopacitymask-ptr-id2d1bitmap-ptr-id2d1brush-ref-d2d-rect-f-ref-d2d-rect-f-d2d1-gamma.md) to use a bitmap mask to clip the original bitmap.
