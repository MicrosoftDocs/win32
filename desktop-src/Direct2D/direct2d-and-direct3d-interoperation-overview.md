...
-   You can write Direct2D content to a Direct3D surface by obtaining an [**IDXGISurface**](https://msdn.microsoft.com/library/windows/desktop/bb174565) and using it with the [**CreateDxgiSurfaceRenderTarget**](/windows/desktop/api/d2d1/nf-d2d1-createdxgisurfacerendertarget) to create an [**ID2D1RenderTarget**](/windows/desktop/api/d2d1/). You can then use the render target to add a two-dimensional interface or background to three-dimensional graphics, or use a Direct2D drawing as a texture for a three dimensional object.
-   By using [**CreateSharedBitmap**](/windows/desktop/api/d2d1/) to create an [**ID2D1Bitmap**](/windows/desktop/api/d2d1/) from an [**IDXGISurface**](https://msdn.microsoft.com/library/windows/desktop/bb174565), you can write a Direct3D scene to a bitmap and render it with Direct2D.
...
A DXGI surface render target is a kind of [**ID2D1RenderTarget**](/windows/desktop/api/d2d1/). Like other Direct2D render targets, you can use it to create resources and issue drawing commands.
...
-   [**ID2D1Bitmap**](/windows/desktop/api/d2d1/) (which may be held indirectly by an [**ID2D1BitmapBrush**](/windows/desktop/api/d2d1/))
