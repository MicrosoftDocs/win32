...
Unlike other APIs, such as [GDI](https://msdn.microsoft.com/library/windows/desktop/dd145203), GDI+ or WPF, [Direct2D](direct2d.direct2d_portal.xml) interoperates with another API, [DirectWrite](https://msdn.microsoft.com/library/windows/desktop/dd368038), to manipulate and render text. This topic describes the benefits and interoperation of these separate components.
...
Therefore, [Direct2D](direct2d.direct2d_portal.xml) provides layered APIs that enable an application to start simply and grow more sophisticated without having to back-track or abandon their working code. A simplified view is shown in the following diagram:
...
An application moving to [Direct2D](direct2d.direct2d_portal.xml) will also obtain the following features:
...
This topic explains the differences and similarities between [Direct2D](direct2d.direct2d_portal.xml) and [DirectWrite](https://msdn.microsoft.com/library/windows/desktop/dd368038) and the architectural motivations for providing them as separate, cooperative APIs.
