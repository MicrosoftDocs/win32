...
| BorderMode<br/> D2D1\_3DPERSPECTIVETRANSFORM\_PROP\_BORDER\_MODE<br/>               | The mode used to calculate the border of the image, soft or hard. See [Border modes](InterpolationMode #1) for more info.<br/> Type is D2D1\_BORDER\_MODE.<br/> Default value is D2D1\_BORDER\_MODE\_SOFT.<br/>                                                              |
...
For an example of this effect, download the [Direct2D 3D transform effect sample](http://go.microsoft.com/fwlink/p/?linkid=254009).
