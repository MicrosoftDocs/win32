...
The following example uses an [**ID2D1HwndRenderTarget**](/windows/desktop/api/d2d1/) to draw and fill several rectangles. This example produces output as shown in the following illustration.
