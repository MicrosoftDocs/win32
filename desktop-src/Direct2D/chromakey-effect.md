...
The properties for the chroma-key effect are defined by the [**D2D1\_CHROMAKEY\_PROP**](/windows/win32/d2d1effects_2/ne-d2d1effects_2-d2d1_chromakey_prop?branch=master) enumeration.
