...
The properties for the posterize effect are defined by the [**D2D1\_POSTERIZE\_PROP**](/windows/win32/d2d1effects_2/ne-d2d1effects_2-d2d1_posterize_prop?branch=master) enumeration.
