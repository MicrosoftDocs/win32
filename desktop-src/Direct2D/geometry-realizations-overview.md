...
On the other hand, consider a kaleidoscope app with animated geometry that continually changes. This app would probably not benefit from using geometry realizations. Since the shapes themselves change from frame to frame, it is not useful to cache their tessellations. The best approach for this app is to draw [**ID2D1Geometry**](id2d1geometry.md) objects directly.

## Creating geometry realizations

An [**ID2D1GeometryRealization**](id2d1geometryrealization.md) object must be created from an existing [**ID2D1Geometry**](id2d1geometry.md) object. To create a geometry realization, call the [**CreateFilledGeometryRealization**](id2d1devicecontext1-createfilledgeometryrealization.md) method or the [**CreateStrokedGeometryRealization**](id2d1devicecontext1-createstrokedgeometryrealization.md) method and pass in the **ID2D1Geometry** to be realized.

-   [**CreateFilledGeometryRealization**](id2d1devicecontext1-createfilledgeometryrealization.md) creates a realization of the interior of the shape: the region that would be drawn by calling [**FillGeometry**](id2d1rendertarget-fillgeometry.md).
-   [**CreateStrokedGeometryRealization**](id2d1devicecontext1-createstrokedgeometryrealization.md) creates a realization of the stroke of the shape: the region that would be drawn by calling [**DrawGeometry**](id2d1rendertarget-drawgeometry.md).

Both kinds of geometry realization are represented by the [**ID2D1GeometryRealization**](id2d1geometryrealization.md) interface.
...
Drawing geometry realizations is similar to drawing other [Direct2D](direct2d-portal.md) primitives, like bitmaps. To do so, call the [**DrawGeometryRealization**](id2d1devicecontext1-drawgeometryrealization.md) method and pass it the geometry realization object to be drawn and the brush to use. As with other Direct2D drawing methods, you must call **DrawGeometryRealization** between calls to [**BeginDraw**](id2d1rendertarget-begindraw.md) and [**EndDraw**](id2d1rendertarget-enddraw.md).
...
[**ID2D1DeviceContext1**](id2d1devicecontext1.md)
</dt> <dt>

[**ID2D1GeometryRealization**](id2d1geometryrealization.md)
</dt> <dt>

[**ComputeFlatteningTolerance function**](computeflatteningtolerance.md)
</dt> </dl>
