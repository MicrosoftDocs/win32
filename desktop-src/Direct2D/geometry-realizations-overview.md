...
On the other hand, consider a kaleidoscope app with animated geometry that continually changes. This app would probably not benefit from using geometry realizations. Since the shapes themselves change from frame to frame, it is not useful to cache their tessellations. The best approach for this app is to draw [**ID2D1Geometry**](/windows/win32/d2d1/?branch=master) objects directly.

## Creating geometry realizations

An [**ID2D1GeometryRealization**](/windows/win32/D2d1_2/?branch=master) object must be created from an existing [**ID2D1Geometry**](/windows/win32/d2d1/?branch=master) object. To create a geometry realization, call the [**CreateFilledGeometryRealization**](/windows/win32/D2d1_2/?branch=master) method or the [**CreateStrokedGeometryRealization**](/windows/win32/D2d1_2/?branch=master) method and pass in the **ID2D1Geometry** to be realized.

-   [**CreateFilledGeometryRealization**](/windows/win32/D2d1_2/?branch=master) creates a realization of the interior of the shape: the region that would be drawn by calling [**FillGeometry**](/windows/win32/d2d1/?branch=master).
-   [**CreateStrokedGeometryRealization**](/windows/win32/D2d1_2/?branch=master) creates a realization of the stroke of the shape: the region that would be drawn by calling [**DrawGeometry**](/windows/win32/d2d1/?branch=master).

Both kinds of geometry realization are represented by the [**ID2D1GeometryRealization**](/windows/win32/D2d1_2/?branch=master) interface.
...
Drawing geometry realizations is similar to drawing other [Direct2D](direct2d-portal.md) primitives, like bitmaps. To do so, call the [**DrawGeometryRealization**](/windows/win32/D2d1_2/?branch=master) method and pass it the geometry realization object to be drawn and the brush to use. As with other Direct2D drawing methods, you must call **DrawGeometryRealization** between calls to [**BeginDraw**](/windows/win32/d2d1/?branch=master) and [**EndDraw**](/windows/win32/d2d1/?branch=master).
...
[**ComputeFlatteningTolerance function**](/windows/win32/D2d1_1helper/?branch=master)
</dt> </dl>
