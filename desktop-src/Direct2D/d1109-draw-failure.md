...
The first tag value (see [**SetTags**](/windows/desktop/api/d2d1/) more for information).
...
The second tag value (see [**SetTags**](/windows/desktop/api/d2d1/) more for information).
