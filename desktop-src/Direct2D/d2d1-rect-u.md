...
**D2D1\_RECT\_U** is a new name for the already defined [**D2D\_RECT\_U**](/windows/win32/dcommon/ns-dcommon-d2d_rect_u?branch=master) structure.
...
[**D2D\_RECT\_U**](/windows/win32/dcommon/ns-dcommon-d2d_rect_u?branch=master)
</dt> </dl>
