...
-   [**Translation(D2D1\_SIZE\_F size)**](https://msdn.microsoft.com/en-us/library/Dd372291(v=VS.85).aspx): takes an ordered pair that defines the distance to translate along the x-axis and the y-axis.
