...
-   [**Translation(D2D1\_SIZE\_F size)**](/windows/desktop/api/d2d1helper/nf-d2d1helper-matrix3x2f-translation(float_float)): takes an ordered pair that defines the distance to translate along the x-axis and the y-axis.
-   [**Translation(float x, float y)**](https://msdn.microsoft.com/en-us/library/Dd372292(v=VS.85).aspx): takes the distance to translate along the x-axis and the distance to translate along the y-axis.
