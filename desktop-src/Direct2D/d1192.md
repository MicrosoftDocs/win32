...
Direct2D Print: Font subsetting routine [**CreateFontPackage**](https://docs.microsoft.com/windows/desktop/api/fontsub/nf-fontsub-createfontpackage) failed, error \[*error code*\]. Original font data is used, output size increase is possible.
