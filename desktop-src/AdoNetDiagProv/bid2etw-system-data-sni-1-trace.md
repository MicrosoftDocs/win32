...
The parent class for SQL Server Network Interface (SNI) events.
...
``` syntax
[dynamic, Guid("{C9996FA6-C06F-F20C-8A20-69B3BA392315}"), DisplayName("System.Data.SNI")]
...
The **Bid2Etw\_System\_Data\_SNI\_1\_Trace** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_SNI\_1\_Trace** class has these properties.
