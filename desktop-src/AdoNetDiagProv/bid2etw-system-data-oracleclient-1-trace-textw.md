---
Description: 'The event type class for System.Data.OracleClient.dll events. (Unicode).'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '496eb416-3017-4ea2-9cfe-e15e20a0d703'
ms.prod: 'windows-server-dev'
ms.technology:
- 'dotnet-ado'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: 'Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextW class'
---

# Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextW class

The event type class for System.Data.OracleClient.dll events. (Unicode)
...
The **Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextW** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextW** class has these properties.
