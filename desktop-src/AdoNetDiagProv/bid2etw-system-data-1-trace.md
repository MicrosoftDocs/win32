---
Description: 'The parent class for events in the System.Data.dll assembly.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '48795645-8343-4281-8dbc-5d9f5c00499f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'dotnet-ado'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: 'Bid2Etw\_System\_Data\_1\_Trace class'
---

# Bid2Etw\_System\_Data\_1\_Trace class

The parent class for events in the System.Data.dll assembly.
...
``` syntax
[dynamic, Guid("{914ABDE3-171E-C600-3348-C514171DE148}"), DisplayName("System.Data")]
...
The **Bid2Etw\_System\_Data\_1\_Trace** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_1\_Trace** class has these properties.
