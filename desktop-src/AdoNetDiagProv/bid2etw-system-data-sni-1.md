---
Description: The Event Tracing for Windows (ETW) provider for the SQL Server Network Interface (SNI)-related events from the System.Data.dll assembly.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: bf05c6d4-34ba-4293-8da9-5eaf2d7aa586
ms.prod: windows-server-dev
ms.technology:
- dotnet-ado
- windows-management-instrumentation
ms.tgt_platform: multiple
title: Bid2Etw\_System\_Data\_SNI\_1 class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# Bid2Etw\_System\_Data\_SNI\_1 class
...
``` syntax
[dynamic, Guid("{C9996FA5-C06F-F20C-8A20-69B3BA392315}")]
...
The **Bid2Etw\_System\_Data\_SNI\_1** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_SNI\_1** class has these properties.
