---
Description: The Event Tracing for Windows (ETW) provider for events in the System.Data.OracleClient.dll assembly.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 05af630d-e249-4c8a-b4e5-eba3c148e727
ms.prod: windows-server-dev
ms.technology:
- dotnet-ado
- windows-management-instrumentation
ms.tgt_platform: multiple
title: Bid2Etw\_System\_Data\_OracleClient\_1 class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Bid2Etw\_System\_Data\_OracleClient\_1 class
...
``` syntax
[dynamic, Guid("{DCD90923-4953-20C2-8708-01976FB15287}")]
...
The **Bid2Etw\_System\_Data\_OracleClient\_1** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_OracleClient\_1** class has these properties.
