---
Description: 'The event type class for SQL Server Network Interface (SNI) events. (ASCII).'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '1a917999-e2f5-408a-88ea-7e37d42944e1'
ms.prod: 'windows-server-dev'
ms.technology:
- 'dotnet-ado'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: 'Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextA class'
---

# Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextA class

The event type class for SQL Server Network Interface (SNI) events. (ASCII)
...
The **Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextA** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextA** class has these properties.
