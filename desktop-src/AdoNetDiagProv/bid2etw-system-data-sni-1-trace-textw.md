---
Description: The event type class for SQL Server Network Interface (SNI) events. (Unicode).
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 4cd1db72-94f6-4e2f-a854-2fdcc74ab3e4
ms.prod: windows-server-dev
ms.technology:
- dotnet-ado
- windows-management-instrumentation
ms.tgt_platform: multiple
title: Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextW class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextW class
...
The **Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextW** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_SNI\_1\_Trace\_TextW** class has these properties.
