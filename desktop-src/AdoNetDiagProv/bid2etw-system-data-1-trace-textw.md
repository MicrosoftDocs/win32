---
Description: The event type class for System.Data.dll events. (Unicode).
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: f280972e-9101-4a13-b9cc-fbafa1f7abdf
ms.prod: windows-server-dev
ms.technology:
- dotnet-ado
- windows-management-instrumentation
ms.tgt_platform: multiple
title: Bid2Etw\_System\_Data\_1\_Trace\_TextW class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# Bid2Etw\_System\_Data\_1\_Trace\_TextW class

The event type class for System.Data.dll events. (Unicode)
...
The **Bid2Etw\_System\_Data\_1\_Trace\_TextW** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_1\_Trace\_TextW** class has these properties.
