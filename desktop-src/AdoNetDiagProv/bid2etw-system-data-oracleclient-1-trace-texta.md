---
Description: The event type class for System.Data.OracleClient.dll events. (ASCII).
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 0966a226-3d4b-4026-b5af-1abf2e4b398e
ms.prod: windows-server-dev
ms.technology:
- dotnet-ado
- windows-management-instrumentation
ms.tgt_platform: multiple
title: Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextA class
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextA class

The event type class for System.Data.OracleClient.dll events. (ASCII)
...
The **Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextA** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_System\_Data\_OracleClient\_1\_Trace\_TextA** class has these properties.
