---
Description: The Event Tracing for Windows (ETW) provider for events in the ADO.NET ETW adapter.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: c13d4d67-6862-489a-a2a0-83729c110948
ms.prod: windows-server-dev
ms.technology:
- dotnet-ado
- windows-management-instrumentation
ms.tgt_platform: multiple
title: Bid2Etw\_ADONETDIAG\_ETW class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Bid2Etw\_ADONETDIAG\_ETW class
...
``` syntax
[dynamic, Guid("{7ACDCAC8-8947-F88A-E51A-24018F5129EF}")]
...
The **Bid2Etw\_ADONETDIAG\_ETW** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_ADONETDIAG\_ETW** class has these properties.
