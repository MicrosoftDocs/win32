---
Description: 'The parent class for events in the ADO.NET ETW adapter.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\markl'
ms.assetid: '1157693e-b044-42bf-a1f0-c454339a1c91'
ms.prod: 'windows-server-dev'
ms.technology:
- 'dotnet-ado'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
title: 'Bid2Etw\_ADONETDIAG\_ETW\_Trace class'
---

# Bid2Etw\_ADONETDIAG\_ETW\_Trace class

The parent class for events in the ADO.NET ETW adapter.
...
``` syntax
[dynamic, Guid("{7ACDCAC9-8947-F88A-E51A-24018F5129EF}"), DisplayName("AdoNetDiag")]
...
The **Bid2Etw\_ADONETDIAG\_ETW\_Trace** class has these types of members:

-   [Properties](#properties)

### Properties

The **Bid2Etw\_ADONETDIAG\_ETW\_Trace** class has these properties.
