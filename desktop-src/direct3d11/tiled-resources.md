...
| [Creating tiled resources](creating-tiled-resources.md)<br/>                     | Tiled resources are created by specifying the [**D3D11\_RESOURCE\_MISC\_TILED**](/windows/win32/D3D11/ne-d3d11-d3d11_resource_misc_flag?branch=master) flag when you create a resource.<br/>                                                                                          |
...
| [Tiled resources features tiers](tiled-resources-features-tiers.md)<br/>         | Direct3D 11.2 exposes tiled resources support in two tiers with the [**D3D11\_TILED\_RESOURCES\_TIER**](/windows/win32/D3D11/ne-d3d11-d3d11_tiled_resources_tier?branch=master) values. <br/>                                                                                         |
