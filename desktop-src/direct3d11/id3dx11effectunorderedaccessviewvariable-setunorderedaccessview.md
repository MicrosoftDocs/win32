...
keywords: ["SetUnorderedAccessView method Direct3D 11", "SetUnorderedAccessView method Direct3D 11 , ID3DX11EffectUnorderedAccessViewVariable interface", "ID3DX11EffectUnorderedAccessViewVariable interface Direct3D 11 , SetUnorderedAccessView method"]
topic_type:
- apiref
api_name:
...
Pointer to an [**ID3D11UnorderedAccessView**](id3d11unorderedaccessview.md).
