...
There are two types of input buffers: [vertex buffers](https://msdn.microsoft.com/library/windows/desktop/bb205133) and index buffers. Vertex buffers supply vertex data to the IA stage. Index buffers are optional; they provide indices to vertices from the vertex buffer. You may create one or more vertex buffers and, optionally, an index buffer.
...
For help with creating a vertex buffer, see [Create a Vertex Buffer](https://msdn.microsoft.com/library/windows/desktop/bb205130). For help with creating an index buffer, see Create an Index Buffer.
