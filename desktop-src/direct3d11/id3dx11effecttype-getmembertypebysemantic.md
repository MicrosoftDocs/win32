...
keywords: ["GetMemberTypeBySemantic method Direct3D 11", "GetMemberTypeBySemantic method Direct3D 11 , ID3DX11EffectType interface", "ID3DX11EffectType interface Direct3D 11 , GetMemberTypeBySemantic method"]
topic_type:
- apiref
api_name:
