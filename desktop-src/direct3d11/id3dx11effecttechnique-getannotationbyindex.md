...
keywords: ["GetAnnotationByIndex method Direct3D 11", "GetAnnotationByIndex method Direct3D 11 , ID3DX11EffectTechnique interface", "ID3DX11EffectTechnique interface Direct3D 11 , GetAnnotationByIndex method"]
topic_type:
- apiref
api_name:
