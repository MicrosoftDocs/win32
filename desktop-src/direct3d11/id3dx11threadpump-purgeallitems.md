...
keywords: ["PurgeAllItems method Direct3D 11", "PurgeAllItems method Direct3D 11 , ID3DX11ThreadPump interface", "ID3DX11ThreadPump interface Direct3D 11 , PurgeAllItems method"]
topic_type:
- apiref
api_name:
