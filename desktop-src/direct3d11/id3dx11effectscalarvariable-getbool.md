...
keywords: ["GetBool method Direct3D 11", "GetBool method Direct3D 11 , ID3DX11EffectScalarVariable interface", "ID3DX11EffectScalarVariable interface Direct3D 11 , GetBool method"]
topic_type:
- apiref
api_name:
