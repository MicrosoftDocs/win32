...
1.  Create an [**IDXGIFactory**](https://msdn.microsoft.com/library/windows/desktop/bb174535) object and use it to enumerate the available adapters. For more information, see [How To: Enumerate Adapters](overviews-direct3d-11-devices-enum.md).
...
3.  Call IDXGIOutput::GetDisplayModeList to retrieve an array of [**DXGI\_MODE\_DESC**](https://msdn.microsoft.com/library/windows/desktop/bb173064) structures and the number of elements in the array. Each **DXGI\_MODE\_DESC** structure represents a valid display mode for the output.
    ```
    UINT numModes = 0;
