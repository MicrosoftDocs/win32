...
Dedicated APIs for copying tiles ([**ID3D11DeviceContext2::CopyTiles**](id3d11devicecontext2-copytiles.md) and [**ID3D11DeviceContext2::UpdateTiles**](id3d11devicecontext2-updatetiles.md)) can't access packed mips. Applications that want to copy data to and from packed mips can do so using all the non-tiled resource specific APIs for copying and rendering to surfaces.
