...
Type: **[**ID3D11VertexShader**](/windows/desktop/api/D3D11/)\*\***

A pointer to an [**ID3D11VertexShader**](/windows/desktop/api/D3D11/) pointer that will be set to the vertex shader on return.
