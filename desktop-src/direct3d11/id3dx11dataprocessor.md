...
keywords: ["ID3DX11DataProcessor interface Direct3D 11", "ID3DX11DataProcessor interface Direct3D 11 , described"]
topic_type:
- apiref
api_name:
...
The **ID3DX11DataProcessor** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **ID3DX11DataProcessor** also has these types of members:
...
<tbody>
<tr class="odd">
<td style="text-align: left;">[<strong>CreateDeviceObject</strong>](id3dx11dataprocessor-createdeviceobject.md)</td>
...
<tr class="even">
<td style="text-align: left;">[<strong>Destroy</strong>](id3dx11dataprocessor-destroy.md)</td>
<td style="text-align: left;"><blockquote>
[!Note]<br />
The D3DX (D3DX 9, D3DX 10, and D3DX 11) utility library is deprecated for Windows 8 and is not supported for Windows Store apps.
</blockquote>
...
<tr class="odd">
<td style="text-align: left;">[<strong>Process</strong>](id3dx11dataprocessor-process.md)</td>
<td style="text-align: left;"><blockquote>
[!Note]<br />
The D3DX (D3DX 9, D3DX 10, and D3DX 11) utility library is deprecated for Windows 8 and is not supported for Windows Store apps.
</blockquote>
