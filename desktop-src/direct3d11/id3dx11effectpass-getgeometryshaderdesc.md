...
keywords: ["GetGeometryShaderDesc method Direct3D 11", "GetGeometryShaderDesc method Direct3D 11 , ID3DX11EffectPass interface", "ID3DX11EffectPass interface Direct3D 11 , GetGeometryShaderDesc method"]
topic_type:
- apiref
api_name:
