---
title: ID3DX11EffectVariable AsSampler method
description: Get a sampler variable.
ms.assetid: 'dff699f7-758a-442b-93eb-23a09468251f'
keywords: ["AsSampler method Direct3D 11", "AsSampler method Direct3D 11 , ID3DX11EffectVariable interface", "ID3DX11EffectVariable interface Direct3D 11 , AsSampler method"]
topic_type:
- apiref
api_name:
