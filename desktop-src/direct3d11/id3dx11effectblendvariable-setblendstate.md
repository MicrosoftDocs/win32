...
description: Sets an effects blend-state.
...
Type: **[**ID3D11BlendState**](/windows/win32/D3D11/nn-d3d11-id3d11blendstate?branch=master)\***

A pointer to an [**ID3D11BlendState**](/windows/win32/D3D11/nn-d3d11-id3d11blendstate?branch=master) interface containing the blend-state to set.
