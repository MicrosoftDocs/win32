...
The [**ID3D11DeviceContext2::UpdateTileMappings**](id3d11devicecontext2-updatetilemappings.md) and [**ID3D11DeviceContext2::CopyTileMappings**](id3d11devicecontext2-copytilemappings.md) APIs manipulate and query tile mappings. Update calls only affect the tiles identified in the call, and others are left as defined previously.
...
To query resource tiling, use [**ID3D11Device2::GetResourceTiling**](id3d11device2-getresourcetiling.md).

For other resource tiling support, use [**ID3D11Device2::CheckMultisampleQualityLevels1**](id3d11device2-checkmultisamplequalitylevels1.md).
...
-   Copy between tiles in a tiled resource (at 64KB tile granularity) and (to/from) a buffer in graphics processing unit (GPU) memory (or staging resource) - [**ID3D11DeviceContext2::CopyTiles**](id3d11devicecontext2-copytiles.md)
-   Copy from application-provided memory to tiles in a tiled resource - [**ID3D11DeviceContext2::UpdateTiles**](id3d11devicecontext2-updatetiles.md)
...
To resize a tile pool, use [**ID3D11DeviceContext2::ResizeTilePool**](id3d11devicecontext2-resizetilepool.md).

## Tiled resource barrier

To specify a data access ordering constraint between multiple tiled resources, use [**ID3D11DeviceContext2::TiledResourceBarrier**](id3d11devicecontext2-tiledresourcebarrier.md).
