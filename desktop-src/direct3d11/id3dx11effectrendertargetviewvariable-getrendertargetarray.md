...
keywords: ["GetRenderTargetArray method Direct3D 11", "GetRenderTargetArray method Direct3D 11 , ID3DX11EffectRenderTargetViewVariable interface", "ID3DX11EffectRenderTargetViewVariable interface Direct3D 11 , GetRenderTargetArray method"]
topic_type:
- apiref
api_name:
...
A pointer to an array of render-target-view interfaces. See [**ID3D11RenderTargetView**](id3d11rendertargetview.md).
