...
-   Call [**ID3D11DeviceContext::ExecuteCommandList**](/windows/win32/D3D11/nf-d3d11-id3d11devicecontext-executecommandlist?branch=master) and pass a valid [**ID3D11CommandList**](/windows/win32/D3D11/nn-d3d11-id3d11commandlist?branch=master) object.
    ```
