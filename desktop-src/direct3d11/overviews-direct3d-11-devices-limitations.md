...
-   D3D\_DRIVER\_TYPE\_WARP on all feature levels in Direct3D 11.1, which Windows 8 includes
    ...
    When you call [**D3D11CreateDevice**](d3d11createdevice.md) to create a Direct3D 11.1 device, the call is valid if you specify a combination of one of these driver types with one of these feature levels.
...
-   D3D\_DRIVER\_TYPE\_WARP on D3D\_FEATURE\_LEVEL\_9\_1 through D3D\_FEATURE\_LEVEL\_10\_1 feature levels in Direct3D 11
    ...
    When you call [**D3D11CreateDevice**](d3d11createdevice.md) to create a Direct3D 11 device, the call is valid if you specify a combination of one of these driver types with one of these feature levels.
...
[**D3D\_DRIVER\_TYPE**](d3d-driver-type.md)
</dt> <dt>

[**D3D\_FEATURE\_LEVEL**](d3d-feature-level.md)
</dt> </dl>
