...
description: Learn how the Direct3D input-assembler stage generates vertex, primitive, and instance identifiers for use in shader operations.
...
> [!NOTE]
> These Direct3D system-generated values apply to apps regardless of whether they use the Win32 or UWP app model.
