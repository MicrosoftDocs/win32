...
keywords: ["GetVertexShaderDesc method Direct3D 11", "GetVertexShaderDesc method Direct3D 11 , ID3DX11EffectPass interface", "ID3DX11EffectPass interface Direct3D 11 , GetVertexShaderDesc method"]
topic_type:
- apiref
api_name:
