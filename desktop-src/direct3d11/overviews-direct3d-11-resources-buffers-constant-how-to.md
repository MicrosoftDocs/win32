...
> [!Note]  
> Make sure to match the VS\_CONSTANT\_BUFFER memory layout in C++ with the HLSL layout. For info about how HLSL handles layout in memory, see [Packing Rules for Constant Variables](https://msdn.microsoft.com/library/windows/desktop/bb509632).
