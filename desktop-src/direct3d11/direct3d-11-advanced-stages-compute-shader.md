...
When you use [DirectCompute](https://go.microsoft.com/fwlink/p/?linkid=209544) with cs\_5\_0 [profiles](https://msdn.microsoft.com/library/windows/desktop/bb509626#shader-profile), keep the following items in mind:
