...
keywords: ["SetClassInstance method Direct3D 11", "SetClassInstance method Direct3D 11 , ID3DX11EffectInterfaceVariable interface", "ID3DX11EffectInterfaceVariable interface Direct3D 11 , SetClassInstance method"]
topic_type:
- apiref
api_name:
