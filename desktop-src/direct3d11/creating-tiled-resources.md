...
| Topic                                                                                                             | Description                                                                                                                                                                                                                                                                                                                   |
|-------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Mappings are into a tile pool](mappings-are-into-a-tile-pool.md)<br/>                                     | When a resource is created with the [**D3D11\_RESOURCE\_MISC\_TILED**](d3d11-resource-misc-flag.md) flag, the tiles that make up the resource come from pointing at locations in a tile pool. A tile pool is a pool of memory (backed by one or more allocations behind the scenes - unseen by the application). <br/> |
...
| [Tile pool creation parameters](tile-pool-creation-parameters.md)<br/>                                     | Use the parameters in this section to define tile pools via the [**ID3D11Device::CreateBuffer**](id3d11device-createbuffer.md) API. <br/>                                                                                                                                                                              |
