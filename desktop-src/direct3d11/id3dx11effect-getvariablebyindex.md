...
keywords: ["GetVariableByIndex method Direct3D 11", "GetVariableByIndex method Direct3D 11 , ID3DX11Effect interface", "ID3DX11Effect interface Direct3D 11 , GetVariableByIndex method"]
topic_type:
- apiref
api_name:
