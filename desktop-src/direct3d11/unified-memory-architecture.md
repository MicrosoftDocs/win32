...
A boolean, set by the driver, can be read from the [**D3D11\_FEATURE\_DATA\_D3D11\_OPTIONS2**](/windows/win32/D3D11/ns-d3d11-d3d11_feature_data_d3d11_options2?branch=master) structure to determine if the hardware supports UMA.
