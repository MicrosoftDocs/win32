...
| D3D10\_CREATE\_DEVICE\_SWITCH\_TO\_REF | [**D3D11\_CREATE\_DEVICE\_SWITCH\_TO\_REF**](d3d11-create-device-flag.md)The switch-to-ref functionality is not supported by Direct3D 11.<br/>                                                                                                                                                                                                                                                                        |
| D3D10\_DRIVER\_TYPE                    | [**D3D\_DRIVER\_TYPE**](d3d-driver-type.md)Note that the enumeration identifiers in [**D3D\_DRIVER\_TYPE**](d3d-driver-type.md) were redefined from the identifiers in [**D3D10\_DRIVER\_TYPE**](https://msdn.microsoft.com/library/windows/desktop/bb205042). Therefore, you should be sure to use the enumeration identifiers instead of literal numbers.<br/> [**D3D\_DRIVER\_TYPE**](d3d-driver-type.md) is defined in D3Dcommon.h.<br/> |
| D3D10\_RESOURCE\_MISC\_FLAG            | [**D3D11\_RESOURCE\_MISC\_FLAG**](d3d11-resource-misc-flag.md)Note that many of these flags were redefined, so be sure to use enumeration identifiers instead of literal numbers.<br/>                                                                                                                                                                                                                                |
| D3D10\_FILTER                          | [**D3D11\_FILTER**](d3d11-filter.md)Note that text filtering D3D10\_FILTER\_TEXT\_1BIT was removed from Direct3D 11. See DirectWrite.<br/>                                                                                                                                                                                                                                                                            |
| D3D11\_COUNTER                         | [**D3D11\_COUNTER**](d3d11-counter.md)Note that the vendor-neutral counters were removed for Direct3D 11 as they were rarely supported.<br/>                                                                                                                                                                                                                                                                          |
...
| Direct3D 10                              | Direct3D 11                                                                                                                                                 |
|------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| D3D10\_SO\_DECLARATION\_ENTRY            | [**D3D11\_SO\_DECLARATION\_ENTRY**](d3d11-so-declaration-entry.md)Adds Stream.<br/>                                                                  |
| D3D10\_BLEND\_DESC                       | [**D3D11\_BLEND\_DESC**](d3d11-blend-desc.md)Note this structure changed significantly from 10 to 10.1 to provide per render target blend state<br/> |
| D3D10\_BUFFER\_DESC                      | [**D3D11\_BUFFER\_DESC**](d3d11-buffer-desc.md)Adds a StructureByteStride for use with Compute Shader resources<br/>                                 |
| D3D10\_SHADER\_RESOURCE\_VIEW\_DESC      | [**D3D11\_SHADER\_RESOURCE\_VIEW\_DESC**](d3d11-shader-resource-view-desc.md)Note this structure had additional union members added for 10.1<br/>    |
| D3D10\_DEPTH\_STENCIL\_VIEW\_DESC        | [**D3D11\_DEPTH\_STENCIL\_VIEW\_DESC**](d3d11-depth-stencil-view-desc.md)Has a new Flags member.<br/>                                                |
| D3D10\_QUERY\_DATA\_PIPELINE\_STATISTICS | [**D3D11\_QUERY\_DATA\_PIPELINE\_STATISTICS**](d3d11-query-data-pipeline-statistics.md)Adds several new shader stage counters.<br/>                  |
...
| Direct3D 10        | Direct3D 11                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ID3D10Device       | [**ID3D11Device**](id3d11device.md) and [**ID3D11DeviceContext**](id3d11devicecontext.md)<br/> The device interface was split into these two parts. For quick porting you can make use of [**ID3D11Device::GetImmediateContext**](id3d11device-getimmediatecontext.md).<br/> "ID3D10Device::GetTextFilterSize" and "SetTextFilerSize" methods no longer exist. See DirectWrite.<br/> Create\*Shader takes an additional optional parameter for [**ID3D11ClassLinkage**](id3d11classlinkage.md).<br/> \*SetShader and \*GetShader take additional optional parameters for [**ID3D11ClassInstance**](id3d11classinstance.md)(s).<br/> [**CreateGeometryShaderWithStreamOutput**](id3d11device-creategeometryshaderwithstreamoutput.md) takes an array and count for multiple output stream strides.<br/> The limit for the NumEntries parameter of [**CreateGeometryShaderWithStreamOutput**](id3d11device-creategeometryshaderwithstreamoutput.md) has increased to D3D11\_SO\_STREAM\_COUNT \* D3D11\_SO\_OUTPUT\_COMPONENT\_COUNT in Direct3D 11.<br/> |
| ID3D10Buffer       | [**ID3D11Buffer**](id3d11buffer.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ID3D10SwitchToRef  | [**ID3D11SwitchToRef**](id3d11switchtoref.md)Switch-to-ref functionality is not supported in Direct3D 11.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ID3D10Texture1D    | [**ID3D11Texture1D**](id3d11texture1d.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ID3D10Texture2D    | [**ID3D11Texture2D**](id3d11texture2d.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ID3D10Texture3D    | [**ID3D11Texture3D**](id3d11texture3d.md)The Map and Unmap methods were moved to [**ID3D11DeviceContext**](id3d11devicecontext.md), and all Map methods use [**D3D11\_MAPPED\_SUBRESOURCE**](d3d11-mapped-subresource.md) instead of a void\*\*.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ID3D10Asynchronous | [**ID3D11Asynchronous**](id3d11asynchronous.md)Begin, End, and GetData were moved to [**ID3D11DeviceContext**](id3d11devicecontext.md).<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
|------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| D3D10\_FEATURE\_LEVEL1 | [**D3D\_FEATURE\_LEVEL**](d3d-feature-level.md)Identical but defined in D3DCommon.h plus the addition of D3D\_FEATURE\_LEVEL\_11\_0 for 11 class hardware along with D3D\_FEATURE\_LEVEL\_9\_1, D3D\_FEATURE\_LEVEL\_9\_2, and D3D\_FEATURE\_LEVEL\_9\_3 for 10level9<br/> (D3D10\_FEATURE\_LEVEL\_9\_1, D3D10\_FEATURE\_LEVEL\_9\_2, and D3D10\_FEATURE\_LEVEL\_9\_3 were also added for 10.1 to d3d10\_1.h)<br/> |
...
| Direct3D 10.1                        | Direct3D 11                                                                                                                   |
|--------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| D3D10\_BLEND\_DESC1                  | [**D3D11\_BLEND\_DESC**](d3d11-blend-desc.md)The 11 version is identical to 10.1.<br/>                                 |
| D3D10\_SHADER\_RESOURCE\_VIEW\_DESC1 | [**D3D11\_SHADER\_RESOURCE\_VIEW\_DESC**](d3d11-shader-resource-view-desc.md)The 11 version is identical to 10.1.<br/> |
...
| Direct3D 10.1             | Direct3D 11                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|---------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ID3D10Device1             | [**ID3D11Device**](id3d11device.md) and [**ID3D11DeviceContext**](id3d11devicecontext.md)<br/> The device interface was split into these two parts. For quick porting you can make use of [**ID3D11Device::GetImmediateContext**](id3d11device-getimmediatecontext.md).<br/> " ID3D10Device::GetTextFilterSize" and "SetTextFilerSize" methods no longer exist. See DirectWrite.<br/> Create\*Shader takes an additional optional parameter for [**ID3D11ClassLinkage**](id3d11classlinkage.md).<br/> \*SetShader and \*GetShader take additional optional parameters for [**ID3D11ClassInstance**](id3d11classinstance.md)(s).<br/> [**CreateGeometryShaderWithStreamOutput**](id3d11device-creategeometryshaderwithstreamoutput.md) takes an array and count for multiple output stream strides.<br/> The limit for the NumEntries parameter of [**CreateGeometryShaderWithStreamOutput**](id3d11device-creategeometryshaderwithstreamoutput.md) has increased to D3D11\_SO\_STREAM\_COUNT \* D3D11\_SO\_OUTPUT\_COMPONENT\_COUNT in Direct3D 11.<br/> |
| ID3D10BlendState1         | [**ID3D11BlendState**](id3d11blendstate.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ID3D10ShaderResourceView1 | [**ID3D11ShaderResourceView**](id3d11shaderresourceview.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
