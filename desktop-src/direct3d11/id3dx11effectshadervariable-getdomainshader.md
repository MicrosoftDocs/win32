...
Type: **[**ID3D11DomainShader**](/windows/win32/D3D11/?branch=master)\*\***

Pointer to an [**ID3D11DomainShader**](/windows/win32/D3D11/?branch=master) pointer that will be set to the domain shader on return.
