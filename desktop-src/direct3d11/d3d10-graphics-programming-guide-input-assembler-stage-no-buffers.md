...
description: Creating and binding buffers is not necessary if your shaders dont require buffers. This section contains an example of simple vertex and pixel shaders that draw a single triangle.
