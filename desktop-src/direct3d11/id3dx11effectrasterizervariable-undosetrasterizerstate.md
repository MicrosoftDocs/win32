...
keywords: ["UndoSetRasterizerState method Direct3D 11", "UndoSetRasterizerState method Direct3D 11 , ID3DX11EffectRasterizerVariable interface", "ID3DX11EffectRasterizerVariable interface Direct3D 11 , UndoSetRasterizerState method"]
topic_type:
- apiref
api_name:
