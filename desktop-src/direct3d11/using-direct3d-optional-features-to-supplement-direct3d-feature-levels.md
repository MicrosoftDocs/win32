...
**Note**  If a Microsoft Direct3D device supports [feature level](https://www.bing.com/search?q=feature level) 11.1, all of the optional features indicated by [**D3D11\_FEATURE\_DATA\_D3D11\_OPTIONS**](/windows/desktop/api/D3D11/ns-d3d11-d3d11_feature_data_d3d11_options) are automatically supported except **SAD4ShaderInstructions** and **ExtendedDoublesShaderInstructions**.
...
Windows Phone 8 mobile devices support feature level 9.3 with specific optional features. See [Direct3D feature level 9\_3 for Windows Phone 8](https://msdn.microsoft.com/windows/desktop/dc5f059f-6a5e-495b-bc88-fd659d051825).
