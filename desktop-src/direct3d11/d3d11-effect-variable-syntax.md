...
| Name         | Description                                                                                                                                                                                 |
|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| DataType     | Any [basic](https://msdn.microsoft.com/library/windows/desktop/bb509706), [texture](https://msdn.microsoft.com/library/windows/desktop/bb509700), unordered access view, shader or state block type.                            |
...
Sampling a texture is done with a texture sampler. To set up a sampler in an effect, see the [sampler type](https://msdn.microsoft.com/library/windows/desktop/bb509644).
