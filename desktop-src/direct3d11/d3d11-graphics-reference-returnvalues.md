...
| D3D11\_ERROR\_DEFERRED\_CONTEXT\_MAP\_WITHOUT\_INITIAL\_DISCARD          | The first call to [**ID3D11DeviceContext::Map**](/windows/win32/D3D11/nf-d3d11-id3d11devicecontext-map?branch=master) after either [**ID3D11Device::CreateDeferredContext**](/windows/win32/D3D11/nf-d3d11-id3d11device-createdeferredcontext?branch=master) or [**ID3D11DeviceContext::FinishCommandList**](/windows/win32/D3D11/nf-d3d11-id3d11devicecontext-finishcommandlist?branch=master) per Resource was not D3D11\_MAP\_WRITE\_DISCARD. |
