...
| D3D11\_ERROR\_DEFERRED\_CONTEXT\_MAP\_WITHOUT\_INITIAL\_DISCARD          | The first call to [**ID3D11DeviceContext::Map**](id3d11devicecontext-map.md) after either [**ID3D11Device::CreateDeferredContext**](id3d11device-createdeferredcontext.md) or [**ID3D11DeviceContext::FinishCommandList**](id3d11devicecontext-finishcommandlist.md) per Resource was not D3D11\_MAP\_WRITE\_DISCARD. |
