...
-   [**ID3D11RefDefaultTrackingOptions::SetTrackingOptions**](id3d11refdefaulttrackingoptions-settrackingoptions.md)
-   [**ID3D11RefTrackingOptions::SetTrackingOptions**](id3d11reftrackingoptions-settrackingoptions.md)
-   [**ID3D11TracingDevice::SetShaderTrackingOptions**](id3d11tracingdevice-setshadertrackingoptionsbytype.md)
-   [**ID3D11TracingDevice::SetShaderTrackingOptionsByType**](id3d11tracingdevice-setshadertrackingoptionsbytype.md)
-   [**ID3D11ShaderTraceFactory::CreateShaderTrace**](id3d11shadertracefactory-createshadertrace.md)
-   [**ID3D11ShaderTrace::TraceReady**](id3d11shadertrace-traceready.md)
-   [**ID3D11ShaderTrace::ResetTrace**](id3d11shadertrace-resettrace.md)
-   [**ID3D11ShaderTrace::GetTraceStats**](id3d11shadertrace-gettracestats.md)
-   [**ID3D11ShaderTrace::PSSelectStamp**](id3d11shadertrace-psselectstamp.md)
-   [**ID3D11ShaderTrace::GetInitialRegisterContents**](id3d11shadertrace-getinitialregistercontents.md)
-   [**ID3D11ShaderTrace::GetStep**](id3d11shadertrace-getstep.md)
-   [**ID3D11ShaderTrace::GetWrittenRegister**](id3d11shadertrace-getwrittenregister.md)
-   [**ID3D11ShaderTrace::GetReadRegister**](id3d11shadertrace-getreadregister.md)
...
> [!Note]  
> While you can use this library and DLL combination for development, you can't deploy Windows Store apps that use this combination. Therefore, you must instead compile HLSL shaders before you ship your Windows Store app. You can write HLSL compilation binaries to disk, or the compiler can generate headers with static byte arrays that contain the shader blob data. You use the [**ID3DBlob**](id3dblob.md) interface to access the blob data. To develop your Windows Store app, call [**D3DCompile2**](https://msdn.microsoft.com/library/windows/desktop/hh446869) or [**D3DCompileFromFile**](https://msdn.microsoft.com/library/windows/desktop/hh446872) to compile the raw HLSL source, and then feed the resulting blob data to Direct3D.
...
-   [**ID3D11Device1::CreateDeviceContextState**](id3d11device1-createdevicecontextstate.md)
-   [**ID3D11DeviceContext1::SwapDeviceContextState**](id3d11devicecontext1-swapdevicecontextstate.md)
-   [**ID3DDeviceContextState**](id3ddevicecontextstate.md)
...
-   [**ID3D11Device::CheckFeatureSupport**](id3d11device-checkfeaturesupport.md) with [**D3D11\_FEATURE\_DATA\_D3D11\_OPTIONS**](d3d11-feature-data-d3d11-options.md), [**D3D11\_FEATURE\_DATA\_ARCHITECTURE\_INFO**](d3d11-feature-data-architecture-info.md), [**D3D11\_FEATURE\_DATA\_D3D9\_OPTIONS**](d3d11-feature-data-d3d9-options.md), [**D3D11\_FEATURE\_DATA\_SHADER\_MIN\_PRECISION\_SUPPORT**](d3d11-feature-data-shader-min-precision-support.md), and [**D3D11\_FEATURE\_DATA\_D3D9\_SHADOW\_SUPPORT**](d3d11-feature-data-d3d9-shadow-support.md) structures
-   [**ID3D11Device::CheckFormatSupport**](id3d11device-checkformatsupport.md) with [**D3D11\_FORMAT\_SUPPORT\_DECODER\_OUTPUT**](d3d11-format-support.md#d3d11-format-support-decoder-output), [**D3D11\_FORMAT\_SUPPORT\_VIDEO\_PROCESSOR\_OUTPUT**](d3d11-format-support.md#d3d11-format-support-video-processor-output), [**D3D11\_FORMAT\_SUPPORT\_VIDEO\_PROCESSOR\_INPUT**](d3d11-format-support.md#d3d11-format-support-video-processor-input), [**D3D11\_FORMAT\_SUPPORT\_VIDEO\_ENCODER**](d3d11-format-support.md#d3d11-format-support-video-encoder), and [**D3D11\_FORMAT\_SUPPORT2\_OUTPUT\_MERGER\_LOGIC\_OP**](d3d11-format-support2.md#d3d11-format-support2-output-merger-logic-op)
...
Direct3D 11.1 lets you create constant buffers that are larger than the maximum constant buffer size that a shader can access (4096 32-bit\*4-component constants – 64KB). Later, when you bind the buffers to the pipeline, for example, via [**PSSetConstantBuffers**](id3d11devicecontext-pssetconstantbuffers.md) or [**PSSetConstantBuffers1**](id3d11devicecontext1-pssetconstantbuffers1.md), you can specify a range of buffers that the shader can access that fits within the 4096 limit.

Direct3D 11.1 updates the [**ID3D11Device::CreateBuffer**](id3d11device-createbuffer.md) method for this feature.
...
-   [**ID3D11Device1::CreateBlendState1**](id3d11device1-createblendstate1.md) with [**D3D11\_LOGIC\_OP**](d3d11-logic-op.md)
...
-   [**ID3D11Device1::CreateRasterizerState1**](id3d11device1-createrasterizerstate1.md)
...
> -   Don't operate the shader at sample frequency. Therefore, [**ID3D11ShaderReflection::IsSampleFrequencyShader**](id3d11shaderreflection-issamplefrequencyshader.md) returns **FALSE**.
>
...
-   [**ID3D11Device::CreateShaderResourceView**](id3d11device-createshaderresourceview.md)
-   [**ID3D11Device::CreateRenderTargetView**](id3d11device-createrendertargetview.md)
-   [**ID3D11Device::CreateUnorderedAccessView**](id3d11device-createunorderedaccessview.md)
...
In addition, Direct3D 11.1 guarantees that you can share Texture2D resources that you created with a mipmap level of 1, array size of 1, bind flags of [**D3D11\_BIND\_SHADER\_RESOURCE**](d3d11-bind-flag.md#d3d11-bind-shader-resource) and [**D3D11\_BIND\_RENDER\_TARGET**](d3d11-bind-flag.md#d3d11-bind-render-target) combined, usage default ([**D3D11\_USAGE\_DEFAULT**](d3d11-usage.md#d3d11-usage-default)), and only these [**D3D11\_RESOURCE\_MISC\_FLAG**](d3d11-resource-misc-flag.md) values:
...
If [**ID3D11Device::CheckFeatureSupport**](id3d11device-checkfeaturesupport.md) returns **TRUE** in **ExtendedResourceSharing**, you can share resources that you created with these features and flags:
...
-   Mipmap levels (one or more levels) in the 2D texture resources (specified in the **MipLevels** member of [**D3D11\_TEXTURE2D\_DESC**](d3d11-texture2d-desc.md))
-   Arrays of 2D texture resources (one or more textures) (specified in the **ArraySize** member of [**D3D11\_TEXTURE2D\_DESC**](d3d11-texture2d-desc.md))
...
Even if [**ID3D11Device::CheckFeatureSupport**](id3d11device-checkfeaturesupport.md) returns **TRUE** in **ExtendedResourceSharing**, you still can't share resources that you created with these features and flags:
...
-   [**ID3D11DeviceContext1::CopySubresourceRegion1**](id3d11devicecontext1-copysubresourceregion1.md)
-   [**ID3D11DeviceContext1::UpdateSubresource1**](id3d11devicecontext1-updatesubresource1.md)
...
-   [**ID3D11DeviceContext1::DiscardResource**](id3d11devicecontext1-discardresource.md)
-   [**ID3D11DeviceContext1::DiscardView**](id3d11devicecontext1-discardview.md)
-   [**ID3D11DeviceContext1::DiscardView1**](id3d11devicecontext1-discardview1.md)
...
-   [**ID3D11DeviceContext::OMSetRenderTargetsAndUnorderedAccessViews**](id3d11devicecontext-omsetrendertargetsandunorderedaccessviews.md)
-   [**ID3D11DeviceContext::CSSetUnorderedAccessViews**](id3d11devicecontext-cssetunorderedaccessviews.md)
...
-   [**ID3D11DeviceContext1::CSSetConstantBuffers1**](id3d11devicecontext1-cssetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::DSSetConstantBuffers1**](id3d11devicecontext1-dssetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::GSSetConstantBuffers1**](id3d11devicecontext1-gssetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::HSSetConstantBuffers1**](id3d11devicecontext1-hssetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::PSSetConstantBuffers1**](id3d11devicecontext1-pssetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::VSSetConstantBuffers1**](id3d11devicecontext1-vssetconstantbuffers1.md)
...
-   [**ID3D11DeviceContext1::CSGetConstantBuffers1**](id3d11devicecontext1-csgetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::DSGetConstantBuffers1**](id3d11devicecontext1-dsgetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::GSGetConstantBuffers1**](id3d11devicecontext1-gsgetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::HSGetConstantBuffers1**](id3d11devicecontext1-hsgetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::PSGetConstantBuffers1**](id3d11devicecontext1-psgetconstantbuffers1.md)
-   [**ID3D11DeviceContext1::VSGetConstantBuffers1**](id3d11devicecontext1-vsgetconstantbuffers1.md)
...
-   [**ID3D11DeviceContext1::ClearView**](id3d11devicecontext1-clearview.md)
...
Direct3D 11.1 updates the [**ID3D11DeviceContext::Map**](id3d11devicecontext-map.md) method for this feature.
...
-   [**ID3D11DeviceContext::CreateDomainShader**](id3d11device-createdomainshader.md)
-   [**ID3D11DeviceContext::CreateGeometryShader**](id3d11device-creategeometryshader.md)
-   [**ID3D11DeviceContext::CreateGeometryShaderWithStreamOutput**](id3d11device-creategeometryshaderwithstreamoutput.md)
-   [**ID3D11DeviceContext::CreateHullShader**](id3d11device-createhullshader.md)
-   [**ID3D11DeviceContext::CreateVertexShader**](id3d11device-createvertexshader.md)
...
Direct3D 11.1 extends support for [WARP](overviews-direct3d-11-devices-create-warp.md) devices, which you create by passing [**D3D\_DRIVER\_TYPE\_WARP**](d3d-driver-type.md#d3d-driver-type-warp) in the *DriverType* parameter of [**D3D11CreateDevice**](d3d11createdevice.md).
...
-   [doubles](d3d11-feature-data-doubles.md)
-   [video encode or decode](d3d11-create-device-flag.md#d3d11-create-device-video-support)
-   [minimum precision shader support](d3d11-feature-data-shader-min-precision-support.md)
...
> -   [**ID3D11Debug::SetFeatureMask**](id3d11debug-setfeaturemask.md)
> -   [**ID3D11Debug::SetPresentPerRenderOpDelay**](id3d11debug-setpresentperrenderopdelay.md)
> -   [**ID3D11Debug::SetSwapChain**](id3d11debug-setswapchain.md)
...
> -   [**D3D11CreateDeviceAndSwapChain**](d3d11createdeviceandswapchain.md)
>
