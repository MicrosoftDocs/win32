...
-   [**ID3D11Device::CheckFormatSupport**](/windows/desktop/api/D3D11/nf-d3d11-id3d11device-checkformatsupport) with [**D3D11\_FORMAT\_SUPPORT\_DECODER\_OUTPUT**](https://www.bing.com/search?q=**D3D11\_FORMAT\_SUPPORT\_DECODER\_OUTPUT**), [**D3D11\_FORMAT\_SUPPORT\_VIDEO\_PROCESSOR\_OUTPUT**](https://www.bing.com/search?q=**D3D11\_FORMAT\_SUPPORT\_VIDEO\_PROCESSOR\_OUTPUT**), [**D3D11\_FORMAT\_SUPPORT\_VIDEO\_PROCESSOR\_INPUT**](https://www.bing.com/search?q=**D3D11\_FORMAT\_SUPPORT\_VIDEO\_PROCESSOR\_INPUT**), [**D3D11\_FORMAT\_SUPPORT\_VIDEO\_ENCODER**](https://www.bing.com/search?q=**D3D11\_FORMAT\_SUPPORT\_VIDEO\_ENCODER**), and [**D3D11\_FORMAT\_SUPPORT2\_OUTPUT\_MERGER\_LOGIC\_OP**](https://www.bing.com/search?q=**D3D11\_FORMAT\_SUPPORT2\_OUTPUT\_MERGER\_LOGIC\_OP**)
...
Starting with Windows 8, you can use the **clipplanes** function attribute in an HLSL [function declaration](https://msdn.microsoft.com/library/windows/desktop/bb509607) rather than [SV\_ClipDistance](https://msdn.microsoft.com/library/windows/desktop/bb509647#system-value) to make your shader work on [feature level](https://www.bing.com/search?q=feature level) 9\_x as well as feature level 10 and higher. For more info, see [User clip planes on feature level 9 hardware](https://msdn.microsoft.com/library/windows/desktop/jj635733).
...
> -   If you have any render-target views bound ([**D3D11\_BIND\_RENDER\_TARGET**](https://www.bing.com/search?q=**D3D11\_BIND\_RENDER\_TARGET**)) and you forced the sample count to greater than 1, ensure that every render target has only a single sample.
...
Direct3D 11.1 guarantees that you can share Texture2D resources that you created with particular resource types and formats. To share Texture2D resources, use the [**D3D11\_RESOURCE\_MISC\_SHARED**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_SHARED**), [**D3D11\_RESOURCE\_MISC\_SHARED\_KEYEDMUTEX**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_SHARED\_KEYEDMUTEX**), or a combination of the **D3D11\_RESOURCE\_MISC\_SHARED\_KEYEDMUTEX** and [**D3D11\_RESOURCE\_MISC\_SHARED\_NTHANDLE**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_SHARED\_NTHANDLE**) (new for Windows 8) flags when you create those resources.
...
In addition, Direct3D 11.1 guarantees that you can share Texture2D resources that you created with a mipmap level of 1, array size of 1, bind flags of [**D3D11\_BIND\_SHADER\_RESOURCE**](https://www.bing.com/search?q=**D3D11\_BIND\_SHADER\_RESOURCE**) and [**D3D11\_BIND\_RENDER\_TARGET**](https://www.bing.com/search?q=**D3D11\_BIND\_RENDER\_TARGET**) combined, usage default ([**D3D11\_USAGE\_DEFAULT**](https://www.bing.com/search?q=**D3D11\_USAGE\_DEFAULT**)), and only these [**D3D11\_RESOURCE\_MISC\_FLAG**](/windows/desktop/api/D3D11/ne-d3d11-d3d11_resource_misc_flag) values:

-   [**D3D11\_RESOURCE\_MISC\_SHARED**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_SHARED**)
-   [**D3D11\_RESOURCE\_MISC\_SHARED\_KEYEDMUTEX**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_SHARED\_KEYEDMUTEX**)
-   [**D3D11\_RESOURCE\_MISC\_SHARED\_NTHANDLE**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_SHARED\_NTHANDLE**)
-   [**D3D11\_RESOURCE\_MISC\_GDI\_COMPATIBLE**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_GDI\_COMPATIBLE**)
...
-   [**D3D11\_USAGE\_DEFAULT**](https://www.bing.com/search?q=**D3D11\_USAGE\_DEFAULT**)
-   [**D3D11\_BIND\_SHADER\_RESOURCE**](https://www.bing.com/search?q=**D3D11\_BIND\_SHADER\_RESOURCE**)
-   [**D3D11\_BIND\_RENDER\_TARGET**](https://www.bing.com/search?q=**D3D11\_BIND\_RENDER\_TARGET**)
-   [**D3D11\_RESOURCE\_MISC\_GENERATE\_MIPS**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_GENERATE\_MIPS**)
-   [**D3D11\_BIND\_UNORDERED\_ACCESS**](https://www.bing.com/search?q=**D3D11\_BIND\_UNORDERED\_ACCESS**)
...
-   [**D3D11\_BIND\_DECODER**](https://www.bing.com/search?q=**D3D11\_BIND\_DECODER**)
-   [**D3D11\_RESOURCE\_MISC\_RESTRICTED\_CONTENT**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_RESTRICTED\_CONTENT**)
-   [**D3D11\_RESOURCE\_MISC\_RESTRICT\_SHARED\_RESOURCE**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_RESTRICT\_SHARED\_RESOURCE**)
-   [**D3D11\_RESOURCE\_MISC\_RESTRICT\_SHARED\_RESOURCE\_DRIVER**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_RESTRICT\_SHARED\_RESOURCE\_DRIVER**)

> [!Note]  
> When **ExtendedResourceSharing** is **TRUE**, you have more flexibility when you specify bind flags for sharing Texture2D resources. Not only does the graphics driver and hardware support more bind flags but also more possible combinations of bind flags. For example, you can specify just [**D3D11\_BIND\_RENDER\_TARGET**](https://www.bing.com/search?q=**D3D11\_BIND\_RENDER\_TARGET**) or no bind flags, and so on.
...
-   [**D3D11\_BIND\_DEPTH\_STENCIL**](https://www.bing.com/search?q=**D3D11\_BIND\_DEPTH\_STENCIL**)
...
-   [**D3D11\_RESOURCE\_MISC\_RESOURCE\_CLAMP**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_RESOURCE\_CLAMP**)
-   [**D3D11\_USAGE\_IMMUTABLE**](https://www.bing.com/search?q=**D3D11\_USAGE\_IMMUTABLE**), [**D3D11\_USAGE\_DYNAMIC**](https://www.bing.com/search?q=**D3D11\_USAGE\_DYNAMIC**), or [**D3D11\_USAGE\_STAGING**](https://www.bing.com/search?q=**D3D11\_USAGE\_STAGING**) (that is, mappable)
-   [**D3D11\_RESOURCE\_MISC\_TEXTURECUBE**](https://www.bing.com/search?q=**D3D11\_RESOURCE\_MISC\_TEXTURECUBE**)
...
Direct3D 11.1 extends support for [WARP](overviews-direct3d-11-devices-create-warp.md) devices, which you create by passing [**D3D\_DRIVER\_TYPE\_WARP**](https://www.bing.com/search?q=**D3D\_DRIVER\_TYPE\_WARP**) in the *DriverType* parameter of [**D3D11CreateDevice**](/windows/desktop/api/D3D11/nf-d3d11-d3d11createdevice).

Starting with Direct3D 11.1 WARP devices support:

-   All Direct3D [feature levels](https://www.bing.com/search?q=feature levels) from 9.1 through to 11.1
...
-   [video encode or decode](https://www.bing.com/search?q=video encode or decode)
...
Use a subset of Direct3D 10\_0+ shadow buffer features to implement shadow effects on [feature level](https://www.bing.com/search?q=feature level) 9\_x. For info about what you need to do to implement shadow effects on feature level 9\_x, see [Implementing shadow buffers for Direct3D feature level 9](https://msdn.microsoft.com/library/windows/apps/jj262110).
