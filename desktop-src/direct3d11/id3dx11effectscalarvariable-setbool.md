...
keywords: ["SetBool method Direct3D 11", "SetBool method Direct3D 11 , ID3DX11EffectScalarVariable interface", "ID3DX11EffectScalarVariable interface Direct3D 11 , SetBool method"]
topic_type:
- apiref
api_name:
