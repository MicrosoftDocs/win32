...
Define the characteristics of the swap chain by filling in a [**DXGI\_SWAP\_CHAIN\_DESC**](https://msdn.microsoft.com/library/windows/desktop/bb173075) structure and initializing an [**IDXGISwapChain**](https://msdn.microsoft.com/library/windows/desktop/bb174569) interface. Initialize a swap chain by calling [**IDXGIFactory::CreateSwapChain**](https://msdn.microsoft.com/library/windows/desktop/bb174537) or [**D3D11CreateDeviceAndSwapChain**](d3d11createdeviceandswapchain.md).

## Create a device and a swap chain

To initialize a device and swap chain, use one of the following two functions:

-   Use the [**D3D11CreateDeviceAndSwapChain**](d3d11createdeviceandswapchain.md) function when you want to initialize the swap chain at the same time as device initialization. This usually is the easiest option.

-   Use the [**D3D11CreateDevice**](d3d11createdevice.md) function when you have already created a swap chain using [**IDXGIFactory::CreateSwapChain**](https://msdn.microsoft.com/library/windows/desktop/bb174537).
