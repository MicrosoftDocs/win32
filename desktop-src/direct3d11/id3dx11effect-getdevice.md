...
keywords: ["GetDevice method Direct3D 11", "GetDevice method Direct3D 11 , ID3DX11Effect interface", "ID3DX11Effect interface Direct3D 11 , GetDevice method"]
topic_type:
- apiref
api_name:
...
A pointer to an [**ID3D11Device**](id3d11device.md).
