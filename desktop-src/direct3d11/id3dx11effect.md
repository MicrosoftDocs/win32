...
The **ID3DX11Effect** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **ID3DX11Effect** also has these types of members:
...
> [!Note]
>
> If you call [**QueryInterface**](https://msdn.microsoft.com/library/windows/desktop/ms682521) on an **ID3DX11Effect** object to retrieve the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface, **QueryInterface** returns E\_NOINTERFACE. To work around this issue, use the following code:
>
