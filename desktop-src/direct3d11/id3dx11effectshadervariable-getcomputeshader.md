...
Type: **[**ID3D11ComputeShader**](/windows/win32/D3D11/?branch=master)\*\***

Pointer to an [**ID3D11ComputeShader**](/windows/win32/D3D11/?branch=master) pointer that will be set to the compute shader on return.
