...
> [!Note]  
> [**Texture3D**](https://msdn.microsoft.com/library/windows/desktop/ff471562) support in tiled resources isn't exposed in the initial implementation of tiled resources, but the desired tile shapes are listed here because support might be consideration in a future release.
