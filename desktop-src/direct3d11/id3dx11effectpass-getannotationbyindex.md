...
keywords: ["GetAnnotationByIndex method Direct3D 11", "GetAnnotationByIndex method Direct3D 11 , ID3DX11EffectPass interface", "ID3DX11EffectPass interface Direct3D 11 , GetAnnotationByIndex method"]
topic_type:
- apiref
api_name:
