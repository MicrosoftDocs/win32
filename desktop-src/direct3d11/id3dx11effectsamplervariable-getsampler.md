...
keywords: ["GetSampler method Direct3D 11", "GetSampler method Direct3D 11 , ID3DX11EffectSamplerVariable interface", "ID3DX11EffectSamplerVariable interface Direct3D 11 , GetSampler method"]
topic_type:
- apiref
api_name:
...
The address of a pointer to a sampler interface (see [**ID3D11SamplerState**](id3d11samplerstate.md)).
