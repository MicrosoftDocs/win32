---
title: ID3DX11EffectVariable AsDepthStencilView method
description: Get a depth-stencil-view variable.
ms.assetid: '491ca6e1-a74c-4996-a25c-ea40910f0f36'
keywords: ["AsDepthStencilView method Direct3D 11", "AsDepthStencilView method Direct3D 11 , ID3DX11EffectVariable interface", "ID3DX11EffectVariable interface Direct3D 11 , AsDepthStencilView method"]
topic_type:
- apiref
api_name:
