...
Type: **[**ID3D11PixelShader**](/windows/desktop/api/D3D11/)\*\***

A pointer to an [**ID3D11PixelShader**](/windows/desktop/api/D3D11/) pointer that will be set to the pixel shader on return.
