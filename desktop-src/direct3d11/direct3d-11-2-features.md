...
Direct3D 11.2 extends support for [WARP](overviews-direct3d-11-devices-create-warp.md) devices, which you create by passing [**D3D\_DRIVER\_TYPE\_WARP**](https://www.bing.com/search?q=**D3D\_DRIVER\_TYPE\_WARP**) in the *DriverType* parameter of [**D3D11CreateDevice**](/windows/desktop/api/D3D11/nf-d3d11-d3d11createdevice). The WARP software renderer in Direct3D 11.2 adds full support for Direct3D [feature level](https://www.bing.com/search?q=feature level) 11\_1, including [tiled resources](#tiled-resources), [**IDXGIDevice3::Trim**](https://msdn.microsoft.com/library/windows/desktop/dn280346), shared BCn surfaces, minblend, and map default. [Double](/windows/desktop/api/D3D11/ns-d3d11-d3d11_feature_data_doubles) support in HLSL shaders has also been enabled along with support for 16x MSAA.
