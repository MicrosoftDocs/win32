...
Handle to the resource module containing the shader-resource view. HMODULE can be obtained with [GetModuleHandle Function](https://msdn.microsoft.com/library/ms683199.aspx).
