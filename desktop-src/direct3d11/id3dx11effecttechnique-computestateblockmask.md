...
keywords: ["ComputeStateBlockMask method Direct3D 11", "ComputeStateBlockMask method Direct3D 11 , ID3DX11EffectTechnique interface", "ID3DX11EffectTechnique interface Direct3D 11 , ComputeStateBlockMask method"]
topic_type:
- apiref
api_name:
