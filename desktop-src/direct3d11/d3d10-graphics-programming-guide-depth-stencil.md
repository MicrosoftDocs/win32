...
An example of reading the depth-stencil buffer as a texture can be found in the [softparticles sample](https://msdn.microsoft.com/library/Ee416430(v=VS.85).aspx).
