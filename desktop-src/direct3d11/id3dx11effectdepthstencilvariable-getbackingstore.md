...
keywords: ["GetBackingStore method Direct3D 11", "GetBackingStore method Direct3D 11 , ID3DX11EffectDepthStencilVariable interface", "ID3DX11EffectDepthStencilVariable interface Direct3D 11 , GetBackingStore method"]
topic_type:
- apiref
api_name:
...
Type: **[**D3D11\_DEPTH\_STENCIL\_DESC**](d3d11-depth-stencil-desc.md)\***

A pointer to a depth-stencil-state description (see [**D3D11\_DEPTH\_STENCIL\_DESC**](d3d11-depth-stencil-desc.md)).
