...
Type: **[**D3D11\_DEPTH\_STENCIL\_DESC**](/windows/win32/D3D11/ns-d3d11-d3d11_depth_stencil_desc?branch=master)\***

A pointer to a depth-stencil-state description (see [**D3D11\_DEPTH\_STENCIL\_DESC**](/windows/win32/D3D11/ns-d3d11-d3d11_depth_stencil_desc?branch=master)).
