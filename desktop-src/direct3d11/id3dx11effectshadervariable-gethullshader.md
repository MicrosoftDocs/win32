...
Type: **[**ID3D11HullShader**](/windows/desktop/api/D3D11/)\*\***

A pointer to an [**ID3D11HullShader**](/windows/desktop/api/D3D11/) pointer that will be set to the hull shader on return.
