...
Type: **[**ID3D11HullShader**](https://msdn.microsoft.com/en-us/library/Ff476537(v=VS.85).aspx)\*\***

A pointer to an [**ID3D11HullShader**](https://msdn.microsoft.com/en-us/library/Ff476537(v=VS.85).aspx) pointer that will be set to the hull shader on return.
