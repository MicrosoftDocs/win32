...
Type: **[**D3D11\_RASTERIZER\_DESC**](/windows/win32/D3D11/ns-d3d11-d3d11_rasterizer_desc?branch=master)\***

A pointer to a rasteriser-state description (see [**D3D11\_RASTERIZER\_DESC**](/windows/win32/D3D11/ns-d3d11-d3d11_rasterizer_desc?branch=master)).
