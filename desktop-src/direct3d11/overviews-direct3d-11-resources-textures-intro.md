...
> [!Note]  
> Devices that you create with [**10\_1 feature level**](https://www.bing.com/search?q=**10\_1 feature level**) and above can support arrays of texture cubes in which the number of textures is equal to the number of texture cubes in an array times six. Devices that you create with [**10\_0 feature level**](https://www.bing.com/search?q=**10\_0 feature level**) support only a single texture cube of six faces. Also, Direct3D 11 does not support partial cubemaps.
