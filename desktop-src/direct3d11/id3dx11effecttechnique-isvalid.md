...
keywords: ["IsValid method Direct3D 11", "IsValid method Direct3D 11 , ID3DX11EffectTechnique interface", "ID3DX11EffectTechnique interface Direct3D 11 , IsValid method"]
topic_type:
- apiref
api_name:
