...
keywords: ["GetTechniqueByIndex method Direct3D 11", "GetTechniqueByIndex method Direct3D 11 , ID3DX11Effect interface", "ID3DX11Effect interface Direct3D 11 , GetTechniqueByIndex method"]
topic_type:
- apiref
api_name:
