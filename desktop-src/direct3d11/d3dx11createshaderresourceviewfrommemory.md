---
title: D3DX11CreateShaderResourceViewFromMemory function
...
keywords: ["D3DX11CreateShaderResourceViewFromMemory function Direct3D 11"]
topic_type:
- apiref
api_name:
...
Address of a pointer to the newly created shader resource view. See [**ID3D11ShaderResourceView**](id3d11shaderresourceview.md).
