...
Address of a pointer to the newly created shader resource view. See [**ID3D11ShaderResourceView**](/windows/win32/D3D11/nn-d3d11-id3d11shaderresourceview?branch=master).
