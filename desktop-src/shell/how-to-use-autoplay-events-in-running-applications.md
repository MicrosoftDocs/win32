...
> [!Note]  
> [**LoadLibrary**](base.loadlibrary) can pose security risks. Refer to the **LoadLibrary** documentation for information on how to correctly load DLLs with different versions of Windows.
>
...
>  
>
> The call to [**IRunningObjectTable::Register**](com.irunningobjecttable_register) requires that the component have the following **AppID** information in the registry.
>
> ```
> HKEY_CLASSES_ROOT
>    AppID
