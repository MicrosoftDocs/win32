...
| [Property](properties.Building_Property_Handlers_Properties) | A property handler that provides access to item properties for Windows Search, the Windows Explorer and other applications that need to access properties.                                                                                                                                                                                                                                                                                                                                                                                                              |
