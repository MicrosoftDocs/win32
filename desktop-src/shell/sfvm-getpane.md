...
Allows the callback object to provide the status bar pane in which to display the Internet zone information. Used by [**IShellFolderViewCB::MessageSFVCB**](/windows/desktop/api/Shlobj/).
