...
The following APIs can be used to query an association array or to construct an association array [**IQueryAssociations**](/windows/desktop/api/Shlwapi/) object that can be queried:
