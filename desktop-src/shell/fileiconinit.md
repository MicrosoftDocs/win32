...
-   On launch.
-   In response to a [**WM\_SETTINGCHANGE**](https://msdn.microsoft.com/en-us/library/ms725497(v=VS.85).aspx) message when the [**SPI\_SETNONCLIENTMETRICS**](https://www.bing.com/search?q=**SPI\_SETNONCLIENTMETRICS**) flag is set.
