...
Pointer to an [**APPBARDATA**](/windows/win32/Shellapi/ns-shellapi-_appbardata?branch=master) structure. You must specify the **cbSize** member when sending this message; all other members are ignored.
