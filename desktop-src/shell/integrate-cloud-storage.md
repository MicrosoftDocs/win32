...
-   A CLSID for your application. One way to generate a CLSID for your application is to use the Uuidgen.exe. See [CLSID Key](https://msdn.microsoft.com/windows/desktop/b5777d87-abf2-45b9-9d95-61db878a5810) for more information about CLSID.
...
Indicate that your namespace extension should function like other file folder structures in File Explorer. For more information about shell instance objects, see [Creating Shell Extensions with Shell Instance Objects](http://go.microsoft.com/fwlink/p/?linkid=533798).
...
This is required to make sure that the File Explorer provides a consistent and expected experience for users. This command sets **FILE\_ATTRIBUTE\_DIRECTORY** and **FILE\_ATTRIBUTE\_READONLY**, both of which are [**File Attribute Constants**](https://msdn.microsoft.com/windows/desktop/ed9a73d2-7fb6-4fb7-97f6-4dbf89e2f156).
