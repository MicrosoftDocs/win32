...
Like all Shell extension handlers, data handlers are in-process Component Object Model (COM) objects implemented as DLLs. They export two interfaces in addition to [**IUnknown**](com.iunknown): [**IPersistFile**](com.ipersistfile) and [**IDataObject**](com.idataobject).
...
Once the data handler is initialized, the Shell delegates calls from the data object to the handler's [**IDataObject**](com.idataobject) interface if one of the custom formats is used.
