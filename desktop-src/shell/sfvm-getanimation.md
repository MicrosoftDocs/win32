...
*phinst* and *pwszName* will be passed to the [animation control](_win32_Animation_Control_Overview) with an [**ACM\_OPEN**](controls.ACM_OPEN) message.
