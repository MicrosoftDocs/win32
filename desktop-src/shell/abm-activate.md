...
Notifies the system that an appbar has been activated. An appbar should call this message in response to the [**WM\_ACTIVATE**](https://msdn.microsoft.com/library/windows/desktop/ms646274) message.
