...
When a user selects a file in Windows Explorer and copies it to the Clipboard, the Shell creates a data object. It then calls [**OleSetClipboard**](https://msdn.microsoft.com/windows/desktop/741def10-d2b5-4395-8049-1eba2e29b0e8) to place a pointer to the data object's [**IDataObject**](https://msdn.microsoft.com/windows/desktop/8a002deb-2727-456c-8078-a9b0d5893ed4) interface on the Clipboard.

When the user selects the **Paste** command from your application's menu or toolbar:

1.  Call [**OleGetClipboard**](https://msdn.microsoft.com/windows/desktop/c5e7badb-339b-48d5-8c9a-3950e2ffe6bf) to retrieve the data object's [**IDataObject**](https://msdn.microsoft.com/windows/desktop/8a002deb-2727-456c-8078-a9b0d5893ed4) interface.
2.  Call [**IDataObject::EnumFormatEtc**](https://msdn.microsoft.com/windows/desktop/657a7394-4481-4e0c-912d-40a9348caf16) to request an enumerator object.
3.  Use the enumerator object's [**IEnumFORMATETC**](https://msdn.microsoft.com/windows/desktop/4d180fdd-2d58-4d26-9242-6552dda0d3e6) interface to enumerate the formats contained by the data object.
...
1.  Call [**IDataObject::GetData**](https://msdn.microsoft.com/windows/desktop/05118461-0438-4715-b2c2-fc2471ce38f0). Set the **cfFormat** member of the [**FORMATETC**](https://msdn.microsoft.com/windows/desktop/4478eb9a-84a1-4f3a-8290-94b8dd20c081) structure to [CF\_HDROP](clipboard.md) and the **tymed** member to [TYMED\_HGLOBAL](dataobject.md). The **dwAspect** member is normally set to DVASPECT\_CONTENT. However, if you need to have the file's path in short (8.3) format, set **dwAspect** to DVASPECT\_SHORT.

    When [**IDataObject::GetData**](https://msdn.microsoft.com/windows/desktop/05118461-0438-4715-b2c2-fc2471ce38f0) returns, the **hGlobal** member of the [**STGMEDIUM**](https://msdn.microsoft.com/windows/desktop/5d05819a-10db-4d8e-91e4-8a7c05885cde) structure points to a global memory object that contains the data.

2.  Create an HDROP variable and set it to the **hGlobal** member of the [**STGMEDIUM**](https://msdn.microsoft.com/windows/desktop/5d05819a-10db-4d8e-91e4-8a7c05885cde) structure. The HDROP variable is now a handle to a [**DROPFILES**](/windows/desktop/api/shlobj_core/ns-shlobj_core-_dropfiles) structure followed by a double null-terminated string containing the fully qualified file paths of the copied files.
...
6.  Call [**ReleaseStgMedium**](https://msdn.microsoft.com/windows/desktop/da7d7bcb-0b5b-4053-8f0e-ff311c424375) and pass in the pointer to the [**STGMEDIUM**](https://msdn.microsoft.com/windows/desktop/5d05819a-10db-4d8e-91e4-8a7c05885cde) structure that you passed to [**IDataObject::GetData**](https://msdn.microsoft.com/windows/desktop/05118461-0438-4715-b2c2-fc2471ce38f0) in step 1. Once you have released the structure, the HDROP value that you created in step 2 is no longer valid and should not be used.
...
2.  Call [**RegisterDragDrop**](https://msdn.microsoft.com/windows/desktop/00726271-4436-41f5-b7cc-666cd77216bc) to register a target window and your application's [**IDropTarget**](https://msdn.microsoft.com/windows/desktop/13fbe834-1ef8-4944-b2e4-9f5c413c65c8) interface.
...
2.  Windows Explorer calls [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315) to initiate the drag loop.
3.  When the drag image reaches your target window, the system notifies you by calling [**IDropTarget::DragEnter**](https://msdn.microsoft.com/windows/desktop/2e4d7013-910c-4a6e-8eee-818e1f2302ac).
4.  To determine what the data object contains, call the data object's [**IDataObject::EnumFormatEtc**](https://msdn.microsoft.com/windows/desktop/657a7394-4481-4e0c-912d-40a9348caf16) method. Use the enumerator object returned by the method to enumerate the formats contained by the data object. If your application does not want to accept any of these formats, return DROPEFFECT\_NONE. For the purposes of this scenario, your application should ignore any data objects that do not contain formats used to transfer files, such as [CF\_HDROP](clipboard.md).
5.  When the user drops the data, the system calls [**IDropTarget::Drop**](https://msdn.microsoft.com/windows/desktop/7ea6d815-bf8f-47d5-99d3-f9a55bafee2e).
6.  Use the [**IDataObject**](https://msdn.microsoft.com/windows/desktop/8a002deb-2727-456c-8078-a9b0d5893ed4) interface to extract the contents of the files.
...
-   If the Shell object is from the file system, the data object contains a [CF\_HDROP](clipboard.md) format with the names of the files. Extract the file name from [CF\_HDROP](clipboard.md) and call [**OleCreateFromFile**](https://msdn.microsoft.com/windows/desktop/98c63646-6617-46b6-8c3e-82d1c4d0adb6) to create a new linked or embedded object. For a discussion of how to retrieve a file name from a [CF\_HDROP](clipboard.md) format, see [Copying File Names from the Clipboard to an Application](#copying-file-names-from-the-clipboard-to-an-application).
...
-   Prior to Shell [version 4.71](versions.md), an application indicated that it was transferring a shortcut file type by setting **FD\_LINKUI** in the **dwFlags** member of the [**FILEDESCRIPTOR**](/windows/desktop/api/Shlobj/ns-shlobj_core-_filedescriptora) structure. For later versions of the Shell, the preferred way to indicate that shortcuts are being transferred is to use the [CFSTR\_PREFERREDDROPEFFECT](clipboard.md) format set to DROPEFFECT\_LINK. This approach is much more efficient than extracting the **FILEDESCRIPTOR** structure just to check a flag.
...
The data transfer mechanism for [CFSTR\_FILECONTENTS](clipboard.md) is normally [TYMED\_ISTREAM](dataobject.md). Transferring an [**IStream**](https://msdn.microsoft.com/windows/desktop/c6f60e37-eadc-46a1-94f6-cacc23613531) interface pointer requires much less memory than loading the data into a global memory object, and **IStream** is a simpler way to represent data than [**IStorage**](https://msdn.microsoft.com/windows/desktop/2f454538-0f40-4811-b908-cd317ef79487).
...
2.  The **hGlobal** member of the returned [**STGMEDIUM**](https://msdn.microsoft.com/windows/desktop/5d05819a-10db-4d8e-91e4-8a7c05885cde) structure points to a global memory object. Lock that object by passing the **hGlobal** value to [**GlobalLock**](https://msdn.microsoft.com/windows/desktop/0d7deac2-c9c4-4adc-8a0a-edfc512a4d6c).
3.  Cast the pointer returned by [**GlobalLock**](https://msdn.microsoft.com/windows/desktop/0d7deac2-c9c4-4adc-8a0a-edfc512a4d6c) to a [**FILEGROUPDESCRIPTOR**](/windows/desktop/api/Shlobj/ns-shlobj_core-_filegroupdescriptora) pointer. It will point to a **FILEGROUPDESCRIPTOR** structure followed by one or more [**FILEDESCRIPTOR**](/windows/desktop/api/Shlobj/ns-shlobj_core-_filedescriptora) structures. Each **FILEDESCRIPTOR** structure contains a description of a file that is contained by one of the accompanying [CFSTR\_FILECONTENTS](clipboard.md) formats.
4.  Examine the [**FILEDESCRIPTOR**](/windows/desktop/api/Shlobj/ns-shlobj_core-_filedescriptora) structures to determine which one corresponds to the file you want to extract. The zero-based index of that **FILEDESCRIPTOR** structure is used to identify the file's [CFSTR\_FILECONTENTS](clipboard.md) format. Because the size of a global memory block is not byte-precise, use the structure's **nFileSizeLow** and **nFileSizeHigh** members to determine how many bytes represent the file in the global memory object.
5.  Call [**IDataObject::GetData**](https://msdn.microsoft.com/windows/desktop/05118461-0438-4715-b2c2-fc2471ce38f0) with the **cfFormat** member of the [**FORMATETC**](https://msdn.microsoft.com/windows/desktop/4478eb9a-84a1-4f3a-8290-94b8dd20c081) structure set to the [CFSTR\_FILECONTENTS](clipboard.md) value and the **lIndex** member set to the index that you determined in the previous step. The **tymed** member is typically set to [TYMED\_HGLOBAL](dataobject.md) \| TYMED\_ISTREAM \| TYMED\_ISTORAGE. The data object can then choose its preferred data transfer mechanism.
6.  The [**STGMEDIUM**](https://msdn.microsoft.com/windows/desktop/5d05819a-10db-4d8e-91e4-8a7c05885cde) structure that [**IDataObject::GetData**](https://msdn.microsoft.com/windows/desktop/05118461-0438-4715-b2c2-fc2471ce38f0) returns will contain a pointer to the file's data. Examine the **tymed** member of the structure to determine the data transfer mechanism.
...
8.  Call [**GlobalLock**](https://msdn.microsoft.com/windows/desktop/0d7deac2-c9c4-4adc-8a0a-edfc512a4d6c) to unlock the global memory object that you locked in step 2.
...
1.  The source calls [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315) with the *dwEffect* parameter set to DROPEFFECT\_MOVE to indicate that the source objects can be moved.
2.  The target receives the DROPEFFECT\_MOVE value through one of its [**IDropTarget**](https://msdn.microsoft.com/windows/desktop/13fbe834-1ef8-4944-b2e4-9f5c413c65c8) methods, indicating that a move is allowed.
...
4.  The target then tells the source whether it needs to delete the original data.
    ...
    -   -   The target sets the *pdwEffect* value it received through its [**IDropTarget::Drop**](https://msdn.microsoft.com/windows/desktop/7ea6d815-bf8f-47d5-99d3-f9a55bafee2e) method to some value other than DROPEFFECT\_MOVE. It is typically set to either DROPEFFECT\_NONE or DROPEFFECT\_COPY. The value will be returned to the source by [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315).
        -   The target also calls the data object's [**IDataObject::SetData**](https://msdn.microsoft.com/windows/desktop/7430d12c-ab07-4a9c-a845-4743818afbc7) method and passes it a [CFSTR\_PERFORMEDDROPEFFECT](clipboard.md) format identifier set to DROPEFFECT\_NONE. This method call is necessary because some drop targets might not set the *pdwEffect* parameter of [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315) properly. The [CFSTR\_PERFORMEDDROPEFFECT](clipboard.md) format is the reliable way to indicate that an optimized move has taken place.
    ...
    -   -   The target sets the *pdwEffect* value it received through its [**IDropTarget::Drop**](https://msdn.microsoft.com/windows/desktop/7ea6d815-bf8f-47d5-99d3-f9a55bafee2e) method to DROPEFFECT\_MOVE. The value will be returned to the source by [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315).
...
3.  The source places the data object on the Clipboard using [**OleSetClipboard**](https://msdn.microsoft.com/windows/desktop/741def10-d2b5-4395-8049-1eba2e29b0e8).
4.  The target retrieves the data object from the Clipboard using [**OleGetClipboard**](https://msdn.microsoft.com/windows/desktop/c5e7badb-339b-48d5-8c9a-3950e2ffe6bf).
...
6.  If the target does not do an optimized move, it calls the [**IDataObject::SetData**](https://msdn.microsoft.com/windows/desktop/7430d12c-ab07-4a9c-a845-4743818afbc7) method with the [CFSTR\_PERFORMEDDROPEFFECT](clipboard.md) format set to DROPEFFECT\_MOVE.
7.  When the paste is complete, the target calls the [**IDataObject::SetData**](https://msdn.microsoft.com/windows/desktop/7430d12c-ab07-4a9c-a845-4743818afbc7) method with the [CFSTR\_PASTESUCCEEDED](clipboard.md) format set to DROPEFFECT\_MOVE.
8.  When the source's [**IDataObject::SetData**](https://msdn.microsoft.com/windows/desktop/7430d12c-ab07-4a9c-a845-4743818afbc7) method is called with the [CFSTR\_PASTESUCCEEDED](clipboard.md) format set to DROPEFFECT\_MOVE, it must check to see if it also received the [CFSTR\_PERFORMEDDROPEFFECT](clipboard.md) format set to DROPEFFECT\_MOVE. If both formats are sent by the target, the source will have to delete the data. If only the [CFSTR\_PASTESUCCEEDED](clipboard.md) format is received, the source can simply remove the data from its display. If the transfer fails, the source updates the display to its original appearance.
...
-   The format is more flexible. It supports three data transfer mechanisms: a global memory object, an [**IStream**](https://msdn.microsoft.com/windows/desktop/c6f60e37-eadc-46a1-94f6-cacc23613531) interface, or an [**IStorage**](https://msdn.microsoft.com/windows/desktop/2f454538-0f40-4811-b908-cd317ef79487) interface.

Global memory objects are rarely used to transfer data to or from virtual objects because the data must be copied into memory in its entirety. Transferring an interface pointer requires almost no memory and is much more efficient. With very large files, an interface pointer might be the only practical data transfer mechanism. Typically, data is represented by an [**IStream**](https://msdn.microsoft.com/windows/desktop/c6f60e37-eadc-46a1-94f6-cacc23613531) pointer, because that interface is somewhat more flexible than [**IStorage**](https://msdn.microsoft.com/windows/desktop/2f454538-0f40-4811-b908-cd317ef79487). The target extracts the pointer from the data object and uses the interface methods to extract the data.
...
-   Be able to handle data transfer through an [**IStream**](https://msdn.microsoft.com/windows/desktop/c6f60e37-eadc-46a1-94f6-cacc23613531) or [**IStorage**](https://msdn.microsoft.com/windows/desktop/2f454538-0f40-4811-b908-cd317ef79487) interface. Data transfer to or from a virtual folder is normally handled by transferring one of these two interface pointers, typically an **IStream** pointer. The target then calls the interface methods to extract the data:
...
Windows allows users to drag an object from an OLE application's data file and drop it on the desktop or a file system folder. This operation creates a *scrap file*, which contains the data or a link to the data. The file name is taken from the short name registered for the CLSID of the object and the [CF\_TEXT](clipboard.md) data. For the Shell to create a scrap file containing data, the application's [**IDataObject**](https://msdn.microsoft.com/windows/desktop/8a002deb-2727-456c-8078-a9b0d5893ed4) interface must support the CF\_EMBEDSOURCE Clipboard format. To create a file containing a link, **IDataObject** must support the CF\_LINKSOURCE format.
...
To establish the format of the embedded object, determine its CLSID by retrieving the object's CF\_OBJECTDESCRIPTOR format. If the CLSID indicates a data format that belongs to the application, it should transfer the native data instead of calling [**OleCreateFromData**](https://msdn.microsoft.com/windows/desktop/aa5e997e-60d4-472d-9c81-5359c277bde3).
...
A delayed rendering format allows an application to create a scrap file but delay the expense of rendering the data until it is requested by a target. The [**IDataObject**](https://msdn.microsoft.com/windows/desktop/8a002deb-2727-456c-8078-a9b0d5893ed4) interface of a scrap will offer the delayed rendering formats to the target along with native and cached data. If the target requests a delayed rendering format, the Shell will run the application and provide the data to the target from the active object.
...
1.  The drop source calls [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315) and blocks its primary thread until the function returns. Blocking the primary thread normally blocks UI processing.
2.  After the target's [**IDropTarget::Drop**](https://msdn.microsoft.com/windows/desktop/7ea6d815-bf8f-47d5-99d3-f9a55bafee2e) method is called, the target extracts the data from the data object on its primary thread. This procedure normally blocks the target's UI processing for the duration of the extraction process.
3.  Once the data has been extracted, the target returns the [**IDropTarget::Drop**](https://msdn.microsoft.com/windows/desktop/7ea6d815-bf8f-47d5-99d3-f9a55bafee2e) call, the system returns [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315), and both threads can proceed.
...
3.  After [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315) returns, call [**InOperation**](/windows/desktop/api/Shldisp/nf-shldisp-idataobjectasynccapability-inoperation):
...
4.  Return the [**IDropTarget::Drop**](https://msdn.microsoft.com/windows/desktop/7ea6d815-bf8f-47d5-99d3-f9a55bafee2e) call, as you would for a normal data transfer operation. [**DoDragDrop**](https://msdn.microsoft.com/windows/desktop/095172ac-9e08-4797-b9da-41a4e5a61315) will return and unblock the drop source. Do not call [**IDataObject::SetData**](https://msdn.microsoft.com/windows/desktop/7430d12c-ab07-4a9c-a845-4743818afbc7) to indicate the outcome of an optimized move or delete-on-paste operation. Wait until the operation is finished.
5.  Extract the data on the background thread. The target's primary thread is unblocked and free to proceed.
6.  If the data transfer was an [optimized move](#handling-optimized-move-operations) or [delete-on-paste](#handling-delete-on-paste-operations) operation, call [**IDataObject::SetData**](https://msdn.microsoft.com/windows/desktop/7430d12c-ab07-4a9c-a845-4743818afbc7) to indicate the outcome.
