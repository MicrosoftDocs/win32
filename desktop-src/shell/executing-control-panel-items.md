...
An application can open the Control Panel programmatically by using the [**WinExec**](https://msdn.microsoft.com/windows/desktop/00ac3bd8-59d3-4f7f-8720-e57d05cee056) function.
...
The following example shows how an application can start the Control Panel item named **MyCpl.cpl** by using the [**WinExec**](https://msdn.microsoft.com/windows/desktop/00ac3bd8-59d3-4f7f-8720-e57d05cee056) function.
...
The following example shows how an application can start the Control Panel item **Windows Update** with [**WinExec**](https://msdn.microsoft.com/windows/desktop/00ac3bd8-59d3-4f7f-8720-e57d05cee056).
...
When you use the [**WinExec**](https://msdn.microsoft.com/windows/desktop/00ac3bd8-59d3-4f7f-8720-e57d05cee056) function, the system can recognize special Control Panel commands. These commands predate Windows Vista.
