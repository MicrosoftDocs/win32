---
Description: Applications, processes, and windows can opt to make themselves unavailable for pinning to the taskbar or for inclusion in the Start menus Most Frequently Used (MFU) list.
...
-   Set the [System.AppUserModel.PreventPinning](properties.props_System_AppUserModel_PreventPinning) property on windows and shortcuts. This property must be set on a window before the [PKEY\_AppUserModel\_ID](properties.props_System_AppUserModel_Id) property is set.
