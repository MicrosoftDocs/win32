...
Notifies the system when an appbar's position has changed. An appbar should call this message in response to the [**WM\_WINDOWPOSCHANGED**](https://msdn.microsoft.com/library/windows/desktop/ms632652) message.
