...
1.  Assign appropriate values to the members of a [**PROPSHEETPAGE**](https://msdn.microsoft.com/windows/desktop/28cbf3df-f345-4b4f-ac34-e32e63c9b6ec) structure. In particular:
    ...
    -   You can also implement a [*PropSheetPageProc*](https://msdn.microsoft.com/windows/desktop/a1f77ead-99c7-4874-8c32-289775c86458) callback function and assign its pointer to a **pfnCallback** member. This function is called when the page is created and when it is about to be destroyed.
2.  Create the page's HPAGE handle by passing the [**PROPSHEETPAGE**](https://msdn.microsoft.com/windows/desktop/28cbf3df-f345-4b4f-ac34-e32e63c9b6ec) structure to the [**CreatePropertySheetPage**](https://msdn.microsoft.com/windows/desktop/fb7ca67a-7dff-4e1d-a303-5da87d8bbd2b) function.
...
4.  Any messages associated with the page will be passed to the dialog box procedure that was assigned to the **pfnDlgProc** member of the [**PROPSHEETPAGE**](https://msdn.microsoft.com/windows/desktop/28cbf3df-f345-4b4f-ac34-e32e63c9b6ec) structure.
5.  If you assigned a [*PropSheetPageProc*](https://msdn.microsoft.com/windows/desktop/a1f77ead-99c7-4874-8c32-289775c86458) callback function to **pfnCallback**, it will be called when the page is about to be destroyed. Your handler can then perform any needed cleanup operations, such as releasing any references that it holds.
