...
An extension DLL must return **TRUE** to continue loading the DLL. If the DLL returns **FALSE**, File Manager calls the [**FreeLibrary**](base.freelibrary) function and ends any communication with the extension DLL.
