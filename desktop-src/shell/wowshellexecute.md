...
Sets the show state based on the SW\_ flag specified in the [**STARTUPINFO**](base.startupinfo_str) structure passed to the [**CreateProcess**](base.createprocess) function by the program that started the application. An application should call [**ShowWindow**](winmsg.showwindow) with this flag to set the initial show state of its main window.
...
Callback function used to call [**CreateProcess**](base.createprocess) in the 16-bit kernel.
