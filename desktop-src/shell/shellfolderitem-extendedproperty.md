...
For a list of FMTIDs and PIDs that are currently supported by the Shell, see [**SHCOLUMNID**](https://msdn.microsoft.com/en-us/library/Bb759748(v=VS.85).aspx).
