...
For a more powerful approach that will work with any folder, use the [**IShellFolder**](ishellfolder.md) interface. See [Getting Information About the Contents of a Folder](folder-info.md) for more details.
