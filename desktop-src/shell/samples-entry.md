...
| [Execute In Explorer Sample](samples-execinexplorer.md)                                                      | Demonstrates how to call the [**ShellExecute**](shellexecute.md) function from the Windows Explorer process.                                                                                                                 |
...
| [File Operation Progress Sink](samples-fileoperationprogresssink.md)                                         | Demonstrates how to use the [**IFileOperationProgressSink**](ifileoperationprogresssink.md) interface methods for monitoring the details of [**IFileOperation**](ifileoperation.md) interface actions.                      |
...
| [NotificationIcon Sample](samples-notificationicon.md)                                                       | Demonstrates how to use the [**Shell\_NotifyIcon**](shell-notifyicon.md) and [**Shell\_NotifyIconGetRect**](shell-notifyicongetrect.md) APIs to display a notification icon.                                                |
...
| [Shell Library Command Line Sample](samples-shelllibrarycommandline.md)                                      | Demonstrates how to use the [**IShellLibrary**](ishelllibrary.md) interface to create a command-line application that provides programmatic access for inspecting and manipulating libraries and library files.              |
...
| [Using Image Factory Sample](samples-usingimagefactory.md)                                                   | Demonstrates how to use the [**IShellItemImageFactory**](ishellitemimagefactory.md) interface to get the best possible image for an item.                                                                                    |
| [Using Thumbnail Providers Sample](samples-usingthumbnailproviders.md)                                       | Demonstrates how to use the [**IThumbnailProvider**](ithumbnailprovider.md) interface to extract the thumbnail for an item from the Windows thumbnail cache system.                                                          |
