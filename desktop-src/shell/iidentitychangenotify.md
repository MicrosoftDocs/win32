...
The **IIdentityChangeNotify** interface inherits from the [**IUnknown**](com.iunknown) interface. **IIdentityChangeNotify** also has these types of members:
...
To implement notifications, a derived interface must connect to the [**IUserIdentityManager**](iuseridentitymanager.md) by calling [**IConnectionPoint::Advise**](com.iconnectionpoint_advise) and by passing a pointer to the interface.
...
[**IConnectionPoint**](com.iconnectionpoint)
</dt> </dl>
