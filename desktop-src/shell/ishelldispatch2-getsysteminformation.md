...
<tbody>
<tr class="odd">
<td><pre><code>IShellDispatch2.GetSystemInformation( _
...
This method is implemented and accessed through the [**Shell.GetSystemInformation**](shell.Shell_GetSystemInformation) method.
...
The processor architecture. For details, see the discussion of the **wProcessorArchitecture** member of the [**SYSTEM\_INFO**](base.system_info_str) structure.
