...
<td>Exposes a method to discover objects that are named with a <strong>GUID</strong> from another object. Unlike [<strong>QueryService</strong>](42026089-3e71-4483-ab35-1a6f305547fe) this interface will not delegate its functionality on to other objects.<br/></td>
</tr>
<tr class="odd">
...
<td>Exposes methods that the Shell uses to retrieve flags and info tip information for an item that resides in an [<strong>IShellFolder</strong>](/windows/desktop/api/Shobjidl/nn-shobjidl_core-ishellfolder) implementation. Info tips are usually displayed inside a [tooltip](1020cec7-57b4-4463-9419-f80fd14fa12c) control.<br/></td>
</tr>
<tr class="even">
