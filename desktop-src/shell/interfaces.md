...
<td>Exposes methods that the Shell uses to retrieve flags and info tip information for an item that resides in an [<strong>IShellFolder</strong>](/windows/desktop/api/Shobjidl/nn-shobjidl_core-ishellfolder) implementation. Info tips are usually displayed inside a [tooltip](https://www.bing.com/search?q=tooltip) control.<br/></td>
</tr>
<tr class="even">
