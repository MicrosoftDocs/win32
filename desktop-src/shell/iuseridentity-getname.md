---
Description: IUserIdentityGetName is not supported and may be altered or unavailable in the future. Instead, use User Accounts with Fast User Switching and Remote Desktop.
ms.assetid: 4db24dd2-d2b8-4a58-9c16-0e721bc195da
title: IUserIdentityGetName method
ms.date: 05/31/2018
ms.topic: article
