...
The **TaskCompletionClient** interface inherits from the [**IUnknown**](com.iunknown) interface. **TaskCompletionClient** also has these types of members:
...
This API is deprecated and may not be available in future versions of Windows. Apps should use the APIs in the [**Windows.ApplicationModel.ExtendedExecution**](w_appmod_extexe.windows_applicationmodel_extendedexecution) namespace instead.
