...
Currently, **UseAutoPlay** is applicable only on Windows XP or later and only on a drive that [**GetDriveType**](fs.getdrivetype) determines to be of type **DRIVE\_CDROM**.
