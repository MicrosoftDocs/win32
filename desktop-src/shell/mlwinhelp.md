...
Returns a nonzero value on success, or zero otherwise. To get extended error information, call [**GetLastError**](https://msdn.microsoft.com/d852e148-985c-416f-a5a7-27b6914b45d4).
...
| HELP\_MULTIKEY      | Displays the topic specified by a keyword in an alternative keyword table.                                                                                                                                                                                           | Address of a [**MULTIKEYHELP**](/windows/desktop/api/Winuser/ns-winuser-tagmultikeyhelpa) structure that specifies a table footnote character and a keyword.                                                                                                                                                                                     |
...
| HELP\_SETPOPUP\_POS | Sets the position of the subsequent pop-up window.                                                                                                                                                                                                                   | Contains the position data. Use the [**MAKELONG**](https://msdn.microsoft.com/VS|winui|~\winui\windowsuserinterface\windowing\windows\windowreference\windowmacros\makelong.htm) macro to concatenate the horizontal and vertical coordinates into a single value. The pop-up window is positioned as if the mouse cursor were at the specified point when the pop-up window was invoked.                                 |
| HELP\_SETWINPOS     | Displays the Windows Help window, if it is minimized or in memory, and sets its size and position as specified.                                                                                                                                                      | Address of a [**HELPWININFO**](/windows/desktop/api/Winuser/ns-winuser-taghelpwininfoa) structure that specifies the size and position of either a primary or secondary help window.                                                                                                                                                             |
