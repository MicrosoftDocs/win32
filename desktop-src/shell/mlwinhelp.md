...
Returns a nonzero value on success, or zero otherwise. To get extended error information, call [**GetLastError**](https://msdn.microsoft.com/windows/desktop/d852e148-985c-416f-a5a7-27b6914b45d4).
...
| HELP\_SETPOPUP\_POS | Sets the position of the subsequent pop-up window.                                                                                                                                                                                                                   | Contains the position data. Use the [**MAKELONG**](https://msdn.microsoft.com/windows/desktop/161979a1-296c-47ed-bf41-74a561b5ba05) macro to concatenate the horizontal and vertical coordinates into a single value. The pop-up window is positioned as if the mouse cursor were at the specified point when the pop-up window was invoked.                                 |
