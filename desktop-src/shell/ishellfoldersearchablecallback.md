...
The **IShellFolderSearchableCallback** interface inherits from the [**IUnknown**](com.iunknown) interface. **IShellFolderSearchableCallback** also has these types of members:
