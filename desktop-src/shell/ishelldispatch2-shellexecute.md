...
<tbody>
<tr class="odd">
<td><pre><code>IShellDispatch2.ShellExecute( _
...
This method is implemented and accessed through the [**Shell.ShellExecute**](https://msdn.microsoft.com/windows/desktop/62E59A1C-51BD-4864-AF09-35FFD49FAB9D) method.
