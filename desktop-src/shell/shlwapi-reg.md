...
| Topic                                                             | Description                                                                                                                                                                         |
|-------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AssocCreate**](/windows/desktop/api/Shlwapi/nf-shlwapi-assoccreate)<br/>                     | Returns a pointer to an [**IQueryAssociations**](/windows/desktop/api/Shlwapi/) object.<br/>                                                                                         |
...
| [**SHGetAssocKeys**](/windows/desktop/api/Shlwapi/nf-shlwapi-shgetassockeys)<br/>               | Retrieves an array of class subkeys associated with an [**IQueryAssociations**](/windows/desktop/api/Shlwapi/) object.<br/>                                                          |
...
| [**SHRegSetValue**](/windows/desktop/api/shlwapi/nf-shlwapi-shregsetvalue)<br/>                 | Sets a registry value.<br/> Use [**RegSetValue**](https://msdn.microsoft.com/windows/desktop/f99774d4-575b-43a3-8887-e15acb0477fd) in its place.<br/>                                                                                  |
