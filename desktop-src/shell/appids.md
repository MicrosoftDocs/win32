...
-   As a property of any of the application's running windows. This can be set in one of two ways:
    ...
    -   [System.AppUserModel.RelaunchCommand](properties.props_System_AppUserModel_RelaunchCommand)
    -   [System.AppUserModel.RelaunchDisplayNameResource](properties.props_System_AppUserModel_RelaunchDisplayNameResource)
    -   [System.AppUserModel.RelaunchIconResource](properties.props_System_AppUserModel_RelaunchIconResource)
...
-   When a single process contains multiple applications, use [**SHGetPropertyStoreForWindow**](properties.SHGetPropertyStoreForWindow) to retrieve the window's property store and set the AppUserModelID as a window property.
...
2.  Set the [System.AppUserModel.PreventPinning](properties.props_System_AppUserModel_PreventPinning) property on windows and shortcuts. This property must be set on a window before the [PKEY\_AppUserModel\_ID](properties.props_System_AppUserModel_Id) property.
