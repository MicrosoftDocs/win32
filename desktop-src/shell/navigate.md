...
3.  Bind to the subfolder to retrieve its [**IShellFolder**](ishellfolder.md) interface.
...
1.  Retrieves the Program Files folder's [**IShellFolder**](ishellfolder.md) interface ([Using the IShellFolder Interface](folder-info.md)).
