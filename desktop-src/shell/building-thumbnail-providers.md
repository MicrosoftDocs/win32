...
Because the image file in the sample is not embedded in the .recipe file and is not a part of its file stream, [**IInitializeWithItem**](https://msdn.microsoft.com/en-us/library/Bb761814(v=VS.85).aspx) is used in the sample. The implementation of the [**IInitializeWithItem::Initialize**](https://msdn.microsoft.com/en-us/library/Bb761816(v=VS.85).aspx) method simply passes its parameters to private class variables.
