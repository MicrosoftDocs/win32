...
The entries under the **InprocServer32** subkey include a reference back to the file name extension's ProgID subkey as well as an entry for a [VersionIndependentProgID](https://msdn.microsoft.com/windows/desktop/5d188db9-ea4f-47fe-882f-a6caa7e86a25).
