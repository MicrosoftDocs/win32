...
The **OpenWithProgids** subkey is preferred to **OpenWithList** to identify an application. For more information on these subkeys, see [Setting Optional Subkeys and File Type Extension Attributes](https://www.bing.com/search?q=Setting Optional Subkeys and File Type Extension Attributes).
