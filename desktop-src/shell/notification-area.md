...
Notification area icons should be high-DPI aware. An application should provide both a 16x16 pixel icon and a 32x32 icon in its resource file, and then use [**LoadIconMetric**](controls.LoadIconMetric) to ensure that the correct icon is loaded and scaled appropriately.
