...
-   [How To Define File Type Attributes](https://msdn.microsoft.com/library/Hh127434(v=VS.85).aspx)
...
-   In general, **HKEY\_CLASSES\_ROOT** is intended to be read from but not written to. For more information, see the [HKEY\_CLASSES\_ROOT](https://msdn.microsoft.com/library/ms724475(v=VS.85).aspx) article.
...
-   To retrieve registry information regarding a file association, use the [**IQueryAssociations**](https://msdn.microsoft.com/library/Bb761400(v=VS.85).aspx) interface. For a scenario that illustrates this procedure, see [File Association Sample Scenario](fa-sample-scenarios.md).
