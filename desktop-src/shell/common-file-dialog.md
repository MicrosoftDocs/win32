...
The calling process can use the window handle of the dialog itself as the parent of the UI. That handle can be obtained by first calling [**IOleWindow::QueryInterface**](https://msdn.microsoft.com/windows/desktop/2d0efbae-4a1c-43b1-9021-8d89377f7282) and then calling [**IOleWindow::GetWindow**](https://msdn.microsoft.com/windows/desktop/833adc81-be58-44a1-88f1-9aa28808e67b) with the handle as shown in this example.
