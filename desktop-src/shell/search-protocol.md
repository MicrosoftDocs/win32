...
> [!Note]  
> The **search:** protocol does not replace the proprietary [search-ms:](ab2695ed-4ef3-4687-81b0-416ca7086e5f) protocol. Applications can still use the **search-ms:** protocol to launch Window Search Explorer or to silently query the Windows Search indexer.
