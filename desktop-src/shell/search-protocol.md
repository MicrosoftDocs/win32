...
> [!Note]  
> The **search:** protocol does not replace the proprietary [search-ms:](_search_3x_WDS_QryIdx_searchms) protocol. Applications can still use the **search-ms:** protocol to launch Window Search Explorer or to silently query the Windows Search indexer.
