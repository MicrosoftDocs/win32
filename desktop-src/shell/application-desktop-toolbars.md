...
Next, the application passes the bounding rectangle back to the system by using the [**ABM\_SETPOS**](abm-setpos.md) message. Then it calls the [**MoveWindow**](https://msdn.microsoft.com/windows/desktop/b844d1a8-a417-43d5-87da-9869990deea4) function to move the appbar into position.
