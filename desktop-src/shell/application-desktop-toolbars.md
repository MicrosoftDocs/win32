...
Next, the application passes the bounding rectangle back to the system by using the [**ABM\_SETPOS**](abm-setpos.md) message. Then it calls the [**MoveWindow**](https://msdn.microsoft.com/en-us/library/ms633534(v=VS.85).aspx) function to move the appbar into position.
