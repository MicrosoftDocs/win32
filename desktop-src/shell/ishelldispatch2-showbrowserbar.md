...
<tbody>
<tr class="odd">
<td><pre><code>IShellDispatch2.ShowBrowserBar( _
...
This method is implemented and accessed through the [**Shell.ShowBrowserBar**](shell.Shell_ShowBrowserBar) method.
