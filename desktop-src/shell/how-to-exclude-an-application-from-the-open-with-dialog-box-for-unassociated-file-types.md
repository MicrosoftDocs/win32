...
> [!Note]  
> If an application has registered itself in the [OpenWithList](fa-file-types.md#setting-optional-subkeys-and-file-type-extension-attributes) or OpenWithProgIDs for the file type, it will appear in the **Recommended Programs** list even if the NoOpenWith entry is set. Also, remember that regardless of whether an application is offered in a list of recommended programs, a user can manually browse to any executable file.
