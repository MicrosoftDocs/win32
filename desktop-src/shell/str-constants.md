...
A set of string keys that are used with the [**IBindCtx::RegisterObjectParam**](https://msdn.microsoft.com/windows/desktop/7ee2b5b2-9b9c-41f1-8e58-7432ebc0f9ed) method to specify a bind context.
...
<td style="text-align: left;"><strong>Introduced in Windows XP</strong>. Specify this bind context to provide file metadata to the [<strong>IShellFolder::ParseDisplayName</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-parsedisplayname) method, which is used instead of attempting to retrieve the actual file metadata. The associated object must implement [<strong>IFileSystemBindData</strong>](https://msdn.microsoft.com/windows/desktop/f5099bb3-21a7-4708-ac48-d32a14646614) and can optionally also implement [<strong>IFileSystemBindData2</strong>](/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ifilesystembinddata2). By default, the <strong>IShellFolder::ParseDisplayName</strong> method verifies that the file exists and uses the file's actual metadata to populate the ID list.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/windows/desktop/0ea3e1e0-c135-4138-81e4-f72412fc3128) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_BESTEFFORT</strong>](https://msdn.microsoft.com/windows/desktop/d3fde1b9-b19f-431d-9cea-bffc289ee683) flag for more information.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/windows/desktop/0ea3e1e0-c135-4138-81e4-f72412fc3128) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_DELAYCREATION</strong>](https://msdn.microsoft.com/windows/desktop/d3fde1b9-b19f-431d-9cea-bffc289ee683) flag for more information.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/windows/desktop/0ea3e1e0-c135-4138-81e4-f72412fc3128) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_FASTPROPERTIESONLY</strong>](https://msdn.microsoft.com/windows/desktop/d3fde1b9-b19f-431d-9cea-bffc289ee683) flag for more information.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/windows/desktop/0ea3e1e0-c135-4138-81e4-f72412fc3128) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_HANDLERPROPERTIESONLY</strong>](https://msdn.microsoft.com/windows/desktop/d3fde1b9-b19f-431d-9cea-bffc289ee683) flag for more information.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><strong>Introduced in Windows 7</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/windows/desktop/0ea3e1e0-c135-4138-81e4-f72412fc3128) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_NO_OPLOCK</strong>](https://msdn.microsoft.com/windows/desktop/d3fde1b9-b19f-431d-9cea-bffc289ee683) flag for more information.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/windows/desktop/0ea3e1e0-c135-4138-81e4-f72412fc3128) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_OPENSLOWITEM</strong>](https://msdn.microsoft.com/windows/desktop/d3fde1b9-b19f-431d-9cea-bffc289ee683) flag for more information.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><strong>Windows Vista only.</strong> Specify this bind context to cause a call to the [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject) method that requests the [<strong>IFilter</strong>](https://www.bing.com/search?q=<strong>IFilter</strong>) interface for a file system object to return a text filter if no other filter is available. This value is not defined as of Windows 7.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><strong>Windows Vista only.</strong> A parsing bind context that is used to pass a set of properties and the item's name when calling [<strong>IShellFolder::ParseDisplayName</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-parsedisplayname). The object in the bind context implements [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) and is retrieved by calling [<strong>IBindCtx::GetObjectParam</strong>](https://msdn.microsoft.com/windows/desktop/8f423495-7a34-4901-968e-1fe204680d8a).<br/> DBFolder is a Shell data source that represents items in search results and query-based views. DBFolder retrieves these items by querying the Windows Search system. Items in the search results are identified through a protocol scheme, for example &quot;file:&quot; or &quot;mapi:&quot;. DBFolder provides the behavior for these items by delegating to Shell data sources that are created for these protocols. See [Developing Protocol Handler Add-ins](https://www.bing.com/search?q=Developing Protocol Handler Add-ins) for more information.<br/> When DBFolder delegates its parsing operation to the Shell data sources that support Windows Search protocols, this bind context provides access to values that were returned in the query result for that item. This includes the following:<br/>
<ul>
<li>[System.ItemType](https://msdn.microsoft.com/windows/desktop/530ba98a-09fd-438b-8872-9eee47f0cf54) (PKEY_ItemType)</li>
<li>[System.ParsingPath](https://msdn.microsoft.com/windows/desktop/e0fb2092-0427-40c9-9e09-aefc5ef017e6) (PKEY_ParsingPath)</li>
<li>[System.ItemPathDisplay](https://msdn.microsoft.com/windows/desktop/27e4490b-7914-4b38-9799-e9d5dc407f13) (PKEY_ItemPathDisplay)</li>
<li>[System.ItemNameDisplay](https://msdn.microsoft.com/windows/desktop/fdb6b0fa-0741-4edc-8902-763a461313b9) (PKEY_ItemNameDisplay)</li>
</ul>
...
<td style="text-align: left;"><strong>Introduced in Windows 8</strong>. Specify this bind context to indicate that the bind context parameter is a property bag ([<strong>IPropertyBag</strong>](https://www.bing.com/search?q=<strong>IPropertyBag</strong>)) used to pass VARIANT values in the bind context. See the Remarks section for further details.<br/></td>
</tr>
<tr class="even">
...
When requesting a property store through [**IShellFolder**](/windows/desktop/api/Shobjidl/nn-shobjidl_core-ishellfolder), you can specify the equivalent of [**GPS\_DEFAULT**](https://msdn.microsoft.com/windows/desktop/d3fde1b9-b19f-431d-9cea-bffc289ee683) by passing in a null [**IBindCtx**](https://msdn.microsoft.com/windows/desktop/e4c8abb5-0c89-44dd-8d95-efbfcc999b46) parameter. You can also specify the equivalent of GPS\_READWRITE by passing a mode of STGM\_READWRITE \| STGM\_EXCLUSIVE in the bind context.

The property bag specified by the **STR\_PROPERTYBAG\_PARAM** bind context object contains additional values that you can access with the [**IPropertyBag::Read**](https://www.bing.com/search?q=**IPropertyBag::Read**) and [**IPropertyBag::Write**](https://www.bing.com/search?q=**IPropertyBag::Write**) methods.
