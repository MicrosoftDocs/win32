...
<td style="text-align: left;"><strong>Introduced in Windows XP</strong>. Specify this bind context to provide file metadata to the [<strong>IShellFolder::ParseDisplayName</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-parsedisplayname) method, which is used instead of attempting to retrieve the actual file metadata. The associated object must implement [<strong>IFileSystemBindData</strong>](https://msdn.microsoft.com/en-us/library/Bb775671(v=VS.85).aspx) and can optionally also implement [<strong>IFileSystemBindData2</strong>](/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ifilesystembinddata2). By default, the <strong>IShellFolder::ParseDisplayName</strong> method verifies that the file exists and uses the file's actual metadata to populate the ID list.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/en-us/library/Aa379840(v=VS.85).aspx) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/en-us/library/Bb761474(v=VS.85).aspx) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_BESTEFFORT</strong>](https://msdn.microsoft.com/en-us/library/Bb762582(v=VS.85).aspx) flag for more information.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/en-us/library/Aa379840(v=VS.85).aspx) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/en-us/library/Bb761474(v=VS.85).aspx) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_DELAYCREATION</strong>](https://msdn.microsoft.com/en-us/library/Bb762582(v=VS.85).aspx) flag for more information.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/en-us/library/Aa379840(v=VS.85).aspx) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/en-us/library/Bb761474(v=VS.85).aspx) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_FASTPROPERTIESONLY</strong>](https://msdn.microsoft.com/en-us/library/Bb762582(v=VS.85).aspx) flag for more information.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/en-us/library/Aa379840(v=VS.85).aspx) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/en-us/library/Bb761474(v=VS.85).aspx) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_HANDLERPROPERTIESONLY</strong>](https://msdn.microsoft.com/en-us/library/Bb762582(v=VS.85).aspx) flag for more information.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><strong>Introduced in Windows 7</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/en-us/library/Aa379840(v=VS.85).aspx) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/en-us/library/Bb761474(v=VS.85).aspx) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_NO_OPLOCK</strong>](https://msdn.microsoft.com/en-us/library/Bb762582(v=VS.85).aspx) flag for more information.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><strong>Introduced in Windows Vista</strong>. Specify this bind context when requesting an [<strong>IPropertySetStorage</strong>](https://msdn.microsoft.com/en-us/library/Aa379840(v=VS.85).aspx) or [<strong>IPropertyStore</strong>](https://msdn.microsoft.com/en-us/library/Bb761474(v=VS.85).aspx) handler. This value is used with [<strong>IShellFolder::BindToObject</strong>](/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder-bindtoobject). See the [<strong>GPS_OPENSLOWITEM</strong>](https://msdn.microsoft.com/en-us/library/Bb762582(v=VS.85).aspx) flag for more information.<br/></td>
</tr>
<tr class="odd">
