...
# JET\_RSTINFO methods

Include protected members  
Include inherited members  

The [JET\_RSTINFO](dn335235\(v=exchg.10\).md) type exposes the following members.
...
<td>Returns a <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf">String</a> that represents the current <a href="dn335235(v=exchg.10).md">JET_RSTINFO</a>. (Overrides <a href="http://msdn2.microsoft.com/en-us/library/7bxwbwt2">Object.ToString()</a>.)</td>
</tr>
</tbody>
</table>
