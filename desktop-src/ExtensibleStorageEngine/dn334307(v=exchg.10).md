---
title: EsentCommittedLogFileCorruptException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentcommittedlogfilecorruptexception_members(v=EXCHG.10)
ms:contentKeyID: 55101358
ms.date: 07/30/2014
ms.topic: article
---

# EsentCommittedLogFileCorruptException members

Include protected members  
Include inherited members  

Base class for JET\_err.CommittedLogFileCorrupt exceptions.

The [EsentCommittedLogFileCorruptException](dn274206\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentCommittedLogFileCorruptException class.</td>
</tr>
</tbody>
</table>
