...
# JET\_COLUMNBASE.ToString method

Returns a [String](http://msdn2.microsoft.com/en-us/library/s1wwdcbf) that represents the current [JET\_COLUMNBASE](dn335045\(v=exchg.10\).md).
...
A [String](http://msdn2.microsoft.com/en-us/library/s1wwdcbf) that represents the current [JET\_COLUMNBASE](dn335045\(v=exchg.10\).md).  
