---
title: EsentDiskFullException members (Microsoft.Isam.Esent.Interop)
TOCTitle: EsentDiskFullException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentDiskFullException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentdiskfullexception_members(v=EXCHG.10)
ms:contentKeyID: 55101618
ms.date: 07/30/2014
ms.topic: article
---

# EsentDiskFullException members

Include protected members  
Include inherited members  

Base class for JET\_err.DiskFull exceptions.

The [EsentDiskFullException](dn334461\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDiskFullException class.</td>
</tr>
</tbody>
</table>
