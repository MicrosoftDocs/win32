...
Closes a database file that was previously opened with [JetOpenDatabase(JET\_SESID, String, String, JET\_DBID, OpenDatabaseGrbit)](dn292219\(v=exchg.10\).md) or created with [JetCreateDatabase(JET\_SESID, String, String, JET\_DBID, CreateDatabaseGrbit)](dn292118\(v=exchg.10\).md).
