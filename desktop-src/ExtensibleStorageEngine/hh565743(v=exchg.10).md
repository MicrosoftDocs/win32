---
title: JET_INDEXID members (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_INDEXID members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.JET_INDEXID
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_indexid_members(v=EXCHG.10)
ms:contentKeyID: 39514671
ms.date: 07/30/2014
ms.topic: article
---

# JET\_INDEXID members
...
The [JET\_INDEXID](hh557060\(v=exchg.10\).md) type exposes the following members.
...
<td>Returns the hash code for this instance. (Overrides <a href="http://msdn2.microsoft.com/en-us/library/y3509fc2">ValueType.GetHashCode()</a>.)</td>
</tr>
<tr class="odd">
<td><img src="images/Dn292146.pubmethod(EXCHG.10).gif" title="Public method" alt="Public method" /></td>
...
<td><a href="hh566531(v=exchg.10).md">Equality</a></td>
<td>Determines whether two specified instances of JET_INDEXID are equal.</td>
</tr>
<tr class="even">
<td><img src="images/Dn350944.puboperator(EXCHG.10).gif" title="Public operator" alt="Public operator" /><img src="images/Dn292146.static(EXCHG.10).gif" title="Static member" alt="Static member" /></td>
<td><a href="hh577553(v=exchg.10).md">Inequality</a></td>
<td>Determines whether two specified instances of JET_INDEXID are not equal.</td>
</tr>
</tbody>
</table>
