---
title: JET_SPACEHINTS methods (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_SPACEHINTS methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.JET_SPACEHINTS
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_spacehints_methods(v=EXCHG.10)
ms:contentKeyID: 55103959
ms.date: 07/30/2014
ms.topic: article
---

# JET\_SPACEHINTS methods
