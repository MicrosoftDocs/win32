---
title: EsentSessionSharingViolationException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentsessionsharingviolationexception_members(v=EXCHG.10)
ms:contentKeyID: 55102714
ms.date: 07/30/2014
ms.topic: article
---

# EsentSessionSharingViolationException members

Include protected members  
Include inherited members  

Base class for JET\_err.SessionSharingViolation exceptions.

The [EsentSessionSharingViolationException](dn350642\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentSessionSharingViolationException class.</td>
</tr>
</tbody>
</table>
