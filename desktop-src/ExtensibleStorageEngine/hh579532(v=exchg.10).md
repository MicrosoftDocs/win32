---
title: OpenDatabaseGrbit enumeration (Microsoft.Isam.Esent.Interop)
...
Options for [JetOpenDatabase(JET\_SESID, String, String, JET\_DBID, OpenDatabaseGrbit)](dn292219\(v=exchg.10\).md).
