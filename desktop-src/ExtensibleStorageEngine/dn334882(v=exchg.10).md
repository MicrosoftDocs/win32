---
title: EsentSLVStreamingFileReadOnlyException methods (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentslvstreamingfilereadonlyexception_methods(v=EXCHG.10)
ms:contentKeyID: 55102949
ms.date: 07/30/2014
ms.topic: article
---

# EsentSLVStreamingFileReadOnlyException methods

Include protected members  
Include inherited members  

The [EsentSLVStreamingFileReadOnlyException](dn334778\(v=exchg.10\).md) type exposes the following members.
