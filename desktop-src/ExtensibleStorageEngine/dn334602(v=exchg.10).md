---
title: EsentLogFileNotCopiedException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentlogfilenotcopiedexception_members(v=EXCHG.10)
ms:contentKeyID: 55102164
ms.date: 07/30/2014
ms.topic: article
---

# EsentLogFileNotCopiedException members

Include protected members  
Include inherited members  

Base class for JET\_err.LogFileNotCopied exceptions.

The [EsentLogFileNotCopiedException](dn334541\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentLogFileNotCopiedException class.</td>
</tr>
</tbody>
</table>
...
[EsentLogFileNotCopiedException class](dn334541\(v=exchg.10\).md)
