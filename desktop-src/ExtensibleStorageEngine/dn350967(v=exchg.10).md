...
Returns a [String](http://msdn2.microsoft.com/en-us/library/s1wwdcbf) that represents the current [InstanceParameters](dn350942\(v=exchg.10\).md).
...
A [String](http://msdn2.microsoft.com/en-us/library/s1wwdcbf) that represents the current [InstanceParameters](dn350942\(v=exchg.10\).md).  
