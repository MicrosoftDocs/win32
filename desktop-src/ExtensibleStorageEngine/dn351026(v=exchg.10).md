---
title: JET_RETINFO methods (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_RETINFO methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.JET_RETINFO
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_retinfo_methods(v=EXCHG.10)
...
<td>Returns a <a href="https://msdn.microsoft.com/en-us/library/s1wwdcbf">String</a> that represents the current <a href="dn335277(v=exchg.10).md">JET_RETINFO</a>. (Overrides <a href="https://msdn.microsoft.com/en-us/library/7bxwbwt2">Object.ToString()</a>.)</td>
</tr>
</tbody>
</table>
