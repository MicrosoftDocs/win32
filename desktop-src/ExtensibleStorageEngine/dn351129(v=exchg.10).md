...
Returns a [String](https://msdn.microsoft.com/en-us/library/s1wwdcbf) that represents the current [Session](dn351164\(v=exchg.10\).md).
...
A [String](https://msdn.microsoft.com/en-us/library/s1wwdcbf) that represents the current [Session](dn351164\(v=exchg.10\).md).  
