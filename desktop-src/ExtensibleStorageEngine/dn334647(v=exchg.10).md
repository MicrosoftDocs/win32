---
title: EsentLogSectorSizeMismatchDatabasesConsistentException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentlogsectorsizemismatchdatabasesconsistentexception_members(v=EXCHG.10)
ms:contentKeyID: 55102208
ms.date: 07/30/2014
mtps_version: v=EXCHG.10
---

# EsentLogSectorSizeMismatchDatabasesConsistentException members

Include protected members  
Include inherited members  

Base class for JET\_err.LogSectorSizeMismatchDatabasesConsistent exceptions.

The [EsentLogSectorSizeMismatchDatabasesConsistentException](dn334645\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentLogSectorSizeMismatchDatabasesConsistentException class.</td>
</tr>
</tbody>
</table>
...
<td>When overridden in a derived class, sets the <a href="http://msdn2.microsoft.com/en-us/library/a9b6042e">SerializationInfo</a> with information about the exception. (Inherited from <a href="dn274314(v=exchg.10).md">EsentErrorException</a>.)</td>
</tr>
<tr class="even">
<td><img src="images/Dn292146.pubmethod(EXCHG.10).gif" title="Public method" alt="Public method" /></td>
