---
title: Api.JetGetLogInfoInstance method  (Microsoft.Isam.Esent.Interop)
...
Used during a backup initiated by [JetBeginExternalBackupInstance(JET\_INSTANCE, BeginExternalBackupGrbit)](dn292104\(v=exchg.10\).md) to query an instance for the names of database patch files and logfiles that should become part of the backup file set. These files may subsequently be opened using [JetOpenFileInstance(JET\_INSTANCE, String, JET\_HANDLE, Int64, Int64)](dn292230\(v=exchg.10\).md) and read using [JetReadFileInstance(JET\_INSTANCE, JET\_HANDLE, \[\], Int32, Int32)](dn332987\(v=exchg.10\).md).
