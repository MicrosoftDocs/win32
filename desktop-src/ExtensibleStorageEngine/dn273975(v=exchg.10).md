...
# EsentBackupInProgressException members

Include protected members  
Include inherited members  

Base class for JET\_err.BackupInProgress exceptions.

The [EsentBackupInProgressException](dn274026\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentBackupInProgressException class.</td>
</tr>
</tbody>
</table>
...
[EsentBackupInProgressException class](dn274026\(v=exchg.10\).md)
