---
title: EsentInitInProgressException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentinitinprogressexception_members(v=EXCHG.10)
ms:contentKeyID: 55101871
ms.date: 07/30/2014
ms.topic: article
---

# EsentInitInProgressException members
...
The [EsentInitInProgressException](dn350503\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentInitInProgressException class.</td>
</tr>
</tbody>
</table>
