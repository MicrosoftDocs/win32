---
title: EsentInvalidPlaceholderColumnException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentinvalidplaceholdercolumnexception_members(v=EXCHG.10)
ms:contentKeyID: 55102076
ms.date: 07/30/2014
ms.topic: article
---

# EsentInvalidPlaceholderColumnException members

Include protected members  
Include inherited members  

Base class for JET\_err.InvalidPlaceholderColumn exceptions.

The [EsentInvalidPlaceholderColumnException](dn319579\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentInvalidPlaceholderColumnException class.</td>
</tr>
</tbody>
</table>
...
[EsentInvalidPlaceholderColumnException class](dn319579\(v=exchg.10\).md)
