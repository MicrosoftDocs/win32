---
title: JET_UNICODEINDEX.lcid property  (Microsoft.Isam.Esent.Interop)
TOCTitle: 'lcid property '
ms:assetid: P:Microsoft.Isam.Esent.Interop.JET_UNICODEINDEX.lcid
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_unicodeindex.lcid(v=EXCHG.10)
...
# JET\_UNICODEINDEX.lcid property
