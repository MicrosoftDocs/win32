---
title: EsentDiskReadVerificationFailureException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentdiskreadverificationfailureexception_members(v=EXCHG.10)
ms:contentKeyID: 55101535
ms.date: 07/30/2014
ms.topic: article
---

# EsentDiskReadVerificationFailureException members
...
The [EsentDiskReadVerificationFailureException](dn274287\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDiskReadVerificationFailureException class.</td>
</tr>
</tbody>
</table>
