...
# JET\_RECORDLIST.columnidBookmark property

Gets the columnid of the column in the temporary table which stores the bookmark of the record. The column is of type JET\_coltyp.Text.
