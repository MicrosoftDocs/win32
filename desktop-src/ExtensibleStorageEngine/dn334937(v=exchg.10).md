---
title: EsentSurrogateBackupInProgressException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentsurrogatebackupinprogressexception_members(v=EXCHG.10)
ms:contentKeyID: 55103001
ms.date: 07/30/2014
ms.topic: article
---

# EsentSurrogateBackupInProgressException members

Include protected members  
Include inherited members  

Base class for JET\_err.SurrogateBackupInProgress exceptions.

The [EsentSurrogateBackupInProgressException](dn334878\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentSurrogateBackupInProgressException class.</td>
</tr>
</tbody>
</table>
