---
title: EsentDatabaseInvalidNameException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentdatabaseinvalidnameexception_members(v=EXCHG.10)
ms:contentKeyID: 55101508
ms.date: 07/30/2014
ms.topic: article
---

# EsentDatabaseInvalidNameException members

Include protected members  
Include inherited members  

Base class for JET\_err.DatabaseInvalidName exceptions.

The [EsentDatabaseInvalidNameException](dn334450\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDatabaseInvalidNameException class.</td>
</tr>
</tbody>
</table>
...
[EsentDatabaseInvalidNameException class](dn334450\(v=exchg.10\).md)
