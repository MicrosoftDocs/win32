...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.server2003.updategrbit(v=EXCHG.10)
...
Options for [JetUpdate2(JET\_SESID, JET\_TABLEID, \[\], Int32, Int32, UpdateGrbit)](dn351205\(v=exchg.10\).md).
