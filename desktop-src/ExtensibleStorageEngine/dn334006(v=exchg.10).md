...
Allows an application to set multiple column values in a single operation. An array of [JET\_SETCOLUMN](dn335260\(v=exchg.10\).md) structures is used to describe the set of column values to be set, and to describe input buffers for each column value to be set.
...
<!-- end list -->
  ...
  - setcolumns  
    ...
    An array of [JET\_SETCOLUMN](dn335260\(v=exchg.10\).md) structures describing the data to set.
