...
- other
api_name: 
- Microsoft.Isam.Esent.Interop.EsentTooManyMempoolEntriesException..ctor
topic_type: 
- kbSyntax
- apiref
api_type: 
...
# EsentTooManyMempoolEntriesException constructor
...
Dim instance As New EsentTooManyMempoolEntriesException()
```
