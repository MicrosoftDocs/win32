---
title: Session members (Microsoft.Isam.Esent.Interop)
TOCTitle: Session members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.Session
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.session_members(v=EXCHG.10)
...
A class that encapsulates a JET\_SESID in a disposable object.
...
<td>Initializes a new instance of the Session class. A new JET_SESSION is allocated from the given instance.</td>
</tr>
</tbody>
</table>
...
<td>Gets the JET_SESID that this session contains.</td>
</tr>
</tbody>
</table>
...
<td>Free the underlying JET_SESID. (Overrides <a href="dn350545(v=exchg.10).md">EsentResource.ReleaseResource()</a>.)</td>
</tr>
<tr class="odd">
<td><img src="images/Dn292116.protmethod(EXCHG.10).gif" title="Protected method" alt="Protected method" /></td>
...
<td>Returns a <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf">String</a> that represents the current <a href="dn351164(v=exchg.10).md">Session</a>. (Overrides <a href="http://msdn2.microsoft.com/en-us/library/7bxwbwt2">Object.ToString()</a>.)</td>
</tr>
</tbody>
</table>
