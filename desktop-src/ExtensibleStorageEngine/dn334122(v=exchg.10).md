...
<td>Returns a <a href="https://msdn.microsoft.com/en-us/library/s1wwdcbf">String</a> that represents the current <a href="dn334170(v=exchg.10).md">BytesColumnValue</a>. (Overrides <a href="dn334163(v=exchg.10).md">ColumnValue.ToString()</a>.)</td>
</tr>
</tbody>
</table>
