---
title: JET_ENUMCOLUMN.err property  (Microsoft.Isam.Esent.Interop)
TOCTitle: 'err property '
ms:assetid: P:Microsoft.Isam.Esent.Interop.JET_ENUMCOLUMN.err
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_enumcolumn.err(v=EXCHG.10)
...
[ColumnSingleValue](hh557250\(v=exchg.10\).md)
