...
# EsentDatabaseNotFoundException members

Include protected members  
Include inherited members  

Base class for JET\_err.DatabaseNotFound exceptions.

The [EsentDatabaseNotFoundException](dn334481\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDatabaseNotFoundException class.</td>
</tr>
</tbody>
</table>
...
[EsentDatabaseNotFoundException class](dn334481\(v=exchg.10\).md)
