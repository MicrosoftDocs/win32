---
title: EsentOutOfBuffersException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentoutofbuffersexception_members(v=EXCHG.10)
ms:contentKeyID: 55102445
ms.date: 07/30/2014
ms.topic: article
---

# EsentOutOfBuffersException members

Include protected members  
Include inherited members  

Base class for JET\_err.OutOfBuffers exceptions.

The [EsentOutOfBuffersException](dn319715\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentOutOfBuffersException class.</td>
</tr>
</tbody>
</table>
