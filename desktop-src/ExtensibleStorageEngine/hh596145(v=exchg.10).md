---
title: GotoSecondaryIndexBookmarkGrbit enumeration (Microsoft.Isam.Esent.Interop)
...
Options for [JetGotoSecondaryIndexBookmark(JET\_SESID, JET\_TABLEID, \[\], Int32, \[\], Int32, GotoSecondaryIndexBookmarkGrbit)](dn292205\(v=exchg.10\).md).
