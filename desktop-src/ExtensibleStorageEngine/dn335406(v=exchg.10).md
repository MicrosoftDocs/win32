---
title: Windows7Api class (Microsoft.Isam.Esent.Interop.Windows7)
TOCTitle: Windows7Api class
ms:assetid: T:Microsoft.Isam.Esent.Interop.Windows7.Windows7Api
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.windows7.windows7api(v=EXCHG.10)
ms:contentKeyID: 55104360
ms.date: 07/30/2014
ms.topic: article
f1_keywords:
...
``` vb
'Declaration
Public NotInheritable Class Windows7Api
'Usage
