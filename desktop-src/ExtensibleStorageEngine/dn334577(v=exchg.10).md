...
# EsentLanguageNotSupportedException methods

Include protected members  
Include inherited members  

The [EsentLanguageNotSupportedException](dn334570\(v=exchg.10\).md) type exposes the following members.
...
[EsentLanguageNotSupportedException class](dn334570\(v=exchg.10\).md)
