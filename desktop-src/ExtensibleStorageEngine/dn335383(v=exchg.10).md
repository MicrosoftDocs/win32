...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.windows8.windows8api.jetsetcursorfilter(v=EXCHG.10)
...
Set an array of simple filters for [JetMove(JET\_SESID, JET\_TABLEID, Int32, MoveGrbit)](dn292217\(v=exchg.10\).md).
...
<!-- end list -->
  ...
  - grbit  
    Type: [Microsoft.Isam.Esent.Interop.Windows8.CursorFilterGrbit](dn335440\(v=exchg.10\).md)  
