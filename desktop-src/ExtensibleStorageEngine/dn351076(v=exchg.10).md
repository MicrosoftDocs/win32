---
title: JET_TABLECREATE.ToString method  (Microsoft.Isam.Esent.Interop)
TOCTitle: 'ToString method '
ms:assetid: M:Microsoft.Isam.Esent.Interop.JET_TABLECREATE.ToString
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_tablecreate.tostring(v=EXCHG.10)
...
# JET\_TABLECREATE.ToString method
