---
title: EsentOutOfObjectIDsException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentoutofobjectidsexception_members(v=EXCHG.10)
ms:contentKeyID: 55102542
ms.date: 07/30/2014
ms.topic: article
---

# EsentOutOfObjectIDsException members

Include protected members  
Include inherited members  

Base class for JET\_err.OutOfObjectIDs exceptions.

The [EsentOutOfObjectIDsException](dn319746\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentOutOfObjectIDsException class.</td>
</tr>
</tbody>
</table>
...
[EsentOutOfObjectIDsException class](dn319746\(v=exchg.10\).md)
