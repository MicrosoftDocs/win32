---
title: JET_ENUMCOLUMNVALUE.cbData property  (Microsoft.Isam.Esent.Interop)
TOCTitle: 'cbData property '
ms:assetid: P:Microsoft.Isam.Esent.Interop.JET_ENUMCOLUMNVALUE.cbData
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_enumcolumnvalue.cbdata(v=EXCHG.10)
...
# JET\_ENUMCOLUMNVALUE.cbData property
