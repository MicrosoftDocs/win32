---
title: JET_HANDLE members (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_HANDLE members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.JET_HANDLE
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_handle_members(v=EXCHG.10)
...
A JET\_HANDLE contains a generic handle.

The [JET\_HANDLE](hh558081\(v=exchg.10\).md) type exposes the following members.
