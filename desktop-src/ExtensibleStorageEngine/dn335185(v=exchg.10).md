---
title: JET_INSTANCE_INFO methods (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_INSTANCE_INFO methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.JET_INSTANCE_INFO
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_instance_info_methods(v=EXCHG.10)
ms:contentKeyID: 55103695
ms.date: 07/30/2014
mtps_version: v=EXCHG.10
---

# JET\_INSTANCE\_INFO methods
