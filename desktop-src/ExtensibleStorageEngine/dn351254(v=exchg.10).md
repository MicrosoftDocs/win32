---
title: UInt64ColumnValue members (Microsoft.Isam.Esent.Interop)
TOCTitle: UInt64ColumnValue members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.UInt64ColumnValue
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.uint64columnvalue_members(v=EXCHG.10)
ms:contentKeyID: 55104181
ms.date: 07/30/2014
ms.topic: article
---

# UInt64ColumnValue members

Include protected members  
Include inherited members  

A [UInt64](http://msdn2.microsoft.com/en-us/library/06cf7918) column value.
...
<td><a href="dn351260(v=exchg.10).md">Size</a></td>
