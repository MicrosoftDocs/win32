---
title: EsentInvalidPrereadException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentinvalidprereadexception_members(v=EXCHG.10)
ms:contentKeyID: 55102018
ms.date: 07/30/2014
ms.topic: article
---

# EsentInvalidPrereadException members

Include protected members  
Include inherited members  

Base class for JET\_err.InvalidPreread exceptions.

The [EsentInvalidPrereadException](dn334516\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentInvalidPrereadException class.</td>
</tr>
</tbody>
</table>
