---
title: EsentDatabaseLeakInSpaceException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentdatabaseleakinspaceexception_members(v=EXCHG.10)
ms:contentKeyID: 55101522
ms.date: 07/30/2014
ms.topic: article
---

# EsentDatabaseLeakInSpaceException members

Include protected members  
Include inherited members  

Base class for JET\_err.DatabaseLeakInSpace exceptions.

The [EsentDatabaseLeakInSpaceException](dn334349\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDatabaseLeakInSpaceException class.</td>
</tr>
</tbody>
</table>
