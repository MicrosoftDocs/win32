---
title: JET_prep enumeration (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_prep enumeration
ms:assetid: T:Microsoft.Isam.Esent.Interop.JET_prep
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_prep(v=EXCHG.10)
