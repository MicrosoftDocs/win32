---
title: EsentCannotNestDistributedTransactionsException class (Microsoft.Isam.Esent.Interop)
...
Base class for JET\_err.CannotNestDistributedTransactions exceptions.
