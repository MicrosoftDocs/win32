---
title: Api.EscrowUpdate method  (Microsoft.Isam.Esent.Interop)
...
This method wraps [JetEscrowUpdate(JET\_SESID, JET\_TABLEID, JET\_COLUMNID, \[\], Int32, \[\], Int32, Int32, EscrowUpdateGrbit)](dn292150\(v=exchg.10\).md).
