...
Base class for JET\_err.LogTornWriteDuringHardRestore exceptions.

The [EsentLogTornWriteDuringHardRestoreException](dn334605\(v=exchg.10\).md) type exposes the following members.
