---
title: EsentDatabase200FormatException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentdatabase200formatexception_members(v=EXCHG.10)
ms:contentKeyID: 55101305
ms.date: 07/30/2014
ms.topic: article
---

# EsentDatabase200FormatException members

Include protected members  
Include inherited members  

Base class for JET\_err.Database200Format exceptions.

The [EsentDatabase200FormatException](dn334342\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDatabase200FormatException class.</td>
</tr>
</tbody>
</table>
