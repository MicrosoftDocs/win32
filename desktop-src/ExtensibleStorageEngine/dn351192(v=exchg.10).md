...
Returns a [String](http://msdn2.microsoft.com/en-us/library/s1wwdcbf) that represents the current [Update](dn351191\(v=exchg.10\).md).
...
A [String](http://msdn2.microsoft.com/en-us/library/s1wwdcbf) that represents the current [Update](dn351191\(v=exchg.10\).md).  
