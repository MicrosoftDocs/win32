...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.vista.jet_recsize.op_addition(v=EXCHG.10)
...
# JET\_RECSIZE.Addition operator
...
Type: [Microsoft.Isam.Esent.Interop.Vista.JET\_RECSIZE](hh557010\(v=exchg.10\).md)  
A JET\_RECSIZE containing the result of adding the sizes in left and right.  
