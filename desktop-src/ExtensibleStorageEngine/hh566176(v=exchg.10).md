---
title: SeekGrbit enumeration (Microsoft.Isam.Esent.Interop)
TOCTitle: SeekGrbit enumeration
ms:assetid: T:Microsoft.Isam.Esent.Interop.SeekGrbit
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.seekgrbit(v=EXCHG.10)
