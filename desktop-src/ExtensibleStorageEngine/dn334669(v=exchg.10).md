...
Base class for JET\_err.LSAlreadySet exceptions.

The [EsentLSAlreadySetException](dn334614\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentLSAlreadySetException class.</td>
</tr>
</tbody>
</table>
