---
title: UpgradeClusterCode method of the PS\_NetworkController class
description: Upgrades the Service Fabric cluster code.
audience: developer
...
Upgrades the Service Fabric cluster code.

## Syntax


```mof
uint32 UpgradeClusterCode();
```
