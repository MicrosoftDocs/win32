---
title: RemoveTemporaryServices method of the PS\_NetworkController class
description: Removes the temporary services from Network Controller.
audience: developer
...
Removes the temporary services from Network Controller.

## Syntax


```mof
uint32 RemoveTemporaryServices();
```
