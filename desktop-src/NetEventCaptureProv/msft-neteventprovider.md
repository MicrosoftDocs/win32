---
title: MSFT\_NetEventProvider class
description: This class encapsulates an ETW provider on a computer for the event capture.
ms.assetid: '401c8c4e-7591-4f16-9ca6-257de0d5065b'
keywords: ["MSFT_NetEventProvider class", "MSFT_NetEventProvider class, described"]
topic_type:
- apiref
api_name:
- MSFT_NetEventProvider
- MSFT_NetEventProvider.InstanceID
- MSFT_NetEventProvider.Caption
- MSFT_NetEventProvider.Description
- MSFT_NetEventProvider.ElementName
- MSFT_NetEventProvider.InstallDate
- MSFT_NetEventProvider.OperationalStatus
- MSFT_NetEventProvider.StatusDescriptions
- MSFT_NetEventProvider.Status
- MSFT_NetEventProvider.HealthState
- MSFT_NetEventProvider.CommunicationStatus
- MSFT_NetEventProvider.DetailedStatus
- MSFT_NetEventProvider.OperatingStatus
- MSFT_NetEventProvider.PrimaryStatus
- MSFT_NetEventProvider.Name
- MSFT_NetEventProvider.Guid
- MSFT_NetEventProvider.SessionGuid
- MSFT_NetEventProvider.SessionName
- MSFT_NetEventProvider.Level
- MSFT_NetEventProvider.MatchAnyKeyword
- MSFT_NetEventProvider.MatchAllKeyword
api_location:
...
The **MSFT\_NetEventProvider** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetEventProvider** class has these properties.
