---
title: MSFT\_NetEventNetworkAdapter class
description: This class encapsulates a target network adapter, on which the traffic is to be captured.
ms.assetid: '88f4a1c0-533e-41b5-b498-ec1572966377'
keywords: ["MSFT_NetEventNetworkAdapter class", "MSFT_NetEventNetworkAdapter class, described"]
topic_type:
- apiref
api_name:
- MSFT_NetEventNetworkAdapter
- MSFT_NetEventNetworkAdapter.InstanceID
- MSFT_NetEventNetworkAdapter.Caption
- MSFT_NetEventNetworkAdapter.Description
- MSFT_NetEventNetworkAdapter.ElementName
- MSFT_NetEventNetworkAdapter.InstallDate
- MSFT_NetEventNetworkAdapter.OperationalStatus
- MSFT_NetEventNetworkAdapter.StatusDescriptions
- MSFT_NetEventNetworkAdapter.Status
- MSFT_NetEventNetworkAdapter.HealthState
- MSFT_NetEventNetworkAdapter.CommunicationStatus
- MSFT_NetEventNetworkAdapter.DetailedStatus
- MSFT_NetEventNetworkAdapter.OperatingStatus
- MSFT_NetEventNetworkAdapter.PrimaryStatus
- MSFT_NetEventNetworkAdapter.Name
- MSFT_NetEventNetworkAdapter.Id
- MSFT_NetEventNetworkAdapter.ProviderName
- MSFT_NetEventNetworkAdapter.CaptureStatus
- MSFT_NetEventNetworkAdapter.InterfaceDescription
api_location:
...
# MSFT\_NetEventNetworkAdapter class
...
The **MSFT\_NetEventNetworkAdapter** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetEventNetworkAdapter** class has these properties.
...
The friendly name or description of the target network adapter.
