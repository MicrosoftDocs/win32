...
title: SetPhysicalPresenceRequest method of the Win32\_Tpm class
...
| <dl> <dt>20</dt> </dl>                                                       | SetNoPPIMaintenance\_True<br/> Sets the provision that you must be physically presence to maintain the TPM.<br/> This operation is reversed by operation 19.<br/> **Windows 7, Windows Server 2008 R2, Windows Vista and Windows Server 2008:** This value is not supported.<br/>   |
