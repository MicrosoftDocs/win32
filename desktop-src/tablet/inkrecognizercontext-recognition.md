...
Occurs when the [**InkRecognizerContext**](/windows/desktop/api/msinkaut/) has generated results from the [**BackgroundRecognize**](/windows/desktop/api/msinkaut/) method.
...
This event method is defined in the \_IInkEvents interface. The \_IInkEvents interface implements the [**IDispatch**](https://msdn.microsoft.com/windows/desktop/ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface with an identifier of DISPID\_IRERecognition.
...
[**BackgroundRecognize Method**](/windows/desktop/api/msinkaut/)
</dt> <dt>
