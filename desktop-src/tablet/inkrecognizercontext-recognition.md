...
Occurs when the [**InkRecognizerContext**](/windows/desktop/api/msinkaut/) has generated results from the [**BackgroundRecognize**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkrecognizercontext-backgroundrecognize) method.
