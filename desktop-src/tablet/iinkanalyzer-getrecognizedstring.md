...
> \[!Caution\]  
> To avoid a memory leak, call [**SysFreeString**](https://msdn.microsoft.com/windows/desktop/8f230ee3-5f6e-4cb9-a910-9c90b754dcd3) for *pbstrRecognizedString* when you no longer need to use the string.
