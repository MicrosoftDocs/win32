...
Applications whose documents contain only ink should use ink serialized format (ISF). They should be able to copy and paste Ink Serialized Format (ISF). An example of this is an application for drawing or annotation. These applications can use the [**ClipboardCopy**](/windows/desktop/api/msinkaut/), and [**ClipboardPaste**](https://www.bing.com/search?q=**ClipboardPaste**) methods.
