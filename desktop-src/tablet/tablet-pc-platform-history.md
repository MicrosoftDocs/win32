...
Windows 7 introduces additional language support, the math input control, and custom dictionaries. [Windows Touch](wintouch.windows_touch_portal) features have also been added to Windows operating systems.
