---
Description: Moves this IContextNode object from its parent context nodes collection of subnodes to the specified context nodes collection of subnodes.
ms.assetid: e19ecbe3-f7aa-499c-86a1-236dc9056fd9
title: IContextNodeReparent method
ms.date: 05/31/2018
ms.topic: article
