...
| [**CanPaste**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkdisp-canpaste)                                     | Indicates whether the [**IDataObject**](https://msdn.microsoft.com/library/windows/desktop/ms688421) can be converted to an **InkDisp** object.<br/>                                                                                       |
...
| [**ClipboardPaste**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkdisp-clipboardpaste)                         | Copies the [**IDataObject**](https://msdn.microsoft.com/library/windows/desktop/ms688421) from the Clipboard to the **InkDisp** object.<br/>                                                                                               |
