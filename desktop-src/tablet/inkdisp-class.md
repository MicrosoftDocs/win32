...
| [**CanPaste**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkdisp-canpaste)                                     | Indicates whether the [**IDataObject**](https://docs.microsoft.com/windows/desktop/api/objidl/nn-objidl-idataobject) can be converted to an **InkDisp** object.<br/>                                                                                       |
...
| [**ClipboardCopy**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkdisp-clipboardcopy)                           | Copies the [InkStrokes](https://msdn.microsoft.com/en-us/library/ms703293(v=VS.85).aspx) collection to the Clipboard.<br/>                                                                                                           |
...
| [**ClipboardPaste**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkdisp-clipboardpaste)                         | Copies the [**IDataObject**](https://docs.microsoft.com/windows/desktop/api/objidl/nn-objidl-idataobject) from the Clipboard to the **InkDisp** object.<br/>                                                                                               |
...
| [**CreateStrokes**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkdisp-createstrokes)                           | Creates an [InkStrokes](https://msdn.microsoft.com/en-us/library/ms703293(v=VS.85).aspx) collection for this **InkDisp** object.<br/>                                                                                                |
...
| [**HitTestCircle**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkdisp-hittestcircle)                   | Retrieves the [**InkStrokes**](https://msdn.microsoft.com/en-us/library/ms703293(v=VS.85).aspx) collection that are either completely inside or intersected by a known circle.<br/>                                                  |
...
| [**Strokes**](/windows/desktop/api/msinkaut15/nf-msinkaut15-iinkdivisionresult-get_strokes)<br/>                           | Read-only<br/>  | Gets the [InkStrokes](https://msdn.microsoft.com/en-us/library/ms703293(v=VS.85).aspx) collection contained in the **InkDisp** object.<br/>                             |
