...
A member of the [**MouseButton**](/windows/win32/inked/ne-inked-mousebutton?branch=master) enumeration that indicates which mouse buttons were pressed.
...
This event method is defined in the **\_IInkEditEvents** interface. The **\_IInkEditEvents** interface implements the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface with an identifier of DISPID\_IeeMouseDown.
