...
The results of the recognition are returned in a [**RecognitionResult**](iinkrecognitionresult.md) object. The results contain a best result string in the [TopString](frlrfMicrosoftInkRecognitionResultClassTopStringTopic) property, as well as a collection of alternative results in a [**RecognitionAlternates**](iinkrecognitionalternates.md) collection. The **RecognitionResult** object can be persisted with the original [**Strokes**](inkstrokes-collection.md) collection from which it was generated.
