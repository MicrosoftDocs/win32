...
To disable Input Panel programmatically, instantiate the [**PenInputPanel**](/windows/desktop/api/msinkaut/) and set its [**AutoShow**](/windows/desktop/api/msinkaut/) property to **False**.
