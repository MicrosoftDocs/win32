...
Applications can use Microsoft Active Accessibility to expose text. However, the [**IAccessible**](https://msdn.microsoft.com/51e95b01-71e7-435b-85fb-28ee43eb08a7) interface defined by earlier versions of Active Accessibility is not optimized for exposing large amounts of rich text. Later versions define interfaces that are optimized for exposing large amounts of text and textual attributes.

To expose large amounts text, create separate Component Object Model (COM) objects that support [**IAccessible**](https://msdn.microsoft.com/51e95b01-71e7-435b-85fb-28ee43eb08a7), or child elements, to represent each run of text. A run is a line, or portion of a line, that shares the same formatting.
...
For more information about exposing text by using Active Accessibility, see [Accessibility](https://msdn.microsoft.com/08403228-6c73-4bbe-bac2-e6910ddc5f0c).
