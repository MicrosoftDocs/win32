...
-   The `AutoClaims` class in this sample inherits from the [UserControl](https://www.bing.com/search?q=UserControl) class rather than the [Form](https://www.bing.com/search?q=Form) class.
