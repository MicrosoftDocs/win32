...
Applications that use [**IAutoComplete**](https://msdn.microsoft.com/bed6eb41-3086-4af7-8c75-651da9dba3b2) get Input Panel Autocomplete integration for free. While the Shell Autocomplete APIs are included in Windows 2000 onward, Input Panel Autocomplete integration is only support on Windows Vista and newer versions. However, applications built prior to the release of Windows Vista that use **IAutoComplete** automatically get Input Panel Autocomplete integration when run on Windows Vista.

In order to take advantage of Tablet Autocomplete in this way, you must use the autocomplete object (**CLSID\_Autocomplete**). If you wish to provide autocomplete functionality for URLs or file names, use the [**SHAutoComplete**](https://msdn.microsoft.com/b47efa8d-2118-4805-bb04-97bd143228dc) function to create the autocomplete object.

In addition to [**IAutoComplete**](https://msdn.microsoft.com/bed6eb41-3086-4af7-8c75-651da9dba3b2), you can implement [**IAutoComplete2**](https://msdn.microsoft.com/c093719f-7176-4ba4-ae75-399e8beeebf0) or [**IAutoCompleteDropDown**](https://msdn.microsoft.com/1f956d61-6a09-464e-bfe8-0b3bcb9ea181)s directly and still get Input Panel Autocomplete integration automatically.
