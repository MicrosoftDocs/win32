...
The **ITablet** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **ITablet** also has these types of members:
...
| [**GetCursor**](/windows/desktop/api/winuser/)                                 | Retrieves the specified [**ITabletCursor**](itabletcursor.md) object.<br/>     |
...
| [**GetPropertyMetrics**](/windows/desktop/api/msinkaut/)               | Retrieves the metrics data for a specified property.<br/>                       |
