...
> [!Note]  
> When working in an ink-enabled application that uses the [**Factoid**](/windows/win32/msinkaut/?branch=master) property of the [**RecognizerContext**](/windows/win32/msinkaut/?branch=master) object, you cannot use version 1 factoids in a regular expression.
