...
> [!Note]  
> When working in an ink-enabled application that uses the [**Factoid**](/windows/desktop/api/msinkaut/) property of the [**RecognizerContext**](/windows/desktop/api/msinkaut/) object, you cannot use version 1 factoids in a regular expression.
