...
To implement such functionality, your application must be able to determine which end of the pen is being used and hence when to change the appearance of the cursor. It can do this by looking for the state of the [**Inverted**](iinkcursor-inverted.md) property on the [**Cursor**](iinkcursor.md) object.
