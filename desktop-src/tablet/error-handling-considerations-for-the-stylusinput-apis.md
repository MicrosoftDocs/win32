...
2.  Calls the [**Error**](istylusplugin-error.md) method (in managed code, either the [Microsoft.StylusInput.IStylusSyncPlugin.Error](frlrfMicrosoftStylusInputIStylusSyncPluginClassErrorTopic) or [Microsoft.StylusInput.IStylusAsyncPlugin.Error](frlrfMicrosoftStylusInputIStylusAsyncPluginClassErrorTopic) method) of the plug-in that threw the exception.
3.  Calls the [**Error**](istylusplugin-error.md) method of the remaining plug-ins in that collection.
