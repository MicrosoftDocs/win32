...
2.  Attach the hWnd (handle, in managed code) of a window to the [**InkOverlay**](/windows/desktop/api/msinkaut/) object's [**hWnd**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkoverlay-get_hwnd) property ([Handle](https://www.bing.com/search?q=Handle) property, in managed code).
3.  Set the [**InkOverlay**](/windows/desktop/api/msinkaut/) object's [**Enabled**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkoverlay-get_enabled) property to **TRUE**.
...
Use the [**Selection**](/windows/desktop/api/msinkaut/nf-msinkaut-iinkoverlay-get_selection) property to return a [**Strokes**](/windows/desktop/api/msinkaut/) collection that you can use to manipulate a user's selection.
