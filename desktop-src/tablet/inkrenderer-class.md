...
| [**MeasureStroke**](https://msdn.microsoft.com/en-us/library/ms702493(v=VS.85).aspx)                         | Calculates the rectangle on the device context that would contain a stroke if they were drawn with the **InkRenderer** object.<br/>                |
