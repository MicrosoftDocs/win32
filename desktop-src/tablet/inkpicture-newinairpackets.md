...
To set which properties are contained in this array, use the [**DesiredPacketDescription**](/windows/desktop/api/msinkaut/) property of the ink collector object. The array that the *PacketData* parameter returns contains the data for those properties.
...
[**DesiredPacketDescription Property**](/windows/desktop/api/msinkaut/)
</dt> <dt>
