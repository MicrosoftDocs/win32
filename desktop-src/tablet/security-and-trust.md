...
| [**InkCollector**](https://msdn.microsoft.com/en-us/library/ms695519(v=VS.85).aspx)                                            | [UIPermissionWindow.SafeTopLevelWindows](https://www.bing.com/search?q=UIPermissionWindow.SafeTopLevelWindows)<br/>                                                                                                          |
...
| [**InkRenderer**](https://msdn.microsoft.com/en-us/library/ms699463(v=VS.85).aspx)                                              | [UIPermissionWindow.SafeTopLevelWindows](https://www.bing.com/search?q=UIPermissionWindow.SafeTopLevelWindows)<br/>                                                                                                          |
...
| [**DynamicRenderer**](https://msdn.microsoft.com/en-us/library/ms701168(v=VS.85).aspx)                                      | [UIPermissionWindow.SafeTopLevelWindows](https://www.bing.com/search?q=UIPermissionWindow.SafeTopLevelWindows)<br/>                                                                                                          |
...
| [**RealTimeStylus**](https://msdn.microsoft.com/en-us/library/ms704918(v=VS.85).aspx)                                        | [UIPermissionWindow.SafeTopLevelWindows](https://www.bing.com/search?q=UIPermissionWindow.SafeTopLevelWindows)<br/>                                                                                                          |
