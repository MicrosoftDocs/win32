...
| [**EndInkInput**](/windows/desktop/api/msinkaut/)             | Indicates that no more ink will be added to the context.<br/>                                                                                                                                                                                         |
| [**GetAlternateList**](/windows/desktop/api/recapis/)                        | Returns a list of alternates for the best result string.<br/>                                                                                                                                                                                         |
| [**GetBestAlternate**](/windows/desktop/api/recapis/)                        | Returns an [HRECOALT Handle](hrecoalt-handle.md) pointer for the best result alternate.<br/>                                                                                                                                                         |
...
| [**IsStringSupported**](/windows/desktop/api/msinkaut/) | Returns a value that indicates whether a word, date, time, number, or other text that is passed in is contained in the dictionary.<br/>                                                                                                               |
