...
This implementation of the [InkEdit](inkedit-control-reference.md) control is based on the [**RichEdit**](https://msdn.microsoft.com/library/windows/desktop/bb774306) control. The managed (.NET Framework) implementation of [InkEdit](https://www.bing.com/search?q=InkEdit) is based on the [**RichTextBox**](https://www.bing.com/search?q=**RichTextBox**) control.
...
> [!Note]  
> To ensure ink is displayed properly, call the [InkEdit](inkedit-control-reference.md) control [**Refresh**](/windows/desktop/api/inked/nf-inked-iinkedit-refresh) method when it receives an [**HScroll**](https://www.bing.com/search?q=**HScroll**) or [**VScroll**](https://www.bing.com/search?q=**VScroll**) event.
