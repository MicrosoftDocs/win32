...
Occurs when the mouse pointer is over the [**InkCollector**](/windows/desktop/api/msinkaut/) or [**InkOverlay**](/windows/desktop/api/msinkaut/) object and a mouse button is pressed.
