...
|--------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| [**IHandWrittenTextInsertion Interface**](ihandwrittentextinsertion.md) | Used by the application's custom text entry code to insert the text into both the text field and the Text Services backing-store.<br/> |
| [**ITextInputPanel Interface**](itextinputpanel.md)                     | Provides control over the Tablet PC Input Panel.<br/>                                                                                  |
| [**ITextInputPanelEventSink Interface**](itextinputpaneleventsink.md)   | Defines methods that handle the [**ITextInputPanel Interface**](itextinputpanel.md) events.<br/>                                      |
| [**ITextInputPanelRunInfo Interface**](itextinputpanelruninfo.md)       | Provides a method to determine if the Text Input Panel is currently running.<br/>                                                      |
