...
title: WM\_TABLET\_DELETED message
...
The indexes passed in *wParam* are related to the index used by the [**ITabletManager::GetTablet**](/windows/desktop/api/rtscom/) method.
