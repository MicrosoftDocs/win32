...
| Event                                                                               | Threads                                                                                                                                                                                                              |
|-------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Recognition**](inkrecognizercontext-recognition.md)                             | Fires on the background recognition thread, or on the thread which calls the [**RecognizerContext**](/windows/desktop/api/msinkaut/) object's [**Recognize**](/windows/desktop/api/msinkaut/) method.<br/> |
