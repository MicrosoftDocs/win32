...
-   Call [**NotifyWinEvent**](https://msdn.microsoft.com/windows/desktop/08e74d45-95b6-44c2-a2e0-5ba6ffdcd56a) when the controls are created or destroyed, gain or lose focus, or otherwise change state.
-   Handle the WM\_GETOBJECT message when used to query properties of the object or objects.

For the purposes of this discussion, a window containing other custom objects also needs to be exposed to Active Accessibility, allowing the client to discover and navigate to the child objects. For more information about how to make custom controls compatible with accessibility aids, see [Accessibility](https://msdn.microsoft.com/windows/desktop/08403228-6c73-4bbe-bac2-e6910ddc5f0c).
