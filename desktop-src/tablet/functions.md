...
| [**SetLineHeight**](setlineheight.md)                           | Sets the [**LineHeight**](https://msdn.microsoft.com/en-us/library/ms699524(v=VS.85).aspx) property on the [**InkDivider**](inkdivider-class.md) object.                                                                                 |
