...
Occurs before [**IInkStrokeDisp**](/windows/win32/msinkaut/nn-msinkaut-iinkstrokedisp?branch=master) objects are deleted from the [**Ink**](/windows/win32/msinkaut/?branch=master) property.
