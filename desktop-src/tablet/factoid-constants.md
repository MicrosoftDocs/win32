...
<td style="text-align: left;">Indicates to a recognizer to use a programmatically-defined list of words. The list of words is defined by the [<strong>WordList</strong>](/windows/desktop/api/msinkaut/) property of a [<strong>InkRecognizerContext</strong>](/windows/desktop/api/msinkaut/) object. <br/>
<blockquote>
[!Note]<br />
...
<pre class="syntax" data-space="preserve"><code>http://www.adatum.com</code></pre></td>
</tr>
<tr class="odd">
...
If you are using the Tablet PC Platform APIs, you can set the [**Factoid**](/windows/desktop/api/msinkaut/) property on an [**InkRecognizerContext**](/windows/desktop/api/msinkaut/) object.
...
[**Factoid Property \[InkRecognizeContext Class\]**](/windows/desktop/api/msinkaut/)
</dt> <dt>

[**Factoid Property \[PenInputPanel Class\]**](/windows/desktop/api/peninputpanel/)
</dt> <dt>
