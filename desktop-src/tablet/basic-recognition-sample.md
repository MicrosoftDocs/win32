...
The code then calls the [**Recognize**](/windows/desktop/api/msinkaut/) method of the [**InkRecognizerContext**](/windows/desktop/api/msinkaut/) object, passing in a pointer to an [**IInkRecognitionResult**](/windows/desktop/api/msinkaut/nn-msinkaut-iinkrecognitionresult) object to hold the results.
