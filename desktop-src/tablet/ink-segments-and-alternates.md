...
The [**RecognitionResult**](/windows/win32/msinkaut/nn-msinkaut-iinkrecognitionresult?branch=master) object supports efficient storage of full recognition results within the [**Ink**](/windows/win32/msinkaut/?branch=master) object. The **Ink** object maps the recognition alternates to the strokes in the **Ink** object and may also contain other information such as baseline position, line indices, and language ranges.
