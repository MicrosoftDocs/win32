...
<td>Gets the [InkStrokes](https://msdn.microsoft.com/en-us/library/ms703293(v=VS.85).aspx) collection currently selected inside the [InkPicture](inkpicture-control-reference.md) control (run time only).<br/></td>
</tr>
<tr class="even">
