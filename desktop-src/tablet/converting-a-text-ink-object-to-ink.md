...
Then, the code obtains the [IPersistStream](_com_IPersistStream) interface from the text ink object.
...
Then, the code uses the [IPersistStream](_com_IPersistStream) interface to save the contents of the text ink object to the stream.
