...
Use [**CoTaskMemFree**](https://msdn.microsoft.com/library/windows/desktop/ms680722) to free the memory from the *ppDirtyRegion* array when you are finished with it.
