...
> [!Note]  
> When working with the .NET Framework version of the API, the application should add a using statement to allow access to the [Microsoft.Ink.TextInput](https://www.bing.com/search?q=Microsoft.Ink.TextInput) namespace and then create the object directly.
