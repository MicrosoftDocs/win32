...
When creating a [**PenInputPanel**](peninputpanel-class.md) object, [**Handwriting**](paneltype.md) is the default **PanelType**. If you change the panel by setting the [**CurrentPanel**](peninputpanel-currentpanel.md) property before the pen input panel becomes active for the first time, a **PanelChanged** event occurs.
