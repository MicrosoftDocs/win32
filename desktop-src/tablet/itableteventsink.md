...
The **ITabletEventSink** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **ITabletEventSink** also has these types of members:
