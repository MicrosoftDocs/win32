...
title: InkOverlay.CursorButtonDown event
ms.date: 05/31/2018
ms.topic: article
...
The [**IInkCursor**](/windows/win32/msinkaut/nn-msinkaut-iinkcursor?branch=master) object that generated the [**CursorButtonDown**](inkcollector-cursorbuttondown.md) event.
