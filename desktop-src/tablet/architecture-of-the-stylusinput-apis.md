...
Two plug-ins are provided in the StylusInput APIs. The [**DynamicRenderer**](dynamicrenderer-class.md) object implements the [**IStylusSyncPlugin**](istylussyncplugin.md) interface. The **DynamicRenderer** object renders the ink in real time, as it is being drawn. The [**GestureRecognizer**](gesturerecognizer-class.md) object implements the **IStylusSyncPlugin** and [**IStylusAsyncPlugin**](istylusasyncplugin.md) interfaces. The **GestureRecognizer** object recognizes application gestures.
...
A class that implements the [**IStylusSyncPlugin**](istylussyncplugin.md) interface. Synchronous plug-ins are generally called directly by the [**RealTimeStylus**](realtimestylus-class.md) object.

Asynchronous plug-in

A class that implements the [**IStylusAsyncPlugin**](istylusasyncplugin.md) interface. Asynchronous plug-ins are generally called on the application's user interface (UI) thread.
...
[**DynamicRenderer**](dynamicrenderer-class.md)
</dt> <dt>
...
[**IStylusAsyncPlugin**](istylusasyncplugin.md)
</dt> <dt>

[**IStylusSyncPlugin**](istylussyncplugin.md)
</dt> <dt>
