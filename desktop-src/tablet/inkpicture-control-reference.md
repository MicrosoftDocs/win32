...
| [**CursorButtonDown Event**](inkpicture-cursorbuttondown.md)                      | Occurs when the [**InkCollector**](/windows/desktop/api/msinkaut/) control detects an [**IInkCursorButton**](/windows/desktop/api/msinkaut/nn-msinkaut-iinkcursorbutton) object that is down.<br/>                                                                                                                                                         |
...
| [**DblClick**](inkpicture-dblclick.md)                                            | Occurs when the InkPicture control is double-clicked.<br/> This event method is defined in the **\_IInkPictureEvents** interface. The **\_IInkPictureEvents** interface implements the [**IDispatch**](https://msdn.microsoft.com/windows/desktop/ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface with an identifier of DISPID\_IPEDblClick.<br/> |
...
| [**SelectionChanged**](inkpicture-selectionchanged.md)                            | Occurs when the selection of text within the InkPicture control has changed, such as through alterations to the user interface, cut-and-paste procedures, or the [**Selection**](/windows/desktop/api/msinkaut/) property.<br/>                                                                                    |
| [**SelectionChanging**](inkpicture-selectionchanging.md)                          | Occurs when the selection of text within the InkPicture control is about to change, such as through alterations to the user interface, cut-and-paste procedures, or the [**Selection**](/windows/desktop/api/msinkaut/) property.<br/>                                                                             |
| [**SelectionMoved**](inkpicture-selectionmoved.md)                                | Occurs when the position of the current selection has changed, such as through alterations to the user interface, cut-and-paste procedures, or the [**Selection**](/windows/desktop/api/msinkaut/) property.<br/>                                                                                                  |
| [**SelectionMoving Event \[InkPicture Control\]**](inkpicture-selectionmoving.md) | Occurs when the position of the current selection is about to change, such as through alterations to the user interface, cut-and-paste procedures, or the [**Selection**](/windows/desktop/api/msinkaut/) property.<br/>                                                                                           |
| [**SelectionResized**](inkpicture-selectionresized.md)                            | Occurs when the size of the current selection has changed, such as through alterations to the user interface, cut-and-paste procedures, or the [**Selection**](/windows/desktop/api/msinkaut/) property.<br/>                                                                                                      |
| [**SelectionResizing**](inkpicture-selectionresizing.md)                          | Occurs when the size of the current selection is about to change, such as through alterations to the user interface, cut-and-paste procedures, or the [**Selection**](/windows/desktop/api/msinkaut/) property.<br/>                                                                                               |
| [**SizeChanged**](inkpicture-sizechanged.md)                                      | Occurs after the InkPicture control has been resized, specifically, after the [**Width**](/windows/desktop/api/msinkaut/) or [**Height**](/windows/desktop/api/msinkaut/) property value changes.<br/>                                                                                                      |
| [**SizeModeChanged**](inkpicture-sizemodechanged.md)                              | Occurs after the [**SizeMode**](/windows/desktop/api/msinkaut/) property of the InkPicture control has been changed.<br/>                                                                                                                                                                                           |
| **StyleChanged**                                                                   | Not implemented.<br/>                                                                                                                                                                                                                                                                                        |
| [**Stroke**](inkpicture-stroke.md)                                                | Occurs when the user draws a new stroke on any tablet.<br/>                                                                                                                                                                                                                                                  |
| [**StrokesDeleted**](inkpicture-strokesdeleted.md)                                | Occurs after [**IInkStrokeDisp**](/windows/desktop/api/msinkaut/nn-msinkaut-iinkstrokedisp) objects have been deleted from the [**Ink**](/windows/desktop/api/msinkaut/) property.<br/>                                                                                                                                                                        |
| [**StrokesDeleting**](inkpicture-strokesdeleting.md)                              | Occurs before [**IInkStrokeDisp**](/windows/desktop/api/msinkaut/nn-msinkaut-iinkstrokedisp) objects are deleted from the [**Ink**](/windows/desktop/api/msinkaut/) property.<br/>                                                                                                                                                                             |
...
<tbody>
<tr class="odd">
<td>[<strong>AutoRedraw Property</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets a value that specifies whether the InkPicture control repaints when the window is invalidated (whether the [<strong>InkDisp</strong>](/windows/desktop/api/msinkaut/) object currently associated with InkPicture control is automatically redrawn when the window associated with the InkPicture receives a WM_PAINT message).<br/></td>
</tr>
<tr class="even">
<td>[<strong>BackColor</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="odd">
<td>[<strong>CollectingInk Property</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets the value that specifies whether the InkPicture control is collecting ink (run time only).<br/></td>
</tr>
<tr class="even">
<td>[<strong>CollectionMode</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="odd">
<td>[<strong>DefaultDrawingAttributes Property</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="even">
<td>[<strong>DesiredPacketDescription Property</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the packet description of the InkPicture control (run time only).<br/></td>
</tr>
<tr class="odd">
<td>[<strong>DynamicRendering Property</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="even">
<td>[<strong>EditingMode</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="odd">
<td>[<strong>Enabled</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets a value that determines whether the InkPicture control can respond to user-generated events.<br/>
<blockquote>
[!Note]<br />
This property is equivalent to the [<strong>InkEnabled</strong>](/windows/desktop/api/msinkaut/) property.
</blockquote>
<br/></td>
</tr>
<tr class="even">
<td>[<strong>EraserMode</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the value that specifies whether ink is erased by stroke or by point.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>EraserWidth</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the value that specifies the width of the eraser pen tip.<br/></td>
</tr>
<tr class="even">
<td>[<strong>hWnd</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets the window handle to which the InkPicture control is bound. (run time only)<br/></td>
</tr>
<tr class="odd">
<td>[<strong>Ink</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the [<strong>InkDisp</strong>](/windows/desktop/api/msinkaut/) object that is associated with the InkPicture control (run time only).<br/></td>
</tr>
<tr class="even">
<td>[<strong>InkEnabled</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="odd">
<td>[<strong>MarginX Property</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the x-axis margin around the window rectangle in screen coordinates.<br/></td>
</tr>
<tr class="even">
<td>[<strong>MarginY Property</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the y-axis margin around the window rectangle in screen coordinates.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>MouseIcon Property</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the current custom mouse icon.<br/></td>
</tr>
<tr class="even">
<td>[<strong>MousePointer Property</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="odd">
<td>[<strong>Picture</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets the graphics file to appear on the InkPicture control.<br/></td>
</tr>
<tr class="even">
<td>[<strong>Renderer Property</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets the [<strong>InkRenderer</strong>](/windows/desktop/api/msinkaut/) object that is used to draw ink on the InkPicture control (run time only).<br/></td>
</tr>
<tr class="odd">
<td>[<strong>Selection</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets the [InkStrokes](/windows/desktop/api/msinkaut/) collection currently selected inside the InkPicture control (run time only).<br/></td>
</tr>
<tr class="even">
<td>[<strong>SizeMode</strong>](/windows/desktop/api/msinkaut/)</td>
<td>Gets or sets how the control handles image placement and sizing.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>SupportHighContrastInk Property</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="even">
<td>[<strong>SupportHighContrastSelectionUI</strong>](/windows/desktop/api/msinkaut/)</td>
...
<tr class="odd">
<td>[<strong>Tablet Property</strong>](/windows/desktop/api/msinkaut/)</td>
...
Persisted [**InkDisp**](/windows/desktop/api/msinkaut/) objects can be loaded and displayed on all editions of Windows Vista and XP and on systems that have only the Windows XP Tablet PC Edition Software Development Kit (SDK) installed. **InkDisp** objects can only be converted to text (recognized), if Windows Vista or the Windows XP Tablet PC Edition 2005 is installed.
