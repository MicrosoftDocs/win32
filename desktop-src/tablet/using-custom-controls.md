...
-   Ensure that [**WM\_GETTEXT**](https://msdn.microsoft.com/windows/desktop/117c3d6d-24cd-462f-bdb0-b65d8914273a) is supported.
-   Ensure that all class-specific messages are supported. It is especially important to support text-retrieval messages such as [**CB\_GETLBTEXT**](https://msdn.microsoft.com/windows/desktop/f84e302a-65bb-45c8-958b-1cb438fb5a7a) and [**LB\_GETTEXT**](https://msdn.microsoft.com/windows/desktop/6bf7ec3b-237b-4668-9493-40c098a32428). Set the appropriate style bits, such as **CBS\_HASSTRINGS** and **LBS\_HASSTRINGS**, to indicate the control supports those messages.
