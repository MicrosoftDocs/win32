...
title: IInkAnalyzerAbort method
ms.date: 05/31/2018
ms.topic: article
...
Call [**IUnknown::Release**](https://msdn.microsoft.com/library/windows/desktop/ms682317) on *ppAbortedRegion* when you no longer need to use the object.
