...
Bluetooth uses the [**WSALookupServiceBegin**](https://msdn.microsoft.com/library/windows/desktop/ms741633) function to query for devices and to discover services.

The following topics describe the use of the [**WSALookupServiceBegin**](https://msdn.microsoft.com/library/windows/desktop/ms741633) function in each of these operations:
