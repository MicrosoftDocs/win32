...
The IP\_PKTINFO socket option allows an application to enable or disable the return of packet information by the [**WSARecvMsg**](/windows/win32/Mswsock/nc-mswsock-lpfn_wsarecvmsg?branch=master) function on an IPv4 socket..
...
The [**getsockopt**](/windows/win32/winsock/nf-winsock-getsockopt?branch=master) function called with the IP\_PKTINFO socket option allows an application to determine if packet information is to be returned by the [**WSARecvMsg**](/windows/win32/Mswsock/nc-mswsock-lpfn_wsarecvmsg?branch=master)function for an IPv4 socket.

The [**setsockopt**](/windows/win32/winsock/nf-winsock-setsockopt?branch=master) function called with the IP\_PKTINFO socket option allows an application to enable or disable the return of packet information by the [**WSARecvMsg**](/windows/win32/Mswsock/nc-mswsock-lpfn_wsarecvmsg?branch=master) function. The IP\_PKTINFO option for a socket is disabled (set to **FALSE**) by default.
