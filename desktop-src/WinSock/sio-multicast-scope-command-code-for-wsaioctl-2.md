...
The function [**WSAJoinLeaf**](/windows/win32/Winsock2/nf-winsock2-wsajoinleaf?branch=master) is used to join a leaf node into the multipoint session. See the following for a discussion on how this function is utilized.
