...
| [Provider-Specific Extension Mechanism](provider-specific-extension-mechanism-2.md)                               | The [**WSAIoctl**](/windows/win32/Winsock2/nf-winsock2-wsaioctl?branch=master) function enables service providers to offer provider-specific feature extensions.                                                                                                                                                                           |
| [Shared Sockets](shared-sockets-2.md)                                                                             | The [**WSADuplicateSocket**](/windows/win32/Winsock2/nf-winsock2-wsaduplicatesocketa?branch=master) function is introduced to enable socket sharing across processes.                                                                                                                                                                       |
