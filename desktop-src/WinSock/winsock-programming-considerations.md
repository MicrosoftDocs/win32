...
| [Provider-Specific Extension Mechanism](provider-specific-extension-mechanism-2.md)                               | The [**WSAIoctl**](wsaioctl-2.md) function enables service providers to offer provider-specific feature extensions.                                                                                                                                                                           |
| [Shared Sockets](shared-sockets-2.md)                                                                             | The [**WSADuplicateSocket**](wsaduplicatesocket-2.md) function is introduced to enable socket sharing across processes.                                                                                                                                                                       |
