...
| <dl> <dt>**[WSAEINVAL](https://www.bing.com/search?q=WSAEINVAL)**</dt> </dl>                 | The *level* parameter is unknown or invalid. On Windows Vista and later, this error is also returned if the socket was in a transitional state.<br/>                                                                                                 |
| <dl> <dt>**[WSAENOPROTOOPT](https://www.bing.com/search?q=WSAENOPROTOOPT)**</dt> </dl>       | The option is unknown or unsupported by the indicated protocol family. This error is returned if the socket descriptor passed in the *s* parameter was for a datagram socket.<br/>                                                                   |
