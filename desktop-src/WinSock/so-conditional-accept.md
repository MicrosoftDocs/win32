...
| <dl> <dt>**[WSAEINVAL](https://www.bing.com/search?q=WSAEINVAL)**</dt> </dl>                 | The *level* parameter is unknown or invalid. This error is also returned if the socket was already in a listening state.<br/>                                                                                                                        |
