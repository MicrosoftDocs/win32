...
The IPV6\_PKTINFO socket option allows an application to enable or disable the return of packet information by the [**WSARecvMsg**](/windows/desktop/api/Mswsock/nc-mswsock-lpfn_wsarecvmsg) function on an IPv6 socket..
...
The [**getsockopt**](/windows/desktop/api/winsock/nf-winsock-getsockopt) function called with the IPV6\_PKTINFO socket option allows an application to determine if packet information is to be returned by the [**WSARecvMsg**](/windows/desktop/api/Mswsock/nc-mswsock-lpfn_wsarecvmsg)function for an IPv6 socket.

The [**setsockopt**](/windows/desktop/api/winsock/nf-winsock-setsockopt) function called with the IPV6\_PKTINFO socket option allows an application to enable or disable the return of packet information by the [**WSARecvMsg**](/windows/desktop/api/Mswsock/nc-mswsock-lpfn_wsarecvmsg) function. The IPV6\_PKTINFO option for a socket is disabled (set to **FALSE**) by default.
