...
The Quality of Service (QoS) implementation details are provided in a separate, dedicated QoS section in the Microsoft Windows Software Development Kit (SDK). Please see the [Quality of Service](https://msdn.microsoft.com/library/Aa374094(v=VS.80).aspx) section of the Windows SDK for information on QoS updates.
