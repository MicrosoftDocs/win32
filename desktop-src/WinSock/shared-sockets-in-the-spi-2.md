...
|-----------------------------------------------------------------------------------------------------------------------------------------|--------|-------------------------------------------------------------------------------|
| 1) [**WSPSocket**](/windows/desktop/api/Ws2spi/nc-ws2spi-lpwspsocket), [**WSPConnect**](https://msdn.microsoft.com/library/ms742272(v=VS.85).aspx)                                                                 |        |                                                                               |
| 2) Requests target process identifier.                                                                                                  | ==> |                                                                               |
|                                                                                                                                         |        | 3) Receives process identifier request and responds.                          |
| 4) Receives process identifier.                                                                                                         | <== |                                                                               |
| 5) Calls [**WSPDuplicateSocket**](https://msdn.microsoft.com/library/ms742274(v=VS.85).aspx) to get a special [**WSAPROTOCOL\_INFO**](https://msdn.microsoft.com/library/ms741675(v=VS.85).aspx) structure. |        |                                                                               |
| 6) Sends **WSAPROTOCOL\_INFO** structure to target.                                                                                     |        |                                                                               |
|                                                                                                                                         | ==> | 7) Receives [**WSAPROTOCOL\_INFO**](https://msdn.microsoft.com/library/ms741675(v=VS.85).aspx) structure.        |
...
| 10) [**WSPClosesocket**](https://msdn.microsoft.com/library/ms742271(v=VS.85).aspx)                                                                                          | <== |                                                                               |
