...
-   If the function has completed, or if [**WSPCancelBlockingCall**](/windows/win32/Ws2spi/?branch=master) has been invoked, the loop is terminated and the blocking function completes with an appropriate result.
