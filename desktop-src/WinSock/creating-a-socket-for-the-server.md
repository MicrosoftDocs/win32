...
1.  The [**getaddrinfo**](/windows/desktop/api/Ws2tcpip/nf-ws2tcpip-getaddrinfo) function is used to determine the values in the [**sockaddr**](sockaddr-2.md) structure:
    ...
    The [**addrinfo**](/windows/desktop/api/Ws2tcpip/nc-ws2tcpip-lpfn_freeaddrinfo) structure is used by the [**getaddrinfo**](/windows/desktop/api/Ws2tcpip/nf-ws2tcpip-getaddrinfo) function.
