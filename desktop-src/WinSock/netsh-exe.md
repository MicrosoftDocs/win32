...
Documentation on all of the **netsh** commands for IPv6 is also available online on Technet. For more information on **netsh** on Windows Server 2008, please see [Netsh commands for Interface (IPv4 and IPv6)](http://go.microsoft.com/fwlink/p/?linkid=189051). For more information on **netsh** on Windows Server 2003, please see [Netsh commands for Interface IPv6](http://go.microsoft.com/fwlink/p/?linkid=95439).
...
Documentation on all of the Netsh commands for IPv4 is also available online on Technet. For more information, please see [Netsh commands for Interface IP](http://go.microsoft.com/fwlink/p/?linkid=107335)
