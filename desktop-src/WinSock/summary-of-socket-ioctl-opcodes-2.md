...
| [**SIO\_ADDRESS\_LIST\_QUERY**](https://msdn.microsoft.com/en-us/library/Dd877219(v=VS.85).aspx) | <Not used>                         | [**SOCKET\_ADDRESS**](/windows/desktop/api/Ws2def/ns-ws2def-_socket_address) | Obtains a list of local transport addresses of the socket's protocol family to which the application can bind. The list of addresses varies based on address family and some addresses are excluded from the list. |
