...
-   Whenever possible, use existing Winsock and IP Helper functions when using IPv6 addresses rather than re-implementing this logic. For example, the [**RtlIpv6AddressToString**](iphlp.rtlipv6addresstostring), [**RtlIpv6AddressToStringEx**](iphlp.rtlipv6addresstostringex), [**RtlIpv6StringToAddress**](iphlp.rtlipv6stringtoaddress), and [**RtlIpv6StringToAddressEx**](iphlp.rtlipv6stringtoaddressex) functions can be used to convert between IPv6 addresses and string representations of these IPv6 addresses.
