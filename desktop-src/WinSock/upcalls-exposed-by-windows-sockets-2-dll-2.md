...
| [**WPUQueueApc**](/windows/desktop/api/Ws2spi/nf-ws2spi-wpuqueueapc)                                   | Queues a user-mode APC to the specified thread.                                                                          | Optional.                      | The [**QueueUserApc**](https://msdn.microsoft.com/library/ms684954(v=VS.85).aspx) may also be used.                                                                                                                      |
