...
| [**WPUPostMessage**](/windows/desktop/api/Ws2spi/nf-ws2spi-wpupostmessage)                             | Performs the standard [**PostMessage**](https://www.bing.com/search?q=**PostMessage**) function in a way that maintains backward compatibility. | Required.                      | Windows 2000 and Windows NT only. Windows 95 allows post message from kernel mode.                                                                                               |
...
| [**WPUQueueApc**](/windows/desktop/api/Ws2spi/nf-ws2spi-wpuqueueapc)                                   | Queues a user-mode APC to the specified thread.                                                                          | Optional.                      | The [**QueueUserApc**](https://msdn.microsoft.com/windows/desktop/5b141372-7c95-4eb2-987b-64fdf7d0783d) may also be used.                                                                                                                      |
