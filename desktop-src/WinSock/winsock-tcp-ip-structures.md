...
|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| [**INTERFACE\_INFO**](interface-info-2.md)      | Used with the ioctl command to obtain information about an interface IP address.                                                         |
| [**INTERFACE\_INFO\_EX**](interface-info-ex.md) | Used with the **SIO\_GET\_INTERFACE\_LIST IOCTL** command to obtain information about an interface IP address, including IPv6 addresses. |
| [**sockaddr\_gen**](sockaddr-gen.md)            | Provides generic socket address information. Used with the [**INTERFACE\_INFO**](interface-info-2.md) structure.                        |
