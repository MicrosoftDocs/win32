...
Three attribute parameters are defined in the [**WSAPROTOCOL\_INFO**](wsaprotocol-info-2.md) structure in order to distinguish the different schemes used in the control and data planes, respectively:
...
Two [**WSAPROTOCOL\_INFO**](wsaprotocol-info-2.md) entries would be present if a multipoint protocol supported both rooted and nonrooted data planes, one entry for each.
