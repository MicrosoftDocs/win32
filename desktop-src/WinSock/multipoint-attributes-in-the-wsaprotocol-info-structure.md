...
Three attribute parameters are defined in the [**WSAPROTOCOL\_INFO**](/windows/desktop/api/Winsock2/) structure in order to distinguish the different schemes used in the control and data planes, respectively:
...
Two [**WSAPROTOCOL\_INFO**](/windows/desktop/api/Winsock2/) entries would be present if a multipoint protocol supported both rooted and nonrooted data planes, one entry for each.
