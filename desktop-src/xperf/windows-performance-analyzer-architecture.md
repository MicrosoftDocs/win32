...
keywords: ["Windows Performance Analyzer, architecture", "Windows Performance Analyzer, kernel trace control", "Windows Performance Analyzer, trace profiles", "Windows Performance Analyzer, xperf.exe", "Windows Performance Analyzer, xperfview.exe", "Windows Performance Analyzer, xbootmgr.exe", "kernel trace control"]
---
