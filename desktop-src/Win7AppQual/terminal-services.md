...
**Windows Server 2008 R2 with the [Remote Desktop Services](https://msdn.microsoft.com/windows/desktop/90c40b7a-e324-43fc-a1e6-f29997ed9436) role enabled:** Not supported. A multiple package installation using the [MsiEmbeddedChainer table](https://msdn.microsoft.com/windows/desktop/ac1e9c7b-bb83-4e1e-9108-211374c7d878) fails if the [Remote Desktop Services](https://msdn.microsoft.com/windows/desktop/90c40b7a-e324-43fc-a1e6-f29997ed9436) role is enabled.

## Links to Other Resources

-   [Terminal Services Programming Guidelines](https://msdn.microsoft.com/windows/desktop/e0cd52c5-40d7-4a48-9d10-fdbcea46a5a0)
