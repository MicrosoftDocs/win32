...
To download the Fiddler add-on, go to the [Internet Explorer add-ons](http://go.microsoft.com/fwlink/p/?linkid=205045) page. For more information about how to troubleshoot by using Fiddler and related tools, see the [How to use fiddler and HTTP replay to have an offline copy of your site](http://go.microsoft.com/fwlink/p/?linkid=205046) blog post and the [Troubleshooting Authentication with Fiddler](http://go.microsoft.com/fwlink/p/?linkid=205048) blog post.
