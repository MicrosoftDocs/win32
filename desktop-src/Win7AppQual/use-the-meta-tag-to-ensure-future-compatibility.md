...
For more information about compatibility and the X-UA-Compatible header, see [Defining Document Compatibility](https://www.bing.com/search?q=Defining Document Compatibility) in the MSDN Library.
