...
-   [**QueryActCtxW Function**](setup.queryactctxw)
-   [UAC manifest](4cf5035b-eae8-42ea-9508-bb3974cef68b)
-   [Application manifests for Windows applications](setup.application_manifests)
-   [Desktop Window Manager (DWM)](dwm.dwm_overview)
