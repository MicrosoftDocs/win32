...
This section describes basic mitigation steps and how to plan for future application compatibility while you are addressing any issues now. The [Website Troubleshooting Guidance](https://code.msdn.microsoft.com/Project/Download/FileDownload.aspx?ProjectName=IE8&DownloadId=7167) white paper contains resources and information to help you isolate compatibility issues.
