...
-   An integrity mechanism restricts write access to [securable objects](https://msdn.microsoft.com/32f2ec06-822f-4d1e-bf51-5ae1d7355e60) by lower-integrity processes, in the same way that user account group membership restricts the rights of users to access sensitive system components.
