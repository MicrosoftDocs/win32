...
-   [Internationalization for Windows Applications](intl.international_support)
-   [GetNLSVersionEx Function](intl.getnlsversionex)
-   [GetNLSVersion Function](intl.getnlsversion)
