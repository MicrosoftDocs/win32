...
| [Internet Explorer Compatibility Test Tool (IECTT)](inernet-explorer-compatibility-test-tool--iectt-.md)                  | A component of the [Microsoft Application Compatibility Toolkit](https://go.microsoft.com/fwlink/p/?LinkId=526740) that can help you diagnose issues in your web applications.       |
