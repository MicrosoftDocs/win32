...
-   [Asynchronous I/O](https://msdn.microsoft.com/en-us/library/Aa365683(v=VS.85).aspx)
-   [**AttachThreadInput Function**](https://msdn.microsoft.com/en-us/library/ms681956(v=VS.85).aspx)
-   [**auto\_ptr Class**](https://msdn.microsoft.com/en-us/library/ew3fk483(v=VS.71).aspx)
-   [**DisableProcessWindowsGhosting Function**](https://msdn.microsoft.com/en-us/library/ms648415(v=VS.85).aspx)
-   [**DllMain Callback Function**](https://msdn.microsoft.com/en-us/library/ms682583(v=VS.85).aspx)
-   [Events](https://msdn.microsoft.com/en-US/library/wewwczdw(v=VS.80).aspx)
-   [**GetMessage Function**](https://msdn.microsoft.com/en-us/library/ms644936(v=VS.85).aspx)
-   [I/O cancellation](https://msdn.microsoft.com/en-us/library/Aa363789(v=VS.85).aspx)
-   [**IsHungAppWindow Function**](https://msdn.microsoft.com/en-us/library/ms633526(v=VS.85).aspx)
-   [Message Queue](https://msdn.microsoft.com/en-us/library/ms644928(v=VS.85).aspx)
-   [**MsgWaitForMultipleObjects Function**](https://msdn.microsoft.com/en-us/library/ms684242(v=VS.85).aspx)
-   [New Thread Pool API](https://msdn.microsoft.com/en-us/library/ms686766(v=VS.85).aspx)
-   [**PostMessage Function**](https://msdn.microsoft.com/en-us/library/ms644944(v=VS.85).aspx)
-   [Restart and Recovery](https://msdn.microsoft.com/en-us/library/Bb525423(v=VS.85).aspx)
-   [**SendMessageCallback Function**](https://msdn.microsoft.com/en-us/library/ms644951(v=VS.85).aspx)
-   [**SendNotifyMessage Function**](https://msdn.microsoft.com/en-us/library/ms644953(v=VS.85).aspx)
