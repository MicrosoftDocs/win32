...
-   [Windows Error Reporting](wer.windows_error_reporting)
-   [Asynchronous Design](c6baed9f-2a25-4728-9a9a-53b7b14840cf)
-   [Asynchronous I/O](fs.synchronous_and_asynchronous_i_o)
-   [**AttachThreadInput Function**](base.attachthreadinput)
-   [**auto\_ptr Class**](7f9108b6-9eb3-4634-b615-cf7aa814f23b)
-   [**DisableProcessWindowsGhosting Function**](winprog.disableprocesswindowsghosting)
-   [**DllMain Callback Function**](base.dllmain)
-   [Events](792aa8da-918b-458e-b154-9836b97735f3)
-   [**GetMessage Function**](winmsg.getmessage)
-   [I/O cancellation](fs.canceling_pending_i_o_operations)
-   [**IsHungAppWindow Function**](winmsg.ishungappwindow)
-   [Message Queue](winmsg.using_messages_and_message_queues)
-   [**MsgWaitForMultipleObjects Function**](base.msgwaitformultipleobjects)
-   [New Thread Pool API](base.thread_pool_api)
-   [**PostMessage Function**](winmsg.postmessage)
-   [Restart and Recovery](recovery.registering_for_application_restart)
-   [**SendMessageCallback Function**](winmsg.sendmessagecallback)
-   [**SendNotifyMessage Function**](winmsg.sendnotifymessage)
-   [Synchronization Objects](base.about_synchronization)
-   [**TerminateThread Function**](base.terminatethread)
-   [Windows Error Reporting](wer.windows_error_reporting)
