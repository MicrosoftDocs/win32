...
To allow a server to impersonate a client, the client calls the [**DdeSetQualityOfService**](/windows/desktop/api/Dde/nf-dde-ddesetqualityofservice) function. The [**SECURITY\_IMPERSONATION\_LEVEL**](a75ad777-c88e-4899-be50-0118c113a600) structure is used to control the level of impersonation the server may perform.
