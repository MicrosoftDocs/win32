...
The clipboard owner can use the [**ScrollWindow**](_win32_ScrollWindow) function to scroll the image in the clipboard viewer window and invalidate the appropriate region.
