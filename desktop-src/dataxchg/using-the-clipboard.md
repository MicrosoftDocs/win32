...
ms.topic: how-to
ms.date: 07/09/2025
# customer intent: As a Windows developer, I want to learn how to use the clipboard so that I can implement cut, copy, and paste functionality in my applications.
---
