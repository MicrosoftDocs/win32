...
keywords: ["WM_DESTROYCLIPBOARD message Data Exchange"]
topic_type:
- apiref
api_name:
- WM_DESTROYCLIPBOARD
...
Sent to the clipboard owner when a call to the [**EmptyClipboard**](emptyclipboard.md) function empties the clipboard.
