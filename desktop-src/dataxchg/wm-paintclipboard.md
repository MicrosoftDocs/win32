---
title: WM\_PAINTCLIPBOARD message
description: Sent to the clipboard owner by a clipboard viewer window when the clipboard contains data in the CF\_OWNERDISPLAY format and the clipboard viewers client area needs repainting.
