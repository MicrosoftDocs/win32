---
title: WM\_ASKCBFORMATNAME message
...
Sent to the clipboard owner by a clipboard viewer window to request the name of a [**CF\_OWNERDISPLAY**](https://www.bing.com/search?q=**CF\_OWNERDISPLAY**) clipboard format.
...
A clipboard viewer window sends this message to the clipboard owner to determine the name of the [**CF\_OWNERDISPLAY**](https://www.bing.com/search?q=**CF\_OWNERDISPLAY**) format   for example, to initialize a menu listing available formats.
