...
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [COM Programming](_com_The_Component_Object_Model)                                                    | As a COM-based API set, the Packaging API relies on you to perform tasks such as error handling, resource management, and synchronization. For an introduction to COM programming, see [COM Programming](_com_The_Component_Object_Model).<br/>                                                                                                                                                                                                                                  |
...
| Technology                                                                          | Description                                                                                                                                                                                                                                                                                                                                                |
|-------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [System.IO.Packaging](N:System.IO.Packaging)                                        | The managed Packaging API implementation. For a summary of key differences between this and the managed API, see [Differences between the Native and Managed APIs](differences-between-the-native-and-managed-apis.md). For in-depth information about the managed implementation, see [System.IO.Packaging](N:System.IO.Packaging).<br/>           |
