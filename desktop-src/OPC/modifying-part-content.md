...
3.  Retrieve and change the content as needed for the application:
    ...
    If the part content is not XML markup, retrieve the part content stream by calling the [**IOpcPart::GetContentStream**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcpart-getcontentstream) method and change the data as needed for the application.
