...
![illustration showing a generic filing cabinet](https://www.bing.com/search?q=illustration showing a generic filing cabinet)
...
![illustration showing a generic directed graph with 5 circles: 1 points to 3, 2 points to 1 and 4, 3 points to 1 and 4, and 4 and 5 point to nothing](https://www.bing.com/search?q=illustration showing a generic directed graph with 5 circles: 1 points to 3, 2 points to 1 and 4, 3 points to 1 and 4, and 4 and 5 point to nothing)
...
![screen shot showing an xps file that was opened for browsing, with a folders view in the left pane, and three folders and two files in the right pane](https://www.bing.com/search?q=screen shot showing an xps file that was opened for browsing, with a folders view in the left pane, and three folders and two files in the right pane)
...
![illustration showing a generic, empty file-folder](https://www.bing.com/search?q=illustration showing a generic, empty file-folder)
...
![illustration showing a generic file-folder that contains information in the form of paperwork](https://www.bing.com/search?q=illustration showing a generic file-folder that contains information in the form of paperwork)
