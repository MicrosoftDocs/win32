...
Windows 7 enables the use of digital signature Packaging APIs by providing an object that implements the [**IOpcDigitalSignatureManager**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcdigitalsignaturemanager) interface. An instance of this object can be created by calling the [**IOpcFactory::CreateDigitalSignatureManager**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcfactory-createdigitalsignaturemanager) method of a Packaging factory. For information about how to create a factory for use with the Packaging APIs, see the [Getting Started with the Packaging API](packaging-api-overview.md).
...
|-------------------------------------------|--------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| package signature                         | [**IOpcDigitalSignature**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcdigitalsignature) interface                             | A signature that is created for a package and composed of representations of the other signature concepts.<br/>              |
| reference to a part                       | [**IOpcSignaturePartReference**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturepartreference) interface                 | A reference to a part that has been signed. <br/>                                                                            |
| reference to relationships                | [**IOpcSignatureRelationshipReference**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturerelationshipreference) interface | A reference to one or more relationships that have been signed and that are all stored in the same Relationships part. <br/> |
| reference to data in the signature markup | [**IOpcSignatureReference**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturereference) interface                         | A reference to application data in the signature markup that has been signed. <br/>                                          |
| object that contains application data     | [**IOpcSignatureCustomObject**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturecustomobject) interface                   | An application-specific object that contains application data in the signature markup that may have been signed.<br/>        |
...
At any time before a signature is generated, the [**IOpcDigitalSignatureManager::SetSignatureOriginPartName**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-setsignatureoriginpartname) method can be used to set the part name of the Digital Signature Origin part. Although the Digital Signature Origin part does not contain signature markup, it serves as the starting point for locating all signatures in the package. If a part name is not set with this method, a name will be generated at signing time unless a Digital Signature Origin part already exists in the package that is being signed.

To generate a signature for signing a package, use the following procedure:

1.  Call [**IOpcDigitalSignatureManager::CreateSigningOptions**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-createsigningoptions) to get a pointer to an object that implements the [**IOpcSigningOptions**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsigningoptions) interface.
2.  Use the [**IOpcSigningOptions**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsigningoptions) interface methods to set necessary signature information.

    This must include, but is not exclusive to, calls to the following methods:

    -   [**IOpcSigningOptions::SetDefaultDigestMethod**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcsigningoptions-setdefaultdigestmethod), to set the default digest method
    -   [**IOpcSigningOptions::SetSignatureMethod**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcsigningoptions-setsignaturemethod), to set the signature method

3.  After all the signature information that is required has been set, call the [**IOpcDigitalSignatureManager::Sign**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-sign) method. Pass **Sign** a pointer to the [**IOpcSigningOptions**](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsigningoptions) interface of the object that contains the signature information.
...
<tbody>
<tr class="odd">
<td>[<strong>IOpcDigitalSignatureManager::Sign</strong>](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-sign) method</td>
<td>Signs the package by creating a signature, using a provided certificate and an [<strong>IOpcSigningOptions</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsigningoptions) interface. <br/></td>
</tr>
<tr class="even">
<td>[<strong>IOpcSigningOptions</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsigningoptions) interface</td>
<td>Used to set the signature options and properties that are needed to generate a package signature.<br/></td>
</tr>
<tr class="odd">
<td>Set interfaces<br/> <dl>[<strong>IOpcCertificateSet</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopccertificateset)<br />
[<strong>IOpcRelationshipSelectorSet</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationshipselectorset)<br />
[<strong>IOpcSignatureCustomObjectSet</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturecustomobjectset)<br />
[<strong>IOpcSignaturePartReferenceSet</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturepartreferenceset)<br />
[<strong>IOpcSignatureReferenceSet</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturereferenceset)<br />
[<strong>IOpcSignatureRelationshipReferenceSet</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturerelationshipreferenceset)<br />
</dl></td>
<td>These sets of Packaging signature interface pointers provide methods for the creation and deletion of the Packaging digital signature objects that are used to generate a signature. These interfaces are accessed through the [<strong>IOpcSigningOptions</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsigningoptions) interface.<br/></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td>[<strong>IOpcDigitalSignatureManager::GetSignatureEnumerator</strong>](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-getsignatureenumerator) method</td>
<td>Gets an enumerator of [<strong>IOpcDigitalSignature</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcdigitalsignature) interfaces, which represent the signatures of the package. <br/></td>
</tr>
<tr class="even">
<td>[<strong>IOpcDigitalSignatureManager::GetSignatureOriginPartName</strong>](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-getsignatureoriginpartname) method</td>
<td>Gets an [<strong>IOpcPartUri</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcparturi) interface that represents the part name of the Digital Signature Origin part.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>IOpcDigitalSignatureManager::RemoveSignature</strong>](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-removesignature) method</td>
<td>Removes a specified part from the package. This part stores signature markup.<br/></td>
</tr>
<tr class="even">
<td>[<strong>IOpcDigitalSignatureManager::ReplaceSignature</strong>](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-replacesignaturexml) method</td>
<td>Replaces the existing signature markup that is stored in a specified part.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>IOpcDigitalSignature</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcdigitalsignature) interface</td>
<td>Represents a digital signature of a package.<br/></td>
</tr>
<tr class="even">
<td>Enumerator interfaces<br/> <dl>[<strong>IOpcCertificateEnumerator</strong>](/previous-versions/windows/desktop/api/msopc/nn-msopc-iopccertificateenumerator)<br />
...
To validate a signature using the Packaging APIs, call the [**IOpcDigitalSignatureManager::Validate**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-validate) method.
...
|---------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
| [**IOpcDigitalSignatureManager::Validate**](/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignaturemanager-validate) | Validates a package signature by using a specified certificate.<br/> |
