...
> [!Note]  
> To run the sample successfully, at least one X.509 certificate must be present. If an X.509 certificate is not present, the [Certificate Creation Tool](https://msdn.microsoft.com/windows/desktop/b0343f8e-9c41-4852-a85c-f8a0c408cf0d) (Makecert.exe) can be used to generate a certificate for testing purposes.
