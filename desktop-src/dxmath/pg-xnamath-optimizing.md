...
-   Use the Colors namespace [constants](ovw-xnamath-reference-constants.md) directly in the *ColorRGBA* parameter in a call to the [**ID3D11DeviceContext::ClearRenderTargetView**](https://msdn.microsoft.com/bbc6d3fb-b64f-47b0-9feb-a248dce0bf4b) or [**ID3D10Device::ClearRenderTargetView**](https://msdn.microsoft.com/VS|directx_sdk|~\id3d10device_clearrendertargetview.htm) method. For Direct3D 9, you must convert to the [**XMCOLOR**](/windows/desktop/api/DirectXPackedVector/ns-directxpackedvector-xmcolor) type to use it as the *Color* parameter in a call to the [**IDirect3DDevice9::Clear**](https://msdn.microsoft.com/VS|directx_sdk|~\idirect3ddevice9__clear.htm) method.
-   Use the [**XMFLOAT4**](/windows/desktop/api/DirectXMath/)/[**XMVECTOR**](xmvector-data-type.md) and [**XMFLOAT4X4**](/windows/desktop/api/DirectXMath/)/[**XMMATRIX**](/windows/desktop/api/DirectXMath/) types to setup constant buffer structures for reference by HLSL [**float4**](https://msdn.microsoft.com/VS|directx_sdk|~\dx_graphics_hlsl_scalar.htm) or [**matrix**](https://msdn.microsoft.com/VS|directx_sdk|~\dx_graphics_hlsl_matrix.htm)/float4x4 types.
    > [!Note]  
    > [**XMFLOAT4X4**](/windows/desktop/api/DirectXMath/)/[**XMMATRIX**](/windows/desktop/api/DirectXMath/) types are in row-major format. Therefore, if you use the /Zpr compiler switch (the [**D3DCOMPILE\_PACK\_MATRIX\_COLUMN\_MAJOR**](https://msdn.microsoft.com/039627DD-D6A4-4EA3-8E91-D2A20770E6FF) compile flag) or omit the row\_major [keyword](https://msdn.microsoft.com/VS|directx_sdk|~\dx_graphics_hlsl_appendix_keywords.htm) when you declare the matrix type in HLSL, you must transpose the matrix when you set it into the constant buffer.

     

-   With Direct3D 10.x and Direct3D 11.x, you can assume that the pointer returned by the Map method (for example, [**ID3D11DeviceContext::Map**](https://msdn.microsoft.com/c9d57873-1faa-42fa-855c-26f565e3b27c)) in the **pData** member ([**D3D10\_MAPPED\_TEXTURE2D**](https://msdn.microsoft.com/VS|directx_sdk|~\d3d10_mapped_texture2d.htm).**pData**, [**D3D10\_MAPPED\_TEXTURE3D**](https://msdn.microsoft.com/VS|directx_sdk|~\d3d10_mapped_texture3d.htm).**pData**, or [**D3D11\_MAPPED\_SUBRESOURCE**](https://msdn.microsoft.com/cbbb8689-0a7d-43b9-bde3-29d93cc7f0fe).**pData**) is 16-byte aligned if you use [feature level](https://msdn.microsoft.com/5ad0525c-249f-452d-950b-df8fa2addde2) 10\_0 or higher or whenever you use [**D3D11\_USAGE\_STAGING**](https://msdn.microsoft.com/251d462e-964e-42db-8554-dba8f5a9b1ef) resources.
