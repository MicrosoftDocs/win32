...
[**XMSHORTN4**](/windows/win32/DirectXPackedVector/ns-directxpackedvector-xmshortn4?branch=master) describes 4D vector for storing signed, normalized values as signed 16-bit integers, (type `int16_t`).
