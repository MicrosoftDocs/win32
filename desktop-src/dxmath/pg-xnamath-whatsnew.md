...
-   3.06 adds [**XMLoadUDecN4\_XR**](https://msdn.microsoft.com/en-us/library/Dn322045(v=VS.85).aspx) and [**XMStoreUDecN4\_XR**](https://msdn.microsoft.com/en-us/library/Dn322046(v=VS.85).aspx) to match the DXGI\_FORMAT\_R10G10B10\_XR\_BIAS\_A2\_UNORM definition.
