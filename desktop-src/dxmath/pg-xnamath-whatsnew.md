...
-   The [**XMMATRIX**](xmmatrix.md) type is fully opaque. To access individual elements of **XMMATRIX**, use other types such as [**XMFLOAT4X4**](xmfloat4x4.md).
...
-   3.06 fixes load/store of [**XMFLOAT3SE**](xmfloat3se.md) to properly match the DXGI\_FORMAT\_R9G9B9E5\_SHAREDEXP definition.
-   3.06 adds [**XMLoadUDecN4\_XR**](-xmloadudecn4-xr.md) and [**XMStoreUDecN4\_XR**](-xmstoreudecn4-xr.md) to match the DXGI\_FORMAT\_R10G10B10\_XR\_BIAS\_A2\_UNORM definition.
-   3.06 adds [**XMColorRGBToSRGB**](-xmcolorrgbtosrgb.md) and [**XMColorSRGBToRGB**](-xmcolorsrgbtorgb.md) to convert between linear RGB and sRGB.
-   3.06 adds [**XMVectorExp2**](xmvectorexp2.md), [**XMVectorLog2**](xmvectorlog2.md), [**XMVectorExpE**](xmvectorexpe.md), and [**XMVectorLogE**](xmvectorloge.md) functions to provide base-e support in addition to the existing base-2 support.
    -   [**XMVectorExp**](xmvectorexp.md) and [**XMVectorLog**](xmvectorlog.md) are now aliases for [**XMVectorExp2**](xmvectorexp2.md) and [**XMVectorLog2**](xmvectorlog2.md) respectively.
...
-   3.06 updates the matrix version of the **Transform** method for [**BoundingOrientedBox**](boundingorientedbox.md) and [**BoundingFrustum**](boundingfrustum.md) to handle scaling.
