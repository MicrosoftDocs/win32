...
This function is a template version of [**XMVectorShiftLeft**](https://www.bing.com/search?q=**XMVectorShiftLeft**) where the *Elements* argument is a template value.
