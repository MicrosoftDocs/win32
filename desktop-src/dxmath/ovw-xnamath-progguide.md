...
| [What's New](pg-xnamath-whatsnew.md)<br/>                  | The DirectXMath library is based on the [XNA Math C++ SIMD library version 2.04](https://blogs.msdn.microsoft.com/chuckw/2011/02/22/xna-math-version-2-04/). Here we describe how DirectXMath differs from XNA Math and how DirectXMath versions differ. <br/> |
