...
<tbody>
<tr class="odd">
<td style="text-align: left;">[<strong>XMVECTOR::operator *= (XMVECTOR&amp;,float)</strong>](xmvector-operator-muleq-1.md)</td>
...
<tr class="even">
<td style="text-align: left;">[<strong>XMVECTOR::operator *= (XMVECTOR&amp;,XMVECTOR)</strong>](xmvector-operator-muleq-2.md)</td>
