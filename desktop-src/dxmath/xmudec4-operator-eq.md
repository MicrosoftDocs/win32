...
<tbody>
<tr class="odd">
<td style="text-align: left;"><a href="https://msdn.microsoft.com/en-us/library/Ee420519(v=VS.85).aspx"><strong>XMUDEC4::operator = (const XMUDEC4&)</strong></a></td>
<td style="text-align: left;">Assigns the vector component data from one instance of <code>XMUDEC4</code> to the current instance of <code>XMUDEC4</code>. <br/> This operator assigns the vector component data from one instance of <a href="https://msdn.microsoft.com/en-us/library/Ee420508(v=VS.85).aspx"><strong>XMUDEC4</strong></a> to the current instance of <code>XMUDEC4</code>. <br/>
<blockquote>
[!Note]<br />
...
<tr class="even">
<td style="text-align: left;"><a href="https://msdn.microsoft.com/en-us/library/Hh404740(v=VS.85).aspx"><strong>XMUDEC4::operator = (const uint32_t)</strong></a></td>
<td style="text-align: left;">Assigns the vector component data packed in an instance of <code>uint32_t</code> to the current instance of <code>XMUDEC4</code>. <br/> This operator assigns the vector component data packed in an instance of <code>uint32_t</code> to the current instance of <a href="https://msdn.microsoft.com/en-us/library/Ee420508(v=VS.85).aspx"><strong>XMUDEC4</strong></a>. <br/>
<blockquote>
[!Note]<br />
This operator is only available under C++.
</blockquote>
