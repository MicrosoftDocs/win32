...
<blockquote>
[!Note]<br />
[<strong>D3DXQUATERNION::operator *</strong>](https://msdn.microsoft.com/VS|directx_sdk|~\d3dxquaternion_extensions.htm) calls the [<strong>D3DXQuaternionMultiply</strong>](https://msdn.microsoft.com/VS|directx_sdk|~\d3dxquaternionmultiply.htm) function, which multiplies two quaternions. But, unless you explicitly use the [<strong>XMQuaternionMultiply</strong>](/windows/desktop/api/DirectXMath/) function, you get an incorrect answer when you use [<strong>XMVECTOR::operator *</strong>](xmvector-operator-mul.md) on a quaternion.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
