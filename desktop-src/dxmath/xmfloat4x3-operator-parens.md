...
Accesses specific matrix elements referenced by row and column from the current instance of [**XMFLOAT4X3**](/windows/desktop/api/DirectXMath/)
...
<tbody>
<tr class="odd">
<td style="text-align: left;">[<strong>XMFLOAT4X3::operator () (size_t,size_t)</strong>](https://www.bing.com/search?q=<strong>XMFLOAT4X3::operator+()+(size_t,size_t)</strong>)</td>
<td style="text-align: left;">Returns a <code>reference</code> to a matrix element of an instance <code>XMFLOAT4X3</code> as specified by row and column arguments.<br/> This operator returns a <code>reference</code> to a matrix element of an instance [<strong>XMFLOAT4X3</strong>](/windows/desktop/api/DirectXMath/) as specified by row and column arguments.<br/>
<blockquote>
[!Note]<br />
