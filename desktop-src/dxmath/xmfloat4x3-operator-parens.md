...
Accesses specific matrix elements referenced by row and column from the current instance of [**XMFLOAT4X3**](/windows/win32/DirectXMath/?branch=master)
...
<tr class="even">
<td style="text-align: left;">[<strong>XMFLOAT4X3::operator () (size_t,size_t)</strong>](xmfloat4x3-operator-parens-2.md)</td>
<td style="text-align: left;">Return the value of a matrix element in an instance <code>XMFLOAT4X3</code> as specified by row and column arguments. <br/> This operator returns the value of a matrix element of an instance [<strong>XMFLOAT4X3</strong>](/windows/win32/DirectXMath/?branch=master) as specified by row and column arguments. <br/>
<blockquote>
[!Note]<br />
