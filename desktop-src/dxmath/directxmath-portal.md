...
For developers new to DirectXMath, you may want to consider using the SimpleMath wrapper in the [DirectX Tool Kit](http://go.microsoft.com/fwlink/?LinkId=248929) as a starting point.
