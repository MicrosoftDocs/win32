...
This function is a template version of [**XMVectorRotateLeft**](https://www.bing.com/search?q=**XMVectorRotateLeft**) where the *Elements* argument is a template value.
