...
<tbody>
<tr class="odd">
<td style="text-align: left;">[<strong>XMVECTOR::operator - (XMVECTOR)</strong>](xmvector-operator---2.md)</td>
...
<tr class="even">
<td style="text-align: left;">[<strong>XMVECTOR::operator - (XMVECTOR,XMVECTOR)</strong>](xmvector-operator---1.md)</td>
