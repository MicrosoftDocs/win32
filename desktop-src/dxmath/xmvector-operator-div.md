...
<tbody>
<tr class="odd">
<td style="text-align: left;">[<strong>XMVECTOR::operator / (XMVECTOR,float)</strong>](xmvector-operator-div-2.md)</td>
...
<tr class="even">
<td style="text-align: left;">[<strong>XMVECTOR::operator / (XMVECTOR,XMVECTOR)</strong>](xmvector-operator-div-1.md)</td>
