...
[**XMDECN4**](/windows/win32/DirectXPackedVector/ns-directxpackedvector-xmdecn4?branch=master) describes a 4D vector for storing signed, normalized values as 10 bit signed x-,y-, and z- components and a 2 bit signed w-component.
