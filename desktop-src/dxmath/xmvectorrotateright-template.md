...
This function is a template version of [**XMVectorRotateRight**](https://www.bing.com/search?q=**XMVectorRotateRight**) where the *Elements* argument is a template value.
