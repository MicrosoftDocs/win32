...
[**XMFLOAT3**](https://msdn.microsoft.com/library/Ee419475(v=VS.85).aspx) describes a structure containing a 3D vector consisting of three single-precision floating-point values.
...
| Topic                                                       | Description                                    |
|-------------------------------------------------------------|------------------------------------------------|
| [**XMFLOAT3 Constructors**](https://msdn.microsoft.com/library/Ee415292(v=VS.85).aspx)<br/>   | Constructors exposed by `XMFLOAT3`.<br/> |
