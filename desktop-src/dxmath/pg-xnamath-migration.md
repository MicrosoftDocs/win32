...
For DirectXMath, **XMVectorPermuteControl** has been eliminated and the XM\_PERMUTE\_0X .. XM\_PERMUTE\_1Z constants have been redefined to be simple 0-7 indices. Here is the new signature for [**XMVectorPermute**](xmvectorpermute.md):
...
Instead of a control word, this function directly takes the 4 indices as parameters, which also makes it analogous to the [**XMVectorSwizzle**](xmvectorswizzle.md) function using the new XM\_SWIZZLE\_X .. XM\_SWIZZLE\_W constants defined as simple 0-3 indices.
...
> [!Note]  
> For constant values, there is a much more efficient way to implement permute. Instead of using the function form of [**XMVectorPermute**](xmvectorpermute.md), use the **template** form:
>
...
> | XMVector3TransformStreamNC | [**XMVector3TransformStream**](xmvector3transformstream.md)                                                      |
> | XMVector4InBoundsR         | [**XMVector4InBounds**](xmvector4inbounds.md) ? [XM\_CRMASK\_CR6BOUNDS](ovw-xnamath-reference-constants.md) : 0 |
> | XMVectorCosHEst            | [**XMVectorCosH**](xmvectorcosh.md)                                                                              |
> | XMVectorExpEst             | [**XMVectorExp**](xmvectorexp.md)                                                                                |
> | XMVectorLogEst             | [**XMVectorLog**](xmvectorlog.md)                                                                                |
> | XMVectorPowEst             | [**XMVectorPow**](xmvectorpow.md)                                                                                |
> | XMVectorSinHEst            | [**XMVectorSinH**](xmvectorsinh.md)                                                                              |
> | XMVectorTanHEst            | [**XMVectorTanH**](xmvectortanh.md)                                                                              |
>
> 
>
>  
