...
<tbody>
<tr class="odd">
<td style="text-align: left;">[<strong>XMVECTOR::operator * (float,XMVECTOR)</strong>](xmvector-operator-mul-1.md)</td>
...
<tr class="even">
<td style="text-align: left;">[<strong>XMVECTOR::operator * (XMVECTOR,float)</strong>](xmvector-operator-mul-2.md)</td>
...
<tr class="odd">
<td style="text-align: left;">[<strong>XMVECTOR::operator * (XMVECTOR,XMVECTOR)</strong>](xmvector-operator-mul-3.md)</td>
