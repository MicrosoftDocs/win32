...
[**XMINT3**](https://msdn.microsoft.com/en-us/library/Hh404659(v=VS.85).aspx) describes a structure containing a 3D vector consisting of three integer values.
...
| Topic                                                   | Description                                  |
|---------------------------------------------------------|----------------------------------------------|
| [**XMINT3 Constructors**](https://msdn.microsoft.com/en-us/library/Hh449510(v=VS.85).aspx)<br/>   | Constructors exposed by `XMINT3`.<br/> |
