...
| [**XMLoadUDecN4\_XR**](/windows/desktop/api/directxpackedvector.inl/nf-directxpackedvector-xmloadudecn4_xr)<br/> | Loads an extended range [**XMUDECN4**](https://msdn.microsoft.com/en-us/library/Ee420527(v=VS.85).aspx) into an [**XMVECTOR**](xmvector-data-type.md).<br/>                                        |
