...
[**XMINT2**](https://msdn.microsoft.com/en-us/library/Hh404654(v=VS.85).aspx) describes a 2D vector consisting of two integer values.
...
| Topic                                                   | Description                                  |
|---------------------------------------------------------|----------------------------------------------|
| [**XMINT2 Constructors**](https://msdn.microsoft.com/en-us/library/Hh449504(v=VS.85).aspx)<br/>   | Constructors exposed by `XMINT2`.<br/> |
