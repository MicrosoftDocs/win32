...
| Topic                                                     | Description                                                                                                |
|-----------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| [**XMVectorACos**](xmvectoracos.md)<br/>           | Computes the arccosine of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>          |
| [**XMVectorACosEst**](xmvectoracosest.md)<br/>     | Estimates the arccosine of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>         |
| [**XMVectorASin**](xmvectorasin.md)<br/>           | Computes the arcsine of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>            |
| [**XMVectorASinEst**](xmvectorasinest.md)<br/>     | Estimates the arcsine of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>           |
| [**XMVectorATan**](xmvectoratan.md)<br/>           | Computes the arctangent of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>         |
| [**XMVectorATan2**](xmvectoratan2.md)<br/>         | Computes the arctangent of *Y*/*X*.<br/>                                                             |
| [**XMVectorATan2Est**](xmvectoratan2est.md)<br/>   | Estimates the arctangent of *Y*/*X*.<br/>                                                            |
| [**XMVectorATanEst**](xmvectoratanest.md)<br/>     | Estimates the arctangent of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>        |
| [**XMVectorCos**](xmvectorcos.md)<br/>             | Computes the cosine of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>             |
...
| [**XMVectorSinEst**](xmvectorsinest.md)<br/>       | Estimates the sine of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>              |
| [**XMVectorSinH**](xmvectorsinh.md)<br/>           | Computes the hyperbolic sine of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>    |
| [**XMVectorTan**](xmvectortan.md)<br/>             | Computes the tangent of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>            |
| [**XMVectorTanEst**](xmvectortanest.md)<br/>       | Estimates the tangent of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/>           |
| [**XMVectorTanH**](xmvectortanh.md)<br/>           | Computes the hyperbolic tangent of each component of an [**XMVECTOR**](xmvector-data-type.md).<br/> |
