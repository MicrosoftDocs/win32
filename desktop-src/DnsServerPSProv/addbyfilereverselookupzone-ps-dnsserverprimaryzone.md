...
keywords: ["AddByFileReverseLookupZone method", "AddByFileReverseLookupZone method, PS_DnsServerPrimaryZone class", "PS_DnsServerPrimaryZone class, AddByFileReverseLookupZone method"]
topic_type:
- apiref
api_name:
