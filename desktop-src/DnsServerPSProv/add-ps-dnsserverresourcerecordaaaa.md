...
- apiref
api_name:
- PS_DnsServerResourceRecordAAAA.Add
api_location:
...
An array that contains the IPv6 address of the record.
...
An array that receives and embedded instance of the [**DnsServerResourceRecordAAAA**](dnsserverresourcerecordaaaa.md) class.
