...
> **Note**: This section shows examples of ProjFS APIs.  Each example is meant to illustrate basic API usage.  For documentation of options unused in these examples please consult the [ProjFS API reference](https://docs.microsoft.com/en-us/windows/desktop/api/_projfs).
...
1. Create a directory to serve as the virtualization root.
    ...
    The provider creates a directory to serve as the virtualization root using, for example **[CreateDirectory](https://docs.microsoft.com/en-us/windows/desktop/api/fileapi/nf-fileapi-createdirectoryw)**:
...
1. Mark the new directory as the virtualization root.
    ...
    The provider calls **[PrjMarkDirectoryAsPlaceholder](https://docs.microsoft.com/en-us/windows/desktop/api/projectedfslib/nf-projectedfslib-prjmarkdirectoryasplaceholder)** to mark the new directory as the virtualization root and assign it to the virtualization instance.
...
1. Set up the callback table.
    ...
    ProjFS communicates with the provider by invoking callback routines implemented by the provider.  The provider populates a [PRJ_CALLBACKS](https://docs.microsoft.com/en-us/windows/desktop/api/projectedfslib/ns-projectedfslib-prj_callbacks) struct with pointers to its callback routines.
...
1. Start the instance.
    ...
    The provider calls **[PrjStartVirtualizing](https://docs.microsoft.com/en-us/windows/desktop/api/projectedfslib/nf-projectedfslib-prjstartvirtualizing)** to start the virtualization instance.
