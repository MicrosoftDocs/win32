...
* PRJ_NOTIFICATION_FILE_OVERWRITTEN - An existing file has been overwritten, for example by calling [CreateFileW](https://docs.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-createfilew) with the **CREATE_ALWAYS** _dwCreationDisposition_ flag.
* PRJ_NOTIFICATION_FILE_RENAMED - A file has been renamed.
* PRJ_NOTIFICATION_HARDLINK_CREATED - A [hard link](https://docs.microsoft.com/windows/desktop/FileIO/hard-links-and-junctions#hard-links) has been created for a file.
...
For more details on each notification refer to the documentation for **[PRJ_NOTIFICATION](https://docs.microsoft.com/windows/desktop/api/projectedfslib/ne-projectedfslib-prj_notification)**.
