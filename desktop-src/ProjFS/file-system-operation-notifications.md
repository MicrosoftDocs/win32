...
* PRJ_NOTIFICATION_HARDLINK_CREATED - A [hard link](https://docs.microsoft.com/en-us/windows/desktop/FileIO/hard-links-and-junctions#hard-links) has been created for a file.
...
For more details on each notification refer to the documentation for **[PRJ_NOTIFICATION](https://docs.microsoft.com/en-us/windows/desktop/api/projectedfslib/ne-projectedfslib-prj_notification)**.
