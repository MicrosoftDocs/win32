...
The value for the *dwClsContext* argument of the [CoCreateInstance](https://www.bing.com/search?q=CoCreateInstance) call must be CLSCTX\_LOCAL\_SERVER. No other server type is supported, and Component Object Model (COM) rejects any other value for this parameter.
