...
The value for the *dwClsContext* argument of the [CoCreateInstance](https://msdn.microsoft.com/library/ms686615(v=VS.85).aspx) call must be CLSCTX\_LOCAL\_SERVER. No other server type is supported, and Component Object Model (COM) rejects any other value for this parameter.
