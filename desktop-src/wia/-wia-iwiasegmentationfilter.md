...
The **IWiaSegmentationFilter** interface inherits from the [**IUnknown**](com.iunknown) interface. **IWiaSegmentationFilter** also has these types of members:
...
The **IWiaSegmentationFilter** interface, like all Component Object Model (COM) interfaces, inherits the [IUnknown](com.iunknown) interface methods.
