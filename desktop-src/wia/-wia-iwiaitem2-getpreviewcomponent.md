...
Applications must call the [IUnknown::Release](com.iunknown_release) method on the interface pointers that they receive through the *ppWiaPreview* parameter.
