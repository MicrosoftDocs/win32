...
title: IWiaItem2GetExtension method
ms.date: 05/31/2018
ms.topic: article
...
Applications must call the [IUnknown::Release](com.iunknown_release) method on the interface pointers they receive through the *riidExtensionInterface* parameter.
