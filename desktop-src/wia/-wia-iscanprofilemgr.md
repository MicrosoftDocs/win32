...
The **IScanProfileMgr** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IScanProfileMgr** also has these types of members:
...
To create an **IScanProfileMgr** object, use the [CoCreateInstance](com.cocreateinstance) method with the following parameters:
