...
title: IWiaDevMgr2CreateDevice method
ms.date: 05/31/2018
ms.topic: article
...
Applications must call the [IUnknown::Release](com.iunknown_release) method on the pointers they receive through the *ppWiaItem2Root* parameter.
