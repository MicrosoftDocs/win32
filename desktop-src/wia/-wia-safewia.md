...
<tbody>
<tr class="odd">
<td style="text-align: left;">[<strong>Devices</strong>](-wia-iwia-devices.md)<br/></td>
<td style="text-align: left;">Read-only<br/></td>
<td style="text-align: left;">Collection of [<strong>DeviceInfo</strong>](-wia-deviceinfo.md) objects that represents all of the devices installed on the computer. Read-only. <br/>
<blockquote>
[!Note]<br />
