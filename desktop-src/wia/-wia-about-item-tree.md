...
<td><ul>
<li>[<strong>WiaItemTypeProgrammableDataSource</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeImage</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeTransfer</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeFile</strong>](-wia-wia-item-type-flags.md)</li>
</ul></td>
...
<li>[<strong>WiaItemTypeProgrammableDataSource</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeImage</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeDocument</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeTransfer</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeFolder</strong>](-wia-wia-item-type-flags.md)</li>
</ul></td>
...
<li>[<strong>WiaItemTypeFolder</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeImage</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeAudio</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeVideo</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeDocument</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeTransfer</strong>](-wia-wia-item-type-flags.md)</li>
</ul></td>
<td>The property set on this item depends on the item type reported. For example, [<strong>WiaItemTypeImage</strong>](-wia-wia-item-type-flags.md) should include some image item properties, like bits per pixel and so forth.</td>
...
<li>[<strong>WiaItemTypeDocument</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeTransfer</strong>](-wia-wia-item-type-flags.md)</li>
<li>[<strong>WiaItemTypeFolder</strong>](-wia-wia-item-type-flags.md)—may be present if the scanner supports multi-item scanning.</li>
<li>[<strong>WiaItemTypeGenerated</strong>](-wia-wia-item-type-flags.md)—may be present if the application generates a WIA item during a multi-item scanning session.</li>
</ul></td>
