...
In the previous code, it is assumed that **pWiaItem** is a valid pointer to the [**IWiaItem**](/windows/desktop/api/wia_xp/nn-wia_xp-iwiaitem) interface. The call to [IUnknown::QueryInterface](https://msdn.microsoft.com/windows/desktop/54d5ff80-18db-43f2-b636-f93ac053146d) fills **pWiaDataTransfer** with a pointer to the [**IWiaDataTransfer**](/windows/desktop/api/wia_xp/nn-wia_xp-iwiadatatransfer) interface of the item referred to by **pWiaItem**.

The application then sets the [STGMEDIUM](https://msdn.microsoft.com/windows/desktop/5d05819a-10db-4d8e-91e4-8a7c05885cde) structure members. For information, see STGMEDIUM and [TYMED](https://msdn.microsoft.com/windows/desktop/ac41286f-7c67-444a-81b7-21b61079bbf5).
...
The application then releases the pointers to the [**IWiaDataTransfer**](/windows/desktop/api/wia_xp/nn-wia_xp-iwiadatatransfer) interface and frees any data allocated in the [STGMEDIUM](https://msdn.microsoft.com/windows/desktop/5d05819a-10db-4d8e-91e4-8a7c05885cde) structure.
