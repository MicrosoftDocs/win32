...
<td style="text-align: left;">The current connection status for the device. The minidriver creates and maintains this property.<br/> Type: <strong>VT_I4</strong>, Access: Read-only, Valid values: <a href="-wia-property-attributes">WIA_PROP_NONE</a><br/> The property can have the following possible values.<br/> 
<table>
<thead>
<tr class="header">
...
<p>WIA devices report time in a <a href="http://msdn.microsoft.com/en-us/library/ms724950(VS.85).aspx">SYSTEMTIME</a> structure.</p></td>
</tr>
<tr class="odd">
