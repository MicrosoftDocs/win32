...
Applications must call the [IUnknown::Release](com.iunknown_release) method on the interface pointers they receive through the *ppIEnumWIA\_DEV\_CAPS* parameter.
