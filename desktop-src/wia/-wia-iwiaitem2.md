...
The **IWiaItem2** interface inherits from the [**IUnknown**](com.iunknown) interface. **IWiaItem2** also has these types of members:
...
The **IWiaItem2** interface, like all Component Object Model (COM) interfaces, inherits the [IUnknown](com.iunknown) interface methods.
