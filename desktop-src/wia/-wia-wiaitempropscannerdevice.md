...
<td style="text-align: left;">Reserved, do not use.<br/> Type: <strong>VT_I4</strong>, Access: Read Only, Valid values: <a href="-wia-property-attributes">WIA_PROP_NONE</a><br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
This property is not supported in Windows Vista and later. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_DOCUMENT_HANDLING_SELECT</strong></a>.
</blockquote>
</div>
<div>
 
...
<p>Type: <strong>VT_I4</strong>, Access: Read/Write, Valid values: <a href="-wia-property-attributes">WIA_PROP_FLAG</a></p>
...
<p>Type: <strong>VT_BSTR</strong>, Access: Read/Write, Valid values: <a href="-wia-property-attributes">WIA_PROP_NONE</a></p>
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_MAX_HORIZONTAL_SIZE</strong></a>.
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_MIN_HORIZONTAL_SIZE</strong></a>.
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_MIN_VERTICAL_SIZE</strong></a>.
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_OPTICAL_XRES</strong></a>.
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_OPTICAL_YRES</strong></a>.
</blockquote>
</div>
<div>
 
...
<p> </p>
<p><strong>See Also</strong></p>
<p><a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_ROTATION</strong></a></p></td>
</tr>
<tr class="even">
...
<p>The format of the color information is <a href="https://docs.microsoft.com/windows/win32/api/wingdi/ns-wingdi-rgbquad">RGBQUAD</a>.</p></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_PAGE_SIZE</strong></a>.
</blockquote>
</div>
<div>
 
...
<li>An application sets the <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_ORIENTATION</strong></a> property to LANSCAPE.</li>
<li>An application changes the <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_XEXTENT</strong></a> property to a smaller value.</li>
</ol>
...
<p><strong>Example 3: An application sets the</strong> <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_ORIENTATION</strong></a>  <strong>property to LANSCAPE</strong></p>
...
<p><strong>Example 4: An application changes the</strong> <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_XEXTENT</strong></a>  <strong>property to a smaller value</strong></p>
<p>In the following example, an application changes the <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_XEXTENT</strong></a> property to 1000. The minidriver should assume that the new value contained in <strong>WIA_IPS_XEXTENT</strong> is no longer valid for the <strong>WIA_DPS_PAGE_SIZE</strong> property and should thus change <strong>WIA_DPS_PAGE_SIZE</strong> to WIA_PAGE_CUSTOM. The minidriver must also adjust <strong>WIA_DPS_PAGE_WIDTH</strong>.</p>
<div class="code">
<span data-codelanguage=""></span>
<table>
<colgroup>
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_PAGES</strong></a>.
</blockquote>
</div>
<div>
 
...
<p>Type: <strong>VT_I4</strong>; Access: Read/Write; Valid values: <a href="-wia-property-attributes">WIA_PROP_RANGE</a> (zero through the maximum number of pages that the document feeder can hold)</p>
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_PREVIEW</strong></a>.
</blockquote>
</div>
<div>
 
...
<p>Type: <strong>VT_I4</strong>, Access: Read/Write, Valid values: <a href="-wia-property-attributes">WIA_PROP_RANGE</a> of zero to the maximum number of pages that the document feeder can hold.</p></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_SHEET_FEEDER_REGISTRATION</strong></a>.
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_SHOW_PREVIEW_CONTROL</strong></a>.
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use <a href="-wia-wiaitempropscanneritem"><strong>WIA_IPS_MAX_VERTICAL_SIZE</strong></a>.
</blockquote>
</div>
<div>
 
