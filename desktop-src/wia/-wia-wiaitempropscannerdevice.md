...
<br/> Contains a unique function instance identifier for a web services scanner device. This identifier represents the web service on the scanner device with which the WIA mini-driver is communicating. No assumptions about the form of this identifier should be made. The WIA mini-driver creates and maintains this property. <br/> WIA applications can use the value of WIA_DPS_DEVICE_ID to find, using the Function Discovery API, the function instance object representing the web services scanner device used in the current WIA 2.0 session.<br/> Type: <strong>VT_BSTR</strong>, Access: Read Only, Valid values: [WIA_PROP_NONE](-wia-property-attributes.md)<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Reserved, do not use.<br/> Type: <strong>VT_I4</strong>, Access: Read Only, Valid values: [WIA_PROP_NONE](-wia-property-attributes.md)<br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
This property is not supported in Windows Vista and later. Use [<strong>WIA_IPS_DOCUMENT_HANDLING_SELECT</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<p>Type: <strong>VT_I4</strong>, Access: Read/Write, Valid values: [WIA_PROP_FLAG](-wia-property-attributes.md)</p>
...
<p>Type: <strong>VT_BSTR</strong>, Access: Read/Write, Valid values: [WIA_PROP_NONE](-wia-property-attributes.md)</p>
...
<p>Type: <strong>VT_I4</strong>, Access: Read Only, Valid values: [WIA_PROP_NONE](-wia-property-attributes.md)</p></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use [<strong>WIA_IPS_MAX_HORIZONTAL_SIZE</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use [<strong>WIA_IPS_MIN_HORIZONTAL_SIZE</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use [<strong>WIA_IPS_MIN_VERTICAL_SIZE</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use [<strong>WIA_IPS_OPTICAL_XRES</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use [<strong>WIA_IPS_OPTICAL_YRES</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<p> </p>
<p><strong>See Also</strong></p>
<p>[<strong>WIA_IPS_ROTATION</strong>](-wia-wiaitempropscanneritem.md)</p></td>
</tr>
<tr class="even">
...
<p>Type: <strong>VT_UI1</strong> | <strong>VT_VECTOR</strong>, Access: Read Only, Valid values: [WIA_PROP_NONE](-wia-property-attributes.md)</p>
<p>The format of the color information is [RGBQUAD](https://msdn.microsoft.com/windows/desktop/22e0991d-078e-4b44-9f03-004137e31f6c).</p></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use [<strong>WIA_IPS_PAGE_SIZE</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<p> </p>
<p>The value of the [<strong>WIA_IPS_ORIENTATION</strong>](-wia-wiaitempropscanneritem.md) property determines the orientation of the currently selected page. The <strong>WIA_DPS_PAGE_WIDTH</strong> and <strong>WIA_DPS_PAGE_HEIGHT</strong> properties report the page's dimensions, in thousandths of an inch. Note that these properties must be in agreement with <strong>WIA_IPS_XEXTENT</strong> and <strong>WIA_IPS_YEXTENT</strong>, which contain the page's dimensions in pixels. Valid values of type WIA_PROP_LIST should depend on valid settings of the <strong>WIA_IPS_ORIENTATION</strong> property. If the device cannot scan landscape-oriented documents with a WIA_PAGE_A4 setting, WIA_PAGE_A4 should not appear in the list of valid values for the <strong>WIA_DPS_PAGE_SIZE</strong> property when <strong>WIA_IPS_ORIENTATION</strong> is set to LANSCAPE.</p>
<p>If an application sets <strong>WIA_DPS_PAGE_SIZE</strong> to any value other than WIA_PAGE_CUSTOM, the minidriver should adjust the values of <strong>WIA_DPS_PAGE_WIDTH</strong> and <strong>WIA_DPS_PAGE_HEIGHT</strong> to the page's dimensions in thousandths of an inch. It should also adjust the values of [<strong>WIA_IPS_XEXTENT</strong>](-wia-wiaitempropscanneritem.md) and <strong>WIA_IPS_YEXTENT</strong> to the page's dimensions in pixels.</p>
<p>If an extent setting ([<strong>WIA_IPS_XEXTENT</strong>](-wia-wiaitempropscanneritem.md) or <strong>WIA_IPS_YEXTENT</strong>) is changed to a value that does not match the current page-size setting, the minidriver should change the value of the <strong>WIA_DPS_PAGE_SIZE</strong> property to WIA_PAGE_CUSTOM. The minidriver should also modify <strong>WIA_DPS_PAGE_WIDTH</strong> or <strong>WIA_DPS_PAGE_HEIGHT</strong> in accordance with the new extent setting.</p>
<p>If [<strong>WIA_IPS_ORIENTATION</strong>](-wia-wiaitempropscanneritem.md) is set to LANSCAPE, the extent settings will be &quot;flipped.&quot; For example, if an application sets <strong>WIA_DPS_PAGE_SIZE</strong> to WIA_PAGE_A4, the minidriver should set <strong>WIA_DPS_PAGE_WIDTH</strong> to 11692 and <strong>WIA_DPS_PAGE_HEIGHT</strong> to 8267. (The minidriver should also set <strong>WIA_IPS_XEXTENT</strong> and <strong>WIA_IPS_YEXTENT</strong> accordingly.) Note that if <strong>WIA_DPS_PAGE_SIZE</strong> is set to WIA_PAGE_CUSTOM, the orientation setting is not used to determine the extent dimensions of the page to be scanned.</p>
<p>The minidriver is responsible for ensuring that the [<strong>WIA_IPS_ORIENTATION</strong>](-wia-wiaitempropscanneritem.md) property is in agreement with the current selection area. If an application changes the value of <strong>WIA_IPS_ORIENTATION</strong> to one that is invalid for the currently selected page size, the minidriver should change the value of <strong>WIA_DPS_PAGE_SIZE</strong> to a page size that is supported by the new orientation value.</p>
<p>If an application sets the <strong>WIA_DPS_PAGE_SIZE</strong> property to WIA_PAGE_CUSTOM, the current selection area is not affected. The WIA minidriver should obtain the current image layout, starting from the current settings of the [<strong>WIA_IPS_XPOS</strong>](-wia-wiaitempropscanneritem.md) and <strong>WIA_IPS_YPOS</strong> properties. If the page-size setting results in a selection area that is outside the scanner's bed, the minidriver must automatically adjust the values of the <strong>WIA_IPS_XPOS</strong> and <strong>WIA_IPS_YPOS</strong> properties to valid settings. If the <strong>WIA_DPS_PAGE_SIZE</strong> and <strong>WIA_IPS_ORIENTATION</strong> properties are set at the same time, and they are invalid when applied in combination, the minidriver should fail the application's settings by returning an error in the [IWiaMiniDrv::drvValidateItemProperties](http://go.microsoft.com/fwlink/p/?linkid=181168). .</p>
...
<li>An application sets the [<strong>WIA_IPS_ORIENTATION</strong>](-wia-wiaitempropscanneritem.md) property to LANSCAPE.</li>
<li>An application changes the [<strong>WIA_IPS_XEXTENT</strong>](-wia-wiaitempropscanneritem.md) property to a smaller value.</li>
</ol>
...
<p><strong>Example 3: An application sets the</strong> [<strong>WIA_IPS_ORIENTATION</strong>](-wia-wiaitempropscanneritem.md)  <strong>property to LANSCAPE</strong></p>
...
<p><strong>Example 4: An application changes the</strong> [<strong>WIA_IPS_XEXTENT</strong>](-wia-wiaitempropscanneritem.md)  <strong>property to a smaller value</strong></p>
<p>In the following example, an application changes the [<strong>WIA_IPS_XEXTENT</strong>](-wia-wiaitempropscanneritem.md) property to 1000. The minidriver should assume that the new value contained in <strong>WIA_IPS_XEXTENT</strong> is no longer valid for the <strong>WIA_DPS_PAGE_SIZE</strong> property and should thus change <strong>WIA_DPS_PAGE_SIZE</strong> to WIA_PAGE_CUSTOM. The minidriver must also adjust <strong>WIA_DPS_PAGE_WIDTH</strong>.</p>
<div class="code">
<span data-codelanguage=""></span>
<table>
<colgroup>
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use [<strong>WIA_IPS_PAGE_WIDTH</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
</div>
<p>Contains the width of the current page selected, in thousandths of an inch. An application reads this property to determine the physical dimensions of the page being scanned. If the extent settings are different from known page sizes, this property reports the width of the page whose <strong>WIA_DPS_PAGE_SIZE</strong> property is set to WIA_PAGE_CUSTOM. <strong>WIA_DPS_PAGE_WIDTH</strong> must be in sync with the value of [<strong>WIA_IPS_XEXTENT</strong>](-wia-wiaitempropscanneritem.md), which reports the width, in pixels, of the page to be scanned. The minidriver creates and maintains this property.</p>
<p>Type: <strong>VT_I4</strong>, Access: Read Only, Valid values: [WIA_PROP_NONE](-wia-property-attributes.md)</p></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use [<strong>WIA_IPS_PAGES</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<p>Type: <strong>VT_I4</strong>; Access: Read/Write; Valid values: [WIA_PROP_RANGE](-wia-property-attributes.md) (zero through the maximum number of pages that the document feeder can hold)</p>
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use [<strong>WIA_IPS_PREVIEW</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<p>Type: <strong>VT_I4</strong>, Access: Read/Write, Valid values: [WIA_PROP_RANGE](-wia-property-attributes.md) of zero to the maximum number of pages that the document feeder can hold.</p></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use [<strong>WIA_IPS_SHEET_FEEDER_REGISTRATION</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported by Windows Vista. Use [<strong>WIA_IPS_SHOW_PREVIEW_CONTROL</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
...
<blockquote>
[!Note]<br />
This property is not supported with Windows Vista and later. Use [<strong>WIA_IPS_MAX_VERTICAL_SIZE</strong>](-wia-wiaitempropscanneritem.md).
</blockquote>
</div>
<div>
 
