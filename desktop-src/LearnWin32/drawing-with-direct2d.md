...
The [**BeginDraw**](https://msdn.microsoft.com/library/windows/desktop/dd371768), [**Clear**](https://msdn.microsoft.com/library/windows/desktop/dd742775), and [**FillEllipse**](https://msdn.microsoft.com/library/windows/desktop/dd742849) methods all have a **void** return type. If an error occurs during the execution of any of these methods, the error is signaled through the return value of the [**EndDraw**](https://msdn.microsoft.com/library/windows/desktop/dd371924) method. The `CreateGraphicsResources` method is shown in the topic [Creating Direct2D Resources](render-targets--devices--and-resources.md#creating-direct2d-resources). This method creates the render target and the solid-color brush.
