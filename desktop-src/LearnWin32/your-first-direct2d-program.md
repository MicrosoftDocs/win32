...
Here is the code listing for the Circle program. The program re-uses the `BaseWindow` class that was defined in the topic [Managing Application State](https://www.bing.com/search?q=Managing Application State). Later topics will examine the code in detail.
