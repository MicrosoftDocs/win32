...
Value from the [**FAX\_PRIORITY\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_priority_type_enum) enumeration that specifies the fax priority.
