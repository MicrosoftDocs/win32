...
The **Save** method saves the [**FaxActivityLogging**](-mfax-faxactivitylogging.md) object's data.

## Syntax


```VB
FaxActivityLogging.Save() As Long
```
...
To use this method, a user must have the [****farQUERY\_CONFIG****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum) and [****farMANAGE\_CONFIG****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum) access rights.
