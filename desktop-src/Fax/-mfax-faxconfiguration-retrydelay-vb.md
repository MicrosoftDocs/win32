...
```VB
Property RetryDelay As Integer
```
...
A value of type **Integer** that indicates the length of time the fax service should wait before retrying a failed fax transmission.
