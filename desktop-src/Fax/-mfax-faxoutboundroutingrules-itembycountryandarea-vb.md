...
A **Long** value that specifies the country/region code of the outbound routing rule to retrieve. Specifying [**frrcANY\_CODE**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_routing_rule_code_enum) will return a rule for any country/region code.
...
A **Long** value that specifies the area code of the outbound routing rule to retrieve. Specifying [**frrcANY\_CODE**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_routing_rule_code_enum) will return a rule for any area code within the specified country/region code.
