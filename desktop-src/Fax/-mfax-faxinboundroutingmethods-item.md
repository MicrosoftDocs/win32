...
A variable of type [**IFaxInboundRoutingMethod**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxinboundroutingmethod) that receives a [**FaxInboundRoutingMethod**](-mfax-faxinboundroutingmethod.md) object.
