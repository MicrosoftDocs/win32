...
A variable of type [**IFaxRecipients**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxrecipients) that receives a [**FaxRecipients**](-mfax-faxrecipients.md) object.
