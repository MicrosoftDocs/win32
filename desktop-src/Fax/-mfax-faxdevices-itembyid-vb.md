...
The [**get\_ItemById**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxdevices-get_itembyid) property returns a [**FaxDevice**](-mfax-faxdevice.md) object from the [**FaxDevices**](-mfax-faxdevices.md) collection, using its device ID.
...
A variable of type [**IFaxDevice**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxdevice) that receives a [**FaxDevice**](-mfax-faxdevice.md) object.
