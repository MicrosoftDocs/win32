...
ms.assetid: df4a3e36-7a83-4ed5-a037-14892ab28d1b
title: FaxJobStatus.TSID property
ms.date: 05/31/2018
ms.topic: article
...
A **String** that receives the TSID associated with the fax job.
