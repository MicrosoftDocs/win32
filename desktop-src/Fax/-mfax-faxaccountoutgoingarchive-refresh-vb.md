...
Refreshes [**FaxAccountOutgoingArchive**](-mfax-faxaccountoutgoingarchive.md) object information for a particular fax account from the fax server.

## Syntax


```VB
FaxAccountOutgoingArchive.Refresh() As Long
```
