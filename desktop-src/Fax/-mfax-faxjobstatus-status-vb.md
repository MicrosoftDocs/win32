...
A variable of type [**FAX\_JOB\_STATUS\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_job_status_enum) that receives the current status of a fax job in the job queue. For more information, see **FAX\_JOB\_STATUS\_ENUM**.
