...
The **Refresh** method refreshes [**FaxIncomingJob**](-mfax-faxincomingjob.md) object information from the fax server.

## Syntax


```VB
FaxIncomingJob.Refresh() As Long
```
...
To use this method, a user must have the [**farQUERY\_QUEUE**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum) access right.
