...
Call the **Refresh** method to update the information for a [FaxStatus](-mfax-faxstatus.md) object. An application must call this method to poll a fax port for new status information. After you successfully call **Refresh**, you must call the appropriate [**IFaxStatus**](/previous-versions/windows/desktop/api/Faxcom/nn-faxcom-ifaxstatus) interface method to retrieve new attribute values that are valid.
