...
Sets the flags of a [**FAX\_ACCOUNT\_EVENTS\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_account_events_type_enum) variable that represents the events for which the account is listening.
...
Type: **[**FAX\_ACCOUNT\_EVENTS\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_account_events_type_enum)**
