...
To use this method, a user must have the [****far2SUBMIT\_LOW****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum_2), [****far2SUBMIT\_NORMAL****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum_2), or [****far2SUBMIT\_HIGH****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum_2) access set correctly, depending on the [**Priority**](-mfax-faxdocument-priority-vb.md) of the fax document.
