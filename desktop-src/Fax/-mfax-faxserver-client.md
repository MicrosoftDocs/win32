...
-   Supports the [**IFaxServer**](-mfax-ifaxserver-client.md) interface.

For more information about creating an instance of a FaxServer object, and for a list of the object's properties and methods, see [**IFaxServer**](-mfax-ifaxserver-client.md).
