...
A variable of type [**IFaxIncomingMessage**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxincomingmessage) that receives a [**FaxIncomingMessage**](-mfax-faxincomingmessage.md) object.
