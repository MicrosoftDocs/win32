...
The **Activity** property creates a [**FaxActivity**](-mfax-faxactivity.md) configuration object. The object permits a fax client application to access information about the activity on a connected fax server, and the fax server status.
...
A [**FaxActivity**](-mfax-faxactivity.md) object.
