...
To create a **FaxInboundRoutingMethods** object in C++, call the [**GetMethods**](/windows/previous-versions/FaxComex/nf-faxcomex-ifaxinboundrouting-getmethods?branch=master) method.
