...
To create a **FaxInboundRoutingMethods** object in C++, call the [**GetMethods**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxinboundrouting-getmethods) method.
