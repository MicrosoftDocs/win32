...
To create a **FaxConfiguration** object in Microsoft Visual Basic, call the [**Configuration**](-mfax-faxserver2-configuration-vb.md) property of the [**IFaxServer2**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxserver2) object.
