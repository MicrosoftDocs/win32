...
To use this method, a user must have the [****farSUBMIT\_LOW****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum), [****farSUBMIT\_NORMAL****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum), or [****farSUBMIT\_HIGH****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum) access right, depending on the [**Priority**](-mfax-faxdocument-priority-vb.md) of the fax document.
