...
A variable of type [**FAX\_RECEIPT\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_receipt_type_enum) that specifies or receives a receipt type. For possible values, see **FAX\_RECEIPT\_TYPE\_ENUM**.
