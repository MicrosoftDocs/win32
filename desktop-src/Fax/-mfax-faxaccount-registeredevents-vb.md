...
Pointer to a variable of type [**FAX\_ACCOUNT\_EVENTS\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_account_events_type_enum) which indicates the events for which the account is listening.
