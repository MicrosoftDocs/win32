...
| [**FaxAccountSet**](-mfax-faxserver2-faxaccountset-vb.md)<br/>      | Read-only<br/> | The [**FaxAccountSet**](-mfax-faxserver2-faxaccountset-vb.md) property returns a [**IFaxAccountSet**](-mfax-faxaccountset-cpp.md) object used to manage the fax accounts on the fax server. <br/>                                                                                                       |
...
| [**Security2**](-mfax-faxserver2-security2-vb.md)<br/>              | Read-only<br/> | The [**Security2**](-mfax-faxserver2-security2-vb.md) property returns a [**IFaxSecurity2**](-mfax-faxsecurity2-cpp.md) object used to configure security on the fax server. <br/>                                                                                                                      |
