...
To create a **FaxDevice** object in Microsoft Visual Basic, call the [**Item**](-mfax-faxdevices-item.md) or [**get\_ItemById**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxdevices-get_itembyid) property of the [**FaxDevices**](-mfax-faxdevices.md) object.

To create a **FaxDevice** object in C++, call the [**Item**](-mfax-faxdevices-item.md) or [**get\_ItemById**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxdevices-get_itembyid) method.
