...
A variable of type [**FAX\_SMTP\_AUTHENTICATION\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_smtp_authentication_type_enum) that specifies or receives the type of authentication. See the **FAX\_SMTP\_AUTHENTICATION\_TYPE\_ENUM** enumeration.
