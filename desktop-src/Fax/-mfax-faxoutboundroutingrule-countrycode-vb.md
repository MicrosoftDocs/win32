...
If this property is equal to [**frrcANY\_CODE**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_routing_rule_code_enum), the outbound routing rule applies to all country/region codes.
