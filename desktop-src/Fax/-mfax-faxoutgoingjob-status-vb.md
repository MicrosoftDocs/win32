...
Value from the [**FAX\_JOB\_STATUS\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_job_status_enum) enumeration that specifies the current status of an outbound fax job in the job queue.

## Remarks

For more information, see [**FAX\_JOB\_STATUS\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_job_status_enum).
