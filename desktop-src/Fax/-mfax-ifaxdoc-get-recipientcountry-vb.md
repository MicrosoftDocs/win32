...
ms.assetid: 404a667c-ab8e-4490-b676-c49424dacd63
title: FaxDoc.RecipientCountry property
ms.date: 05/31/2018
ms.topic: article
...
# FaxDoc.RecipientCountry property

Sets or retrieves the **RecipientCountry** property of a [FaxDoc](-mfax-faxdoc.md) object. The **RecipientCountry** property is a null-terminated string that contains the country/region of the recipient of the fax transmission.
...
```VB
Property RecipientCountry As String
```
