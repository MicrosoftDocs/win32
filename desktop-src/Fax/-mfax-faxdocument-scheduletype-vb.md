...
A variable of type [**FAX\_SCHEDULE\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_schedule_type_enum) that specifies or receives the schedule type. For possible values, see **FAX\_SCHEDULE\_TYPE\_ENUM**.
