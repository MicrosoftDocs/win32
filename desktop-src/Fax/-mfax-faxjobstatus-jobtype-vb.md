...
A variable of type [**FAX\_JOB\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_job_type_enum) that receives the job type. For more information, see **FAX\_JOB\_TYPE\_ENUM**.
