...
To use this method, a user must have the [**farSUBMIT\_LOW**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum) or **farQUERY\_JOBS** access right.

With the [**farSUBMIT\_LOW**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum) access right, users will be able to use this method only for their own faxes. With the **farQUERY\_JOBS** access right, users will be able to use this method for all faxes on the server.
