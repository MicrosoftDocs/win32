...
```VB
Property OutgoingQueueAgeLimit As Integer
```
...
A value of type **Integer** that indicates the length of time that an undeliverable fax message is kept on the fax server before it is deleted.
