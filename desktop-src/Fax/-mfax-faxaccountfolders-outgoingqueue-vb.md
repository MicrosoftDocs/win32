...
A variable of type [**IFaxAccountOutgoingQueue**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxaccountoutgoingqueue) that receives a [**FaxAccountOutgoingQueue**](-mfax-faxaccountoutgoingqueue.md) object.
