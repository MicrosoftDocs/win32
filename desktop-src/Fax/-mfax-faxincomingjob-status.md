...
A **Long** that receives the current status of an inbound fax job in the job queue. For more information, see [**FAX\_JOB\_STATUS\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_job_status_enum).
...
[**get\_Status**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxincomingjob-get_status)
</dt> </dl>
