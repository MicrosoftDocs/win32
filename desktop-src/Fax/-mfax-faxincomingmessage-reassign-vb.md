...
To use this method, a user must have the [****far2MANAGE\_RECEIVE\_FOLDER****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum_2) and [****far2QUERY\_CONFIG****](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_access_rights_enum_2) access rights. Also, IFaxConfiguration::IncomingFaxesArePublic must be set to false.
