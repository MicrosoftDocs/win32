...
-   Create by calling the [**IFaxPorts::get\_Item**](/previous-versions/windows/desktop/api/Faxcom/nf-faxcom-ifaxports-get_item) method.
-   Supports the [**IFaxPort**](/previous-versions/windows/desktop/api/Faxcom/nn-faxcom-ifaxport) interface.

For more information about creating an instance of a FaxPort object, and for a list of the object's properties and methods, see [**IFaxPort**](/previous-versions/windows/desktop/api/Faxcom/nn-faxcom-ifaxport).
