...
The **TSID** property is a null-terminated string that contains the transmitting station identifier (TSID) associated with the fax outbound job.
...
A **String** that receives the TSID associated with the outbound fax job.
