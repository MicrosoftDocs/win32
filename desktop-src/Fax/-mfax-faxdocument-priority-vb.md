...
A variable of type [**FAX\_PRIORITY\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_priority_type_enum) that specifies or receives the transmission priority. For possible values, see **FAX\_PRIORITY\_TYPE\_ENUM**.
