...
|:----------------------------------------------------------------------------|:----------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Descriptor**](-mfax-faxsecurity2-descriptor.md)<br/>              | Read/write<br/> | Represents the security descriptor for a [**IFaxServer2**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxserver2) interface.<br/>                                                                                                                                                                    |
...
A **FaxSecurity2** object is accessed through a [**IFaxServer2**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxserver2) interface.
...
To create a **FaxSecurity2** object in Microsoft Visual Basic, call the [**Security2**](-mfax-faxserver2-security2-vb.md) property of the [**IFaxServer2**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxserver2) interface.
