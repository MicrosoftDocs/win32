...
To create a **FaxOutgoingMessage** object in C++, call the [**GetMessage**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxoutgoingarchive-getmessage) method, or the [**Message**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxoutgoingmessageiterator-get_message) method.
