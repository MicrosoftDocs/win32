...
To create a **FaxOutgoingMessageIterator** object in C++, call the [**GetMessages**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxoutgoingarchive-getmessages) method.
