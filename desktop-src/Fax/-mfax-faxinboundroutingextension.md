...
To create a **FaxInboundRoutingExtension** object in C++, call the [**Item**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxinboundroutingextensions-get_item) method.
