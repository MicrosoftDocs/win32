...
ms.assetid: acddbbee-3f8e-4a9f-bf77-1b01de2d2762
title: FaxIncomingJob.DeviceId property
ms.date: 05/31/2018
ms.topic: article
...
# FaxIncomingJob.DeviceId property
...
A **Long** that receives the device ID for the fax device receiving the fax job.
