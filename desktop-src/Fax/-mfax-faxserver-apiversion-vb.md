...
Value from the [**FAX\_SERVER\_APIVERSION\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_server_apiversion_enum) enumeration that specifies the version of the fax server API.
