...
A variable of type [**FAX\_RECEIPT\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/FaxComex/ne-faxcomex-fax_receipt_type_enum) that specifies or receives a value or combination of values of permitted types of delivery receipts. See the **FAX\_RECEIPT\_TYPE\_ENUM** enumeration.
