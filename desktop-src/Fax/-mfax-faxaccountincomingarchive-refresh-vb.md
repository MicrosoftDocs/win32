...
Refreshes [**FaxAccountIncomingArchive**](-mfax-faxaccountincomingarchive.md) object information for a particular fax account from the fax server.

## Syntax


```VB
FaxAccountIncomingArchive.Refresh() As Long
```
