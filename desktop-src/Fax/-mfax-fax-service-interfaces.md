---
Description: 'The fax service extended Component Object Model (COM) implementation includes the following interfaces.'
ms.assetid: 'a2aa67f2-93a6-45ff-a4a9-f813d512df50'
title: Fax Service Interfaces
---

# Fax Service Interfaces

The fax service extended Component Object Model (COM) implementation includes the following interfaces.
...
-   [**IFaxAccountNotify**](-mfax-ifaxaccountnotify.md)
...
-   [**IFaxDeviceProviders**](-mfax-faxdeviceproviders-cpp.md)
...
-   [**IFaxServerNotify**](-mfax-ifaxservernotify.md)
-   [**IFaxServerNotify2**](-mfax-ifaxservernotify2.md)
