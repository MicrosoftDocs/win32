...
| [**ItemById**](-mfax-faxdevices-itembyid-vb.md)<br/> | Read-only<br/> | The [**get\_ItemById**](-mfax-faxdevices-itembyid.md) property returns a [**FaxDevice**](-mfax-faxdevice.md) object from the **FaxDevices** collection, using its device ID.<br/>         |
