...
| [**ItemById**](-mfax-faxdevices-itembyid-vb.md)<br/> | Read-only<br/> | The [**get\_ItemById**](/previous-versions/windows/desktop/api/FaxComex/nf-faxcomex-ifaxdevices-get_itembyid) property returns a [**FaxDevice**](-mfax-faxdevice.md) object from the **FaxDevices** collection, using its device ID.<br/>         |
