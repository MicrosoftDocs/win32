...
<td>By using the [<strong>SendToFaxRecipient</strong>](/previous-versions/windows/desktop/api/Fxsutility/nf-fxsutility-sendtofaxrecipient) API, developers can also integrate the &quot;Send to Fax Recipient&quot; functionality into their applications. Users can right-click a document in Explorer and select <strong>Send to Fax Recipient</strong>.<br/></td>
</tr>
</tbody>
</table>
