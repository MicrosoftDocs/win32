...
For more information about routing information, see the [**RoutingInfo**](/previous-versions/windows/desktop/api/FaxDev/ns-faxdev-_fax_dev_status) member of the **FAX\_DEV\_STATUS** structure.
