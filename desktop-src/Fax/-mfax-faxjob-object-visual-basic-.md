...
3.  Retrieve the [**Count**](/previous-versions/windows/desktop/api/Faxcom/nf-faxcom-ifaxjobs-get_count) property and then the [**Item**](/previous-versions/windows/desktop/api/Faxcom/nf-faxcom-ifaxjobs-get_item) property for the [**FaxJobs**](-mfax-faxjobs-object-visual-basic-.md) collection to create a **FaxJob** object.
