...
The **Count** property represents the number of objects in the [**FaxOutboundRoutingRules**](-mfax-faxoutboundroutingrules.md) collection. This is the total number of outbound routing rules associated with the fax server.
...
A **Long** that receives the number of outbound routing rules in the collection.
