...
You do not create the **FaxJobStatus** object. It is received as part of a notification when you implement [**FaxServerNotify.OnIncomingJobChanged**](/previous-versions/windows/desktop/api/FaxComex/) or [**FaxServerNotify.OnOutgoingJobChanged**](/previous-versions/windows/desktop/api/FaxComex/), which include a pointer to the **FaxJobStatus** object. When the event occurs and the implemented function is called, you receive this object containing the dynamic information.
