...
A variable of type [**IFaxAccountIncomingArchive**](-mfax-faxaccountincomingarchive-cpp.md) that receives a [**FaxIncomingArchive**](-mfax-faxincomingarchive.md) object.
