...
ms.assetid: 2d4e6a69-b312-4b46-b2a3-a7dcd4941102
title: FaxAccountFolders.IncomingArchive property
...
A variable of type [**IFaxAccountIncomingArchive**](/previous-versions/windows/desktop/api/FaxComex/nn-faxcomex-ifaxaccountincomingarchive) that receives a [**FaxIncomingArchive**](-mfax-faxincomingarchive.md) object.
