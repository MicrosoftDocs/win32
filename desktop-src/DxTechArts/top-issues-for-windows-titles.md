...
> [!Note]  
> Before you use **dxsetup**, read [Not So Direct Setup](https://blogs.msdn.microsoft.com/b/chuckw/archive/2010/09/08/not-so-direct-setup.aspx).
