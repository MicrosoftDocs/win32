...
keywords: ["WM_DWMCOMPOSITIONCHANGED message Desktop Window Manager"]
topic_type:
- apiref
api_name:
...
The [**DwmIsCompositionEnabled**](dwmiscompositionenabled.md) function can be used to determine the current composition state.
