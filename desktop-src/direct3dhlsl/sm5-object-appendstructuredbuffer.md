...
The UAV bound to this resource must have been created with [**D3D11\_BUFFER\_UAV\_FLAG\_APPEND**](https://msdn.microsoft.com/library/windows/desktop/ff476096).

For more information about an append structured buffer, see both sections: [append and consume buffer](https://msdn.microsoft.com/library/windows/desktop/ff476335) and [structured buffer](https://msdn.microsoft.com/library/windows/desktop/ff476335).
