...
You can access user clip planes in the Microsoft Direct3D 9 API via [**IDirect3DDevice9::SetClipPlane**](https://msdn.microsoft.com/library/windows/desktop/bb174426) and [**IDirect3DDevice9::GetClipPlane**](https://msdn.microsoft.com/library/windows/desktop/bb174380) methods. In Microsoft Direct3D 10 and later, you can access user clip planes through the [SV\_ClipDistance](https://www.bing.com/search?q=SV\_ClipDistance) semantic. But before Windows 8, SV\_ClipDistance was not available for [feature level](https://msdn.microsoft.com/library/windows/desktop/ff476876#overview) 9\_x hardware in the Direct3D 10 or Direct3D 11 APIs. So, before Windows 8, the only way to access user clip planes with feature level 9\_x hardware was through the Direct3D 9 API. Direct3D Windows Store apps can't use the Direct3D 9 API. Here we describe the syntax that you can use to access user clip planes through the Direct3D 11 API on feature level 9\_x and higher.
