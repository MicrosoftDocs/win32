...
description: The SampleBias::SampleBias(S,float,float,float) function for TextureCube samples a texture, after applying the bias value to the mipmap level.
