...
description: Describes the new wave operation intrinsics added to HLSL Shader Model 6.0.
...
> [!Note]  
> : The Shader Model 6.0 specifics described is a preview and subject to change, pending the release of [supporting tools and drivers](www.youtube.com/watch?v=dcDDvoauaz0).
