---
title: SampleLevel::SampleLevel(S,float,float,int,uint) function for Texture1DArray
description: Samples a texture on the specified mipmap level and returns status about the operation. For Texture1DArray. | SampleLevel::SampleLevel(S,float,float,int,uint) function
