...
This example (from the [BasicHLSL10 Sample](e749975d-211e-f7ed-5dd1-b9c29681c71b)) illustrates uniform and non-uniform inputs to a vertex shader function.
...
This example (from the [ContentStreaming Sample](2f1dbc4b-e181-5d6d-901e-52a39f4109a2)) uses an input structure to pass arguments to a pixel shader function.
