...
The UAV bound to this resource must have been created with the [**D3D11\_BUFFER\_UAV\_FLAG\_RAW**](https://msdn.microsoft.com/library/windows/desktop/ff476096).

You can use the **RWByteAddressBuffer** object type when you work with raw buffers. For more info about raw viewing of buffers, see [Raw Views of Buffers](https://msdn.microsoft.com/library/windows/desktop/ff476900#raw-buffer-views).
