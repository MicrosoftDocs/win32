...
Direct3D 9 interfaces are restricted to device driver interface (DDI) drivers that are DirectX 7-level and above. To check the DDI level, run the [DirectX Diagnostic Tool](5c42f23b-2dd5-db29-a58c-bde391d312c2) and examine the saved text file.
