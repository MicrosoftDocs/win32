...
A [**D3D\_BLOB\_PART**](d3d-blob-part.md)-typed value that specifies the part to set. Currently, you can update only private data; that is, **D3DSetBlobPart** currently only supports the [**D3D\_BLOB\_PRIVATE\_DATA**](https://www.bing.com/search?q=**D3D\_BLOB\_PRIVATE\_DATA**) value.
