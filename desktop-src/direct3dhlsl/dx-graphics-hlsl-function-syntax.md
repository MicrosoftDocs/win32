...
Optional list of clip planes, which is up to 6 user-specified clip planes. This is an alternate mechanism for [SV\_ClipDistance](https://www.bing.com/search?q=SV\_ClipDistance) that works on [feature level](https://msdn.microsoft.com/library/windows/desktop/ff476876#overview) 9\_x and higher.
