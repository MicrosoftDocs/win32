...
> [!Note]  
> **D3DGetOutputSignatureBlob** may be altered or unavailable for releases after Windows 8.1. Instead use [**D3DGetBlobPart**](d3dgetblobpart.md) with the [**D3D\_BLOB\_OUTPUT\_SIGNATURE\_BLOB**](d3d-blob-part.md) value.
