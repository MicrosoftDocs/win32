...
Optional metadata, in the form of a string, attached to a global variable. An annotation is used by the effect framework and ignored by HLSL; to see more detailed syntax, see [annotation syntax](https://msdn.microsoft.com/library/windows/desktop/bb205046).
...
A sample that uses packoffset is: [HLSLWithoutFX10 Sample](61f892cf-4760-177b-5048-0ba3906d8bfc).
