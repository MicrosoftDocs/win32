...
| Item | Description |
|------|-------------|
| *byteOffset* | [in] A parameter representing the byte offset at which the comparison and replacement should start.  || *compare* | [in] The value to compare with the current memory location's value. If the values are equal, the operation will proceed.  || *value* | [in] The value to place in the memory location if the comparison passes.  |
## Return value
