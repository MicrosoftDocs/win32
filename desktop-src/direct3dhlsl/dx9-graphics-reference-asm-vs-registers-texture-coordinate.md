...
The fixed function vertex pipeline flags, [**D3DTEXTURETRANSFORMFLAGS**](https://msdn.microsoft.com/library/windows/desktop/bb172618) (D3DTTFF\_COUNT1, D3DTTFF\_COUNT2, D3DTTFF\_COUNT3, D3DTTFF\_COUNT4), should be set to zero if you are using a programmable vertex shader.
