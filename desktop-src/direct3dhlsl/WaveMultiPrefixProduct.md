...
| Item | Description |
|------|-------------|
| *value* | [in] The input value. This value can be a scalar, vector, or matrix with component type of float or int.  || *mask* | [in] A boolean mask that determines the lanes from which to calculate the prefix product.  |
## Return value
