...
-   \_semantics: Identifies the intended data usage, and may be any of the values in [**D3DDECLUSAGE**](https://msdn.microsoft.com/library/windows/desktop/bb172534) (without the D3DDECLUSAGE\_ prefix). Additionally, an integer index can be appended to the semantic to distinguish parameters that use similar semantics.
...
[Antialias Sample](3663ae49-3fb4-eedb-fca6-332848ea45e0)
</dt> </dl>
