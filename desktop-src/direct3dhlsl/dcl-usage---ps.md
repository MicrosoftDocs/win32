...
-   \_semantics: Identifies the intended data usage, and may be any of the values in [**D3DDECLUSAGE**](https://docs.microsoft.com/windows/desktop/direct3d9/d3ddeclusage) (without the D3DDECLUSAGE\_ prefix). Additionally, an integer index can be appended to the semantic to distinguish parameters that use similar semantics.
