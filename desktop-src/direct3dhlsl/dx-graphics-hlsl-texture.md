...
<p>Direct3D 10 uses [templated texture objects](dx-graphics-hlsl-to-type.md) instead. Here is an example of the equivalent texture operation. This example is from the [BasicHLSL10 Sample](e749975d-211e-f7ed-5dd1-b9c29681c71b) and uses the [sample](dx-graphics-hlsl-to-sample.md) texture-object function.</p>
<div class="code">
