...
-   [Migration from Direct3D 9 to Direct3D 10 and later](#migration-from-direct3d-9-to-direct3d-10-and-later)
    ...
    -   [Direct3D 9 VPOS and Direct3D 10 SV\_Position](#direct3d-9-vpos-and-direct3d-10-sv-position)
...
<tr class="even">
<td>VPOS</td>
<td>The pixel location (x,y) in screen space. To convert a Direct3D 9 shader (that uses this semantic) to a Direct3D 10 and later shader, see [Direct3D 9 VPOS and Direct3D 10 SV_Position](#direct3d-9-vpos-and-direct3d-10-sv-position))</td>
<td>float2</td>
</tr>
<tr class="odd">
<td>Output</td>
...
|---------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|
| SV\_ClipDistance\[n\]                                   | Clip distance data. SV\_ClipDistance values are each assumed to be a float32 signed distance to a plane. Primitive setup only invokes rasterization on pixels for which the interpolated plane distance(s) are &gt;= 0. Multiple clip planes can be implemented simultaneously, by declaring multiple component(s) of one or more vertex elements as the SV\_ClipDistance. The combined clip and cull distance values are at most D3D\#\_CLIP\_OR\_CULL\_DISTANCE\_COUNT components in at most D3D\#\_CLIP\_OR\_CULL\_DISTANCE\_ELEMENT\_COUNT registers. Available to all shaders to be read or written to, except the vertex shader which can write the value but not take it as input.<br/> The **clipplanes** attribute works like SV\_ClipDistance but works on all hardware [feature level](https://msdn.microsoft.com/library/windows/desktop/ff476876#overview) 9\_x and higher. For more info, see [User clip planes on feature level 9 hardware](https://msdn.microsoft.com/library/windows/desktop/jj635733).<br/> | float             |
...
| SV\_InstanceID                                          | Per-instance identifier automatically generated by the runtime (see [Using System-Generated Values (Direct3D 10)](https://msdn.microsoft.com/library/windows/desktop/bb205118)). Available to all shaders.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |                   |
...
| SV\_PrimitiveID                                         | Per-primitive identifier automatically generated by the runtime (see [Using System-Generated Values (Direct3D 10)](https://msdn.microsoft.com/library/windows/desktop/bb205118)). Can be written to by the geometry or pixel shaders, and read by the geometry, pixel, hull or domain shaders.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | uint              |
| SV\_RenderTargetArrayIndex                              | Render-target array index. Applied to geometry shader output and indicates the render target array slice that the primitive will be drawn to by the pixel shader. SV\_RenderTargetArrayIndex is only valid if the render target is an array resource. This semantic applies only to primitives, if a primitive has more than one vertex the value from the leading vertex will be used. This value also indicates which array slice of a depthstencilview is used for read/write purposes.<br/> Can be written from the geometry shader and read or written by the pixel shader.                                                                                                                                                                                                                                                                                                                                                                                                                                        | uint              |
...
| SV\_VertexID                                            | Per-vertex identifier automatically generated by the runtime (see [Using System-Generated Values (Direct3D 10)](https://msdn.microsoft.com/library/windows/desktop/bb205118)). Available as the input to the vertex shader only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | uint              |
| SV\_ViewportArrayIndex                                  | Viewport array index. Applied to geometry shader output and indicates which viewport to use for the primitive currently being written out. Can be read or written by the pixel shader. The primitive will be transformed and clipped against the viewport specified by the index before it is passed to the rasterizer. This semantic applies only to primitives, if a primitive has more than one vertex the value from the leading vertex will be used.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | uint              |
...
-   When multisampling (MultisampleEnable is **TRUE** in [**D3D10\_RASTERIZER\_DESC**](https://msdn.microsoft.com/library/windows/desktop/bb172408)) and writing a depth value (using a pixel shader), the single value written out is also used in the [depth test](https://msdn.microsoft.com/library/windows/desktop/bb205074); so the ability to render primitive edges at higher resolution is lost when multisampling.
