...
|-|-|-|
| [SV\_Barycentrics](sv-barycentrics.md) | Provides the barycentric coordinates of the current pixel relative to the primitive. Available as input to a pixel shader in Shader Model 6.1 and later. | float3 |
...
| [SV\_ViewID](sv-viewid.md) | Identifies the current view instance. Available as input to graphics shaders in Shader Model 6.1 and later. | uint |
