...
1.  If [**D3DD3DPSHADERCAPS2\_0\_NOTEXINSTRUCTIONLIMIT**](https://msdn.microsoft.com/library/windows/desktop/bb172591) is set, slots = 2; otherwise slots = 1.
2.  If [**D3DD3DPSHADERCAPS2\_0\_NOTEXINSTRUCTIONLIMIT**](https://msdn.microsoft.com/library/windows/desktop/bb172591) is set and the texture is a cube map, slots = 4; otherwise slot = 1.
3.  If [**D3DD3DPSHADERCAPS2\_0\_NOTEXINSTRUCTIONLIMIT**](https://msdn.microsoft.com/library/windows/desktop/bb172591) is set, slots = 6; otherwise slots = 1.
4.  If [**D3DD3DPSHADERCAPS2\_0\_NOTEXINSTRUCTIONLIMIT**](https://msdn.microsoft.com/library/windows/desktop/bb172591) is not set, slots = 1; otherwise:
    -   if [**D3DD3DPSHADERCAPS2\_0\_NOTEXINSTRUCTIONLIMIT**](https://msdn.microsoft.com/library/windows/desktop/bb172591) is set and the texture is a cube map, slots = 4.
    -   if [**D3DD3DPSHADERCAPS2\_0\_NOTEXINSTRUCTIONLIMIT**](https://msdn.microsoft.com/library/windows/desktop/bb172591) is set and the texture is not a cube map, slots = 3.
