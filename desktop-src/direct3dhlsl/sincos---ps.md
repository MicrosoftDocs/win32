...
-   src1 and src2 are source registers and must be two different [Constant Float Register](dx9-graphics-reference-asm-ps-registers-constant-float.md)s (c\#). The values of src1 and src2 must be that of the macros [**D3DSINCOSCONST1**](https://msdn.microsoft.com/library/windows/desktop/bb172606) and [**D3DSINCOSCONST2**](https://msdn.microsoft.com/library/windows/desktop/bb172607) respectively.
