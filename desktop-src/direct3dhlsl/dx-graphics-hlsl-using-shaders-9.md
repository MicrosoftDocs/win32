...
Shaders were first added to Microsoft DirectX in DirectX 8.0. At that time, several virtual shader machines were defined, each roughly corresponding to a particular graphics processor produced by the top 3D graphics vendors. For each of these virtual shader machines, an assembly language was designed. Programs written to the shader models (names vs\_1\_1 and ps\_1\_1 - ps\_1\_4) were relatively short and were generally written by developers directly in the appropriate assembly language. The application would pass this human-readable assembly language code to the D3DX library using [**D3DXAssembleShader**](https://msdn.microsoft.com/library/windows/desktop/bb172707) and get back a binary representation of the shader which would in turn get passed using [**CreateVertexShader**](https://msdn.microsoft.com/library/windows/desktop/bb174366) or [**CreatePixelShader**](https://msdn.microsoft.com/library/windows/desktop/bb174359). For more detail, see the software development kit (SDK).

The situation in Direct3D 9 is similar. An application passes an HLSL shader to D3DX using [**D3DXCompileShader**](https://msdn.microsoft.com/library/windows/desktop/bb172731) and gets back a binary representation of the compiled shader which in turn is passed to Microsoft Direct3D using [**CreatePixelShader**](https://msdn.microsoft.com/library/windows/desktop/bb174359) or [**CreateVertexShader**](https://msdn.microsoft.com/library/windows/desktop/bb174366). The runtime does not know anything about HLSL, only the binary assembly shader models. This is nice because it means that the HLSL compiler can be updated independent of the Direct3D runtime. You can also compile shaders offline using [fxc](https://msdn.microsoft.com/library/windows/desktop/bb232919).
...
-   [**SetVertexShader**](https://msdn.microsoft.com/library/windows/desktop/bb174465)
-   [**SetVertexShaderConstantF**](https://msdn.microsoft.com/library/windows/desktop/bb174467)
-   [**SetStreamSource**](https://msdn.microsoft.com/library/windows/desktop/bb174459)
-   [**DrawPrimitive**](https://msdn.microsoft.com/library/windows/desktop/bb174371)
