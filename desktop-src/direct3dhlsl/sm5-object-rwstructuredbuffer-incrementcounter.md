...
The bound unordered access view must have [**D3D11\_BUFFER\_UAV\_FLAG\_COUNTER**](https://msdn.microsoft.com/library/windows/desktop/ff476096) set during creation for this method to work.
