...
The right side of each expression is the value assigned to each state. See the [**D3D11\_SAMPLER\_DESC**](https://msdn.microsoft.com/library/windows/desktop/ff476207) structure for the possible state values for Direct3D 11. There is a 1 to 1 relationship between the state names and the members of the structure. See the following example.
...
-   Direct3D 10 uses [state groups](https://msdn.microsoft.com/library/windows/desktop/bb205052).
-   Direct3D 9 uses individual [states](https://msdn.microsoft.com/library/windows/desktop/bb173347).
...
<tbody>
<tr class="odd">
<td>Differences between Direct3D 9 and Direct3D 10:<br/> Here is a partial example of a Direct3D 9 sampler from [BasicHLSL Sample](c1164af8-8570-210f-304e-0fb07281c294).<br/> <span data-codelanguage=""></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
...
<p>Here is a partial example of a Direct3D 10 sampler from [BasicHLSL10 Sample](e749975d-211e-f7ed-5dd1-b9c29681c71b).</p>
<div class="code">
