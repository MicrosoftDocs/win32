...
-   The translation represents type [**int**](https://msdn.microsoft.com/library/windows/desktop/aa383751) the same as type **long**, and [**unsigned int**](https://msdn.microsoft.com/en-us/library/cc953fe1(v=VS.71).aspx) the same as **unsigned long**.
