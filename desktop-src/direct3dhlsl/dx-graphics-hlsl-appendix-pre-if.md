...
-   Conditional compilation expressions are treated as [**signed long**](https://msdn.microsoft.com/windows/desktop/58b0106a-0406-4b74-a430-7cbd315c0f89) values, and these expressions are evaluated using the same rules as expressions in C++.
...
-   The translation represents type [**int**](https://msdn.microsoft.com/library/windows/desktop/aa383751) the same as type **long**, and [**unsigned int**](https://msdn.microsoft.com/windows/desktop/58b0106a-0406-4b74-a430-7cbd315c0f89) the same as **unsigned long**.
