...
> [!Note]  
> **D3DGetInputAndOutputSignatureBlob** may be altered or unavailable for releases after Windows 8.1. Instead use [**D3DGetBlobPart**](d3dgetblobpart.md) with the [**D3D\_BLOB\_INPUT\_AND\_OUTPUT\_SIGNATURE\_BLOB**](https://www.bing.com/search?q=**D3D\_BLOB\_INPUT\_AND\_OUTPUT\_SIGNATURE\_BLOB**) value.
