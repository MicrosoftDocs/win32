...
-   [Windows Graphics Device Interface (GDI)](http://go.microsoft.com/fwlink/p/?linkid=151261) integration.
...
[Windows Graphics Device Interface (GDI)](http://go.microsoft.com/fwlink/p/?linkid=151261) text stack components are used to expose font selection and formatting functionality through the Ribbon Font Control. The various font features supported by the [LOGFONT Structure](http://go.microsoft.com/fwlink/p/?linkid=151263), [CHOOSEFONT Structure](http://go.microsoft.com/fwlink/p/?linkid=151262), and [CHARFORMAT2 Structure](http://go.microsoft.com/fwlink/p/?linkid=151508) are exposed through the sub-controls that are included in the Font Control.

The sub-controls that are displayed in the Font Control depend on the *FontType* template declared in the Ribbon markup. The *FontType* templates (discussed in further detail in the following section) are designed to align with the common [Windows Graphics Device Interface (GDI)](http://go.microsoft.com/fwlink/p/?linkid=151261) text structures.
...
| Template      | Supports                                                                 |
|---------------|--------------------------------------------------------------------------|
| FontOnly      | [LOGFONT Structure](http://go.microsoft.com/fwlink/p/?linkid=151263)     |
| FontWithColor | [CHOOSEFONT Structure](http://go.microsoft.com/fwlink/p/?linkid=151262)  |
| RichFont      | [CHARFORMAT2 Structure](http://go.microsoft.com/fwlink/p/?linkid=151508) |
...
| Property Key                                                                                                                  | Notes                                                                                                                                                                                                                                                                                                                                                                                          |
|-------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [UI\_PKEY\_FontProperties](windowsribbon-reference-properties-uipkey-fontproperties.md)                                      | Exposes, in aggregate as an [IPropertyStore](http://go.microsoft.com/fwlink/p/?linkid=139562) object, all Font Control sub-control properties.<br/> The framework queries this property when `UI_INVALIDATIONS_VALUE` is passed as the value of *flags* in the call to [**IUIFramework::InvalidateUICommand**](https://msdn.microsoft.com/library/windows/desktop/dd371375).<br/> |
| [UI\_PKEY\_FontProperties\_ChangedProperties](windowsribbon-reference-properties-uipkey-fontproperties-changedproperties.md) | Exposes, in aggregate as an [**IUISimplePropertySet**](https://msdn.microsoft.com/library/windows/desktop/dd371358) object, only Font Control sub-control properties that have changed.<br/>                                                                                                                                                                                                        |
...
In addition to the properties supported by the Font Control itself, the Ribbon framework also defines a [property key](windowsribbon-reference-properties.md) for each Font Control sub-control. These property keys and their values are exposed by the framework through an [IPropertyStore](http://go.microsoft.com/fwlink/p/?linkid=139562) interface implementation that defines the methods for managing a collection, also called a property bag, of name and value pairs.

The application translates the font structures to properties that are accessible through the [IPropertyStore](http://go.microsoft.com/fwlink/p/?linkid=139562) interface methods. This model emphasizes the distinction between the Font Control and the Windows Graphics Device Interface (GDI) text stack components ([LOGFONT Structure](http://go.microsoft.com/fwlink/p/?linkid=151263), [CHOOSEFONT Structure](http://go.microsoft.com/fwlink/p/?linkid=151262), and [CHARFORMAT2 Structure](http://go.microsoft.com/fwlink/p/?linkid=151508)) that are supported by the framework.
...
The following code example illustrates how to implement the [**IUICommandHandler::Execute**](https://msdn.microsoft.com/library/windows/desktop/dd371489) method for a Font Control.
...
The following code example illustrates how to implement the [**IUICommandHandler::UpdateProperty**](https://msdn.microsoft.com/library/windows/desktop/dd371494) method for a Font Control.
