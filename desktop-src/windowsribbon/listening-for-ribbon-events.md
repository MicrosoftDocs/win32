...
The Windows Ribbon framework uses the [Event Tracing for Windows (ETW)](http://go.microsoft.com/fwlink/p/?linkid=141498) infrastructure to enable developers to learn how users are interacting with their application's ribbon.
...
1.  The ribbon application must register an [Event Tracing for Windows (ETW)](http://go.microsoft.com/fwlink/p/?linkid=141498) listener to receive ribbon event notifications from the Ribbon framework.
2.  The Ribbon framework fires ribbon UI event callbacks at run time, if the application has registered an [Event Tracing for Windows (ETW)](http://go.microsoft.com/fwlink/p/?linkid=141498) listener.
...
<td>Event verb<br/> Mode ID (value set through [<strong>SetModes</strong>](https://msdn.microsoft.com/library/windows/desktop/dd371476))<br/>
<blockquote>
[!Note]<br />
...
[Declaring Commands and Controls with Ribbon Markup](scenicintent_schema)
</dt> <dt>
