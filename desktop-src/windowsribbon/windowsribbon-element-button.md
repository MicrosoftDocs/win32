...
<td>Boolean<br/></td>
<td>No<br/></td>
<td>This attribute is valid only when the <strong>Button</strong> element is a child of [<strong>QuickAccessToolbar.ApplicationDefaults</strong>](windowsribbon-element-quickaccesstoolbar-applicationdefaults.md). <br/> Restricted to one of the following values:<br/> <br/>
