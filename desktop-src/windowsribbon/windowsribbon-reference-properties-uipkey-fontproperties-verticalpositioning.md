...
The property value is from the [**UI\_FONTVERTICALPOSITION**](https://msdn.microsoft.com/library/windows/desktop/dd371571) enumeration.
...
[**UI\_FONTVERTICALPOSITION**](https://msdn.microsoft.com/library/windows/desktop/dd371571)
</dt> <dt>
