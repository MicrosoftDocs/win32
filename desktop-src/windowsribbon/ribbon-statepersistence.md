...
Various aspects of a ribbon, including configuration and interaction preferences, can be customized by a user at run time to improve usability and productivity. The Ribbon framework provides the functionality to preserve these settings across application sessions through two methods defined in the implementation of the [**IUIRibbon**](https://msdn.microsoft.com/library/windows/desktop/dd371360) interface: [**IUIRibbon::LoadSettingsFromStream**](https://msdn.microsoft.com/library/windows/desktop/dd371361) and [**IUIRibbon::SaveSettingsToStream**](https://msdn.microsoft.com/library/windows/desktop/dd371362).
...
-   Commands added to the [Quick Access Toolbar](windowsribbon-controls-quickaccesstoolbar.md) Command list by the user. Specified by an [**IUICollection**](https://msdn.microsoft.com/library/windows/desktop/dd371519) object through the [UI\_PKEY\_ItemsSource](windowsribbon-reference-properties-uipkey-itemssource.md) property key.
...
-   The preferred [Quick Access Toolbar](windowsribbon-controls-quickaccesstoolbar.md) docking state. Specified by the [**UI\_CONTROLDOCK**](https://msdn.microsoft.com/library/windows/desktop/dd371560) value of the [UI\_PKEY\_QuickAccessToolbarDock](windowsribbon-reference-properties-uipkey-quickaccesstoolbardock.md) property key.
    ...
    ![screen shot of the command context menu in the microsoft paint ribbon.](images/controls/qat-contextmenu-showbelow.png)
...
-   The ribbon minimized state as specified by the boolean value of the [UI\_PKEY\_Minimized](windowsribbon-reference-properties-uipkey-minimized.md) property key.
    ...
    ![screen shot of the command context menu in the microsoft paint ribbon.](images/controls/qat-contextmenu-minimize.png)
...
For optimal performance, the [**IUIRibbon::LoadSettingsFromStream**](https://msdn.microsoft.com/library/windows/desktop/dd371361) method should be called from the [**IUIApplication::OnViewChanged**](https://msdn.microsoft.com/library/windows/desktop/dd371537) callback function during the framework initialization phase, as shown in the following example.
