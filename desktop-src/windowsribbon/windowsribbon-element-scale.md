...
<td>xs:string<br/></td>
<td>Yes<br/></td>
<td>This value should correspond to one of the valid sizes for the <em>SizeDefinition</em> attribute of the associated [<strong>Group</strong>](windowsribbon-element-group.md) of controls specified in <em>Group</em>. <br/> Restricted to one of the following values: <br/> <br/>
<dt><span></span><span></span><strong></strong> (Popup)<br/> </dt> <dd> Identical control layout to <code>Large</code> but hosted in a pop-up or a drop-down pane.<br/> </dd> <dt><span></span><span></span><strong></strong> (Small)<br/> </dt> <dd> Small [<strong>SizeDefinition</strong>](windowsribbon-element-sizedefinition.md) template.<br/> </dd> <dt><span></span><span></span><strong></strong> (Medium)<br/> </dt> <dd> Medium [<strong>SizeDefinition</strong>](windowsribbon-element-sizedefinition.md) template.<br/> </dd> <dt><span></span><span></span><strong></strong> (Large)<br/> </dt> <dd> Large [<strong>SizeDefinition</strong>](windowsribbon-element-sizedefinition.md) template.<br/> </dd> </dl></td>
</tr>
</tbody>
</table>
