...
This document supplements the [Vector Markup Language (VML) specification](http://go.microsoft.com/fwlink/p/?linkid=161711) that was submitted to the World Wide Web Consortium (W3C). With this document and the complete VML specification, you should be able to use VML to design webpages. We have assumed that you already have a working knowledge of HTML.
