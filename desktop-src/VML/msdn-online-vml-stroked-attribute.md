...
[Stroked Attribute Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/examples/x_strokd.md). (Requires Microsoft Internet Explorer 5 or greater.)
