...
Similarly, you can place the &lt;fill&gt; sub-element inside the &lt;background&gt; element to describe how to fill the background of a Web page. You can then use the property attributes of the &lt;fill&gt; sub-element to customize the fill effect, such as [gradient fill](https://www.bing.com/search?q=gradient fill), [pattern fill](https://www.bing.com/search?q=pattern fill), or [picture fill](https://www.bing.com/search?q=picture fill).
