...
[StrokeColor Attribute Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/examples/x_strcol.md). (Requires Microsoft Internet Explorer 5 or greater.)
