...
-   [Simple Path Child Element Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/path/t_path.md)
-   [Dynamic Path Child Element Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/path/x_path.md)
