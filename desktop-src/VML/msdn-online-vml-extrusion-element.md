...
-   [Simple Shape Extrusion](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/extrusion/t_extrusion.md)
-   [Dynamic Shape Extrusion](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/extrusion/x_extrusion.md)
