...
| [HRef](vml-msdn_online_vml_h_elementref_attribute__imagedata__vml) | Defines a URL to the original image file.              |
...
-   [Simple Gradient Fill](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/fill/t_fill.md)
-   [Dynamic Fill Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/fill/x_fill.md)
