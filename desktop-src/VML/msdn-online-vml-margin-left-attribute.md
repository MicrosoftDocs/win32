...
[Margin-Left Attribute Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/examples/x_marlef.md). (Requires Microsoft Internet Explorer 5 or greater.)
