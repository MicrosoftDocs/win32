...
| [HRef](vml-msdn_online_vml_h_elementref_attribute__imagedata__vml) | Defines a URL for an image.                                           |
...
-   [Simple ImageData Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/image/t_image.md)
-   [Dynamic ImageData Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/image/x_image.md)
