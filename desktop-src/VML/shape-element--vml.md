...
| [HRef](vml-msdn_online_vml_h_elementref_attribute__shape__vml)                                     | Defines a URL for a shape. When the shape is clicked, the browser will load the URL.           |
...
In addition, you must put the following code in your [**HTML**](ie-mdL_Element_HTML_Object) element of your web page to obtain the correct schemas for VML and Microsoft Office Extensions. If you are not using Office Extensions, you can omit the second schema.
...
You must also have the following in your [**STYLE**](https://msdn.microsoft.com/library/ms535898) element to register the behavior of VML and Microsoft Office Extensions. If you are not using Office Extensions, you can omit the second behavior definition.
