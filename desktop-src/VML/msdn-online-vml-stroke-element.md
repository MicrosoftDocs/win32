...
| [HRef](vml-msdn_online_vml_h_elementref_attribute__stroke__vml)    | Defines the URL to the original image for the stroke.         |
...
-   [Simple Stroke Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/stroke/t_stroke.md)
-   [Stroke Image Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/stroke/x_stroke.md)
