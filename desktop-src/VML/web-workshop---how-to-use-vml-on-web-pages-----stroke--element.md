...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/DashStyle/Solid.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/DashStyle/dot.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/DashStyle/dash.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/DashStyle/dashdot.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/DashStyle/longdash.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/DashStyle/longdashdot.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/DashStyle/rect.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/Opacity/Line1.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/Opacity/Line2.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/LineStyle/Single.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/LineStyle/ThinThin.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/LineStyle/ThinThick.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/LineStyle/ThickThin.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/LineStyle/ThickBThin.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/JoinStyle/round.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/JoinStyle/bevel.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/JoinStyle/Miter.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/FillType/solid.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/FillType/pattern.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/FillType/tile.md)
...
[Show Me](http://samples.msdn.microsoft.com/workshop/samples/vml/examples/AdvancedLine/FillType/frame.md)

For more information about this element, see the [VML specification](http://www.w3.org/TR/NOTE-VML#-toc416858395) .
