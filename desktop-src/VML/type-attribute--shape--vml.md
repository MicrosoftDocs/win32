...
[Type Attribute Example](http://samples.msdn.microsoft.com/workshop/samples/vml/shape/examples/x_type.md). (Requires Microsoft Internet Explorer 5 or greater.)
