...
You can use the [**IX509Extension**](ix509extension.md) interface to define an arbitrary extension. The Certificate Enrollment API also provides interfaces derived from **IX509Extension** to enable you to easily create any of the most common extensions. The following list identifies the common extensions supported by Microsoft certification authorities, and the object identifiers and interfaces that you can use to create them.
...
**Interface:  **[**IX509ExtensionAlternativeNames**](ix509extensionalternativenames.md)
...
**Interface:  **[**IX509Extension**](ix509extension.md)
...
**Interface:  **[**IX509ExtensionAuthorityKeyIdentifier**](ix509extensionauthoritykeyidentifier.md)
...
**Interface:  **[**IX509ExtensionBasicConstraints**](ix509extensionbasicconstraints.md)
...
**Interface:  **[**IX509ExtensionCertificatePolicies**](ix509extensioncertificatepolicies.md)
...
**Interface:  **[**IX509ExtensionEnhancedKeyUsage**](ix509extensionenhancedkeyusage.md)
...
**Interface:  **[**IX509ExtensionKeyUsage**](ix509extensionkeyusage.md)
...
**Interface:  **[**IX509ExtensionMSApplicationPolicies**](ix509extensionmsapplicationpolicies.md)
...
**Interface:  **[**IX509ExtensionSmimeCapabilities**](ix509extensionsmimecapabilities.md)
...
**Interface:  **[**IX509ExtensionSubjectKeyIdentifier**](ix509extensionsubjectkeyidentifier.md)
...
**Interface:  **[**IX509ExtensionTemplate**](ix509extensiontemplate.md)
...
**Interface:  **[**IX509ExtensionTemplateName**](ix509extensiontemplatename.md)
