...
1.  Processes the following command line arguments:
    -   The name of a CNG [*cryptographic service provider*](https://docs.microsoft.com/windows/desktop/SecGloss/c-gly) (CSP).
    -   The name of the algorithm used to generate an asymmetric private key.
    -   The name of the algorithm used to [*hash*](https://docs.microsoft.com/windows/desktop/SecGloss/h-gly) the [*certificate request*](https://docs.microsoft.com/windows/desktop/SecGloss/c-gly).
...
7.  Creates a [*hashing algorithm*](https://docs.microsoft.com/windows/desktop/SecGloss/h-gly) [*object identifier*](https://docs.microsoft.com/windows/desktop/SecGloss/o-gly) (OID) from the algorithm name specified on the command line and sets the OID on the CMC request object.
8.  Signs the certificate request and encodes it by using [*Distinguished Encoding Rules*](https://docs.microsoft.com/windows/desktop/SecGloss/d-gly) (DER).
