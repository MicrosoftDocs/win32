...
8.  Creates an [**ICertConfig**](https://docs.microsoft.com/windows/desktop/api/certcli/nn-certcli-icertconfig) object and use it to retrieve a string that contains the CA configuration.
9.  Creates a CryptoAPI [**ICertRequest2**](https://docs.microsoft.com/windows/desktop/api/certcli/nn-certcli-icertrequest2) object and uses it plus the strings that contain the CA configuration and the certificate request to submit the request to the CA.
