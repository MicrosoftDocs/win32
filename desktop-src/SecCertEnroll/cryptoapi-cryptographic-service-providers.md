...
Providers associated with Cryptography API ([*CryptoAPI*](https://msdn.microsoft.com/library/windows/desktop/ms721572#-security-cryptoapi-gly)) are called cryptographic service providers (CSPs) in this documentation. CSPs typically implement cryptographic algorithms and provide key storage. Providers associated with CNG, on the other hand, separate algorithm implementation from key storage. The following Microsoft CSPs are distributed with Windows Vista and Windows Server 2008.
