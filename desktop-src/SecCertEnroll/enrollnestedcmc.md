...
7.  Creates an [**ICertConfig**](https://docs.microsoft.com/windows/desktop/api/certcli/nn-certcli-icertconfig) object and use it to retrieve a string that contains the CA configuration.
