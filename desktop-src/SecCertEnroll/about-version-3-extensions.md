...
| CRL Distribution Points(2.5.29.31)<br/>     | Contains the URI of the base [*certificate revocation list*](https://msdn.microsoft.com/library/windows/desktop/ms721572#-security-certificate-revocation-list-gly) (CRL).                                  |
