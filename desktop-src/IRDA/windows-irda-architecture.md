...
keywords: ["Infrared Data Association IrDA , described, architecture", "architecture IrDA", "networking IrDA , architecture", "infrared networking IrDA , Windows architecture"]
---
