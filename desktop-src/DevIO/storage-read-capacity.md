...
Contains information about the size of a device. This is returned from the [**IOCTL\_STORAGE\_READ\_CAPACITY**](ioctl-storage-read-capacity.md) control code.
...
[**IOCTL\_STORAGE\_READ\_CAPACITY**](ioctl-storage-read-capacity.md)
</dt> </dl>
