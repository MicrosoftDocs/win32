...
Contains the serial number of a USB device. It is used by the [**IOCTL\_STORAGE\_GET\_MEDIA\_SERIAL\_NUMBER**](/windows/win32/WinIoCtl/ni-winioctl-ioctl_storage_get_media_serial_number?branch=master) control code.
...
[**IOCTL\_STORAGE\_GET\_MEDIA\_SERIAL\_NUMBER**](/windows/win32/WinIoCtl/ni-winioctl-ioctl_storage_get_media_serial_number?branch=master)
</dt> </dl>
