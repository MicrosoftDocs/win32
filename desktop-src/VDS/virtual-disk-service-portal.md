...
VDS is available in the Microsoft Windows Software Development Kit (SDK). You can install the SDK for Windows 7 and Windows Server 2008 R2 from the [Windows Download Center](http://go.microsoft.com/fwlink/p/?linkid=139812). This version of the Windows SDK can be used to develop VDS applications for Windows Server 2003, Windows Vista, and later. You can also download the [ISO version](http://go.microsoft.com/fwlink/p/?linkid=160664) of the SDK from the Windows Download Center.
