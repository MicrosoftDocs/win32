...
> [!WARNING]
> Journaling Hooks APIs are unsupported starting in Windows 11 and will be removed in a future release. Because of this, we highly recommend calling the [**SendInput**](../api/winuser/nf-winuser-sendinput.md) TextInput API instead.
