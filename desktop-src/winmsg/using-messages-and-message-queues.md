...
The following example shows how to use [**PeekMessage**](https://msdn.microsoft.com/library/ms644943(v=VS.85).aspx) to examine a message queue for mouse clicks and keyboard input during a lengthy operation.
