...
| Name                                                 | Description                                                                                                                                                                                                                                                                                                                                                                |
|------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CreateMDIWindow**](createmdiwindow.md)           | Creates a MDI child window. <br/>                                                                                                                                                                                                                                                                                                                                    |
| [**DefFrameProc**](defframeproc.md)                 | Provides default processing for any window messages that the window procedure of a MDI frame window does not process. All window messages that are not explicitly processed by the window procedure must be passed to the [**DefFrameProc**](defframeproc.md) function, not the [**DefWindowProc**](defwindowproc.md) function. <br/>                              |
| [**DefMDIChildProc**](defmdichildproc.md)           | Provides default processing for any window message that the window procedure of a MDI child window does not process. A window message not processed by the window procedure must be passed to the [**DefMDIChildProc**](defmdichildproc.md) function, not to the [**DefWindowProc**](defwindowproc.md) function. <br/>                                             |
| [**TranslateMDISysAccel**](translatemdisysaccel.md) | Processes accelerator keystrokes for window menu commands of the MDI child windows associated with the specified MDI client window. The function translates [**WM\_KEYUP**](https://msdn.microsoft.com/library/windows/desktop/ms646281) and [**WM\_KEYDOWN**](https://msdn.microsoft.com/library/windows/desktop/ms646280) messages to [**WM\_SYSCOMMAND**](https://msdn.microsoft.com/library/windows/desktop/ms646360) messages and sends them to the appropriate MDI child windows. <br/> |
...
| Name                                       | Description                                                                                               |
|--------------------------------------------|-----------------------------------------------------------------------------------------------------------|
| [**MDICREATESTRUCT**](mdicreatestruct.md) | Contains information about the class, title, owner, location, and size of a MDI child window. <br/> |
