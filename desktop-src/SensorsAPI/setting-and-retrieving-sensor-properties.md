...
You can choose to retrieve a single property value, or to retrieve a collection of property values together. To retrieve single value, call [**ISensor::GetProperty**](https://www.bing.com/search?q=**ISensor::GetProperty**). To retrieve a collection of values, call [**ISensor::GetProperties**](https://www.bing.com/search?q=**ISensor::GetProperties**). You can retrieve all properties for a sensor by passing **NULL** through the first parameter to **ISensor::GetProperties**.
...
To set one or more values for properties, call [**ISensor::SetProperties**](https://www.bing.com/search?q=**ISensor::SetProperties**). You provide this method with an [IPortableDeviceValues](http://go.microsoft.com/fwlink/p/?linkid=134660) pointer that contains the collection of properties to set, and their associated values. The method returns a corresponding [IPortableDeviceValues](http://go.microsoft.com/fwlink/p/?linkid=134660) interface that may contain error codes for properties that could not be set.
