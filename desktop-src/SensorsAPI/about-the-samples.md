...
You can also download the AmbientLightAware sample from Code Gallery. For more information, see the [Ambient Light Aware](http://go.microsoft.com/fwlink/?LinkId=528001) download page.
