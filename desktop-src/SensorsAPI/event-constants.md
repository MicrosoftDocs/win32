...
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="SENSOR_EVENT_PARAMETER_EVENT_ID"></span><span id="sensor_event_parameter_event_id"></span><dl> <dt>**SENSOR\_EVENT\_PARAMETER\_EVENT\_ID**</dt> <dt>(PID = 2)</dt> </dl> | Indicates that the **GUID** value in [IPortableDeviceValues](http://go.microsoft.com/fwlink/p/?linkid=134660) is an event type ID, such as SENSOR\_EVENT\_DATA\_UPDATED.<br/> |
