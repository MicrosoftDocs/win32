...
After you have retrieved a sensor object, you can call [**ISensor::GetSupportedDataFields**](https://www.bing.com/search?q=**ISensor::GetSupportedDataFields**) to determine whether the sensor can provide the data you need.
