...
keywords: ["doWipeMethod method", "doWipeMethod method, MDM_RemoteWipe class", "MDM_RemoteWipe class, doWipeMethod method"]
topic_type:
- apiref
api_name:
...
Triggers the device to start the remote wipe. See also, [doWipe](https://msdn.microsoft.com/windows/hardware/commercialize/customize/mdm/remotewipe-csp#dowipe).
