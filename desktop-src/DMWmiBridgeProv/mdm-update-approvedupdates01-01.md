...
keywords: ["MDM_Update_ApprovedUpdates01_01 class", "MDM_Update_ApprovedUpdates01_01 class, described"]
topic_type:
- apiref
api_name:
...
[ApprovedTime](https://docs.microsoft.com/windows/client-management/mdm/update-csp#approvedupdates-approved-update-guid-approvedtime)
</dt> <dd> <dl> <dt>
