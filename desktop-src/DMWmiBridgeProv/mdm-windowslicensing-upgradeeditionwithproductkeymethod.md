...
keywords: ["UpgradeEditionWithProductKeyMethod method", "UpgradeEditionWithProductKeyMethod method, MDM_WindowsLicensing class", "MDM_WindowsLicensing class, UpgradeEditionWithProductKeyMethod method"]
topic_type:
- apiref
api_name:
...
Enters a product key for an edition upgrade of Windows 10 desktop devices. See also, [UpgradeEditionWithProductKey](https://msdn.microsoft.com/windows/hardware/commercialize/customize/mdm/windowslicensing-csp#upgradeeditionwithproductkey).
