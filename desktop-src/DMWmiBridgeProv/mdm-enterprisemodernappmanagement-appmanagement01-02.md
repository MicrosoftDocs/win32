...
keywords: ["MDM_EnterpriseModernAppManagement_AppManagement01_02 class", "MDM_EnterpriseModernAppManagement_AppManagement01_02 class, described"]
topic_type:
- apiref
api_name:
...
[DoNotUpdate](https://docs.microsoft.com/windows/client-management/mdm/enterprisemodernappmanagement-csp#----packagefamilyname-donotupdate)
</dt> <dd> <dl> <dt>
