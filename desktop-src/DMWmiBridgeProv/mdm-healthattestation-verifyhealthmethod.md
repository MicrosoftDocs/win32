...
Method to notify the device to prepare a health certificate verification request. See also, [VerifyHealth](https://docs.microsoft.com/windows/client-management/mdm/healthattestation-csp).
