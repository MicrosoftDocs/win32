...
The **MDM\_Policy\_Result01\_Licensing02** class represents the licensing policies available.
...
The **MDM\_Policy\_Result01\_Licensing02** class has these types of members:

-   [Properties](#properties)

### Properties

The **MDM\_Policy\_Result01\_Licensing02** class has these properties.

<dl> <dt>

[AllowWindowsEntitlementReactivation](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-licensing#licensing-allowwindowsentitlementreactivation)
</dt> <dd> <dl> <dt>
...
[DisallowKMSClientOnlineAVSValidation](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-licensing#licensing-disallowkmsclientonlineavsvalidation)
</dt> <dd> <dl> <dt>
