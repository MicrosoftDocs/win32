...
Method to perform an install of an app and a license from the Windows Store. See also, [StoreInstall](https://docs.microsoft.com/windows/client-management/mdm/enterprisemodernappmanagement-csp).
