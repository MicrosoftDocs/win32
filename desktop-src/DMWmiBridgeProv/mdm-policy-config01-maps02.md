---
title: MDM\_Policy\_Config01\_Maps02 class
description: The MDM\_Policy\_Config01\_Maps02 class represents the map policies available.
ms.assetid: 'd2965f1f-a858-4b43-9c46-17ba718291b1'
keywords: ["MDM_Policy_Config01_Maps02 class", "MDM_Policy_Config01_Maps02 class, described"]
topic_type:
- apiref
api_name:
...
# MDM\_Policy\_Config01\_Maps02 class

\[Some information relates to pre-released product which may be substantially modified before it's commercially released. Microsoft makes no warranties, express or implied, with respect to the information provided here.\]

The **MDM\_Policy\_Config01\_Maps02** class represents the map policies available.
...
The **MDM\_Policy\_Config01\_Maps02** class has these types of members:

-   [Properties](#properties)

### Properties

The **MDM\_Policy\_Config01\_Maps02** class has these properties.
