...
keywords: ["MDM_ActiveSync_User_Options03 class", "MDM_ActiveSync_User_Options03 class, described"]
topic_type:
- apiref
api_name:
...
[Logging](https://docs.microsoft.com/windows/client-management/mdm/activesync-csp#options-logging)
</dt> <dd> <dl> <dt>
...
[MailAgeFilter](https://docs.microsoft.com/windows/client-management/mdm/activesync-csp#options-mailagefilter)
</dt> <dd> <dl> <dt>
...
[Schedule](https://docs.microsoft.com/windows/client-management/mdm/activesync-csp#options-schedule)
</dt> <dd> <dl> <dt>
...
[UseSSL](https://docs.microsoft.com/windows/client-management/mdm/activesync-csp#options-usessl)
</dt> <dd> <dl> <dt>
