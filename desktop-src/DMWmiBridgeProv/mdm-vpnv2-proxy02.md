...
keywords: ["MDM_VPNv2_Proxy02 class", "MDM_VPNv2_Proxy02 class, described"]
topic_type:
- apiref
api_name:
- MDM_VPNv2_Proxy02
...
The **MDM\_VPNv2\_Proxy02** class has these types of members:

-   [Properties](#properties)

### Properties

The **MDM\_VPNv2\_Proxy02** class has these properties.

<dl> <dt>

[AutoConfigUrl](https://docs.microsoft.com/windows/client-management/mdm/vpnv2-csp#vpnv2-profilename-proxy-autoconfigurl)
</dt> <dd> <dl> <dt>
...
Identifies the name of the parent node. A collection of configuration objects to enable a post-connect proxy support for VPN. The proxy defined for this profile is applied when this profile is active and connected.
