...
keywords: ["MDM_Policy_Result01_Cryptography02 class", "MDM_Policy_Result01_Cryptography02 class, described"]
topic_type:
- apiref
api_name:
...
[AllowFipsAlgorithmPolicy](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-cryptography#cryptography-allowfipsalgorithmpolicy)
</dt> <dd> <dl> <dt>
...
[TLSCipherSuites](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-cryptography#cryptography-tlsciphersuites)
</dt> <dd> <dl> <dt>
