...
keywords: ["MDM_WindowsAdvancedThreatProtection class", "MDM_WindowsAdvancedThreatProtection class, described"]
topic_type:
- apiref
api_name:
...
[Offboarding](https://docs.microsoft.com/windows/client-management/mdm/windowsadvancedthreatprotection-csp#offboarding)
</dt> <dd> <dl> <dt>
...
[Onboarding](https://docs.microsoft.com/windows/client-management/mdm/windowsadvancedthreatprotection-csp#onboarding)
</dt> <dd> <dl> <dt>
