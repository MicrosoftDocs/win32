...
keywords: ["MDM_DevDetail_Ext01 class", "MDM_DevDetail_Ext01 class, described"]
topic_type:
- apiref
api_name:
- MDM_DevDetail_Ext01
...
[DeviceHardwareData](https://docs.microsoft.com/windows/client-management/mdm/devdetail-csp#devicehardwaredata)
</dt> <dd> <dl> <dt>
...
[WLANMACAddress](https://docs.microsoft.com/windows/client-management/mdm/devdetail-csp#ext-wlanmacaddress)
</dt> <dd> <dl> <dt>
