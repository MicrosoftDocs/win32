...
[UseRemotePassport](https://msdn.microsoft.com/windows/hardware/commercialize/customize/mdm/passportforwork-csp#tenantid-policies-remote-useremotepassport--only-for---device-vendor-msft-)
</dt> <dd> <dl> <dt>
