...
keywords: ["MDM_PassportForWork_Device_Policies02 class", "MDM_PassportForWork_Device_Policies02 class, described"]
topic_type:
- apiref
api_name:
...
# MDM\_PassportForWork\_Device\_Policies02 class
...
The **MDM\_PassportForWork\_Device\_Policies02** class has these types of members:

-   [Properties](#properties)

### Properties

The **MDM\_PassportForWork\_Device\_Policies02** class has these properties.
...
[UseCertificateForOnPremAuth](https://msdn.microsoft.com/windows/hardware/commercialize/customize/mdm/passportforwork-csp#)
</dt> <dd> <dl> <dt>
