...
keywords: ["MDM_DeviceStatus_Battery01 class", "MDM_DeviceStatus_Battery01 class, described"]
topic_type:
- apiref
api_name:
...
[EstimatedChargeRemaining](https://docs.microsoft.com/windows/client-management/mdm/devicestatus-csp#devicestatus-battery-estimatedchargeremaining)
</dt> <dd> <dl> <dt>
...
[EstimatedRuntime](https://docs.microsoft.com/windows/client-management/mdm/devicestatus-csp#devicestatus-battery-estimatedruntime)
</dt> <dd> <dl> <dt>
