...
|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| [**IsSamePathAs**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-issamepathas)<br/>                   | Verifies if the specified binding path is the same as this binding path.<br/>                    |
| [**IsSubPathOf**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-issubpathof)<br/>                     | Verifies if this binding path is a subpath of the specified binding path.<br/>                   |
| [**IsEnabled**](/windows/desktop/api/Netcfgx/nf-netcfgx-inetcfgbindingpath-isenabled)<br/>                         | Retrieves the current state of a binding path.<br/>                                              |
| [**Enable**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-enable)<br/>                               | Sets the state of a binding path to enabled or disabled.<br/>                                    |
| [**GetPathToken**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-getpathtoken)<br/>                   | Retrieves the identifier of a binding path that is unique across operating system reboots.<br/>  |
| [**GetOwner**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-getowner)<br/>                           | Retrieves the network component that owns a binding path.<br/>                                   |
| [**GetDepth**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-getdepth)<br/>                           | Retrieves the number of network components contained in a binding path.<br/>                     |
| [**EnumBindingInterfaces**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-enumbindinginterfaces)<br/> | Retrieves an enumeration of a collection of binding interfaces contained in a binding path.<br/> |
