...
|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| [**Install**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentsetup-install)<br/>               | Performs operations required to install the network component that owns the notify object.<br/> |
| [**Upgrade**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentsetup-upgrade)<br/>               | Modifies the network component, if required, when the operating system upgrades.<br/>           |
| [**ReadAnswerFile**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentsetup-readanswerfile)<br/> | Retrieves parameters from a file to configure the network component.<br/>                       |
| [**Removing**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentsetup-removing)<br/>             | Performs operations required to remove the network component that owns the notify object.<br/>  |
