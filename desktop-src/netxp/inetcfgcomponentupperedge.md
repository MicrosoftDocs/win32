...
|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| [**GetInterfaceIdsForAdapter**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentupperedge-getinterfaceidsforadapter)<br/>     | Retrieves interfaces associated with a specific network adapter.<br/> |
| [**AddInterfacesToAdapter**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentupperedge-addinterfacestoadapter)<br/>           | Adds interfaces to a specific network adapter.<br/>                   |
| [**RemoveInterfacesFromAdapter**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentupperedge-removeinterfacesfromadapter)<br/> | Removes interfaces from a specific network adapter.<br/>              |
