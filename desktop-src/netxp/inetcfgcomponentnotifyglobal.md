...
|--------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| [**GetSupportedNotifications**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentnotifyglobal-getsupportednotifications)<br/> | Retrieves the types of notifications required by a notify object.<br/> |
| [**SysQueryBindingPath**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentnotifyglobal-sysquerybindingpath)<br/>             | Evaluates a pending binding path change.<br/>                          |
| [**SysNotifyBindingPath**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentnotifyglobal-sysnotifybindingpath)<br/>           | Performs operations resulting from a binding path change.<br/>         |
| [**SysNotifyComponent**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentnotifyglobal-sysnotifycomponent)<br/>               | Performs operations resulting from a component change.<br/>            |
