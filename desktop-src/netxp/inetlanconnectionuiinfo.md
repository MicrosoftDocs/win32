...
|---------------------------------------------------------------------------|--------------------------------------------------------------|
| [**GetDeviceGuid**](/windows/desktop/api/netcfgn/nf-netcfgn-inetlanconnectionuiinfo-getdeviceguid)<br/> | Retrieves a pointer to the GUID for a LAN device.<br/> |
