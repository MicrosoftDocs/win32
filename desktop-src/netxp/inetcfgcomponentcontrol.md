...
|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| [**Initialize**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentcontrol-initialize)<br/>                     | Initializes the network component's notify object.<br/>                                               |
| [**ApplyRegistryChanges**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentcontrol-applyregistrychanges)<br/> | Applies to the registry changes made to the network component's configuration.<br/>                   |
| [**ApplyPnpChanges**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentcontrol-applypnpchanges)<br/>           | Informs the notify object of the network component that it can configure its component's driver.<br/> |
| [**CancelChanges**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentcontrol-cancelchanges)<br/>               | Disregards proposed changes for the network component's configuration.<br/>                           |
