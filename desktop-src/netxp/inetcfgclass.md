...
|------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| [**FindComponent**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgclass-findcomponent)<br/>   | Retrieves a network component belonging to a particular type.<br/>                                |
| [**EnumComponents**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgclass-enumcomponents)<br/> | Retrieves an enumeration containing a collection of network components of a particular type.<br/> |
...
Notify objects call the [**INetCfg::QueryNetCfgClass**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfg-querynetcfgclass) method to obtain a pointer to a **INetCfgClass** interface.
