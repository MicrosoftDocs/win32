...
The **IProvisioningProfileWireless** interface supports the [preferred profile provisioning](preferred-profile-provisioning.md)method.

The XML data used in this interface is based on the [WirelessProfile schema](wirelessprofile-schema.md).
