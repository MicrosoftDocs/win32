...
|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| [**GetDisplayName**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getdisplayname)<br/>         | Retrieves the name of a component that displays in a network connection's property sheet.<br/>   |
| [**SetDisplayName**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-setdisplayname)<br/>         | Sets the name of a component that displays in a network connection's property sheet.<br/>        |
| [**GetHelpText**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-gethelptext)<br/>               | Retrieves a component's description that displays in a network connection's property sheet.<br/> |
| [**GetId**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getid)<br/>                           | Retrieves a component's identifier.<br/>                                                         |
| [**GetCharacteristics**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getcharacteristics)<br/> | Retrieves a component's characteristics.<br/>                                                    |
| [**GetInstanceGuid**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getinstanceguid)<br/>       | Retrieves a component's instance GUID.<br/>                                                      |
| [**GetPnpDevNodeId**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getpnpdevnodeid)<br/>       | Retrieves the identifier of a component's Plug and Play device node.<br/>                        |
| [**GetClassGuid**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getclassguid)<br/>             | Retrieves the class GUID for a component's type.<br/>                                            |
| [**GetBindName**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getbindname)<br/>               | Retrieves a component's description for binding operations.<br/>                                 |
| [**GetDeviceStatus**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-getdevicestatus)<br/>       | Retrieves the status of a network card.<br/>                                                     |
| [**OpenParamKey**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-openparamkey)<br/>             | Opens and retrieves the registry key that contains parameters for a network component.<br/>      |
| [**RaisePropertyUi**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgcomponent-raisepropertyui)<br/>       | Displays a component's property sheet so users can modify the component's properties.<br/>       |
