...
|---------------------------------------------------------------|---------------------------------------------------------------------------------------|
| [**Next**](/windows/desktop/api/netcfgx/nf-netcfgx-ienumnetcfgbindinginterface-next)<br/>   | Retrieves the next specified number of items in the enumeration sequence.<br/>  |
| [**Skip**](/windows/desktop/api/netcfgx/nf-netcfgx-ienumnetcfgbindinginterface-skip)<br/>   | Skips over the next specified number of items in the enumeration sequence.<br/> |
| [**Reset**](/windows/desktop/api/Netcfgx/nf-netcfgx-ienumnetcfgbindinginterface-reset)<br/> | Resets the enumeration sequence to the beginning item.<br/>                     |
| [**Clone**](/windows/desktop/api/Netcfgx/nf-netcfgx-ienumnetcfgbindinginterface-clone)<br/> | The **Clone**method is not implemented. Do not use it in your driver.<br/>      |
...
Notify objects call the [**INetCfgBindingPath::EnumBindingInterfaces**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-enumbindinginterfaces)method to obtain a pointer to **IEnumNetCfgBindingInterface**.

### See Also

[**INetCfgBindingInterface**](inetcfgbindinginterface.md), [**INetCfgBindingPath::EnumBindingInterfaces**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindingpath-enumbindinginterfaces)
