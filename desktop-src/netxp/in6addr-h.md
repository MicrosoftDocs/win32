---
Description: 'This section contains reference topics for the In6Addr.h header.'
ms.assetid: 'AF11DFE9-5B13-43CE-9D79-659359B82537'
title: 'In6Addr.h'
---

# In6Addr.h

This section contains reference topics for the In6Addr.h header.
...
| Topic                                   | Description                                                           |
|-----------------------------------------|-----------------------------------------------------------------------|
| [**IPv6Addr**](ipv6addr.md)<br/> | The IPv6Addr structure describes an IPv6 network address. <br/> |
