...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| [**AcquireWriteLock**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfglock-acquirewritelock)<br/> | Requests a lock on network configuration for a particular client.<br/>               |
| [**ReleaseWriteLock**](/windows/desktop/api/Netcfgx/nf-netcfgx-inetcfglock-releasewritelock)<br/> | Releases a previously obtained lock on network configuration.<br/>                   |
| [**IsWriteLocked**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfglock-iswritelocked)<br/>       | Indicates the name of the client that currently controls network configuration.<br/> |
