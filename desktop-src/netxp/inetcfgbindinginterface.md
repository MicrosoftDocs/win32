...
|-----------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| [**GetName**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindinginterface-getname)<br/>                     | Retrieves the name of a binding interface.<br/>                                          |
| [**GetUpperComponent**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindinginterface-getuppercomponent)<br/> | Retrieves the network component connected to the upper part of a binding interface.<br/> |
| [**GetLowerComponent**](/windows/desktop/api/netcfgx/nf-netcfgx-inetcfgbindinginterface-getlowercomponent)<br/> | Retrieves the network component connected to the lower part of a binding interface.<br/> |
