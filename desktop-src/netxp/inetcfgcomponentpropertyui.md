...
|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| [**QueryPropertyUi**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentpropertyui-querypropertyui)<br/>       | Determines if the given context is appropriate for displaying properties for the component that owns the notify object.<br/>             |
| [**SetContext**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentpropertyui-setcontext)<br/>                 | Directs the component's notify object to display the component's properties in the context of a particular binding path or adapter.<br/> |
| [**MergePropPages**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentpropertyui-mergeproppages)<br/>         | Creates custom property pages and merges them into the component's default set.<br/>                                                     |
| [**ValidateProperties**](/windows/desktop/api/netcfgn/nf-netcfgn-inetcfgcomponentpropertyui-validateproperties)<br/> | Checks proposed changes for the component's properties.<br/>                                                                             |
| [**ApplyProperties**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentpropertyui-applyproperties)<br/>       | Stores, in memory, proposed changes for the component's properties.<br/>                                                                 |
| [**CancelProperties**](/windows/desktop/api/Netcfgn/nf-netcfgn-inetcfgcomponentpropertyui-cancelproperties)<br/>     | Disregards proposed changes for the component's properties.<br/>                                                                         |
