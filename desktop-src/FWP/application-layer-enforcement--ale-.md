...
Filters in the ALE layers authorize inbound and outbound connection creation, port assignments, socket operations such as [**listen()**](https://msdn.microsoft.com/library/windows/desktop/ms739168), raw socket creation, and promiscuous mode receiving.
