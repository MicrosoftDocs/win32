...
api_name: 
- MSFT_NetUDPEndpoint
- MSFT_NetUDPEndpoint.Caption
- MSFT_NetUDPEndpoint.Description
- MSFT_NetUDPEndpoint.ElementName
- MSFT_NetUDPEndpoint.InstallDate
- MSFT_NetUDPEndpoint.Name
- MSFT_NetUDPEndpoint.OperationalStatus
- MSFT_NetUDPEndpoint.StatusDescriptions
- MSFT_NetUDPEndpoint.Status
- MSFT_NetUDPEndpoint.HealthState
- MSFT_NetUDPEndpoint.CommunicationStatus
- MSFT_NetUDPEndpoint.DetailedStatus
- MSFT_NetUDPEndpoint.OperatingStatus
- MSFT_NetUDPEndpoint.PrimaryStatus
- MSFT_NetUDPEndpoint.OtherEnabledState
- MSFT_NetUDPEndpoint.EnabledDefault
- MSFT_NetUDPEndpoint.TimeOfLastStateChange
- MSFT_NetUDPEndpoint.TransitioningToState
- MSFT_NetUDPEndpoint.AvailableRequestedStates
- MSFT_NetUDPEndpoint.InstanceID
- MSFT_NetUDPEndpoint.EnabledState
- MSFT_NetUDPEndpoint.RequestedState
- MSFT_NetUDPEndpoint.Directionality
- MSFT_NetUDPEndpoint.AggregationBehavior
- MSFT_NetUDPEndpoint.LocalAddress
- MSFT_NetUDPEndpoint.LocalPort
api_type: 
- DllExport
api_location: 
- NetTCPIP.dll
...
# MSFT\_NetUDPEndpoint class

Represents the UDP connection for the Microsoft TCP/IP WMI v2 provider.
...
The **MSFT\_NetUDPEndpoint** class has these types of members:
...
The **MSFT\_NetUDPEndpoint** class has these properties.
...
This property is inherited from [**MSFT\_NetTransportConnection**](msft-nettransportconnection.md).
