...
- MSFT_NetTCPConnection.Caption
- MSFT_NetTCPConnection.Description
- MSFT_NetTCPConnection.ElementName
- MSFT_NetTCPConnection.InstallDate
- MSFT_NetTCPConnection.Name
- MSFT_NetTCPConnection.OperationalStatus
- MSFT_NetTCPConnection.StatusDescriptions
- MSFT_NetTCPConnection.Status
- MSFT_NetTCPConnection.HealthState
- MSFT_NetTCPConnection.CommunicationStatus
- MSFT_NetTCPConnection.DetailedStatus
- MSFT_NetTCPConnection.OperatingStatus
- MSFT_NetTCPConnection.PrimaryStatus
- MSFT_NetTCPConnection.OtherEnabledState
- MSFT_NetTCPConnection.EnabledDefault
- MSFT_NetTCPConnection.TimeOfLastStateChange
- MSFT_NetTCPConnection.TransitioningToState
- MSFT_NetTCPConnection.AvailableRequestedStates
- MSFT_NetTCPConnection.InstanceID
- MSFT_NetTCPConnection.EnabledState
- MSFT_NetTCPConnection.RequestedState
- MSFT_NetTCPConnection.Directionality
- MSFT_NetTCPConnection.AggregationBehavior
- MSFT_NetTCPConnection.LocalAddress
- MSFT_NetTCPConnection.LocalPort
- MSFT_NetTCPConnection.RemoteAddress
- MSFT_NetTCPConnection.RemotePort
- MSFT_NetTCPConnection.State
- MSFT_NetTCPConnection.AppliedSetting
- MSFT_NetTCPConnection.OwningProcess
- MSFT_NetTCPConnection.CreationTime
- MSFT_NetTCPConnection.OffloadState
api_type: 
- DllExport
api_location: 
- NetTCPIP.dll
...
The **MSFT\_NetTCPConnection** class has these types of members:
...
The **MSFT\_NetTCPConnection** class has these properties.
...
The name of the setting applied for this TCP connection. For information about these settings, see [**MSFT\_NetTCPSetting**](msft-nettcpsetting.md).

<dl> <dt>

<span id="Internet"></span><span id="internet"></span><span id="INTERNET"></span>**Internet** (0)
</dt> <dt>

<span id="Datacenter"></span><span id="datacenter"></span><span id="DATACENTER"></span>**Datacenter** (1)
</dt> <dt>

<span id="Compat"></span><span id="compat"></span><span id="COMPAT"></span>**Compat** (2)
</dt> <dt>

<span id="InternetCustom"></span><span id="internetcustom"></span><span id="INTERNETCUSTOM"></span>**InternetCustom** (3)
</dt> <dt>

<span id="DatacenterCustom"></span><span id="datacentercustom"></span><span id="DATACENTERCUSTOM"></span>**DatacenterCustom** (4)
</dt> </dl>
...
The creation time of the TCP connection.
...
<span id="InHost"></span><span id="inhost"></span><span id="INHOST"></span>**InHost** (0)
</dt> <dt>

<span id="Offloading"></span><span id="offloading"></span><span id="OFFLOADING"></span>**Offloading** (1)
</dt> <dt>

<span id="Offloaded"></span><span id="offloaded"></span><span id="OFFLOADED"></span>**Offloaded** (2)
</dt> <dt>

<span id="Uploading"></span><span id="uploading"></span><span id="UPLOADING"></span>**Uploading** (3)
</dt> </dl>
...
The PID of the owning process of the TCP connection.
...
| Value                                                                                                                                                                                                                                       | Meaning                                                                                                                                                           |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="Closed"></span><span id="closed"></span><span id="CLOSED"></span><dl> <dt>**Closed**</dt> <dt>1</dt> </dl>                     | Represents no connection state at all.<br/>                                                                                                                 |
| <span id="Listen"></span><span id="listen"></span><span id="LISTEN"></span><dl> <dt>**Listen**</dt> <dt>2</dt> </dl>                     | Waiting for a connection request from any remote TCP and port.<br/>                                                                                         |
| <span id="SynSent"></span><span id="synsent"></span><span id="SYNSENT"></span><dl> <dt>**SynSent**</dt> <dt>3</dt> </dl>                 | Waiting for a matching connection request after having sent a connection request (SYN packet).<br/>                                                         |
| <span id="SynReceived"></span><span id="synreceived"></span><span id="SYNRECEIVED"></span><dl> <dt>**SynReceived**</dt> <dt>4</dt> </dl> | Waiting for a confirming connection request acknowledgment after having both received and sent a connection request (SYN packet).<br/>                      |
| <span id="Established"></span><span id="established"></span><span id="ESTABLISHED"></span><dl> <dt>**Established**</dt> <dt>5</dt> </dl> | Represents an open connection, data received can be delivered to the user. This is the normal state for the data transfer phase of the TCP connection.<br/> |
| <span id="FinWait1"></span><span id="finwait1"></span><span id="FINWAIT1"></span><dl> <dt>**FinWait1**</dt> <dt>6</dt> </dl>             | Waiting for a connection termination request from the remote TCP, or an acknowledgment of the connection termination request previously sent.<br/>          |
| <span id="FinWait2"></span><span id="finwait2"></span><span id="FINWAIT2"></span><dl> <dt>**FinWait2**</dt> <dt>7</dt> </dl>             | Waiting for a connection termination request from the remote TCP.<br/>                                                                                      |
| <span id="CloseWait"></span><span id="closewait"></span><span id="CLOSEWAIT"></span><dl> <dt>**CloseWait**</dt> <dt>8</dt> </dl>         | Waiting for a connection termination request from the local user.<br/>                                                                                      |
| <span id="Closing"></span><span id="closing"></span><span id="CLOSING"></span><dl> <dt>**Closing**</dt> <dt>9</dt> </dl>                 | Waiting for a connection termination request acknowledgment from the remote TCP.<br/>                                                                       |
| <span id="LastAck"></span><span id="lastack"></span><span id="LASTACK"></span><dl> <dt>**LastAck**</dt> <dt>10</dt> </dl>                | Waiting for an acknowledgment of the connection termination request previously sent to the remote TCP. <br/>                                                |
| <span id="TimeWait"></span><span id="timewait"></span><span id="TIMEWAIT"></span><dl> <dt>**TimeWait**</dt> <dt>11</dt> </dl>            | Waiting for enough time to pass to be sure the remote TCP received the acknowledgment of its connection termination request.<br/>                           |
| <span id="DeleteTCB"></span><span id="deletetcb"></span><span id="DELETETCB"></span><dl> <dt>**DeleteTCB**</dt> <dt>12</dt> </dl>        | Represents the deletion of the Transmission Control Block (TCB), a data structure used to maintain information on each TCP entry.<br/>                      |
