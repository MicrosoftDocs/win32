...
- MSFT_NetTransportConnection.Caption
- MSFT_NetTransportConnection.Description
- MSFT_NetTransportConnection.ElementName
- MSFT_NetTransportConnection.InstallDate
- MSFT_NetTransportConnection.Name
- MSFT_NetTransportConnection.OperationalStatus
- MSFT_NetTransportConnection.StatusDescriptions
- MSFT_NetTransportConnection.Status
- MSFT_NetTransportConnection.HealthState
- MSFT_NetTransportConnection.CommunicationStatus
- MSFT_NetTransportConnection.DetailedStatus
- MSFT_NetTransportConnection.OperatingStatus
- MSFT_NetTransportConnection.PrimaryStatus
- MSFT_NetTransportConnection.OtherEnabledState
- MSFT_NetTransportConnection.EnabledDefault
- MSFT_NetTransportConnection.TimeOfLastStateChange
- MSFT_NetTransportConnection.TransitioningToState
- MSFT_NetTransportConnection.AvailableRequestedStates
- MSFT_NetTransportConnection.InstanceID
- MSFT_NetTransportConnection.EnabledState
- MSFT_NetTransportConnection.RequestedState
- MSFT_NetTransportConnection.Directionality
- MSFT_NetTransportConnection.AggregationBehavior
- MSFT_NetTransportConnection.LocalAddress
- MSFT_NetTransportConnection.LocalPort
api_type: 
- DllExport
api_location: 
- NetTCPIP.dll
...
# MSFT\_NetTransportConnection class

Represents the transport connection for the Microsoft TCP/IP WMI v2 provider.
...
The **MSFT\_NetTransportConnection** class has these types of members:
...
The **MSFT\_NetTransportConnection** class has these properties.
...
<span id="No_Lower-Level_Composition"></span><span id="no_lower-level_composition"></span><span id="NO_LOWER-LEVEL_COMPOSITION"></span>**No Lower-Level Composition** (2)
</dt> <dt>

<span id="Combined_In_Parallel"></span><span id="combined_in_parallel"></span><span id="COMBINED_IN_PARALLEL"></span>**Combined In Parallel** (3)
</dt> <dt>

<span id="Combined_In_Sequence"></span><span id="combined_in_sequence"></span><span id="COMBINED_IN_SEQUENCE"></span>**Combined In Sequence** (4)
</dt> </dl>
...
Indicates the directionality of the pipe. For unidirectional pipes, the source and sink are indicated by a property (SourceOrSink) of the association, EndpointOfNetworkPipe.
...
<span id="Bi-Directional"></span><span id="bi-directional"></span><span id="BI-DIRECTIONAL"></span>**Bi-Directional** (2)
</dt> <dt>

<span id="Unidirectional"></span><span id="unidirectional"></span><span id="UNIDIRECTIONAL"></span>**Unidirectional** (3)
</dt> </dl>
...
The local address of the transport connection.
...
The local port of the transport connection.
...
| Value                                                                                                                                                                                                                                                                 | Meaning                                                                                                                                                                                                                               |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="Unknown"></span><span id="unknown"></span><span id="UNKNOWN"></span><dl> <dt>**Unknown**</dt> <dt>0</dt> </dl>                                           | the last requested state for the element is unknown.<br/>                                                                                                                                                                       |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>2</dt> </dl>                                           |                                                                                                                                                                                                                                       |
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>3</dt> </dl>                                       | requests an immediate disabling of the element, such that it will not execute or accept any commands or processing requests.<br/>                                                                                               |
| <span id="Shut_Down"></span><span id="shut_down"></span><span id="SHUT_DOWN"></span><dl> <dt>**Shut Down**</dt> <dt>4</dt> </dl>                                   | Requests an orderly transition to the Disabled state, and might involve removing power, to completely erase any existing state.<br/>                                                                                            |
| <span id="No_Change"></span><span id="no_change"></span><span id="NO_CHANGE"></span><dl> <dt>**No Change**</dt> <dt>5</dt> </dl>                                   | Deprecated in lieu of indicating the last requested state is "Unknown" (0). If the last requested or desired state is unknown, RequestedState should have the value "Unknown" (0), but may have the value "No Change" (5).<br/> |
| <span id="Offline"></span><span id="offline"></span><span id="OFFLINE"></span><dl> <dt>**Offline**</dt> <dt>6</dt> </dl>                                           | The element has been requested to transition to the Enabled but Offline EnabledState. <br/>                                                                                                                                     |
| <span id="Test"></span><span id="test"></span><span id="TEST"></span><dl> <dt>**Test**</dt> <dt>7</dt> </dl>                                                       |                                                                                                                                                                                                                                       |
| <span id="Deferred"></span><span id="deferred"></span><span id="DEFERRED"></span><dl> <dt>**Deferred**</dt> <dt>8</dt> </dl>                                       |                                                                                                                                                                                                                                       |
| <span id="Quiesce"></span><span id="quiesce"></span><span id="QUIESCE"></span><dl> <dt>**Quiesce**</dt> <dt>9</dt> </dl>                                           |                                                                                                                                                                                                                                       |
| <span id="Reboot"></span><span id="reboot"></span><span id="REBOOT"></span><dl> <dt>**Reboot**</dt> <dt>10</dt> </dl>                                              | Refers to doing a "Shut Down" and then moving to an "Enabled" state.<br/>                                                                                                                                                       |
| <span id="Reset"></span><span id="reset"></span><span id="RESET"></span><dl> <dt>**Reset**</dt> <dt>11</dt> </dl>                                                  | Reset indicates that the element is first "Disabled" and then "Enabled". <br/>                                                                                                                                                  |
| <span id="Not_Applicable"></span><span id="not_applicable"></span><span id="NOT_APPLICABLE"></span><dl> <dt>**Not Applicable**</dt> <dt>12</dt> </dl>              | Knowledge of the last RequestedState is not supported for the EnabledLogicalElement.<br/>                                                                                                                                       |
| <span id="DMTF_Reserved"></span><span id="dmtf_reserved"></span><span id="DMTF_RESERVED"></span><dl> <dt>**DMTF Reserved**</dt> <dt>13 32767</dt> </dl>            |                                                                                                                                                                                                                                       |
| <span id="Vendor_Reserved"></span><span id="vendor_reserved"></span><span id="VENDOR_RESERVED"></span><dl> <dt>**Vendor Reserved**</dt> <dt>32768 65535</dt> </dl> |                                                                                                                                                                                                                                       |
