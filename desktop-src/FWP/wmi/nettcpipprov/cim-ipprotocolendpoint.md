...
- CIM_IPProtocolEndpoint.InstanceID
- CIM_IPProtocolEndpoint.Caption
- CIM_IPProtocolEndpoint.ElementName
- CIM_IPProtocolEndpoint.InstallDate
- CIM_IPProtocolEndpoint.StatusDescriptions
- CIM_IPProtocolEndpoint.Status
- CIM_IPProtocolEndpoint.HealthState
- CIM_IPProtocolEndpoint.CommunicationStatus
- CIM_IPProtocolEndpoint.DetailedStatus
- CIM_IPProtocolEndpoint.OperatingStatus
- CIM_IPProtocolEndpoint.PrimaryStatus
- CIM_IPProtocolEndpoint.OtherEnabledState
- CIM_IPProtocolEndpoint.RequestedState
- CIM_IPProtocolEndpoint.EnabledDefault
- CIM_IPProtocolEndpoint.TransitioningToState
- CIM_IPProtocolEndpoint.AvailableRequestedStates
- CIM_IPProtocolEndpoint.SystemCreationClassName
- CIM_IPProtocolEndpoint.SystemName
- CIM_IPProtocolEndpoint.CreationClassName
- CIM_IPProtocolEndpoint.Description
- CIM_IPProtocolEndpoint.Name
- CIM_IPProtocolEndpoint.OperationalStatus
- CIM_IPProtocolEndpoint.EnabledState
- CIM_IPProtocolEndpoint.TimeOfLastStateChange
- CIM_IPProtocolEndpoint.NameFormat
- CIM_IPProtocolEndpoint.ProtocolType
- CIM_IPProtocolEndpoint.OtherTypeDescription
- CIM_IPProtocolEndpoint.ProtocolIFType
- CIM_IPProtocolEndpoint.IPv4Address
- CIM_IPProtocolEndpoint.IPv6Address
- CIM_IPProtocolEndpoint.Address
- CIM_IPProtocolEndpoint.SubnetMask
- CIM_IPProtocolEndpoint.PrefixLength
- CIM_IPProtocolEndpoint.AddressType
- CIM_IPProtocolEndpoint.IPVersionSupport
...
# CIM_IPProtocolEndpoint WMI class
...
| <span id="IPv6AutoConfig"></span><span id="ipv6autoconfig"></span><span id="IPV6AUTOCONFIG"></span><dl> <dt>**IPv6AutoConfig**</dt> <dt>8</dt> </dl>               | The values were assinged using the IPv6 AutoConfig Protocol. See RFC 4862.<br/>                             |
...
Qualifiers: [**ModelCorrespondence**](/windows/win32/wmisdk/standard-qualifiers) ("CIM\_ProtocolEndpoint.OtherTypeDescription"), [**Override**](/windows/win32/wmisdk/standard-qualifiers) ("ProtocolIFType")
</dt> </dl>
