...
- MSFT_NetTransportFilter.InstanceID
- MSFT_NetTransportFilter.Caption
- MSFT_NetTransportFilter.Description
- MSFT_NetTransportFilter.ElementName
- MSFT_NetTransportFilter.InstallDate
- MSFT_NetTransportFilter.OperationalStatus
- MSFT_NetTransportFilter.StatusDescriptions
- MSFT_NetTransportFilter.Status
- MSFT_NetTransportFilter.HealthState
- MSFT_NetTransportFilter.CommunicationStatus
- MSFT_NetTransportFilter.DetailedStatus
- MSFT_NetTransportFilter.OperatingStatus
- MSFT_NetTransportFilter.PrimaryStatus
- MSFT_NetTransportFilter.Name
- MSFT_NetTransportFilter.SystemCreationClassName
- MSFT_NetTransportFilter.SystemName
- MSFT_NetTransportFilter.CreationClassName
- MSFT_NetTransportFilter.IsNegated
- MSFT_NetTransportFilter.Protocol
- MSFT_NetTransportFilter.LocalPortStart
- MSFT_NetTransportFilter.LocalPortEnd
- MSFT_NetTransportFilter.RemotePortStart
- MSFT_NetTransportFilter.RemotePortEnd
- MSFT_NetTransportFilter.DestinationPrefix
- MSFT_NetTransportFilter.SettingName
api_type: 
- DllExport
api_location: 
- NetTCPIP.dll
...
# MSFT\_NetTransportFilter class

Represents the filter for the transport protocol parameter setting for the Microsoft TCP/IP WMI v2 provider.
...
``` syntax
[UMLPackagePath("CIM::Network::Filtering"), ClassVersion("1.0.0"), dynamic, provider("nettcpip"), AMENDMENT]
...
The **MSFT\_NetTransportFilter** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetTransportFilter** class has these properties.
...
This property is inherited from [**CIM\_FilterEntryBase**](cim-filterentrybase.md).
...
The destination prefix to filter.
...
The end of the local port number.
...
The start of the local port number.
...
Specifies the protocol to which the filter applies.

<dl> <dt>

<span id="TCP"></span><span id="tcp"></span>**TCP** (6)
</dt> <dt>

<span id="UDP"></span><span id="udp"></span>**UDP** (17)
</dt> </dl>
...
The end of the remote port number.
...
The start of the remote port number.
...
The name of the setting associated with the filter. For information about the setting, see [**MSFT\_NetTCPSetting**](msft-nettcpsetting.md).
...
[**CIM\_FilterEntryBase**](cim-filterentrybase.md)
</dt> <dt>
