...
- CIM_NetworkPipe.CommunicationStatus
- CIM_NetworkPipe.DetailedStatus
- CIM_NetworkPipe.OperatingStatus
- CIM_NetworkPipe.PrimaryStatus
- CIM_NetworkPipe.OtherEnabledState
- CIM_NetworkPipe.EnabledDefault
- CIM_NetworkPipe.TimeOfLastStateChange
- CIM_NetworkPipe.TransitioningToState
- CIM_NetworkPipe.AvailableRequestedStates
...
This object is different than the association between the endpoints ([**CIM\_ActiveConnection**](/previous-versions//cc136779(v=vs.85))) since the emphasis is NOT on the endpoints but on the management of the pipe itself - its state, configuration, etc. Network pipes are defined in the context of a network and represent the 'transfer of information . . . between . . . endpoints'. These concepts are aligned with the definition of the Pipe object in ITU's M.3100 specification.
...
Qualifiers: [**ModelCorrespondence**](/windows/win32/wmisdk/standard-qualifiers) ("CIM\_EnabledLogicalElement.EnabledState"), [**Override**](/windows/win32/wmisdk/standard-qualifiers) ("RequestedState")
</dt> </dl>
