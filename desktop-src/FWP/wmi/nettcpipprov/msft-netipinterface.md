...
api_name: 
- MSFT_NetIPInterface
- MSFT_NetIPInterface.InstanceID
- MSFT_NetIPInterface.Caption
- MSFT_NetIPInterface.ElementName
- MSFT_NetIPInterface.InstallDate
- MSFT_NetIPInterface.StatusDescriptions
- MSFT_NetIPInterface.Status
- MSFT_NetIPInterface.HealthState
- MSFT_NetIPInterface.CommunicationStatus
- MSFT_NetIPInterface.DetailedStatus
- MSFT_NetIPInterface.OperatingStatus
- MSFT_NetIPInterface.PrimaryStatus
- MSFT_NetIPInterface.OtherEnabledState
- MSFT_NetIPInterface.RequestedState
- MSFT_NetIPInterface.EnabledDefault
- MSFT_NetIPInterface.TransitioningToState
- MSFT_NetIPInterface.AvailableRequestedStates
- MSFT_NetIPInterface.SystemCreationClassName
- MSFT_NetIPInterface.SystemName
- MSFT_NetIPInterface.CreationClassName
- MSFT_NetIPInterface.Description
- MSFT_NetIPInterface.Name
- MSFT_NetIPInterface.OperationalStatus
- MSFT_NetIPInterface.EnabledState
- MSFT_NetIPInterface.TimeOfLastStateChange
- MSFT_NetIPInterface.NameFormat
- MSFT_NetIPInterface.ProtocolType
- MSFT_NetIPInterface.ProtocolIFType
- MSFT_NetIPInterface.OtherTypeDescription
- MSFT_NetIPInterface.LANID
- MSFT_NetIPInterface.LANType
- MSFT_NetIPInterface.OtherLANType
- MSFT_NetIPInterface.MACAddress
- MSFT_NetIPInterface.AliasAddresses
- MSFT_NetIPInterface.GroupAddresses
- MSFT_NetIPInterface.MaxDataSize
- MSFT_NetIPInterface.InterfaceIndex
- MSFT_NetIPInterface.InterfaceAlias
- MSFT_NetIPInterface.AddressFamily
- MSFT_NetIPInterface.Forwarding
- MSFT_NetIPInterface.Advertising
- MSFT_NetIPInterface.NlMtu
- MSFT_NetIPInterface.InterfaceMetric
- MSFT_NetIPInterface.NeighborUnreachabilityDetection
- MSFT_NetIPInterface.BaseReachableTime
- MSFT_NetIPInterface.RetransmitTime
- MSFT_NetIPInterface.DadTransmits
- MSFT_NetIPInterface.RouterDiscovery
- MSFT_NetIPInterface.ManagedAddressConfiguration
- MSFT_NetIPInterface.OtherStatefulConfiguration
- MSFT_NetIPInterface.WeakHostSend
- MSFT_NetIPInterface.WeakHostReceive
- MSFT_NetIPInterface.IgnoreDefaultRoutes
- MSFT_NetIPInterface.AdvertisedRouterLifetime
- MSFT_NetIPInterface.AdvertiseDefaultRoute
- MSFT_NetIPInterface.CurrentHopLimit
- MSFT_NetIPInterface.Store
- MSFT_NetIPInterface.ForceArpNdWolPattern
- MSFT_NetIPInterface.DirectedMacWolPattern
- MSFT_NetIPInterface.EcnMarking
- MSFT_NetIPInterface.Dhcp
- MSFT_NetIPInterface.ReachableTime
- MSFT_NetIPInterface.AutomaticMetric
- MSFT_NetIPInterface.NeighborDiscoverySupported
- MSFT_NetIPInterface.ConnectionState
- MSFT_NetIPInterface.DadRetransmitTime
- MSFT_NetIPInterface.CompartmentId
- MSFT_NetIPInterface.IsolationId
- MSFT_NetIPInterface.LowestIfNetLuid
api_type: 
- DllExport
api_location: 
- NetTCPIP.dll
...
Represents a TCP/IP (Internet Protocol Suite) network Interface.
...
The **MSFT\_NetIPInterface** class has these types of members:
...
The **MSFT\_NetIPInterface** class has these properties.
...
Gets a value that indicates whether the interface uses the IPv4 or IPv6 address family. This property gets one of the following values.



| Value                                                                                                                                                                                                            | Meaning                             |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|
| <span id="IPv4"></span><span id="ipv4"></span><span id="IPV4"></span><dl> <dt>**IPv4**</dt> <dt>2</dt> </dl>  | The IPv4 address family.<br/> |
| <span id="IPv6"></span><span id="ipv6"></span><span id="IPV6"></span><dl> <dt>**IPv6**</dt> <dt>23</dt> </dl> | The IPv6 address family.<br/> |
...
Gets and sets a value that indicates whether the interface advertises itself as a default router. This property can contain one of the following values.



| Value                                                                                                                                                                                                                           | Meaning                                                                 |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | The interface does not advertise itself as a default router.<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | The interface advertises itself as a default router.<br/>         |
...
Gets and sets the lifetime of the router.
...
Gets and sets a value that indicates whether to send router advertisements to the interface. This parameter can contain one of the following values. By default, router advertisements are not sent to the router.



| Value                                                                                                                                                                                                                           | Meaning                                                       |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | Do not send router advertisements to the interface<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | Send router advertisements to the interface<br/>        |
...
This property is inherited from [**CIM\_LANEndpoint**](cim-lanendpoint.md).
...
Gets and sets a value that indicates whether automatic metric is enabled. This property can contain one of the following values.



| Value                                                                                                                                                                                                                           | Meaning                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | Automatic metric is disabled.<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | Automatic metric is enabled.<br/>  |
...
Gets and sets the base reachable time, in milliseconds.
...
Gets the connection state of the interface. This property can contain one of the following values.

<dl> <dt>

<span id="Disconnected"></span><span id="disconnected"></span><span id="DISCONNECTED"></span>**Disconnected** (0)
</dt> <dt>
...
Gets and sets the hop limit for the outgoing traffic of the interface.
...
Gets and sets the retransmit time of duplicate address detection (DAD), in milliseconds.
...
Gets and sets the number of duplicate address detection transmits.
...
Gets and sets a value that indicates whether DHCP is enabled on the interface. This property can contain one of the following values.
...
Gets and sets a value that indicates whether the direct MAC WOL pattern is enabled on the interface.



| Value                                                                                                                                                                                                                           | Meaning                                            |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | The direct MAC WOL pattern is disabled.<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | The direct MAC WOL pattern is enabled.<br/>  |
...
Gets and sets a value that indicates whether To control ECN codepoints for outgoing packets. Four possible values: - Disabled - UseEct1 - UseEct0 - AppDecide") : Amended ToSubclass,Values{"Disabled", "UseEct1", "UseEct0", "AppDecide
...
<span id="UseEct1"></span><span id="useect1"></span><span id="USEECT1"></span>**UseEct1** (1)
</dt> <dt>

<span id="UseEct0"></span><span id="useect0"></span><span id="USEECT0"></span>**UseEct0** (2)
</dt> <dt>

<span id="AppDecide"></span><span id="appdecide"></span><span id="APPDECIDE"></span>**AppDecide** (3)
</dt> </dl>
...
Gets and sets a value that indicates whether the ARP, Neighbor Discovery, and wake-on-LAN (WOL) pattern is enabled on the interface.



| Value                                                                                                                                                                                                                           | Meaning                                                              |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | The ARP, Neighbor Discovery, and WOL pattern is disabled.<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | The ARP, Neighbor Discovery, and WOL pattern is enabled.<br/>  |
...
Gets and sets a value that indicates whether forwarding is enabled on the interface. This parameter can contain one of the following values. Forwarding is enabled by default.



| Value                                                                                                                                                                                                                           | Meaning                            |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | Forwarding is enabled.<br/>  |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | Forwarding is disabled.<br/> |
...
Gets and sets a value that indicates whether the interface ignores default routes. This property can contain one of the following values.



| Value                                                                                                                                                                                                                           | Meaning                                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | The interface does not ignore default routes.<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | The interface ignores default routes.<br/>         |
...
Gets the alias of the interface.
...
Gets and sets the interface metric that applies to interface routes.
...
Gets the network isolation identifier.
...
Qualifiers: [**ModelCorrespondence**](/windows/win32/wmisdk/standard-qualifiers) ("CIM\_LANConnectivitySegment.LANID", "CIM\_LANSegment.LANID")
</dt> </dl>
...
Qualifiers: [**Deprecated**](/windows/win32/wmisdk/standard-wmi-qualifiers) ("CIM\_ProtocolEndpoint.ProtocolType"), [**ModelCorrespondence**](/windows/win32/wmisdk/standard-qualifiers) ("CIM\_LANConnectivitySegment.ConnectivityType", "CIM\_LANSegment.LANType")
</dt> </dl>

An indication of the kind of technology used on the LAN. This property is deprecated in lieu of **ProtocolType**, which is an enumeration inherited from [**CIM\_ProtocolEndpoint**](cim-protocolendpoint.md) and which includes the values specified here.
...
<span id="TokenRing"></span><span id="tokenring"></span><span id="TOKENRING"></span>**TokenRing** (3)
</dt> <dt>

<span id="FDDI"></span><span id="fddi"></span>**FDDI** (4)
</dt> </dl>
...
Qualifiers: [**MaxLen**](/windows/win32/wmisdk/standard-qualifiers) (12)
</dt> </dl>

The principal unicast address used in communication with the LAN endpoint. The MAC address is formatted as twelve hexadecimal digits (e.g., "010203040506"), with each pair representing one of the six octets of the MAC address in "canonical" bit order according to RFC 2469.
...
Gets and sets a value that indicates whether the interfaces uses a stateful protocol retrieve network addresses. If router discovery is enabled and advertising is disabled on the interface, this property is ignored. This property can contain one of the following values.
...
Qualifiers: [**Units**](/windows/win32/wmisdk/standard-qualifiers) ("Bits")
</dt> </dl>
...
Gets a value that indicates whether neighbor discovery is supported. This property can contain one of the following values.



| Value                                                                                                                                                                                                       | Meaning                                         |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| <span id="No"></span><span id="no"></span><span id="NO"></span><dl> <dt>**No**</dt> <dt>0</dt> </dl>     | Neighbor discovery is not supported.<br/> |
| <span id="Yes"></span><span id="yes"></span><span id="YES"></span><dl> <dt>**Yes**</dt> <dt>1</dt> </dl> | Neighbor discovery is supported.<br/>     |
...
Gets a value that indicates whether Neighbor Unreachability Detection (NUD) is enabled on the interface. This parameter can contain one of the following values.



| Value                                                                                                                                                                                                                           | Meaning                     |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | NUD is enabled.<br/>  |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | NUD is disabled.<br/> |
...
Gets and sets the network layer maximum transmission unit (MTU) of the interface, in bytes. The default value is the natural MTU of the link.
...
Qualifiers: [**Deprecated**](/windows/win32/wmisdk/standard-wmi-qualifiers) ("CIM\_ProtocolEndpoint.OtherTypeDescription"), [**ModelCorrespondence**](/windows/win32/wmisdk/standard-qualifiers) ("CIM\_LANConnectivitySegment.OtherTypeDescription", "CIM\_LANEndpoint.LANType")
</dt> </dl>

A free-form string that describes the type of technology used on the LAN when the value of the LANType property is equal to 1 (i.e., "Other"). This property is deprecated since its purpose overlaps with **OtherTypeDescription**, which is inherited from [**CIM\_ProtocolEndpoint**](cim-protocolendpoint.md).
...
Gets and sets a value that indicates whether the interfaces uses a stateful protocol retrieve configuration information. If router discovery is enabled and advertising is disabled on the interface, this property is ignored. This property can contain one of the following values.
...
Gets the reachable time of the interface, in milliseconds.
...
Gets and sets the retransmit time, in milliseconds.
...
Gets and sets a value that indicates whether router discover is enabled on the interface. This property can contain one of the following values.
...
<span id="ControlledByDHCP"></span><span id="controlledbydhcp"></span><span id="CONTROLLEDBYDHCP"></span>**ControlledByDHCP** (2)
</dt> <dt>

<span id="Unchanged"></span><span id="unchanged"></span><span id="UNCHANGED"></span>**Unchanged** (255)
</dt> </dl>
...
Gets a value that indicates whether the interface store persists after a reboot. This property can contain one of the following values.
...
Gets and sets a value that indicates whether weak host receives are enabled. This property can contain one of the following values.



| Value                                                                                                                                                                                                                           | Meaning                                     |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | Weak host receives are disabled.<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | Weak host receives are enabled.<br/>  |
...
Gets and sets a value that indicates whether weak host sends are enabled. This property can contain one of the following values.



| Value                                                                                                                                                                                                                           | Meaning                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Disabled**</dt> <dt>0</dt> </dl> | Weak host sends are disabled.<br/> |
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Enabled**</dt> <dt>1</dt> </dl>     | Weak host sends are enabled.<br/>  |
