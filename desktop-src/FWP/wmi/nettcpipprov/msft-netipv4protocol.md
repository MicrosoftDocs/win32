...
- MSFT_NetIPv4Protocol.InstanceID
- MSFT_NetIPv4Protocol.Caption
- MSFT_NetIPv4Protocol.ElementName
- MSFT_NetIPv4Protocol.InstallDate
- MSFT_NetIPv4Protocol.StatusDescriptions
- MSFT_NetIPv4Protocol.Status
- MSFT_NetIPv4Protocol.HealthState
- MSFT_NetIPv4Protocol.CommunicationStatus
- MSFT_NetIPv4Protocol.DetailedStatus
- MSFT_NetIPv4Protocol.OperatingStatus
- MSFT_NetIPv4Protocol.PrimaryStatus
- MSFT_NetIPv4Protocol.OtherEnabledState
- MSFT_NetIPv4Protocol.RequestedState
- MSFT_NetIPv4Protocol.EnabledDefault
- MSFT_NetIPv4Protocol.TransitioningToState
- MSFT_NetIPv4Protocol.AvailableRequestedStates
- MSFT_NetIPv4Protocol.SystemCreationClassName
- MSFT_NetIPv4Protocol.SystemName
- MSFT_NetIPv4Protocol.CreationClassName
- MSFT_NetIPv4Protocol.Description
- MSFT_NetIPv4Protocol.Name
- MSFT_NetIPv4Protocol.OperationalStatus
- MSFT_NetIPv4Protocol.EnabledState
- MSFT_NetIPv4Protocol.TimeOfLastStateChange
- MSFT_NetIPv4Protocol.NameFormat
- MSFT_NetIPv4Protocol.ProtocolType
- MSFT_NetIPv4Protocol.ProtocolIFType
- MSFT_NetIPv4Protocol.OtherTypeDescription
- MSFT_NetIPv4Protocol.DefaultHopLimit
- MSFT_NetIPv4Protocol.NeighborCacheLimit
- MSFT_NetIPv4Protocol.RouteCacheLimit
- MSFT_NetIPv4Protocol.ReassemblyLimit
- MSFT_NetIPv4Protocol.IcmpRedirects
- MSFT_NetIPv4Protocol.SourceRoutingBehavior
- MSFT_NetIPv4Protocol.DhcpMediaSense
- MSFT_NetIPv4Protocol.MediaSenseEventLog
- MSFT_NetIPv4Protocol.MldLevel
- MSFT_NetIPv4Protocol.MldVersion
- MSFT_NetIPv4Protocol.MulticastForwarding
- MSFT_NetIPv4Protocol.GroupForwardedFragments
- MSFT_NetIPv4Protocol.RandomizeIdentifiers
- MSFT_NetIPv4Protocol.AddressMaskReply
- MSFT_NetIPv4Protocol.MinimumMtu
api_type: 
- DllExport
api_location: 
- NetTCPIP.dll
...
# MSFT\_NetIPv4Protocol class

Represents the IPv4 protocol of the Microsoft TCP/IP WMI v2 provider.
...
The **MSFT\_NetIPv4Protocol** class has these types of members:
...
The **MSFT\_NetIPv4Protocol** class has these properties.
...
Minimum value of IPv4 MTU. The default value is 576. The value can range between 352 and 576.
