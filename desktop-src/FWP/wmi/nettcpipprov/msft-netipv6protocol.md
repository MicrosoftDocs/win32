...
- MSFT_NetIPv6Protocol.InstanceID
- MSFT_NetIPv6Protocol.Caption
- MSFT_NetIPv6Protocol.ElementName
- MSFT_NetIPv6Protocol.InstallDate
- MSFT_NetIPv6Protocol.StatusDescriptions
- MSFT_NetIPv6Protocol.Status
- MSFT_NetIPv6Protocol.HealthState
- MSFT_NetIPv6Protocol.CommunicationStatus
- MSFT_NetIPv6Protocol.DetailedStatus
- MSFT_NetIPv6Protocol.OperatingStatus
- MSFT_NetIPv6Protocol.PrimaryStatus
- MSFT_NetIPv6Protocol.OtherEnabledState
- MSFT_NetIPv6Protocol.RequestedState
- MSFT_NetIPv6Protocol.EnabledDefault
- MSFT_NetIPv6Protocol.TransitioningToState
- MSFT_NetIPv6Protocol.AvailableRequestedStates
- MSFT_NetIPv6Protocol.SystemCreationClassName
- MSFT_NetIPv6Protocol.SystemName
- MSFT_NetIPv6Protocol.CreationClassName
- MSFT_NetIPv6Protocol.Description
- MSFT_NetIPv6Protocol.Name
- MSFT_NetIPv6Protocol.OperationalStatus
- MSFT_NetIPv6Protocol.EnabledState
- MSFT_NetIPv6Protocol.TimeOfLastStateChange
- MSFT_NetIPv6Protocol.NameFormat
- MSFT_NetIPv6Protocol.ProtocolType
- MSFT_NetIPv6Protocol.ProtocolIFType
- MSFT_NetIPv6Protocol.OtherTypeDescription
- MSFT_NetIPv6Protocol.DefaultHopLimit
- MSFT_NetIPv6Protocol.NeighborCacheLimit
- MSFT_NetIPv6Protocol.RouteCacheLimit
- MSFT_NetIPv6Protocol.ReassemblyLimit
- MSFT_NetIPv6Protocol.IcmpRedirects
- MSFT_NetIPv6Protocol.SourceRoutingBehavior
- MSFT_NetIPv6Protocol.DhcpMediaSense
- MSFT_NetIPv6Protocol.MediaSenseEventLog
- MSFT_NetIPv6Protocol.MldLevel
- MSFT_NetIPv6Protocol.MldVersion
- MSFT_NetIPv6Protocol.MulticastForwarding
- MSFT_NetIPv6Protocol.GroupForwardedFragments
- MSFT_NetIPv6Protocol.RandomizeIdentifiers
- MSFT_NetIPv6Protocol.AddressMaskReply
- MSFT_NetIPv6Protocol.UseTemporaryAddresses
- MSFT_NetIPv6Protocol.MaxDadAttempts
- MSFT_NetIPv6Protocol.MaxValidLifetime
- MSFT_NetIPv6Protocol.MaxPreferredLifetime
- MSFT_NetIPv6Protocol.RegenerateTime
- MSFT_NetIPv6Protocol.MaxRandomTime
api_type: 
- DllExport
api_location: 
- NetTCPIP.dll
...
The **MSFT\_NetIPv6Protocol** class has these types of members:
...
The **MSFT\_NetIPv6Protocol** class has these properties.
...
This property is inherited from [**MSFT\_NetBaseIPProtocol**](msft-netbaseipprotocol.md).
...
| Value                                                                                                                                                                                                                       | Meaning                                                            |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|
| <span id="No"></span><span id="no"></span><span id="NO"></span><dl> <dt>**No**</dt> <dt>0</dt> </dl>                     | Do not use temporary addresses. <br/>                        |
| <span id="Yes"></span><span id="yes"></span><span id="YES"></span><dl> <dt>**Yes**</dt> <dt>1</dt> </dl>                 | Use temporary addresses.<br/>                                |
| <span id="Always"></span><span id="always"></span><span id="ALWAYS"></span><dl> <dt>**Always**</dt> <dt>2</dt> </dl>     | Always generate random numbers.<br/>                         |
| <span id="Counter"></span><span id="counter"></span><span id="COUNTER"></span><dl> <dt>**Counter**</dt> <dt>3</dt> </dl> | Use temporary addresses with the per-interface counter.<br/> |
