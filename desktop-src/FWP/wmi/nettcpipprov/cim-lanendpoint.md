...
api_name: 
- CIM_LANEndpoint
- CIM_LANEndpoint.InstanceID
- CIM_LANEndpoint.Caption
- CIM_LANEndpoint.ElementName
- CIM_LANEndpoint.InstallDate
- CIM_LANEndpoint.StatusDescriptions
- CIM_LANEndpoint.Status
- CIM_LANEndpoint.HealthState
- CIM_LANEndpoint.CommunicationStatus
- CIM_LANEndpoint.DetailedStatus
- CIM_LANEndpoint.OperatingStatus
- CIM_LANEndpoint.PrimaryStatus
- CIM_LANEndpoint.OtherEnabledState
- CIM_LANEndpoint.RequestedState
- CIM_LANEndpoint.EnabledDefault
- CIM_LANEndpoint.TransitioningToState
- CIM_LANEndpoint.AvailableRequestedStates
- CIM_LANEndpoint.SystemCreationClassName
- CIM_LANEndpoint.SystemName
- CIM_LANEndpoint.CreationClassName
- CIM_LANEndpoint.Description
- CIM_LANEndpoint.Name
- CIM_LANEndpoint.OperationalStatus
- CIM_LANEndpoint.EnabledState
- CIM_LANEndpoint.TimeOfLastStateChange
- CIM_LANEndpoint.NameFormat
- CIM_LANEndpoint.ProtocolType
- CIM_LANEndpoint.ProtocolIFType
- CIM_LANEndpoint.OtherTypeDescription
...
``` syntax
[UMLPackagePath("CIM::Network::ProtocolEndpoints"), Version("2.7.0"), AMENDMENT]
