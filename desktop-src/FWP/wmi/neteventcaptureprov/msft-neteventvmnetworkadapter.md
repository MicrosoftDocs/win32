...
- MSFT_NetEventVmNetworkAdapter.InstanceID
- MSFT_NetEventVmNetworkAdapter.Caption
- MSFT_NetEventVmNetworkAdapter.Description
- MSFT_NetEventVmNetworkAdapter.ElementName
- MSFT_NetEventVmNetworkAdapter.InstallDate
- MSFT_NetEventVmNetworkAdapter.OperationalStatus
- MSFT_NetEventVmNetworkAdapter.StatusDescriptions
- MSFT_NetEventVmNetworkAdapter.Status
- MSFT_NetEventVmNetworkAdapter.HealthState
- MSFT_NetEventVmNetworkAdapter.CommunicationStatus
- MSFT_NetEventVmNetworkAdapter.DetailedStatus
- MSFT_NetEventVmNetworkAdapter.OperatingStatus
- MSFT_NetEventVmNetworkAdapter.PrimaryStatus
- MSFT_NetEventVmNetworkAdapter.Name
- MSFT_NetEventVmNetworkAdapter.Id
- MSFT_NetEventVmNetworkAdapter.ProviderName
- MSFT_NetEventVmNetworkAdapter.CaptureStatus
- MSFT_NetEventVmNetworkAdapter.MacAddress
- MSFT_NetEventVmNetworkAdapter.SwitchName
- MSFT_NetEventVmNetworkAdapter.PortName
- MSFT_NetEventVmNetworkAdapter.VMName
- MSFT_NetEventVmNetworkAdapter.VMId
api_location:
...
The **MSFT\_NetEventVmNetworkAdapter** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetEventVmNetworkAdapter** class has these properties.
...
This property is inherited from [**MSFT\_NetEventPacketCaptureTarget**](msft-neteventpacketcapturetarget.md).
...
The MacAddress or the LinkLayerAddress of the VM Network Adapter.
...
The port name of the VM network adapter.
...
Name of the packet capture provider.
...
The name of the virtual switch the VM network adapter is connected to.
...
The Id of the virtual machine that the VM network adapter belongs to.
...
The name of the virtual machine that the VM network adapter belongs to.
