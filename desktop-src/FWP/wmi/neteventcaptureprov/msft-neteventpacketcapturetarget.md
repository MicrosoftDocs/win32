...
- MSFT_NetEventPacketCaptureTarget.InstanceID
- MSFT_NetEventPacketCaptureTarget.Caption
- MSFT_NetEventPacketCaptureTarget.Description
- MSFT_NetEventPacketCaptureTarget.ElementName
- MSFT_NetEventPacketCaptureTarget.InstallDate
- MSFT_NetEventPacketCaptureTarget.OperationalStatus
- MSFT_NetEventPacketCaptureTarget.StatusDescriptions
- MSFT_NetEventPacketCaptureTarget.Status
- MSFT_NetEventPacketCaptureTarget.HealthState
- MSFT_NetEventPacketCaptureTarget.CommunicationStatus
- MSFT_NetEventPacketCaptureTarget.DetailedStatus
- MSFT_NetEventPacketCaptureTarget.OperatingStatus
- MSFT_NetEventPacketCaptureTarget.PrimaryStatus
- MSFT_NetEventPacketCaptureTarget.Name
- MSFT_NetEventPacketCaptureTarget.Id
- MSFT_NetEventPacketCaptureTarget.ProviderName
- MSFT_NetEventPacketCaptureTarget.CaptureStatus
api_location:
...
The **MSFT\_NetEventPacketCaptureTarget** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetEventPacketCaptureTarget** class has these properties.
