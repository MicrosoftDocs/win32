...
- MSFT_NetEventProviderBase.InstanceID
- MSFT_NetEventProviderBase.Caption
- MSFT_NetEventProviderBase.Description
- MSFT_NetEventProviderBase.ElementName
- MSFT_NetEventProviderBase.InstallDate
- MSFT_NetEventProviderBase.OperationalStatus
- MSFT_NetEventProviderBase.StatusDescriptions
- MSFT_NetEventProviderBase.Status
- MSFT_NetEventProviderBase.HealthState
- MSFT_NetEventProviderBase.CommunicationStatus
- MSFT_NetEventProviderBase.DetailedStatus
- MSFT_NetEventProviderBase.OperatingStatus
- MSFT_NetEventProviderBase.PrimaryStatus
- MSFT_NetEventProviderBase.Name
- MSFT_NetEventProviderBase.Guid
- MSFT_NetEventProviderBase.SessionGuid
- MSFT_NetEventProviderBase.SessionName
- MSFT_NetEventProviderBase.Level
- MSFT_NetEventProviderBase.MatchAnyKeyword
- MSFT_NetEventProviderBase.MatchAllKeyword
api_location:
...
The **MSFT\_NetEventProviderBase** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetEventProviderBase** class has these properties.
