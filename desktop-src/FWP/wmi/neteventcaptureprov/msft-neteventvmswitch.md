...
- MSFT_NetEventVmSwitch.InstanceID
- MSFT_NetEventVmSwitch.Caption
- MSFT_NetEventVmSwitch.Description
- MSFT_NetEventVmSwitch.ElementName
- MSFT_NetEventVmSwitch.InstallDate
- MSFT_NetEventVmSwitch.OperationalStatus
- MSFT_NetEventVmSwitch.StatusDescriptions
- MSFT_NetEventVmSwitch.Status
- MSFT_NetEventVmSwitch.HealthState
- MSFT_NetEventVmSwitch.CommunicationStatus
- MSFT_NetEventVmSwitch.DetailedStatus
- MSFT_NetEventVmSwitch.OperatingStatus
- MSFT_NetEventVmSwitch.PrimaryStatus
- MSFT_NetEventVmSwitch.Name
- MSFT_NetEventVmSwitch.Id
- MSFT_NetEventVmSwitch.ProviderName
- MSFT_NetEventVmSwitch.CaptureStatus
api_location:
...
The **MSFT\_NetEventVmSwitch** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetEventVmSwitch** class has these properties.
