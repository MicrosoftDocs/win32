---
description: MSFT\_NetAdapterPowerManagementElementSetting associates a network adapter with its MSFT\_NetAdapterPowerManagementSettingData.
ms.assetid: f15f8e52-4603-4756-9656-b1a74c164734
title: MSFT\_NetAdapterPowerManagementElementSetting class
...
- MSFT_NetAdapterPowerManagementElementSetting.IsDefault
- MSFT_NetAdapterPowerManagementElementSetting.IsCurrent
- MSFT_NetAdapterPowerManagementElementSetting.IsNext
- MSFT_NetAdapterPowerManagementElementSetting.IsMinimum
- MSFT_NetAdapterPowerManagementElementSetting.IsMaximum
- MSFT_NetAdapterPowerManagementElementSetting.ManagedElement
- MSFT_NetAdapterPowerManagementElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterPowerManagementElementSetting class

MSFT\_NetAdapterPowerManagementElementSetting associates a network adapter with its MSFT\_NetAdapterPowerManagementSettingData.
...
class MSFT_NetAdapterPowerManagementElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterPowerManagementSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterPowerManagementElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterPowerManagementElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterPowerManagementSettingData**
</dt> <dt>
...
The Power Management setting data for the network adapter.
