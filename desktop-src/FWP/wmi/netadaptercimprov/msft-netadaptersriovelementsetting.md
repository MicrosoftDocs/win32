---
description: Associates a network port with its SRIOV data.
ms.assetid: 2fe98047-302e-4789-8f5d-75b5d52dbc85
title: MSFT\_NetAdapterSriovElementSetting class
...
- MSFT_NetAdapterSriovElementSetting.IsDefault
- MSFT_NetAdapterSriovElementSetting.IsCurrent
- MSFT_NetAdapterSriovElementSetting.IsNext
- MSFT_NetAdapterSriovElementSetting.IsMinimum
- MSFT_NetAdapterSriovElementSetting.IsMaximum
- MSFT_NetAdapterSriovElementSetting.ManagedElement
- MSFT_NetAdapterSriovElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterSriovElementSetting class

Associates a network port with its SRIOV data.
...
class MSFT_NetAdapterSriovElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterSriovSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterSriovElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterSriovElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterSriovSettingData**
</dt> <dt>
...
The RSS setting data for network adapter.
