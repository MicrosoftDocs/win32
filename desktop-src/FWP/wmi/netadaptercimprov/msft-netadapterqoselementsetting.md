---
description: Associates a network port with its QoS properties.
ms.assetid: 80924229-9040-43d0-9185-adec9b4b84b6
title: MSFT\_NetAdapterQosElementSetting class
...
- MSFT_NetAdapterQosElementSetting.IsDefault
- MSFT_NetAdapterQosElementSetting.IsCurrent
- MSFT_NetAdapterQosElementSetting.IsNext
- MSFT_NetAdapterQosElementSetting.IsMinimum
- MSFT_NetAdapterQosElementSetting.IsMaximum
- MSFT_NetAdapterQosElementSetting.ManagedElement
- MSFT_NetAdapterQosElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterQosElementSetting class

Associates a network port with its QoS properties.
...
class MSFT_NetAdapterQosElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterQosSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterQosElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterQosElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterQosSettingData**
</dt> <dt>
...
The QoS properties for the network adapter.
