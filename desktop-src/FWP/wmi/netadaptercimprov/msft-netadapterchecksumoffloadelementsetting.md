---
description: Associates a network adapter with its TCPIP checksum offload data.
ms.assetid: 40682467-365e-45d8-87c3-3ca925010e80
title: MSFT\_NetAdapterChecksumOffloadElementSetting class
...
- MSFT_NetAdapterChecksumOffloadElementSetting.IsDefault
- MSFT_NetAdapterChecksumOffloadElementSetting.IsCurrent
- MSFT_NetAdapterChecksumOffloadElementSetting.IsNext
- MSFT_NetAdapterChecksumOffloadElementSetting.IsMinimum
- MSFT_NetAdapterChecksumOffloadElementSetting.IsMaximum
- MSFT_NetAdapterChecksumOffloadElementSetting.ManagedElement
- MSFT_NetAdapterChecksumOffloadElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterChecksumOffloadElementSetting class

Associates a network adapter with its TCPIP checksum offload data.
...
class MSFT_NetAdapterChecksumOffloadElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterChecksumOffloadSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterChecksumOffloadElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterChecksumOffloadElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterChecksumOffloadSettingData**
</dt> <dt>
...
A reference to the TCPIP checksum offload setting data for the network adapter.
