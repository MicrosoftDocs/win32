---
description: Associates a network port with its binding information.
ms.assetid: 386fb655-bed6-4ac6-b9d4-adbaeaac84a3
title: MSFT\_NetAdapterBindingElementSetting class
...
- MSFT_NetAdapterBindingElementSetting.IsDefault
- MSFT_NetAdapterBindingElementSetting.IsCurrent
- MSFT_NetAdapterBindingElementSetting.IsNext
- MSFT_NetAdapterBindingElementSetting.IsMinimum
- MSFT_NetAdapterBindingElementSetting.IsMaximum
- MSFT_NetAdapterBindingElementSetting.ManagedElement
- MSFT_NetAdapterBindingElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterBindingElementSetting class

Associates a network port with its binding information.
...
class MSFT_NetAdapterBindingElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterBindingSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterBindingElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterBindingElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterBindingSettingData**
</dt> <dt>
...
The binding information for the network adapter.
