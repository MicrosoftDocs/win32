---
description: Associates a network adapter with its Virtual Machine Queue (VMQ) setting data.
ms.assetid: 774cd27c-5079-4024-a960-5bd295e11f6a
title: MSFT\_NetAdapterVmqElementSetting class
...
- MSFT_NetAdapterVmqElementSetting.IsDefault
- MSFT_NetAdapterVmqElementSetting.IsCurrent
- MSFT_NetAdapterVmqElementSetting.IsNext
- MSFT_NetAdapterVmqElementSetting.IsMinimum
- MSFT_NetAdapterVmqElementSetting.IsMaximum
- MSFT_NetAdapterVmqElementSetting.ManagedElement
- MSFT_NetAdapterVmqElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterVmqElementSetting class

Associates a network adapter with its Virtual Machine Queue (VMQ) setting data.
...
class MSFT_NetAdapterVmqElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterVmqSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterVmqElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterVmqElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterVmqSettingData**
</dt> <dt>
...
The VMQ setting data for the network adapter.
