---
description: Associates a network port with its SRIOV Vf data.
ms.assetid: 234bad53-3c01-46d0-96b3-33b275a7ab22
title: MSFT\_NetAdapterSriovVfElementSetting class
...
- MSFT_NetAdapterSriovVfElementSetting.IsDefault
- MSFT_NetAdapterSriovVfElementSetting.IsCurrent
- MSFT_NetAdapterSriovVfElementSetting.IsNext
- MSFT_NetAdapterSriovVfElementSetting.IsMinimum
- MSFT_NetAdapterSriovVfElementSetting.IsMaximum
- MSFT_NetAdapterSriovVfElementSetting.ManagedElement
- MSFT_NetAdapterSriovVfElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterSriovVfElementSetting class

Associates a network port with its SRIOV Vf data.
...
class MSFT_NetAdapterSriovVfElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterSriovVfSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterSriovVfElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterSriovVfElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterSriovVfSettingData**
</dt> <dt>
...
The SRIOV setting data for the network adapter.
