...
- MSFT_NetAdapterLsoElementSetting.IsDefault
- MSFT_NetAdapterLsoElementSetting.IsCurrent
- MSFT_NetAdapterLsoElementSetting.IsNext
- MSFT_NetAdapterLsoElementSetting.IsMinimum
- MSFT_NetAdapterLsoElementSetting.IsMaximum
- MSFT_NetAdapterLsoElementSetting.ManagedElement
- MSFT_NetAdapterLsoElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
