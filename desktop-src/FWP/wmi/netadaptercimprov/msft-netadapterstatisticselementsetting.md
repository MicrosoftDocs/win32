---
description: Associates a network adapter with the setting data of its statistics.
ms.assetid: 25c3866c-1f50-4431-9877-1d8cd5e77cdb
title: MSFT\_NetAdapterStatisticsElementSetting class
...
- MSFT_NetAdapterStatisticsElementSetting.IsDefault
- MSFT_NetAdapterStatisticsElementSetting.IsCurrent
- MSFT_NetAdapterStatisticsElementSetting.IsNext
- MSFT_NetAdapterStatisticsElementSetting.IsMinimum
- MSFT_NetAdapterStatisticsElementSetting.IsMaximum
- MSFT_NetAdapterStatisticsElementSetting.ManagedElement
- MSFT_NetAdapterStatisticsElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterStatisticsElementSetting class

Associates a network adapter with the setting data of its statistics.
...
class MSFT_NetAdapterStatisticsElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterStatisticsSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterStatisticsElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterStatisticsElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterStatisticsSettingData**
</dt> <dt>
...
The statistics setting data for the network adapter.
