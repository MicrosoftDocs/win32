...
- MSFT_NetAdapterIPsecOffloadV2ElementSetting.IsDefault
- MSFT_NetAdapterIPsecOffloadV2ElementSetting.IsCurrent
- MSFT_NetAdapterIPsecOffloadV2ElementSetting.IsNext
- MSFT_NetAdapterIPsecOffloadV2ElementSetting.IsMinimum
- MSFT_NetAdapterIPsecOffloadV2ElementSetting.IsMaximum
- MSFT_NetAdapterIPsecOffloadV2ElementSetting.ManagedElement
- MSFT_NetAdapterIPsecOffloadV2ElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
The **MSFT\_NetAdapterIPsecOffloadV2ElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterIPsecOffloadV2ElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterIPsecOffloadV2SettingData**
</dt> <dt>
...
A reference to the [**MSFT\_NetAdapterIPsecOffloadV2SettingData**](msft-netadapteripsecoffloadv2settingdata.md) object that is associated with the element.
