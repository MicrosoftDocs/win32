---
description: Associates a network adapter with its Receive Side Scale (RSS) setting data.
ms.assetid: 81227024-1254-4e09-99d0-ec5c7fe3bc6b
title: MSFT\_NetAdapterRssElementSetting class
...
- MSFT_NetAdapterRssElementSetting.IsDefault
- MSFT_NetAdapterRssElementSetting.IsCurrent
- MSFT_NetAdapterRssElementSetting.IsNext
- MSFT_NetAdapterRssElementSetting.IsMinimum
- MSFT_NetAdapterRssElementSetting.IsMaximum
- MSFT_NetAdapterRssElementSetting.ManagedElement
- MSFT_NetAdapterRssElementSetting.SettingData
api_type: 
- DllExport
api_location: 
- NetAdapterCim.dll
...
# MSFT\_NetAdapterRssElementSetting class

Associates a network adapter with its Receive Side Scale (RSS) setting data.
...
class MSFT_NetAdapterRssElementSetting : MSFT_NetAdapterElementSettingData
{
  ...
  MSFT_NetAdapterRssSettingData REF SettingData;
};
```

## Members

The **MSFT\_NetAdapterRssElementSetting** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_NetAdapterRssElementSetting** class has these properties.
...
Data type: **MSFT\_NetAdapterRssSettingData**
</dt> <dt>
...
The RSS setting data for the network adapter.
