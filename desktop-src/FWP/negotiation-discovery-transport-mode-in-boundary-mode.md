...
1.  Add one or both of the following QM transport mode policy provider contexts and set the [**IPSEC\_POLICY\_FLAG\_ND\_BOUNDARY**](/windows/win32/Ipsectypes/ns-ipsectypes-ipsec_transport_policy0_?branch=master) flag.  
