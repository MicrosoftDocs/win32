...
You can coordinate with [Distributed Transaction Coordinator](http://go.microsoft.com/fwlink/p/?linkid=139572) user-mode resources such as SQL or MSMQ, and with kernel-mode resources that use the KTM. First, create a DTC transaction, or a [**System.Transactions**](N:System.Transactions) object, then call the [**IKernelTransaction**](b8d835d2-f454-46e2-b143-b9af61936490) object, from which you can obtain the KTM handle. The **IKernelTransaction** object creates a KTM transaction that is subordinate to the DTC transaction. With this handle, you can create your transacted objects, but signal the outcome of the transaction using DTC or **System.Transactions**.
