...
-   [**TransferObjectData**](/windows/desktop/api/mswmdm/nf-mswmdm-iwmdmoperation-transferobjectdata) Called one or more times. The processing of data is described in the following steps:
    ...
    4.  The application decrypts the data, using [**CSecureChannelClient::DecryptParam**](/windows/desktop/api/scclient/nf-scclient-csecurechannelclient-decryptparam), and stores it or uses it, as needed.
...
-   [**TransferObjectData**](/windows/desktop/api/mswmdm/nf-mswmdm-iwmdmoperation-transferobjectdata) Called one or more times. The processing of data is described in the following steps:
    ...
    4.  The application encrypts the data in the buffer, using [**CSecureChannelClient::EncryptParam**](/windows/desktop/api/scclient/nf-scclient-csecurechannelclient-encryptparam).
