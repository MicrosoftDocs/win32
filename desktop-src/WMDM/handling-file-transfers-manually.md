...
-   [**TransferObjectData**](/windows/desktop/api/mswmdm/nf-mswmdm-iwmdmoperation-transferobjectdata) Called one or more times. The processing of data is described in the following steps:
    ...
    4.  The application decrypts the data, using [**CSecureChannelClient::DecryptParam**](https://msdn.microsoft.com/en-us/library/Ff801022(v=VS.85).aspx), and stores it or uses it, as needed.
...
-   [**TransferObjectData**](/windows/desktop/api/mswmdm/nf-mswmdm-iwmdmoperation-transferobjectdata) Called one or more times. The processing of data is described in the following steps:
    ...
    4.  The application encrypts the data in the buffer, using [**CSecureChannelClient::EncryptParam**](https://msdn.microsoft.com/en-us/library/Ff801024(v=VS.85).aspx).
