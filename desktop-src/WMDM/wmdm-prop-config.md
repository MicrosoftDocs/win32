...
The [**WMDM\_FORMAT\_CAPABILITY**](wmdm-format-capability.md) structure returned by [**IWMDMDevice3::GetFormatCapability**](/windows/win32/mswmdm/nf-mswmdm-iwmdmdevice3-getformatcapability?branch=master) for a particular format consists of a number of property configurations. **WMDM\_PROP\_CONFIG** structures describe those configurations.
