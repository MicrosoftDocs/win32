...
keywords: ["WMDM_PROP_CONFIG structure windows Media Device Manager"]
topic_type:
- apiref
api_name:
- WMDM_PROP_CONFIG
...
The [**WMDM\_FORMAT\_CAPABILITY**](wmdm-format-capability.md) structure returned by [**IWMDMDevice3::GetFormatCapability**](iwmdmdevice3-getformatcapability.md) for a particular format consists of a number of property configurations. **WMDM\_PROP\_CONFIG** structures describe those configurations.
