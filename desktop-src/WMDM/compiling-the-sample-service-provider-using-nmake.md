...
keywords: ["Windows Media Device Manager,samples", "Device Manager,samples", "Windows Media Device Manager,service provider sample", "Device Manager,service provider sample", "service providers,samples", "samples,service providers", "samples,compiling using NMAKE"]
---
