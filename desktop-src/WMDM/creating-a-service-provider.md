...
6.  Before handling any call, verify that a secure channel has been established. Call [**CSecureChannelServer::fIsAuthenticated**](/windows/desktop/api) before performing any actions. If this call fails, return WMDM\_E\_NOTCERTIFIED.
