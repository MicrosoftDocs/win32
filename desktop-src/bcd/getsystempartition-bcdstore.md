...
keywords: ["GetSystemPartition method Boot Config", "GetSystemPartition method Boot Config , BcdStore class", "BcdStore class Boot Config , GetSystemPartition method"]
topic_type:
- apiref
api_name:
