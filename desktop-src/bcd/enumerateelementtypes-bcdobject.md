...
keywords: ["EnumerateElementTypes method Boot Config", "EnumerateElementTypes method Boot Config , BcdObject class", "BcdObject class Boot Config , EnumerateElementTypes method"]
topic_type:
- apiref
api_name:
