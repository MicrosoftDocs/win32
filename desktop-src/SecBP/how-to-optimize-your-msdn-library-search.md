...
To search MSDN, enter a keyword or character string in the **Search MSDN with Bing** box. After you search the [Microsoft Developer Network](http://go.microsoft.com/fwlink/p/?linkid=83026) (MSDN) website, you can narrow your search results by clicking the options available in the **Refine search** column under **By Source** or **By Topic**. These options become available after your first search attempt.
