...
description: Do not use. The IMessengerGroup interface provides methods and properties to handle a groups collection of users.
...
The **IMessengerGroup** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IMessengerGroup** also has these types of members:
