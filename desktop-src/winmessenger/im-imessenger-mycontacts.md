...
Return value. Pointer to a pointer to an [IDispatch](https://msdn.microsoft.com/windows/desktop/c1accca9-971c-4435-8a5e-e25404a3fb25) interface. Returns the [**IMessengerContacts**](im-imessengercontacts.md) interface on the contact list or [**MessengerContacts**](im-messengercontacts.md) collection object.
