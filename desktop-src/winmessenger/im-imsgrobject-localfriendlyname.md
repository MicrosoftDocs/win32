...
keywords: ["LocalFriendlyName property Windows Messenger", "LocalFriendlyName property Windows Messenger , IMsgrObject interface", "IMsgrObject interface Windows Messenger , LocalFriendlyName property"]
topic_type:
- apiref
api_name:
