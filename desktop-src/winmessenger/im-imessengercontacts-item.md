...
Address of a pointer to an [IDispatch](https://msdn.microsoft.com/windows/desktop/c1accca9-971c-4435-8a5e-e25404a3fb25) interface on a [**MessengerContacts**](im-messengercontacts.md) object requested with *Index*. The object can now be accessed through the [**IMessengerContact**](im-imessengercontact.md) interface.
