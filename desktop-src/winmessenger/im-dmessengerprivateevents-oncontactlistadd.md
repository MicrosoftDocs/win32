...
Pointer to an [IDispatch](c1accca9-971c-4435-8a5e-e25404a3fb25) interface of a [**MessengerContact**](im-messengercontact.md) object representing the user that has been added to the contact list.
