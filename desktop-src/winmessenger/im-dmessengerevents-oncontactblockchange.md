...
keywords: ["OnContactBlockChange event Windows Messenger", "OnContactBlockChange event Windows Messenger , DMessengerEvents interface", "DMessengerEvents interface Windows Messenger , OnContactBlockChange event"]
topic_type:
- apiref
api_name:
