...
keywords: ["OnUserFriendlyNameChangeResult event Windows Messenger", "OnUserFriendlyNameChangeResult event Windows Messenger , DMsgrObjectEvents interface", "DMsgrObjectEvents interface Windows Messenger , OnUserFriendlyNameChangeResult event"]
topic_type:
- apiref
api_name:
