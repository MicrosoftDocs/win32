...
keywords: ["MyFriendlyName property Windows Messenger", "MyFriendlyName property Windows Messenger , IMessenger interface", "IMessenger interface Windows Messenger , MyFriendlyName property"]
topic_type:
- apiref
api_name:
