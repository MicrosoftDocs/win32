...
keywords:
- OnTermination event Windows Messenger
- OnTermination event Windows Messenger , DMsgrSessionEvents interface
- DMsgrSessionEvents interface Windows Messenger , OnTermination event
topic_type:
- apiref
api_name:
