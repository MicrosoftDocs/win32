...
keywords:
- UnRegisterApplication method Windows Messenger
- UnRegisterApplication method Windows Messenger , IMsgrSessionManager interface
- IMsgrSessionManager interface Windows Messenger , UnRegisterApplication method
topic_type:
- apiref
api_name:
