...
keywords: ["ApplicationName property Windows Messenger", "ApplicationName property Windows Messenger , IMsgrSession interface", "IMsgrSession interface Windows Messenger , ApplicationName property"]
topic_type:
- apiref
api_name:
