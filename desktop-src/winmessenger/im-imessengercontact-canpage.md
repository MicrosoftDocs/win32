...
keywords:
- CanPage property Windows Messenger
- CanPage property Windows Messenger , IMessengerContact interface
- IMessengerContact interface Windows Messenger , CanPage property
topic_type:
- apiref
api_name:
