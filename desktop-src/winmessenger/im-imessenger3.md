...
The **IMessenger3** interface inherits from [**IMessenger2**](im-imessenger2.md). **IMessenger3** also has these types of members:

-   [Properties](#properties)

### Properties

The **IMessenger3** interface has these properties.



| Property                                               | Description                                                                                                                         |
|:-------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------|
| [**Property**](im-imessenger3-property.md)<br/> | `get_Property` retrieves the Messenger client version and the locale ID (LCID). `put_Property` is reserved. Do not use. <br/> |
