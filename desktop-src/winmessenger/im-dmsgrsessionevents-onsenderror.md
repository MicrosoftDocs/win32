...
keywords: ["OnSendError event Windows Messenger", "OnSendError event Windows Messenger , DMsgrSessionEvents interface", "DMsgrSessionEvents interface Windows Messenger , OnSendError event"]
topic_type:
- apiref
api_name:
