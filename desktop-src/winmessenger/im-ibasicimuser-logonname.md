...
keywords: ["LogonName property Windows Messenger", "LogonName property Windows Messenger , IBasicIMUser interface", "IBasicIMUser interface Windows Messenger , LogonName property"]
topic_type:
- apiref
api_name:
