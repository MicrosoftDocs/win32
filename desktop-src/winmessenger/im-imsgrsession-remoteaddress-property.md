...
keywords: ["RemoteAddress property Windows Messenger", "RemoteAddress property Windows Messenger , IMsgrSession interface", "IMsgrSession interface Windows Messenger , RemoteAddress property"]
topic_type:
- apiref
api_name:
