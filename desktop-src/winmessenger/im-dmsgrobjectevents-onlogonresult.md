...
keywords: ["OnLogonResult event Windows Messenger", "OnLogonResult event Windows Messenger , DMsgrObjectEvents interface", "DMsgrObjectEvents interface Windows Messenger , OnLogonResult event"]
topic_type:
- apiref
api_name:
