...
keywords:
- OnSignin event Windows Messenger
- OnSignin event Windows Messenger , DMessengerEvents interface
- DMessengerEvents interface Windows Messenger , OnSignin event
topic_type:
- apiref
api_name:
