...
The **IMsgrSession** interface inherits from the [**IDispatch**](https://msdn.microsoft.com/windows/desktop/ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IMsgrSession** also has these types of members:
...
| [**User**](im-imsgrsession-user-property.md)<br/>                       | Read-only<br/> | Retrieves a pointer to an [IDispatch](https://msdn.microsoft.com/windows/desktop/c1accca9-971c-4435-8a5e-e25404a3fb25) of a [**MessengerContact**](im-messengercontact.md) object.<br/> |
