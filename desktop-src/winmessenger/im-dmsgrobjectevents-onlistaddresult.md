...
keywords: ["OnListAddResult event Windows Messenger", "OnListAddResult event Windows Messenger , DMsgrObjectEvents interface", "DMsgrObjectEvents interface Windows Messenger , OnListAddResult event"]
topic_type:
- apiref
api_name:
