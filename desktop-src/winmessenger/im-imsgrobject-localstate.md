...
keywords: ["LocalState property Windows Messenger", "LocalState property Windows Messenger , IMsgrObject interface", "IMsgrObject interface Windows Messenger , LocalState property"]
topic_type:
- apiref
api_name:
