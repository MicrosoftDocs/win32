...
keywords:
- OnGroupRemoved event Windows Messenger
- OnGroupRemoved event Windows Messenger , DMessengerEvents interface
- DMessengerEvents interface Windows Messenger , OnGroupRemoved event
topic_type:
- apiref
api_name:
