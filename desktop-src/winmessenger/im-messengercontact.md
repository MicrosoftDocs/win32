...
description: Do not use. The MessengerContact object corresponds to the IMessengerContact interface. This object provides a local representation of a remote contact. It represents a single user as stored in the Messenger object's internal contact list.
ms.assetid: 'f00b35ee-030e-4946-a954-2d0fd3e4193f'
keywords: ["MessengerContact object Windows Messenger", "MessengerContact object Windows Messenger , described"]
topic_type:
- apiref
api_name:
- MessengerContact
