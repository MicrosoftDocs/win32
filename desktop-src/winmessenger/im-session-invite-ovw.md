...
![relationship between two applications connected via session invite.](https://www.bing.com/search?q=relationship between two applications connected via session invite.)
