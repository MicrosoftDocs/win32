...
keywords: ["OnLockChallenge event Windows Messenger", "OnLockChallenge event Windows Messenger , DMsgrSessionManagerEvents interface", "DMsgrSessionManagerEvents interface Windows Messenger , OnLockChallenge event"]
topic_type:
- apiref
api_name:
