...
keywords: ["Service property Windows Messenger", "Service property Windows Messenger , IMessengerGroup interface", "IMessengerGroup interface Windows Messenger , Service property"]
topic_type:
- apiref
api_name:
