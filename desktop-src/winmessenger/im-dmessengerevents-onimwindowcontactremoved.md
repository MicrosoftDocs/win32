...
keywords: ["OnIMWindowContactRemoved event Windows Messenger", "OnIMWindowContactRemoved event Windows Messenger , DMessengerEvents interface", "DMessengerEvents interface Windows Messenger , OnIMWindowContactRemoved event"]
topic_type:
- apiref
api_name:
...
|         |                                                                                                                                                                                                                                                                                            |
|---------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **C++** | Pointer to a [IDispatch](c1accca9-971c-4435-8a5e-e25404a3fb25) interface on the [**MessengerContact**](im-messengercontact.md) object that corresponds to the added contact. Using this pointer, clients can now code to its [**IMessengerContact**](im-imessengercontact.md) interface. |
...
|         |                                                                                                                                                                                                                                                                                      |
|---------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **C++** | Pointer to a [IDispatch](c1accca9-971c-4435-8a5e-e25404a3fb25) interface on the [**MessengerConversationWnd**](im-messengerconversationwnd.md) object. Using this pointer, clients can now code to its [**IMessengerConversationWnd**](im-imessengerconversationwnd.md) interface. |
