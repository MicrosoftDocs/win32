...
keywords: ["_NewEnum property Windows Messenger", "_NewEnum property Windows Messenger , IMessengerGroups interface", "IMessengerGroups interface Windows Messenger , _NewEnum property"]
topic_type:
- apiref
api_name:
