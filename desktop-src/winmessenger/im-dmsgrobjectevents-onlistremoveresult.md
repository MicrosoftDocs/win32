...
description: Indicates the result of an attempt to remove a user from the Messenger User object's User List.
ms.assetid: '2bfd454a-3956-4f9f-96b3-8834324f5500'
keywords: ["OnListRemovedResult event Windows Messenger", "OnListRemovedResult event Windows Messenger , DMsgrObjectEvents interface", "DMsgrObjectEvents interface Windows Messenger , OnListRemovedResult event"]
topic_type:
- apiref
api_name:
