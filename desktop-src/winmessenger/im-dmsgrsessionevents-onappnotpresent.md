...
keywords: ["OnAppNotPresent event Windows Messenger", "OnAppNotPresent event Windows Messenger , DMsgrSessionEvents interface", "DMsgrSessionEvents interface Windows Messenger , OnAppNotPresent event"]
topic_type:
- apiref
api_name:
