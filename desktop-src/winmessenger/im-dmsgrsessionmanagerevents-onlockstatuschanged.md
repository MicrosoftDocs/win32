...
keywords: ["OnLockStatusChanged event Windows Messenger", "OnLockStatusChanged event Windows Messenger , DMsgrSessionManagerEvents interface", "DMsgrSessionManagerEvents interface Windows Messenger , OnLockStatusChanged event"]
topic_type:
- apiref
api_name:
