...
keywords: ["OnDeclined event Windows Messenger", "OnDeclined event Windows Messenger , DMsgrSessionEvents interface", "DMsgrSessionEvents interface Windows Messenger , OnDeclined event"]
topic_type:
- apiref
api_name:
