...
keywords:
- Invite method Windows Messenger
- Invite method Windows Messenger , IMsgrSession interface
- IMsgrSession interface Windows Messenger , Invite method
topic_type:
- apiref
api_name:
- IMsgrSession.Invite
...
Pointer to an [IDispatch](https://msdn.microsoft.com/windows/desktop/c1accca9-971c-4435-8a5e-e25404a3fb25) of a [**MessengerContact**](im-messengercontact.md) object representing the user that is invited to the session.
