...
keywords: ["LocalAddress property Windows Messenger", "LocalAddress property Windows Messenger , IMsgrSession interface", "IMsgrSession interface Windows Messenger , LocalAddress property"]
topic_type:
- apiref
api_name:
