...
keywords: ["LocalLogonName property Windows Messenger", "LocalLogonName property Windows Messenger , IMsgrObject interface", "IMsgrObject interface Windows Messenger , LocalLogonName property"]
topic_type:
- apiref
api_name:
