...
keywords: ["OnContextData event Windows Messenger", "OnContextData event Windows Messenger , DMsgrSessionEvents interface", "DMsgrSessionEvents interface Windows Messenger , OnContextData event"]
topic_type:
- apiref
api_name:
