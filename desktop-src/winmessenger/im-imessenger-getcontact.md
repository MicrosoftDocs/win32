...
A pointer to a pointer to the [IDispatch](https://msdn.microsoft.com/windows/desktop/c1accca9-971c-4435-8a5e-e25404a3fb25) interface on the new (or existing) [**MessengerContact**](im-messengercontact.md) object. The new object can now be accessed through the [**IMessengerContact**](im-imessengercontact.md) interface.
