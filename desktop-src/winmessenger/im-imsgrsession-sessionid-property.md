...
keywords:
- SessionID property Windows Messenger
- SessionID property Windows Messenger , IMsgrSession interface
- IMsgrSession interface Windows Messenger , SessionID property
topic_type:
- apiref
api_name:
