...
The *vService* parameter can be specified as a **BSTR** containing the ID (not the name) of the service, or it can also be a pointer to an [IDispatch](https://msdn.microsoft.com/windows/desktop/c1accca9-971c-4435-8a5e-e25404a3fb25) of a [**MessengerService**](im-messengerservice.md) object.
