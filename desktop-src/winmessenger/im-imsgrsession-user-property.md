...
keywords: ["User property Windows Messenger", "User property Windows Messenger , IMsgrSession interface", "IMsgrSession interface Windows Messenger , User property"]
topic_type:
- apiref
api_name:
- IMsgrSession.User
