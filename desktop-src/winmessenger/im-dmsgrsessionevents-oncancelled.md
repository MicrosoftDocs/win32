...
keywords:
- OnCancelled event Windows Messenger
- OnCancelled event Windows Messenger , DMsgrSessionEvents interface
- DMsgrSessionEvents interface Windows Messenger , OnCancelled event
topic_type:
- apiref
api_name:
