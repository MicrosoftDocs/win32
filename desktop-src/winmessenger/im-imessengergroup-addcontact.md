...
keywords: ["AddContact method Windows Messenger", "AddContact method Windows Messenger , IMessengerGroup interface", "IMessengerGroup interface Windows Messenger , AddContact method"]
topic_type:
- apiref
api_name:
