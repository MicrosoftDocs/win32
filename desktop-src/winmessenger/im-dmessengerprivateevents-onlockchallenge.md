...
keywords: ["OnLockChallenge event Windows Messenger", "OnLockChallenge event Windows Messenger , DMessengerPrivateEvents interface", "DMessengerPrivateEvents interface Windows Messenger , OnLockChallenge event"]
topic_type:
- apiref
api_name:
