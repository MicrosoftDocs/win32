...
keywords: ["OnAppRegistered event Windows Messenger", "OnAppRegistered event Windows Messenger , DMsgrSessionManagerEvents interface", "DMsgrSessionManagerEvents interface Windows Messenger , OnAppRegistered event"]
topic_type:
- apiref
api_name:
