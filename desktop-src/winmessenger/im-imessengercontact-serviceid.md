...
keywords: ["ServiceID property Windows Messenger", "ServiceID property Windows Messenger , IMessengerContact interface", "IMessengerContact interface Windows Messenger , ServiceID property"]
topic_type:
- apiref
api_name:
