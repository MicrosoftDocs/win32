...
keywords: ["OnIMWindowCreated event Windows Messenger", "OnIMWindowCreated event Windows Messenger , DMessengerEvents interface", "DMessengerEvents interface Windows Messenger , OnIMWindowCreated event"]
topic_type:
- apiref
api_name:
