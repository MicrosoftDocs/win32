...
keywords:
- RequestChallenge method Windows Messenger
- RequestChallenge method Windows Messenger , IMsgrLock interface
- IMsgrLock interface Windows Messenger , RequestChallenge method
topic_type:
- apiref
api_name:
