...
Note that with Windows Installer, file hashing is available to optimize the copying of files. For details, see [**MsiGetFileHash**](/windows/win32/Msi/nf-msi-msigetfilehasha?branch=master) and the [MsiFileHash table](msifilehash-table.md). The MsiFileHash table can only be used with unversioned files.
