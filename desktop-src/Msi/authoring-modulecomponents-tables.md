---
Description: List the all the components delivered by the merge module in the ModuleComponents table. Note that the merge modules components are also specified in the Component table. For more information, see Authoring Merge Module Component Tables.
