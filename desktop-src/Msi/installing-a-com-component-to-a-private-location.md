---
Description: To force a COM-client application to always use the same copy of a COM-server, author the applications installation package to specify an isolated components relationship between the COM server and client.
