...
-   Generate an advertise script by calling [**MsiAdvertiseProduct**](msiadvertiseproduct.md) or [**MsiAdvertiseProductEx**](msiadvertiseproductex.md).
-   Your process must impersonate the user that is the target for the advertisement.
-   Call [**MsiAdvertiseScript**](msiadvertisescript.md), and use the flags SCRIPTFLAGS\_CACHEINFO \| SCRIPTFLAGS\_REGDATA\_APPINFO \| SCRIPTFLAGS\_REGDATA\_CNFGINFO \| SCRIPTFLAGS\_SHORTCUTS.
