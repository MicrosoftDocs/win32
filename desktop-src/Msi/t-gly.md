...
Set of properties used to flag the error conditions of a [*transform*](https://docs.microsoft.com/windows). For more information, see [**MsiCreateTransformSummaryInfo**](/windows/desktop/api/Msiquery/nf-msiquery-msicreatetransformsummaryinfoa).
...
Set of properties used to verify that the [*transform*](https://docs.microsoft.com/windows) can be applied to the database. For a list of these properties, see [**MsiCreateTransformSummaryInfo**](/windows/desktop/api/Msiquery/nf-msiquery-msicreatetransformsummaryinfoa).
