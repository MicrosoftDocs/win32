...
Template of the differences between two [*installer databases*](https://www.bing.com/search?q=*installer databases*) that can be applied to produce similar changes in other databases. For example, a localization transform can be used to change the language of an application. For more information, see [Merges and Transforms](merges-and-transforms.md).
...
Set of properties used to flag the error conditions of a [*transform*](#-msi-transform-gly). For more information, see [**MsiCreateTransformSummaryInfo**](/windows/desktop/api/Msiquery/nf-msiquery-msicreatetransformsummaryinfoa).
...
Set of properties used to verify that the [*transform*](#-msi-transform-gly) can be applied to the database. For a list of these properties, see [**MsiCreateTransformSummaryInfo**](/windows/desktop/api/Msiquery/nf-msiquery-msicreatetransformsummaryinfoa).
