...
Authors should not need to set the **TempFolder** property. Windows Installer uses the [**GetTempPath**](https://msdn.microsoft.com/windows/desktop/fb366f0d-df6b-44c2-92c9-b7a8e2583054) function to retrieve the path of the directory designated for temporary files and to set this property.
