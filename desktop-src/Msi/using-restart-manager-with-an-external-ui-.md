...
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| IDOK                     | The **OK** button was pressed by the user. The Windows Installer will request that the [Restart Manager](https://www.bing.com/search?q=Restart+Manager) shut down and restart the applications that hold files currently in use.                                                                                                                                               |
