...
Applications can use the [**GetShortPathName**](https://msdn.microsoft.com/library/Aa364989(v=VS.85).aspx) function to retrieve the short path form of a specified file path.
