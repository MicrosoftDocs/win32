...
> [!Note]  
> Msiexec also sets an error level on return that corresponds to [System Error Codes](base.system_error_codes).
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer [Command-Line Option](command-line-options.md) is <strong>/?</strong>.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer [Command-Line Option](command-line-options.md) is <strong>/qn</strong>.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer [Command-Line Option](command-line-options.md) is <strong>/qb!-</strong> with [<strong>REBOOTPROMPT</strong>](rebootprompt.md)=S set on the command line.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer command line has [<strong>REBOOT</strong>](reboot.md)=ReallySuppress set on the command line.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer command line has [<strong>REBOOT</strong>](reboot.md)=Force set on the command line.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer command line has [<strong>REBOOTPROMPT</strong>](rebootprompt.md) = &quot;&quot; set on the command line.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer [Command-Line Option](command-line-options.md) is <strong>/x</strong>.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer [Command-Line Option](command-line-options.md) is <strong>/I</strong> with [<strong>MSIPATCHREMOVE</strong>](msipatchremove.md)=Update1.msp | PatchGUID1[;Update2.msp | PatchGUID2] set on the command line.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer [Command-Line Option](command-line-options.md) is <strong>/L*</strong>.
</blockquote>
<br/>
<blockquote>
[!Note]<br />
...
<blockquote>
[!Note]<br />
The equivalent Windows Installer [Command-Line Option](command-line-options.md) is <strong>/I</strong>.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
