...
Windows Installer 4.0 cannot perform [Multiple Package Installations](multiple-package-installations.md) using [*transaction processing*](https://www.bing.com/search?q=*transaction processing*).
