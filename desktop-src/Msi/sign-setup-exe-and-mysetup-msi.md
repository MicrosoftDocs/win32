...
Before you place Setup.exe and MySetup.msi on the Web server, you should sign the files with your digital certificate and private key, Mycert.cer and Mycert.pvk, using the [SignTool](https://msdn.microsoft.com/windows/desktop/aa59cb35-5fba-4ce8-97ea-fc767c83f88e) utility. For more information about using the SignTool utility, see [CryptoAPI Tools Reference](https://msdn.microsoft.com/windows/desktop/f7208137-5971-4aa5-a46f-b5a64985cd19) in the Microsoft Windows Software Development Kit (SDK).
