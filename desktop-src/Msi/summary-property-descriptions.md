...
| [**Character Count**](character-count-summary.md)            | This part of the summary information stream is divided into two 16-bit words. The upper word contains [*transform validation flags*](https://www.bing.com/search?q=*transform validation flags*). Lower word contains [*transform error condition flags*](https://www.bing.com/search?q=*transform error condition flags*). |
