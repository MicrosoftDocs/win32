...
| [**MSIRESTARTMANAGERCONTROL**](msirestartmanagercontrol.md)<br/> | Specifies whether the package uses the [Restart Manager](https://www.bing.com/search?q=Restart Manager) or [FilesInUse](filesinuse-dialog.md) functionality.<br/>                                          |
...
| [**MsiRestartManagerSessionKey**](msirestartmanagersessionkey.md)<br/> | The Installer sets this property to the session key for the [Restart Manager](https://www.bing.com/search?q=Restart Manager) session.<br/>                                                                                                                                                         |
| [**MsiRunningElevated**](msirunningelevated-.md)<br/>                  | The Installer sets the value of this property to 1 when the installer is running with [*elevated*](https://www.bing.com/search?q=*elevated*) privileges.<br/>                                                                                                                   |
