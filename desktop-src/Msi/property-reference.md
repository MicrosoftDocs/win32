...
| [**MSIRESTARTMANAGERCONTROL**](msirestartmanagercontrol.md)<br/> | Specifies whether the package uses the [Restart Manager](rstmgr.portal) or [FilesInUse](filesinuse-dialog.md) functionality.<br/>                                          |
...
| [**MsiRestartManagerSessionKey**](msirestartmanagersessionkey.md)<br/> | The Installer sets this property to the session key for the [Restart Manager](rstmgr.portal) session.<br/>                                                                                                                                                         |
