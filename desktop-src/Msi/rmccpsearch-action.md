...
The RMCCPSearch action requires the [**CCP\_DRIVE**](ccp-drive.md) property to be set to the root path on the removable [*volume*](https://www.bing.com/search?q=*volume*) that has the installation for any of the qualifying products.
