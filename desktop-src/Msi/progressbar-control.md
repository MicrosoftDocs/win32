...
This control can be created from the PROGRESS\_CLASS class by using the [**CreateWindowEx**](_win32_createwindowex_cpp) function. It has the **WS\_CHILD** and **WS\_GROUP** styles.
