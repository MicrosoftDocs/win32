...
To obtain more information about why the installer is attempting to overwrite this particular file, you can use the verbose logging option. Use the INSTALLLOGMODE\_VERBOSE value in a call to [**MsiEnableLog**](/windows/win32/Msi/nf-msi-msienableloga?branch=master) or use the verbose output option of the [Command Line Options](command-line-options.md). This logs the following information.
