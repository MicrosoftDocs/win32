...
Built-in capabilities of the installer that can be used to author a graphical UI for installation. An author may choose an [*external user interface*](https://www.bing.com/search?q=*external user interface*). For more information, see [About the User Interface](about-the-user-interface.md).
...
Service that installs applications or features as requested by the user or another application. [*Advertising*](https://www.bing.com/search?q=*Advertising*) makes a feature or application available for install-on-demand installation. For more information, see: [Installation-on-Demand](installation-on-demand.md).
...
The [*Windows Installer*](https://www.bing.com/search?q=*Windows Installer*).
...
Relational database containing setup instructions for an installation. The installer database is stored in the [*.msi file*](https://www.bing.com/search?q=*.msi file*). For more information, see [Installer Database](installer-database.md).
...
Software that enables a developer to create and edit an [*.msi file*](https://www.bing.com/search?q=*.msi file*). This together with any [*external source files*](https://www.bing.com/search?q=*external source files*) comprise a [*package*](https://www.bing.com/search?q=*package*) containing all the information required for an installation.
...
Stored in the [*.msi file*](https://www.bing.com/search?q=*.msi file*). Multiple internal source files can be compressed and stored together in a [*cabinet file*](https://www.bing.com/search?q=*cabinet file*) that is stored within an .msi file.
