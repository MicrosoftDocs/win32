...
The File Table contains a complete list of source files with their various attributes, ordered by a unique, non-localized, identifier. Files can be stored on the source media as individual files or compressed within a [*cabinet file*](c-gly.md#-msi-cabinet-file-using-windows-installer-gly). For more information, see [Using Cabinets and Compressed Sources](using-cabinets-and-compressed-sources.md).
...
| **msidbFileAttributesChecksum**      | 0x000400    | 1024    | The file contains a valid [*checksum*](c-gly.md#-msi-checksum-gly). A checksum is required to repair a file that has become corrupted.                                                                                                                                                                                                                                                                                                                                                                                           |
...
The **msidbFileAttributesChecksum** bit within the Attributes column should be set for every executable file in the installation that has a valid [*checksum*](c-gly.md#-msi-checksum-gly) stored in the Portable Executable (PE) file header. Only those files that have this bit set will ever be verified for valid checksum during a reinstall. For more information, see the [**REINSTALLMODE**](reinstallmode.md).
...
The [InstallFiles](installfiles-action.md) and [RemoveFiles](removefiles-action.md) actions in the [*sequence tables*](s-gly.md#-msi-sequence-tables-gly) process the information in this table. For information about using *sequence tables*, see [Using a Sequence Table](using-a-sequence-table.md).
