...
The installer sets the value of the **MsiRestartManagerSessionKey** property to the session key for the [Restart Manager](rstmgr.portal) session. Custom actions can use the session key to join the [Restart Manager](rstmgr.portal) session.
