...
| Invalid Language Id                                                       | The database contains an invalid numeric Language Identifier (LANGID). See the [Language](language.md) data type. See [Language Identifier Constants and Strings](https://msdn.microsoft.com/windows/desktop/8a6373e0-46c2-4b1b-bc67-543f426ef15a). For example, 1033 for the U.S. and 0 for language neutral.<br/> |
