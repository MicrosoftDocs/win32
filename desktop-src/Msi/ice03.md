...
| Invalid Language Id                                                       | The database contains an invalid numeric Language Identifier (LANGID). See the [Language](language.md) data type. See [Language Identifier Constants and Strings](intl.language_identifier_constants_and_strings). For example, 1033 for the U.S. and 0 for language neutral.<br/> |
