...
The installer sets the value of the **UserSID** property to the string representation of the security identifier (SID) of the user running the installation. For more information, see [Authorization Structures](https://msdn.microsoft.com/windows/desktop/abf5c51d-c000-45f4-b341-ec4a027e89ec).
