...
The **SystemLanguageID** property is the default language identifier for the system. The installer sets it by a call to [**GetSystemDefaultLangID**](intl.getsystemdefaultlangid).
