---
Description: Authors of installation packages can specify that the installer copy the shared files (commonly shared DLLs) of an application into that applications folder rather than to a shared location.
