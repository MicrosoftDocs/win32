...
You can set this value to **L** for **WINHTTP\_AUTOLOGON\_SECURITY\_LEVEL\_LOW**, set to **M** for **WINHTTP\_AUTOLOGON\_SECURITY\_LEVEL\_MEDIUM**, and set to **H** for **WINHTTP\_AUTOLOGON\_SECURITY\_LEVEL\_HIGH**. The default level is **WINHTTP\_AUTOLOGON\_SECURITY\_LEVEL\_MEDIUM**. For more information about automatic logon policy, see the section for [Authentication in WinHTTP](https://msdn.microsoft.com/library/Aa383144(v=VS.85).aspx).
