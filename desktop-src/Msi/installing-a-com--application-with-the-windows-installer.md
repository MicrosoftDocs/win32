...
For information about how to install COM+ applications, see the [Deploying COM+ Applications](cos.deploying_com__applications) section in the [COM+ (Component Services)](cos.component_services_portal) documentation.
