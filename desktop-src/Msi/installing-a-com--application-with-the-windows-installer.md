...
For information about how to install COM+ applications, see the [Deploying COM+ Applications](https://msdn.microsoft.com/library/ms687602(v=VS.85).aspx) section in the [COM+ (Component Services)](https://msdn.microsoft.com/library/ms685978(v=VS.85).aspx) documentation.
