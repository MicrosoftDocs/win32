...
Refer to the [Multilingual User Interface (MUI)](https://msdn.microsoft.com/library/windows/desktop/dd319073) documentation for information on how to develop MUI-enabled applications .
