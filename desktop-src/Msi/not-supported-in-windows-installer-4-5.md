...
Windows Installer 4.5 does not support some services configuration options that can enable a package to customize the [services](https://msdn.microsoft.com/windows/desktop/711391da-05c6-4d89-88d6-c68c2e5c2f86) on a computer. For more information, see [Using Services Configuration](using-services-configuration.md).

Windows Installer 4.5 does not support some features that enable the Windows Installer to secure new accounts, Windows [Services](https://msdn.microsoft.com/windows/desktop/711391da-05c6-4d89-88d6-c68c2e5c2f86), files, folders, and registry keys. For information, see [Securing Resources](securing-resources-.md).
