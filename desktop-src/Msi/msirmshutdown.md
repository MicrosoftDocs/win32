...
| <dl> <dt>1</dt> </dl> | Processes or services that are currently using files affected by the update, and that do not respond to the [Restart Manager](rstmgr.portal), are forced to shut down.<br/>                                                                                       |
...
The **MSIRMSHUTDOWN** property is ignored if the [Restart Manager](rstmgr.portal) is unavailable or disabled.
