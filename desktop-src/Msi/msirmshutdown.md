...
| <dl> <dt>1</dt> </dl> | Processes or services that are currently using files affected by the update, and that do not respond to the [Restart Manager](https://msdn.microsoft.com/en-us/library/Cc948910(v=VS.85).aspx), are forced to shut down.<br/>                                                                                       |
...
The **MSIRMSHUTDOWN** property is ignored if the [Restart Manager](https://msdn.microsoft.com/en-us/library/Cc948910(v=VS.85).aspx) is unavailable or disabled.
