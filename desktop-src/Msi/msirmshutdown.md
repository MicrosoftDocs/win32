...
| <dl> <dt>1</dt> </dl> | Processes or services that are currently using files affected by the update, and that do not respond to the [Restart Manager](44b7975a-0093-4c8f-9a14-2a6bfd7a68a5), are forced to shut down.<br/>                                                                                       |
...
The **MSIRMSHUTDOWN** property is ignored if the [Restart Manager](44b7975a-0093-4c8f-9a14-2a6bfd7a68a5) is unavailable or disabled.
