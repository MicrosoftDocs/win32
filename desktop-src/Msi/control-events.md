...
| [RmShutdownAndRestart](rmshutdownandrestart-controlevent.md)       | Use the [Restart Manager](https://msdn.microsoft.com/library/windows/desktop/cc948910) to shutdown all applications that have files in use and to restart them at the end of the installation.                                                              |
