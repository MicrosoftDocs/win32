...
To physically create the dialog box using the Windows user interface API, [**DialogBox**](_win32_dialogbox_cpp) is called and passes a pointer to the template. In Windows Installer, the dialog box is created during execution of one of the three UI sequence tables.
