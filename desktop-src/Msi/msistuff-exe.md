...
| **-u**               | ISETUPPROPNAME\_BASEURL      | Set BaseURL, the base URL location of Setup.exe. If no value is present, the location of Setup.exe defaults to removable media. Only URL based installs are subject to a check with [**WinVerifyTrust**](https://msdn.microsoft.com/b7efac6a-ac9f-477a-aada-63fe32208e6f). The trailing slash on the URL is optional. This option may be omitted.                                                                                                                                                                                                                     |
