...
This control can be created from the BUTTON class by using the [**CreateWindowEx**](_win32_createwindowex_cpp) function. It has the **BS\_GROUPBOX**, **WS\_CHILD**, and **WS\_GROUP** styles.
