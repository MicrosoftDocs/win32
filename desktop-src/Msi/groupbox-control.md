...
This control can be created from the BUTTON class by using the [**CreateWindowEx**](https://www.bing.com/search?q=**CreateWindowEx**) function. It has the **BS\_GROUPBOX**, **WS\_CHILD**, and **WS\_GROUP** styles.
