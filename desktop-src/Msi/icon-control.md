...
This control can be created from the STATIC class by using the [**CreateWindowEx**](https://www.bing.com/search?q=**CreateWindowEx**) function. It has the **SS\_ICON**, **SS\_CENTERIMAGE**, **WS\_CHILD**, and **WS\_GROUP** styles.
