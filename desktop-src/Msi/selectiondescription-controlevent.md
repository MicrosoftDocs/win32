...
This ControlEvent requires the user interface to be run at the [*full UI*](https://www.bing.com/search?q=*full UI*) level. This event will not work with a [*reduced UI*](https://www.bing.com/search?q=*reduced UI*) or [*basic UI*](https://www.bing.com/search?q=*basic UI*). For more information, see [User Interface Levels](user-interface-levels.md).
