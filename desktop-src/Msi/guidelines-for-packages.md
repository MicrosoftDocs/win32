...
Outside of [Group Policy](https://msdn.microsoft.com/library/Aa374177(v=VS.85).aspx), the following check for UAC compliance can be used on Windows XP.
