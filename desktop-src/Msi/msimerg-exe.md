...
Msimerg.exe is a command line utility that uses [**MsiDatabaseMerge**](msidatabasemerge.md) to [merge](merges-and-transforms.md) a reference database into a base database.
