...
| Value                                                                        | Meaning                                                                                                                                                                                      |
|------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <dl> <dt>0</dt> </dl> | All system services that were shut down to install the update are restarted. All applications that registered themselves with the [Restart Manager](rstmgr.portal) are restarted.<br/> |
| <dl> <dt>1</dt> </dl> | Processes that were shut down using the [Restart Manager](rstmgr.portal) while installing the update will not be restarted after the update is applied.<br/>                           |
...
The **MSIDISABLERMRESTART** Property is ignored if the [Restart Manager](rstmgr.portal) is unavailable or disabled.
