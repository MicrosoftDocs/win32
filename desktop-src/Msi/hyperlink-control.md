...
This control can be created from the WC\_LINK class by using the [**CreateWindowEx**](_win32_createwindowex_cpp) function. It has the WS\_CHILD, WS\_TABSTOP and WS\_GROUP styles.
