...
Changes made to the database are saved if and only if the [**CloseDatabase**](/windows/desktop/api/Mergemod/) method is called with *bCommit* set to **TRUE**.
...
See [**Merge**](/windows/desktop/api/Mergemod/) function.
