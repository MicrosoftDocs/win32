---
Description: The installer sets the OLEAdvtSupport property to true when the current users system has been upgraded to work with installation-on-demand through COM.
