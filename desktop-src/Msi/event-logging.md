...
<strong>msirbRebootCustomActionReason</strong> (4)- A custom action called the [<strong>MsiSetMode</strong>](/windows/desktop/api/Msiquery/nf-msiquery-msisetmode) function.<br />
