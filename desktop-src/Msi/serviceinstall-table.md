...
| SERVICE\_DEMAND\_START | 0x00000003 | A service start when the service control manager calls the [**StartService**](https://msdn.microsoft.com/f185a878-e1c3-4fe5-8ec9-c5296d27f985) function. |
