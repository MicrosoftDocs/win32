...
| SERVICE\_DEMAND\_START | 0x00000003 | A service start when the service control manager calls the [**StartService**](base.startservice) function. |
...
This table has most of the parameters to the Win32 [**CreateService**](base.createservice) function.
