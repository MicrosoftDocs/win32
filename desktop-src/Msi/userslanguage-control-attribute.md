---
Description: If this bit flag is set, fonts are created using the users default UI code page. If the bit flag is not set, fonts are created using the database code page.
