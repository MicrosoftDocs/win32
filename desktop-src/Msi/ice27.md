...
ICE27 validates the [*sequence tables*](https://www.bing.com/search?q=*sequence tables*) of an installation package for valid actions, action sequence restrictions, and organization in Search, Costing, Selection, and Execution sections.
