...
For more information, see [Terminal Services](termserv.terminal_services_start_page) in the Microsoft Windows Software Development Kit (SDK).
...
[Terminal Services](termserv.terminal_services_start_page)
</dt> </dl>
