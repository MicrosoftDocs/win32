...
| [MsiRMFilesInUse Dialog](msirmfilesinuse-dialog.md)                           | Gives users the option to use the [Restart Manager](44b7975a-0093-4c8f-9a14-2a6bfd7a68a5) to close and restart applications. Available beginning with Windows Installer version 4.0. |
...
| [**MSIRESTARTMANAGERCONTROL**](msirestartmanagercontrol.md)                   | Property to disable Windows Installer interaction with the [Restart Manager](44b7975a-0093-4c8f-9a14-2a6bfd7a68a5). Available beginning with Windows Installer version 4.0.          |
| [**MSIDISABLERMRESTART**](msidisablermrestart.md)                             | Specifies how the [Restart Manager](44b7975a-0093-4c8f-9a14-2a6bfd7a68a5) closes and restarts applications. Available beginning with Windows Installer version 4.0.                  |
| [**MSIRMSHUTDOWN**](msirmshutdown.md)                                         | Specifies how the [Restart Manager](44b7975a-0093-4c8f-9a14-2a6bfd7a68a5) closes and restarts applications. Available beginning with Windows Installer version 4.0.                  |
...
| [DisableAutomaticApplicationShutdown](disableautomaticapplicationshutdown.md) | Policy to disable Windows Installer interaction with [Restart Manager](44b7975a-0093-4c8f-9a14-2a6bfd7a68a5). Available beginning with Windows Installer version 4.0.                |
