...
The [AppSearch](appsearch-action.md) action in [*sequence tables*](https://www.bing.com/search?q=*sequence tables*) processes the information in this table. For information about using *sequence tables*, see [Using a Sequence Table](using-a-sequence-table.md).
