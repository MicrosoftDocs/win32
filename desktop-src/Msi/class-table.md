...
|---------------------------------------|---------------------------------------------------------------------------|
| [LocalServer](_com_localserver)       | Specifies the full path to a 16-bit local server application.             |
| [LocalServer32](_com_localserver32)   | Specifies the full path to a 32-bit local server application.             |
| [InprocServer](_com_inprocserver)     | Specifies the path to an in-process server DLL.                           |
| [InprocServer32](_com_inprocserver32) | Specifies the path to a 32-bit in-process server and the threading model. |
...
If multiple patterns exist, they must be delimited by a semicolon, and numeric subkeys are generated: 0, 1, 2... For more information about this functionality, see [**GetClassFile**](_com_getclassfile).
