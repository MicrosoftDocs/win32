...
| Windows Installer 3.1 | 3.1.4000.1830             | Released with Windows Server 2003 with Service Pack 1 (SP1) and Windows XP Professional x64 Edition. Update this version to version 3.1.4000.2435 to address the issue discussed in [KB898628](https://go.microsoft.com/fwlink/p/?LinkID=83847). |
| Windows Installer 3.1 | 3.1.4000.3959             | Released with Windows Server 2003 with Service Pack 2 (SP2).                                                                                                                                                                                    |
| Windows Installer 3.1 | 3.1.4000.2435             | Released with a fix to address the issue discussed in [KB898628](https://go.microsoft.com/fwlink/p/?LinkID=83847). This is the latest version of Windows Installer 3.1.                                                                          |
