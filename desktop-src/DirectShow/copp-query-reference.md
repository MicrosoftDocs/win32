...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](dxva-coppstatusdata.md) structure. The bus type is returned in the **dwData** member as a flag from the [**COPP\_BusType**](copp-bustype.md) enumeration.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](dxva-coppstatusdata.md) structure. The connector type is returned in the **dwData** member as a flag from the [**COPP\_ConnectorType**](copp-connectortype.md) enumeration.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusDisplayData**](dxva-coppstatusdisplaydata.md) structure.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusHDCPKeyData**](dxva-coppstatushdcpkeydata.md) structure.
...
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](dxva-coppstatusdata.md) structure. The current protection level is returned in the **dwData** member. The meaning of this value depends on the protection mechanism that is queried. For each protection mechanism, the value of the **dwData** member is a flag from a different enumeration, as shown in the following table.

    | Protection mechanism | Enumeration                                                           |
    |----------------------|-----------------------------------------------------------------------|
    | ACP                  | [**COPP\_ACP\_Protection\_Level**](copp-acp-protection-level.md)     |
    | CGMS-A               | [**COPP\_CGMSA\_Protection\_Level**](copp-cgmsa-protection-level.md) |
    | HDCP                 | [**COPP\_HDCP\_Protection\_Level**](copp-hdcp-protection-level.md)   |
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](dxva-coppstatusdata.md) structure. The protection mechanisms are returned in the **dwData** member as a combination of zero or more flags. See [COPP Protection Type Flags](copp-protection-type-flags.md). If more than one protection mechanism is available, the flags are combined with a bitwise **OR**.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusSignalingCmdData**](dxva-coppstatussignalingcmddata.md) structure.
