...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](/windows/win32/dxva9typ/ns-dxva9typ-_dxva_coppstatusdata?branch=master) structure. The bus type is returned in the **dwData** member as a flag from the [**COPP\_BusType**](/windows/win32/dxva9typ/ne-dxva9typ-_copp_bustype?branch=master) enumeration.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](/windows/win32/dxva9typ/ns-dxva9typ-_dxva_coppstatusdata?branch=master) structure. The connector type is returned in the **dwData** member as a flag from the [**COPP\_ConnectorType**](/windows/win32/dxva9typ/ne-dxva9typ-_copp_connectortype?branch=master) enumeration.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusDisplayData**](/windows/win32/dxva9typ/ns-dxva9typ-_dxva_coppstatusdisplaydata?branch=master) structure.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusHDCPKeyData**](/windows/win32/dxva9typ/ns-dxva9typ-_dxva_coppstatushdcpkeydata?branch=master) structure.
...
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](/windows/win32/dxva9typ/ns-dxva9typ-_dxva_coppstatusdata?branch=master) structure. The current protection level is returned in the **dwData** member. The meaning of this value depends on the protection mechanism that is queried. For each protection mechanism, the value of the **dwData** member is a flag from a different enumeration, as shown in the following table.

    | Protection mechanism | Enumeration                                                           |
    |----------------------|-----------------------------------------------------------------------|
    | ACP                  | [**COPP\_ACP\_Protection\_Level**](/windows/win32/dxva9typ/ne-dxva9typ-_copp_acp_protection_level?branch=master)     |
    | CGMS-A               | [**COPP\_CGMSA\_Protection\_Level**](/windows/win32/dxva9typ/ne-dxva9typ-_copp_cgmsa_protection_level?branch=master) |
    | HDCP                 | [**COPP\_HDCP\_Protection\_Level**](/windows/win32/dxva9typ/ne-dxva9typ-_copp_hdcp_protection_level?branch=master)   |
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusData**](/windows/win32/dxva9typ/ns-dxva9typ-_dxva_coppstatusdata?branch=master) structure. The protection mechanisms are returned in the **dwData** member as a combination of zero or more flags. See [COPP Protection Type Flags](copp-protection-type-flags.md). If more than one protection mechanism is available, the flags are combined with a bitwise **OR**.
...
-   **Input data**: None.
-   **Return data**: Returns a [**DXVA\_COPPStatusSignalingCmdData**](/windows/win32/dxva9typ/ns-dxva9typ-_dxva_coppstatussignalingcmddata?branch=master) structure.
