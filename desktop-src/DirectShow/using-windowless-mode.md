...
1.  [**WM\_PAINT**](https://msdn.microsoft.com/afebaa07-cf00-47db-a919-46436f164881). Call [**IVMRWindowlessControl::RepaintVideo**](/windows/desktop/api/Strmif/nf-strmif-ivmrwindowlesscontrol-repaintvideo). This method causes the VMR-7 to repaint the most recent video frame.
2.  [**WM\_DISPLAYCHANGE**](https://msdn.microsoft.com/5a6111fd-648e-41a9-aaf8-e5d93f5d54cd): Call [**IVMRWindowlessControl::DisplayModeChanged**](/windows/desktop/api/Strmif/nf-strmif-ivmrwindowlesscontrol-displaymodechanged). This method notifies the VMR-7 that the video must be shown at a new resolution or color depth.
...
1.  [**WM\_PAINT**](https://msdn.microsoft.com/afebaa07-cf00-47db-a919-46436f164881). Call [**IVMRWindowlessControl9::RepaintVideo**](/windows/desktop/api/Vmr9/nf-vmr9-ivmrwindowlesscontrol9-repaintvideo). This method causes the VMR-9 to repaint the most recent video frame.
2.  [**WM\_DISPLAYCHANGE**](https://msdn.microsoft.com/5a6111fd-648e-41a9-aaf8-e5d93f5d54cd): Call [**IVMRWindowlessControl9::DisplayModeChanged**](/windows/desktop/api/Vmr9/nf-vmr9-ivmrwindowlesscontrol9-displaymodechanged). This method notifies the VMR-9 that the video must be shown at a new resolution or color depth.
...
The following example shows a [**WM\_PAINT**](https://msdn.microsoft.com/afebaa07-cf00-47db-a919-46436f164881) message handler. It paints a region defined by the client rectangle minus the video rectangle. Do not draw onto the video rectangle, because the VMR will paint over it, causing flickering. For the same reason, do not set a background brush in your window class.
...
Although you must respond to [**WM\_PAINT**](https://msdn.microsoft.com/afebaa07-cf00-47db-a919-46436f164881) messages, there is nothing you need to do between **WM\_PAINT** messages to update the video. As this example shows, windowless mode lets you treat the video image simply as a self-drawing region on the window.
