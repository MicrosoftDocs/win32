...
3.  The [**CreateClassEnumerator**](/windows/desktop/api/Strmif/nf-strmif-icreatedevenum-createclassenumerator) method returns a pointer to the [**IEnumMoniker**](https://msdn.microsoft.com/windows/desktop/c8dec22b-946d-48ae-9315-54d353f3b853) interface. To enumerate the monikers, call [**IEnumMoniker::Next**](https://msdn.microsoft.com/windows/desktop/ab4fd626-bddc-42b4-b279-b89d1f79b1e1).
...
The [**IEnumMoniker**](https://msdn.microsoft.com/windows/desktop/c8dec22b-946d-48ae-9315-54d353f3b853) interface enumerates a list of [**IMoniker**](https://msdn.microsoft.com/windows/desktop/17f4c1df-7a9c-42ef-a888-70cd8d85f070) interfaces, each of which represents a device moniker. The application can read properties from the moniker, or use the moniker to create a DirectShow capture filter for the device. Moniker properties are returned as **VARIANT** values. The following properties are supported by device monikers.
...
-   If the "WaveInID" property is present, it means the DirectShow capture filter uses the [Waveform Audio](https://msdn.microsoft.com/windows/desktop/3188355c-65be-4372-8e87-e7f755982592) APIs internally to communicate with the device. The value of the "WaveInID" property corresponds to the identifier used by the **waveIn\*** functions, such as [**waveInOpen**](https://msdn.microsoft.com/windows/desktop/41b5b581-d35c-48ad-adcf-659126c4af50).

To read properties from the moniker, perform the following steps.

1.  Call [**IMoniker::BindToStorage**](https://msdn.microsoft.com/windows/desktop/94c8219f-8131-45dd-b350-878ffd6161ea) to get a pointer to the [**IPropertyBag**](https://msdn.microsoft.com/windows/desktop/128e847b-99f9-44a3-9176-56eb34f3dddc) interface.
...
To create a DirectShow capture filter for the device, call the [**IMoniker::BindToObject**](https://msdn.microsoft.com/windows/desktop/b5ce39ff-3387-4f72-9aea-5a26eed3810c) method to get an [**IBaseFilter**](/windows/desktop/api/Strmif/nn-strmif-ibasefilter) pointer. Then call [**IFilterGraph::AddFilter**](/windows/desktop/api/Strmif/nf-strmif-ifiltergraph-addfilter) to add the filter to the filter graph:
