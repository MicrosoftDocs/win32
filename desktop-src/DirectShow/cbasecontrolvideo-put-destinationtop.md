...
title: CBaseControlVideo.put\_DestinationTop method
ms.date: 05/31/2018
ms.topic: article
...
# CBaseControlVideo.put\_DestinationTop method

The `put_DestinationTop` method sets the top coordinate of the destination rectangle.
