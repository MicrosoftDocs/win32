...
This method overrides the [**CBasePin::BreakConnect**](cbasepin-breakconnect.md) method. It decommits the allocator and releases the [**IMemAllocator**](imemallocator.md) and [**IPin**](ipin.md) interfaces.
