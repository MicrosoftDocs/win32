...
-   Interlaced video. For interlaced video, the decoder requires a [**VIDEOINFOHEADER2**](/windows/desktop/api/Dvdmedia/ns-dvdmedia-tagvideoinfoheader2) format, which the Video Renderer does not support.
