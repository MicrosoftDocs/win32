...
Sent when the [DVD Navigator](dvd-navigator-filter.md) processes a DVD navigation command.
...
The lower 32 bits of the raw navigation command.
...
The upper 32 bits of the raw navigation command.
