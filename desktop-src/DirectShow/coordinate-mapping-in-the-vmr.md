...
1.  The transformation *T(Src)* maps the source rectangle to the destination rectangle. These are specified by the **rcSource** and **rcTarget** members of the [**VIDEOINFOHEADER**](videoinfoheader.md) or [**VIDEOINFOHEADER2**](videoinfoheader2.md) structure in the media type. This mapping preprocesses the source image as it passes to the VMR.
