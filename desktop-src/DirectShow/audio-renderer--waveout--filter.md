...
This filter does not check the audio stream's subtype. The [**WAVEFORMAT**](https://msdn.microsoft.com/library/windows/desktop/dd757712) or [**WAVEFORMATEX**](/windows/desktop/api/mmreg/) structure passed in the format contains the information needed for the connection.
