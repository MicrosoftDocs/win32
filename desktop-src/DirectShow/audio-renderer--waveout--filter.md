...
This filter does not check the audio stream's subtype. The [**WAVEFORMAT**](https://msdn.microsoft.com/library/windows/desktop/dd757712) or [**WAVEFORMATEX**](https://msdn.microsoft.com/en-us/library/Dd390970(v=VS.85).aspx) structure passed in the format contains the information needed for the connection.
