...
title: IKsPropertySetGet method
ms.date: 05/31/2018
ms.topic: article
...
> [!Note]  
> Another interface by this name exists in the dsound.h header file. The two interfaces are not compatible. The [IKsControl](stream.ikscontrol) interface, documented in the DirectShow DDK, is now the recommended interface for passing property sets between WDM drivers and user mode components.
