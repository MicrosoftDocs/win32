...
You do not have to implement [**IUnknown::AddRef**](com.iunknown_addref) or [**IUnknown::Release**](com.iunknown_release). All of the filter and pin classes derive from [**CUnknown**](cunknown.md), which handles reference counting.
