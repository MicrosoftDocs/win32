...
-   Streaming thread(s): [**IMemInputPin::Receive**](imeminputpin-receive.md), [**IMemInputPin::ReceiveMultiple**](imeminputpin-receivemultiple.md), [**IPin::EndOfStream**](ipin-endofstream.md), [**IMemAllocator::GetBuffer**](imemallocator-getbuffer.md).
-   Application thread: [**IMediaFilter::Pause**](imediafilter-pause.md), [**IMediaFilter::Run**](imediafilter-run.md), [**IMediaFilter::Stop**](imediafilter-stop.md), [**IMediaSeeking::SetPositions**](imediaseeking-setpositions.md), [**IPin::BeginFlush**](ipin-beginflush.md), [**IPin::EndFlush**](ipin-endflush.md).
-   Either: [**IPin::NewSegment**](ipin-newsegment.md).
...
-   It is waiting to get a sample inside the [**IMemAllocator::GetBuffer**](imemallocator-getbuffer.md) method, because all of the allocator's samples are in use.
