...
| [**EC\_DVD\_CURRENT\_HMSF\_TIME**](ec-dvd-current-hmsf-time.md)               | Signals the current time in [**DVD\_HMSF\_TIMECODE**](/windows/desktop/api/strmif/ns-strmif-tagdvd_hmsf_timecode) format at the beginning of every video object unit (VOBU).                                   |
