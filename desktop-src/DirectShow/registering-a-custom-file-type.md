...
> [!Note]  
> This scheme is similar to the one used by the [**GetClassFile**](com.getclassfile) function.
...
Windows Media Player uses an additional set of registry entries. For more information, see [File Name Extension Registry Settings](wmp.file_name_extension_registry_settings) in the Windows Media Player SDK.
