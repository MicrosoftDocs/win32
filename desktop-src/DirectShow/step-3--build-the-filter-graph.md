...
1.  Calls [**CoCreateInstance**](https://msdn.microsoft.com/en-us/library/ms686615(v=VS.85).aspx) to create a new instance of the [Filter Graph Manager](filter-graph-manager.md).
