...
The `CBasicAudio` class implements the **IDispatch** methods of the [**IBasicAudio**](ibasicaudio.md) interface. The remaining **IBasicAudio** methods are left as pure virtual methods, and must be implemented by a derived class.
