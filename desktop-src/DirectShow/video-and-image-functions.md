...
| [**MPEG1\_SEQUENCE\_INFO**](/windows/desktop/api/dvdmedia/nf-amvideo-mpeg1_sequence_info)                 | Returns the address of the sequence header inside an [**MPEG1VIDEOINFO**](/windows/desktop/api/amvideo/ns-amvideo-tagmpeg1videoinfo) structure.                                                          |
...
| [**SIZE\_EGA\_PALETTE**](/windows/desktop/api/Amvideo/)                       | Calculates the size needed for the palette entries in a 4-bit RGB bitmap.                                                                                         |
| [**SIZE\_MASKS**](/windows/desktop/api/Amvideo/)                                    | Calculates the size of the color masks in a [**VIDEOINFO**](/windows/desktop/api/amvideo/ns-amvideo-tagvideoinfo) structure.                                                                             |
...
| [**SIZE\_PALETTE**](/windows/desktop/api/Amvideo/)                                | calculates the size of the palette entries in a [**VIDEOINFO**](/windows/desktop/api/amvideo/ns-amvideo-tagvideoinfo) structure.                                                                         |
| [**SIZE\_PREHEADER**](/windows/desktop/api/Amvideo/)                            | Calculates the byte offset of the **bmiHeader** field within a [**VIDEOINFOHEADER**](/windows/desktop/api/amvideo/ns-amvideo-tagvideoinfoheader) structure.                                              |
| [**SIZE\_VIDEOHEADER**](/windows/desktop/api/Amvideo/)                        | Calculates the size of the [**VIDEOINFOHEADER**](/windows/desktop/api/amvideo/ns-amvideo-tagvideoinfoheader) structure.                                                                                  |
| [**TRUECOLOR**](/windows/desktop/api/Amvideo/)                                   | Returns the [**TRUECOLORINFO**](/windows/desktop/api/amvideo/ns-amvideo-tag_truecolorinfo) structure from a [**VIDEOINFO**](/windows/desktop/api/amvideo/ns-amvideo-tagvideoinfo) structure.                                            |
