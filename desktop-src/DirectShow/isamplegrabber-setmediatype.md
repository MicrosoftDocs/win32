...
title: ISampleGrabberSetMediaType method
ms.date: 05/31/2018
ms.topic: article
...
Pointer to an [**AM\_MEDIA\_TYPE**](/windows/win32/strmif/ns-strmif-_ammediatype?branch=master) structure specifies the required media type. It is not necessary to set all the structure members; see Remarks for details.
