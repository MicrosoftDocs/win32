...
The **EC\_BUILT** event is sent by the [Video Control](mstv-video_control_overview) when a graph has been completely built. This event is not forwarded to applications.
