...
| [**eAVDecAACDownmixMode**](https://msdn.microsoft.com/library/Dd757608(v=VS.85).aspx)                                     | Specifies whether an AAC decoder uses standard MPEG-2/MPEG-4 stereo downmix equations.                    |
...
| [**eAVDecVideoInputScanType**](https://msdn.microsoft.com/library/Dd388763(v=VS.85).aspx)                             | Specifies how the decoded video stream is interlaced.                                                     |
...
| [**eAVEncAudioDualMono**](https://msdn.microsoft.com/library/Dd388765(v=VS.85).aspx)                                       | Specifies whether 2-channel audio is encoded as stereo or dual mono.                                      |
| [**eAVEncAudioInputContent Enumeration**](https://msdn.microsoft.com/library/Dd388768(v=VS.85).aspx)                   | Specifies whether the audio content contains music or voice.                                              |
| [**eAVEncCommonRateControlMode**](https://msdn.microsoft.com/library/Dd388772(v=VS.85).aspx)                       | Specifies the rate control mode.                                                                          |
| [**eAVEncCommonStreamEndHandling**](https://msdn.microsoft.com/library/Dd388776(v=VS.85).aspx)                   | Specifies whether the encoder discards partial groups of pictures (GOPs) at the end of the stream.        |
| [**eAVEncDDAtoDConverterType**](https://msdn.microsoft.com/library/Dd388780(v=VS.85).aspx)                           | Specifies the type of analog-to-digital (A/D) conversion for a Dolby Digital audio stream.                |
| [**eAVEncDDDynamicRangeCompressionControl**](https://msdn.microsoft.com/library/Dd319379(v=VS.85).aspx) | Specifies the dynamic range control profile in a Dolby Digital audio stream.                              |
...
| [**eAVEncDDProductionRoomType**](https://msdn.microsoft.com/library/Dd319390(v=VS.85).aspx)                         | Specifies the room type for a Dolby Digital audio stream.                                                 |
...
| [**eAVEncMPAEmphasisType**](https://msdn.microsoft.com/library/Dd319403(v=VS.85).aspx)                                   | Specifies the type of de-emphasis filter that should be used when decoding.                               |
| [**eAVEncMPALayer**](https://msdn.microsoft.com/library/Dd319405(v=VS.85).aspx)                                                 | Specifies the MPEG audio layer.                                                                           |
...
| [**eAVEncMPVProfile**](https://msdn.microsoft.com/library/Dd319417(v=VS.85).aspx)                                             | Specifies the MPEG-2 profile.                                                                             |
...
| [**eAVEncMPVScanPattern**](https://msdn.microsoft.com/library/Dd319423(v=VS.85).aspx)                                     | Specifies the macroblock scan pattern.                                                                    |
| [**eAVEncMPVSceneDetection**](https://msdn.microsoft.com/library/Dd319426(v=VS.85).aspx)                               | Specifies how the encoder behaves when it detects a new scene.                                            |
| [**eAVEncMuxOutput**](https://msdn.microsoft.com/library/Dd757614(v=VS.85).aspx)                                               | Specifies the type of output stream produced by a multiplexer.                                            |
| [**eAVEncVideoChromaResolution**](https://msdn.microsoft.com/library/Dd319429(v=VS.85).aspx)                       | Specifies chroma resolution.                                                                              |
...
| [**eAVEncVideoFilmContent**](https://msdn.microsoft.com/library/Dd319452(v=VS.85).aspx)                                 | Specifies whether the original source of the input video was film or video.                               |
| [**eAVEncVideoOutputFrameRateConversion**](https://msdn.microsoft.com/library/Dd319454(v=VS.85).aspx)     | Specifies whether the encoder converts the frame rate.                                                    |
| [**eAVEncVideoOutputScanType**](https://msdn.microsoft.com/library/Dd319457(v=VS.85).aspx)                           | Specifies how the encoder interlaces the output video.                                                    |
