...
| [**eAVDecAACDownmixMode**](/windows/desktop/api/codecapi/)                                     | Specifies whether an AAC decoder uses standard MPEG-2/MPEG-4 stereo downmix equations.                    |
...
| [**eAVDecVideoInputScanType**](/windows/desktop/api/codecapi/)                             | Specifies how the decoded video stream is interlaced.                                                     |
...
| [**eAVEncAudioDualMono**](/windows/desktop/api/codecapi/)                                       | Specifies whether 2-channel audio is encoded as stereo or dual mono.                                      |
| [**eAVEncAudioInputContent Enumeration**](/windows/desktop/api/codecapi/)                   | Specifies whether the audio content contains music or voice.                                              |
| [**eAVEncCommonRateControlMode**](/windows/desktop/api/codecapi/)                       | Specifies the rate control mode.                                                                          |
| [**eAVEncCommonStreamEndHandling**](/windows/desktop/api/codecapi/)                   | Specifies whether the encoder discards partial groups of pictures (GOPs) at the end of the stream.        |
| [**eAVEncDDAtoDConverterType**](/windows/desktop/api/codecapi/)                           | Specifies the type of analog-to-digital (A/D) conversion for a Dolby Digital audio stream.                |
| [**eAVEncDDDynamicRangeCompressionControl**](/windows/desktop/api/codecapi/) | Specifies the dynamic range control profile in a Dolby Digital audio stream.                              |
...
| [**eAVEncDDProductionRoomType**](/windows/desktop/api/codecapi/)                         | Specifies the room type for a Dolby Digital audio stream.                                                 |
...
| [**eAVEncMPAEmphasisType**](/windows/desktop/api/codecapi/)                                   | Specifies the type of de-emphasis filter that should be used when decoding.                               |
| [**eAVEncMPALayer**](/windows/desktop/api/codecapi/)                                                 | Specifies the MPEG audio layer.                                                                           |
...
| [**eAVEncMPVProfile**](/windows/desktop/api/codecapi/)                                             | Specifies the MPEG-2 profile.                                                                             |
...
| [**eAVEncMPVScanPattern**](/windows/desktop/api/codecapi/)                                     | Specifies the macroblock scan pattern.                                                                    |
| [**eAVEncMPVSceneDetection**](/windows/desktop/api/codecapi/)                               | Specifies how the encoder behaves when it detects a new scene.                                            |
| [**eAVEncMuxOutput**](/windows/desktop/api/codecapi/)                                               | Specifies the type of output stream produced by a multiplexer.                                            |
| [**eAVEncVideoChromaResolution**](/windows/desktop/api/codecapi/)                       | Specifies chroma resolution.                                                                              |
...
| [**eAVEncVideoFilmContent**](/windows/desktop/api/codecapi/)                                 | Specifies whether the original source of the input video was film or video.                               |
| [**eAVEncVideoOutputFrameRateConversion**](/windows/desktop/api/codecapi/)     | Specifies whether the encoder converts the frame rate.                                                    |
| [**eAVEncVideoOutputScanType**](/windows/desktop/api/codecapi/)                           | Specifies how the encoder interlaces the output video.                                                    |
