...
This member function retrieves the **m\_bAutoShow** member setting and has the same result as using the [**IVideoWindow::get\_AutoShow**](/windows/win32/Control/nf-control-ivideowindow-get_autoshow?branch=master) method.
