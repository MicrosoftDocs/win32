...
To send a Certified Output Protection Protocol (COPP) command, fill in an [**AMCOPPCommand**](amcoppcommand.md) structure as follows:
...
Now pass the structure to the [**IAMCertifiedOutputProtection::ProtectionCommand**](iamcertifiedoutputprotection-protectioncommand.md) method.
