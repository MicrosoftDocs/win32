...
title: IRenderEngineSetSourceNameValidation method
ms.date: 05/31/2018
ms.topic: article
...
**BSTR** value containing pairs of filter strings, formatted as required by the **lpstrFilter** member of the [**OPENFILENAME**](dlgbox.openfilename_str) structure. The media locator uses this filter if it presents an Open File dialog box to the end user.
