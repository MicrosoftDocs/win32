...
Pointer to a variable that receives a member of the [**FILTER\_STATE**](/windows/desktop/api/strmif/ne-strmif-_filterstate) enumerated type, indicating the filter's state.
