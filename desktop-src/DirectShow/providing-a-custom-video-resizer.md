...
-   The filter should accept only [**VIDEOINFOHEADER**](/windows/win32/amvideo/ns-amvideo-tagvideoinfoheader?branch=master) formats (FORMAT\_VideoInfo). Reject other format types.
