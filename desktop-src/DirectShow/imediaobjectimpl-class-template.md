...
| Method                                                                      | Description                                                          |
|-----------------------------------------------------------------------------|----------------------------------------------------------------------|
| [**CheckTypesSet**](/windows/desktop/api)                     | Determines whether all of the non-optional streams have media types. |
| [**InputType**](/windows/desktop/api)                             | Retrieves the current media type for a specified input stream.       |
| [**InputTypeSet**](/windows/desktop/api)                       | Queries whether the media type was set on an input stream.           |
...
| [**OutputType**](/windows/desktop/api)                           | Retrieves the current media type for a specified output stream.      |
| [**OutputTypeSet**](/windows/desktop/api)                     | Queries whether the media type was set on an output stream.          |
