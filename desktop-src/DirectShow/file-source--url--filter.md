...
|                                          |                                                                                                                                      |
|------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| Filter Interfaces                        | [**IAMOpenProgress**](iamopenprogress.md), [**IBaseFilter**](ibasefilter.md), [**IFileSourceFilter**](ifilesourcefilter.md)       |
...
| Output Pin Interfaces                    | [**IAMAsyncReaderTimestampScaling**](iamasyncreadertimestampscaling.md), [**IAsyncReader**](iasyncreader.md), [**IPin**](ipin.md) |
