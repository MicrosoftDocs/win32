...
-   For RGB 24, every pixel is an [**RGBTRIPLE**](https://msdn.microsoft.com/windows/desktop/bc1467a5-0027-4f22-bfc9-1deab562c573). Each color is one byte, with a value from 0 to 255, inclusive. The memory layout is: 
