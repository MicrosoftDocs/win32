---
Description: The Active method notifies the pin that the filter is now active. This method overrides the CBasePinActive method. If the pin is connected, this method starts the streaming thread.
