...
The filter does not invoke the callback function for preroll samples, or for samples in which the **dwStreamId** member of the [**AM\_SAMPLE2\_PROPERTIES**](/windows/desktop/api/strmif/ns-strmif-tagam_sample2_properties) structure is anything other than AM\_STREAM\_MEDIA.
