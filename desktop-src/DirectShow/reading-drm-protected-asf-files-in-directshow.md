...
3.  Query the Filter Graph Manager for the [**IObjectWithSite**](com.iobjectwithsite) interface.
4.  Call [**IObjectWithSite::SetSite**](com.iobjectwithsite_setsite) with a pointer to your implementation of **IServiceProvider**.
5.  The Filter Graph Manager will call **IServiceProvider::QueryService**, specifying **IID\_IWMReader** for the service identifier.
6.  In your implementation of **QueryService**, call [**WMCreateCertificate**](wmformat.wmcreatecertificate) to create the software key.
...
The following code shows how to call [**SetSite**](com.iobjectwithsite_setsite) on the Filter Graph Manager:
...
The following code shows how to get a pointer to the [**IWMDRMReader**](wmformat.iwmdrmreader) interface from the [WM ASF Reader](wm-asf-reader-filter.md):
