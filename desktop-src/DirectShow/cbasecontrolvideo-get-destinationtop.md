...
title: CBaseControlVideo.get\_DestinationTop method
ms.date: 05/31/2018
ms.topic: article
...
This member function implements the [**IBasicVideo::get\_DestinationTop**](/windows/win32/Control/nf-control-ibasicvideo-get_destinationtop?branch=master) method.
