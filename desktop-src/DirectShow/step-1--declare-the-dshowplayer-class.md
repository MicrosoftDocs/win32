...
-   Throughout this tutorial, the [SafeRelease](https://msdn.microsoft.com/windows/desktop/2e9af7bc-f478-4a9c-b28f-b0a72fa9ec75) function is used to release COM interface pointers.
