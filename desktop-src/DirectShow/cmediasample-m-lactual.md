---
Description: Length of the valid data in the buffer, in bytes. The value must be equal to or less than the size of the buffer, specified by the CMediaSamplem\_cbBuffer member variable.
ms.assetid: 75610043-fe0b-4cd0-9fd6-292f25040d72
title: CMediaSamplem\_lActual member
ms.date: 05/31/2018
ms.topic: article
