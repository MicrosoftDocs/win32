...
| Topic                                                                                         | Description                                                                                                                                                                        |
|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Software Device API Programming Guide](software-device-api-programming-guide.md)<br/> | This guide contains info on how to use the Software Device API to enumerate PnP devices. <br/>                                                                               |
