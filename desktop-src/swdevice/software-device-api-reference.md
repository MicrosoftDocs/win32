...
| Topic                                                                           | Description                                                                                                                                   |
|---------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| [Software Device API Functions](software-device-api-functions.md)<br/>   | This section describes Software Device API functions that a client app calls and a callback function that a client app implements.<br/> |
| [Software Device API Structures](software-device-api-structures.md)<br/> | This section describes Software Device API structures.<br/>                                                                             |
