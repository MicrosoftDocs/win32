...
The **Uncompress** [WMI class](https://msdn.microsoft.com/library/aa393244) method uncompresses the logical file (or directory) specified in the **Win32\_NTEventlogFile.Name** property.
