...
The **UncompressEx** [WMI class](https://msdn.microsoft.com/library/aa393244) method uncompresses the logical file (or directory) specified in the **Win32\_NTEventlogFile.Name** property. This method is an extended version of the [**Uncompress**](https://msdn.microsoft.com/library/aa393937) method.
...
Name of the file or directory where the **UncompressEx** method failed. This parameter is **null** if the method succeeds.
...
Names the child file or directory to use as a starting point for **UncompressEx**. The *StartFileName* parameter is typically the *StopFileName* parameter that specifies the file or directory at which an error occurred from the previous method call. If this parameter is **NULL**, the operation is performed on the file or directory specified in the **ExecMethod** call.
