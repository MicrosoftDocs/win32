...
[**AERT\_Allocate**](/windows/win32/baseaudioprocessingobject/nf-baseaudioprocessingobject-aert_allocate?branch=master)  
[**AERT\_Free**](/windows/win32/baseaudioprocessingobject/nf-baseaudioprocessingobject-aert_free?branch=master)  
</dl>
...
For more information about the general requirements to help you develop audio processing objects, see [Design Considerations for sAPO Development](audio.design_considerations_for_sapo_development).
