...
<tbody>
<tr class="odd">
<td>[<strong>CreateAudioMediaType</strong>](createaudiomediatype.md)<br/></td>
...
<tr class="even">
<td>[<strong>CreateAudioMediaTypeFromUncompressedAudioFormat</strong>](createaudiomediatypefromuncompressedaudioformat.md)<br/></td>
<td>The <code>CreateAudioMediaTypeFromUncompressedAudioFormat</code> function uses the information provided in the [<strong>UNCOMPRESSEDAUDIOFORMAT</strong>](uncompressedauudioformat.md) structure to create a media type object that describes the audio format.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>IAudioMediaType</strong>](iaudiomediatype.md)<br/></td>
<td>The <code>IAudioMediaType</code> interface exposes methods that allow an sAPO to get information that is used to negotiate with the audio engine for the appropriate audio data format. An sAPO also returns this interface in response to a call to [<strong>IAudioSystemEffectsCustomFormats::GetFormat</strong>](iaudiosystemeffectscustomformats-getformat.md).<br/> <code>IAudioMediaType</code> inherits from <strong>IUnknown</strong> and also supports the following methods:<br/> <dl>[<strong>IAudioMediaType::GetAudioFormat</strong>](iaudiomediatype-getaudioformat.md) <br/><br />
[<strong>IAudioMediaType::GetUncompressedAudioFormat</strong>](iaudiomediatype-getuncompressedaudioformat.md) <br/><br />
[<strong>IAudioMediaType::IsCompressedFormat</strong>](iaudiomediatype-iscompressedformat.md) <br/><br />
[<strong>IAudioMediaType::IsEqual</strong>](iaudiomediatype-isequal.md) <br/><br />
</dl></td>
</tr>
<tr class="even">
<td>[<strong>UNCOMPRESSEDAUUDIOFORMAT</strong>](uncompressedauudioformat.md)<br/></td>
