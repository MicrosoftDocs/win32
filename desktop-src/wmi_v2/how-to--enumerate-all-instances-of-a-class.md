...
5.  Enumerate the instances of the desired class via [**MI\_Session\_EnumerateInstances**](/windows/previous-versions/Mi/nf-mi-mi_session_enumerateinstances?branch=master). In the following example, the code has hardcoded values for both the **namespaceName** and the **className** parameters.
