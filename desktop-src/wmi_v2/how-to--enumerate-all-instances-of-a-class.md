...
5.  Enumerate the instances of the desired class via [**MI\_Session\_EnumerateInstances**](mi-session-enumerateinstances.md). In the following example, the code has hardcoded values for both the **namespaceName** and the **className** parameters.
