...
keywords:
- TableOfContentsHasChildren property HelpAPI
- TableOfContentsHasChildren property HelpAPI , ITopic interface
- ITopic interface HelpAPI , TableOfContentsHasChildren property
topic_type:
- apiref
api_name:
