...
keywords:
- IsCurrentlyNonBlockingWriteLocked property HelpAPI
- IsCurrentlyNonBlockingWriteLocked property HelpAPI , ICatalogReadWriteLock interface
- ICatalogReadWriteLock interface HelpAPI , IsCurrentlyNonBlockingWriteLocked property
topic_type:
- apiref
api_name:
