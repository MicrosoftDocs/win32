...
keywords:
- GetTopicForF1Keyword method HelpAPI
- GetTopicForF1Keyword method HelpAPI , ICatalogRead interface
- ICatalogRead interface HelpAPI , GetTopicForF1Keyword method
topic_type:
- apiref
api_name:
