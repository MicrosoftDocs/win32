...
keywords: ["Server class AD Schema", "server class AD Schema"]
topic_type:
- apiref
api_name:
- Server
...
| Update Frequency  | Each time a server is defined in or removed from a site. |
...
| Possible Superiors          | [**Servers-Container**](c-serverscontainer.md)                                                |
| Auxiliary Classes           | \-                                                                                             |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                   |
| Default Security Descriptor | D:(A;CI;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)(A;;RPLCLORC;;;AU) |
...
| [**DNS-Host-Name**](a-dnshostname.md)                                    | False     | **Server**                      |
...
| [**Managed-By**](a-managedby.md)                                         | False     | **Server**                      |
...
| [**Serial-Number**](a-serialnumber.md)                                   | False     | **Server**                      |
| [**Server-Reference**](a-serverreference.md)                             | False     | **Server**                      |
...
| [**SMTP-Mail-Address**](a-mailaddress.md)                                | False     | **Server**                      |
