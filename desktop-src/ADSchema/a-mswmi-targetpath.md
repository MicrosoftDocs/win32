...
keywords: ["ms-WMI-TargetPath attribute AD Schema", "msWMI-TargetPath attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-WMI-TargetPath
...
# ms-WMI-TargetPath attribute

List of key/value pairs for uniquely identifying a WMI object.
...
| Classes used in        | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
