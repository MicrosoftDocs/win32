...
keywords: ["msRASSavedCallbackNumber attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# msRASSavedCallbackNumber attribute

The [**msRASSavedCallbackNumber**](a-msradiusservicetype.md) attribute is used internally. Do not modify this value directly.
