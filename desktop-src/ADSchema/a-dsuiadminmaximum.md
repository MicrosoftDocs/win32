...
keywords: ["DS-UI-Admin-Maximum attribute AD Schema", "dSUIAdminMaximum attribute AD Schema"]
topic_type:
- apiref
api_name:
- DS-UI-Admin-Maximum
...
# DS-UI-Admin-Maximum attribute

This is the default maximum number of objects to be shown in a container by the admin UI.
