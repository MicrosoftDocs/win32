...
keywords: ["Logon-Hours attribute AD Schema", "logonHours attribute AD Schema"]
topic_type:
- apiref
api_name:
- Logon-Hours
...
| Update Frequency  | Whenever the account's logon hours needs to change.   |
