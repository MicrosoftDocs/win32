...
keywords: ["ms-DS-Tombstone-Quota-Factor attribute AD Schema", "msDS-TombstoneQuotaFactor attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Tombstone-Quota-Factor attribute

The percentage factor by which the tombstone object count should be reduced for the purpose of quota accounting.
