...
keywords: ["ms-DS-Is-Used-As-Resource-Security-Attribute attribute AD Schema", "msDS-IsUsedAsResourceSecurityAttribute attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Is-Used-As-Resource-Security-Attribute attribute
