...
keywords: ["Last-Known-Parent attribute AD Schema", "lastKnownParent attribute AD Schema"]
topic_type:
- apiref
api_name:
- Last-Known-Parent
...
| Ldap-Display-Name | lastKnownParent                         |
| Size              | \-                                      |
| Update Privilege  | This value is set by the system.        |
| Update Frequency  | Whenever an object is orphaned.         |
| Attribute-Id      | 1.2.840.113556.1.4.781                  |
| System-Id-Guid    | 52ab8670-5709-11d1-a9c6-0000f80367c1    |
