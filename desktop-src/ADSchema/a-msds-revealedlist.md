...
keywords: ["ms-DS-Revealed-List attribute AD Schema", "msDS-RevealedList attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-Revealed-List
...
# ms-DS-Revealed-List attribute

Identifies security principals whose current computer account passwords have been replicated to the RODC.
