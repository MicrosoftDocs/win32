...
keywords: ["ACS-Total-No-Of-Flows attribute AD Schema", "aCSTotalNoOfFlows attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Total-No-Of-Flows attribute

The total number of flows that a given user may have.
