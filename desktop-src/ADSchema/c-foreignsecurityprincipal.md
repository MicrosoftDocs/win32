---
title: Foreign-Security-Principal class
description: The Security Principal from an external source.
audience: developer
...
keywords: ["Foreign-Security-Principal class AD Schema", "foreignSecurityPrincipal class AD Schema"]
topic_type:
- apiref
api_name:
...
# Foreign-Security-Principal class
...
| [**Foreign-Identifier**](a-foreignidentifier.md)                         | False     | **Foreign-Security-Principal**  |
...
| [**Object-Sid**](a-objectsid.md)                                         | True      | **Foreign-Security-Principal**  |
