...
keywords: ["MS-SQL-OLAPServer class AD Schema", "mS-SQL-OLAPServer class AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-OLAPServer
...
# MS-SQL-OLAPServer class

Container for storing [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md) objects.
...
| [**MS-SQL-Keywords**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-OLAPServer**                                                                    |
| [**MS-SQL-Language**](a-ms-sql-language.md)                              | False     | **MS-SQL-OLAPServer**                                                                    |
