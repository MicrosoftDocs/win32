...
keywords: ["Serial-Number attribute AD Schema", "serialNumber attribute AD Schema"]
topic_type:
- apiref
api_name:
- Serial-Number
...
| Classes used in        | [**Device**](c-device.md)<br/> [**Server**](c-server.md)<br/> |
...
| Search-Flags           | 0x00000000                                                                                                        |
| System-Flags           | 0x00000010                                                                                                        |
| Classes used in        | [**Device**](c-device.md)<br/> [**Person**](c-person.md)<br/> [**Server**](c-server.md)<br/> |
