...
keywords: ["ms-DS-App-Data class AD Schema", "msDS-AppData class AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-App-Data
...
# ms-DS-App-Data class

Stores data that is to be used by an object. For example, profile information for a user object.
...
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 9e67d761-e327-4d55-bc95-682f875e2f8e |
...
| [**Keywords**](a-keywords.md)                                              | False     | **ms-DS-App-Data**                                               |
| [**Last-Known-Parent**](a-lastknownparent.md)                              | False     | [**Top**](c-top.md)<br/>                                  |
| [**Managed-By**](a-managedby.md)                                           | False     | **ms-DS-App-Data**                                               |
...
| [**ms-DS-Byte-Array**](a-msds-bytearray.md)                                | False     | **ms-DS-App-Data**                                               |
...
| [**ms-DS-Date-Time**](a-msds-datetime.md)                                  | False     | **ms-DS-App-Data**                                               |
| [**ms-DS-Integer**](a-msds-integer.md)                                     | False     | **ms-DS-App-Data**                                               |
...
| [**ms-DS-Object-Reference**](a-msds-objectreference.md)                    | False     | **ms-DS-App-Data**                                               |
...
| [**Owner**](a-owner.md)                                                    | False     | **ms-DS-App-Data**                                               |
