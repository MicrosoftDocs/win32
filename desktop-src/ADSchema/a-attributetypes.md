...
keywords: ["Attribute-Types attribute AD Schema", "attributeTypes attribute AD Schema"]
topic_type:
- apiref
api_name:
- Attribute-Types
...
A multi-valued property that contains strings that represent each attribute in the schema.
