...
keywords: ["ms-WMI-PropertyName attribute AD Schema", "msWMI-PropertyName attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-WMI-PropertyName
...
# ms-WMI-PropertyName attribute

The target policy object name for a parameter object.
...
| Classes used in        | [**ms-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
