...
keywords: ["ms-DS-Az-Script-Engine-Cache-Max attribute AD Schema", "msDS-AzScriptEngineCacheMax attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Az-Script-Engine-Cache-Max attribute

The maximum number of scripts that are cached by the application.
