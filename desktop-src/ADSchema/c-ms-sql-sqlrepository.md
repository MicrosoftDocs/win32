...
keywords: ["MS-SQL-SQLRepository class AD Schema", "mS-SQL-SQLRepository class AD Schema"]
topic_type:
- apiref
api_name:
...
# MS-SQL-SQLRepository class

Class for storing SQL Server repository properties.
