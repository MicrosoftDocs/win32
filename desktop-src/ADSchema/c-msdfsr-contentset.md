...
keywords: ["ms-DFSR-ContentSet class AD Schema", "msDFSR-ContentSet class AD Schema"]
topic_type:
- apiref
api_name:
- ms-DFSR-ContentSet
...
# ms-DFSR-ContentSet class

Defines the content set configuration information.
...
| Possible Superiors          | [**ms-DFSR-Content**](c-msdfsr-content.md)                                                                                      |
| Auxiliary Classes           | \-                                                                                                                               |
...
| [**Description**](a-description.md)                                        | False     | **ms-DFSR-ContentSet** [**Top**](c-top.md)<br/> |
...
The **ms-DFSR-ContentSet** class is a part of the Distributed File System (DFS) Replication service support.
