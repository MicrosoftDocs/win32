...
keywords: ["Extension-Name attribute AD Schema", "extensionName attribute AD Schema"]
topic_type:
- apiref
api_name:
- Extension-Name
...
| Size              | \-                                          |
| Update Privilege  | The creator of the extension object.        |
| Update Frequency  | Whenever a new UI extension is created.     |
