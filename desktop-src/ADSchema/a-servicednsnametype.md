...
keywords:
- Service-DNS-Name-Type attribute AD Schema
- serviceDNSNameType attribute AD Schema
topic_type:
- apiref
api_name:
...
# Service-DNS-Name-Type attribute

Type of DNS Record to look up for this service. For example, A or SRV.
