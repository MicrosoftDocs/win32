...
keywords: ["Package-Type attribute AD Schema", "packageType attribute AD Schema"]
topic_type:
- apiref
api_name:
- Package-Type
...
This attribute describes the type of installation required for an application package, for example, MSI, EXE, CAB.
