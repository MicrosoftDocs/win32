...
keywords: ["Subnet-Container class AD Schema", "subnetContainer class AD Schema"]
topic_type:
- apiref
api_name:
- Subnet-Container
...
# Subnet-Container class

Container for holding all subnet objects.
...
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | b7b13125-b82e-11d0-afee-0000f80367c1 |
