---
title: Server-Reference-BL attribute
...
keywords: ["Server-Reference-BL attribute AD Schema", "serverReferenceBL attribute AD Schema"]
topic_type:
- apiref
api_name:
- Server-Reference-BL
