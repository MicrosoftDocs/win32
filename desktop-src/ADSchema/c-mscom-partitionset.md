---
title: ms-COM-PartitionSet class
description: A conceptual collection of COM+ partitions.
audience: developer
...
keywords: ["ms-COM-PartitionSet class AD Schema", "msCOM-PartitionSet class AD Schema"]
topic_type:
- apiref
api_name:
- ms-COM-PartitionSet
