...
keywords: ["ms-WMI-PolicyTemplate class AD Schema", "msWMI-PolicyTemplate class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-WMI-PolicyTemplate class

The policy template provides a recipe for creating a class instance in the target namespace.
...
| [**ms-WMI-Author**](a-mswmi-author.md)                                     | False     | **ms-WMI-PolicyTemplate**       |
