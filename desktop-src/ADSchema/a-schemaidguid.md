...
keywords: ["Schema-ID-GUID attribute AD Schema", "schemaIDGUID attribute AD Schema"]
topic_type:
- apiref
api_name:
- Schema-ID-GUID
...
| Update Frequency  | This value is set when the object is created and cannot be changed. |
