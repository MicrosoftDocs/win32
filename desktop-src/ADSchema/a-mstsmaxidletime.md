...
keywords: ["ms-TS-Max-Idle-Time attribute AD Schema", "msTSMaxIdleTime attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-TS-Max-Idle-Time
...
# ms-TS-Max-Idle-Time attribute

Terminal Services session Maximum Idle Time is the maximum amount of time, in minutes, that the Terminal Services session can remain idle.
