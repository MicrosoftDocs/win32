...
keywords: ["RID-Set class AD Schema", "rIDSet class AD Schema"]
topic_type:
- apiref
api_name:
- RID-Set
...
There is one of these per Domain Controller. It holds the RID pools that were allocated by the DC.
...
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 7bfdcb89-4807-11d1-a9c3-0000f80367c1 |
...
| Possible Superiors          | [**Computer**](c-computer.md)[**Container**](c-container.md)[**User**](c-user.md)         |
| Auxiliary Classes           | \-                                                                                           |
...
| [**RID-Allocation-Pool**](a-ridallocationpool.md)                        | True      | **RID-Set**                     |
| [**RID-Next-RID**](a-ridnextrid.md)                                      | True      | **RID-Set**                     |
| [**RID-Previous-Allocation-Pool**](a-ridpreviousallocationpool.md)       | True      | **RID-Set**                     |
| [**RID-Used-Pool**](a-ridusedpool.md)                                    | True      | **RID-Set**                     |
