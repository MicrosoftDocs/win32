...
keywords: ["Licensing-Site-Settings class AD Schema", "licensingSiteSettings class AD Schema"]
topic_type:
- apiref
api_name:
...
| Ldap-Display-Name | licensingSiteSettings                |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 1be8f17d-a9ff-11d0-afe2-00c04fd930c9 |
...
| [**Site-Server**](a-siteserver.md)                                       | False     | **Licensing-Site-Settings**                                               |
