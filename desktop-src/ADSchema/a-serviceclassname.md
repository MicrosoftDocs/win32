...
keywords: ["Service-Class-Name attribute AD Schema", "serviceClassName attribute AD Schema"]
topic_type:
- apiref
api_name:
- Service-Class-Name
...
The string name of the service that an administration point represents.
