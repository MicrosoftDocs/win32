...
keywords: ["Lost-And-Found class AD Schema", "lostAndFound class AD Schema"]
topic_type:
- apiref
api_name:
- Lost-And-Found
...
| Possible Superiors          | [**DMD**](c-dmd.md)[**Domain-DNS**](c-domaindns.md)[**Configuration**](c-configuration.md) |
| Auxiliary Classes           | \-                                                                                            |
...
| [**Move-Tree-State**](a-movetreestate.md)                                | False     | **Lost-And-Found**              |
