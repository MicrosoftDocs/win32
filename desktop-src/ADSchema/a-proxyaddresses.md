...
keywords: ["Proxy-Addresses attribute AD Schema", "proxyAddresses attribute AD Schema"]
topic_type:
- apiref
api_name:
- Proxy-Addresses
...
| Update Frequency  | Created by a DLL provided with the Address-Type directory object when the address type is installed. |
