...
keywords: ["MS-SQL-RegisteredOwner attribute AD Schema", "mS-SQL-RegisteredOwner attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# MS-SQL-RegisteredOwner attribute

The registered owner for the current instance of SQL Server.
