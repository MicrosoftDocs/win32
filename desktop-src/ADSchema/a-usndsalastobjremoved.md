...
keywords: ["USN-DSA-Last-Obj-Removed attribute AD Schema", "uSNDSALastObjRemoved attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# USN-DSA-Last-Obj-Removed attribute
...
| Update Frequency  | Whenever a directory object changes. |
