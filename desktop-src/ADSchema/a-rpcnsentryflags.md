...
keywords: ["rpc-Ns-Entry-Flags attribute AD Schema", "rpcNsEntryFlags attribute AD Schema"]
topic_type:
- apiref
api_name:
- rpc-Ns-Entry-Flags
...
# rpc-Ns-Entry-Flags attribute

Flag to indicate that the RPC NS entry was explicitly created.
...
| Classes used in        | [**rpc-Server**](c-rpcserver.md)<br/> |
