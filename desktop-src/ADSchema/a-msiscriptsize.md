...
keywords: ["Msi-Script-Size attribute AD Schema", "msiScriptSize attribute AD Schema"]
topic_type:
- apiref
api_name:
- Msi-Script-Size
...
# Msi-Script-Size attribute

The file size for the Microsoft installer advertisement script file for this application.
...
|-------------------|--------------------------------------|
| CN                | Msi-Script-Size                      |
| Ldap-Display-Name | msiScriptSize                        |
| Size              | \-                                   |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
