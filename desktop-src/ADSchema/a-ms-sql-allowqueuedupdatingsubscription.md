...
keywords: ["MS-SQL-AllowQueuedUpdatingSubscription attribute AD Schema", "mS-SQL-AllowQueuedUpdatingSubscription attribute AD Schema"]
topic_type:
- apiref
api_name:
...
True to allow queued transactions when updating subscriptions.
