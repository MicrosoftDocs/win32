...
keywords: ["ACS-Max-No-Of-Account-Files attribute AD Schema", "aCSMaxNoOfAccountFiles attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Max-No-Of-Account-Files attribute

The maximum number of RSVP account files.
