...
keywords: ["Inter-Site-Transport-Container class AD Schema", "interSiteTransportContainer class AD Schema"]
topic_type:
- apiref
api_name:
...
# Inter-Site-Transport-Container class

Holds Inter-Site-Transport objects.
