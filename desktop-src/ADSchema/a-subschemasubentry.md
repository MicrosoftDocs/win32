...
keywords: ["SubSchemaSubEntry attribute AD Schema", "subSchemaSubEntry attribute AD Schema"]
topic_type:
- apiref
api_name:
- SubSchemaSubEntry
...
| Update Frequency  | When the Active Directory is loaded or when a new class or attribute is defined. |
