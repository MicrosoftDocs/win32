...
keywords: ["ACS-Max-Size-Of-RSVP-Account-File attribute AD Schema", "aCSMaxSizeOfRSVPAccountFile attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Max-Size-Of-RSVP-Account-File attribute

The maximum size, in bytes, of an RSVP account file.
