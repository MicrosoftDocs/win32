...
keywords: ["ACS-Minimum-Latency attribute AD Schema", "aCSMinimumLatency attribute AD Schema"]
topic_type:
- apiref
api_name:
- ACS-Minimum-Latency
...
# ACS-Minimum-Latency attribute

The **ACS-Minimum-Latency** attribute is for internal use only. Based on RFC2210.
