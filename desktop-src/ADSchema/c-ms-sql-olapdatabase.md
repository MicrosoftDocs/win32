---
title: MS-SQL-OLAPDatabase class
description: Container for storing MS-SQL-OLAPCube objects.
audience: developer
...
keywords: ["MS-SQL-OLAPDatabase class AD Schema", "mS-SQL-OLAPDatabase class AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-OLAPDatabase
...
# MS-SQL-OLAPDatabase class

Container for storing [**MS-SQL-OLAPCube**](c-ms-sql-olapcube.md) objects.
...
| Possible Superiors          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
| Auxiliary Classes           | \-                                                                                           |
