---
title: ms-Authz-Central-Access-Rules class
description: A container of this class can contain Central Access Policy Entry objects.
audience: developer
...
keywords: ["ms-Authz-Central-Access-Rules class AD Schema", "msAuthz-CentralAccessRules class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-Authz-Central-Access-Rules class
