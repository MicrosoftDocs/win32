...
keywords: ["ms-DNS-Parent-Has-Secure-Delegation attribute AD Schema", "msDNS-ParentHasSecureDelegation attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DNS-Parent-Has-Secure-Delegation attribute

An attribute used to define whether the parental delegation to the DNS zone is secure.
