...
keywords: ["Primary-Group-Token attribute AD Schema", "primaryGroupToken attribute AD Schema"]
topic_type:
- apiref
api_name:
- Primary-Group-Token
...
| Update Frequency  | Whenever an objects primary group changes. |
