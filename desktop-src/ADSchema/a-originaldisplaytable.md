...
keywords: ["Original-Display-Table attribute AD Schema", "originalDisplayTable attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Original-Display-Table attribute

The MAPI (original) display table for an address entry.
