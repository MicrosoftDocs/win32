...
keywords: ["ms-DS-PSO-Applied attribute AD Schema", "msDS-PSOApplied attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-PSO-Applied
...
# ms-DS-PSO-Applied attribute

Password settings object that is applied to this object.
