...
keywords: ["FRS-File-Filter attribute AD Schema", "fRSFileFilter attribute AD Schema"]
topic_type:
- apiref
api_name:
- FRS-File-Filter
...
# FRS-File-Filter attribute

A list of file name extensions excluded from file replication.
