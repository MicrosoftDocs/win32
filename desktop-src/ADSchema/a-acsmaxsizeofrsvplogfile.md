...
keywords: ["ACS-Max-Size-Of-RSVP-Log-File attribute AD Schema", "aCSMaxSizeOfRSVPLogFile attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Max-Size-Of-RSVP-Log-File attribute

The maximum size, in bytes, of an RSVP log file.
