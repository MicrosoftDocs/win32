...
keywords: ["Auxiliary-Class attribute AD Schema", "auxiliaryClass attribute AD Schema"]
topic_type:
- apiref
api_name:
- Auxiliary-Class
...
# Auxiliary-Class attribute

The list of auxiliary classes to be associated with this class.
