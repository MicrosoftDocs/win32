---
title: Remote-Storage-Service-Point class
description: This class holds information about the remote storage location for files that are stored offline.
audience: developer
...
keywords: ["Remote-Storage-Service-Point class AD Schema", "remoteStorageServicePoint class AD Schema"]
topic_type:
- apiref
api_name:
...
# Remote-Storage-Service-Point class

This class holds information about the remote storage location for files that are stored offline.
...
| Ldap-Display-Name | remoteStorageServicePoint            |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 2a39c5bd-8960-11d1-aebc-0000f80367c1 |
...
| [**Remote-Storage-GUID**](a-remotestorageguid.md)                        | False     | **Remote-Storage-Service-Point**                                                         |
