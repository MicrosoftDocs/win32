...
keywords: ["COM-Typelib-Id attribute AD Schema", "cOMTypelibId attribute AD Schema"]
topic_type:
- apiref
api_name:
- COM-Typelib-Id
...
# COM-Typelib-Id attribute

This attribute stores the list of type library IDs contained in this application package.
