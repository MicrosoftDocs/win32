...
keywords: ["FRS-Replica-Set-GUID attribute AD Schema", "fRSReplicaSetGUID attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# FRS-Replica-Set-GUID attribute

GUID that identifies an FRS Replica Set.
