...
keywords: ["ms-DS-Claim-Source attribute AD Schema", "msDS-ClaimSource attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-Claim-Source
...
# ms-DS-Claim-Source attribute

For a claim type, this attribute indicates the source of the claim type. For example, the source can be certificate.
