...
keywords: ["Setup-Command attribute AD Schema", "setupCommand attribute AD Schema"]
topic_type:
- apiref
api_name:
- Setup-Command
...
# Setup-Command attribute

This attribute indicates whether a setup command is required to set up this application.
