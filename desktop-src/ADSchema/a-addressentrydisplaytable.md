...
keywords: ["Address-Entry-Display-Table attribute AD Schema", "addressEntryDisplayTable attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Address-Entry-Display-Table attribute

The display table for an address entry.
