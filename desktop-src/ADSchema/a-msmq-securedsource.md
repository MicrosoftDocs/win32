...
This is part of an MSMQ object, it is set by calling API to MQCreateQueue or MQSetProperties. It controls whether MSMQ accepts messages only from a secured source (for example, https) for this queue.
