...
keywords: ["MSMQ-Journal attribute AD Schema", "mSMQJournal attribute AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Journal
...
# MSMQ-Journal attribute

Indicates whether messages retrieved form the queue should be kept in journal.
