...
keywords: ["MSMQ-In-Routing-Servers attribute AD Schema", "mSMQInRoutingServers attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# MSMQ-In-Routing-Servers attribute

DN links to MSMQ routing servers through which all incoming traffic to this computer should be routed.
