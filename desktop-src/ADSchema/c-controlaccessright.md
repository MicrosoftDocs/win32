...
keywords: ["Control-Access-Right class AD Schema", "controlAccessRight class AD Schema"]
topic_type:
- apiref
api_name:
...
# Control-Access-Right class

Identifies an extended right that can be granted or revoked by using an ACL.
...
| [**Applies-To**](a-appliesto.md)                                         | False     | **Control-Access-Right**        |
...
| [**Valid-Accesses**](a-validaccesses.md)                                 | False     | **Control-Access-Right**        |
