---
title: File-Link-Tracking class
description: Container for File-Link-Tracking-Entry objects.
audience: developer
...
keywords: ["File-Link-Tracking class AD Schema", "fileLinkTracking class AD Schema"]
topic_type:
- apiref
api_name:
- File-Link-Tracking
...
# File-Link-Tracking class

Container for File-Link-Tracking-Entry objects.
