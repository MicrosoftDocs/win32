...
keywords:
- ACS-Max-Aggregate-Peak-Rate-Per-User attribute AD Schema
- aCSMaxAggregatePeakRatePerUser attribute AD Schema
topic_type:
- apiref
api_name:
...
# ACS-Max-Aggregate-Peak-Rate-Per-User attribute

The maximum peak rate any user may have for all flows.
...
| Ldap-Display-Name | aCSMaxAggregatePeakRatePerUser       |
| Size              | 8 bytes                              |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
