...
keywords: ["Transport-Address-Attribute attribute AD Schema", "transportAddressAttribute attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Transport-Address-Attribute attribute

The name of the address type for the transport.
...
| Ldap-Display-Name | transportAddressAttribute                                       |
| Size              | \-                                                              |
| Update Privilege  | This value is set by the system.                                |
| Update Frequency  | When connecting sites.                                          |
| Attribute-Id      | 1.2.840.113556.1.4.895                                          |
| System-Id-Guid    | c1dc867c-a261-11d1-b606-0000f80367c1                            |
