...
keywords: ["FRS-Control-Data-Creation attribute AD Schema", "fRSControlDataCreation attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# FRS-Control-Data-Creation attribute

Warning/Error level pair for file data creation (megabytes per second).
