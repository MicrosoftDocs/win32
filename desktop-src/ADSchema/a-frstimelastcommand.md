...
keywords: ["FRS-Time-Last-Command attribute AD Schema", "fRSTimeLastCommand attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# FRS-Time-Last-Command attribute

The time in which the last command was executed.
