...
keywords: ["MSMQ-Custom-Recipient class AD Schema", "msMQ-Custom-Recipient class AD Schema"]
topic_type:
- apiref
api_name:
...
# MSMQ-Custom-Recipient class

Used to define a custom MSMQ recipient (also known as an alias queue). Defines an alias for an out-of-enterprise queue. Contains the format name of that queue.
...
| Update Frequency  | Only after the external queue was moved. |
| Schema-Id-Guid    | 876d6817-35cc-436c-acea-5ef7174dd9be     |
...
| [**MSMQ-Recipient-FormatName**](a-msmq-recipient-formatname.md)            | False     | **MSMQ-Custom-Recipient**       |
