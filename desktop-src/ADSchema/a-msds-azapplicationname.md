...
keywords: ["ms-DS-Az-Application-Name attribute AD Schema", "msDS-AzApplicationName attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Az-Application-Name attribute

A string that uniquely identifies an application object.
...
| Classes used in        | [**ms-DS-Az-Application**](c-msds-azapplication.md)<br/> |
