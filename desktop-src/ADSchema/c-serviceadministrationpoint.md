...
keywords: ["Service-Administration-Point class AD Schema", "serviceAdministrationPoint class AD Schema"]
topic_type:
- apiref
api_name:
...
# Service-Administration-Point class

Holds binding information for connecting to a service to administer it.
