...
keywords: ["Phone-Home-Primary attribute AD Schema", "homePhone attribute AD Schema"]
topic_type:
- apiref
api_name:
- Phone-Home-Primary
...
| Update Frequency  | When the user's record is created and whenever the phone number needs to change. |
...
| Search-Flags           | 0x00000000                                                                                                                                               |
| System-Flags           | 0x00000010                                                                                                                                               |
| Classes used in        | [**inetOrgPerson**](c-inetorgperson.md)<br/> [**Organizational-Person**](c-organizationalperson.md)<br/> [**User**](c-user.md)<br/> |
