...
keywords: ["Ipsec-ISAKMP-Reference attribute AD Schema", "ipsecISAKMPReference attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Ipsec-ISAKMP-Reference attribute

The **Ipsec-ISAKMP-Reference** attribute is for internal use only.
