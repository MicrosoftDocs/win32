...
keywords: ["rpc-Ns-Annotation attribute AD Schema", "rpcNsAnnotation attribute AD Schema"]
topic_type:
- apiref
api_name:
- rpc-Ns-Annotation
...
# rpc-Ns-Annotation attribute

A string that describs a given RPC Profile element.
