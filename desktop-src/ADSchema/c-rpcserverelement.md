...
keywords: ["rpc-Server-Element class AD Schema", "rpcServerElement class AD Schema"]
topic_type:
- apiref
api_name:
- rpc-Server-Element
...
# rpc-Server-Element class

Represents a single interface in a given RPC Server.
...
| Possible Superiors          | [**rpc-Server**](c-rpcserver.md)                                                            |
| Auxiliary Classes           | \-                                                                                           |
...
| [**rpc-Ns-Bindings**](a-rpcnsbindings.md)                                | True      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                         | True      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Transfer-Syntax**](a-rpcnstransfersyntax.md)                   | True      | **rpc-Server-Element**                                                                   |
