...
keywords: ["rpc-Ns-Interface-ID attribute AD Schema", "rpcNsInterfaceID attribute AD Schema"]
topic_type:
- apiref
api_name:
- rpc-Ns-Interface-ID
...
# rpc-Ns-Interface-ID attribute

An Interface ID supported by a given server.
...
| Classes used in        | [**rpc-Profile-Element**](c-rpcprofileelement.md)<br/> [**rpc-Server-Element**](c-rpcserverelement.md)<br/> |
