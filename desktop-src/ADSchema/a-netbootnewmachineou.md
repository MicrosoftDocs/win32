...
keywords: ["netboot-New-Machine-OU attribute AD Schema", "netbootNewMachineOU attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# netboot-New-Machine-OU attribute

Indicates where the new client computer account will be created.
