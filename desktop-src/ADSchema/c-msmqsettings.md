...
keywords: ["MSMQ-Settings class AD Schema", "mSMQSettings class AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Settings
...
The purpose of these objects is to enable fast query of MSMQ servers in a specific site. This object holds information such as Message Queuing services the server provides.
...
|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | MSMQ-Settings                                                                                                                                                           |
| Ldap-Display-Name | mSMQSettings                                                                                                                                                            |
| Update Privilege  | The queue owner.                                                                                                                                                        |
| Update Frequency  | This object is created for each Message Queuing server that is installed on a Windows 2000 domain controller and for each Message Queuing server with routing services. |
| Schema-Id-Guid    | 9a0dc347-c100-11d1-bbc5-0080c76670c0                                                                                                                                    |
...
| Possible Superiors          | [**Server**](c-server.md)                                                                   |
| Auxiliary Classes           | \-                                                                                           |
...
| [**MSMQ-Dependent-Client-Service**](a-msmqdependentclientservice.md)     | False     | **MSMQ-Settings**               |
| [**MSMQ-Ds-Service**](a-msmqdsservice.md)                                | False     | **MSMQ-Settings**               |
| [**MSMQ-Migrated**](a-msmqmigrated.md)                                   | False     | **MSMQ-Settings**               |
| [**MSMQ-Nt4-Flags**](a-msmqnt4flags.md)                                  | False     | **MSMQ-Settings**               |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | False     | **MSMQ-Settings**               |
| [**MSMQ-QM-ID**](a-msmqqmid.md)                                          | False     | **MSMQ-Settings**               |
| [**MSMQ-Routing-Service**](a-msmqroutingservice.md)                      | False     | **MSMQ-Settings**               |
| [**MSMQ-Services**](a-msmqservices.md)                                   | False     | **MSMQ-Settings**               |
| [**MSMQ-Site-Name**](a-msmqsitename.md)                                  | False     | **MSMQ-Settings**               |
| [**MSMQ-Site-Name-Ex**](a-msmqsitenameex.md)                             | False     | **MSMQ-Settings**               |
