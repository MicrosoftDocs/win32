...
keywords: ["ms-DS-UpdateScript attribute AD Schema", "msDS-UpdateScript attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-UpdateScript
...
# ms-DS-UpdateScript attribute

This is used to hold the script with the domain restructure instructions.
