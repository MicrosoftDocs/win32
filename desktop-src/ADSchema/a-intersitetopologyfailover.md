...
keywords: ["Inter-Site-Topology-Failover attribute AD Schema", "interSiteTopologyFailover attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Inter-Site-Topology-Failover attribute

Indicates how much time must transpire since the last keep-alive for the inter-site topology generator to be considered dead.
...
| Ldap-Display-Name | interSiteTopologyFailover            |
| Size              | 4 bytes                              |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
