...
keywords: ["ms-DS-Behavior-Version attribute AD Schema", "msDS-Behavior-Version attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Behavior-Version attribute
...
| Classes used in        | [**Cross-Ref**](c-crossref.md)<br/> [**Cross-Ref-Container**](c-crossrefcontainer.md)<br/> [**Domain-DNS**](c-domaindns.md)<br/> [**NTDS-DSA**](c-ntdsdsa.md)<br/> |
