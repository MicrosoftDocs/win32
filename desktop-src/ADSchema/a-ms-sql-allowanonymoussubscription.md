...
keywords: ["MS-SQL-AllowAnonymousSubscription attribute AD Schema", "mS-SQL-AllowAnonymousSubscription attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# MS-SQL-AllowAnonymousSubscription attribute

True if the publication allows anonymous subscribers to subscribe to it.
