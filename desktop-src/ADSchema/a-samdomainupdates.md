...
keywords: ["SAM-Domain-Updates attribute AD Schema", "samDomainUpdates attribute AD Schema"]
topic_type:
- apiref
api_name:
- SAM-Domain-Updates
...
| Classes used in        | [**Sam-Server**](c-samserver.md)<br/> |
