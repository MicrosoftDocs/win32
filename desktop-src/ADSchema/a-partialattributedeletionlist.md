...
keywords: ["Partial-Attribute-Deletion-List attribute AD Schema", "partialAttributeDeletionList attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Partial-Attribute-Deletion-List attribute
