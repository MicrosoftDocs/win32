---
title: MS-SQL-SQLDatabase class
description: Class for storing SQL Server database properties.
audience: developer
...
keywords: ["MS-SQL-SQLDatabase class AD Schema", "mS-SQL-SQLDatabase class AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-SQLDatabase
...
# MS-SQL-SQLDatabase class

Class for storing SQL Server database properties.
...
| Possible Superiors          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Auxiliary Classes           | \-                                                                                           |
