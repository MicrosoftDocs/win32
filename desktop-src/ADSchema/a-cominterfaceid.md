...
keywords: ["COM-InterfaceID attribute AD Schema", "cOMInterfaceID attribute AD Schema"]
topic_type:
- apiref
api_name:
- COM-InterfaceID
...
# COM-InterfaceID attribute

This attribute stores the list of interfaces that are implemented in this application package.
...
| Classes used in        | [**Class-Registration**](c-classregistration.md)<br/> [**Package-Registration**](c-packageregistration.md)<br/> [**Type-Library**](c-typelibrary.md)<br/> |
