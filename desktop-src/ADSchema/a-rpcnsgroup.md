...
keywords: ["rpc-Ns-Group attribute AD Schema", "rpcNsGroup attribute AD Schema"]
topic_type:
- apiref
api_name:
- rpc-Ns-Group
...
# rpc-Ns-Group attribute

A reference to an RPC Server entry or another RPC Group.
...
| Classes used in        | [**rpc-Group**](c-rpcgroup.md)<br/> |
