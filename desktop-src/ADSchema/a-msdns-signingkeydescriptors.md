...
keywords: ["ms-DNS-Signing-Key-Descriptors attribute AD Schema", "msDNS-SigningKeyDescriptors attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DNS-Signing-Key-Descriptors attribute

An attribute that contains the set of DNSSEC Signing Key Descriptors (SKDs) used by the DNS server to generate keys and sign the DNS zone.
...
| Update Privilege  | \-                                                    |
| Update Frequency  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.2143                               |
| System-Id-Guid    | 3443d8cd-e5b6-4f3b-b098-659a0214a079                  |
