...
keywords: ["Ipsec-Negotiation-Policy class AD Schema", "ipsecNegotiationPolicy class AD Schema"]
topic_type:
- apiref
api_name:
...
# Ipsec-Negotiation-Policy class

The **Ipsec-Negotiation-Policy** class is for internal use only.
...
| [**IPSEC-Negotiation-Policy-Action**](a-ipsecnegotiationpolicyaction.md) | False     | **Ipsec-Negotiation-Policy**                 |
| [**IPSEC-Negotiation-Policy-Type**](a-ipsecnegotiationpolicytype.md)     | False     | **Ipsec-Negotiation-Policy**                 |
