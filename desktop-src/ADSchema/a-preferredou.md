...
keywords: ["Preferred-OU attribute AD Schema", "preferredOU attribute AD Schema"]
topic_type:
- apiref
api_name:
- Preferred-OU
...
|-------------------|-----------------------------------------|
| CN                | Preferred-OU                            |
| Ldap-Display-Name | preferredOU                             |
| Size              | \-                                      |
| Update Privilege  | \-                                      |
| Update Frequency  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.97                   |
| System-Id-Guid    | bf9679ff-0de6-11d0-a285-00aa003049e2    |
