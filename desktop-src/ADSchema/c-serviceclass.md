...
keywords: ["Service-Class class AD Schema", "serviceClass class AD Schema"]
topic_type:
- apiref
api_name:
- Service-Class
...
Used to store the properties of a Winsock service.
...
| [**Display-Name**](a-displayname.md)                                     | True      | **Service-Class** [**Top**](c-top.md)<br/> |
