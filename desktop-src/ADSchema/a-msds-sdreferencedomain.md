...
keywords: ["ms-DS-SD-Reference-Domain attribute AD Schema", "msDS-SDReferenceDomain attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-SD-Reference-Domain attribute

The name of the domain to be used for security descriptor translation for a non-domain-naming context.
