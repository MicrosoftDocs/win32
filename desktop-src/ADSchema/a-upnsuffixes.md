...
keywords: ["UPN-Suffixes attribute AD Schema", "uPNSuffixes attribute AD Schema"]
topic_type:
- apiref
api_name:
- UPN-Suffixes
...
| Classes used in        | [**Cross-Ref-Container**](c-crossrefcontainer.md)<br/> [**Organizational-Unit**](c-organizationalunit.md)<br/> |
