...
keywords: ["Dfs-Configuration class AD Schema", "dfsConfiguration class AD Schema"]
topic_type:
- apiref
api_name:
- Dfs-Configuration
...
# Dfs-Configuration class

Holds all Fault-tolerant DFS configurations.
...
| Possible Superiors          | [**Domain-DNS**](c-domaindns.md)[**Container**](c-container.md)                            |
| Auxiliary Classes           | \-                                                                                           |
