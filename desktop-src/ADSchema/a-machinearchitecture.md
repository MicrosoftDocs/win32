...
keywords: ["Machine-Architecture attribute AD Schema", "machineArchitecture attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Machine-Architecture attribute

Contains a list of hardware processors supported by a given application.
