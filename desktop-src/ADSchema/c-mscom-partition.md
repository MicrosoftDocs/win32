...
keywords: ["ms-COM-Partition class AD Schema", "msCOM-Partition class AD Schema"]
topic_type:
- apiref
api_name:
- ms-COM-Partition
...
# ms-COM-Partition class

A namespace used by COM+ to allow multiple versions of the same COM+ application to exist on the same physical computer.
...
|-------------------|--------------------------------------|
| CN                | ms-COM-Partition                     |
| Ldap-Display-Name | msCOM-Partition                      |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | c9010e74-4e58-49f7-8a89-5e3e2340fcf8 |
...
| [**ms-COM-ObjectId**](a-mscom-objectid.md)                                 | False     | **ms-COM-Partition**            |
