...
keywords: ["LDAP-IPDeny-List attribute AD Schema", "lDAPIPDenyList attribute AD Schema"]
topic_type:
- apiref
api_name:
- LDAP-IPDeny-List
...
# LDAP-IPDeny-List attribute

Holds a list of binary IP addresses that are denied access to an LDAP server.
