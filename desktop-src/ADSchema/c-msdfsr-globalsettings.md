---
title: ms-DFSR-GlobalSettings class
description: Contains the global settings that apply to all replication group members.
audience: developer
...
keywords: ["ms-DFSR-GlobalSettings class AD Schema", "msDFSR-GlobalSettings class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DFSR-GlobalSettings class

Contains the global settings that apply to all replication group members.
...
The **ms-DFSR-GlobalSettings** class is a part of the Distributed File System (DFS) Replication service support.
