...
keywords: ["ms-DS-Non-Members attribute AD Schema", "msDS-NonMembers attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-Non-Members
...
| Update Frequency  | At initialization and policy change.    |
