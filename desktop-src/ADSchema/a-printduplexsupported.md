...
keywords: ["Print-Duplex-Supported attribute AD Schema", "printDuplexSupported attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Print-Duplex-Supported attribute
...
| Size              | 4 bytes. Duplex supported = 2. Simplex only = 1 or 0. |
| Update Privilege  | \-                                                    |
| Update Frequency  | \-                                                    |
