...
keywords:
- MSMQ-Site-Name-Ex attribute AD Schema
- mSMQSiteNameEx attribute AD Schema
topic_type:
- apiref
api_name:
- MSMQ-Site-Name-Ex
...
# MSMQ-Site-Name-Ex attribute

The **MSMQ-Site-Name-Ex** attribute contains MSMQ mixed-mode information.
