...
keywords: ["Print-Orientations-Supported attribute AD Schema", "printOrientationsSupported attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Print-Orientations-Supported attribute
...
| Size              | 4 bytes. Possible values: 0, 90, 270, and 0 = no landscape. |
| Update Privilege  | \-                                                          |
| Update Frequency  | \-                                                          |
