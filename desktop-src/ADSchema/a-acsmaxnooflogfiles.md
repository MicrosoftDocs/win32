...
keywords: ["ACS-Max-No-Of-Log-Files attribute AD Schema", "aCSMaxNoOfLogFiles attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Max-No-Of-Log-Files attribute

The maximum number of RSVP log files.
