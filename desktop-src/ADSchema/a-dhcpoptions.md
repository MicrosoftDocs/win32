...
keywords: ["dhcp-Options attribute AD Schema", "dhcpOptions attribute AD Schema"]
topic_type:
- apiref
api_name:
- dhcp-Options
...
|-------------------|-------------------------------------------------------|
| CN                | dhcp-Options                                          |
| Ldap-Display-Name | dhcpOptions                                           |
| Size              | \-                                                    |
| Update Privilege  | \-                                                    |
| Update Frequency  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.714                                |
| System-Id-Guid    | 963d274f-48be-11d1-a9c3-0000f80367c1                  |
