...
keywords: ["netboot-Allow-New-Clients attribute AD Schema", "netbootAllowNewClients attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# netboot-Allow-New-Clients attribute

The **netboot-Allow-New-Clients** attribute is reserved for internal use.
