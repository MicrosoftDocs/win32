...
keywords: ["ms-DS-Revealed-DSAs attribute AD Schema", "msDS-RevealedDSAs attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-Revealed-DSAs
...
# ms-DS-Revealed-DSAs attribute

Backward link for [**ms-DS-Revealed-Users**](a-msds-revealedusers.md). Identifies which RODC holds that user's secret.
