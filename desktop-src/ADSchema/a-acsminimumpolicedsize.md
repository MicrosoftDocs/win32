...
keywords:
- ACS-Minimum-Policed-Size attribute AD Schema
- aCSMinimumPolicedSize attribute AD Schema
topic_type:
- apiref
api_name:
...
# ACS-Minimum-Policed-Size attribute

The **ACS-Minimum-Policed-Size** attribute is for internal use only. Based on RFC2210.
