...
keywords: ["Per-Recip-Dialog-Display-Table attribute AD Schema", "perRecipDialogDisplayTable attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Per-Recip-Dialog-Display-Table attribute

The Per Recipient options MAPI display table.
