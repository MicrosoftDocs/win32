...
keywords: ["MS-SQL-Applications attribute AD Schema", "mS-SQL-Applications attribute AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-Applications
...
# MS-SQL-Applications attribute

Not used. Default is set to, Appl 1, Appl 2, Appl 3, Appl 4, and Appl 5.
