...
keywords: ["ACS-Allocable-RSVP-Bandwidth attribute AD Schema", "aCSAllocableRSVPBandwidth attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Allocable-RSVP-Bandwidth attribute

The maximum bandwidth that can be reserved.
