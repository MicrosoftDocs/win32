...
keywords: ["MS-SQL-LastDiagnosticDate attribute AD Schema", "mS-SQL-LastDiagnosticDate attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# MS-SQL-LastDiagnosticDate attribute

The last date that DBCC checkdb was run.
...
| Update Frequency  | When DBCC checkdb is run.                   |
...
| Classes used in        | [**MS-SQL-SQLDatabase**](c-ms-sql-sqldatabase.md)<br/> |
