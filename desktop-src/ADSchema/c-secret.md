...
keywords: ["Secret class AD Schema", "secret class AD Schema"]
topic_type:
- apiref
api_name:
- Secret
...
A Local Security Authority secret. Used for trust relationships and saving service passwords.
...
|-------------------|--------------------------------------|
| CN                | Secret                               |
| Ldap-Display-Name | secret                               |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | bf967aae-0de6-11d0-a285-00aa003049e2 |
...
| Default Security Descriptor | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY) |
...
| [**Current-Value**](a-currentvalue.md)                                   | False     | **Secret**                      |
...
| [**Last-Set-Time**](a-lastsettime.md)                                    | False     | **Secret**                      |
...
| [**Prior-Set-Time**](a-priorsettime.md)                                  | False     | **Secret**                      |
| [**Prior-Value**](a-priorvalue.md)                                       | False     | **Secret**                      |
