...
keywords: ["Servers-Container class AD Schema", "serversContainer class AD Schema"]
topic_type:
- apiref
api_name:
- Servers-Container
...
# Servers-Container class

Holds server objects in a site.
...
| Update Frequency  | When a site is created.              |
...
| Default Security Descriptor | D:(A;;CC;;;BA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)(A;;RPLCLORC;;;AU) |
