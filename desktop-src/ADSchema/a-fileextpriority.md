...
keywords:
- File-Ext-Priority attribute AD Schema
...
# File-Ext-Priority attribute

This attribute contains a list of file name extensions in an application package and their associated priorities.
