...
keywords: ["Knowledge-Information attribute AD Schema", "knowledgeInformation attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Knowledge-Information attribute

Specifies a human-readable accumulated description of knowledge mastered by a specific Directory System Agent.
...
| Classes used in        | [**DSA**](c-dsa.md)<br/> |
