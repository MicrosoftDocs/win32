...
keywords: ["Name-Service-Flags attribute AD Schema", "nameServiceFlags attribute AD Schema"]
topic_type:
- apiref
api_name:
- Name-Service-Flags
...
# Name-Service-Flags attribute

Configuration flags for RPC Name Service.
...
| Classes used in        | [**Rpc-Container**](c-rpccontainer.md)<br/> |
