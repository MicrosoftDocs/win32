...
keywords: ["associatedName attribute AD Schema"]
topic_type:
- apiref
api_name:
- associatedName
...
The associatedName attribute type specifies an entry in the organizational DIT that is associated with a DNS domain.
