...
keywords:
- LDAP-Display-Name attribute AD Schema
- lDAPDisplayName attribute AD Schema
topic_type:
- apiref
api_name:
- LDAP-Display-Name
...
The name used by LDAP clients, such as the ADSI LDAP provider, to read and write the attribute by using the LDAP protocol.
