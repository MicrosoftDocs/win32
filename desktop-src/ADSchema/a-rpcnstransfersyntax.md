...
keywords: ["rpc-Ns-Transfer-Syntax attribute AD Schema", "rpcNsTransferSyntax attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# rpc-Ns-Transfer-Syntax attribute

The UUID of the transfer syntax supported by the current entry.
...
| Classes used in        | [**rpc-Server-Element**](c-rpcserverelement.md)<br/> |
