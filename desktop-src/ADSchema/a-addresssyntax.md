...
keywords: ["Address-Syntax attribute AD Schema", "addressSyntax attribute AD Schema"]
topic_type:
- apiref
api_name:
- Address-Syntax
...
# Address-Syntax attribute

A grammar for encoding the display table properties as a string.
