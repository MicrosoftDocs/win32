...
description: An object of this class holds the one set of Claims Transformation Policy for Cross-Forest Claims Transformation. | ms-DS-Claims-Transformation-Policy-Type class
ms.assetid: 5368ea9a-0fd7-4b0e-8b49-d5c3ee3cb09c
ms.tgt_platform: multiple
keywords:
- ms-DS-Claims-Transformation-Policy-Type class AD Schema
- msDS-ClaimsTransformationPolicyType class AD Schema
topic_type:
- apiref
api_name:
...
# ms-DS-Claims-Transformation-Policy-Type class

An object of this class holds the one set of Claims Transformation Policy for Cross-Forest Claims Transformation.
...
| Ldap-Display-Name | msDS-ClaimsTransformationPolicyType     |
| Update Privilege  | \-                                      |
| Update Frequency  | \-                                      |
| Schema-Id-Guid    | 2eeb62b3-1373-fe45-8101-387f1676edc7    |
...
| Possible Superiors          | [**ms-DS-Claims-Transformation-Policies**](c-msds-claimstransformationpolicies.md) |
| Auxiliary Classes           | \-                                                                                  |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                        |
| Default Security Descriptor | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;EA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)          |
...
| [**ms-DS-Transformation-Rules**](a-msds-transformationrules.md)                             | False     | **ms-DS-Claims-Transformation-Policy-Type** |
| [**ms-DS-Transformation-Rules-Compiled**](a-msds-transformationrulescompiled.md)            | False     | **ms-DS-Claims-Transformation-Policy-Type** |
