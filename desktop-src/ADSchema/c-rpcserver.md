...
keywords: ["rpc-Server class AD Schema", "rpcServer class AD Schema"]
topic_type:
- apiref
api_name:
- rpc-Server
...
Represents a particular server that holds one or more RPC interfaces.
...
|-------------------|--------------------------------------|
| CN                | rpc-Server                           |
| Ldap-Display-Name | rpcServer                            |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 88611be0-8cf4-11d0-afda-00c04fd930c9 |
...
| Subclass of                 | [**rpc-Entry**](c-rpcentry.md)<br/>                                                   |
...
| [**rpc-Ns-Codeset**](a-rpcnscodeset.md)                                  | False     | **rpc-Server**                                                                           |
| [**rpc-Ns-Entry-Flags**](a-rpcnsentryflags.md)                           | False     | **rpc-Server**                                                                           |
| [**rpc-Ns-Object-ID**](a-rpcnsobjectid.md)                               | False     | **rpc-Server**                                                                           |
