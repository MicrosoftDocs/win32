...
keywords: ["ms-Kds-SecretAgreement-Param attribute AD Schema", "msKds-SecretAgreementParam attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-Kds-SecretAgreement-Param attribute

The parameters for the secret agreement algorithm.
