...
keywords: ["Site-List attribute AD Schema", "siteList attribute AD Schema"]
topic_type:
- apiref
api_name:
- Site-List
...
List of sites connected to this link object.
...
| Update Frequency  | Whenever a site is added to or removed from. |
...
| Classes used in        | [**Site-Link**](c-sitelink.md)<br/> |
