---
title: Sites-Container class
description: A container for storing site objects. Located in the configuration naming context.
audience: developer
...
keywords: ["Sites-Container class AD Schema", "sitesContainer class AD Schema"]
topic_type:
- apiref
api_name:
- Sites-Container
...
# Sites-Container class

A container for storing site objects. Located in the configuration naming context.
...
|-------------------|------------------------------------------|
| CN                | Sites-Container                          |
| Ldap-Display-Name | sitesContainer                           |
| Update Privilege  | This object is maintained by the system. |
| Update Frequency  | When the directory service is created.   |
| Schema-Id-Guid    | 7a4117da-cd67-11d0-afff-0000f80367c1     |
