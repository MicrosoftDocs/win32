...
keywords: ["Phone-Office-Other attribute AD Schema", "otherTelephone attribute AD Schema"]
topic_type:
- apiref
api_name:
- Phone-Office-Other
...
| Update Frequency  | When the users record is created and whenever the phone number needs to change. |
