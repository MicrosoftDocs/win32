...
keywords: ["Unicode-Pwd attribute AD Schema", "unicodePwd attribute AD Schema"]
topic_type:
- apiref
api_name:
- Unicode-Pwd
...
| Update Frequency  | When the user's record is created and whenever the password needs to change. |
