---
title: ms-DFSR-Content class
description: Represents a container for ms-DFSR-ContentSet objects.
audience: developer
...
keywords: ["ms-DFSR-Content class AD Schema", "msDFSR-Content class AD Schema"]
topic_type:
- apiref
api_name:
- ms-DFSR-Content
...
# ms-DFSR-Content class

Represents a container for [**ms-DFSR-ContentSet**](c-msdfsr-contentset.md) objects.
...
|-------------------|--------------------------------------|
| CN                | ms-DFSR-Content                      |
| Ldap-Display-Name | msDFSR-Content                       |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 64759b35-d3a1-42e4-b5f1-a3de162109b3 |
...
| Possible Superiors          | [**ms-DFSR-ReplicationGroup**](c-msdfsr-replicationgroup.md)                                                                    |
| Auxiliary Classes           | \-                                                                                                                               |
...
| [**ms-DFSR-Extension**](a-msdfsr-extension.md)                             | False     | **ms-DFSR-Content**             |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | False     | **ms-DFSR-Content**             |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | False     | [**Top**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                 | False     | **ms-DFSR-Content**             |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | False     | [**Top**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                    | False     | **ms-DFSR-Content**             |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | False     | **ms-DFSR-Content**             |
| [**ms-DS-Approx-Immed-Subordinates**](a-msds-approx-immed-subordinates.md)    | False     | [**Top**](c-top.md)<br/> |
...
The **ms-DFSR-Content** class is a part of the Distributed File System (DFS) Replication service support.
