...
keywords: ["Other-Mailbox attribute AD Schema", "otherMailbox attribute AD Schema"]
topic_type:
- apiref
api_name:
- Other-Mailbox
...
| Update Frequency  | Each time the user is issued an additional mail address. |
