...
keywords: ["ms-WMI-Name attribute AD Schema", "msWMI-Name attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-WMI-Name
...
# ms-WMI-Name attribute

The display name for top-level policy objects. Used in the Global Catalog.
...
| Classes used in        | [**ms-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> [**ms-WMI-Som**](c-mswmi-som.md)<br/> |
