---
title: Ipsec-Policy class
description: The Ipsec-Policy class is for internal use only.
audience: developer
...
keywords: ["Ipsec-Policy class AD Schema", "ipsecPolicy class AD Schema"]
topic_type:
- apiref
api_name:
- Ipsec-Policy
...
The **Ipsec-Policy** class is for internal use only.
...
|-------------------|--------------------------------------|
| CN                | Ipsec-Policy                         |
| Ldap-Display-Name | ipsecPolicy                          |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | b7b13121-b82e-11d0-afee-0000f80367c1 |
...
| [**Ipsec-ISAKMP-Reference**](a-ipsecisakmpreference.md)                  | False     | **Ipsec-Policy**                             |
| [**Ipsec-Name**](a-ipsecname.md)                                         | False     | [**Ipsec-Base**](c-ipsecbase.md)<br/> |
| [**Ipsec-NFA-Reference**](a-ipsecnfareference.md)                        | False     | **Ipsec-Policy**                             |
