...
keywords: ["meetingAdvertiseScope attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# meetingAdvertiseScope attribute

Indicates whether an entry should be advertised outside a corporate gateway or proxy.
