...
keywords: ["Site-Server attribute AD Schema", "siteServer attribute AD Schema"]
topic_type:
- apiref
api_name:
- Site-Server
...
| Update Frequency  | Whenever the licensing site needs to change. |
...
| Classes used in        | [**Licensing-Site-Settings**](c-licensingsitesettings.md)<br/> |
