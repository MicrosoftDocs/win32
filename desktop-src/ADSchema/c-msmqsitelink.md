...
keywords: ["MSMQ-Site-Link class AD Schema", "mSMQSiteLink class AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Site-Link
...
# MSMQ-Site-Link class

Contains information about MSMQ routing connectivity between sites. This object is created for each routing link that is created and contains connectivity information. These objects are contained by MSMQ Services objects.
...
|-------------------|-------------------------------------------------------------------|
| CN                | MSMQ-Site-Link                                                    |
| Ldap-Display-Name | mSMQSiteLink                                                      |
| Update Privilege  | The queue owner.                                                  |
| Update Frequency  | An instance is created per each pair of sites that are connected. |
| Schema-Id-Guid    | 9a0dc346-c100-11d1-bbc5-0080c76670c0                              |
...
| Possible Superiors          | [**MSMQ-Enterprise-Settings**](c-msmqenterprisesettings.md)                                 |
| Auxiliary Classes           | \-                                                                                           |
...
| [**MSMQ-Cost**](a-msmqcost.md)                                           | True      | **MSMQ-Site-Link**              |
| [**MSMQ-Site-1**](a-msmqsite1.md)                                        | True      | **MSMQ-Site-Link**              |
| [**MSMQ-Site-2**](a-msmqsite2.md)                                        | True      | **MSMQ-Site-Link**              |
| [**MSMQ-Site-Gates**](a-msmqsitegates.md)                                | False     | **MSMQ-Site-Link**              |
| [**MSMQ-Site-Gates-Mig**](a-msmqsitegatesmig.md)                         | False     | **MSMQ-Site-Link**              |
