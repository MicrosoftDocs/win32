...
keywords: ["Last-Backup-Restoration-Time attribute AD Schema", "lastBackupRestorationTime attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Last-Backup-Restoration-Time attribute

When the last system restore occurred.
