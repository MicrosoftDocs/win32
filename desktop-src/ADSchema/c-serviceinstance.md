---
title: Service-Instance class
description: A connection point object used by the Windows Sockets Registration and Resolution (RnR) name service, which is accessed through the Windows Sockets WSA\ APIs.
audience: developer
...
keywords: ["Service-Instance class AD Schema", "serviceInstance class AD Schema"]
topic_type:
- apiref
api_name:
- Service-Instance
...
A connection point object used by the Windows Sockets Registration and Resolution (RnR) name service, which is accessed through the Windows Sockets WSA\* APIs.
...
|-------------------|--------------------------------------|
| CN                | Service-Instance                     |
| Ldap-Display-Name | serviceInstance                      |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | bf967ab2-0de6-11d0-a285-00aa003049e2 |
...
| [**Display-Name**](a-displayname.md)                                     | True      | **Service-Instance** [**Top**](c-top.md)<br/>                                     |
...
| [**Service-Class-ID**](a-serviceclassid.md)                              | True      | **Service-Instance**                                                                     |
| [**Service-Instance-Version**](a-serviceinstanceversion.md)              | False     | **Service-Instance**                                                                     |
...
| [**Winsock-Addresses**](a-winsockaddresses.md)                           | False     | **Service-Instance**                                                                     |
