...
keywords: ["ms-TS-Remote-Control attribute AD Schema", "msTSRemoteControl attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-TS-Remote-Control attribute

Terminal Services Remote Control specifies whether to allow remote observation or remote control of the user's Terminal Services session.
