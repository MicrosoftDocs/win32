...
For a Read-Only Domain Controller (RODC), identifies whether the specified user's secrets can be cached.
...
| Classes used in        | [**Computer**](c-computer.md)<br/> [**NTDS-DSA**](c-ntdsdsa.md)<br/> [**Server**](c-server.md)<br/> |
