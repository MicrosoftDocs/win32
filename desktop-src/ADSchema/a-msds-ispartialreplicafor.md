...
keywords: ["ms-DS-Is-Partial-Replica-For attribute AD Schema", "msDS-IsPartialReplicaFor attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Is-Partial-Replica-For attribute

Backward link for [**hasPartialReplicaNCs**](a-haspartialreplicancs.md). Identifies which DCs hold that partition as a partial replica.
