...
keywords: ["ACS-Permission-Bits attribute AD Schema", "aCSPermissionBits attribute AD Schema"]
topic_type:
- apiref
api_name:
- ACS-Permission-Bits
...
# ACS-Permission-Bits attribute

Allows multicast flow origination for a given user.
