...
keywords: ["ACS-Max-Peak-Bandwidth attribute AD Schema", "aCSMaxPeakBandwidth attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Max-Peak-Bandwidth attribute

The peak bandwidth that can be reserved.
...
| Classes used in        | [**ACS-Resource-Limits**](c-acsresourcelimits.md)<br/> [**ACS-Subnet**](c-acssubnet.md)<br/> |
