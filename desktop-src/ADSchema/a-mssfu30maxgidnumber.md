...
keywords: ["msSFU-30-Max-Gid-Number attribute AD Schema", "msSFU30MaxGidNumber attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# msSFU-30-Max-Gid-Number attribute

Contains the maximum number of groups migrated to an NIS domain.
