...
keywords: ["COM-ClassID attribute AD Schema", "cOMClassID attribute AD Schema"]
topic_type:
- apiref
api_name:
- COM-ClassID
...
# COM-ClassID attribute

This attribute stores the list of ClassIDs that are implemented in this application package.
...
| Classes used in        | [**Package-Registration**](c-packageregistration.md)<br/> [**Type-Library**](c-typelibrary.md)<br/> |
