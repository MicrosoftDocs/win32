...
keywords: ["MS-SQL-Location attribute AD Schema", "mS-SQL-Location attribute AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-Location
...
# MS-SQL-Location attribute

A user defined string. Default is set to Location.
