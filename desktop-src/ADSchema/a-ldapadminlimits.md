...
keywords: ["LDAP-Admin-Limits attribute AD Schema", "lDAPAdminLimits attribute AD Schema"]
topic_type:
- apiref
api_name:
- LDAP-Admin-Limits
...
# LDAP-Admin-Limits attribute

Contains a set of attribute-value pairs defining LDAP server administrative limits.
...
| Classes used in        | [**Query-Policy**](c-querypolicy.md)<br/> |
