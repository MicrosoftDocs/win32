...
keywords: ["ms-PKI-OID-Attribute attribute AD Schema", "msPKI-OID-Attribute attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-PKI-OID-Attribute attribute

The attribute for the enterprise OID.
