...
description: This attribute specifies the path for the users logon script. The string can be null.
audience: developer
...
keywords:
- Script-Path attribute AD Schema
- scriptPath attribute AD Schema
topic_type:
- apiref
api_name:
- Script-Path
...
| Update Frequency  | When the user record is created and whenever the path needs to change. |
