...
keywords: ["ms-TS-Max-Disconnection-Time attribute AD Schema", "msTSMaxDisconnectionTime attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-TS-Max-Disconnection-Time attribute

Terminal Services session Maximum Disconnection Time is the maximum amount of time, in minutes, that a disconnected Terminal Services session remains active on the terminal server.
