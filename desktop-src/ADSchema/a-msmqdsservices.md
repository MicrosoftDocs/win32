...
keywords: ["MSMQ-Ds-Services attribute AD Schema", "mSMQDsServices attribute AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Ds-Services
...
# MSMQ-Ds-Services attribute

Indicates whether the MSMQ installed on this computer provides MSMQ DS services.
