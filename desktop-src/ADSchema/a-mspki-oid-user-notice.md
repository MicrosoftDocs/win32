...
keywords: ["ms-PKI-OID-User-Notice attribute AD Schema", "msPKI-OID-User-Notice attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-PKI-OID-User-Notice attribute

The user notice for the enterprise issuer policy OID.
