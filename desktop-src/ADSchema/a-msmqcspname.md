...
keywords: ["MSMQ-CSP-Name attribute AD Schema", "mSMQCSPName attribute AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-CSP-Name
...
# MSMQ-CSP-Name attribute

The type of cryptographic provider used by MSMQ.
...
| Classes used in        | [**MSMQ-Enterprise-Settings**](c-msmqenterprisesettings.md)<br/> |
