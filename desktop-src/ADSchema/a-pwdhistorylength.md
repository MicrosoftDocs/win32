...
keywords: ["Pwd-History-Length attribute AD Schema", "pwdHistoryLength attribute AD Schema"]
topic_type:
- apiref
api_name:
- Pwd-History-Length
...
| Update Frequency  | When the account policy needs to change. |
