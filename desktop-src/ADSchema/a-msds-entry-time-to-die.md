...
keywords: ["ms-DS-Entry-Time-To-Die attribute AD Schema", "msDS-Entry-Time-To-Die attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Entry-Time-To-Die attribute

Holds the absolute expiration time of a dynamic object in the directory.
