...
keywords: ["Ipsec-Base class AD Schema", "ipsecBase class AD Schema"]
topic_type:
- apiref
api_name:
- Ipsec-Base
...
IPSEC base class from which all IPSEC classes are derived.
...
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | b40ff825-427a-11d1-a9c2-0000f80367c1 |
...
| [**Ipsec-Data**](a-ipsecdata.md)                                         | False     | **Ipsec-Base**                  |
| [**Ipsec-Data-Type**](a-ipsecdatatype.md)                                | False     | **Ipsec-Base**                  |
| [**Ipsec-ID**](a-ipsecid.md)                                             | False     | **Ipsec-Base**                  |
| [**Ipsec-Name**](a-ipsecname.md)                                         | False     | **Ipsec-Base**                  |
| [**Ipsec-Owners-Reference**](a-ipsecownersreference.md)                  | False     | **Ipsec-Base**                  |
