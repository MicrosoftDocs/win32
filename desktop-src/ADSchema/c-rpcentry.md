...
keywords: ["rpc-Entry class AD Schema", "rpcEntry class AD Schema"]
topic_type:
- apiref
api_name:
- rpc-Entry
...
An abstract class whose subclasses are used by the RPC Name Service (Ns), which is accessed by using the RpcNs\* functions in the Win32 API.
...
|-------------------|--------------------------------------|
| CN                | rpc-Entry                            |
| Ldap-Display-Name | rpcEntry                             |
| Update Privilege  | Schema administrator                 |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | bf967aac-0de6-11d0-a285-00aa003049e2 |
