...
keywords:
- Superior-DNS-Root attribute AD Schema
- superiorDNSRoot attribute AD Schema
topic_type:
- apiref
api_name:
- Superior-DNS-Root
...
# Superior-DNS-Root attribute

This is a system attribute that is used for referrals generation.
