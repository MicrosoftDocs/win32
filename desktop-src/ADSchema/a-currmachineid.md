...
keywords: ["Curr-Machine-Id attribute AD Schema", "currMachineId attribute AD Schema"]
topic_type:
- apiref
api_name:
- Curr-Machine-Id
...
# Curr-Machine-Id attribute

The ID of the machine where a Link-Track-Vol-Entry object is located.
