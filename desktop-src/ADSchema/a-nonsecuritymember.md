...
keywords: ["Non-Security-Member attribute AD Schema", "nonSecurityMember attribute AD Schema"]
topic_type:
- apiref
api_name:
- Non-Security-Member
...
| Update Frequency  | Whenever a user is added or removed from the DL. |
