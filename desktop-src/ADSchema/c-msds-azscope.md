---
title: ms-DS-Az-Scope class
description: Describes a set of objects managed by an application.
audience: developer
...
keywords: ["ms-DS-Az-Scope class AD Schema", "msDS-AzScope class AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-Az-Scope
...
# ms-DS-Az-Scope class

Describes a set of objects managed by an application.
...
| Possible Superiors          | [**ms-DS-Az-Application**](c-msds-azapplication.md)                                                                             |
| Auxiliary Classes           | \-                                                                                                                               |
...
| [**Description**](a-description.md)                                        | False     | **ms-DS-Az-Scope** [**Top**](c-top.md)<br/> |
