---
title: ms-PKI-Enterprise-Oid class
description: Used when a certificate UI displays a display name for a certificate template, enhanced key usage, application policy, and issuance policy. The UI component will try to locate a string in the attribute that matches the default language locale.
...
Used when a certificate UI displays a display name for a certificate template, enhanced key usage, application policy, and issuance policy. The UI component will try to locate a string in the attribute that matches the default language locale.
...
| Ldap-Display-Name | msPKI-Enterprise-Oid                                                                         |
| Update Privilege  | Domain administrator                                                                         |
| Update Frequency  | It is updated when the administrator runs certutil.exe to store localized name for each oid. |
...
| Possible Superiors          | [**Container**](c-container.md)**ms-PKI-Enterprise-Oid**                                    |
| Auxiliary Classes           | \-                                                                                           |
...
| [**ms-PKI-Cert-Template-OID**](a-mspki-cert-template-oid.md)               | False     | **ms-PKI-Enterprise-Oid**       |
| [**ms-PKI-OID-Attribute**](a-mspki-oid-attribute.md)                       | False     | **ms-PKI-Enterprise-Oid**       |
| [**ms-PKI-OID-CPS**](a-mspki-oid-cps.md)                                   | False     | **ms-PKI-Enterprise-Oid**       |
| [**ms-PKI-OID-LocalizedName**](a-mspki-oidlocalizedname.md)                | False     | **ms-PKI-Enterprise-Oid**       |
| [**ms-PKI-OID-User-Notice**](a-mspki-oid-user-notice.md)                   | False     | **ms-PKI-Enterprise-Oid**       |
...
| [**ms-DS-Non-Members-BL**](a-msds-nonmembersbl.md)                              | False     | [**Top**](c-top.md)<br/> |
| [**ms-DS-Object-Reference-BL**](a-msds-objectreferencebl.md)                    | False     | [**Top**](c-top.md)<br/> |
| [**ms-DS-OIDToGroup-Link**](a-msds-oidtogrouplink.md)                           | False     | **ms-PKI-Enterprise-Oid**       |
