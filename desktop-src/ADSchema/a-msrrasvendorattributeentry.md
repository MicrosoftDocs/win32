...
keywords: ["ms-RRAS-Vendor-Attribute-Entry attribute AD Schema", "msRRASVendorAttributeEntry attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-RRAS-Vendor-Attribute-Entry attribute

A string that enables vendors to add router attributes to the DS for use in queries, in the form AttributeName:vendorID:AttributeType.
...
| Classes used in        | [**RRAS-Administration-Dictionary**](c-rrasadministrationdictionary.md)<br/> |
