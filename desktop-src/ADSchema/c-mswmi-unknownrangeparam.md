---
title: ms-WMI-UnknownRangeParam class
description: Supports parameter types we know nothing about, so they are transported as compiled WMI objects.
audience: developer
...
keywords: ["ms-WMI-UnknownRangeParam class AD Schema", "msWMI-UnknownRangeParam class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-WMI-UnknownRangeParam class

Supports parameter types we know nothing about, so they are transported as compiled WMI objects.
