...
keywords: ["MS-SQL-SQLPublication class AD Schema", "mS-SQL-SQLPublication class AD Schema"]
topic_type:
- apiref
api_name:
...
# MS-SQL-SQLPublication class

Class for storing SQL Server publication properties. Permits the user to browse the publications that are available to subscribe to.
...
| [**MS-SQL-Database**](a-ms-sql-database.md)                                                     | False     | **MS-SQL-SQLPublication**       |
