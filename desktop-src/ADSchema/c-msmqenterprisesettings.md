...
keywords: ["MSMQ-Enterprise-Settings class AD Schema", "mSMQEnterpriseSettings class AD Schema"]
topic_type:
- apiref
api_name:
...
# MSMQ-Enterprise-Settings class

An object with general MSMQ information. It is placed under \\Configuration\\Services. There can only be one of these in a forest. This object contains organization wide configuration information for message queuing.
...
| [**MSMQ-Long-Lived**](a-msmqlonglived.md)                                | False     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-Name-Style**](a-msmqnamestyle.md)                                | False     | **MSMQ-Enterprise-Settings**    |
