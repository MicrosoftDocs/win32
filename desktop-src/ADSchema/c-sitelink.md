---
title: Site-Link class
description: This object represents the connection between two sites.
audience: developer
...
keywords: ["Site-Link class AD Schema", "siteLink class AD Schema"]
topic_type:
- apiref
api_name:
- Site-Link
...
|-------------------|----------------------------------------------------|
| CN                | Site-Link                                          |
| Ldap-Display-Name | siteLink                                           |
| Update Privilege  | Domain administrator                               |
| Update Frequency  | Whenever the sites connected to this link changes. |
| Schema-Id-Guid    | d50c2cde-8951-11d1-aebc-0000f80367c1               |
...
| [**Cost**](a-cost.md)                                                    | False     | **Site-Link**                   |
...
| [**Options**](a-options.md)                                              | False     | **Site-Link**                   |
...
| [**Repl-Interval**](a-replinterval.md)                                   | False     | **Site-Link**                   |
...
| [**Schedule**](a-schedule.md)                                            | False     | **Site-Link**                   |
...
| [**Site-List**](a-sitelist.md)                                           | True      | **Site-Link**                   |
