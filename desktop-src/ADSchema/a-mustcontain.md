...
keywords: ["Must-Contain attribute AD Schema", "mustContain attribute AD Schema"]
topic_type:
- apiref
api_name:
- Must-Contain
...
The list of mandatory attributes for a class. These attributes must be specified when an instance of the class is created.
