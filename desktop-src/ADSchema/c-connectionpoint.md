...
keywords: ["Connection-Point class AD Schema", "connectionPoint class AD Schema"]
topic_type:
- apiref
api_name:
- Connection-Point
...
Base class from which all connectable objects are derived.
...
| [**Common-Name**](a-cn.md)                                               | True      | **Connection-Point** [**Top**](c-top.md)<br/> |
...
| [**Keywords**](a-keywords.md)                                            | False     | **Connection-Point**                                 |
| [**Last-Known-Parent**](a-lastknownparent.md)                            | False     | [**Top**](c-top.md)<br/>                      |
| [**Managed-By**](a-managedby.md)                                         | False     | **Connection-Point**                                 |
...
| [**ms-DS-Settings**](a-msds-settings.md)                                   | False     | **Connection-Point**                                 |
