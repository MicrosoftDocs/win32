...
keywords: ["Address-Entry-Display-Table-MSDOS attribute AD Schema", "addressEntryDisplayTableMSDOS attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Address-Entry-Display-Table-MSDOS attribute

The MAPI display table for an address entry for MSDOS client.
