...
keywords: ["Inter-Site-Transport class AD Schema", "interSiteTransport class AD Schema"]
topic_type:
- apiref
api_name:
...
# Inter-Site-Transport class

Optional attribute of ntdsConnection objects. If present, holds the DN of an interSiteTransport object in the CN=Inter-Site Transports,CN=Sites,CN=Configuration,... container.
...
| Ldap-Display-Name | interSiteTransport                                                                                                                 |
| Update Privilege  | This value is set by the KCC or enterprise administrator.                                                                          |
| Update Frequency  | Created/managed by the Knowledge Consistency Checker in response to changes in the network topology (including temporary outages). |
| Schema-Id-Guid    | 26d97376-6070-11d1-a9c6-0000f80367c1                                                                                               |
...
| Possible Superiors          | [**Inter-Site-Transport-Container**](c-intersitetransportcontainer.md)                      |
| Auxiliary Classes           | \-                                                                                           |
...
| [**Options**](a-options.md)                                              | False     | **Inter-Site-Transport**        |
...
| [**Repl-Interval**](a-replinterval.md)                                   | False     | **Inter-Site-Transport**        |
...
| [**Transport-Address-Attribute**](a-transportaddressattribute.md)        | True      | **Inter-Site-Transport**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | True      | **Inter-Site-Transport**        |
