...
keywords: ["MS-SQL-InformationDirectory attribute AD Schema", "mS-SQL-InformationDirectory attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# MS-SQL-InformationDirectory attribute

The informational directory for the current instance of SQL Server.
...
| Classes used in        | [**MS-SQL-SQLRepository**](c-ms-sql-sqlrepository.md)<br/> |
