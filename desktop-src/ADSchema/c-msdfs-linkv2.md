---
title: ms-DFS-Link-v2 class
description: DFS link in DFS namespace.
audience: developer
...
keywords: ["ms-DFS-Link-v2 class AD Schema", "msDFS-Linkv2 class AD Schema"]
topic_type:
- apiref
api_name:
- ms-DFS-Link-v2
...
# ms-DFS-Link-v2 class

DFS link in DFS namespace.
