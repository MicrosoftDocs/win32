---
title: MS-SQL-OLAPCube class
description: Class for storing SQL Server OLAP Cube properties.
audience: developer
...
keywords: ["MS-SQL-OLAPCube class AD Schema", "mS-SQL-OLAPCube class AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-OLAPCube
...
# MS-SQL-OLAPCube class

Class for storing SQL Server OLAP Cube properties.
...
|-------------------|--------------------------------------|
| CN                | MS-SQL-OLAPCube                      |
| Ldap-Display-Name | mS-SQL-OLAPCube                      |
| Update Privilege  | This value is set by the system.     |
| Update Frequency  | At system setup.                     |
| Schema-Id-Guid    | 09f0506a-cd28-11d2-9993-0000f87a57d4 |
...
| Possible Superiors          | [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md)                                         |
| Auxiliary Classes           | \-                                                                                           |
...
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Keywords**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                      | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                  | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Size**](a-ms-sql-size.md)                                      | False     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                  | False     | **MS-SQL-OLAPCube**             |
