...
keywords: ["MS-SQL-SortOrder attribute AD Schema", "mS-SQL-SortOrder attribute AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-SortOrder
...
# MS-SQL-SortOrder attribute

The sort order for the current instance of SQL Server.
