...
keywords: ["documentPublisher attribute AD Schema"]
topic_type:
- apiref
api_name:
- documentPublisher
...
The documentPublisher attribute is the person or organization that published a document.
...
| Classes used in        | [**document**](c-document.md)<br/> |
