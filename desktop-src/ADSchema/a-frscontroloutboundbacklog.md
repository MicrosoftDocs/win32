...
keywords: ["FRS-Control-Outbound-Backlog attribute AD Schema", "fRSControlOutboundBacklog attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# FRS-Control-Outbound-Backlog attribute

Warning/Error level pair for outbound backlog (number of files).
