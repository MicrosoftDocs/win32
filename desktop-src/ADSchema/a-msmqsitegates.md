...
keywords: ["MSMQ-Site-Gates attribute AD Schema", "mSMQSiteGates attribute AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Site-Gates
...
# MSMQ-Site-Gates attribute

The list of DNs for MSMQ routing servers, through which all traffic between sites must be routed.
