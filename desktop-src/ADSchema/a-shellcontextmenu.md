...
keywords: ["Shell-Context-Menu attribute AD Schema", "shellContextMenu attribute AD Schema"]
topic_type:
- apiref
api_name:
- Shell-Context-Menu
...
# Shell-Context-Menu attribute

The order number and GUID of the context menu for this object.
