...
keywords: ["MSMQ-Site-2 attribute AD Schema", "mSMQSite2 attribute AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Site-2
...
# MSMQ-Site-2 attribute

The DN of the second site of a pair that are connected.
...
| Size              | \-                                      |
| Update Privilege  | \-                                      |
| Update Frequency  | Each time an MSMQ-Site-Line is created. |
