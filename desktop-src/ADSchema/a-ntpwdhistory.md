...
keywords: ["Nt-Pwd-History attribute AD Schema", "ntPwdHistory attribute AD Schema"]
topic_type:
- apiref
api_name:
- Nt-Pwd-History
...
| Update Frequency  | Each time the user changes passwords.                 |
