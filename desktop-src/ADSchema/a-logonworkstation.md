...
keywords: ["Logon-Workstation attribute AD Schema", "logonWorkstation attribute AD Schema"]
topic_type:
- apiref
api_name:
- Logon-Workstation
...
# Logon-Workstation attribute

This attribute is not used. See the [**User-Workstations**](a-userworkstations.md) attribute.
