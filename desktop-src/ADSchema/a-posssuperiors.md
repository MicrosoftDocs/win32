...
keywords: ["Poss-Superiors attribute AD Schema", "possSuperiors attribute AD Schema"]
topic_type:
- apiref
api_name:
- Poss-Superiors
...
# Poss-Superiors attribute

The list of objects that can contain this class.
...
| Update Frequency  | When the class is defined.                                      |
