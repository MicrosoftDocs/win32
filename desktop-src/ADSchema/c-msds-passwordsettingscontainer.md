...
keywords: ["ms-DS-Password-Settings-Container class AD Schema", "msDS-PasswordSettingsContainer class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Password-Settings-Container class

Container for password settings objects.
