...
keywords: ["Default-Object-Category attribute AD Schema", "defaultObjectCategory attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Default-Object-Category attribute

The object category to use for the object if one is not specified.
