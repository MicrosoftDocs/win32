---
title: MS-SQL-CreationDate attribute
...
keywords: ["MS-SQL-CreationDate attribute AD Schema", "mS-SQL-CreationDate attribute AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-CreationDate
...
| Update Frequency  | When a new database is created.             |
