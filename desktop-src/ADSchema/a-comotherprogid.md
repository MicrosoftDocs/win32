...
keywords: ["COM-Other-Prog-Id attribute AD Schema", "cOMOtherProgId attribute AD Schema"]
topic_type:
- apiref
api_name:
- COM-Other-Prog-Id
...
# COM-Other-Prog-Id attribute

List of other program ID strings for the host class.
