...
keywords: ["Desktop-Profile attribute AD Schema", "desktopProfile attribute AD Schema"]
topic_type:
- apiref
api_name:
- Desktop-Profile
...
| Classes used in        | [**Group**](c-group.md)<br/> [**Organizational-Unit**](c-organizationalunit.md)<br/> [**Sam-Domain**](c-samdomain.md)<br/> [**User**](c-user.md)<br/> |
...
| Search-Flags           | 0x00000000                                                                                         |
| System-Flags           | 0x00000010                                                                                         |
| Classes used in        | [**Group**](c-group.md)<br/> [**Organizational-Unit**](c-organizationalunit.md)<br/> |
