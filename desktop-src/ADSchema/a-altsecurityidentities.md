...
keywords: ["Alt-Security-Identities attribute AD Schema", "altSecurityIdentities attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Alt-Security-Identities attribute
...
| Update Frequency  | Each time a new authentication mechanism is needed. |
