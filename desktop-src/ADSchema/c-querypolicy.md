...
keywords: ["Query-Policy class AD Schema", "queryPolicy class AD Schema"]
topic_type:
- apiref
api_name:
- Query-Policy
...
| [**LDAP-Admin-Limits**](a-ldapadminlimits.md)                            | False     | **Query-Policy**                |
| [**LDAP-IPDeny-List**](a-ldapipdenylist.md)                              | False     | **Query-Policy**                |
