...
keywords: ["MSMQ-Queue-Type attribute AD Schema", "mSMQQueueType attribute AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Queue-Type
...
# MSMQ-Queue-Type attribute

A GUID that describes the type of service provided by the queue.
