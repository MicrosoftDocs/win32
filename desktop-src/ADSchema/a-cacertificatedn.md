...
keywords: ["CA-Certificate-DN attribute AD Schema", "cACertificateDN attribute AD Schema"]
topic_type:
- apiref
api_name:
- CA-Certificate-DN
...
| Classes used in        | [**Certification-Authority**](c-certificationauthority.md)<br/> [**PKI-Enrollment-Service**](c-pkienrollmentservice.md)<br/> |
