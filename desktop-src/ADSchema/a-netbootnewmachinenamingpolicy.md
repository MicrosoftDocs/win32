...
keywords: ["netboot-New-Machine-Naming-Policy attribute AD Schema", "netbootNewMachineNamingPolicy attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# netboot-New-Machine-Naming-Policy attribute

Indicates the naming scheme which new client computer accounts will use.
