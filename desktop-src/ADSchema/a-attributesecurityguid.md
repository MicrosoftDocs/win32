...
keywords: ["Attribute-Security-GUID attribute AD Schema", "attributeSecurityGUID attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Attribute-Security-GUID attribute

The GUID to be used to apply security credentials to a set of objects.
