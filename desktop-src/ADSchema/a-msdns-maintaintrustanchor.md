...
keywords: ["ms-DNS-Maintain-Trust-Anchor attribute AD Schema", "msDNS-MaintainTrustAnchor attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DNS-Maintain-Trust-Anchor attribute

An attribute used to define the type of trust anchor to automatically publish in the forest-wide trust anchor store when the DNS zone is signed.
