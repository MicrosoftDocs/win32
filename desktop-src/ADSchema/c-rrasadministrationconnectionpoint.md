...
keywords: ["RRAS-Administration-Connection-Point class AD Schema", "rRASAdministrationConnectionPoint class AD Schema"]
topic_type:
- apiref
api_name:
...
# RRAS-Administration-Connection-Point class

This object contains the connection point for RRAS.
...
| [**ms-RRAS-Attribute**](a-msrrasattribute.md)                            | False     | **RRAS-Administration-Connection-Point**                                                 |
