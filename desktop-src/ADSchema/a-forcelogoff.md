...
keywords: ["Force-Logoff attribute AD Schema", "forceLogoff attribute AD Schema"]
topic_type:
- apiref
api_name:
- Force-Logoff
...
| Classes used in        | [**Domain-Policy**](c-domainpolicy.md)<br/> [**Sam-Domain-Base**](c-samdomainbase.md)<br/> |
