...
keywords: ["Groups-to-Ignore attribute AD Schema", "groupsToIgnore attribute AD Schema"]
topic_type:
- apiref
api_name:
- Groups-to-Ignore
...
|-------------------|---------------------------------------------|
| CN                | Groups-to-Ignore                            |
| Ldap-Display-Name | groupsToIgnore                              |
| Size              | \-                                          |
| Update Privilege  | \-                                          |
| Update Frequency  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.344                      |
| System-Id-Guid    | eea65904-8ac6-11d0-afda-00c04fd930c9        |
