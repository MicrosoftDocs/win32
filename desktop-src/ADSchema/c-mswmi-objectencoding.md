...
keywords: ["ms-WMI-ObjectEncoding class AD Schema", "msWMI-ObjectEncoding class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-WMI-ObjectEncoding class

Holds encoding data for a WMI Class or Instance Object as well as additional info regarding the object.
...
| [**ms-WMI-Genus**](a-mswmi-genus.md)                                       | True      | **ms-WMI-ObjectEncoding**       |
