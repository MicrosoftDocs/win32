...
keywords: ["Ipsec-Filter class AD Schema", "ipsecFilter class AD Schema"]
topic_type:
- apiref
api_name:
- Ipsec-Filter
...
Represents an IPSec filter, which is used to create security policies such as those that block ports and protocols.
