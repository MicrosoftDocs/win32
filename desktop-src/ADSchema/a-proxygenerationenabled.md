...
keywords: ["Proxy-Generation-Enabled attribute AD Schema", "proxyGenerationEnabled attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Proxy-Generation-Enabled attribute

**TRUE** if proxy generation is enabled.
