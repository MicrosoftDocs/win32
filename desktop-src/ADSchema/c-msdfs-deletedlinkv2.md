---
title: ms-DFS-Deleted-Link-v2 class
description: Deleted DFS link in DFS namespace.
audience: developer
...
keywords: ["ms-DFS-Deleted-Link-v2 class AD Schema", "msDFS-DeletedLinkv2 class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DFS-Deleted-Link-v2 class

Deleted DFS link in DFS namespace.
...
| Ldap-Display-Name | msDFS-DeletedLinkv2                  |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 25173408-04ca-40e8-865e-3f9ce9bf1bd3 |
...
| Possible Superiors          | [**ms-DFS-Namespace-v2**](c-msdfs-namespacev2.md)                                           |
| Auxiliary Classes           | \-                                                                                           |
...
| [**ms-DFS-Comment-v2**](a-msdfs-commentv2.md)                                 | False     | **ms-DFS-Deleted-Link-v2**      |
...
| [**ms-DFS-Short-Name-Link-Path-v2**](a-msdfs-shortnamelinkpathv2.md)          | False     | **ms-DFS-Deleted-Link-v2**      |
