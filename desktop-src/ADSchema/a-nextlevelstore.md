...
keywords: ["Next-Level-Store attribute AD Schema", "nextLevelStore attribute AD Schema"]
topic_type:
- apiref
api_name:
- Next-Level-Store
...
# Next-Level-Store attribute

This attribute indicates the next class store to search.
