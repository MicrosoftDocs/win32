...
Contains the Distributed File System (DFS) Replication service settings that are applicable to the local computer.
...
| [**ms-DFSR-Extension**](a-msdfsr-extension.md)                             | False     | **ms-DFSR-LocalSettings**       |
...
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                 | False     | **ms-DFSR-LocalSettings**       |
