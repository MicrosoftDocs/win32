...
keywords: ["ms-DS-Allowed-DNS-Suffixes attribute AD Schema", "msDS-AllowedDNSSuffixes attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Allowed-DNS-Suffixes attribute

The list of allowed suffixes for the dNSHostName attribute in computer objects.
...
| Classes used in        | [**Domain-DNS**](c-domaindns.md)<br/> |
