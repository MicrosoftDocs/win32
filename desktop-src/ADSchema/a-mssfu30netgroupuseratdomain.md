---
title: msSFU-30-Netgroup-User-At-Domain attribute
description: Contains part of the netgroup map that represents computed strings, such as \ 0034;user domain \ 0034;.
audience: developer
...
Contains part of the netgroup map that represents computed strings, such as "user@domain".
