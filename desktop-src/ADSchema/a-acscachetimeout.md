...
keywords: ["ACS-Cache-Timeout attribute AD Schema", "aCSCacheTimeout attribute AD Schema"]
topic_type:
- apiref
api_name:
- ACS-Cache-Timeout
...
# ACS-Cache-Timeout attribute

The amount of time before the expiration of ACS objects that are cached by the ACS service.
