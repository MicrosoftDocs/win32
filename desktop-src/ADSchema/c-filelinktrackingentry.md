...
keywords: ["File-Link-Tracking-Entry class AD Schema", "fileLinkTrackingEntry class AD Schema"]
topic_type:
- apiref
api_name:
...
# File-Link-Tracking-Entry class

Holds the GUID and current computer information for a link-tracked file.
...
| Ldap-Display-Name | fileLinkTrackingEntry                |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 8e4eb2ed-4712-11d0-a1a0-00c04fd930c9 |
