...
keywords: ["ACS-Enable-ACS-Service attribute AD Schema", "aCSEnableACSService attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Enable-ACS-Service attribute

True if ACS service is to be enabled.
