...
keywords: ["ms-WMI-RealRangeParam class AD Schema", "msWMI-RealRangeParam class AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-WMI-RealRangeParam class

Real number range parameter object.
...
| Ldap-Display-Name | msWMI-RealRangeParam                 |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 6afe8fe2-70bc-4cce-b166-a96f7359c514 |
...
| [**ms-WMI-int8Default**](a-mswmi-int8default.md)                           | True      | **ms-WMI-RealRangeParam**                                  |
| [**ms-WMI-int8Max**](a-mswmi-int8max.md)                                   | False     | **ms-WMI-RealRangeParam**                                  |
| [**ms-WMI-int8Min**](a-mswmi-int8min.md)                                   | False     | **ms-WMI-RealRangeParam**                                  |
