...
keywords: ["ms-DS-Az-Application-Version attribute AD Schema", "msDS-AzApplicationVersion attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ms-DS-Az-Application-Version attribute
...
| Update Frequency  | When the version number for the application changes. |
