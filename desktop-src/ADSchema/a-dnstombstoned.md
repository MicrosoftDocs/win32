...
keywords: ["DNS-Tombstoned attribute AD Schema", "dNSTombstoned attribute AD Schema"]
topic_type:
- apiref
api_name:
- DNS-Tombstoned
...
| Update Frequency  | Whenever an object is deleted.       |
...
| Classes used in        | [**Dns-Node**](c-dnsnode.md)<br/> |
