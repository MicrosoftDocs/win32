...
keywords: ["Default-Security-Descriptor attribute AD Schema", "defaultSecurityDescriptor attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# Default-Security-Descriptor attribute

The security descriptor to be assigned to the object when it is first created.
