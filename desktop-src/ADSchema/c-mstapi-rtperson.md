...
keywords: ["ms-TAPI-Rt-Person class AD Schema", "msTAPI-RtPerson class AD Schema"]
topic_type:
- apiref
api_name:
- ms-TAPI-Rt-Person
...
# ms-TAPI-Rt-Person class

Used to map a user to the IP address of the computer that the user is logged into for use by TAPI multicast conferences.
...
| Update Frequency  | Whenever a TAPI client starts up after having registered with the TAPI directory. |
...
| Possible Superiors          | [**Organizational-Unit**](c-organizationalunit.md)[**Organization**](c-organization.md)    |
| Auxiliary Classes           | \-                                                                                           |
...
| [**ms-TAPI-Ip-Address**](a-mstapi-ipaddress.md)                            | False     | **ms-TAPI-Rt-Person**           |
