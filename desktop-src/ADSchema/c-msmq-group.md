...
keywords: ["MSMQ-Group class AD Schema", "msMQ-Group class AD Schema"]
topic_type:
- apiref
api_name:
- MSMQ-Group
...
Used to define a group of MSMQ queues (also known as a Distribution List).
...
| Update Frequency  | Each time a member is added to or removed from a group. |
...
| [**Member**](a-member.md)                                                  | True      | **MSMQ-Group**                  |
