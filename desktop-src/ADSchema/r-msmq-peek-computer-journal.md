...
description: Allows peeking at messages in the Computer Journal queue.
audience: developer
...
keywords: ["msmq-Peek-computer-Journal extended right AD Schema"]
topic_type:
- apiref
api_name:
...
# msmq-Peek-computer-Journal extended right
