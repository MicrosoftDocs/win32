...
keywords: ["ms-COM-ObjectId attribute AD Schema", "msCOM-ObjectId attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-COM-ObjectId
...
# ms-COM-ObjectId attribute

GUID used to identify a COM+ Partition or a COM+ PartitionSet.
...
| Classes used in        | [**ms-COM-Partition**](c-mscom-partition.md)<br/> [**ms-COM-PartitionSet**](c-mscom-partitionset.md)<br/> |
