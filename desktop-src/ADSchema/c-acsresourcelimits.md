...
keywords: ["ACS-Resource-Limits class AD Schema", "aCSResourceLimits class AD Schema"]
topic_type:
- apiref
api_name:
- ACS-Resource-Limits
...
# ACS-Resource-Limits class

Contains reservable resources limits for a subnet. These limits can be for each ACS service type or for all service types.
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-Bandwidth**](a-acsallocablersvpbandwidth.md)       | False     | **ACS-Resource-Limits**         |
| [**ACS-Max-Peak-Bandwidth**](a-acsmaxpeakbandwidth.md)                   | False     | **ACS-Resource-Limits**         |
| [**ACS-Max-Peak-Bandwidth-Per-Flow**](a-acsmaxpeakbandwidthperflow.md)   | False     | **ACS-Resource-Limits**         |
| [**ACS-Max-Token-Rate-Per-Flow**](a-acsmaxtokenrateperflow.md)           | False     | **ACS-Resource-Limits**         |
| [**ACS-Service-Type**](a-acsservicetype.md)                              | False     | **ACS-Resource-Limits**         |
