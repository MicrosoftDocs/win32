...
keywords: ["IndexedScopes attribute AD Schema", "indexedScopes attribute AD Schema"]
topic_type:
- apiref
api_name:
- IndexedScopes
...
# IndexedScopes attribute

List of directory scopes (for example, C:\\ or D:\) that are indexed.
...
| Classes used in        | [**Index-Server-Catalog**](c-indexservercatalog.md)<br/> |
