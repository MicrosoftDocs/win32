...
keywords: ["ms-DS-NC-Type attribute AD Schema", "msDS-NcType attribute AD Schema"]
topic_type:
- apiref
api_name:
- ms-DS-NC-Type
...
# ms-DS-NC-Type attribute

A bitfield that maintains information about aspects of an NC replica that is relevant to replication.
