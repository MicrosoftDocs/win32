---
title: ms-WMI-Rule class
description: Defines a single rule in a SOM.
audience: developer
...
keywords: ["ms-WMI-Rule class AD Schema", "msWMI-Rule class AD Schema"]
topic_type:
- apiref
api_name:
- ms-WMI-Rule
...
Defines a single rule in a SOM.
...
| Possible Superiors          | [**Container**](c-container.md)[**ms-WMI-Som**](c-mswmi-som.md)                            |
| Auxiliary Classes           | \-                                                                                           |
