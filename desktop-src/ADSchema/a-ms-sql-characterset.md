...
keywords: ["MS-SQL-CharacterSet attribute AD Schema", "mS-SQL-CharacterSet attribute AD Schema"]
topic_type:
- apiref
api_name:
- MS-SQL-CharacterSet
...
# MS-SQL-CharacterSet attribute

The character set for the current instance of SQL Server.
