---
title: ms-WMI-RangeParam class
description: Range parameter class that is the basis of the PolicyTemplate.
audience: developer
...
keywords: ["ms-WMI-RangeParam class AD Schema", "msWMI-RangeParam class AD Schema"]
topic_type:
- apiref
api_name:
- ms-WMI-RangeParam
...
# ms-WMI-RangeParam class

Range parameter class that is the basis of the PolicyTemplate. It describes one mergeable property of the target. Each subclass implements a specific type. Implements merge method to support merging. Implements a resolve method to generate the final target property.
...
| Ldap-Display-Name | msWMI-RangeParam                     |
| Update Privilege  | \-                                   |
| Update Frequency  | \-                                   |
| Schema-Id-Guid    | 45fb5a57-5018-4d0f-9056-997c8c9122d9 |
...
| [**ms-WMI-PropertyName**](a-mswmi-propertyname.md)                         | True      | **ms-WMI-RangeParam**           |
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | True      | **ms-WMI-RangeParam**           |
| [**ms-WMI-TargetType**](a-mswmi-targettype.md)                             | True      | **ms-WMI-RangeParam**           |
