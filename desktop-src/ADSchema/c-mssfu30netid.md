---
title: msSFU-30-Net-Id class
description: Used to store the network ID.
audience: developer
...
keywords: ["msSFU-30-Net-Id class AD Schema", "msSFU30NetId class AD Schema"]
topic_type:
- apiref
api_name:
- msSFU-30-Net-Id
...
# msSFU-30-Net-Id class

Used to store the network ID.
...
| [**msSFU-30-Nis-Domain**](a-mssfu30nisdomain.md)                           | False     | **msSFU-30-Net-Id**             |
