...
keywords: ["ACS-Enable-RSVP-Accounting attribute AD Schema", "aCSEnableRSVPAccounting attribute AD Schema"]
topic_type:
- apiref
api_name:
...
# ACS-Enable-RSVP-Accounting attribute

True if RSVP accounting is enabled.
