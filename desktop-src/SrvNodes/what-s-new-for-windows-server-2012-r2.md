...
-   [iSCSI Target Server](https://docs.microsoft.com/previous-versions/windows/win32/iscsitarg/iscsi-software-target-api-portal)
...
-   [Mobile Device Management Registration](/windows/win32/MDMReg/mobile-device-management-registration-portal)
...
-   [Windows Clustering](https://docs.microsoft.com/previous-versions/windows/win32/mscs/windows-clustering)
...
-   [User Access Logging](https://docs.microsoft.com/previous-versions/windows/win32/ual/user-access-logging)
...
-   [Windows Management Infrastructure](https://docs.microsoft.com/previous-versions/windows/win32/wmi_v2/what-s-new-in-mi)
...
-   [NFS Provider for WMI](https://docs.microsoft.com/previous-versions/windows/win32/nfswmi/wmi-provider-for-nfs-portal)
...
-   [Offline Files](/windows/win32/DevNotes/offline-files)

    The Offline Files API allows applications to control and monitor the behavior of Offline Files programmatically. Windows Server 2012 adds the [**OfflineFilesQueryStatusEx**](https://docs.microsoft.com/previous-versions/windows/win32/api/cscapi/nf-cscapi-offlinefilesquerystatusex), [**OfflineFilesStart**](https://docs.microsoft.com/previous-versions/windows/win32/api/cscapi/nf-cscapi-offlinefilesstart) and [**RenameItem**](https://docs.microsoft.com/previous-versions/windows/win32/offlinefiles/win32-offlinefilescache-renameitem) functions.

-   [SMB Management](https://docs.microsoft.com/previous-versions/windows/win32/smb/smb-management-api-portal)

    **New!** The SMB Management API provides WMI classes and methods to manage shares and share access.

-   [Server Core](https://docs.microsoft.com/previous-versions/windows/win32/legacy/hh846323(v=vs.85))
...
-   [Windows Server Backup](https://docs.microsoft.com/previous-versions/windows/win32/wsb/windows-server-backup-portal)
...
-   [Windows Desktop Sharing](https://docs.microsoft.com/previous-versions/windows/win32/rdp/rdp-portal)
...
-   [Remote Desktop Services](/windows/win32/TermServ/terminal-services-portal)
...
-   [Management OData](https://docs.microsoft.com/powershell/scripting/developer/webservices/creating-a-management-odata-web-service?view=powershell-7)
