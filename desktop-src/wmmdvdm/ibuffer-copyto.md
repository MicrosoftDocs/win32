...
keywords: ["CopyTo method Windows Movie Maker and DVD Maker", "CopyTo method Windows Movie Maker and DVD Maker , IBuffer interface", "IBuffer interface Windows Movie Maker and DVD Maker , CopyTo method"]
topic_type:
- apiref
api_name:
- IBuffer.CopyTo
