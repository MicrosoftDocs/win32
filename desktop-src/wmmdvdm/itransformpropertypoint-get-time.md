...
keywords:
- get_Time method Windows Movie Maker and DVD Maker
- get_Time method Windows Movie Maker and DVD Maker , ITransformPropertyPoint interface
- ITransformPropertyPoint interface Windows Movie Maker and DVD Maker , get_Time method
topic_type:
- apiref
api_name:
