...
keywords:
- get_Monitor method Windows Movie Maker and DVD Maker
- get_Monitor method Windows Movie Maker and DVD Maker , ISurfaceManager interface
- ISurfaceManager interface Windows Movie Maker and DVD Maker , get_Monitor method
topic_type:
- apiref
api_name:
