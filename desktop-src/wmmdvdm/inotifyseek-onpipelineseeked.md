...
keywords: ["OnPipelineSeeked method Windows Movie Maker and DVD Maker", "OnPipelineSeeked method Windows Movie Maker and DVD Maker , INotifySeek interface", "INotifySeek interface Windows Movie Maker and DVD Maker , OnPipelineSeeked method"]
topic_type:
- apiref
api_name:
