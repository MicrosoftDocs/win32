...
keywords: ["get_Flags method Windows Movie Maker and DVD Maker", "get_Flags method Windows Movie Maker and DVD Maker , IBuffer interface", "IBuffer interface Windows Movie Maker and DVD Maker , get_Flags method"]
topic_type:
- apiref
api_name:
- IBuffer.get_Flags
