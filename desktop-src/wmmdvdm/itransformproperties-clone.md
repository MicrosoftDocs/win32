...
keywords: ["Clone method Windows Movie Maker and DVD Maker", "Clone method Windows Movie Maker and DVD Maker , ITransformProperties interface", "ITransformProperties interface Windows Movie Maker and DVD Maker , Clone method"]
topic_type:
- apiref
api_name:
