...
Specifies the properties of the text media node.
...
The [**ExitDuration**](exitduration.md), [**ExitEffect**](exiteffect.md), and [**ExitPosition**](exitposition.md) elements are optional.
