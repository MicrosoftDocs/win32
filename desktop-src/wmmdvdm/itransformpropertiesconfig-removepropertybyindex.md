...
keywords: ["RemovePropertyByIndex method Windows Movie Maker and DVD Maker", "RemovePropertyByIndex method Windows Movie Maker and DVD Maker , ITransformPropertiesConfig interface", "ITransformPropertiesConfig interface Windows Movie Maker and DVD Maker , RemovePropertyByIndex method"]
topic_type:
- apiref
api_name:
