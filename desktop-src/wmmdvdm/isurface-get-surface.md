...
keywords:
- get_Surface method Windows Movie Maker and DVD Maker
- get_Surface method Windows Movie Maker and DVD Maker , ISurface interface
- ISurface interface Windows Movie Maker and DVD Maker , get_Surface method
topic_type:
- apiref
api_name:
