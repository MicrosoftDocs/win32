...
keywords:
- get_Device method Windows Movie Maker and DVD Maker
- get_Device method Windows Movie Maker and DVD Maker , ISurfaceManager interface
- ISurfaceManager interface Windows Movie Maker and DVD Maker , get_Device method
topic_type:
- apiref
api_name:
