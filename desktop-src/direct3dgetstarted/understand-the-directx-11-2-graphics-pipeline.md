...
The first four processes typically use the [**ID3D11Device**](https://msdn.microsoft.com/library/windows/desktop/dn280493) interface methods for initializing and managing graphics resources, and the last two use the [**ID3D11DeviceContext**](https://msdn.microsoft.com/library/windows/desktop/dn280498) interface methods to manage and execute the graphics pipeline.
...
-   **CreateDeviceDependentResources**: Called whenever the scene must be initialized or restarted. This method loads your initial vertex data, textures, shaders, and other resources, and constructs the initial constant and vertex buffers. Typically, most of the work here is done with [**ID3D11Device**](https://msdn.microsoft.com/library/windows/desktop/dn280493) methods, not [**ID3D11DeviceContext**](https://msdn.microsoft.com/library/windows/desktop/dn280498) methods.
