...
You can also register a message alias by calling the [**NetMessageNameAdd**](netmessagenameadd.md) function. A *message name table* contains a list of registered message aliases (users and applications) permitted to receive messages. The aliases registered in the message name table are case insensitive.
...
-   [**MSG\_INFO\_0**](msg-info-0-str.md)
-   [**MSG\_INFO\_1**](msg-info-1-str.md)
