...
-   [Distributed File System (Dfs) functions](https://msdn.microsoft.com/library/bb524801)
...
-   [Statistics functions](https://msdn.microsoft.com/library/windows/desktop/bb525411)
