...
keywords: ["CreateInstanceFromPropertyData method DNS", "CreateInstanceFromPropertyData method DNS , MicrosoftDNS_CNAMEType class", "MicrosoftDNS_CNAMEType class DNS , CreateInstanceFromPropertyData method"]
topic_type:
- apiref
api_name:
...
# CreateInstanceFromPropertyData method of the MicrosoftDNS\_CNAMEType class

The **CreateInstanceFromPropertyData** method instantiates a Canonical Name (CNAME) Resource Record.
