...
The uppermost domain in a hierarchical name space such as the DNS name space is called the [*root*](https://www.bing.com/search?q=*root*). The root, which is defined as " " (nothing) or more accurately "." (a dot), is the base at which any entire-domain-tree search must be initiated.
