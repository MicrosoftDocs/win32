...
keywords: ["About Domain Name System DNS", "Domain Name System DNS , about", "Domain Name System DNS , described"]
---
...
All functions that require this convention clearly state this requirement within the first few sentences of their function definition. Use the proper function name; for example, you cannot simply call [**DnsQuery**](dnsquery.md) instead of DnsQuery\_A.
