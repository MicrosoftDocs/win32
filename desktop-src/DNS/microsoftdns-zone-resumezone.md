...
keywords: ["ResumeZone method DNS", "ResumeZone method DNS , MicrosoftDNS_Zone class", "MicrosoftDNS_Zone class DNS , ResumeZone method"]
topic_type:
- apiref
api_name:
...
# ResumeZone method of the MicrosoftDNS\_Zone class

The **ResumeZone** method resumes the DNS Zone.
