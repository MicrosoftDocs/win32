...
keywords: ["GetDistinguishedName method DNS", "GetDistinguishedName method DNS , MicrosoftDNS_RootHints class", "MicrosoftDNS_RootHints class DNS , GetDistinguishedName method"]
topic_type:
- apiref
api_name:
