...
keywords: ["CreateInstanceFromPropertyData method DNS", "CreateInstanceFromPropertyData method DNS , MicrosoftDNS_NXTType class", "MicrosoftDNS_NXTType class DNS , CreateInstanceFromPropertyData method"]
topic_type:
- apiref
api_name:
...
# CreateInstanceFromPropertyData method of the MicrosoftDNS\_NXTType class

The **CreateInstanceFromPropertyData** method instantiates a Next (NXT) Resource Record.
