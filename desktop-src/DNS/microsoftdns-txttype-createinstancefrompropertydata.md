...
keywords: ["CreateInstanceFromPropertyData method DNS", "CreateInstanceFromPropertyData method DNS , MicrosoftDNS_TXTType class", "MicrosoftDNS_TXTType class DNS , CreateInstanceFromPropertyData method"]
topic_type:
- apiref
api_name:
...
# CreateInstanceFromPropertyData method of the MicrosoftDNS\_TXTType class

The **CreateInstanceFromPropertyData** method instantiates a Text (TXT) Resource Record.
