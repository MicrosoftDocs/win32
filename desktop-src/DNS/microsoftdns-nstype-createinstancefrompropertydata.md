...
keywords: ["CreateInstanceFromPropertyData method DNS", "CreateInstanceFromPropertyData method DNS , MicrosoftDNS_NSType class", "MicrosoftDNS_NSType class DNS , CreateInstanceFromPropertyData method"]
topic_type:
- apiref
api_name:
