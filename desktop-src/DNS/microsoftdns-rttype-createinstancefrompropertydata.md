...
keywords: ["CreateInstanceFromPropertyData method DNS", "CreateInstanceFromPropertyData method DNS , MicrosoftDNS_RTType class", "MicrosoftDNS_RTType class DNS , CreateInstanceFromPropertyData method"]
topic_type:
- apiref
api_name:
