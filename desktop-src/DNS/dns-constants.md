...
| DNS\_QUERY\_BYPASS\_CACHE               | 0x00000008 | Bypasses the [*resolver*](https://www.bing.com/search?q=*resolver*) cache on the lookup.                                                                                                                                                                                                                                                                                                                                                                            |
...
| DNS\_QUERY\_ADDRCONFIG                  | 0x00002000 | Windows 7 only: Do not send [**A**](/windows/desktop/api/Windns/ns-windns-__unnamed_struct_2) type queries if IPv4 addresses are not available on an interface and do not send [**AAAA**](/windows/desktop/api/Windns/ns-windns-__unnamed_struct_15) type queries if IPv6 addresses are not available.                                                                                                                                                                                                                                   |
| DNS\_QUERY\_DUAL\_ADDR                  | 0x00004000 | Windows 7 only: Query both [**AAAA**](/windows/desktop/api/Windns/ns-windns-__unnamed_struct_15) and [**A**](/windows/desktop/api/Windns/ns-windns-__unnamed_struct_2) type records and return results for each. Results for **A** type records are mapped into **AAAA** type.                                                                                                                                                                                                                                                           |
