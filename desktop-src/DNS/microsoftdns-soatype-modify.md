...
SOA serial number representing the number of times the zone has been updated, used by [*secondary servers*](https://www.bing.com/search?q=*secondary servers*) to determine whether zone transfer is necessary.
