...
<td>The headers and libraries for [Direct3D](direct3d.md) and other Windows graphics APIs, like [Direct2D](direct2d.direct2d_portal.xml), are available in the Windows SDK. <br/>
<blockquote>
[!Note]<br />
...
<td>The [HLSL](direct3dhlsl.dx_graphics_hlsl) compiler is a tool in the appropriate architecture subdirectory under the bin folder in the Windows SDK.<br/>
<blockquote>
[!Note]<br />
...
<td>A replacement for the PIX for Windows tool is now a feature in Microsoft Visual Studio, called Visual Studio Graphics Debugger. This new feature has greatly improved usability, support for Windows 8, and Direct3D 11.1, and integration with traditional Microsoft Visual Studio features such as call stacks and debugging windows for [HLSL](direct3dhlsl.dx_graphics_hlsl) debugging. For more info about this new feature, see [Debugging DirectX Graphics](http://msdn.microsoft.com/en-us/library/hh315751.aspx).<br/></td>
</tr>
<tr class="even">
<td><span id="XAudio2_for_"></span><span id="xaudio2_for_"></span><span id="XAUDIO2_FOR_"></span>[XAudio2](87557bb3-9d92-c85e-4e7a-d21af03db624) for Windows<br/></td>
<td>The [XAudio2](87557bb3-9d92-c85e-4e7a-d21af03db624) API is now a system component in Windows 8. The headers and libraries for XAudio2 are available in the Windows SDK.<br/></td>
</tr>
<tr class="odd">
<td><span id="XInput_for_"></span><span id="xinput_for_"></span><span id="XINPUT_FOR_"></span>[XInput](fbbc651b-9264-9b5d-01c6-efc58f50b19d) for Windows<br/></td>
<td>The [XInput](fbbc651b-9264-9b5d-01c6-efc58f50b19d) API is now a system component in Windows 8. The headers and libraries for XInput are available in the Windows SDK.<br/></td>
</tr>
<tr class="even">
<td><span id="XNAMATH"></span><span id="xnamath"></span>XNAMATH<br/></td>
<td>The most recent version of XNAMATH, which is updated for Windows 8, is now [DirectXMath](719954bf-0d7d-f647-2d3f-a77d87df204e). The headers for DirectXMath are available in the Windows SDK.<br/></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><span id="Games_Explorer_and_GDFMAKER"></span><span id="games_explorer_and_gdfmaker"></span><span id="GAMES_EXPLORER_AND_GDFMAKER"></span>[Games Explorer](e01f5313-be50-4d12-8a8f-816d45878e5c) and GDFMAKER<br/></td>
<td>The [Games Explorer](e01f5313-be50-4d12-8a8f-816d45878e5c) API presents games to users of Windows. The Games Explorer API is supported only on Windows Vista and Windows 7. Use the Games Definition File Maker tool (GDFMAKER.EXE) to declare game ratings for Windows Store apps. <br/> The Game Definition File Maker tool (GDFMaker.exe) is included in the x86 subdirectory under the bin folder in the Windows SDK, and supports both Windows Store apps and Win32 desktop applications.<br/>
<blockquote>
[!Note]<br />
...
5.  D3DX is not considered the canonical API for using Direct3D in Windows 8 and later and therefore isn't included with the corresponding Windows SDK. Investigate alternate solutions for working with the Direct3D API. For legacy projects, such as the Windows 7 (and earlier) DirectX SDK samples, the following steps are necessary to build applications with D3DX using the DirectX SDK:
    ...
    5.  Be aware that replacement technologies for current uses of D3DX11 include [DirectXTex](http://go.microsoft.com/fwlink/p/?linkid=248926) and [DirectXTK](http://blogs.msdn.com/b/chuckw/archive/2012/03/02/directxtk.aspx). D3DXMath is replaced by [DirectXMath](dxmath.directxmath_portal).
