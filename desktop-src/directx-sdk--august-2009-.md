...
|--------------------|-------------|
| Windows Graphics Components<br> | The headers and libraries for [Direct3D](/windows/desktop/direct3d) and other Windows graphics APIs, like [Direct2D](/windows/desktop/Direct2D/direct2d-portal), are available in the Windows SDK. <br> **Note:** The deprecated D3DX9/D3DX10/D3DX11 utility libraries are available via [NuGet](https://www.nuget.org/packages/Microsoft.DXSDK.D3DX), but there are also a number of [open source alternatives](https://walbourn.github.io/living-without-d3dx/). The D3DCSX DirectCompute utility library and redistributable DLL is available in the Windows SDK. D3DX12 is available on [GitHub](https://github.com/microsoft/DirectX-Headers).<br> | 
| HLSL compiler (FXC.EXE)<br> | The [HLSL](/windows/desktop/direct3dhlsl/dx-graphics-hlsl) compiler is a tool in the appropriate architecture subdirectory under the bin folder in the Windows SDK.<br> **Note:** The D3DCompiler API and redistributable DLL is available in the Windows SDK.<br>For DirectX 12 development, use the DXCompiler in the Windows SDK and hosted on [GitHub](https://github.com/Microsoft/DirectXShaderCompiler).<br> | 
...
| [XInput](/windows/desktop/xinput/xinput-game-controller-apis-portal) for Windows<br> | The [XInput](/windows/desktop/xinput/xinput-game-controller-apis-portal) 1.4 API is now a system component in Windows 11, Windows 10, and Windows 8.x. The headers and libraries for XInput are available in the Windows SDK.<br> **Note:** Legacy XInput 9.1.0 is also available as part of Windows 7 or later.<br> | 
