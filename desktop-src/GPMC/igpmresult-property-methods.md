...
keywords: ["IGPMResult Property Methods GPMC"]
topic_type:
- apiref
api_name:
...
The property methods of the [**IGPMResult**](igpmresult.md) interface get the properties described in the following table. For a general discussion of property methods, see [**Interface Property Methods**](https://msdn.microsoft.com/library/aa746378) in the ADSI documentation .
...
For calls to the [**IGPMGPO::Backup**](igpmgpo-backup.md) method, the result is a pointer to an [**IGPMBackup**](igpmbackup.md) interface. For calls to [**IGPMDomain::RestoreGPO**](igpmdomain-restoregpo.md), [**IGPMGPO::Import**](igpmgpo-import.md), and [**IGPMGPO::CopyTo**](igpmgpo-copyto.md), the result is a pointer to an [**IGPMGPO**](igpmgpo.md) interface.
...
Returns a reference to the [**GPMStatusMsgCollection**](igpmstatusmsgcollection.md) object.
