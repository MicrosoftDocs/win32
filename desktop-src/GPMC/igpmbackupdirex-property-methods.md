...
The value that specifies whether the specified backup is a GPO backup [**GPMBackup**](/windows/previous-versions/Gpmgmt/nn-gpmgmt-igpmbackup?branch=master) or a Starter GPO backup **GPMStarterGPOBackup**.
