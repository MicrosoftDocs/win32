...
The property methods of the [**IGPMGPOLink**](/previous-versions/windows/desktop/api/Gpmgmt/nn-gpmgmt-igpmgpolink) interface get and set the properties described in the following table. For a general discussion of property methods, see [**Interface Property Methods**](https://msdn.microsoft.com/library/aa746378) in the ADSI documentation.
...
Returns a reference to the [**GPMSOM**](/previous-versions/windows/desktop/api/Gpmgmt/nn-gpmgmt-igpmsom) object to which the GPO link is attached.
