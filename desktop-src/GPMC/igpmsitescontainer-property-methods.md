...
keywords:
- IGPMSitesContainer Property Methods GPMC
topic_type:
- apiref
api_name:
...
The property methods of the [**IGPMSitesContainer**](/previous-versions/windows/desktop/api/Gpmgmt/nn-gpmgmt-igpmsitescontainer) interface get the properties described in the following table. For a general discussion of property methods, see [**Interface Property Methods**](https://msdn.microsoft.com/library/aa746378) in the ADSI documentation .
...
Full DNS name of the forest in which the [**GPMSitesContainer**](/previous-versions/windows/desktop/api/Gpmgmt/nn-gpmgmt-igpmsitescontainer) resides; this is the name of the forest root domain.
