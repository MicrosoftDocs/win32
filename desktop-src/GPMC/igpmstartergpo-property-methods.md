...
The property methods of the [**IGPMStarterGPO**](/previous-versions/windows/desktop/api/Gpmgmt/nn-gpmgmt-igpmstartergpo) interface get and set the properties described in the following table. For a general discussion of property methods, see [Interface Property Methods](https://msdn.microsoft.com/library/aa746378) in the ADSI documentation.
