...
-   Reservation 1: http://+:80/vroot/subdir/ for User A and User C. This reservation is placed in the "+" bucket.
-   Reservation 2: http://adatum.com:80/vroot/ for User B. This reservation is placed in the "Explicit Host" bucket.
-   Registration: http://+:80/vroot/subdir/ by User B fails due to reservation 1.
-   Registration: http://adatum.com:80/vroot/subdir/ by User B succeeds due to reservation 2.
-   Registration: http://adatum.com:80/vroot/subdir/ by User C fails due to the more explicit reservation 2. The strong wildcard reservation does not have meaning within the context of the explicit reservation or registration.
