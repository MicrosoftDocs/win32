...
Handle to the DirectDraw surface to be created for Direct3D. These handles are unique within each different [**DD\_DIRECTDRAW\_LOCAL**](ddstrcts_2df3e80e-6d5d-4d81-9ae8-d92b7c7c74eb.xml) structure.
...
Handle to a [**DD\_CREATESURFACEEXDATA**](d3dstrct_221c1055-03a3-4b43-bef4-8b0fbd6eb45e.xml) structure that contains the information required for the driver to create the surface.
