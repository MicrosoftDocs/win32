...
Handle to the DirectDraw surface to be created for Direct3D. These handles are unique within each different [**DD\_DIRECTDRAW\_LOCAL**](https://www.bing.com/search?q=**DD\_DIRECTDRAW\_LOCAL**) structure.
...
Handle to a [**DD\_CREATESURFACEEXDATA**](https://www.bing.com/search?q=**DD\_CREATESURFACEEXDATA**) structure that contains the information required for the driver to create the surface.
