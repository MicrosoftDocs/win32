...
Pointer to a [**DD\_MOTIONCOMP\_LOCAL**](https://www.bing.com/search?q=**DD\_MOTIONCOMP\_LOCAL**) structure that contains a description of the motion compensation being requested.
...
Pointer to a [**DD\_QUERYMOCOMPSTATUSDATA**](https://www.bing.com/search?q=**DD\_QUERYMOCOMPSTATUSDATA**) structure that contains the information needed to query the status.
