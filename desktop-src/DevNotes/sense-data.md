...
For more information about the sense data format, see [SCSI Request Sense Command](http://en.wikipedia.org/wiki/SCSI_Request_Sense_Command) (http://en.wikipedia.org/wiki/SCSI\_Request\_Sense\_Command).
