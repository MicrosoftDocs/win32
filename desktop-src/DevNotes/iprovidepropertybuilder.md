...
The **IProvidePropertyBuilder:IUnknown** interface inherits from the [**IUnknown**](com.iunknown) interface. **IProvidePropertyBuilder** also has these types of members:
