...
Handle to a [**DD\_DIRECTDRAW\_GLOBAL**](https://www.bing.com/search?q=**DD\_DIRECTDRAW\_GLOBAL**) structure that represents the driver.
...
Pointer to a [**DD\_GETSCANLINEDATA**](https://www.bing.com/search?q=**DD\_GETSCANLINEDATA**) structure in which the driver returns the number of the current scan line.
