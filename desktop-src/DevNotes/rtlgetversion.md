...
Pointer to either a [**RTL\_OSVERSIONINFOW**](https://www.bing.com/search?q=**RTL\_OSVERSIONINFOW**) structure or a [**RTL\_OSVERSIONINFOEXW**](https://www.bing.com/search?q=**RTL\_OSVERSIONINFOEXW**) structure that contains the version information about the currently running operating system. A caller specifies which input structure is used by setting the **dwOSVersionInfoSize** member of the structure to the size in bytes of the structure that is used.
...
**RtlGetVersion** is the equivalent of the [**GetVersionEx**](https://msdn.microsoft.com/windows/desktop/8e3ab4d6-bacd-4bc5-b8f6-dd49289354de) function in the Windows SDK. See the example in the Windows SDK that shows how to get the system version.
...
[**PsGetVersion**](https://www.bing.com/search?q=**PsGetVersion**)
</dt> </dl>
