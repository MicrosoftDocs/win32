...
Pointer to either a [**RTL\_OSVERSIONINFOW**](https://msdn.microsoft.com/library/Ff563624(v=VS.85).aspx) structure or a [**RTL\_OSVERSIONINFOEXW**](https://msdn.microsoft.com/library/Ff563620(v=VS.85).aspx) structure that contains the version information about the currently running operating system. A caller specifies which input structure is used by setting the **dwOSVersionInfoSize** member of the structure to the size in bytes of the structure that is used.
...
**RtlGetVersion** is the equivalent of the [**GetVersionEx**](https://msdn.microsoft.com/library/ms724451(v=VS.85).aspx) function in the Windows SDK. See the example in the Windows SDK that shows how to get the system version.
...
[**PsGetVersion**](https://msdn.microsoft.com/library/Ff559941(v=VS.85).aspx)
</dt> </dl>
