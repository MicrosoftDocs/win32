...
An [**ACCESS\_MASK**](https://msdn.microsoft.com/windows/desktop/f115ee54-3333-4109-8004-d71904a7a943) that specifies the requested access to the directory object. It is typical to use GENERIC\_READ so the handle can be passed to the [**NtQueryDirectoryObject**](ntquerydirectoryobject.md) function.
