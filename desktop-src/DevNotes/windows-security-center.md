...
In order for third party security solutions that provide real-time protection to be compliant with Windows, they are required to register and report any subsequent status changes using private APIs for communicating with Windows Security app. In turn, the app communicates these updates to the Notification Center, where they are finally displayed to the end user.
