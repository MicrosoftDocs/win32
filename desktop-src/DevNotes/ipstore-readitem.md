...
If **ReadItem** completes successfully, the application is responsible for freeing the returned data buffer using the [**CoTaskMemFree**](https://www.bing.com/search?q=**CoTaskMemFree**) function.
