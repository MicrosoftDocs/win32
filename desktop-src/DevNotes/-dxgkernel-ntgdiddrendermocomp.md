...
Handle to a [**DD\_MOTIONCOMP\_LOCAL**](display.dd_motioncomp_local) structure that contains a description of the motion compensation being requested.
...
Pointer to a [**DD\_RENDERMOCOMPDATA**](display.dd_rendermocompdata) structure that contains the information needed to render a frame.
