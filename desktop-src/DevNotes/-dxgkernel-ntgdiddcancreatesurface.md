...
Pointer to a [**DD\_CANCREATESURFACEDATA**](https://www.bing.com/search?q=**DD\_CANCREATESURFACEDATA**) structure containing the information required for the driver to determine whether a surface can be created.
