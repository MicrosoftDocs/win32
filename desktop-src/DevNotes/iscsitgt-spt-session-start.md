...
Used with the [**IOCTL\_SCSI\_MINIPORT**](https://www.bing.com/search?q=**IOCTL\_SCSI\_MINIPORT**) IOCTL and the CTLCODE\_ISCSITGT\_SPT\_SESSION\_START (0x100) control code to start a session.
