...
Used with the [**IOCTL\_SCSI\_MINIPORT**](storage.ioctl_scsi_miniport) IOCTL and the CTLCODE\_ISCSITGT\_SPT\_SESSION\_START (0x100) control code to start a session.
...
[**SRB\_IO\_CONTROL**](storage.srb_io_control)
</dt> </dl>
