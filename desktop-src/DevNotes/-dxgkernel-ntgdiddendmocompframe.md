...
Handle to a [DD\_MOTIONCOMP\_LOCAL](http://msdn.microsoft.com/en-us/library/ms794211.aspx) structure that contains a description of the motion compensation being requested.
...
Pointer to a [DD\_ENDMOCOMPFRAMEDATA](http://msdn.microsoft.com/en-us/library/ms793897.aspx) structure that contains the information needed to complete the decoded frame.
