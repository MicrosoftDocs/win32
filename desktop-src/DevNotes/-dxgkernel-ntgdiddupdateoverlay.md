...
Handle to a [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure that describes the overlay surface.
...
Pointer to a [**DD\_UPDATEOVERLAYDATA**](https://www.bing.com/search?q=**DD\_UPDATEOVERLAYDATA**) structure that contains the information required to update the overlay.
