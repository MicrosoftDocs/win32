...
A pointer to an [OBJECT\_ATTRIBUTES](http://go.microsoft.com/fwlink/p/?linkid=85317) structure that supplies the attributes to be used for the file object.
...
A pointer to a [FILE\_BASIC\_INFORMATION](http://go.microsoft.com/fwlink/p/?linkid=119327) structure to receive the returned file attribute information.
