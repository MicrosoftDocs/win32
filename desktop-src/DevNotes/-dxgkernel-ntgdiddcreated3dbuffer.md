...
Pointer to a [**DDSURFACEDESC**](d6656bae-9f90-497b-82d5-be4be3213687) structure describing the surface or buffer that the driver should create.
...
Pointer to a [**DD\_SURFACE\_GLOBAL**](11e0a6b9-16b9-4fc3-8e17-776f56c12196) structure containing surface data that is shared globally with multiple surfaces.
...
Pointer to a list of [**DD\_SURFACE\_LOCAL**](45a41cec-0257-4e26-809d-c2fc4c247328) structures describing the surface objects created by the driver. There is usually only one entry in this array.
...
Pointer to a [**DD\_CREATESURFACEDATA**](5a3b4267-43b4-44dc-abad-cb3f3d07f30e) structure that contains the information required to create the buffer.
