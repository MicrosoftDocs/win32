...
Handle to a [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure that describes the surface to be unlocked.
...
Pointer to a [**DD\_UNLOCKDATA**](https://www.bing.com/search?q=**DD\_UNLOCKDATA**) structure that contains the information required to perform the lock release.
