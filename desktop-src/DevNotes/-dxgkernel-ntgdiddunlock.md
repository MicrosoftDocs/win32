...
Handle to a [**DD\_SURFACE\_LOCAL**](ddstrcts_07a504fc-c8bb-4b48-b825-4da3012e4f95.xml) structure that describes the surface to be unlocked.
...
Pointer to a [**DD\_UNLOCKDATA**](ddstrcts_1784fe3c-5a41-4428-ac94-06226857ae9a.xml) structure that contains the information required to perform the lock release.
