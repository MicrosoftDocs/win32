...
Pointer to a [**DD\_BEGINMOCOMPFRAMEDATA**](https://www.bing.com/search?q=**DD\_BEGINMOCOMPFRAMEDATA**) structure that contains the information needed to start decoding a new frame.
