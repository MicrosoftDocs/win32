...
# NtGdiDdGetMoCompFormats function
...
Pointer to a [**DD\_GETMOCOMPFORMATSDATA**](https://www.bing.com/search?q=**DD\_GETMOCOMPFORMATSDATA**) structure that contains the uncompressed format information for the hardware.

</dd> </dl>

## Return value

**NtGdiDdGetMoCompFormats** returns one of the following callback codes.
