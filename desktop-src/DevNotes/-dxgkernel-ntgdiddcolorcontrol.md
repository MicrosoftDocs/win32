...
Handle to the [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure representing the overlay surface.
...
Pointer to a [**DD\_COLORCONTROLDATA**](https://www.bing.com/search?q=**DD\_COLORCONTROLDATA**) structure that contains the color control information for a specified overlay surface.
