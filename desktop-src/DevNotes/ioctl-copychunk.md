...
A handle to the file that is the target of the server-side copy operation. To obtain this handle, call the [**CreateFile**](base.createfile) function.
...
If the output buffer is too small, the call fails, the [**GetLastError**](base.getlasterror) function returns **ERROR\_INSUFFICIENT\_BUFFER**, and *lpBytesReturned* is zero.
