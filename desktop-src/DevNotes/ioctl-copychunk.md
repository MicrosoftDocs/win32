...
A handle to the file that is the target of the server-side copy operation. To obtain this handle, call the [**CreateFile**](https://www.bing.com/search?q=**CreateFile**) function.
...
If the output buffer is too small, the call fails, the [**GetLastError**](https://msdn.microsoft.com/windows/desktop/d852e148-985c-416f-a5a7-27b6914b45d4) function returns **ERROR\_INSUFFICIENT\_BUFFER**, and *lpBytesReturned* is zero.
