...
Destroys a previously allocated kernel-mode Microsoft DirectDraw surface object that was created with the **dwCaps** member of the [**DDSCAPS**](https://www.bing.com/search?q=**DDSCAPS**) structure set to DDSCAPS\_EXECUTEBUFFER.
...
Handle to a [**DD\_DESTROYSURFACEDATA**](https://www.bing.com/search?q=**DD\_DESTROYSURFACEDATA**) structure that contains the information needed to destroy a Direct3D command or vertex buffer.
