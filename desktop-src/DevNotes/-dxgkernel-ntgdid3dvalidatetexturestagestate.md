...
Pointer to a [**D3DNTHAL\_VALIDATETEXTURESTAGESTATEDATA**](7fe52804-1cbf-4e7a-8dd9-0c9f342a8125) structure that contains the information required for the driver to determine and return the number of passes required to perform the blending operations.
