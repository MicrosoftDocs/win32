...
Pointer to a [**D3DNTHAL\_VALIDATETEXTURESTAGESTATEDATA**](d3dstrct_ec3a38f0-8f36-4d40-9974-ba434f0aa42e.xml) structure that contains the information required for the driver to determine and return the number of passes required to perform the blending operations.
