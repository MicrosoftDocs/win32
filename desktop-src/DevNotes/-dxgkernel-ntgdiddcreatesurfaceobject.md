...
Pointer to the [**DD\_SURFACE\_LOCAL**](ddstrcts_07a504fc-c8bb-4b48-b825-4da3012e4f95.xml) structure that represents the DirectDraw user-mode surface object with which to associate the allocated memory. See the DDK documentation for details.
...
Pointer to the [**DD\_SURFACE\_MORE**](ddstrcts_b86749f9-edbf-4e8b-ae17-27840ad4e5d5.xml) structure that contains additional local data for each individual surface object. See the DDK documentation for details.
...
Pointer to the [**DD\_SURFACE\_GLOBAL**](ddstrcts_83ae0625-9b08-4380-bd3a-d8d67675a48b.xml) structure that contains surface data shared globally with multiple surfaces. See the DDK documentation for details.
