...
Queries the driver for additional Microsoft DirectDraw and Microsoft Direct3D functionality that the driver supports.
...
Pointer to a [DD\_GETDRIVERINFODATA](http://msdn.microsoft.com/en-us/library/ms793868.aspx) structure that contains the information required to perform the query.

</dd> </dl>

## Return value

**NtGdiDdGetDriverInfo** returns one of the following callback codes.
