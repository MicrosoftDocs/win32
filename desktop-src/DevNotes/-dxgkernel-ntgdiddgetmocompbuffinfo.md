...
Pointer to a [**DD\_GETMOCOMPCOMPBUFFDATA**](https://www.bing.com/search?q=**DD\_GETMOCOMPCOMPBUFFDATA**) structure that contains the compressed buffer information.
