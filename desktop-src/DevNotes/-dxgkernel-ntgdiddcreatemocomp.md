...
Pointer to a [**DD\_CREATEMOCOMPDATA**](https://www.bing.com/search?q=**DD\_CREATEMOCOMPDATA**) structure that contains the information required to begin using motion compensation.
