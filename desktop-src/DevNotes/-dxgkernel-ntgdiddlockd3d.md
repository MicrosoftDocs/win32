...
Pointer to a [**DD\_SURFACE\_LOCAL**](ddstrcts_07a504fc-c8bb-4b48-b825-4da3012e4f95.xml) structure that describes the surface associated with the memory region to be locked down.
...
Pointer to a [**DD\_LOCKDATA**](ddstrcts_8de05e54-e1e1-4773-982d-e48f7e051f7e.xml) structure that contains the information required to perform the lock down.
