...
Handle to the [**DD\_DIRECTDRAW\_GLOBAL**](ddstrcts_d176c3e5-1e8b-4ff6-ba62-2fcfc42a9e5b.xml) structure representing the DirectDraw object.
...
Pointer to a [**DD\_CANCREATESURFACEDATA**](ddstrcts_53ef5031-d754-4aab-8729-520852df024a.xml) structure. This structure contains the information required for the driver to determine whether a command or vertex buffer can be created.
