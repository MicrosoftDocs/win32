...
Handle to the [**DD\_DIRECTDRAW\_GLOBAL**](https://www.bing.com/search?q=**DD\_DIRECTDRAW\_GLOBAL**) structure representing the DirectDraw object.
...
Pointer to a [**DD\_CANCREATESURFACEDATA**](https://www.bing.com/search?q=**DD\_CANCREATESURFACEDATA**) structure. This structure contains the information required for the driver to determine whether a command or vertex buffer can be created.
