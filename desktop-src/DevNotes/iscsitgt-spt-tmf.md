...
Used with the [**IOCTL\_SCSI\_MINIPORT**](storage.ioctl_scsi_miniport) IOCTL and the CTLCODE\_ISCSITGT\_SPT\_TMF (0x102) control code to invoke a task management function.
