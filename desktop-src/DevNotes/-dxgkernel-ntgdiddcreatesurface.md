...
Pointer to the [**DDSURFACEDESC**](https://www.bing.com/search?q=**DDSURFACEDESC**) structure describing the surface or buffer that the driver should create.
...
Pointer to the [**DD\_SURFACE\_GLOBAL**](https://www.bing.com/search?q=**DD\_SURFACE\_GLOBAL**) structure containing surface data that is shared globally with multiple surfaces.
...
Pointer to a list of [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structures describing the surface objects created by the driver.
...
Pointer to a [**DD\_CREATESURFACEDATA**](https://www.bing.com/search?q=**DD\_CREATESURFACEDATA**) structure that contains the information required to create a surface.
