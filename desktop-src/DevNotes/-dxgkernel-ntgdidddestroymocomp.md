...
Handle to a [**DD\_MOTIONCOMP\_LOCAL**](https://www.bing.com/search?q=**DD\_MOTIONCOMP\_LOCAL**) structure that contains a description of the motion compensation object to be destroyed.
...
Pointer to a [**DD\_DESTROYMOCOMPDATA**](https://www.bing.com/search?q=**DD\_DESTROYMOCOMPDATA**) structure that contains the information needed to finish motion compensation.
