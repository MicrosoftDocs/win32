...
A pointer to the retrieved interface pointer for the storage provider. When you finish using the interface, decrement its reference count by calling its [**IUnknown::Release**](_com_iunknown_release) method. This parameter cannot be **NULL**.
...
This function has no associated import library; you must call it using the [**LoadLibrary**](base.loadlibrary) and [**GetProcAddress**](base.getprocaddress) functions.
...
[**CryptProtectData**](security.cryptprotectdata)
</dt> <dt>

[**CryptUnprotectData**](security.cryptunprotectdata)
</dt> </dl>
