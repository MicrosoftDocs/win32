...
The [**RtlCopyMemory**](kernel.rtlcopymemory) routine runs faster than **RtlMoveMemory**, but **RtlCopyMemory** requires that the source and destination memory blocks do not overlap.
...
[**RtlCopyMemory**](kernel.rtlcopymemory)
</dt> </dl>
