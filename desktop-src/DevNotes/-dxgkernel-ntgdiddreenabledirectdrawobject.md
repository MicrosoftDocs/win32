...
Applications are advised to use the DirectDraw or [Direct3D](http://msdn.microsoft.com/en-us/library/bb205147(VS.85).aspx) version 8 APIs, which automate and abstract this process in a manner independent of the operating system.
