...
Parses text to identify words and provides the results to the [WordSink](https://msdn.microsoft.com/library/ms691570.aspx) object.
...
A pointer to a [TEXT\_SOURCE](https://msdn.microsoft.com/library/ms690919.aspx) structure that contains the Unicode text.
...
A pointer to the [WordSink](https://msdn.microsoft.com/library/ms691570.aspx) object that receives and handles the words generated by this method. If this parameter is **NULL**, the method does not break the string into words.
...
[TEXT\_SOURCE](https://msdn.microsoft.com/library/ms690919.aspx)
</dt> <dt>
