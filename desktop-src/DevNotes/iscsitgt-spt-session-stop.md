...
Used with the [**IOCTL\_SCSI\_MINIPORT**](storage.ioctl_scsi_miniport) IOCTL and the CTLCODE\_ISCSITGT\_SPT\_SESSION\_END (0x101) control code to stop a session.
