...
Handle to a [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure that describes the surface associated with the memory region to be locked down.
...
Pointer to a [**DD\_LOCKDATA**](https://www.bing.com/search?q=**DD\_LOCKDATA**) structure that contains the information required to perform the lockdown.
