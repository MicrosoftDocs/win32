...
Handle to a [**DD\_SURFACE\_LOCAL**](https://msdn.microsoft.com/windows/desktop/45a41cec-0257-4e26-809d-c2fc4c247328) structure that describes the surface associated with the memory region to be locked down.
...
Pointer to a [**DD\_LOCKDATA**](https://msdn.microsoft.com/windows/desktop/46de3dbb-abdf-4518-b62d-891efa5a949b) structure that contains the information required to perform the lockdown.
