...
An [**ACCESS\_MASK**](https://msdn.microsoft.com/f115ee54-3333-4109-8004-d71904a7a943) that specifies the requested access to the directory object. This parameter can be one or more of the following values.
