...
An [**ACCESS\_MASK**](security.access_mask) that specifies the requested access to the directory object. This parameter can be one or more of the following values.
