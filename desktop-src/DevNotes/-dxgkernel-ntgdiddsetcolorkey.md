...
Pointer to the [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure that describes the surface with which the color key is to be associated.
...
Pointer to a [**DD\_SETCOLORKEYDATA**](https://www.bing.com/search?q=**DD\_SETCOLORKEYDATA**) structure that contains the information required to set the color key for the specified surface.
