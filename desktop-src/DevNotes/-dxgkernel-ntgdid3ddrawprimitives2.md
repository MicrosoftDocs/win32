...
Handle to the [**DD\_SURFACE\_LOCAL**](ddstrcts_07a504fc-c8bb-4b48-b825-4da3012e4f95.xml) structure that identifies the DirectDraw surface containing the command data.
...
Handle to the [**DD\_SURFACE\_LOCAL**](ddstrcts_07a504fc-c8bb-4b48-b825-4da3012e4f95.xml) structure that identifies the DirectDraw surface containing the vertex data.
...
Pointer to a [**D3DNTHAL\_DRAWPRIMITIVES2DATA**](d3dstrct_ec3a38f0-8f36-4d40-9974-ba434f0aa42e.xml) structure that contains the information required for the driver to render one or more primitives.
