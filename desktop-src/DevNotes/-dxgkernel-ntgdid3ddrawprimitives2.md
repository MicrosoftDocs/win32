...
Handle to the [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure that identifies the DirectDraw surface containing the command data.
...
Handle to the [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure that identifies the DirectDraw surface containing the vertex data.
...
Pointer to a [**D3DNTHAL\_DRAWPRIMITIVES2DATA**](https://www.bing.com/search?q=**D3DNTHAL\_DRAWPRIMITIVES2DATA**) structure that contains the information required for the driver to render one or more primitives.
