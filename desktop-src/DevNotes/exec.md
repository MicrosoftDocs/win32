...
1.  Use the [**RegOpenKeyEx**](base.regopenkeyex) function to determine whether the Network Diagnostic is installed. If it is installed, the **{e2e2dd38-d088-4134-82b7-f2ba38496583}** key is present.
2.  Use the [**RegQueryValueEx**](base.regqueryvalueex) function to retrieve the path of the Network Diagnostic executable file from the **Exec** entry.
