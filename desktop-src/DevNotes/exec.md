...
1.  Use the [**RegOpenKeyEx**](https://msdn.microsoft.com/c8a590f2-3249-437f-a320-c7443d42b792) function to determine whether the Network Diagnostic is installed. If it is installed, the **{e2e2dd38-d088-4134-82b7-f2ba38496583}** key is present.
2.  Use the [**RegQueryValueEx**](https://msdn.microsoft.com/202d253a-10ff-40e7-8eec-a49717443b81) function to retrieve the path of the Network Diagnostic executable file from the **Exec** entry.
