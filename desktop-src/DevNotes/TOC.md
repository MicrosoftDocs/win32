...
#### [OnItemDeleted Method](https://msdn.microsoft.com/en-us/library/Hh802721(v=VS.85).aspx)
#### [OnClosed Method](https://msdn.microsoft.com/en-us/library/Hh802719(v=VS.85).aspx)
...
#### [HWND property](https://msdn.microsoft.com/en-us/library/Mt725310(v=VS.85).aspx)
#### [TheaterMode property](/windows/desktop/api/Exdisp/nf-exdisp-iwebbrowser2-get_theatermode)
#### [ToolBar property](https://msdn.microsoft.com/en-us/library/Mt725312(v=VS.85).aspx)
## [Installation](installation.md)
### [CoInstall](https://msdn.microsoft.com/en-us/library/Bb432203(v=VS.85).aspx)
#### [CSPLATFORM](https://msdn.microsoft.com/en-us/library/Bb432231(v=VS.85).aspx)
#### [QUERYCONTEXT](https://msdn.microsoft.com/en-us/library/Bb432414(v=VS.85).aspx)
#### [TYSPEC](tyspec.md)
...
##### [CACHE_READ_CALLBACK](https://msdn.microsoft.com/en-us/library/Bb432262(v=VS.85).aspx)
##### [FCACHE_CREATE_CALLBACK](https://msdn.microsoft.com/en-us/library/Bb432261(v=VS.85).aspx)
##### [FCACHE_RICHCREATE_CALLBACK](https://msdn.microsoft.com/en-us/library/Bb432263(v=VS.85).aspx)
