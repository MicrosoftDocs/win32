...
Handle to a [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure that represents the DirectDraw overlay surface.
...
Pointer to a [**DD\_SURFACE\_LOCAL**](https://www.bing.com/search?q=**DD\_SURFACE\_LOCAL**) structure representing the surface that is being overlaid.
...
Pointer to a [**DD\_SETOVERLAYPOSITIONDATA**](https://www.bing.com/search?q=**DD\_SETOVERLAYPOSITIONDATA**) structure that contains the information required to set the overlay position.
