...
A pointer to [FILETIME](https://msdn.microsoft.com/library/ms724284.aspx) structure that receives the time at which the enumerated subkey was last written. This parameter can be **NULL**.
