...
The application can also set *dwIndex* to the index of the last subkey on the first call to the function and decrement the index until the subkey with the index 0 is enumerated. To retrieve the index of the last subkey, use the [**ORQueryInfoKey**](https://msdn.microsoft.com/windows/desktop/25eb2cd2-9fdd-4d6f-8071-daab56f9aae1) function.
