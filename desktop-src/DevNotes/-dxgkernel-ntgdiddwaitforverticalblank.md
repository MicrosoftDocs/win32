...
Pointer to a [**DD\_WAITFORVERTICALBLANKDATA**](https://www.bing.com/search?q=**DD\_WAITFORVERTICALBLANKDATA**) structure that contains the information required to obtain the vertical blank status.
