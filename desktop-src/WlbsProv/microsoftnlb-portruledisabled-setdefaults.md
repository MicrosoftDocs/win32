---
title: SetDefaults method of the MicrosoftNLB\_PortRuleDisabled class
description: Resets the node's port rule configuration to the default.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '009a592f-cbe7-4cb8-a620-d1c265c2eae3'
ms.prod: 'windows-server-dev'
ms.technology:
- 'network-load-balancing'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetDefaults method", "SetDefaults method, MicrosoftNLB_PortRuleDisabled class", "MicrosoftNLB_PortRuleDisabled class, SetDefaults method"]
topic_type:
- apiref
api_name:
- MicrosoftNLB_PortRuleDisabled.SetDefaults
api_location:
- WlbsProv.dll
api_type:
- COM
...
# SetDefaults method of the MicrosoftNLB\_PortRuleDisabled class
