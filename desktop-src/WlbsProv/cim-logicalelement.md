...
description: The CIM\_LogicalElement class is the base class for all the components of the system that represent abstract system components.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '34ae7bae-6dd5-4881-8054-33d678595add'
...
The CIM\_LogicalElement class is the base class for all the components of the system that represent abstract system components.
