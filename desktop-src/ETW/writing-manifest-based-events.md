...
When you compile the manifest (see [Compiling an Instrumentation Manifest](https://msdn.microsoft.com/windows/desktop/ecb72942-08fc-470d-b4d6-f5f1a70de3fa)) that the example above uses, it creates the following header file (referenced in the example above).
