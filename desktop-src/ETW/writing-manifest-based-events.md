...
When you compile the manifest (see [Compiling an Instrumentation Manifest](wes.compiling_an_instrumentation_manifest)) that the example above uses, it creates the following header file (referenced in the example above).
