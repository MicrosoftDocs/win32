...
Context data that a consumer can specify when calling [**OpenTrace**](opentrace.md). If the consumer uses [**EventRecordCallback**](eventrecordcallback.md) to consume events, ETW sets the **UserContext** member of the [**EVENT\_RECORD**](https://msdn.microsoft.com/library/Aa363769(v=VS.85).aspx) structure to this value.
