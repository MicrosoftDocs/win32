...
If the function returns INVALID\_PROCESSTRACE\_HANDLE, you can use the [**GetLastError**](base.getlasterror) function to obtain extended error information. The following table lists some common errors and their causes.
