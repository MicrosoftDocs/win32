...
<li>The <strong>Flags</strong> member of <a href="https://docs.microsoft.com/windows/desktop/api/evntcons/ns-evntcons-_event_header"><strong>EVENT_HEADER</strong></a></li>
</ul>
