...
<li>Multiply the pointer size for the event log by 2 and add the product to the byte pointer (the <strong>PointerSize</strong> member of <a href="trace-logfile-header.md"><strong>TRACE_LOGFILE_HEADER</strong></a> contains the pointer size value)</li>
</ul>
...
<ul>
<li>The <strong>PointerSize</strong> member of <a href="trace-logfile-header.md"><strong>TRACE_LOGFILE_HEADER</strong></a></li>
