...
A [**TIME\_ZONE\_INFORMATION**](base.time_zone_information_str) structure that contains the time zone for the **BootTime**, **EndTime** and **StartTime** members.
...
[**LARGE\_INTEGER**](winprog.large_integer_str)
</dt> <dt>

[**TIME\_ZONE\_INFORMATION**](base.time_zone_information_str)
</dt> </dl>
