...
| **EVENT\_TRACE\_TYPE\_CONFIG\_NETINFO**(Event type value is 17)<br/>      | Network information event. The [**SystemConfig\_Network**](systemconfig-network.md) MOF class defines the event data for this event.                                                |
