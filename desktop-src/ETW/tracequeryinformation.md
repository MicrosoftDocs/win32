...
The information class to query. The information that the class captures is included in the extended data section of the event. For a list of information classes that you can query, see the [**TRACE\_QUERY\_INFO\_CLASS**](etw.trace_query_info_class) enumeration.
