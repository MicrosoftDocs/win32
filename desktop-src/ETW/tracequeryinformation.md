...
| <dl> <dt>**Other**</dt> </dl>                     | Use [**FormatMessage**](https://msdn.microsoft.com/windows/desktop/b9d61342-4bcf-42e9-96f1-a5993dfb6c0c) to obtain the message string for the returned error.<br/>                                                           |
