...
For information on registering event trace providers, see [**EventRegister**](/windows/desktop/api/Evntprov/nf-evntprov-eventregister) and [**RegisterTraceGuids**](registertraceguids.md).
