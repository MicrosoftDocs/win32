...
| [**TdhGetWppMessage**](/windows/desktop/api/Tdh/nf-tdh-tdhgetwppmessage)                                              | Retrieves the formatted WPP message embedded into an [**EVENT\_RECORD**](/windows/desktop/api) structure.                                                      |
