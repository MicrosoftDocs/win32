...
Values passed in the *CreateOptions* and *CreateDispositions* parameters to the [**NtCreateFile**](winprog.ntcreatefile) function.
...
Value passed in the *FileAttributes* parameter to the [**NtCreateFile**](winprog.ntcreatefile) function.
...
Value passed in the *ShareAccess* parameter to the [**NtCreateFile**](winprog.ntcreatefile) function.
