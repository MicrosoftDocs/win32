...
-   If the enable flags value is 0, call the [**GetLastError**](https://msdn.microsoft.com/windows/desktop/d852e148-985c-416f-a5a7-27b6914b45d4) function to retrieve the last known error.
