...
Pointer to an optional [**FILETIME**](base.filetime_str) structure that specifies the beginning time period for which you want to receive events. The function does not deliver events recorded prior to *StartTime*.
...
Pointer to an optional [**FILETIME**](base.filetime_str) structure that specifies the ending time period for which you want to receive events. The function does not deliver events recorded after *EndTime*.
