...
description: CIM\_LogicalElement is a base class for all the components of a System that represent abstract system components, such as Files, Processes, or system capabilities in the form of Logical Devices.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: e563c63a-c294-45ec-8b2f-629caca317d6
