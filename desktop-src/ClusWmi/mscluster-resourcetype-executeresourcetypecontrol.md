...
keywords: ["ExecuteResourceTypeControl method", "ExecuteResourceTypeControl method, MSCluster_ResourceType class", "MSCluster_ResourceType class, ExecuteResourceTypeControl method"]
topic_type:
- apiref
api_name:
