...
| [**GetLocalOffsetForDate**](/windows/desktop/api/WbemTime/) | Overloaded. Returns the offset in minutes(+ or -) between GMT and local time for the time supplied in the argument.<br/>         |
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| [**operator =**](/windows/desktop/api/WbemTime/)                                                                                                                                                                                                                                                                                                                                                                                                                       | *Assignment* operator facilitates conversions between various Windows and ANSI C run-time time formats.                           |
...
| [**operator -**](/windows/desktop/api/WbemTime/)                                                                                                                                                                                                                                                                                                                                                                                                                       | *Subtraction* operator decrements an object's time by another object's time. The result is returned in a new **WBEMTime** object. |
...
| [**operator ==**](/windows/desktop/api/WbemTime/)[**operator !=**](/windows/desktop/api/WbemTime/)<br/> [**operator &gt;**](/windows/desktop/api/WbemTime/)<br/> [**operator &gt;=**](/windows/desktop/api/WbemTime/)<br/> [**operator &lt;**](/windows/desktop/api/WbemTime/)<br/> [**operator &lt;=**](/windows/desktop/api/WbemTime/)<br/> | Comparison operators compare two **WBEMTime** objects.                                                                            |
