...
-   Using the classes in the [**Microsoft.Management.Infrastructure**](https://msdn.microsoft.com/library/hh872326) namespace in the .NET Framework to create a provider using managed code. (The **System.Management.Instrumentation** namespace is no longer supported.)
...
-   Ensure that your provider is loading properly by tracking the [**MSFT\_WmiProvider\_OperationEvent**](https://msdn.microsoft.com/library/aa392573) event notifications. These events will inform you about any provider load failures. Other troubleshooting classes that may be helpful are [**Win32\_ProcessStartTrace**](https://msdn.microsoft.com/library/aa394374) and [**Win32\_ProcessStopTrace**](https://msdn.microsoft.com/library/aa394376). For more information about troubleshooting providers, see [Debugging Providers](debugging-providers.md) and [Provider Configuration and Troubleshooting Classes](provider-configuration-and-troubleshooting-classes.md).
