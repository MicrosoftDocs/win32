...
Deleting a class or an instance is a simple procedure. However, due to the permanent nature of a class, you will probably not need to delete a class often. For example, you are unlikely to delete the [**Win32\_DiskDrive**](https://msdn.microsoft.com/library/aa394132) class, because it is unlikely that you do not have a disk drive somewhere in your enterprise. Instead, you will be more likely to delete an instance of a class. For more information, see [Deleting an Instance](deleting-an-instance.md).
