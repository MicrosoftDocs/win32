...
| [Managed Reference for WMI Windows PowerShell Command Classes](managed-reference-for-wmi-powershell-command-classes.md) | Windows PowerShell implements Windows Management Instrumentation (WMI) functionality through a set of cmdlets. You can use these cmdlets to complete the end-to-end tasks that are necessary to manage local and remote computers.<br/> See [Windows PowerShell](https://go.microsoft.com/fwlink/p/?linkid=142509) for more information.<br/> |
