...
This method is similar to [**SWbemServices.ExecMethod**](swbemservices-execmethod.md), but it operates directly on the object whose method is to be executed. For example, the following code example calls the [**StartService**](https://msdn.microsoft.com/library/aa393660) provider method in [**Win32\_Service**](https://msdn.microsoft.com/library/aa394418) and uses [direct access](manipulating-class-and-instance-information.md).
...
This version calls **SWbemObject.ExecMethod\_** to execute the [**StartService**](https://msdn.microsoft.com/library/aa393660) method.
...
The following example shows the [**ExecMethod**](swbemservices-execmethod.md) method.The script creates a [**Win32\_Process**](https://msdn.microsoft.com/library/aa394372) object representing a process running Notepad. For more information about a script illustrating the same operations performed asynchronously, see [**SWbemObject.ExecMethodAsync\_**](swbemobject-execmethodasync-.md). For an example using direct access, see [**Create Method in Class Win32\_Process**](https://msdn.microsoft.com/library/aa389388) . For an example of the same operation using an [**SWbemServices**](swbemservices.md) object, see **SWbemServices.ExecMethod**.
