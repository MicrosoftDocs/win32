...
|:----------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------|
| [**operator != (CHString, CHString)**](/windows/desktop/api/ChString/)            | Compares two **CHStrings** for inequality.<br/>                                                             |
| [**operator != (CHString, LPCWSTR)**](/windows/desktop/api/ChString/)              | Compares a **CHString** with a **LPCWSTR** for inequality.<br/>                                             |
| [**operator \[\]**](/windows/desktop/api/ChString/)                                                | Returns the character at a given position   operator substitution for [**GetAt**](/windows/desktop/api/ChString/nf-chstring-chstring-getat(int)).<br/> |
...
| [**operator &lt; (CHString, LPCWSTR)**](/windows/desktop/api/ChString/)            | Compares a **CHString** with a **LPCWSTR**.<br/>                                                            |
| [**operator &lt; (CHString, CHString)**](/windows/desktop/api/ChString/)          | Compares two **CHStrings**.<br/>                                                                            |
| [**operator &lt;= (CHString, CHString)**](/windows/desktop/api/ChString/)    | Compares two **CHStrings**.<br/>                                                                            |
| [**operator &lt;= (CHString, LPCWSTR)**](/windows/desktop/api/ChString/)      | Compares a **CHString** with a **LPCWSTR**.<br/>                                                            |
| [**operator =**](chstring--operator-equal.md)                                                      | Assigns a new value to a **CHString** string.<br/>                                                          |
| [**operator == (CHString, CHString)**](/windows/desktop/api/ChString/)          | Compares two **CHStrings** for equality.<br/>                                                               |
| [**operator == (CHString, LPCWSTR)**](/windows/desktop/api/ChString/)            | Compares a **CHString** with a **LPCWSTR** for equality.<br/>                                               |
| [**operator &gt; (CHString, CHString)**](/windows/desktop/api/ChString/)       | Compares two **CHStrings**.<br/>                                                                            |
| [**operator &gt; (CHString, LPCWSTR)**](/windows/desktop/api/ChString/)         | Compares a **CHString** with a **LPCWSTR**.<br/>                                                            |
| [**operator &gt;= (CHString, CHString)**](/windows/desktop/api/ChString/) | Compares two **CHStrings**.<br/>                                                                            |
| [**operator &gt;= (CHString, LPCWSTR)**](/windows/desktop/api/ChString/)   | Compares a **CHString** with a **LPCWSTR**.<br/>                                                            |
