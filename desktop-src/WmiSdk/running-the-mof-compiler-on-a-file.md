...
Until you run the MOF compiler, [**Mofcomp.exe**](mofcomp.md), a provider is not registered with WMI and the classes it created in the MOF file are not available in the [*WMI repository*](https://www.bing.com/search?q=*WMI repository*). The following procedure describes how to compile a MOF file.
