...
You can also use a [moniker](constructing-a-moniker-string.md) in a call to [**GetObject**](47dd01cb-9468-481e-be7e-55f69a744635), and set the default security settings, as in the following example.
