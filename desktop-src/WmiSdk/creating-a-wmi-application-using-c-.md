...
1.  [Initialize COM](initializing-com-for-a-wmi-application.md).
    ...
    Because WMI is based on COM technology, you must perform calls to the [**CoInitializeEx**](https://www.bing.com/search?q=**CoInitializeEx**) and [**CoInitializeSecurity**](https://www.bing.com/search?q=**CoInitializeSecurity**) functions to access WMI.
