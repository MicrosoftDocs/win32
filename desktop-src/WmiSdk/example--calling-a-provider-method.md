...
1.  Initialize COM parameters with a call to [**CoInitializeEx**](https://www.bing.com/search?q=**CoInitializeEx**).

    For more information, see [Initializing COM for a WMI Application](initializing-com-for-a-wmi-application.md).

2.  Initialize COM process security by calling [**CoInitializeSecurity**](https://www.bing.com/search?q=**CoInitializeSecurity**).
...
3.  Obtain the initial locator to WMI by calling [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**).
...
5.  Set [**IWbemServices**](/windows/desktop/api/WbemCli/nn-wbemcli-iwbemservices) proxy security so the WMI service can impersonate the client by calling [**CoSetProxyBlanket**](https://www.bing.com/search?q=**CoSetProxyBlanket**).
...
6.  Use the [**IWbemServices**](/windows/desktop/api/WbemCli/nn-wbemcli-iwbemservices) pointer to make requests to WMI. This example uses [**IWbemServices::ExecMethod**](/windows/desktop/api/WbemCli/nf-wbemcli-iwbemservices-execmethod) to call the provider method [**Win32\_Process::Create**](https://msdn.microsoft.com/library/aa389388).
    ...
    The following code example shows how the [**Win32\_Process::Create**](https://msdn.microsoft.com/library/aa389388) method out-parameters are given to an [**IWbemClassObject**](/windows/desktop/api/WbemCli/nn-wbemcli-iwbemclassobject) pointer. The out-parameter value is obtained with the [**IWbemClassObject::Get**](/windows/desktop/api/WbemCli/nf-wbemcli-iwbemclassobject-get) method and stored in a [**VARIANT**](https://msdn.microsoft.com/windows/desktop/e305240e-9e11-4006-98cc-26f4932d2118) variable so that it can be displayed to the user.
