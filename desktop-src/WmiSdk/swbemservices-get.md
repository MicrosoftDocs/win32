...
You can use this method to obtain [*singleton*](https://www.bing.com/search?q=*singleton*) objects, such as [**\_\_CIMOMIdentification**](--cimomidentification.md), which contains version information about the WMI installation that is running.

You can examine the repository with a viewing tool such as [CIM Studio](https://www.bing.com/search?q=CIM Studio) to verify that the new class and instance appear. For an example of removing a class and instance from the repository, see [**SWbemServices.Delete**](swbemservices-delete.md) or [**SWbemObject.Delete\_**](swbemobject-delete-.md).
