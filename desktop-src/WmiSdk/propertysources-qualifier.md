...
When defining properties for join view classes, you must define a separate view property for each of the source class properties unless the source class properties are the basis of the join view class. The following example creates properties in a join view class on similar properties from the [**Win32\_Printer**](https://msdn.microsoft.com/library/aa394363) source class and the [**Win32\_PrinterConfiguration**](https://msdn.microsoft.com/library/aa394364) source class:
...
If the two source classes are being joined by a common property, you can only define a single view class property because the value of both source class properties is always the same. The following example shows how to join the [**Win32\_Printer**](https://msdn.microsoft.com/library/aa394363) class and the [**Win32\_PrinterConfiguration**](https://msdn.microsoft.com/library/aa394364) by a common property value:
