...
When a filter is bound to a logical consumer the event is recorded by [Event Tracing](https://msdn.microsoft.com/library/windows/desktop/bb968803) for Windows (ETW). For more information, see [Tracing WMI Activity](tracing-wmi-activity.md).
