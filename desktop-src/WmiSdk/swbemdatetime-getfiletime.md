...
After completing the **GetFileTime** method, the [Err](https://msdn.microsoft.com/library/sbf5ze0e.aspx) object may contain the error code in the following list.
