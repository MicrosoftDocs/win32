...
2.  Examine the returned COM error object with a call to the [**IErrorInterface::QueryInterface**](https://www.bing.com/search?q=**IErrorInterface::QueryInterface**) method.

    Make sure to specify IID\_WbemClassObject for the *riid* parameter in the [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**) call. The **QueryInterface** method returns an instance of a WMI class, typically [**\_\_ExtendedStatus**](--extendedstatus.md).
