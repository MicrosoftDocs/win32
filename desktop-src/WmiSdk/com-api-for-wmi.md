...
| [**IWbemQuery**](/windows/desktop/api/Wmiutils/nn-wmiutils-iwbemquery)                                             | Provides an entry point through which a [*WMI Query Language*](gloss-w.md#wmi-gloss-wmi-query-language) (WQL) query can be parsed.                                                                                                                                                                        |
