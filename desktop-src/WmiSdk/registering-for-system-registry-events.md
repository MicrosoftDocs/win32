...
To receive notifications from the [System Registry](https://msdn.microsoft.com/library/aa393886) provider, a management application must register as a temporary event consumer. Most of the requirements to register for the System Registry provider are the same as any other event registration, except you must also perform the following procedure.
...
2.  Determine which type of event you want to receive and create the query.
    ...
    |------------------------------------------------------------------|----------------------|-------------------------------------------------------------|
    | [**RegistryEvent**](https://msdn.microsoft.com/library/aa393039)                       | N/A<br/>       | Abstract base class for changes in the registry.<br/> |
    | [**RegistryTreeChangeEvent**](https://msdn.microsoft.com/library/aa393041)   | RootPath<br/>  | Monitors changes to a hierarchy of keys.<br/>         |
    | [**RegistryKeyChangeEvent**](https://msdn.microsoft.com/library/aa393040)     | KeyPath<br/>   | Monitors changes to a single key.<br/>                |
    | [**RegistryValueChangeEvent**](https://msdn.microsoft.com/library/aa393042) | ValueName<br/> | Monitors changes to a single value.<br/>              |
    ...
    Changes to the **HKEY\_CLASSES\_ROOT** and **HKEY\_CURRENT\_USER** hives are not supported by [**RegistryEvent**](https://msdn.microsoft.com/library/aa393039) or classes derived from it, such as [**RegistryTreeChangeEvent**](https://msdn.microsoft.com/library/aa393041).
...
The following VBScript code example shows how to monitor the change in the values of a key by registering for the registry provider event type [**RegistryKeyChangeEvent**](https://msdn.microsoft.com/library/aa393040). The script calls an asynchronous method, [**SWbemServices.ExecNotificationQueryAsync**](swbemservices-execnotificationqueryasync.md). For more information about asynchronous calls and security, see [Making an Asynchronous Call with VBScript](making-an-asynchronous-call-with-vbscript.md).
