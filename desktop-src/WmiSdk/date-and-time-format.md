...
WMI uses the date and time formats defined by the Distributed Management Task Force ([DMTF.org](Http://go.microsoft.com/fwlink/p/?linkid=84401)) Common Information Model (CIM) specification.
...
For more information about converting to and from the WMI DATETIME format, see [**SWbemDateTime**](swbemdatetime.md) and the article on TechNet ScriptCenter [It's About Time (Oh, and About Dates, too)](Http://go.microsoft.com/fwlink/p/?linkid=84437).
