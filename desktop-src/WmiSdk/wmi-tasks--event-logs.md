...
<td>Include the <a href="privilege-constants">Security</a> privilege when connecting to the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/legacy/aa394225(v=vs.85)"><strong>Win32_NTEventlogFile</strong></a> class. For more information, see <a href="executing-privileged-operations-using-vbscript">Executing Privileged Operations Using VBScript</a>.<br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
