...
Data queries are WQL statements that request instances of classes. To issue a data query, applications call the [**IWbemServices::ExecQuery**](iwbemservices-execquery.md) or [**IWbemServices::ExecQueryAsync**](iwbemservices-execqueryasync.md) method.
