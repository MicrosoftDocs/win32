...
-   Initialize the [**IWbemLocator**](/windows/desktop/api/Wbemcli/nn-wbemcli-iwbemlocator) interface through a call to [**CoCreateInstance**](7295a55b-12c7-4ed0-a7a4-9ecee16afdec).

    WMI does not require that you perform any additional procedures when calling [**CoCreateInstance**](7295a55b-12c7-4ed0-a7a4-9ecee16afdec) on [**IWbemLocator**](/windows/desktop/api/Wbemcli/nn-wbemcli-iwbemlocator).
