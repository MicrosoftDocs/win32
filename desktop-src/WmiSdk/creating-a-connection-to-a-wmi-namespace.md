...
-   Initialize the [**IWbemLocator**](/windows/desktop/api/Wbemcli/nn-wbemcli-iwbemlocator) interface through a call to [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**).

    WMI does not require that you perform any additional procedures when calling [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**) on [**IWbemLocator**](/windows/desktop/api/Wbemcli/nn-wbemcli-iwbemlocator).
