...
1.  Create an [**IWbemContext**](/windows/desktop/api/WbemCli/nn-wbemcli-iwbemcontext) object with a call to [**CoCreateInstance**](https://msdn.microsoft.com/en-us/library/ms686615(v=VS.85).aspx).
...
2.  Add \_\_GET\_EXTENSIONS, \_\_GET\_EXT\_CLIENT\_REQUEST, and any other named values that describe the properties you want to retrieve to the [**IWbemContext**](/windows/desktop/api/WbemCli/nn-wbemcli-iwbemcontext) object.
    ...
    | \_\_GET\_EXT\_PROPERTIES<br/>      | [**SAFEARRAY**](https://docs.microsoft.com/previous-versions/windows/desktop/api/oaidl/ns-oaidl-tagsafearray) of strings listing the properties to be retrieved. Cannot be simultaneously specified with \_\_GET\_EXT\_KEYS\_ONLY.<br/> An asterisk "\*" is an invalid property name for \_\_GET\_EXT\_PROPERTIES.<br/>                    |
