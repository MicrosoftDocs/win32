---
Description: WMI tasks for printers and printing manage and obtain data about printers, such as finding or setting the default printer. For other examples, see the TechNet ScriptCenter at http//www.microsoft.com/technet.
audience: developer
...
WMI tasks for printers and printing manage and obtain data about printers, such as finding or setting the default printer. For other examples, see the TechNet ScriptCenter at [http://www.microsoft.com/technet](Http://go.microsoft.com/fwlink/p/?linkid=84103).
...
<td>Use the [<strong>Win32_Printer</strong>](https://msdn.microsoft.com/library/aa394363) class and the [<strong>AddPrinterConnection</strong>](https://msdn.microsoft.com/library/aa384769) method.<br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
...
<td><p>Use the [<strong>Win32_Printer</strong>](https://msdn.microsoft.com/library/aa394363) class and the [<strong>SetDefaultPrinter</strong>](https://msdn.microsoft.com/library/aa393291) method.</p>
<div class="code">
...
<td><p>Use the [<strong>Win32_Printer</strong>](https://msdn.microsoft.com/library/aa394363) class, and the [<strong>CancelAllJobs</strong>](https://msdn.microsoft.com/library/aa384838) method.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
