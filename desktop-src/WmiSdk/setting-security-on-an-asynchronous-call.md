...
For more information about the [**CoInitializeSecurity**](_com_coinitializesecurity) function and parameters, see the [COM](_cos_com_start_page) documentation.
