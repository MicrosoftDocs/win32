...
The following code example shows a join view class created from the Performance Monitor provider classes [**Win32\_PerfRawData\_PerfProc\_Process**](https://msdn.microsoft.com/library/dn750765) and [**Win32\_PerfRawData\_PerfProc\_Thread**](https://msdn.microsoft.com/library/aa394325) with properties of both classes joined by the **ProcessID** property.
