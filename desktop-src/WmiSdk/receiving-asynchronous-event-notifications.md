...
1.  Set up your application with calls to the [**CoInitializeEx**](https://www.bing.com/search?q=**CoInitializeEx**) and [**CoInitializeSecurity**](https://www.bing.com/search?q=**CoInitializeSecurity**) functions.

    Calling [**CoInitializeEx**](https://www.bing.com/search?q=**CoInitializeEx**) initializes COM, while [**CoInitializeSecurity**](https://www.bing.com/search?q=**CoInitializeSecurity**) grants WMI the permission to call into the process of the consumer. The **CoInitializeEx** function also grants you the ability to program a multithreaded application, which is necessary for asynchronous notification. For more information, see [Maintaining WMI Security](maintaining-wmi-security.md).
    ...
    The following code example describes how to set up the temporary event consumer with calls to [**CoInitializeEx**](https://www.bing.com/search?q=**CoInitializeEx**) and [**CoInitializeSecurity**](https://www.bing.com/search?q=**CoInitializeSecurity**).
