...
####### [GetValuesForProp methods](https://msdn.microsoft.com/en-us/library/Aa384849(v=VS.85).aspx)
######## [GetValuesForProp(CHStringArray&, LPCWSTR) method](https://msdn.microsoft.com/en-us/library/Aa384851(v=VS.85).aspx)
######## [GetValuesForProp(LPCWSTR, std::vector<_bstr_t&gt;&) method](https://msdn.microsoft.com/en-us/library/Aa384854(v=VS.85).aspx)
...
######## [GetWBEMINT64(LPCWSTR, LONGLONG&) method](https://msdn.microsoft.com/en-us/library/Aa388983(v=VS.85).aspx)
######## [GetWBEMINT64(LPCWSTR, ULONGLONG&) method](https://msdn.microsoft.com/en-us/library/Aa388984(v=VS.85).aspx)
######## [GetWBEMINT64(LPCWSTR, WBEMINT64&) method](https://msdn.microsoft.com/en-us/library/Aa388985(v=VS.85).aspx)
...
######## [SetCharSplat(LPCWSTR, DWORD) method](https://msdn.microsoft.com/en-us/library/Aa388992(v=VS.85).aspx)
######## [SetCharSplat(LPCWSTR, LPCSTR) method](https://msdn.microsoft.com/en-us/library/Aa388993(v=VS.85).aspx)
######## [SetCharSplat(LPCWSTR, LPCWSTR) method](https://msdn.microsoft.com/en-us/library/Aa388994(v=VS.85).aspx)
####### [SetCHString methods](cinstance-setchstring.md)
######## [SetCHString(LPCWSTR, constCHString&) method](https://msdn.microsoft.com/en-us/library/Aa388996(v=VS.85).aspx)
######## [SetCHString(LPCWSTR, LPCSTR) method](https://msdn.microsoft.com/en-us/library/Aa389190(v=VS.85).aspx)
...
######## [SetWBEMINT64(LPCWSTR, constLONGLONG&) method](https://msdn.microsoft.com/en-us/library/Aa389211(v=VS.85).aspx)
######## [SetWBEMINT64(LPCWSTR, constWBEMINT64&) method](https://msdn.microsoft.com/en-us/library/Aa389215(v=VS.85).aspx)
######## [SetWBEMINT64(LPCWSTR, constULONGLONG&) method](https://msdn.microsoft.com/en-us/library/Aa389213(v=VS.85).aspx)
...
####### [FrameworkLoginDLL method](https://msdn.microsoft.com/en-us/library/Aa389782(v=VS.85).aspx)
####### [FrameworkLogoffDLL method](https://msdn.microsoft.com/en-us/library/Aa389783(v=VS.85).aspx)
####### [GetAllDerivedInstances method](https://msdn.microsoft.com/en-us/library/Aa389784(v=VS.85).aspx)
...
####### [GetEmptyInstance methods](https://msdn.microsoft.com/en-us/library/Aa389788(v=VS.85).aspx)
######## [GetEmptyInstance(LPCWSTR, CInstance**, LPCWSTR) method](https://msdn.microsoft.com/en-us/library/Aa389789(v=VS.85).aspx)
######## [GetEmptyInstance(MethodContext*, LPCWSTR, CInstance**, LPCWSTR) method](https://msdn.microsoft.com/en-us/library/Aa389790(v=VS.85).aspx)
####### [GetInstanceByPath method](https://msdn.microsoft.com/en-us/library/Aa389791(v=VS.85).aspx)
...
####### [GetInstancesByQuery method](https://msdn.microsoft.com/en-us/library/Aa389794(v=VS.85).aspx)
####### [GetInstancesByQueryAsynch method](/windows/desktop/api/WbemGlue/nf-wbemglue-cwbemproviderglue-getinstancesbyqueryasynch)
####### [GetNameSpaceConnection method](https://msdn.microsoft.com/en-us/library/Aa389796(v=VS.85).aspx)
####### [IsDerivedFrom method](https://msdn.microsoft.com/en-us/library/Aa389797(v=VS.85).aspx)
...
####### [DeleteInstance method](https://msdn.microsoft.com/en-us/library/Aa392766(v=VS.85).aspx)
####### [EnumerateInstances method](/windows/desktop/api/Provider/nf-provider-provider-enumerateinstances)
####### [ExecMethod method](https://msdn.microsoft.com/en-us/library/Aa392769(v=VS.85).aspx)
...
####### [GetObject method](https://msdn.microsoft.com/en-us/library/Aa392779(v=VS.85).aspx)
...
####### [PutInstance method](https://msdn.microsoft.com/en-us/library/Aa392883(v=VS.85).aspx)
...
####### [CHString constructors](https://msdn.microsoft.com/en-us/library/Aa385428(v=VS.85).aspx)
######## [CHString() constructor](https://msdn.microsoft.com/en-us/library/Aa385468(v=VS.85).aspx)
######## [CHString(constCHString&) constructor](https://msdn.microsoft.com/en-us/library/Aa385434(v=VS.85).aspx)
######## [CHString(constunsigned char*) constructor](https://msdn.microsoft.com/en-us/library/Aa385441(v=VS.85).aspx)
...
######## [CHString(LPCWSTR, int) constructor](https://msdn.microsoft.com/en-us/library/Aa385456(v=VS.85).aspx)
######## [CHString(WCHAR, int) constructor](https://msdn.microsoft.com/en-us/library/Aa385463(v=VS.85).aspx)
...
######## [Find(WCHAR) method](https://msdn.microsoft.com/en-us/library/Aa385501(v=VS.85).aspx)
####### [FindOneOf method](/windows/desktop/api/ChString/nf-chstring-chstring-findoneof)
####### [Format methods](https://msdn.microsoft.com/en-us/library/Aa385504(v=VS.85).aspx)
######## [Format(LPCWSTR, ) method](https://msdn.microsoft.com/en-us/library/Aa385527(v=VS.85).aspx)
######## [Format(UINT, ) method](https://msdn.microsoft.com/en-us/library/Aa385532(v=VS.85).aspx)
####### [FormatMessageW methods](https://msdn.microsoft.com/en-us/library/Aa385509(v=VS.85).aspx)
######## [FormatMessageW(LPCWSTR, ) method](https://msdn.microsoft.com/en-us/library/Aa385515(v=VS.85).aspx)
######## [FormatMessageW(UINT, ) method](https://msdn.microsoft.com/en-us/library/Aa385519(v=VS.85).aspx)
...
######## [Mid(int, int) method](https://msdn.microsoft.com/en-us/library/Aa385636(v=VS.85).aspx)
...
####### [operator LPCWSTR method](https://msdn.microsoft.com/en-us/library/Aa385699(v=VS.85).aspx)
...
####### [InsertAt methods](https://msdn.microsoft.com/en-us/library/Aa390886(v=VS.85).aspx)
######## [InsertAt(int, CHStringArray*) method](https://msdn.microsoft.com/en-us/library/Aa385381(v=VS.85).aspx)
######## [InsertAt(int, LPCWSTR, int) method](https://msdn.microsoft.com/en-us/library/Aa385383(v=VS.85).aspx)
...
####### [SetAt method](https://msdn.microsoft.com/en-us/library/Aa385402(v=VS.85).aspx)
...
######## [Free(ParsedObjectPath*) method](https://msdn.microsoft.com/en-us/library/Bb204792(v=VS.85).aspx)
...
####### [TRefPointerCollection method](https://msdn.microsoft.com/en-us/library/Aa393919(v=VS.85).aspx)
...
######## [GetLocalOffsetForDate(constFILETIME*) method](https://msdn.microsoft.com/en-us/library/Aa394022(v=VS.85).aspx)
######## [GetLocalOffsetForDate(conststruct tm*) method](https://msdn.microsoft.com/en-us/library/Aa394023(v=VS.85).aspx)
######## [GetLocalOffsetForDate(constSYSTEMTIME*) method](https://msdn.microsoft.com/en-us/library/Aa394024(v=VS.85).aspx)
######## [GetLocalOffsetForDate(consttime_t&) method](https://msdn.microsoft.com/en-us/library/Aa394025(v=VS.85).aspx)
...
######## [operator-(constWBEMTime&) method](https://msdn.microsoft.com/en-us/library/Aa394037(v=VS.85).aspx)
######## [operator-(constWBEMTimeSpan&) method](https://msdn.microsoft.com/en-us/library/Aa394036(v=VS.85).aspx)
...
######## [operator=(constBSTR&) method](https://msdn.microsoft.com/en-us/library/Aa394031(v=VS.85).aspx)
######## [operator=(constFILETIME&) method](https://msdn.microsoft.com/en-us/library/Aa394032(v=VS.85).aspx)
######## [operator=(conststruct tm&) method](https://msdn.microsoft.com/en-us/library/Aa394033(v=VS.85).aspx)
######## [operator=(constSYSTEMTIME&) method](https://msdn.microsoft.com/en-us/library/Aa394034(v=VS.85).aspx)
######## [operator=(consttime_t&) method](https://msdn.microsoft.com/en-us/library/Aa394035(v=VS.85).aspx)
####### [operator-= method](/windows/desktop/api/WbemTime/nf-wbemtime-wbemtime-operator-=)
####### [SetDMTF method](/windows/desktop/api/WbemTime/nf-wbemtime-wbemtime-setdmtf)
####### [WBEMTime constructors](https://msdn.microsoft.com/en-us/library/Aa394042(v=VS.85).aspx)
######## [WBEMTime() constructor](https://msdn.microsoft.com/en-us/library/Aa394048(v=VS.85).aspx)
######## [WBEMTime(BSTR) constructor](https://msdn.microsoft.com/en-us/library/Aa394043(v=VS.85).aspx)
######## [WBEMTime(conststruct tm&) constructor](https://msdn.microsoft.com/en-us/library/Aa394045(v=VS.85).aspx)
######## [WBEMTime(constFILETIME&) constructor](https://msdn.microsoft.com/en-us/library/Aa394044(v=VS.85).aspx)
######## [WBEMTime(constSYSTEMTIME&) constructor](https://msdn.microsoft.com/en-us/library/Aa394046(v=VS.85).aspx)
######## [WBEMTime(consttime_t&) constructor](https://msdn.microsoft.com/en-us/library/Aa394047(v=VS.85).aspx)
##### [WBEMTimeSpan](/windows/desktop/api/WbemTime/nl-wbemtime-wbemtimespan)
###### [WBEMTimeSpan Methods](wbemtimespan-methods.md)
####### [WbemTimeSpan constructors](https://msdn.microsoft.com/en-us/library/Aa394007(v=VS.85).aspx)
######## [WBEMTimeSpan() constructor](https://msdn.microsoft.com/en-us/library/Aa394010(v=VS.85).aspx)
######## [WBEMTimeSpan(BSTR) constructor](https://msdn.microsoft.com/en-us/library/Aa394008(v=VS.85).aspx)
######## [WBEMTimeSpan(int, int, int, int, int, int, int) constructor](https://msdn.microsoft.com/en-us/library/Aa394009(v=VS.85).aspx)
...
####### [operator= method](https://msdn.microsoft.com/en-us/library/Aa394002(v=VS.85).aspx)
