...
-   Managed objects and WMI providers
    ...
    An example of a provider is the preinstalled [Registry provider](https://msdn.microsoft.com/library/aa393886), which accesses data in the system registry. The Registry provider has one [*WMI class*](gloss-w.md), [**StdRegProv**](https://msdn.microsoft.com/library/aa393664), with many methods but no properties. Other preinstalled providers, such as the [Win32 provider](https://msdn.microsoft.com/library/aa394388), usually have classes with many properties but few methods, such as [**Win32\_Process**](https://msdn.microsoft.com/library/aa394372) or [**Win32\_LogicalDisk**](https://msdn.microsoft.com/library/aa394173). The Registry provider DLL file, Stdprov.dll, contains the code that dynamically returns data when requested by client scripts or applications.
