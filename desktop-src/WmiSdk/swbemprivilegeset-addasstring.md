...
The following VBScript code example creates a new port for a print server using [**Win32\_TCPIPPrinterPort**](https://msdn.microsoft.com/library/aa394492). The **SeLoadDriverPrivilege** is required for this operation. See [Executing Privileged Operations](executing-privileged-operations.md).
