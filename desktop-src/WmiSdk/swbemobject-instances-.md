...
The **Instances\_** method only works for class objects. It is not an error for the returned collection to have zero elements. The default behavior for this method is [*semisynchronous*](https://www.bing.com/search?q=*semisynchronous*) because of the default *IFlags* value **wbemFlagReturnImmediately**.
