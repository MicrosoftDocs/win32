...
-   [LocalSystem](https://msdn.microsoft.com/library/windows/desktop/ms684190)
-   [NetworkService](https://msdn.microsoft.com/library/windows/desktop/ms684272)
-   [LocalService](https://msdn.microsoft.com/library/windows/desktop/ms684188)
...
If you do not set a value for the [**HostingModel**](--win32provider.md) property, WMI will set a default value of **NetworkServiceHostOrSelfHost**. If the **HostingModel** value is set to **LocalSystemHost**, WMI uses tracing to generate events 5603 and 5604 in the Windows Event Log. Because the local [LocalSystem](https://msdn.microsoft.com/library/windows/desktop/ms684190) account is highly privileged, this setting is not recommended. You can view these events in the **Event Viewer**. For more information, see [Tracing WMI Activity](tracing-wmi-activity.md).

Set the [**HostingModel**](--win32provider.md) property for decoupled providers as "Decoupled:Com". Providers created by adding instrumentation classes from [**Microsoft.Management.Infrastructure**](https://msdn.microsoft.com/library/hh872326) in the .NET Framework are decoupled providers. (**System.Management.Instrumentation** is no longer supported.) For more information about creating a decoupled provider, see [Incorporating a Provider in an Application](incorporating-a-provider-in-an-application.md).
...
3.  Assign the appropriate shared host value to the [**HostingModel**](--win32provider.md) property. Shared host values such as "NetworkServiceHost" are defined in the **HostingSpecification** property of [**MSFT\_Providers**](https://msdn.microsoft.com/library/aa392509) class.
...
[**MSFT\_Providers**](https://msdn.microsoft.com/library/aa392509)
</dt> <dt>
