...
After the completion of the **OnObjectReady** event, the [Err](https://msdn.microsoft.com/library/sbf5ze0e.aspx) object may contain one of the error codes below.
