...
Arbitrary arithmetic expressions cannot be used. For example, the following query returns only the instances of the [**Win32\_LogicalDisk**](https://msdn.microsoft.com/library/aa394173) class that represent NTFS drives:
