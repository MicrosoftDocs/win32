...
-   Added the [**CIM\_RegisteredProfile**](https://msdn.microsoft.com/library/ee309375), [**CIM\_ElementConformsToProfile**](https://msdn.microsoft.com/library/mt446049), and [**CIM\_ReferencedProfile**](cim-referencedprofile.md) classes.
...
<span id="CIM_RegisteredProfile"></span><span id="cim_registeredprofile"></span><span id="CIM_REGISTEREDPROFILE"></span>[**CIM\_RegisteredProfile**](https://msdn.microsoft.com/library/ee309375)
</dt> <dd>
...
<span id="CIM_ElementConformsToProfile"></span><span id="cim_elementconformstoprofile"></span><span id="CIM_ELEMENTCONFORMSTOPROFILE"></span>[**CIM\_ElementConformsToProfile**](https://msdn.microsoft.com/library/mt446049)
</dt> <dd>

Used to associate instances of management elements that are defined in profiles with the [**CIM\_RegisteredProfile**](https://msdn.microsoft.com/library/ee309375) class that identifies the particular profile specifications that are implemented.
