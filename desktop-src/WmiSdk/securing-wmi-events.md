...
WMI events are delivered by the [*event provider*](https://www.bing.com/search?q=*event provider*) to a [*temporary*](https://www.bing.com/search?q=*temporary*) or [*permanent*](https://www.bing.com/search?q=*permanent*) consumer. The WMI event system uses the comparison of [*security descriptors*](https://www.bing.com/search?q=*security descriptors*) on events and user account [*SIDs*](https://www.bing.com/search?q=*SIDs*) to control event access.
