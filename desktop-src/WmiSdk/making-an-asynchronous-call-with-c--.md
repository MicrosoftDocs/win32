...
2.  Log on to the target WMI namespace.
    ...
    Applications always have to call the COM function [**CoInitializeSecurity**](e0933741-6b75-4ce1-aa63-6240e4a7130f) during the initialization phase. If they do not do so before making an asynchronous call, WMI releases the application sink without completing the asynchronous call. For more information, see [Initializing COM for a WMI Application](initializing-com-for-a-wmi-application.md).
