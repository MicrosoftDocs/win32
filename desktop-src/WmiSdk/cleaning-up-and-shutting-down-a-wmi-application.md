...
2.  Call [**CoUninitialize**](https://www.bing.com/search?q=**CoUninitialize**).

    As with all COM applications, you must call [**CoUninitialize**](https://www.bing.com/search?q=**CoUninitialize**) at the end of your application.
