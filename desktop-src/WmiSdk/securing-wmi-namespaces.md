...
WMI namespace security relies on standard Windows user [*security identifiers*](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-identifier-gly) (SIDs) and access control lists. Administrators and users have different default permissions.
