...
5.  Define a COM object to contain your provider. The example code for this step is located in a complete example at the end of this topic.
    ...
    1.  As with any COM object, you must implement a constructor and a deconstructor, as well as the [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**), [**AddRef**](https://www.bing.com/search?q=**AddRef**), and [**Release**](https://www.bing.com/search?q=**Release**) methods.
