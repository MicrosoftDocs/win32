...
The third layer of the [*CIM schema*](https://www.bing.com/search?q=*CIM schema*), which includes platform-specific extensions of the CIM schema such as Windows, UNIX, and Exchange Server. Also see [*common model*](https://www.bing.com/search?q=*common model*) and core model.
