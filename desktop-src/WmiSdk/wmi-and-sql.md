...
WMI queries use [*WMI Query Language (WQL)*](gloss-w.md#wmi-gloss-wmi-query-language), a subset of SQL. For more information about WMI queries, see [Querying with WQL](querying-with-wql.md).
