...
A common cause of access denied errors when using WMI is the lack of an enabled privilege for operations, such as getting all instances of [**Win32\_NTEventlogFile**](https://msdn.microsoft.com/library/aa394225). Without enabling the **SeSecurity** privilege, you cannot access the Security log file.
