...
You can also modify an existing namespace by adding this attribute and then compile the MOF file again. **RequiresEncryption** is used in [*MOF*](https://www.bing.com/search?q=*MOF*) with the [pragma namespace](pragma-namespace.md) preprocessor instruction.
