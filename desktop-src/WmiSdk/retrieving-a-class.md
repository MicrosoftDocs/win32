...
2.  The following code example retrieves the class definition for the class that describes logical drives on your computer.
    ...
    On Active Server Pages (ASP) use [**GetObject**](47dd01cb-9468-481e-be7e-55f69a744635) or [CreateObject](https://msdn.microsoft.com/library/xzysf6hc.aspx) in the server-side script. For more information, see [Creating Active Server Pages for WMI](creating-active-server-pages-for-wmi.md).
