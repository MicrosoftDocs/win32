...
To set authentication for a proxy, call the [**CoSetProxyBlanket**](_com_cosetproxyblanket) function. For more information and a code example, see [Setting the Security on IWbemServices and Other Proxies](setting-the-security-on-iwbemservices-and-other-proxies.md).
