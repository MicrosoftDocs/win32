...
|----------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [PERF\_AVERAGE\_BULK](https://go.microsoft.com/fwlink/p/?linkid=44341)Decimal 1073874176<br/>       | Number of items processed, on average, during an operation. This counter type displays a ratio of the items processed (such as bytes sent) to the number of operations completed, and requires a base property with PERF\_AVERAGE\_BASE as the counter type. |
| [PERF\_COUNTER\_COUNTER](https://go.microsoft.com/fwlink/p/?linkid=44341)Decimal 272696320<br/>     | Average number of operations completed during each second of the sample interval. .                                                                                                                                                                          |
| [PERF\_SAMPLE\_COUNTER](https://go.microsoft.com/fwlink/p/?linkid=44341)Decimal 4260864<br/>        | Average number of operations completed in one second. This counter type requires a base property with the counter type PERF\_SAMPLE\_BASE.                                                                                                                   |
| [PERF\_COUNTER\_BULK\_COUNT](https://go.microsoft.com/fwlink/p/?linkid=44341)Decimal 272696576<br/> | Average number of operations completed during each second of the sample interval. This counter type is the same as the PERF\_COUNTER\_COUNTER type, but it uses larger fields to accommodate larger values.                                                  |
