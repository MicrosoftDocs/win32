...
Parses all the performance libraries on the system and refreshes the classes derived from [**Win32\_PerfRawData**](https://msdn.microsoft.com/library/aa394299) and [**Win32\_PerfFormattedData**](https://msdn.microsoft.com/library/aa394253).
