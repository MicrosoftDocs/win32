...
Using an [**SWbemRefresher**](swbemrefresher.md) object is required to get accurate data from WMI performance classes, such as [**Win32\_PerfFormattedData\_PerfDisk\_LogicalDisk**](https://msdn.microsoft.com/library/aa394261) or other preinstalled classes derived from [**Win32\_Perf**](https://msdn.microsoft.com/library/aa394252).
...
2.  Connect to the WMI namespace. To use preinstalled [**Win32\_Perf**](https://msdn.microsoft.com/library/aa394252) performances classes, connect to **root\\cimv2**.
...
3.  Add a single object (call [**SWbemRefresher.Add**](swbemrefresher-add.md)) or a collection (call [**SWbemRefresher.AddEnum**](swbemrefresher-addenum.md)) to the refresher.
    ...
    Use the precalculated data classes derived from [**Win32\_PerfFormattedData**](https://msdn.microsoft.com/library/aa394253), for example, [**Win32\_PerfFormattedData\_PerfDisk\_LogicalDisk**](https://msdn.microsoft.com/library/aa394261) instead of [**Win32\_PerfRawData\_PerfDisk\_LogicalDisk**](https://msdn.microsoft.com/library/aa394307). Otherwise, you must calculate the values for all of the properties other than simple counters.
...
The following VBScript code example shows how to refresh a single object on the local computer. The script creates a refresher container and adds an instance of an enumerator for [**Win32\_PerfFormattedData\_PerfProc\_Process**](https://msdn.microsoft.com/library/dn750765) instances. The [**Refresh**](swbemrefresher-refresh.md) call is made three times to demonstrate the changes in the **PercentProcessorTime** property for processes using more than one percent of the processor time.
