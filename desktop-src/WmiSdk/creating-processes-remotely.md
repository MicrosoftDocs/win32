...
You can use [**Win32\_ScheduledJob.Create**](https://msdn.microsoft.com/library/aa389389) to create an interactive process remotely. But processes started by **Win32\_ScheduledJob.Create** run under the LocalSystem account that can confer too much privilege.
