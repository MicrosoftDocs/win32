...
1.  Create a dedicated process with a call to [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**).

    The following code example calls [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**) to create a dedicated process.
...
4.  Call [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**) for the wrapper, and request a pointer to the [**IWbemObjectSink**](iwbemobjectsink.md) interface.

    The following code example calls [**QueryInterface**](https://www.bing.com/search?q=**QueryInterface**) and requests a pointer to the [**IWbemObjectSink**](iwbemobjectsink.md) interface.
...
8.  When finished, uninitialize COM with a call to [**Release()**](https://www.bing.com/search?q=**Release()**).

    The following code example shows how to call [**Release()**](https://www.bing.com/search?q=**Release()**) on the *pUnsecApp* pointer.
...
For more information about the [**CoInitializeSecurity**](https://www.bing.com/search?q=**CoInitializeSecurity**) function and parameters, see the [COM](https://www.bing.com/search?q=COM) documentation in the Platform Software Development Kit (SDK).
