...
4.  Call [**QueryInterface**](54d5ff80-18db-43f2-b636-f93ac053146d) for the wrapper, and request a pointer to the [**IWbemObjectSink**](iwbemobjectsink.md) interface.

    The following code example calls [**QueryInterface**](54d5ff80-18db-43f2-b636-f93ac053146d) and requests a pointer to the [**IWbemObjectSink**](iwbemobjectsink.md) interface.
...
8.  When finished, uninitialize COM with a call to [**Release()**](4b494c6f-f0ee-4c35-ae45-ed956f40dc7a).
...
For more information about the [**CoInitializeSecurity**](e0933741-6b75-4ce1-aa63-6240e4a7130f) function and parameters, see the [COM](b21a6b08-c17c-4fcc-bc60-39037bc9902f) documentation in the Platform Software Development Kit (SDK).
