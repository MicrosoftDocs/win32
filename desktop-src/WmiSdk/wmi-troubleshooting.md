...
Provider writers may also encounter debugging issues unless you are writing a [*decoupled provider*](https://www.bing.com/search?q=*decoupled provider*). For more information, see [Debugging Providers](debugging-providers.md).

## Logging and Tracing

The WMI log files no longer exist; they were replaced by [Event Tracing for Windows (ETW)](https://msdn.microsoft.com/library/windows/desktop/bb968803). For more information, see [Tracing WMI Activity](tracing-wmi-activity.md), [Logging WMI Activity](logging-wmi-activity.md), and [WMI Log Files](wmi-log-files.md).
...
-   Access denied errors from Internet Connection Firewall (ICF) changes.
    ...
    For more information, see [Connecting Through Windows Firewall](https://msdn.microsoft.com/library/aa822854).
