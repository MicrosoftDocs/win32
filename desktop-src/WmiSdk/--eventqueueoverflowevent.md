...
For more information, see the [**MaximumQueueSize**](--eventconsumer.md) property in the [**\_\_EventConsumer**](--eventconsumer.md) class and the [**HighThresholdOnEvents**](https://msdn.microsoft.com/library/aa394522) property in the **Win32\_WMISetting** class.
