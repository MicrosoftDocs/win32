...
In the WMI infrastructure, the WMI service (Winmgmt) is the operating system component that acts as the mediator between management applications and WMI data [*providers*](https://www.bing.com/search?q=*providers*). The [*WMI repository*](https://www.bing.com/search?q=*WMI repository*) is a storage area for WMI-related static data.
...
WMI uses [Event Tracing](https://msdn.microsoft.com/library/windows/desktop/bb968803) (ETW) to record WMI service activity.
