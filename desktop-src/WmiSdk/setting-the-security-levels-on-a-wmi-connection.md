...
-   Set the security levels on the [**IWbemServices**](/windows/desktop/api/WbemCli/nn-wbemcli-iwbemservices) proxy with a call to [**CoSetProxyBlanket**](c2e5e681-8fa5-4b02-b59d-ba796eb0dccf).

    The following code example describes a common way of calling [**CoSetProxyBlanket**](c2e5e681-8fa5-4b02-b59d-ba796eb0dccf).
