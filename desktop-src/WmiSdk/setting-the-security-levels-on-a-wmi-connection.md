...
-   Set the security levels on the [**IWbemServices**](/windows/desktop/api/WbemCli/nn-wbemcli-iwbemservices) proxy with a call to [**CoSetProxyBlanket**](https://www.bing.com/search?q=**CoSetProxyBlanket**).

    The following code example describes a common way of calling [**CoSetProxyBlanket**](https://www.bing.com/search?q=**CoSetProxyBlanket**).
