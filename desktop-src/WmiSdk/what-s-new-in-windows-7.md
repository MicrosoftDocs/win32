...
WMI implemented the [**Win32\_OptionalFeature**](https://msdn.microsoft.com/library/ee309383) class. This class queries and returns the status of the optional features that are present on a computer. For example queries using Windows PowerShell, see [Querying the Status of Optional Features](querying-the-status-of-optional-features.md).
...
The [software licensing classes](https://msdn.microsoft.com/library/dn622972) have new methods and properties to provide more software licensing data. In addition, the [**SoftwareLicensingTokenActivationLicense**](https://msdn.microsoft.com/library/dd637983) class was added.
...
[Power metering and budgeting classes](https://msdn.microsoft.com/library/dn622954) are the primary interface for the query of Power Meter Interface (PMI) information from underlying power meters on the system.
...
[Power policy classes](https://msdn.microsoft.com/library/dn622955) enable the remote management of all power policy infrastructures.
