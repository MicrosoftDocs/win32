...
Windows Management Instrumentation (WMI) is the Microsoft implementation of Web-Based Enterprise Management (WBEM), which is an industry initiative to develop a standard technology for accessing management information in an enterprise environment. WMI uses the Common Information Model (CIM) industry standard to represent systems, applications, networks, devices, and other managed components. CIM is developed and maintained by the Distributed Management Task Force ([DMTF](http://go.microsoft.com/fwlink/p/?linkid=67786)).
...
| [User Account Control and WMI](user-account-control-and-wmi.md)                                       | User Account Control (UAC) affects what WMI data is returned, remote access, and how scripts must be run. For more information, see [Getting Started with User Account Control on Windows Vista](Http://go.microsoft.com/fwlink/p/?linkid=84438). |
...
| [Date and Time Format](date-and-time-format.md)                                                       | WMI uses the date and time formats defined by the Distributed Management Task Force CIM specification. For more information, see [DMTF](Http://go.microsoft.com/fwlink/p/?linkid=84401).                                                          |
