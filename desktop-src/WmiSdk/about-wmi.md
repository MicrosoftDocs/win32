...
| [User Account Control and WMI](user-account-control-and-wmi.md)                                       | User Account Control (UAC) affects what WMI data is returned, remote access, and how scripts must be run. For more information, see [Getting Started with User Account Control on Windows Vista](https://technet.microsoft.com/En-US/WindowsVista/aa906022.aspx). |
