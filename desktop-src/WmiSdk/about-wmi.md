...
Many Windows features have associated WMI providers, like the [Boot Configuration Data (BCD) Provider](https://msdn.microsoft.com/library/windows/desktop/bb986746) or the [Storage Volume Provider](https://msdn.microsoft.com/library/aa393675). WMI Providers implement the functionality described by WMI classes methods and properties to manage associated Windows features. For more information, see [WMI Providers](wmi-providers.md) and [WMI Classes](wmi-classes.md).
...
| [User Account Control and WMI](user-account-control-and-wmi.md)                                       | User Account Control (UAC) affects what WMI data is returned, remote access, and how scripts must be run. For more information, see [Getting Started with User Account Control on Windows Vista](https://go.microsoft.com/fwlink/p/?linkid=84438). |
...
| [IPv6 and IPv4 Support in WMI](ipv6-and-ipv4-support-in-wmi.md)                                       | WMI [IP Route Provider](https://msdn.microsoft.com/library/aa391405) and network classes supply data for IPv4 addresses. Starting with Windows Vista, WMI also provides limited support for IPv6 network capabilities.                                       |
| [Date and Time Format](date-and-time-format.md)                                                       | WMI uses the date and time formats defined by the Distributed Management Task Force CIM specification. For more information, see [DMTF](https://go.microsoft.com/fwlink/p/?linkid=84401).                                                          |
