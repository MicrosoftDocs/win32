...
Providers, unless they are [*decoupled providers*](https://www.bing.com/search?q=*decoupled providers*) running within an application, are loaded in a Wmiprvse.exe process, and not through Svchost.exe with a Winmgmt.exe process. For more information, see [Provider Hosting and Security](provider-hosting-and-security.md).
