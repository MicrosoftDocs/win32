...
After the completion of the **ConnectServer** method, the [Err](https://msdn.microsoft.com/library/sbf5ze0e.aspx) object may contain one of the error codes in the following list.
...
The following VBScript code example describes how to connect to a remote computer to obtain [**Win32\_IP4RouteTable**](https://msdn.microsoft.com/library/aa394162) data. The domain name that is specified in *strDomain* is used in *strAuthority*.
