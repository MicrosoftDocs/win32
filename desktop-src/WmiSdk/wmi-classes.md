...
| [CIM Classes](cimclas.md)                                 | [*Common Information Model (CIM)*](https://www.bing.com/search?q=*Common Information Model (CIM)*) schema classes. If you want to write your own WMI classes then you can inherit from one or more of these classes. The WMI [Win32 Classes](https://msdn.microsoft.com/library/aa394388) inherit from the CIM classes.                                                                          |
