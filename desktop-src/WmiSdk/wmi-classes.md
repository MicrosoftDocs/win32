...
| [CIM Classes](cimclas.md)                                 | [*Common Information Model (CIM)*](gloss-c.md#wmi-gloss-common-information-model) schema classes. If you want to write your own WMI classes then you can inherit from one or more of these classes. The WMI [Win32 Classes](https://msdn.microsoft.com/library/aa394388) inherit from the CIM classes.                                                                          |
