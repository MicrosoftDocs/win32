...
Connecting to a WMI namespace on a remote computer may require that you change the settings for [Windows Firewall](http://go.microsoft.com/fwlink/p/?linkid=157267), [User Account Control (UAC)](Http://go.microsoft.com/fwlink/p/?linkid=84439), DCOM, or Common Information Model Object Manager (CIMOM).
