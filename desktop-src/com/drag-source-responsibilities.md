...
-   Providing a data-transfer object for the drop target that exposes the [**IDataObject**](idataobject.md) and [**IDropSource**](idropsource.md) interfaces.
...
The main task is creating a data-transfer object that exposes the [**IDataObject**](idataobject.md) and [**IDropSource**](idropsource.md) interfaces. The drag source might or might not include a copy of the selected data. Including it is not mandatory, but doing so helps protect against inadvertent changes and allows the Clipboard operations code to be identical to the drag and drop code.
