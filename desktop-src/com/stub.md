...
-   The interface stubs implement [**IRpcStubBuffer**](https://msdn.microsoft.com/library/ms678504(v=VS.85).aspx), not [**IRpcProxyBuffer**](https://msdn.microsoft.com/library/ms693743(v=VS.85).aspx).
...
The following diagram shows the structure of the stub. Each interface stub is connected to an interface on the object. The channel dispatches incoming messages to the appropriate interface stub. All the components talk to the channel through [**IRpcChannelBuffer**](https://msdn.microsoft.com/library/ms679738(v=VS.85).aspx), the interface that provides access to the RPC run-time library.
