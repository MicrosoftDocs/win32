...
| [**FileType**](filetype-key.md)                                               | Used by [**GetClassFile**](/windows/win32/Objbase/nf-objbase-getclassfile?branch=master) to match patterns against various file bytes in a non-compound file. |
