...
The lifetime of pointers to interfaces is always managed through the [**AddRef**](/windows/desktop/api) and [**Release**](/windows/desktop/api) methods on every COM interface. For more information, see [Rules for Managing Reference Counts](rules-for-managing-reference-counts.md).
