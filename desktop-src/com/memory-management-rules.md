...
The lifetime of pointers to interfaces is always managed through the [**AddRef**](/windows/desktop/api/unknwnbase/nf-unknwn-iunknown-addref) and [**Release**](/windows/desktop/api/unknwnbase/nf-unknwn-iunknown-release) methods on every COM interface. For more information, see [Rules for Managing Reference Counts](rules-for-managing-reference-counts.md).
