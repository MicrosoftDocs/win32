...
-   Use MIDL to generate a type library that the system uses to provide marshaling support at run time. This is the easiest way to implement marshaling support. All you have to do is generate a type library and register it. Your interfaces must be Automation-compatible (either [**oleautomation**](https://msdn.microsoft.com/library/windows/desktop/aa367129) or [**dual**](https://msdn.microsoft.com/library/windows/desktop/aa366807)), which places some restrictions on the kinds of data types you can use as method parameters. However, in most cases, the advantage of having your interfaces accessible to programs written in other languages, such as Microsoft Visual Basic and Java, outweighs the limitations on data types.
