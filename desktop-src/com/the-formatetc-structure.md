...
| **ptd**<br/>      | A [**DVTARGETDEVICE**](/windows/desktop/api/ObjIdl/ns-objidl-tagdvtargetdevice) structure, which contains enough information about a Windows target device, such as a screen or printer, so that a handle to its device context (hDC) can be created using the [**CreateDC**](https://msdn.microsoft.com/library/windows/desktop/dd183490) function. <br/> |
