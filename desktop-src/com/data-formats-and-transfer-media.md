...
To alleviate these problems, COM provides two data structures: [**FORMATETC**](/windows/desktop/api/ObjIdl/ns-objidl-tagformatetc) and [**STGMEDIUM**](/windows/desktop/api/ObjIdl/ns-objidl-tagstgmedium). For more information, see the following topics:
