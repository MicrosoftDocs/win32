...
You can use the [**OpenProcessToken**](https://msdn.microsoft.com/library/windows/desktop/aa379295) function to get a handle to the primary token of a process. Use the [**OpenThreadToken**](https://msdn.microsoft.com/library/windows/desktop/aa379296) function to get a handle to the impersonation token of a thread.
