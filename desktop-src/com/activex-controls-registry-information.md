...
The **DefaultIcon** entry is used to identify an icon to be displayed when the control is minimized to an icon. The [**ExtractIcon**](https://www.bing.com/search?q=**ExtractIcon**) function is used to get the icon from the .DLL or .EXE file specified.
