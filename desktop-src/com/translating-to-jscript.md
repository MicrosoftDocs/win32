...
For more information about JScript, see the JScript Language Reference. For more information see the [ECMA 262 language specification](http://go.microsoft.com/fwlink/p/?linkid=103812).
