...
The server must implement code for a class object through an implementation of either the [**IClassFactory**](/windows/desktop/api) or [**IClassFactory2**](/windows/desktop/api/OCIdl/nn-ocidl-iclassfactory2) interface.
