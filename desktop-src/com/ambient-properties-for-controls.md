...
| DisplayAsDefault<br/> | -713<br/> | Only if the control is marked OLEMISC\_ACTSLIKEBUTTON (which means that support for keyboard mnemonics is provided, thus [**IOleControl::GetControlInfo**](iolecontrol-getcontrolinfo.md) and [**IOleControl::OnMnemonic**](iolecontrol-onmnemonic.md) must be implemented).<br/> |



 

As described previously, use of ambients requires both [**IOleControl**](iolecontrol.md) (for [**OnAmbientPropertyChange**](iolecontrol-onambientpropertychange.md) as a minimum) as well as [**IOleObject**](ioleobject.md) (for [**SetClientSite**](ioleobject-setclientsite.md) and [**GetClientSite**](ioleobject-getclientsite.md)).
