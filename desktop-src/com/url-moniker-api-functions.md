...
-   Be familiar with [**CreateURLMoniker**](https://www.bing.com/search?q=**CreateURLMoniker**) and [**IsValidURL**](https://www.bing.com/search?q=**IsValidURL**) if you will be using URL monikers in stand-alone applications. If you are authoring an ActiveX control, you should use [**IBindHost::CreateMoniker**](https://msdn.microsoft.com/windows/desktop/45e7247f-c611-4a6a-a630-3c20c3581a7d) instead of **CreateURLMoniker**.
