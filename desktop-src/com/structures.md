...
-   [**CALLFRAME\_MARSHALCONTEXT**](/windows/desktop/api/callobj/ns-callobj-__midl_icallframe_0004)
...
-   [**MULTI\_QI**](https://msdn.microsoft.com/en-us/library/ms687289(v=VS.85).aspx)
...
-   [**SOLE\_AUTHENTICATION\_LIST**](https://msdn.microsoft.com/en-us/library/ms680039(v=VS.85).aspx)
