...
An ActiveX Control, by virtue of being a COM object, must have associated server code that supports control creation through [**IClassFactory**](/windows/desktop/api/unknwnbase/nn-unknwn-iclassfactory) as a minimum.
