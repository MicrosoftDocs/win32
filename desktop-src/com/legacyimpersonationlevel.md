...
keywords: ["LegacyImpersonationLevel registry value COM"]
---

# LegacyImpersonationLevel

Sets the default level of impersonation for applications that do not call [**CoInitializeSecurity**](coinitializesecurity.md).
