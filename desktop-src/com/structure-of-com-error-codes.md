...
| FACILITY\_STORAGE<br/>  | 3<br/> | For status codes returned from [**IStorage**](https://msdn.microsoft.com/library/windows/desktop/aa380015) or [**IStream**](https://msdn.microsoft.com/library/windows/desktop/aa380034) method calls relating to structured storage. Status codes whose code (lower 16 bits) value is in the range of MS-DOS error codes (that is, less than 256) have the same meaning as the corresponding MS-DOS error. <br/> |
