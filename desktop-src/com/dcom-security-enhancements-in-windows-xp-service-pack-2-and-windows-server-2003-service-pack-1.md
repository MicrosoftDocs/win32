...
| **InvalidSecurityDescriptorLoggingLevel**<br/>                                                 | **HKEY\_LOCAL\_MACHINE\\SOFTWARE\\ Microsoft\\Ole**<br/>                                                 | Not applicable.<br/>                                                                                                                                                                 | This registry key is not present; however, a missing key or value is interpreted asÂ 1.<br/> This event is logged by default. It should rarely occur.<br/>                                                                                                                                                                                                    | 1 - Always log event log failures when the COM infrastructure finds an invalid security descriptor.<br/> 2 - Never log event log failures when the COM infrastructure finds an invalid security descriptor.<br/> |
