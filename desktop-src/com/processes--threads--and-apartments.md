...
The thread scheduler determines when and how often to execute a thread, according to a combination of the process's priority class attribute and the thread's base priority. You set a process's priority class attribute by calling the [**SetPriorityClass**](https://msdn.microsoft.com/library/windows/desktop/ms686219) function , and you set a thread's base priority with a call to [**SetThreadPriority**](https://msdn.microsoft.com/library/windows/desktop/ms686277).
