...
| [**IFontDisp**](https://msdn.microsoft.com/en-us/library/ms692695(v=VS.85).aspx)                        | Exposes a font object's properties through Automation. It provides a subset of the [**IFont**](/windows/desktop/api/OCIdl/nn-ocidl-ifont) methods.                                                                                           |
...
| [**IPictureDisp**](https://msdn.microsoft.com/en-us/library/ms680762(v=VS.85).aspx)                  | Exposes the picture object's properties through Automation. It provides a subset of the functionality available through [**IPicture**](/windows/desktop/api/OCIdl/nn-ocidl-ipicture) methods.                                                |
