...
| CATID\_RequiresDataPathHost<br/>                                                                                                                                                             | The object requires the ability to save data to one or more paths and requires container involvement, therefore requiring container support for [**IBindHost**](_inet_IBindHost_Interface_cpp).<br/>                                                                                                                                  |
