...
Several of the persistent object interfaces, [**IPersistStreamInit**](/windows/desktop/api/OCIdl/nn-ocidl-ipersiststreaminit), [**IPersistStorage**](/windows/desktop/api/ObjIdl/nn-objidl-ipersiststorage), [IPersistMemory](https://go.microsoft.com/fwlink/p/?linkid=103726), and [IPersistPropertyBag](https://go.microsoft.com/fwlink/p/?linkid=103727), allow clients to initialize objects to a "fresh" or "default" state. This initial state is different from that of a newly created object, which has no state.
