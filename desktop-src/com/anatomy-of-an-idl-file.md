...
The IDL [**import**](https://msdn.microsoft.com/library/windows/desktop/aa367047) statement is used here to bring in a header file, Mydefs.h, which contains user-defined types, and Unknwn.idl, which contains the definition of [**IUnknown**](/windows/desktop/api/Unknwn/nn-unknwn-iunknown), from which IFace1 and IFace2 derive.
...
The [**interface**](https://msdn.microsoft.com/library/windows/desktop/aa367054) keyword defines the interface name. All object interfaces must derive, directly or indirectly, from [**IUnknown**](/windows/desktop/api/Unknwn/nn-unknwn-iunknown).
