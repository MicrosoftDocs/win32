...
The [**IVBFormat**](ivbformat.md) interface allows controls to better integrate into the Visual Basic environment when formatting data.

CATID - {02496840-3AC4-11cf-87B9-00AA006C8166} CATID\_VBFormat

The [**IVBGetControl**](ivbgetcontrol.md) interface allows a control to enumerate other controls on the VB form.

CATID - {02496841-3AC4-11cf-87B9-00AA006C8166} CATID\_VBGetControl

Two additional private interfaces, [**IGetVBAObject**](igetvbaobject.md) and [**IGetOleObject**](igetoleobject.md), are described here even though they do not define component categories. Use of these four interfaces is not recommended because they are not supported by containers other than Visual Basic.
