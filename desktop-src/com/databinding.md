...
The new ImmediateBind bit maps through to the new VARFLAG\_FIMMEDIATEBIND (0x80) and the FUNCFLAG\_FIMMEDIATEBIND (0x80) bits in the VARFLAGS and FUNCFLAGS enumerations for the [ITypeInfo](https://msdn.microsoft.com/library/ms221696.aspx) interface allowing for the properties attributes to be inspected.
