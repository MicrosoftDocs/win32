...
For more information about activation security, see [**COAUTHINFO**](/windows/desktop/api/wtypesbase/ns-wtypesbase-_coauthinfo) and [**COSERVERINFO**](/windows/desktop/api).
