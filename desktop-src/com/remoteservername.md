...
As described in the documentation for the [**CLSCTX**](/windows/desktop/api/WTypes/ne-wtypesbase-tagclsctx) enumeration and the [**COSERVERINFO**](/windows/desktop/api/objidlbase/ns-objidl-_coserverinfo) structure, one of the parameters of the distributed COM activation is a pointer to a **COSERVERINFO** structure. When this value is not **NULL**, the information in the **COSERVERINFO** structure overrides the setting of the **RemoteServerName** key for the function call.
