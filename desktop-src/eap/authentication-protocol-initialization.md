...
If the [**RasEapBegin**](https://msdn.microsoft.com/library/Aa363520(v=VS.85).aspx) call returns any value other than **NO\_ERROR**, the session is disconnected. The returned error is logged (on the server), or displayed to the user (on the client).
