...
| [**IAudioBass**](/windows/desktop/api/Devicetopology/)                           | Provides access to a hardware bass-level control.                                                                                                                                                                         |
...
| [**IAudioMidrange**](/windows/desktop/api/Devicetopology/)                   | Provides access to a hardware midrange-level control.                                                                                                                                                                     |
...
| [**IAudioTreble**](/windows/desktop/api/Devicetopology/)                       | Provides access to a hardware treble-level control.                                                                                                                                                                       |
| [**IAudioVolumeLevel**](/windows/desktop/api/Devicetopology/)             | Provides access to a hardware volume control.                                                                                                                                                                             |
...
| [**ISubunit**](/windows/desktop/api/Devicetopology/)                               | Represents a hardware subunit (for example, a volume-level control) that lies in the data path between a client and an audio endpoint device.                                                                             |
