...
<li>Windows 7 provides better device role detection when a new device is added to the system. For more information, see <a href="device-roles-in-windows-vista">Working with Device Roles</a>.</li>
...
For more information about the improvements, see <a href="protected-user-mode-audio--puma-">Protected User Mode Audio (PUMA)</a>.<br/></td>
</tr>
<tr class="even">
...
<td>New samples have been added to the Windows SDK that demonstrate the use of the Core Audio APIs. For more information, see <a href="sdk-samples-that-use-the-core-audio-apis">SDK Samples That Use the Core Audio APIs</a>.</td>
</tr>
</tbody>
</table>
