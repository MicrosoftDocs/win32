...
-   [**IAudioEndpointVolume::GetChannelVolumeLevel**](iaudioendpointvolume-getchannelvolumelevel.md)
-   [**IAudioEndpointVolume::GetMasterVolumeLevel**](iaudioendpointvolume-getmastervolumelevel.md)
...
These methods produce an approximately linear relationship between volume setting and perceived loudness. The volume range in decibels of the volume controls that are managed by these methods depends on the audio endpoint device. To determine the volume range for a particular device, call the [**IAudioEndpointVolume::GetVolumeRange**](iaudioendpointvolume-getvolumerange.md) method.
...
-   [**IAudioEndpointVolume::GetChannelVolumeLevelScalar**](iaudioendpointvolume-getchannelvolumelevelscalar.md)
-   [**IAudioEndpointVolume::GetMasterVolumeLevelScalar**](iaudioendpointvolume-getmastervolumelevelscalar.md)
