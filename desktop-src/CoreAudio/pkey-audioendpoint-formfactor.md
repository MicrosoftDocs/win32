...
title: PKEY\_AudioEndpoint\_FormFactor
ms.date: 05/31/2018
ms.topic: article
...
The **uintVal** member of the **PROPVARIANT** structure contains an enumeration value that is cast to type UINT. It is set to one of the following [**EndpointFormFactor**](/windows/win32/Mmdeviceapi/ne-mmdeviceapi-__midl___midl_itf_mmdeviceapi_0000_0000_0003?branch=master) enumeration values:
