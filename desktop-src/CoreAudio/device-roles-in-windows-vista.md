...
The [MMDevice API](mmdevice-api.md) supports device roles. The [**ERole**](/windows/win32/Mmdeviceapi/ne-mmdeviceapi-__midl___midl_itf_mmdeviceapi_0000_0000_0002?branch=master) enumeration defines the device roles that are supported by the MMDevice API.
...
An application can also get jack information by using the Core Audio APIs. For more information, see [**IKsJackDescription**](/windows/win32/Devicetopology/nn-devicetopology-iksjackdescription?branch=master) and [**IKsJackDescription2**](/windows/win32/Devicetopology/nn-devicetopology-iksjackdescription2?branch=master).
