...
6.  Send the KS property request to the audio driver by calling the [**IKsControl::KsProperty**](https://www.bing.com/search?q=**IKsControl::KsProperty**) method. For more information about this method, see the Windows DDK documentation.
