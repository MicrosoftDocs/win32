...
| [**IAudioBass**](https://msdn.microsoft.com/en-us/library/Dd370857(v=VS.85).aspx)                           | KSPROPERTY\_AUDIO\_BASS            |
...
| [**IAudioMidrange**](https://msdn.microsoft.com/en-us/library/Dd368232(v=VS.85).aspx)                   | KSPROPERTY\_AUDIO\_MID             |
...
| [**IAudioTreble**](https://msdn.microsoft.com/en-us/library/Dd371001(v=VS.85).aspx)                       | KSPROPERTY\_AUDIO\_TREBLE          |
| [**IAudioVolumeLevel**](https://msdn.microsoft.com/en-us/library/Dd371019(v=VS.85).aspx)             | KSPROPERTY\_AUDIO\_VOLUMELEVEL     |
...
The first three properties in this list can be accessed through the control interfaces that appear in the preceding table, but the KSPROPERTY\_AUDIO\_BASS\_BOOST property has no corresponding control interface in the DeviceTopology API. However, an application can use the [**IKsControl**](https://msdn.microsoft.com/en-us/library/Ff559766(v=VS.85).aspx) interface to access this property, if the subunit supports the property.
...
6.  Send the KS property request to the audio driver by calling the [**IKsControl::KsProperty**](https://msdn.microsoft.com/en-us/library/Ff559792(v=VS.85).aspx) method. For more information about this method, see the Windows DDK documentation.
