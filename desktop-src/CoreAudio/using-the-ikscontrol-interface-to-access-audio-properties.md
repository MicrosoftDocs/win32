...
| [**IAudioBass**](/windows/desktop/api/Devicetopology/)                           | KSPROPERTY\_AUDIO\_BASS            |
...
| [**IAudioMidrange**](/windows/desktop/api/Devicetopology/)                   | KSPROPERTY\_AUDIO\_MID             |
...
| [**IAudioTreble**](/windows/desktop/api/Devicetopology/)                       | KSPROPERTY\_AUDIO\_TREBLE          |
| [**IAudioVolumeLevel**](/windows/desktop/api/Devicetopology/)             | KSPROPERTY\_AUDIO\_VOLUMELEVEL     |
...
The first three properties in this list can be accessed through the control interfaces that appear in the preceding table, but the KSPROPERTY\_AUDIO\_BASS\_BOOST property has no corresponding control interface in the DeviceTopology API. However, an application can use the [**IKsControl**](https://msdn.microsoft.com/d73cf2fc-15bb-4f45-aae3-fb55bcd072a3) interface to access this property, if the subunit supports the property.
...
6.  Send the KS property request to the audio driver by calling the [**IKsControl::KsProperty**](https://msdn.microsoft.com/cc43f704-e1f8-4d62-8cdf-11575ec0b473) method. For more information about this method, see the Windows DDK documentation.
