...
-   A function-specific interface (for example, [**IAudioVolumeLevel**](https://msdn.microsoft.com/library/Dd371019(v=VS.85).aspx)) that exposes the control parameters for a particular type of hardware control (for example, a volume control).
...
-   [**IAudioBass**](https://msdn.microsoft.com/library/Dd370857(v=VS.85).aspx)
...
-   [**IAudioMidrange**](https://msdn.microsoft.com/library/Dd368232(v=VS.85).aspx)
...
-   [**IAudioTreble**](https://msdn.microsoft.com/library/Dd371001(v=VS.85).aspx)
-   [**IAudioVolumeLevel**](https://msdn.microsoft.com/library/Dd371019(v=VS.85).aspx)
