...
1.  Calls the [**IAudioRenderClient::GetBuffer**](iaudiorenderclient-getbuffer.md) method to get the next buffer.
2.  Fills the buffer.
3.  Calls the [**IAudioRenderClient::ReleaseBuffer**](iaudiorenderclient-releasebuffer.md) method to release the buffer.
