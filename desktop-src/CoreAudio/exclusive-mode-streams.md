...
1.  Calls the [**IAudioRenderClient::GetBuffer**](/windows/win32/Audioclient/nf-audioclient-iaudiorenderclient-getbuffer?branch=master) method to get the next buffer.
2.  Fills the buffer.
3.  Calls the [**IAudioRenderClient::ReleaseBuffer**](/windows/win32/Audioclient/nf-audioclient-iaudiorenderclient-releasebuffer?branch=master) method to release the buffer.
