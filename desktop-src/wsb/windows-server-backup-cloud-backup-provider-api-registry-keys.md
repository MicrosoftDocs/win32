...
A cloud backup provider must register or de-register with the Windows Server Backup feature using the [**RegisterOnlineBackupWithWindowsServerBackup**](registeronlinebackupwithwindowsserverbackup.md) and [**DeregisterOnlineBackupFromWindowsServerBackup**](deregisteronlinebackupfromwindowsserverbackup.md) functions. The registry keys should not be manually modified.
