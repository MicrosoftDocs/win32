...
keywords: ["DDCCIGetVCPFeature function Monitor Configuration"]
topic_type:
- apiref
api_name:
- DDCCIGetVCPFeature
...
Receives the VCP code type, as a member of the [**MC\_VCP\_CODE\_TYPE**](mc-vcp-code-type.md) enumeration.
...
Applications should call [**GetVCPFeatureAndVCPFeatureReply**](getvcpfeatureandvcpfeaturereply.md) instead of calling this function.
