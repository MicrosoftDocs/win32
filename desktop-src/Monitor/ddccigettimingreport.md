...
A pointer to an [**MC\_TIMING\_REPORT**](/windows/win32/LowLevelMonitorConfigurationAPI/ns-lowlevelmonitorconfigurationapi-_mc_timing_report?branch=master) structure that receives the timing information.
...
Applications should call [**GetTimingReport**](/windows/win32/LowLevelMonitorConfigurationAPI/nf-lowlevelmonitorconfigurationapi-gettimingreport?branch=master) instead of calling this function.
