...
keywords: ["DDCCIGetTimingReport function Monitor Configuration"]
topic_type:
- apiref
api_name:
...
A pointer to an [**MC\_TIMING\_REPORT**](mc-timing-report.md) structure that receives the timing information.
...
Applications should call [**GetTimingReport**](gettimingreport.md) instead of calling this function.
