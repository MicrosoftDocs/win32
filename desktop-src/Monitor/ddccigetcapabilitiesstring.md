...
keywords: ["DDCCIGetCapabilitiesString function Monitor Configuration"]
topic_type:
- apiref
api_name:
...
Applications should call [**CapabilitiesRequestAndCapabilitiesReply**](capabilitiesrequestandcapabilitiesreply.md) instead of calling this function.
