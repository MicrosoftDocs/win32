...
keywords: ["DestroyPhysicalMonitorInternal function Monitor Configuration"]
topic_type:
- apiref
api_name:
...
Applications should call [**DestroyPhysicalMonitor**](destroyphysicalmonitor.md) instead of calling this function.
