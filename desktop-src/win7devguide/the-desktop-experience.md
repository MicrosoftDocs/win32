...
Templates and markup authoring are available to developers for rapid development and integration of Ribbon functionality. (See [Windows Ribbon Framework](http://go.microsoft.com/?linkid=9669714) and [Windows Ribbon Framework: Developer Resources](http://go.microsoft.com/?linkid=9669715).)
