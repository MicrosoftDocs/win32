...
[Media Foundation](https://msdn.microsoft.com/library/windows/desktop/ms694197) and [DirectShow](https://msdn.microsoft.com/library/windows/desktop/dd375454) provide the basis for media support in Windows. Media Foundation was introduced in Windows Vista as the replacement for DirectShow. In Windows 7, Media Foundation has been enhanced to provide better format support, including *MPEG-4*, as well as support for video capture devices and hardware codecs.
...
[Media Foundation](https://msdn.microsoft.com/library/windows/desktop/ms694197) now supports the following types of hardware devices in the audio/video pipeline:
...
In Windows Vista, [Media Foundation](https://msdn.microsoft.com/library/windows/desktop/ms694197) exposed a relatively low-level set of APIs. These APIs are flexible, but may not be appropriate for performing tasks. Windows 7 adds new high-level APIs that make it simpler to write media applications in *C++*. These new high-level APIs include:
...
Windows 7 includes numerous enhancements to the underlying [Media Foundation](https://msdn.microsoft.com/library/windows/desktop/ms694197) platform APIs. Advanced applications can use these APIs directly; other applications will get the benefits indirectly. These benefits include:
