...
keywords: ["Windows error reporting Windows Error Reporting , what's new"]
---
...
-   Adds the ability to register an out-of-process exception handler that WER calls when a crash occurs to collect the event name, reporting parameters, and debug launching options. For details, see the [**WerRegisterRuntimeExceptionModule**](werregisterruntimeexceptionmodule.md) function.

Functions that were added:

-   [**OutOfProcessExceptionEventCallback**](outofprocessexceptioneventcallback.md)
-   [**OutOfProcessExceptionEventSignatureCallback**](outofprocessexceptioneventsignaturecallback.md)
-   [**OutOfProcessExceptionEventDebuggerLaunchCallback**](outofprocessexceptioneventdebuggerlaunchcallback.md)
-   [**RaiseFailFastException**](https://msdn.microsoft.com/library/windows/desktop/dd941688)
-   [**WerRegisterRuntimeExceptionModule**](werregisterruntimeexceptionmodule.md)
-   [**WerUnregisterRuntimeExceptionModule**](werunregisterruntimeexceptionmodule.md)

Structures that were added:

-   [**WER\_RUNTIME\_EXCEPTION\_INFORMATION**](wer-runtime-exception-information.md)
