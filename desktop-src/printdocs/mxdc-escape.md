...
To determine if the printer driver is the MXDC, call [**ExtEscape**](/windows/desktop/api/Wingdi/nf-wingdi-extescape) with the [**GETTECHNOLOGY**](https://msdn.microsoft.com/en-us/library/Dd144931(v=VS.85).aspx) escape. If the driver is the MXDC, the **ExtEscape** will return the zero-terminated string, "https://schemas.microsoft.com/xps/2005/06". Be sure the buffer referenced by the *lpszOutData* parameter is large enough to hold this string.
...
[Printer Escape Functions](https://msdn.microsoft.com/en-us/library/Dd162843(v=VS.85).aspx)
</dt> <dt>
