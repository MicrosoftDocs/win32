...
![a diagram that shows the relationship of the print spooler api to the other print apis that a native windows application can use](https://www.bing.com/search?q=a diagram that shows the relationship of the print spooler api to the other print apis that a native windows application can use)
