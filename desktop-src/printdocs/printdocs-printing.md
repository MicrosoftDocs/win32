...
<tbody>
<tr class="odd">
<td>[Print Document Package API](https://www.bing.com/search?q=Print Document Package API)<br/></td>
...
<blockquote>
[!Note]<br />
Developers who are writing applications for Windows Vista and later versions of Windows should consider using the [XPS Document API](https://www.bing.com/search?q=XPS Document API) in their application.
</blockquote>
...
![a diagram that shows how a native windows application can use the print apis](https://www.bing.com/search?q=a diagram that shows how a native windows application can use the print apis)

 

The [Print Document Package API](https://www.bing.com/search?q=Print Document Package API)s in this section describe the print document package and print preview interfaces that you can use with Windows 8 and later versions of Windows desktop.
