...
2.  Display the **Print** common dialog box.
    ...
    Call [**PrintDlg**](https://www.bing.com/search?q=**PrintDlg**) with the initialized [**PRINTDLG**](https://msdn.microsoft.com/library/windows/desktop/ms646843) structure to display the **Print** common dialog box and collect the user data, as shown in the following code example.
