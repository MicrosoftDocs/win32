...
The PrintTicket and PrintCapabilities are described by using elements of the Print Schema, which is defined by the [Print Schema Specification](http://go.microsoft.com/?linkid=7141496).
...
![a diagram that shows the relationship of the print ticket api to the other print apis that a native windows application can use](https://www.bing.com/search?q=a diagram that shows the relationship of the print ticket api to the other print apis that a native windows application can use)
