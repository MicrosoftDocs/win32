---
description: Learn about the PageTrueTypeFontMode user-configurable element. This topic isn't current. For the most current information, see the Print Schema Specification.
