---
description: Learn about the DocumentCoverFront user-configurable element. This topic isn't current. For the most current information, see the Print Schema Specification.
