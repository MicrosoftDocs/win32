...
|                                                                                                                |                                                                                                                                                                                                                                                                                                                          |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [XPS Document API](https://www.bing.com/search?q=XPS Document API)<br/>                                                        | The [XPS Document API](https://www.bing.com/search?q=XPS Document API) lets you create XPS documents from your Win32 program and save them as a document file or send them directly to a printer.<br/> You can also use the [XPS Document API](https://www.bing.com/search?q=XPS Document API) to modify existing XPS documents in a Win32 program.<br/> |
| [XPS Digital Signature API](https://www.bing.com/search?q=XPS Digital Signature API)<br/>                                      | The [XPS Digital Signature API](https://www.bing.com/search?q=XPS Digital Signature API) lets you add digital signatures to XPS documents from your Win32 program.<br/> You can also use the XPS Digital Signature API to verify whether an XPS document is authentic and unaltered.<br/>                                          |
...
[XPS Digital Signature API](https://www.bing.com/search?q=XPS Digital Signature API)
</dt> <dt>
