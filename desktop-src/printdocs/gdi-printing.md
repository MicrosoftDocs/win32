...
If you write applications for Windows Vista or later versions of Windows, consider using the [XPS Document API](https://www.bing.com/search?q=XPS+Document+API) and the [XPS Print API](xps-printing.md) to use the higher-performance graphics interfaces that are supported by XPSDrv print drivers.
...
![a diagram that shows the relationship of the gdi print api to the other print apis that a win32 application can use](https://www.bing.com/search?q=a+diagram+that+shows+the+relationship+of+the+gdi+print+api+to+the+other+print+apis+that+a+win32+application+can+use)
...
[XPS Document API](https://www.bing.com/search?q=XPS+Document+API)
</dt> <dt>
