...
Native Windows applications that create XPS documents, such as by using the [XPS Document API](https://www.bing.com/search?q=XPS+Document+API), can use the XPS Print API to send XPS document content to a printer.
...
![a diagram that shows the relationship of the xps print api to the other print apis that a native windows application can use](https://www.bing.com/search?q=a+diagram+that+shows+the+relationship+of+the+xps+print+api+to+the+other+print+apis+that+a+native+windows+application+can+use)
