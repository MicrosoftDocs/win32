---
description: Learn about the PageOutputColor user-configurable element. This topic isn't current. For the most current information, see the Print Schema Specification.
...
| \_DeviceBitsPerPixelValue\_<br/> | integer<br/> | bits per pixel<br/> | Greater than 0, less than maximum device support value.<br/>                                                                                                                    | Numeric value indicating the number of bits per pixel of color data supported by the printer.<br/>                          |
| \_DriverBitsPerPixelValue\_<br/> | integer<br/> | bits per pixel<br/> | Greater than 0, less than maximum device support value.<br/>                                                                                                                    | Numeric value indicating the number of bits per pixel that the core driver should use for its bitmap rendering buffer.<br/> |
