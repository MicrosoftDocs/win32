...
|------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|-----------|-------------|
| [**PTConvertPrintTicketToDevMode**](/windows/desktop/api/prntvpt/nf-prntvpt-ptconvertprinttickettodevmode) | Converts a print ticket to a [**DEVMODE**](/windows/desktop/api/Wingdi/ns-wingdi-_devicemodea) structure.                                                                            | Prntvpt.h | Prntvpt.lib |
| [**PTConvertDevModeToPrintTicket**](/windows/desktop/api/prntvpt/nf-prntvpt-ptconvertdevmodetoprintticket) | Converts a [**DEVMODE**](/windows/desktop/api/Wingdi/ns-wingdi-_devicemodea) to a print ticket.                                                                                      | Prntvpt.h | Prntvpt.lib |
...
| [**PTOpenProviderEx**](/windows/desktop/api/prntvpt/nf-prntvpt-ptopenproviderex)                           | Opens a print ticket provider, even if it does not support the preferred version of the [Print Schema](https://msdn.microsoft.com/windows/desktop/d746bdd1-96c2-41f5-ad99-0b51c8ee8731). | Prntvpt.h | Prntvpt.lib |
...
| [**PTQuerySchemaVersionSupport**](/windows/desktop/api/prntvpt/nf-prntvpt-ptqueryschemaversionsupport)     | Gets the latest version of the [Print Schema](https://msdn.microsoft.com/windows/desktop/d746bdd1-96c2-41f5-ad99-0b51c8ee8731) that a specified printer supports.                        | Prntvpt.h | Prntvpt.lib |
...
|----------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| [**EDefaultDevmodeType**](/windows/desktop/api/prntvpt/ne-prntvpt-tagedefaultdevmodetype) | Enables callers to specify which [**DEVMODE**](/windows/desktop/api/Wingdi/ns-wingdi-_devicemodea) is used as the source of default values when a print ticket does not specify all the settings that might be in a **DEVMODE**. | Prntvpt.h |
