...
\[The interfaces described in this section are deprecated. Client applications should use the [Print Document Package API](https://www.bing.com/search?q=Print+Document+Package+API) instead.\]
...
[Documents](https://www.bing.com/search?q=Documents)
</dt> <dt>
