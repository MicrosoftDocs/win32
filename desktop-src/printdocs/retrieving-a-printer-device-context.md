...
You can choose from two **Print** common dialog boxes to display to a user; the newer dialog box, which you can display by calling the [**PrintDlgEx**](https://msdn.microsoft.com/library/ms646942(v=VS.85).aspx) function, and the older style dialog box, which you can display by calling the [**PrintDlg**](https://msdn.microsoft.com/library/ms646940(v=VS.85).aspx) function. The following sections describe how to call each dialog box from an application.

### Using the PrintDlgEx Function

Call the [**PrintDlgEx**](https://msdn.microsoft.com/library/ms646942(v=VS.85).aspx) function to display the **Print** property sheet. By using the property sheet, the user can specify information about the print job. For example, the user can select a range of pages to print, the number of copies, and so on. The **PrintDlgEx** can also retrieve a handle to a device context for the selected printer. You can use the handle to render output on the printer.

For sample code that illustrates the use of [**PrintDlgEx**](https://msdn.microsoft.com/library/ms646942(v=VS.85).aspx) to retrieve a printer device context, see "Using the Print Property Sheet" in [Using Common Dialog Boxes](https://msdn.microsoft.com/library/ms646829(v=VS.85).aspx).
...
For more information about the [**PrintDlg**](https://msdn.microsoft.com/library/ms646940(v=VS.85).aspx) function, see "Displaying the Print Dialog Box" in [Using Common Dialog Boxes](https://msdn.microsoft.com/library/ms646829(v=VS.85).aspx).
