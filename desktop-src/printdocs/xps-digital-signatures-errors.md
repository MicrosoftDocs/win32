...
| <span id="XPS_E_MARKUP_COMPATIBILITY_ELEMENTS"></span><span id="xps_e_markup_compatibility_elements"></span><dl> <dt>**XPS\_E\_MARKUP\_COMPATIBILITY\_ELEMENTS**</dt> <dt>0x80520389</dt> </dl> | The [**XPS\_SIGN\_FLAGS**](/windows/desktop/api/xpsdigitalsignature/ne-xpsdigitalsignature-__midl___midl_itf_xpsdigitalsignature_0000_0000_0003) value specified that no markup compatibility elements were expected; however, markup compatibility elements were found.<br/> |
...
Some XPS digital signature API methods make calls to the [Packaging](https://msdn.microsoft.com/library/windows/desktop/dd371623) API. For information about the Packaging API return values, see [Packaging Errors](https://msdn.microsoft.com/library/windows/desktop/dd371632).
...
[Packaging Errors](https://msdn.microsoft.com/library/windows/desktop/dd371632)
</dt> <dt>

[Cryptography Return Values](https://msdn.microsoft.com/library/windows/desktop/aa380257)
</dt> </dl>
