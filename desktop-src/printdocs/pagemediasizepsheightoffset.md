---
description: Get information about the PageMediaSizePSHeightOffset parameter. This topic isn't current. For the most current information, see the Print Schema Specification.
