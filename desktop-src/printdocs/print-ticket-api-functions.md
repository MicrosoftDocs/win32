...
| [**PTConvertDevModeToPrintTicket**](/windows/desktop/api/prntvpt/nf-prntvpt-ptconvertdevmodetoprintticket)<br/>         | Converts a [**DEVMODE**](/windows/desktop/api/Wingdi/ns-wingdi-_devicemodea) structure to a print ticket inside an [**IStream**](https://docs.microsoft.com/windows/desktop/Stg/istream-compound-file-implementation).<br/>        |
...
| [**PTGetPrintCapabilities**](/windows/desktop/api/prntvpt/nf-prntvpt-ptgetprintcapabilities)<br/>                       | Retrieves the printer's capabilities formatted in compliance with the XML [Print Schema](https://msdn.microsoft.com/en-us/library/Dd372919(v=VS.85).aspx).<br/>                   |
| [**PTGetPrintDeviceCapabilities**](https://msdn.microsoft.com/en-us/library/Mt784458(v=VS.85).aspx)<br/>    | Retrieves the device printer's capabilities formatted in compliance with the XML [Print Schema](https://msdn.microsoft.com/en-us/library/Dd372919(v=VS.85).aspx).<br/>            |
| [**PTGetPrintDeviceResources**](https://msdn.microsoft.com/en-us/library/Mt784459(v=VS.85).aspx)<br/>          | It retrieves the print devices resources for a printer formatted in compliance with the XML [Print Schema](https://msdn.microsoft.com/en-us/library/Dd372919(v=VS.85).aspx).<br/> |
...
| [**PTQuerySchemaVersionSupport**](/windows/desktop/api/prntvpt/nf-prntvpt-ptqueryschemaversionsupport)<br/>             | Retrieves the highest (latest) version of the [Print Schema](https://msdn.microsoft.com/en-us/library/Dd372919(v=VS.85).aspx) that the specified printer supports.<br/>           |
