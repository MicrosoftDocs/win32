...
The **MSFT\_MpThreat** class has these types of members:
...
The **MSFT\_MpThreat** class has these methods.



| Method                                 | Description    |
|:---------------------------------------|:---------------|
| [**Remove**](remove-msft-mpthreat.md) | TBD<br/> |
...
The **MSFT\_MpThreat** class has these properties.
