...
| [**EapHostPeerFreeErrorMemory**](https://msdn.microsoft.com/library/windows/desktop/aa363557)                                               | Frees memory allocated to an [**EAP\_ERROR**](/previous-versions/windows/desktop/api/eaptypes/ns-eaptypes-_eap_error) structure.                                                                                                                                                                                                              |
