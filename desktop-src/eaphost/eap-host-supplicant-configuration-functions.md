...
| [**EapHostPeerFreeErrorMemory**](https://docs.microsoft.com/previous-versions/windows/desktop/api/eaphostpeerconfigapis/nf-eaphostpeerconfigapis-eaphostpeerfreeerrormemory)                                               | Frees memory allocated to an [**EAP\_ERROR**](/previous-versions/windows/desktop/api/eaptypes/ns-eaptypes-_eap_error) structure.                                                                                                                                                                                                              |
