---
title: MSFT\_WmiProvider\_CreateClassEnumAsyncEvent\_Pre class
description: Represents an event generated immediately prior to calling the provider's implementation of IWbemServices CreateClassEnumAsync.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '99e3490e-4f6e-4910-acb7-3e93f0f712aa'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre class", "MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.TIME_CREATED
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.TransactionIdentifer
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.Flags
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.HostingGroup
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.HostingSpecification
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.Locale
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.Namespace
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.Provider
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.SuperclassName
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.TransactionIdentifier
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Pre.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_CreateClassEnumAsyncEvent\_Pre class

The **MSFT\_WmiProvider\_CreateClassEnumAsyncEvent\_Pre** event class represents an event generated immediately prior to calling the provider's implementation of [**IWbemServices::CreateClassEnumAsync**](https://msdn.microsoft.com/library/aa392096).
...
The **MSFT\_WmiProvider\_CreateClassEnumAsyncEvent\_Pre** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_CreateClassEnumAsyncEvent\_Pre** class has these properties.
