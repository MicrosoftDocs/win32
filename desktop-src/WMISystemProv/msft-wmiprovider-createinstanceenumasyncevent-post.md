---
title: MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Post class
description: Represents an event generated immediately following completion of the provider's implementation of IWbemServices CreateInstanceEnumAsync.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'd34b6b1b-f9a0-4f59-955e-11d2633ea662'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post class", "MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.TIME_CREATED
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.TransactionIdentifer
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.ClassName
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.Flags
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.HostingGroup
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.HostingSpecification
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.Locale
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.Namespace
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.ObjectParameter
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.Provider
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.ResultCode
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.StringParameter
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.TransactionIdentifier
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Post.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Post class

The **MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Post** event class represents an event generated immediately following completion of the provider's implementation of [**IWbemServices::CreateInstanceEnumAsync**](https://msdn.microsoft.com/library/aa392098).
...
The **MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Post** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Post** class has these properties.
...
Name of the class for which instances are desired.
