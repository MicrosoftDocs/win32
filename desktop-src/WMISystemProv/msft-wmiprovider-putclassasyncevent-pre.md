...
description: Represents an event generated immediately prior to calling the providers implementation of IWbemServices PutClassAsync.
audience: developer
...
keywords:
- MSFT_WmiProvider_PutClassAsyncEvent_Pre class
- MSFT_WmiProvider_PutClassAsyncEvent_Pre class, described
topic_type:
- apiref
api_name:
