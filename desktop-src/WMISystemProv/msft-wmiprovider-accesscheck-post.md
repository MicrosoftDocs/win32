---
title: MSFT\_WmiProvider\_AccessCheck\_Post class
description: Represents an event generated immediately following completion of the provider's implementation of IWbemEventProviderSecurity AccessCheck.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'de64f2ce-7676-4445-8367-9120374bd661'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_AccessCheck_Post class", "MSFT_WmiProvider_AccessCheck_Post class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_AccessCheck_Post
- MSFT_WmiProvider_AccessCheck_Post.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_AccessCheck_Post.TIME_CREATED
- MSFT_WmiProvider_AccessCheck_Post.TransactionIdentifer
- MSFT_WmiProvider_AccessCheck_Post.HostingGroup
- MSFT_WmiProvider_AccessCheck_Post.HostingSpecification
- MSFT_WmiProvider_AccessCheck_Post.Locale
- MSFT_WmiProvider_AccessCheck_Post.Namespace
- MSFT_WmiProvider_AccessCheck_Post.Provider
- MSFT_WmiProvider_AccessCheck_Post.Query
- MSFT_WmiProvider_AccessCheck_Post.QueryLanguage
- MSFT_WmiProvider_AccessCheck_Post.Result
- MSFT_WmiProvider_AccessCheck_Post.Sid
- MSFT_WmiProvider_AccessCheck_Post.TransactionIdentifier
- MSFT_WmiProvider_AccessCheck_Post.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_AccessCheck\_Post class

The **MSFT\_WmiProvider\_AccessCheck\_Post** event class represents an event generated immediately following completion of the provider's implementation of [**IWbemEventProviderSecurity::AccessCheck**](https://msdn.microsoft.com/library/aa391743).
...
The **MSFT\_WmiProvider\_AccessCheck\_Post** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_AccessCheck\_Post** class has these properties.
...
Array that represents the SID of the client that creates the subscription. This property is **NULL** if the subscription is temporary.
