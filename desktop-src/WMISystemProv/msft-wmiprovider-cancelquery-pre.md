---
title: MSFT\_WmiProvider\_CancelQuery\_Pre class
description: Represents an event generated immediately prior to calling the provider's implementation of IWbemEventProviderQuerySink CancelQuery.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '81e13b13-54b5-482e-8a9b-d547106aabe8'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_CancelQuery_Pre class", "MSFT_WmiProvider_CancelQuery_Pre class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_CancelQuery_Pre
- MSFT_WmiProvider_CancelQuery_Pre.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_CancelQuery_Pre.TIME_CREATED
- MSFT_WmiProvider_CancelQuery_Pre.TransactionIdentifer
- MSFT_WmiProvider_CancelQuery_Pre.HostingGroup
- MSFT_WmiProvider_CancelQuery_Pre.HostingSpecification
- MSFT_WmiProvider_CancelQuery_Pre.Locale
- MSFT_WmiProvider_CancelQuery_Pre.Namespace
- MSFT_WmiProvider_CancelQuery_Pre.Provider
- MSFT_WmiProvider_CancelQuery_Pre.QueryId
- MSFT_WmiProvider_CancelQuery_Pre.TransactionIdentifier
- MSFT_WmiProvider_CancelQuery_Pre.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_CancelQuery\_Pre class

The **MSFT\_WmiProvider\_CancelQuery\_Pre** event class represents an event generated immediately prior to calling the provider's implementation of [**IWbemEventProviderQuerySink::CancelQuery**](https://msdn.microsoft.com/library/aa391738).
...
The **MSFT\_WmiProvider\_CancelQuery\_Pre** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_CancelQuery\_Pre** class has these properties.
...
Holds the WMI-generated identifier for the query. This identifier was originally delivered to the provider by the [**NewQuery**](https://msdn.microsoft.com/library/aa391739) method of this interface.
