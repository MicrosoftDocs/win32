...
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.TIME_CREATED
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.TransactionIdentifer
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.Flags
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.HostingGroup
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.HostingSpecification
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.Locale
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.Namespace
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.ObjectPath
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.Provider
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.TransactionIdentifier
- MSFT_WmiProvider_DeleteInstanceAsyncEvent_Pre.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
The **MSFT\_WmiProvider\_DeleteInstanceAsyncEvent\_Pre** event class represents an event generated immediately prior to calling the provider's implementation of [**IWbemServices::DeleteInstanceAsync**](https://msdn.microsoft.com/library/aa392102).
...
The **MSFT\_WmiProvider\_DeleteInstanceAsyncEvent\_Pre** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_DeleteInstanceAsyncEvent\_Pre** class has these properties.
