---
title: MSFT\_WmiProvider\_InitializationOperationFailureEvent class
description: Defines the unsuccessful initialization of the provider server instance.
audience: developer
...
- MSFT_WmiProvider_InitializationOperationFailureEvent.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_InitializationOperationFailureEvent.TIME_CREATED
- MSFT_WmiProvider_InitializationOperationFailureEvent.TransactionIdentifer
- MSFT_WmiProvider_InitializationOperationFailureEvent.HostingGroup
- MSFT_WmiProvider_InitializationOperationFailureEvent.HostingSpecification
- MSFT_WmiProvider_InitializationOperationFailureEvent.Locale
- MSFT_WmiProvider_InitializationOperationFailureEvent.Namespace
- MSFT_WmiProvider_InitializationOperationFailureEvent.Provider
- MSFT_WmiProvider_InitializationOperationFailureEvent.ResultCode
- MSFT_WmiProvider_InitializationOperationFailureEvent.TransactionIdentifier
- MSFT_WmiProvider_InitializationOperationFailureEvent.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
The **MSFT\_WmiProvider\_InitializationOperationFailureEvent** event class defines the unsuccessful initialization of the provider server instance. Following activation of the provider server, WMI attempts to initialize the instance provider through a number of COM interface method calls.
...
The **MSFT\_WmiProvider\_InitializationOperationFailureEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_InitializationOperationFailureEvent** class has these properties.
