...
description: Represents an event generated immediately following completion of the providers implementation of IWbemServices CreateClassEnumAsync.
audience: developer
...
keywords:
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Post class
- MSFT_WmiProvider_CreateClassEnumAsyncEvent_Post class, described
topic_type:
- apiref
api_name:
