---
title: MSFT\_WmiProvider\_CancelQuery\_Post class
description: Represents an event generated immediately following completion of the provider's implementation of IWbemEventProviderQuerySink CancelQuery.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'c5987630-f007-4786-b9a3-0d6680545992'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_CancelQuery_Post class", "MSFT_WmiProvider_CancelQuery_Post class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_CancelQuery_Post
- MSFT_WmiProvider_CancelQuery_Post.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_CancelQuery_Post.TIME_CREATED
- MSFT_WmiProvider_CancelQuery_Post.TransactionIdentifer
- MSFT_WmiProvider_CancelQuery_Post.HostingGroup
- MSFT_WmiProvider_CancelQuery_Post.HostingSpecification
- MSFT_WmiProvider_CancelQuery_Post.Locale
- MSFT_WmiProvider_CancelQuery_Post.Namespace
- MSFT_WmiProvider_CancelQuery_Post.Provider
- MSFT_WmiProvider_CancelQuery_Post.QueryId
- MSFT_WmiProvider_CancelQuery_Post.Result
- MSFT_WmiProvider_CancelQuery_Post.TransactionIdentifier
- MSFT_WmiProvider_CancelQuery_Post.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_CancelQuery\_Post class

The **MSFT\_WmiProvider\_CancelQuery\_Post** event class represents an event generated immediately following completion of the provider's implementation of [**IWbemEventProviderQuerySink::CancelQuery**](https://msdn.microsoft.com/library/aa391738).
...
The **MSFT\_WmiProvider\_CancelQuery\_Post** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_CancelQuery\_Post** class has these properties.
...
Contains an identifier of the query that was canceled. This identifier was originally delivered to the provider by the [**NewQuery**](https://msdn.microsoft.com/library/aa391739) method of this interface.
