---
title: MSFT\_WmiProvider\_UnloadOperationEvent class
description: Defines the removal of the provider cache entry.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '280eecd0-b634-4faf-aff6-f41977d9c34f'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_UnloadOperationEvent class", "MSFT_WmiProvider_UnloadOperationEvent class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_UnloadOperationEvent
- MSFT_WmiProvider_UnloadOperationEvent.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_UnloadOperationEvent.TIME_CREATED
- MSFT_WmiProvider_UnloadOperationEvent.TransactionIdentifer
- MSFT_WmiProvider_UnloadOperationEvent.HostingGroup
- MSFT_WmiProvider_UnloadOperationEvent.HostingSpecification
- MSFT_WmiProvider_UnloadOperationEvent.Locale
- MSFT_WmiProvider_UnloadOperationEvent.Namespace
- MSFT_WmiProvider_UnloadOperationEvent.Provider
- MSFT_WmiProvider_UnloadOperationEvent.TransactionIdentifier
- MSFT_WmiProvider_UnloadOperationEvent.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_UnloadOperationEvent class

The **MSFT\_WmiProvider\_UnLoadOperationEvent** event class defines the removal of the provider cache entry. At this point there will be no reference held by WMI on the COM server instance. WMI caches provider registration objects to decrease overall execution time. The subsystem will drop cache entries either through the cache aging process, through loss of RPC connectivity, through user control or due to some change in the provider's registration.
...
The **MSFT\_WmiProvider\_UnloadOperationEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_UnloadOperationEvent** class has these properties.
