---
title: MSFT\_WmiProvider\_OperationEvent\_Pre class
description: Contains the operation event generated prior to calling provider implementation.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'd2b1e646-1ebb-4f35-a555-079c58e4f196'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_OperationEvent_Pre class", "MSFT_WmiProvider_OperationEvent_Pre class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_OperationEvent_Pre
- MSFT_WmiProvider_OperationEvent_Pre.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_OperationEvent_Pre.TIME_CREATED
- MSFT_WmiProvider_OperationEvent_Pre.TransactionIdentifer
- MSFT_WmiProvider_OperationEvent_Pre.HostingGroup
- MSFT_WmiProvider_OperationEvent_Pre.HostingSpecification
- MSFT_WmiProvider_OperationEvent_Pre.Locale
- MSFT_WmiProvider_OperationEvent_Pre.Namespace
- MSFT_WmiProvider_OperationEvent_Pre.Provider
- MSFT_WmiProvider_OperationEvent_Pre.TransactionIdentifier
- MSFT_WmiProvider_OperationEvent_Pre.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_OperationEvent\_Pre class

The **MSFT\_WmiProvider\_OperationEvent\_Pre** event class contains the operation event generated prior to calling provider implementation.
...
The **MSFT\_WmiProvider\_OperationEvent\_Pre** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_OperationEvent\_Pre** class has these properties.
