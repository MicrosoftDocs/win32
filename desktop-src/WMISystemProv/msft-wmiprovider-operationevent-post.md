---
title: MSFT\_WmiProvider\_OperationEvent\_Post class
description: Contains the operation event generated following completion of provider implementation.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f518fb6c-6c1e-4ab5-9634-2cf1e4871ea4'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_OperationEvent_Post class", "MSFT_WmiProvider_OperationEvent_Post class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_OperationEvent_Post
- MSFT_WmiProvider_OperationEvent_Post.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_OperationEvent_Post.TIME_CREATED
- MSFT_WmiProvider_OperationEvent_Post.TransactionIdentifer
- MSFT_WmiProvider_OperationEvent_Post.HostingGroup
- MSFT_WmiProvider_OperationEvent_Post.HostingSpecification
- MSFT_WmiProvider_OperationEvent_Post.Locale
- MSFT_WmiProvider_OperationEvent_Post.Namespace
- MSFT_WmiProvider_OperationEvent_Post.Provider
- MSFT_WmiProvider_OperationEvent_Post.TransactionIdentifier
- MSFT_WmiProvider_OperationEvent_Post.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_OperationEvent\_Post class

The **MSFT\_WmiProvider\_OperationEvent\_Post** base class contains the operation event generated following completion of provider implementation.
...
The **MSFT\_WmiProvider\_OperationEvent\_Post** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_OperationEvent\_Post** class has these properties.
