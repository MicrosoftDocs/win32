---
title: MSFT\_WmiConsumerProviderLoaded class
description: Defines the successful activation of the event consumer provider COM object.
audience: developer
...
- MSFT_WmiConsumerProviderLoaded.SECURITY_DESCRIPTOR
- MSFT_WmiConsumerProviderLoaded.TIME_CREATED
- MSFT_WmiConsumerProviderLoaded.Namespace
- MSFT_WmiConsumerProviderLoaded.ProviderName
- MSFT_WmiConsumerProviderLoaded.Machine
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
The **MSFT\_WmiConsumerProviderLoaded** event class defines the successful activation of the event consumer provider COM object.
...
The **MSFT\_WmiConsumerProviderLoaded** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiConsumerProviderLoaded** class has these properties.
