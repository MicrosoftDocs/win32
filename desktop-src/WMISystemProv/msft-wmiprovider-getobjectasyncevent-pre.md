...
description: Represents an event generated immediately preceding the providers implementation of IWbemServices GetObjectAsync.
audience: developer
...
keywords:
- MSFT_WmiProvider_GetObjectAsyncEvent_Pre class
- MSFT_WmiProvider_GetObjectAsyncEvent_Pre class, described
topic_type:
- apiref
api_name:
