---
title: MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Pre class
description: Represents an event generated immediately prior to calling the provider's implementation of IWbemServices CreateInstanceEnumAsync.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '238ce680-3665-456b-b660-4c7bb5f0b0e1'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre class", "MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.TIME_CREATED
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.TransactionIdentifer
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.ClassName
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.Flags
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.HostingGroup
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.HostingSpecification
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.Locale
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.Namespace
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.Provider
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.TransactionIdentifier
- MSFT_WmiProvider_CreateInstanceEnumAsyncEvent_Pre.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Pre class

The **MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Pre** event class represents an event generated immediately prior to calling the provider's implementation of [**IWbemServices::CreateInstanceEnumAsync**](https://msdn.microsoft.com/library/aa392098).
...
The **MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Pre** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_CreateInstanceEnumAsyncEvent\_Pre** class has these properties.
