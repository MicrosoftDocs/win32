...
- MSFT_WmiProvider_NewQuery_Pre.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_NewQuery_Pre.TIME_CREATED
- MSFT_WmiProvider_NewQuery_Pre.TransactionIdentifer
- MSFT_WmiProvider_NewQuery_Pre.HostingGroup
- MSFT_WmiProvider_NewQuery_Pre.HostingSpecification
- MSFT_WmiProvider_NewQuery_Pre.Locale
- MSFT_WmiProvider_NewQuery_Pre.Namespace
- MSFT_WmiProvider_NewQuery_Pre.Provider
- MSFT_WmiProvider_NewQuery_Pre.Query
- MSFT_WmiProvider_NewQuery_Pre.QueryId
- MSFT_WmiProvider_NewQuery_Pre.QueryLanguage
- MSFT_WmiProvider_NewQuery_Pre.TransactionIdentifier
- MSFT_WmiProvider_NewQuery_Pre.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
The **MSFT\_WmiProvider\_NewQuery\_Pre** event class represents an event generated immediately prior to calling the provider's implementation of [**IWbemEventProviderQuerySink::NewQuery**](https://msdn.microsoft.com/library/aa391739).
...
The **MSFT\_WmiProvider\_NewQuery\_Pre** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_NewQuery\_Pre** class has these properties.
