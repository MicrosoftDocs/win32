---
title: MSFT\_WmiProvider\_LoadOperationFailureEvent class
description: Defines the unsuccessful activation and initialization of the provider cache entry.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f098e596-ad8c-4329-a50d-202b2b2ead95'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_LoadOperationFailureEvent class", "MSFT_WmiProvider_LoadOperationFailureEvent class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_LoadOperationFailureEvent
- MSFT_WmiProvider_LoadOperationFailureEvent.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_LoadOperationFailureEvent.TIME_CREATED
- MSFT_WmiProvider_LoadOperationFailureEvent.TransactionIdentifer
- MSFT_WmiProvider_LoadOperationFailureEvent.Clsid
- MSFT_WmiProvider_LoadOperationFailureEvent.HostingGroup
- MSFT_WmiProvider_LoadOperationFailureEvent.HostingSpecification
- MSFT_WmiProvider_LoadOperationFailureEvent.InProcServer
- MSFT_WmiProvider_LoadOperationFailureEvent.InProcServerPath
- MSFT_WmiProvider_LoadOperationFailureEvent.Locale
- MSFT_WmiProvider_LoadOperationFailureEvent.LocalServer
- MSFT_WmiProvider_LoadOperationFailureEvent.LocalServerPath
- MSFT_WmiProvider_LoadOperationFailureEvent.Namespace
- MSFT_WmiProvider_LoadOperationFailureEvent.Provider
- MSFT_WmiProvider_LoadOperationFailureEvent.ResultCode
- MSFT_WmiProvider_LoadOperationFailureEvent.ServerName
- MSFT_WmiProvider_LoadOperationFailureEvent.Synchronisation
- MSFT_WmiProvider_LoadOperationFailureEvent.ThreadingModel
- MSFT_WmiProvider_LoadOperationFailureEvent.TransactionIdentifier
- MSFT_WmiProvider_LoadOperationFailureEvent.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
The **MSFT\_WmiProvider\_LoadOperationFailureEvent** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_LoadOperationFailureEvent** class has these properties.
