...
- MSFT_WmiProvider_ProvideEvents_Post.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_ProvideEvents_Post.TIME_CREATED
- MSFT_WmiProvider_ProvideEvents_Post.TransactionIdentifer
- MSFT_WmiProvider_ProvideEvents_Post.Flags
- MSFT_WmiProvider_ProvideEvents_Post.HostingGroup
- MSFT_WmiProvider_ProvideEvents_Post.HostingSpecification
- MSFT_WmiProvider_ProvideEvents_Post.Locale
- MSFT_WmiProvider_ProvideEvents_Post.Namespace
- MSFT_WmiProvider_ProvideEvents_Post.Provider
- MSFT_WmiProvider_ProvideEvents_Post.Result
- MSFT_WmiProvider_ProvideEvents_Post.TransactionIdentifier
- MSFT_WmiProvider_ProvideEvents_Post.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
The **MSFT\_WmiProvider\_ProviderEvents\_Post** event class represents an event generated immediately following completion of the provider's implementation of [**IWbemEventProvider::ProvideEvents**](https://msdn.microsoft.com/library/aa391744).
...
The **MSFT\_WmiProvider\_ProvideEvents\_Post** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_ProvideEvents\_Post** class has these properties.
