---
title: MSFT\_WmiProvider\_NewQuery\_Post class
description: Represents an event generated immediately following completion of the provider's implementation of IWbemEventProviderQuerySink NewQuery.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '40bb0fc0-03e4-48bc-a3bb-926c71b0b44e'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_WmiProvider_NewQuery_Post class", "MSFT_WmiProvider_NewQuery_Post class, described"]
topic_type:
- apiref
api_name:
- MSFT_WmiProvider_NewQuery_Post
- MSFT_WmiProvider_NewQuery_Post.SECURITY_DESCRIPTOR
- MSFT_WmiProvider_NewQuery_Post.TIME_CREATED
- MSFT_WmiProvider_NewQuery_Post.TransactionIdentifer
- MSFT_WmiProvider_NewQuery_Post.HostingGroup
- MSFT_WmiProvider_NewQuery_Post.HostingSpecification
- MSFT_WmiProvider_NewQuery_Post.Locale
- MSFT_WmiProvider_NewQuery_Post.Namespace
- MSFT_WmiProvider_NewQuery_Post.Provider
- MSFT_WmiProvider_NewQuery_Post.Query
- MSFT_WmiProvider_NewQuery_Post.QueryId
- MSFT_WmiProvider_NewQuery_Post.QueryLanguage
- MSFT_WmiProvider_NewQuery_Post.Result
- MSFT_WmiProvider_NewQuery_Post.TransactionIdentifier
- MSFT_WmiProvider_NewQuery_Post.User
api_location:
- WmiPrvSD.dll
api_type:
- DllExport
...
# MSFT\_WmiProvider\_NewQuery\_Post class

The **MSFT\_WmiProvider\_NewQuery\_Post** event class represents an event generated immediately following completion of the provider's implementation of [**IWbemEventProviderQuerySink::NewQuery**](https://msdn.microsoft.com/library/aa391739).
...
The **MSFT\_WmiProvider\_NewQuery\_Post** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_WmiProvider\_NewQuery\_Post** class has these properties.
