...
ms.assetid: 'P:Microsoft.RightsManagement.EditableDocumentRights.Extract'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
keywords: ["Extract property", "Extract property, EditableDocumentRights class", "EditableDocumentRights class, Extract property"]
topic_type:
- apiref
api_name:
