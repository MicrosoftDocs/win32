...
ms.assetid: 'P:Microsoft.RightsManagement.ProtectedFileStream.Position'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
keywords: ["Position property", "Position property, ProtectedFileStream class", "ProtectedFileStream class, Position property"]
topic_type:
- apiref
api_name:
