...
ms.assetid: 'P:Microsoft.RightsManagement.UserPolicy.TemplateDescriptor'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
keywords: ["TemplateDescriptor property", "TemplateDescriptor property, UserPolicy class", "UserPolicy class, TemplateDescriptor property"]
topic_type:
- apiref
api_name:
