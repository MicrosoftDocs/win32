...
ms.assetid: 'M:Microsoft.RightsManagement.ProtectedFileStream.FlushAsync'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
keywords: ["FlushAsync method", "FlushAsync method, ProtectedFileStream class", "ProtectedFileStream class, FlushAsync method"]
topic_type:
- apiref
api_name:
