---
title: EmailRights.Forward property
description: Gets a right that allows a protected email message to be forwarded.
audience: developer
author: REDMOND\\bruceper
manager: REDMOND\\mbaldwin
ms.assetid: P:Microsoft.RightsManagement.EmailRights.Forward
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
keywords:
- Forward property
- Forward property, EmailRights class
- EmailRights class, Forward property
topic_type:
- apiref
api_name:
- Microsoft.RightsManagement.EmailRights.Forward
