...
ms.assetid: MMicrosoft.RightsManagement.ProtectedFileStream.GetInputStreamAt(System.UInt64)
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
keywords:
- GetInputStreamAt method
- GetInputStreamAt method, ProtectedFileStream class
- ProtectedFileStream class, GetInputStreamAt method
topic_type:
- apiref
api_name:
