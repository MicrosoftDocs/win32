---
title: CustomProtectedStream.ReadAsync method
description: Returns an asynchronous byte reader object.
audience: developer
author: REDMOND\\bruceper
manager: REDMOND\\mbaldwin
ms.assetid: 'M:Microsoft.RightsManagement.CustomProtection.CustomProtectedStream.ReadAsync(Windows.Storage.Streams.IBuffer,System.UInt32,Windows.Storage.Streams.InputStreamOptions)'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
keywords: ["ReadAsync method", "ReadAsync method, CustomProtectedStream class", "CustomProtectedStream class, ReadAsync method"]
topic_type:
- apiref
api_name:
- Microsoft.RightsManagement.CustomProtectedStream.ReadAsync
api_location:
...
# CustomProtectedStream.ReadAsync method
