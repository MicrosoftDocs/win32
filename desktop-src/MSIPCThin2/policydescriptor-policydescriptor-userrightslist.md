...
keywords: ["PolicyDescriptor(userRightsList) constructor", "PolicyDescriptor(userRightsList) constructor, PolicyDescriptor class", "PolicyDescriptor class, PolicyDescriptor(userRightsList) constructor"]
topic_type:
- apiref
api_name:
