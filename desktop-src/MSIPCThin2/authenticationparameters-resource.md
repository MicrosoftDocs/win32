...
ms.assetid: 'P:Microsoft.RightsManagement.AuthenticationParameters.Resource'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
keywords: ["Resource property", "Resource property, AuthenticationParameters class", "AuthenticationParameters class, Resource property"]
topic_type:
- apiref
api_name:
