...
| **Toolbar menus**\[newline\] a menu bar implemented as a toolbar. \[newline\]                                                                   | toolbar menus are toolbars consisting primarily of commands in [menu buttons](ctrl-command-buttons.md#usage-patterns) and split buttons, with only a few direct commands, if any. \[newline\] ![screen shot of toolbar menu with drop-down menu ](images/cmd-menus-image3.png)<br/> A toolbar menu in Windows Photo Gallery.<br/> For guidelines on this pattern, see [Toolbars](cmd-toolbars.md).<br/>                                                                                                                                                                                                             |
...
| **Menu buttons**\[newline\] command buttons that display a small set of related commands in a drop-down menu. \[newline\]                       | [menu buttons](ctrl-command-buttons.md#usage-patterns) look like ordinary command buttons except they have a drop-down arrow within them. clicking the button displays a drop-down menu instead of performing a command.\[newline\] [split buttons](ctrl-command-buttons.md#usage-patterns) are similar to menu buttons except that they are variations of a command, and clicking the left portion of the button performs the action on the label directly.\[newline\] ![screen shot of menu button with drop-down commands ](images/cmd-menus-image5.png)<br/> A menu button with a small set of related commands.<br/> |
...
-   To restore the menu bar, provide a Menu bar checkmark option in the View (for primary toolbars) or Tools (for secondary toolbars) menu category. For more information, see [Standard menu and split buttons](cmd-toolbars.md#standard-menu-and-split-buttons).
