...
|                                                                                                                                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|-------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Menu bars**\[newline\] a menu bar displays commands and options in drop-down menus. \[newline\]                                               | menu bars are very common and easy to find, as well as an efficient use of space. \[newline\] ![screen shot of menu bar with drop-down menu ](images/cmd-menus-image2.png)<br/> A menu bar from Windows Mail.<br/>                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Toolbar menus**\[newline\] a menu bar implemented as a toolbar. \[newline\]                                                                   | toolbar menus are toolbars consisting primarily of commands in [menu buttons](https://www.bing.com/search?q=menu buttons) and split buttons, with only a few direct commands, if any. \[newline\] ![screen shot of toolbar menu with drop-down menu ](images/cmd-menus-image3.png)<br/> A toolbar menu in Windows Photo Gallery.<br/> For guidelines on this pattern, see [Toolbars](cmd-toolbars.md).<br/>                                                                                                                                                                                                             |
| **Tab menus**\[newline\] buttons within tabs that display a small set of commands and options related to a tab in a drop-down menu. \[newline\] | tabs with menus look like ordinary tabs except their bottom portion has a button with drop-down arrow. clicking the button displays a drop-down menu instead of selecting the tab. \[newline\] ![screen shot of tab menu with drop-down menu ](images/cmd-menus-image4.png)<br/> Tab menus are used in Windows Media Player.<br/>                                                                                                                                                                                                                                                                                           |
| **Menu buttons**\[newline\] command buttons that display a small set of related commands in a drop-down menu. \[newline\]                       | [menu buttons](https://www.bing.com/search?q=menu buttons) look like ordinary command buttons except they have a drop-down arrow within them. clicking the button displays a drop-down menu instead of performing a command.\[newline\] [split buttons](https://www.bing.com/search?q=split buttons) are similar to menu buttons except that they are variations of a command, and clicking the left portion of the button performs the action on the label directly.\[newline\] ![screen shot of menu button with drop-down commands ](images/cmd-menus-image5.png)<br/> A menu button with a small set of related commands.<br/> |
| **Context menus**\[newline\] drop-down menus that display a small set of commands and options related to the current context. \[newline\]       | context menus drop-down when users right-click on an object or window region that supports a context menu. \[newline\] ![screen shot of context menu displaying commands ](images/cmd-menus-image6.png)\[newline\] a context menu from windows explorer.\[newline\] if context menus are the best menu choice but you need a solution suitable for all users, you can use a menu drop-down arrow button. \[newline\] ![screen shot of photo with drop-down menu button ](images/cmd-menus-image7.png)<br/> A context menu made visible with a menu drop-down button.<br/>                                                   |
| **Task pane menus**\[newline\] a small set of commands related to the selected object or program mode. \[newline\]                              | unlike context menus, they are displayed automatically within a window pane, instead of on demand. \[newline\] ![screen shot of photo with task pane menu on right ](images/cmd-menus-image8.png)<br/> A task pane menu from the Windows Photo Gallery viewer.<br/>                                                                                                                                                                                                                                                                                                                                                         |
...
-   To restore the menu bar, provide a Menu bar checkmark option in the View (for primary toolbars) or Tools (for secondary toolbars) menu category. For more information, see [Standard menu and split buttons](https://www.bing.com/search?q=Standard menu and split buttons).
