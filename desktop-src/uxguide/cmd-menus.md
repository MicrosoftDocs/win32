...
| **Toolbar menus**\[newline\] a menu bar implemented as a toolbar. \[newline\]                                                                   | toolbar menus are toolbars consisting primarily of commands in [menu buttons](ctrl-command-buttons.md) and split buttons, with only a few direct commands, if any. \[newline\] ![screen shot of toolbar menu with drop-down menu ](images/cmd-menus-image3.png)<br/> A toolbar menu in Windows Photo Gallery.<br/> For guidelines on this pattern, see [Toolbars](cmd-toolbars.md).<br/>                                                                                                                                                                                                             |
...
| **Menu buttons**\[newline\] command buttons that display a small set of related commands in a drop-down menu. \[newline\]                       | [menu buttons](ctrl-command-buttons.md) look like ordinary command buttons except they have a drop-down arrow within them. clicking the button displays a drop-down menu instead of performing a command.\[newline\] [split buttons](ctrl-command-buttons.md) are similar to menu buttons except that they are variations of a command, and clicking the left portion of the button performs the action on the label directly.\[newline\] ![screen shot of menu button with drop-down commands ](images/cmd-menus-image5.png)<br/> A menu button with a small set of related commands.<br/> |
