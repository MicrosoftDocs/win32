...
The desktop is the onscreen work area provided by Microsoft Windows, analogous to a physical desktop. It consists of a [work area](https://www.bing.com/search?q=work area) and [taskbar](winenv-taskbar.md). The work area may span multiple monitors.
