...
-   **Is the control used to choose one option from a list of mutually exclusive values?** If not, use another control. To choose multiple options, use a [standard multiple-selection list](https://www.bing.com/search?q=standard multiple-selection list), check box list, list builder, or add/remove list instead.
-   **Are the options commands?** If so, use a [menu button](https://www.bing.com/search?q=menu button) or split button instead. Use drop-down lists and combo boxes for objects (nouns) or attributes (adjectives), but not commands (verbs).
...
-   **Will users need assistance in selecting valid values?** If so, use a text box with a [Browse button](https://www.bing.com/search?q=Browse button) instead.
...
|                                                                                                                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|-------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Drop-down list** A standard drop-down list, with a fixed set of predetermined values. \[newline\]                                 | when closed, only the selected item is visible. when users click the drop-down button, all the options become visible. to change the value, users open the list and click another value.\[newline\] ![screen shot of drop-down list, options hidden ](images/ctrl-drop-image6.png)\[newline\] in this example, the list is in its normal state.\[newline\] ![screen shot of drop-down list, options displayed ](images/ctrl-drop-image7.png)<br/> In this example, the list has been dropped down.<br/> |
| **Preview drop-down list** A drop-down list that previews the results of the selection to help users choose.\[newline\]             | ![screen shot of color and text options ](images/ctrl-drop-image8.png)<br/> In these examples, the drop-down lists preview the results of the selection.<br/>                                                                                                                                                                                                                                                                                                                                           |
| **Editable drop-down list** A drop-down combo box, which allows users to enter a value that isn't in the drop-down list.\[newline\] | ![aa511458.dropdownlists27(en-us,msdn.10).png](images/ctrl-drop-image9.png)![screen shot of editable font-size combo box ](images/ctrl-drop-image10.png)<br/> Examples of an editable drop-down list in edit and dropped-down modes.<br/> Use this control when you want to give the flexibility of a text box, yet want to assist users by providing a convenient list of likely choices.<br/>                                                                                                   |
| **Editable list boxes** A regular combo box, which allows users to enter a value that isn't in the always visible list. \[newline\] | ![screen shot of drop-down list of font options ](images/ctrl-drop-image11.png)<br/> In these examples, the editable list boxes are always displayed.<br/> This control is a better choice than the editable drop-down list when it is important to encourage users to review the alternative choices or invite change.<br/>                                                                                                                                                                      |
...
-   **Don't use the change of a drop-down list or combo box to**:
    ...
    -   Dynamically display other controls related to the selected control ([screen readers](https://www.bing.com/search?q=screen readers) cannot detect such events).
...
-   **Select the safest (to prevent loss of data or system access) and most secure option by default.** If safety and security aren't factors, select the most likely or convenient option.
    -   **Exception:** Display a blank default value if the control represents a property in a [mixed state](https://www.bing.com/search?q=mixed state), which happens when displaying a property for multiple objects that don't have the same setting.
