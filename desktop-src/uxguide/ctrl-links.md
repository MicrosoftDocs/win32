...
-   **Would a command button be a better choice?** Use a [command button](ctrl-command-buttons.md) if:
    ...
    -   Similarly, in a [wizard](win-wizards.md) or [task flow](https://www.bing.com/search?q=task flow), the command represents commitment. In such windows, command buttons suggest commitment whereas links suggest navigating to the next step.

## Design concepts

**Making links recognizable**

Links lack [affordance](https://www.bing.com/search?q=affordance), which means **their visual properties don't suggest how they are used** and are understood only through experience. Links without an underline and link system colors appear as normal text; the only way to ascertain their behavior is from their presentation, their context, or by positioning the pointer over them.
...
2. Use links that give specific descriptive information about the result of clicking on the link, using as much text as necessary. Users should be able to accurately predict the result of a link from its link text and optional [infotip](https://www.bing.com/search?q=infotip).
...
| **Definition links**\[newline\] a text link used to display a definition in an infotip when the user clicks on or hovers over the link. \[newline\] | this pattern is useful for defining terms that may not be known to your users without adding screen clutter.\[newline\] ![screen shot of infotip displayed by mouse hover ](images/ctrl-links-image2.png)<br/> In this example, the infotip definition is displayed. <br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Menu links**\[newline\] a set of task links used to create a menu. \[newline\]                                                                    | because the context of the menu indicates a set of links, the text is usually not underlined (except on hover) and might not use the link system colors.\[newline\] ![screen shot of a set of links ](images/ctrl-links-image3.png)<br/> In this example, a set of links creates a menu.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Option links**\[newline\] a selected option or its placeholder, where clicking the link invokes a command to change that option.\[newline\]       | unlike regular text links, the link changes its text to reflect the currently selected option and is always drawn using the unvisited link color. \[newline\] ![screen shot of a rule in outlook rules wizard ](images/ctrl-links-image4.png)\[newline\] the example on the left shows a rule from the microsoft outlook rules wizard with placeholder options. after users click the links and select some options, the right-hand example updates the link text to show the results.\[newline\] using option links is particularly suitable if the options have a variable format. \[newline\] ![screen shot of a modified rule in the rules wizard ](images/ctrl-links-image5.png)\[newline\] the example on the right shows that outlook rules have a variable format. \[newline\] ![screen shot of how text changes to drop-down list ](images/ctrl-links-image6.png)<br/> The example on the left shows an option link. It becomes a drop-down list when selected, as shown on the right.<br/> |
...
|                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|--------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Plain text links**\[newline\] consist only of text. \[newline\]                                      | this presentation is the most flexible because it can be used anywhere, including [inline](https://www.bing.com/search?q=inline).\[newline\] ![screen shot of blue link text ](images/ctrl-links-image7.png)<br/> In this example, the text color clearly identifies an inline link.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
-   If a link requires further explanation, **provide the explanation in either a supplemental explanation in a separate text control or an** [infotip](https://www.bing.com/search?q=infotip), but not both. Use complete sentences and ending punctuation. Providing both is unnecessary if the text is the same, and confusing if the text is different.
...
-   Don't assign an [access key](https://www.bing.com/search?q=access key). Links are accessed using the Tab key.
