...
Modern wizard design places a premium on efficiency, making the Progress page optional for shorter operations, and often dispensing with the traditional [Welcome page](https://www.bing.com/search?q=Welcome page) and [Congratulations page](https://www.bing.com/search?q=Congratulations page) at the beginning and end.
...
-   Every wizard page must have a [main instruction](https://www.bing.com/search?q=main instruction).

### Titles

-   Put the name of the wizard in the title bar. Use [title-style capitalization](https://www.bing.com/search?q=title-style capitalization).
