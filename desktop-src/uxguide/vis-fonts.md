...
|                                                                                                                                                                                                                                                           |                                                                                                                                                       |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Title bar text**\[newline\] text on the title bar that identifies the window.\[newline\]                                                                                                                                                                | ![example of title-bar text font ](images/vis-fonts-image2.png)<br/>                                                                            |
| **Main instructions**\[newline\] text that explains what to do on a page, window, or dialog box. \[newline\]                                                                                                                                              | ![example of main-instructions text font ](images/vis-fonts-image3.png)<br/>                                                                    |
| **Secondary instructions**\[newline\] supplemental text that explains what to do on a page, window, or dialog box. \[newline\]                                                                                                                            | ![example of secondary-instructions text font ](images/vis-fonts-image4.png)<br/>                                                               |
| **Normal text**\[newline\] ordinary (read-only) text displayed in a user interface. \[newline\]                                                                                                                                                           | ![example of normal text font ](images/vis-fonts-image5.png)<br/>                                                                               |
| **Emphasized text**\[newline\] bold text is used to make the text easier to parse and to draw attention to text users must read. italic text is used to refer to text literally (instead of quotation marks) and to emphasize specific words. \[newline\] | ![example of emphasized text font ](images/vis-fonts-image6.png)<br/>                                                                           |
| **Editable text**\[newline\] text that users can edit is shown in a box. to reduce the weight of the presentation, the box may be displayed only when the editable text is selected. \[newline\]                                                          | ![example of editable text font ](images/vis-fonts-image7.png)<br/>                                                                             |
| **Disabled text**\[newline\] text that doesn't apply to the current context, such as labels for disabled controls. disabled text indicates that users (normally) shouldn't bother reading the text. \[newline\]                                           | ![example of disabled text font ](images/vis-fonts-image8.png)<br/>                                                                             |
| **Links**\[newline\] text used to navigate to another page, window, or help topic, or initiate a command. \[newline\]                                                                                                                                     | ![example of link text font ](images/vis-fonts-image9.png)\[newline\] ![example of links (hover) text font ](images/vis-fonts-image10.png)<br/> |
| **Group header**\[newline\] text used to group items in a list view. \[newline\]                                                                                                                                                                          | ![example of group-header text font ](images/vis-fonts-image11.png)<br/>                                                                        |
| **File name**\[newline\] file name text (in content view only). \[newline\]                                                                                                                                                                               | ![example of file name (in content view) text font ](images/vis-fonts-image12.png)<br/>                                                         |
| **Document text**\[newline\] text used in documents (as opposed to ui text). \[newline\]                                                                                                                                                                  | ![example of document text font ](images/vis-fonts-image13.png)<br/>                                                                            |
| **Document headings**\[newline\] text used as a heading within a document. \[newline\]                                                                                                                                                                    | ![example of document headings text font ](images/vis-fonts-image14.png)<br/>                                                                   |
...
-   Most UI text should be plain without any attributes. Attributes may be used as follows:
    ...
    -   **Italic.** Use to refer to text literally instead of quotation marks. Use sparingly to emphasize specific words. Use for [prompts](glossary.md) in [text boxes](ctrl-text-boxes.md) and [editable drop-down lists](https://msdn.microsoft.com/library/windows/desktop/dn742404).
