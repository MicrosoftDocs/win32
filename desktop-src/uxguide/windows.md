...
<td>This article covers default placement of windows when initially displayed on the screen, their stacking order relative to other windows ([Z order](https://www.bing.com/search?q=Z order)), their initial size, and how their display affects input focus.<br/></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td>[Dialog Boxes](win-dialog-box.md)<br/></td>
...
<tr class="even">
<td>[Common Dialogs](win-common-dlg.md)<br/></td>
...
<tr class="odd">
<td>[Wizards](win-wizards.md)<br/></td>
...
<tr class="even">
<td>[Property Windows](win-property-win.md)<br/></td>
