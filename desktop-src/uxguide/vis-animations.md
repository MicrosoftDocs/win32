...
|                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Hover feedback**\[newline\] to show where the interaction point is. \[newline\]                                | indicates that the interaction point is active. hover can be shown through a static effect as well.\[newline\] windows vocabulary: display hover effect (bounding rectangle, highlight, enlargement) with a fade in/fade out effect for smoothness. \[newline\] ![screen shot of one of six album covers highlighted ](images/vis-animations-image24.png)<br/> In the Zune digital media player, album covers highlight and add playback controls on hover.<br/>                                                                                                                                                                                                                 |
| **Click feedback**\[newline\] to show that a clickable object is responsive and received a click. \[newline\]    | indicates that an object has been clicked.\[newline\] windows vocabulary: flash object background on click down event. to show touch contact, use a ripple effect. \[newline\] ![photo of finger on touch screen showing ripples ](images/vis-animations-image25.png)<br/> Touch displays a ripple animation so that the user knows the interaction was recognized.<br/>                                                                                                                                                                                                                                                                                                         |
| **Selection feedback**\[newline\] to show that an object is selected. \[newline\]                                | indicates that an object is selected. selection can be shown through a static effect as well.\[newline\] windows vocabulary: draw selection rectangle with a fade in/fade out effect for smoothness. \[newline\] ![figure of an album cover clicked and then selected ](images/vis-animations-image26.png)<br/> In Zune, album covers blink on click, and then get a selection rectangle on selection.<br/>                                                                                                                                                                                                                                                                      |
| **Progress feedback**\[newline\] to show that a task is being performed. \[newline\]                             | progress feedback indicates that a task is making progress, typically with activity indicators, progress bars, or animations that illustrate the task. determinate progress feedback shows roughly how much of the task has been done and how much remains, whereas indeterminate progress only indicates that the task is being done.\[newline\] windows vocabulary: spinning activity indicators, progress bars, progress backgrounds, illustration animations. \[newline\] ![screen shot of dialog box with 'signing in' text ](images/vis-animations-image27.png)<br/> In this example, Windows Live Messenger displays indeterminate progress feedback during sign-in.<br/> |
| **Attractor**\[newline\] to show that something needs the user's attention. \[newline\]                          | attract the right level of attention when significant objects are created or need attention (often due to change), or important or urgent events happen. see [attracting the right level of attention](#attracting-the-right-level-of-attention) for design techniques.\[newline\] windows vocabulary: flashing, moving, pulsing, glowing, gleam. \[newline\] ![screen shot demonstrating toolbar animation ](images/vis-animations-image28.png)<br/> The Windows Live toolbar animates on first appearance to make it obvious where it is.<br/>                                                                                                                                 |
| **Relationship**\[newline\] to show the relationship between objects or causality in effects. \[newline\]        | show relationships, especially when the relationship might not be understood or expected, in a way that's not distracting or confusing.\[newline\] windows vocabulary: morphing, transportation, physical change such as flipping over, growing from a point source, shrinking to a point destination. \[newline\] ![screen shot of color calibration dialog box](images/vis-animations-image29.png)<br/> In this example, the animation shows the relationship between the gamma setting and its affect on the display.<br/>                                                                                                                                                    |
| **Illustration/Preview**\[newline\] to explain visually a concept, task, or the effect of a command. \[newline\] | an animation or video that explains a concept or how something works visually, either to supplement or replace a textual explanation. doing so allows users to perform tasks or choose commands efficiently and confidently. \[newline\] ![screen shot of pen correcting spelling mistake ](images/vis-animations-image30.png)<br/> In this example, the Tablet PC Input Panel "show me" commands use illustrations to show how to correct, delete, split, and join.<br/>                                                                                                                                                                                                        |
...
|                                                                                                                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Object grow/shrink/appear**\[newline\] to change an object's size or state smoothly. \[newline\]                                                                                                         | object changes between states, possibly while moving. transition keeps users oriented during changes.\[newline\] windows vocabulary: morph, change size, object slides in or out. \[newline\] ![screen shot of three sizes of weather gadgets ](images/vis-animations-image31.png)<br/> In this example, the Weather Gadget morphs from its concise state to display its Options dialog box.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Content show/hide/change**\[newline\] to show, hide, or change content smoothly, typically for progressive disclosure. \[newline\]                                                                       | window interior reshapes to display more, less, or different content. transition keeps users oriented during changes.\[newline\] windows vocabulary: pane slides in or out. flyout windows fade in and out. different content fades or rolls in. \[newline\] ![screen shot of three sizes of calculator ](images/vis-animations-image32.png)<br/> The Windows Calculator has a smooth transition between view modes.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Control or affordance show/hide**\[newline\] to smoothly show or hide controls or their affordances on hover or mouse move in order to simplify the normal visual appearance. \[newline\]                | display controls when users are hovering the pointer over a command area, or display affordances when users are hovering over a control. hovering over these areas indicates that the user intends to interact. affordances may hide if the pointer becomes stationary. \[newline\] ![screen shot of faded controls before hover ](images/vis-animations-image33.png)<br/> In this example, the Windows Media Player controls fade in on hover when in full screen mode.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Scene transitions**\[newline\] to make a scene transition smooth and seamless in order to avoid attention. \[newline\]                                                                                   | abrupt scene changes can be jarring, especially for large screen areas, so use scene transitions to create smoothness and continuity, and to provide context. scene transitions are designed to be natural and low key, to avoid calling attention to the process of transition itself.\[newline\] windows vocabulary: fade in/out; cross fade; sliding in/left, out/right, up, down; pushes and covers. \[newline\] ![screen shot of one photo fading into another ](images/vis-animations-image34.png)<br/> In this example, the Windows desktop wallpaper gently cross-fades between images to make the transition feel smooth and controlled.<br/>                                                                                                                                                                                                                                                                                                                               |
| **Special scene transitions**\[newline\] to draw attention to a scene change to make it special or refocus the user's attention. \[newline\]                                                               | while most scene transitions should not call attention to the process of transition, some are designed to break the flow and draw attention in order to emphasize that something different is about to happen. to draw attention, special scene transitions are designed to be unnatural and have high visual impact. \[newline\] ![screen shot of attention-grabbing transition slide ](images/vis-animations-image35.png)<br/> In this example, PowerPoint uses attention-getting transitions to draw the audience into the change.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Direct manipulations**\[newline\] to show the effect of direct manipulations (such as move, scroll/pan, rotate, and zoom). \[newline\]                                                                   | the transition shows the effect of the manipulation in real time. the effect should feel smooth, continuous, and consistent with the real world. moving and rotating may not be continuous in some places to indicate restrictions or likely preferred choices. zooming makes content larger or smaller, possibly changing the level of detail accordingly. \[newline\] ![screen shot of three sizes of magnifier ](images/vis-animations-image36.png)<br/> In this example, Magnifier zooms smoothly between levels.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Incorrect direct manipulations**\[newline\] to indicate that a direct manipulation (such as move, scroll/pan) was attempted but could not be done. \[newline\]                                           | the transition shows the manipulation being attempted, but reverts back to the original state. often the effect looks like the manipulation can't be performed due to some real-world physical restriction. these animations are used instead of text-based error messages, which would disrupt the real-world feel of the manipulation.\[newline\] windows vocabulary: bounce \[newline\] ![figure of animation communicating visually ](images/vis-animations-image4.png)<br/> In this example, the document bounces to show that the user has reached the end.<br/>                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Sort, filter, reorder transitions**\[newline\] to indicate that the presentation or content of a collection of items has changed. \[newline\]                                                            | the transition shows (or for complex changes, suggests) the effect of the change. \[newline\] ![screen shot of rows cameras with three removed ](images/vis-animations-image37.png)\[newline\] ![similar screen shot with different cameras removed ](images/vis-animations-image38.png)\[newline\] ![similar screen shot with other cameras removed ](images/vis-animations-image39.png)\[newline\] in this example, bing visual search uses a filter transition.\[newline\] ![screen shot of album cover changing its appearance ](images/vis-animations-image40.png)<br/> In this example, Windows Media Center uses a reorder transition as a special experience while a song is playing.<br/>                                                                                                                                                                                                                                                                                   |
| **Performance transitions**\[newline\] to make an action appear to happen faster. \[newline\]                                                                                                              | while any transition has the potential for making an action appear to happen faster, the primary purpose of these transitions is to improve the perception of performance and responsiveness. a good technique is to show the task being performed in deliberate steps. by contrast, delaying the action, rendering the results in a haphazard manner, or using an activity indicator will feel slow.\[newline\] windows vocabulary: perform action in stages, with smooth transitions between the stages. \[newline\] ![screen shot of jump list adding destinations ](images/vis-animations-image41.png)<br/> In this example, a taskbar Jump List immediately displays the standard items, and then slides out to display the destinations once the list is ready. Doing so disguises the time required to build the list. By contrast, delaying the initial display would feel unresponsive, and displaying an incomplete list or progress feedback would feel much slower.<br/> |
| **Special experiences**\[newline\] to engage and delight users during infrequent, [special experiences](https://www.bing.com/search?q=special experiences) that are important to your program and have the user's full attention. \[newline\] | while any transition has the potential for being a special experience, these transitions are best reserved for infrequent experiences that are truly special to your program. custom transitions are used to give a special feel. branding and personality are often important design elements. unlike other patterns, special experiences can demand attention, be heavy, and require users to wait a moment. consequently, these transitions wear out quickly if overused because the experience is no longer special. \[newline\] ![screen shot of windows logo changing to new screen ](images/vis-animations-image42.png)<br/> In this example, Windows Media Center displays an animation while loading to immediately engage users.<br/>                                                                                                                                                                                                                                      |
