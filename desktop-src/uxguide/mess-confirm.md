...
|                                                                                                                                                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Routine confirmations**\[newline\] confirm that the user wants to proceed with a routine, low risk action. \[newline\]                                              | these confirmations are usually phrased "are you sure...?" and often have a don't show this message again check box to minimize their annoyance. \[newline\] ![screen shot of 'move folder to recycle bin?' ](images/mess-confirm-image11.png)\[newline\] ![screen shot of 'don't show message again' ](images/mess-confirm-image12.png)<br/> Examples of routine confirmations.<br/> **Note:** This pattern is usually unnecessary and should be avoided.<br/>                                                                                                                                                                                                                                                                                        |
| **Risky action confirmations**\[newline\] confirm that the user wants to proceed with an action that has some risk and can't be easily undone. \[newline\]            | because they have risk, these confirmations usually have a warning icon. \[newline\] ![screen shot of volume-formatting confirmation ](images/mess-confirm-image13.png)\[newline\] ![screen shot of permanent deletion confirmation ](images/mess-confirm-image14.png)<br/> Examples of risky action confirmations.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Unintended consequence confirmations**\[newline\] confirm that the user wants to proceed with an action that has unexpected or unintended consequences. \[newline\] | in addition to asking a question, these confirmations point out the unintended consequences. because they have unintended consequences, these confirmations usually have a warning icon. \[newline\] ![screen shot of 'close all tabs?' confirmation ](images/mess-confirm-image15.png)\[newline\] ![screen shot of 'cancel installation?' confirmation ](images/mess-confirm-image16.png)\[newline\] examples of unintended consequence confirmations.\[newline\] however, this pattern requires that the consequences are truly unintended. \[newline\] **incorrect:**\[newline\] ![screen shot of 'turn off key logger?' confirmation ](images/mess-confirm-image17.png)<br/> The consequences are intended here, so this is a routine confirmation.<br/> |
| **Clarifications**\[newline\] clarify how the user wants to proceed with an action that has potentially ambiguous or unexpected consequences. \[newline\]             | drag-and-drop operations can result in clarifications if the effect of the operation can be misinterpreted. \[newline\] ![screen shot of 'change only this occurrence?'](images/mess-confirm-image18.png)\[newline\] ![screen shot of 'always save on exit?' confirmation ](images/mess-confirm-image19.png)<br/> Examples of clarifications.<br/> **Note:** This pattern should be avoided because it is better to design actions without ambiguous consequences and assume the most likely desired result. <br/>                                                                                                                                                                                                                                     |
| **Security confirmations**\[newline\] confirm that the user wants to proceed with an action with security consequences. \[newline\]                                   | ![screen shot of 'do you want to run this software?' ](images/mess-confirm-image20.png)\[newline\] ![screen shot of 'remember password?' confirmation ](images/mess-confirm-image21.png)<br/> Examples of security confirmations.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Ulterior motive confirmations**\[newline\] provide information about an action, but present it as a confirmation. \[newline\]                                       | while these dialog boxes are presented as confirmations, their real goal is user education or advertisement of features. \[newline\] ![screen shot of want this toolbar on your taskbar? ](images/mess-confirm-image22.png)<br/> An example of an ulterior motive confirmation.<br/> **Note:** This pattern is not recommended because there is usually a better, more direct alternative. For example, [animations](vis-animations.md) are a better way to show the relationship between cause and effect. <br/>                                                                                                                                                                                                                                     |
...
| Unintended consequence confirmations \[newline\] | state the unintended consequence.\[newline\] **exception:** if a question asking if the user wants to proceed clearly implies the unintended consequence, ask the question instead. \[newline\] ![screen shot of 'close all tabs?' confirmation ](images/mess-confirm-image15.png)<br/> In this example, asking the user to proceed sufficiently conveys the consequences of the action.<br/> |
