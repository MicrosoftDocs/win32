...
For command labeling guidelines, see [Command labels](commands). For guidelines on specific common controls, see the respective [control guidelines](controls.md).
