...
For command labeling guidelines, see [Command labels](f579745a-5327-4c8b-bfa7-fe81d9657a3b). For guidelines on specific common controls, see the respective [control guidelines](controls.md).
