...
| **Toolbar menus**\[newline\] a menu bar implemented as a toolbar. \[newline\]                                        | toolbar menus are toolbars consisting primarily of commands in [menu buttons](ctrl-command-buttons.md) and split buttons, with only a few direct commands, if any. \[newline\] ![screen shot of menu bar with icons and commands ](images/cmd-toolbars-image10.png)<br/> A toolbar menu in Windows Photo Gallery.<br/> |
...
|                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Unlabeled icons**\[newline\] one or more rows of small unlabeled icon buttons. \[newline\]                                           | use this style if there are too many buttons to label or the program is frequently used. with this style, programs with complex functionality can have multiple rows, and therefore, this is the only style that needs to be customizable. with this style, some command buttons can be labeled if they are frequently used. \[newline\] ![screen shot of toolbar with small, unlabeled icons ](images/cmd-toolbars-image14.png)<br/> An unlabeled icons toolbar from WordPad.<br/> |
| **Large unlabeled icons**\[newline\] a single row of large unlabeled icon buttons. \[newline\]                                         | use this style for simple utilities that have easily recognizable icons and are usually run in small windows. \[newline\] ![screen shot of toolbar with large, unlabeled icons ](images/cmd-toolbars-image15.png)\[newline\] ![screen shot of toolbar with large icons ](images/cmd-toolbars-image16.png)<br/> Large unlabeled icons toolbars from Windows Live Messenger and the Windows Snipping Tool.<br/>                                                                       |
| **Labeled icons**\[newline\] a single row of small labeled icons. \[newline\]                                                          | use this style if there are few commands or the program isn't frequently used. this style always has a single row. \[newline\] ![screen shot of toolbar with labeled icons ](images/cmd-toolbars-image8.png)<br/> A labeled icons toolbar from Windows Explorer.<br/>                                                                                                                                                                                                               |
| **Partial toolbars**\[newline\] a partial row of small icons used to save space when a full toolbar isn't necessary. \[newline\]       | use this style for windows with navigation buttons, a search box, or tabs to eliminate unnecessary weight at the top of the window. \[newline\] ![screen shot of menu bar, toolbar and favorites bar ](images/cmd-toolbars-image17.png)<br/> Partial toolbars can be combined with navigation buttons, a search box, or tabs.<br/>                                                                                                                                                  |
| **Large partial toolbars**\[newline\] a partial row of large icons used to save space when a full toolbar isn't necessary. \[newline\] | use this style for simple utilities that have navigation buttons or a search box to eliminate unnecessary weight at the top of the window. \[newline\] ![screen shot of a large partial toolbar ](images/cmd-toolbars-image18.png)<br/> A large partial toolbar from Windows Defender.<br/>                                                                                                                                                                                         |
...
|                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Command icon buttons**\[newline\] clicking a command button initiates an immediate action. \[newline\]                                                                                                 | ![screen shot of a labeled-icons toolbar ](images/cmd-toolbars-image19.png)<br/> Examples of icon command buttons from Windows Fax and Scan.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Mode icon buttons**\[newline\] clicking a mode button enters the selected mode. \[newline\]                                                                                                            | ![screen shot of a vertical toolbar ](images/cmd-toolbars-image20.png)<br/> Examples of mode buttons from Windows Paint.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Property icon buttons**\[newline\] a property button's state reflects the state of the currently selected objects, if any. clicking the button applies the change to the selected objects. \[newline\] | ![screen shot of formatting icons and selected text ](images/cmd-toolbars-image21.png)<br/> Examples of property buttons from Microsoft Word.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Labeled icon buttons**\[newline\] a command button or property button labeled with an icon and a text label. \[newline\]                                                                               | these buttons are used for frequently used toolbar buttons whose icon isn't sufficiently self-explanatory. they are also used in toolbars that have so few buttons that each button can have a text label. \[newline\] ![screen shot of toolbar with some icons labeled ](images/cmd-toolbars-image22.png)<br/> A toolbar with its most frequently used buttons labeled.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Menu buttons**\[newline\] a command button used to present a small set of related commands. \[newline\]                                                                                                | a single downward-pointing triangle indicates that clicking the button shows a menu. \[newline\] ![screen shot of toolbar and drop-down command list ](images/cmd-toolbars-image23.png)<br/> A menu button with a small set of related commands.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Split buttons**\[newline\] a command button used to consolidate variations of a command, especially when one of the commands is used most of the time. \[newline\]                                     | ![screen shot of split print button ](images/cmd-toolbars-image24.png)\[newline\] a split button in its normal state.\[newline\] like a menu button, a single downward-pointing triangle indicates that clicking the rightmost portion of the button shows a menu. \[newline\] ![screen shot of split print button commands ](images/cmd-toolbars-image25.png)\[newline\] a dropped down split button.\[newline\] in this example, a split button is used to consolidate all the print-related commands. the immediate print command is used most of the time, so users normally don't need to see the other commands. \[newline\] unlike a menu button, clicking the left portion of the button performs the action on the label directly. split buttons are effective in situations where the next command is likely to be the same as the last command. in this case, the label is changed to the last command, as with a color picker:\[newline\] ![screen shot of bucket icon pouring paint ](images/cmd-toolbars-image26.png)<br/> In this example, the label is changed to the last command.<br/> |
| **Drop-down lists**\[newline\] a drop-down list (editable or read-only) used to view or change a property. \[newline\]                                                                                   | ![screen shot of drop-down list of fonts ](images/cmd-toolbars-image27.png)<br/> In this example, drop-down lists are used to view and set font attributes.<br/> A drop-down list in a toolbar reflects the state of the currently selected object, if any. Changing the list changes the selected object's state. <br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
