...
-   **Select types of notifications to display.** Your notification must be useful and relevant, but there may be notifications that users don't want to see. This is especially true for FYI [notifications](https://www.bing.com/search?q=notifications). Let users choose to enable the less important ones.
...
<li>Doing so is optional and users must [opt in](https://www.bing.com/search?q=opt in).</li>
</ul>
...
-   For the temporary notification source pattern:
    ...
    -   Remove the icon based on its [notification design](https://www.bing.com/search?q=notification design) pattern:
...
-   **Choose an easily recognizable icon design.** Prefer icons with unique outlines over square or rectangular shaped icons. Keep the designs simple prefer symbols over realistic images. Apply the other [Aero-style icon guidelines](https://www.bing.com/search?q=Aero-style icon guidelines) as well.
...
-   For [progressive escalation](https://www.bing.com/search?q=progressive escalation), **use icons with a progressively more emphatic appearance as the situation becomes more urgent.**
...
-   **Allow users to opt into or out of different notification types** if your program has notifications that some users might not want to see. The [FYI](https://www.bing.com/search?q=FYI) notification pattern requires users to opt in, so these notifications must be disabled by default.
...
-   When appropriate, present notification area flyouts with three sections:
    ...
    -   **Related links.** Provide at most one of each type of the following optional links:
        ...
        -   A link to a specific, relevant Help topic. Follow the standard [Help link guidelines](https://www.bing.com/search?q=Help link guidelines).
...
-   Disable features that are rarely used, or potentially annoying or distracting. Let users [opt in](https://www.bing.com/search?q=opt in) to such features.
...
-   To reduce taskbar clutter, consider providing the ability to minimize programs to the notification area only if all of the following apply:
    ...
    -   Doing so is optional and users must [opt in](https://www.bing.com/search?q=opt in).
