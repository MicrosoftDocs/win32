...
The mouse is the primary input device used to interact with objects in Windows. The term mouse can also refer to other pointing devices, such as trackballs, touchpads and pointing sticks built into notebook computers, pens used with Windows Tablet and Touch Technology, and, on computers with touchscreens, even a user's finger.
...
**Note:** Guidelines related to [accessibility](inter-accessibility.md) and [touch](inter-touch.md) are presented in a separate article.
...
![screen shot of command button and slider ](images/inter-mouse-image3.png)
...
|                              |                                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Simple action**<br/> | **Interaction**<br/>                                                                                                                                                                                                                                                                                                    | **Typical effect**<br/>                                                                                                                                                                                                                                                                                                                                                                                                   |
...
|                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                   |                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Compound action**<br/>   | **Interaction**<br/>                                                                                                                                                                                                                                                                                                                                                                                                        | **Typical effect**<br/>                                        | **Pointers**<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Moving\[newline\]                | if moving is a mode (entered by giving a command), enter the mode, position the pointer over a movable object, press button and move mouse, release mouse button. in this case, the pointer changes shape to indicate the mode.\[newline\] otherwise, position the pointer over a movable object's grabber, press button and move mouse, release mouse button. in this case, the pointer doesn't need to change shape.\[newline\] | object moves in direction of pointer movement.\[newline\]            | move\[newline\] ![screen shot of pointer with four arrows ](images/inter-mouse-image9.png)\[newline\] used to move a window in any direction.\[newline\] pan\[newline\] ![screen shot of pointer with hand shape ](images/inter-mouse-image10.png)<br/> Used to move an object within a window in any direction.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Resizing\[newline\]              | position the pointer over a resizable border or resize handle, press a mouse button and move mouse, and then release the mouse button.\[newline\]                                                                                                                                                                                                                                                                                 | object resizes in direction of pointer movement.\[newline\]          | vertical and horizontal resize\[newline\] ![screen shot of up-down and right-left pointers ](images/inter-mouse-image11.png)![screen shot of up-down and right-left pointers ](images/inter-mouse-image12.png)\[newline\] used to resize a single dimension.\[newline\] diagonal resize\[newline\] ![bb545459.mouse13(en-us,msdn.10).png](images/inter-mouse-image13.png)![screen shot of diagonal pointers with arrow tips](images/inter-mouse-image14.png)\[newline\] used to resize two dimensions simultaneously.\[newline\] row and column resize\[newline\] ![bb545459.mouse15(en-us,msdn.10).png](images/inter-mouse-image15.png)![screen shot of arrow pointers with crossbar ](images/inter-mouse-image16.png)<br/> Used to resize a row or column in a grid.<br/> |
| Splitting\[newline\]             | position the pointer over a splitter, press a mouse button and move mouse, and then release the mouse button.\[newline\]                                                                                                                                                                                                                                                                                                          | split pane border moves in direction of pointer movement.\[newline\] | window splitters\[newline\] ![bb545459.mouse17(en-us,msdn.10).png](images/inter-mouse-image17.png)![screen shot of arrow pointers with double crossbar ](images/inter-mouse-image18.png)<br/> Used to resize a split pane vertically or horizontally.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Dragging and dropping\[newline\] | position the pointer over a valid object for dragging, press a mouse button and move mouse to a drop target, and then release the mouse button.\[newline\]                                                                                                                                                                                                                                                                        | object is moved or copied to the drop target.\[newline\]             | normal select\[newline\] ![screen shot of photo, standard pointer, and infotip ](images/inter-mouse-image19.png)\[newline\] used over valid drag targets. may also have an infotip to indicate specific effect.\[newline\] unavailable\[newline\] ![screen shot of small blocked/offline icon ](images/inter-mouse-image20.png)<br/> Used to indicate a surface isn't a valid drop target.<br/>                                                                                                                                                                                                                                                                                                                                                                             |
...
|------------------------------------------------------------------------------------------------|------------------------------------------|---------------------------------------------------------------------------------------------|
| **Shape**<br/>                                                                           | **Name**<br/>                      | **When used**<br/>                                                                    |
| ![screen shot of doughnut-shaped pointer ](images/inter-mouse-image21.png)<br/>          | Busy pointer<br/>                  | Used to wait for a window to become responsive.<br/>                                  |
