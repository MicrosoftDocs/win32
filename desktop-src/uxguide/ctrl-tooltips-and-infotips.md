...
|                                                                                                                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|---------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Tooltips**\[newline\] display the label of an unlabeled control or glyph. \[newline\]                                         | because these tips serve as labels, their text follows the label guidelines for the underlying control. \[newline\] ![screen shot of export list button with tooltip ](images/ctrl-tooltips-and-infotips-image5.png)\[newline\] in this example, the tooltip gives the command label.\[newline\] ![screen shot of close button with tooltip ](images/ctrl-tooltips-and-infotips-image6.png)![screen shot of play button with tooltip ](images/ctrl-tooltips-and-infotips-image7.png)\[newline\] in these examples, tooltips label graphic buttons.\[newline\] ![screen shot of show menu glyph with tooltip ](images/ctrl-tooltips-and-infotips-image8.png)<br/> In this example, the tooltip labels a glyph.<br/> |
| **Infotips**\[newline\] provide a supplemental description or explanation of an object or control. \[newline\]                  | use infotips to describe or explain objects and controls such as [toolbar](cmd-toolbars.md) controls, [icons](vis-icons.md) (including icon overlays), [links](ctrl-links.md), [tabs](ctrl-tabs.md), [progressive disclosure controls](ctrl-progressive-disclosure-controls.md), and custom controls. \[newline\] ![screen shot of e-mail button with infotip ](images/ctrl-tooltips-and-infotips-image9.png)\[newline\] ![screen shot of burn button with infotip ](images/ctrl-tooltips-and-infotips-image10.png)<br/> In these examples, infotips provide supplemental information about controls and objects.<br/>                                                                                        |
| **Alt text infotips**\[newline\] describe a graphic for accessibility. \[newline\]                                              | this pattern is primarily for users who have some form of vision impairment, and may be using a screen reader. \[newline\] ![screen shot of windows start button with infotip ](images/ctrl-tooltips-and-infotips-image11.png)<br/> In this example, the infotip describes the Start menu graphic.<br/>                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Thumbnails**\[newline\] display a small image of an item. \[newline\]                                                         | thumbnails give an easily recognizable graphic representation of a window or document. \[newline\] ![screen shot of control panel categories thumbnail ](images/ctrl-tooltips-and-infotips-image12.png)\[newline\] in this example, the windows taskbar gives thumbnail tips for its items.\[newline\] ![screen shot of thumbnail of photo and its data ](images/ctrl-tooltips-and-infotips-image13.png)<br/> In this example, Windows Photo Gallery gives thumbnail tips for its items.<br/>                                                                                                                                                                                                                      |
| **Detail infotips**\[newline\] display detailed information about an object. \[newline\]                                        | infotips are an effective way to show detailed information about an object, or to provide data. \[newline\] ![screen shot of photo's infotip showing file type ](images/ctrl-tooltips-and-infotips-image14.png)![screen shot of graph with infotip detailing values ](images/ctrl-tooltips-and-infotips-image15.png)<br/> In these examples, infotips give detailed information about an object or data.<br/>                                                                                                                                                                                                                                                                                                      |
| **Start Menu infotips**\[newline\] describe an item on the start menu. \[newline\]                                              | the start menu consists of program names and important windows destinations, such as documents, pictures, and control panel. these tips describe start menu items, typically by giving a brief description of the program or destination as well as the primary tasks users can perform with it. these descriptions are also indexed by the start menu search box, further helping users find the programs they need. \[newline\] ![screen shot of welcome center infotip ](images/ctrl-tooltips-and-infotips-image16.png)<br/> In this example, the infotip describes what users can do with a program in the Start menu.<br/>                                                                                    |
| **Control Panel infotips**\[newline\] describe a control panel category or task. \[newline\]                                    | these tips provide supplemental information to help users choose the right control panel category and item. \[newline\] ![screen shot of user accounts category with infotip ](images/ctrl-tooltips-and-infotips-image17.png)<br/> In this example, the infotip describes the User Accounts Control Panel category.<br/>                                                                                                                                                                                                                                                                                                                                                                                           |
| **Full name infotips**\[newline\] display the full name of an item when the name is truncated or not fully visible. \[newline\] | these tips allow you to display items in a more compact space, while reducing the need for horizontal scrolling. this is especially important when the content length is unknown because it is dynamic. unlike the other patterns, when used in lists and trees these tips are displayed directly over the source object. \[newline\] ![screen shot of radio-button group-title infotip ](images/ctrl-tooltips-and-infotips-image18.png)<br/> In this example, an infotip is used to display the full item name on hover.<br/>                                                                                                                                                                                     |
| **Status infotips**\[newline\] display status information for notification area icons. \[newline\]                              | normally, tips should be static because users don't expect them to change from one instance to the next. **notification area icons are an exception** because these icons communicate status, and there is no other screen space available for status text. \[newline\] ![screen shot of 'messenger not signed in' infotip ](images/ctrl-tooltips-and-infotips-image19.png)\[newline\] ![screen shot of 'messenger signed in' infotip ](images/ctrl-tooltips-and-infotips-image20.png)<br/> In these examples, infotips give status information for notification area icons.<br/>                                                                                                                                  |
...
-   **Use tooltips to provide labels for unlabeled controls.** Controls that commonly have tooltips are [toolbar buttons](cmd-toolbars.md), graphic buttons, and [progressive disclosure controls](ctrl-progressive-disclosure-controls.md). Controls with prompts are considered labeled, such as [text boxes](ctrl-text-boxes.md) and [combo boxes](https://msdn.microsoft.com/library/windows/desktop/dn742404). All other controls should have explicit labels.
...
-   Add an [ellipsis](https://www.bing.com/search?q=ellipsis) if the label is for a command that needs additional information.
...
-   Use full sentences with ending punctuation.
    -   **Exception:** Notification area [icon infotips](https://www.bing.com/search?q=icon infotips) don't use ending punctuation.
-   Use sentence-style capitalization.
