...
-   When appropriate, provide more direct or [modeless](https://www.bing.com/search?q=modeless) alternatives. Allow users to:
...
-   Use the following commands to display common dialogs (given along with their preferred [access keys](https://www.bing.com/search?q=access keys)):
...
-   Use [sentence-style capitalization](https://www.bing.com/search?q=sentence-style capitalization) for the file type names, and lowercase for the file type extensions.
