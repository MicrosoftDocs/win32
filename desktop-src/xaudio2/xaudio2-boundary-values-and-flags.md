...
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="XAUDIO2_MAX_BUFFER_BYTES"></span><span id="xaudio2_max_buffer_bytes"></span><dl> <dt>**XAUDIO2\_MAX\_BUFFER\_BYTES**</dt> </dl>             | Maximum value allowed for [**XAUDIO2\_BUFFER**](/windows/win32/xaudio2/ns-xaudio2-xaudio2_buffer?branch=master).AudioBytes.<br/>                                                      |
...
| <span id="XAUDIO2_DEFAULT_FREQ_RATIO"></span><span id="xaudio2_default_freq_ratio"></span><dl> <dt>**XAUDIO2\_DEFAULT\_FREQ\_RATIO**</dt> </dl>       | Default value for the **MaxFrequencyRatio** argument of [**IXAudio2::CreateSourceVoice**](ixaudio2-interface-createsourcevoice.md).<br/> |
| <span id="XAUDIO2_MAX_FILTER_ONEOVERQ"></span><span id="xaudio2_max_filter_oneoverq"></span><dl> <dt>**XAUDIO2\_MAX\_FILTER\_ONEOVERQ**</dt> </dl>    | Maximum value for [**XAUDIO2\_FILTER\_PARAMETERS**](/windows/win32/xaudio2/ns-xaudio2-xaudio2_filter_parameters?branch=master).**OneOverQ**.<br/>                                     |
| <span id="XAUDIO2_MAX_FILTER_FREQUENCY"></span><span id="xaudio2_max_filter_frequency"></span><dl> <dt>**XAUDIO2\_MAX\_FILTER\_FREQUENCY**</dt> </dl> | Maximum value for [**XAUDIO2\_FILTER\_PARAMETERS**](/windows/win32/xaudio2/ns-xaudio2-xaudio2_filter_parameters?branch=master).**Frequency**.<br/>                                    |
| <span id="XAUDIO2_MAX_LOOP_COUNT"></span><span id="xaudio2_max_loop_count"></span><dl> <dt>**XAUDIO2\_MAX\_LOOP\_COUNT**</dt> </dl>                   | Maximum value that will not be treated as infinite looping for [**XAUDIO2\_BUFFER**](/windows/win32/xaudio2/ns-xaudio2-xaudio2_buffer?branch=master).**LoopCount**.<br/>              |
...
| <span id="XAUDIO2_COMMIT_ALL"></span><span id="xaudio2_commit_all"></span><dl> <dt>**XAUDIO2\_COMMIT\_ALL**</dt> </dl>                         | Used as a parameter in [**IXAudio2::CommitChanges**](ixaudio2-interface-commitchanges.md).<br/>                                                                   |
...
| <span id="XAUDIO2_NO_LOOP_REGION"></span><span id="xaudio2_no_loop_region"></span><dl> <dt>**XAUDIO2\_NO\_LOOP\_REGION**</dt> </dl>            | Specifies no loop region, used in [**XAUDIO2\_BUFFER**](/windows/win32/xaudio2/ns-xaudio2-xaudio2_buffer?branch=master).**LoopCount**.<br/>                                                                    |
| <span id="XAUDIO2_LOOP_INFINITE"></span><span id="xaudio2_loop_infinite"></span><dl> <dt>**XAUDIO2\_LOOP\_INFINITE**</dt> </dl>                | Specifies infinite looping, used in [**XAUDIO2\_BUFFER**](/windows/win32/xaudio2/ns-xaudio2-xaudio2_buffer?branch=master).**LoopCount**.<br/>                                                                  |
| <span id="XAUDIO2_DEFAULT_CHANNELS"></span><span id="xaudio2_default_channels"></span><dl> <dt>**XAUDIO2\_DEFAULT\_CHANNELS**</dt> </dl>       | Specifies the default number of channels for the current platform, used in [**IXAudio2::CreateMasteringVoice**](ixaudio2-interface-createmasteringvoice.md).<br/> |
| <span id="XAUDIO2_DEFAULT_SAMPLERATE"></span><span id="xaudio2_default_samplerate"></span><dl> <dt>**XAUDIO2\_DEFAULT\_SAMPLERATE**</dt> </dl> | Specifies the default sample rate for the current platform, used in [**IXAudio2::CreateMasteringVoice**](ixaudio2-interface-createmasteringvoice.md).<br/>        |
...
<td style="text-align: left;">Specifies that the debug/checked version of the audio engine should be used instead of the release version. See [<strong>XAudio2Create</strong>](/windows/win32/xaudio2/nf-xaudio2-xaudio2create?branch=master).<br/>
<blockquote>
[!Note]<br />
...
<td style="text-align: left;">Specifies that a source voice will not use pitch shifting, see [<strong>IXAudio2::CreateSourceVoice</strong>](ixaudio2-interface-createsourcevoice.md).<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Specifies that no sample rate conversion is available on a source voice, the voice's outputs must have the same sample rate. See [<strong>IXAudio2::CreateSourceVoice</strong>](ixaudio2-interface-createsourcevoice.md).<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Specifies that the filter effect should be available on a voice. See [<strong>IXAudio2::CreateSourceVoice</strong>](ixaudio2-interface-createsourcevoice.md) and [<strong>IXAudio2::CreateSubmixVoice</strong>](ixaudio2-interface-createsubmixvoice.md).<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Specifies that a voice should continue emitting effect output after it is stopped. See [<strong>IXAudio2SourceVoice::Stop</strong>](ixaudio2sourcevoice-interface-stop.md).<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Indicates the last buffer in a stream. See [<strong>XAUDIO2_BUFFER</strong>](/windows/win32/xaudio2/ns-xaudio2-xaudio2_buffer?branch=master).<strong>Flags</strong>.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Specifies that the audio engine should stop when no source voices are started and start when a voice is started. See [<strong>XAudio2Create</strong>](/windows/win32/xaudio2/nf-xaudio2-xaudio2create?branch=master).<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Indicates a filter should be used on a voice send. See [<strong>XAUDIO2_SEND_DESCRIPTOR</strong>](/windows/win32/xaudio2/ns-xaudio2-xaudio2_send_descriptor?branch=master).<strong>Flags</strong>.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Specifies a non-default processing quantum of 21.33 ms (1024 samples at 48KHz). See [<strong>XAudio2Create</strong>](/windows/win32/xaudio2/nf-xaudio2-xaudio2create?branch=master).<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Specifies that a virtual audio client should not be used. See [<strong>IXAudio2::CreateMasteringVoice</strong>](ixaudio2-interface-createmasteringvoice.md).<br/>
<blockquote>
[!Note]<br />
