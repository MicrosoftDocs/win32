...
|                                                                                          |                                                                                                                                                                                         |
|------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetRegistrationPropertiesInternal**](https://msdn.microsoft.com/library/Ee416375(v=VS.85).aspx) | Returns a pointer to the [**XAPO\_REGISTRATION\_PROPERTIES**](/windows/desktop/api/xapo/ns-xapo-xapo_registration_properties)S structure containing the registration properties the XAPO was created with.<br/> |
| [**IsLocked**](https://msdn.microsoft.com/library/Ee416377(v=VS.85).aspx)                                                   | Checks if the XAPO is locked.<br/>                                                                                                                                                |
| LONG m\_lReferenceCount<br/>                                                       | The XAPO object's COM reference count.<br/>                                                                                                                                       |
| [**ProcessThru**](https://msdn.microsoft.com/library/Ee416378(v=VS.85).aspx)                                             | Called by an [**IXAPO::Process**](https://msdn.microsoft.com/library/Ee418456(v=VS.85).aspx) implementation when an XAPO is disabled for thru processing.<br/>                                                  |
| [**ValidateFormatDefault**](https://msdn.microsoft.com/library/Ee416380(v=VS.85).aspx)                         | Verifies that an audio format falls within the default ranges supported.<br/>                                                                                                     |
| [**ValidateFormatPair**](https://msdn.microsoft.com/library/Ee416382(v=VS.85).aspx)                               | Verifies that an input and output format pair configuration is supported with respect to the XAPO property flags.<br/>                                                            |
