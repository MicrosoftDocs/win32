...
1.  Retrieve the speaker configuration using [**IXAudio2MasteringVoice::GetChannelMask**](https://www.bing.com/search?q=**IXAudio2MasteringVoice::GetChannelMask**).
...
5.  Apply the output matrix to the originating voice by using [**IXAudio2Voice::SetOutputMatrix**](https://www.bing.com/search?q=**IXAudio2Voice::SetOutputMatrix**). The originating voice will be either a source voice or a submix voice sending to either a submix voice or a mastering voice. You can get info about the originating and destination voices, like their number of channels, by using [**IXAudio2Voice::GetVoiceDetails**](https://www.bing.com/search?q=**IXAudio2Voice::GetVoiceDetails**).
