...
1.  Overall volume adjustment, affecting all audio channels. See [**IXAudio2Voice::SetVolume**](https://www.bing.com/search?q=**IXAudio2Voice::SetVolume**).
...
3.  Per-channel output volume adjustment. See [**IXAudio2Voice::SetChannelVolumes**](https://www.bing.com/search?q=**IXAudio2Voice::SetChannelVolumes**).
...
-   An optional state-variable filter can be used to color the sound in various ways. See [**IXAudio2Voice::SetFilterParameters**](https://www.bing.com/search?q=**IXAudio2Voice::SetFilterParameters**).
-   An optional filter can be applied to the voice's outputs. See [**IXAudio2Voice::SetOutputFilterParameters**](https://www.bing.com/search?q=**IXAudio2Voice::SetOutputFilterParameters**).
