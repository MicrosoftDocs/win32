...
1.  Create a [**submix voice**](ixaudio2submixvoice.md) to which all of the game's sound effect voices will send.
    ```
...
2.  Create an [**XAUDIO2\_VOICE\_SENDS**](xaudio2-voice-sends.md) structure that contains a reference to the submix voice.
    ```
...
3.  Pass the [**XAUDIO2\_VOICE\_SENDS**](xaudio2-voice-sends.md) structure to new source voices as they are created.
    ```
