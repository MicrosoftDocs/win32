...
-   Use the [**SetVolume**](ixaudio2voice-interface-setvolume.md) function.
...
2.  Use the [**SetChannelVolumes**](ixaudio2voice-interface-setchannelvolumes.md) function to set the volume of the output channels.
...
2.  Use the [**SetOutputMatrix**](ixaudio2voice-interface-setoutputmatrix.md) function to set the output matrix.
