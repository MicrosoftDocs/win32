...
<div class="alert"><b>Note</b>  If multiple processors bits are set when calling [**XAudio2Create**](/windows/desktop/api/xaudio2/nf-xaudio2-xaudio2create), the system will create a seaprate worker thread for each processor.</div>
