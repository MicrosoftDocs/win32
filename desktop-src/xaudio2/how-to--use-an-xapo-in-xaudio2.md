...
5.  Apply the effect chain to an XAudio2 voice with the [**SetEffectChain**](ixaudio2voice-interface-seteffectchain.md) function.
    ...
    > [!Note]  
    > An effect chain can also be applied to a voice when the voice is created by passing the chain as a parameter to [**IXAudio2::CreateSourceVoice**](ixaudio2-interface-createsourcevoice.md), [**IXAudio2::CreateSubmixVoice**](ixaudio2-interface-createsubmixvoice.md), or [**IXAudio2::CreateMasteringVoice**](ixaudio2-interface-createmasteringvoice.md).
...
8.  Pass the effect parameter structure to the effect by calling the [**SetEffectParameters**](ixaudio2voice-interface-seteffectparameters.md) function on the voice to which the effect is attached.
