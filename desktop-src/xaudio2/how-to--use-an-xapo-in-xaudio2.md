...
5.  Apply the effect chain to an XAudio2 voice with the [**SetEffectChain**](https://www.bing.com/search?q=**SetEffectChain**) function.
    ...
    > [!Note]  
    > An effect chain can also be applied to a voice when the voice is created by passing the chain as a parameter to [**IXAudio2::CreateSourceVoice**](https://www.bing.com/search?q=**IXAudio2::CreateSourceVoice**), [**IXAudio2::CreateSubmixVoice**](https://www.bing.com/search?q=**IXAudio2::CreateSubmixVoice**), or [**IXAudio2::CreateMasteringVoice**](https://www.bing.com/search?q=**IXAudio2::CreateMasteringVoice**).
...
8.  Pass the effect parameter structure to the effect by calling the [**SetEffectParameters**](https://www.bing.com/search?q=**SetEffectParameters**) function on the voice to which the effect is attached.
