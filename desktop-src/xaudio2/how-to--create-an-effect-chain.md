...
4.  Apply the effect chain to a voice with the [**SetEffectChain**](ixaudio2voice-interface-seteffectchain.md) function.
...
7.  Pass the effect parameter structure to the effect by calling the [**SetEffectParameters**](ixaudio2voice-interface-seteffectparameters.md) function on the voice to which the effect is attached.
...
8.  Disable or enable the effect, whenever appropriate.
    ...
    You can use [**DisableEffect**](ixaudio2voice-interface-disableeffect.md) at any time to turn an effect off.
    ...
    You can turn on an effect again with [**EnableEffect**](ixaudio2voice-interface-enableeffect.md).
    ...
    The parameters for [**DisableEffect**](ixaudio2voice-interface-disableeffect.md) and [**EnableEffect**](ixaudio2voice-interface-enableeffect.md) specify which effect in the chain to enable or disable.
