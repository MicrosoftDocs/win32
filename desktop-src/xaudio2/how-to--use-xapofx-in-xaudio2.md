...
4.  Apply the effect chain to an XAudio2 voice with the [**SetEffectChain**](ixaudio2voice-interface-seteffectchain.md) function.
    ...
    > [!Note]  
    > You can also apply an effect chain to a voice when you create the voice by passing the chain as a parameter to [**IXAudio2::CreateSourceVoice**](ixaudio2-interface-createsourcevoice.md), [**IXAudio2::CreateSubmixVoice**](ixaudio2-interface-createsubmixvoice.md), or [**IXAudio2::CreateMasteringVoice**](ixaudio2-interface-createmasteringvoice.md).
