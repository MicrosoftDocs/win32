...
4.  Apply the effect chain to an XAudio2 voice with the [**SetEffectChain**](https://www.bing.com/search?q=**SetEffectChain**) function.
    ...
    > [!Note]  
    > You can also apply an effect chain to a voice when you create the voice by passing the chain as a parameter to [**IXAudio2::CreateSourceVoice**](https://www.bing.com/search?q=**IXAudio2::CreateSourceVoice**), [**IXAudio2::CreateSubmixVoice**](https://www.bing.com/search?q=**IXAudio2::CreateSubmixVoice**), or [**IXAudio2::CreateMasteringVoice**](https://www.bing.com/search?q=**IXAudio2::CreateMasteringVoice**).
