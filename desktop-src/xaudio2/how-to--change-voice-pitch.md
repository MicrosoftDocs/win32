...
This topic shows you how you can raise or lower the pitch of audio data by changing its rate of playback using the [**SetFrequencyRatio**](https://www.bing.com/search?q=**SetFrequencyRatio**) function on a source voice.
...
2.  Use the [**SetFrequencyRatio**](https://www.bing.com/search?q=**SetFrequencyRatio**) function to set the frequency ratio of the source voice.
