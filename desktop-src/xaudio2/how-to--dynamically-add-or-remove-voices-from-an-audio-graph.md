...
-   To add a voice or subgraph to an audio graph
    ...
    Set the output of a voice in the graph, the parent voice, to the voice to be added using the [**SetOutputVoices**](ixaudio2voice-interface-setoutputvoices.md) function. Set the output of the new voice to the original child of the parent voice.
