---
title: JET_INDEXCREATE constructor  (Microsoft.Isam.Esent.Interop)
...
- other
api_name: 
- Microsoft.Isam.Esent.Interop.JET_INDEXCREATE..ctor
topic_type: 
- apiref
- kbSyntax
api_type: 
...
Dim instance As New JET_INDEXCREATE()
```
