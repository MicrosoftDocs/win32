---
title: EsentErrorException methods (Microsoft.Isam.Esent.Interop)
TOCTitle: EsentErrorException methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.EsentErrorException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esenterrorexception_methods(v=EXCHG.10)
ms:contentKeyID: 55101647
ms.date: 07/30/2014
ms.topic: article
---

# EsentErrorException methods
...
<td>When overridden in a derived class, sets the <a href="https://msdn.microsoft.com/en-us/library/a9b6042e">SerializationInfo</a> with information about the exception. (Overrides <a href="https://msdn.microsoft.com/en-us/library/fwb1489e">Exception.GetObjectData(SerializationInfo, StreamingContext)</a>.)</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Public method" alt="Public method" /></td>
