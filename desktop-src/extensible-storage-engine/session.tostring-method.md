...
Returns a [String](https://docs.microsoft.com/dotnet/api/system.string?redirectedfrom=MSDN) that represents the current [Session](dn351164\(v=exchg.10\).md).
...
A [String](https://docs.microsoft.com/dotnet/api/system.string?redirectedfrom=MSDN) that represents the current [Session](dn351164\(v=exchg.10\).md).  
