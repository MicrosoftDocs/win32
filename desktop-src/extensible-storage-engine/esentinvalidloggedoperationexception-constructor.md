---
description: "Learn more about: EsentInvalidLoggedOperationException constructor"
...
- other
api_name: 
- Microsoft.Isam.Esent.Interop.EsentInvalidLoggedOperationException..ctor
topic_type: 
- kbSyntax
- apiref
api_type: 
...
# EsentInvalidLoggedOperationException constructor
...
Dim instance As New EsentInvalidLoggedOperationException()
```
