---
title: EsentInvalidLogSequenceException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentinvalidlogsequenceexception_members(v=EXCHG.10)
ms:contentKeyID: 55101992
ms.date: 07/30/2014
ms.topic: article
---

# EsentInvalidLogSequenceException members
...
The [EsentInvalidLogSequenceException](dn319554\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentInvalidLogSequenceException class.</td>
</tr>
</tbody>
</table>
