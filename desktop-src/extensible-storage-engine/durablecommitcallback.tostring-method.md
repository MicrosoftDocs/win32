...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.windows8.durablecommitcallback.tostring(v=EXCHG.10)
...
# DurableCommitCallback.ToString method
