---
title: EsentTableLockedException methods (Microsoft.Isam.Esent.Interop)
TOCTitle: EsentTableLockedException methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.EsentTableLockedException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esenttablelockedexception_methods(v=EXCHG.10)
ms:contentKeyID: 55103019
ms.date: 07/30/2014
ms.topic: article
---

# EsentTableLockedException methods

Include protected members  
Include inherited members  

The [EsentTableLockedException](dn334909\(v=exchg.10\).md) type exposes the following members.
