---
title: EsentOSSnapshotInvalidSequenceException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentossnapshotinvalidsequenceexception_members(v=EXCHG.10)
ms:contentKeyID: 55102377
ms.date: 07/30/2014
ms.topic: article
---

# EsentOSSnapshotInvalidSequenceException members
...
The [EsentOSSnapshotInvalidSequenceException](dn319729\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentOSSnapshotInvalidSequenceException class.</td>
</tr>
</tbody>
</table>
