...
ms:contentKeyID: 55101112
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.EsentBadColumnIdException.EsentBadColumnIdException
dev_langs:
- CSharp
- JScript
- VB
- other
api_name: 
- Microsoft.Isam.Esent.Interop.EsentBadColumnIdException..ctor
topic_type: 
- apiref
- kbSyntax
api_type: 
...
# EsentBadColumnIdException constructor
...
Dim instance As New EsentBadColumnIdException()
```
...
[EsentBadColumnIdException members](./esentbadcolumnidexception-members.md)
