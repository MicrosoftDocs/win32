---
title: EsentDataHasChangedException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentdatahaschangedexception_members(v=EXCHG.10)
ms:contentKeyID: 55101572
ms.date: 07/30/2014
ms.topic: article
---

# EsentDataHasChangedException members
...
The [EsentDataHasChangedException](dn334397\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDataHasChangedException class.</td>
</tr>
</tbody>
</table>
