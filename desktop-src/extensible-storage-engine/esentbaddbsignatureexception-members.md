---
title: EsentBadDbSignatureException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentbaddbsignatureexception_members(v=EXCHG.10)
ms:contentKeyID: 55101068
ms.date: 07/30/2014
ms.topic: article
---

# EsentBadDbSignatureException members
...
The [EsentBadDbSignatureException](dn274009\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentBadDbSignatureException class.</td>
</tr>
</tbody>
</table>
...
[EsentBadDbSignatureException class](dn274009\(v=exchg.10\).md)
