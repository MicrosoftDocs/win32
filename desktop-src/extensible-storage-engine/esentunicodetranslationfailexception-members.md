---
title: EsentUnicodeTranslationFailException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentunicodetranslationfailexception_members(v=EXCHG.10)
ms:contentKeyID: 55103150
ms.date: 07/30/2014
ms.topic: article
---

# EsentUnicodeTranslationFailException members
...
The [EsentUnicodeTranslationFailException](dn350826\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentUnicodeTranslationFailException class.</td>
</tr>
</tbody>
</table>
