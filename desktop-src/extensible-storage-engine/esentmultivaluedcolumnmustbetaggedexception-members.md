---
title: EsentMultiValuedColumnMustBeTaggedException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentmultivaluedcolumnmustbetaggedexception_members(v=EXCHG.10)
ms:contentKeyID: 55102255
ms.date: 07/30/2014
ms.topic: article
---

# EsentMultiValuedColumnMustBeTaggedException members
...
The [EsentMultiValuedColumnMustBeTaggedException](dn334758\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentMultiValuedColumnMustBeTaggedException class.</td>
</tr>
</tbody>
</table>
