---
title: JET_SETCOLUMN methods (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_SETCOLUMN methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.JET_SETCOLUMN
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_setcolumn_methods(v=EXCHG.10)
ms:contentKeyID: 55103850
ms.date: 07/30/2014
ms.topic: article
---

# JET_SETCOLUMN methods
...
<td>Returns a <a href="https://docs.microsoft.com/dotnet/api/system.string?redirectedfrom=MSDN">String</a> that represents the current <a href="dn335260(v=exchg.10).md">JET_SETCOLUMN</a>. (Overrides <a href="https://docs.microsoft.com/dotnet/api/system.object.tostring?redirectedfrom=MSDN#System_Object_ToString">Object.ToString()</a>.)</td>
</tr>
</tbody>
</table>
