---
title: EsentMissingCurrentLogFilesException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentmissingcurrentlogfilesexception_members(v=EXCHG.10)
ms:contentKeyID: 55102201
ms.date: 07/30/2014
ms.topic: article
---

# EsentMissingCurrentLogFilesException members
...
The [EsentMissingCurrentLogFilesException](dn334701\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentMissingCurrentLogFilesException class.</td>
</tr>
</tbody>
</table>
