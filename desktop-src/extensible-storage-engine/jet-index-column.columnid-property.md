...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.windows8.jet_index_column.columnid(v=EXCHG.10)
...
# JET_INDEX_COLUMN.columnid property
