---
title: EsentSeparatedLongValueException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentseparatedlongvalueexception_members(v=EXCHG.10)
ms:contentKeyID: 55102687
ms.date: 07/30/2014
ms.topic: article
---

# EsentSeparatedLongValueException members
...
The [EsentSeparatedLongValueException](dn350615\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentSeparatedLongValueException class.</td>
</tr>
</tbody>
</table>
