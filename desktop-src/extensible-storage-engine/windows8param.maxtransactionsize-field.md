...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.windows8.windows8param.maxtransactionsize(v=EXCHG.10)
...
Percentage of version store that can be used by oldest transaction before [VersionStoreOutOfMemory](hh564840\(v=exchg.10\).md) (default = 100).
