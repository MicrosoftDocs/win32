---
title: EsentLogCorruptedException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentlogcorruptedexception_members(v=EXCHG.10)
ms:contentKeyID: 55102072
ms.date: 07/30/2014
ms.topic: article
---

# EsentLogCorruptedException members
...
The [EsentLogCorruptedException](dn334510\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentLogCorruptedException class.</td>
</tr>
</tbody>
</table>
