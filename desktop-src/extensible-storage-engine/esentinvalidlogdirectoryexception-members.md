---
title: EsentInvalidLogDirectoryException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentinvalidlogdirectoryexception_members(v=EXCHG.10)
ms:contentKeyID: 55101978
ms.date: 07/30/2014
ms.topic: article
---

# EsentInvalidLogDirectoryException members
...
The [EsentInvalidLogDirectoryException](dn319548\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentInvalidLogDirectoryException class.</td>
</tr>
</tbody>
</table>
...
[EsentInvalidLogDirectoryException class](dn319548\(v=exchg.10\).md)
