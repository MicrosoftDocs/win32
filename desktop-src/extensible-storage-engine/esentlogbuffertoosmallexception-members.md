---
title: EsentLogBufferTooSmallException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentlogbuffertoosmallexception_members(v=EXCHG.10)
ms:contentKeyID: 55102065
ms.date: 07/30/2014
ms.topic: article
---

# EsentLogBufferTooSmallException members
...
The [EsentLogBufferTooSmallException](dn334573\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentLogBufferTooSmallException class.</td>
</tr>
</tbody>
</table>
...
[EsentLogBufferTooSmallException class](dn334573\(v=exchg.10\).md)
