---
title: EsentTransTooDeepException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esenttranstoodeepexception_members(v=EXCHG.10)
ms:contentKeyID: 55103138
ms.date: 07/30/2014
ms.topic: article
---

# EsentTransTooDeepException members
...
The [EsentTransTooDeepException](dn350808\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentTransTooDeepException class.</td>
</tr>
</tbody>
</table>
