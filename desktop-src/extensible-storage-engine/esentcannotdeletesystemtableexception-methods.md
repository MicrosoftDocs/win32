---
title: EsentCannotDeleteSystemTableException methods (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentcannotdeletesystemtableexception_methods(v=EXCHG.10)
ms:contentKeyID: 55101139
ms.date: 07/30/2014
ms.topic: article
---

# EsentCannotDeleteSystemTableException methods

Include protected members  
Include inherited members  

The [EsentCannotDeleteSystemTableException](dn274139\(v=exchg.10\).md) type exposes the following members.
