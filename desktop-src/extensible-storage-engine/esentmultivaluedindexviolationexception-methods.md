---
title: EsentMultiValuedIndexViolationException methods (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentmultivaluedindexviolationexception_methods(v=EXCHG.10)
