---
title: EsentLogFilePathInUseException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentlogfilepathinuseexception_members(v=EXCHG.10)
ms:contentKeyID: 55102182
ms.date: 07/30/2014
ms.topic: article
---

# EsentLogFilePathInUseException members
...
The [EsentLogFilePathInUseException](dn334545\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentLogFilePathInUseException class.</td>
</tr>
</tbody>
</table>
