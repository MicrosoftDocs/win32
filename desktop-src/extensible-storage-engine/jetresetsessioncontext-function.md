...
| <p>JET_errSessionContextNotSetByThisThread</p> | <p>The session could not be disassociated from the current thread because it is associated with a different thread.</p> | 
