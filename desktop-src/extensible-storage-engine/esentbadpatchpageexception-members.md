---
title: EsentBadPatchPageException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentbadpatchpageexception_members(v=EXCHG.10)
ms:contentKeyID: 55101096
ms.date: 07/30/2014
ms.topic: article
---

# EsentBadPatchPageException members
...
The [EsentBadPatchPageException](dn274093\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentBadPatchPageException class.</td>
</tr>
</tbody>
</table>
...
[EsentBadPatchPageException class](dn274093\(v=exchg.10\).md)
