---
title: EsentInvalidColumnException properties (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentinvalidcolumnexception_properties(v=EXCHG.10)
ms:contentKeyID: 55101890
ms.date: 07/30/2014
ms.topic: article
---

# EsentInvalidColumnException properties
...
<td>Gets a text message describing the exception. (Overrides <a href="https://docs.microsoft.com/dotnet/api/system.exception.message?redirectedfrom=MSDN#System_Exception_Message">Exception.Message</a>.)</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Public property" alt="Public property" /></td>
