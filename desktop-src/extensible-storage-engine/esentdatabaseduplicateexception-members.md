---
title: EsentDatabaseDuplicateException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentdatabaseduplicateexception_members(v=EXCHG.10)
ms:contentKeyID: 55101462
ms.date: 07/30/2014
ms.topic: article
---

# EsentDatabaseDuplicateException members
...
The [EsentDatabaseDuplicateException](dn334296\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentDatabaseDuplicateException class.</td>
</tr>
</tbody>
</table>
