---
title: EsentIndexHasPrimaryException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentindexhasprimaryexception_members(v=EXCHG.10)
ms:contentKeyID: 55101818
ms.date: 07/30/2014
ms.topic: article
---

# EsentIndexHasPrimaryException members
...
The [EsentIndexHasPrimaryException](dn350439\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentIndexHasPrimaryException class.</td>
</tr>
</tbody>
</table>
