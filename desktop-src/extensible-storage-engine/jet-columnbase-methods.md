---
title: JET_COLUMNBASE methods (Microsoft.Isam.Esent.Interop)
TOCTitle: JET_COLUMNBASE methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.JET_COLUMNBASE
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.jet_columnbase_methods(v=EXCHG.10)
ms:contentKeyID: 55103433
ms.date: 07/30/2014
ms.topic: article
---

# JET_COLUMNBASE methods
...
<td>Returns a <a href="https://docs.microsoft.com/dotnet/api/system.string?redirectedfrom=MSDN">String</a> that represents the current <a href="dn335045(v=exchg.10).md">JET_COLUMNBASE</a>. (Overrides <a href="https://docs.microsoft.com/dotnet/api/system.object.tostring?redirectedfrom=MSDN#System_Object_ToString">Object.ToString()</a>.)</td>
</tr>
</tbody>
</table>
