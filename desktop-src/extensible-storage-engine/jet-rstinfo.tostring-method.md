...
Returns a [String](/dotnet/api/system.string) that represents the current [JET_RSTINFO](dn335235\(v=exchg.10\).md).
...
A [String](/dotnet/api/system.string) that represents the current [JET_RSTINFO](dn335235\(v=exchg.10\).md).  
