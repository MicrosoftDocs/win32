...
| <p>JET_DbInfoPageSize</p> | <p>Available only on Windows XP and later. <em>pvResult</em> will be interpreted as an unsigned long. This will return the page size of the database in bytes.</p> | 
