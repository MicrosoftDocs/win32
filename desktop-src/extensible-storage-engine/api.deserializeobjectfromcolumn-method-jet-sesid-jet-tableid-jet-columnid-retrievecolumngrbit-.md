---
title: Api.DeserializeObjectFromColumn method (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit)
...
[DeserializeObjectFromColumn overload](./api.deserializeobjectfromcolumn-method.md)
