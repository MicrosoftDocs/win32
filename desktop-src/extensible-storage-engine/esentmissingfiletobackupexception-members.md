---
title: EsentMissingFileToBackupException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentmissingfiletobackupexception_members(v=EXCHG.10)
ms:contentKeyID: 55102291
ms.date: 07/30/2014
ms.topic: article
---

# EsentMissingFileToBackupException members
...
The [EsentMissingFileToBackupException](dn334656\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentMissingFileToBackupException class.</td>
</tr>
</tbody>
</table>
