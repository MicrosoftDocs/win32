---
title: EsentReadPgnoVerifyFailureException members (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentreadpgnoverifyfailureexception_members(v=EXCHG.10)
ms:contentKeyID: 55102496
ms.date: 07/30/2014
ms.topic: article
---

# EsentReadPgnoVerifyFailureException members
...
The [EsentReadPgnoVerifyFailureException](dn319871\(v=exchg.10\).md) type exposes the following members.
...
<td>Initializes a new instance of the EsentReadPgnoVerifyFailureException class.</td>
</tr>
</tbody>
</table>
