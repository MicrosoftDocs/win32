---
title: EsentBadRestoreTargetInstanceException properties (Microsoft.Isam.Esent.Interop)
...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.isam.esent.interop.esentbadrestoretargetinstanceexception_properties(v=EXCHG.10)
ms:contentKeyID: 55101103
ms.date: 07/30/2014
ms.topic: article
---

# EsentBadRestoreTargetInstanceException properties

Include protected members  
Include inherited members  

The [EsentBadRestoreTargetInstanceException](dn274044\(v=exchg.10\).md) type exposes the following members.
