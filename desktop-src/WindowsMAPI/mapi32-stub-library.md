...
Simple MAPI provides a set of functions that enable you to add a basic level of messaging functionality to Microsoft Windows-based applications. Extended MAPI is the same as [Microsoft Outlook 2007 MAPI](https://msdn.microsoft.com/windows/desktop/3d980b86-7001-4869-9780-121c6bfc7275), and is simply referred to as MAPI in the MAPI documentation.
