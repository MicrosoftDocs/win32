...
The Publication API is used to interact with remote contacts. The [Peer Signaling](https://www.bing.com/search?q=Peer Signaling) layer used by the Publication Manager is also used by the PNM module for establishing connections.
