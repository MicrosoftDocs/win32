...
You set the Content property of a visual by calling the [**IDCompositionVisual::SetContent**](/windows/desktop/api/Dcomp/) method.
...
For more information, see [**IDCompositionVisual::SetBorderMode**](/windows/desktop/api/Dcomp/).
...
You set the BitmapInterpolationMode property of a visual by calling the [**IDCompositionVisual::SetBitmapInterpolationMode**](/windows/desktop/api/Dcomp/) method.
...
You set the CompositeMode property of a visual by calling the [**IDCompositionVisual::SetCompositeMode**](/windows/desktop/api/Dcomp/) method.
...
You set the OffsetX and OffsetY properties of a visual by calling the [**IDCompositionVisual::SetOffsetX**](/windows/desktop/api/Dcomp/) and [**SetOffsetY**](/windows/desktop/api/Dcomp/) methods.
...
You set the Effect property of a visual by calling the [**IDCompositionVisual::SetEffect**](/windows/desktop/api/Dcomp/) method.
...
You set the Transform property of a visual by calling the [**IDCompositionVisual::SetTransform**](/windows/desktop/api/Dcomp/) method.
...
You set the TransformParent property of a visual by calling the [**IDCompositionVisual::SetTransformParent**](/windows/desktop/api/Dcomp/) method.
...
The [**IDCompositionSurface::BeginDraw**](/windows/desktop/api/Dcomp/) and [**IDCompositionSurface::EndDraw**](/windows/desktop/api/Dcomp/) methods let you synchronize rendering updates with visual updates. For example, you can call **IDCompositionSurface::BeginDraw**, update the OffsetX and Clip properties of a visual, call [**IDCompositionDevice::Commit**](/windows/desktop/api/Dcomp/), draw content with Microsoft DirectX, and then call **IDCompositionSurface::EndDraw**. In this case, Microsoft DirectComposition ensures that bitmap content and the visual properties are updated at the same time.
...
-   For the Transform property, you can use [**IDCompositionDevice::CreateTransformGroup**](/windows/desktop/api/Dcomp/) to create a group of transforms to apply to a visual all at once. DirectComposition applies the transforms in the order that you specify.
-   For the Effect property, you can use [**IDCompositionEffectGroup**](/windows/desktop/api/Dcomp/) to apply a group of effects. DirectComposition applies the effects in the order that you specify. In addition, 3D perspective transformations result in flattening of the visual tree after all 3D transformations in the current visual have been applied. This helps ensure that the resulting visual looks as close to 3D as possible.
...
-   Both threads need to be able to call [**IDCompositionDevice::Commit**](/windows/desktop/api/Dcomp/). If only one of the threads calls **IDCompositionDevice::Commit**, the other thread cannot commit any of its changes to DirectComposition.
-   Transactional behavior might be lost if one thread calls [**IDCompositionDevice::Commit**](/windows/desktop/api/Dcomp/) while the other thread is still making changes that are intended to be part of the same transaction.
...
[**IDCompositionSurface::BeginDraw**](/windows/desktop/api/Dcomp/)
</dt> <dt>

[**IDCompositionSurface::EndDraw**](/windows/desktop/api/Dcomp/)
</dt> <dt>

[**IDCompositonDevice::Commit**](/windows/desktop/api/Dcomp/)
</dt> <dt>
