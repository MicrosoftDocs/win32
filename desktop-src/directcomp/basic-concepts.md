...
You set the BitmapInterpolationMode property of a visual by calling the [**IDCompositionVisual::SetBitmapInterpolationMode**](https://msdn.microsoft.com/en-us/library/Hh449147(v=VS.85).aspx) method.
