...
You set the Content property of a visual by calling the [**IDCompositionVisual::SetContent**](https://msdn.microsoft.com/library/Hh449157(v=VS.85).aspx) method.
...
For more information, see [**IDCompositionVisual::SetBorderMode**](https://msdn.microsoft.com/library/Hh449149(v=VS.85).aspx).
...
You set the BitmapInterpolationMode property of a visual by calling the [**IDCompositionVisual::SetBitmapInterpolationMode**](https://msdn.microsoft.com/library/Hh449147(v=VS.85).aspx) method.
...
You set the CompositeMode property of a visual by calling the [**IDCompositionVisual::SetCompositeMode**](https://msdn.microsoft.com/library/Hh802902(v=VS.85).aspx) method.
...
You set the OffsetX and OffsetY properties of a visual by calling the [**IDCompositionVisual::SetOffsetX**](https://msdn.microsoft.com/library/Hh449126(v=VS.85).aspx) and [**SetOffsetY**](https://msdn.microsoft.com/library/Hh449131(v=VS.85).aspx) methods.
...
You set the Effect property of a visual by calling the [**IDCompositionVisual::SetEffect**](https://msdn.microsoft.com/library/Hh449159(v=VS.85).aspx) method.
...
You set the Transform property of a visual by calling the [**IDCompositionVisual::SetTransform**](https://msdn.microsoft.com/library/Hh449178(v=VS.85).aspx) method.
...
You set the TransformParent property of a visual by calling the [**IDCompositionVisual::SetTransformParent**](https://msdn.microsoft.com/library/Hh449172(v=VS.85).aspx) method.
...
The [**IDCompositionSurface::BeginDraw**](https://msdn.microsoft.com/library/Hh449100(v=VS.85).aspx) and [**IDCompositionSurface::EndDraw**](https://msdn.microsoft.com/library/Hh449102(v=VS.85).aspx) methods let you synchronize rendering updates with visual updates. For example, you can call **IDCompositionSurface::BeginDraw**, update the OffsetX and Clip properties of a visual, call [**IDCompositionDevice::Commit**](https://msdn.microsoft.com/library/Hh437393(v=VS.85).aspx), draw content with Microsoft DirectX, and then call **IDCompositionSurface::EndDraw**. In this case, Microsoft DirectComposition ensures that bitmap content and the visual properties are updated at the same time.
...
-   For the Transform property, you can use [**IDCompositionDevice::CreateTransformGroup**](https://msdn.microsoft.com/library/Hh437410(v=VS.85).aspx) to create a group of transforms to apply to a visual all at once. DirectComposition applies the transforms in the order that you specify.
-   For the Effect property, you can use [**IDCompositionEffectGroup**](https://msdn.microsoft.com/library/Hh437418(v=VS.85).aspx) to apply a group of effects. DirectComposition applies the effects in the order that you specify. In addition, 3D perspective transformations result in flattening of the visual tree after all 3D transformations in the current visual have been applied. This helps ensure that the resulting visual looks as close to 3D as possible.
...
-   Both threads need to be able to call [**IDCompositionDevice::Commit**](https://msdn.microsoft.com/library/Hh437393(v=VS.85).aspx). If only one of the threads calls **IDCompositionDevice::Commit**, the other thread cannot commit any of its changes to DirectComposition.
-   Transactional behavior might be lost if one thread calls [**IDCompositionDevice::Commit**](https://msdn.microsoft.com/library/Hh437393(v=VS.85).aspx) while the other thread is still making changes that are intended to be part of the same transaction.
...
[**IDCompositionSurface::BeginDraw**](https://msdn.microsoft.com/library/Hh449100(v=VS.85).aspx)
</dt> <dt>

[**IDCompositionSurface::EndDraw**](https://msdn.microsoft.com/library/Hh449102(v=VS.85).aspx)
</dt> <dt>

[**IDCompositonDevice::Commit**](https://msdn.microsoft.com/library/Hh437393(v=VS.85).aspx)
</dt> <dt>
