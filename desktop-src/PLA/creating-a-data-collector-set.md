...
After specifying the property values for the data collector set, you need to [add one or more data collectors to the set](adding-a-data-collector-to-a-data-collector-set.md) and call the [**IDataCollectorSet::Commit**](/previous-versions/windows/desktop/api/Pla/nf-pla-idatacollectorset-commit) method to save the set. Before calling **Commit**, you can optionally [specify a schedule for running the set](running-a-data-collector-set.md) and [specify how to manage the collected data](managing-the-data-of-a-data-collector-set.md).
