...
3.  For all sides found, the application must call the [**AllocateNtmsMedia**](/windows/desktop/api/Ntmsapi/nf-ntmsapi-allocatentmsmedia) function, specifying the side and media pool.
