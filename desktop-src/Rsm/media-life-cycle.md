...
When a new cartridge is inserted into a library, RSM typically puts the cartridge in either the import or the unrecognized media pool. The administrator or your application can move the cartridge to the appropriate free media pool using the [**MoveToNtmsMediaPool**](/windows/desktop/api/Ntmsapi/nf-ntmsapi-movetontmsmediapool) function.
