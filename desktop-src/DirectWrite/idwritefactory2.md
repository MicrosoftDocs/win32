...
The **IDWriteFactory1** interface inherits from [**IDWriteFactory1**](/windows/win32/dwrite_1/?branch=master). **IDWriteFactory2** also has these types of members:
...
| [**CreateFontFallbackBuilder**](/windows/win32/dwrite_2/?branch=master)     | Creates a font fallback builder object.<br/>                                                         |
...
| [**TranslateColorGlyphRun**](/windows/win32/dwrite_2/?branch=master)           | This method is called on a glyph run to translate it in to multiple color glyph runs.<br/>           |
