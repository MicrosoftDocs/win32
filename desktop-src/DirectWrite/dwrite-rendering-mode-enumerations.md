...
<blockquote>
[!Note]<br />
This topic is about [<strong>DWRITE_RENDERING_MODE</strong>](/windows/desktop/api/dwrite/ne-dwrite-dwrite_rendering_mode) in Windows 8 and later. For info on the previous version see [<strong>this topic</strong>](/windows/desktop/api/dwrite/).
</blockquote>
<br/></td>
</tr>
<tr class="even">
<td>[<strong>DWRITE_RENDERING_MODE</strong>](/windows/desktop/api/dwrite/)<br/></td>
<td>Represents a method of rendering glyphs. <br/>
<blockquote>
[!Note]<br />
