...
keywords: ["GetSystemFontFallback method Direct Write", "GetSystemFontFallback method Direct Write , IDWriteFactory2 interface", "IDWriteFactory2 interface Direct Write , GetSystemFontFallback method"]
topic_type:
- apiref
api_name:
...
Type: **[**IDWriteFontFallback**](idwritefontfallback.md)\*\***
