...
Your custom text renderer will need a constructor. This example uses both solid and bitmap [Direct2D](direct2d.direct2d_portal.xml) brushes to render the text.
