...
| [**IDWriteBitmapRenderTarget2**](/windows/win32/directwrite/dwrite_3/nn-dwrite_3-idwritebitmaprendertarget2) | Encapsulates a 32-bit device independent bitmap and device context, which can be used for rendering glyphs. |
