...
keywords: ["GetMetrics method Direct Write", "GetMetrics method Direct Write , IDWriteTextLayout2 interface", "IDWriteTextLayout2 interface Direct Write , GetMetrics method"]
topic_type:
- apiref
api_name:
...
Type: **[**DWRITE\_TEXT\_METRICS1**](dwrite-text-metrics1.md)\***
