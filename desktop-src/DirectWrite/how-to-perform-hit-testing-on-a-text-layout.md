...
Provides a short tutorial about how to add hit testing to a [DirectWrite](direct-write-portal.md) application that displays text by using the [**IDWriteTextLayout**](/windows/desktop/api/dwrite/) interface.
...
To begin, you will need an application that uses an [**IDWriteTextLayout**](/windows/desktop/api/dwrite/) object. If you already have an application that displays text with a text layout, go to Step 2.
...
To determine where the user has clicked the text layout we will use the [**IDWriteTextLayout::HitTestPoint**](/windows/desktop/api/dwrite/) method.
...
1.  Declare the variables we will pass as parameters to the method.
    ...
    The [**HitTestPoint**](/windows/desktop/api/dwrite/) method outputs the following parameters.
...
2.  Call the [**HitTestPoint**](/windows/desktop/api/dwrite/) method of the [**IDWriteTextLayout**](/windows/desktop/api/dwrite/) object.
...
Add the following to the **OnClick** you defined in Step 2, after the call to the [**HitTestPoint**](/windows/desktop/api/dwrite/) method.
...
2.  The **textPosition** member of the *hitTestMetrics* structure contains the zero-based index of the character clicked.
    ...
    Gets the underline for this character by passing this value to the [**IDWriteTextLayout::GetUnderline**](/windows/desktop/api/dwrite/) method.
...
4.  Toggles the underline by using the [**IDWriteTextLayout::SetUnderline**](/windows/desktop/api/dwrite/) method.
