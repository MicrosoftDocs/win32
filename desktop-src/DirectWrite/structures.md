...
| [**DWRITE\_PANOSE**](/windows/desktop/api/Dwrite_1/ns-dwrite_1-dwrite_panose)<br/>                                        | The [**DWRITE\_PANOSE**](/windows/desktop/api/Dwrite_1/ns-dwrite_1-dwrite_panose) union describes typeface classification values that you use with [**IDWriteFont1::GetPanose**](/windows/desktop/api/dwrite_1/) to select and match the font.<br/> |
...
| [**DWRITE\_TEXT\_RANGE**](/windows/desktop/api/dwrite/ns-dwrite-dwrite_text_range)<br/>                               | Specifies a range of text positions where format is applied in the text represented by an [**IDWriteTextLayout**](/windows/desktop/api/dwrite/) object.<br/>                                                     |
