...
-   Certain DirectWrite APIs use the [**DWRITE\_FONT\_WEIGHT**](dwrite-font-weight.md), [**DWRITE\_FONT\_STRETCH**](dwrite-font-stretch.md) and [**DWRITE\_FONT\_STYLE**](dwrite-font-style.md) enumerations for specifying weight, stretch and style attributes when selecting faces. If a variable font uses corresponding variation axes but has many named instances that require finer granularity, not all of the named instances will be selectable in those APIs.
