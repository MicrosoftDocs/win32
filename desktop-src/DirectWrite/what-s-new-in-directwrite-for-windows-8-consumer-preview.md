...
-   [**IDWriteFactory3::GetSystemFontCollection**](/windows/desktop/api/dwrite_3/) method
...
-   [**IDWriteFontFactory3::GetSystemFontSet**](/windows/desktop/api/dwrite_3/) method
...
-   [**IDWriteGdiInterop1**](/windows/desktop/api/dwrite_3/) interface
...
-   [**IDWriteFactory2::TranslateColorGlyphRun**](/windows/desktop/api/dwrite_2/) method

## What's new in Windows 8

A new factory interface, [**IDWriteFactory1**](/windows/desktop/api/dwrite_1/), for creating additional interfaces that are available.
...
Starting in Windows 8, the [**GetScriptProperties**](/windows/desktop/api/dwrite_1/) method returns info for a number of new scripts. Here is the list of scripts that [DirectWrite](direct-write-portal.md) supports in Windows 8 and after.
