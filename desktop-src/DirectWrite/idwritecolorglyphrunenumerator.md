...
keywords: ["IDWriteColorGlyphRunEnumerator interface Direct Write", "IDWriteColorGlyphRunEnumerator interface Direct Write , described"]
topic_type:
- apiref
api_name:
...
| Method                                                                | Description                                                 |
|:----------------------------------------------------------------------|:------------------------------------------------------------|
| [**GetCurrentRun**](idwritecolorglyphrunenumerator-getcurrentrun.md) | Returns the current glyph run of the enumerator.<br/> |
