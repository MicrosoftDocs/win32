...
keywords: ["GetServerClusterName method", "GetServerClusterName method, MSFT_ServerManagerTasks class", "MSFT_ServerManagerTasks class, GetServerClusterName method"]
topic_type:
- apiref
api_name:
