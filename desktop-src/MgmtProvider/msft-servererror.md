...
api_name:
- MSFT_ServerError
- MSFT_ServerError.ErrorType
- MSFT_ServerError.OtherErrorType
- MSFT_ServerError.OwningEntity
- MSFT_ServerError.MessageID
- MSFT_ServerError.Message
- MSFT_ServerError.MessageArguments
- MSFT_ServerError.PerceivedSeverity
- MSFT_ServerError.ProbableCause
- MSFT_ServerError.ProbableCauseDescription
- MSFT_ServerError.RecommendedActions
- MSFT_ServerError.ErrorSource
- MSFT_ServerError.ErrorSourceFormat
- MSFT_ServerError.OtherErrorSourceFormat
- MSFT_ServerError.CIMStatusCode
- MSFT_ServerError.CIMStatusCodeDescription
- MSFT_ServerError.ErrorCode
- MSFT_ServerError.ExtendedErrorCode
api_location:
- MgmtProvider.dll
api_type:
- DllExport
...
``` syntax
[Indication, Exception, UMLPackagePath("CIM::Interop"), ClassVersion("1.0.0"), AMENDMENT]
...
The **MSFT\_ServerError** class has these types of members:

-   [Properties](#properties)

### Properties

The **MSFT\_ServerError** class has these properties.
...
The error code reported by the provider.
...
The extended error code reported by the provider.
