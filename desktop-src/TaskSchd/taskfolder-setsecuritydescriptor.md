...
keywords: ["SetSecurityDescriptor property Task Scheduler", "SetSecurityDescriptor property Task Scheduler , TaskFolder object", "TaskFolder object Task Scheduler , SetSecurityDescriptor property"]
topic_type:
- apiref
api_name:
