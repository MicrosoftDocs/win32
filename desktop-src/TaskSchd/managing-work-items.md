...
Whenever you modify a work item, you must call the [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**) object to save the modified work item to disk. The [**IPersistFile**](https://www.bing.com/search?q=**IPersistFile**) interface is a standard COM interface that is supported by the [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask) interface.
