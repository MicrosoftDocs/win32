...
5.  Call **ITask::Release** to free resources and [**CoUninitialize**](https://www.bing.com/search?q=**CoUninitialize**) to uninitialize COM. This example calls [**Release**](https://www.bing.com/search?q=**Release**) to free the pointer to the [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask) interface. (Note that **Release** is an [**IUnknown**](https://www.bing.com/search?q=**IUnknown**) method inherited by **ITask**.)
