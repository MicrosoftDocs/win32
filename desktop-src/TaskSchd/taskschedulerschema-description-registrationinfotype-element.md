...
keywords: ["Description element Task Scheduler"]
topic_type:
- apiref
api_name:
- Description
...
For C++ development, the description of a task is specified using the [**IRegistrationInfo::Description**](iregistrationinfo-description.md) property.
