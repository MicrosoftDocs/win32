...
keywords: ["GetSecurityDescriptor property Task Scheduler", "GetSecurityDescriptor property Task Scheduler , TaskFolder object", "TaskFolder object Task Scheduler , GetSecurityDescriptor property"]
topic_type:
- apiref
api_name:
