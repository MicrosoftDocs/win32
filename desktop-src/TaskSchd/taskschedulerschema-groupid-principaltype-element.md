...
keywords: ["GroupId element Task Scheduler"]
topic_type:
- apiref
api_name:
- GroupId
...
For C++ development, the group identifier of the principal is specified using the [**IPrincipal::GroupId**](iprincipal-groupid.md) property.
