...
For C++ development, the group identifier of the principal is specified using the [**IPrincipal::GroupId**](/windows/win32/taskschd/nf-taskschd-iprincipal-get_groupid?branch=master) property.
