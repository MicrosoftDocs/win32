...
In the following examples, the modified object is always saved to disk by a call to [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**). (The [**IPersistFile**](https://www.bing.com/search?q=**IPersistFile**) interface is a standard COM interface inherited by the task object.)

The following procedure describes how to set a task property.

**To set a task property**

1.  Call [**CoInitialize**](https://www.bing.com/search?q=**CoInitialize**) to initialize the COM library and [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**) to get a Task Scheduler object. (These examples assume that the Task Scheduler service is running.)
...
4.  Call [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**) to store the modified task object to disk.
