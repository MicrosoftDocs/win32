...
keywords: ["event trigger Task Scheduler , object", "EventTrigger object Task Scheduler", "EventTrigger object Task Scheduler , described"]
topic_type:
- apiref
api_name:
- EventTrigger
...
For more information and a code example for this scripting object, see [Event Trigger Example (Scripting)](taskschd-event_trigger_example__scripting_).
