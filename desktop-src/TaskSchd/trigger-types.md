...
| Idle trigger (event-based trigger)For scripting development, see [**IdleTrigger**](idletrigger.md).<br/> For C++ development, see [**IIdleTrigger**](/windows/desktop/api/taskschd/).<br/> For XML development, see [**IdleTrigger Element**](taskschedulerschema-idletrigger-triggergroup-element.md).<br/>                                                                                                     | Starts the task when the computer enters an idle state.                                                                                                                                      |
