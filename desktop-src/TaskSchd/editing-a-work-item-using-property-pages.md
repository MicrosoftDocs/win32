...
3.  Call [**IScheduledWorkItem::EditWorkItem**](/windows/win32/Mstask/nf-mstask-ischeduledworkitem-editworkitem?branch=master) to display the property pages for the task.
