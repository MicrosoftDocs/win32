...
An object that provides methods for enumerating tasks in the Scheduled Tasks folder. This object supports two interfaces: **IUnknown** and [**IEnumWorkItems**](/windows/win32/Mstask/nn-mstask-ienumworkitems?branch=master). Enumeration objects are created by calls to [**ITaskScheduler::Enum**](/windows/win32/Mstask/nf-mstask-itaskscheduler-enum?branch=master).
