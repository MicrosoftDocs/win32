...
6.  Save the task with the new trigger to disk using [**IPersistFile::Save**](da9581e8-98c7-4592-8ee1-a1bc8232635b). (The [**IPersistFile**](7d34507f-8a16-43b4-8225-010798abc546) interface is a standard COM interface supported by the [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask) interface.)
7.  Call [**Release**](4b494c6f-f0ee-4c35-ae45-ed956f40dc7a) to release all resources. (Note that **Release** is an [**IUnknown**](33f1d79a-33fc-4ce5-a372-e08bda378332) method inherited by [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask).)
