...
6.  Save the task with the new trigger to disk using [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**). (The [**IPersistFile**](https://www.bing.com/search?q=**IPersistFile**) interface is a standard COM interface supported by the [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask) interface.)
7.  Call [**Release**](https://www.bing.com/search?q=**Release**) to release all resources. (Note that **Release** is an [**IUnknown**](https://www.bing.com/search?q=**IUnknown**) method inherited by [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask).)
