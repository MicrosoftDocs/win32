...
Flags that specify how to set the security descriptor. The TASK\_DONT\_ADD\_PRINCIPAL\_ACE flag (0x10) from the [**TASK\_CREATION**](/windows/win32/taskschd/ne-taskschd-_task_creation?branch=master) enumeration can be specified.
