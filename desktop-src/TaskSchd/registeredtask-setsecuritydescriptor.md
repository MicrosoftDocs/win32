...
keywords: ["SetSecurityDescriptor method Task Scheduler", "SetSecurityDescriptor method Task Scheduler , RegisteredTask object", "RegisteredTask object Task Scheduler , SetSecurityDescriptor method"]
topic_type:
- apiref
api_name:
...
Flags that specify how to set the security descriptor. The TASK\_DONT\_ADD\_PRINCIPAL\_ACE flag (0x10) from the [**TASK\_CREATION**](taskcreation.md) enumeration can be specified.
