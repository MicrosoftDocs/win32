...
keywords: ["UseUnifiedSchedulingEngine element Task Scheduler"]
topic_type:
- apiref
api_name:
...
For C++ development, this information is accessed through the [**ITaskSettings2::UseUnifiedSchedulingEngine**](itasksettings2-useunifiedschedulingengine.md) property.
