...
The highest version of Task Scheduler that a computer supports. The highest version is a value that is split into MajorVersion/MinorVersion on the 16-bit boundary. The Task Scheduler service returns 1 for the major version and 2 for the minor version. Use the [CLng](Http://go.microsoft.com/fwlink/p/?linkid=84362) function to get the integer value of the property.

## Examples

The following code shows how to use the [CLng](Http://go.microsoft.com/fwlink/p/?linkid=84362) function to get the value of the **HighestVersion** property.
