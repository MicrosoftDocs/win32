...
These conditions are set by calling [**IScheduledWorkItem::SetFlags**](ischeduledworkitem-setflags.md).
...
Idle triggers are created by setting the TASK\_TRIGGER\_TYPE member of the [**TASK\_TRIGGER**](task-trigger.md) structure to TASK\_EVENT\_TRIGGER\_ON\_IDLE.
...
The idle time is set by a call to [**IScheduledWorkItem::SetIdleWait**](ischeduledworkitem-setidlewait.md).
