...
|--------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**IEnumWorkItems**](/windows/desktop/api/Mstask/nn-mstask-ienumworkitems)         | Provides the methods for enumerating the tasks in the [*Scheduled Tasks folder*](https://www.bing.com/search?q=*Scheduled Tasks folder*).                                                                                                              |
...
| [**IScheduledWorkItem**](/windows/desktop/api/Mstask/nn-mstask-ischeduledworkitem) | Provides the methods for managing specific [*work items*](https://www.bing.com/search?q=*work items*).                                                                                                                                                 |
