...
description: Specifies when the Task scheduler must start the task during emergency Automatic maintenance, if it failed to complete during regular Automatic maintenance.
