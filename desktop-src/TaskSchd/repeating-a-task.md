...
For C++ development, the repetition pattern is defined by the [**IRepetitionPattern**](/windows/win32/taskschd/nn-taskschd-irepetitionpattern?branch=master) interface.
