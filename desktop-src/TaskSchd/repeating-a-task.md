...
keywords: ["repetition pattern Task Scheduler"]
---
...
For C++ development, the repetition pattern is defined by the [**IRepetitionPattern**](irepetitionpattern.md) interface.
