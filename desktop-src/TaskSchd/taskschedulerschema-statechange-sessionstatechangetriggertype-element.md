...
For C++ development, see [**StateChange Property of ISessionStateChangeTrigger**](/windows/win32/taskschd/nf-taskschd-isessionstatechangetrigger-get_statechange?branch=master).
