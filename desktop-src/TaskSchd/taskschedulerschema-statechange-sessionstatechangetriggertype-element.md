...
keywords: ["StateChange element Task Scheduler"]
topic_type:
- apiref
api_name:
- StateChange
...
For C++ development, see [**StateChange Property of ISessionStateChangeTrigger**](isessionstatechangetrigger-statechange.md).
