...
Note that if you are retrieving a string property (such as the application name, parameters, or working directory), you must call [CoTaskMemFree](3d0af12e-fc74-4ef7-b2dd-e9da5d0483c7) to free the memory allocated for the returned string.
