...
The code examples listed at the bottom of the page show how to retrieve the properties that are unique to task objects. For other [*work item*](https://www.bing.com/search?q=*work item*) properties that also apply to tasks, see [Retrieving Work Item Examples](retrieving-work-item-property-examples.md).
...
Note that if you are retrieving a string property (such as the application name, parameters, or working directory), you must call [CoTaskMemFree](https://www.bing.com/search?q=CoTaskMemFree) to free the memory allocated for the returned string.
...
| Retrieving the [*priority level*](https://www.bing.com/search?q=*priority level*) of the task                                                                    | [C/C++ Code Example: Retrieving Task Priority](c-c-code-example-retrieving-task-priority.md)                           |
| Retrieving the [*working directory*](https://www.bing.com/search?q=*working directory*) of a task and displaying the path to the working directory on the screen | [C/C++ Code Example: Retrieving the Task Working Directory](c-c-code-example-retrieving-the-task-working-directory.md) |
