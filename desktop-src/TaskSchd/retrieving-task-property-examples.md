...
Note that if you are retrieving a string property (such as the application name, parameters, or working directory), you must call [CoTaskMemFree](_com_cotaskmemfree) to free the memory allocated for the returned string.
