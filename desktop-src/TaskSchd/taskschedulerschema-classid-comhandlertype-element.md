...
keywords: ["ClassId element Task Scheduler"]
topic_type:
- apiref
api_name:
- ClassId
...
Applications define the class identifier using the [**ClassId**](icomhandleraction-classid.md) property of the [**IComHandlerAction**](icomhandleraction.md) interface.
