---
title: ActionCollection.Count property
description: For scripting, gets the number of actions in the collection.
ms.assetid: '42616ef3-e1b7-42cc-a3e5-e459f81ab4e1'
keywords: ["Count property Task Scheduler", "Count property Task Scheduler , ActionCollection object", "ActionCollection object Task Scheduler , Count property"]
topic_type:
- apiref
api_name:
