...
This example clears all command-line parameters associated with a known task. This example assumes that the task and the test task already exist on the local computer.
