...
keywords: ["GetSecurityDescriptor method Task Scheduler", "GetSecurityDescriptor method Task Scheduler , RegisteredTask object", "RegisteredTask object Task Scheduler , GetSecurityDescriptor method"]
topic_type:
- apiref
api_name:
