...
5.  Release all resources. Call [**CoTaskMemFree**](https://msdn.microsoft.com/library/ms680722(v=VS.85).aspx) to release the trigger strings and **ITask::Release** to release the [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask) interface. (Note that [**Release**](https://msdn.microsoft.com/library/ms682317(v=VS.85).aspx) is an [**IUnknown**](https://msdn.microsoft.com/library/ms680509(v=VS.85).aspx) method inherited by **ITask**.)
