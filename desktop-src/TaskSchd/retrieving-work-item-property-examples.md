...
Note that if you are retrieving a string property (such as comment for a work item), you must call [**CoTaskMemFree**](_com_cotaskmemfree) to free the memory allocated for the returned string.
