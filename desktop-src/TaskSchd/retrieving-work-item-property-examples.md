...
Note that if you are retrieving a string property (such as comment for a work item), you must call [**CoTaskMemFree**](3d0af12e-fc74-4ef7-b2dd-e9da5d0483c7) to free the memory allocated for the returned string.
...
5.  If the returned property is a string, call [**CoTaskMemFree**](3d0af12e-fc74-4ef7-b2dd-e9da5d0483c7) to free the memory allocated for the returned string.
