...
Note that if you are retrieving a string property (such as comment for a work item), you must call [**CoTaskMemFree**](https://www.bing.com/search?q=**CoTaskMemFree**) to free the memory allocated for the returned string.
...
5.  If the returned property is a string, call [**CoTaskMemFree**](https://www.bing.com/search?q=**CoTaskMemFree**) to free the memory allocated for the returned string.
