...
| [**AllowHardTerminate**](tasksettings-allowhardterminate.md)<br/>                 | Read/write<br/> | Gets or sets a Boolean value that indicates that the task may be terminated by using [**TerminateProcess**](https://docs.microsoft.com/windows/desktop/api/processthreadsapi/nf-processthreadsapi-terminateprocess).<br/>                                                                                                                                                                                                                                                                               |
