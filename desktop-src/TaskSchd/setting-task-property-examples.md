...
In the following examples, the modified task object is always saved to disk by a call to [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**). (The [**IPersistFile**](https://www.bing.com/search?q=**IPersistFile**) interface is a standard COM interface inherited by the task object.)
