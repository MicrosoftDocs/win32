...
3.  Save the new task to disk by calling [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**). (The [**IPersistFile**](https://www.bing.com/search?q=**IPersistFile**) interface is a standard COM interface supported by the **ITask** interface.)
4.  Call **ITask::Release** to release all resources. (Note that [**Release**](https://www.bing.com/search?q=**Release**) is an [**IUnknown**](https://www.bing.com/search?q=**IUnknown**) method inherited by [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask).)
