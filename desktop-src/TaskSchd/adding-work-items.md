...
There are two ways to add [*work items*](https://www.bing.com/search?q=*work items*) to the [*Scheduled Tasksfolder*](https://www.bing.com/search?q=*Scheduled Tasksfolder*). You can create a new work item within the folder, or you can add an existing work item to the folder.
