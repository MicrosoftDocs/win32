...
keywords: ["MessageBody property Task Scheduler", "MessageBody property Task Scheduler , ShowMessageAction object", "ShowMessageAction object Task Scheduler , MessageBody property"]
topic_type:
- apiref
api_name:
...
\[This object is no longer supported. You can use IExecAction with the Windows scripting [**MsgBox function**](ae073d50-e4a4-4e23-8e46-0cb1369965e7) to show a message in the user session.\]
