...
keywords: ["AllowHardTerminate (settingsType) element Task Scheduler", "AllowHardTerminate element Task Scheduler"]
topic_type:
- apiref
api_name:
- AllowHardTerminate
...
For C++ development, see the [**AllowHardTerminate property of ITaskSettings**](itasksettings-allowhardterminate.md).
