...
After creating the idle trigger, call [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**) to save the new trigger to disk.
...
5.  Save the task with the new idle trigger to disk using [**IPersistFile::Save**](https://www.bing.com/search?q=**IPersistFile::Save**). (The [**IPersistFile**](https://www.bing.com/search?q=**IPersistFile**) interface is a standard COM interface supported by the [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask) interface.)
6.  Call **ITask::Release** to release all resources. (Note that [**Release**](https://www.bing.com/search?q=**Release**) is an [**IUnknown**](https://www.bing.com/search?q=**IUnknown**) method inherited by [**ITask**](/windows/desktop/api/Mstask/nn-mstask-itask).)
