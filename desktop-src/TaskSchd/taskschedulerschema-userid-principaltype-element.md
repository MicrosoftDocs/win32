...
For C++ development, the user identifier is specified using the [**IPrincipal::UserId**](/windows/win32/taskschd/nf-taskschd-iprincipal-get_userid?branch=master) property.
