...
Clients discover devices that support the EMI through calls to [**SetupDiEnumDeviceInterfaces**](https://msdn.microsoft.com/5095404d-2447-407e-99e2-dd3ef3c3b905) and [**SetupDiGetDeviceInterfaceDetail**](https://msdn.microsoft.com/fb4963f1-0ed4-483d-9f39-dcbac493bf1d). One instance of an EMI device interface is created for each energy metering device that is EMI-compliant and is present in the system.
