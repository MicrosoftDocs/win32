...
The following example uses the [**CreateMutex**](/windows/desktop/api/WinBase/nf-synchapi-createmutexa) function to create a mutex object and the [**CreateThread**](https://msdn.microsoft.com/en-us/library/ms682453(v=VS.85).aspx) function to create worker threads.
