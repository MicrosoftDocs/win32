...
| [**SleepConditionVariableSRW**](/windows/desktop/api/WinBase/nf-synchapi-sleepconditionvariablesrw)     | Sleeps on the specified condition variable and releases the specified SRW lock as an atomic operation.         |
| [**WakeAllConditionVariable**](/windows/desktop/api/WinBase/nf-synchapi-wakeallconditionvariable)       | Wakes all threads waiting on the specified condition variable.                                                 |
| [**WakeConditionVariable**](/windows/desktop/api/WinBase/nf-synchapi-wakeconditionvariable)             | Wakes a single thread waiting on the specified condition variable.                                             |
