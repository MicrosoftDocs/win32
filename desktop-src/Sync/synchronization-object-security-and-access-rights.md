...
| **TIMER\_MODIFY\_STATE** (0x0002) | Modify state access, which is required for the [**SetWaitableTimer**](https://msdn.microsoft.com/en-us/library/ms686289(v=VS.85).aspx) and [**CancelWaitableTimer**](/windows/desktop/api) functions.                                                                                                                                            |
