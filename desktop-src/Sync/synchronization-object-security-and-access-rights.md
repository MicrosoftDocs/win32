...
| **EVENT\_MODIFY\_STATE** (0x0002) | Modify state access, which is required for the [**SetEvent**](https://docs.microsoft.com/windows/win32/api/synchapi/nf-synchapi-setevent), [**ResetEvent**](https://msdn.microsoft.com/library/ms685081(v=VS.85).aspx) and [**PulseEvent**](/windows/desktop/api/WinBase/nf-winbase-pulseevent) functions.                                                                                                                                    |
