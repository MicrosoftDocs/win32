...
You can perform either synchronous or asynchronous (also called overlapped) I/O operations on files, named pipes, and serial communications devices. The [**WriteFile**](https://www.bing.com/search?q=**WriteFile**), [**ReadFile**](https://www.bing.com/search?q=**ReadFile**), [**DeviceIoControl**](https://msdn.microsoft.com/1d35c087-6672-4fc6-baa1-a886dd9d3878), [**WaitCommEvent**](https://msdn.microsoft.com/79e955c0-8756-4d6f-bce6-49e8e44d0d3f), [**ConnectNamedPipe**](https://msdn.microsoft.com/50f6680f-900e-4411-a849-ec9a911c9e32), and [**TransactNamedPipe**](https://msdn.microsoft.com/79afcb18-babb-453e-8618-81b43ecb24c4) functions can be performed either synchronously or asynchronously. The [**ReadFileEx**](https://www.bing.com/search?q=**ReadFileEx**) and [**WriteFileEx**](https://www.bing.com/search?q=**WriteFileEx**) functions can be performed only asynchronously.
...
To cancel all pending asynchronous I/O operations, use the [**CancelIoEx**](https://msdn.microsoft.com/a2ce13b8-7da6-4848-848d-901d9667c2e3) function and provide an [**OVERLAPPED**](/windows/desktop/api/WinBase/ns-minwinbase-_overlapped) structure that specifies the request to cancel. Use the [**CancelIo**](https://www.bing.com/search?q=**CancelIo**) function to cancel pending asynchronous I/O operations issued by the calling thread for the specified file handle.
