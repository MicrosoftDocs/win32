...
**Windows 8:** Starting in Windows 8 the appropriate native interlocked exchange primitives are available for 64-bit code, for example [**InterlockedCompare64Exchange128**](/windows/desktop/api/WinBase/).
...
| [**InterlockedPushListSList**](/windows/desktop/api/WinBase/)     | Inserts a singly-linked list at the front of another singly linked list.                                                                                  |
