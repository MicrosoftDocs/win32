...
| Object                | Description                                                                                                                                                                                             |
|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| manual-reset timer    | A timer whose state remains signaled until [**SetWaitableTimer**](/windows/desktop/api/WinBase/nf-synchapi-setwaitabletimer) is called to establish a new due time.                                                                          |
...
-   The thread calls the [**SetWaitableTimer**](/windows/desktop/api/WinBase/nf-synchapi-setwaitabletimer) function to activate the timer. Note the use of the following parameters for **SetWaitableTimer**:
