...
-   Per client machine, with the machine-wide COM authentication level set by using either [DCOMCNFG](https://msdn.microsoft.com/library/windows/desktop/ms680051) or the Component Services administrative tool.
-   Per client application administratively, using [DCOMCNFG](https://msdn.microsoft.com/library/windows/desktop/ms678426) or using the Component Services administrative tool if the client should be a COM+ application.
-   Per client process programmatically, with [**CoInitializeSecurity**](https://msdn.microsoft.com/library/windows/desktop/ms693736).
-   At any point programmatically, using [**CoSetProxyBlanket**](https://msdn.microsoft.com/library/windows/desktop/ms692692).
