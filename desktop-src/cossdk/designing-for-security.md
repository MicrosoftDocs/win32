...
-   If you are designing a component that will be used in a distributed application using role-based security, you can use the [COM+ security](com--security.md) functionality. This functionality allows you to call methods such as [**IObjectContext::IsCallerInRole**](iobjectcontext-iscallerinrole.md) and [**IObjectContext::IsSecurityEnabled**](iobjectcontext-issecurityenabled.md) to help protect blocks of code from unauthorized access. You can also use the security call context to get information about an object's callers.
