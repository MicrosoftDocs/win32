...
-   If you are designing a component that will be used in a distributed application using role-based security, you can use the [COM+ security](com--security.md) functionality. This functionality allows you to call methods such as [**IObjectContext::IsCallerInRole**](/windows/win32/ComSvcs/nf-comsvcs-iobjectcontext-iscallerinrole?branch=master) and [**IObjectContext::IsSecurityEnabled**](/windows/win32/ComSvcs/nf-comsvcs-iobjectcontext-issecurityenabled?branch=master) to help protect blocks of code from unauthorized access. You can also use the security call context to get information about an object's callers.
