...
| [**CServiceConfig**](cserviceconfig.md)                         | Specifies and configures the services that are to be active in the service domain entered when calling either [**CoCreateActivity**](cocreateactivity.md) or [**CoEnterServiceDomain**](coenterservicedomain.md).                     |
