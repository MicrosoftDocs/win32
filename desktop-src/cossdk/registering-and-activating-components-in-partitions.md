...
When the client program calls the [**CoCreateInstance**](https://msdn.microsoft.com/library/windows/desktop/ms686615) or [**CoGetObject**](https://msdn.microsoft.com/library/windows/desktop/ms678805) function to instantiate an object, COM+ performs two distinct steps, as follows:
