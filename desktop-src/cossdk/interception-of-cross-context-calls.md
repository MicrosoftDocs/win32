...
If you share object references across context boundaries by other means—for example, in global variables—you should always use [**CoMarshalInterface**](https://msdn.microsoft.com/library/windows/desktop/ms678428) and [**CoUnmarshalInterface**](https://msdn.microsoft.com/library/windows/desktop/ms693382). These functions can translate an object reference into a proxy usable in a different context. Never share a raw object reference across context boundaries.
