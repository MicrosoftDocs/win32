...
-   **Creation timeout (ms).** Specifies how long a client will wait, in milliseconds, for an object to be returned from the pool after a call to [**CoCreateInstance**](https://msdn.microsoft.com/library/windows/desktop/ms686615). If the client call is unsuccessful, the error E\_TIMEOUT is returned.
