...
For more information about how to use this collection, Microsoft Visual Basic developers should see the [**SecurityCallContext**](securitycallcontext.md) class. C and C++ developers should refer to [**ISecurityCallContext**](isecuritycallcontext.md).
...
For more information about this collection, Visual Basic developers should see the [**SecurityCallers**](securitycallers.md) class. C and C++ developers should refer to [**ISecurityCallersColl**](isecuritycallerscoll.md).
...
For more information on this collection, Visual Basic developers should see the [**SecurityIdentity**](securityidentity.md) class. C and C++ developers should refer to [**ISecurityIdentityColl**](isecurityidentitycoll.md).
