...
| [Using the Queue Moniker](using-the-queue-moniker.md)<br/>                               | Describes how to activate a queuable component programmatically using **GetObject** or [**CoGetObject**](https://msdn.microsoft.com/library/windows/desktop/ms678805).<br/> |
