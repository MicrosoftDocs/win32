...
The valid access rights for files and directories include the **DELETE**, **READ\_CONTROL**, **WRITE\_DAC**, **WRITE\_OWNER**, and **SYNCHRONIZE** [standard access rights](https://msdn.microsoft.com/library/windows/desktop/aa379607). The following table lists the access rights that are specific to files and directories.
...
| <span id="FILE_TRAVERSE"></span><span id="file_traverse"></span><dl> <dt>**FILE\_TRAVERSE**</dt> <dt>32 (0x20)</dt> </dl>                               | For a directory, the right to traverse the directory. By default, users are assigned the **BYPASS\_TRAVERSE\_CHECKING** [privilege](https://msdn.microsoft.com/library/windows/desktop/aa379306), which ignores the **FILE\_TRAVERSE** [access right](https://msdn.microsoft.com/library/windows/desktop/aa374902). See the remarks in [File Security and Access Rights](file-security-and-access-rights.md) for more information.<br/> |
