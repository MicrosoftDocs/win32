---
description: Describes considerations for application control of file buffering, also known as unbuffered file input/output (I/O). Learn how to manage file I/O performance and reliability by controlling file buffering in Windows applications.
ms.assetid: ae1e5d0f-9b55-4aae-8402-b9c8e33d9363
title: File Buffering
ms.topic: concept-article
ms.date: 05/31/2025
# customer intent: As a Windows developer, I want to understand how to control file buffering in my applications, so that I can manage file I/O performance and reliability.
---
