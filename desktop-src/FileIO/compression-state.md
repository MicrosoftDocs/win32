...
Use the [**FSCTL\_GET\_COMPRESSION**](/windows/desktop/api/WinIoCtl/) control code to determine the compression state of a file or directory.
...
Use the [**FSCTL\_SET\_COMPRESSION**](/windows/desktop/api/WinIoCtl/) control code to set the compression state of a file or directory. This operation also sets the compression attribute of the file or directory.
