...
An application can truncate or extend a file by using the [**SetEndOfFile**](/windows/win32/FileAPI/nf-fileapi-setendoffile?branch=master) function. This function sets the end of file to the current position of the file pointer.
