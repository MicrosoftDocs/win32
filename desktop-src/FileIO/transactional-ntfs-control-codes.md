...
| [**FSCTL\_TXFS\_SAVEPOINT\_INFORMATION**](https://msdn.microsoft.com/en-us/library/Bb736256(v=VS.85).aspx)<br/>                   | The [**FSCTL\_TXFS\_SAVEPOINT\_INFORMATION**](https://msdn.microsoft.com/en-us/library/Bb736256(v=VS.85).aspx) control code controls setting, clearing, and rolling back to the specified savepoint.<br/> To perform this operation, call the [**DeviceIoControl**](https://msdn.microsoft.com/library/windows/desktop/aa363216) function with the following parameters.<br/>                                                                                                                 |
