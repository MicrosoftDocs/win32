...
-   Backup applications that use [file streams](file-streams.md) should specify **BACKUP\_REPARSE\_DATA** in the [**WIN32\_STREAM\_ID**](https://docs.microsoft.com/windows/desktop/api/winbase/ns-winbase-_win32_stream_id) structure when backing up files with reparse points.
