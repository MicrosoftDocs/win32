...
A file or directory that is deleted by calling the [**DeleteFileTransacted**](deletefiletransacted.md) function remains visible to all outside readers.
...
A directory that is deleted by calling the [**RemoveDirectoryTransacted**](removedirectorytransacted.md) function remains visible to all outside readers.
...
The contents of a directory can be changed while an enumeration is in progress as a result of using APIs that enumerate, for example the [**FindFirstFileTransacted**](findfirstfiletransacted.md) and [**FindNextFile**](findnextfile.md) functions.

Changes to a directory outside a transaction are not isolated from the transaction and are immediately visible within the transaction. For example, if a non-transacted writer adds a file to a directory, the new file is immediately visible inside the transaction such that calling the [**FindFirstFileTransacted**](findfirstfiletransacted.md) or [**FindNextFile**](findnextfile.md) function will return the new file.

Changes made to a directory inside a transaction are isolated until the transaction commits. For example, a file created in the directory as part of the transaction. A non-transacted reader calling the [**FindFirstFile**](findfirstfile.md) or [**FindNextFile**](findnextfile.md) function will not see the newly created file until the transaction commits.
...
To rename a file as a transacted operation, call [**MoveFileTransacted**](movefiletransacted.md) to move the file.
...
TxF does not support operations on EFS files. You cannot open an EFS-encrypted file for transactions. Calling the [**CreateFileTransacted**](createfiletransacted.md) function on an EFS file will fail with the error **ERROR\_EFS\_NOT\_ALLOWED\_IN\_TRANSACTION**. Similarly, calling the [**EncryptFile**](encryptfile.md) function on a file in a transaction will fail with the error **ERROR\_EFS\_NOT\_ALLOWED\_IN\_TRANSACTION**.
...
-   [**CreateDirectoryTransacted**](createdirectorytransacted.md)
-   [**CreateFileTransacted**](createfiletransacted.md)
-   [**CreateHardLinkTransacted**](createhardlinktransacted.md)
-   [**CreateSymbolicLinkTransacted**](createsymboliclinktransacted.md)
-   [**DeleteFileTransacted**](deletefiletransacted.md)
-   [**FindFirstFileNameTransactedW**](findfirstfilenametransactedw.md)
-   [**FindFirstFileTransacted**](findfirstfiletransacted.md)
-   [**FindFirstStreamTransactedW**](findfirststreamtransactedw.md)
-   [**GetCompressedFileSizeTransacted**](getcompressedfilesizetransacted.md)
-   [**GetFileAttributesTransacted**](getfileattributestransacted.md)
-   [**GetFullPathNameTransacted**](getfullpathnametransacted.md)
-   [**GetLongPathNameTransacted**](getlongpathnametransacted.md)
-   [**MoveFileTransacted**](movefiletransacted.md)
-   [**RemoveDirectoryTransacted**](removedirectorytransacted.md)
-   [**SetFileAttributesTransacted**](setfileattributestransacted.md)

For example, the [**CreateFile**](createfile.md) function now has a transacted version: [**CreateFileTransacted**](createfiletransacted.md).

### File I/O Functions Changed By TxF

The following table lists the functions whose behavior is affected by Transactional NTFS. For example, the behavior of the [**ReadFile**](readfile.md) function will vary depending on whether the *hFile* parameter was created by the [**CreateFile**](createfile.md) function or the [**CreateFileTransacted**](createfiletransacted.md) function.
...
| <span id="FindNextFile"></span><span id="findnextfile"></span><span id="FINDNEXTFILE"></span>[**FindNextFile**](findnextfile.md)<br/>                                                                                                                                                                                                                                                                                                         | If there is a transaction bound to the file enumeration handle, then the files that are returned are subject to transaction isolation rules.<br/>                                                                                                                                                                                                                                                                    |
| <span id="FSCTL_SET_COMPRESSION"></span><span id="fsctl_set_compression"></span>[**FSCTL\_SET\_COMPRESSION**](fsctl-set-compression.md)<br/>                                                                                                                                                                                                                                                                                                  | You cannot change the compression state of a file opened by [**CreateFileTransacted**](createfiletransacted.md).<br/>                                                                                                                                                                                                                                                                                               |
| <span id="GetFileInformationByHandle__________and__________GetFileInformationByHandleEx"></span><span id="getfileinformationbyhandle__________and__________getfileinformationbyhandleex"></span><span id="GETFILEINFORMATIONBYHANDLE__________AND__________GETFILEINFORMATIONBYHANDLEEX"></span>[**GetFileInformationByHandle**](getfileinformationbyhandle.md) and [**GetFileInformationByHandleEx**](getfileinformationbyhandleex.md)<br/> | If there is a transaction bound to the file handle, then the function returns information for the isolated file view.<br/>                                                                                                                                                                                                                                                                                           |
| <span id="GetFileSize_and__________GetFileSizeEx"></span><span id="getfilesize_and__________getfilesizeex"></span><span id="GETFILESIZE_AND__________GETFILESIZEEX"></span>[**GetFileSize**](getfilesize.md) and [**GetFileSizeEx**](getfilesizeex.md)<br/>                                                                                                                                                                                  | If there is a transaction bound to the file handle, then the function returns information for the isolated file view.<br/>                                                                                                                                                                                                                                                                                           |
| <span id="GetVolumeInformation"></span><span id="getvolumeinformation"></span><span id="GETVOLUMEINFORMATION"></span>[**GetVolumeInformation**](getvolumeinformation.md)<br/>                                                                                                                                                                                                                                                                 | If the volume supports file system transactions, the function returns **FILE\_SUPPORTS\_TRANSACTIONS** in *lpFileSystemFlags*.<br/>                                                                                                                                                                                                                                                                                  |
...
| <span id="ReadDirectoryChangesW"></span><span id="readdirectorychangesw"></span><span id="READDIRECTORYCHANGESW"></span>[**ReadDirectoryChangesW**](readdirectorychangesw.md)<br/>                                                                                                                                                                                                                                                            | If there is a transaction bound to the directory handle, then the notifications reflect the isolated view of the directory. Changes to files outside the transacted view of the directory are not included in the notifications.<br/>                                                                                                                                                                                |
| <span id="ReadFile___________ReadFileEx__and__________ReadFileScatter"></span><span id="readfile___________readfileex__and__________readfilescatter"></span><span id="READFILE___________READFILEEX__AND__________READFILESCATTER"></span>[**ReadFile**](readfile.md), [**ReadFileEx**](readfileex.md), and [**ReadFileScatter**](readfilescatter.md)<br/>                                                                                  | If there is a transaction bound to the file handle, then the function returns data from the transacted view of the file. A transacted read handle is guaranteed to show the same view of a file for the duration of the handle.<br/>                                                                                                                                                                                 |
| <span id="SetEndOfFile"></span><span id="setendoffile"></span><span id="SETENDOFFILE"></span>[**SetEndOfFile**](setendoffile.md)<br/>                                                                                                                                                                                                                                                                                                         | If there is a transaction bound to the handle, then the change in the end-of-file position is transacted.<br/>                                                                                                                                                                                                                                                                                                       |
| <span id="SetFileInformationByHandle"></span><span id="setfileinformationbyhandle"></span><span id="SETFILEINFORMATIONBYHANDLE"></span>[**SetFileInformationByHandle**](setfileinformationbyhandle.md)<br/>                                                                                                                                                                                                                                   | If there is a transaction bound to the handle, then the changes made will be transacted for the information classes **FileBasicInfo**, **FileRenameInfo**, **FileAllocationInfo**, **FileEndOfFileInfo**, and **FileDispositionInfo**.<br/>                                                                                                                                                                          |
| <span id="SetFileShortName"></span><span id="setfileshortname"></span><span id="SETFILESHORTNAME"></span>[**SetFileShortName**](setfileshortname.md)<br/>                                                                                                                                                                                                                                                                                     | If there is a transaction bound to the handle, then the change in the file's short name is transacted.<br/>                                                                                                                                                                                                                                                                                                          |
...
| <span id="WriteFile__________WriteFileEx__and_________WriteFileGather"></span><span id="writefile__________writefileex__and_________writefilegather"></span><span id="WRITEFILE__________WRITEFILEEX__AND_________WRITEFILEGATHER"></span>[**WriteFile**](writefile.md), [**WriteFileEx**](writefileex.md), and [**WriteFileGather**](writefilegather.md)<br/>                                                                              | If there is a transaction bound to the file handle, then the file write is transacted.<br/>                                                                                                                                                                                                                                                                                                                          |
