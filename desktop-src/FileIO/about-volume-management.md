...
| [Naming a Volume](naming-a-volume.md)<br/>                           | A label is a user-friendly name that is assigned to a volume, usually by an end user, to make it easier to recognize. A volume can have a label, a drive letter, both, or neither. To set the label for a volume, use the [**SetVolumeLabel**](setvolumelabel.md) function.<br/> |
...
| [Obtaining Volume Information](obtaining-volume-information.md)<br/> | Before you access files and directories on a given volume, you should determine the capabilities of the file system by using the [**GetVolumeInformation**](getvolumeinformation.md) function.<br/>                                                                              |
