...
| Pointer to the volume parameter block, or [**VPB**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_vpb) | Identifies the volume or partition the file data resides on.                                                                                                                                    |
| Pointer to section object pointers                            | Identifies a root structure that describes a [mapped file](https://docs.microsoft.com/windows/desktop/Memory/file-mapping).                                                                                                                  |
...
These attributes are defined as part of the [**FILE\_OBJECT**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_file_object) structure in Ntddk.h. Refer to the definition of this structure in the Windows Driver Kit (WDK) documentation for the data lengths and types of the values.
