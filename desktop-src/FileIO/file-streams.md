...
Each stream also maintains its own state for compression, encryption, and sparseness. The **FILE\_ATTRIBUTE\_SPARSE\_FILE** attribute on the file is set in the **dwFileAttributes** member of the [**WIN32\_FIND\_DATA**](/windows/win32/MinWinBase/ns-minwinbase-_win32_find_dataa?branch=master) structure returned from the [**FindFirstFile**](/windows/win32/FileAPI/nf-fileapi-findfirstfilea?branch=master), [**FindFirstFileEx**](/windows/win32/FileAPI/nf-fileapi-findfirstfileexa?branch=master), and [**FindNextFile**](/windows/win32/FileAPI/nf-fileapi-findnextfilea?branch=master) functions if any of the streams have ever been sparse. [**GetFileAttributes**](/windows/win32/FileAPI/nf-fileapi-getfileattributesa?branch=master), [**GetFileAttributesEx**](/windows/win32/FileAPI/nf-fileapi-getfileattributesexa?branch=master), [**GetFileAttributesTransacted**](/windows/win32/WinBase/nf-winbase-getfileattributestransacteda?branch=master), [**GetFileInformationByHandle**](/windows/win32/FileAPI/nf-fileapi-getfileinformationbyhandle?branch=master), and [**GetFileInformationByHandleEx**](/windows/win32/WinBase/nf-winbase-getfileinformationbyhandleex?branch=master) return the sparse state of the default data stream if no stream is specified.
...
| ::$DATA                    | Data stream. The default data stream has no name. Data streams can be enumerated using the [**FindFirstStreamW**](/windows/win32/fileapi/nf-fileapi-findfirststreamw?branch=master) and [**FindNextStreamW**](/windows/win32/fileapi/nf-fileapi-findnextstreamw?branch=master) functions.                                                                                                                                                                                                                                                |
| ::$EA                      | Contains Extended Attributes data. Files with an $EA stream type may not contain a $REPARSE\_POINT stream type.                                                                                                                                                                                                                                                                                                                                  |
...
| ::$REPARSE\_POINT          | The reparse point data. Files with a $REPARSE\_POINT stream type may not contain an $EA stream type.                                                                                                                                                                                                                                                                                                                                             |
