---
description: Learn about the Microsoft implementation of the Server Message Block (SMB) Protocol.
ms.assetid: 641017fa-3721-40aa-b13c-e26c8b61ce5c
title: Microsoft SMB Protocol and CIFS Protocol Overview
ms.topic: overview
ms.date: 07/08/2025
# customer intent: As a Windows app developer, I want to understand the Microsoft SMB Protocol and CIFS Protocol, so that I can implement file sharing and other network functionalities in my applications.
---
