...
You can determine whether a file system supports disk quotas by calling the [**GetVolumeInformation**](getvolumeinformation.md) function and examining the **FILE\_VOLUME\_QUOTAS** bit flag.
