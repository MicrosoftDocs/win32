...
To obtain a handle to a volume for use with update sequence number (USN) change journal operations, call the [**CreateFile**](createfile.md) function with the *lpFileName* parameter set to a string of the following form: \\\\.\\*X*:
