...
| [**CSV\_CONTROL\_OP**](/windows/desktop/api/WinIoCtl/ne-winioctl-csv_control_op)<br/>                         | Specifies the type of CSV control operation to use with the [**FSCTL\_CSV\_CONTROL**](https://msdn.microsoft.com/en-us/library/Dn280516(v=VS.85).aspx) control code.<br/>                                                                                                       |
