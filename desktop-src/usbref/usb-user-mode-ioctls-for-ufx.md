...
<tbody>
<tr class="odd">
<td>[<strong>IOCTL_GENERICUSBFN_ACTIVATE_USB_BUS</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_activate_usb_bus?branch=master)<br/></td>
...
<tr class="even">
<td>[<strong>IOCTL_GENERICUSBFN_BUS_EVENT_NOTIFICATION</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_bus_event_notification?branch=master)<br/></td>
...
<tr class="odd">
<td>[<strong>IOCTL_GENERICUSBFN_CONTROL_STATUS_HANDSHAKE_IN</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_control_status_handshake_in?branch=master)<br/></td>
...
<tr class="even">
<td>[<strong>IOCTL_GENERICUSBFN_CONTROL_STATUS_HANDSHAKE_OUT</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_control_status_handshake_out?branch=master)<br/></td>
...
<tr class="odd">
<td>[<strong>IOCTL_GENERICUSBFN_DEACTIVATE_USB_BUS</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_deactivate_usb_bus?branch=master)<br/></td>
<td>This IOCTL code is nevtot supported.<br/></td>
</tr>
<tr class="even">
<td>[<strong>IOCTL_GENERICUSBFN_GET_CLASS_INFO</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_get_class_info?branch=master)<br/></td>
...
<tr class="odd">
<td>[<strong>IOCTL_GENERICUSBFN_GET_CLASS_INFO_EX</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_get_class_info_ex?branch=master)<br/></td>
...
<tr class="even">
<td>[<strong>IOCTL_GENERICUSBFN_GET_INTERFACE_DESCRIPTOR_SET</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_get_interface_descriptor_set?branch=master)<br/></td>
...
<tr class="odd">
<td>[<strong>IOCTL_GENERICUSBFN_GET_PIPE_STATE</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_get_pipe_state?branch=master)<br/></td>
...
<tr class="even">
<td>[<strong>IOCTL_GENERICUSBFN_REGISTER_USB_STRING</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_register_usb_string?branch=master)<br/></td>
<td>This I/O control code (IOCTL) is sent by a user-mode service or application to register a USB string descriptor.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>IOCTL_GENERICUSBFN_SET_PIPE_STATE</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_set_pipe_state?branch=master)<br/></td>
...
<tr class="even">
<td>[<strong>IOCTL_GENERICUSBFN_TRANSFER_IN</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_transfer_in?branch=master)<br/></td>
...
<tr class="odd">
<td>[<strong>IOCTL_GENERICUSBFN_TRANSFER_IN_APPEND_ZERO_PKT</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_transfer_in_append_zero_pkt?branch=master)<br/></td>
<td>This I/O control code (IOCTL) is sent by a user-mode service or application to issue an IN direction transfer on the endpoint that corresponds to the specified pipe ID in the input buffer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>IOCTL_GENERICUSBFN_TRANSFER_OUT</strong>](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_transfer_out?branch=master)<br/></td>
...
3.  The service issues [**IOCTL\_GENERICUSBFN\_GET\_CLASS\_INFO**](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_get_class_info?branch=master) to retrieve information about the available pipes, as configured in the registry.
4.  After the service is ready to communicate, it issues [**IOCTL\_GENERICUSBFN\_ACTIVATE\_USB\_BUS**](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_activate_usb_bus?branch=master). After all class drivers are activated, the USB function class extension can connect to the host.
5.  To receive USB notifications, the service issues [**IOCTL\_GENERICUSBFN\_BUS\_EVENT\_NOTIFICATION**](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_bus_event_notification?branch=master). This IOCTL completes when a new USB event has occurred. Events ([**USBFN\_EVENT**](/windows-hardware/drivers/ddi/content/usbfnbase/ne-usbfnbase-_usbfn_event?branch=master)) of particular interest include:
    ...
    -   **UsbfnEventSetupPacket**: The USB function class extension has received an interface-specific setup packet (`bmRequestType.Type == BMREQUEST_CLASS`). The service should reply to the setup packet by issuing a transfer request in pipe 0, followed by a handshake request ([**IOCTL\_GENERICUSBFN\_CONTROL\_STATUS\_HANDSHAKE\_OUT**](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_control_status_handshake_out?branch=master)) in the opposite direction on pipe 0.
6.  After the **UsbfnEventConfigured** event is received, the service can begin issuing transfer requests using [**IOCTL\_GENERICUSBFN\_TRANSFER\_IN**](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_transfer_in?branch=master), [**IOCTL\_GENERICUSBFN\_TRANSFER\_IN\_APPEND\_ZERO\_PKT**](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_transfer_in_append_zero_pkt?branch=master), and [**IOCTL\_GENERICUSBFN\_TRANSFER\_OUT**](/windows/win32/GenericUsbFnIoctl/ni-genericusbfnioctl-ioctl_genericusbfn_transfer_out?branch=master).
