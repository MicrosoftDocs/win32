...
-   [**USBD\_CalculateUsbBandwidth**](usbd-calculateusbbandwidth.md)
-   [**USBD\_CreateConfigurationRequest**](usbd-createconfigurationrequest.md)
-   [**USBD\_Debug\_LogEntry**](https://msdn.microsoft.com/library/windows/hardware/ff539037)
-   [**USBD\_GetUSBDIVersion**](usbd-getusbdiversion.md)
-   [**USBD\_ParseConfigurationDescriptor**](usbd-parseconfigurationdescriptor.md)
-   [**USBD\_QueryBusTime**](usbd-querybustime.md)
-   [**USBD\_RegisterHcFilter**](usbd-registerhcfilter.md)
...
-   [**IOCTL\_USB\_DIAG\_IGNORE\_HUBS\_OFF**](ioctl-usb-diag-ignore-hubs-off.md)
-   [**IOCTL\_USB\_DIAG\_IGNORE\_HUBS\_ON**](ioctl-usb-diag-ignore-hubs-on.md)
-   [**IOCTL\_USB\_DIAGNOSTIC\_MODE\_OFF**](ioctl-usb-diagnostic-mode-off.md)
-   [**IOCTL\_USB\_DIAGNOSTIC\_MODE\_ON**](ioctl-usb-diagnostic-mode-on.md)
-   [**IOCTL\_USB\_GET\_HUB\_CAPABILITIES**](ioctl-usb-get-hub-capabilities.md)
-   [**IOCTL\_USB\_HCD\_DISABLE\_PORT**](ioctl-usb-hcd-disable-port.md)
-   [**IOCTL\_USB\_HCD\_ENABLE\_PORT**](ioctl-usb-hcd-enable-port.md)
-   [**IOCTL\_USB\_HCD\_GET\_STATS\_1**](ioctl-usb-hcd-get-stats-1.md)
-   [**IOCTL\_USB\_HCD\_GET\_STATS\_2**](ioctl-usb-hcd-get-stats-2.md)
-   [**IOCTL\_USB\_RESET\_HUB**](ioctl-usb-reset-hub.md)
...
Write a filter driver that supports detection of chargers, if the function controller uses the in-box Synopsys and ChipIdea drivers. If you are writing a client driver for a proprietary function controller, charger/attach detection is integrated in the client driver by implementing [*EVT\_UFX\_DEVICE\_PROPRIETARY\_CHARGER\_SET\_PROPERTY*](evt-ufx-device-proprietary-charger-set-property.md), [*EVT\_UFX\_DEVICE\_PROPRIETARY\_CHARGER\_RESET*](evt-ufx-device-proprietary-charger-reset.md), and [*EVT\_UFX\_DEVICE\_DETECT\_PROPRIETARY\_CHARGER*](evt-ufx-device-detect-proprietary-charger.md).
