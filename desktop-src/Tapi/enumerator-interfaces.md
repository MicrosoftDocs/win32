...
| [**IEnumQueue**](https://msdn.microsoft.com/en-us/library/ms727545(v=VS.85).aspx)                                           | [**ITQueue**](https://msdn.microsoft.com/en-us/library/ms731449(v=VS.85).aspx)                                                                                                                         |
| [**IEnumTerminal**](/windows/desktop/api/tapi3if/nn-tapi3if-ienumterminal)                                     | [**ITTerminal**](https://msdn.microsoft.com/en-us/library/ms732646(v=VS.85).aspx)                                                                                                                   |
