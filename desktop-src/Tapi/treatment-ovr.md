...
Treatment refers to the handling of an incoming session that has not yet been answered or has been put on hold, such as music. Please see [LINECALLTREATMENT\_ Constants](https://msdn.microsoft.com/library/ms735562(v=VS.85).aspx) for a list of treatments defined by TAPI.

Not all service providers support use of this information.

**TAPI 2.x:  **[**lineGetCallInfo**](https://msdn.microsoft.com/library/ms735720(v=VS.85).aspx) (**dwCallTreatment** member of *lpCallInfo*)
