...
This section contains an alphabetic listing of the line device structures used by TAPI. These line device structures include:
...
-   [**LINEMEDIACONTROLTONE**](/windows/desktop/api/Tapi/ns-tapi-linemediacontroltone)
-   [**LINEMESSAGE**](/windows/desktop/api/Tapi/ns-tapi-linemessage)
-   [**LINEMONITORTONE**](/windows/desktop/api/Tapi/ns-tapi-linemonitortone)
-   [**LINEPROVIDERENTRY**](/windows/desktop/api/Tapi/ns-tapi-lineproviderentry)
-   [**LINEPROVIDERLIST**](/windows/desktop/api/Tapi/ns-tapi-lineproviderlist)
-   [**LINEREQMEDIACALL**](/windows/desktop/api/Tapi/ns-tapi-linereqmediacall)
-   [**LINEREQMAKECALL**](/windows/desktop/api/Tapi/ns-tapi-linereqmakecall)
-   [**LINETERMCAPS**](/windows/desktop/api/Tapi/ns-tapi-linetermcaps)
