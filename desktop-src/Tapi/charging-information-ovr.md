...
**TAPI 2.x:** See [**lineGetCallInfo**](https://msdn.microsoft.com/en-us/library/ms735720(v=VS.85).aspx) (**dwChargingInfoSize** and **dwChargingInfoOffset** members of *lpCallInfo*).
