...
The function [**TSPI\_phoneSetButtonInfo**](https://msdn.microsoft.com/library/ms725943(v=VS.85).aspx) sets the information associated with a button on a phone device. [**TSPI\_phoneGetButtonInfo**](https://msdn.microsoft.com/library/ms725926(v=VS.85).aspx) returns information associated with a button on a phone device. The service provider sends a PHONE\_BUTTON message to the TAPI callback function when a button on the phone is pressed.
