---
Description: 'The following code fragment illustrates modification of a conference's time span. The default time span is thirty minutes. In this fragment, the time span is set to one year.'
