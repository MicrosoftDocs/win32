...
**TSPIMessage** is an enumeration type that defines the set of additional [**LINEEVENT**](https://msdn.microsoft.com/en-us/library/ms725228(v=VS.85).aspx) and [**PHONEEVENT**](https://msdn.microsoft.com/library/ms725259) functions appearing in TSPI that do not appear in TAPI.
