...
The **tStateEntryTime** member in [**LINECALLSTATUS**](/windows/desktop/api/Tapi/ns-tapi-linecallstatus_tag) allows timing of calls in states to be reported. The member (of type **SYSTIME**) indicates the time at which the current state was entered.
