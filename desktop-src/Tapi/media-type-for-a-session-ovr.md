...
**TAPI 2.x:** See [**lineGetCallInfo**](https://msdn.microsoft.com/en-us/library/ms735720(v=VS.85).aspx), [**lineSetMediaMode**](https://msdn.microsoft.com/en-us/library/ms736102(v=VS.85).aspx), [**lineMonitorMedia**](https://msdn.microsoft.com/en-us/library/ms735997(v=VS.85).aspx), [**LINE\_MONITORMEDIA**](https://msdn.microsoft.com/en-us/library/ms736558(v=VS.85).aspx) message, [LINEMEDIAMODE\_ Constants](https://msdn.microsoft.com/en-us/library/ms735994(v=VS.85).aspx).
