...
A programmer interested in creating call center applications may also want to consult the TAPI 2.2 functions that can enable portions of a call center suite. See TAPI 2.2 [Call Center Control](https://msdn.microsoft.com/en-us/library/ms734836(v=VS.85).aspx).
