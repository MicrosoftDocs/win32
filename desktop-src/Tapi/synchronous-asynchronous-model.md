...
**TAPI 2.x:** Lists which state whether each function completes synchronously or asynchronously appear in [TAPI Quick Function Reference](https://msdn.microsoft.com/library/ms737239(v=VS.85).aspx).
