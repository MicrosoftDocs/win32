---
Description: 'User-user information is a buffer that can be transmitted from one end of a connection to another. This information is specific to the ISDN Q.931 standard. Please refer to your service provider's documentation on the meaning and use of this data.'
