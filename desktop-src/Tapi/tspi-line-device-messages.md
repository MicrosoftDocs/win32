...
-   [**LINE\_ADDRESSSTATE**](https://msdn.microsoft.com/library/ms725215)
-   [**LINE\_CALLDEVSPECIFIC**](line-calldevspecific.md)
-   [**LINE\_DEVSPECIFICEX**](https://msdn.microsoft.com/library/ms725226)
-   [**LINE\_CALLDEVSPECIFICFEATURE**](line-calldevspecificfeature.md)
-   [**LINE\_CALLINFO**](https://msdn.microsoft.com/library/ms725218)
-   [**LINE\_CALLSTATE**](https://msdn.microsoft.com/library/ms725219)
-   [**LINE\_CLOSE**](https://msdn.microsoft.com/library/ms725220)
-   [**LINE\_CREATE**](https://msdn.microsoft.com/library/ms725223)
-   [**LINE\_CREATEDIALOGINSTANCE**](line-createdialoginstance.md)
-   [**LINE\_DEVSPECIFIC**](https://msdn.microsoft.com/library/ms725225)
...
-   [**LINE\_LINEDEVSTATE**](https://msdn.microsoft.com/library/ms725231)
