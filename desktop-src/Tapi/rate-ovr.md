...
**TAPI 2.x:  **[**lineSetCallParams**](https://msdn.microsoft.com/en-us/library/ms736086(v=VS.85).aspx), [**lineGetCallInfo**](https://msdn.microsoft.com/en-us/library/ms735720(v=VS.85).aspx), **dwMinRate** or **dwMaxRate** member of [**LINECALLINFO**](https://msdn.microsoft.com/en-us/library/ms735527(v=VS.85).aspx)
