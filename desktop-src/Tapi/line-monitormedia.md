---
Description: The TAPI LINE_MONITORMEDIA message is sent when a change in the call's media type is detected. The sending of this message is controlled with the lineMonitorMedia function
