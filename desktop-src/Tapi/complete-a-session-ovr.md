...
The [LINECALLCOMPLMODE\_ Constants](https://msdn.microsoft.com/library/ms735518(v=VS.85).aspx) define the possible options an application might have, depending on service provider capabilities.
...
**TAPI 2.x:** See [**lineCompleteCall**](https://msdn.microsoft.com/library/ms735576(v=VS.85).aspx), [**lineUncompleteCall**](https://msdn.microsoft.com/library/ms736476(v=VS.85).aspx).
