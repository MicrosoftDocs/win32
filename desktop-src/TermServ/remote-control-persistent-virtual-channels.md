...
Remote control persistent virtual channels are specified during the call to **VirtualChannelInit**. Refer to the reference page for [**VirtualChannelInit**](virtualchannelinit.md) for specific information about this.
