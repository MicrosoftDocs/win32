...
keywords: ["Win32_TSVmMetadataItem class Remote Desktop Services", "Win32_TSVmMetadataItem class Remote Desktop Services , described"]
topic_type:
- apiref
api_name:
...
The **Win32\_TSVmMetadataItem** class has these types of members:

-   [Properties](#properties)

### Properties

The **Win32\_TSVmMetadataItem** class has these properties.
...
Specifies the section within the metadata where this item resides.
...
Enlightenment settings section.
