...
keywords: ["IConnectionBrokerClient interface Remote Desktop Services", "IConnectionBrokerClient interface Remote Desktop Services , described"]
topic_type:
- apiref
api_name:
...
The **IConnectionBrokerClient** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **IConnectionBrokerClient** also has these types of members:
