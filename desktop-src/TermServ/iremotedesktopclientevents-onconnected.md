...
- OnConnected method Remote Desktop Services , IRemoteDesktopClientEvents interface
- IRemoteDesktopClientEvents interface Remote Desktop Services , OnConnected method
topic_type:
- apiref
api_name:
