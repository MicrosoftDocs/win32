...
| Method                                                                                      | Description                                                                                                                                                        |
|:--------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**attachEvent**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-attachevent?branch=master)                                     | Attaches an event handler to an event.<br/>                                                                                                                  |
| [**Connect**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-connect?branch=master)                                             | Initiates a connection by using the properties currently set on the Remote Desktop Protocol (RDP) app container client control.<br/>                         |
| [**DeleteSavedCredentials**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-deletesavedcredentials?branch=master)               | Deletes saved credentials for the specified remote computer.<br/>                                                                                            |
| [**detachEvent**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-detachevent?branch=master)                                     | Detaches an event handler from an event.<br/>                                                                                                                |
| [**Disconnect**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-disconnect?branch=master)                                       | Disconnects the active connection.<br/>                                                                                                                      |
...
| [**Reconnect**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-reconnect?branch=master)                                         | Initiates an automatic reconnection of the Remote Desktop Protocol (RDP) app container client control to fit the session to the new width and height.<br/>   |
| [**UpdateSessionDisplaySettings**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-updatesessiondisplaysettings?branch=master)   | Updates the width and height settings for the Remote Desktop Protocol (RDP) app container client control.<br/>                                               |
...
|:---------------------------------------------------------------------|:---------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Actions**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-get_actions?branch=master)<br/>           | Read-only<br/> | Retrieves the actions object for the Remote Desktop Protocol (RDP) app container client.<br/>                                                                    |
...
| [**TouchPointer**](/windows/win32/rdpappcontainerclient/nf-rdpappcontainerclient-iremotedesktopclient-get_touchpointer?branch=master)<br/> | Read-only<br/> | Contains the [**RemoteDesktopClientTouchPointer**](/windows/win32/rdpappcontainerclient/nn-rdpappcontainerclient-iremotedesktopclienttouchpointer?branch=master) object for the Remote Desktop Protocol (RDP) app container client.<br/> |
