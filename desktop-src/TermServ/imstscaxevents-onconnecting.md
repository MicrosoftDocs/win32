...
keywords: ["OnConnecting method Remote Desktop Services", "OnConnecting method Remote Desktop Services , IMsTscAxEvents interface", "IMsTscAxEvents interface Remote Desktop Services , OnConnecting method"]
topic_type:
- apiref
api_name:
