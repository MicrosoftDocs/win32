...
The [**IRemoteDesktopClient**](iremotedesktopclient.md) interface exposes the following properties.

## In this section

<dl> <dt>

[**Actions property**](iremotedesktopclient-actions.md)
</dt> <dd>
...
[**TouchPointer property**](iremotedesktopclient-touchpointer.md)
</dt> <dd>

Contains the [**RemoteDesktopClientTouchPointer**](iremotedesktopclienttouchpointer.md) object for the Remote Desktop Protocol (RDP) app container client.
