...
keywords: ["OnConfirmClose method Remote Desktop Services", "OnConfirmClose method Remote Desktop Services , IMsTscAxEvents interface", "IMsTscAxEvents interface Remote Desktop Services , OnConfirmClose method"]
topic_type:
- apiref
api_name:
