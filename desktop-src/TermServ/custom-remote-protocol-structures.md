...
[**WRDS\_CONNECTION\_SETTINGS**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wrds_connection_settings)
</dt> <dd>
...
[**WRDS\_CONNECTION\_SETTINGS\_1**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wrds_connection_settings_1)
</dt> <dd>
...
[**WRDS\_DYNAMIC\_TIME\_ZONE\_INFORMATION**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wrds_dynamic_time_zone_information)
</dt> <dd>
...
[**WRDS\_LISTENER\_SETTINGS**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wrds_listener_settings)
</dt> <dd>
...
[**WRDS\_LISTENER\_SETTINGS\_1**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wrds_listener_settings_1)
</dt> <dd>
...
[**WRDS\_SETTINGS**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wrds_settings)
</dt> <dd>
...
[**WRDS\_SETTINGS\_1**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wrds_settings_1)
</dt> <dd>
...
[**WTS\_CACHE\_STATS**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_cache_stats)
</dt> <dd>
...
[**WTS\_DISPLAY\_IOCTL**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_display_ioctl)
</dt> <dd>
...
[**WTS\_CLIENT\_DATA**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_client_data)
</dt> <dd>
...
[**WTS\_LICENSE\_CAPABILITIES**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_license_capabilities)
</dt> <dd>
...
[**WTS\_POLICY\_DATA**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_policy_data)
</dt> <dd>
...
[**WTS\_PROPERTY\_VALUE**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-__wts_property_value)
</dt> <dd>
...
[**WTS\_PROTOCOL\_CACHE**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_protocol_cache)
</dt> <dd>
...
[**WTS\_PROTOCOL\_COUNTERS**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_protocol_counters)
</dt> <dd>
...
[**WTS\_PROTOCOL\_STATUS**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_protocol_status)
</dt> <dd>
...
[**WTS\_SERVICE\_STATE**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_service_state)
</dt> <dd>
...
[**WTS\_SESSION\_ID**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_session_id)
</dt> <dd>
...
[**WTS\_SMALL\_RECT**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_small_rect)
</dt> <dd>
...
[**WTS\_SOCKADDR**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_sockaddr)
</dt> <dd>
...
[**WTS\_SYSTEMTIME**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_systemtime)
</dt> <dd>
...
[**WTS\_TIME\_ZONE\_INFORMATION**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_time_zone_information)
</dt> <dd>
...
[**WTS\_USER\_CREDENTIAL**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_user_credential)
</dt> <dd>
...
[**WTS\_USER\_DATA**](/windows/desktop/api/Wtsdefs/ns-wtsdefs-_wts_user_data)
</dt> <dd>
