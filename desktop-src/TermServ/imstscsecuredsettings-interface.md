...
keywords: ["IMsTscSecuredSettings interface Remote Desktop Services", "IMsTscSecuredSettings interface Remote Desktop Services , described"]
topic_type:
- apiref
api_name:
...
The **IMsTscSecuredSettings** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IMsTscSecuredSettings** also has these types of members:
