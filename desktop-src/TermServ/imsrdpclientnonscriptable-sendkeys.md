...
An array whose size is equal to *numKeys*. The array contains keystroke data and corresponds to the value of the *lParam* parameter of the [WM\_KEYDOWN](http://go.microsoft.com/fwlink/p/?linkid=178142) message. The data specifies the repeat count, scan code, extended-key flag, context code, previous key-state flag, and transition-state flag. For a description of the bits in this array, see [WM\_KEYDOWN](http://go.microsoft.com/fwlink/p/?linkid=178142).
