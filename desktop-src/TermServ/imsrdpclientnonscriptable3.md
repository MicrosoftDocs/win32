...
description: Provides access to the nonscriptable properties of a clients remote session on the Remote Desktop ActiveX control. Derives from the IMsRdpClientNonScriptable2 interface.
audience: developer
