...
keywords: ["SetName method Remote Desktop Services", "SetName method Remote Desktop Services , Win32_TSGatewayRADIUSServer class", "Win32_TSGatewayRADIUSServer class Remote Desktop Services , SetName method"]
topic_type:
- apiref
api_name:
...
# SetName method of the Win32\_TSGatewayRADIUSServer class

Sets the **Name** property for this Remote Authentication Dial-In User Service (RADIUS) server.
