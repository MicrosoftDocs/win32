...
keywords: ["OnConnected method Remote Desktop Services", "OnConnected method Remote Desktop Services , IMsTscAxEvents interface", "IMsTscAxEvents interface Remote Desktop Services , OnConnected method"]
topic_type:
- apiref
api_name:
