...
keywords: ["ScheduleTask method Remote Desktop Services", "ScheduleTask method Remote Desktop Services , IRDVTaskPluginNotifySink interface", "IRDVTaskPluginNotifySink interface Remote Desktop Services , ScheduleTask method"]
topic_type:
- apiref
api_name:
...
Type: **[**FILETIME**](https://msdn.microsoft.com/library/windows/desktop/ms724284)**
...
The task end time, in UTC. Pass a [**FILETIME**](https://msdn.microsoft.com/library/windows/desktop/ms724284) set to all zeros if no end time is specified.
