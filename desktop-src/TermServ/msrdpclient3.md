...
keywords: ["MsRdpClient3 class Remote Desktop Services", "MsRdpClient3 class Remote Desktop Services , described"]
topic_type:
- apiref
api_name:
- MsRdpClient3
...
**MsRdpClient3** has these types of members:
...
The **MsRdpClient3** class has these methods.
...
The **MsRdpClient3** class has these properties.
...
| CLSID<br/>                    | CLSID\_MsRdpClient3 is defined as 7584C670-2274-4EFB-B00B-D6AABA6D3850<br/>      |
