...
keywords: ["IMsRdpClient8 interface Remote Desktop Services", "IMsRdpClient8 interface Remote Desktop Services , described"]
topic_type:
- apiref
api_name:
- IMsRdpClient8
...
The **IMsRdpClient8** interface inherits from [**IMsRdpClient7**](imsrdpclient7.md). **IMsRdpClient8** also has these types of members:
