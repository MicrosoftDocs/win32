...
| EnableZoom | VT_BOOL | W | No | Introduced in Windows 11 version 24H2. Writing **True** to this property allows the user to zoom in on the remote session window while [smart sizing](/windows/win32/termserv/imsrdpclientadvancedsettings-smartsizing) is active. |
