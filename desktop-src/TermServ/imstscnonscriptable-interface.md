...
keywords: ["IMsTscNonScriptable interface Remote Desktop Services", "IMsTscNonScriptable interface Remote Desktop Services , described"]
topic_type:
- apiref
api_name:
- IMsTscNonScriptable
...
The **IMsTscNonScriptable** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **IMsTscNonScriptable** also has these types of members:
