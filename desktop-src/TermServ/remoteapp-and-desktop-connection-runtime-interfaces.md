---
title: RemoteApp and Desktop Connection Runtime interfaces
description: Supports interfaces that allow the development of custom clients in RemoteApp and Desktop Connection.
audience: developer
...
keywords: ["Remote Desktop Services Remote Desktop Services , RemoteApp and Desktop Connection Runtime API reference"]
---

# RemoteApp and Desktop Connection Runtime interfaces

The RemoteApp and Desktop Connection Runtime API supports interfaces that allow the development of custom clients in RemoteApp and Desktop Connection.
...
[**IWorkspaceClientExt**](iworkspaceclientext.md)
</dt> <dd>
...
[**IWorkspaceRegistration**](iworkspaceregistration.md)
</dt> <dd>
...
[**IWorkspaceReportMessage**](iworkspacereportmessage.md)
</dt> <dd>
...
[**IWorkspaceResTypeRegistry**](iworkspacerestyperegistry.md)
</dt> <dd>
...
[**IWorkspaceScriptable**](iworkspacescriptable.md)
</dt> <dd>
...
[**IWorkspaceScriptable2**](iworkspacescriptable2.md)
</dt> <dd>
