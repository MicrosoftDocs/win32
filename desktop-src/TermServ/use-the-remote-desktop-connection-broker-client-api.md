...
3.  When the [**IConnectionBrokerClient**](iconnectionbrokerclient.md) interface is no longer needed, call the [**Release**](https://msdn.microsoft.com/library/windows/desktop/ms682317) method.
...
1.  Create an event that can be signaled using the [**CreateEvent**](https://msdn.microsoft.com/library/windows/desktop/ms682396), or similar function, to use for the *hStatusEvent* parameter.
