...
| [**NegotiateSecurityLayer**](imsrdpclientnonscriptable3-negotiatesecuritylayer.md)<br> | Read/write<br> | Specifies whether the NegotiateSecurityLayer setting is supported for this connection.<br> **Note:** When [**CredSspSupport**](imsrdpclientnonscriptable3-enablecredsspsupport.md) is enabled and present on the client, or when Secure Sockets Layer (SSL) is enabled with user authentication, NegotiateSecurityLayer is ignored.<br> | 
...
| <a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>Property</strong></a><br /> | Read/write<br /> | Contains a named property.<br /> | 
