---
title: MsRdpClient10NotSafeForScripting class
...
keywords:
- MsRdpClient10NotSafeForScripting class Remote Desktop Services
- MsRdpClient10NotSafeForScripting class Remote Desktop Services , described
topic_type:
- apiref
api_name:
...
# MsRdpClient10NotSafeForScripting class
...
**MsRdpClient10NotSafeForScripting** has these types of members:
...
The **MsRdpClient10NotSafeForScripting** class has these methods.
...
The **MsRdpClient10NotSafeForScripting** class has these properties.
...
<tr class="odd">
<td style="text-align: left;"><a href="imsrdppreferredredirectioninfo-useredirectionservername"><strong>Property</strong></a><br/></td>
<td style="text-align: left;">Read/write<br/></td>
...
<td style="text-align: left;">Read/write<br/></td>
<td style="text-align: left;">Specifies the publisher certificate chain. The chain is stored in a variant of type VT_BYREF that contains a pointer to a <a href="https://msdn.microsoft.com/library/windows/desktop/aa377182"><strong>CERT_CHAIN_CONTEXT</strong></a> structure.<br/></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="text-align: left;"><a href="imsrdpclient10-remoteprogram3"><strong>RemoteProgram3</strong></a><br/></td>
<td style="text-align: left;">Read-only<br/></td>
<td style="text-align: left;">An object that supports the <a href="itsremoteprogram3"><strong>ITSRemoteProgram3</strong></a> interface.<br/></td>
</tr>
<tr class="odd">
...
| CLSID<br/>                    | CLSID\_MsRdpClient10NotSafeForScripting is defined as A0C63C30-F08D-4AB4-907C-34905D770C7D<br/> |
