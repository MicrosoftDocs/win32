...
The server application can call the [**WTSVirtualChannelOpen**](wtsvirtualchannelopen.md) function to open a handle to a virtual channel. The application can then use the handle in any of the following functions.
