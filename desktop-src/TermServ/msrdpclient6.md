---
title: MsRdpClient6 class
description: Microsoft RDP Client Control (redistributable) - version 7.
audience: developer
...
keywords: ["MsRdpClient6 class Remote Desktop Services", "MsRdpClient6 class Remote Desktop Services , described"]
topic_type:
- apiref
api_name:
- MsRdpClient6
...
**MsRdpClient6** has these types of members:
...
The **MsRdpClient6** class has these methods.
...
The **MsRdpClient6** class has these properties.
...
| CLSID<br/>                    | CLSID\_MsRdpClient6 is defined as 7390F3D8-0439-4C05-91E3-CF5CB290C3D0<br/>      |
