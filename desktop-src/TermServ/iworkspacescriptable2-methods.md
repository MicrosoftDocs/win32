...
The [**IWorkspaceScriptable2**](iworkspacescriptable2.md) interface supports the following methods.

## In this section

<dl> <dt>

[**StartWorkspaceEx method**](iworkspacescriptable2-startworkspaceex.md)
</dt> <dd>
...
[**ResourceDismissed method**](iworkspacescriptable2-resourcedismissed.md)
</dt> <dd>
