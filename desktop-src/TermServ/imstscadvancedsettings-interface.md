...
The **IMsTscAdvancedSettings** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **IMsTscAdvancedSettings** also has these types of members:
