...
The **IMsRdpDevice** interface inherits from the [**IUnknown**](https://msdn.microsoft.com/library/windows/desktop/ms680509) interface. **IMsRdpDevice** also has these types of members:
