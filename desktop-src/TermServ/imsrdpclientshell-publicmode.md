...
keywords: ["PublicMode property Remote Desktop Services", "PublicMode property Remote Desktop Services , IMsRdpClientShell interface", "IMsRdpClientShell interface Remote Desktop Services , PublicMode property"]
topic_type:
- apiref
api_name:
