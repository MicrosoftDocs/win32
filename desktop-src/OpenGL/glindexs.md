...
The current index can be updated at any time. In particular, **glIndexs** can be called between a call to [**glBegin**](https://docs.microsoft.com/windows/desktop/OpenGL/glbegin) and the corresponding call to [**glEnd**](glend.md).
