...
keywords: ["glGetPixelMapfv function OpenGL"]
topic_type:
- apiref
api_name:
- glGetPixelMapfv
...
The **glGetPixelMapfv**, [**glGetPixelMapuiv**](glgetpixelmapuiv.md), and [**glGetPixelMapusv**](glgetpixelmapusv.md) functions return the specified pixel map.
