...
description: Specifies the raster position for pixel operations. | glRasterPos4fv function (Gl.h)
...
A pointer to an array of four elements, specifying x, y, z, and w coordinates for the current raster position.
