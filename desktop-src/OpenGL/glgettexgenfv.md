...
keywords: ["glGetTexGenfv function OpenGL"]
topic_type:
- apiref
api_name:
- glGetTexGenfv
...
The [**glGetTexGendv**](glgettexgendv.md), **glGetTexGenfv**, and [**glGetTexGeniv**](glgettexgeniv.md) functions return texture coordinate generation parameters.
