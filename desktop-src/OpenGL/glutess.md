...
keywords: ["gluTessCallback function OpenGL"]
topic_type:
- apiref
api_name:
- gluTessCallback
...
<tr class="odd">
<td>GLU_TESS_END</td>
<td>The GLU_TESS_END callback serves the same purpose as [<strong>glEnd</strong>](glend.md). It indicates the end of a primitive, and it takes no arguments. The function prototype for this callback is: <strong>void</strong> <strong>end</strong> (<strong>void</strong>);<br/></td>
</tr>
<tr class="even">
