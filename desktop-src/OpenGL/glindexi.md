...
The current index can be updated at any time. In particular, **glIndexi** can be called between a call to [**glBegin**](https://msdn.microsoft.com/library/windows/desktop/dd318361) and the corresponding call to [**glEnd**](glend.md).
