...
keywords: ["gluBeginSurface function OpenGL"]
topic_type:
- apiref
api_name:
- gluBeginSurface
...
The **gluBeginSurface** and [**gluEndSurface**](gluendsurface.md) functions delimit a Non-Uniform Rational B-Spline ([NURBS](using-nurbs-curves-and-surfaces.md)) surface definition.
