...
To detach a rendering context from a thread, make it not current. You can do this by calling the [**wglMakeCurrent**](/windows/win32/wingdi/nf-wingdi-wglmakecurrent?branch=master) function with the parameters set to **NULL**. The following is a sample of this simple task.
