...
Microsoft's implementation of OpenGL for Windows uses the [**PIXELFORMATDESCRIPTOR**](pixelformatdescriptor.md) data structure to convey pixel format data. The structure's members specify the preceding properties and several others.
