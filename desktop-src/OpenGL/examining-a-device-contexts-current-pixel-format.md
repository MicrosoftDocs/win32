...
Use the [**GetPixelFormat**](getpixelformat.md) and [**DescribePixelFormat**](describepixelformat.md) functions to examine a device context's current pixel format, as shown in the following code fragment.
