...
You determine the colors of your application's logical palette with [PALETTEENTRY](https://msdn.microsoft.com/library/windows/desktop/dd162769) structures. Typically you create an array of **PALETTEENTRY** structures to specify the entire palette entry table of the logical palette.
