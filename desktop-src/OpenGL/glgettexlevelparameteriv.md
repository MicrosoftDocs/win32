...
keywords: ["glGetTexLevelParameteriv function OpenGL"]
topic_type:
- apiref
api_name:
...
The [**glGetTexLevelParameterfv**](glgettexlevelparameterfv.md) and **glGetTexLevelParameteriv** functions return texture parameter values for a specific level of detail.
