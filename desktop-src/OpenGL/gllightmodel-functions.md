...
keywords: ["OpenGL,glLightModel functions", "OpenGL reference,glLightModel functions", "reference for OpenGL,glLightModel functions", "OpenGL,light functions", "OpenGL reference,light functions", "reference for OpenGL,light functions", "glLightModel functions", "light functions"]
---
