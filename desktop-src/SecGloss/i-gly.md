...
See also [*access token*](https://www.bing.com/search?q=*access token*) and [*primary token*](https://www.bing.com/search?q=*primary token*).
...
A [*security identifier*](https://www.bing.com/search?q=*security identifier*) (SID) that represents an integrity level. An integrity SID in the [*system access control list*](https://www.bing.com/search?q=*system access control list*) (SACL) of an object's security descriptor specifies the integrity level of the object. Integrity SIDs in an access token specify the integrity level of the token.
