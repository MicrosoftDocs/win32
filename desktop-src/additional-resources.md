...
| [Windows Messaging (MAPI)](https://msdn.microsoft.com/library/windows/desktop/dd296730)                                                                           | [Office MAPI](https://msdn.microsoft.com/en-us/library/Cc765775(v=office.12).aspx)                                       |
...
-   [Application User Interface Technical Articles](https://msdn.microsoft.com/en-us/library/Hh703249(v=VS.85).aspx)
-   [Books and Columns](https://msdn.microsoft.com/library/windows/desktop/hh529128)
-   [Component Development Technical Articles](https://msdn.microsoft.com/en-us/library/Hh703250(v=VS.85).aspx)
-   [Compression Resources](https://msdn.microsoft.com/en-us/library/Hh529130(v=VS.85).aspx)
-   [Data Access and Storage Technical Articles](https://msdn.microsoft.com/en-us/library/Hh703251(v=VS.85).aspx)
-   [Developer Notes](https://msdn.microsoft.com/library/bb432247)
-   [Developer Notes (Visual Studio)](https://msdn.microsoft.com/en-US/library/Cc507808(v=VS.80).aspx)
-   [Diagnostics Technical Articles](https://msdn.microsoft.com/en-us/library/Hh703252(v=VS.85).aspx)
-   [Directory Services Technical Articles](https://msdn.microsoft.com/en-us/library/Hh703253(v=VS.85).aspx)
-   [Graphics and Multimedia Technical Articles](https://msdn.microsoft.com/en-us/library/Hh703254(v=VS.85).aspx)
-   [Indexing Service](https://msdn.microsoft.com/library/windows/desktop/ee805985)
-   [Interoperabilty with Managed Code](https://msdn.microsoft.com/en-us/library/ms717435(v=VS.85).aspx)
-   [Legacy Collaboration Features](https://msdn.microsoft.com/en-us/library/Hh529136(v=VS.85).aspx)
...
-   [Windows SideShow](https://msdn.microsoft.com/en-us/library/ms744202(v=VS.85).aspx)
