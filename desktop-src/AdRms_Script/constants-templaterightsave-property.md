---
Description: Retrieves a value that specifies a right to save content.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\mbaldwin
ms.assetid: 1e3ecc30-4471-4b51-9b96-9692fc1829e3
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
title: Constants.TemplateRightSave property
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Constants.TemplateRightSave property

The **TemplateRightSave** property retrieves a value that specifies a right to save content.
...
This property returns an integer value (512).
