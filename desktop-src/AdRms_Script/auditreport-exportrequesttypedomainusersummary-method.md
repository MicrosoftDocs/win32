---
Description: Generates a report for the number of total, successful, and failed requests for a given request type for each user in a domain.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\mbaldwin
ms.assetid: b3ff85a2-b6f9-4145-924f-383643a01bce
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
title: AuditReport.ExportRequestTypeDomainUserSummary method
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# AuditReport.ExportRequestTypeDomainUserSummary method

The **ExportRequestTypeDomainUserSummary** method generates a report for the number of total, successful, and failed requests for a given request type for each user in a domain.

## Syntax


```VB
AuditReport.ExportRequestTypeDomainUserSummary( _
  ByVal languageId, _
  ByVal start, _
  ByVal end, _
...
' *******************************************************************
' Generate a RequestTypeDomainUserSummary report for the acquire 
...
SUB CreateReport()
  ...
  outFile = "c:\AcquireLicenseTypeDomainUserSummary.xls"
  fileType = 0
  ...
  ' Generate the report.
  CALL auditReport.ExportRequestTypeDomainUserSummary( _
      lcid, _ 
      startDate, _ 
      endDate, _ 
      requestId, _
