---
Description: Retrieves a value that specifies a right to reply to an email message.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\mbaldwin
ms.assetid: 7ccd5ea9-2328-48e4-938a-947fe300d519
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
title: Constants.TemplateRightReply property
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Constants.TemplateRightReply property

The **TemplateRightReply** property retrieves a value that specifies a right to reply to an email message.
...
This property returns an integer value (64).
