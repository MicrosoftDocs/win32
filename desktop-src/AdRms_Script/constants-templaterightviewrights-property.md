---
Description: 'Retrieves a value that specifies a right to view content rights.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\mbaldwin'
ms.assetid: '76cb6e47-3177-497a-af6e-cf763449a754'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
title: 'Constants.TemplateRightViewRights property'
---

# Constants.TemplateRightViewRights property

The **TemplateRightViewRights** property retrieves a value that specifies a right to view content rights.
...
```VB
Constants.TemplateRightViewRights
```
...
This property returns an integer value (0x8).
