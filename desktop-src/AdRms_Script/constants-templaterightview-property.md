---
Description: Retrieves a value that specifies a right to view content.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\mbaldwin
ms.assetid: de7322d0-1169-41a7-9242-357230abd8ed
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
title: Constants.TemplateRightView property
ms.date: 05/31/2018
ms.topic: article
