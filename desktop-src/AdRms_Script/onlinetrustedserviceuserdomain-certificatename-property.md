...
The **CertificationName** property retrieves the common name of the Windows Live ID service.
...
```VB
OnlineTrustedServiceUserDomain.CertificationName
```
...
This property returns a string value. The current value of the common name is "Windows Live ID".
