---
Description: 'Retrieves a value that specifies a right to forward content.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\mbaldwin'
ms.assetid: '9e8095be-b70b-400c-9ec0-70c50914060a'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
title: 'Constants.TemplateRightForward property'
---

# Constants.TemplateRightForward property

The **TemplateRightForward** property retrieves a value that specifies a right to forward content.
...
```VB
Constants.TemplateRightForward
```
...
This property returns an integer value (32).
