---
Description: Retrieves a value that specifies a right to reply to all members identified in an email message.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\mbaldwin
ms.assetid: ad8cd91f-4589-46b0-a957-796dd18ebd0c
ms.prod: windows-server-dev
ms.technology: active-directory-rights-management
ms.tgt_platform: multiple
title: Constants.TemplateRightReplyAll property
ms.date: 05/31/2018
ms.topic: article
ms.author: windowssdkdev
---

# Constants.TemplateRightReplyAll property

The **TemplateRightReplyAll** property retrieves a value that specifies a right to reply to all members identified in an email message.
...
```VB
Constants.TemplateRightReplyAll
```
...
This property returns an integer value (128).
