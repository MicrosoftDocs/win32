---
Description: 'Retrieves a value that specifies a right to allow macros in content.'
audience: developer
author: 'REDMOND\\markl'
manager: 'REDMOND\\mbaldwin'
ms.assetid: 'cb0bd65f-8a7e-4f13-9462-d175d8ec4345'
ms.prod: 'windows-server-dev'
ms.technology: 'active-directory-rights-management'
ms.tgt_platform: multiple
title: 'Constants.TemplateRightAllowMacros property'
---

# Constants.TemplateRightAllowMacros property

The **TemplateRightAllowMacros** property retrieves a value that specifies a right to allow macros in content.
...
```VB
Constants.TemplateRightAllowMacros
```
