...
| [Distributed File System Replication](/previous-versions/windows/desktop/dfsr/dfsr-overview) | The Distributed File System Replication (DFSR) service is a state-based, multimaster replication engine that supports replication scheduling and bandwidth throttling. |
...
| [Non-Volatile Memory Library (NVML)](/windows/win32/persistent-memory-programming-in-windows---nvml-integration) | Allows developers to utilize NVML APIs in order to code for persistent memory in Windows environments. |
