...
| [Backup](https://msdn.microsoft.com/en-us/library/Ee663261(v=VS.85).aspx)<br/>                                                                                  | Describes registry keys and specialized APIs for backup and restore, the Volume Shadow Copy Service (VSS), and the Windows Server Backup feature.<br/>                                                                                                                                                |
...
| [MSXML](https://msdn.microsoft.com/en-us/library/ms763742(v=VS.85).aspx)<br/>                                                         | Microsoft XML Core Services (MSXML) allows customers who use JScript, Visual Basic Scripting Edition (VBScript), and Microsoft Visual Studio to build high-performance XML-based applications.<br/>                                                                                                   |
| [Non-Volatile Memory Library (NVML)](https://msdn.microsoft.com/library/Mt806229(v=VS.85).aspx)<br/> | Allows developers to utilize NVML APIs in order to code for persistent memory in Windows environments.<br/>                                                                                                                                                                                           |
...
| [Windows Data Access Components](https://msdn.microsoft.com/en-us/library/Aa968814(v=VS.85).aspx)<br/>                                | Windows Data Access Components (Windows DAC) 6.0 is a set of technologies that provide access to information across the enterprise. These technologies include Microsoft ActiveX Data Objects (ADO), OLE DB, and Microsoft Open Database Connectivity (ODBC).<br/>                                    |
...
| [XmlLite](https://msdn.microsoft.com/en-us/library/ms752872(v=VS.85).aspx)<br/>                                                       | XmlLite is a lightweight XML parser designed for ease of use, performance, and standards compliance.<br/>                                                                                                                                                                                             |
