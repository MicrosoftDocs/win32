...
Network traffic data that is collected in frames. A network packet provider (NPP) performs a capture. See also [*delayed capture*](https://www.bing.com/search?q=*delayed capture*), and [*real-time capture*](#-netmon-real-time-capture-gly)
