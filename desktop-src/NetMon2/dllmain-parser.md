...
Indicator to determine why the function is called. For a list of all possible flags, see [DllMain](https://msdn.microsoft.com/library/windows/desktop/ms682583). The parser implementation must process the following values.
...
The operating system calls **DllMain** to load and unload the parser DLL. This function is based on the dynamic-link library [DllMain](https://msdn.microsoft.com/library/windows/desktop/ms682583) function.
