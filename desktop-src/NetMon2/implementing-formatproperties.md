...
> [!Note]  
> A [**PROPERTYINFO**](propertyinfo.md) structure is specified when adding a property to the [*property database*](https://www.bing.com/search?q=*property database*) of the parser.
...
-   The [**FormatPropertyInstance**](formatpropertyinstance.md) function to use the [*generic formatter*](https://www.bing.com/search?q=*generic formatter*) that Network Monitor provides.
