...
The **GetCaptureCommentFromFilename** function extracts the capture comment from a [*capture file*](https://www.bing.com/search?q=*capture file*).
...
[*Experts*](https://www.bing.com/search?q=*Experts*) and [*parsers*](https://www.bing.com/search?q=*parsers*) can call the **GetCaptureCommentFromFilename** function.
