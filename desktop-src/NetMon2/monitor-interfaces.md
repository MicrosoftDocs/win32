...
| [IMonitorEventer](imonitoreventer.md) | Provides methods used to send events. This interface is provided by the [*Monitor Control Service*](m.md#-netmon-monitor-control-service-gly) (MCSVC). |
