...
| [IMonitorEventer](imonitoreventer.md) | Provides methods used to send events. This interface is provided by the [*Monitor Control Service*](https://www.bing.com/search?q=*Monitor Control Service*) (MCSVC). |
