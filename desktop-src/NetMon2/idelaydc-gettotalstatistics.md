...
Network Monitor also stores [*conversation statistics*](https://www.bing.com/search?q=*conversation statistics*), which can be retrieved by calling the [IDelaydC::GetConversationStatistics](idelaydc-getconversationstatistics.md) method.
