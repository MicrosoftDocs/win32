...
Network Monitor also stores [*conversation statistics*](https://www.bing.com/search?q=*conversation statistics*), which can be retrieved by calling the [IStats::GetConversationStatistics](istats-getconversationstatistics.md) method.
