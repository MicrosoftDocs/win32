...
title: IStatsGetTotalStatistics method
ms.date: 05/31/2018
ms.topic: article
...
Network Monitor also stores [*conversation statistics*](c.md#-netmon-conversation-statistics-gly), which can be retrieved by calling the [IStats::GetConversationStatistics](istats-getconversationstatistics.md) method.
