...
|--------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**DllMain Expert**](dllmain-expert.md)   | Indicates that the expert DLL has been loaded or unloaded. When a process loads or unloads the DLL, the operating system calls the [**DllMain**](https://msdn.microsoft.com/library/windows/desktop/ms682583) function. |
