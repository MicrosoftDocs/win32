...
| [**GetControlState**](irtc-getcontrolstate.md)                     | Retrieves the state of the [*capture*](https://www.bing.com/search?q=*capture*), which indicates if the capture is running or paused.<br/>                      |
| [**GetConversationStatistics**](irtc-getconversationstatistics.md) | Retrieves [*session*](https://www.bing.com/search?q=*session*) and [*station information*](https://www.bing.com/search?q=*station information*) for the current capture.<br/> |
