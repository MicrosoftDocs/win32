...
The Network Monitor functions, listed in the following table, can be used to develop either [*parsers*](https://www.bing.com/search?q=*parsers*) or [*experts*](https://www.bing.com/search?q=*experts*).
