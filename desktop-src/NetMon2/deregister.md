...
The **Deregister** export function frees the resources used to create the protocol [*property database*](https://www.bing.com/search?q=*property database*). The parser DLL must implement **Deregister**.
...
When implementing **Deregister**, the parser DLL must call the [DestroyPropertyDatabase](destroypropertydatabase.md) function to release the [*property database*](https://www.bing.com/search?q=*property database*) resources.
