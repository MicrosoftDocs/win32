...
| [**GetControlState**](istats-getcontrolstate.md)                     | Retrieves the state of the [*capture*](c.md#-netmon-capture-gly), which indicates if the capture is running or paused.<br/>                        |
| [**GetConversationStatistics**](istats-getconversationstatistics.md) | Retrieves [*session*](s.md#-netmon-session-gly) and [*station information*](s.md#-netmon-station-information-gly) about the current capture.<br/> |
