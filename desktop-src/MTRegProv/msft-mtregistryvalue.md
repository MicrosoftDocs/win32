---
title: MSFT\_MTRegistryValue class
description: Represents a registry value.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'acf913cb-6b55-4e50-a46c-27c4d8be5728'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_MTRegistryValue class", "MSFT_MTRegistryValue class, described"]
topic_type:
- apiref
api_name:
- MSFT_MTRegistryValue
- MSFT_MTRegistryValue.InstanceID
- MSFT_MTRegistryValue.Caption
- MSFT_MTRegistryValue.Description
- MSFT_MTRegistryValue.ElementName
- MSFT_MTRegistryValue.Name
- MSFT_MTRegistryValue.Type
- MSFT_MTRegistryValue.Status
api_location:
- RegProv.dll
api_type:
- DllExport
...
The **MSFT\_MTRegistryValue** class has these types of members:
...
The **MSFT\_MTRegistryValue** class has these methods.



| Method                                            | Description                                |
|:--------------------------------------------------|:-------------------------------------------|
| [**GetValue**](msft-mtregistryvalue-getvalue.md) | Gets the registry value object.<br/> |
| [**Rename**](rename-msft-mtregistryvalue.md)     | Renames the registry object.<br/>    |
...
The **MSFT\_MTRegistryValue** class has these properties.
