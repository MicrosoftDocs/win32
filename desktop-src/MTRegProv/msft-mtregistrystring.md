---
title: MSFT\_MTRegistryString class
description: Represent the string registry data.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '65e1bbdd-902c-47b9-a423-722890dfcaa9'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["MSFT_MTRegistryString class", "MSFT_MTRegistryString class, described"]
topic_type:
- apiref
api_name:
- MSFT_MTRegistryString
- MSFT_MTRegistryString.InstanceID
- MSFT_MTRegistryString.Caption
- MSFT_MTRegistryString.Description
- MSFT_MTRegistryString.ElementName
- MSFT_MTRegistryString.Name
- MSFT_MTRegistryString.Type
- MSFT_MTRegistryString.Status
- MSFT_MTRegistryString.Data
api_location:
- RegProv.dll
api_type:
- DllExport
...
The **MSFT\_MTRegistryString** class has these types of members:
...
The **MSFT\_MTRegistryString** class has these methods.



| Method                                             | Description                                                                                                                                          |
|:---------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetValue**](msft-mtregistrystring-getvalue.md) | Gets the registry value object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/> |
| [**Rename**](msft-mtregistrystring-rename.md)     | Renames the registry object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/>    |
...
The **MSFT\_MTRegistryString** class has these properties.
...
String data of the registry value.
