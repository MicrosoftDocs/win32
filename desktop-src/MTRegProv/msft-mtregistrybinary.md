---
title: MSFT\_MTRegistryBinary class
description: Represent the binary registry data.
audience: developer
...
- MSFT_MTRegistryBinary.InstanceID
- MSFT_MTRegistryBinary.Caption
- MSFT_MTRegistryBinary.Description
- MSFT_MTRegistryBinary.ElementName
- MSFT_MTRegistryBinary.Name
- MSFT_MTRegistryBinary.Type
- MSFT_MTRegistryBinary.Status
- MSFT_MTRegistryBinary.Data
api_location:
- RegProv.dll
api_type:
- DllExport
...
The **MSFT\_MTRegistryBinary** class has these types of members:
...
The **MSFT\_MTRegistryBinary** class has these methods.



| Method                                             | Description                                                                                                                                          |
|:---------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetValue**](msft-mtregistrybinary-getvalue.md) | Gets the registry value object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/> |
| [**Rename**](msft-mtregistrybinary-rename.md)     | Renames the registry object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/>    |
...
The **MSFT\_MTRegistryBinary** class has these properties.
...
Binary data of the registry value.
