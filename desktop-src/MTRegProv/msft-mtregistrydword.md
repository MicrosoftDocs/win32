---
title: MSFT\_MTRegistryDword class
description: Represent the 32-bit registry data.
audience: developer
...
- MSFT_MTRegistryDword.InstanceID
- MSFT_MTRegistryDword.Caption
- MSFT_MTRegistryDword.Description
- MSFT_MTRegistryDword.ElementName
- MSFT_MTRegistryDword.Name
- MSFT_MTRegistryDword.Type
- MSFT_MTRegistryDword.Status
- MSFT_MTRegistryDword.Data
api_location:
- RegProv.dll
api_type:
- DllExport
...
The **MSFT\_MTRegistryDword** class has these types of members:
...
The **MSFT\_MTRegistryDword** class has these methods.



| Method                                            | Description                                                                                                                                          |
|:--------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetValue**](msft-mtregistrydword-getvalue.md) | Gets the registry value object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/> |
| [**Rename**](msft-mtregistrydword-rename.md)     | Renames the registry object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/>    |
...
The **MSFT\_MTRegistryDword** class has these properties.
...
32-bit integer data of the registry value.
