---
title: MSFT\_MTRegistryQword class
description: Represent the 64-bit registry data.
audience: developer
...
- MSFT_MTRegistryQword.InstanceID
- MSFT_MTRegistryQword.Caption
- MSFT_MTRegistryQword.Description
- MSFT_MTRegistryQword.ElementName
- MSFT_MTRegistryQword.Name
- MSFT_MTRegistryQword.Type
- MSFT_MTRegistryQword.Status
- MSFT_MTRegistryQword.Data
api_location:
- RegProv.dll
api_type:
- DllExport
...
The **MSFT\_MTRegistryQword** class has these types of members:
...
The **MSFT\_MTRegistryQword** class has these methods.



| Method                                            | Description                                                                                                                                          |
|:--------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetValue**](msft-mtregistryqword-getvalue.md) | Gets the registry value object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/> |
| [**Rename**](msft-mtregistryqword-rename.md)     | Renames the registry object.<br/> This method is inherited from the [**MSFT\_MTRegistryValue**](msft-mtregistryvalue.md) class.<br/>    |
...
The **MSFT\_MTRegistryQword** class has these properties.
...
64-bit integer data of the registry value.
