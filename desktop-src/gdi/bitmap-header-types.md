...
The [**BITMAPV5HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv5header?branch=master) structure is an extended [**BITMAPV4HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv4header?branch=master) structure, which is an extended [**BITMAPINFOHEADER**](/windows/win32/Wingdi/?branch=master) structure. However, the **BITMAPINFOHEADER** and [**BITMAPCOREHEADER**](/windows/win32/Wingdi/ns-wingdi-tagbitmapcoreheader?branch=master) have only the **Size** member in common with other bitmap header structures.

The [**BITMAPCOREHEADER**](/windows/win32/Wingdi/ns-wingdi-tagbitmapcoreheader?branch=master) and [**BITMAPV4HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv4header?branch=master) formats have been superseded by [**BITMAPINFOHEADER**](/windows/win32/Wingdi/?branch=master) and [**BITMAPV5HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv5header?branch=master) formats, respectively. The **BITMAPCOREHEADER** and **BITMAPV4HEADER** formats are presented for completeness and backward compatibility.

The format for a DIB is the following (for more information, see [Bitmap Storage](bitmap-storage.md) ):

-   a [**BITMAPFILEHEADER**](/windows/win32/Wingdi/ns-wingdi-tagbitmapfileheader?branch=master) structure
-   either a [**BITMAPCOREHEADER**](/windows/win32/Wingdi/ns-wingdi-tagbitmapcoreheader?branch=master), a [**BITMAPINFOHEADER**](/windows/win32/Wingdi/?branch=master), a [**BITMAPV4HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv4header?branch=master), or a [**BITMAPV5HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv5header?branch=master) structure.
-   an optional color table, which is either a set of [**RGBQUAD**](/windows/win32/Wingdi/ns-wingdi-tagrgbquad?branch=master) structures or a set of [**RGBTRIPLE**](/windows/win32/Wingdi/ns-wingdi-tagrgbtriple?branch=master) structures.
-   the bitmap data
...
Profile data will only exist for [**BITMAPV5HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv5header?branch=master) structures where **bV5CSType** is PROFILE\_LINKED or PROFILE\_EMBEDDED. For functions that receive packed DIBs, the profile data comes after the bitmap data.
...
The red, green, and blue bitfield masks for BI\_BITFIELD bitmaps immediately follow the [**BITMAPINFOHEADER**](/windows/win32/Wingdi/?branch=master), [**BITMAPV4HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv4header?branch=master), and [**BITMAPV5HEADER**](/windows/win32/Wingdi/ns-wingdi-bitmapv5header?branch=master) structures. The **BITMAPV4HEADER** and **BITMAPV5HEADER** structures contain additional members for red, green, and blue masks as follows.
...
When the **biCompression** member of [**BITMAPINFOHEADER**](/windows/win32/Wingdi/?branch=master) is set to BI\_BITFIELDS and the function receives an argument of type **LPBITMAPINFO**, the color masks will immediately follow the header. The color table, if present, will follow the color masks. [**BITMAPCOREHEADER**](/windows/win32/Wingdi/ns-wingdi-tagbitmapcoreheader?branch=master) bitmaps do not support color masks.

By default, bitmap data is bottom-up in its format. Bottom-up means that the first scan line in the bitmap data is the last scan line to be displayed. For example, the 0<sup>th</sup> pixel of the 0<sup>th</sup> scan line of the bitmap data of a 10-pixel by 10-pixel bitmap will be the 0<sup>th</sup> pixel of the 9<sup>th</sup> scan line of the displayed or printed image. Run-length encoded (RLE) format bitmaps and [**BITMAPCOREHEADER**](/windows/win32/Wingdi/ns-wingdi-tagbitmapcoreheader?branch=master) bitmaps cannot be top-down bitmaps. The scan lines are **DWORD** aligned, except for RLE-compressed bitmaps. They must be padded for scan line widths, in bytes, that are not evenly divisible by four, except for RLE compressed bitmaps. For example, a 10- by 10-pixel 24-bpp bitmap will have two padding bytes at the end of each scan line.
