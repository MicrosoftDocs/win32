...
The following example uses the [**EnumFontFamilies**](https://msdn.microsoft.com/en-us/library/Dd162619(v=VS.85).aspx) function to retrieve the number of available raster, vector, and TrueType font families.
