...
You can also process complex scripts with Uniscribe. Uniscribe is a set of functions that allow a fine degree of control for complex scripts. For more information, see [Uniscribe](https://msdn.microsoft.com/library/Dd374091(v=VS.85).aspx) and [Processing Complex Scripts](https://msdn.microsoft.com/library/Dd319103(v=VS.85).aspx).
