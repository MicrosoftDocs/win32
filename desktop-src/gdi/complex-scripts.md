...
To toggle both attributes at once, execute the following statement and then call [**SetTextAlign**](settextalign.md) and [**ExtTextOut**](exttextout.md), as shown previously:
