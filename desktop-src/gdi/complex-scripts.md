...
You can also process complex scripts with Uniscribe. Uniscribe is a set of functions that allow a fine degree of control for complex scripts. For more information, see [Uniscribe](https://msdn.microsoft.com/windows/desktop/de7a882f-ed74-4be2-b66d-59c2e50dc07a) and [Processing Complex Scripts](https://msdn.microsoft.com/windows/desktop/1190baed-5959-4f7a-8946-ac3b3da85821).
