...
| [**DeviceCapabilities**](https://msdn.microsoft.com/windows/desktop/d7f63ef7-0a2e-47c3-9e81-6e8a6dffe9af)           | Retrieves the capabilities of a printer device driver.                                                                                    |
...
| [**EnumObjectsProc**](https://www.bing.com/search?q=**EnumObjectsProc**)                 | An application-defined callback function used with the [**EnumObjects**](/windows/desktop/api/Wingdi/nf-wingdi-enumobjects) function.                                       |
