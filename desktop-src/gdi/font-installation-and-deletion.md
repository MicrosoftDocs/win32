...
-   Copy the font into the %windir%\\fonts folder. Then, either go to the Control Panel and click the **Fonts** icon, or call [**AddFontResource**](https://msdn.microsoft.com/windows/desktop/e553a25a-f281-4ddc-8e95-1f61ed8238f9) or [**AddFontResourceEx**](https://msdn.microsoft.com/windows/desktop/eaf8ebf0-1b06-4a09-a842-83540245a117). The font is available to an application even before the reboot. However, in a terminal server situation the font is available for the current session but is not available for other sessions until after a reboot. If you only copy the font into the %windir%\\fonts folder, the font will be available only after the system is rebooted.
