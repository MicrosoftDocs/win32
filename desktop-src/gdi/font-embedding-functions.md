...
| [*READEMBEDPROC*](/windows/desktop/api/T2embapi/)                                       | Client-provided callback function to read stream contents from a buffer.                                                                                 |
...
| [*WRITEEMBEDPROC*](/windows/desktop/api/T2embapi/)                                     | Client-provided callback function to write stream contents to a buffer.                                                                                  |
