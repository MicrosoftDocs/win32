...
| [**GetDisplayAutoRotationPreferences**](https://msdn.microsoft.com/en-us/library/Dn376360(v=VS.85).aspx) | Gets the orientation preferences of the display.                                                                                 |
...
| [**SetDisplayAutoRotationPreferences**](https://msdn.microsoft.com/en-us/library/Dn376361(v=VS.85).aspx) | Sets the orientation preferences of the display.                                                                                 |
