...
This API is designed for use by C/C++ programmers. Familiarity with the Windows [message-driven architecture](learnwin32.window_messages) is required.
...
-   [Paths](paths.md)
-   [Pens](pens.md)
-   [Printing and Print Spooler](gdi.printing_and_print_spooler)
...
[GDI+](_gdiplus_GDI_start)
</dt> <dt>

[OpenGL](opengl.opengl)
</dt> <dt>

[Windows Image Acquisition](_wia_startpage)
</dt> </dl>
