...
An application can also use [**SetWorldTransform**](setworldtransform.md) to outline the shape of the pen used to outline a path if the pen is a geometric pen. For a description of geometric pens, see [Pens](pens.md).
