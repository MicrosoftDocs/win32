...
Bitmaps should be saved in a file that uses the established bitmap file format and assigned a name with the three-character .bmp extension. The established bitmap file format consists of a [**BITMAPFILEHEADER**](/windows/desktop/api/Wingdi/ns-wingdi-tagbitmapfileheader) structure followed by a [**BITMAPINFOHEADER**](/windows/desktop/api/Wingdi/), [**BITMAPV4HEADER**](/windows/desktop/api/Wingdi/ns-wingdi-bitmapv4header), or [**BITMAPV5HEADER**](/windows/desktop/api/Wingdi/ns-wingdi-bitmapv5header) structure. An array of [**RGBQUAD**](/windows/desktop/api/Wingdi/ns-wingdi-tagrgbquad) structures (also called a color table) follows the bitmap information header structure. The color table is followed by a second array of indexes into the color table (the actual bitmap data).
...
| [**BITMAPINFOHEADER**](/windows/desktop/api/Wingdi/) | 0x0E 0x35           |
