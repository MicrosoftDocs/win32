...
Unlike [**WM\_PRINT**](wm-print.md), **WM\_PRINTCLIENT** is not processed by [**DefWindowProc**](_win32_DefWindowProc_cpp). A window should process the **WM\_PRINTCLIENT** message through an application-defined [**WindowProc**](_win32_WindowProc_cpp) function for it to be used properly.
