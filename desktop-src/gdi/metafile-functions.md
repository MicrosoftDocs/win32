...
| [**EnhMetaFileProc**](https://msdn.microsoft.com/en-us/library/Dd162606(v=VS.85).aspx)                           | An application-defined callback function used with the EnumEnhMetaFile function.                                       |
...
-   [**EnumMetaFileProc**](https://msdn.microsoft.com/en-us/library/Dd162630(v=VS.85).aspx)
