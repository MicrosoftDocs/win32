...
For more information about the WDDM, see [Windows Vista Display Driver Model (WDDM) Design Guide](https://msdn.microsoft.com/library/windows/hardware/ff570593) on MSDN.
...
For more information about Direct3D 10, see [Direct3D 10](https://msdn.microsoft.com/library/windows/desktop/bb205066).
...
Windows 8 extends the [Direct3D 11 API](#direct3d-11) with Direct3D 11.1. Direct3D 11.1 supports all existing hardware that [feature levels](https://msdn.microsoft.com/library/windows/desktop/ff476876#overview) 11, 10\_x, and 9\_x support, as well as a new 11\_1 feature level.

In addition to the [Direct3D 11.1 API](https://msdn.microsoft.com/library/windows/desktop/hh404562), Windows 8 includes [DXGI 1.2](https://msdn.microsoft.com/library/windows/desktop/hh404490), [Direct2D device contexts](https://msdn.microsoft.com/library/windows/desktop/hh780339), and support for WDDM 1.2 drivers.

> [!Note]  
> If you want your Windows Store apps to program 3D graphics with DirectX, you can use the Direct3D 11.1 API. For more info about programming 3D graphics with DirectX, see [Introduction to 3D graphics with DirectX](https://msdn.microsoft.com/library/windows/apps/hh465137).
