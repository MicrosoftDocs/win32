...
A sample application that takes advantage of Direct3D 9Ex Flip Model and associated present statistics functionality is shown in the [D3D9ExFlipEx sample on the MSDN Code Gallery](http://go.microsoft.com/fwlink/p/?linkid=179115).
...
[D3D9ExFlipEx MSDN Code Gallery sample](http://go.microsoft.com/fwlink/p/?linkid=179115)
</dt> <dt>
