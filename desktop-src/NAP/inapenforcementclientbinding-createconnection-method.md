...
keywords: ["CreateConnection method NAP", "CreateConnection method NAP , INapEnforcementClientBinding interface", "INapEnforcementClientBinding interface NAP , CreateConnection method"]
topic_type:
- apiref
api_name:
