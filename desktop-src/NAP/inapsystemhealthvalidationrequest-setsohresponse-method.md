...
keywords: ["SetSoHResponse method NAP", "SetSoHResponse method NAP , INapSystemHealthValidationRequest interface", "INapSystemHealthValidationRequest interface NAP , SetSoHResponse method"]
topic_type:
- apiref
api_name:
...
The **INapSystemHealthValidationRequest::SetSoHResponse** method allows System Health Validators (SHVs) to set the [**SoHResponse**](soh-struct.md) to be sent to its System Health Agent (SHA) counterpart on the client-side.
...
A pointer to a [**SoHResponse**](soh-struct.md) structure.
