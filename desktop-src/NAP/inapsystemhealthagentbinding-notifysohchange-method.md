...
keywords: ["NotifySoHChange method NAP", "NotifySoHChange method NAP , INapSystemHealthAgentBinding interface", "INapSystemHealthAgentBinding interface NAP , NotifySoHChange method"]
topic_type:
- apiref
api_name:
