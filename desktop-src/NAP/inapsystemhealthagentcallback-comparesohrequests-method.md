...
A pointer to the [**SoHRequest**](/windows/win32/NapTypes/ns-naptypes-tagsoh?branch=master) on the left of the comparison operation.
...
A pointer to the [**SoHRequest**](/windows/win32/NapTypes/ns-naptypes-tagsoh?branch=master) on the right of the comparison operation.
...
If SHAs have not put any time-stamps or Ids into their SoHs, they may choose to not implement this function and return **E\_NOTIMPL**. In this case, the NapAgent performs a byte-wise comparison on the [**SoHRequests**](/windows/win32/NapTypes/ns-naptypes-tagsoh?branch=master).
