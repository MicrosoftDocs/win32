...
keywords: ["GetCacheSoHFlag method NAP", "GetCacheSoHFlag method NAP , INapSystemHealthAgentRequest interface", "INapSystemHealthAgentRequest interface NAP , GetCacheSoHFlag method"]
topic_type:
- apiref
api_name:
