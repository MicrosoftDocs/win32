...
keywords: ["SetConnectionId method NAP", "SetConnectionId method NAP , INapEnforcementClientConnection interface", "INapEnforcementClientConnection interface NAP , SetConnectionId method"]
topic_type:
- apiref
api_name:
