...
A pointer to a pointer to a [**PrivateData**](/windows/win32/NapTypes/ns-naptypes-tagprivatedata?branch=master) opaque data blob that only the NapAgent can interpret.
