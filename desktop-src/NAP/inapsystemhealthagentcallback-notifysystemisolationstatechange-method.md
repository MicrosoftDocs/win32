...
keywords: ["NotifySystemIsolationStateChange method NAP", "NotifySystemIsolationStateChange method NAP , INapSystemHealthAgentCallback interface", "INapSystemHealthAgentCallback interface NAP , NotifySystemIsolationStateChange method"]
topic_type:
- apiref
api_name:
