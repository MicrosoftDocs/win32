...
A pointer to a pointer to a [**NetworkSoHRequest**](/windows/desktop/api/NapTypes/ns-naptypes-tagnetworksoh) structure, which is an opaque data blob to the enforcer.
