...
A pointer to a pointer to a [**NetworkSoHRequest**](/windows/win32/NapTypes/ns-naptypes-tagnetworksoh?branch=master) structure, which is an opaque data blob to the enforcer.
