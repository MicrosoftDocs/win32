...
keywords: ["GetConfigID method NAP", "GetConfigID method NAP , INapSystemHealthValidationRequest2 interface", "INapSystemHealthValidationRequest2 interface NAP , GetConfigID method"]
topic_type:
- apiref
api_name:
