...
keywords: ["INapSystemHealthValidator interface NAP", "INapSystemHealthValidator interface NAP , described"]
topic_type:
- apiref
api_name:
...
| Method                                                                                   | Description                                                                                                                               |
|:-----------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| [**INapSystemHealthValidator::Validate**](inapsystemhealthvalidator-validate-method.md) | The NAP system calls this application defined method to validate the [**SoHRequest**](soh-struct.md) received from a client. <br/> |
