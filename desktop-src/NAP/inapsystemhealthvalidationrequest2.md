---
title: INapSystemHealthValidationRequest2 interface
...
keywords: ["INapSystemHealthValidationRequest2 interface NAP", "INapSystemHealthValidationRequest2 interface NAP , described"]
topic_type:
- apiref
api_name:
