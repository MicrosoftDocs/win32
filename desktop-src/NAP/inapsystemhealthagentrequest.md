...
| [**INapSystemHealthAgentRequest::GetCorrelationId**](inapsystemhealthagentrequest-getcorrelationid-method.md)             | Used by system health agents to correlate SoHs and [**SoHResponse**](/windows/desktop/api/NapTypes/ns-naptypes-tagsoh).<br/> |
...
| [**INapSystemHealthAgentRequest::GetSoHResponse**](inapsystemhealthagentrequest-getsohresponse-method.md)                 | Used by the health agent to retrieve their [**SoHResponse**](/windows/desktop/api/NapTypes/ns-naptypes-tagsoh).<br/>         |
