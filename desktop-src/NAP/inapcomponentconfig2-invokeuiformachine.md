...
keywords: ["InvokeUIForMachine method NAP", "InvokeUIForMachine method NAP , INapComponentConfig2 interface", "INapComponentConfig2 interface NAP , InvokeUIForMachine method"]
topic_type:
- apiref
api_name:
...
A pointer to a [**CountedString**](countedstring-struct.md) that contains the machine name of the NAP client.
