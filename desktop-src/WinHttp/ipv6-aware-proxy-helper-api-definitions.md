...
The following functions are extensions to the [Navigator Proxy Auto-Config (PAC) File Format specification](http://go.microsoft.com/fwlink/p/?linkid=84541) to enable WPAD scripts to handle IPv6 capable networks.
