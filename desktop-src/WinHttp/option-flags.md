...
The following option flags are supported by [**WinHttpQueryOption**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryoption?branch=master) and [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master).
...
Retrieves the pointer to the callback function set with [**WinHttpSetStatusCallback**](/windows/win32/Winhttp/nf-winhttp-winhttpsetstatuscallback?branch=master).
...
When the server requests a client certificate, [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master), or [**WinHttpReceiveResponse**](/windows/win32/Winhttp/nf-winhttp-winhttpreceiveresponse?branch=master) returns an [**ERROR\_WINHTTP\_CLIENT\_AUTH\_CERT\_NEEDED**](error-messages.md#error-winhttp-client-auth-cert-needed) error. If the server requests the certificate but does not require it, the application can specify this option to indicate that it does not have a certificate. The server can choose another authentication scheme or allow anonymous access to the server. The application provides the **WINHTTP\_NO\_CLIENT\_CERT\_CONTEXT** macro in the *lpBuffer* parameter of [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master) as shown in the following code example.
...
Retrieves a [**SecPkgContext\_IssuerListInfoEx**](https://msdn.microsoft.com/library/windows/desktop/aa380078) structure when the error from [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master) or [**WinHttpReceiveResponse**](/windows/win32/Winhttp/nf-winhttp-winhttpreceiveresponse?branch=master) is **ERROR\_WINHTTP\_CLIENT\_AUTH\_CERT\_NEEDED**. The issuer list in the structure contains a list of acceptable Certificate Authorities (CA) from the server. The client application can filter the CA list to retrieve the client certificate for SSL authentication.

Alternately, if the server requests the client certificate, but does not require it, the application can call [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master) with the **WINHTTP\_OPTION\_CLIENT\_CERT\_CONTEXT** option. For more information, see the **WINHTTP\_OPTION\_CLIENT\_CERT\_CONTEXT** option.
...
Retrieves the source and destination IP address, and port of the request that generated the response when [**WinHttpReceiveResponse**](/windows/win32/Winhttp/nf-winhttp-winhttpreceiveresponse?branch=master) returns. The application calls [**WinHttpQueryOption**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryoption?branch=master) with the **WINHTTP\_OPTION\_CONNECTION\_INFO** option, and provides the [**WINHTTP\_CONNECTION\_INFO**](/windows/win32/Winhttp/ns-winhttp-winhttp_connection_info?branch=master) structure in the *lpBuffer* parameter. For more information, see **WINHTTP\_CONNECTION\_INFO**.
...
Sets an unsigned long integer value that specifies which features are disabled with one or more of the following flags. Be aware that this feature should only be passed to [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master) on request handles after the request handle is created with [**WinHttpOpenRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpopenrequest?branch=master), and before the request is sent with [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master).
...
Automatic redirection is disabled when sending requests with [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master). If automatic redirection is disabled, an application must register a callback function in order for Passport authentication to succeed.
...
Sets or retrieves an [**HTTP\_VERSION\_INFO**](/windows/win32/Winhttp/ns-winhttp-__unnamed_struct_1?branch=master) structure that contains the HTTP version being supported. This is a process-wide option; use **NULL** for the handle.
...
Sets or retrieves an [**WINHTTP\_PROXY\_INFO**](/windows/win32/Winhttp/ns-winhttp-__unnamed_struct_3?branch=master) structure that contains the proxy data on an existing session handle or request handle. When retrieving proxy data, an application must free the **lpszProxy** and **lpszProxyBypass** strings contained in this structure (if they are non-**NULL**) using the [**GlobalFree**](https://msdn.microsoft.com/library/windows/desktop/aa366579) function. An application can query for the global proxy data (the default proxy) by passing a **NULL** handle.
...
Gets the proxy Server Principal Name that WinHTTP supplied to SSPI during authentication. This string value is usefor passing to [**SspiPromptForCredentials**](https://msdn.microsoft.com/library/windows/desktop/dd401714) after an authentication failure.
...
Retrieves the certificate for a SSL/TLS server into the [**WINHTTP\_CERTIFICATE\_INFO**](/windows/win32/Winhttp/ns-winhttp-__unnamed_struct_5?branch=master) structure. The application must free the **lpszSubjectInfo** and **lpszIssuerInfo** members with [**LocalFree**](https://msdn.microsoft.com/library/windows/desktop/aa366730).
...
Uses secure transfers. This is only returned in a call to [**WinHttpQueryOption**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryoption?branch=master).
...
Uses medium (56-bit) encryption. This is only returned in a call to [**WinHttpQueryOption**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryoption?branch=master).
...
Uses strong (128-bit) encryption. This is only returned in a call to [**WinHttpQueryOption**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryoption?branch=master).
...
Uses weak (40-bit) encryption. This is only returned in a call to [**WinHttpQueryOption**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryoption?branch=master).
...
Gets a pointer to [**SecPkgContext\_Bindings**](https://msdn.microsoft.com/library/windows/desktop/dd919960) structure that specifies a Channel Binding Token (CBT).
...
Retrieves the server certification context. **WINHTTP\_OPTION\_SERVER\_CERT\_CONTEXT** can be passed to obtain a duplicated pointer to the [**CERT CONTEXT**](https://msdn.microsoft.com/library/windows/desktop/aa377189) for a server certificate received during a negotiated SSL connection. The client must call [**CertFreeCertificateContext**](https://msdn.microsoft.com/library/windows/desktop/aa376075) on the returned PCCERT\_CONTEXT pointer that is filled into the buffer.
...
Gets the server Server Principal Name that WinHTTP supplied to SSPI during authentication. This string value can be passed to [**SspiPromptForCredentials**](https://msdn.microsoft.com/library/windows/desktop/dd401714) after an authentication failure.
...
Instructs the stack to start a WebSocket handshake process with [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master). This option takes no parameters.
...
Sets or retrieves the [*user agent*](glossary.md#term-user-agent) string on handles supplied by [**WinHttpOpen**](/windows/win32/Winhttp/nf-winhttp-winhttpopen?branch=master) and used in subsequent [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master) functions, as long as it is not overridden by a header added by [**WinHttpAddRequestHeaders**](/windows/win32/Winhttp/nf-winhttp-winhttpaddrequestheaders?branch=master) or **WinHttpSendRequest**. When retrieving a user agent, the application should pass in a buffer, sized in bytes, that is big enough to hold the returned URL in wide char. When setting the user agent, the buffer size is the length of the string, in characters, plus the **NULL** terminator.
...
Sets the time, in milliseconds, that [**WinHttpWebSocketClose**](/windows/win32/winhttp/nf-winhttp-winhttpwebsocketclose?branch=master) should wait to complete the close handshake. The default is 10 seconds.
...
Sets the interval, in milliseconds, to send a keep-alive packet over the connection. The default interval is 30000 (30 seconds). The minimum interval is 15000 (15 seconds). Using [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master) to set a value lower than 15000 will return with **ERROR\_INVALID\_PARAMETER**.
...
| WINHTTP\_OPTION\_CLIENT\_CERT\_CONTEXT             | \-             | X              | \-           | X          | [**CERT\_CONTEXT**](https://msdn.microsoft.com/library/windows/desktop/aa377189)                                       |
...
| WINHTTP\_OPTION\_CONNECT\_INFO                     | \-             | X              | X            | \-         | [**WINHTTP\_CONNECTION\_INFO**](/windows/win32/Winhttp/ns-winhttp-winhttp_connection_info?branch=master)                     |
...
| WINHTTP\_OPTION\_GLOBAL\_PROXY\_CREDS              | X              | X              | \-           | X          | [**WINHTTP\_CREDS**](/windows/win32/Winhttp/ns-winhttp-tagwinhttp_creds?branch=master)                                          |
| WINHTTP\_OPTION\_GLOBAL\_SERVER\_CREDS             | X              | X              | \-           | X          | [**WINHTTP\_CREDS\_EX**](/windows/win32/Winhttp/ns-winhttp-tagwinhttp_creds_ex?branch=master)                                   |
| WINHTTP\_OPTION\_HANDLE\_TYPE                      | X              | X              | X            | \-         | **DWORD**                                                                        |
| WINHTTP\_OPTION\_HTTP\_VERSION                     | X              | X              | X            | X          | [**HTTP\_VERSION\_INFO**](/windows/win32/Winhttp/ns-winhttp-__unnamed_struct_1?branch=master)                                 |
...
| WINHTTP\_OPTION\_PROXY                             | X              | X              | X            | X          | [**WINHTTP\_PROXY\_INFO**](/windows/win32/Winhttp/ns-winhttp-__unnamed_struct_3?branch=master)                              |
...
| WINHTTP\_OPTION\_SECURITY\_CERTIFICATE\_STRUCT     | \-             | X              | X            | \-         | [**WINHTTP\_CERTIFICATE\_INFO**](/windows/win32/Winhttp/ns-winhttp-__unnamed_struct_5?branch=master)                  |
...
| WINHTTP\_OPTION\_SERVER\_CBT                       | \-             | X              | X            | \-         | [**SecPkgContext\_Bindings**](https://msdn.microsoft.com/library/windows/desktop/dd919960)\*                 |
| WINHTTP\_OPTION\_SERVER\_CERT\_CONTEXT             | \-             | X              | X            | \-         | [**CERT CONTEXT**](https://msdn.microsoft.com/library/windows/desktop/aa377189)                                        |
