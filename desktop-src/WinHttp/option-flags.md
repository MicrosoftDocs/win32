...
Retrieves the certificate for a SSL/TLS server into the [**WINHTTP\_CERTIFICATE\_INFO**](internet-certificate-info.md) structure. The application must free the **lpszSubjectInfo** and **lpszIssuerInfo** members with [**LocalFree**](https://msdn.microsoft.com/library/windows/desktop/aa366730).
...
| WINHTTP\_OPTION\_PROXY                             | X              | X              | X            | X          | [**WINHTTP\_PROXY\_INFO**](internet-proxy-info.md)                              |
...
| WINHTTP\_OPTION\_SECURITY\_CERTIFICATE\_STRUCT     | \-             | X              | X            | \-         | [**WINHTTP\_CERTIFICATE\_INFO**](internet-certificate-info.md)                  |
