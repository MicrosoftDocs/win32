...
The [**WinHttpCrackUrl**](winhttpcrackurl.md) function separates a URL into its component parts and returns the components indicated by the [**URL\_COMPONENTS**](/windows/desktop/api/Winhttp/ns-winhttp-__unnamed_struct_2) structure that is passed to the function.
...
The [**WinHttpCreateUrl**](winhttpcreateurl.md) function uses the information in the previously described [**URL\_COMPONENTS**](/windows/desktop/api/Winhttp/ns-winhttp-__unnamed_struct_2) structure to create a URL.
