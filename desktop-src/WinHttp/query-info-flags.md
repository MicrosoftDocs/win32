...
Retrieves an MD5 digest of the entity body for the purpose of providing an end-to-end message integrity check for the entity body. For more information, see [RFC 1864](Http://go.microsoft.com/fwlink/p/?linkid=84555).
