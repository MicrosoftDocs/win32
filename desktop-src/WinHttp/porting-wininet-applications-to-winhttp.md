...
|------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**HttpAddRequestHeaders**](https://msdn.microsoft.com/library/windows/desktop/aa384227)             | [**WinHttpAddRequestHeaders**](/windows/win32/Winhttp/nf-winhttp-winhttpaddrequestheaders?branch=master)                                                                                                                                           | None.                                                                                                                                                                                                                                                                                                                                |
| [**HttpEndRequest**](https://msdn.microsoft.com/library/windows/desktop/aa384230)                           | [**WinHttpReceiveResponse**](/windows/win32/Winhttp/nf-winhttp-winhttpreceiveresponse?branch=master)                                                                                                                                               | The context value is set with [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master) or [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master). Request options are set with [**WinHttpOpenRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpopenrequest?branch=master). [**WinHttpReceiveResponse**](/windows/win32/Winhttp/nf-winhttp-winhttpreceiveresponse?branch=master) must be called after sending a request.                      |
| [**HttpOpenRequest**](https://msdn.microsoft.com/library/windows/desktop/aa384233)                         | [**WinHttpOpenRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpopenrequest?branch=master)                                                                                                                                                       | The context value is set with [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master) or [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master).                                                                                                                                                                                                      |
| [**HttpQueryInfo**](https://msdn.microsoft.com/library/windows/desktop/aa384238)                             | [**WinHttpQueryHeaders**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryheaders?branch=master)                                                                                                                                                     | None.                                                                                                                                                                                                                                                                                                                                |
| [**HttpSendRequest**](https://msdn.microsoft.com/library/windows/desktop/aa384247)                         | [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master)                                                                                                                                                       | The context value can be set with [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master).                                                                                                                                                                                                                                                  |
| [**HttpSendRequestEx**](https://msdn.microsoft.com/library/windows/desktop/aa384318)                     | [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master)                                                                                                                                                       | Buffers cannot be provided.                                                                                                                                                                                                                                                                                                          |
| [**InternetCanonicalizeUrl**](https://msdn.microsoft.com/library/windows/desktop/aa384342)         | No equivalent                                                                                                                                                                                          | URLs are now put in canonical form in [**WinHttpOpenRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpopenrequest?branch=master).                                                                                                                                                                                                                                              |
...
| [**InternetCloseHandle**](https://msdn.microsoft.com/library/windows/desktop/aa384350)                 | [**WinHttpCloseHandle**](/windows/win32/Winhttp/nf-winhttp-winhttpclosehandle?branch=master)                                                                                                                                                       | Closing a parent handle in WinHTTP does not recursively close child handles.                                                                                                                                                                                                                                                         |
| [**InternetCombineUrl**](https://msdn.microsoft.com/library/windows/desktop/aa384355)                   | No equivalent                                                                                                                                                                                          | URLs can be assembled with the [**WinHttpCreateUrl**](/windows/win32/Winhttp/nf-winhttp-winhttpcreateurl?branch=master) function.                                                                                                                                                                                                                                                |
...
| [**InternetConnect**](https://msdn.microsoft.com/library/windows/desktop/aa384363)                         | [**WinHttpConnect**](/windows/win32/Winhttp/nf-winhttp-winhttpconnect?branch=master)                                                                                                                                                               | The context value is set with [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master) or [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master). Request options are set with [**WinHttpOpenRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpopenrequest?branch=master). User credentials are set with [**WinHttpSetCredentials**](/windows/win32/Winhttp/nf-winhttp-winhttpsetcredentials?branch=master).                                 |
| [**InternetCrackUrl**](https://msdn.microsoft.com/library/windows/desktop/aa384376)                       | [**WinHttpCrackUrl**](/windows/win32/Winhttp/nf-winhttp-winhttpcrackurl?branch=master)                                                                                                                                                             | Opposite behavior of the ICU\_ESCAPE flag: with [**InternetCrackUrl**](https://msdn.microsoft.com/library/windows/desktop/aa384376), this flag causes escape sequences (%xx) to be converted to characters, but with [**WinHttpCrackUrl**](/windows/win32/Winhttp/nf-winhttp-winhttpcrackurl?branch=master), it causes characters that must be escaped from in an HTTP request to be converted to escape sequences. |
| [**InternetCreateUrl**](https://msdn.microsoft.com/library/windows/desktop/aa384473)                     | [**WinHttpCreateUrl**](/windows/win32/Winhttp/nf-winhttp-winhttpcreateurl?branch=master)                                                                                                                                                           | None.                                                                                                                                                                                                                                                                                                                                |
...
| [**InternetOpen**](https://msdn.microsoft.com/library/windows/desktop/aa385096)                               | [**WinHttpOpen**](/windows/win32/Winhttp/nf-winhttp-winhttpopen?branch=master)                                                                                                                                                                     | None.                                                                                                                                                                                                                                                                                                                                |
| [**InternetOpenUrl**](https://msdn.microsoft.com/library/windows/desktop/aa385098)                         | [**WinHttpConnect**](/windows/win32/Winhttp/nf-winhttp-winhttpconnect?branch=master), [**WinHttpOpenRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpopenrequest?branch=master), [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master), [**WinHttpReceiveResponse**](/windows/win32/Winhttp/nf-winhttp-winhttpreceiveresponse?branch=master) | This functionality is available in the WinHTTP functions listed.                                                                                                                                                                                                                                                                     |
| [**InternetQueryDataAvailable**](https://msdn.microsoft.com/library/windows/desktop/aa385100)   | [**WinHttpQueryDataAvailable**](/windows/win32/Winhttp/nf-winhttp-winhttpquerydataavailable?branch=master)                                                                                                                                         | No reserved parameters.                                                                                                                                                                                                                                                                                                              |
| [**InternetQueryOption**](https://msdn.microsoft.com/library/windows/desktop/aa385101)                 | [**WinHttpQueryOption**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryoption?branch=master)                                                                                                                                                       | WinHTTP offers a different set of options from WinINet. For more information and options offered by WinHTTP, see [**Option Flags**](option-flags.md).                                                                                                                                                                               |
| [**InternetReadFile**](https://msdn.microsoft.com/library/windows/desktop/aa385103)                       | [**WinHttpReadData**](/windows/win32/Winhttp/nf-winhttp-winhttpreaddata?branch=master)                                                                                                                                                             | None.                                                                                                                                                                                                                                                                                                                                |
| [**InternetReadFileEx**](https://msdn.microsoft.com/library/windows/desktop/aa385105)                   | [**WinHttpReadData**](/windows/win32/Winhttp/nf-winhttp-winhttpreaddata?branch=master)                                                                                                                                                             | Rather than a structure, the buffer is a region of memory addressed with a pointer.                                                                                                                                                                                                                                                  |
| [**InternetSetOption**](https://msdn.microsoft.com/library/windows/desktop/aa385114)                     | [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master)                                                                                                                                                           | None.                                                                                                                                                                                                                                                                                                                                |
| [**InternetSetStatusCallback**](https://msdn.microsoft.com/library/windows/desktop/aa385120)     | [**WinHttpSetStatusCallback**](/windows/win32/Winhttp/nf-winhttp-winhttpsetstatuscallback?branch=master)                                                                                                                                           | For more information, see "Different Handling of Asynchronous Requests" in this topic.                                                                                                                                                                                                                                               |
| [**InternetTimeFromSystemTime**](https://msdn.microsoft.com/library/windows/desktop/aa385123)   | [**WinHttpTimeFromSystemTime**](/windows/win32/Winhttp/nf-winhttp-winhttptimefromsystemtime?branch=master)                                                                                                                                         | None.                                                                                                                                                                                                                                                                                                                                |
| [**InternetTimeToSystemTime**](https://msdn.microsoft.com/library/windows/desktop/aa385125)       | [**WinHttpTimeToSystemTime**](/windows/win32/Winhttp/nf-winhttp-winhttptimetosystemtime?branch=master)                                                                                                                                             | None.                                                                                                                                                                                                                                                                                                                                |
| [**InternetWriteFile**](https://msdn.microsoft.com/library/windows/desktop/aa385128)                     | [**WinHttpWriteData**](/windows/win32/Winhttp/nf-winhttp-winhttpwritedata?branch=master)                                                                                                                                                           | None.                                                                                                                                                                                                                                                                                                                                |
...
The status callback function receives updates on the status of operations through notification flags. In WinHTTP, notifications are selected using the *dwNotificationFlags* parameter of the [**WinHttpSetStatusCallback**](/windows/win32/Winhttp/nf-winhttp-winhttpsetstatuscallback?branch=master) function. Use the **WINHTTP\_CALLBACK\_FLAG\_ALL\_NOTIFICATIONS** flag to be notified of all status updates.

Notifications that indicate a particular operation is complete are called completion notifications, or just completions. In WinINet, each time the callback function receives a completion, the *lpvStatusInformation* parameter contains an [**INTERNET\_ASYNC\_RESULT**](https://msdn.microsoft.com/library/windows/desktop/aa385129) structure. In WinHTTP, this structure is not available for all completions. It is important to review the reference page for [**WINHTTP\_STATUS\_CALLBACK**](/windows/win32/Winhttp/nc-winhttp-winhttp_status_callback?branch=master), which contains information about notifications and what type of data can be expected for each.
...
For compatibility, user credentials can similarly be set in WinHTTP using the [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master) function, but this is not recommended because it can pose a security vulnerability.

Instead, when an application receives a 401 status code in WinHTTP, the recommended method of setting credentials is first to identify an authentication scheme using [**WinHttpQueryAuthSchemes**](/windows/win32/Winhttp/nf-winhttp-winhttpqueryauthschemes?branch=master) and, second, set the credentials using [**WinHttpSetCredentials**](/windows/win32/Winhttp/nf-winhttp-winhttpsetcredentials?branch=master). The following code example shows how to do this.
...
WinHTTP does not rely on Internet Explorer settings to determine the automatic logon policy. Instead, the auto-logon policy is set with [**WinHttpSetOption**](/windows/win32/Winhttp/nf-winhttp-winhttpsetoption?branch=master). For more information about authentication in WinHTTP, including the auto-logon policy, see [Authentication in WinHTTP](authentication-in-winhttp.md).

## Differences in Secure HTTP Transactions

In WinINet, initiate a secure session using either [**HttpOpenRequest**](https://msdn.microsoft.com/library/windows/desktop/aa384233) or [**InternetConnect**](https://msdn.microsoft.com/library/windows/desktop/aa384363), but in WinHTTP, you must call [**WinHttpOpenRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpopenrequest?branch=master) using the **WINHTTP\_FLAG\_SECURE** flag.
...
-   Starting with WinHttp 5.1, if a server certificate fails or contains errors, the call to [**WinHttpSendRequest**](/windows/win32/Winhttp/nf-winhttp-winhttpsendrequest?branch=master) reports a **WINHTTP\_CALLBACK\_STATUS\_SECURE\_FAILURE** in the callback function. If the error generated by **WinHttpSendRequest** is ignored, subsequent calls to [**WinHttpReceiveResponse**](/windows/win32/Winhttp/nf-winhttp-winhttpreceiveresponse?branch=master) fail with an ERROR\_WINHTTP\_OPERATION\_CANCELLED error.
