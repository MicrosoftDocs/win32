...
The response to the request can be found under a different URI and should be retrieved using a GET [*HTTP verb*](https://www.bing.com/search?q=*HTTP verb*) on that resource.
...
The redirected request keeps the same [*HTTP verb*](https://www.bing.com/search?q=*HTTP verb*). HTTP/1.1 behavior.
...
The [*HTTP verb*](https://www.bing.com/search?q=*HTTP verb*) used is not allowed.
