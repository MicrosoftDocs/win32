...
For detailed information on HTTP transactions and the HTTP protocol, see [RFC 2616](Http://go.microsoft.com/fwlink/p/?linkid=84048), Hypertext Transfer Protocol — HTTP/1.1.
...
WinHTTP functions support both server and proxy authentication for HTTP sessions. WinHTTP supports the following authentication schemes: Basic, Digest (see [RFC 2617](Http://go.microsoft.com/fwlink/p/?linkid=84049)), [NTLM Authentication](https://msdn.microsoft.com/windows/desktop/ae434165-4429-4ef0-b083-60abdfc50de0), Negotiate/ [Kerberos](https://msdn.microsoft.com/windows/desktop/a53a1edf-f374-4cbf-8050-7cde45284157), and Microsoft Passport 1.4. For detailed information on authentication, as well as an example of using authentication in a Microsoft Visual C++ application, see [Authentication in WinHTTP](authentication-in-winhttp.md).
