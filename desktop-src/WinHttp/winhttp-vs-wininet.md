...
With a few exceptions, [WinINet](https://msdn.microsoft.com/library/windows/desktop/aa385331) is a superset of [WinHTTP](winhttp-start-page.md). When selecting between the two, you should use WinINet, unless you plan to run within a service or service-like process that requires impersonation and session isolation.
...
| **Decompression Support**<br/> Support for gzip and deflate compression scheme.<br/>                                                                                                                                                                                                                   | yes<br/> | yes<br/> |
...
[WinINet](https://msdn.microsoft.com/library/windows/desktop/aa385331)
</dt> <dt>

[WinHTTP](winhttp-start-page.md)
</dt> </dl>
