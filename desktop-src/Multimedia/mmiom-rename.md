...
The **MMIOM\_RENAME** message is sent to an I/O procedure by the [**mmioRename**](mmiorename.md) function to request that the specified file be renamed.
...
If the file is renamed successfully, the return value is zero. If the specified file was not found, the return value is MMIOERR\_FILENOTFOUND.
