...
keywords: ["DrawDib,device context (DC)", "DrawDib,drawing DCs", "DrawDibRealize function"]
---

# Drawing a Display Context

The following example prepares a DrawDib DC by using the [**DrawDibRealize**](drawdibrealize.md) function prior to displaying several images in a bitmap sequence.
