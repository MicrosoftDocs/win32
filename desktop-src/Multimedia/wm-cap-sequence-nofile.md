...
The **WM\_CAP\_SEQUENCE\_NOFILE** message initiates streaming video capture without writing data to a file. You can send this message explicitly or by using the [**capCaptureSequenceNoFile**](/windows/win32/Vfw/nf-vfw-capcapturesequencenofile?branch=master) macro.
