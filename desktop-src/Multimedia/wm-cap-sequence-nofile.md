---
title: WM\_CAP\_SEQUENCE\_NOFILE message
...
keywords: ["WM_CAP_SEQUENCE_NOFILE message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_SEQUENCE\_NOFILE** message initiates streaming video capture without writing data to a file. You can send this message explicitly or by using the [**capCaptureSequenceNoFile**](capcapturesequencenofile.md) macro.
