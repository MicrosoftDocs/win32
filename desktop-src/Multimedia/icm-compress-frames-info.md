...
keywords: ["ICM_COMPRESS_FRAMES_INFO message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
Pointer to an [**ICCOMPRESSFRAMES**](iccompressframes.md) structure. The **GetData** and **PutData** members of this structure are not used with this message.
...
Size, in bytes, of [**ICCOMPRESSFRAMES**](iccompressframes.md).
