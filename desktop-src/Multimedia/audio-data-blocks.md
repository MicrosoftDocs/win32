...
The [**waveInAddBuffer**](https://www.bing.com/search?q=**waveInAddBuffer**) and [**waveOutWrite**](https://www.bing.com/search?q=**waveOutWrite**) functions require applications to allocate data blocks to pass to the device drivers for recording or playback purposes. Both of these functions use the [**WAVEHDR**](https://www.bing.com/search?q=**WAVEHDR**) structure to describe its data block.
...
|----------------------------------------------------------|------------------------------------------------------------------|
| [**waveInPrepareHeader**](https://www.bing.com/search?q=**waveInPrepareHeader**)       | Prepares a waveform-audio input data block.                      |
| [**waveInUnprepareHeader**](https://www.bing.com/search?q=**waveInUnprepareHeader**)   | Cleans up the preparation on a waveform-audio input data block.  |
| [**waveOutPrepareHeader**](https://www.bing.com/search?q=**waveOutPrepareHeader**)     | Prepares a waveform-audio output data block.                     |
| [**waveOutUnprepareHeader**](https://www.bing.com/search?q=**waveOutUnprepareHeader**) | Cleans up the preparation on a waveform-audio output data block. |



 

Before you pass an audio data block to a device driver, you must prepare the data block by passing it to either [**waveInPrepareHeader**](https://www.bing.com/search?q=**waveInPrepareHeader**) or [**waveOutPrepareHeader**](https://www.bing.com/search?q=**waveOutPrepareHeader**). When the device driver is finished with the data block and returns it, you must clean up this preparation by passing the data block to either [**waveInUnprepareHeader**](https://www.bing.com/search?q=**waveInUnprepareHeader**) or [**waveOutUnprepareHeader**](https://www.bing.com/search?q=**waveOutUnprepareHeader**) before any allocated memory can be freed.
...
-   By polling the WHDR\_DONE bit in the **dwFlags** member of the [**WAVEHDR**](https://www.bing.com/search?q=**WAVEHDR**) structure sent with each data block
