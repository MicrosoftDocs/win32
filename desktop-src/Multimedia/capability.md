...
Returns information in the *lpszReturnString* parameter of the [**mciSendString**](/windows/desktop/api/Mmsystem/) function. The information is dependent on the request type.
