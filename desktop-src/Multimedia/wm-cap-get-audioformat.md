...
Pointer to a [**WAVEFORMATEX**](/windows/desktop/api/Mmreg/) structure, or **NULL**. If the value is **NULL**, the size, in bytes, required to hold the structure is returned.
