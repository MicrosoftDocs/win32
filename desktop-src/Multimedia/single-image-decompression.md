...
You can use the [**ICImageDecompress**](/windows/win32/Vfw/nf-vfw-icimagedecompress?branch=master) function to decompress a single image. This function returns a handle of the decompressed DIB. The decompressed DIB is stored in the CF\_DIB format.
