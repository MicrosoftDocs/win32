---
title: WM\_CAP\_SET\_CALLBACK\_FRAME message
...
The **WM\_CAP\_SET\_CALLBACK\_FRAME** message sets a preview callback function in the application. AVICap calls this procedure when the capture window captures preview frames. You can send this message explicitly or by using the [**capSetCallbackOnFrame**](/windows/win32/Vfw/nf-vfw-capsetcallbackonframe?branch=master) macro.
...
Pointer to the preview callback function, of type [**capVideoStreamCallback**](/windows/win32/Vfw/nc-vfw-capvideocallback?branch=master). Specify **NULL** for this parameter to disable a previously installed callback function.
