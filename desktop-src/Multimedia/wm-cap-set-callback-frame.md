...
keywords: ["WM_CAP_SET_CALLBACK_FRAME message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_SET\_CALLBACK\_FRAME** message sets a preview callback function in the application. AVICap calls this procedure when the capture window captures preview frames. You can send this message explicitly or by using the [**capSetCallbackOnFrame**](capsetcallbackonframe.md) macro.
...
Pointer to the preview callback function, of type [**capVideoStreamCallback**](capvideostreamcallback.md). Specify **NULL** for this parameter to disable a previously installed callback function.
