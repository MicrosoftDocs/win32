...
You use installable drivers to give applications or DLLs a standard way to access a device or a set of useful routines. The following sections show how to create an installable driver by using a [DriverProc](https://www.bing.com/search?q=DriverProc) function and how to open an installable driver and direct it to carry out useful tasks.
