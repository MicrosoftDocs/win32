...
The following example uses the [**midiOutShortMsg**](https://msdn.microsoft.com/library/Dd798481(v=VS.85).aspx) function to send a specified MIDI event to a given MIDI output device:
