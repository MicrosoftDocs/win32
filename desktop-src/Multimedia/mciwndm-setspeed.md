...
keywords: ["MCIWNDM_SETSPEED message Windows Multimedia"]
topic_type:
- apiref
api_name:
- MCIWNDM_SETSPEED
...
The **MCIWNDM\_SETSPEED** message sets the playback speed of an MCI device. You can send this message explicitly or by using the [**MCIWndSetSpeed**](mciwndsetspeed.md) macro.
