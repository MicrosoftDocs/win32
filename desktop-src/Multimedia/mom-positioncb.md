...
A pointer to a [**MIDIHDR**](midihdr.md) structure identifying the input buffer.
...
If position callbacks are being generated more quickly than your application can process them, the **dwOffset** member of the [**MIDIHDR**](midihdr.md) structure might refer to an event your application has not yet processed.
