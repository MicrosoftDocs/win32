...
keywords: ["capGetDriverDescription function"]
---

# Enumerating Installed Capture Drivers

The following example uses the [**capGetDriverDescription**](capgetdriverdescription.md) function to obtain the names and versions of the installed capture drivers.
