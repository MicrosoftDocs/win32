...
The **MMIOM\_WRITEFLUSH** message is sent to an I/O procedure by the [**mmioWrite**](https://www.bing.com/search?q=**mmioWrite**) function to request that data be written to an open file and that any internal buffers used by the I/O procedure be flushed to disk.
