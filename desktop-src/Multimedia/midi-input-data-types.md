...
| [**MIDIHDR**](https://www.bing.com/search?q=**MIDIHDR**)       | Header for a stream buffer or a block of MIDI system-exclusive data. For input applications, this structure records only system-exclusive data (streaming is not supported for MIDI input). |
| [**MIDIINCAPS**](https://www.bing.com/search?q=**MIDIINCAPS**) | Structure used to inquire about the capabilities of a MIDI input device.                                                                                                                    |
