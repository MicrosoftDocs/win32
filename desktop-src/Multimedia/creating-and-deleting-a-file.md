...
To create a file, set the *dwOpenFlags* parameter of the [**mmioOpen**](mmioopen.md) function to MMIO\_CREATE. The following example creates a file and opens it for reading and writing.
