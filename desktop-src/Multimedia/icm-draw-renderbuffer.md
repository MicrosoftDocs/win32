...
keywords: ["ICM_DRAW_RENDERBUFFER message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **ICM\_DRAW\_RENDERBUFFER** message notifies a rendering driver to draw the frames that have been passed to it. You can send this message explicitly or by using the [**ICDrawRenderBuffer**](icdrawrenderbuffer.md) macro.
