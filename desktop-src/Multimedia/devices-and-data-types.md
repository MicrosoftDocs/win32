...
Use the [**waveOutOpen**](waveoutopen.md) function to open a waveform-audio output device for playback. This function opens the device associated with the specified device identifier and returns a handle of the open device by writing the handle of a specified memory location.
...
|------------------------------------------------|------------------------------------------------------------------------------|
| [**auxGetNumDevs**](auxgetnumdevs.md)         | Retrieves the number of auxiliary output devices present in the system.      |
| [**waveInGetNumDevs**](waveingetnumdevs.md)   | Retrieves the number of waveform-audio input devices present in the system.  |
| [**waveOutGetNumDevs**](waveoutgetnumdevs.md) | Retrieves the number of waveform-audio output devices present in the system. |
...
| Function                                       | Description                                                             |
|------------------------------------------------|-------------------------------------------------------------------------|
| [**auxGetDevCaps**](auxgetdevcaps.md)         | Retrieves the capabilities of a specified auxiliary output device.      |
| [**waveInGetDevCaps**](waveingetdevcaps.md)   | Retrieves the capabilities of a specified waveform-audio input device.  |
| [**waveOutGetDevCaps**](waveoutgetdevcaps.md) | Retrieves the capabilities of a specified waveform-audio output device. |
...
|------------------------------------------------|------------------------------------|
| Function                                       | Structure                          |
| [**auxGetDevCaps**](auxgetdevcaps.md)         | [**AUXCAPS**](auxcaps.md)         |
| [**waveInGetDevCaps**](waveingetdevcaps.md)   | [**WAVEINCAPS**](waveincaps.md)   |
| [**waveOutGetDevCaps**](waveoutgetdevcaps.md) | [**WAVEOUTCAPS**](waveoutcaps.md) |
...
-   Device identifiers are determined implicitly from the number of devices present in a system. This number is obtained by using the [**auxGetNumDevs**](auxgetnumdevs.md), [**waveInGetNumDevs**](waveingetnumdevs.md), or [**waveOutGetNumDevs**](waveoutgetnumdevs.md) function.
-   Device handles are returned when device drivers are opened by using the [**waveInOpen**](waveinopen.md) or [**waveOutOpen**](waveoutopen.md) function.
...
After waveform-audio playback is complete, call [**waveOutClose**](waveoutclose.md) to close the output device. If **waveOutClose** is called while a waveform-audio file is playing, the close operation fails and the function returns an error code indicating that the device was not closed. If you do not want to wait for playback to end before closing the device, call the [**waveOutReset**](waveoutreset.md) function before closing. This ends playback and allows the device to be closed. Be sure to use the [**waveOutUnprepareHeader**](waveoutunprepareheader.md) function to clean up the preparation on all data blocks before closing the device.
