...
keywords: ["MM_WOM_DONE message Windows Multimedia"]
topic_type:
- apiref
api_name:
- MM_WOM_DONE
...
The **MM\_WOM\_DONE** message is sent to a window when the given output buffer is being returned to the application. Buffers are returned to the application when they have been played, or as the result of a call to the [**waveOutReset**](waveoutreset.md) function.
...
Pointer to a [**WAVEHDR**](wavehdr.md) structure identifying the buffer.
