...
| Value                                  | Meaning                                                                                                                                                                  |
|----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**MM\_MOM\_CLOSE**](mm-mom-close.md) | Sent when the device is closed by using the [**midiOutClose**](midioutclose.md) function.                                                                               |
| [**MM\_MOM\_DONE**](mm-mom-done.md)   | Sent when the device driver is finished with a data block sent by using the [**midiOutLongMsg**](midioutlongmsg.md) or [**midiStreamOut**](midistreamout.md) function. |
| [**MM\_MOM\_OPEN**](mm-mom-open.md)   | Sent when the device is opened by using the [**midiOutOpen**](midioutopen.md) function.                                                                                 |



 

A *wParam* parameter and an *lParam* parameter are associated with each of these messages. The *wParam* parameter always specifies the handle of an open MIDI device. For [**MM\_MOM\_DONE**](mm-mom-done.md), *lParam* specifies an address of a [**MIDIHDR**](midihdr.md) structure identifying the completed data block. The *lParam* parameter is unused for [**MM\_MOM\_CLOSE**](mm-mom-close.md) and [**MM\_MOM\_OPEN**](mm-mom-open.md).
