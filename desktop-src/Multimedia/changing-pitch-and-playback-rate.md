...
|----------------------------------------------------------|-----------------------------------------------------------------------------|
| [**waveOutGetPitch**](waveoutgetpitch.md)               | Retrieves the pitch for the specified waveform-audio output device.         |
| [**waveOutGetPlaybackRate**](waveoutgetplaybackrate.md) | Retrieves the playback rate for the specified waveform-audio output device. |
| [**waveOutSetPitch**](waveoutsetpitch.md)               | Sets the pitch for the specified waveform-audio output device.              |
| [**waveOutSetPlaybackRate**](waveoutsetplaybackrate.md) | Sets the playback rate for the specified waveform-audio output device.      |
