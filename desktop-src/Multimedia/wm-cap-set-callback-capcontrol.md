...
The **WM\_CAP\_SET\_CALLBACK\_CAPCONTROL** message sets a callback function in the application giving it precise recording control. You can send this message explicitly or by using the [**capSetCallbackOnCapControl**](/windows/win32/Vfw/nf-vfw-capsetcallbackoncapcontrol?branch=master) macro.
...
Pointer to the callback function, of type [**capControlCallback**](/windows/win32/Vfw/nc-vfw-capcontrolcallback?branch=master). Specify **NULL** for this parameter to disable a previously installed callback function.
