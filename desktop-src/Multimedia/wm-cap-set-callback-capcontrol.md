...
keywords: ["WM_CAP_SET_CALLBACK_CAPCONTROL message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_SET\_CALLBACK\_CAPCONTROL** message sets a callback function in the application giving it precise recording control. You can send this message explicitly or by using the [**capSetCallbackOnCapControl**](capsetcallbackoncapcontrol.md) macro.
...
Pointer to the callback function, of type [**capControlCallback**](capcontrolcallback.md). Specify **NULL** for this parameter to disable a previously installed callback function.
