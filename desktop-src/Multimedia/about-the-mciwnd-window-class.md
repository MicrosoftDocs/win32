...
keywords: ["MCIWnd window class,about", "MCIWndCreate function"]
---

# About the MCIWnd Window Class

The MCIWnd Window class is easy to use. By using a single function, [**MCIWndCreate**](mciwndcreate.md) your application can create a control that plays any device that uses the media control interface (MCI). These devices include CD audio, waveform-audio, MIDI, and video devices.
