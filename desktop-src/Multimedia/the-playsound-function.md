...
You can use the [**PlaySound**](https://msdn.microsoft.com/library/Dd743680(v=VS.85).aspx) function to play waveform audio if the sound fits into available memory. (The [**sndPlaySound**](https://msdn.microsoft.com/library/Dd798676(v=VS.85).aspx) function offers a subset of the capabilities of PlaySound. To maximize the portability of your Win32-based application, use **PlaySound**, not **sndPlaySound**.)
...
The [**PlaySound**](https://msdn.microsoft.com/library/Dd743680(v=VS.85).aspx) function allows you to play a sound in a continuous loop, ending only when you call **PlaySound** again, specifying either **NULL** or the sound identifier of another sound for the *pszSound* parameter.
