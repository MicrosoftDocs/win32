...
The threshold is initially zero. You can set the movement threshold by using the [**joySetThreshold**](https://www.bing.com/search?q=**joySetThreshold**) function. You can retrieve the minimum polling frequency of the joystick by using the [**joyGetDevCaps**](https://www.bing.com/search?q=**joyGetDevCaps**) function.
