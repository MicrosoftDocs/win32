...
The **MMIOM\_OPEN** message is sent to an I/O procedure by the [**mmioOpen**](mmioopen.md) function to request that a file be opened or deleted.
...
The **dwFlags** member of the [**MMIOINFO**](mmioinfo.md) structure contains flags passed to the [**mmioOpen**](mmioopen.md) function.

The **lDiskOffset** member of the [**MMIOINFO**](mmioinfo.md) structure is initialized to zero. If this value is incorrect, the I/O procedure must correct it.

If the application passed an [**MMIOINFO**](mmioinfo.md) structure to [**mmioOpen**](mmioopen.md), the return value is returned in the **wErrorRet** member.
