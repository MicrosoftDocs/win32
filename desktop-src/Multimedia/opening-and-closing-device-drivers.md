...
| Value                                | Meaning                                            |
|--------------------------------------|----------------------------------------------------|
| [**midiInClose**](midiinclose.md)   | Closes a specified MIDI input device.              |
| [**midiInOpen**](midiinopen.md)     | Opens a specified MIDI input device for recording. |
| [**midiOutClose**](midioutclose.md) | Closes a specified MIDI output device.             |
| [**midiOutOpen**](midioutopen.md)   | Opens a MIDI output device for playback.           |
