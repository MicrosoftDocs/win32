...
The **WM\_CAP\_SET\_SCROLL** message defines the portion of the video frame to display in the capture window. This message sets the upper left corner of the client area of the capture window to the coordinates of a specified pixel within the video frame. You can send this message explicitly or by using the [**capSetScrollPos**](/windows/win32/Vfw/nf-vfw-capsetscrollpos?branch=master) macro.
