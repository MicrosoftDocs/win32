...
The **WM\_CAP\_STOP** message stops the capture operation. You can send this message explicitly or by using the [**capCaptureStop**](/windows/win32/Vfw/nf-vfw-capcapturestop?branch=master) macro.
