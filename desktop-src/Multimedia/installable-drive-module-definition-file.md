...
The module-definition (.DEF) file of an installable driver names the driver, exports the [DriverProc](driverproc.md) function, and defines a driver description. The following example shows a typical module-definition file for an installable driver:
