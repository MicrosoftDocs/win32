...
keywords: ["MMIOM_SEEK message Windows Multimedia"]
topic_type:
- apiref
api_name:
- MMIOM_SEEK
...
The **MMIOM\_SEEK** message is sent to an I/O procedure by the [**mmioSeek**](mmioseek.md) function to request that the current file position be moved.
...
The I/O procedure is responsible for maintaining the current file position in the **lDiskOffset** member of the [**MMIOINFO**](mmioinfo.md) structure.
