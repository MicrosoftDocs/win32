...
For example, if *lppe* is an address of the [PALETTEENTRY](https://go.microsoft.com/fwlink/p/?linkid=16938) array containing the new colors, and *lpbi* is the [**BITMAPINFOHEADER**](https://msdn.microsoft.com/library/windows/desktop/dd318229) structure used in [**DrawDibBegin**](/windows/desktop/api/Vfw/nf-vfw-drawdibbegin) or [**DrawDibDraw**](/windows/desktop/api/Vfw/nf-vfw-drawdibdraw), the following fragment updates the DIB color table.
