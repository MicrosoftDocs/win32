...
Address of a [**DRVCONFIGINFO**](drvconfiginfo.md) structure or **NULL**. If a structure is given, it contains the names of the registry key and value associated with the driver.
