...
To use an event callback, use the [CreateEvent](https://go.microsoft.com/fwlink/p/?linkid=17091) function to retrieve the handle of an event and specify CALLBACK\_EVENT in the call to the [**midiOutOpen**](https://msdn.microsoft.com/library/Dd798476(v=VS.85).aspx) function.
