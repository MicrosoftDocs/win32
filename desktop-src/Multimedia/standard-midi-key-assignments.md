...
keywords: ["creating MIDI files,standard key assignments", "standard MIDI key assignments", "Musical Instrument Digital Interface (MIDI),standard key assignments", "MIDI (Musical Instrument Digital Interface),standard key assignments", "MIDI Manufacturers Association (MMA)", "MMA (MIDI Manufacturers Association)", "General MIDI Mode specification"]
---
