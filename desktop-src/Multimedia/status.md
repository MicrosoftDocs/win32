...
<tr class="odd">
<td>speed</td>
<td>Returns the current speed of the device in frames per second (or in the same format used by the [<strong>set</strong>](multimedia-_win32_set) &quot;speed&quot; command). The MCIPIONR videodisc player does not support this flag.</td>
</tr>
<tr class="even">
