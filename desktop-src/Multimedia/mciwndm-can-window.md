...
keywords: ["MCIWNDM_CAN_WINDOW message Windows Multimedia"]
topic_type:
- apiref
api_name:
- MCIWNDM_CAN_WINDOW
...
The **MCIWNDM\_CAN\_WINDOW** message determines if an MCI device supports window-oriented MCI commands. You can send this message explicitly or by using the [**MCIWndCanWindow**](mciwndcanwindow.md) macro.
