---
title: ICM\_DRAW\_BEGIN message
...
keywords: ["ICM_DRAW_BEGIN message Windows Multimedia"]
topic_type:
- apiref
api_name:
- ICM_DRAW_BEGIN
...
Pointer to an [**ICDRAWBEGIN**](icdrawbegin-struct.md) structure containing the input format.
