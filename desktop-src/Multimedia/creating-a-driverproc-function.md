...
You create a [DriverProc](driverproc.md) function in much the same way as you create a window procedure. The function consists of a **switch** statement, and each case processes a given driver message, returning a value indicating success or failure. The **DriverProc** function has the following form:
