...
Pointer to a [**BITMAPINFOHEADER**](https://docs.microsoft.com/previous-versions//dd183376(v=vs.85)) structure containing the input format.
...
Pointer to a [**BITMAPINFOHEADER**](https://docs.microsoft.com/previous-versions//dd183376(v=vs.85)) structure to contain the color table. The space reserved for the color table is always at least 256 colors. You can specify zero for this parameter to return only the size of the color table.
