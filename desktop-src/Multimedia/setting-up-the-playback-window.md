...
The following example finds the dimensions needed to play an AVI file, creates a window corresponding to that size, and plays the file in the window by using the MCIAVI driver. It uses the [**mciSendCommand**](/windows/desktop/api/Mmsystem/) function
