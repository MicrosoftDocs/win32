...
The **WM\_CAP\_FILE\_SET\_INFOCHUNK** message sets and clears information chunks. Information chunks can be inserted in an AVI file during capture to embed text strings or custom data. You can send this message explicitly or by using the [**capFileSetInfoChunk**](/windows/win32/Vfw/nf-vfw-capfilesetinfochunk?branch=master) macro.
...
Pointer to a [**CAPINFOCHUNK**](/windows/win32/Vfw/ns-vfw-tagcapinfochunk?branch=master) structure defining the information chunk to be created or deleted.
