...
The **WM\_CAP\_DRIVER\_DISCONNECT** message disconnects a capture driver from a capture window. You can send this message explicitly or by using the [**capDriverDisconnect**](/windows/win32/Vfw/nf-vfw-capdriverdisconnect?branch=master) macro.
