...
keywords: ["WM_CAP_DRIVER_DISCONNECT message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_DRIVER\_DISCONNECT** message disconnects a capture driver from a capture window. You can send this message explicitly or by using the [**capDriverDisconnect**](capdriverdisconnect.md) macro.
