---
title: WM\_CAP\_SET\_PREVIEWRATE message
...
keywords: ["WM_CAP_SET_PREVIEWRATE message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_SET\_PREVIEWRATE** message sets the frame display rate in preview mode. You can send this message explicitly or by using the [**capPreviewRate**](cappreviewrate.md) macro.
