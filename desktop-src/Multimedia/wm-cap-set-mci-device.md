...
The **WM\_CAP\_SET\_MCI\_DEVICE** message specifies the name of the MCI video device to be used to capture data. You can send this message explicitly or by using the [**capSetMCIDeviceName**](/windows/win32/Vfw/nf-vfw-capsetmcidevicename?branch=master) macro.
