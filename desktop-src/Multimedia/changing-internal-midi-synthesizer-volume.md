...
| Value                                        | Meaning                                                                       |
|----------------------------------------------|-------------------------------------------------------------------------------|
| [**midiOutGetVolume**](midioutgetvolume.md) | Retrieves the volume level of the specified internal MIDI synthesizer device. |
| [**midiOutSetVolume**](midioutsetvolume.md) | Sets the volume level of the specified internal MIDI synthesizer device.      |
