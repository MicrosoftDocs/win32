...
keywords: ["MCIWNDM_GETZOOM message Windows Multimedia"]
topic_type:
- apiref
api_name:
- MCIWNDM_GETZOOM
...
The **MCIWNDM\_GETZOOM** message retrieves the current zoom value used by an MCI device. You can send this message explicitly or by using the [**MCIWndGetZoom**](mciwndgetzoom.md) macro.
