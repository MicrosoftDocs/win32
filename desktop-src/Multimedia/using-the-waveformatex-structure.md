...
For PCM audio data on no more than two channels and with 8-bit or 16-bit samples, use the [**WAVEFORMATEX**](/windows/desktop/api/Mmreg/) structure to specify the data format.
