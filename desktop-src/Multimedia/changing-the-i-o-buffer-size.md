...
The following example opens a file named SAMPLE.TXT for unbuffered I/O, and then enables buffered I/O with an internal 16K buffer using the [**mmioSetBuffer**](https://www.bing.com/search?q=**mmioSetBuffer**) function.
