...
keywords: ["WM_CAP_SET_CALLBACK_VIDEOSTREAM message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_SET\_CALLBACK\_VIDEOSTREAM** message sets a callback function in the application. AVICap calls this procedure during streaming capture when a video buffer is filled. You can send this message explicitly or by using the [**capSetCallbackOnVideoStream**](capsetcallbackonvideostream.md) macro.
...
Pointer to the video-stream callback function, of type [**capVideoStreamCallback**](capvideostreamcallback.md). Specify **NULL** for this parameter to disable a previously installed video-stream callback function.
