...
The [**PlaySound**](/windows/win32/Mmsystem/?branch=master) function will also play sounds referred to by a keyname in the registry. Users can assign their own sounds to system alerts and warnings, or to user actions, such as a mouse button click. Sounds that are associated with system alerts and warnings are called *sound events*.
...
The [**sndPlaySound**](/windows/win32/Mmsystem/?branch=master) function always searches the registry for a keyname matching *lpszSound* before attempting to load a file with this name. The [**PlaySound**](/windows/win32/Mmsystem/?branch=master) function accepts flags that specify the location of the sound.
