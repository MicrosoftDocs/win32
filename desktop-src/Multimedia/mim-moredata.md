...
Specifies the time that the message was received by the input device driver. The time stamp is specified in milliseconds, beginning at 0 when the [**midiInStart**](midiinstart.md) function was called.
