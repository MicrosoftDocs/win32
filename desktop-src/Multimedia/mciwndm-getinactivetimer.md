...
keywords: ["MCIWNDM_GETINACTIVETIMER message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **MCIWNDM\_GETINACTIVETIMER** message retrieves the update period used when the MCIWnd window is the inactive window. You can send this message explicitly or by using the [**MCIWndGetInactiveTimer**](mciwndgetinactivetimer.md) macro.
