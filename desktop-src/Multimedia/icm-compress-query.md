...
When a driver receives this message, it should examine the [**BITMAPINFO**](https://msdn.microsoft.com/library/windows/desktop/dd183375) structure associated with *lpbiInput* to determine if it can compress the input format.
