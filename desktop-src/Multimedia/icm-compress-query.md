...
When a driver receives this message, it should examine the [**BITMAPINFO**](https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-tagbitmapinfo) structure associated with *lpbiInput* to determine if it can compress the input format.
