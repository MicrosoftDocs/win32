...
-   Pass the instance data using the **dwUser** member of the [**WAVEHDR**](wavehdr.md) structure that identifies an audio data block being sent to a device driver.
