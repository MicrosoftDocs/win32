...
-   Create a function in the DLL that calls the [**mmioInstallIOProc**](https://msdn.microsoft.com/en-us/library/Dd757323(v=VS.85).aspx) function to install the I/O procedure.
