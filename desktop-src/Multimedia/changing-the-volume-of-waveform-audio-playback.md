...
|----------------------------------------------|-----------------------------------------------------------------------------------|
| [**waveOutGetVolume**](waveoutgetvolume.md) | Retrieves the current volume level of the specified waveform-audio output device. |
| [**waveOutSetVolume**](waveoutsetvolume.md) | Sets the volume level of the specified waveform-audio output device.              |
