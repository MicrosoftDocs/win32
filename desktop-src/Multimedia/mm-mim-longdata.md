...
The returned buffer might not be full. To determine the number of bytes recorded into the returned buffer, use the **dwBytesRecorded** member of the [**MIDIHDR**](https://www.bing.com/search?q=**MIDIHDR**) structure pointed to by *lpMidiHdr*.
