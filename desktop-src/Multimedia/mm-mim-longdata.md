...
The returned buffer might not be full. To determine the number of bytes recorded into the returned buffer, use the **dwBytesRecorded** member of the [**MIDIHDR**](midihdr.md) structure pointed to by *lpMidiHdr*.
