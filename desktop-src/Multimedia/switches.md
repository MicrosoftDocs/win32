...
The switch controls are two-state switches. These controls use the [**MIXERCONTROLDETAILS\_BOOLEAN**](/windows/desktop/api/mmeapi/) structure to retrieve and set control properties. The following table describes the types of switches.
