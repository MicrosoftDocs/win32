...
**MCIWNDM\_REALIZE** uses the palette of the MCI device and calls the [**RealizePalette**](https://msdn.microsoft.com/library/windows/desktop/dd162896) function. If your application explicitly handles the [**WM\_PALETTECHANGED**](https://msdn.microsoft.com/library/windows/desktop/dd145214) and [**WM\_QUERYNEWPALETTE**](https://msdn.microsoft.com/library/windows/desktop/dd145218) messages, you should use this message in your application instead of using **RealizePalette**. If the body of one of these message handlers contains only **RealizePalette**, forward the message to the MCIWnd window, which will automatically realize the palette.
...
[**WM\_PALETTECHANGED**](https://msdn.microsoft.com/library/windows/desktop/dd145214)
</dt> <dt>
