...
keywords: ["MCIWndGetTimeFormat macro", "MCIWndSetTimeFormat macro", "MCIWndUseTime macro", "MCIWndUseFrames macro"]
---
...
You can retrieve the current time format for a file or device by using the [**MCIWndGetTimeFormat**](mciwndgettimeformat.md) macro. You can change the current time format to any other time format supported by a device by using the [**MCIWndSetTimeFormat**](mciwndsettimeformat.md) macro. Or you can the set the time format to milliseconds or frames by using the [**MCIWndUseTime**](mciwndusetime.md) or [**MCIWndUseFrames**](mciwnduseframes.md) macros.
