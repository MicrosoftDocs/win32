...
The following example opens the waveform-audio device by specifying a waveform-audio file named "TIMPANI.WAV" using the [**mciSendCommand**](/windows/desktop/api/Mmsystem/) function.
