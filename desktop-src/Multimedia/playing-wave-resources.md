...
You can use the [**PlaySound**](/windows/desktop/api/Mmsystem/) function to play a sound that is stored as a resource. Although this is also possible using the [**sndPlaySound**](/windows/desktop/api/Mmsystem/) function, **sndPlaySound** requires that you find, load, lock, unlock, and free the resource; **PlaySound** achieves all of this with a single line of code.
