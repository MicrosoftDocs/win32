...
You can use the [**mixerGetDevCaps**](https://www.bing.com/search?q=**mixerGetDevCaps**) function to determine the capabilities of mixer devices. This function fills a [**MIXERCAPS**](https://www.bing.com/search?q=**MIXERCAPS**) structure with information about the capabilities of a specified device.
