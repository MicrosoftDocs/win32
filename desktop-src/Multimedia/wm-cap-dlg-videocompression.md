...
keywords: ["WM_CAP_DLG_VIDEOCOMPRESSION message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_DLG\_VIDEOCOMPRESSION** message displays a dialog box in which the user can select a compressor to use during the capture process. The list of available compressors can vary with the video format selected in the capture driver's Video Format dialog box. You can send this message explicitly or by using the [**capDlgVideoCompression**](capdlgvideocompression.md) macro.
