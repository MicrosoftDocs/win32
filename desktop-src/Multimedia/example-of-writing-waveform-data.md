...
The following example illustrates the steps required to allocate and set up a [**WAVEHDR**](wavehdr.md) structure and write a block of data to a waveform output device.
