...
To direct an installable driver to carry out useful tasks, you must open the driver by using the [OpenDriver](opendriver.md) function and send it messages by using the [SendDriverMessage](senddrivermessage.md) function. The following example shows how to direct the driver to display its configuration dialog box.
