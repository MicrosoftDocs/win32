...
-   Use the [**WM\_CAP\_SET\_PREVIEW**](wm-cap-set-preview.md) message to enable or disable preview mode by sending the (or the [**capPreview**](/windows/win32/Vfw/nf-vfw-cappreview?branch=master) macro) to a capture window.
-   Use the [**WM\_CAP\_SET\_PREVIEWRATE**](wm-cap-set-previewrate.md) message (or the [**capPreviewRate**](/windows/win32/Vfw/nf-vfw-cappreviewrate?branch=master) macro) to set the rate at which frames are displayed in preview mode
-   Use the [**WM\_CAP\_SET\_SCALE**](wm-cap-set-scale.md) message (or the [**capPreviewScale**](/windows/win32/Vfw/nf-vfw-cappreviewscale?branch=master) macro) to enable or disable scaling of the preview video.
