...
Address of a [**DRVCONFIGINFO**](https://www.bing.com/search?q=**DRVCONFIGINFO**) structure or **NULL**. If the structure is given, it contains the names of the registry key and value associated with the driver.
