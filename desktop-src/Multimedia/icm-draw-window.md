...
keywords: ["ICM_DRAW_WINDOW message Windows Multimedia"]
topic_type:
- apiref
api_name:
- ICM_DRAW_WINDOW
...
The **ICM\_DRAW\_WINDOW** message notifies a rendering driver that the window specified for the [**ICM\_DRAW\_BEGIN**](icm-draw-begin.md) message needs to be redrawn. The window has moved or become temporarily obscured. You can send this message explicitly or by using the [**ICDrawWindow**](icdrawwindow.md) macro.
