...
keywords: ["audio mixers,controls", "audio mixers,faders", "mixers,controls", "mixers,faders", "faders", "MIXERCONTROLDETAILS_UNSIGNED structure", "volume fade control", "bass volume fade control", "treble volume fade control", "graphic equalizer control"]
---

# Faders

The fader controls are typically vertical controls that can be adjusted up or down. These controls have a linear scale and use the [**MIXERCONTROLDETAILS\_UNSIGNED**](mixercontroldetails-unsigned.md) structure to retrieve and set control details. The following table describes the types of faders.
