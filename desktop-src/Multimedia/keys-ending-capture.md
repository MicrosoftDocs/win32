...
keywords: ["WM_CAP_GET_SEQUENCE_SETUP message", "capCaptureGetSetup macro", "CAPTUREPARMS structure", "WM_CAP_SET_SEQUENCE_SETUP message", "capCaptureSetSetup macro"]
---
