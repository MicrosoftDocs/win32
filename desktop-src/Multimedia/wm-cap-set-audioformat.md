...
keywords: ["WM_CAP_SET_AUDIOFORMAT message Windows Multimedia"]
topic_type:
- apiref
api_name:
...
The **WM\_CAP\_SET\_AUDIOFORMAT** message sets the audio format to use when performing streaming or step capture. You can send this message explicitly or by using the [**capSetAudioFormat**](capsetaudioformat.md) macro.
...
Pointer to a [**WAVEFORMATEX**](waveformatex.md) or [**PCMWAVEFORMAT**](pcmwaveformat.md) structure that defines the audio format.
