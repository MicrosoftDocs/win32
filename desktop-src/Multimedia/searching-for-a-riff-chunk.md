...
The following example uses the [**mmioDescend**](https://www.bing.com/search?q=**mmioDescend**) function to search for a "RIFF" chunk with a form type of "WAVE" to verify that the file that has just been opened is a waveform-audio file.
