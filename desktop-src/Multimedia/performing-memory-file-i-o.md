...
To open a memory file, use the [**mmioOpen**](mmioopen.md) function with the *szFilename* parameter set to **NULL** and the MMIO\_READWRITE flag set in the *dwOpenFlags* parameter. Set the *lpmmioinfo* parameter to point to an [**MMIOINFO**](mmioinfo.md) structure that has been set up as follows:
