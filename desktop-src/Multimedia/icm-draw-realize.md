...
keywords: ["ICM_DRAW_REALIZE message Windows Multimedia"]
topic_type:
- apiref
api_name:
- ICM_DRAW_REALIZE
...
The **ICM\_DRAW\_REALIZE** message notifies a rendering driver to realize its drawing palette while drawing. You can send this message explicitly or by using the [**ICDrawRealize**](icdrawrealize.md) macro.
