...
The **SslExportKey** function returns an [*Secure Sockets Layer protocol*](https://docs.microsoft.com/windows/desktop/SecGloss/s-gly) (SSL) [*session key*](https://docs.microsoft.com/windows/desktop/SecGloss/s-gly) or public ephemeral key into a serialized [*BLOB*](https://docs.microsoft.com/windows/desktop/SecGloss/b-gly).
