...
| <span id="BCRYPT_KEY_DERIVATION_INTERFACE"></span><span id="bcrypt_key_derivation_interface"></span><dl> <dt>**BCRYPT\_KEY\_DERIVATION\_INTERFACE**</dt> <dt>0x00000007</dt> </dl>          | The key derivation interface.<br/> **Windows 8** is the minimum supported client for this value.<br/> |
| <span id="BCRYPT_KEY_ENCAPSULATION_INTERFACE"></span><span id="bcrypt_key_encapsulation_interface"></span><dl> <dt>**BCRYPT\_KEY\_ENCAPSULATION\_INTERFACE**</dt> <dt>0x00000008</dt> </dl>          | The key encapsulation interface.<br/> **Windows 11 24H2** is the minimum supported client for this value.<br/> |
