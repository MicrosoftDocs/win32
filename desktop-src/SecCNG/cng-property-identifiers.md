...
The list of [*DER*](https://msdn.microsoft.com/library/windows/desktop/ms721573#-security-der-gly)-encoded hashing [*object identifiers*](https://msdn.microsoft.com/library/windows/desktop/ms721599#-security-object-identifier-gly) (OIDs). This property is a [**BCRYPT\_OID\_LIST**](/windows/desktop/api/Bcrypt/ns-bcrypt-_bcrypt_oid_list) structure. This property can only be read.
