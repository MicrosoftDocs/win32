...
| **BCRYPT_3DES_ECB_ALG_HANDLE** | A handle for the triple Data Encryption Standard algorithm using Electronic Codebook mode (ECB). Standard: SP800-67, SP800-38A. |
...
| **BCRYPT_3DES_112_CBC_ALG_HANDLE** | A handle for the 112-bit triple Data Encryption Standard algorithm using Cipher Block Chaining mode (CBC). Standard: SP800-67, SP800-38A. |
| **BCRYPT_3DES_112_ECB_ALG_HANDLE** | A handle for the 112-bit triple Data Encryption Standard algorithm using Electronic Codebook mode (ECB). Standard: SP800-67, SP800-38A. |
...
| **BCRYPT_AES_ECB_ALG_HANDLE** | A handle for the Advanced Encryption Standard (AES) algorithm using Electronic Codebook Mode (ECB). Standard: FIPS 197. |
...
| **BCRYPT_DES_ECB_ALG_HANDLE** | A handle for the Data Encryption Standard (DES) algorithm using Electronic Codebook Mode (ECB). Standard: FIPS 46-3, FIPS 81. |
