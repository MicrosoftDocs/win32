...
> [!NOTE]
> The LMS, ML-DSA, and SLH-DSA handles in this section relate to a prerelease product which may be substantially modified before it's commercially released. Microsoft makes no warranties, express or implied, with respect to the information provided here. The feature described in this section is available in pre-release versions of the [Windows Insider Preview](https://www.microsoft.com/software-download/windowsinsiderpreviewSDK).

| Constant | Description |
|----------|-------------|
| **BCRYPT_LMS_ALG_HANDLE** | A handle to the Leighton-Micali Hash-Based Signature (LMS) algorithm. Standard: RFC 8554. |
| **BCRYPT_MLDSA_44_ALG_HANDLE** | A handle to the module-lattice digital signature algorithm. Standard: FIPS 204. |
| **BCRYPT_MLDSA_65_ALG_HANDLE** | A handle to the module-lattice digital signature algorithm. Standard: FIPS 204. |
| **BCRYPT_MLDSA_87_ALG_HANDLE** | A handle to the module-lattice digital signature algorithm. Standard: FIPS 204. |
| **BCRYPT_SLHDSA_SHA2_128S_ALG_HANDLE** | A handle for the SLHDSA SHA2 128-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHAKE_128S_ALG_HANDLE** | A handle for the SLHDSA SHAKE 128-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHA2_128F_ALG_HANDLE** | A handle for the SLHDSA SHA2 128-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHAKE_128F_ALG_HANDLE** | A handle for the SLHDSA SHAKE 128-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHA2_192S_ALG_HANDLE** | A handle for the SLHDSA SHA2 192-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHAKE_192S_ALG_HANDLE** | A handle for the SLHDSA SHAKE 192-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHA2_192F_ALG_HANDLE** | A handle for the SLHDSA SHA2 192-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHAKE_192F_ALG_HANDLE** | A handle for the SLHDSA SHAKE 192-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHA2_256S_ALG_HANDLE** | A handle for the SLHDSA SHA2 256-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHAKE_256S_ALG_HANDLE** | A handle for the SLHDSA SHAKE 256-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHA2_256F_ALG_HANDLE** | A handle for the SLHDSA SHA2 256-bit stateless hash-based algorithm. Standard: FIPS 205. |
| **BCRYPT_SLHDSA_SHAKE_256F_ALG_HANDLE** | A handle for the SLHDSA SHAKE 256-bit stateless hash-based algorithm. Standard: FIPS 205. |
...
| **BCRYPT_RNG_FIPS186_DSA_ALG_HANDLE** | A handle to the random-number generator algorithm suitable for DSA (Digital Signature Algorithm). Standard: FIPS 186-2.<br/> **Windows 8:** Support for FIPS 186-3 begins. |
...
| **BCRYPT_AES_CMAC_ALG_HANDLE** | A handle for the Advanced Encryption Standard (AES) cipher based message authentication code (CMAC) symmetric encryption algorithm. Standard: SP 800-38B.<br/>**Windows 8:** Support for this algorithm begins. |
| **BCRYPT_AES_GMAC_ALG_HANDLE** | A handle for the Advanced Encryption Standard (AES) Galois message authentication code (GMAC) symmetric encryption algorithm. Standard: SP800-38D.<br/>**Windows Vista SP1:** Support for this algorithm begins. |
