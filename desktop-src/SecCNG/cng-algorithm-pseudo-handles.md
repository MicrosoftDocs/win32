...
| **BCRYPT_COMPOSITE_MLKEM_ALG_HANDLE**<br/>0x000004A1 | A handle to the composite ML-KEM and traditional key encapsulation algorithm. | [IETF draft](https://datatracker.ietf.org/doc/html/draft-ietf-lamps-pq-composite-sigs) |
