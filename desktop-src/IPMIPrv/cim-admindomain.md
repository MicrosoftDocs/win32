---
title: CIM\_AdminDomain class
description: Aggregates a grouping of managed system elements so that all of its components are administered similarly.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ec895a46-bd98-480e-9d2e-c5b854c94083'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_AdminDomain class", "CIM_AdminDomain class, described"]
topic_type:
- apiref
api_name:
- CIM_AdminDomain
- CIM_AdminDomain.Caption
- CIM_AdminDomain.Description
- CIM_AdminDomain.ElementName
- CIM_AdminDomain.InstallDate
- CIM_AdminDomain.OperationalStatus
- CIM_AdminDomain.StatusDescriptions
- CIM_AdminDomain.Status
- CIM_AdminDomain.HealthState
- CIM_AdminDomain.EnabledState
- CIM_AdminDomain.OtherEnabledState
- CIM_AdminDomain.RequestedState
- CIM_AdminDomain.EnabledDefault
- CIM_AdminDomain.TimeOfLastStateChange
- CIM_AdminDomain.CreationClassName
- CIM_AdminDomain.Name
- CIM_AdminDomain.PrimaryOwnerName
- CIM_AdminDomain.PrimaryOwnerContact
- CIM_AdminDomain.Roles
- CIM_AdminDomain.NameFormat
api_location:
- IpmiPrv.dll
api_type:
- DllExport
...
# CIM\_AdminDomain class

Aggregates a grouping of managed system elements so that all of its components are administered similarly.
...
``` syntax
[Abstract, Version("2.8.0"), UUID("{5ff6d537-9404-4324-9cba-f704aa329e01}"), AMENDMENT]
...
The **CIM\_AdminDomain** class has these types of members:
...
The **CIM\_AdminDomain** class has these methods.



| Method                                                           | Description                                                                                                                                                                                    |
|:-----------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](cim-admindomain-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
...
The **CIM\_AdminDomain** class has these properties.
...
Serves as key of a System instance in an enterprise environment.
...
Qualifiers: [**Override**](https://msdn.microsoft.com/library/aa393650) ("NameFormat"), [**ModelCorrespondence**](https://msdn.microsoft.com/library/aa393650) ("CIM\_AdminDomain.Name")
</dt> </dl>

How the **Name** of the admin domain is generated, using the heuristic specified in the CIM V2 System Model specification. It assumes that the documented rules are traversed in order, to determine and assign a **Name**. The **NameFormat** values list defines the precedence order for assigning the **Name** of the admin domain.

The "FC" value is deprecated and replaced by "WWN".
...
<span id="Autonomous_System"></span><span id="autonomous_system"></span><span id="AUTONOMOUS_SYSTEM"></span>
...
<span id="Network_Access_Provider"></span><span id="network_access_provider"></span><span id="NETWORK_ACCESS_PROVIDER"></span>
...
<span id="Network_Operations_Center"></span><span id="network_operations_center"></span><span id="NETWORK_OPERATIONS_CENTER"></span>
...
<span id="Point_of_Presence"></span><span id="point_of_presence"></span><span id="POINT_OF_PRESENCE"></span>
...
<span id="Regional_Network_Provider"></span><span id="regional_network_provider"></span><span id="REGIONAL_NETWORK_PROVIDER"></span>
...
<span id="LAN"></span><span id="lan"></span>
...
<span id="Policy_Repository"></span><span id="policy_repository"></span><span id="POLICY_REPOSITORY"></span>
...
<span id="Fibre_Channel_Worldwide_Name"></span><span id="fibre_channel_worldwide_name"></span><span id="FIBRE_CHANNEL_WORLDWIDE_NAME"></span>

**Fibre Channel Worldwide Name** ("WWN")
...
Information on how the primary system owner can be reached, for example phone number or email address.
...
The administrator-defined roles this System plays in the managed environment. Examples might be "Building 8 print server" or "Boise user directories". A single system may perform multiple roles.
