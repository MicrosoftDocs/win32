---
title: CIM\_Log class
description: Represents any type of event, error or informational register or chronicle.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '3dd94c7c-d8fe-459c-80b3-4311f122eb8f'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_Log class", "CIM_Log class, described"]
topic_type:
- apiref
api_name:
- CIM_Log
...
- CIM_Log.InstallDate
- CIM_Log.Name
- CIM_Log.OperationalStatus
- CIM_Log.StatusDescriptions
- CIM_Log.Status
- CIM_Log.HealthState
- CIM_Log.EnabledState
- CIM_Log.OtherEnabledState
- CIM_Log.RequestedState
- CIM_Log.EnabledDefault
- CIM_Log.TimeOfLastStateChange
- CIM_Log.MaxNumberOfRecords
- CIM_Log.CurrentNumberOfRecords
api_location:
- IpmiPrv.dll
api_type:
- DllExport
...
``` syntax
[Experimental, Abstract, Version("2.8.1000"), UUID("{f8c12ed7-c769-49fa-bf3e-db0b0160c94e}"), AMENDMENT]
...
The **CIM\_Log** class has these types of members:
...
The **CIM\_Log** class has these methods.



| Method                                                   | Description                                                                                                                                                                                    |
|:---------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ClearLog**](cim-log-clearlog.md)                     | Requests that the Log be cleared of all entries.<br/>                                                                                                                                    |
| [**RequestStateChange**](cim-log-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
...
The **CIM\_Log** class has these properties.
