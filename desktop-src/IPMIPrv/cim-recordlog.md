---
title: CIM\_RecordLog class
description: RecordLog serves as an aggregation point for LogRecord objects.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'ef15bcb1-d905-481a-8756-ee0559d38234'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["CIM_RecordLog class", "CIM_RecordLog class, described"]
topic_type:
- apiref
api_name:
- CIM_RecordLog
- CIM_RecordLog.Caption
- CIM_RecordLog.Description
- CIM_RecordLog.ElementName
- CIM_RecordLog.InstallDate
- CIM_RecordLog.Name
- CIM_RecordLog.OperationalStatus
- CIM_RecordLog.StatusDescriptions
- CIM_RecordLog.Status
- CIM_RecordLog.HealthState
- CIM_RecordLog.EnabledState
- CIM_RecordLog.OtherEnabledState
- CIM_RecordLog.RequestedState
- CIM_RecordLog.EnabledDefault
- CIM_RecordLog.TimeOfLastStateChange
...
The **CIM\_RecordLog** class has these types of members:
...
The **CIM\_RecordLog** class has these methods.



| Method                                                         | Description                                                                                                                                                                                    |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ClearLog**](cim-recordlog-clearlog.md)                     | Requests that the Log be cleared of all entries.<br/> This method is inherited from [**CIM\_Log**](cim-log.md).<br/>                                                              |
| [**RequestStateChange**](cim-recordlog-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
...
The **CIM\_RecordLog** class has these properties.
