---
title: RequestStateChange method of the CIM\_NumericSensor class
description: Initiates a requests to change the state of a computer system.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'db81d58d-f480-4544-a483-22991186b4e6'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, CIM_NumericSensor class", "CIM_NumericSensor class, RequestStateChange method"]
topic_type:
- apiref
api_name:
...
# RequestStateChange method of the CIM\_NumericSensor class
