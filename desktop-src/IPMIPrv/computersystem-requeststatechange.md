---
title: RequestStateChange method of the ComputerSystem class
description: Initiates a requests to change the state of a computer system.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'C321C15C-54B7-43D1-AE12-EA9155880519'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, ComputerSystem interface", "ComputerSystem interface, RequestStateChange method"]
topic_type:
- apiref
api_name:
- ComputerSystem.RequestStateChange
api_location:
- IpmiPrv.dll
api_type:
- COM
