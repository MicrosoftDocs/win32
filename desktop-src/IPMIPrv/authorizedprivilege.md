---
title: AuthorizedPrivilege class
description: Represents authorization information for an Account instance, which specifies account privileges to activities.
audience: developer
...
api_name:
- AuthorizedPrivilege
- AuthorizedPrivilege.Caption
- AuthorizedPrivilege.Description
- AuthorizedPrivilege.ElementName
- AuthorizedPrivilege.InstanceID
- AuthorizedPrivilege.PrivilegeGranted
- AuthorizedPrivilege.Activities
- AuthorizedPrivilege.ActivityQualifiers
- AuthorizedPrivilege.QualifierFormats
api_location:
- IpmiPrv.dll
api_type:
- DllExport
...
Represents authorization information for an [**Account**](account.md) instance, which specifies account privileges to activities.
