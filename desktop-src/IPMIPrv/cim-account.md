---
title: CIM\_Account class
description: Represents the information held by a security service to track identity and privileges managed by that service.
audience: developer
...
- CIM_Account
- CIM_Account.Caption
- CIM_Account.Description
- CIM_Account.ElementName
- CIM_Account.InstallDate
- CIM_Account.OperationalStatus
- CIM_Account.StatusDescriptions
- CIM_Account.Status
- CIM_Account.HealthState
- CIM_Account.SystemCreationClassName
- CIM_Account.SystemName
- CIM_Account.CreationClassName
- CIM_Account.Name
- CIM_Account.UserID
- CIM_Account.ObjectClass
- CIM_Account.Descriptions
- CIM_Account.Host
- CIM_Account.LocalityName
- CIM_Account.OrganizationName
- CIM_Account.OU
- CIM_Account.SeeAlso
- CIM_Account.UserCertificate
...
The **CIM\_Account** class has these types of members:

-   [Properties](#properties)

### Properties

The **CIM\_Account** class has these properties.
