---
title: RequestStateChange method of the Sensor class
description: Initiates a requests to change the state of the sensor.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '053C7BCD-BB08-4EE9-B955-0C20302E2FF1'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["RequestStateChange method", "RequestStateChange method, Sensor interface", "Sensor interface, RequestStateChange method"]
topic_type:
- apiref
api_name:
- Sensor.RequestStateChange
api_location:
- IpmiPrv.dll
api_type:
- COM
...
# RequestStateChange method of the Sensor class
