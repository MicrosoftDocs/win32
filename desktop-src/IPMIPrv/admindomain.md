---
title: AdminDomain class
description: Represents a group of ComputerSystem instances.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'b16ce27e-26b8-44ab-9c92-b3122f64ebdf'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["IPMI provider WS-Management", "AdminDomain class", "AdminDomain class, described"]
topic_type:
- apiref
api_name:
- AdminDomain
- AdminDomain.Caption
- AdminDomain.Description
- AdminDomain.ElementName
- AdminDomain.InstallDate
- AdminDomain.OperationalStatus
- AdminDomain.StatusDescriptions
- AdminDomain.Status
- AdminDomain.HealthState
- AdminDomain.EnabledState
- AdminDomain.OtherEnabledState
- AdminDomain.RequestedState
- AdminDomain.EnabledDefault
- AdminDomain.TimeOfLastStateChange
- AdminDomain.CreationClassName
- AdminDomain.Name
- AdminDomain.PrimaryOwnerName
- AdminDomain.PrimaryOwnerContact
- AdminDomain.Roles
- AdminDomain.NameFormat
api_location:
- IpmiPrv.dll
api_type:
- DllExport
...
Represents a group of [**ComputerSystem**](computersystem.md) instances.
...
``` syntax
[Dynamic, Provider("IPMIPrv"), UUID("{f0610966-50c3-47ab-8db5-a2f3bccf3cb1}"), AMENDMENT]
...
The **AdminDomain** class has these types of members:
...
The **AdminDomain** class has these methods.



| Method                                                       | Description                                                                                                                                                                                    |
|:-------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**RequestStateChange**](admindomain-requeststatechange.md) | Requests that the state of the element be changed to the specified value.<br/> This method is inherited from [**CIM\_EnabledLogicalElement**](cim-enabledlogicalelement.md).<br/> |
...
The **AdminDomain** class has these properties.
...
This property is inherited from [**CIM\_AdminDomain**](cim-admindomain.md).
