---
title: SaveProperties method of the Sensor class
description: Saves the configuration and state of the sensor.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '3B760743-7753-4354-B9A1-655014223E3D'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SaveProperties method", "SaveProperties method, Sensor interface", "Sensor interface, SaveProperties method"]
topic_type:
- apiref
api_name:
- Sensor.SaveProperties
api_location:
- IpmiPrv.dll
api_type:
- COM
...
# SaveProperties method of the Sensor class
