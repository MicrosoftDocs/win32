...
ms.assetid: '2247d7aa-4997-4c91-96a0-567345ee6ebb'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["SetPowerState method", "SetPowerState method, CIM_Sensor class", "CIM_Sensor class, SetPowerState method"]
topic_type:
- apiref
api_name:
