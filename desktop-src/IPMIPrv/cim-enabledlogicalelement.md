...
description: An element that is enabled and disabled, such as a logical device or a service access point.
audience: developer
...
An element that is enabled and disabled, such as a logical device or a service access point.
