---
title: OnlineDevice method of the CIM\_Sensor class
description: Brings the sensor online so it can accept requests, or offline so it can no longer accept requests.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '3a49a31b-3f11-4cd7-95fb-4a3a26238280'
ms.prod: 'windows-server-dev'
ms.technology:
- 'intelligent-platform-management-interface'
- 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["OnlineDevice method", "OnlineDevice method, CIM_Sensor class", "CIM_Sensor class, OnlineDevice method"]
topic_type:
- apiref
api_name:
...
# OnlineDevice method of the CIM\_Sensor class
