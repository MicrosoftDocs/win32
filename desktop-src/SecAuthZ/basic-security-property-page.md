...
The basic security property page is the starting page of the property sheet displayed by the [**EditSecurity**](editsecurity.md) function. You can also use the [**CreateSecurityPage**](createsecuritypage.md) function to create a basic security property page to insert in your own property sheet.
...
You can use the **pszPageTitle** member of the [**SI\_OBJECT\_INFO**](si-object-info.md) structure to specify the title of the basic security property page. The default title is **Security**.
