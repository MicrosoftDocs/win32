...
| [**WELL\_KNOWN\_SID\_TYPE**](/windows/desktop/api/Winnt/ne-winnt-well_known_sid_type)<br/>                               | A list of commonly used [security identifiers](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-identifier-gly) (SIDs). Programs can pass these values to the [**CreateWellKnownSid**](https://msdn.microsoft.com/en-us/library/Aa446585(v=VS.85).aspx) function to create a SID from this list.<br/> |
