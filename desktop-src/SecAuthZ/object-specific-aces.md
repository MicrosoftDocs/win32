...
<td>Indicates the type of child object that can inherit the ACE. Inheritance is also controlled by the inheritance flags in the [<strong>ACE_HEADER</strong>](/windows/desktop/api/Winnt/ns-winnt-_ace_header), as well as by any protection against inheritance placed on the child objects. For more information, see [ACE Inheritance](ace-inheritance.md).</td>
</tr>
</tbody>
</table>
