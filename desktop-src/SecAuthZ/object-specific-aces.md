...
<td>Indicates the type of child object that can inherit the ACE. Inheritance is also controlled by the inheritance flags in the [<strong>ACE_HEADER</strong>](ace-header.md), as well as by any protection against inheritance placed on the child objects. For more information, see [ACE Inheritance](ace-inheritance.md).</td>
</tr>
</tbody>
</table>
...
| Type                      | Description                                                                                                                                                                                                                                       |
|---------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Access-denied object ACE  | Used in a DACL to deny a trustee access to a property or property set on the object, or to limit ACE inheritance to a specified type of child object. Uses the [**ACCESS\_DENIED\_OBJECT\_ACE**](access-denied-object-ace.md) structure.         |
| Access-allowed object ACE | Used in a DACL to allow a trustee access to a property or property set on the object, or to limit ACE inheritance to a specified type of child object. Uses the [**ACCESS\_ALLOWED\_OBJECT\_ACE**](access-allowed-object-ace.md) structure.      |
| System-audit object ACE   | Used in a SACL to log a trustee's attempts to access a property or property set on the object, or to limit ACE inheritance to a specified type of child object. Uses the [**SYSTEM\_AUDIT\_OBJECT\_ACE**](system-audit-object-ace.md) structure. |
