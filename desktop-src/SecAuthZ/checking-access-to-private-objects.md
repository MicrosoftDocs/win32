...
The [**AreAllAccessesGranted**](https://msdn.microsoft.com/en-us/library/Aa375351(v=VS.85).aspx) and [**AreAnyAccessesGranted**](https://msdn.microsoft.com/en-us/library/Aa375363(v=VS.85).aspx) functions compare a requested [*access mask*](https://docs.microsoft.com/windows/desktop/SecGloss/a-gly) with a granted access mask.
