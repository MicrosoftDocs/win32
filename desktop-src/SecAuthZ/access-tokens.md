...
Use the [**OpenProcessToken**](/windows/desktop/api/Winbase/nf-ntifs-ntopenprocesstoken) function to retrieve a handle to the primary token of a process. Use the [**OpenThreadToken**](/windows/desktop/api/Winbase/nf-ntifs-ntopenthreadtoken) function to retrieve a handle to the impersonation token of a thread. For more information, see [Impersonation](client-impersonation.md).
...
|--------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AdjustTokenGroups**](https://www.bing.com/search?q=**AdjustTokenGroups**)         | Changes the group information in an access token.                                                                                                                      |
| [**AdjustTokenPrivileges**](https://www.bing.com/search?q=**AdjustTokenPrivileges**) | Enables or disables the privileges in an access token. It does not grant new privileges or revoke existing ones.                                                       |
| [**CheckTokenMembership**](https://www.bing.com/search?q=**CheckTokenMembership**)   | Determines whether a specified SID is enabled in a specified access token.                                                                                             |
| [**CreateRestrictedToken**](https://www.bing.com/search?q=**CreateRestrictedToken**) | Creates a new token that is a restricted version of an existing token. The restricted token can have disabled SIDs, deleted privileges, and a list of restricted SIDs. |
| [**DuplicateToken**](https://www.bing.com/search?q=**DuplicateToken**)               | Creates a new impersonation token that duplicates an existing token.                                                                                                   |
| [**DuplicateTokenEx**](https://www.bing.com/search?q=**DuplicateTokenEx**)           | Creates a new primary token or impersonation token that duplicates an existing token.                                                                                  |
| [**GetTokenInformation**](https://www.bing.com/search?q=**GetTokenInformation**)     | Retrieves information about a token.                                                                                                                                   |
| [**IsTokenRestricted**](https://www.bing.com/search?q=**IsTokenRestricted**)         | Determines whether a token has a list of restricting SIDs.                                                                                                             |
| [**OpenProcessToken**](/windows/desktop/api/Winbase/nf-ntifs-ntopenprocesstoken)           | Retrieves a handle to the primary access token for a process.                                                                                                          |
| [**OpenThreadToken**](/windows/desktop/api/Winbase/nf-ntifs-ntopenthreadtoken)             | Retrieves a handle to the impersonation access token for a thread.                                                                                                     |
| [**SetThreadToken**](https://www.bing.com/search?q=**SetThreadToken**)               | Assigns or removes an impersonation token for a thread.                                                                                                                |
| [**SetTokenInformation**](https://www.bing.com/search?q=**SetTokenInformation**)     | Changes a token's owner, primary group, or default DACL.                                                                                                               |
