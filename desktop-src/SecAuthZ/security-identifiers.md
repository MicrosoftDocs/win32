...
|----------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AllocateAndInitializeSid**](/windows/desktop/api/Winbase/nf-ntifs-rtlallocateandinitializesidex)   | Allocates and initializes a SID with the specified number of subauthorities.                                                                              |
...
| [**CopySid**](https://www.bing.com/search?q=**CopySid**)                                     | Copies a source SID to a buffer.                                                                                                                          |
| [**EqualPrefixSid**](https://www.bing.com/search?q=**EqualPrefixSid**)                       | Tests two SID prefix values for equality. A SID prefix is the entire SID except for the last subauthority value.                                          |
| [**EqualSid**](https://www.bing.com/search?q=**EqualSid**)                                   | Tests two SIDs for equality. They must match exactly to be considered equal.                                                                              |
| [**FreeSid**](https://www.bing.com/search?q=**FreeSid**)                                     | Frees a previously allocated SID by using the [**AllocateAndInitializeSid**](/windows/desktop/api/Winbase/nf-ntifs-rtlallocateandinitializesidex) function.                                      |
| [**GetLengthSid**](https://www.bing.com/search?q=**GetLengthSid**)                           | Retrieves the length of a SID.                                                                                                                            |
| [**GetSidIdentifierAuthority**](https://www.bing.com/search?q=**GetSidIdentifierAuthority**) | Retrieves a pointer to the identifier authority for a SID.                                                                                                |
| [**GetSidLengthRequired**](https://www.bing.com/search?q=**GetSidLengthRequired**)           | Retrieves the size of the buffer required to store a SID with a specified number of subauthorities.                                                       |
| [**GetSidSubAuthority**](https://www.bing.com/search?q=**GetSidSubAuthority**)               | Retrieves a pointer to a specified subauthority in a SID.                                                                                                 |
| [**GetSidSubAuthorityCount**](https://www.bing.com/search?q=**GetSidSubAuthorityCount**)     | Retrieves the number of subauthorities in a SID.                                                                                                          |
| [**InitializeSid**](/windows/desktop/api/Winbase/nf-ntifs-rtlallocateandinitializesidex)                         | Initializes a [**SID**](/windows/desktop/api/Winnt/ns-winnt-_sid) structure.                                                                                                               |
| [**IsValidSid**](https://www.bing.com/search?q=**IsValidSid**)                               | Tests the validity of a SID by verifying that the revision number is within a known range and that the number of subauthorities is less than the maximum. |
