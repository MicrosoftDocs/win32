...
1.  Start the impersonation by using an impersonation function, such as [**ImpersonateNamedPipeClient**](/windows/desktop/api/Winbase/).
2.  Call the [**OpenThreadToken**](/windows/desktop/api/Winbase/nf-ntifs-ntopenthreadtoken) function to get an impersonation token that has the security context of the client.
3.  Call the [**DuplicateTokenEx**](https://www.bing.com/search?q=**DuplicateTokenEx**) function to convert the impersonation token into a primary token.
