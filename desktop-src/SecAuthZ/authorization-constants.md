...
| [**Capability SID Constants**](capability-sid-constants.md)<br/>       | Define for applications well-known capabilities by using the [**AllocateAndInitializeSid**](allocateandinitializesid.md) function.<br/>                                                                                                                       |
