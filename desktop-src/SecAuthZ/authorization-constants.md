...
| [**Capability SID Constants**](capability-sid-constants.md)<br/>       | Define for applications well-known capabilities by using the [**AllocateAndInitializeSid**](/windows/desktop/api/Winbase/nf-ntifs-rtlallocateandinitializesidex) function.<br/>                                                                                                                       |
