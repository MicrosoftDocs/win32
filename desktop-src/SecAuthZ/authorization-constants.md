...
| [**Capability SID Constants**](capability-sid-constants.md)<br/>       | Define for applications well-known capabilities by using the [**AllocateAndInitializeSid**](/windows/win32/Winbase/nf-ntifs-rtlallocateandinitializesidex?branch=master) function.<br/>                                                                                                                       |
