...
| <span id="SE_DEBUG_NAME"></span><span id="se_debug_name"></span><dl><dt><strong>SE_DEBUG_NAME</strong></dt><dt>TEXT("SeDebugPrivilege")</dt></dl> | Debug and adjust the memory of any process, ignoring the DACL for the process. <br /> User Right: Debug programs.<br /> | 
...
| <span id="SE_MANAGE_VOLUME_NAME"></span><span id="se_manage_volume_name"></span><dl><dt><strong>SE_MANAGE_VOLUME_NAME</strong></dt><dt>TEXT("SeManageVolumePrivilege")</dt></dl> | Required to enable volume management privileges. <br /> User Right: Perform volume maintenance tasks.<br /> | 
