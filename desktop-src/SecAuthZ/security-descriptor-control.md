...
To get the control bits of a security descriptor, call the [**GetSecurityDescriptorControl**](getsecuritydescriptorcontrol.md) function. To set the control bits of a security descriptor, use the functions for modifying security descriptors. For a list of these functions, see the See Also section.

Applications can use the [**SetSecurityDescriptorControl**](setsecuritydescriptorcontrol.md) function to set the control bits that relate to automatic inheritance of ACEs.

The control value retrieved by the [**GetSecurityDescriptorControl**](getsecuritydescriptorcontrol.md) function can include a combination of the following **SECURITY\_DESCRIPTOR\_CONTROL** bit flags.



| Value                                                     | Meaning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|-----------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SE\_DACL\_AUTO\_INHERIT\_REQ<br/> 0x0100<br/> | Indicates a required [*security descriptor*](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-descriptor-gly) in which the [*discretionary access control list*](https://msdn.microsoft.com/library/windows/desktop/ms721573#-security-discretionary-access-control-list-gly) (DACL) is set up to support automatic propagation of inheritable [*access control entries*](https://msdn.microsoft.com/library/windows/desktop/ms721532#-security-access-control-entry-gly) (ACEs) to existing child objects.<br/> For [*access control lists*](https://msdn.microsoft.com/library/windows/desktop/ms721532#-security-access-control-list-gly) (ACLs) that support auto inheritance, this bit is always set. Protected servers can call the [**ConvertToAutoInheritPrivateObjectSecurity**](converttoautoinheritprivateobjectsecurity.md) function to convert a security descriptor and set this flag. <br/> |
...
| SE\_SACL\_DEFAULTED<br/> 0x0008<br/>          | A default mechanism, rather than the original [*provider*](https://msdn.microsoft.com/library/windows/desktop/ms721603#-security-provider-gly) of the security descriptor, provided the SACL. This flag can affect how the system treats the SACL, with respect to ACE inheritance. The system ignores this flag if the SE\_SACL\_PRESENT flag is not set. To set this flag, use the [**SetSecurityDescriptorSacl**](setsecuritydescriptorsacl.md) function.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| SE\_SACL\_PRESENT<br/> 0x0010<br/>            | Indicates a security descriptor that has a SACL. To set this flag, use the [**SetSecurityDescriptorSacl**](setsecuritydescriptorsacl.md) function.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| SE\_SACL\_PROTECTED<br/> 0x2000<br/>          | Prevents the SACL of the security descriptor from being modified by inheritable ACEs. To set this flag, use the [**SetSecurityDescriptorControl**](setsecuritydescriptorcontrol.md) function.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
