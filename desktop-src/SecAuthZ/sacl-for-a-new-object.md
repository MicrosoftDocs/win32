...
The system uses a different algorithm to build a SACL for a new Active Directory object. For more information, see [How Security Descriptors are Set on New Directory Objects](https://msdn.microsoft.com/library/ms676927).
