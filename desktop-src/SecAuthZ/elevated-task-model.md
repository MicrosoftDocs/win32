...
-   The [*security descriptor*](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-descriptor-gly) associated with the task must be configured to allow standard users to start the task.
-   The task scheduler service must be running.

For information about how to create and start tasks, see [Task Scheduler](https://msdn.microsoft.com/library/windows/desktop/aa383614).
