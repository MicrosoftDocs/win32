...
To convert a security descriptor to a string format, call the [**ConvertSecurityDescriptorToStringSecurityDescriptor**](convertsecuritydescriptortostringsecuritydescriptor.md) function. To convert a string-format security descriptor back to a valid functional security descriptor, call the [**ConvertStringSecurityDescriptorToSecurityDescriptor**](convertstringsecuritydescriptortosecuritydescriptor.md) function.
