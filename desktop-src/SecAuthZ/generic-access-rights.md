...
ms.date: 07/08/2025
# customer intent: As a Windows app developer, I want to understand how to use generic access rights when working with securable objects, so that I can simplify the process of specifying access rights when opening handles to these objects.
---
