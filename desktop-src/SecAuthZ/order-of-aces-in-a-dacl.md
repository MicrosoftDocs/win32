...
Functions such as [**AddAccessAllowedAceEx**](addaccessallowedaceex.md) and [**AddAccessAllowedObjectAce**](addaccessallowedobjectace.md) add an ACE to the end of an ACL. It is the caller's responsibility to ensure that the ACEs are added in the proper order.
