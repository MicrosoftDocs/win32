...
-   Every [*security identifier*](https://msdn.microsoft.com/library/windows/desktop/ms721625#-security-security-identifier-gly) (SID) that is present in either token is also present in the other token.
