...
> [!NOTE]
> Conditional [*access control entries*](/windows/desktop/SecGloss/a-gly) (ACEs) have a different format than other ACE types. For conditional ACEs, see [Security Descriptor Definition Language for Conditional ACEs](security-descriptor-definition-language-for-conditional-aces-.md).
...
| Access rights string | Constant in Sddl.h | Access right value |
|----------------------|--------------------|--------------------|
| "FA"                 | SDDL\_FILE\_ALL     | FILE\_GENERIC\_ALL |
