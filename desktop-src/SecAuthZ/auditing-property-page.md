...
To include the **Auditing** property page, set the **SI\_ADVANCED** and **SI\_EDIT\_AUDITS** flags in the [**SI\_OBJECT\_INFO**](si-object-info.md) structure returned by your [**ISecurityInformation::GetObjectInformation**](isecurityinformation-getobjectinformation.md) implementation.
