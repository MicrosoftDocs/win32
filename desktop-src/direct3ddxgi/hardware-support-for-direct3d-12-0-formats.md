---
Description: This section specifies the formats ([**DXGI_FORMAT_***](https://msdn.microsoft.com/library/Bb173059(v=VS.85).aspx) values) that are supported in Direct3D Feature Level 12.0 hardware.
...
This section specifies the formats ([**DXGI_FORMAT_***](https://msdn.microsoft.com/library/Bb173059(v=VS.85).aspx) values) that are supported in Direct3D Feature Level 12.0 hardware.
...
## DXGI_FORMAT_R24G8\_TYPELESS (44)
| Target | Support |
| - | - |
| Bits Per Element (BPE) | 32 |
| Format Support | ![required](images/letter-r.jpg) |
...
## DXGI_FORMAT_D24\_UNORM\_S8\_UINT (45)
| Target | Support |
| - | - |
| Bits Per Element (BPE) | 32 |
| Format Support | ![required](images/letter-r.jpg) |
...
## DXGI_FORMAT_R24\_UNORM\_X8\_TYPELESS (46)
| Target | Support |
| - | - |
| Bits Per Element (BPE) | 32 |
| Format Support | ![required](images/letter-r.jpg) |
...
## DXGI_FORMAT_X24\_TYPELESS\_G8\_UINT (47)
| Target | Support |
| - | - |
| Bits Per Element (BPE) | 32 |
| Format Support | ![required](images/letter-r.jpg) |
