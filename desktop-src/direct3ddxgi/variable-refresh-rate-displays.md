...
To add vsync-off support to your apps, you can refer to a complete running sample for Direct3D 12, **D3D12Fullscreen** (refer to [Working Samples](https://msdn.microsoft.com/library/Mt186624(v=VS.85).aspx)). There are also a few points not explicitly called out in the sample code but you need to pay attention to.
