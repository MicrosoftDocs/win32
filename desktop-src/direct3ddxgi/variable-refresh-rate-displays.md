...
To use this feature, app users need to be on Windows 10 systems with either [KB3156421](https://support.microsoft.com/en-us/kb/3156421) or the Anniversary Update installed. The feature works on all versions of Direct3D 11 and 12 using **DXGI\_SWAP\_EFFECT\_FLIP\_\*** swap effects.

To add vsync-off support to your apps, you can refer to a complete running sample for Direct3D 12, **D3D12Fullscreen** (refer to [Working Samples](https://msdn.microsoft.com/windows/desktop/4C4475D4-534F-484F-8D60-9ACEA09AC109)). There are also a few points not explicitly called out in the sample code but you need to pay attention to.
