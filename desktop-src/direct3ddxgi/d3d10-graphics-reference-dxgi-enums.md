...
| Topic                                                                                                         | Description                                                                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**DXGI\_ADAPTER\_FLAG**](https://docs.microsoft.com/windows/desktop/api/dxgi/ne-dxgi-dxgi_adapter_flag)<br/>                                          | Identifies the type of DXGI adapter.<br/>                                                                                                                                   |
| [**DXGI\_ADAPTER\_FLAG3**](https://docs.microsoft.com/windows/desktop/api/dxgi1_6/ne-dxgi1_6-dxgi_adapter_flag3)<br/>                                        | Identifies the type of DXGI adapter.<br/>                                                                                                                                   |
...
| [**DXGI\_FORMAT**](https://docs.microsoft.com/windows/desktop/api/dxgiformat/ne-dxgiformat-dxgi_format)<br/>                                                       | Resource data formats, including fully-typed and typeless formats. A list of modifiers at the bottom of the page more fully describes each format type. <br/>               |
...
| [**DXGI\_MODE\_ROTATION**](https://docs.microsoft.com/previous-versions/windows/desktop/legacy/bb173065(v=vs.85))<br/>                                        | Flags that indicate how the back buffers should be rotated to fit the physical rotation of a monitor.<br/>                                                                  |
| [**DXGI\_MODE\_SCALING**](https://docs.microsoft.com/previous-versions/windows/desktop/legacy/bb173066(v=vs.85))<br/>                                          | Flags indicating how an image is stretched to fit a given monitor's resolution.<br/>                                                                                        |
| [**DXGI\_MODE\_SCANLINE\_ORDER**](https://docs.microsoft.com/previous-versions/windows/desktop/legacy/bb173067(v=vs.85))<br/>                           | Flags indicating the method the raster uses to create an image on a surface.<br/>                                                                                           |
...
| [**DXGI\_OFFER\_RESOURCE\_FLAGS**](/windows/desktop/api/dxgi1_5/ne-dxgi1_5-_dxgi_offer_resource_flags)<br/>                                  | Specifies flags for the [**OfferResources1**](/windows/desktop/api/dxgi1_5/nf-dxgi1_5-idxgidevice4-offerresources1) method.<br/>                                                                                |
| [**DXGI\_OFFER\_RESOURCE\_PRIORITY**](/windows/desktop/api/dxgi1_2/ne-dxgi1_2-_dxgi_offer_resource_priority)<br/>                           | Identifies the importance of a resource s content when you call the [**IDXGIDevice2::OfferResources**](/windows/desktop/api/DXGI1_2/nf-dxgi1_2-idxgidevice2-offerresources) method to offer the resource. <br/> |
...
| [**DXGI\_RECLAIM\_RESOURCE\_RESULTS**](/windows/desktop/api/dxgi1_5/ne-dxgi1_5-_dxgi_reclaim_resource_results)<br/>                          | Specifies result flags for the [**ReclaimResources1**](/windows/desktop/api/dxgi1_5/nf-dxgi1_5-idxgidevice4-reclaimresources1) method.<br/>                                                                     |
| [**DXGI\_RESIDENCY**](https://docs.microsoft.com/windows/desktop/api/dxgi/ne-dxgi-dxgi_residency)<br/>                                                 | Flags indicating the memory location of a resource.<br/>                                                                                                                    |
...
| [**DXGI\_SWAP\_CHAIN\_FLAG**](https://docs.microsoft.com/windows/desktop/api/dxgi/ne-dxgi-dxgi_swap_chain_flag)<br/>                                   | Options for swap-chain behavior.<br/>                                                                                                                                       |
