...
> [!Note]  
> In D3D10 and D3D11, you don't have to call [**IDXGISwapChain::GetBuffer**](/windows/desktop/api/DXGI/nf-dxgi-idxgiswapchain-getbuffer) to retrieve back buffer 0 after you call [**IDXGISwapChain1::Present1**](/windows/desktop/api/DXGI1_2/nf-dxgi1_2-idxgiswapchain1-present1) because for convenience the identities of back buffers change. This does not occur in D3D12 and the application must manually track back buffer indices.
