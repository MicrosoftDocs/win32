...
Certificate Services supports [*certificate requests*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) based on the PKCS \#10 format and the Keygen (Netscape) format. Certificate Services also supports PKCS \#7 renewal requests and Cryptographic Message Syntax (CMS) requests.
