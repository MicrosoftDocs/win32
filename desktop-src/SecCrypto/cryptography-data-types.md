...
| [**HCRYPTHASH**](hcrypthash.md)                                               | Specifies handles to a [*hash object*](https://msdn.microsoft.com/en-us/library/ms721586(v=VS.85).aspx).                                                                                      |
| [**HCRYPTKEY**](hcryptkey.md)                                                 | Specifies handles to cryptographic keys.                                                                                                                                                         |
| [**HCRYPTOIDFUNCADDR**](hcryptoidfuncaddr.md)                                 | Represents a handle to a function that can be installed by using an [*object identifier*](https://msdn.microsoft.com/en-us/library/ms721599(v=VS.85).aspx) (OID).                 |
...
| [**HCRYPTPROV\_OR\_NCRYPT\_KEY\_HANDLE**](hcryptprov-or-ncrypt-key-handle.md) | Specifies a handle to a CryptoAPI [*cryptographic service provider*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) (CSP) or CNG CSP. |
