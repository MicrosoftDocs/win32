...
| [**HCRYPTHASH**](hcrypthash.md)                                               | Specifies handles to a [*hash object*](security.h_gly#-security-hash-object-gly).                                                                                      |
| [**HCRYPTKEY**](hcryptkey.md)                                                 | Specifies handles to cryptographic keys.                                                                                                                                                         |
| [**HCRYPTOIDFUNCADDR**](hcryptoidfuncaddr.md)                                 | Represents a handle to a function that can be installed by using an [*object identifier*](security.o_gly#-security-object-identifier-gly) (OID).                 |
...
| [**HCRYPTPROV\_OR\_NCRYPT\_KEY\_HANDLE**](hcryptprov-or-ncrypt-key-handle.md) | Specifies a handle to a CryptoAPI [*cryptographic service provider*](security.c_gly#-security-cryptographic-service-provider-gly) (CSP) or CNG CSP. |
