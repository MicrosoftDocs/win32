...
| Section                                                                                                                                         | Contents                                                                                    |
|-------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| [Simplified Message Functions](https://www.bing.com/search?q=Simplified Message Functions)                                                         | Lists the simplified message functions.                                                     |
...
| [Encrypting a Message](https://msdn.microsoft.com/windows/desktop/1788b496-ad19-427e-be07-4aa68543fced)                                                                                           | Details the tasks needed to encrypt and decrypt a message.                                  |
| [Decrypting a Message](https://msdn.microsoft.com/windows/desktop/4858a43b-3084-4a03-8b6f-4a788cdb3dd5)                                                                                           | Details the tasks needed to decrypt a message.                                              |
