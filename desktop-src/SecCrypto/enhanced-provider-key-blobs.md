...
The Base Provider, Strong Provider, and Enhanced Provider use the same [*key BLOBs*](https://msdn.microsoft.com/library/ms721590(v=VS.85).aspx).
...
[*Public key BLOBs*](https://msdn.microsoft.com/library/ms721603(v=VS.85).aspx), type **PUBLICKEYBLOB**, are used to store [*public keys*](https://msdn.microsoft.com/library/ms721603(v=VS.85).aspx) outside a [*cryptographic service provider*](https://msdn.microsoft.com/library/ms721572(v=VS.85).aspx) (CSP). Extended provider public key BLOBs have the following format.
...
[*Private key BLOBs*](https://msdn.microsoft.com/library/ms721603(v=VS.85).aspx), type **PRIVATEKEYBLOB**, are used to store [*private keys*](https://msdn.microsoft.com/library/ms721603(v=VS.85).aspx) outside a CSP. Extended provider private key BLOBs have the following format.
