...
The Base Provider, Strong Provider, and Enhanced Provider use the same [*key BLOBs*](https://www.bing.com/search?q=*key BLOBs*).
...
[*Public key BLOBs*](https://www.bing.com/search?q=*Public key BLOBs*), type **PUBLICKEYBLOB**, are used to store [*public keys*](https://www.bing.com/search?q=*public keys*) outside a [*cryptographic service provider*](https://www.bing.com/search?q=*cryptographic service provider*) (CSP). Extended provider public key BLOBs have the following format.
...
[*Private key BLOBs*](https://www.bing.com/search?q=*Private key BLOBs*), type **PRIVATEKEYBLOB**, are used to store [*private keys*](https://www.bing.com/search?q=*private keys*) outside a CSP. Extended provider private key BLOBs have the following format.
...
[*Simple key BLOBs*](https://www.bing.com/search?q=*Simple key BLOBs*), type **SIMPLEBLOB**, are used to store and transport session keys outside a CSP. Extended provider simple key BLOBs are always encrypted with a [*key exchange public key*](https://www.bing.com/search?q=*key exchange public key*). The **pbData** member of the **SIMPLEBLOB** is a sequence of bytes in the following format.
