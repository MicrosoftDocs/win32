...
The Base Provider, Strong Provider, and Enhanced Provider use the same [*key BLOBs*](https://msdn.microsoft.com/en-us/library/ms721590(v=VS.85).aspx).
...
[*Public key BLOBs*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx), type **PUBLICKEYBLOB**, are used to store [*public keys*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx) outside a [*cryptographic service provider*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) (CSP). Extended provider public key BLOBs have the following format.
...
[*Private key BLOBs*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx), type **PRIVATEKEYBLOB**, are used to store [*private keys*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx) outside a CSP. Extended provider private key BLOBs have the following format.
...
[*Simple key BLOBs*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx), type **SIMPLEBLOB**, are used to store and transport session keys outside a CSP. Extended provider simple key BLOBs are always encrypted with a [*key exchange public key*](https://msdn.microsoft.com/en-us/library/ms721590(v=VS.85).aspx). The **pbData** member of the **SIMPLEBLOB** is a sequence of bytes in the following format.
