...
The following table lists the algorithms supported by the Microsoft [*Advanced Encryption Standard*](security.a_gly#-security-aes-gly) (AES) Cryptographic Provider.
