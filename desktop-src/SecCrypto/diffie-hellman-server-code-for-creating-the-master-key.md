...
The following example shows typical [*Diffie-Hellman*](security.d_gly#-security-diffie-hellman-algorithm-gly)/Schannel server-side code for creating a [*master key*](security.m_gly#-security-master-key-gly).
