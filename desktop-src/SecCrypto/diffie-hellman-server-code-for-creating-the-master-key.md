...
The following example shows typical [*Diffie-Hellman*](https://www.bing.com/search?q=*Diffie-Hellman*)/Schannel server-side code for creating a [*master key*](https://www.bing.com/search?q=*master key*).
