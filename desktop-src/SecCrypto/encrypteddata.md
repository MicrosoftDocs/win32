...
The **EncryptedData** object provides properties and methods to encrypt and decrypt data using a [*session key*](https://www.bing.com/search?q=*session key*) derived from a secret.
