...
The **EncryptedData** object provides properties and methods to encrypt and decrypt data using a [*session key*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) derived from a secret.
