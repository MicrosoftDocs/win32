...
The **EncryptedData** object provides properties and methods to encrypt and decrypt data using a [*session key*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx) derived from a secret.
