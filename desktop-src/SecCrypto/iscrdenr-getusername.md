...
<tbody>
<tr class="odd">
<td><pre><code>SCrdEnr.getUserName( _
  ByVal dwFlags, _
...
You can specify the name of the user to whom the [*smart card*](https://www.bing.com/search?q=*smart card*) is issued by calling either [**ISCrdEnr::setUserName**](iscrdenr-setusername.md) or [**ISCrdEnr::selectUserName**](iscrdenr-selectusername.md). After a user name has been specified, its value can be retrieved by calling **getUserName**.
