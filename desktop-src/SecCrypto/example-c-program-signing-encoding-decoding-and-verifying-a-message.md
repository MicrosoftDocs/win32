...
-   Adding the encoded [*BLOB*](https://msdn.microsoft.com/library/ms721569(v=VS.85).aspx) to the message to be decoded by using [**CryptMsgUpdate**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate).
...
-   Freeing memory, closing [*certificate stores*](https://msdn.microsoft.com/library/ms721572(v=VS.85).aspx), and freeing [*certificate context*](https://msdn.microsoft.com/library/ms721572(v=VS.85).aspx).
