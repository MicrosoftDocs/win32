...
| [Retrieving a Certificate Revocation List](retrieving-a-certificate-revocation-list.md)<br/>                                       | Information about retrieving a [*certificate revocation list*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) (CRL).<br/> |
