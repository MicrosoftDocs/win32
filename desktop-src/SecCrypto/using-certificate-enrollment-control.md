...
| Collecting the necessary information and submitting a [*certificate request*](security.c_gly#-security-certificate-request-gly) in different programming languages. | [Creating the Certificate Request](creating-the-certificate-request.md)                                                                   |
