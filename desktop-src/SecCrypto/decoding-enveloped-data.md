...
-   A pointer to the [*digitally enveloped*](https://www.bing.com/search?q=*digitally enveloped*) message is retrieved.
-   A [*certificate store*](https://www.bing.com/search?q=*certificate store*) is opened.
-   From the message, the recipient ID (My ID) is retrieved.
-   The recipient ID is used to retrieve the certificate.
-   The [*private key*](https://www.bing.com/search?q=*private key*) associated with that certificate is retrieved.
-   The private key is used to decrypt the [*symmetric*](https://www.bing.com/search?q=*symmetric*) ([*session*](https://www.bing.com/search?q=*session*)) key.
...
5.  Again call [**CryptMsgGetParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam), passing in CMSG\_INNER\_CONTENT\_TYPE\_PARAM to get the data type of the [*inner content*](https://www.bing.com/search?q=*inner content*).
