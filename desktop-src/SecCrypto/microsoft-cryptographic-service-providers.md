...
The following [*cryptographic service providers*](https://www.bing.com/search?q=*cryptographic service providers*) (CSP) are currently available from Microsoft.
...
| [Microsoft DSS Cryptographic Provider](microsoft-dss-cryptographic-provider.md)                                                         | Provides hashing, data signing, and signature verification capability using the Secure Hash Algorithm ([*SHA*](https://www.bing.com/search?q=*SHA*)) and Digital Signature Standard (DSS) algorithms. |
