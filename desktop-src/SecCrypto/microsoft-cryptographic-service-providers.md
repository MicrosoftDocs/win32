...
The following [*cryptographic service providers*](security.c_gly#-security-cryptographic-service-provider-gly) (CSP) are currently available from Microsoft.
...
| [Microsoft DSS Cryptographic Provider](microsoft-dss-cryptographic-provider.md)                                                         | Provides hashing, data signing, and signature verification capability using the Secure Hash Algorithm ([*SHA*](security.s_gly#-security-secure-hash-algorithm-gly)) and Digital Signature Standard (DSS) algorithms. |
