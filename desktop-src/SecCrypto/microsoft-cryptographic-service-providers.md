...
The following [*cryptographic service providers*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) (CSP) are currently available from Microsoft.
...
| [Microsoft DSS Cryptographic Provider](microsoft-dss-cryptographic-provider.md)                                                         | Provides hashing, data signing, and signature verification capability using the Secure Hash Algorithm ([*SHA*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx)) and Digital Signature Standard (DSS) algorithms. |
