...
-   A pointer to the [*plaintext*](https://www.bing.com/search?q=*plaintext*) message is retrieved.
-   A symmetric ([*session*](https://www.bing.com/search?q=*session*)) key is generated.
-   The [*symmetric key*](https://www.bing.com/search?q=*symmetric key*) and specified encryption algorithm are used to encrypt the message data.
...
-   The [*public key*](https://www.bing.com/search?q=*public key*) is retrieved from the recipient's certificate.
...
The result of this procedure is an encoded message that contains the encrypted data, the [*symmetric key*](https://www.bing.com/search?q=*symmetric key*) that is encrypted with the recipient's public keys, and the recipient information data structures. The combination of encrypted content and an encrypted symmetric key for a recipient is a [*digital envelope*](https://www.bing.com/search?q=*digital envelope*) for that recipient. Any type of content can be enveloped for multiple recipients.
