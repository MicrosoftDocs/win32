...
All normal [*RSA*](https://www.bing.com/search?q=*RSA*)/Schannel and [*Diffie-Hellman*](https://www.bing.com/search?q=*Diffie-Hellman*)/Schannel operations use the AT\_KEYEXCHANGE [*public/private key pair*](https://www.bing.com/search?q=*public/private key pair*). To provide server [*authentication*](https://www.bing.com/search?q=*authentication*), the server-side of Schannel operations must have access to its [*X.509*](https://www.bing.com/search?q=*X.509*) certificate containing its public key and access to the matching [*private key*](https://www.bing.com/search?q=*private key*). The client-side of [*Schannel*](https://www.bing.com/search?q=*Schannel*) needs its certificate with its public key and access to its private key if client authentication is implemented.
...
Diffie-Hellman supports only [*CALG\_DH\_EPHEM*](https://www.bing.com/search?q=*CALG\_DH\_EPHEM*) and uses normal RSA or DSS public keys.
