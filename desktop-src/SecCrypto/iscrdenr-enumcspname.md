...
The **enumCSPName** method enumerates the name of the available [*cryptographic service providers*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) (CSPs).
...
<tbody>
<tr class="odd">
<td><pre><code>SCrdEnr.enumCSPName( _
  ByVal dwIndex, _
  ByVal dwFlags, _
