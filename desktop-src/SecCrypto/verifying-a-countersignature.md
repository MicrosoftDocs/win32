...
4.  Call [**CryptMsgGetParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam) to retrieve the [*countersignature*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) from the message.
...
If the [**CryptMsgVerifyCountersignatureEncoded**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgverifycountersignatureencoded) function call succeeds, the [*countersignature*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) is verified.
