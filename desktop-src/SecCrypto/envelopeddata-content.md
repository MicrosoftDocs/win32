...
Setting this property must be done before the [**Encrypt**](envelopeddata-encrypt.md) method is called. When the value of this property is reset, directly or indirectly, the whole [*state*](https://www.bing.com/search?q=*state*) of the object is reset, and any encrypted content in the object is lost.
