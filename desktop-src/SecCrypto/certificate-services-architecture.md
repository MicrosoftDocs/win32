...
| Section                                      | Content                                                                                                                                                                                                                                                                    |
|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Policy Modules](policy-modules.md)         | Customizable programs that can be used during the evaluation of [*certificate requests*](https://www.bing.com/search?q=*certificate requests*); these programs enforce the rules by which Certificate Services issues or denies the request. |
