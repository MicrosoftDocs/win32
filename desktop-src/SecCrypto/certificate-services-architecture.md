...
| Section                                      | Content                                                                                                                                                                                                                                                                    |
|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Policy Modules](policy-modules.md)         | Customizable programs that can be used during the evaluation of [*certificate requests*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb); these programs enforce the rules by which Certificate Services issues or denies the request. |
