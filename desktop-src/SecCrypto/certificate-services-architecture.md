...
| Section                                      | Content                                                                                                                                                                                                                                                                    |
|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Policy Modules](policy-modules.md)         | Customizable programs that can be used during the evaluation of [*certificate requests*](https://msdn.microsoft.com/library/ms721572(v=VS.85).aspx); these programs enforce the rules by which Certificate Services issues or denies the request. |
