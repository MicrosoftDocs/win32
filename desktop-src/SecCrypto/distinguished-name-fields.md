...
A [*certificate request*](https://www.bing.com/search?q=*certificate request*) contains information that should uniquely identify the individual making the request.
...
| Country/region      | The [*X.500*](https://www.bing.com/search?q=*X.500*) Naming Scheme standard requires a 2-character country/region code. The country/region code for the United States is US; the country/region code for Canada is CA.                                                                                                                          |
