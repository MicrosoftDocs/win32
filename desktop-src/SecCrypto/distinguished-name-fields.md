...
A [*certificate request*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) contains information that should uniquely identify the individual making the request.
...
| Country/region      | The [*X.500*](https://msdn.microsoft.com/28dba6ef-939f-4789-9789-ee6e0fef0177) Naming Scheme standard requires a 2-character country/region code. The country/region code for the United States is US; the country/region code for Canada is CA.                                                                                                                          |
