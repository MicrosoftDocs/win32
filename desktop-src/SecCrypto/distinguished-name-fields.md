...
A [*certificate request*](security.c_gly#-security-certificate-request-gly) contains information that should uniquely identify the individual making the request.
...
| Country/region      | The [*X.500*](security.x_gly#-security-x-500-gly) Naming Scheme standard requires a 2-character country/region code. The country/region code for the United States is US; the country/region code for Canada is CA.                                                                                                                          |
