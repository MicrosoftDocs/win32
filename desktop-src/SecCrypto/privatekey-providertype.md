...
| <span id="CAPICOM_PROV_DSS_DH"></span><span id="capicom_prov_dss_dh"></span><dl> <dt>**CAPICOM\_PROV\_DSS\_DH**</dt> </dl>                       | The CSP that supports both [*Digital Signature Standard*](https://www.bing.com/search?q=*Digital Signature Standard*) (DSS) and [*Diffie-Hellman*](https://www.bing.com/search?q=*Diffie-Hellman*) protocols.<br/>                                                                                                                                                           |
...
| <span id="CAPICOM_PROV_RSA_AES"></span><span id="capicom_prov_rsa_aes"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_AES**</dt> </dl>                    | The CSP that supports both digital signatures and data encryption using the [*Advanced Encryption Standard*](https://www.bing.com/search?q=*Advanced Encryption Standard*) (AES) algorithm.<br/>                                                                                                                                                                                                                                                                           |
