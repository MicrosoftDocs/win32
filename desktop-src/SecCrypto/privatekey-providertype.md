...
| <span id="CAPICOM_PROV_DSS_DH"></span><span id="capicom_prov_dss_dh"></span><dl> <dt>**CAPICOM\_PROV\_DSS\_DH**</dt> </dl>                       | The CSP that supports both [*Digital Signature Standard*](https://msdn.microsoft.com/en-us/library/ms721573(v=VS.85).aspx) (DSS) and [*Diffie-Hellman*](https://msdn.microsoft.com/en-us/library/ms721573(v=VS.85).aspx) protocols.<br/>                                                                                                                                                           |
...
| <span id="CAPICOM_PROV_RSA_AES"></span><span id="capicom_prov_rsa_aes"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_AES**</dt> </dl>                    | The CSP that supports both digital signatures and data encryption using the [*Advanced Encryption Standard*](https://msdn.microsoft.com/en-us/library/ms721532(v=VS.85).aspx) (AES) algorithm.<br/>                                                                                                                                                                                                                                                                           |
