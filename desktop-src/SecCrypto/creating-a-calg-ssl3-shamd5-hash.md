...
1.  Using standard CryptoAPI methodology, create both a MD5 and a [*SHA*](https://www.bing.com/search?q=*SHA*) [*hash*](https://www.bing.com/search?q=*hash*) of the target data.
...
3.  Get a handle to a [*hash object*](https://www.bing.com/search?q=*hash object*) by calling [**CryptCreateHash**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatehash) with CALG\_SSL3\_SHAMD5 passed in the *Algid* parameter.
