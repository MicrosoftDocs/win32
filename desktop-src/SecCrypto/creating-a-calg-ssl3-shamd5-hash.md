...
3.  Get a handle to a [*hash object*](security.h_gly#-security-hash-object-gly) by calling [**CryptCreateHash**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatehash) with CALG\_SSL3\_SHAMD5 passed in the *Algid* parameter.
