...
If the [*key BLOB*](security.k_gly#-security-key-blob-gly) is encrypted, then everything but the [**PUBLICKEYSTRUC**](publickeystruc.md) portion of the BLOB is encrypted.
