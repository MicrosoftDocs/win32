...
The **Remove** method removes a [*certificate*](https://www.bing.com/search?q=*certificate*) from an open [*certificate store*](https://www.bing.com/search?q=*certificate store*). This method can only be used with a store that has been opened with read/write permission.
