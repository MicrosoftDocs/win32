...
A pointer to a [**SIGNER\_PROVIDER\_INFO**](signer-provider-info.md) structure that specifies the [*cryptographic service provider*](https://www.bing.com/search?q=*cryptographic service provider*) (CSP) and [*private key*](https://www.bing.com/search?q=*private key*) information used to create the digital signature.
