...
The following example enumerates the certificates in a [*certificate store*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx), displays the subject and user of each certificate, and converts the subject name from each certificate into its [*Abstract Syntax Notation One*](https://msdn.microsoft.com/en-us/library/ms721532(v=VS.85).aspx) (ASN.1) encoded form, and then back in to its decoded form.

This example shows the following tasks and [*CryptoAPI*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) functions:
