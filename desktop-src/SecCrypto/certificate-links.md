...
The functions [**CertAddCertificateLinkToStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddcertificatelinktostore), [**CertAddCRLLinkToStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddcrllinktostore), and [**CertAddCTLLinkToStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddctllinktostore) add links to existing contexts into [*certificate stores*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) rather than adding copies of those contexts. Adding links to stores makes the same physical [*certificate*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb), [*CRL*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb), or [*CTL*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) available through several different stores. Changes made to the extended properties of a [*context*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) from the store of the original context, or from a store where a link to that context is stored, are available in the store that holds the original context and in all other stores that have links to that context.
