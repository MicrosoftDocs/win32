...
The **Certificate** object represents a single [*digital certificate*](security.d_gly#-security-digital-certificate-gly).
...
| [**HasPrivateKey**](certificate-hasprivatekey.md)           | Determines whether the certificate has a [*private key*](security.p_gly#-security-private-key-gly) associated with it.<br/> (Inherited from **CertificateICertificate2ICertificate**)                                    |
