...
The **Certificate** object represents a single [*digital certificate*](https://www.bing.com/search?q=*digital certificate*).
...
| [**HasPrivateKey**](certificate-hasprivatekey.md)           | Determines whether the certificate has a [*private key*](https://www.bing.com/search?q=*private key*) associated with it.<br/> (Inherited from **CertificateICertificate2ICertificate**)                                    |
