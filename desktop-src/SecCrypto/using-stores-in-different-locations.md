...
The example shows exporting [*certificates*](https://www.bing.com/search?q=*certificates*) from an open [*store*](https://www.bing.com/search?q=*store*), writing the exported certificates to a file, reading them back in and importing them into a different store. The newly imported certificates are then enumerated and displayed.
