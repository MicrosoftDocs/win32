...
[*Certificates*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) can be added to or removed from [*certificate stores*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) if the store is opened with read/write permission. Read/write permission is not granted to Active Directory stores. While certificates can be added to or removed from memory stores, changes in memory stores are not persisted between sessions.
