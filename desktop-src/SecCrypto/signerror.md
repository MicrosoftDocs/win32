...
The **SignError** function calls the [**GetLastError**](https://msdn.microsoft.com/windows/desktop/d852e148-985c-416f-a5a7-27b6914b45d4) function and converts the return code to an **HRESULT**.
