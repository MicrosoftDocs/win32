...
The following example creates, signs, and envelopes a message, and it illustrates the following tasks and [*CryptoAPI*](https://www.bing.com/search?q=*CryptoAPI*) functions:
