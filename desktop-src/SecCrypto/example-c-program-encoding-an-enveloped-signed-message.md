...
The following example creates, signs, and envelopes a message, and it illustrates the following tasks and [*CryptoAPI*](https://msdn.microsoft.com/library/ms721572(v=VS.85).aspx) functions:
