...
The following table lists the default [*key lengths*](https://www.bing.com/search?q=*key lengths*) supported by the Base Provider and the Enhanced Provider for standard algorithms.
...
| [*Triple DES*](https://www.bing.com/search?q=*Triple DES*) (2-key) | Not supported | 112-bit                       |
...
[*DES*](https://www.bing.com/search?q=*DES*) and [*Triple DES*](https://www.bing.com/search?q=*Triple DES*) algorithms are supported in the Enhanced Provider.
