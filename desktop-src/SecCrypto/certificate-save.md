...
A string that contains the [*plaintext*](security.p_gly#-security-plaintext-gly) password for a [*private key*](security.p_gly#-security-private-key-gly) file. The password can contain up to 32 Unicode characters, including a terminating null character. For information about protecting the password, see [Handling Passwords](https://msdn.microsoft.com/1d810f71-9bf5-4c5c-a573-c35081f604cf).
