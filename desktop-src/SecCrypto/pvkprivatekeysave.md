...
The **PvkPrivateKeySave** function saves a [*private key*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx) and its corresponding [*public key*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx) to a specified file.
...
A handle to a [*cryptographic service provider*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) (CSP).
