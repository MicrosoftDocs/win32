...
| Section                                                                                                                            | Information                                                                                                                                                                             |
|------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Setting the Backup and Restore Privileges](setting-the-backup-and-restore-privileges.md)                                         | Setting the necessary [*privileges*](https://msdn.microsoft.com/2fe6cfd3-8a2e-4dbe-9fb8-332633daa97a) to call the Certificate Services backup and restore functions                      |
...
| [Backing Up and Restoring the Certificate Services Private Key](backing-up-and-restoring-the-certificate-services-private-key.md) | Backing up and restoring [*private keys*](https://msdn.microsoft.com/2fe6cfd3-8a2e-4dbe-9fb8-332633daa97a), which cannot be backed up or restored with the Certificate Services API. |
