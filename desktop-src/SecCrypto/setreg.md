...
| **3**  | Check the [*revocation list*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) | If **TRUE**, performs the revocation check. To bypass revocation check, set this flag to **FALSE**. The default is **TRUE**.**Internet Explorer 3.*x*:** The default is **FALSE**.<br/>                                                                                                                                                                                                                                               |
