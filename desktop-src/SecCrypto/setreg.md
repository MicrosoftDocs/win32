...
| **3**  | Check the [*revocation list*](https://www.bing.com/search?q=*revocation list*) | If **TRUE**, performs the revocation check. To bypass revocation check, set this flag to **FALSE**. The default is **TRUE**.**Internet Explorer 3.*x*:** The default is **FALSE**.<br/>                                                                                                                                                                                                                                               |
