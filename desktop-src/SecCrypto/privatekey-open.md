...
The **Open** method accesses an existing [*key container*](https://msdn.microsoft.com/library/ms721590(v=VS.85).aspx). This method associates the key container to the [*certificate*](https://msdn.microsoft.com/library/ms721572(v=VS.85).aspx) that corresponds to the [*private key*](https://msdn.microsoft.com/library/ms721603(v=VS.85).aspx) by adding the CERT\_KEY\_PROV\_INFO\_PROP\_ID property using the specified information.
...
| Value                                                                                                                                                                                                   | Meaning                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="CAPICOM_PROV_RSA_FULL"></span><span id="capicom_prov_rsa_full"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_FULL**</dt> </dl>                 | The full [*RSA*](https://msdn.microsoft.com/library/ms721604(v=VS.85).aspx) [*cryptographic service provider*](https://msdn.microsoft.com/library/ms721572(v=VS.85).aspx) (CSP). This provider type supports both [*digital signatures*](https://msdn.microsoft.com/library/ms721573(v=VS.85).aspx) and data [*encryption*](https://msdn.microsoft.com/library/ms721575(v=VS.85).aspx).<br/> |
| <span id="CAPICOM_PROV_RSA_SIG"></span><span id="capicom_prov_rsa_sig"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_SIG**</dt> </dl>                    | The subset of the RSA CSP that supports only those functions and algorithms that are required for [*hashes*](https://msdn.microsoft.com/library/ms721586(v=VS.85).aspx) and [*digital signatures*](https://msdn.microsoft.com/library/ms721573(v=VS.85).aspx).<br/>                                                                                                                                                                              |
| <span id="CAPICOM_PROV_DSS"></span><span id="capicom_prov_dss"></span><dl> <dt>**CAPICOM\_PROV\_DSS**</dt> </dl>                                 | The [*Digital Signature Standard*](https://msdn.microsoft.com/library/ms721573(v=VS.85).aspx) (DSS) CSP. This provider type supports only hashes and digital signatures. DSS uses the [*Digital Signature Algorithm*](https://msdn.microsoft.com/library/ms721573(v=VS.85).aspx) (DSA).<br/>                                                                                     |
| <span id="CAPICOM_PROV_FORTEZZA"></span><span id="capicom_prov_fortezza"></span><dl> <dt>**CAPICOM\_PROV\_FORTEZZA**</dt> </dl>                  | The CSP that contains the cryptographic protocols and algorithms owned by the [*National Institute of Standards and Technology*](https://msdn.microsoft.com/library/ms721596(v=VS.85).aspx) (NIST).<br/>                                                                                                                                                                          |
...
| <span id="CAPICOM_PROV_SSL"></span><span id="capicom_prov_ssl"></span><dl> <dt>**CAPICOM\_PROV\_SSL**</dt> </dl>                                 | The CSP that supports the [*Secure Sockets Layer*](https://msdn.microsoft.com/library/ms721625(v=VS.85).aspx) (SSL) protocol.<br/>                                                                                                                                                                                                                                                                                  |
| <span id="CAPICOM_PROV_RSA_SCHANNEL"></span><span id="capicom_prov_rsa_schannel"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_SCHANNEL**</dt> </dl>     | The CSP that supports both RSA and [*Schannel*](https://msdn.microsoft.com/library/ms721625(v=VS.85).aspx) protocols.<br/>                                                                                                                                                                                                                                                                                                                                    |
| <span id="CAPICOM_PROV_DSS_DH"></span><span id="capicom_prov_dss_dh"></span><dl> <dt>**CAPICOM\_PROV\_DSS\_DH**</dt> </dl>                       | The CSP that supports both DSS and [*Diffie-Hellman*](https://msdn.microsoft.com/library/ms721573(v=VS.85).aspx) protocols.<br/>                                                                                                                                                                                                                                                                                              |
...
| <span id="CAPICOM_PROV_DH_SCHANNEL"></span><span id="capicom_prov_dh_schannel"></span><dl> <dt>**CAPICOM\_PROV\_DH\_SCHANNEL**</dt> </dl>        | The CSP that supports both [*Diffie-Hellman*](https://msdn.microsoft.com/library/ms721573(v=VS.85).aspx) and [*Schannel*](https://msdn.microsoft.com/library/ms721625(v=VS.85).aspx) protocols.<br/>                                                                                                                                                                                                                       |
...
| <span id="CAPICOM_PROV_RSA_AES"></span><span id="capicom_prov_rsa_aes"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_AES**</dt> </dl>                    | The CSP that supports both digital signatures and data encryption using the Advanced Encryption Standard ([*AES*](https://msdn.microsoft.com/library/ms721532(v=VS.85).aspx)) algorithm.<br/>                                                                                                                                                                                                                                                                           |
