...
The **Open** method accesses an existing [*key container*](https://www.bing.com/search?q=*key container*). This method associates the key container to the [*certificate*](https://www.bing.com/search?q=*certificate*) that corresponds to the [*private key*](https://www.bing.com/search?q=*private key*) by adding the CERT\_KEY\_PROV\_INFO\_PROP\_ID property using the specified information.
...
| Value                                                                                                                                                                                                   | Meaning                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="CAPICOM_PROV_RSA_FULL"></span><span id="capicom_prov_rsa_full"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_FULL**</dt> </dl>                 | The full [*RSA*](https://www.bing.com/search?q=*RSA*) [*cryptographic service provider*](https://www.bing.com/search?q=*cryptographic service provider*) (CSP). This provider type supports both [*digital signatures*](https://www.bing.com/search?q=*digital signatures*) and data [*encryption*](https://www.bing.com/search?q=*encryption*).<br/> |
| <span id="CAPICOM_PROV_RSA_SIG"></span><span id="capicom_prov_rsa_sig"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_SIG**</dt> </dl>                    | The subset of the RSA CSP that supports only those functions and algorithms that are required for [*hashes*](https://www.bing.com/search?q=*hashes*) and [*digital signatures*](https://www.bing.com/search?q=*digital signatures*).<br/>                                                                                                                                                                              |
| <span id="CAPICOM_PROV_DSS"></span><span id="capicom_prov_dss"></span><dl> <dt>**CAPICOM\_PROV\_DSS**</dt> </dl>                                 | The [*Digital Signature Standard*](https://www.bing.com/search?q=*Digital Signature Standard*) (DSS) CSP. This provider type supports only hashes and digital signatures. DSS uses the [*Digital Signature Algorithm*](https://www.bing.com/search?q=*Digital Signature Algorithm*) (DSA).<br/>                                                                                     |
| <span id="CAPICOM_PROV_FORTEZZA"></span><span id="capicom_prov_fortezza"></span><dl> <dt>**CAPICOM\_PROV\_FORTEZZA**</dt> </dl>                  | The CSP that contains the cryptographic protocols and algorithms owned by the [*National Institute of Standards and Technology*](https://www.bing.com/search?q=*National Institute of Standards and Technology*) (NIST).<br/>                                                                                                                                                                          |
...
| <span id="CAPICOM_PROV_SSL"></span><span id="capicom_prov_ssl"></span><dl> <dt>**CAPICOM\_PROV\_SSL**</dt> </dl>                                 | The CSP that supports the [*Secure Sockets Layer*](https://www.bing.com/search?q=*Secure Sockets Layer*) (SSL) protocol.<br/>                                                                                                                                                                                                                                                                                  |
| <span id="CAPICOM_PROV_RSA_SCHANNEL"></span><span id="capicom_prov_rsa_schannel"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_SCHANNEL**</dt> </dl>     | The CSP that supports both RSA and [*Schannel*](https://www.bing.com/search?q=*Schannel*) protocols.<br/>                                                                                                                                                                                                                                                                                                                                    |
| <span id="CAPICOM_PROV_DSS_DH"></span><span id="capicom_prov_dss_dh"></span><dl> <dt>**CAPICOM\_PROV\_DSS\_DH**</dt> </dl>                       | The CSP that supports both DSS and [*Diffie-Hellman*](https://www.bing.com/search?q=*Diffie-Hellman*) protocols.<br/>                                                                                                                                                                                                                                                                                              |
...
| <span id="CAPICOM_PROV_DH_SCHANNEL"></span><span id="capicom_prov_dh_schannel"></span><dl> <dt>**CAPICOM\_PROV\_DH\_SCHANNEL**</dt> </dl>        | The CSP that supports both [*Diffie-Hellman*](https://www.bing.com/search?q=*Diffie-Hellman*) and [*Schannel*](https://www.bing.com/search?q=*Schannel*) protocols.<br/>                                                                                                                                                                                                                       |
...
| <span id="CAPICOM_PROV_RSA_AES"></span><span id="capicom_prov_rsa_aes"></span><dl> <dt>**CAPICOM\_PROV\_RSA\_AES**</dt> </dl>                    | The CSP that supports both digital signatures and data encryption using the Advanced Encryption Standard ([*AES*](https://www.bing.com/search?q=*AES*)) algorithm.<br/>                                                                                                                                                                                                                                                                           |
