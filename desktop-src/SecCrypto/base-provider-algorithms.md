...
|-------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CALG\_MD2<br/>          | MD2 hashing algorithm<br/>                                                                                                                                          | For more information, see [*MD2 algorithm*](security.m_gly#-security-md2-algorithm-gly).<br/>                                         |
| CALG\_MD5<br/>          | MD5 hashing algorithm<br/>                                                                                                                                          | For more information, see [*MD5 algorithm*](security.m_gly#-security-md5-algorithm-gly).<br/>                                         |
| CALG\_SHA<br/>          | SHA hashing algorithm<br/>                                                                                                                                          | For more information, see [*Secure Hash Algorithm*](security.s_gly#-security-secure-hash-algorithm-gly).<br/>                 |
| CALG\_SHA1<br/>         | Same as CALG\_SHA<br/>                                                                                                                                              | For more information, see [*Secure Hash Algorithm*](security.s_gly#-security-secure-hash-algorithm-gly).<br/>                 |
| CALG\_MAC<br/>          | [*Message Authentication Code*](security.m_gly#-security-message-authentication-code-gly) (MAC) keyed-hash algorithm<br/> | Block cipher MAC.<br/>                                                                                                                                            |
...
| CALG\_DES<br/>          | DES encryption<br/>                                                                                                                                                 | For more information, see [*Data Encryption Standard*](security.d_gly#-security-data-encryption-standard-gly) (DES).<br/>  |
