...
|-------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CALG\_MD2<br/>          | MD2 hashing algorithm<br/>                                                                                                                                          | For more information, see [*MD2 algorithm*](https://www.bing.com/search?q=*MD2 algorithm*).<br/>                                         |
| CALG\_MD5<br/>          | MD5 hashing algorithm<br/>                                                                                                                                          | For more information, see [*MD5 algorithm*](https://www.bing.com/search?q=*MD5 algorithm*).<br/>                                         |
| CALG\_SHA<br/>          | SHA hashing algorithm<br/>                                                                                                                                          | For more information, see [*Secure Hash Algorithm*](https://www.bing.com/search?q=*Secure Hash Algorithm*).<br/>                 |
| CALG\_SHA1<br/>         | Same as CALG\_SHA<br/>                                                                                                                                              | For more information, see [*Secure Hash Algorithm*](https://www.bing.com/search?q=*Secure Hash Algorithm*).<br/>                 |
| CALG\_MAC<br/>          | [*Message Authentication Code*](https://www.bing.com/search?q=*Message Authentication Code*) (MAC) keyed-hash algorithm<br/> | Block cipher MAC.<br/>                                                                                                                                            |
...
| CALG\_DES<br/>          | DES encryption<br/>                                                                                                                                                 | For more information, see [*Data Encryption Standard*](https://www.bing.com/search?q=*Data Encryption Standard*) (DES).<br/>  |
