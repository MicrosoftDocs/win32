...
The Base Provider and Extended Provider use the same [*key BLOBs*](https://msdn.microsoft.com/en-us/library/ms721590(v=VS.85).aspx).
...
[*Private key BLOBs*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx), type **PRIVATEKEYBLOB**, are used to store [*private keys*](https://msdn.microsoft.com/en-us/library/ms721603(v=VS.85).aspx) outside a CSP. Base provider private key BLOBs have the following format.
