...
The Base Provider and Extended Provider use the same [*key BLOBs*](https://www.bing.com/search?q=*key BLOBs*).
...
[*Public key BLOBs*](https://www.bing.com/search?q=*Public key BLOBs*), type **PUBLICKEYBLOB**, are used to store [*public keys*](https://www.bing.com/search?q=*public keys*) outside a [*cryptographic service provider*](https://www.bing.com/search?q=*cryptographic service provider*) (CSP). Base provider public key BLOBs have the following format.
...
[*Private key BLOBs*](https://www.bing.com/search?q=*Private key BLOBs*), type **PRIVATEKEYBLOB**, are used to store [*private keys*](https://www.bing.com/search?q=*private keys*) outside a CSP. Base provider private key BLOBs have the following format.
