...
| dhpubkeyver3 | A [**DHPUBKEY\_VER3**](/windows/desktop/api/Wincrypt/ns-wincrypt-_pubkeyver3) structure. The **magic** member should be set to 0x33484400 for public keys. Notice that the hexadecimal value is just an [*ASCII*](https://msdn.microsoft.com/en-us/library/ms721532(v=VS.85).aspx) encoding of "DH3".                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| Q            | The Q value is located directly after the P value and should always be the length in bytes of the [**DHPUBKEY\_VER3**](/windows/desktop/api/Wincrypt/ns-wincrypt-_pubkeyver3) **bitlenQ** field divided by eight ([*little-endian*](https://msdn.microsoft.com/en-us/library/ms721592(v=VS.85).aspx) format). If the bitlenQ value is 0, then the value is absent from the BLOB.                                                                                                                                                                                                                                                                                                                                                                 |
...
| J            | The J value is located directly after the G value and should always be the length in bytes of the [**DHPUBKEY\_VER3**](/windows/desktop/api/Wincrypt/ns-wincrypt-_pubkeyver3) **bitlenJ** field divided by eight ([*little-endian*](https://msdn.microsoft.com/en-us/library/ms721592(v=VS.85).aspx) format). If the bitlenQ value is 0, then the value is absent from the BLOB.                                                                                                                                                                                                                                                                                                                                                                 |
