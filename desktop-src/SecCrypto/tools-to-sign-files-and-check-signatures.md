...
| Tool                     | Remarks                                                                                                                                                                                                                                                                            |
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [MakeCat](makecat.md)   | Makes an unsigned catalog file. This catalog file is subsequently used to compare the [*hashes*](https://msdn.microsoft.com/library/ms721586(v=VS.85).aspx) within the catalog file to the hashes of individual files, which helps prove that the original files are free of tampering. |
