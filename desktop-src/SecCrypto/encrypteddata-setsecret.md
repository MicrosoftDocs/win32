...
The **SetSecret** method sets the value of the secret used to derive the cryptographic [*session key*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) used to encrypt and decrypt data.
