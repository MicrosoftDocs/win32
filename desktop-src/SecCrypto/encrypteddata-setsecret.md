...
The **SetSecret** method sets the value of the secret used to derive the cryptographic [*session key*](https://www.bing.com/search?q=*session key*) used to encrypt and decrypt data.
