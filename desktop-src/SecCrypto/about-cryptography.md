...
| Section                                                                | Description                                                                                                                                                                                                                                   |
|------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Cryptography Essentials](cryptography-essentials.md)                 | Information about services that enable developers to add, to applications, security based on [*cryptography*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx).                                                          |
...
| [Cryptographic Service Providers](cryptographic-service-providers.md) | Information about [*Cryptographic Service Providers*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) (CSP) that contain implementations of cryptographic standards and algorithms. |
