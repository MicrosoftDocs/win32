...
| Section                                                                | Description                                                                                                                                                                                                                                   |
|------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Cryptography Essentials](cryptography-essentials.md)                 | Information about services that enable developers to add, to applications, security based on [*cryptography*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb).                                                          |
...
| [Cryptographic Service Providers](cryptographic-service-providers.md) | Information about [*Cryptographic Service Providers*](https://msdn.microsoft.com/db46def4-bfdc-4801-a57d-d568e94a2dbb) (CSP) that contain implementations of cryptographic standards and algorithms. |
