...
| Section                                                                | Description                                                                                                                                                                                                                                   |
|------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Cryptography Essentials](cryptography-essentials.md)                 | Information about services that enable developers to add, to applications, security based on [*cryptography*](security.c_gly#-security-cryptography-gly).                                                          |
...
| [Cryptographic Service Providers](cryptographic-service-providers.md) | Information about [*Cryptographic Service Providers*](security.c_gly#-security-cryptographic-service-provider-gly) (CSP) that contain implementations of cryptographic standards and algorithms. |
