...
The following example gets and sets certificate properties, and illustrates the following tasks and [*CryptoAPI*](https://www.bing.com/search?q=*CryptoAPI*) functions.
...
-   Setting the [*enhanced key usage*](https://www.bing.com/search?q=*enhanced key usage*) property on certificates by using the [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier) function.
