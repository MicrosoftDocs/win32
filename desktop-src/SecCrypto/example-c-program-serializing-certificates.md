...
-   Creating a serialized form of a [*certificate context*](security.c_gly#-security-certificate-context-gly) and its properties using [**CertSerializeCertificateStoreElement**](/windows/desktop/api/Wincrypt/nf-wincrypt-certserializecertificatestoreelement).
