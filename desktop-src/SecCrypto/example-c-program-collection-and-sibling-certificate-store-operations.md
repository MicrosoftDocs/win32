...
This example uses the **CreateMyDACL** function, defined in the [Creating a DACL](security.creating_a_dacl) topic, to ensure the open file is created with a proper DACL.
