...
The following procedures create a signed [*certificate trust list*](https://www.bing.com/search?q=*certificate trust list*) (CTL) and save it to a [*certificate store*](https://www.bing.com/search?q=*certificate store*).

**To create and sign a CTL**

1.  Create an array of items to be stored in the [*CTL*](https://www.bing.com/search?q=*CTL*). In the case of trusted certificates, this must be the SHA1 or MD5 hashes of the trusted certificates.
