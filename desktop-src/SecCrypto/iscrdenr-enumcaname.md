...
The **enumCAName** method enumerates the name of the [*certification authorities*](https://www.bing.com/search?q=*certification authorities*) (CAs) for a given certificate template name.
