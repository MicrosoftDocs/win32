...
The **PvkGetCryptProv** function gets a handle to a [*cryptographic service provider*](https://www.bing.com/search?q=*cryptographic service provider*) (CSP) based on either a [*private key*](https://www.bing.com/search?q=*private key*) file or a key container name.
