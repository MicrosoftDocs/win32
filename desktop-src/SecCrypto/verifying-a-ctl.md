...
To make it more difficult for an interloper to substitute a bogus [*certificate trust list*](https://www.bing.com/search?q=*certificate trust list*) (CTL) for an existing one, verify the signature on the CTL each time the CTL is used. Do not use a CTL that does not contain a trusted signature.

**To verify a CTL signature**

1.  Open the [*certificate store*](https://www.bing.com/search?q=*certificate store*) containing the desired CTL.
