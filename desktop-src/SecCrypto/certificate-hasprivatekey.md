...
title: ICertificate2HasPrivateKey method
ms.date: 05/31/2018
ms.topic: article
...
The **HasPrivateKey** method determines whether the [*certificate*](security.c_gly#-security-certificate-gly) has a [*private key*](security.p_gly#-security-private-key-gly) associated with it. The method determines this by checking whether the CERT\_KEY\_PROV\_INFO\_PROP\_ID property is present.
