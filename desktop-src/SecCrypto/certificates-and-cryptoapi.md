...
[*CryptoAPI*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) supports using X.509 certificates as defined in [IETF RFC 3280](https://go.microsoft.com/fwlink/p/?linkid=104367). This documentation assumes the use of an X.509 or comparable [*digital certificate*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx).
