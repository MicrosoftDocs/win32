...
The base cryptographic functions use [*certificates*](https://www.bing.com/search?q=*certificates*), and [*low-level message functions*](https://www.bing.com/search?q=*low-level message functions*) and [*simplified message functions*](https://www.bing.com/search?q=*simplified message functions*) also use them. To send or receive messages that incorporate certificates, use low-level message functions.
