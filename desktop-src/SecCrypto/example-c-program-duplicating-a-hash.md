...
The following example creates and duplicates a [*hash*](https://www.bing.com/search?q=*hash*) of some text. It then adds additional text to the original hash and different text to the duplicate.
