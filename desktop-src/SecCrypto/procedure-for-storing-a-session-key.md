...
For an example of creating a [*session key*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) and exporting that key to a [*simple key BLOB*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) that can be written to a disk file, see [Example C Program: Exporting a Session Key](example-c-program-exporting-a-session-key.md).
...
The new session key can be encrypted with the original user's [*public key*](https://msdn.microsoft.com/2fe6cfd3-8a2e-4dbe-9fb8-332633daa97a) [*exchange key*](https://msdn.microsoft.com/f1caccd2-3453-448e-b194-bf899eff8091), and this new key can be substituted for the original. If the user unknowingly used the substituted session key to encrypt files and messages, the individual who created the substitute key could easily decrypt them.
