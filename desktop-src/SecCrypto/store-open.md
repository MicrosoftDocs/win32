...
\[The **Open** method is available for use in the operating systems specified in the Requirements section. Instead, use the [**X509Store Class**](T:System.Security.Cryptography.X509Certificates.X509Store) in the [**System.Security.Cryptography.X509Certificates**](frlrfSystemSecurityCryptographyX509Certificates) namespace.\]

The **Open** method opens a specified [*certificate store*](security.c_gly#-security-certificate-store-gly). By default, the CAPICOM\_CURRENT\_USER\_STORE location and CAPICOM\_MY\_STORE store are opened as read-only.
