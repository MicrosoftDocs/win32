...
The **FuncVerifyImage** callback function is used by a [*cryptographic service provider*](https://www.bing.com/search?q=*cryptographic service provider*) (CSP) to verify the signature of a DLL.
