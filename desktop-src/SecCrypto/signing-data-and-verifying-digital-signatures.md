...
Signing data and verification of signatures on data are among the most important tasks done with [*cryptography*](security.c_gly#-security-cryptography-gly). The following sections show examples for digital signature tasks:
