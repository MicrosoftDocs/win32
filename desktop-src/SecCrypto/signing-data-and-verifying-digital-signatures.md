...
Signing data and verification of signatures on data are among the most important tasks done with [*cryptography*](https://www.bing.com/search?q=*cryptography*). The following sections show examples for digital signature tasks:
