...
Both the Base Provider and the Extended Provider can specify the value and length of the [*salt value*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) to be used. The Base Provider sets a salt value using the KP\_SALT parameter value. The Base Provider always sets eleven bytes of salt value.
...
> [!Note]  
> The total length of an Enhanced Provider [*symmetric key*](https://msdn.microsoft.com/3e9d7672-2314-45c8-8178-5a0afcfd0c50) and its salt value cannot be greater than 128 bits.
