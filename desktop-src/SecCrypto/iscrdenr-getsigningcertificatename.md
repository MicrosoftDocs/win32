...
A pointer to a string that returns the name of the signing certificate. The signing certificate will be used to sign the [*certificate request*](https://www.bing.com/search?q=*certificate request*).
...
A string that represents the name of the signing certificate. The signing certificate will be used to sign the [*certificate request*](https://www.bing.com/search?q=*certificate request*).
