...
1.  Load the Certadm.dll library into memory (by calling [**LoadLibrary**](https://msdn.microsoft.com/windows/desktop/d936b4dd-058c-48e1-834b-b47ef6d8ef65)).
2.  Retrieve the address of each of the necessary functions in Certadm.dll (by means of [**GetProcAddress**](https://msdn.microsoft.com/windows/desktop/a0d7fc09-f888-4f46-a571-d3719a627597)). Use these addresses when calling the functions in the remaining steps.
...
16. Release the Certadm.dll resources by calling [**FreeLibrary**](https://msdn.microsoft.com/windows/desktop/823d3147-4ba8-4fe5-ade4-e5604f47eb0a).
