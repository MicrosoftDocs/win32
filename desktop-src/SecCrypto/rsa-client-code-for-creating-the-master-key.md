...
The following example shows typical RSA/Schannel client-side code for creating a [*master key*](https://msdn.microsoft.com/en-us/library/ms721594(v=VS.85).aspx).
