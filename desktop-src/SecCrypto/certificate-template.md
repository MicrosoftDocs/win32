...
title: ICertificate2Template method
ms.date: 05/31/2018
ms.topic: article
...
The **Template** method returns the template that is associated with the certificate. This method is introduced in CAPICOM 2.0.
