...
The following example creates a named [*key container*](https://msdn.microsoft.com/en-us/library/ms721590(v=VS.85).aspx) and adds a [*signature key pair*](https://msdn.microsoft.com/en-us/library/ms721625(v=VS.85).aspx) and an [*exchange key pair*](https://msdn.microsoft.com/en-us/library/ms721575(v=VS.85).aspx) to the container. This example can be run without problem even if the named key container and cryptographic keys already exist.
