...
Policy modules can call methods from [**ICertServerPolicy**](/windows/desktop/api/Certif/nn-certif-icertserverpolicy) to assist in the processing of a [*certificate request*](security.c_gly#-security-certificate-request-gly); **ICertServerPolicy** allows properties and certificate extensions to be set and retrieved.
