...
The **Add** method adds a [**Certificate**](certificate.md) object to an open [*certificate store*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx). This method can only be used with a store that has been opened with read/write permission.
