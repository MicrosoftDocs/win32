...
| Function | Description | 
|----------|-------------|
| [**CryptAcquireContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Acquires a handle to the current user's [**key container**](/windows/desktop/SecGloss/k-gly) within a particular CSP. | 
| [**CryptContextAddRef**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcontextaddref) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Increments the [**reference count**](/windows/desktop/SecGloss/r-gly) on an [**HCRYPTPROV**](hcryptprov.md) handle. | 
| [**CryptEnumProviders**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumprovidersa) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Enumerates the providers on a computer. | 
| [**CryptEnumProviderTypes**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumprovidertypesa) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Enumerates the types of providers supported on the computer. | 
| [**CryptGetDefaultProvider**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetdefaultprovidera) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Determines the default CSP either for the current user or for the computer for a specified provider type. | 
| [**CryptGetProvParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetprovparam) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Retrieves the parameters that govern the operations of a CSP. | 
| [**CryptInstallDefaultContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptinstalldefaultcontext) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Installs a previously acquired [**HCRYPTPROV**](hcryptprov.md) context to be used as a default context. | 
| [**CryptReleaseContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptreleasecontext) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Releases the handle acquired by the [**CryptAcquireContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta) function. | 
| [**CryptSetProvider**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetprovidera) and [**CryptSetProviderEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetproviderexa) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Specifies the user default CSP for a particular CSP type. | 
| [**CryptSetProvParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetprovparam) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Specifies attributes of a CSP. | 
| [**CryptUninstallDefaultContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptuninstalldefaultcontext) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Removes a default context previously installed by [**CryptInstallDefaultContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptinstalldefaultcontext). | 
| <a href="freecryptprovfromcertex.md"><strong>FreeCryptProvFromCertEx</strong></a> | Releases the handle either to a <a href="/windows/desktop/SecGloss/c-gly"><em>cryptographic service provider</em></a> (CSP) or to a Cryptography API: Next Generation (CNG) key. | 
...
| Function | Description | 
|----------|-------------|
| [**CryptDeriveKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptderivekey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Creates a key derived from a password. | 
| [**CryptDestroyKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdestroykey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Destroys a key. | 
| [**CryptDuplicateKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptduplicatekey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Makes an exact copy of a key, including the [**state**](/windows/desktop/SecGloss/s-gly) of the key. | 
| [**CryptExportKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptexportkey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Transfers a key from the CSP into a [**key BLOB**](/windows/desktop/SecGloss/k-gly) in the application's memory space. | 
| [**CryptGenKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgenkey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Creates a random key. | 
| [**CryptGenRandom**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgenrandom) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Generates random data. | 
| [**CryptGetKeyParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyparam) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Retrieves a key's parameters. | 
| [**CryptGetUserKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetuserkey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Gets a handle to the key exchange or signature key. | 
| [**CryptImportKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptimportkey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Transfers a key from a [**key BLOB**](/windows/desktop/SecGloss/k-gly) to a CSP. | 
| [**CryptSetKeyParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyparam) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Specifies a key's parameters. | 
...
| Function | Description | 
|----------|-------------|
| [**CryptDecrypt**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecrypt) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Decrypts a section of [**ciphertext**](/windows/desktop/SecGloss/c-gly) by using the specified encryption key. | 
| [**CryptEncrypt**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencrypt) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Encrypts a section of [**plaintext**](/windows/desktop/SecGloss/p-gly) by using the specified encryption key. | 
| <a href="/windows/desktop/api/Dpapi/nf-dpapi-cryptprotectdata"><strong>CryptProtectData</strong></a> | Performs encryption on the data in a <a href="/previous-versions/windows/desktop/legacy/aa381414(v=vs.85)"><strong>DATA_BLOB</strong></a> structure. | 
| <a href="/windows/desktop/api/Dpapi/nf-dpapi-cryptprotectmemory"><strong>CryptProtectMemory</strong></a> | Encrypts memory to protect sensitive information. | 
| <a href="/windows/desktop/api/Dpapi/nf-dpapi-cryptunprotectdata"><strong>CryptUnprotectData</strong></a> | Performs a decryption and integrity check of the data in a <a href="/previous-versions/windows/desktop/legacy/aa381414(v=vs.85)"><strong>DATA_BLOB</strong></a>. | 
| <a href="/windows/desktop/api/Dpapi/nf-dpapi-cryptunprotectmemory"><strong>CryptUnprotectMemory</strong></a> | Decrypts memory that was encrypted using <a href="/windows/desktop/api/Dpapi/nf-dpapi-cryptprotectmemory"><strong>CryptProtectMemory</strong></a>. | 
...
| Function | Description | 
|----------|-------------|
| [**CryptCreateHash**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatehash) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Creates an empty hash object. | 
| [**CryptDestroyHash**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdestroyhash) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Destroys a hash object. | 
| <a href="/windows/desktop/api/Wincrypt/nf-wincrypt-cryptduplicatehash"><strong>CryptDuplicateHash</strong></a> | Duplicates a hash object. | 
| <a href="/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgethashparam"><strong>CryptGetHashParam</strong></a> | Retrieves a hash object parameter. | 
| [**CryptHashData**](/windows/desktop/api/Wincrypt/nf-wincrypt-crypthashdata) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Hashes a block of data, adding it to the specified hash object. | 
| [**CryptHashSessionKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-crypthashsessionkey) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Hashes a session key, adding it to the specified hash object. | 
| [**CryptSetHashParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsethashparam) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Sets a hash object parameter. | 
| [**CryptSignHash**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignhasha) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Signs the specified hash object. | 
...
| [**CryptVerifySignature**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptverifysignaturea) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Verifies a digital signature, given a handle to the hash object. | 
...
| [**CryptHashCertificate**](/windows/desktop/api/Wincrypt/nf-wincrypt-crypthashcertificate) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Hashes the encoded content. | 
...
| [**CryptHashPublicKeyInfo**](/windows/desktop/api/Wincrypt/nf-wincrypt-crypthashpublickeyinfo) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Computes the hash of the encoded public key information. | 
| [**CryptHashToBeSigned**](/windows/desktop/api/Wincrypt/nf-wincrypt-crypthashtobesigned) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Computes the hash of the "to be signed" information in the encoded signed content ([**CERT_SIGNED_CONTENT_INFO**](/windows/desktop/api/Wincrypt/ns-wincrypt-cert_signed_content_info)). | 
| [**CryptImportPKCS8**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptimportpkcs8) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Imports the [**private key**](/windows/desktop/SecGloss/p-gly) in PKCS #8 format to a [**cryptographic service provider**](/windows/desktop/SecGloss/c-gly) (CSP). | 
| [**CryptImportPublicKeyInfo**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptimportpublickeyinfo) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Converts and imports public key information into the provider, and returns a handle of the public key. | 
| [**CryptImportPublicKeyInfoEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptimportpublickeyinfoex) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Converts and imports the public key information into the provider, and returns a handle of the public key. Additional parameters (over those specified by [**CryptImportPublicKeyInfo**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptimportpublickeyinfo)) that can be used to override defaults are provided to supplement [**CERT_PUBLIC_KEY_INFO**](/windows/desktop/api/Wincrypt/ns-wincrypt-cert_public_key_info). | 
...
| [**CryptQueryObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptqueryobject) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Retrieves information about the content of a BLOB or a file. | 
...
| Function | Description | 
|----------|-------------|
| [**CryptCreateKeyIdentifierFromCSP**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatekeyidentifierfromcsp) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Creates a key identifier from a CSP's [**public key BLOB**](/windows/desktop/SecGloss/p-gly). | 
...
| [**CryptGetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyidentifierproperty) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Acquires a specific property from a specified key identifier. | 
| [**CryptSetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyidentifierproperty) |  **Important:** <br>This API is deprecated. New and existing software should start using [Cryptography Next Generation APIs.](/windows/desktop/SecCNG/cng-portal) Microsoft may remove this API in future releases.<br> Sets a property of a specified key identifier. | 
