...
The Microsoft [*Diffie-Hellman*](https://www.bing.com/search?q=*Diffie-Hellman*)/[*Schannel*](https://www.bing.com/search?q=*Schannel*) Cryptographic Provider supports the following algorithms.



| Algorithm ID                  | Description                                                                                                                                           | Comments                                                                                                   |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| CALG\_DH\_SF                  | Diffie-Hellman store and forward [*key exchange algorithm*](https://www.bing.com/search?q=*key exchange algorithm*) | Key length: Can be set, 384 bits to 512 bits in 8 bit increments. Default key length: 512 bits.<br/> |
