...
The Microsoft [*Diffie-Hellman*](security.d_gly#-security-diffie-hellman-algorithm-gly)/[*Schannel*](security.s_gly#-security-schannel-gly) Cryptographic Provider supports the following algorithms.



| Algorithm ID                  | Description                                                                                                                                           | Comments                                                                                                   |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| CALG\_DH\_SF                  | Diffie-Hellman store and forward [*key exchange algorithm*](security.k_gly#-security-key-exchange-algorithm-gly) | Key length: Can be set, 384 bits to 512 bits in 8 bit increments. Default key length: 512 bits.<br/> |
