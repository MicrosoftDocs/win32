...
The following example demonstrates a number of common [*certificate store*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) operations as well as the following tasks and [*CryptoAPI*](https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx) functions:
