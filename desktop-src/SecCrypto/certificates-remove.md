...
| <span id="String"></span><span id="string"></span><span id="STRING"></span><dl> <dt>****String****</dt> <dt></dt> </dl>                                        | The first [**Certificate**](certificate.md) object in the collection that matches the [*SHA-1*](security.s_gly#-security-sha-gly) thumbprint contained in the specified string is removed.<br/> |
