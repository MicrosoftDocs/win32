---
title: DisableByPath method of the MSFT\_WdacBidTraceTask class
description: Disables Built-in Diagnostics Tracing (BidTrace) for troubleshooting WDAC components.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'd5b88447-64d6-4806-9122-37016cf242a2'
ms.prod: 'windows-server-dev'
ms.technology: 'windows-management-instrumentation'
ms.tgt_platform: multiple
keywords: ["DisableByPath method", "DisableByPath method, MSFT_WdacBidTraceTask class", "MSFT_WdacBidTraceTask class, DisableByPath method"]
topic_type:
- apiref
api_name:
- MSFT_WdacBidTraceTask.DisableByPath
api_location:
- WdacWmiProv.dll
api_type:
- COM
...
# DisableByPath method of the MSFT\_WdacBidTraceTask class
