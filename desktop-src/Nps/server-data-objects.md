...
The SDO API is composed of COM interfaces. Each of the interfaces in the SDO API inherits from the COM [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. The **IDispatch** interface enables developers to call the SDO interface methods from Visual Basic or any Automation client, as well as from C/C++.
