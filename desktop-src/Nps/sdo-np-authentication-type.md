...
**ID:** 4105 = [**IAS\_ATTRIBUTE\_NP\_AUTHENTICATION\_TYPE**](https://msdn.microsoft.com/library/bb960612)
...
-   **IAS\_AUTH\_PAP** (1)
-   **IAS\_AUTH\_MD5CHAP** (2)
-   **IAS\_AUTH\_MSCHAP** (3)
-   **IAS\_AUTH\_MSCHAP2** (4)
-   **IAS\_AUTH\_EAP** (5)
-   **IAS\_AUTH\_ARAP** (6)
-   **IAS\_AUTH\_NONE** (7)
-   **IAS\_AUTH\_CUSTOM** (8)
-   **IAS\_AUTH\_MSCHAP\_CPW** (9)
-   **IAS\_AUTH\_MSCHAP2\_CPW** (10)
-   **IAS\_AUTH\_PEAP** (11)
