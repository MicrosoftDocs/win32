...
Once you have the CLSID, call [**CoCreateInstance**](https://msdn.microsoft.com/en-us/library/ms686615(v=VS.85).aspx) with this CLSID. Specify [**ISdoMachine**](https://msdn.microsoft.com/library/bb960655) as the interface for which to return a pointer.
