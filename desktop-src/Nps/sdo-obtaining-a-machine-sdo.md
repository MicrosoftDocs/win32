...
Use the [**CLSIDFromProgID**](https://www.bing.com/search?q=**CLSIDFromProgID**) function to obtain the class identifier (CLSID) for the SDO machine object. The programmatic identifier (ProgID) to use for the object is "IAS.SdoMachine".

Once you have the CLSID, call [**CoCreateInstance**](https://www.bing.com/search?q=**CoCreateInstance**) with this CLSID. Specify [**ISdoMachine**](https://msdn.microsoft.com/library/bb960655) as the interface for which to return a pointer.
