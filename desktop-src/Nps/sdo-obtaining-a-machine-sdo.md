...
Use the [**CLSIDFromProgID**](89fb20af-65bf-4ed4-9f71-eb707ee8eb09) function to obtain the class identifier (CLSID) for the SDO machine object. The programmatic identifier (ProgID) to use for the object is "IAS.SdoMachine".

Once you have the CLSID, call [**CoCreateInstance**](7295a55b-12c7-4ed0-a7a4-9ecee16afdec) with this CLSID. Specify [**ISdoMachine**](https://msdn.microsoft.com/library/bb960655) as the interface for which to return a pointer.
