...
NPS fully supports the Remote Authentication Dial-In User Service (RADIUS) protocol. The RADIUS protocol is the de facto standard for remote user authentication and it is documented in [RFC 2865](Http://go.microsoft.com/fwlink/p/?linkid=84055) and [RFC 2866](Http://go.microsoft.com/fwlink/p/?linkid=84056).
...
For more information on RADIUS authentication and authorization, see [RFC 2865](Http://go.microsoft.com/fwlink/p/?linkid=84055).
...
For more information on RADIUS accounting, see [RFC 2866](Http://go.microsoft.com/fwlink/p/?linkid=84056).
...
[RADIUS Accounting Packets](https://msdn.microsoft.com/library/bb892007)
</dt> <dt>
