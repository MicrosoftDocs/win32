...
The vtClientsCollection variable is of type [\_variant\_t](Http://go.microsoft.com/fwlink/p/?linkid=83857). A \_variant\_t object encapsulates, or encloses, the [**VARIANT**](https://msdn.microsoft.com/windows/desktop/e305240e-9e11-4006-98cc-26f4932d2118) data type. The class manages resource allocation and deallocation, and makes function calls to [**VariantInit**](https://msdn.microsoft.com/windows/desktop/96aeb671-5528-4d3c-8e70-313716550b42) and [**VariantClear**](https://msdn.microsoft.com/windows/desktop/28741d81-8404-4f85-95d3-5c209ec13835) as appropriate.

After the call to "pSdo-&gt;GetProperty()", the vtProtocolsCollection variable specifies an object. The **pdispVal** member of vtProtocolsCollection contains a pointer to the [**IDispatch**](https://msdn.microsoft.com/windows/desktop/ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface for the object.
...
[**VariantClear**](https://msdn.microsoft.com/windows/desktop/28741d81-8404-4f85-95d3-5c209ec13835)
</dt> <dt>

[**VariantInit**](https://msdn.microsoft.com/windows/desktop/96aeb671-5528-4d3c-8e70-313716550b42)
</dt> <dt>
