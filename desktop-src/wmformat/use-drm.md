...
keywords: ["Use_DRM windows Media Format"]
topic_type:
- apiref
api_name:
- Use_DRM
...
Use [**IWMHeaderInfo::SetAttribute**](iwmheaderinfo-setattribute.md) to set this property to **TRUE** when creating DRM version 1 content. This property is not accessible from the reader object.
