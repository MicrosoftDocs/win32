...
This structure is returned (encapsulated in a [**WM\_LICENSE\_STATE\_DATA**](/windows/desktop/api/Wmsdkidl/) structure) from a call to [**IWMDRMReader::GetDRMProperty**](/windows/desktop/api/Wmsdkidl/nf-wmsdkidl-iwmdrmreader-getdrmproperty) when you specify one of the DRM license state properties. These properties are:
