...
keywords: ["Is_Protected windows Media Format"]
topic_type:
- apiref
api_name:
- Is_Protected
...
This is a coded attribute. Retrieving this property provides the same information as calling [**WMIsContentProtected**](wmiscontentprotected.md).
