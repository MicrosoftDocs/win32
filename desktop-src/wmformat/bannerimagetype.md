...
keywords: ["BannerImageType windows Media Format"]
topic_type:
- apiref
api_name:
- BannerImageType
...
The **BannerImageType** attribute specifies the type of image stored in the [**BannerImageData**](bannerimagedata.md) attribute. This attribute is a value from the [**WMT\_IMAGE\_TYPE**](wmt-image-type.md) enumeration type.
