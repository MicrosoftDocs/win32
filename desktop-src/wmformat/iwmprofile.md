...
| [**GetStreamByNumber**](/previous-versions/windows/desktop/api/wmcontainer/nf-wmcontainer-imfasfprofile-getstreambynumber)               | Retrieves a stream, using the number of the stream, from the profile.<br/>            |
| [**GetStreamCount**](/previous-versions/windows/desktop/api/mftransform/nf-mftransform-imftransform-getstreamcount)                     | Retrieves the number of streams in the profile.<br/>                                  |
