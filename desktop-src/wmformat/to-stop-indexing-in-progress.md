...
After you begin indexing with a call to [**IWMIndexer::StartIndexing**](/windows/win32/Wmsdkidl/nf-wmsdkidl-iwmindexer-startindexing?branch=master), the indexer will normally continue until the file is indexed. You can stop indexing operations by calling the [**IWMIndexer::Cancel**](/windows/win32/Wmsdkidl/nf-wmsdkidl-iwmindexer-cancel?branch=master) method. After you have canceled indexing, you can call **StartIndexing** again, but the indexer will start from the beginning of the file rather than resuming from the point of cancellation.
