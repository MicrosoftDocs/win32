...
keywords: ["Windows Media Format SDK,licenses", "Windows Media Format SDK,deleting licenses", "digital rights management (DRM),licenses", "DRM (digital rights management),licenses", "digital rights management (DRM),deleting licenses", "DRM (digital rights management),deleting licenses", "DRM Client Extended APIs,licenses", "Client Extended APIs,licenses", "DRM Client Extended APIs,deleting licenses", "Client Extended APIs,deleting licenses", "licenses,deleting"]
---
