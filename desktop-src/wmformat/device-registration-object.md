...
keywords: ["Windows Media Format SDK,device registration objects", "Advanced Systems Format (ASF),device registration objects", "ASF (Advanced Systems Format),device registration objects", "objects,device registration objects", "device registration objects"]
---
...
The device registration object is created by the [**WMCreateDeviceRegistration**](wmcreatedeviceregistration.md) function, which sets a pointer to an **IWMDeviceRegistration** interface. The other methods of the device registration object can be obtained by calling the **QueryInterface** method.
...
|--------------------------------------------------------|-------------------------------------------|
| [**IWMDeviceRegistration**](iwmdeviceregistration.md) | Manages the device registration database. |
| [**IWMDRMMessageParser**](iwmdrmmessageparser.md)     | Parses messages sent by devices.          |
| [**IWMProximityDetection**](iwmproximitydetection.md) | Manages device validation.                |
