...
| [**WMCreateCertificate**](/windows/desktop/api/Wmsdkidl/)                                   | Wraps the user's certificates into an object.                                                                                                           |
...
| [**WMCreateSecureChannel**](/windows/desktop/api/Wmsecure/nf-wmsecure-wmcreatesecurechannel)                               | Creates an object that implements [**IWMSecureChannel**](/windows/desktop/api/Wmsecure/).                                                                         |
| [**WMCreateSecureChannel\_Certified**](/windows/desktop/api/Wmsecure/nf-wmsecure-wmcreatesecurechannel_certified)          | Creates an object that implements [**IWMSecureChannel**](/windows/desktop/api/Wmsecure/).                                                                         |
| [**WMCreateSecureChannel\_Certified\_DES**](/windows/desktop/api/Wmsecure/nf-wmsecure-wmcreatesecurechannel_certified_des) | Creates an object that implements [**IWMSecureChannel**](/windows/desktop/api/Wmsecure/)..                                                                        |
| [**WMCreateSecureChannel\_DES**](/windows/desktop/api/Wmsecure/nf-wmsecure-wmcreatesecurechannel_des)                      | Creates an object that implements [**IWMSecureChannel**](/windows/desktop/api/Wmsecure/).                                                                         |
