...
This property can be set using [**IWMDRMWriter::SetDRMAttribute**](/windows/win32/Wmsdkidl/nf-wmsdkidl-iwmdrmwriter-setdrmattribute?branch=master). It is not accessible by the reader object.
...
A new key seed can be generated using the [**IWMDRMWriter::GenerateKeySeed**](/windows/win32/Wmsdkidl/nf-wmsdkidl-iwmdrmwriter-generatekeyseed?branch=master) method or by any other suitable means.
