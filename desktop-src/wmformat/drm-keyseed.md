...
keywords: ["DRM_KeySeed windows Media Format"]
topic_type:
- apiref
api_name:
- DRM_KeySeed
...
This property can be set using [**IWMDRMWriter::SetDRMAttribute**](iwmdrmwriter-setdrmattribute.md). It is not accessible by the reader object.
...
A new key seed can be generated using the [**IWMDRMWriter::GenerateKeySeed**](iwmdrmwriter-generatekeyseed.md) method or by any other suitable means.
