...
To receive compressed samples with the synchronous reader, call [**IWMSyncReader::SetReadStreamSamples**](/windows/win32/Wmsdkidl/nf-wmsdkidl-iwmsyncreader-setreadstreamsamples?branch=master) before or during playback. Pass true for *fCompressed*.
