...
keywords: ["Advanced Systems Format (ASF),retrieving compressed samples", "ASF (Advanced Systems Format),retrieving compressed samples", "Advanced Systems Format (ASF),synchronous readers", "ASF (Advanced Systems Format),synchronous readers", "Advanced Systems Format (ASF),compressed samples", "ASF (Advanced Systems Format),compressed samples", "synchronous readers,retrieving compressed samples", "synchronous readers,compressed samples", "compressed samples,retrieving"]
---
...
To receive compressed samples with the synchronous reader, call [**IWMSyncReader::SetReadStreamSamples**](iwmsyncreader-setreadstreamsamples.md) before or during playback. Pass true for *fCompressed*.
