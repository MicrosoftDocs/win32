...
6.  If there are any Windows Media DRM revocations:
    ...
    2.  Call **IMFContentEnabler::AutomaticEnable** which directs the user to a URL that contains component renewal information. This method is documented in the [Media Foundation SDK](http://msdn.microsoft.com/library/ms694197(VS.85).aspx) (http://msdn.microsoft.com/library/ms694197(VS.85).aspx).
        > [!Note]  
