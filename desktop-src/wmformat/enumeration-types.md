...
| [**WMT\_DRMLA\_TRUST**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_drmla_trust)                                   | Defines the trust state of a DRM license acquisition URL.                                                                        |
| [**WMT\_FILESINK\_MODE**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_filesink_mode)                               | Defines the types of input accepted by the file sink.                                                                            |
...
| [**WMT\_INDEX\_TYPE**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_index_type)                                     | Defines the object with which a time-based index can be associated.                                                              |
| [**WMT\_INDEXER\_TYPE**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_indexer_type)                                 | Defines the types of indexing supported by the indexer.                                                                          |
...
| [**WMT\_MUSICSPEECH\_CLASS\_MODE**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_musicspeech_class_mode)            | Defines the compression modes available to the Windows Media Audio 9 Voice codec.                                                |
| [**WMT\_OFFSET\_FORMAT**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_offset_format)                               | Defines the types of offsets used in this SDK.                                                                                   |
...
| [**WMT\_STORAGE\_FORMAT**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_storage_format)                             | Defines the file types that can be manipulated with this SDK.                                                                    |
| [**WMT\_STREAM\_SELECTION**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-wmt_stream_selection)                         | Defines the status of a stream.                                                                                                  |
| [**WMT\_TRANSPORT\_TYPE**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_transport_type)                             | Defines the transport types supported by this SDK.                                                                               |
...
| [**WMT\_WATERMARK\_ENTRY\_TYPE**](/windows/desktop/api/Wmsdkidl/ne-wmsdkidl-tagwmt_watermark_entry_type)                | Defines the types of supported watermarks.                                                                                       |
