...
The reader object can seek to a point in a file based on the SMPTE time code associated with a video stream. Time code data is encapsulated in [**WMT\_TIMECODE\_EXTENSION\_DATA**](/windows/win32/Wmsdkidl/ns-wmsdkidl-_wmt_timecode_extension_data?branch=master) structures that are attached to video samples as data unit extensions.
