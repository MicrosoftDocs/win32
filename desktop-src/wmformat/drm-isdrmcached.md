...
keywords: ["DRM_IsDRMCached windows Media Format"]
topic_type:
- apiref
api_name:
- DRM_IsDRMCached
...
This is a read-only property that is retrieved using [**IWMDRMReader::GetDRMProperty**](iwmdrmreader-getdrmproperty.md). It is **TRUE** when the license acquisition URL matches one of two know URLs used for local license acquisition in DRM version 1.
