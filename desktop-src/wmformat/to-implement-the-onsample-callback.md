...
Applications that deliver compressed samples from ASF files need to implement the [**IWMReaderCallbackAdvanced::OnStreamSample**](iwmreadercallbackadvanced-onstreamsample.md) callback method. **OnStreamSample** functions almost identically to **OnSample**, except that it receives compressed samples by stream number instead of uncompressed samples by output number.

## Related topics

<dl> <dt>

[**IWMReaderCallback Interface**](iwmreadercallback.md)
</dt> <dt>
