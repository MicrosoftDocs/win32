...
keywords: ["Advanced Systems Format (ASF),retrieving media samples", "ASF (Advanced Systems Format),retrieving media samples", "Advanced Systems Format (ASF),synchronous readers", "ASF (Advanced Systems Format),synchronous readers", "synchronous readers,retrieving media samples"]
---
...
> [!Note]  
> To ensure that the synchronous reader delivers correct sample durations for video streams, you must first configure the stream output. Call the [**IWMSyncReader::SetOutputSetting**](iwmsyncreader-setoutputsetting.md) method to set the g\_wszVideoSampleDurations setting to **TRUE**.
