...
5.  Obtain a pointer to the [**INSSBuffer3**](/previous-versions/previous-versions/windows/desktop/api/wmsbuffer/nn-wmsbuffer-inssbuffer3) interface by calling **INSSBuffer::QueryInterface**.
