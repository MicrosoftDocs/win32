...
Many other messages are sent to **OnStatus** by the reader object to enable the application to respond to the status of reading operations. The possible status message values are defined in the [**WMT\_STATUS**](wmt-status.md) enumeration type.

## Related topics

<dl> <dt>

[**IWMStatusCallback::OnStatus**](iwmstatuscallback-onstatus.md)
</dt> <dt>
