...
|-----------|------------------|-------------|
| Center X | <strong>fEffectPara0</strong> | X-coordinate, relative to the video frame, of the center of the circle. | 
| Center Y | <strong>fEffectPara1</strong> | Y-coordinate, relative to the video frame, of center of the circle. | 
| Radius | <strong>fEffectPara2</strong> | Radius, in pixels, of the circle. | 
