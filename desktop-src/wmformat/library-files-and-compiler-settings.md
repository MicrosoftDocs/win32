...
**Note** Applications that play or create files protected by Digital Rights Management (DRM) require an individualized static library that must be obtained separately from Microsoft. For more information, see the Windows Media Licensing Form at the [Microsoft Web site](http://go.microsoft.com/fwlink/p/?linkid=8076). If you use the DRM library, you should not link to Wmvcore.lib.
