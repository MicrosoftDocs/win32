---
title: DRM\_VIDEO\_OUTPUT\_PROTECTION\_IDS structure
...
keywords: ["DRM_VIDEO_OUTPUT_PROTECTION_IDS structure windows Media Format", "structure windows Media Format"]
topic_type:
- apiref
api_name:
