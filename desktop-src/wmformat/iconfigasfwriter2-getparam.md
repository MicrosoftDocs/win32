...
Specifies the parameter to retrieve. It must be a value defined in the [\_AM\_ASFWRITERCONFIG\_PARAM](https://msdn.microsoft.com/library/Dd758054(v=VS.85).aspx) enumeration.
