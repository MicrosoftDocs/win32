...
|-----------|------------------|-------------|
| Center X | <strong>fEffectPara0</strong> | X-coordinate, relative to the video frame, of the center of the rectangle. | 
| Center Y | <strong>fEffectPara1</strong> | Y-coordinate, relative to the video frame, of the center of the rectangle. | 
| Width | <strong>fEffectPara2</strong> | Width of the rectangle in pixels. | 
| Height | <strong>fEffectPara3</strong> | Height of the rectangle in pixels. | 
