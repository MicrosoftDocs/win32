...
The **DRM\_LicenseState\_CopyToNonSDMIDevice** property contains a [**WM\_LICENSE\_STATE\_DATA**](/windows/desktop/api/Wmsdkidl/) structure that contains details about how this right has been applied to the content.
