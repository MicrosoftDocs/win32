...
keywords: ["SetNotify method windows Media Format", "SetNotify method windows Media Format , IAMWMBufferPass interface", "IAMWMBufferPass interface windows Media Format , SetNotify method"]
topic_type:
- apiref
api_name:
...
The **SetNotify** method is used by applications to provide the WM ASF Writer or [WM ASF Reader](wm-asf-reader-filter.md) filter with a pointer to the application's [**IAMWMBufferPassCallback**](iamwmbufferpasscallback.md) interface.
...
[**IAMWMBufferPass Interface**](iamwmbufferpass.md)
</dt> </dl>
