...
keywords: ["Windows Media Format SDK,indexer objects", "Advanced Systems Format (ASF),indexer objects", "ASF (Advanced Systems Format),indexer objects", "objects,indexer objects", "indexer objects", "indexes,indexer objects"]
---
...
The indexer object is created by the [**WMCreateIndexer**](wmcreateindexer.md) function, which sets a pointer to an **IWMIndexer** interface. The other interfaces of the indexer object can be obtained by calling the **QueryInterface** method.
...
|------------------------------------|-------------------------------------------------------------------------------------|
| [**IWMIndexer**](iwmindexer.md)   | Starts and stops the indexing process.                                              |
| [**IWMIndexer2**](iwmindexer2.md) | Configures the indexer, enabling indexing by frame, by time, or by SMPTE time code. |
