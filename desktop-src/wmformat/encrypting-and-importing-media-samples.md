...
keywords: ["Windows Media Format SDK,DRM import", "Windows Media Format SDK,import", "Windows Media Format SDK,encrypting media samples", "digital rights management (DRM),import", "DRM (digital rights management),import", "digital rights management (DRM),encrypting media samples", "DRM (digital rights management),encrypting media samples", "DRM Client Extended APIs,import", "Client Extended APIs,import", "DRM Client Extended APIs,encrypting media samples", "Client Extended APIs,encrypting media samples"]
---
...
1.  Call the **QueryInterface** method of the sample object to get the [**INSSBuffer3**](inssbuffer3.md) interface.
...
4.  Provide the salt value to the SDK by calling [**INSSBuffer::SetProperty**](inssbuffer3-setproperty.md).
