...
1.  Call the **QueryInterface** method of the sample object to get the [**INSSBuffer3**](/windows/win32/wmsbuffer/nn-wmsbuffer-inssbuffer3?branch=master) interface.
...
4.  Provide the salt value to the SDK by calling [**INSSBuffer::SetProperty**](/windows/win32/Wmsbuffer/nf-wmsbuffer-inssbuffer3-setproperty?branch=master).
