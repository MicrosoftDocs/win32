...
| [**WMVIDEOINFOHEADER2**](/windows/desktop/api/Wmsdkidl/ns-wmsdkidl-tagwmvideoinfoheader2)                                         | Describes the bitmap and color information for a video image, including [*interlace*](wmformat-glossary.md#wmformat-interlace), copy protection, and aspect ratio.       |
