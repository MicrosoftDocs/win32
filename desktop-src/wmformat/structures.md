...
| [**DRM\_LICENSE\_STATE\_DATA**](drm-license-state-data.md)                              | Contains [*license*](https://www.bing.com/search?q=*license*) information about a specified [*DRM*](https://www.bing.com/search?q=*DRM*) right. |
...
| [**WM\_INDIVIDUALIZE\_STATUS**](wm-individualize-status.md)                             | Records the status of the [*individualization*](https://www.bing.com/search?q=*individualization*) process.                                                                |
...
| [**WMVIDEOINFOHEADER2**](/windows/desktop/api/Wmsdkidl/ns-wmsdkidl-tagwmvideoinfoheader2)                                         | Describes the bitmap and color information for a video image, including [*interlace*](https://www.bing.com/search?q=*interlace*), copy protection, and aspect ratio.       |
