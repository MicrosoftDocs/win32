...
keywords: ["Use_Advanced_DRM windows Media Format"]
topic_type:
- apiref
api_name:
- Use_Advanced_DRM
...
This is a read-write property that is retrieved using [**IWMDRMReader::GetDRMProperty**](iwmdrmreader-getdrmproperty.md) and set using [**IWMDRMWriter::SetDRMAttribute**](iwmdrmwriter-setdrmattribute.md). This property is not accessible from the reader object.
