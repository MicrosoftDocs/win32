...
|------------------------------------|----------------------------------------------------------------------|
| [**INSSBuffer**](/windows/desktop/api/wmsbuffer/nn-wmsbuffer-inssbuffer)   | Controls and provides access to the buffer.                          |
| [**INSSBuffer2**](/windows/desktop/api/wmsbuffer/nn-wmsbuffer-inssbuffer2) | Not implemented.                                                     |
| [**INSSBuffer3**](/windows/desktop/api/wmsbuffer/nn-wmsbuffer-inssbuffer3) | Supports buffer properties, which are used for data unit extensions. |
