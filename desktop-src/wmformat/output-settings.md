...
| g\_wszEnableFrameInterpolation | **WMT\_TYPE\_BOOL**  | If True, the codec will deliver the video stream at a higher [*frame rate*](wmformat-glossary.md#wmformat-frame-rate), interpolating the frames algorithmically.                                                                                                                                                          |
