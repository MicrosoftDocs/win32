...
| g\_wszEnableFrameInterpolation | **WMT\_TYPE\_BOOL**  | If True, the codec will deliver the video stream at a higher [*frame rate*](https://www.bing.com/search?q=*frame rate*), interpolating the frames algorithmically.                                                                                                                                                          |
