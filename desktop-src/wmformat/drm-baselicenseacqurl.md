...
keywords: ["DRM_BaseLicenseAcqURL windows Media Format"]
topic_type:
- apiref
api_name:
...
This is an optional read-write property that is set and retrieved using [**IWMDRMReader::GetDRMProperty**](iwmdrmreader-getdrmproperty.md). It is provided to enable license distribution systems to use relative paths in the license acquisition URL properties.
