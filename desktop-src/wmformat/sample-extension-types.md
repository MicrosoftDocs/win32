...
<td>The data indicates whether the sample is a [<em>cleanpoint</em>](https://www.bing.com/search?q=<em>cleanpoint</em>). A value of zero indicates that the sample is not a cleanpoint. A non-zero value indicates that it is a cleanpoint. This sample data unit extension (DUE) type is used to keep track of cleanpoints when writing precompressed media streams that were encoded with third-party codecs.</td>
</tr>
<tr class="even">
