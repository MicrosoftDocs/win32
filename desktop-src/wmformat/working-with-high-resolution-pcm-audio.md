...
keywords: ["Advanced Systems Format (ASF),high-resolution PCM audio", "ASF (Advanced Systems Format),high-resolution PCM audio", "profiles,high-resolution PCM audio", "codecs,high-resolution PCM audio", "Advanced Systems Format (ASF),PCM audio", "ASF (Advanced Systems Format),PCM audio", "profiles,PCM audio", "codecs,PCM audio", "high-resolution PCM audio", "PCM audio"]
---
...
These formats are configured by using a structured extension of the [**WAVEFORMATEX**](https://msdn.microsoft.com/library/windows/desktop/dd757720) structure, called [**WAVEFORMATEXTENSIBLE**](https://msdn.microsoft.com/library/windows/desktop/dd757721). The **WAVEFORMATEXTENSIBLE** structure includes information about the channels included in the audio. This structure is required when using high-resolution PCM audio, because some Windows APIs will not accept **WAVEFORMATEX** structures that contain high-resolution values.
