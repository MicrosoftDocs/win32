---
title: DRM\_ACTION\_ALLOWED\_QUERY\_RESULTS enumeration
...
keywords: ["DRM_ACTION_ALLOWED_QUERY_RESULTS enumeration windows Media Format", "enumeration windows Media Format"]
topic_type:
- apiref
api_name:
