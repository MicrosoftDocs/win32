...
keywords: ["Advanced Systems Format (ASF),data unit extensions", "ASF (Advanced Systems Format),data unit extensions", "data unit extensions,setting", "streams,data unit extensions"]
---
...
To add extended data to a sample, use the [**INSSBuffer3::SetProperty**](inssbuffer3-setproperty.md) method. You can get information about the data unit extensions configured on a stream by using the [**IWMStreamConfig2::GetDataUnitExtensionCount**](iwmstreamconfig2-getdataunitextensioncount.md) and [**IWMStreamConfig2::GetDataUnitExtension**](iwmstreamconfig2-getdataunitextension.md) methods.
