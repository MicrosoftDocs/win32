...
The COM interface from which this interface derives. The base interface must be [**IUnknown**](https://www.bing.com/search?q=**IUnknown**), [**IDispatch**](https://msdn.microsoft.com/windows/desktop/ebbff4bc-36b2-4861-9efa-ffa45e013eb5), or another COM interface that derives, either directly or indirectly, from **IUnknown** or **IDispatch**.
