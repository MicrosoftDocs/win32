...
The interface name forms the first part of the name of interface-handle data structures that are parameters to the RPC run-time functions. For more information, see [**RPC\_IF\_HANDLE**](https://msdn.microsoft.com/library/windows/desktop/aa378626).
...
[**RPC\_IF\_HANDLE**](https://msdn.microsoft.com/library/windows/desktop/aa378626)
</dt> <dt>
