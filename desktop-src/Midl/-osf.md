...
In **/osf** mode, the RpcSs package is automatically enabled when you use full pointers, the arguments require memory allocation, or when you use the [**enable\_allocate**](enable-allocate.md) attribute. This means that you do not have to supply the [**midl\_user\_allocate**](https://msdn.microsoft.com/library/windows/desktop/aa378715) and [**midl\_user\_free**](https://msdn.microsoft.com/library/windows/desktop/aa378716) functions in your client and server application.
...
[Rpcss Memory Management Package](https://msdn.microsoft.com/library/windows/desktop/aa378480)
</dt> </dl>
