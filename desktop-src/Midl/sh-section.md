---
title: sh_section keyword
description: The \ sh\_section\ keyword specifies the system object is a handle to a section.
keywords:
- sh_section keyword MIDL
topic_type:
- apiref
api_name:
- sh_section keyword
...
The **sh\_section** keyword specifies that a `system_handle` holds a handle to a section.
...
[Section Objects and Views](/windows-hardware/drivers/kernel/section-objects-and-views)
</dt> <dt>

[**ZwCreateSection** function (including access specifications)](/windows-hardware/drivers/ddi/wdm/nf-wdm-zwcreatesection)
</dt> </dl>
