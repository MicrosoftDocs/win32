...
Specifies the name of an Automation interface from which this derived interface inherits member functions, status codes, and interface attributes. All Automation interfaces are derived from [**IUnknown**](_com_iunknown) or [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5).
...
| **BSTR**                                        | Length-prefixed string, as described in the Automation topic [BSTR](1b2d7d2c-47af-4389-a6b6-b01b7e915228).                                                                                                    |
...
| **Interface IDispatch \***                      | Pointer to the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface (VT\_DISPATCH).                                                                                                                |
| **Interface IUnknown \***                       | Pointer to an interface that does not derive from [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) (VT\_UNKNOWN). (Any OLE interface can be represented by its [**IUnknown**](_com_iunknown) interface.) |
| **dispinterface**Â *Typename \**                | Pointer to an interface derived from [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) (VT\_DISPATCH).                                                                                                    |
| **Coclass**Â *Typename \**                      | Pointer to a coclass name (VT\_UNKNOWN).                                                                                                                                                                      |
| **\[oleautomation\] interface**Â  *Typename \** | Pointer to an interface that derives from [**IUnknown**](_com_iunknown).                                                                                                                                      |
...
An interface is compatible with Automation if it is derived from [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) or [**IUnknown**](_com_iunknown), it has the **\[oleautomation\]** attribute, and all of its VTBL entries are Automation compatible. For 32-bit platforms, the calling convention for all methods in the interface must be STDCALL. For 16-bit systems, all methods must have the CDECL calling convention.
