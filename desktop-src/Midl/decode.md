...
For more information about using this serialization support, see [Serialization Services](https://msdn.microsoft.com/library/windows/desktop/aa378670) and **\[**[**encode**](encode.md)**\]**.
