...
For additional information about serialization handles and encoding or decoding data, see [Serialization Services](https://msdn.microsoft.com/library/windows/desktop/aa378670).
