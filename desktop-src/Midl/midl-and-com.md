...
For more information on defining COM interfaces with MIDL, see [Defining COM Interfaces](https://msdn.microsoft.com/library/ms688488(v=VS.85).aspx). For more information on building generated files for various platforms, see [Targeting Stubs for Specific 32-bit or 64-bit Platforms](targeting-stubs-for-specific-32-bit-or-64-bit-platforms.md).
