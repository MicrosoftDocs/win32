...
![the protected mode dialog.](https://www.bing.com/search?q=the protected mode dialog.)
...
-   Because gadgets are considered executable code, they can instantiate any installed ActiveX object when the option "Initialize and script ActiveX controls not marked as safe for scripting" is enabled in Internet Explorer. ![the internet explorer security settings dialog showing the 'initialize and script activex controls not marked as safe for scripting' radio button selection.](https://www.bing.com/search?q=the internet explorer security settings dialog showing the 'initialize and script activex controls not marked as safe for scripting' radio button selection.)
-   Since gadgets can aggregate data from various locations, the option "Access data sources across domains" is enabled in Internet Explorer. ![the internet explorer security settings dialog showing the 'access data sources across domains' radio button selection.](https://www.bing.com/search?q=the internet explorer security settings dialog showing the 'access data sources across domains' radio button selection.)
...
![the security warning dialog presented to a user when a gadget is installed.](https://www.bing.com/search?q=the security warning dialog presented to a user when a gadget is installed.)
