...
- apiref
api_name:
- System.MessageStore.Message.body
api_location:
- Sidebar.Exe
api_type:
- COM
...
Gets the Windows Mail (formerly Outlook Express) message body.
...
```JScript
strbody = System.MessageStore.Message.body
```
...
A **String** that receives the message body.
