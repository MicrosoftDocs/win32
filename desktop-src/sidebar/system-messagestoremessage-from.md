...
keywords:
- from property Windows Sidebar
- from property Windows Sidebar , System.MessageStore.Message object
- System.MessageStore.Message object Windows Sidebar , from property
topic_type:
- apiref
api_name:
