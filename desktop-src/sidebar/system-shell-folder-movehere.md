---
title: System.Shell.Folder.moveHere method
description: Moves a System.Shell.Item to a folder.
ms.assetid: '45e9cca0-eb3b-41c3-8930-e28d04ef8837'
keywords: ["moveHere method Windows Sidebar", "moveHere method Windows Sidebar , System.Shell.Folder object", "System.Shell.Folder object Windows Sidebar , moveHere method"]
topic_type:
- apiref
api_name:
- System.Shell.Folder.moveHere
api_location:
- Sidebar.Exe
api_type:
- COM
...
# System.Shell.Folder.moveHere method

\[ The Windows Gadget Platform/Sidebar is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions. \]

Moves a [**System.Shell.Item**](system-shell-item.md) to a folder.
...
The [**System.Shell.Item**](system-shell-item.md) to move.
...
**Integer** that specifies any combination of move operation options.
...
The following example demonstrates how to move an object to a system folder.
