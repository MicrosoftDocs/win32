...
Address of a variable that receives the [**MoveTo**](iagentcharacter_moveto) request ID.

</dd> </dl>

When using the HTTP protocol to access character and animation data, use the [**Prepare**](https://msdn.microsoft.com/library/windows/desktop/ms699189) method to ensure the availability of the **Moving** state animations before calling this method. Even if the animation is not loaded, the server still moves the frame.
