...
keywords: ["SortOrderProperty property Legacy Windows Environment Features", "SortOrderProperty property Legacy Windows Environment Features , IResultsViewer interface", "IResultsViewer interface Legacy Windows Environment Features , SortOrderProperty property"]
topic_type:
- apiref
api_name:
...
Sets the [**ColumnSortOrder**](search-2x-columnsortorder.md) property.
