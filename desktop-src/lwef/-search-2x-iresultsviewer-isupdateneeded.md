...
keywords: ["IsUpdateNeeded property Legacy Windows Environment Features", "IsUpdateNeeded property Legacy Windows Environment Features , IResultsViewer interface", "IResultsViewer interface Legacy Windows Environment Features , IsUpdateNeeded property"]
topic_type:
- apiref
api_name:
