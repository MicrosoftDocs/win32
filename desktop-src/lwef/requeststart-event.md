...
The [**Status**](status-property.md) returns 4 (request in progress) for the [**Request**](https://docs.microsoft.com/windows/desktop/lwef/the-request-object) object returned.
