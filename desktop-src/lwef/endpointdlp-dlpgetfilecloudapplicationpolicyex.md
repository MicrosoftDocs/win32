---
description: Returns the enforcement level of a file uploaded to a cloud application. This function is designed to be called from external sources.
...
- kbSyntax
api_name: 
- DlpGetFileCloudApplicationPolicyEx
api_type: 
- DllExport
api_location: 
- EndpointDlp.dll
