...
Returns or sets the text that is passed to the speech engine grammar (for recognition) for matching this [**Command**](https://msdn.microsoft.com/library/windows/desktop/ms696441) for the character.
...
| Part     | Description                                                                                                                                       |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| *string* | A string expression corresponding to the words or phrase to be used by the speech engine for recognizing this [**Command**](https://msdn.microsoft.com/library/windows/desktop/ms696441). |
...
If you do not supply this parameter, the [**VoiceCaption**](voicecaption-property.md) for your [**Commands**](https://msdn.microsoft.com/library/windows/desktop/ms695971) object will not appear in the Voice Commands Window. If you specify a [**Voice**](voice-property.md) parameter but not a **VoiceCaption** (or [**Caption**](lwef-)), the command will not appear in the Voice Commands Window, but it will be voice-accessible when the client application becomes input-active.
