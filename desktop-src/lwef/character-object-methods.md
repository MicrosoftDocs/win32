...
The server also exposes methods for each character in a [**Characters**](https://msdn.microsoft.com/library/windows/desktop/ms696372) collection. The following methods are supported:
...
To simplify the syntax of your code, you can define an object variable and set it to reference a character object in the [**Characters**](https://msdn.microsoft.com/library/windows/desktop/ms696372) collection; then you can use your variable to reference methods or properties of the character. The following example demonstrates how you can do this using the Visual Basic Set statement:
...
In Visual Basic 5.0, you can also create your reference by declaring your variable as a [**Character**](https://msdn.microsoft.com/library/windows/desktop/ms696372)object:
...
Some programming languages do not support collections. However, you can access a [**Character**](https://msdn.microsoft.com/library/windows/desktop/ms696372) object's methods with the [**Character**](character-method.md) method:
...
In addition, you can also create a reference to the [**Character**](https://msdn.microsoft.com/library/windows/desktop/ms696372) object to make your script code easier to follow:
