...
This property tracks the type of the content being displayed in the results view.

## Syntax

## Property value

Returns a pointer to the type of contents displayed in the results view.
