...
keywords: ["IndexColumn property Legacy Windows Environment Features", "IndexColumn property Legacy Windows Environment Features , IResultProperty interface", "IResultProperty interface Legacy Windows Environment Features , IndexColumn property"]
topic_type:
- apiref
api_name:
