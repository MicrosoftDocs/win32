...
Retrieves the value of the [**Visible**](visible-property.md) property for a [**Command**](https://msdn.microsoft.com/library/windows/desktop/ms696441).
...
The address of a variable that receives the [**Visible**](visible-property.md) property for a [**Command**](https://msdn.microsoft.com/library/windows/desktop/ms696441).
