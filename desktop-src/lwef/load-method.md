...
Loads a character into the [**Characters**](https://msdn.microsoft.com/library/windows/desktop/ms696372) collection.
...
You can also handle the error by setting [**RaiseRequestErrors**](lwef-requestraiseerrors_event) to **False**, declaring a object, and assigning the **Load** request to it. Then follow the **Load** call with a statement that checks the status of the [**Request**](https://msdn.microsoft.com/library/windows/desktop/ms696325) object.
