...
| *Cause*       | Returns a value that indicates what caused the Help mode to complete. 1 The user selected a command supplied by your application.<br/> 2 The user selected the [**Commands**](https://msdn.microsoft.com/library/windows/desktop/ms695971) object of another client.<br/> 3 The user selected the Open Voice Commands command.<br/> 4 The user selected the Close Voice Commands command.<br/> 5 The user selected the Show *CharacterName* command.<br/> 6 The user selected the Hide *CharacterName* command.<br/> 7 The user selected (clicked) the character.<br/> |
