---
description: Generates an ETW event for the specified file.
title: DlpAuditOperationEnforcementEvent function (endpointdlp.h)
ms.topic: reference
ms.date: 06/14/2023
topic_type: 
- APIRef
...
# DlpAuditOperationEnforcementEvent function

Generates an ETW for the specified file.
