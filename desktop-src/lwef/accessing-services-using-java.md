...
Then get the [**IAgentCharacterEx**](IAgentCharacterEx) interface that enables you to access its methods:
...
Similarly, to be notified of events, you must implement either the [**IAgentNotifySink**](IAgentNotifySink) or the [**IAgentNotifySinkEx**](IAgentNotifySinkEx) interface, creating and registering an object of that type:
