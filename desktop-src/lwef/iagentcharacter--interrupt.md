...
**Interrupt** halts the existing animation, but does not flush the character's animation queue. It starts the next animation in the character's queue. To halt and flush a character's queue, use the [**Stop**](https://msdn.microsoft.com/library/windows/desktop/ms699178) method.
