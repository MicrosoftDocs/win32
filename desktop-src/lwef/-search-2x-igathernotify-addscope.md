...
keywords: ["AddScope (Deprecated) method Legacy Windows Environment Features", "AddScope (Deprecated) method Legacy Windows Environment Features , IGatherNotify interface", "IGatherNotify interface Legacy Windows Environment Features , AddScope (Deprecated) method"]
topic_type:
- apiref
api_name:
