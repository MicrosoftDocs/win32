...
keywords: ["MPTHREAT_INFOEX_UNUSED structure Legacy Windows Environment Features", "PMPTHREAT_INFOEX_UNUSED structure pointer Legacy Windows Environment Features"]
topic_type:
- apiref
api_name:
