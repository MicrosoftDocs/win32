...
Removes all [**Command**](https://msdn.microsoft.com/library/windows/desktop/ms696441) objects from the [**Commands**](https://msdn.microsoft.com/library/windows/desktop/ms695971) collection.
