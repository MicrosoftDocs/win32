...
<span id="Description"></span><span id="description"></span><span id="DESCRIPTION"></span>[**Description**](Description)
</dt> <dd>
...
Avoid calling this method directly after a [**Show**](Show) method. **Show** automatically sets the input-active client. When the character is hidden, the [**Activate**](Activate) call may fail if it gets processed before the **Show** method completes.
