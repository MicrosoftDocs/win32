...
**IAgentNotifySinkEx** is derived from the [**IAgentNotifySink**](lwef-iagentnotifysink) interface. It includes all the **IAgentNotifySink** methods and provides access to additional functions.
