...
The [**Character**](https://msdn.microsoft.com/library/windows/desktop/ms696372) object exposes the following properties:
...
Note that the [**Height**](height-property.md), [**Left**](left-property.md), [**Top**](top-property.md), and [**Width**](width-property-co.md) properties of a character differ from those that may be supported by the programming environment for the placement of the control. The [**Character**](https://msdn.microsoft.com/library/windows/desktop/ms696372) properties apply to the visible presentation of a character, not the location of the Microsoft Agent control.

As with [**Character**](https://msdn.microsoft.com/library/windows/desktop/ms696372) object methods, you can access a character's properties using the [**Characters**](https://msdn.microsoft.com/library/windows/desktop/ms696372) collection, or simplify your syntax by declaring an object variable and setting it to a character in the collection. In the following example, Test1 and Test2 will be set to the same value:
