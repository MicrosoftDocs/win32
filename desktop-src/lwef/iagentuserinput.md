...
When the server notifies the input-active client with [**IAgentNotifySink::Command**](iagentnotifysink--command.md), it returns information through the [**IAgentUserInput**](https://msdn.microsoft.com/library/windows/desktop/ms697590) object. **IAgentUserInput** defines an interface that allows applications to query these values.
