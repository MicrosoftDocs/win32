...
If you do not supply this parameter, the [**VoiceCaption**](voicecaption-property.md) for your [**Commands**](https://msdn.microsoft.com/library/windows/desktop/ms695971) object will not appear in the Voice Commands Window.
