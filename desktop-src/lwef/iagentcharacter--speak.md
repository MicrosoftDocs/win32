...
Address of a variable that receives the [**Speak**](https://msdn.microsoft.com/library/windows/desktop/ms697891) request ID.
...
> [!Note]  
> Set the character's language ID (using [**IAgentCharacterEx::SetLanguageID**](iagentcharacterex--setlanguageid.md) before using the [**Speak**](https://msdn.microsoft.com/library/windows/desktop/ms697891) method to ensure appropriate text display within the word balloon.
