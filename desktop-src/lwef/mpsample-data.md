---
title: MPSAMPLE\_DATA structure
...
keywords: ["MPSAMPLE_DATA structure Legacy Windows Environment Features", "PMPSAMPLE_DATA structure pointer Legacy Windows Environment Features"]
topic_type:
- apiref
api_name:
- MPSAMPLE_DATA
