...
| **const unsigned short** **CSHELPCAUSE\_OTHERPROGRAM = 2;**<br/>        | The user selected the [**Commands**](https://msdn.microsoft.com/library/windows/desktop/ms695971) object of another client. |
