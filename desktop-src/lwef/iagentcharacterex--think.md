...
The [**IAgentBalloon**](https://msdn.microsoft.com/library/windows/desktop/ms697893) settings also apply to the appearance style of the thought balloon. For example, the balloon's [**Enabled**](enabled-property.md) property must also be **True** for the text to display.
