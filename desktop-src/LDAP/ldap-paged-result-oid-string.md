...
keywords: ["LDAP_PAGED_RESULT_OID_STRING control code LDAP"]
topic_type:
- apiref
api_name:
...
To use this control, format the control contents using the [**ldap\_create\_page\_control**](ldap-create-page-control.md) function, or set the members of the [**LDAPControl**](ldapcontrol.md) structure as follows.
...
Client applications should use the LDAP API functions, such as [**ldap\_create\_page\_control**](ldap-create-page-control.md), [**ldap\_search\_init\_page**](ldap-search-init-page.md), [**ldap\_parse\_result**](ldap-parse-result.md), [**ldap\_parse\_page\_control**](ldap-parse-page-control.md), and so on, instead of attempting to create and manipulate this control directly.
