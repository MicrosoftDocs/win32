...
A pointer to a zero-terminated [format string](https://www.bing.com/search?q=format string) that defines the desired display. Setting this parameter to **NULL** will reset the control to the default format string for the current style.
