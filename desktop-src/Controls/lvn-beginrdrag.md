---
title: LVN\_BEGINRDRAG notification code
description: Notifies a list-view controls parent window that a drag-and-drop operation involving the right mouse button is being initiated. This notification code is sent in the form of a WM\_NOTIFY message.
