...
keywords: ["LVN_BEGINRDRAG notification code Windows Controls"]
topic_type:
- apiref
api_name:
- LVN_BEGINRDRAG
...
Pointer to an [**NMLISTVIEW**](nmlistview.md) structure. The **iItem** member identifies the item being dragged, and the other members are zero.
