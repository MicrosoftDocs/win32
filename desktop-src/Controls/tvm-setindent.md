...
keywords: ["TVM_SETINDENT message Windows Controls"]
topic_type:
- apiref
api_name:
- TVM_SETINDENT
...
Sets the width of indentation for a tree-view control and redraws the control to reflect the new width. You can send this message explicitly or by using the [**TreeView\_SetIndent**](treeview-setindent.md) macro.
...
[**TreeView\_SetIndent**](treeview-setindent.md)
</dt> </dl>
