...
When a trackbar control is created with the [**TBS\_TOOLTIPS**](https://www.bing.com/search?q=**TBS\_TOOLTIPS**) style, it creates a default tooltip control that appears next to the slider, displaying the slider's current position.
