...
A pointer to an [**NMKEY**](/windows/desktop/api/Commctrl/ns-commctrl-tagnmkey) structure that contains additional information about the key that caused the notification code.
