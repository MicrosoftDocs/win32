...
If the pager control has the [**PGS\_HORZ**](https://www.bing.com/search?q=**PGS\_HORZ**) style, the button size determines the width of the pager buttons. If the pager control has the [**PGS\_VERT**](https://www.bing.com/search?q=**PGS\_VERT**) style, the button size determines the height of the pager buttons. By default, the pager control sets its button size to three-fourths of the width of the scroll bar.
