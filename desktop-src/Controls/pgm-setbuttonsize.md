...
If the pager control has the [**PGS\_HORZ**](pager-control-styles.md#pgs-horz) style, the button size determines the width of the pager buttons. If the pager control has the [**PGS\_VERT**](pager-control-styles.md#pgs-vert) style, the button size determines the height of the pager buttons. By default, the pager control sets its button size to three-fourths of the width of the scroll bar.
