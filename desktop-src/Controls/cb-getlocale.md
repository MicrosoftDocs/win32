...
Gets the current locale of the combo box. The locale is used to determine the correct sorting order of displayed text for combo boxes with the [**CBS\_SORT**](https://www.bing.com/search?q=**CBS\_SORT**) style and text added by using the [**CB\_ADDSTRING**](cb-addstring.md) message.
