...
| When you hold the mouse pointer over a partially concealed folder name in the Windows Explorer tree view, a tooltip appears that displays the entire name. How do I create one of these in-place tooltips? | See [Implementing In-Place Tooltips](https://www.bing.com/search?q=Implementing In-Place Tooltips) in [Using Tooltip Controls](using-tooltip-contro.md).                                  |
| How do I create a toolbar that the user can customize?                                                                                                                                                     | See [Customizing Toolbars](https://www.bing.com/search?q=Customizing Toolbars) in Using Toolbar Controls.                                                                        |
| How do I embed a control, such as an edit box, in a toolbar control?                                                                                                                                       | See [Embedding Nonbutton Controls](https://www.bing.com/search?q=Embedding Nonbutton Controls) in Toolbars in [Using Toolbar Controls](using-toolbar-controls.md). |
