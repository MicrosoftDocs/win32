...
| <dl> <dt>**CDRF\_NEWFONT**</dt> </dl>           | Your application specified a new font for the item. The control will use the new font. For more information about changing fonts, see [Changing fonts and colors](custom-draw.md#customdraw-changingfontsandcolors). This occurs when **dwDrawStage** equals CDDS\_ITEMPREPAINT.<br/> |
