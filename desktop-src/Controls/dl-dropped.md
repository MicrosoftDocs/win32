...
keywords: ["DL_DROPPED notification code Windows Controls"]
topic_type:
- apiref
api_name:
- DL_DROPPED
...
A pointer to a [**DRAGLISTINFO**](draglistinfo.md) structure that contains the DL\_DROPPED notification code, the handle to the drag list box, and the cursor position.
