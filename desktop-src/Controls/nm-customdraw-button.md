---
title: NM\_CUSTOMDRAW (button) notification code
...
keywords: ["NM_CUSTOMDRAW (button) notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_CUSTOMDRAW
...
A pointer to an [**NMCUSTOMDRAW**](nmcustomdraw.md) structure that contains information about the drawing operation. The **dwItemSpec** member of this structure contains the index of the item being drawn and the **lItemlParam** member of this structure contains the item's *lParam*.
