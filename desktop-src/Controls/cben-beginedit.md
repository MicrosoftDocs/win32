...
keywords: ["CBEN_BEGINEDIT notification code Windows Controls"]
topic_type:
- apiref
api_name:
- CBEN_BEGINEDIT
...
A pointer to an [**NMHDR**](nmhdr.md) structure that contains information about the notification code.
