...
keywords: ["EN_ENDCOMPOSITION notification code Windows Controls"]
topic_type:
- apiref
api_name:
- EN_ENDCOMPOSITION
...
A [**ENDCOMPOSITIONNOTIFY**](endcompositionnotify.md) structure that receives information about the end composition condition.
