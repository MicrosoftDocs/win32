...
keywords: ["LVM_SETITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_SETITEM
...
Sets some or all of a list-view item's attributes. You can also send LVM\_SETITEM to set the text of a subitem. You can send this message explicitly or by using the [**ListView\_SetItem**](listview-setitem.md) macro.
