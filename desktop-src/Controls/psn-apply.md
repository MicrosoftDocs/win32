...
To set the return value, the dialog box procedure for the page must call the [**SetWindowLong**](https://msdn.microsoft.com/library/windows/desktop/ms633591) function with the DWL\_MSGRESULT value, and the dialog box procedure must return **TRUE**.
