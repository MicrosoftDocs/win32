...
| <span id="GDT_NONE"></span><span id="gdt_none"></span><dl> <dt>**GDT\_NONE**</dt> </dl>    | Set the DTP control to "no date" and clear its check box. When this flag is specified, *lParam* is ignored. This flag applies only to DTP controls that are set to the [**DTS\_SHOWNONE**](https://www.bing.com/search?q=**DTS\_SHOWNONE**) style. <br/> |
