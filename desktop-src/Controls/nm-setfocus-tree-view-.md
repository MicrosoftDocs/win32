---
title: NM\_SETFOCUS (tree view) notification code
description: Notifies a tree-view controls parent window that the control has received the input focus. This notification code is sent in the form of a WM\_NOTIFY message.
