...
Specifies the size of the [**TBBUTTON**](/windows/desktop/api/Commctrl/ns-commctrl-_tbbutton) structure.
...
Size, in bytes, of the [**TBBUTTON**](/windows/desktop/api/Commctrl/ns-commctrl-_tbbutton) structure.
