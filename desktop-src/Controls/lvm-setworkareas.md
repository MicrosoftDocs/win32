...
Pointer to an array of [**RECT**](https://msdn.microsoft.com/library/windows/desktop/dd162897) structures that contain the new working areas of the list-view control. Values in these structures are in client coordinates. If this parameter is **NULL**, the working area will be set to the client area of the control. *wParam* specifies the number of structures in this array.
