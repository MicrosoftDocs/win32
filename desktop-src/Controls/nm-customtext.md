...
keywords: ["NM_CUSTOMTEXT notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_CUSTOMTEXT
...
A pointer to an [**NMCUSTOMTEXT**](nmcustomtext.md) structure that contains additional information about this notification.
