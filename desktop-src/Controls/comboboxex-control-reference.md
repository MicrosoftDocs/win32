...
| [**CBEM\_GETEDITCONTROL**](cbem-geteditcontrol.md)     | Gets the handle to the edit control portion of a ComboBoxEx control. A ComboBoxEx control uses an edit box when it is set to the [**CBS\_DROPDOWN**](https://www.bing.com/search?q=**CBS\_DROPDOWN**) style. <br/> |
