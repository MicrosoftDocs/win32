...
keywords: ["RB_SIZETORECT message Windows Controls"]
topic_type:
- apiref
api_name:
- RB_SIZETORECT
...
Pointer to a [**RECT**](https://msdn.microsoft.com/library/windows/desktop/dd162897) structure that specifies the rectangle to which the rebar control should be sized.
