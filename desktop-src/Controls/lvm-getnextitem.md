---
title: LVM\_GETNEXTITEM message
...
keywords: ["LVM_GETNEXTITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETNEXTITEM
...
Searches for a list-view item that has the specified properties and bears the specified relationship to a specified item. You can send this message explicitly or by using the [**ListView\_GetNextItem**](listview-getnextitem.md) macro.
