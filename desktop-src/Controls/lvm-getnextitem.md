...
Searches for a list-view item that has the specified properties and bears the specified relationship to a specified item. You can send this message explicitly or by using the [**ListView\_GetNextItem**](/windows/win32/Commctrl/nf-commctrl-listview_getnextitem?branch=master) macro.
