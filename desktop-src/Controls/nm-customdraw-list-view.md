...
keywords: ["NM_CUSTOMDRAW (list view) notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_CUSTOMDRAW
...
Pointer to a [**NMLVCUSTOMDRAW**](nmlvcustomdraw.md) structure that contains information about the drawing operation. The first member of this structure, **nmcd**, is a pointer to an [**NMCUSTOMDRAW**](nmcustomdraw.md) structure. The **dwItemSpec** member of the structure pointed to by **nmcd** contains the identifier of the item being drawn and the **lItemlParam** member contains its application-defined data.
