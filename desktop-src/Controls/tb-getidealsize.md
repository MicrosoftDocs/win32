...
Pointer to a [**SIZE**](https://msdn.microsoft.com/library/windows/desktop/dd145106) structure that receives the height or width at which all buttons would be displayed. If *wParam* is **TRUE**, only the **cy** member (height) is valid. If *wParam* is **FALSE**, only the **cx** member (width) is valid.
