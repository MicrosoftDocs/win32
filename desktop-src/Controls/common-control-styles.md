...
| <span id="CCS_NOMOVEX"></span><span id="ccs_nomovex"></span><dl> <dt>**CCS\_NOMOVEX**</dt> </dl>                   | [Version 4.70](common-controls-intro.md). Causes the control to resize and move itself vertically, but not horizontally, in response to a [**WM\_SIZE**](https://docs.microsoft.com/windows/desktop/winmsg/wm-size) message. If CCS\_NORESIZE is used, this style does not apply.<br/>                                                                                                    |
| <span id="CCS_NOMOVEY"></span><span id="ccs_nomovey"></span><dl> <dt>**CCS\_NOMOVEY**</dt> </dl>                   | Causes the control to resize and move itself horizontally, but not vertically, in response to a [**WM\_SIZE**](https://docs.microsoft.com/windows/desktop/winmsg/wm-size) message. If CCS\_NORESIZE is used, this style does not apply. Header windows have this style by default.<br/>                                                                                                    |
