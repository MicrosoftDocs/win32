...
Sent when a button receives the keyboard focus. The button must have the [**BS\_NOTIFY**](https://www.bing.com/search?q=**BS\_NOTIFY**) style to send this notification code.
