...
description: Retrieves the number of logical positions the trackbars slider moves in response to keyboard input from the arrow keys, such as the or keys. The logical positions are the integer increments in the trackbars range of minimum to maximum slider positions.
