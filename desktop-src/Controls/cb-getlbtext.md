...
If you create the combo box with an owner-drawn style but without the [**CBS\_HASSTRINGS**](https://www.bing.com/search?q=**CBS\_HASSTRINGS**) style, the buffer pointed to by *lParam* receives the data associated with the item.
