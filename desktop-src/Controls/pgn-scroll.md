---
title: PGN\_SCROLL notification code
description: Notifies a pager controls parent window that the contained window is about to be scrolled. This notification is sent in the form of a WM\_NOTIFY message.
