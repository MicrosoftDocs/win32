...
| [**Animate\_Create**](/windows/desktop/api/Commctrl/nf-commctrl-animate_create)       | Creates an animation control. [**Animate\_Create**](/windows/desktop/api/Commctrl/nf-commctrl-animate_create) calls the [**CreateWindow**](https://msdn.microsoft.com/library/windows/desktop/ms632679) function to create the animation control. <br/>                                                                                   |
