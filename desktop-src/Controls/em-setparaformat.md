...
Pointer to a [**PARAFORMAT**](/windows/win32/Richedit/ns-richedit-_paraformat?branch=master) structure specifying the new paragraph formatting attributes. Only the attributes specified by the **dwMask** member are changed.

Microsoft Rich Edit 2.0 and later: This parameter can be a pointer to a [**PARAFORMAT2**](/windows/win32/Richedit/ns-richedit-paraformat2?branch=master) structure, which is an extension of the [**PARAFORMAT**](/windows/win32/Richedit/ns-richedit-_paraformat?branch=master) structure. Before sending the **EM\_SETPARAFORMAT** message, set the structure's **cbSize** member to indicate the version of the structure.
