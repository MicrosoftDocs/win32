...
description: Notifies a controls parent window that the control has created a tooltip control. This notification code is sent in the form of a WM\_NOTIFY message.
...
A pointer to an [**NMTOOLTIPSCREATED**](/windows/win32/Commctrl/ns-commctrl-tagnmtooltipscreated?branch=master) structure that contains additional information about this notification.
