...
keywords: ["HDM_SETBITMAPMARGIN message Windows Controls"]
topic_type:
- apiref
api_name:
- HDM_SETBITMAPMARGIN
...
Sets the width of the margin, specified in pixels, of a bitmap in an existing header control. You can send this message explicitly or use the [**Header\_SetBitmapMargin**](header-setbitmapmargin.md) macro.
