...
*lParam* 
</dt> <dd>A pointer to an [**LVGROUPMETRICS**](/windows/win32/Commctrl/ns-commctrl-taglvgroupmetrics?branch=master) structure that receives the retrieved metrics.</dd> </dl>
