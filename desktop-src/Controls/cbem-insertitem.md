...
keywords: ["CBEM_INSERTITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- CBEM_INSERTITEM
...
A pointer to a [**COMBOBOXEXITEM**](comboboxexitem.md) structure that contains information about the item to be inserted. When the message is sent, the **iItem** member must be set to indicate the zero-based index at which to insert the item. To insert an item at the end of the list, set the **iItem** member to -1.
