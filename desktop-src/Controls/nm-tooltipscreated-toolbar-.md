...
Pointer to an [**NMTOOLTIPSCREATED**](/windows/desktop/api/Commctrl/ns-commctrl-tagnmtooltipscreated) structure that contains additional information about this notification.
