...
description: Notifies a toolbars parent window that the toolbar has created a tooltip control. This notification code is sent in the form of a WM\_NOTIFY message.
...
Pointer to an [**NMTOOLTIPSCREATED**](/windows/win32/Commctrl/ns-commctrl-tagnmtooltipscreated?branch=master) structure that contains additional information about this notification.
