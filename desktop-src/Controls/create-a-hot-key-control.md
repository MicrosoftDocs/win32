...
This topic demonstrates how to create a hot key control. You create a hot key control by using the [**CreateWindowEx**](https://msdn.microsoft.com/library/windows/desktop/ms632680) function, specifying the HOTKEY\_CLASS window class.
