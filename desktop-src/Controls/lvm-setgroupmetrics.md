...
keywords: ["LVM_SETGROUPMETRICS message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_SETGROUPMETRICS
...
*lParam* 
</dt> <dd>Pointer to an [**LVGROUPMETRICS**](lvgroupmetrics.md) structure that contains the metrics to set.</dd> </dl>
