---
title: TTM\_GETCURRENTTOOL message
...
keywords: ["TTM_GETCURRENTTOOL message Windows Controls"]
topic_type:
- apiref
api_name:
- TTM_GETCURRENTTOOL
...
Pointer to a [**TOOLINFO**](toolinfo.md) structure that receives information about the current tool. If this value is **NULL**, the return value indicates the existence of the current tool without actually retrieving the tool information. If this value is not **NULL**, the **cbSize** member of the **TOOLINFO** structure must be filled in before sending this message.
