...
| <span id="ES_EX_NOCALLOLEINIT"></span><span id="es_ex_nocalloleinit"></span><dl> <dt>**ES\_EX\_NOCALLOLEINIT**</dt> </dl> | Prevents the control from calling the [**OleInitialize**](https://msdn.microsoft.com/library/windows/desktop/ms690134) function when created. This window style is useful only in dialog templates because [**CreateWindowEx**](https://msdn.microsoft.com/library/windows/desktop/ms632680) does not accept this style.<br/> |
...
| <span id="ES_NOHIDESEL"></span><span id="es_nohidesel"></span><dl> <dt>**ES\_NOHIDESEL**</dt> </dl>       | Negates the default behavior for an edit control. The default behavior hides the selection when the control loses the input focus and inverts the selection when the control receives the input focus. If you specify [**ES\_NOHIDESEL**](https://www.bing.com/search?q=**ES\_NOHIDESEL**), the selected text is inverted, even if the control does not have the focus.<br/> |
...
-   [**ES\_LOWERCASE**](https://www.bing.com/search?q=**ES\_LOWERCASE**)
-   [**ES\_OEMCONVERT**](https://www.bing.com/search?q=**ES\_OEMCONVERT**)
-   [**ES\_UPPERCASE**](https://www.bing.com/search?q=**ES\_UPPERCASE**)
