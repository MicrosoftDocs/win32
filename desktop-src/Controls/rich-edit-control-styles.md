...
| <span id="ES_NOHIDESEL"></span><span id="es_nohidesel"></span><dl> <dt>**ES\_NOHIDESEL**</dt> </dl>       | Negates the default behavior for an edit control. The default behavior hides the selection when the control loses the input focus and inverts the selection when the control receives the input focus. If you specify [**ES\_NOHIDESEL**](edit-control-styles.md#es-nohidesel), the selected text is inverted, even if the control does not have the focus.<br/> |
...
-   [**ES\_LOWERCASE**](edit-control-styles.md#es-lowercase)
-   [**ES\_OEMCONVERT**](edit-control-styles.md#es-oemconvert)
-   [**ES\_UPPERCASE**](edit-control-styles.md#es-uppercase)
