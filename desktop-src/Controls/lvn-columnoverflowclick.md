...
Pointer to a [**NMLISTVIEW**](/windows/win32/Commctrl/ns-commctrl-tagnmlistview?branch=master) structure that describes the notification code. The caller is responsible for allocating this structure, including the contained [**NMHDR**](/windows/win32/richedit/ns-richedit-_nmhdr?branch=master) structure. Set the members of the **NMHDR** structure. The **code** member must be set to LVN\_COLUMNOVERFLOWCLICK.
