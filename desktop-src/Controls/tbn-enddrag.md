---
title: TBN\_ENDDRAG notification code
description: Notifies the toolbars parent window that the user has stopped dragging a button in a toolbar. This notification code is sent in the form of a WM\_NOTIFY message.
