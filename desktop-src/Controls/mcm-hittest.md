...
| <dl> <dt>**MCHT\_CALENDARWEEKNUM**</dt> </dl>  | The given point was over a week number ([**MCS\_WEEKNUMBERS**](https://www.bing.com/search?q=**MCS\_WEEKNUMBERS**) style only). The [**SYSTEMTIME**](https://msdn.microsoft.com/library/windows/desktop/ms724950) structure at *lParam-&gt;st* is set to the corresponding date in the leftmost column.<br/> |
