...
| <dl> <dt>**MCHT\_CALENDARDATE**</dt> </dl>     | The given point was on a particular date within the calendar. The [**SYSTEMTIME**](https://msdn.microsoft.com/library/windows/desktop/ms724950) structure at *lParam-&gt;st* is set to the date at the given point.<br/>                                                                                    |
...
| <dl> <dt>**MCHT\_CALENDARDAY**</dt> </dl>      | The given point was over a day abbreviation ("Fri", for example). The [**SYSTEMTIME**](https://msdn.microsoft.com/library/windows/desktop/ms724950) structure at *lParam-&gt;st* is set to the corresponding date in the top row.<br/>                                                                      |
| <dl> <dt>**MCHT\_CALENDARWEEKNUM**</dt> </dl>  | The given point was over a week number ([**MCS\_WEEKNUMBERS**](month-calendar-control-styles.md#mcs-weeknumbers) style only). The [**SYSTEMTIME**](https://msdn.microsoft.com/library/windows/desktop/ms724950) structure at *lParam-&gt;st* is set to the corresponding date in the leftmost column.<br/> |
