...
| <dl> <dt>**MCHT\_CALENDARWEEKNUM**</dt> </dl>  | The given point was over a week number ([**MCS\_WEEKNUMBERS**](month-calendar-control-styles.md) style only). The [**SYSTEMTIME**](https://msdn.microsoft.com/library/windows/desktop/ms724950) structure at *lParam->st* is set to the corresponding date in the leftmost column.<br/> |
