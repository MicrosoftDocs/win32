...
Sets the tooltip text for a part in a status bar. The status bar must have been created with the [**SBT\_TOOLTIPS**](https://www.bing.com/search?q=**SBT\_TOOLTIPS**) style to enable tooltips.
