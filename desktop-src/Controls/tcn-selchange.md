---
title: TCN\_SELCHANGE notification code
description: Notifies a tab controls parent window that the currently selected tab has changed. This notification code is sent in the form of a WM\_NOTIFY message.
