...
keywords: ["TBN_DROPDOWN notification code Windows Controls"]
topic_type:
- apiref
api_name:
- TBN_DROPDOWN
...
Pointer to an [**NMTOOLBAR**](nmtoolbar.md) structure that contains information about this notification code. For this notification code, only the **hdr** and **iItem** members of this structure are valid.
