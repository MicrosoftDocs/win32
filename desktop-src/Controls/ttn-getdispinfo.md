...
Pointer to an [**NMTTDISPINFO**](/windows/win32/Commctrl/ns-commctrl-tagnmttdispinfoa?branch=master) structure that identifies the tool that needs text and receives the requested information.
...
Fill the structure's appropriate members to return the requested information to the tooltip control. If your message handler sets the **uFlags** member of the [**NMTTDISPINFO**](/windows/win32/Commctrl/ns-commctrl-tagnmttdispinfoa?branch=master) structure to TTF\_DI\_SETITEM, the tooltip control stores the information and will not request it again.
