...
keywords: ["LVM_GETFOCUSEDGROUP message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETFOCUSEDGROUP
...
Gets the group that has the focus. Send this message explicitly or by using the [**ListView\_GetFocusedGroup**](listview-getfocusedgroup.md) macro.
