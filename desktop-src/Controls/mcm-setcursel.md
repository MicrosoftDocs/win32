...
Returns nonzero if successful, or zero otherwise. This message will fail if applied to a month calendar control that uses the [**MCS\_MULTISELECT**](https://www.bing.com/search?q=**MCS\_MULTISELECT**) style.
