...
keywords: ["LVM_GETCOLUMN message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETCOLUMN
...
Gets the attributes of a list-view control's column. You can send this message explicitly or by using the [**ListView\_GetColumn**](listview-getcolumn.md) macro.
