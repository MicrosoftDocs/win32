---
title: TBN\_GETOBJECT notification code
...
Sent by a toolbar control that uses the [**TBSTYLE\_REGISTERDROP**](https://www.bing.com/search?q=**TBSTYLE\_REGISTERDROP**) style to request a drop target object when the pointer passes over one of its buttons. This notification code is sent in the form of a [**WM\_NOTIFY**](wm-notify.md) message.
