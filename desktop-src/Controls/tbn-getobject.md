...
keywords: ["TBN_GETOBJECT notification code Windows Controls"]
topic_type:
- apiref
api_name:
- TBN_GETOBJECT
...
Pointer to an [**NMOBJECTNOTIFY**](nmobjectnotify.md) structure that contains information about the button that the pointer passed over and receives data the application provides in response to this notification code.
