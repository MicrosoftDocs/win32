...
| [**WM\_SETCURSOR**](https://docs.microsoft.com/windows/desktop/menurc/wm-setcursor)           | Sets the cursor shape, depending on whether the cursor is on a divider or in a header item.                                                                                                                                                                                                                   |
