...
keywords: ["LVM_GETTILEVIEWINFO message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETTILEVIEWINFO
...
*lParam* 
</dt> <dd>Pointer to an [**LVTILEVIEWINFO**](lvtileviewinfo.md) structure that receives the retrieved information.</dd> </dl>
