...
keywords: ["TCM_DESELECTALL message Windows Controls"]
topic_type:
- apiref
api_name:
- TCM_DESELECTALL
...
Resets items in a tab control, clearing any that were set to the [**TCIS\_BUTTONPRESSED**](tab-control-item-states.md#tcis-buttonpressed) state. You can send this message explicitly or by using the [**TabCtrl\_DeselectAll**](tabctrl-deselectall.md) macro.
