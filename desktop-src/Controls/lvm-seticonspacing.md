...
Sets the spacing between icons in list-view controls that have the [**LVS\_ICON**](https://www.bing.com/search?q=**LVS\_ICON**) style. You can send this message explicitly or by using the [**ListView\_SetIconSpacing**](/windows/desktop/api/Commctrl/nf-commctrl-listview_seticonspacing) macro.
