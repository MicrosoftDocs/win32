...
keywords: ["DL_BEGINDRAG notification code Windows Controls"]
topic_type:
- apiref
api_name:
- DL_BEGINDRAG
...
A pointer to a [**DRAGLISTINFO**](draglistinfo.md) structure that contains the DL\_BEGINDRAG notification code, the handle to the drag list box, and the cursor position.
