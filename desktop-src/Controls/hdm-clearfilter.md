...
keywords: ["HDM_CLEARFILTER message Windows Controls"]
topic_type:
- apiref
api_name:
- HDM_CLEARFILTER
...
Clears the filter for a given header control. You can send this message explicitly or use the [**Header\_ClearFilter**](header-clearfilter.md) macro.
...
[**Header\_ClearAllFilters**](header-clearallfilters.md)
</dt> </dl>
