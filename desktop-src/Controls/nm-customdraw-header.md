---
title: NM\_CUSTOMDRAW (header) notification code
...
keywords: ["NM_CUSTOMDRAW (header) notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_CUSTOMDRAW
...
See [Using Custom Draw](custom-draw.md#customdraw-processingnm-customdraw) for further discussion.
