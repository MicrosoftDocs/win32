...
| [**Button\_SetDropDownState**](/windows/desktop/api/Commctrl/nf-commctrl-button_setdropdownstate)                   | Sets the drop down state for a specified button with style of [**BS\_SPLITBUTTON**](https://www.bing.com/search?q=**BS\_SPLITBUTTON**). Use this macro or send the [**BCM\_SETDROPDOWNSTATE**](bcm-setdropdownstate.md) message explicitly. <br/>           |
...
| [**BCM\_SETDROPDOWNSTATE**](bcm-setdropdownstate.md) | Sets the drop down state for a button with style [**TBSTYLE\_DROPDOWN**](https://www.bing.com/search?q=**TBSTYLE\_DROPDOWN**). Send this message explicitly or by using the [**Button\_SetDropDownState**](/windows/desktop/api/Commctrl/nf-commctrl-button_setdropdownstate) macro.<br/>                                        |
...
<td>Sent when the user double-clicks a button. This notification code is sent automatically for [<strong>BS_USERBUTTON</strong>](https://www.bing.com/search?q=<strong>BS_USERBUTTON</strong>), [<strong>BS_RADIOBUTTON</strong>](https://www.bing.com/search?q=<strong>BS_RADIOBUTTON</strong>), and [<strong>BS_OWNERDRAW</strong>](https://www.bing.com/search?q=<strong>BS_OWNERDRAW</strong>) buttons. Other button types send [BN_DBLCLK](bn-dblclk.md) only if they have the [<strong>BS_NOTIFY</strong>](https://www.bing.com/search?q=<strong>BS_NOTIFY</strong>) style.<br/> The parent window of the button receives the [BN_DBLCLK](bn-dblclk.md) notification code through the [<strong>WM_COMMAND</strong>](https://msdn.microsoft.com/library/windows/desktop/ms647591) message. <br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
This notification code is provided only for compatibility with 16-bit versions of Windows earlier than version 3.0. Applications should use the [<strong>BS_OWNERDRAW</strong>](https://www.bing.com/search?q=<strong>BS_OWNERDRAW</strong>) button style and the [<strong>DRAWITEMSTRUCT</strong>](/windows/desktop/api/Winuser/ns-winuser-tagdrawitemstruct) structure for this task.
</blockquote>
...
<td>Sent when the user double-clicks a button. This notification code is sent automatically for [<strong>BS_USERBUTTON</strong>](https://www.bing.com/search?q=<strong>BS_USERBUTTON</strong>), [<strong>BS_RADIOBUTTON</strong>](https://www.bing.com/search?q=<strong>BS_RADIOBUTTON</strong>), and [<strong>BS_OWNERDRAW</strong>](https://www.bing.com/search?q=<strong>BS_OWNERDRAW</strong>) buttons. Other button types send [BN_DOUBLECLICKED](bn-doubleclicked.md) only if they have the [<strong>BS_NOTIFY</strong>](https://www.bing.com/search?q=<strong>BS_NOTIFY</strong>) style.<br/> The parent window of the button receives the [BN_DOUBLECLICKED](bn-doubleclicked.md) notification code through the [<strong>WM_COMMAND</strong>](https://msdn.microsoft.com/library/windows/desktop/ms647591) message. <br/></td>
</tr>
<tr class="odd">
...
<td>Sent when a button loses the keyboard focus. The button must have the [<strong>BS_NOTIFY</strong>](https://www.bing.com/search?q=<strong>BS_NOTIFY</strong>) style to send this notification code. <br/> The parent window of the button receives the [BN_KILLFOCUS](bn-killfocus.md) notification code through the [<strong>WM_COMMAND</strong>](https://msdn.microsoft.com/library/windows/desktop/ms647591) message. <br/></td>
</tr>
<tr class="odd">
...
<td>Sent when a button receives the keyboard focus. The button must have the [<strong>BS_NOTIFY</strong>](https://www.bing.com/search?q=<strong>BS_NOTIFY</strong>) style to send this notification code. <br/> The parent window of the button receives the [BN_SETFOCUS](bn-setfocus.md) notification code through the [<strong>WM_COMMAND</strong>](https://msdn.microsoft.com/library/windows/desktop/ms647591) message.<br/></td>
</tr>
<tr class="even">
...
| [**BUTTON\_SPLITINFO**](/windows/desktop/api/Commctrl/ns-commctrl-tagbutton_splitinfo) | Contains information that defines a split button ([**BS\_SPLITBUTTON**](https://www.bing.com/search?q=**BS\_SPLITBUTTON**) and [**BS\_DEFSPLITBUTTON**](https://www.bing.com/search?q=**BS\_DEFSPLITBUTTON**) styles). Used with the [**BCM\_GETSPLITINFO**](bcm-getsplitinfo.md) and [**BCM\_SETSPLITINFO**](bcm-setsplitinfo.md) messages.<br/> |
