---
title: NM\_RELEASEDCAPTURE (rebar) notification code
description: Notifies a rebar controls parent window that the control is releasing mouse capture. This notification code is sent in the form of a WM\_NOTIFY message.
