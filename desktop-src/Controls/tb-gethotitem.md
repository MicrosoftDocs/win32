...
Returns the index of the hot item, or -1 if no hot item is set. Toolbar controls that do not have the [**TBSTYLE\_FLAT**](toolbar-control-and-button-styles.md#tbstyle-flat) style do not have hot items.
