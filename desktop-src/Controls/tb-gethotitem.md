...
Returns the index of the hot item, or -1 if no hot item is set. Toolbar controls that do not have the [**TBSTYLE\_FLAT**](https://www.bing.com/search?q=**TBSTYLE\_FLAT**) style do not have hot items.
