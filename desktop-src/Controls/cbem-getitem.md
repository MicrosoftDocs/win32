...
keywords: ["CBEM_GETITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- CBEM_GETITEM
...
A pointer to a [**COMBOBOXEXITEM**](comboboxexitem.md) structure that receives the item information.
