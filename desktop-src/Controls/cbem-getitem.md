...
A pointer to a [**COMBOBOXEXITEM**](/windows/win32/Commctrl/ns-commctrl-tagcomboboxexitema?branch=master) structure that receives the item information.
