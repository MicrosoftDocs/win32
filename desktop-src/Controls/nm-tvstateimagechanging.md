...
A pointer to an [**NMTVSTATEIMAGECHANGING**](/windows/win32/Commctrl/ns-commctrl-tagnmtvstateimagechanging?branch=master) structure that contains additional information about this notification.
