...
To respond to the **LB\_GETHORIZONTALEXTENT** message, the list box must have been defined with the [**WS\_HSCROLL**](https://msdn.microsoft.com/library/windows/desktop/ms632600#ws-hscroll) style.
