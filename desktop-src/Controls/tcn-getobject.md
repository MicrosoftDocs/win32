...
Sent by a tab control when it has the [**TCS\_EX\_REGISTERDROP**](https://www.bing.com/search?q=**TCS\_EX\_REGISTERDROP**) extended style and an object is dragged over a tab item in the control. This notification code is sent in the form of a [**WM\_NOTIFY**](wm-notify.md) message.
