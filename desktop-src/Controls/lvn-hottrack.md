...
Sent by a list-view control when the user moves the mouse over an item. This notification code is only sent by list-view controls that have the [**LVS\_EX\_TRACKSELECT**](https://www.bing.com/search?q=**LVS\_EX\_TRACKSELECT**) extended list-view style. It is sent in the form of a [**WM\_NOTIFY**](wm-notify.md) message.
