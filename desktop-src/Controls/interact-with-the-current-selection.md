...
As with edit controls, you can specify the [**ES\_NOHIDESEL**](edit-control-styles.md#es-nohidesel) window style to prevent a rich edit control from hiding the selection highlight when it loses the focus.
