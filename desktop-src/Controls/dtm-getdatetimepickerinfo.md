...
*lParam* \[in\]
</dt> <dd> A pointer to <a href="/windows/desktop/api/Commctrl/ns-commctrl-tagdatetimepickerinfo">**DATETIMEPICKERINFO**</a> to receive the information. The caller is responsible for allocating the memory for this structure. Set the **cbSize** member of the structure to sizeof(DATETIMEPICKERINFO) before sending this message.</dd> </dl>
