---
title: EM\_GETMODIFY message
description: Gets the state of an edit controls modification flag. The flag indicates whether the contents of the edit control have been modified. You can send this message to either an edit control or a rich edit control.
