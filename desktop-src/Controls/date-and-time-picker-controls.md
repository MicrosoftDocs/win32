...
> [!Note] Windows does not support dates prior to 1601. See the [**FILETIME**](https://msdn.microsoft.com/library/windows/desktop/ms724284) structure for details.
>
...
The following illustration shows a window that contains three date-picker controls. The first date-picker control was created with the [**DTS\_SHOWNONE**](https://www.bing.com/search?q=**DTS\_SHOWNONE**) style, the second with the [**DTS\_UPDOWN**](https://www.bing.com/search?q=**DTS\_UPDOWN**) style, and the third with no special styles. In the third control, the user has clicked the down arrow to display the calendar.
...
DTP controls that do not use the [**DTS\_UPDOWN**](https://www.bing.com/search?q=**DTS\_UPDOWN**) style display an arrow button. If the user clicks this button, a month calendar control drops down. The user can select a specific date by clicking an area of the calendar.

## Date and Time Picker Control Styles and Formats

Date and time picker (DTP) controls have several [Date and Time Picker Control Styles](date-and-time-picker-control-styles.md) that determine a control's appearance and behavior. Specify the style when creating the control with the *dwStyle* parameter of [**CreateWindowEx**](https://msdn.microsoft.com/library/windows/desktop/ms632680). To retrieve or change the window style after you have created the control, use [**GetWindowLong**](https://msdn.microsoft.com/library/windows/desktop/ms633584) and [**SetWindowLong**](https://msdn.microsoft.com/library/windows/desktop/ms633591).
...
|                                                                                                       |                                                            |
|-------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| [**DTS\_LONGDATEFORMAT**](https://www.bing.com/search?q=**DTS\_LONGDATEFORMAT**)                 | The display will look like: "Friday, April 19, 1996".      |
| [**DTS\_SHORTDATEFORMAT**](https://www.bing.com/search?q=**DTS\_SHORTDATEFORMAT**)               | The display will look like: "4/19/96".                     |
| [**DTS\_SHORTDATECENTURYFORMAT**](https://www.bing.com/search?q=**DTS\_SHORTDATECENTURYFORMAT**) | **Version 5.80**. The display will look like: "4/19/1996". |
| [**DTS\_TIMEFORMAT**](https://www.bing.com/search?q=**DTS\_TIMEFORMAT**)                         | The display will look like: "5:31:42 PM".                  |
...
| [DTN\_USERSTRING](dtn-userstring.md)         | Signals the end of a user's edit operation within the control. This notification is sent only by DTP controls that use the [**DTS\_APPCANPARSE**](https://www.bing.com/search?q=**DTS\_APPCANPARSE**) style. |
