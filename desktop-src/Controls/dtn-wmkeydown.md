---
title: DTN\_WMKEYDOWN notification code
...
keywords: ["DTN_WMKEYDOWN notification code Windows Controls"]
topic_type:
- apiref
api_name:
- DTN_WMKEYDOWN
...
A pointer to an [**NMDATETIMEWMKEYDOWN**](nmdatetimewmkeydown.md) structure containing information about this instance of the notification code. The structure includes information about the key that the user typed, the substring that defines the callback field, and the current system date and time.
