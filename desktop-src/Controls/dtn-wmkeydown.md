...
A pointer to an [**NMDATETIMEWMKEYDOWN**](/windows/win32/Commctrl/ns-commctrl-tagnmdatetimewmkeydowna?branch=master) structure containing information about this instance of the notification code. The structure includes information about the key that the user typed, the substring that defines the callback field, and the current system date and time.
