...
keywords: ["WM_DRAWITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- WM_DRAWITEM
...
Pointer to a [**DRAWITEMSTRUCT**](drawitemstruct.md) structure containing information about the item to be drawn and the type of drawing required.
...
The *itemAction* member of the [**DRAWITEMSTRUCT**](drawitemstruct.md) structure specifies the drawing operation that an application should perform.

Before returning from processing this message, an application should ensure that the device context identified by the *hDC* member of the [**DRAWITEMSTRUCT**](drawitemstruct.md) structure is in the default state.
