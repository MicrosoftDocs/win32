...
keywords: ["TVN_ITEMEXPANDED notification code Windows Controls"]
topic_type:
- apiref
api_name:
- TVN_ITEMEXPANDED
...
Pointer to an [**NMTREEVIEW**](nmtreeview.md) structure. The **itemNew** member is a [**TVITEM**](tvitem.md) structure that contains valid information about the parent item in the **hItem**, **state**, and **lParam** members. The **action** member indicates whether the list expanded or collapsed. For a list of possible values, see the description of the [**TVM\_EXPAND**](tvm-expand.md) message.
