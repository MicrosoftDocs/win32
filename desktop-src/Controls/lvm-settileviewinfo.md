...
keywords: ["LVM_SETTILEVIEWINFO message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_SETTILEVIEWINFO
...
*lParam* 
</dt> <dd>Pointer to an [**LVTILEVIEWINFO**](lvtileviewinfo.md) structure that contains the information to set.</dd> </dl>
