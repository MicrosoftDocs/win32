...
Handling this notification code allows the owner of the control to provide a custom string that the control will display. (For additional information about callback fields, see [Callback fields](https://www.bing.com/search?q=Callback fields).)
