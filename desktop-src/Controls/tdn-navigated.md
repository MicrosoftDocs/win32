...
keywords: ["TDN_NAVIGATED notification code Windows Controls"]
topic_type:
- apiref
api_name:
- TDN_NAVIGATED
...
Sent by a task dialog when navigation has occurred. This notification code is received only through the task dialog callback function, which can be registered using the [**TaskDialogIndirect**](taskdialogindirect.md) method.
