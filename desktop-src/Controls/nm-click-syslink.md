...
keywords: ["NM_CLICK (syslink) notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_CLICK
...
Pointer to an [**NMLINK**](nmlink.md) structure that contains additional information about this notification.
