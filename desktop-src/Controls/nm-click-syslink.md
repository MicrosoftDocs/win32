...
description: Notifies a controls parent window that the user has clicked a hyperlink with the left mouse button within the control. This notification code is sent in the form of a WM\_NOTIFY message.
...
Pointer to an [**NMLINK**](/windows/win32/Commctrl/ns-commctrl-tagnmlink?branch=master) structure that contains additional information about this notification.
