...
When you add an item to the list, you assign it to a group by setting the **iGroupId** member of the item's [**LVITEM**](/windows/win32/Commctrl/ns-commctrl-taglvitema?branch=master) structure to the value of the **iGroupId** member of the groups's [**LVGROUP**](/windows/win32/Commctrl/ns-commctrl-taglvgroup?branch=master) structure. An item that is not assigned to a group does not appear in the list when group view is enabled. To enable or disable group view, use the [**ListView\_EnableGroupView**](/windows/win32/Commctrl/nf-commctrl-listview_enablegroupview?branch=master) macro.
