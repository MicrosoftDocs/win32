...
When an event occurs in a list box, the list box sends a notification code, in the form of a [**WM\_COMMAND**](https://msdn.microsoft.com/library/windows/desktop/ms647591) message, to the dialog box procedure of the owner window. List box notification codes are sent when a user selects, double-clicks, or cancels a list box item; when the list box receives or loses the keyboard focus; and when the system cannot allocate enough memory for a list box request. A **WM\_COMMAND** message contains the list box identifier in the low-order word of the *wParam* parameter, and the notification code in the high-order word. The *lParam* parameter contains the control window handle.
...
|----------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**WM\_CHAR**](https://msdn.microsoft.com/library/windows/desktop/ms646276)                   | Moves the selection to the first item that begins with the character that the user typed. If the list box has the L[**BS\_OWNERDRAW**](https://www.bing.com/search?q=**BS\_OWNERDRAW**) style, no action occurs. Multiple characters that are typed within a short interval are treated as a group, and the first item that begins with that series of characters is selected.<br/> |
| [**WM\_CREATE**](https://msdn.microsoft.com/library/windows/desktop/ms632619)                 | Creates an empty list box.                                                                                                                                                                                                                                                                                                                                               |
| [**WM\_DESTROY**](https://msdn.microsoft.com/library/windows/desktop/ms632620)               | Destroys the list box and frees any resources that it uses.                                                                                                                                                                                                                                                                                                              |
|                                                    | Passes the message to the dialog box procedure or parent window process.                                                                                                                                                                                                                                                                                                 |
| [**WM\_ENABLE**](https://msdn.microsoft.com/library/windows/desktop/ms632621)                 | If the control is visible, invalidates the rectangle so the strings can be painted gray.                                                                                                                                                                                                                                                                                 |
| [**WM\_ERASEBKGND**](https://msdn.microsoft.com/library/windows/desktop/ms648055)         | Erases the background of a list box. If the list box has the L[**BS\_OWNERDRAW**](https://www.bing.com/search?q=**BS\_OWNERDRAW**) style, the background is not erased.                                                                                                                                                                                                                   |
| [**WM\_GETDLGCODE**](https://msdn.microsoft.com/library/windows/desktop/ms645425)         | Returns DLGC\_WANTARROWS \| DLGC\_WANTCHARS, indicating that the default list box procedure processes the arrow keys and [**WM\_CHAR**](https://msdn.microsoft.com/library/windows/desktop/ms646276) messages.                                                                                                                                                                                                      |
| [**WM\_GETFONT**](https://msdn.microsoft.com/library/windows/desktop/ms632624)               | Returns a handle to the current font for the list box.                                                                                                                                                                                                                                                                                                                   |
| [**WM\_HSCROLL**](wm-hscroll.md)                  | Scrolls the list box horizontally.                                                                                                                                                                                                                                                                                                                                       |
| [**WM\_KEYDOWN**](https://msdn.microsoft.com/library/windows/desktop/ms646280)             | Processes virtual keys for scrolling. The virtual key is the index of the item to move the caret to. The selection is not changed.                                                                                                                                                                                                                                       |
| [**WM\_KILLFOCUS**](https://msdn.microsoft.com/library/windows/desktop/ms646282)         | Turns the caret off and destroys it. Sends an [LBN\_KILLFOCUS](lbn-killfocus.md) notification code to the owner of the list box.                                                                                                                                                                                                                                        |
| [**WM\_LBUTTONDBLCLK**](https://msdn.microsoft.com/library/windows/desktop/ms645606) | Tracks the mouse in the list box client area. This enables the user to cancel a selection if the mouse button is released outside the list box client area.                                                                                                                                                                                                              |
| [**WM\_LBUTTONDOWN**](https://msdn.microsoft.com/library/windows/desktop/ms645607)     | Tracks the mouse in the list box client area. This enables the user to cancel a selection if the mouse button is released outside the list box client area.                                                                                                                                                                                                              |
| [**WM\_LBUTTONUP**](https://msdn.microsoft.com/library/windows/desktop/ms645608)         | Tracks the mouse in the list box client area. This enables the user to cancel a selection if the mouse button is released outside the list box client area.                                                                                                                                                                                                              |
| [**WM\_MOUSEMOVE**](https://msdn.microsoft.com/library/windows/desktop/ms645616)         | Tracks the mouse in the list box client area. This enables the user to cancel a selection if the mouse button is released outside the list box client area.                                                                                                                                                                                                              |
| [**WM\_PAINT**](https://msdn.microsoft.com/library/windows/desktop/dd145213)                      | Performs a subclassed paint operation by using the list box handle to the device context (DC).                                                                                                                                                                                                                                                                           |
| [**WM\_SETFOCUS**](https://msdn.microsoft.com/library/windows/desktop/ms646283)           | Turns the caret on and sends an [LBN\_SETFOCUS](lbn-setfocus.md) notification code to the owner of the list box.                                                                                                                                                                                                                                                        |
| [**WM\_SETFONT**](https://msdn.microsoft.com/library/windows/desktop/ms632642)               | Sets a new font for the list box.                                                                                                                                                                                                                                                                                                                                        |
| [**WM\_SETREDRAW**](https://msdn.microsoft.com/library/windows/desktop/dd145219)              | Sets or clears the redraw flag based on the value of *wParam*.                                                                                                                                                                                                                                                                                                           |
| [**WM\_SIZE**](https://msdn.microsoft.com/library/windows/desktop/ms632646)                     | Resizes the list box to an integral number of items.                                                                                                                                                                                                                                                                                                                     |
...
An application can create an owner-drawn list box by specifying the [**LBS\_OWNERDRAWFIXED**](https://www.bing.com/search?q=**LBS\_OWNERDRAWFIXED**) or [**LBS\_OWNERDRAWVARIABLE**](https://www.bing.com/search?q=**LBS\_OWNERDRAWVARIABLE**) style. If all list items in the list box are the same height, such as strings or icons, an application can use the **LBS\_OWNERDRAWFIXED** style. If list items are of varying height (for example, bitmaps of different size) an application can use the **LBS\_OWNERDRAWVARIABLE** style.

The owner of an owner-drawn list box can process a [**WM\_MEASUREITEM**](wm-measureitem.md) message to specify the dimensions of list items. If the application creates the list box by using the [**LBS\_OWNERDRAWFIXED**](https://www.bing.com/search?q=**LBS\_OWNERDRAWFIXED**) style, the system sends the **WM\_MEASUREITEM** message only once. The dimensions that are specified by the owner are used for all list items. If the [**LBS\_OWNERDRAWVARIABLE**](https://www.bing.com/search?q=**LBS\_OWNERDRAWVARIABLE**) style is used, the system sends a **WM\_MEASUREITEM** message for each list item that is added to the list box. The owner can determine or set the height of a list item at any time by using the [**LB\_GETITEMHEIGHT**](lb-getitemheight.md) and [**LB\_SETITEMHEIGHT**](lb-setitemheight.md) messages, respectively.

If the information displayed in an owner-drawn list box includes text, an application can keep track of the text for each list item by specifying the [**LBS\_HASSTRINGS**](https://www.bing.com/search?q=**LBS\_HASSTRINGS**) style. List boxes with the [**LBS\_SORT**](https://www.bing.com/search?q=**LBS\_SORT**) style are sorted based on this text. If a list box is sorted, but is not of the **LBS\_HASSTRINGS** style, the owner must process the [**WM\_COMPAREITEM**](wm-compareitem.md) message.
