...
Retrieves the Unicode character format flag for the control. You can send this message explicitly or use the [**TabCtrl\_GetUnicodeFormat**](/windows/win32/Commctrl/nf-commctrl-tabctrl_getunicodeformat?branch=master) macro.
