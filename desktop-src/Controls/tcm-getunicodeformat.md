---
title: TCM\_GETUNICODEFORMAT message
...
keywords: ["TCM_GETUNICODEFORMAT message Windows Controls"]
topic_type:
- apiref
api_name:
...
Retrieves the Unicode character format flag for the control. You can send this message explicitly or use the [**TabCtrl\_GetUnicodeFormat**](tabctrl-getunicodeformat.md) macro.
