---
title: BN\_KILLFOCUS notification code
...
keywords: ["BN_KILLFOCUS notification code Windows Controls"]
topic_type:
- apiref
api_name:
- BN_KILLFOCUS
...
Sent when a button loses the keyboard focus. The button must have the [**BS\_NOTIFY**](button-styles.md#bs-notify) style to send this notification code.
