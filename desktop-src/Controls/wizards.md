...
For further discussion of backward-compatible wizards, see [Backward Compatible Wizard 97](_wiz_backward_compatible_wizard_97_back).

## Remarks

For a complete discussion of design issues for Wizard97, see the [Wizard97 Specification](_wiz_wizard_97), elsewhere in the Windows SDK. This document has guidelines for such things as the dimensions for the dialog boxes, bitmap dimensions and colors, and the placement of controls.
