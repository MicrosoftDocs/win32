...
keywords: ["LVM_ISITEMVISIBLE message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_ISITEMVISIBLE
...
Indicates if an item in the list-view control is visible. Send this message explicitly or by using the [**ListView\_IsItemVisible**](listview-isitemvisible.md) macro.
