...
keywords: ["EM_GETEDITSTYLEEX message Windows Controls"]
topic_type:
- apiref
api_name:
- EM_GETEDITSTYLEEX
...
| <dl> <dt>**SES\_HIDETEMPFORMAT**</dt> </dl>         | Hide temporary formatting that is created when [**ITextFont.Reset**](itextfont-reset.md) is called with **tomApplyTmp**. For example, such formatting is used by spell checkers to display a squiggly underline under possibly misspelled words.<br/> |
| <dl> <dt>**SES\_EX\_USEMOUSEWPARAM**</dt> </dl>     | Use *wParam* when handling the [**WM\_MOUSEMOVE**](https://msdn.microsoft.com/library/windows/desktop/ms645616) message and do not call [**GetAsyncKeyState**](https://msdn.microsoft.com/library/windows/desktop/ms646293).<br/>                                                                                              |
