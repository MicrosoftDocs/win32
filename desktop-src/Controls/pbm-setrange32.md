...
Returns a **DWORD** value that holds the previous 16-bit low limit in its [**LOWORD**](https://msdn.microsoft.com/library/windows/desktop/ms632659) and the previous 16-bit high limit in its [**HIWORD**](https://msdn.microsoft.com/library/windows/desktop/ms632657). If the previous ranges were 32-bit values, the return value consists of the **LOWORD**s of both 32-bit limits.
