...
keywords: ["LVM_DELETEITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_DELETEITEM
...
Removes an item from a list-view control. You can send this message explicitly or by using the [**ListView\_DeleteItem**](listview-deleteitem.md) macro.
