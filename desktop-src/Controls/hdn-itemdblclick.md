...
keywords: ["HDN_ITEMDBLCLICK notification code Windows Controls"]
topic_type:
- apiref
api_name:
- HDN_ITEMDBLCLICK
...
A pointer to an [**NMHEADER**](nmheader.md) structure that contains information about this notification code.
