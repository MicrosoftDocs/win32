...
Gets information on a specified group. Send this message explicitly or by using the [**ListView\_GetGroupInfoByIndex**](/windows/win32/Commctrl/nf-commctrl-listview_getgroupinfobyindex?branch=master) macro.
