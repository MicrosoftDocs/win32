...
| Basic set of character/paragraph formatting properties                             | See [**CHARFORMAT**](/windows/desktop/api/Richedit/ns-richedit-_charformat) and [**PARAFORMAT**](/windows/desktop/api/Richedit/ns-richedit-paraformat).                                                                                                                                                                                                                |
