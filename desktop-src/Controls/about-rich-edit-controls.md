...
| Basic set of character/paragraph formatting properties                             | See [**CHARFORMAT**](/windows/desktop/api/Richedit/ns-richedit-_charformat) and [**PARAFORMAT**](/windows/desktop/api/Richedit/ns-richedit-_paraformat).                                                                                                                                                                                                                |
...
<td>Built-in normal style and heading styles 1 through 9 are supported by the [<strong>EM_SETPARAFORMAT</strong>](em-setparaformat.md) and [Text Object Model](text-object-model.md) (TOM) interfaces.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td>Font binding</td>
<td>Microsoft Rich Edit 3.0 will automatically choose an appropriate font for characters that clearly do not belong to the current character set stamp. This is done by assigning character sets to text runs and associating fonts with those character sets. For more information, see [Font Binding](https://www.bing.com/search?q=Font Binding).</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td>Hyphenation</td>
<td>Hyphenation is supported through the following APIs: [<em>HyphenateProc</em>](/windows/desktop/api/Richedit/nf-richedit-hyphenateproc), [<strong>EM_SETHYPHENATEINFO</strong>](em-sethyphenateinfo.md), and [<strong>EM_GETHYPHENATEINFO</strong>](em-gethyphenateinfo.md).</td>
</tr>
<tr class="even">
<td>Page rotation</td>
<td>Top-to-bottom and bottom-to-top layout is supported through [<strong>EM_SETPAGEROTATE</strong>](em-setpagerotate.md) and [<strong>EM_GETPAGEROTATE</strong>](em-getpagerotate.md).</td>
</tr>
<tr class="odd">
<td>Text Services Framework support</td>
<td><ul>
<li>To turn on TSF and certain TSF features, use the following styles in [<strong>EM_SETEDITSTYLE</strong>](em-seteditstyle.md): SES_USECTF, SES_CTFALLOWEMBED, SES_CTFALLOWPROOFING, and SES_CTFALLOWSMARTTAG.</li>
<li>To set and get the TSF mode bias, use [<strong>EM_SETCTFMODEBIAS</strong>](em-setctfmodebias.md) and [<strong>EM_GETCTFMODEBIAS</strong>](em-getctfmodebias.md).</li>
<li>To set and get the TSF keyboard status, use [<strong>EM_SETCTFOPENSTATUS</strong>](em-setctfopenstatus.md) and [<strong>EM_GETCTFOPENSTATUS</strong>](em-getctfopenstatus.md).</li>
</ul></td>
</tr>
<tr class="even">
<td>Additional IME support</td>
<td><ul>
<li>To set and get the IME mode bias, use [<strong>EM_SETIMEMODEBIAS</strong>](em-setimemodebias.md) and [<strong>EM_GETIMEMODEBIAS</strong>](em-getimemodebias.md).</li>
<li>To get the properties and capabilities of the IME, use [<strong>EM_GETIMEPROPERTY</strong>](em-getimeproperty.md).</li>
<li>To get the IME composition text, use [<strong>EM_GETIMECOMPTEXT</strong>](em-getimecomptext.md).</li>
<li>To determine whether the locale is an East Asian locale, use [<strong>EM_ISIME</strong>](em-isime.md).</li>
</ul></td>
</tr>
<tr class="odd">
<td>Additional [<strong>EM_SETEDITSTYLE</strong>](em-seteditstyle.md) settings</td>
...
<tr class="even">
<td>Additional [<strong>EM_SETCHARFORMAT</strong>](em-setcharformat.md) settings</td>
...
<td>Using [<strong>TM_SINGLECODEPAGE</strong>](https://www.bing.com/search?q=<strong>TM_SINGLECODEPAGE</strong>) in [<strong>EM_SETTEXTMODE</strong>](em-settextmode.md) prevents Unicode input from entering a Rich Edit control.</td>
</tr>
<tr class="even">
<td>Unsupported RTF keyword notification</td>
<td>[EN_LOWFIRTF](en-lowfirtf.md) warns an application when there is an unsupported RTF keyword.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td>ES_VERTICAL</td>
<td>The [<strong>ES_VERTICAL</strong>](https://www.bing.com/search?q=<strong>ES_VERTICAL</strong>) window style is supported.</td>
</tr>
<tr class="even">
<td>[<strong>WM_UNICHAR</strong>](https://msdn.microsoft.com/library/windows/desktop/ms646288) support</td>
<td>To send or post Unicode characters to ANSI windows, use [<strong>WM_UNICHAR</strong>](https://msdn.microsoft.com/library/windows/desktop/ms646288). It is equivalent to [<strong>WM_CHAR</strong>](https://msdn.microsoft.com/library/windows/desktop/ms646276), but it uses (UTF)-32.</td>
</tr>
</tbody>
</table>
...
The following window styles are used with multiline edit controls but not with rich edit controls: [**ES\_LOWERCASE**](https://www.bing.com/search?q=**ES\_LOWERCASE**), [**ES\_UPPERCASE**](https://www.bing.com/search?q=**ES\_UPPERCASE**), and [**ES\_OEMCONVERT**](https://www.bing.com/search?q=**ES\_OEMCONVERT**).
