...
If a month calendar control is not using the [**MCS\_NOTODAY**](https://www.bing.com/search?q=**MCS\_NOTODAY**) style, the user can return to the current day by clicking the "Today" text at the bottom of the control. If the current day is not visible, the control updates its display to show it.
