...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Remove the horizontal scroll bar and auto-scroll depending on mouse position.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Include dimmed checkbox state if the control has the [<strong>TVS_CHECKBOXES</strong>](https://www.bing.com/search?q=<strong>TVS_CHECKBOXES</strong>) style.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Specifies how the background is erased or filled.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Retrieves calendar grid information.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Include exclusion checkbox state if the control has the [<strong>TVS_CHECKBOXES</strong>](https://www.bing.com/search?q=<strong>TVS_CHECKBOXES</strong>) style.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Fade expando buttons in or out when the mouse moves away or into a state of hovering over the control.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Do not indent the tree view for the expando buttons.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). <strong>Intended for internal use; not recommended for use in applications.</strong> Do not collapse the previously selected tree-view item unless it has the same parent as the new selection. This style must be used with the [<strong>TVS_SINGLEEXPAND</strong>](https://www.bing.com/search?q=<strong>TVS_SINGLEEXPAND</strong>) style. <br/>
<blockquote>
[!Note]<br />
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Include partial checkbox state if the control has the [<strong>TVS_CHECKBOXES</strong>](https://www.bing.com/search?q=<strong>TVS_CHECKBOXES</strong>) style.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Allow rich tooltips in the tree view (custom drawn with icon and text).<br/></td>
</tr>
</tbody>
</table>
