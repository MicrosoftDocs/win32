...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Include dimmed checkbox state if the control has the [<strong>TVS_CHECKBOXES</strong>](tree-view-control-window-styles.md#tvs-checkboxes) style.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Include exclusion checkbox state if the control has the [<strong>TVS_CHECKBOXES</strong>](tree-view-control-window-styles.md#tvs-checkboxes) style.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). <strong>Intended for internal use; not recommended for use in applications.</strong> Do not collapse the previously selected tree-view item unless it has the same parent as the new selection. This style must be used with the [<strong>TVS_SINGLEEXPAND</strong>](tree-view-control-window-styles.md#tvs-singleexpand) style. <br/>
<blockquote>
[!Note]<br />
...
<td style="text-align: left;">[Windows Vista](common-control-versions.md). Include partial checkbox state if the control has the [<strong>TVS_CHECKBOXES</strong>](tree-view-control-window-styles.md#tvs-checkboxes) style.<br/></td>
</tr>
<tr class="odd">
