...
keywords: ["DTM_GETMCFONT message Windows Controls"]
topic_type:
- apiref
api_name:
- DTM_GETMCFONT
...
Gets the font that the date and time picker (DTP) control's child month calendar control is currently using. You can send this message explicitly or use the [**DateTime\_GetMonthCalFont**](datetime-getmonthcalfont.md) macro.
