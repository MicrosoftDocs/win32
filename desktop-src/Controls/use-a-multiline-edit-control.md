...
The following C++ code example implements much of the functionality of a simple word processor by adding a multiline edit control to the client area of a window. The system automatically performs wordwrap operations for the edit control and also handles the processing for the vertical scroll bar (created by specifying [**ES\_AUTOVSCROLL**](https://www.bing.com/search?q=**ES\_AUTOVSCROLL**) in the call to the [**CreateWindow**](https://msdn.microsoft.com/library/windows/desktop/ms632679) function).
