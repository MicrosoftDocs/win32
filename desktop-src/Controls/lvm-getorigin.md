...
keywords: ["LVM_GETORIGIN message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETORIGIN
...
Retrieves the current view origin for a list-view control. You can send this message explicitly or by using the [**ListView\_GetOrigin**](listview-getorigin.md) macro.
