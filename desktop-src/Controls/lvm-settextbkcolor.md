...
keywords: ["LVM_SETTEXTBKCOLOR message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_SETTEXTBKCOLOR
...
Sets the background color of text in a list-view control. You can send this message explicitly or by using the [**ListView\_SetTextBkColor**](listview-settextbkcolor.md) macro.
