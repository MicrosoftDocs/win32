---
title: EN\_ALIGN\_LTR\_EC notification code
...
keywords: ["EN_ALIGN_LTR_EC notification code Windows Controls"]
topic_type:
- apiref
api_name:
- EN_ALIGN_LTR_EC
...
Sent when the user has changed the edit control direction to left-to-right. The parent window of the edit control receives this notification code through a [**WM\_COMMAND**](https://msdn.microsoft.com/library/windows/desktop/ms647591) message.
