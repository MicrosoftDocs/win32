...
keywords: ["LVM_HITTEST message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_HITTEST
...
Determines which list-view item, if any, is at a specified position. You can send this message explicitly or by using the [**ListView\_HitTest**](listview-hittest.md) macro.
...
Pointer to an [**LVHITTESTINFO**](lvhittestinfo.md) structure that contains the position to hit test and receives information about the results of the hit test.
