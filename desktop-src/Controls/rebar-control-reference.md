...
| [RBN\_AUTOSIZE](rbn-autosize.md)                            | Sent by a rebar control created with the [**RBS\_AUTOSIZE**](rebar-control-styles.md#rbs-autosize) style when the rebar automatically resizes itself. This notification code is sent in the form of a [**WM\_NOTIFY**](wm-notify.md) message. <br/>                  |
...
| [RBN\_GETOBJECT](rbn-getobject.md)                          | Sent by a rebar control created with the [**RBS\_REGISTERDROP**](rebar-control-styles.md#rbs-registerdrop) style when an object is dragged over a band in the control. This notification code is sent in the form of a [**WM\_NOTIFY**](wm-notify.md) message. <br/> |
