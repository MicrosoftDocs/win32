...
keywords: ["LVM_SETITEMTEXT message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_SETITEMTEXT
...
Changes the text of a list-view item or subitem. You can send this message explicitly or by using the [**ListView\_SetItemText**](listview-setitemtext.md) macro.
