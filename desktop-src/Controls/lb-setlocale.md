...
Sets the current locale of the list box. You can use the locale to determine the correct sorting order of displayed text (for list boxes with the [**LBS\_SORT**](https://www.bing.com/search?q=**LBS\_SORT**) style) and of text added by the [**LB\_ADDSTRING**](lb-addstring.md) message.
