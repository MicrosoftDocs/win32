...
keywords: ["HDN_ITEMKEYDOWN notification code Windows Controls"]
topic_type:
- apiref
api_name:
- HDN_ITEMKEYDOWN
...
A pointer to an [**NMHEADER**](nmheader.md) structure that contains additional information about the key that is being pressed.
