...
keywords: ["TVN_ITEMCHANGING notification code Windows Controls"]
topic_type:
- apiref
api_name:
- TVN_ITEMCHANGING
...
Pointer to an [**NMTVITEMCHANGE**](nmtvitemchange.md) structure describing the item that is changing. The **uChanged** member is set to TVIF\_STATE.
