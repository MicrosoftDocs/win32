---
title: TVN\_ITEMCHANGING notification code
description: Notifies a tree-view controls parent window that item attributes are about to change. This notification code is sent in the form of a WM\_NOTIFY message.
...
Pointer to an [**NMTVITEMCHANGE**](/windows/win32/Commctrl/ns-commctrl-tagtvitemchange?branch=master) structure describing the item that is changing. The **uChanged** member is set to TVIF\_STATE.
