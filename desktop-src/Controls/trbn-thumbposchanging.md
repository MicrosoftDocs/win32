...
Pointer to a [**NMTRBTHUMBPOSCHANGING**](/windows/win32/Commctrl/ns-commctrl-tagtrbthumbposchanging?branch=master) structure. The caller is responsible for allocating this structure and setting its members, including the members of the contained [**NMHDR**](/windows/win32/richedit/ns-richedit-_nmhdr?branch=master) structure.
