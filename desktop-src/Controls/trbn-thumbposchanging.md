...
keywords: ["TRBN_THUMBPOSCHANGING notification code Windows Controls"]
topic_type:
- apiref
api_name:
...
Pointer to a [**NMTRBTHUMBPOSCHANGING**](nmtrbthumbposchanging.md) structure. The caller is responsible for allocating this structure and setting its members, including the members of the contained [**NMHDR**](nmhdr.md) structure.
