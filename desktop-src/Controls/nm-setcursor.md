...
keywords: ["NM_SETCURSOR notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_SETCURSOR
...
A pointer to an [**NMMOUSE**](nmmouse.md) structure that contains additional information about this notification.
