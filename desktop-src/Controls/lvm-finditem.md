...
keywords: ["LVM_FINDITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_FINDITEM
...
Searches for a list-view item with the specified characteristics. You can send this message explicitly or by using the [**ListView\_FindItem**](listview-finditem.md) macro.
...
A pointer to an [**LVFINDINFO**](lvfindinfo.md) structure that contains information about what to search for.
