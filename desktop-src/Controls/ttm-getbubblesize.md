...
keywords: ["TTM_GETBUBBLESIZE message Windows Controls"]
topic_type:
- apiref
api_name:
- TTM_GETBUBBLESIZE
...
Pointer to the tooltip [**TOOLINFO**](toolinfo.md) structure.
...
If the TTF\_TRACK and TTF\_ABSOLUTE flags are set in the **uFlags** member of the tooltip [**TOOLINFO**](toolinfo.md) structure, this message can be used to help position the tooltip accurately.
