---
title: NM\_RELEASEDCAPTURE (trackbar) notification code
description: Notifies a trackbar controls parent window that the control is releasing mouse capture. This notification code is sent in the form of a WM\_NOTIFY message.
