...
keywords: ["RB_GETCOLORSCHEME message Windows Controls"]
topic_type:
- apiref
api_name:
- RB_GETCOLORSCHEME
...
Pointer to a [**COLORSCHEME**](colorscheme.md) structure that will receive the color scheme information. You must set the **dwSize** member of this structure to **sizeof**(COLORSCHEME) before sending this message.
