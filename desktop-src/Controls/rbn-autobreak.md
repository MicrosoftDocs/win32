...
description: Notifies a rebars parent that a break will appear in the bar. The parent determines whether to make the break. This notification code is sent in the form of a WM\_NOTIFY message.
...
Pointer to a [**NMREBARAUTOBREAK**](/windows/win32/Commctrl/ns-commctrl-tagnmrebarautobreak?branch=master) structure that contains information about the notification code.
...
The value in the **fAutoBreak** member of the [**NMREBARAUTOBREAK**](/windows/win32/Commctrl/ns-commctrl-tagnmrebarautobreak?branch=master) structure indicates whether a break should occur in the rebar.
