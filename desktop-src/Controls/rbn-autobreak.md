...
keywords: ["RBN_AUTOBREAK message Windows Controls"]
topic_type:
- apiref
api_name:
- RBN_AUTOBREAK
...
Pointer to a [**NMREBARAUTOBREAK**](nmrebarautobreak.md) structure that contains information about the notification code.
...
The value in the **fAutoBreak** member of the [**NMREBARAUTOBREAK**](nmrebarautobreak.md) structure indicates whether a break should occur in the rebar.
