...
keywords: ["LVM_GETHEADER message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETHEADER
...
Gets the handle to the header control used by the list-view control. You can send this message explicitly or use the [**ListView\_GetHeader**](listview-getheader.md) macro.
