...
keywords: ["TVM_SORTCHILDRENCB message Windows Controls"]
topic_type:
- apiref
api_name:
- TVM_SORTCHILDRENCB
...
Sorts tree-view items using an application-defined callback function that compares the items. You can send this message explicitly or by using the [**TreeView\_SortChildrenCB**](treeview-sortchildrencb.md) macro.
