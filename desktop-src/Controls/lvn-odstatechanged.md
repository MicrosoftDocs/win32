---
title: LVN\_ODSTATECHANGED notification code
...
keywords: ["LVN_ODSTATECHANGED notification code Windows Controls"]
topic_type:
- apiref
api_name:
- LVN_ODSTATECHANGED
...
Pointer to an [**NMLVODSTATECHANGE**](nmlvodstatechange.md) structure that contains information about the item or items that have changed.
