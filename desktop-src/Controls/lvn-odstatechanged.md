...
Pointer to an [**NMLVODSTATECHANGE**](/windows/win32/Commctrl/ns-commctrl-tagnmlvodstatechange?branch=master) structure that contains information about the item or items that have changed.
