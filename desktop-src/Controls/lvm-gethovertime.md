...
keywords: ["LVM_GETHOVERTIME message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETHOVERTIME
...
Retrieves the amount of time that the mouse cursor must hover over an item before it is selected. You can send this message explicitly or use the [**ListView\_GetHoverTime**](listview-gethovertime.md) macro.
