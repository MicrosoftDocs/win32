...
| [**SB\_GETTIPTEXT**](sb-gettiptext.md)             | Retrieves the tooltip text for a part in a status bar. The status bar must be created with the [**SBT\_TOOLTIPS**](status-bar-styles.md#sbt-tooltips) style to enable tooltips. <br/>         |
...
| [**SB\_SETTIPTEXT**](sb-settiptext.md)             | Sets the tooltip text for a part in a status bar. The status bar must have been created with the [**SBT\_TOOLTIPS**](status-bar-styles.md#sbt-tooltips) style to enable tooltips.<br/>        |
