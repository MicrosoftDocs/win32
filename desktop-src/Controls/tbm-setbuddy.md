...
| Value                                                                                                                                | Meaning                                                                                                                                                                                                                                                                                         |
|--------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="TRUE"></span><span id="true"></span><dl> <dt>**TRUE**</dt> </dl>    | The buddy will appear to the left of the trackbar if the trackbar control uses the [**TBS\_HORZ**](https://www.bing.com/search?q=**TBS\_HORZ**) style. If the trackbar uses the [**TBS\_VERT**](https://www.bing.com/search?q=**TBS\_VERT**) style, the buddy appears above the trackbar control.<br/>  |
| <span id="FALSE"></span><span id="false"></span><dl> <dt>**FALSE**</dt> </dl> | The buddy will appear to the right of the trackbar if the trackbar control uses the [**TBS\_HORZ**](https://www.bing.com/search?q=**TBS\_HORZ**) style. If the trackbar uses the [**TBS\_VERT**](https://www.bing.com/search?q=**TBS\_VERT**) style, the buddy appears below the trackbar control.<br/> |
