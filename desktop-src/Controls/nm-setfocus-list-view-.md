...
description: Notifies a list-view controls parent window that the control has received the input focus. This notification code is sent in the form of a WM\_NOTIFY message.
