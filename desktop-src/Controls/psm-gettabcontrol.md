...
keywords: ["PSM_GETTABCONTROL message Windows Controls"]
topic_type:
- apiref
api_name:
- PSM_GETTABCONTROL
...
Retrieves the handle to the tab control of a property sheet. You can send this message explicitly or by using the [**PropSheet\_GetTabControl**](propsheet-gettabcontrol.md) macro.
