...
If you use the [**PropSheet\_ShowWizButtons**](/windows/desktop/api/Prsht/nf-prsht-propsheet_showwizbuttons) macro to send this message, it will be posted. At any other time, you can use [**SendMessage**](https://msdn.microsoft.com/library/windows/desktop/ms644950) to send **PSM\_SHOWWIZBUTTONS**.
