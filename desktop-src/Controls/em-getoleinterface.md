...
Pointer to a pointer that receives the [**IRichEditOle**](/windows/desktop/api/Richole/nn-richole-iricheditole) object. The control calls the [**AddRef**](https://msdn.microsoft.com/library/windows/desktop/ms691379) method for the object before returning, so the calling application must call the [**Release**](https://msdn.microsoft.com/library/windows/desktop/ms682317) method when it is done with the object.
