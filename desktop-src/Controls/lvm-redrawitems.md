...
keywords: ["LVM_REDRAWITEMS message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_REDRAWITEMS
...
Forces a list-view control to redraw a range of items. You can send this message explicitly or by using the [**ListView\_RedrawItems**](listview-redrawitems.md) macro.
