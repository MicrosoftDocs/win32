...
In the following C++ code example, the application-defined function first calls [**InitCommonControlsEx**](/windows/desktop/api/Commctrl/nf-commctrl-initcommoncontrolsex) and sets the **dwICC** member of the [**INITCOMMONCONTROLSEX**](/windows/desktop/api/Commctrl/ns-commctrl-taginitcommoncontrolsex) structure to [**ICC\_INTERNET\_CLASSES**](initcommoncontrolsex-4vvx.md#icc-internet-classes), which specifies the IP address class. It then calls [**CreateWindowEx**](https://msdn.microsoft.com/library/windows/desktop/ms632680) to create an instance of the IP address control.
