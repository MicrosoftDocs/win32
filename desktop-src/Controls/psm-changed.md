...
keywords: ["PSM_CHANGED message Windows Controls"]
topic_type:
- apiref
api_name:
- PSM_CHANGED
...
Informs a property sheet that information in a page has changed. You can send this message explicitly or by using the [**PropSheet\_Changed**](propsheet-changed.md) macro.
