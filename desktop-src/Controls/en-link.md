...
To receive **EN\_LINK** notification codes when the link has focus, specify the [**ENM\_LINK**](https://www.bing.com/search?q=**ENM\_LINK**) flag in the mask sent with the [**EM\_SETEVENTMASK**](em-seteventmask.md) message.
