...
description: Notifies a rich edit controls parent window that a user action on a Component Object Model (COM) object has failed. A rich edit control sends this notification code in the form of a WM\_NOTIFY message.
...
An [**ENOLEOPFAILED**](/windows/win32/Richedit/ns-richedit-_enoleopfailed?branch=master) structure that contains information about the failure.
