...
The tree-view control must have the [**TVS\_EX\_DRAWIMAGEASYNC**](https://www.bing.com/search?q=**TVS\_EX\_DRAWIMAGEASYNC**) extended style. Note that this is equivalent to list-view's LVN\_ASYNCDRAWN flag and its corresponding style.
