...
The application will receive this notification code once at the start of the save process and once for each button. This notification code gives you an opportunity to add your own information to that saved by the Shell. If you do not wish to add information, ignore the notification code. See [Toolbar Customization](https://www.bing.com/search?q=Toolbar Customization) for a more detailed discussion of how to handle TBN\_SAVE.
