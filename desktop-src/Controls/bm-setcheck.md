...
| <span id="BST_INDETERMINATE"></span><span id="bst_indeterminate"></span><dl> <dt>**BST\_INDETERMINATE**</dt> </dl> | Sets the button state to grayed, indicating an indeterminate state. Use this value only if the button has the [**BS\_3STATE**](button-styles.md#bs-3state) or [**BS\_AUTO3STATE**](button-styles.md#bs-auto3state) style.<br/> |
