...
keywords: ["PSN_WIZNEXT notification code Windows Controls"]
topic_type:
- apiref
api_name:
- PSN_WIZNEXT
...
To set the return value, the dialog box procedure for the page must call the [**SetWindowLong**](https://msdn.microsoft.com/library/windows/desktop/ms633591) function with the **DWL\_MSGRESULT** value and return **TRUE**. For example:
