...
Sets the [formatting rectangle](https://www.bing.com/search?q=formatting rectangle) of a multiline edit control. The **EM\_SETRECTNP** message is identical to the [**EM\_SETRECT**](em-setrect.md) message, except that **EM\_SETRECTNP** does *not* redraw the edit control window.
