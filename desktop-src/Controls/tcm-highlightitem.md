...
keywords: ["TCM_HIGHLIGHTITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- TCM_HIGHLIGHTITEM
...
Sets the highlight state of a tab item. You can send this message explicitly or by using the [**TabCtrl\_HighlightItem**](tabctrl-highlightitem.md) macro.
