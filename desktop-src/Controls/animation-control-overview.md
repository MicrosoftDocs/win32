...
| [**WM\_SIZE**](https://msdn.microsoft.com/library/windows/desktop/ms632646)             | Checks if the control has the [**ACS\_CENTER**](animation-control-styles.md) style. If the control does not, it calls [**DefWindowProc**](https://msdn.microsoft.com/library/windows/desktop/ms633572). Otherwise, it centers the animation in the control, invalidates the control, and then calls **DefWindowProc**. |
