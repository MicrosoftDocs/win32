...
This section describes the window messages handled by the window procedure for the [**ANIMATE\_CLASS**](https://www.bing.com/search?q=**ANIMATE\_CLASS**) window class.
...
| [**WM\_SIZE**](https://msdn.microsoft.com/library/windows/desktop/ms632646)             | Checks if the control has the [**ACS\_CENTER**](https://www.bing.com/search?q=**ACS\_CENTER**) style. If the control does not, it calls [**DefWindowProc**](https://msdn.microsoft.com/library/windows/desktop/ms633572). Otherwise, it centers the animation in the control, invalidates the control, and then calls **DefWindowProc**. |
