...
| <span id="RBS_REGISTERDROP"></span><span id="rbs_registerdrop"></span><dl> <dt>**RBS\_REGISTERDROP**</dt> </dl>          | [Version 4.71](common-control-versions.md). The rebar control generates [RBN\_GETOBJECT](rbn-getobject.md) notification codes when an object is dragged over a band in the control. To receive the RBN\_GETOBJECT notifications, initialize OLE with a call to [**OleInitialize**](https://msdn.microsoft.com/library/windows/desktop/ms690134) or [**CoInitialize**](https://msdn.microsoft.com/library/windows/desktop/ms678543).<br/> |
