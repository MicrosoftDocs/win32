...
description: Notifies a list-view controls parent window that an item is changing. This notification code is sent in the form of a WM\_NOTIFY message.
...
Pointer to an [**NMLISTVIEW**](/windows/win32/Commctrl/ns-commctrl-tagnmlistview?branch=master) structure that identifies the item and specifies which of its attributes are changing.
