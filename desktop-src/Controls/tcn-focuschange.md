---
title: TCN\_FOCUSCHANGE notification code
description: Notifies a tab controls parent window that the button focus has changed. This notification code is sent in the form of a WM\_NOTIFY message.
