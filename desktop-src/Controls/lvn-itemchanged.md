...
keywords: ["LVN_ITEMCHANGED notification code Windows Controls"]
topic_type:
- apiref
api_name:
- LVN_ITEMCHANGED
...
Pointer to an [**NMLISTVIEW**](nmlistview.md) structure that identifies the item and specifies which of its attributes have changed. If the **iItem** member of the structure pointed to by *lParam* is -1, the change has been applied to all items in the list view.
