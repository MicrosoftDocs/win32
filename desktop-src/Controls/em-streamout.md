...
| <span id="SF_UNICODE"></span><span id="sf_unicode"></span><dl> <dt>**SF\_UNICODE**</dt> </dl>             | **Microsoft Rich Edit 2.0 and later:** Indicates Unicode text. You can combine this flag with the **SF\_TEXT** flag, but not with any variation of **SF\_RTF**.<br/>                                                                                                                                                        |
| <span id="SF_USECODEPAGE"></span><span id="sf_usecodepage"></span><dl> <dt>**SF\_USECODEPAGE**</dt> </dl> | **Rich Edit 3.0 and later:** Generates UTF-8 RTF and text using other code pages. The code page is set in the high word of *wParam*. For example, for UTF-8 RTF, set *wParam* to (CP\_UTF8 << 16) \| SF\_USECODEPAGE \| SF\_RTF. If this flag is not set, then any RTF will be generated as 7-bit ASCII (with extended ASCII characters escaped).<br/>                               |
