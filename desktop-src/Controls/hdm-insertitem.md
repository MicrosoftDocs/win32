...
keywords: ["HDM_INSERTITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- HDM_INSERTITEM
...
Inserts a new item into a header control. You can send this message explicitly or use the [**Header\_InsertItem**](header-insertitem.md) macro.
...
A pointer to an [**HDITEM**](hditem.md) structure that contains information about the new item.
