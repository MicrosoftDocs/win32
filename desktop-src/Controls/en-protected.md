...
An [**ENPROTECTED**](/windows/desktop/api/Richedit/ns-richedit-_enprotected) structure containing information about the message that triggered the notification code.
...
To receive EN\_PROTECTED notification codes, specify [**ENM\_PROTECTED**](https://www.bing.com/search?q=**ENM\_PROTECTED**) in the mask sent with the [**EM\_SETEVENTMASK**](em-seteventmask.md) message.
