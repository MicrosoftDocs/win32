...
keywords: ["LVM_GETITEMPOSITION message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETITEMPOSITION
...
Retrieves the position of a list-view item. You can send this message explicitly or by using the [**ListView\_GetItemPosition**](listview-getitemposition.md) macro.
