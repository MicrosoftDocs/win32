...
keywords: ["NM_CUSTOMDRAW (toolbar) notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_CUSTOMDRAW
...
| <dl> <dt>**TBCDRF\_HILITEHOTTRACK**</dt> </dl>  | [Version 4.71](common-control-versions.md). Use the **clrHighlightHotTrack** member of the [**NMTBCUSTOMDRAW**](nmtbcustomdraw.md) structure to draw the background of hot-tracked items. This occurs when **dwDrawStage** equals CDDS\_ITEMPREPAINT.<br/>                        |
