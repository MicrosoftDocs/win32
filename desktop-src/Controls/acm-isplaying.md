...
keywords: ["ACM_ISPLAYING message Windows Controls"]
topic_type:
- apiref
api_name:
- ACM_ISPLAYING
...
Checks whether an Audio-Video Interleaved (AVI) clip is playing. You can send this message explicitly or use the [**Animate\_IsPlaying**](animate-isplaying.md) macro.
