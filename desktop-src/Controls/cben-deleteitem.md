...
A pointer to an [**NMCOMBOBOXEX**](/windows/win32/Commctrl/ns-commctrl-nmcomboboxexa?branch=master) structure that contains information about the notification code and the deleted item.
