...
keywords: ["CBEN_DELETEITEM notification code Windows Controls"]
topic_type:
- apiref
api_name:
- CBEN_DELETEITEM
...
A pointer to an [**NMCOMBOBOXEX**](nmcomboboxex.md) structure that contains information about the notification code and the deleted item.
