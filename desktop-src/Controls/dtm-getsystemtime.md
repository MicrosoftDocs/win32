...
Returns GDT\_VALID if the time information was successfully placed in *lParam*. Returns GDT\_NONE if the control was set to the [**DTS\_SHOWNONE**](https://www.bing.com/search?q=**DTS\_SHOWNONE**) style and the control check box was not selected. Returns GDT\_ERROR if an error occurs.
