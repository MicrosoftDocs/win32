...
keywords: ["PGM_GETBUTTONSIZE message Windows Controls"]
topic_type:
- apiref
api_name:
- PGM_GETBUTTONSIZE
...
Retrieves the current button size for the pager control. You can send this message explicitly or use the [**Pager\_GetButtonSize**](pager-getbuttonsize.md) macro.
