...
keywords: ["LVM_SETUNICODEFORMAT message Windows Controls"]
topic_type:
- apiref
api_name:
...
Sets the UNICODE character format flag for the control. This message allows you to change the character set used by the control at run time rather than having to re-create the control. You can send this message explicitly or use the [**ListView\_SetUnicodeFormat**](listview-setunicodeformat.md) macro.
