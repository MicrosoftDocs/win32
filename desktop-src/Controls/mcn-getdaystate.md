...
Pointer to an [**NMDAYSTATE**](/windows/desktop/api/Commctrl/ns-commctrl-tagnmdaystate) structure. The structure contains information about the time frame for which the control needs information, and it receives the address of an array that provides this data.
