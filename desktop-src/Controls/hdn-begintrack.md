...
keywords: ["HDN_BEGINTRACK notification code Windows Controls"]
topic_type:
- apiref
api_name:
- HDN_BEGINTRACK
...
A pointer to an [**NMHEADER**](nmheader.md) structure that contains information about the header control and the item whose divider is to be dragged.
