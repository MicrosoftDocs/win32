...
keywords: ["HDM_GETFOCUSEDITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- HDM_GETFOCUSEDITEM
...
Gets the item in a header control that has the focus. Send this message explicitly or by using the [**Header\_GetFocusedItem**](header-getfocuseditem.md) macro.
