...
|-----------------|------------------------------------------|----------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| TMT\_BOOL       | **TRUE** or **FALSE**                    | Boolean                                | [**GetThemeBool**](getthemebool.md), [**GetThemeSysBool**](getthemesysbool.md)                                       |
| TMT\_COLOR      | RGB color value                          | [**COLORREF**](https://msdn.microsoft.com/library/windows/desktop/dd183449) structure | [**GetThemeColor**](getthemecolor.md), [**GetThemeSysColor**](getthemesyscolor.md)                                   |
| TMT\_DISKSTREAM | Disk stream                              | **HINSTANCE**                          | [**GetThemeStream**](getthemestream.md)                                                                               |
| TMT\_ENUM       | Enumerated value                         | Enumeration                            | [**GetThemeEnumValue**](getthemeenumvalue.md).                                                                        |
| TMT\_FILENAME   | Filename relative to the theme directory | **WCHAR** array                        | [**GetThemeFilename**](getthemefilename.md)                                                                           |
| TMT\_FONT       | Font description                         | [**LOGFONT**](https://msdn.microsoft.com/library/windows/desktop/dd145037) structure   | [**GetThemeFont**](getthemefont.md), [**GetThemeSysFont**](getthemesysfont.md)                                       |
| TMT\_HBITMAP    | Bitmap                                   | **HBITMAP** handle                     | [**GetThemeBitmap**](getthemebitmap.md)                                                                               |
| TMT\_INT        | Signed number                            | Integer                                | [**GetThemeInt**](getthemeint.md), [**GetThemeSysInt**](getthemesysint.md), [**GetThemeMetric**](getthememetric.md) |
| TMT\_INTLIST    | List of integers                         | [**INTLIST**](intlist.md) structure   | [**GetThemeIntList**](getthemeintlist.md)                                                                             |
| TMT\_MARGINS    | Margins: left, top, right, and bottom    | [**MARGINS**](margins.md) structure   | [**GetThemeMargins**](getthememargins.md)                                                                             |
| TMT\_POSITION   | Location of an item                      | [**POINT**](https://msdn.microsoft.com/library/windows/desktop/dd162805) structure       | [**GetThemePosition**](getthemeposition.md)                                                                           |
| TMT\_RECT       | Size and location of a rectangle         | [**RECT**](https://msdn.microsoft.com/library/windows/desktop/dd162897) structure         | [**GetThemeRect**](getthemerect.md)                                                                                   |
| TMT\_SIZE       | Size of an item                          | [**SIZE**](https://msdn.microsoft.com/library/windows/desktop/dd145106) structure         | [**GetThemePartSize**](getthemepartsize.md)                                                                           |
| TMT\_STRING     | Unicode string                           | **WCHAR** array                        | [**GetThemeString**](getthemestring.md), [**GetThemeSysString**](getthemesysstring.md)                               |
...
| TMT\_DRAWBORDERS          |                                                                                                                                                                                                                 |
| TMT\_FLATMENUS            | See [**GetThemeSysBool**](getthemesysbool.md).                                                                                                                                                                 |
| TMT\_GLYPHONLY            | **TRUE** if the glyph associated with the part and state should be drawn without a background.                                                                                                                  |
| TMT\_GLYPHTRANSPARENT     | **TRUE** if the glyph associated with the part and state have transparent areas. See [**GetThemeColor**](getthemecolor.md) for the definition of the TMT\_GLYPHCOLOR value that defines the transparent color. |
...
| TMT\_FROMCOLOR4              |                                                                                                                                                                                                |
| TMT\_FROMCOLOR5              |                                                                                                                                                                                                |
| TMT\_GLOWCOLOR               | The color of the glow produced by calling [**DrawThemeIcon**](drawthemeicon.md) using this part and state.                                                                                    |
...
| ICONEFFECT          | ICE\_NONE, ICE\_GLOW, ICE\_SHADOW, ICE\_PULSE, ICE\_ALPHA                                                                                                                                                                                                  | The type of effect to be displayed when this part is drawn using [**DrawThemeIcon**](drawthemeicon.md).                                             |
| IMAGELAYOUT         | IL\_VERTICAL, IL\_HORIZONTAL                                                                                                                                                                                                                               | The type of alignment used when multiple images are drawn.                                                                                           |
| IMAGESELECTTYPE     | IST\_NONE, IST\_SIZE, IST\_DPI                                                                                                                                                                                                                             | The type of method used to select between sized images for this part. See the TMT\_IMAGEFILE1 value of [**GetThemeFilename**](getthemefilename.md). |
...
| ID                       | Notes                                                                                                                                                                                                            |
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| TMT\_ALPHALEVEL          | The alpha value (0-255) used for [**DrawThemeIcon**](drawthemeicon.md).                                                                                                                                         |
...
| TMT\_SATURATION          | The amount of saturation (0-255) to apply to an icon drawn using [**DrawThemeIcon**](drawthemeicon.md).                                                                                                         |
...
| TMT\_COMPANY         |                                                     |
| TMT\_COPYRIGHT       |                                                     |
| TMT\_CSSNAME         | See [**GetThemeSysString**](getthemesysstring.md). |
| TMT\_DESCRIPTION     |                                                     |
| TMT\_DISPLAYNAME     |                                                     |
| TMT\_LASTUPDATED     |                                                     |
| TMT\_SIZES           |                                                     |
...
| TMT\_URL             |                                                     |
| TMT\_VERSION         |                                                     |
| TMT\_XMLNAME         | See [**GetThemeSysString**](getthemesysstring.md). |
| TMT\_NAME            |                                                     |
