...
keywords: ["LVM_GETGROUPINFO message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETGROUPINFO
...
*lParam* 
</dt> <dd>A pointer an [**LVGROUP**](lvgroup.md) structure that receives the retrieved information. Set the **cbSize** member of this structure to sizeof(LVGROUP). </dd> </dl>
