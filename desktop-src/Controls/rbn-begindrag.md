...
keywords: ["RBN_BEGINDRAG notification code Windows Controls"]
topic_type:
- apiref
api_name:
- RBN_BEGINDRAG
...
Pointer to an [**NMREBAR**](nmrebar.md) structure that contains information about the notification code.
