...
Sent by a tree-view control that has the [**TVS\_INFOTIP**](https://www.bing.com/search?q=**TVS\_INFOTIP**) style. This notification code is sent when the control is requesting additional text information to be displayed in a tooltip. The notification code is sent in the form of a [**WM\_NOTIFY**](wm-notify.md) message.
...
This notification code is only sent by tree-view controls that have the [**TVS\_INFOTIP**](https://www.bing.com/search?q=**TVS\_INFOTIP**) style.
