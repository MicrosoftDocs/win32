...
keywords: ["TVN_GETINFOTIP notification code Windows Controls"]
topic_type:
- apiref
api_name:
- TVN_GETINFOTIP
...
Pointer to an [**NMTVGETINFOTIP**](nmtvgetinfotip.md) structure that contains information about this notification code.
