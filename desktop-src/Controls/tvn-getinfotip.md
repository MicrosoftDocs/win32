...
Pointer to an [**NMTVGETINFOTIP**](/windows/win32/Commctrl/ns-commctrl-tagnmtvgetinfotipa?branch=master) structure that contains information about this notification code.
