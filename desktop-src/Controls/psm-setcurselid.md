...
keywords: ["PSM_SETCURSELID message Windows Controls"]
topic_type:
- apiref
api_name:
- PSM_SETCURSELID
...
Activates the given page in a property sheet based on the resource identifier of the page. You can send this message explicitly or by using the [**PropSheet\_SetCurSelByID**](propsheet-setcurselbyid.md) macro.
