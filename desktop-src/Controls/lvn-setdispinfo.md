...
keywords: ["LVN_SETDISPINFO notification code Windows Controls"]
topic_type:
- apiref
api_name:
- LVN_SETDISPINFO
...
Pointer to an [**NMLVDISPINFO**](nmlvdispinfo.md) structure that specifies information for the changed item. The **item** member of this structure is an [**LVITEM**](lvitem.md) structure that contains information about the item that was changed. The **pszText** member of **item** contains a valid value, regardless of whether the LVIF\_TEXT flag is set in the **mask** member of this structure.
...
The notification receiver casts *lParam* to retrieve the [**NMLVDISPINFO**](nmlvdispinfo.md) structure. The *wParam* parameter contains the message code.
