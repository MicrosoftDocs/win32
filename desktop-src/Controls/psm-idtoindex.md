...
keywords: ["PSM_IDTOINDEX message Windows Controls"]
topic_type:
- apiref
api_name:
- PSM_IDTOINDEX
...
Takes the resource ID of a property sheet page and returns its zero-based index. You can send this message explicitly or use the [**PropSheet\_IdToIndex**](propsheet-idtoindex.md) macro.
