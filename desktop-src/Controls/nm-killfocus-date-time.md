...
keywords: ["NM_KILLFOCUS (date time) notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_KILLFOCUS
...
The address of an [**NMHDR**](nmhdr.md) structure that contains additional information about this notification.
