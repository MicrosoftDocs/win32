...
The [**LOWORD**](https://msdn.microsoft.com/library/windows/desktop/ms632659) specifies the minimum position for the slider, and the [**HIWORD**](https://msdn.microsoft.com/library/windows/desktop/ms632657) specifies the maximum position.
