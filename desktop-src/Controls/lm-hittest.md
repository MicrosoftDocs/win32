...
*lParam* 
</dt> <dd>Pointer to a [**LHITTESTINFO**](/windows/win32/Commctrl/ns-commctrl-taglhittestinfo?branch=master) structure to be filled with information about the link the user clicked, if any exists. </dd> </dl>
...
If the **LM\_HITTEST** message succeeds, the system fills in [**LITEM.iLink**](/windows/win32/Commctrl/ns-commctrl-taglitem?branch=master) and **LITEM.szID**. If the **LM\_HITTEST** message fails, do not assume that any information in **LITEM** is valid.
