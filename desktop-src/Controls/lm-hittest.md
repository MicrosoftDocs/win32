...
keywords: ["LM_HITTEST message Windows Controls"]
topic_type:
- apiref
api_name:
- LM_HITTEST
...
*lParam* 
</dt> <dd>Pointer to a [**LHITTESTINFO**](lhittestinfo.md) structure to be filled with information about the link the user clicked, if any exists. </dd> </dl>
...
If the **LM\_HITTEST** message succeeds, the system fills in [**LITEM.iLink**](litem.md) and **LITEM.szID**. If the **LM\_HITTEST** message fails, do not assume that any information in **LITEM** is valid.
