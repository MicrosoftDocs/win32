...
A pointer to a [**RECT**](https://msdn.microsoft.com/library/windows/desktop/dd162897) structure to receive information on the group specified by *wParam*. The message receiver is responsible for setting the structure members with information for the group specified by *wParam*.

The calling process is responsible for allocating memory for the structure. Set the **top** member of the [**RECT**](https://msdn.microsoft.com/library/windows/desktop/dd162897) to one of the following flags to specify the coordinates of the rectangle to get.
