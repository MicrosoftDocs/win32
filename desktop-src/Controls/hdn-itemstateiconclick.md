...
keywords: ["HDN_ITEMSTATEICONCLICK message Windows Controls"]
topic_type:
- apiref
api_name:
...
A pointer to an [**NMHEADER**](nmheader.md) structure that contains additional information about the state icon that was clicked on.
