...
description: Notifies a header controls parent window that the user clicked an items state icon. This notification code is sent in the form of a WM\_NOTIFY message.
...
A pointer to an [**NMHEADER**](/windows/win32/Commctrl/ns-commctrl-tagnmheadera?branch=master) structure that contains additional information about the state icon that was clicked on.
