...
keywords: ["TVM_SETTEXTCOLOR message Windows Controls"]
topic_type:
- apiref
api_name:
- TVM_SETTEXTCOLOR
...
Sets the text color of the control. You can send this message explicitly or by using the [**TreeView\_SetTextColor**](treeview-settextcolor.md) macro.
