...
keywords: ["LVM_GETSELECTEDCOUNT message Windows Controls"]
topic_type:
- apiref
api_name:
...
Determines the number of selected items in a list-view control. You can send this message explicitly or by using the [**ListView\_GetSelectedCount**](listview-getselectedcount.md) macro.
