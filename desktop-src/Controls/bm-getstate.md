...
| <dl> <dt>**BST\_DROPDOWNPUSHED**</dt> </dl> | [Windows Vista](common-control-versions.md). The button is in the drop-down state. Applies only if the button has the [**TBSTYLE\_DROPDOWN**](toolbar-control-and-button-styles.md#tbstyle-dropdown) style.<br/> |
...
| <dl> <dt>**BST\_INDETERMINATE**</dt> </dl>  | The state of the button is indeterminate. Applies only if the button has the [**BS\_3STATE**](button-styles.md#bs-3state) or [**BS\_AUTO3STATE**](button-styles.md#bs-auto3state) style.<br/>                    |
