...
| <dl> <dt>**BST\_DROPDOWNPUSHED**</dt> </dl> | [Windows Vista](common-control-versions.md). The button is in the drop-down state. Applies only if the button has the [**TBSTYLE\_DROPDOWN**](https://www.bing.com/search?q=**TBSTYLE\_DROPDOWN**) style.<br/> |
...
| <dl> <dt>**BST\_INDETERMINATE**</dt> </dl>  | The state of the button is indeterminate. Applies only if the button has the [**BS\_3STATE**](https://www.bing.com/search?q=**BS\_3STATE**) or [**BS\_AUTO3STATE**](https://www.bing.com/search?q=**BS\_AUTO3STATE**) style.<br/>                    |
