...
The return value is a zero-based value with the starting position of the selection in the [**LOWORD**](/previous-versions/windows/desktop/legacy/ms632659(v=vs.85)) and the position of the first **TCHAR** after the last selected **TCHAR** in the [**HIWORD**]([HIWORD macro](../winmsg/hiword.md)(v=vs.85)). If either of these values exceeds 65,535, the return value is -1.
