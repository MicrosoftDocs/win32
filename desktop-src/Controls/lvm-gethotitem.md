...
keywords: ["LVM_GETHOTITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETHOTITEM
...
Retrieves the index of the hot item. You can send this message explicitly or use the [**ListView\_GetHotItem**](listview-gethotitem.md) macro.
