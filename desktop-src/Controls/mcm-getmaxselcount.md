...
keywords: ["MCM_GETMAXSELCOUNT message Windows Controls"]
topic_type:
- apiref
api_name:
- MCM_GETMAXSELCOUNT
...
Retrieves the maximum date range that can be selected in a month calendar control. You can send this message explicitly or by using the [**MonthCal\_GetMaxSelCount**](monthcal-getmaxselcount.md) macro.
