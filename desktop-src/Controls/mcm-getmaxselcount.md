...
Retrieves the maximum date range that can be selected in a month calendar control. You can send this message explicitly or by using the [**MonthCal\_GetMaxSelCount**](/windows/win32/Commctrl/nf-commctrl-monthcal_getmaxselcount?branch=master) macro.
