...
keywords: ["MCM_GETCALENDARGRIDINFO message Windows Controls"]
topic_type:
- apiref
api_name:
...
Pointer to an [**MCGRIDINFO**](mcgridinfo.md) structure that contains information about the calendar grid.
