---
title: NM\_RCLICK (list view) notification code
...
keywords: ["NM_RCLICK (list view) notification code Windows Controls"]
topic_type:
- apiref
api_name:
- NM_RCLICK
...
[Version 4.71](common-control-versions.md). Pointer to an [**NMITEMACTIVATE**](nmitemactivate.md) structure that contains additional information about this notification. The **iItem**, **iSubItem**, and **ptAction** members of this structure contain information about the item.
