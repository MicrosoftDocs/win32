...
If the list-view control has the [**LVS\_AUTOARRANGE**](https://www.bing.com/search?q=**LVS\_AUTOARRANGE**) style, the items in the list-view control are arranged after the position of the item is set.

On Windows Vista, sending this message to a list-view control with the [**LVS\_AUTOARRANGE**](https://www.bing.com/search?q=**LVS\_AUTOARRANGE**) style does nothing, and the return value is **FALSE**.
