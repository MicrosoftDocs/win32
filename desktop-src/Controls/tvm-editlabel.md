---
title: TVM\_EDITLABEL message
description: Begins in-place editing of the specified items text, replacing the text of the item with a single-line edit control containing the text.
...
Begins in-place editing of the specified item's text, replacing the text of the item with a single-line edit control containing the text. This message implicitly selects and focuses the specified item. You can send this message explicitly or by using the [**TreeView\_EditLabel**](/windows/win32/Commctrl/nf-commctrl-treeview_editlabel?branch=master) macro.
