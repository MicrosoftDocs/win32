...
The following flags are passed to the [**IImageList::Draw**](iimagelist-draw.md) method in the **fState** member of [**IMAGELISTDRAWPARAMS**](imagelistdrawparams.md).
...
| <span id="ILS_ALPHA"></span><span id="ils_alpha"></span><dl> <dt>**ILS\_ALPHA**</dt> <dt>0x00000008</dt> </dl>          | Alpha blends the icon. Alpha blending controls the transparency level of an icon, according to the value of its alpha channel. The value of the alpha channel is indicated by the **frame** member in the [**IMAGELISTDRAWPARAMS**](imagelistdrawparams.md) method. The alpha channel can be from 0 to 255, with 0 being completely transparent, and 255 being completely opaque.<br/> |
