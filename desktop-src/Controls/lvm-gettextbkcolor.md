...
keywords: ["LVM_GETTEXTBKCOLOR message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETTEXTBKCOLOR
...
Retrieves the text background color of a list-view control. You can send this message explicitly or by using the [**ListView\_GetTextBkColor**](listview-gettextbkcolor.md) macro.
