...
Sent by a list box with the [**LBS\_WANTKEYBOARDINPUT**](https://www.bing.com/search?q=**LBS\_WANTKEYBOARDINPUT**) style to its owner in response to a [**WM\_CHAR**](https://msdn.microsoft.com/library/windows/desktop/ms646276) message.
...
Only owner-drawn list boxes that do not have the [**LBS\_HASSTRINGS**](https://www.bing.com/search?q=**LBS\_HASSTRINGS**) style can receive this message.
