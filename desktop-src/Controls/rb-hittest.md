...
keywords: ["RB_HITTEST message Windows Controls"]
topic_type:
- apiref
api_name:
- RB_HITTEST
...
Pointer to an [**RBHITTESTINFO**](rbhittestinfo.md) structure. Before sending the message, the **pt** member of this structure must be initialized to the point that will be hit tested, in client coordinates.
