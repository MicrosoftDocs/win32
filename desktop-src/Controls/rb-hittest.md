...
Pointer to an [**RBHITTESTINFO**](/windows/win32/Commctrl/ns-commctrl-_rb_hittestinfo?branch=master) structure. Before sending the message, the **pt** member of this structure must be initialized to the point that will be hit tested, in client coordinates.
