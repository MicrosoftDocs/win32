...
keywords: ["LVM_INSERTGROUP message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_INSERTGROUP
...
*lParam* 
</dt> <dd>Pointer to a [**LVGROUP**](lvgroup.md) structure that contains the group to add.</dd> </dl>
...
To turn on group mode, call [**LVM\_ENABLEGROUPVIEW**](lvm-enablegroupview.md) or [**ListView\_EnableGroupView**](listview-enablegroupview.md).
