...
The following example illustrates how to use the [**HDM\_INSERTITEM**](hdm-insertitem.md) message and the [**HDITEM**](/windows/desktop/api/Commctrl/ns-commctrl-_hd_itema) structure to add an item to a header control. The new item consists of a string that is left-justified within the item rectangle.
