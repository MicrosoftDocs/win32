...
keywords: ["PSM_GETRESULT message Windows Controls"]
topic_type:
- apiref
api_name:
- PSM_GETRESULT
...
Used by modeless property sheets to retrieve the information returned to modal property sheets by [**PropertySheet**](propertysheet.md). You can send this message explicitly or use the [**PropSheet\_GetResult**](propsheet-getresult.md) macro.
