...
**Rich Edit 1.0 and 3.0:** A pointer to a [**POINTL**](https://msdn.microsoft.com/library/windows/desktop/dd162807) structure that receives the client area coordinates of the character. The coordinates are in screen units and are relative to the upper-left corner of the control's client area.
...
**Edit controls and Rich Edit 2.0:** The return value contains the client area coordinates of the character. The [**LOWORD**](https://msdn.microsoft.com/library/windows/desktop/ms632659) contains the horizontal coordinate and the [**HIWORD**](https://msdn.microsoft.com/library/windows/desktop/ms632657) contains the vertical coordinate.
