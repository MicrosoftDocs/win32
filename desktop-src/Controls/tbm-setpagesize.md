...
description: Sets the number of logical positions the trackbars slider moves in response to keyboard input, such as the or keys, or mouse input, such as clicks in the trackbars channel.
