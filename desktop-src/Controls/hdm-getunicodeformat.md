...
keywords: ["HDM_GETUNICODEFORMAT message Windows Controls"]
topic_type:
- apiref
api_name:
...
Gets the Unicode character format flag for the control. You can send this message explicitly or use the [**Header\_GetUnicodeFormat**](header-getunicodeformat.md) macro.
