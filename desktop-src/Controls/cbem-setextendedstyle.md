...
*wParam* enables you to modify one or more extended styles without having to retrieve the existing styles first. For example, if you pass [**CBES\_EX\_NOEDITIMAGE**](https://www.bing.com/search?q=**CBES\_EX\_NOEDITIMAGE**) for *wParam* and 0 for *lParam*, the **CBES\_EX\_NOEDITIMAGE** style will be cleared, but all other styles will remain the same.

If you try to set an extended style for a ComboBoxEx control created with the [**CBS\_SIMPLE**](https://www.bing.com/search?q=**CBS\_SIMPLE**) style, it may not repaint properly.
