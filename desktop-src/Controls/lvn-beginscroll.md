...
keywords: ["LVN_BEGINSCROLL notification code Windows Controls"]
topic_type:
- apiref
api_name:
- LVN_BEGINSCROLL
...
Pointer to a [**NMLVSCROLL**](nmlvscroll.md) structure that contains the horizontal or vertical position of where the scroll operation starts.
