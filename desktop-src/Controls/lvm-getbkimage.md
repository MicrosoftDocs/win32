...
keywords: ["LVM_GETBKIMAGE message Windows Controls"]
topic_type:
- apiref
api_name:
- LVM_GETBKIMAGE
...
Gets the background image in a list-view control. You can send this message explicitly or by using the [**ListView\_GetBkImage**](listview-getbkimage.md) macro.
...
A pointer to an [**LVBKIMAGE**](lvbkimage.md) structure that will receive the background image information.
