...
keywords: ["TVM_INSERTITEM message Windows Controls"]
topic_type:
- apiref
api_name:
- TVM_INSERTITEM
...
Inserts a new item in a tree-view control. You can send this message explicitly or by using the [**TreeView\_InsertItem**](treeview-insertitem.md) macro.
...
Pointer to a [**TVINSERTSTRUCT**](tvinsertstruct.md) structure that specifies the attributes of the tree-view item.
