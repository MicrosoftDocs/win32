...
A [**Dictionary&gt;**](/windows/win32/WebServices/ns-webservices-_ws_xml_dictionary?branch=master) can be specified as part of the [**WS\_XML\_STRING**](/windows/win32/WebServices/ns-webservices-_ws_xml_string?branch=master) type. All strings within a single **Dictionary&gt;** must be unique.
