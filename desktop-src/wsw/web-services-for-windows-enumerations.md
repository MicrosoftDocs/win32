...
-   [**WS\_HTTP\_HEADER\_AUTH\_SCHEME**](/windows/desktop/api/WebServices/)
-   [**WS\_HTTP\_HEADER\_AUTH\_TARGET**](/windows/desktop/api/WebServices/ne-webservices-ws_http_header_auth_target)
-   [**WS\_HTTP\_HEADER\_MAPPING\_OPTIONS**](/windows/desktop/api/WebServices/)
-   [**WS\_HTTP\_PROXY\_SETTING\_MODE**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
-   [**WS\_HTTP\_REQUEST\_MAPPING\_OPTIONS**](/windows/desktop/api/WebServices/)
-   [**WS\_HTTP\_RESPONSE\_MAPPING\_OPTIONS**](/windows/desktop/api/WebServices/)
