...
# RequestReplyNamedPipesServerWithWindowsTransportSecurityExample

This example shows a named pipes server that accepts a channel, and receives and replies to messages with security provided by Windows SSPI transport security.
...
## RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp
