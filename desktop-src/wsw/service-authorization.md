...
keywords: ["Service Authorization Web Services for Windows", "WWSAPI", "WWS"]
---
...
A service host receives a security callback [**WS\_SERVICE\_SECURITY\_CALLBACK**](ws-service-security-callback.md) as part of the [**WS\_SERVICE\_ENDPOINT**](ws-service-endpoint.md) which is passed to the [**WsCreateServiceHost**](wscreateservicehost.md) function. This callback is invoked when the [WS\_MESSAGE](ws-message.md) is received.
