...
keywords: ["StreamingTcpClientExample Native-Web-Services", "WWSAPI", "WWS"]
---

# StreamingTcpClientExample

This example shows a TCP client that sends one-way messages in a streaming fashion.

-   [StreamingTcpClient.cpp](#streamingtcpclientcpp)
-   [PurchaseOrder.wsdl](#purchaseorderwsdl)
-   [Makefile](#makefile)

## StreamingTcpClient.cpp
