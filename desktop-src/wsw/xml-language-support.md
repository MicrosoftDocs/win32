...
keywords: ["XML Language Support Web Services for Windows", "WWSAPI", "WWS"]
---
...
When reading, [**WsGetXmlAttribute**](wsgetxmlattribute.md) may be used to discover the value of an "xml:lang" attribute in scope.

When writing, [**WsWriteStartAttribute**](wswritestartattribute.md) may be used to write an "xml:lang" attribute.
