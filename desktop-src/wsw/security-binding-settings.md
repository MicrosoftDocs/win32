...
|--------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**WS\_CERT\_FAILURE**](https://msdn.microsoft.com/en-us/library/Dd819123(v=VS.85).aspx)                                         | Defines failures related to certificate validation.                                                                                                               |
| [**WS\_HTTP\_HEADER\_AUTH\_SCHEME**](https://msdn.microsoft.com/en-us/library/Dd401907(v=VS.85).aspx)                 | Defines the options for performing client authentication using HTTP authentication headers.                                                                       |
