...
Each service operation within service model is given as a [**WS\_OPERATION\_DESCRIPTION**](/windows/win32/WebServices/ns-webservices-_ws_operation_description?branch=master). WS\_OPERATION\_DESCRIPTION is generated by [wsutil.exe](web-service-compiler-tool.md).

For each wsdl:operation the tool generates a separate [**WS\_OPERATION\_DESCRIPTION**](/windows/win32/WebServices/ns-webservices-_ws_operation_description?branch=master).
