...
keywords: ["Service Operation Web Services for Windows", "WWSAPI", "WWS"]
---
...
Each service operation within service model is given as a [**WS\_OPERATION\_DESCRIPTION**](ws-operation-description.md). WS\_OPERATION\_DESCRIPTION is generated by [wsutil.exe](web-service-compiler-tool.md).

For each wsdl:operation the tool generates a separate [**WS\_OPERATION\_DESCRIPTION**](ws-operation-description.md).
