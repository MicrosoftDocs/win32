...
To create and display a **Print** property sheet, initialize a [**PRINTDLGEX**](/windows/win32/api/commdlg/ns-commdlg-printdlgexa) structure and pass the structure to the [**PrintDlgEx**](https://msdn.microsoft.com/en-us/library/ms646942(v=VS.85).aspx) function.
