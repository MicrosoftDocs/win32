...
The help context identifier for the dialog box window. When the system sends a [**WM\_HELP**](_win32_WM_HELP) message, it passes this value in the **wContextId** member of the [**HELPINFO**](_win32_HELPINFO_str) structure.
