...
| [*DialogProc*](https://msdn.microsoft.com/en-us/library/ms645469(v=VS.85).aspx)                                 | An application-defined callback function used with the [**CreateDialog**](/windows/desktop/api/Winuser/nf-winuser-createdialoga) and [**DialogBox**](/windows/desktop/api/Winuser/nf-winuser-dialogboxa) families of functions. It processes messages sent to a modal or modeless dialog box. The **DLGPROC** type defines a pointer to this callback function. [*DialogProc*](https://msdn.microsoft.com/en-us/library/ms645469(v=VS.85).aspx) is a placeholder for the application-defined function name. <br/>                                                    |
...
| [**MSGBOXPARAMS**](/windows/desktop/api/Winuser/ns-winuser-tagmsgboxparamsa)           | Contains information used to display a message box. The [**MessageBoxIndirect**](/windows/desktop/api/Winuser/nf-winuser-messageboxindirecta) function uses this structure.<br/>                                                                                                                                                                                                           |
