...
| [*DialogProc*](/windows/desktop/api/Winuser/nf-winuser-defdlgproca)                                 | An application-defined callback function used with the [**CreateDialog**](/windows/desktop/api/Winuser/nf-winuser-createdialoga) and [**DialogBox**](/windows/desktop/api/Winuser/nf-winuser-dialogboxa) families of functions. It processes messages sent to a modal or modeless dialog box. The **DLGPROC** type defines a pointer to this callback function. [*DialogProc*](/windows/desktop/api/Winuser/nf-winuser-defdlgproca) is a placeholder for the application-defined function name. <br/>                                                    |
