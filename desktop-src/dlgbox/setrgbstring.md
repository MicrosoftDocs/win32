...
The hook procedure of a **Color** dialog box, [*CCHookProc*](/windows/desktop/api/Commdlg/), can send the **SETRGBSTRING** registered message to the dialog box to set the current color selection.
