...
Notifies a [**PagePaintHook**](pagepainthook.md) hook procedure that the **Page Setup** dialog box is about to draw the contents of the sample page. The hook procedure can use this message to carry out initialization tasks related to drawing the contents of the sample page.
