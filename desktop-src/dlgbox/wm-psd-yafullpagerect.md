...
Notifies the hook procedure of a **Page Setup** dialog box, [*PagePaintHook*](pagepainthook.md), that the dialog box is about to draw the return address portion of an envelope sample page.
