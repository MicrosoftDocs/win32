...
keywords: ["SHAREVISTRING message Dialog Boxes"]
topic_type:
- apiref
api_name:
- SHAREVISTRING
...
A pointer to a [**OPENFILENAME**](openfilename-str.md) structure. The **lpstrFile** member of this structure contains the file name that caused the sharing violation.
...
The dialog box sends the **SHAREVISTRING** registered message only if you did not specify the **OFN\_SHAREAWARE** flag in the **Flags** member of the [**OPENFILENAME**](openfilename-str.md) structure when you created the dialog.
