...
keywords: ["WM_PSD_MARGINRECT message Dialog Boxes"]
topic_type:
- apiref
api_name:
- WM_PSD_MARGINRECT
...
Notifies the hook procedure of a **Page Setup** dialog box, [**PagePaintHook**](pagepainthook.md), that the dialog box is about to draw the margin rectangle of the sample page.
