---
title: WM\_PSD\_FULLPAGERECT message
...
keywords: ["WM_PSD_FULLPAGERECT message Dialog Boxes"]
topic_type:
- apiref
api_name:
- WM_PSD_FULLPAGERECT
...
Notifies a [*PagePaintHook*](pagepainthook.md) hook procedure of the coordinates of the sample page rectangle in the **Page Setup** dialog box. The dialog box sends this message when it is about to draw the contents of the sample page.
