...
Notifies a [*PagePaintHook*](https://www.bing.com/search?q=*PagePaintHook*) hook procedure of the coordinates of the sample page rectangle in the **Page Setup** dialog box. The dialog box sends this message when it is about to draw the contents of the sample page.
