...
The help context identifier for the control. When the system sends a [**WM\_HELP**](https://www.bing.com/search?q=**WM\_HELP**) message, it passes the **helpID** value in the **dwContextId** member of the [**HELPINFO**](https://www.bing.com/search?q=**HELPINFO**) structure.
...
[**WM\_HELP**](https://www.bing.com/search?q=**WM\_HELP**)
</dt> </dl>
