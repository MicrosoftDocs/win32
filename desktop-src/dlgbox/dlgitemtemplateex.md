...
The help context identifier for the control. When the system sends a [**WM\_HELP**](_win32_WM_HELP) message, it passes the **helpID** value in the **dwContextId** member of the [**HELPINFO**](_win32_HELPINFO_str) structure.
