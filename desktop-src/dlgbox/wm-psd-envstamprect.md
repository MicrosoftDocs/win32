...
Notifies the hook procedure of a **Page Setup** dialog box, [*PagePaintHook*](https://msdn.microsoft.com/library/ms646935(v=VS.85).aspx), that the dialog box is about to draw the envelope-stamp rectangle of the sample page.
