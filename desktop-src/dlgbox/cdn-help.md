...
keywords: ["CDN_HELP notification code Dialog Boxes"]
topic_type:
- apiref
api_name:
- CDN_HELP
...
A pointer to an [**OFNOTIFY**](ofnotify-str.md) structure. The **OFNOTIFY** structure contains an [**NMHDR**](_win32_nmhdr_str) structure whose **code** member indicates the **CDN\_HELP** notification message.
