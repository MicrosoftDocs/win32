...
A pointer to an [**OFNOTIFY**](/windows/win32/Commdlg/ns-commdlg-_ofnotifya?branch=master) structure. The **OFNOTIFY** structure contains an [**NMHDR**](_win32_nmhdr_str) structure whose **code** member indicates the **CDN\_HELP** notification message.
