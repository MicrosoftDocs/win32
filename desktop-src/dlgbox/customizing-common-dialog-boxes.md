...
| **Print**                                | [*PrintHookProc*](printhookproc.md)                |
| **Page Setup**                           | [*PageSetupHook*](pagesetuphook.md)                |
...
The Explorer-style **Open** and **Save As** dialog boxes support a set of predefined messages. These include notification messages sent in the form of a [**WM\_NOTIFY**](_win32_WM_NOTIFY) message to your hook procedure, and messages that your hook procedure can send to the dialog box. For a complete list of these messages, see [Explorer-Style Hook Procedures](open-and-save-as-dialog-boxes.md#explorer-style-hook-procedures).
...
| Pressed the F1 key.                                                   | [**WM\_HELP**](_win32_WM_HELP)               |
| Clicked the **?** button on the title bar and then clicked a control. | [**WM\_HELP**](_win32_WM_HELP)               |
