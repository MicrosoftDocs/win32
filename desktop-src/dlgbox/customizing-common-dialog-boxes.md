...
|------------------------------------------|-----------------------------------------------------|
| **Color**                                | [*CCHookProc*](/windows/desktop/api/Commdlg/)                      |
| **Find** or **Replace**                  | [*FRHookProc*](https://www.bing.com/search?q=*FRHookProc*)                      |
| **Font**                                 | [*CFHookProc*](https://www.bing.com/search?q=*CFHookProc*)                      |
| **Open** or **Save As** (Explorer-style) | [*OFNHookProc*](https://www.bing.com/search?q=*OFNHookProc*)                    |
| **Open** or **Save As** (Old-style)      | [*OFNHookProcOldStyle*](https://msdn.microsoft.com/library/windows/desktop/ms646932) |
| **Print**                                | [*PrintHookProc*](https://www.bing.com/search?q=*PrintHookProc*)                |
| **Page Setup**                           | [*PageSetupHook*](https://www.bing.com/search?q=*PageSetupHook*)                |



 

For the **Page Setup** dialog box, you can also specify a [*PagePaintHook*](https://www.bing.com/search?q=*PagePaintHook*) hook procedure. This is a special hook procedure that you can use to customize the appearance of the sample page displayed by the **Page Setup** dialog box.

> [!Note]  
> The **Print Setup** dialog box has been superseded by the **Page Setup** dialog box. Applications should use the **Page Setup** dialog box. However, for compatibility, the [**PrintDlg**](https://www.bing.com/search?q=**PrintDlg**) function continues to support display of the **Print Setup** dialog box. You can provide a [*SetupHookProc*](https://www.bing.com/search?q=*SetupHookProc*) hook procedure for the **Print Setup** dialog box.
...
| [**FINDMSGSTRING**](findmsgstring.md) | A **Find** or **Replace** dialog box sends this message to the window procedure of its parent window when the user clicks the **Find Next**, **Replace**, or **Replace All**, or closes the dialog box. The message's *lParam* parameter is a pointer to a [**FINDREPLACE**](/windows/desktop/api/Commdlg/ns-commdlg-tagfindreplacea) structure containing the user's input.                                                                               |
...
| Pressed the F1 key.                                                   | [**WM\_HELP**](https://www.bing.com/search?q=**WM\_HELP**)               |
| Clicked the **?** button on the title bar and then clicked a control. | [**WM\_HELP**](https://www.bing.com/search?q=**WM\_HELP**)               |



 

You should process these messages for the controls you have added, but let the default dialog box procedure process the messages for the standard controls. For more information about how to process these messages, see [Help](https://www.bing.com/search?q=Help).

### The Help Button

You can display a **Help** button in any of the common dialog boxes by setting a **SHOWHELP** value in the **Flags** member of the initialization structure for the dialog box. If you display the **Help** button, you must process the user's request for help. The processing can be done either in one of your application's window procedures or in a hook procedure for the dialog box. Typically, you would process the request for help by calling the [**WinHelp**](https://www.bing.com/search?q=**WinHelp**) function.
