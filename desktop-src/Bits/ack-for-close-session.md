...
description: Use the Ack for Close-Session packet to acknowledge the clients Close-Session request. The server sends the acknowledgment after releasing all resources associated with the upload session.
