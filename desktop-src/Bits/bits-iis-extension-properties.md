...
| **BITSMaximumUploadSize**Data type: **String**<br> | Maximum number of bytes that can be uploaded per job. Specify the maximum number of bytes as a decimal string; the string value must be less than or equal to "1844674407370955". An empty string is the same as specifying "1844674407370955".<br> Default value is an empty string.<br> **Note:** In IIS 7, the default upload limit is 30 million bytes. The value of the **BITSMaximumUploadSize** property cannot exceed the IIS limit. For details and information on changing the IIS default, see [KB942074](https://support.microsoft.com//kb/942074).<br> | 
