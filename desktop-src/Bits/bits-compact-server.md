...
For information about using cmdlets, see the [Windows PowerShell](http://go.microsoft.com/fwlink/p/?linkid=142509) documentation.

For more information about the Import-Module cmdlet, see [Import-Module](http://go.microsoft.com/fwlink/p/?linkid=154271) in the Microsoft TechNet Library. For help at the command line, type **get-help import-module**.

For more information about the Add-WindowsFeature cmdlet, see [Add-WindowsFeature](http://go.microsoft.com/fwlink/p/?linkid=154270) in the Microsoft TechNet Library. For help at the command line, type **get-help Add-WindowsFeature**.
...
For more information, see the [BITS provider](http://go.microsoft.com/fwlink/p/?linkid=154267) documentation.
