...
description: Background transfers use only idle network bandwidth in an effort to preserve the users interactive experience with other network applications, such as Internet Explorer.
