...
description: Use the Ack for Create-Session packet to acknowledge the clients Create-Session request.
...
Replace reason-code with the HTTP reason code. The following table shows the typical reason codes for a response to a [**Create-Session**](create-session.md) request. For a list of HTTP reason codes, see [RFC 2616](http://go.microsoft.com/fwlink/p/?linkid=84048).
