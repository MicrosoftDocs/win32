...
description: Use the Ack for Cancel-Session packet to acknowledge the clients Cancel-Session request. The server sends the acknowledgment after releasing all resources associated with the upload session.
