...
-   Log on to a [terminal service](https://go.microsoft.com/fwlink/p/?linkid=160632) client.
-   Use [fast user switching](https://go.microsoft.com/fwlink/p/?linkid=166155).
...
Users with a [restricted token](https://go.microsoft.com/fwlink/p/?linkid=166157) (a token that contains restricting SIDs) cannot create or modify jobs.
 
