...
A process can use the [**CreateWindowStation**](https://msdn.microsoft.com/en-us/library/ms682496(v=VS.85).aspx) function to create a new window station, and the **CreateDesktop** or [**CreateDesktopEx**](https://msdn.microsoft.com/en-us/library/ms682127(v=VS.85).aspx) function to create a new desktop. The number of desktops that can be created is limited by the size of the system desktop heap. For more information, see [**CreateDesktop**](https://msdn.microsoft.com/en-us/library/ms682124(v=VS.85).aspx).
