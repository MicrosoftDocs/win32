...
A process can use the [**CreateWindowStation**](/windows/desktop/api/Winuser/nf-winuser-createwindowstationa) function to create a new window station, and the **CreateDesktop** or [**CreateDesktopEx**](/windows/desktop/api/Winuser/nf-winuser-createdesktopexa) function to create a new desktop. The number of desktops that can be created is limited by the size of the system desktop heap. For more information, see [**CreateDesktop**](/windows/desktop/api/Winuser/nf-winuser-createdesktopa).
