...
keywords: ["command abbreviation NetSh", "components NetSh , command abbreviation"]
---
...
This functionality is provided by the [**MatchToken**](matchtoken.md) function provided by the NetShell API. Programmers creating NetShell helpers can use the **MatchToken** function to implement command abbreviation for NetShell commands.
