...
This functionality is provided by the [**MatchToken**](/previous-versions/windows/desktop/api/Netsh/nf-netsh-matchtoken) function provided by the NetShell API. Programmers creating NetShell helpers can use the **MatchToken** function to implement command abbreviation for NetShell commands.
