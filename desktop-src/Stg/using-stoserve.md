...
**StoServe** is a DLL that is intended primarily as a COM server. Although it can be implicitly loaded by linking to its associated .LIB file, it is normally used after an explicit LoadLibrary call, usually from within the COM function [**CoGetClassObject**](https://msdn.microsoft.com/windows/desktop/65e758ce-50a4-49e8-b3b2-0cd148d2781a). **StoServe** is a self-registering in-process server.
