...
keywords: ["Allocate method Structured Storage", "Allocate method Structured Storage , IMemoryAllocator interface", "IMemoryAllocator interface Structured Storage , Allocate method"]
topic_type:
- apiref
api_name:
