...
[**IStorage::CopyTo**](/windows/win32/Objidl/nf-objidl-istorage-copyto?branch=master) can be used to layout a docfile, thus improving performance in most scenarios.
