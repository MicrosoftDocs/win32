...
A property value is passed through property interfaces as an instance of the type [**PROPVARIANT**](/windows/desktop/api/propidlbase/ns-propidl-tagpropvariant).
