...
A property value is passed through property interfaces as an instance of the type [**PROPVARIANT**](https://msdn.microsoft.com/library/Aa380072(v=VS.85).aspx).
