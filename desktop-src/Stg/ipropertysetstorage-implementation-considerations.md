...
Several issues arise when considering how to provide an implementation of the [**IPropertySetStorage**](ipropertysetstorage.md) interface that reads and writes the COM property set format. The following sections describe these considerations.
...
For more information, see [**IPropertySetStorage**](ipropertysetstorage.md) in the Reference section under Interfaces.
