...
The [StoClien](structured-storage-client-sample--stoclien-.md) sample uses many of the utility classes and services provided by [APPUTIL](Http://go.microsoft.com/fwlink/p/?linkid=84368). For more information about [APPUTIL](Http://go.microsoft.com/fwlink/p/?linkid=84368), see the [APPUTIL](Http://go.microsoft.com/fwlink/p/?linkid=84368) library source code in the sibling [APPUTIL](Http://go.microsoft.com/fwlink/p/?linkid=84368) directory and Apputil.md in the main tutorial directory. For more information about [APPUTIL](Http://go.microsoft.com/fwlink/p/?linkid=84368), see [How to Build Samples](how-to-build-samples.md).
