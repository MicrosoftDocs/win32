...
Creates an object that can be used to enumerate [**STATPROPSETSTG**](/windows/desktop/api) structures. Each **STATPROPSETSTG** structure provides data about a single property set.
