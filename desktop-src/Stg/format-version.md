...
-   **Property types**. Version 1 property sets can hold all the property types that can be held in a version 0 property set plus some additional types. See the [**PROPVARIANT**](/windows/desktop/api/propidlbase/ns-propidl-tagpropvariant) structure for more information on these types.
