...
The address of pointer variable **m\_pIStorage** is passed to [**StgCreateDocfile**](stgcreatedocfile.md) as the fourth parameter. When the call successfully returns, **m\_pIStorage** contains an interface pointer to an [**IStorage**](istorage.md) interface. This is the interface that is used for any subsequent operations on the file.
