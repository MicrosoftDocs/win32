...
The address of pointer variable **m\_pIStorage** is passed to [**StgCreateDocfile**](/windows/win32/coml2api/nf-coml2api-stgcreatedocfile?branch=master) as the fourth parameter. When the call successfully returns, **m\_pIStorage** contains an interface pointer to an [**IStorage**](/windows/win32/Objidl/nn-objidl-istorage?branch=master) interface. This is the interface that is used for any subsequent operations on the file.
