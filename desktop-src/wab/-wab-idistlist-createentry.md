...
Type: **[**ENTRYID**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-entryid)\***

Pointer to a variable of type [**ENTRYID**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-entryid) specifying the entry identifier of the object to copy from.
...
Type: **[**IDistList**](/previous-versions/windows/desktop/api/wabdefs/)\*\***

Address of a pointer to a variable of type [**IDistList**](/previous-versions/windows/desktop/api/wabdefs/) receiving the property interface to the new object.
