...
Pointer to a [**SPropTagArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sproptagarray) variable receiving the property tag array to be deleted.
...
Address of a pointer to an [**SPropProblemArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_spropproblemarray) variable receiving the problem array. This must be freed by the caller if a non-NULL value is returned.
