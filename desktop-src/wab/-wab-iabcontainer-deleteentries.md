...
Pointer to a variable of type [**ENTRYLIST**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sbinaryarray) that specifies the identifiers of entries to be deleted.
