...
Pointer to a variable of type [**ENTRYID**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-entryid) specifying the address to open for the entry identifier of the object.
