...
Pointer to a variable of type [**ENTRYID**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-entryid) that specifies the identifier of the object to open.
