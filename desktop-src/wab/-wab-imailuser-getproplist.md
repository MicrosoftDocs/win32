...
Address of a pointer to a variable of type [**SPropTagArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sproptagarray) that receives the property tags. Must be freed by the client if a non-null value is retrieved.
