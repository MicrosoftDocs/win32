...
3.  For each named property corresponding to the GUID, add the identifier for the named property under the GUID as a subkey. You can represent named properties as either a **LONG** or a string. See [MAPINAMEID](https://msdn.microsoft.com/windows/desktop/0099fa14-0929-4443-9dff-a8b10b95b1c0) for more information.
