...
Pointer to a variable of type [**ENTRYLIST**](/windows/previous-versions/Wabdefs/ns-wabdefs-_sbinaryarray?branch=master) that specifies the address of an array of entry identifier structures that are being deleted from the distribution list.
