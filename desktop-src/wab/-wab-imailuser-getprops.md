...
Pointer to a variable of type [**SPropTagArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sproptagarray) that specifies the properties to be retrieved.
...
Address of a pointer to a variable of type [**SPropValue**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_spropvalue) that receives the property values. The variable must be freed by the client.
...
If zero was passed in the cValues member of the [**SPropTagArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sproptagarray) structure to which *lpPropTagArray* points, the method returns MAPI\_E\_INVALID\_PARAMETER.
