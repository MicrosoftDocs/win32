...
Pointer to an [**SPropTagArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sproptagarray) structure of properties whose values are to be retrieved. A **NULL** value specifies that all properties should be retrieved.
...
Address of a pointer to an `SPropValue` variable type that retrieves the [**SPropValue**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_spropvalue) array. It must be freed by the caller.
...
| <dl> <dt>**MAPI\_E\_INVALID\_PARAMETER**</dt> </dl> | Zero was passed in the *cValues* member of the [**SPropTagArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sproptagarray) structure to which *lpPropTagArray* points. <br/>                                                                                                                                                                                                                                        |
