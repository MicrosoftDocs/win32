...
Type: **[MAPINAMEID](https://msdn.microsoft.com/windows/desktop/0099fa14-0929-4443-9dff-a8b10b95b1c0)\*\***

Address of a pointer to a variable of type [MAPINAMEID](https://msdn.microsoft.com/windows/desktop/0099fa14-0929-4443-9dff-a8b10b95b1c0) that specifies the names and their globally unique identifiers (GUIDs).
...
Address of a pointer to a variable of type [**SPropTagArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_sproptagarray) that receives the property tags. Must be freed by the client.
