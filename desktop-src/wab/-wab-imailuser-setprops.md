...
Pointer to a variable of type [**SPropValue**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_spropvalue) that specifies the properties to be set.
...
Address of a pointer to a variable of type [**SPropProblemArray**](/previous-versions/windows/desktop/api/Wabdefs/ns-wabdefs-_spropproblemarray) that receives any problems that occurred. The variable must be freed by the client if a non-null value is returned.
