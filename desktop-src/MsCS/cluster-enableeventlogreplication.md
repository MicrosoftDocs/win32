...
keywords:
- EnableEventLogReplication Failover Cluster ,for clusters
...
Controls whether the system, application, and security event log entries of all the [node's](nodes.md) are replicated across the entire [*cluster*](https://www.bing.com/search?q=*cluster*).
