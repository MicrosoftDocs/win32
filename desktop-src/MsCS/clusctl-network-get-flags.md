...
keywords: ["CLUSCTL_NETWORK_GET_FLAGS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the flags that are set for a [network](networks.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNetworkControl**](clusternetworkcontrol.md) parameter.
