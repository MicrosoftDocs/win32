...
keywords:
- CLUSCTL_RESOURCE_NETNAME_VALIDATE_VCO control code Failover Cluster
topic_type:
- apiref
api_name:
...
Confirms whether the security principal of the designated resource can be managed by the cluster. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) function.
