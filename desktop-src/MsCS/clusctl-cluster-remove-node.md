...
keywords: ["CLUSCTL_CLUSTER_REMOVE_NODE control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Removes a node from a cluster. Applications use this [control code](about-control-codes.md) as a [**ClusterControl**](clustercontrol.md) parameter.
...
For complete parameter descriptions, see [**ClusterControl**](clustercontrol.md).
