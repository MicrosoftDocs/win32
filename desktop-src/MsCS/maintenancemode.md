...
Contains the maintenance mode of the [*Physical Disk resource*](https://www.bing.com/search?q=*Physical Disk resource*). The following table summarizes the attributes of the **MaintenanceMode** property.
...
The **MaintenanceMode** property can be set to one of the following values enumerated by the [**MAINTENANCE\_MODE\_TYPE\_ENUM**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-_maintenance_mode_type_enum) enumeration.
