...
keywords: ["MaintenanceMode Failover Cluster , for Physical Disk private properties", "MaintenanceMode Failover Cluster"]
topic_type:
- apiref
api_name:
- MaintenanceMode
...
The **MaintenanceMode** property can be set to one of the following values enumerated by the [**MAINTENANCE\_MODE\_TYPE\_ENUM**](maintenance-mode-type-enum.md) enumeration.
