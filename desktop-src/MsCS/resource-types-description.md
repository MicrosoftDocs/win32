---
title: Description
description: Provides comments about the resource type. The following table summarizes the attributes of the Description property.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: c61b3e66-1fe4-4ca3-bd97-5e84023d5bb1
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- Description Failover Cluster ,for groups
...
```C++
WCHAR szDescriptionData[] = L"Resource type description";
