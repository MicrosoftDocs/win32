...
keywords: ["CLUSCTL_NETWORK_GET_COMMON_PROPERTY_FMTS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Reserved for future use. Applications use this control code as a parameter to the [**ClusterNetworkControl**](clusternetworkcontrol.md) function.
...
[**ClusterNetworkControl**](clusternetworkcontrol.md) returns the following value.
