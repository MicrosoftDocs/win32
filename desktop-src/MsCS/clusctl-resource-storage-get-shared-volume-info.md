...
keywords: ["CLUSCTL_RESOURCE_STORAGE_GET_SHARED_VOLUME_INFO control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Pointer to a [value list](value-lists.md) of [**CLUSPOP\_BINARY**](clusprop-binary.md) structures. Each binary structure, in turn, contains a CLUS\_CSV\_VOLUME\_INFO structure describing each cluster shared volume associated with the designated resource.
