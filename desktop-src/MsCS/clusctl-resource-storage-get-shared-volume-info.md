...
Pointer to a [value list](value-lists.md) of [**CLUSPOP\_BINARY**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_binary) structures. Each binary structure, in turn, contains a CLUS\_CSV\_VOLUME\_INFO structure describing each cluster shared volume associated with the designated resource.
