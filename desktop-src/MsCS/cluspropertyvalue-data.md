...
Retrieves a [**ClusPropertyValueData**](cluspropertyvaluedata-collection.md) collection containing all of the [*data values*](https://www.bing.com/search?q=*data values*) associated with a [*property value*](https://www.bing.com/search?q=*property value*).
