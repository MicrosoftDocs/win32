---
title: CLUSCTL\_NETINTERFACE\_VALIDATE\_PRIVATE\_PROPERTIES control code
description: Verifies that a property list is properly formatted.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 5bc41c4a-ec42-4f29-bd49-18daf3a18275
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_NETINTERFACE_VALIDATE_PRIVATE_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_NETINTERFACE\_VALIDATE\_PRIVATE\_PROPERTIES control code

Verifies that a [property list](property-lists.md) is properly formatted. Applications use this [control code](about-control-codes.md) as a [**ClusterNetInterfaceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusternetinterfacecontrol?branch=master) parameter.
...
Pass a pointer to a property list containing one or more read/write network interface [private properties](private-properties.md).
...
ClusAPI.h defines the 32 bits of CLUSCTL\_NETINTERFACE\_VALIDATE\_PRIVATE\_PROPERTIES as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
