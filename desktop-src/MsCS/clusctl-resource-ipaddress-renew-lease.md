...
keywords: ["CLUSCTL_RESOURCE_IPADDRESS_RENEW_LEASE control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Renews the DHCP based lease of an IP address associated with a designated resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
