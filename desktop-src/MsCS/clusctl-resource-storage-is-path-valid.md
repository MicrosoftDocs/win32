...
keywords: ["CLUSCTL_RESOURCE_STORAGE_IS_PATH_VALID control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Implementations of [**ResourceControl**](resourcecontrol.md) can return one of the previous values or the following value.
