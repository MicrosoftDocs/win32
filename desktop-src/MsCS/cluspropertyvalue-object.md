...
Represents a single [*property value*](p-gly.md#-wolf-property-value-gly) associated with a multi-value property. The property value consists of one or more [*data values*](d-gly.md#-wolf-data-value-gly).
