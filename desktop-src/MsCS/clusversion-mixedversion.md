...
Indicates whether more than one version of the [Cluster service](cluster-service.md) is present in the [*cluster*](https://www.bing.com/search?q=*cluster*), a state described as [*mixed mode*](https://www.bing.com/search?q=*mixed mode*).
