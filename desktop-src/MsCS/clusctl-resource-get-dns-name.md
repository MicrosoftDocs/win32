...
keywords: ["CLUSCTL_RESOURCE_GET_DNS_NAME control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the DNS name of the designated resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
