...
**Long** that receives the [*major version*](m-gly.md#-wolf-major-version-gly).

## Remarks

The **MajorVersion** and [**ClusVersion.MinorVersion**](clusversion-minorversion.md) properties together form a complete Windows [*version number*](v-gly.md#-wolf-version-number-gly).
