...
keywords:
- CLUSCTL_GROUP_GET_NAME control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the name of a [group](groups.md). Applications use this [control code](about-control-codes.md) as a [**ClusterGroupControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustergroupcontrol?branch=master) parameter.
