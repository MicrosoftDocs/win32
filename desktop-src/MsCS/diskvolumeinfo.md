...
Stores information about the volumes on a [*Physical Disk resource*](p-gly.md#-wolf-physical-disk-resource-gly). The following table summarizes the attributes of the **DiskVolumeInfo** property.
