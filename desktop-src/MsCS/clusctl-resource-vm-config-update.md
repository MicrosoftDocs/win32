...
keywords:
- CLUSCTL_RESOURCE_VM_CONFIG_UPDATE control code Failover Cluster
topic_type:
- apiref
api_name:
...
The CLUSCTL\_RESOURCE\_VM\_CONFIG\_UPDATE [control code](about-control-codes.md)updates the [**VmSwitchPorts**](virtual-machine-configurations-vmswitchports.md) and [**VmPhysicalDisks**](virtual-machine-configurations-vmphysicaldisks.md) properties of the Virtual Machine configuration resource instances. Applications use this control code as a parameter to [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) function, and [resource DLLs](resource-dlls.md) receive the control code as a parameter to the [*ResourceControl*](/windows/previous-versions/ResApi/nc-resapi-presource_control_routine?branch=master) callback function.
