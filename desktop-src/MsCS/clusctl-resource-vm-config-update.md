...
The CLUSCTL\_RESOURCE\_VM\_CONFIG\_UPDATE [control code](about-control-codes.md)updates the [**VmSwitchPorts**](virtual-machine-configurations-vmswitchports.md) and [**VmPhysicalDisks**](virtual-machine-configurations-vmphysicaldisks.md) properties of the Virtual Machine configuration resource instances. Applications use this control code as a parameter to [**ClusterResourceControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusterresourcecontrol) function, and [resource DLLs](resource-dlls.md) receive the control code as a parameter to the [*ResourceControl*](/previous-versions/windows/desktop/api/ResApi/nc-resapi-presource_control_routine) callback function.
