...
- Flags property Failover Cluster , ClusVersion object
- ClusVersion object Failover Cluster , Flags property
topic_type:
- apiref
api_name:
- ClusVersion.Flags
...
Returns flags associated with the [*cluster version*](https://www.bing.com/search?q=*cluster version*).
