...
keywords: ["CLUSCTL_RESOURCE_TYPE_SET_PRIVATE_PROPERTIES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Updates the read/write [private properties](private-properties.md) for a [resource type](resource-types.md). Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceTypeControl**](clusterresourcetypecontrol.md) function, and resource DLLs receive the control code as a parameter to he [**ResourceTypeControl**](resourcetypecontrol.md) callback function.
