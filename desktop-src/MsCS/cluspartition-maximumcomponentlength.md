...
keywords:
- MaximumComponentLength property Failover Cluster
- MaximumComponentLength property Failover Cluster , ClusPartition object
- ClusPartition object Failover Cluster , MaximumComponentLength property
topic_type:
- apiref
api_name:
...
Returns the maximum component length of a [*storage class resource*](https://www.bing.com/search?q=*storage class resource*) partition.
