---
title: ClusNodes.Refresh method
...
- Refresh method Failover Cluster , ClusNodes collection
- ClusNodes collection Failover Cluster , Refresh method
topic_type:
- apiref
api_name:
- ClusNodes.Refresh
...
Refreshes the data in the [**ClusNodes**](clusnodes-collection.md) collection.
