...
Updates information about the security principal associated with a designated resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusterresourcecontrol) function.
...
Takes the security principal's information to be updated. This information is structured according to the [**CLUS\_NETNAME\_PWD\_INFO**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clus_netname_pwd_info) structure.
