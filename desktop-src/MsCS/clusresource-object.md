...
| [**CanResourceBeDependent**](clusresource-canresourcebedependent.md) | Determines if the resource can be [*dependent*](https://www.bing.com/search?q=*dependent*) on another resource.<br/> |
...
| [**Cluster**](clusresource-cluster.md)<br/>                         | Read-only<br/>  | Returns the [*cluster*](https://www.bing.com/search?q=*cluster*) that includes the resource.<br/>                                                                                    |
...
| [**PossibleOwnerNodes**](clusresource-possibleownernodes.md)<br/>   | Read-only<br/>  | Returns the nodes that are members of the resource's [*possible owners*](https://www.bing.com/search?q=*possible owners*) list.<br/>                                                  |
