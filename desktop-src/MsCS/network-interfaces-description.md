---
title: Description
description: Provides comments about the network interface. The following table summarizes the attributes of the Description property.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'f0498896-9145-4cc1-9f46-cd673c5dcb36'
ms.prod: 'windows-server-dev'
ms.technology: 'failover-clustering'
ms.tgt_platform: multiple
keywords: ["Description Failover Cluster ,for network interfaces", "Description Failover Cluster"]
topic_type:
- apiref
api_name:
- Description
...
```C++
WCHAR szDescriptionData[] = L"Network Interface Description";
