...
| Handle                                      | Function                                                                                                                                      |
|---------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| [*Cluster*](https://www.bing.com/search?q=*Cluster*)    | [**OpenCluster**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster)<br/> [**CloseCluster**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_close_cluster)<br/>                                                 |
| [Node](nodes.md)                           | [**OpenClusterNode**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster_node)<br/> [**CloseClusterNode**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_close_cluster_node)<br/>                                 |
| [Network](networks.md)                     | [**OpenClusterNetwork**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster_network)<br/> [**CloseClusterNetwork**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_close_cluster_network)<br/>                     |
| [Network interface](network-interfaces.md) | [**OpenClusterNetInterface**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster_net_interface)<br/> [**CloseClusterNetInterface**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_close_cluster_net_interface)<br/> |
| [Group](groups.md)                         | [**OpenClusterGroup**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster_group)<br/> [**CloseClusterGroup**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_close_cluster_group)<br/>                             |
| [Resource](resources.md)                   | [**OpenClusterResource**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster_resource)<br/> [**CloseClusterResource**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_close_cluster_resource)<br/>                 |
...
2.  Open a cluster handle by calling [**OpenCluster**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster)
3.  Open the object handle by calling [**OpenCluster**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster). Pass the cluster handle obtained from step 1 as well as the name of the object.
...
The following example provides two functions: *ClusDocEx\_OpenLocalClusterWithName* and *ClusDocEx\_ResAddPossibleOwner*. The first function returns an RPC cluster handle by using [**GetComputerName**](https://msdn.microsoft.com/library/windows/desktop/ms724295) to supply a name for [**OpenCluster**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_open_cluster). The second function illustrates a call to [**AddClusterResourceNode**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_add_cluster_resource_node), which requires a resource handle and a node handle.
