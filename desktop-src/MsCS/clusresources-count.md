...
keywords: ["Count property Failover Cluster", "Count property Failover Cluster , ClusResources collection", "ClusResources collection Failover Cluster , Count property"]
topic_type:
- apiref
api_name:
- ClusResources.Count
