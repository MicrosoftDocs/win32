...
The **QuorumArbitrationTimeMin** property specifies the minimum number of seconds a [node](nodes.md) is allowed to spend arbitrating for the quorum resource in a [*cluster*](https://www.bing.com/search?q=*cluster*).
