...
keywords: ["CLUSCTL_RESOURCE_GET_LOADBAL_PROCESS_LIST control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the load balancing processor list. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
