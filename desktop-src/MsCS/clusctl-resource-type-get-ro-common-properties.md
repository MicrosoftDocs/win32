...
keywords: ["CLUSCTL_RESOURCE_TYPE_GET_RO_COMMON_PROPERTIES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Use default. Whether or not your implementation of [**ResourceTypeControl**](resourcetypecontrol.md) performs processing for CLUSCTL\_RESOURCE\_TYPE\_GET\_RO\_COMMON\_PROPERTIES, return ERROR\_INVALID\_FUNCTION to let the Resource Monitor create the property list. The Resource Monitor will return a version-appropriate list of common resource type properties.
