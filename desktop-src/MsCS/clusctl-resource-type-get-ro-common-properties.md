...
Use default. Whether or not your implementation of [**ResourceTypeControl**](/windows/previous-versions/ResApi/nc-resapi-presource_type_control_routine?branch=master) performs processing for CLUSCTL\_RESOURCE\_TYPE\_GET\_RO\_COMMON\_PROPERTIES, return ERROR\_INVALID\_FUNCTION to let the Resource Monitor create the property list. The Resource Monitor will return a version-appropriate list of common resource type properties.
