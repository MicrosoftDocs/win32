...
Returns the number of objects in the collection (the number of [resources](resources.md) of a particular [type](resource-types.md) in the [*cluster*](https://www.bing.com/search?q=*cluster*)).
