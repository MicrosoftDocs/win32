---
title: CLUSCTL\_GROUP\_GET\_PRIVATE\_PROPERTIES control code
description: Retrieves the read/write private properties for a group.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: aa82f5ca-3f04-47ec-b037-769eddce94d7
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_GROUP_GET_PRIVATE_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_GROUP\_GET\_PRIVATE\_PROPERTIES control code

Retrieves the read/write [private properties](private-properties.md) for a [group](groups.md). Applications use this [control code](about-control-codes.md) as a [**ClusterGroupControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustergroupcontrol?branch=master) parameter.
...
ClusterGroupControl( 
  ...
  CLUSCTL_GROUP_GET_PRIVATE_PROPERTIES,  // this control code
...
On a successful return, points to a [property list](property-lists.md) containing the specified group's read/write group [private properties](private-properties.md).
...
ClusAPI.h defines the 32 bits of CLUSCTL\_GROUP\_GET\_PRIVATE\_PROPERTIES as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
