...
keywords: ["Name Failover Cluster ,for networks", "Name Failover Cluster"]
topic_type:
- apiref
api_name:
- Name
...
[**SetClusterNetworkName**](setclusternetworkname.md)
</dt> </dl>
