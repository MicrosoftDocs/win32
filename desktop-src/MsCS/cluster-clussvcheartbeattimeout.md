...
Used by the cluster network driver to specify the maximum number of seconds allowed before a non-communicating [node](nodes.md) is considered to be offline and unavailable as a resource to the [*cluster*](https://www.bing.com/search?q=*cluster*).
