...
keywords: ["CLUSCTL_RESOURCE_FILESERVER_SHARE_MODIFY control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Modifies an existing file share on a physical disk resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
