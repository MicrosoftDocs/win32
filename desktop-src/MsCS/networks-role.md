...
keywords:
- Role Failover Cluster ,for networks
...
Provides the **Role** of the [network](networks.md) in the [*cluster*](https://www.bing.com/search?q=*cluster*). The following table summarizes the attributes of the **Role** property.
...
The data value for the **Role** property can be set to one of the following values of the [**CLUSTER\_NETWORK\_ROLE**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_network_role) enumeration.
