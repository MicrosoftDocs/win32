---
title: DomainNames.Refresh method
...
keywords: ["Refresh method Failover Cluster", "Refresh method Failover Cluster , DomainNames collection", "DomainNames collection Failover Cluster , Refresh method"]
topic_type:
- apiref
api_name:
- DomainNames.Refresh
...
Refreshes the data in the [**DomainNames**](domainnames-collection.md) collection.
