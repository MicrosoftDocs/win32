...
Returns the name of the file system residing on a [*storage class resource*](https://www.bing.com/search?q=*storage class resource*) partition ("FAT", "NTFS", and so on).
