...
The [Cluster service](cluster-service.md) calls the [**Open**](/previous-versions/windows/desktop/api/ResApi/nc-resapi-popen_routine) entry point function (through a [Resource Monitor](resource-monitor.md)) to create a new instance of a [resource type](resource-types.md). Your [resource DLL](resource-dlls.md) should initialize an actual instance of the physical or logical entity to be supported as the [resource](resources.md) and associate it with a set of instance data. **Open** can also lay groundwork for the [**Online**](/previous-versions/windows/desktop/api/ResApi/nc-resapi-ponline_routine) entry point.
