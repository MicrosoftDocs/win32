---
title: ClusResource.Name property
...
- Name property Failover Cluster , ClusResource class
- ClusResource class Failover Cluster , Name property
topic_type:
- apiref
api_name:
- ClusResource.Name
...
Retrieves or sets the name of a [resource](resources.md).
...
**String** containing the new name for the resource
