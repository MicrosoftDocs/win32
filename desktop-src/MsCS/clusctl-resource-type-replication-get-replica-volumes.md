---
title: CLUSCTL\_RESOURCE\_TYPE\_REPLICATION\_GET\_REPLICA\_VOLUMES control code
description: Gets all volumes that can be used for replication on the source disk and the destination disk.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: F1D2A0CD-EB89-40C3-AFF2-56854067A3A6
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_RESOURCE_TYPE_REPLICATION_GET_REPLICA_VOLUMES control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_RESOURCE\_TYPE\_REPLICATION\_GET\_REPLICA\_VOLUMES control code

Gets all volumes that can be used for replication on the source disk and the destination disk. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceTypeControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusterresourcetypecontrol) function, and [resource DLLs](resource-dlls.md) receive the control code as a parameter to the [**ResourceTypeControl**](/previous-versions/windows/desktop/api/ResApi/nc-resapi-presource_type_control_routine) callback function.
...
ClusterResourceTypeControl( 
  ...
  CLUSCTL_RESOURCE_TYPE_REPLICATION_GET_REPLICA_VOLUMES,  // this control code
...
ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_TYPE\_REPLICATION\_GET\_REPLICA\_VOLUMES (x02002159) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
...
| Operation code | 0 23         | **CLCTL\_REPLICATION\_GET\_REPLICA\_VOLUMES** (x00002159)<br/> |
