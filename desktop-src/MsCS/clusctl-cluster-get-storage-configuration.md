---
title: CLUSCTL\_CLUSTER\_GET\_STORAGE\_CONFIGURATION control code
description: Retrieves the storage configuration for a cluster.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 12972639-7D04-474F-8523-434BC7C50418
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_CLUSTER_GET_STORAGE_CONFIGURATION control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_CLUSTER\_GET\_STORAGE\_CONFIGURATION control code

Retrieves the storage configuration for a cluster. Applications use this [control code](about-control-codes.md) as a [**ClusterControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustercontrol?branch=master) parameter.
...
ClusterControl( 
  ...
  CLUSCTL_CLUSTER_GET_STORAGE_CONFIGURATION,  // this control code
...
On a successful return, points to a [property list](property-lists.md) that contains the specified cluster's storage configuration.
...
ClusAPI.h defines the 32 bits of this control code (0x070002E5) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
...
| Operation code | 0 23         | **CLCTL\_GET\_STORAGE\_CONFIGURATION** (0x2E5) |
