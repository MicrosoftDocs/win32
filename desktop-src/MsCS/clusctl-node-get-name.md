...
keywords:
- CLUSCTL_NODE_GET_NAME control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the name of a [node](nodes.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNodeControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusternodecontrol?branch=master) parameter.
