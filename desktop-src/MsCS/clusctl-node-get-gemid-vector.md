---
title: CLUSCTL\_NODE\_GET\_GEMID\_VECTOR control code
description: TBD.
audience: developer
...
ClusAPI.h defines the 32 bits of CLUSCTL\_NODE\_GET\_GEMID\_VECTOR (0x040002D1) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
