...
Specifies cluster networks that should not be used during a live migration. The networks are specified by the network ID returned by the [**GetClusterNetworkId**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_get_cluster_network_id) function, separated by semicolons. The following table summarizes the attributes of the **MigrationExcludeNetworks** property.
