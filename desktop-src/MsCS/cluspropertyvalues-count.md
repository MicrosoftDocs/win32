---
title: ClusPropertyValues.Count property
description: Number of property values in the ClusPropertyValues collection.
audience: developer
...
keywords: ["Count property Failover Cluster", "Count property Failover Cluster , ClusPropertyValues collection", "ClusPropertyValues collection Failover Cluster , Count property"]
topic_type:
- apiref
api_name:
...
Returns the number of [*property values*](p-gly.md#-wolf-property-value-gly) in the [**ClusPropertyValues**](cluspropertyvalues-collection.md) collection.
