...
keywords:
- CLUSCTL_NETINTERFACE_GET_COMMON_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the read/write [common properties](common-properties.md) for a [network interface](network-interfaces.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNetInterfaceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusternetinterfacecontrol?branch=master) parameter.
