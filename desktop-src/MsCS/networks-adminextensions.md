...
ms.assetid: '3df0d05d-265b-4ff0-ae97-30e5c48ee98c'
ms.prod: 'windows-server-dev'
ms.technology: 'failover-clustering'
ms.tgt_platform: multiple
keywords: ["AdminExtensions Failover Cluster ,for networks", "AdminExtensions Failover Cluster"]
topic_type:
- apiref
api_name:
- AdminExtensions
...
The **AdminExtensions** property provides the class identifiers (CLSIDs) for the [Cluster Administrator](cluster-administrator.md) extensions that are associated with the [network](networks.md). The following table summarizes the attributes of the **AdminExtensions** property.
