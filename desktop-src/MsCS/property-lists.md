...
keywords: ["property lists Failover Cluster", "data Failover Cluster ,property lists", "properties Failover Cluster ,lists"]
---
...
-   A count of the properties in the list, represented by a [**CLUSPROP\_LIST**](clusprop-list.md) structure.
-   One [value list](value-lists.md) for each property.
-   Each property value list, in turn, consists of the following entries:
-   A property name represented by a [**CLUSPROP\_PROPERTY\_NAME**](clusprop-property-name.md) structure.
...
-   A [**CLUSPROP\_SYNTAX**](clusprop-syntax.md) union set to CLUSPROP\_SYNTAX\_ENDMARK.
