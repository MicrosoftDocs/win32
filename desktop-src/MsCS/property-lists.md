...
-   A count of the properties in the list, represented by a [**CLUSPROP\_LIST**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_list) structure.
-   One [value list](value-lists.md) for each property.
-   Each property value list, in turn, consists of the following entries:
-   A property name represented by a [**CLUSPROP\_PROPERTY\_NAME**](/previous-versions/windows/desktop/api/ClusAPI/) structure.
...
-   A [**CLUSPROP\_SYNTAX**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_syntax) union set to CLUSPROP\_SYNTAX\_ENDMARK.
