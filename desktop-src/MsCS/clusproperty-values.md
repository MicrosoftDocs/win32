...
Retrieves a [**ClusPropertyValues**](cluspropertyvalues-collection.md) collection containing all of the [*property values*](https://www.bing.com/search?q=*property values*) associated with a multi-value [cluster object property](cluster-object-properties.md).
