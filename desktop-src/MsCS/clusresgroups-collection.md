...
Provides access to all cluster [groups](groups.md) belonging either to a [*cluster*](https://www.bing.com/search?q=*cluster*) or to a particular [node](nodes.md) in a cluster.
