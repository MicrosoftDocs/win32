...
Specifies the [**role**](networks-role.md) that the [*cluster*](https://www.bing.com/search?q=*cluster*) automatically assigns to any newly discovered or created [network](networks.md). The following table summarizes the attributes of the **DefaultNetworkRole** property.
...
The **DefaultNetworkRole** property can be set to one of the following values of the [**CLUSTER\_NETWORK\_ROLE**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_network_role) enumeration.
