---
title: ClusResGroup.Name property
...
- Name property Failover Cluster , ClusResGroup class
- ClusResGroup class Failover Cluster , Name property
topic_type:
- apiref
api_name:
- ClusResGroup.Name
...
Retrieves or sets the name of a [group](groups.md).
...
**String** containing the new name for the group.
