...
keywords: ["CLUSCTL_GROUP_GET_COMMON_PROPERTY_FMTS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves a [property list](property-lists.md) describing the format of each [group common property](group-common-properties.md). Applications use this control code as a parameter to the [**ClusterGroupControl**](clustergroupcontrol.md) function.
