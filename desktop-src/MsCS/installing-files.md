...
1.  Call the [**GetNodeClusterState**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_get_node_cluster_state) function to determine if setup is running in a clustered environment.
