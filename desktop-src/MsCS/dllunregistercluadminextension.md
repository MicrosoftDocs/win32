...
Cancels the registration of a [Failover Cluster Administrator](cluster-administrator.md) extension DLL for [resources](resources.md) with the [*cluster*](c-gly.md#-wolf-cluster-gly) by removing information from the [cluster database](cluster-database.md).
...
You must implement this function in your extension DLL. Remove the **CLSID** of your extension from the [**AdminExtensions**](groups-adminextensions.md) property of each [*cluster object*](c-gly.md#-wolf-cluster-object-gly) extended by your DLL.
