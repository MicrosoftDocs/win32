...
keywords:
- CLUSCTL_NETWORK_GET_CHARACTERISTICS control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the intrinsic characteristics of a [network](networks.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNetworkControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusternetworkcontrol) parameter.
...
The following control code function parameters are specific to this control code. For complete parameter descriptions, see [**ClusterNetworkControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusternetworkcontrol).
...
On a successful return, contains a DWORD bitmask describing the network's characteristics enumerated from the [**CLUS\_CHARACTERISTICS**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-clus_characteristics) enumeration. Only one bitmask is currently defined.
