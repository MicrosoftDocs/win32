---
title: ClusResTypeResources.Refresh method
...
keywords: ["Refresh method Failover Cluster", "Refresh method Failover Cluster , ClusResTypeResources class", "ClusResTypeResources class Failover Cluster , Refresh method"]
topic_type:
- apiref
api_name:
- ClusResTypeResources.Refresh
api_location:
- MsClus.dll
api_type:
- COM
...
# ClusResTypeResources.Refresh method
...
Refreshes the data in the [**ClusResTypeResources**](clusrestyperesources-collection.md) collection.
