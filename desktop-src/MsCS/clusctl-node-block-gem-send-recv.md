---
title: CLUSCTL\_NODE\_BLOCK\_GEM\_SEND\_RECV control code
description: TBD.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '76DA3FA5-7529-4285-BF74-C92928ECE678'
ms.prod: 'windows-server-dev'
ms.technology: 'failover-clustering'
ms.tgt_platform: multiple
keywords: ["CLUSCTL_NODE_BLOCK_GEM_SEND_RECV control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
# CLUSCTL\_NODE\_BLOCK\_GEM\_SEND\_RECV control code
...
ClusterNodeControl(
  ...
  CLUSCTL_NODE_BLOCK_GEM_SEND_RECV,  // this control code
...
ClusAPI.h defines the 32 bits of CLUSCTL\_NODE\_BLOCK\_GEM\_SEND\_RECV (0x040002CD) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
...
| Operation code | 0–23         | **CLCTL\_BLOCK\_GEM\_SEND\_RECV** (0x2CD)<br/> |
