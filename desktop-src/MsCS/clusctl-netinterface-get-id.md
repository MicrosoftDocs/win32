...
keywords:
- CLUSCTL_NETINTERFACE_GET_ID control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the [cluster database](cluster-database.md) subkey identifier for a [network interface](network-interfaces.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNetInterfaceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusternetinterfacecontrol?branch=master) parameter.
