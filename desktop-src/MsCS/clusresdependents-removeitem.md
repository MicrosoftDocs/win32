...
Removes a [resource](resources.md) from the [**ClusResDependents**](clusresdependents-collection.md) collection but does not delete it from the [*cluster*](https://www.bing.com/search?q=*cluster*).
