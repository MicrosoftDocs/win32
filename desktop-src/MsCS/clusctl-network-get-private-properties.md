...
keywords: ["CLUSCTL_NETWORK_GET_PRIVATE_PROPERTIES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the read/write [private properties](private-properties.md) for a [network](networks.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNetworkControl**](clusternetworkcontrol.md) parameter.
