---
title: ClusPropertyValue.Value property
description: The data value of a property value.
audience: developer
...
- Value property Failover Cluster , ClusPropertyValue object
- ClusPropertyValue object Failover Cluster , Value property
topic_type:
- apiref
api_name:
- ClusPropertyValue.Value
api_location:
- MsClus.dll
api_type:
- COM
...
# ClusPropertyValue.Value property
...
Sets or retrieves the [*data value*](https://www.bing.com/search?q=*data value*) of a [*property value*](https://www.bing.com/search?q=*property value*).
