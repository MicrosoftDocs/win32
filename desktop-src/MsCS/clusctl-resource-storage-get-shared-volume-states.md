...
keywords: ["CLUSCTL_RESOURCE_STORAGE_GET_SHARED_VOLUME_STATES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the status of a Cluster Shared Volume (CSV). Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
