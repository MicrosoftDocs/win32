...
keywords:
- CLUSCTL_CLUSTER_VALIDATE_COMMON_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
Verifies that a [property list](property-lists.md) contains valid cluster property names and values and that the list is properly formatted. Applications use this [control code](about-control-codes.md) as a [**ClusterControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustercontrol?branch=master) parameter.
