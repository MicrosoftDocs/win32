...
keywords: ["CLUSCTL_RESOURCE_GET_NAME control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the name of a [resource](resources.md). Applications use this [control code](about-control-codes.md) as a [**ClusterResourceControl**](clusterresourcecontrol.md) parameter.
