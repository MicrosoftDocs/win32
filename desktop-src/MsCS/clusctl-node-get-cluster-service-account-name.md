...
keywords:
- CLUSCTL_NODE_GET_CLUSTER_SERVICE_ACCOUNT_NAME control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the user account name under which the cluster service is running on a [node](nodes.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNodeControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusternodecontrol?branch=master) parameter.
