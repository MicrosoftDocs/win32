---
title: CLUSCTL\_RESOURCE\_TYPE\_GET\_COMMON\_PROPERTIES control code
description: Retrieves the read/write common properties for a resource type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: '6d628d94-5ab9-4300-9490-cfe9924ad62e'
ms.prod: 'windows-server-dev'
ms.technology: 'failover-clustering'
ms.tgt_platform: multiple
keywords: ["CLUSCTL_RESOURCE_TYPE_GET_COMMON_PROPERTIES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
# CLUSCTL\_RESOURCE\_TYPE\_GET\_COMMON\_PROPERTIES control code

Retrieves the read/write [common properties](common-properties.md) for a [resource type](resource-types.md). Applications use this [control code](about-control-codes.md) as a [**ClusterResourceTypeControl**](clusterresourcetypecontrol.md) parameter, and [resource DLLs](resource-dlls.md) receive the control code as a [**ResourceTypeControl**](resourcetypecontrol.md) parameter.
...
ClusterResourceTypeControl( 
  ...
  CLUSCTL_RESOURCE_TYPE_GET_COMMON_PROPERTIES,       // this control code
...
On a successful return, points to a [property list](property-lists.md) containing the resource type's read/write [common resource type properties](resource-type-common-properties.md).
...
ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_TYPE\_GET\_COMMON\_PROPERTIES as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
