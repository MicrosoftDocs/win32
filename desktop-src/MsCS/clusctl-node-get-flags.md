...
keywords: ["CLUSCTL_NODE_GET_FLAGS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the flags that are set for a [node](nodes.md). Applications use this [control code](about-control-codes.md) as a [**ClusterNodeControl**](clusternodecontrol.md) parameter.
