...
keywords: ["CLUSCTL_GROUP_GET_PRIVATE_PROPERTY_FMTS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
[**ClusterGroupControl**](clustergroupcontrol.md) returns **ERROR\_INVALID\_FUNCTION**.
