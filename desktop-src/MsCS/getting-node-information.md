...
|--------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Cluster that contains the node             | [**GetClusterFromNode**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_get_cluster_from_node)                                                                                                                                                                                                                                                                                                          |
...
| Network interfaces in the node             | [**ClusterNodeOpenEnum**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_cluster_node_open_enum), [**ClusterNodeEnum**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_cluster_node_enum), [**ClusterNodeCloseEnum**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_cluster_node_close_enum)                                                                                                                                                                                                      |
...
| State of the Cluster service on the node   | [**GetNodeClusterState**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_get_node_cluster_state)                                                                                                                                                                                                                                                                                                        |
| State of the node                          | [**GetClusterNodeState**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_get_cluster_node_state)                                                                                                                                                                                                                                                                                                        |
| Version of the Cluster service on the node | [**GetClusterInformation**](/previous-versions/windows/desktop/api/ClusAPI/nc-clusapi-pclusapi_get_cluster_information)                                                                                                                                                                                                                                                                                                    |
