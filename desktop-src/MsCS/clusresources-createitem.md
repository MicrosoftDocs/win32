...
Value indicating how to create the resource. *lFlag* can be set to one of these values enumerated from the [**CLUSTER\_RESOURCE\_CREATE\_FLAGS**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_resource_create_flags) enumeration.
