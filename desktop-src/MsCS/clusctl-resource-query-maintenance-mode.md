...
Queries the [*maintenance mode*](https://www.bing.com/search?q=*maintenance mode*) state of the specified disk resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusterresourcecontrol) function.
...
On a successful return, points to a [**CLUS\_MAINTENANCE\_MODE\_INFO**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clus_maintenance_mode_info) structure containing the current maintenance mode state of the disk resource.
