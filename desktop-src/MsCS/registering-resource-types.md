...
4.  Perform COM registration for the extension DLL by calling [**DLLRegisterServer**](/windows/previous-versions/WtClusRes/?branch=master) from each cluster node and on each remote system with a copy of the extension.
