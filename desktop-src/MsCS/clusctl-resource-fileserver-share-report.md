...
Retrieves the add/delete/change notifications for file shares managed by the File Server [resource](resources.md). Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusterresourcecontrol) function.
...
The structure for the notification list comes from the [**FILESHARE\_CHANGE\_LIST**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-_fileshare_change_list) structure.
