...
Contains the last time, in 100 nanosecond units, recorded by the [*DNS*](https://www.bing.com/search?q=*DNS*) that is associated with the [message queuing](message-queuing.md) resource. The following table summarizes the attributes of the **LastDNSUpdateTime** property.
