---
title: ClusterNames.Refresh method
description: Refreshes the data in the ClusterNames collection.
audience: developer
...
- Refresh method Failover Cluster , ClusterNames collection
- ClusterNames collection Failover Cluster , Refresh method
topic_type:
- apiref
api_name:
- ClusterNames.Refresh
api_location:
- MsClus.dll
api_type:
- COM
...
Refreshes the data in the [**ClusterNames**](clusternames-collection.md) collection.
