...
Registers a [Failover Cluster Administrator](cluster-administrator.md) extension DLL for [resources](resources.md) with the [*cluster*](c-gly.md#-wolf-cluster-gly) by adding information to the [cluster database](cluster-database.md).
