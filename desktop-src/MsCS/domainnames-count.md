---
title: DomainNames.Count property
...
keywords: ["Count property Failover Cluster", "Count property Failover Cluster , DomainNames collection", "DomainNames collection Failover Cluster , Count property"]
topic_type:
- apiref
api_name:
- DomainNames.Count
...
Returns the number of objects in the [**DomainNames**](domainnames-collection.md) collection.
