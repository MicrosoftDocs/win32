...
Reads the [cluster database](cluster-database.md) and updates the data in the [**ClusProperties**](clusproperties-collection.md) collection to reflect the current [*cluster*](c-gly.md#-wolf-cluster-gly) data.
