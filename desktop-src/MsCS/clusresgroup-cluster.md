...
- Cluster property Failover Cluster , ClusResGroup class
- ClusResGroup class Failover Cluster , Cluster property
topic_type:
- apiref
api_name:
...
Returns the [*cluster*](https://www.bing.com/search?q=*cluster*) associated with the [group](groups.md).
...
A [**Cluster**](cluster-object.md) object that receives the group's [*cluster*](https://www.bing.com/search?q=*cluster*).
