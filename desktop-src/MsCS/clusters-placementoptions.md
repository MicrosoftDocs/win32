...
This property can contain a bitwise combination of the following [**PLACEMENT\_OPTIONS**](/previous-versions/windows/desktop/api/clusapi/ne-clusapi-placement_options) values.
