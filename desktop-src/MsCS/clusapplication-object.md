...
The **ClusApplication** object provides access to the [**DomainNames**](domainnames-collection.md) and [**ClusterNames**](clusternames-collection.md) collections and opens a connection to a specified [*cluster*](https://www.bing.com/search?q=*cluster*).
