...
|----------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Cluster**](clusnode-cluster.md) Property                         | Returns a [**Cluster**](cluster-object.md) object providing access to the [*cluster*](https://www.bing.com/search?q=*cluster*) associated with the node.                                      |
