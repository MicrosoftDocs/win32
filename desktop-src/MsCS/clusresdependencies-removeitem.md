...
- RemoveItem method Failover Cluster , ClusResDependencies class
- ClusResDependencies class Failover Cluster , RemoveItem method
topic_type:
- apiref
api_name:
...
Removes a [resource](resources.md) from the [*dependency*](https://www.bing.com/search?q=*dependency*) collection but does not delete it from the [*cluster*](https://www.bing.com/search?q=*cluster*).
