...
keywords: ["CLUSCTL_RESOURCE_TYPE_GET_COMMON_PROPERTY_FMTS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Reserved for future use. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceTypeControl**](clusterresourcetypecontrol.md) function.
...
[**ClusterResourceTypeControl**](clusterresourcetypecontrol.md) returns the following value.
