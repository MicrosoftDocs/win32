...
keywords:
- CLUSCTL_RESOURCE_STORAGE_GET_DISKID control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the disk ID for a storage class resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) function.
