...
Returns a [**ClusResTypes**](clusrestypes-collection.md) collection providing access to the [resource types](resource-types.md) in a [*cluster*](c-gly.md#-wolf-cluster-gly).
