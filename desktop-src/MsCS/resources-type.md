...
keywords: ["Type Failover Cluster ,for resources", "Type Failover Cluster"]
topic_type:
- apiref
api_name:
- Type
...
To access the type name of a resource type, call [**ClusterResourceControl**](clusterresourcecontrol.md) and pass [CLUSCTL\_RESOURCE\_GET\_RESOURCE\_TYPE](clusctl-resource-get-resource-type.md) for the *dwControlCode* parameter.
