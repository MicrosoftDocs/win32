...
To read data from a [value](value-lists.md) or [property list](property-lists.md) with [**CLUSPROP\_BUFFER\_HELPER**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_buffer_helper), use the following procedure.

**To read data from a value or property list**

1.  Obtain a buffer containing data.
2.  Set the **pb** member of [**CLUSPROP\_BUFFER\_HELPER**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_buffer_helper) to the start of the buffer.
3.  Use one of [**CLUSPROP\_BUFFER\_HELPER**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_buffer_helper)'s member pointers to read the **Syntax** member of the next data structure.
...
6.  Verify that there is room in the buffer to advance [**CLUSPROP\_BUFFER\_HELPER**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_buffer_helper) to the next read position.
