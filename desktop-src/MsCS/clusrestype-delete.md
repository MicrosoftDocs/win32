...
- Delete method Failover Cluster , ClusResType object
- ClusResType object Failover Cluster , Delete method
topic_type:
- apiref
api_name:
- ClusResType.Delete
...
Deletes the [resource type](resource-types.md) from the [*cluster*](https://www.bing.com/search?q=*cluster*) and unregisters the type with the [*Cluster service*](https://www.bing.com/search?q=*Cluster service*).
