...
Returns the number of objects in the collection (the number of [*possible owner*](https://www.bing.com/search?q=*possible owner*) [nodes](nodes.md) listed for a [resource type](resource-types.md)).
