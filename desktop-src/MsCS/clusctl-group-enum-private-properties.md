---
title: CLUSCTL\_GROUP\_ENUM\_PRIVATE\_PROPERTIES control code
description: Retrieves a list of the private property names for a group.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 78a77a38-d301-452b-a11a-cf42eaf46532
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_GROUP_ENUM_PRIVATE_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_GROUP\_ENUM\_PRIVATE\_PROPERTIES control code

Retrieves a list of the private property names for a [group](groups.md). Applications use this [control code](about-control-codes.md) as a [**ClusterGroupControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustergroupcontrol?branch=master) parameter.
...
ClusterGroupControl( 
  ...
  CLUSCTL_GROUP_ENUM_PRIVATE_PROPERTIES,  // this control code
...
On a successful return, *lpOutBuffer* contains an array of null-terminated Unicode strings with an additional **NULL** terminator appended to the last string. Each string in the array contains the name of a read/write group private property.
...
ClusAPI.h defines the 32 bits of CLUSCTL\_GROUP\_ENUM\_PRIVATE\_PROPERTIES as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
