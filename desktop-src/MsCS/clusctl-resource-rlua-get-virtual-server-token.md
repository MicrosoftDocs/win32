---
title: CLUSCTL\_RESOURCE\_RLUA\_GET\_VIRTUAL\_SERVER\_TOKEN control code
description: TBD.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 'EA5B5EDF-AC14-4CB8-A96F-1ADD4E37E377'
ms.prod: 'windows-server-dev'
ms.technology: 'failover-clustering'
ms.tgt_platform: multiple
keywords: ["CLUSCTL_RESOURCE_RLUA_GET_VIRTUAL_SERVER_TOKEN control code Failover Cluster"]
---

# CLUSCTL\_RESOURCE\_RLUA\_GET\_VIRTUAL\_SERVER\_TOKEN control code
...
ClusterResourceControl( 
  ...
  CLUSCTL_RESOURCE_RLUA_GET_VIRTUAL_SERVER_TOKEN,   // this control code
...
ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_RLUA\_GET\_VIRTUAL\_SERVER\_TOKEN (0x0100016D) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
