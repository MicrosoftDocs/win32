...
keywords: ["CLUSCTL_RESOURCE_GET_NETWORK_NAME control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
The following parameters are specific to this control code. For complete parameter descriptions, see [**ClusterResourceControl**](clusterresourcecontrol.md) or [**ResourceControl**](resourcecontrol.md).
