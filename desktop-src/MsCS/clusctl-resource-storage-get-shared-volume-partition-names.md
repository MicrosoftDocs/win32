---
title: CLUSCTL\_RESOURCE\_STORAGE\_GET\_SHARED\_VOLUME\_PARTITION\_NAMES control code
description: Retrieves partition names for a Cluster Shared Volume (CSV).
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 30F89E63-AC02-4A35-A940-59BEDDA65495
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_RESOURCE_STORAGE_GET_SHARED_VOLUME_PARTITION_NAMES control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_RESOURCE\_STORAGE\_GET\_SHARED\_VOLUME\_PARTITION\_NAMES control code

Retrieves partition names for a Cluster Shared Volume (CSV). Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) function.
...
ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_STORAGE\_GET\_SHARED\_VOLUME\_PARTITION\_NAMES (0x0100029D) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
...
| Operation code | 0 23         | **CLCTL\_STORAGE\_GET\_SHARED\_VOLUME\_PARTITION\_NAMES** (0X29D)<br/> |
