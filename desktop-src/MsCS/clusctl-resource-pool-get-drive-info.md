...
keywords: ["CLUSCTL_RESOURCE_POOL_GET_DRIVE_INFO control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves drive information for a storage pool. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
