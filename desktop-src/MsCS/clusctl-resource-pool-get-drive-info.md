---
title: CLUSCTL\_RESOURCE\_POOL\_GET\_DRIVE\_INFO control code
description: Retrieves drive information for a storage pool.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: A01CBB29-23E3-4E5C-A87A-0FE39B88342A
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_RESOURCE_POOL_GET_DRIVE_INFO control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_RESOURCE\_POOL\_GET\_DRIVE\_INFO control code

Retrieves drive information for a storage pool. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) function.
...
ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_POOL\_GET\_DRIVE\_INFO (0x010002B5) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
...
| Operation code | 0 23         | **CLCTL\_POOL\_GET\_DRIVE\_INFO** (0x2B5)<br/> |
