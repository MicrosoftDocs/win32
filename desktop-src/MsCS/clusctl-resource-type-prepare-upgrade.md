...
keywords: ["CLUSCTL_RESOURCE_TYPE_PREPARE_UPGRADE control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Optional. For information about the [**ResourceTypeControl**](resourcetypecontrol.md) entry point, see [Implementing ResourceTypeControl](implementing-resourcetypecontrol.md).
