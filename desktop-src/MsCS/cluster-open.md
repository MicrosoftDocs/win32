...
keywords:
- Open method Failover Cluster
- Open method Failover Cluster , Cluster object
- Cluster object Failover Cluster , Open method
topic_type:
- apiref
api_name:
- Cluster.Open
...
Opens a connection to a [*cluster*](https://www.bing.com/search?q=*cluster*).
