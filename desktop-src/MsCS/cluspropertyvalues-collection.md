...
Contains all of the [*property values*](https://www.bing.com/search?q=*property values*) associated with a multi-value property, with each value represented by a [**ClusPropertyValue**](cluspropertyvalue-object.md) object.
