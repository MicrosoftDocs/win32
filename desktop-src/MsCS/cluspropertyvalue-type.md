...
keywords: ["Type property Failover Cluster", "Type property Failover Cluster , ClusPropertyValue object", "ClusPropertyValue object Failover Cluster , Type property"]
---
...
**Long** describing the type of the property value. MsClus.h defines the following types, enumerated in the [**CLUSTER\_PROPERTY\_TYPE**](cluster-property-type.md) enumeration.
...
Describes resource class information. A resource class value is described with a [**CLUSPROP\_RESOURCE\_CLASS**](clusprop-resource-class.md) structure.

Resource classes are returned when an application calls [**ClusterResourceControl**](clusterresourcecontrol.md) or [**ClusterResourceTypeControl**](clusterresourcetypecontrol.md) with one of the following control codes.
