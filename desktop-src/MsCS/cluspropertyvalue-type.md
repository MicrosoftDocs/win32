...
Returns or sets the type of a [*property value*](p-gly.md#-wolf-property-value-gly).
...
**Long** describing the type of the property value. MsClus.h defines the following types, enumerated in the [**CLUSTER\_PROPERTY\_TYPE**](/windows/previous-versions/ClusAPI/ne-clusapi-cluster_property_type?branch=master) enumeration.
...
Describes resource class information. A resource class value is described with a [**CLUSPROP\_RESOURCE\_CLASS**](/windows/previous-versions/ClusAPI/ns-clusapi-clusprop_resource_class?branch=master) structure.

Resource classes are returned when an application calls [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) or [**ClusterResourceTypeControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcetypecontrol?branch=master) with one of the following control codes.
