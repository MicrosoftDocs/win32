...
Retrieves the name of the [network](networks.md) to which a [network interface](network-interfaces.md) is connected. Applications use this [control code](about-control-codes.md) as a [**ClusterNetInterfaceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusternetinterfacecontrol?branch=master) parameter.
