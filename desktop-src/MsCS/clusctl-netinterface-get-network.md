...
keywords: ["CLUSCTL_NETINTERFACE_GET_NETWORK control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Retrieves the name of the [network](networks.md) to which a [network interface](network-interfaces.md) is connected. Applications use this [control code](about-control-codes.md) as a [**ClusterNetInterfaceControl**](clusternetinterfacecontrol.md) parameter.
