...
Returns a value containing the lowest version of the [*Cluster service*](c-gly.md#-wolf-cluster-service-gly) with which the current [*cluster*](c-gly.md#-wolf-cluster-gly) is compatible.
