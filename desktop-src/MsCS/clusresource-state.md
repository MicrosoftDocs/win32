...
**Long** that receives a constant describing the state of the resource. The values are enumerated from the [**CLUSTER\_RESOURCE\_STATE**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_resource_state) enumeration.
...
The resource has [*failed*](https://www.bing.com/search?q=*failed*).
...
The resource is in the process of coming [*online*](https://www.bing.com/search?q=*online*) or going [*offline*](https://www.bing.com/search?q=*offline*).
