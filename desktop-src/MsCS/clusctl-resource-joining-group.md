...
keywords: ["CLUSCTL_RESOURCE_JOINING_GROUP control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Tells a resource when it is joining a group. Resource DLLs receive this [control code](about-control-codes.md) as a [**ResourceControl**](resourcecontrol.md) parameter. Because the control code is internal, applications cannot use it in a control code function.
