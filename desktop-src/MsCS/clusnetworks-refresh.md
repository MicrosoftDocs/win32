---
title: ClusNetworks.Refresh method
description: Refreshes the data in the ClusNetworks collection.
audience: developer
...
- Refresh method Failover Cluster , ClusNetworks collection
- ClusNetworks collection Failover Cluster , Refresh method
topic_type:
- apiref
api_name:
- ClusNetworks.Refresh
api_location:
- MsClus.dll
api_type:
- COM
...
Refreshes the data in the [**ClusNetworks**](clusnetworks-collection.md) collection.
