...
- RemoveItem method Failover Cluster , ClusPropertyValueData collection
- ClusPropertyValueData collection Failover Cluster , RemoveItem method
topic_type:
- apiref
api_name:
...
Deletes a [*data value*](https://www.bing.com/search?q=*data value*) from a [**ClusPropertyValueData**](cluspropertyvaluedata-collection.md) collection.
