...
- ClusResPossibleOwnerNodes collection Failover Cluster , described
topic_type:
- apiref
api_name:
...
Provides access to a resource's list of [*possible owner*](https://www.bing.com/search?q=*possible owner*) [nodes](nodes.md).
