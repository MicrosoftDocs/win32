...
Provides the **AutoMetric** of the [network](networks.md) in the [*cluster*](c-gly.md#-wolf-cluster-gly). The following table summarizes the attributes of the **AutoMetric** property.
