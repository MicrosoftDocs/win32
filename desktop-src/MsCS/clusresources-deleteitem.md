...
keywords: ["DeleteItem method Failover Cluster", "DeleteItem method Failover Cluster , ClusResources collection", "ClusResources collection Failover Cluster , DeleteItem method"]
topic_type:
- apiref
api_name:
...
Deletes a [resource](resources.md) from the [*cluster*](c-gly.md#-wolf-cluster-gly) and removes it from a [**ClusResources**](clusresources-collection.md) collection.
