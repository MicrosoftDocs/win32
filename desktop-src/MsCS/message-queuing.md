...
Supports [Message Queuing (MSMQ)](_mq_message_queuing_msmq_start_page). Only one MSMQ [resource](resources.md) can be in a resource group at one time. The following table summarizes the dependencies and private properties of an MSMQ resource.
