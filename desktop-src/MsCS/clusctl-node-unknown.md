...
For complete parameter descriptions, see [**ClusterNodeControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusternodecontrol). This control code has no parameters associated with it.

<dl></dl>

## Return value

When an application uses CLUSCTL\_NODE\_UNKNOWN as a parameter for [**ClusterNodeControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusternodecontrol), **ClusterNodeControl** always returns **ERROR\_SUCCESS**.
