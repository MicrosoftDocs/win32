...
keywords: ["CLUSCTL_NODE_GET_COMMON_PROPERTIES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
The following control code function parameters are specific to this control code. For complete parameter descriptions, see [**ClusterNodeControl**](clusternodecontrol.md).
