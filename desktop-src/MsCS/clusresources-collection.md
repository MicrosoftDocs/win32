...
keywords: ["ClusResources collection Failover Cluster", "ClusResources collection Failover Cluster , described"]
topic_type:
- apiref
api_name:
- ClusResources
...
Provides access to the [resources](resources.md) that belong to a [*cluster*](c-gly.md#-wolf-cluster-gly).
