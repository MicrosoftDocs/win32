...
Verifies that a [*storage class resource*](s-gly.md#-wolf-storage-class-resource-gly) is a Cluster Shared Volume (CSV). Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) function.
