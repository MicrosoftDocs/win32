...
keywords: ["CLUSCTL_RESOURCE_STORAGE_IS_SHARED_VOLUME control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Verifies that a [*storage class resource*](s-gly.md#-wolf-storage-class-resource-gly) is a Cluster Shared Volume (CSV). Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
