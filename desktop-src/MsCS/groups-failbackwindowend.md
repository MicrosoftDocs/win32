...
keywords: ["FailbackWindowEnd Failover Cluster ,for groups", "FailbackWindowEnd Failover Cluster"]
topic_type:
- apiref
api_name:
- FailbackWindowEnd
...
Provides the latest time that the [group](groups.md) can be [failed back](failback.md) to the [node](nodes.md) identified as its [*preferred owner*](p-gly.md#-wolf-preferred-owner-gly) node. The following table summarizes the attributes of the **FailbackWindowEnd** property.
