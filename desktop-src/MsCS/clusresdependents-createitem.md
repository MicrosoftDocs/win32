...
Creates a [resource](resources.md) in the [*cluster*](https://www.bing.com/search?q=*cluster*) and adds it to the [**ClusResDependents**](clusresdependents-collection.md) collection.
