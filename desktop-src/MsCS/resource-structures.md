...
Stores a [*cluster*](https://www.bing.com/search?q=*cluster*) handle.
...
Stores the Resource Monitor's handle to the instance, which is used to identify the instance in the [**LogEvent**](/previous-versions/windows/desktop/api/ResApi/nc-resapi-plog_event_routine) and [**SetResourceStatus**](/previous-versions/windows/desktop/api/ResApi/nc-resapi-pset_resource_status_routine) callback functions.
...
A [**CLUS\_WORKER**](/previous-versions/windows/desktop/api/ResApi/ns-resapi-clus_worker) thread used to handle pending operations.
...
Stores the state of the resource. The value of this member is taken from the [**CLUSTER\_RESOURCE\_STATE**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_resource_state) enumeration. The possible values are as follows.
...
| ClusterResourceFailed<br/>         | The resource has [*failed*](https://www.bing.com/search?q=*failed*).<br/>                                                                         |
| ClusterResourcePending<br/>        | The resource is in the process of coming online or going [*offline*](https://www.bing.com/search?q=*offline*).<br/>                               |
