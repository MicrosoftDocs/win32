...
Defines the operation that is performed on the Virtual Machine (VM) for an [*Offline*](/previous-versions/windows/desktop/api/ResApi/nc-resapi-poffline_routine) call on the VM resource instance. The following table summarizes the attributes of the **OfflineAction** property.
