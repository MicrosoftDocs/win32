...
Resource is a storage device, such as a [*Physical Disk resource*](p-gly.md#-wolf-physical-disk-resource-gly).
...
Resource is a [*network*](n-gly.md#-wolf-network-gly) device.
