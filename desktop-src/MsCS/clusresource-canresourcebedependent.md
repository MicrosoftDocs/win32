...
- CanResourceBeDependent method Failover Cluster , ClusResource class
- ClusResource class Failover Cluster , CanResourceBeDependent method
topic_type:
- apiref
api_name:
...
Determines if the [resource](resources.md) can be [*dependent*](https://www.bing.com/search?q=*dependent*) on another resource.
