...
A cluster's [WINS Service](wins-service.md) resource has two [private properties](private-properties.md).



| Property                                              | Status   |
|-------------------------------------------------------|----------|
| [**BackupPath**](the-wins-service-backuppath.md)     | Optional |
| [**DatabasePath**](the-wins-service-databasepath.md) | Optional |
