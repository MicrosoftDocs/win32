...
keywords:
- CLUSCTL_CLUSTER_GET_FQDN control code Failover Cluster
topic_type:
- apiref
api_name:
...
Retrieves the fully qualified domain name (FQDN) of a [*cluster*](https://www.bing.com/search?q=*cluster*). Applications use this [control code](about-control-codes.md) as a [**ClusterControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clustercontrol) parameter.
