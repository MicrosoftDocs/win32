...
Instructs the server to inform every active node in the cluster to stop participating in the cluster. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clustercontrol) function.
