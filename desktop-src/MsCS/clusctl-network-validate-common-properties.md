...
keywords:
- CLUSCTL_NETWORK_VALIDATE_COMMON_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
Verifies that a [property list](property-lists.md) contains valid [network](networks.md) property names and values and that the list is properly formatted. Applications use this [control code](about-control-codes.md) as a [**ClusterNetworkControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusternetworkcontrol) parameter.
