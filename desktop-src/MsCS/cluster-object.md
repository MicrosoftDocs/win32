...
Enables operations on the [*cluster*](https://www.bing.com/search?q=*cluster*) and provides access to all of the objects in the cluster.
...
| [**Version**](cluster-version.md)<br/>                         | Returns a [**ClusVersion**](clusversion-object.md) object describing the [*cluster version*](https://www.bing.com/search?q=*cluster version*).<br/>                               |
