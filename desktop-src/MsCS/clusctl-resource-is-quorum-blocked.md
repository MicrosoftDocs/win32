...
keywords: ["CLUSCTL_RESOURCE_IS_QUORUM_BLOCKED control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Prevents a resource from being designated as the quorum resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function.
