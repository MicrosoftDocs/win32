---
title: CLUSCTL\_RESOURCE\_IS\_QUORUM\_BLOCKED control code
description: Prevents a resource from being designated as the quorum resource.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 9D2407E6-6909-4BB6-B8F8-6631F528165C
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_RESOURCE_IS_QUORUM_BLOCKED control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_RESOURCE\_IS\_QUORUM\_BLOCKED control code

Prevents a resource from being designated as the quorum resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusterresourcecontrol?branch=master) function.
...
ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_IS\_QUORUM\_BLOCKED (0x010002B1) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
...
| Operation code | 0 23         | **CLCTL\_IS\_QUORUM\_BLOCKED** (0x2B1)<br/> |
