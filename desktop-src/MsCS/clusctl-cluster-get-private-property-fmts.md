...
keywords:
- CLUSCTL_CLUSTER_GET_PRIVATE_PROPERTY_FMTS control code Failover Cluster
topic_type:
- apiref
api_name:
...
[**ClusterControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustercontrol?branch=master) returns **ERROR\_INVALID\_FUNCTION**.
