...
- CommonROProperties property Failover Cluster , Cluster object
- Cluster object Failover Cluster , CommonROProperties property
topic_type:
- apiref
api_name:
...
Returns the read-only [common properties](common-properties.md) of a [*cluster*](https://www.bing.com/search?q=*cluster*).
