...
Modifies the drive letter associated with the designated storage-class resource. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clusterresourcecontrol) function.
...
Pointer to a [**CLUS\_STORAGE\_SET\_DRIVELETTER**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-_clus_storage_set_driveletter) structure specifying the drive letter.
