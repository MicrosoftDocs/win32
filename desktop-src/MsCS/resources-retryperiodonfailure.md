...
The Cluster Service attempts to restart the resource by calling its resource DLL's [**Online**](/previous-versions/windows/desktop/api/ResApi/nc-resapi-ponline_routine) entry point function.
