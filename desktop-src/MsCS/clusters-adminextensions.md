...
keywords: ["AdminExtensions Failover Cluster , for clusters", "AdminExtensions Failover Cluster"]
topic_type:
- apiref
api_name:
- AdminExtensions
...
The **AdminExtensions** property provides the class identifiers (CLSIDs) for the [Cluster Administrator](cluster-administrator.md) extensions that are associated with the [*cluster*](c-gly.md#-wolf-cluster-gly). The following table summarizes the attributes of the **AdminExtensions** property.
