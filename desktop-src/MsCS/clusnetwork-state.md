...
**Long**that receives a constant representing the network's current state enumerated by the [**CLUSTER\_NETWORK\_STATE**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_network_state) enumeration.
