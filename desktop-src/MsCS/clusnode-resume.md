...
Resumes the [*cluster*](https://www.bing.com/search?q=*cluster*) activity of a [node](nodes.md) after it has been [*paused*](https://www.bing.com/search?q=*paused*) by the [**ClusNode.Pause**](clusnode-pause.md) method.
