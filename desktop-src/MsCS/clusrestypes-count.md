---
title: ClusResTypes.Count property
...
- Count property Failover Cluster , ClusResTypes collection
- ClusResTypes collection Failover Cluster , Count property
topic_type:
- apiref
api_name:
- ClusResTypes.Count
...
Returns the number of objects in the [**ClusResTypes**](clusrestypes-collection.md) collection.
