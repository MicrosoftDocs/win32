...
ms.assetid: '1A338CE2-B370-4946-82B2-1901FE7EACB5'
ms.prod: 'windows-server-dev'
ms.technology: 'failover-clustering'
ms.tgt_platform: multiple
keywords: ["StatusKerberos Failover Cluster , for virtual machine replication brokers", "StatusKerberos Failover Cluster"]
topic_type:
- apiref
api_name:
- StatusKerberos
