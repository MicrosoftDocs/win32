...
keywords: ["CLUSCTL_RESOURCE_VALIDATE_COMMON_PROPERTIES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Verifies that a [property list](property-lists.md) contains valid [resource](resources.md) [common property](common-properties.md) names and values and that the list is properly formatted. Applications use this [control code](about-control-codes.md) as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function, and resource DLLs receive the control code as a parameter to the [**ResourceControl**](resourcecontrol.md) callback function.
