...
keywords: ["CLUSCTL_CLUSTER_SET_PRIVATE_PROPERTIES control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Updates the read/write [private properties](private-properties.md) for a cluster. Applications use this [control code](about-control-codes.md) as a [**ClusterControl**](clustercontrol.md) parameter.
