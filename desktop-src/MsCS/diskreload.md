...
If this property has a nonzero value, during the [*online*](https://www.bing.com/search?q=*online*) operation, the [*Physical Disk resource*](https://www.bing.com/search?q=*Physical Disk resource*) will reload the volume level information from the disk (for example, driveletters, volume guids), instead of applying the volume information from the [**DiskVolumeInfo**](diskvolumeinfo.md) property. The following table summarizes the attributes of the **DiskReload** property.
