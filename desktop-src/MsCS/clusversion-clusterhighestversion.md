...
Returns a value containing the highest version of the [*Cluster service*](https://www.bing.com/search?q=*Cluster service*) with which the current [*cluster*](https://www.bing.com/search?q=*cluster*) is compatible.
