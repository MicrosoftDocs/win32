...
keywords: ["Count property Failover Cluster", "Count property Failover Cluster , ClusterNames collection", "ClusterNames collection Failover Cluster , Count property"]
topic_type:
- apiref
api_name:
- ClusterNames.Count
