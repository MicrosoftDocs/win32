...
\[Support for the Failover Cluster Administrator extension functions and interfaces was removed in Windows Server 2008, except [**IWEExtendPropertySheet**](/previous-versions/windows/desktop/api/cluadmex/nn-cluadmex-iweextendpropertysheet) and [**IWCPropertySheetCallback**](/previous-versions/windows/desktop/api/cluadmex/nn-cluadmex-iwcpropertysheetcallback).\]
