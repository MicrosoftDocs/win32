...
- ScsiAddress property Failover Cluster , ClusDisk object
- ClusDisk object Failover Cluster , ScsiAddress property
topic_type:
- apiref
api_name:
...
Returns a [**ClusScsiAddress**](clusscsiaddress-object.md) object describing [*SCSI*](https://www.bing.com/search?q=*SCSI*) information about a [Physical Disk](physical-disk.md).
