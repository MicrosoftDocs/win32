...
keywords:
- CLUSCTL_NETINTERFACE_GET_PRIVATE_PROPERTY_FMTS control code Failover Cluster
topic_type:
- apiref
api_name:
...
[**ClusterNetInterfaceControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clusternetinterfacecontrol?branch=master) returns returns **ERROR\_INVALID\_FUNCTION**.
