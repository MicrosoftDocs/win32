...
Creates a [resource](resources.md) in the [*cluster*](c-gly.md#-wolf-cluster-gly) and adds it to the [**ClusResTypeResources**](clusrestyperesources-collection.md) collection.
