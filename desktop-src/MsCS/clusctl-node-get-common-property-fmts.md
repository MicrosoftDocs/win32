...
keywords: ["CLUSCTL_NODE_GET_COMMON_PROPERTY_FMTS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Reserved for future use. Applications use this control code as a parameter to the [**ClusterNodeControl**](clusternodecontrol.md) function.
...
[**ClusterNodeControl**](clusternodecontrol.md) returns the following value.
