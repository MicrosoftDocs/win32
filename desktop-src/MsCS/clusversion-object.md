...
Provides version information about the operating system and the [*Cluster service*](https://www.bing.com/search?q=*Cluster service*). For more information on [*cluster versions*](https://www.bing.com/search?q=*cluster versions*) and [*version numbers*](https://www.bing.com/search?q=*version numbers*), see [Version Compatibility](version-compatibility.md).
...
| [**Flags**](clusversion-flags.md)<br/>                                 | Returns any cluster version flags set in the [*cluster*](https://www.bing.com/search?q=*cluster*).<br/>                    |
