...
keywords: ["Item property Failover Cluster", "Item property Failover Cluster , ClusPartitions collection", "ClusPartitions collection Failover Cluster , Item property"]
topic_type:
- apiref
api_name:
- ClusPartitions.Item
