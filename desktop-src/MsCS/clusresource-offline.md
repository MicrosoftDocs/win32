...
- Offline method Failover Cluster , ClusResource class
- ClusResource class Failover Cluster , Offline method
topic_type:
- apiref
api_name:
...
Takes the [resource](resources.md) [*offline*](https://www.bing.com/search?q=*offline*).
