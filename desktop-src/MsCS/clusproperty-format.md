---
title: ClusProperty.Format property
...
Returns or sets the format (data type) of a [cluster object property](cluster-object-properties.md).
...
**Long** describing the format of the cluster object property. MsClus.h defines the following formats, enumerated in the [**CLUSTER\_PROPERTY\_FORMAT**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_property_format) enumeration.
