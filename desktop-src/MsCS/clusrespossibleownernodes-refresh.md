---
title: ClusResPossibleOwnerNodes.Refresh method
...
keywords: ["Refresh method Failover Cluster", "Refresh method Failover Cluster , ClusResPossibleOwnerNodes class", "ClusResPossibleOwnerNodes class Failover Cluster , Refresh method"]
topic_type:
- apiref
api_name:
- ClusResPossibleOwnerNodes.Refresh
api_location:
- MsClus.dll
api_type:
- COM
...
# ClusResPossibleOwnerNodes.Refresh method
...
Refreshes the data in the [**ClusResPossibleOwnerNodes**](clusrespossibleownernodes-collection.md) collection.
