---
title: ClusResGroups.Refresh method
...
- Refresh method Failover Cluster , ClusResGroups collection
- ClusResGroups collection Failover Cluster , Refresh method
topic_type:
- apiref
api_name:
...
Refreshes the data in the [**ClusResGroups**](clusresgroups-collection.md) collection.
