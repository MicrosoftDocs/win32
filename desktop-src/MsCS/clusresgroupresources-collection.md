...
| [**DeleteItem**](clusresgroupresources-deleteitem.md) | Removes a resource from the group and deletes it from the [*cluster*](https://www.bing.com/search?q=*cluster*).<br/> |
