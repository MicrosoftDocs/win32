...
keywords: ["CLUSCTL_GROUP_UNKNOWN control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
This [control code](about-control-codes.md) verifies that control codes are being processed on the node where execution of the control is directed. Applications use this control code as a [**ClusterGroupControl**](clustergroupcontrol.md) parameter.
...
For complete parameter descriptions, see [**ClusterGroupControl**](clustergroupcontrol.md). This control code has no parameters associated with it.

<dl></dl>

## Return value

When an application uses CLUSCTL\_GROUP\_UNKNOWN as a parameter for [**ClusterGroupControl**](clustergroupcontrol.md), **ClusterGroupControl** always returns **ERROR\_SUCCESS**.
