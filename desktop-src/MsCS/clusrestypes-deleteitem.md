...
- DeleteItem method Failover Cluster , ClusResTypes collection
- ClusResTypes collection Failover Cluster , DeleteItem method
topic_type:
- apiref
api_name:
...
Deletes a [resource type](resource-types.md) from the [*cluster*](https://www.bing.com/search?q=*cluster*) and removes it from the [**ClusResTypes**](clusrestypes-collection.md) collection.
