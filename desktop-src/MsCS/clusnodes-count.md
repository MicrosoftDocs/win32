---
title: ClusNodes.Count property
...
- Count property Failover Cluster , ClusNodes collection
- ClusNodes collection Failover Cluster , Count property
topic_type:
- apiref
api_name:
- ClusNodes.Count
...
Returns the number of objects in the [**ClusNodes**](clusnodes-collection.md) collection.
