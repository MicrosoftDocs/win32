...
There can be only one DFS root per [*cluster*](https://www.bing.com/search?q=*cluster*). In other words, a cluster can have only one file share resource whose **IsDfsRoot** property is set to **TRUE**.
