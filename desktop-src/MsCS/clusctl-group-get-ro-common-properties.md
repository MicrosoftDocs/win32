---
title: CLUSCTL\_GROUP\_GET\_RO\_COMMON\_PROPERTIES control code
description: Retrieves the read-only common properties for a group.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 2ada0f26-36c3-4b16-a135-0ccd53fd9bdb
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_GROUP_GET_RO_COMMON_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_GROUP\_GET\_RO\_COMMON\_PROPERTIES control code

Retrieves the read-only common properties for a group. Applications use this [control code](about-control-codes.md) as a [**ClusterGroupControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustergroupcontrol?branch=master) parameter.
...
ClusterGroupControl( 
  ...
  CLUSCTL_GROUP_GET_RO_COMMON_PROPERTIES,  // this control code
...
On a successful return, points to a [property list](property-lists.md) containing the specified group's read-only [common group properties](group-common-properties.md).
...
ClusAPI.h defines the 32 bits of CLUSCTL\_GROUP\_GET\_RO\_COMMON\_PROPERTIES as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
