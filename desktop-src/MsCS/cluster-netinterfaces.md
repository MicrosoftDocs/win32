...
Returns a [**ClusNetInterfaces**](clusnetinterfaces-collection.md) collection providing access to the [network interfaces](network-interfaces.md) in a [*cluster*](https://www.bing.com/search?q=*cluster*).
