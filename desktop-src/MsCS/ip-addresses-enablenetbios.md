...
There is a limit of 64 NetBIOS devices in the [*cluster*](c-gly.md#-wolf-cluster-gly). If you have a large number of IP addresses for non-NetBIOS use (for example, a Web server with many virtual roots), set **EnableNetBIOS** to **FALSE** for each IP Address resource.
