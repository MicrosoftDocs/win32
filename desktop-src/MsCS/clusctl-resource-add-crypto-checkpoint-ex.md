---
title: CLUSCTL\_RESOURCE\_ADD\_CRYPTO\_CHECKPOINT\_EX control code
description: TBD.
audience: developer
...
ClusterResourceControl( 
  ...
  CLUSCTL_RESOURCE_ADD_CRYPTO_CHECKPOINT_EX,   // this control code
...
ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_ADD\_CRYPTO\_CHECKPOINT\_EX (0x014002D6) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
