...
Retrieves the name of the current [*Global Update Manager*](https://www.bing.com/search?q=*Global Update Manager*) (GUM) lock owner for a [*cluster*](https://www.bing.com/search?q=*cluster*). Applications use this [control code](about-control-codes.md) as a [**ClusterControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clustercontrol) parameter.
