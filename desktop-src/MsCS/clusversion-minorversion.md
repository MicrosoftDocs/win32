...
**Long** that receives the [*minor version*](https://www.bing.com/search?q=*minor version*).

## Remarks

The [**ClusVersion.MajorVersion**](clusversion-majorversion.md) and **MinorVersion** properties together form a complete Windows [*version number*](https://www.bing.com/search?q=*version number*).
