...
keywords: ["ClusDisks collection Failover Cluster", "ClusDisks collection Failover Cluster , described"]
topic_type:
- apiref
api_name:
- ClusDisks
...
Provides access to the [*cluster-capable*](c-gly.md#-wolf-cluster-capable-disk-gly) [Physical Disks](creating-physical-disk-resources.md) available to a [resource type](resource-types.md).
