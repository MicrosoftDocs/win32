...
keywords: ["CLUSCTL_NETINTERFACE_GET_COMMON_PROPERTY_FMTS control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Reserved for future use. Applications use this control code as a parameter to the [**ClusterNetInterfaceControl**](clusternetinterfacecontrol.md) function.
...
[**ClusterNetInterfaceControl**](clusternetinterfacecontrol.md) returns the following value.
