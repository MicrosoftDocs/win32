---
title: CLUSCTL\_GROUP\_SET\_PRIVATE\_PROPERTIES control code
description: Updates the read/write private properties for a group.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: a0043a00-5f5a-4088-935f-c4b0cc90ea9d
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_GROUP_SET_PRIVATE_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
# CLUSCTL\_GROUP\_SET\_PRIVATE\_PROPERTIES control code

Updates the read/write [private properties](private-properties.md) for a [group](groups.md). Applications use this [control code](about-control-codes.md) as a [**ClusterGroupControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustergroupcontrol?branch=master) parameter.


```C++
ClusterGroupControl( hGroup,                                // group handle
                     hHostNode,                             // optional node handle
                     CLUSCTL_GROUP_SET_PRIVATE_PROPERTIES,  // this control code
...
The following control code function parameters are specific to this control code. For complete parameter descriptions, see [**ClusterGroupControl**](/windows/previous-versions/ClusAPI/nf-clusapi-clustergroupcontrol?branch=master).
...
Pass a pointer to a [property list](property-lists.md) containing one or more read/write group [private properties](private-properties.md). Properties that do not already exist will be created.
...
By default, failover clusters do not define any private properties for groups. However, you can use the CLUSCTL\_GROUP\_SET\_PRIVATE\_PROPERTIES control code to define private properties for a group.
...
ClusAPI.h defines the 32 bits of CLUSCTL\_GROUP\_SET\_PRIVATE\_PROPERTIES as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
