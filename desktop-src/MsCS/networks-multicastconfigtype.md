...
Specifies whether a [network's](networks.md) [*heartbeat*](https://www.bing.com/search?q=*heartbeat*) multicast address was set manually, obtained from Multicast Address Dynamic Client Allocation Protocol (MADCAP), or chosen by the [*cluster*](https://www.bing.com/search?q=*cluster*). The following table summarizes the attributes of the **MulticastConfigType** property.
