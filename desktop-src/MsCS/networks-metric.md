...
Provides the **Metric** of the [network](networks.md) in the [*cluster*](https://www.bing.com/search?q=*cluster*). The following table summarizes the attributes of the **Metric** property.
