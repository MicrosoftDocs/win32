...
keywords: ["ClusNodes collection Failover Cluster", "ClusNodes collection Failover Cluster , described"]
topic_type:
- apiref
api_name:
- ClusNodes
...
Provides access to the [nodes](nodes.md) in a [*cluster*](c-gly.md#-wolf-cluster-gly).
