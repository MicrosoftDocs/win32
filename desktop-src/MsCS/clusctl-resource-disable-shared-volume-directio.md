...
keywords: ["CLUSCTL_RESOURCE_DISABLE_SHARED_VOLUME_DIRECTIO control code Failover Cluster"]
topic_type:
- apiref
api_name:
...
Disables higher performance I/O on the cluster shared volume. Applications use this control code as a parameter to the [**ClusterResourceControl**](clusterresourcecontrol.md) function, and [resource DLLs](resource-dlls.md) receive the control code as a parameter to the [*ResourceControl*](resourcecontrol.md) callback function.
