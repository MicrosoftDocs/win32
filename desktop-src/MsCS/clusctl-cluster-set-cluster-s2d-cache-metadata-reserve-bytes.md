---
title: CLUSCTL\_CLUSTER\_SET\_CLUSTER\_S2D\_CACHE\_METADATA\_RESERVE\_BYTES control code
description: Sets the size of Storage Spaces Direct (S2D) metadata reserve.
audience: developer
...
Applications use this [control code](about-control-codes.md) as a [**ClusterControl**](/previous-versions/windows/desktop/api/ClusAPI/nf-clusapi-clustercontrol) parameter.


```C++
ClusterControl( hCluster,       // cluster handle
                hHostNode,      // optional node handle
                CLUSCTL_CLUSTER_SET_CLUSTER_S2D_CACHE_METADATA_RESERVE_BYTES, // control code
...
Pass a pointer to a **ULARGE\_INTEGER** to set the size of the metadata reserve in bytes.
...
ClusAPI.h defines the 32 bits of CLUSCTL\_CLUSTER\_SET\_CLUSTER\_S2D\_CACHE\_METADATA\_RESERVE\_BYTES (0x07402D62) as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
