...
keywords: ["PreferredOwnerNodes property Failover Cluster", "PreferredOwnerNodes property Failover Cluster , ClusResGroup class", "ClusResGroup class Failover Cluster , PreferredOwnerNodes property"]
topic_type:
- apiref
api_name:
