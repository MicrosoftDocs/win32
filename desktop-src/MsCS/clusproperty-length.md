...
- Length property Failover Cluster , ClusProperty object
- ClusProperty object Failover Cluster , Length property
topic_type:
- apiref
api_name:
- ClusProperty.Length
...
The **Length** property corresponds to the **cbLength** member of a [**CLUSPROP\_VALUE**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_value) structure.
