---
title: CLUSCTL\_RESOURCE\_TYPE\_GET\_PRIVATE\_PROPERTIES control code
description: Retrieves the read/write private properties for a resource type.
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: 28c5043e-259e-4bcb-aad1-92b8cc6b8845
ms.prod: windows-server-dev
ms.technology: failover-clustering
ms.tgt_platform: multiple
keywords:
- CLUSCTL_RESOURCE_TYPE_GET_PRIVATE_PROPERTIES control code Failover Cluster
topic_type:
- apiref
api_name:
...
ClusterResourceTypeControl( 
  ...
  CLUSCTL_RESOURCE_TYPE_GET_PRIVATE_PROPERTIES,  // this control code
...
On a successful return, points to a [property list](property-lists.md) containing the resource type's read/write private properties.
...
If any other value is returned, then the operation was not successful. The *lpcbBytesReturned* parameter points to an unreliable value.

</dd> </dl>

## Remarks

ClusAPI.h defines the 32 bits of CLUSCTL\_RESOURCE\_TYPE\_GET\_PRIVATE\_PROPERTIES as follows (for more information, see [Control Code Architecture](control-code-architecture.md)).
...
Required. Always support CLUSCTL\_RESOURCE\_TYPE\_GET\_PRIVATE\_PROPERTIES in your implementation of [**ResourceTypeControl**](/windows/previous-versions/ResApi/nc-resapi-presource_type_control_routine?branch=master). Return a property list that includes the names and data values for all of the resource type-specific read/write private properties. Remember to terminate the list with CLUSPROP\_SYNTAX\_ENDMARK. For more information on working with property lists, see [Creating Property Lists](creating-property-lists.md).
