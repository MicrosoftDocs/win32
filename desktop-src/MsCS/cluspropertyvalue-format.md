...
- Format property Failover Cluster , ClusPropertyValue object
- ClusPropertyValue object Failover Cluster , Format property
topic_type:
- apiref
api_name:
...
Returns or sets the format (data type) of a [*property value*](https://www.bing.com/search?q=*property value*).
...
**Long** describing the format of the property value. MsClus.h defines the following formats, enumerated by the [**CLUSTER\_PROPERTY\_FORMAT**](/previous-versions/windows/desktop/api/ClusAPI/ne-clusapi-cluster_property_format) enumeration.
...
The **Format** property corresponds to the **wFormat** member of a [**CLUSPROP\_SYNTAX**](/previous-versions/windows/desktop/api/ClusAPI/ns-clusapi-clusprop_syntax) union.
