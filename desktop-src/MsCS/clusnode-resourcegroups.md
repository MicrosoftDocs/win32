...
To retrieve information about all of the groups in the [*cluster*](c-gly.md#-wolf-cluster-gly), use the [**Cluster.ResourceGroups**](cluster-resourcegroups.md) property.
