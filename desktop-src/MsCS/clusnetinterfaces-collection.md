...
keywords: ["ClusNetInterfaces collection Failover Cluster", "ClusNetInterfaces collection Failover Cluster , described"]
topic_type:
- apiref
api_name:
- ClusNetInterfaces
...
Provides access to the [network interfaces](network-interfaces.md) in a [*cluster*](c-gly.md#-wolf-cluster-gly).
