---
title: ClusResDependencies.Refresh method
...
- Refresh method Failover Cluster , ClusResDependencies class
- ClusResDependencies class Failover Cluster , Refresh method
topic_type:
- apiref
api_name:
...
# ClusResDependencies.Refresh method
...
Refreshes the data in the [**ClusResDependencies**](clusresdependencies-collection.md) collection.
