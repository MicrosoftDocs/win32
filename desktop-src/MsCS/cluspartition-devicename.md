...
- DeviceName property Failover Cluster , ClusPartition object
- ClusPartition object Failover Cluster , DeviceName property
topic_type:
- apiref
api_name:
...
Returns the device name of a [*storage class resource*](https://www.bing.com/search?q=*storage class resource*) partition.
