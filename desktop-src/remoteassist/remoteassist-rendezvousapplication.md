...
|:----------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| [**IRendezvousApplication**](/previous-versions/windows/desktop/api/RendezvousSession/nn-rendezvoussession-irendezvousapplication) | Used by an instant messaging (IM) application to create a remote assistance session. <br/> |
...
| Method                                                                                   | Description                                                                                                                                                                              |
|:-----------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**SetRendezvousSession**](/previous-versions/windows/desktop/api/RendezvousSession/nf-rendezvoussession-irendezvousapplication-setrendezvoussession) | Passes [**IRendezvousSession**](/previous-versions/windows/desktop/api/RendezvousSession/nn-rendezvoussession-irendezvoussession) to the Windows Remote Assistance application. This method is used by the instant messaging application. <br/> |
