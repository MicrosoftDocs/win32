...
keywords: ["OnSendError event Remote Assistance", "OnSendError event Remote Assistance , DRendezvousSessionEvents interface", "DRendezvousSessionEvents interface Remote Assistance , OnSendError event"]
topic_type:
- apiref
api_name:
...
Invoked when the [**SendContextData**](remoteassist-irendezvoussession-sendcontextdata.md) method has failed on the remote end of the connection.
