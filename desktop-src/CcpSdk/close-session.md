---
Description: 'Closes a SOA session, which ends the job for the session and deletes the response messages.'
audience: developer
author: 'REDMOND\\danlep'
manager: 'REDMOND\\timlt'
ms.assetid: '339756DA-34FA-4332-B62D-FE6ADE6AD6BA'
...
You can specify the Close Session request as follows.



| Method                      | Request URI                                                                                           |
|-----------------------------|-------------------------------------------------------------------------------------------------------|
| POST (before HPC Pack 2016) | https://*head\_node\_name*:*port*/WindowsHpc/*HPC\_cluster\_name*/session/*session\_identifier*/Close |
| POST (HPC Pack 2016)        | https://*head\_node\_name*:*port*/WindowsHpc/session/*session\_identifier*/Close                      |
