---
Description: 'Adds the job to the scheduling queue using the job identifier to identify the job.'
audience: developer
author: 'REDMOND\\danlep'
manager: 'REDMOND\\timlt'
ms.assetid: '15f0fa90-37ac-4c08-bcf7-d57034d5a586'
ms.prod: 'windows-server-dev'
ms.technology: 'compute-cluster-pack'
ms.tgt_platform: multiple
title: 'IScheduler::SubmitJobById method'
---
