---
Description: 'Sets the values of custom properties for a task.'
audience: developer
author: 'REDMOND\\danlep'
manager: 'REDMOND\\timlt'
ms.assetid: '41BEE57E-C52B-4AF2-B254-40598433C749'
ms.prod: 'windows-server-dev'
ms.technology: 'compute-cluster-pack'
ms.tgt_platform: multiple
title: Set Task Custom Properties
---
...
You can specify the Set Task Custom Properties request as follows.



| Method                      | Request URI                                                                                                                        |
|-----------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| POST (before HPC Pack 2016) | https://*head\_node\_name*:*port*/MicrosoftHPC/*HPC\_cluster\_name*/Job/*job\_identifier*/Task/*task\_identifier*/CustomProperties |
| POST (HPC Pack 2016)        | https://*head\_node\_name*:*port*/MicrosoftHPC/Job/*job\_identifier*/Task/*task\_identifier*/CustomProperties                      |
...
| Element         | Description                                                                           |
|-----------------|---------------------------------------------------------------------------------------|
| ArrayOfProperty | Represents the set of custom properties that you want to set for the task.<br/> |
