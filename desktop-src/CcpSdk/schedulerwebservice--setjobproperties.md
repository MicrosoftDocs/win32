---
Description: 'Sets the values for the properties of the specified job.'
audience: developer
author: 'REDMOND\\danlep'
manager: 'REDMOND\\timlt'
ms.assetid: 'CA8E625E-E4B8-4FE4-87BA-BAF76522B02E'
...
You can specify the Set Job Properties request as follows.



| Method                     | Request URI                                                                             |
|----------------------------|-----------------------------------------------------------------------------------------|
| PUT (before HPC Pack 2016) | https://*head\_node\_name*:*port*/WindowsHPC/*HPC\_cluster\_name*/Job/*job\_identifier* |
| PUT (HPC Pack 2016)        | https://*head\_node\_name*:*port*/WindowsHPC/Job/*job\_identifier*                      |
...
<ArrayOfProperty xmlns="http://schemas.microsoft.com/HPCS2008R2/common">
    ...
    <Property>
        <Name>Property2 Name</Name> 
        <Value>Property2 Value</Value>
    </Property>
    …
</ArrayOfProperty>
```
...
| Element         | Description                                                                               |
|-----------------|-------------------------------------------------------------------------------------------|
| ArrayOfProperty | Represents the set of properties for the job for which you want to set values.<br/> |
...
The following table shows the job properties for which you can set the values. For information about the property, including the versions of Microsoft HPC Pack that support it, see the corresponding property of the ISchedulerJob interface or JobPropertyIds class in the managed API for Microsoft HPC Pack.
