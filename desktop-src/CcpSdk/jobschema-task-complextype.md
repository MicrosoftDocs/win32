...
ms.assetid: 'e616237f-4e47-41fb-bdeb-34620d801501'
...
|-----------------------------------------------------------------------------|----------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CustomProperties**](jobschema-customproperties-task-element.md)         | [**NameValueCollection**](jobschema-namevaluecollection-complextype.md)   | A collection of custom properties that the task uses. See [**ISchedulerTask::GetCustomProperties**](ischedulertask-getcustomproperties.md). <br/>                                                         |
| [**EnvironmentVariables**](jobschema-environmentvariables-task-element.md) | [**NameValueCollection1**](jobschema-namevaluecollection1-complextype.md) | A collection of environment variables that the task uses. See [**ISchedulerTask.EnvironmentVariables**](ischedulertask-environmentvariables.md).<br/>                                                     |
| [**ExtendedTerms**](jobschema-extendedterms-task-element.md)               | [**NameValueCollection1**](jobschema-namevaluecollection-complextype.md)  | Do not use. Use [**CustomProperties**](jobschema-customproperties-task-element.md) instead.<br/> **Microsoft Compute Cluster Server 2003:** A collection of extended terms that the task uses.<br/> |
...
| ParentJobState          | [**JobState**](jobschema-jobstate-simpletype.md)   | The state of the job that contains this task. See [TaskPropertyIds.ParentJobState](https://msdn.microsoft.com/library/microsoft.hpc.scheduler.properties.taskpropertyids.parentjobstate.aspx).<br/>                                            |
...
| PreviousState           | [**TaskState**](jobschema-taskstate-simpletype.md) | The previous state of the task. See [**ISchedulerTask.PreviousState**](ischedulertask-previousstate.md).<br/>                                                                                                                                 |
...
| State                   | [**TaskState**](jobschema-taskstate-simpletype.md) | The state of the task. See [**ISchedulerTask.State**](ischedulertask-state.md).<br/>                                                                                                                                                          |
...
| UnitType                | [**UnitType**](jobschema-unittype-simpletype.md)   | Determines whether cores, nodes, or sockets are used to allocate resources for the task. See [**ISchedulerJob.UnitType**](ischedulerjob-unittype.md).<br/>                                                                                    |
