---
Description: 'Sets the value of one or more environment variables for a job.'
audience: developer
author: 'REDMOND\\danlep'
manager: 'REDMOND\\timlt'
ms.assetid: '3B2FFE95-E986-4A4F-9964-E105B016EFE0'
...
You can specify the Set Job Environment Variables request as follows.



| Method                      | Request URI                                                                                          |
|-----------------------------|------------------------------------------------------------------------------------------------------|
| POST (before HPC Pack 2016) | https://*head\_node\_name*:*port*/WindowsHPC/*HPC\_cluster\_name*/Job/*job\_identifier*/EnvVariables |
| POST (HPC Pack 2016)        | https://*head\_node\_name*:*port*/WindowsHPC/Job/*job\_identifier*/EnvVariables                      |
...
| Element         | Description                                                                              |
|-----------------|------------------------------------------------------------------------------------------|
| ArrayOfProperty | Represents the set of environment variables that you want to set for the job.<br/> |
| Property        | Represents a single environment variable for the job.<br/>                         |
