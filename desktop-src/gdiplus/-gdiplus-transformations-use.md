...
Affine transformations include rotating, scaling, reflecting, shearing, and translating. In Windows GDI+, the [**Matrix**](/windows/win32/gdiplusmatrix/nl-gdiplusmatrix-matrix?branch=master) class provides the foundation for performing affine transformations on vector drawings, images, and text.
