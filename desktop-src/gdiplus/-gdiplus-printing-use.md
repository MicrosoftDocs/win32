...
With a few minor adjustments to your code, you can send Windows GDI+ output to a printer rather than to a screen. To draw on a printer, obtain a device context handle for the printer and pass that handle to a [**Graphics**](/windows/desktop/api/gdiplusgraphics/nl-gdiplusgraphics-graphics) constructor. Place your GDI+ drawing commands in between calls to [StartDoc](http://msdn.microsoft.com/library/en-us/gdi/prntspol_95sz.asp) and [EndDoc](http://msdn.microsoft.com/library/en-us/gdi/prntspol_0qhv.asp).
