...
To create a path, construct a [**GraphicsPath**](/windows/desktop/api/gdipluspath/nl-gdipluspath-graphicspath) object, and then call methods, such as [AddLine](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addline(in const point &,in const point &)) and [AddCurve](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addcurve(in const point,in int)), to add primitives to the path.
