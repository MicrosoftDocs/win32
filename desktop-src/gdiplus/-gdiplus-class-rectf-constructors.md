...
| [**RectF()**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-rectf(in const pointf &_in const sizef &))                                     | Creates a [**RectF**](/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rectf) object and initializes the **X**, **Y**, **Width**, and **Height** data members to zero. This is the default constructor.<br/>                                                                                                                                      |
