---
Description: Windows GDI+ provides several dash styles that are listed in the DashStyle enumeration. If those standard dash styles dont suit your needs, you can create a custom dash pattern.
