...
When you fill a shape, you must pass the address of a [**Brush**](/windows/win32/gdiplusbrush/nl-gdiplusbrush-brush?branch=master) object to one of the fill methods of the [**Graphics**](/windows/win32/gdiplusgraphics/nl-gdiplusgraphics-graphics?branch=master) class. The one parameter of the [**SolidBrush**](/windows/win32/gdiplusbrush/nl-gdiplusbrush-solidbrush?branch=master) constructor is a [**Color**](/windows/win32/gdipluscolor/nl-gdipluscolor-color?branch=master) object. To fill an opaque shape, set the alpha component of the color to 255. To fill a semitransparent shape, set the alpha component to any value from 1 through 254.
