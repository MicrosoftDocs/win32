...
This topic lists the methods of the [**Image**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-image) class. For a complete class listing, see **Image Class**.
...
-   [**Save(IStream\*,CLSID\*,EncoderParameters\*)**](/windows/desktop/api/Gdiplusheaders/)
-   [**Save(WCHAR\*,CLSID\*,EncoderParameters\*)**](/windows/desktop/api/Gdiplusheaders/)
-   [**SaveAdd(EncoderParameters\*)**](/windows/desktop/api/Gdiplusheaders/)
-   [**SaveAdd(Image\*,EncoderParameters\*)**](/windows/desktop/api/Gdiplusheaders/)
