...
| Document                                      | Location                                                                                                        |
|-----------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| Tagged Image File Format (TIFF) Specification | [http://partners.adobe.com/public/developer/en/tiff/TIFF6.pdf](http://go.microsoft.com/fwlink/p/?linkid=182491) |
| Exif Specification                            | <http://www.exif.org/specifications.html>                                                                       |
| Portable Network Graphics (PNG) Specification | <http://www.w3.org/TR/REC-png.html>                                                                             |
| ISO/IEC 10918-1 (JPEG)                        | <http://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=18902>                         |
| ICC.1:1998-09                                 | <http://www.color.org>                                                                                          |
