...
##### [AdjustableArrowCap](/windows/desktop/api/Gdipluslinecaps/nf-gdipluslinecaps-adjustablearrowcap-adjustablearrowcap(const adjustablearrowcap &))
...
##### [Bitmap Overloaded Constructor](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-bitmap-bitmap(const bitmap &))
###### [Bitmap(IDirectDrawSurface7*)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(INT,INT,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(BITMAPINFO*,VOID*)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(INT,INT,PixelFormat)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(HBITMAP,HPALETTE)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(INT,INT,INT,PixelFormat,BYTE*)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(WCHAR*,BOOL)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(HINSTANCE, WCHAR*)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(HICON)](/windows/desktop/api/Gdiplusheaders/)
###### [Bitmap(IStream*,BOOL)](/windows/desktop/api/Gdiplusheaders/)
##### [Bitmap Methods](-gdiplus-class-bitmap-methods.md)
###### [Clone Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-bitmap-clone(in const rectf &,in pixelformat))
####### [Clone(Rect&amp;,PixelFormat)](/windows/desktop/api/Gdiplusheaders/)
####### [Clone(RectF&amp;,PixelFormat)](/windows/desktop/api/Gdiplusheaders/)
####### [Clone(REAL,REAL,REAL,REAL,PixelFormat)](/windows/desktop/api/Gdiplusheaders/)
####### [Clone(INT,INT,INT,INT,PixelFormat)](/windows/desktop/api/Gdiplusheaders/)
###### [ApplyEffect Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-bitmap-applyeffect(in bitmap,in int,in effect,in rect,out rect,out bitmap))
####### [ApplyEffect(Bitmap**,INT,Effect*,RECT*,RECT*,Bitmap**)](/windows/desktop/api/Gdiplusheaders/)
####### [ApplyEffect(Effect*,RECT*)](/windows/desktop/api/Gdiplusheaders/)
...
#### [BitmapData](/windows/desktop/api/Gdiplusimaging/)
...
##### [CachedBitmap](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-cachedbitmap-cachedbitmap(const cachedbitmap &))
...
##### [CharacterRange Overloaded Constructor](/windows/desktop/api/gdiplustypes/)
###### [CharacterRange()](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-characterrange-characterrange~r2)
###### [CharacterRange(INT,INT)](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-characterrange-characterrange(int,int))
...
##### [Color Overloaded Constructor](/windows/desktop/api/gdipluscolor/)
###### [Color(BYTE,BYTE,BYTE,BYTE)](/windows/desktop/api/Gdipluscolor/)
###### [Color()](/windows/desktop/api/Gdipluscolor/nf-gdipluscolor-color-color(in argb))
###### [Color(BYTE,BYTE,BYTE)](/windows/desktop/api/Gdipluscolor/)
###### [Color(ARGB)](/windows/desktop/api/Gdipluscolor/)
...
##### [CustomLineCap](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-customlinecap-customlinecap(const customlinecap &))
...
#### [EncoderParameter](/windows/desktop/api/Gdiplusimaging/)
#### [EncoderParameters](/windows/desktop/api/Gdiplusimaging/)
#### [Font](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-font)
##### [Font Overloaded Constructor](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-font-font(const font &))
###### [Font(FontFamily*,REAL,INT,Unit)](/windows/desktop/api/Gdiplusheaders/)
###### [Font(HDC,HFONT)](/windows/desktop/api/Gdiplusheaders/)
###### [Font(HDC,LOGFONTA*)](/windows/desktop/api/Gdiplusheaders/)
###### [Font(HDC,LOGFONTW*)](/windows/desktop/api/Gdiplusheaders/)
###### [Font(WCHAR*,REAL,INT,Unit,FontCollection*)](/windows/desktop/api/Gdiplusheaders/)
###### [Font(HDC)](/windows/desktop/api/Gdiplusheaders/)
...
###### [GetHeight Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-font-getheight(in real))
...
##### [FontCollection](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-fontcollection-fontcollection(const fontcollection &))
...
##### [FontFamily Overloaded Constructor](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-fontfamily-fontfamily(const fontfamily &))
###### [FontFamily()](/windows/desktop/api/Gdiplusheaders/)
###### [FontFamily(WCHAR*,FontCollection*)](/windows/desktop/api/Gdiplusheaders/)
...
###### [operator delete](/windows/desktop/api/Gdiplusbase/nf-gdiplusbase-gdiplusbase-operator delete)
###### [operator delete[]](/windows/desktop/api/Gdiplusbase/nf-gdiplusbase-gdiplusbase-operator delete[])
###### [operator new](/windows/desktop/api/Gdiplusbase/nf-gdiplusbase-gdiplusbase-operator new)
###### [operator new[]](/windows/desktop/api/Gdiplusbase/nf-gdiplusbase-gdiplusbase-operator new[])
#### [Graphics](/windows/desktop/api/gdiplusgraphics/nl-gdiplusgraphics-graphics)
##### [Graphics Overloaded Constructor](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-graphics(const graphics &))
###### [Graphics(Image*)](/windows/desktop/api/Gdiplusgraphics/)
###### [Graphics(HDC)](/windows/desktop/api/Gdiplusgraphics/)
###### [Graphics(HDC,HANDLE)](/windows/desktop/api/Gdiplusgraphics/)
###### [Graphics(HWND,BOOL)](/windows/desktop/api/Gdiplusgraphics/)
...
###### [BeginContainer Overloaded Method](/windows/desktop/api/gdiplusgraphics/)
...
###### [DrawArc Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawarc(in const pen,in const rect &,in real,in real))
...
###### [DrawBezier Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawbezier(in const pen,in const point &,in const point &,in const point &,in const point &))
...
###### [DrawBeziers Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawbeziers(in const pen,in const point,in int))
...
###### [DrawClosedCurve Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawclosedcurve(in const pen,in const point,in int))
...
###### [DrawCurve Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawcurve(in const pen,in const point,in int))
...
###### [DrawEllipse Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawellipse(in const pen,in const rect &))
...
###### [DrawImage Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawimage(in image,in const point &))
...
###### [DrawLine Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawline(in const pen,in const point &,in const point &))
####### [DrawLine(Pen*,Point&amp;,Point&amp;)](/windows/desktop/api/Gdiplusgraphics/)
####### [DrawLine(Pen*,PointF&amp;,Point&amp;)](/windows/desktop/api/Gdiplusgraphics/)
...
###### [DrawLines Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawlines(in const pen,in const point,in int))
...
###### [DrawPie Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawpie(in const pen,in const rect &,in real,in real))
...
###### [DrawPolygon Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawpolygon(in const pen,in const point,in int))
...
###### [DrawRectangle Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawrectangle(in const pen,in const rect &))
...
###### [DrawRectangles Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawrectangles(in const pen,in const rect,in int))
...
###### [DrawString Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawstring(const wchar,int,const font,const pointf &,const brush))
...
###### [EnumerateMetafile Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-enumeratemetafile(in const metafile,in const point &,in const rect &,in unit,in enumeratemetafileproc,in void,in const imageattributes))
...
###### [ExcludeClip Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-excludeclip(in const rect &))
...
###### [FillClosedCurve Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillclosedcurve(in const brush,in const point,in int))
...
###### [FillEllipse Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillellipse(in const brush,in const rect &))
...
###### [FillPie Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillpie(in const brush,in const rect &,in real,in real))
...
###### [FillPolygon Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillpolygon(in const brush,in const point,in int))
...
###### [FillRectangle Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillrectangle(in const brush,in const rect &))
...
###### [FillRectangles Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillrectangles(in const brush,in const rect,in int))
...
###### [FromHDC Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fromhdc(in hdc))
####### [FromHDC(HDC)](/windows/desktop/api/Gdiplusgraphics/)
####### [FromHDC(HDC,HANDLE)](/windows/desktop/api/Gdiplusgraphics/)
...
###### [GetClipBounds Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-getclipbounds(out rect))
...
###### [GetVisibleClipBounds Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-getvisibleclipbounds(out rect))
...
###### [IntersectClip Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-intersectclip(in const rect &))
...
###### [IsVisible Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-isvisible(in const point &))
...
###### [MeasureString Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-measurestring(in const wchar,in int,in const font,in const pointf &,in const stringformat,out rectf))
...
###### [SetClip Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-setclip(in const graphicspath,in combinemode))
...
###### [TranslateClip Overloaded Method](/windows/desktop/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-translateclip(in int,in int))
...
##### [GraphicsPath Overloaded Constructor](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-graphicspath(const graphicspath &))
###### [GraphicsPath(Point*,BYTE*,INT,FillMode)](/windows/desktop/api/Gdipluspath/)
###### [GraphicsPath(FillMode)](/windows/desktop/api/Gdipluspath/)
###### [GraphicsPath(PointF*,BYTE*,INT,FillMode)](/windows/desktop/api/Gdipluspath/)
##### [GraphicsPath Methods](-gdiplus-class-graphicspath-methods.md)
###### [AddArc Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addarc(in const rect &,in real,in real))
####### [AddArc(Rect&amp;,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddArc(RectF&amp;,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddArc(INT,INT,INT,INT,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddArc(REAL,REAL,REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
###### [AddBezier Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addbezier(in const point &,in const point &,in const point &,in const point &))
####### [AddBezier(Point&amp;,Point&amp;,Point&amp;,Point&amp;)](/windows/desktop/api/Gdipluspath/)
####### [AddBezier(REAL,REAL,REAL,REAL,REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddBezier(PointF&amp;,PointF&amp;,PointF&amp;,PointF&amp;)](/windows/desktop/api/Gdipluspath/)
####### [AddBezier(INT,INT,INT,INT,INT,INT,INT,INT)](/windows/desktop/api/Gdipluspath/)
###### [AddBeziers Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addbeziers(in const point,in int))
####### [AddBeziers(Point*,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddBeziers(PointF*,INT)](/windows/desktop/api/Gdipluspath/)
###### [AddClosedCurve Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addclosedcurve(in const point,in int))
####### [AddClosedCurve(Point*,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddClosedCurve(Point*,INT,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddClosedCurve(PointF*,INT,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddClosedCurve(PointF*,INT)](/windows/desktop/api/Gdipluspath/)
###### [AddCurve Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addcurve(in const point,in int))
####### [AddCurve(Point*,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddCurve(PointF*,INT,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddCurve(PointF*,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddCurve(Point*,INT,INT,INT,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddCurve(Point*,INT,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddCurve(PointF*,INT,INT,INT,REAL)](/windows/desktop/api/Gdipluspath/)
###### [AddEllipse Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addellipse(in const rect &))
####### [AddEllipse(Rect&amp;)](/windows/desktop/api/Gdipluspath/)
####### [AddEllipse(RectF&amp;)](/windows/desktop/api/Gdipluspath/)
####### [AddEllipse(INT,INT,INT,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddEllipse(REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
###### [AddLine Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addline(in const point &,in const point &))
####### [AddLine(Point&amp;,Point&amp;)](/windows/desktop/api/Gdipluspath/)
####### [AddLine(PointF&amp;,PointF&amp;)](/windows/desktop/api/Gdipluspath/)
####### [AddLine(REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddLine(INT,INT,INT,INT)](/windows/desktop/api/Gdipluspath/)
###### [AddLines Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addlines(in const point,in int))
####### [AddLines(Point*,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddLines(PointF*,INT)](/windows/desktop/api/Gdipluspath/)
###### [AddPath](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-addpath)
###### [AddPie Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addpie(in const rect &,in real,in real))
####### [AddPie(Rect&amp;,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddPie(INT,INT,INT,INT,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddPie(REAL,REAL,REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
####### [AddPie(RectF&amp;,REAL,REAL)](/windows/desktop/api/Gdipluspath/)
###### [AddPolygon Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addpolygon(in const point,in int))
####### [AddPolygon(Point*,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddPolygon(PointF*,INT)](/windows/desktop/api/Gdipluspath/)
###### [AddRectangle Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addrectangle(in const rect &))
####### [AddRectangle(Rect&amp;)](/windows/desktop/api/Gdipluspath/)
####### [AddRectangle(RectF&amp;)](/windows/desktop/api/Gdipluspath/)
###### [AddRectangles Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addrectangles(in const rect,int))
####### [AddRectangles(Rect*,INT)](/windows/desktop/api/Gdipluspath/)
####### [AddRectangles(RectF*,INT)](/windows/desktop/api/Gdipluspath/)
###### [AddString Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-addstring(in const wchar,in int,in const fontfamily,in int,in real,in const point &,in const stringformat))
####### [AddString(WCHAR*,INT,FontFamily*,INT,REAL,Rect&amp;,StringFormat*)](/windows/desktop/api/Gdipluspath/)
####### [AddString(WCHAR*,INT,FontFamily*,INT,REAL,PointF&amp;,StringFormat*)](/windows/desktop/api/Gdipluspath/)
####### [AddString(WCHAR*,INT,FontFamily*,INT,REAL,Point&amp;,StringFormat*)](/windows/desktop/api/Gdipluspath/)
####### [AddString(WCHAR*,INT,FontFamily*,INT,REAL,RectF&amp;,StringFormat*)](/windows/desktop/api/Gdipluspath/)
...
###### [GetBounds Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-getbounds(out rect,in const matrix,in const pen))
####### [GetBounds(Rect*,Matrix*,Pen*)](/windows/desktop/api/Gdipluspath/)
####### [GetBounds(RectF*,Matrix*,Pen*)](/windows/desktop/api/Gdipluspath/)
...
###### [GetPathPoints Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-getpathpoints(out point,in int))
####### [GetPathPoints(Point*,INT)](/windows/desktop/api/Gdipluspath/)
####### [GetPathPoints(PointF*,INT)](/windows/desktop/api/Gdipluspath/)
...
###### [IsOutlineVisible Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-isoutlinevisible(in const point &,in const pen,in const graphics))
####### [IsOutlineVisible(Point&amp;,Pen*,Graphics*)](/windows/desktop/api/Gdipluspath/)
####### [IsOutlineVisible(REAL,REAL,Pen*,Graphics*)](/windows/desktop/api/Gdipluspath/)
####### [IsOutlineVisible(INT,INT,Pen*,Graphics*)](/windows/desktop/api/Gdipluspath/)
####### [IsOutlineVisible(PointF&amp;,Pen*,Graphics*)](/windows/desktop/api/Gdipluspath/)
###### [IsVisible Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspath-isvisible(in const point &,in const graphics))
####### [IsVisible(REAL,REAL,Graphics*)](/windows/desktop/api/Gdipluspath/)
####### [IsVisible(PointF&amp;,Graphics*)](/windows/desktop/api/Gdipluspath/)
####### [IsVisible(INT,INT,Graphics*)](/windows/desktop/api/Gdipluspath/)
####### [IsVisible(Point&amp;,Graphics*)](/windows/desktop/api/Gdipluspath/)
...
##### [GraphicsPathIterator](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspathiterator-graphicspathiterator(const graphicspathiterator &))
...
###### [NextMarker Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspathiterator-nextmarker(out const graphicspath))
####### [NextMarker(GraphicsPath*)](/windows/desktop/api/Gdipluspath/)
####### [NextMarker(INT*,INT*)](/windows/desktop/api/Gdipluspath/)
###### [NextPathType](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspathiterator-nextpathtype)
###### [NextSubpath Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspathiterator-nextsubpath(out const graphicspath,out bool))
####### [NextSubpath(GraphicsPath*,BOOL*)](/windows/desktop/api/Gdipluspath/)
####### [NextSubpath(INT*,INT*,BOOL*)](/windows/desktop/api/Gdipluspath/)
...
##### [HatchBrush](/windows/desktop/api/Gdiplusbrush/nf-gdiplusbrush-hatchbrush-hatchbrush(const hatchbrush &))
...
##### [Image Overloaded Constructor](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-image-image(gpimage,status))
###### [Image(IStream*,BOOL)](/windows/desktop/api/Gdiplusheaders/)
###### [Image(WCHAR*,BOOL)](/windows/desktop/api/Gdiplusheaders/)
...
###### [Save Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-image-save(in istream,in const clsid,in const encoderparameters))
...
###### [SaveAdd Overloaded Method](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-image-saveadd(in image,in const encoderparameters))
...
##### [ImageAttributes](/windows/desktop/api/Gdiplusimageattributes/nf-gdiplusimageattributes-imageattributes-imageattributes(const imageattributes &))
...
#### [ImageCodecInfo](/windows/desktop/api/Gdiplusimaging/)
#### [ImageItemData](/windows/desktop/api/Gdiplusimaging/)
#### [InstalledFontCollection](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-installedfontcollection)
##### [InstalledFontCollection](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-installedfontcollection-installedfontcollection(const installedfontcollection &))
...
##### [LinearGradientBrush Overloaded Constructor](/windows/desktop/api/gdiplusbrush/nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(const lineargradientbrush &))
###### [LinearGradientBrush(PointF&amp;,PointF&amp;,Color&amp;,Color&amp;)](/windows/desktop/api/Gdiplusbrush/)
###### [LinearGradientBrush(Rect&amp;,Color&amp;,Color&amp;,REAL,BOOL)](/windows/desktop/api/Gdiplusbrush/)
###### [LinearGradientBrush(RectF&amp;,Color&amp;,Color&amp;,LinearGradientMode)](/windows/desktop/api/Gdiplusbrush/)
###### [LinearGradientBrush(Point&amp;,Point&amp;,Color&amp;,Color&amp;)](/windows/desktop/api/Gdiplusbrush/)
###### [LinearGradientBrush(Rect&amp;,Color&amp;,Color&amp;,REAL,BOOL)](/windows/desktop/api/Gdiplusbrush/)
###### [LinearGradientBrush(Rect&amp;,Color&amp;,Color&amp;,LinearGradientMode)](/windows/desktop/api/Gdiplusbrush/)
...
###### [GetRectangle Overloaded Method](/windows/desktop/api/gdiplusbrush/nf-gdiplusbrush-lineargradientbrush-getrectangle(out rect))
...
###### [Matrix(RectF&amp;,PointF*)](/windows/desktop/api/Gdiplusmatrix/)
###### [Matrix(Rect&amp;,Point*)](/windows/desktop/api/Gdiplusmatrix/)
###### [Matrix()](/windows/desktop/api/Gdiplusmatrix/nf-gdiplusmatrix-matrix-matrix(const matrix &))
###### [Matrix(REAL,REAL,REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdiplusmatrix/)
...
###### [TransformPoints Overloaded Method](/windows/desktop/api/gdiplusmatrix/nf-gdiplusmatrix-matrix-transformpoints(in out point,in int))
####### [TransformPoints(Point*,INT)](/windows/desktop/api/Gdiplusmatrix/)
####### [TransformPoints(PointF*,INT)](/windows/desktop/api/Gdiplusmatrix/)
###### [TransformVectors Overloaded Method](/windows/desktop/api/gdiplusmatrix/nf-gdiplusmatrix-matrix-transformvectors(in out point,in int))
...
##### [Metafile Overloaded Constructor](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-metafile-metafile(const metafile &))
###### [Metafile(HDC,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(HDC,RectF&amp;,MetaFileFrameUnit,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(HMETAFILE,WmfPlaceableFileHeader*,BOOL)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(WCHAR*,HDC,Rect&amp;,MetaFileFrameUnit,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(IStream*,HDC,RectF&amp;,MetafileFrameUnit,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(IStream*,HDC,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(IStream*,HDC,Rect&amp;,MetafileFrameUnit,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(WCHAR*,HDC,RectF&amp;,MetafileFrameUnit,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(WCHAR*,HDC,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(IStream*)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(HENHMETAFILE,BOOL)](/windows/desktop/api/gdiplusheaders/)
###### [Metafile(HDC,Rect&amp;,MetafileFrameUnit,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
##### [Metafile Methods](-gdiplus-class-metafile-methods.md)
###### [ConvertToEmfPlus Overloaded Method](/windows/desktop/api/gdiplusheaders/)
####### [ConvertToEmfPlus(Graphics*,BOOL*,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-metafile-converttoemfplus(in const graphics,in const wchar,in out int,in emftype,in const wchar))
####### [ConvertToEmfPlus(Graphics*,IStream*,BOOL*,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
####### [ConvertToEmfPlus(Graphics*,WCHAR*,BOOL*,EmfType,WCHAR*)](/windows/desktop/api/gdiplusheaders/)
...
###### [GetMetafileHeader Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-metafile-getmetafileheader(in const wchar,out metafileheader))
####### [GetMetafileHeader(WCHAR*,MetafileHeader*)](/windows/desktop/api/gdiplusheaders/)
####### [GetMetafileHeader(HENHMETAFILE*,MetafileHeader*)](/windows/desktop/api/gdiplusheaders/)
####### [GetMetafileHeader(HMETAFILE,WmfPlaceableFileHeader*,MetafileHeader*)](/windows/desktop/api/gdiplusheaders/)
####### [GetMetafileHeader(MetafileHeader*)](/windows/desktop/api/gdiplusheaders/)
####### [GetMetafileHeader(IStream*,MetafileHeader*)](/windows/desktop/api/gdiplusheaders/)
...
##### [PathData](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-pathdata-pathdata(const pathdata &))
#### [PathGradientBrush](/windows/desktop/api/gdipluspath/nl-gdipluspath-pathgradientbrush)
##### [PathGradientBrush Overloaded Constructor](/windows/desktop/api/gdipluspath/nf-gdipluspath-pathgradientbrush-pathgradientbrush(const pathgradientbrush &))
###### [PathGradientBrush(Point*,INT,WrapMode)](/windows/desktop/api/Gdipluspath/)
###### [PathGradientBrush(PointF*,INT,WrapMode)](/windows/desktop/api/Gdipluspath/)
###### [PathGradientBrush(GraphicsPath*)](/windows/desktop/api/Gdipluspath/)
...
###### [GetCenterPoint Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-pathgradientbrush-getcenterpoint(out point))
...
###### [GetRectangle Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-pathgradientbrush-getrectangle(out rect))
...
###### [SetCenterPoint Overloaded Method](/windows/desktop/api/gdipluspath/nf-gdipluspath-pathgradientbrush-setcenterpoint(in const point &))
...
##### [Pen Overloaded Constructor](/windows/desktop/api/gdipluspen/nf-gdipluspen-pen-pen(const pen &))
###### [Pen(Brush*,REAL)](/windows/desktop/api/Gdipluspen/)
###### [Pen(Color&amp;,REAL)](/windows/desktop/api/Gdipluspen/)
...
###### [Point()](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-point-point(in const point &))
###### [Point(INT,INT)](/windows/desktop/api/Gdiplustypes/)
###### [Point(Point&amp;)](/windows/desktop/api/Gdiplustypes/)
###### [Point(Size&amp;)](/windows/desktop/api/Gdiplustypes/)
...
###### [PointF(REAL,REAL)](/windows/desktop/api/Gdiplustypes/)
###### [PointF(SizeF&amp;)](/windows/desktop/api/Gdiplustypes/)
###### [PointF()](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-pointf-pointf(in const pointf &))
###### [PointF(PointF&amp;)](/windows/desktop/api/Gdiplustypes/)
##### [PointF Methods](-gdiplus-class-pointf-methods.md)
###### [Equals](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-pointf-equals)
###### [operator+(PointF&amp;)](/windows/desktop/api/Gdiplustypes/)
###### [operator-(PointF&amp;)](/windows/desktop/api/Gdiplustypes/)
#### [PrivateFontCollection](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-privatefontcollection)
##### [PrivateFontCollection](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-privatefontcollection-privatefontcollection(const privatefontcollection &))
...
#### [PropertyItem](/windows/desktop/api/Gdiplusimaging/)
#### [Rect](/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rect)
##### [Rect Overloaded Constructor](-gdiplus-class-rect-constructors.md)
###### [Rect()](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rect-rect(in const point &,in const size &))
###### [Rect(Point&amp;,Size&amp;)](/windows/desktop/api/Gdiplustypes/)
###### [Rect(INT,INT,INT,INT)](/windows/desktop/api/Gdiplustypes/)
##### [Rect Methods](-gdiplus-class-rect-methods.md)
###### [Clone](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rect-clone)
###### [Contains Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rect-contains(in const point &))
...
###### [Inflate Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rect-inflate(in const point &))
####### [Inflate(INT,INT)](/windows/desktop/api/Gdiplustypes/)
####### [Inflate(Point&amp;)](/windows/desktop/api/Gdiplustypes/)
###### [Intersect Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rect-intersect(out rect &,in const rect &,in const rect &))
...
###### [Offset Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rect-offset(in int,in int))
...
###### [RectF(PointF&amp;,SizeF&amp;)](/windows/desktop/api/Gdiplustypes/)
###### [RectF()](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-rectf(in const pointf &,in const sizef &))
###### [RectF(REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdiplustypes/)
##### [RectF Methods](-gdiplus-class-rectf-methods.md)
###### [Clone](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-clone)
###### [Contains Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rectf-contains(in const pointf &))
####### [Contains(RectF&amp;)](/windows/desktop/api/Gdiplustypes/)
####### [Contains(PointF&amp;)](/windows/desktop/api/Gdiplustypes/)
####### [Contains(REAL,REAL)](/windows/desktop/api/Gdiplustypes/)
...
###### [Inflate Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rectf-inflate(in const pointf &))
####### [Inflate(PointF&amp;)](/windows/desktop/api/Gdiplustypes/)
####### [Inflate(REAL,REAL)](/windows/desktop/api/Gdiplustypes/)
###### [Intersect Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rectf-intersect(out rectf &,in const rectf &,in const rectf &))
####### [Intersect(Rect&amp;,Rect&amp;,Rect&amp;)](/windows/desktop/api/Gdiplustypes/)
####### [Intersect(Rect&amp;)](/windows/desktop/api/Gdiplustypes/)
...
###### [Offset Overloaded Method](/windows/desktop/api/gdiplustypes/nf-gdiplustypes-rectf-offset(in real,in real))
####### [Offset(INT,INT)](/windows/desktop/api/Gdiplustypes/)
####### [Offset(Point&amp;)](/windows/desktop/api/Gdiplustypes/)
...
###### [Region(Rect&amp;)](/windows/desktop/api/Gdiplusheaders/)
###### [Region()](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-region-region(const region &))
###### [Region(BYTE*,INT)](/windows/desktop/api/Gdiplusheaders/)
###### [Region(GraphicsPath*)](/windows/desktop/api/Gdiplusheaders/)
###### [Region(HRGN)](/windows/desktop/api/Gdiplusheaders/)
###### [Region(RectF&amp;)](/windows/desktop/api/Gdiplusheaders/)
##### [Region Methods](-gdiplus-class-region-methods.md)
###### [Clone](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-region-clone)
###### [Complement Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-complement(in const graphicspath))
####### [Complement(GraphicsPath*)](/windows/desktop/api/Gdiplusheaders/)
####### [Complement(Region*)](/windows/desktop/api/Gdiplusheaders/)
####### [Complement(Rect&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Complement(RectF&amp;)](/windows/desktop/api/Gdiplusheaders/)
###### [Equals](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-region-equals)
###### [Exclude Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-exclude(in const graphicspath))
####### [Exclude(GraphicsPath*)](/windows/desktop/api/Gdiplusheaders/)
####### [Exclude(RectF&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Exclude(Rect&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Exclude(Region*)](/windows/desktop/api/Gdiplusheaders/)
###### [FromHRGN](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-region-fromhrgn)
###### [GetBounds Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-getbounds(out rectf,in const graphics))
####### [GetBounds(Rect*,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [GetBounds(RectF*,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
...
###### [GetRegionScans Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-getregionscans(in const matrix,out rect,out int))
####### [GetRegionScans(Matrix*,Rect*,INT*)](/windows/desktop/api/Gdiplusheaders/)
####### [GetRegionScans(Matrix*,RectF*,INT*)](/windows/desktop/api/Gdiplusheaders/)
###### [GetRegionScansCount](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-region-getregionscanscount)
###### [Intersect Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-intersect(in const graphicspath))
####### [Intersect(Rect&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Intersect(GraphicsPath*)](/windows/desktop/api/Gdiplusheaders/)
####### [Intersect(RectF&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Intersect(Region*)](/windows/desktop/api/Gdiplusheaders/)
...
###### [IsVisible Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-isvisible(in const point &,in const graphics))
####### [IsVisible(PointF&amp;,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [IsVisible(RectF&amp;,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [IsVisible(Rect&amp;,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [IsVisible(INT,INT,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [IsVisible(REAL,REAL,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [IsVisible(INT,INT,INT,INT,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [IsVisible(Point&amp;,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
####### [IsVisible(REAL,REAL,REAL,REAL,Graphics*)](/windows/desktop/api/Gdiplusheaders/)
...
###### [Translate Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-translate(in int,in int))
####### [Translate(REAL,REAL)](/windows/desktop/api/Gdiplusheaders/)
####### [Translate(INT,INT)](/windows/desktop/api/Gdiplusheaders/)
###### [Union Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-union(in const graphicspath))
####### [Union(Rect&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Union(Region*)](/windows/desktop/api/Gdiplusheaders/)
####### [Union(RectF&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Union(GraphicsPath*)](/windows/desktop/api/Gdiplusheaders/)
###### [Xor Overloaded Method](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-region-xor(in const graphicspath))
####### [Xor(GraphicsPath*)](/windows/desktop/api/Gdiplusheaders/)
####### [Xor(RectF&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Xor(Rect&amp;)](/windows/desktop/api/Gdiplusheaders/)
####### [Xor(Region*)](/windows/desktop/api/Gdiplusheaders/)
...
###### [Size()](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-size-size(in const size &))
###### [Size(INT,INT)](/windows/desktop/api/Gdiplustypes/)
###### [Size(Size&amp;)](/windows/desktop/api/Gdiplustypes/)
...
###### [operator+](/windows/desktop/api/Gdiplustypes/)
###### [operator-](/windows/desktop/api/Gdiplustypes/)
...
###### [SizeF()](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-sizef-sizef(in const sizef &))
###### [SizeF(REAL,REAL)](/windows/desktop/api/Gdiplustypes/)
###### [SizeF(SizeF&amp;)](/windows/desktop/api/Gdiplustypes/)
...
##### [SolidBrush](/windows/desktop/api/Gdiplusbrush/nf-gdiplusbrush-solidbrush-solidbrush(const solidbrush &))
...
##### [StringFormat Overloaded Constructor](/windows/desktop/api/gdiplusstringformat/nf-gdiplusstringformat-stringformat-stringformat(const stringformat &))
###### [StringFormat(INT,LANGID)](/windows/desktop/api/Gdiplusstringformat/)
###### [StringFormat(StringFormat*)](/windows/desktop/api/Gdiplusstringformat/)
...
##### [TextureBrush Overloaded Constructor](/windows/desktop/api/gdiplusbrush/nf-gdiplusbrush-texturebrush-texturebrush(const texturebrush &))
###### [TextureBrush(Image*,wrapMode,RectF&amp;)](/windows/desktop/api/Gdiplusbrush/)
###### [TextureBrush(Image*,Rect&amp;,ImageAttributes*)](/windows/desktop/api/Gdiplusbrush/)
###### [TextureBrush(Image*,WrapMode,INT,INT,INT,INT)](/windows/desktop/api/Gdiplusbrush/)
###### [TextureBrush(Image*,WrapMode,REAL,REAL,REAL,REAL)](/windows/desktop/api/Gdiplusbrush/)
###### [TextureBrush(Image*,RectF&amp;,ImageAttributes*)](/windows/desktop/api/Gdiplusbrush/)
###### [TextureBrush(Image*,WrapMode)](/windows/desktop/api/Gdiplusbrush/)
###### [TextureBrush(Image*,WrapMode,Rect&amp;)](/windows/desktop/api/Gdiplusbrush/)
