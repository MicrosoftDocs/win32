...
To draw an ellipse, you need a [**Graphics**](-gdiplus-class-graphics-class.md) object and a [**Pen**](-gdiplus-class-pen-class.md) object. The **Graphics** object provides the [DrawEllipse](-gdiplus-class-graphics-drawellipse-methods.md) method, and the **Pen** object stores attributes of the ellipse, such as line width and color. The address of the **Pen** object is passed as one of the arguments to the DrawEllipse method. The remaining arguments passed to the DrawEllipse method specify the bounding rectangle for the ellipse. The following example draws an ellipse; the bounding rectangle has a width of 160, a height of 80, and an upper-left corner of (100, 50).
...
[DrawEllipse](-gdiplus-class-graphics-drawellipse-methods.md) is an overloaded method of the [**Graphics**](-gdiplus-class-graphics-class.md) class, so there are several ways you can supply it with arguments. For example, you can construct a [**Rect**](-gdiplus-class-rect-class.md) object and pass a reference to the **Rect** object as an argument to the DrawEllipse method.
...
An arc is a portion of an ellipse. To draw an arc, you call the [DrawArc](-gdiplus-class-graphics-drawarc-methods.md) method of the [**Graphics**](-gdiplus-class-graphics-class.md) class. The parameters of the DrawArc method are the same as the parameters of the [DrawEllipse](-gdiplus-class-graphics-drawellipse-methods.md) method, except that DrawArc requires a starting angle and sweep angle. The following example draws an arc with a starting angle of 30 degrees and a sweep angle of 180 degrees.
