...
You can apply one of the transformations shown in the preceding list when you call the [Save](https://msdn.microsoft.com/en-us/library/ms535399(v=VS.85).aspx) method of an [**Image**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-image) object. If the following conditions are met, then the transformation will proceed without loss of information:
