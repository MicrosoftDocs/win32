...
With certain file formats, you can save multiple images (frames) to a single file. For example, you can save several pages to a single TIFF file. To save the first page, call the [Save](https://msdn.microsoft.com/library/ms535399(v=VS.85).aspx) method of the [**Image**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-image) class. To save subsequent pages, call the [SaveAdd](https://msdn.microsoft.com/library/ms535398(v=VS.85).aspx) method of the **Image** class.

> [!Note]  
> You cannot use [SaveAdd](https://msdn.microsoft.com/library/ms535398(v=VS.85).aspx) to add frames to an animated gif file.
