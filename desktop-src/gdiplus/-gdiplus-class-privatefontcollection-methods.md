...
This topic lists the methods of the [**PrivateFontCollection**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-privatefontcollection) class. For a complete class listing, see **PrivateFontCollection Class**.
