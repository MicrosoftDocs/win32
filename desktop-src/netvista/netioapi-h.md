...
<tbody>
<tr class="odd">
<td>[<strong>CancelMibChangeNotify2</strong>](cancelmibchangenotify2.md)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceAliasToLuid</strong>](convertinterfacealiastoluid.md)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceGuidToLuid</strong>](convertinterfaceguidtoluid.md)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceIndexToLuid</strong>](convertinterfaceindextoluid.md)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceLuidToAlias</strong>](convertinterfaceluidtoalias.md)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceLuidToGuid</strong>](convertinterfaceluidtoguid.md)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceLuidToIndex</strong>](convertinterfaceluidtoindex.md)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceLuidToNameA</strong>](convertinterfaceluidtonamea.md)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceLuidToNameW</strong>](convertinterfaceluidtonamew.md)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceNameToLuidA</strong>](convertinterfacenametoluida.md)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceNameToLuidW</strong>](convertinterfacenametoluidw.md)<br/></td>
...
<tr class="even">
<td>[<strong>CreateUnicastIpAddressEntry</strong>](createunicastipaddressentry.md)<br/></td>
...
<tr class="odd">
<td>[<strong>DeleteAnycastIpAddressEntry</strong>](deleteanycastipaddressentry.md)<br/></td>
...
<tr class="odd">
<td>[<strong>FlushIpNetTable2</strong>](flushipnettable2.md)<br/></td>
<td>The <strong>FlushIpNetTable2</strong> function flushes the IP neighbor table on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>FlushIpPathTable</strong>](flushippathtable.md)<br/></td>
<td>The <strong>FlushIpPathTable</strong> function flushes the IP path table on a local computer.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>FreeMibTable</strong>](freemibtable.md)<br/></td>
<td>The <strong>FreeMibTable</strong> function frees the buffer that is allocated by the functions that return tables of network interfaces, addresses, and routes (for example, [<strong>GetIfTable2</strong>](getiftable2.md) and [<strong>GetAnycastIpAddressTable</strong>](getanycastipaddresstable.md)).<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetAnycastIpAddressEntry</strong>](getanycastipaddressentry.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetAnycastIpAddressTable</strong>](getanycastipaddresstable.md)<br/></td>
<td>The <strong>GetAnycastIpAddressTable</strong> function retrieves the anycast IP address table on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetBestRoute2</strong>](getbestroute2.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetIfTable2</strong>](getiftable2.md)<br/></td>
<td>The <strong>GetIfTable2</strong> function retrieves the MIB-II interface table.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetIfTable2Ex</strong>](getiftable2ex.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetInvertedIfStackTable</strong>](getinvertedifstacktable.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetIpInterfaceTable</strong>](getipinterfacetable.md)<br/></td>
<td>The <strong>GetIpInterfaceTable</strong> function retrieves the IP interface entries on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetIpNetEntry2</strong>](getipnetentry2.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetIpNetTable2</strong>](getipnettable2.md)<br/></td>
<td>The <strong>GetIpNetTable2</strong> function retrieves the IP neighbor table on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetIpPathEntry</strong>](getippathentry.md)<br/></td>
<td>The <strong>GetIpPathEntry</strong> function retrieves information for an IP path entry on a local computer.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>GetIpPathTable</strong>](getippathtable.md)<br/></td>
<td>The <strong>GetIpPathEntry</strong> function retrieves information for an IP path entry on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetMulticastIpAddressEntry</strong>](getmulticastipaddressentry.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetMulticastIpAddressTable</strong>](getmulticastipaddresstable.md)<br/></td>
...
<tr class="even">
<td>[<strong>GetTeredoPort</strong>](getteredoport.md)<br/></td>
...
<tr class="odd">
<td>[<strong>GetUnicastIpAddressEntry</strong>](getunicastipaddressentry.md)<br/></td>
...
<tr class="even">
<td>[<strong>GetUnicastIpAddressTable</strong>](getunicastipaddresstable.md)<br/></td>
<td>The <strong>GetUnicastIpAddressTable</strong> function retrieves the unicast IP address table on a local computer.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>if_indextoname</strong>](if-indextoname.md)<br/></td>
...
<tr class="even">
<td>[<strong>if_nametoindex</strong>](if-nametoindex.md)<br/></td>
...
<tr class="odd">
<td>[<strong>InitializeIpForwardEntry</strong>](initializeipforwardentry.md)<br/></td>
<td>The <strong>InitializeIpForwardEntry</strong> function initializes a [<strong>MIB_IPFORWARD_ROW2</strong>](mib-ipforward-row2.md) structure with default values for an IP route entry on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>InitializeIpInterfaceEntry</strong>](initializeipinterfaceentry.md)<br/></td>
<td>The <strong>InitializeIpInterfaceEntry</strong> function initializes the members of an [<strong>MIB_IPINTERFACE_ROW</strong>](mib-ipinterface-row.md) structure entry with default values.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>InitializeUnicastIpAddressEntry</strong>](initializeunicastipaddressentry.md)<br/></td>
<td>The <strong>InitializeUnicastIpAddressEntry</strong> function initializes a [<strong>MIB_UNICASTIPADDRESS_ROW</strong>](mib-unicastipaddress-row.md) structure with default values for a unicast IP address entry on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>NotifyIpInterfaceChange</strong>](notifyipinterfacechange.md)<br/></td>
...
<tr class="odd">
<td>[<strong>NotifyRouteChange2</strong>](notifyroutechange2.md)<br/></td>
...
<tr class="even">
<td>[<strong>NotifyStableUnicastIpAddressTable</strong>](notifystableunicastipaddresstable.md)<br/></td>
...
<tr class="odd">
<td>[<strong>NotifyTeredoPortChange</strong>](notifyteredoportchange.md)<br/></td>
...
<tr class="even">
<td>[<strong>NotifyUnicastIpAddressChange</strong>](notifyunicastipaddresschange.md)<br/></td>
...
<tr class="odd">
<td>[<strong>ResolveIpNetEntry2</strong>](resolveipnetentry2.md)<br/></td>
...
<tr class="odd">
<td>[<strong>SetUnicastIpAddressEntry</strong>](setunicastipaddressentry.md)<br/></td>
...
<tr class="odd">
<td>[<strong>MIB_IPFORWARD_ROW2</strong>](mib-ipforward-row2.md)<br/></td>
<td>The MIB_IPFORWARD_ROW2 structure stores information about an IP route entry.<br/></td>
</tr>
<tr class="even">
<td>[<strong>MIB_IPFORWARD_TABLE2</strong>](mib-ipforward-table2.md)<br/></td>
<td>The MIB_IPFORWARD_TABLE2 structure contains a table of IP route entries.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>MIB_IPINTERFACE_ROW</strong>](mib-ipinterface-row.md)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertIpv4MaskToLength</strong>](convertipv4masktolength.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>ConvertLengthtoIpv4Mask</strong>](convertlengthtoipv4mask.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>GetCurrentThreadCompartmentId</strong>](getcurrentthreadcompartmentid.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetNetworkInformation</strong>](getnetworkinformation.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>GetSessionCompartmentId</strong>](getsessioncompartmentid.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>SetCurrentThreadCompartmentId</strong>](setcurrentthreadcompartmentid.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>SetNetworkInformation</strong>](setnetworkinformation.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>SetSessionCompartmentId</strong>](setsessioncompartmentid.md)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
</tbody>
</table>
