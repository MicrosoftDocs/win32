...
<tbody>
<tr class="odd">
<td>[<strong>CancelMibChangeNotify2</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceAliasToLuid</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceGuidToLuid</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceIndexToLuid</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceLuidToAlias</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceLuidToGuid</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceLuidToIndex</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceLuidToNameA</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceLuidToNameW</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>ConvertInterfaceNameToLuidA</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertInterfaceNameToLuidW</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>CreateUnicastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>DeleteAnycastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>DeleteIpForwardEntry2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>DeleteIpForwardEntry2</strong> function deletes an IP route entry on a local computer.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>DeleteIpNetEntry2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>DeleteIpNetEntry2</strong> function deletes a neighbor IP address entry on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>DeleteUnicastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>FlushIpNetTable2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>FlushIpNetTable2</strong> function flushes the IP neighbor table on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>FlushIpPathTable</strong>](/windows/desktop/api/Netioapi/)<br/></td>
<td>The <strong>FlushIpPathTable</strong> function flushes the IP path table on a local computer.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>FreeMibTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>FreeMibTable</strong> function frees the buffer that is allocated by the functions that return tables of network interfaces, addresses, and routes (for example, [<strong>GetIfTable2</strong>](/windows/desktop/api/netioapi/) and [<strong>GetAnycastIpAddressTable</strong>](/windows/desktop/api/netioapi/)).<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetAnycastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetAnycastIpAddressTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetAnycastIpAddressTable</strong> function retrieves the anycast IP address table on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetBestRoute2</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetIfEntry2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetIfEntry2</strong> function retrieves information for the specified interface on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetIfStackTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetIfTable2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetIfTable2</strong> function retrieves the MIB-II interface table.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetIfTable2Ex</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetInvertedIfStackTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetIpInterfaceTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetIpInterfaceTable</strong> function retrieves the IP interface entries on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetIpNetEntry2</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetIpNetTable2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetIpNetTable2</strong> function retrieves the IP neighbor table on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetIpPathEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetIpPathEntry</strong> function retrieves information for an IP path entry on a local computer.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>GetIpPathTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetIpPathEntry</strong> function retrieves information for an IP path entry on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetMulticastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetMulticastIpAddressTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>GetTeredoPort</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>GetUnicastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>GetUnicastIpAddressTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>GetUnicastIpAddressTable</strong> function retrieves the unicast IP address table on a local computer.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>if_indextoname</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>if_nametoindex</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>InitializeIpForwardEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>InitializeIpForwardEntry</strong> function initializes a [<strong>MIB_IPFORWARD_ROW2</strong>](/windows/desktop/api/netioapi/) structure with default values for an IP route entry on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>InitializeIpInterfaceEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>InitializeIpInterfaceEntry</strong> function initializes the members of an [<strong>MIB_IPINTERFACE_ROW</strong>](/windows/desktop/api/netioapi/) structure entry with default values.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>InitializeUnicastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The <strong>InitializeUnicastIpAddressEntry</strong> function initializes a [<strong>MIB_UNICASTIPADDRESS_ROW</strong>](/windows/desktop/api/netioapi/) structure with default values for a unicast IP address entry on a local computer.<br/></td>
</tr>
<tr class="even">
<td>[<strong>NotifyIpInterfaceChange</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>NotifyRouteChange2</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>NotifyStableUnicastIpAddressTable</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>NotifyTeredoPortChange</strong>](/windows/desktop/api/Netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>NotifyUnicastIpAddressChange</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>ResolveIpNetEntry2</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>SetUnicastIpAddressEntry</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="even">
<td>[<strong>IP_ADDRESS_PREFIX</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The IP_ADDRESS_PREFIX structure stores an IP address prefix.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>MIB_ANYCASTIPADDRESS_ROW</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The MIB_ANYCASTIPADDRESS_ROW structure stores information about an anycast IP address.<br/></td>
</tr>
<tr class="even">
<td>[<strong>MIB_ANYCASTIPADDRESS_TABLE</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The MIB_ANYCASTIPADDRESS_TABLE structure contains a table of anycast IP address entries.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>MIB_IFSTACK_ROW</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The MIB_IFSTACK_ROW structure represents the relationship between two network interfaces.<br/></td>
</tr>
<tr class="even">
<td>[<strong>MIB_IFSTACK_TABLE</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>MIB_IPFORWARD_ROW2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The MIB_IPFORWARD_ROW2 structure stores information about an IP route entry.<br/></td>
</tr>
<tr class="even">
<td>[<strong>MIB_IPFORWARD_TABLE2</strong>](/windows/desktop/api/netioapi/)<br/></td>
<td>The MIB_IPFORWARD_TABLE2 structure contains a table of IP route entries.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>MIB_IPINTERFACE_ROW</strong>](/windows/desktop/api/netioapi/)<br/></td>
...
<tr class="odd">
<td>[<strong>ConvertIpv4MaskToLength</strong>](/windows/desktop/api/Netioapi/)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>ConvertLengthtoIpv4Mask</strong>](/windows/desktop/api/Netioapi/)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>GetCurrentThreadCompartmentId</strong>](/windows/desktop/api/Netioapi/nf-netioapi-getcurrentthreadcompartmentid)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>GetNetworkInformation</strong>](/windows/desktop/api/Netioapi/nf-netioapi-getnetworkinformation)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>GetSessionCompartmentId</strong>](/windows/desktop/api/Netioapi/nf-netioapi-getsessioncompartmentid)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>SetCurrentThreadCompartmentId</strong>](/windows/desktop/api/Netioapi/nf-netioapi-setcurrentthreadcompartmentid)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="odd">
<td>[<strong>SetNetworkInformation</strong>](/windows/desktop/api/Netioapi/nf-netioapi-setnetworkinformation)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
<tr class="even">
<td>[<strong>SetSessionCompartmentId</strong>](/windows/desktop/api/Netioapi/nf-netioapi-setsessioncompartmentid)<br/></td>
<td>Reserved for future use. Do not use this function.<br/></td>
</tr>
</tbody>
</table>
