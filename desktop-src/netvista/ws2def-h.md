...
| Topic                                                           | Description                                                                                                                           |
|-----------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| [**CMSGHDR**](/windows/win32/ws2def/ns-ws2def-_wsacmsghdr?branch=master)<br/>                           | The CMSGHDR structure defines the header for a control data object that is associated with a datagram.<br/>                     |
| [**SOCKADDR**](/windows/win32/ws2def/ns-ws2def-sockaddr?branch=master)<br/>                         | The SOCKADDR structure is a generic structure that specifies a transport address.<br/>                                          |
| [**SOCKADDR\_IN**](/windows/win32/ws2def/ns-ws2def-sockaddr_in?branch=master)<br/>                  | The SOCKADDR\_IN structure specifies a transport address and port for the [**AF\_INET**](netvista.af_inet) address family.<br/> |
| [**SOCKADDR\_STORAGE**](/windows/win32/ws2def/ns-ws2def-sockaddr_storage?branch=master)<br/>        | The SOCKADDR\_STORAGE structure is a generic structure that specifies a transport address.<br/>                                 |
| [**SOCKET\_ADDRESS\_LIST**](/windows/win32/ws2def/ns-ws2def-_socket_address_list?branch=master)<br/> | The SOCKET\_ADDRESS\_LIST structure defines a variable-sized list of transport addresses.<br/>                                  |
