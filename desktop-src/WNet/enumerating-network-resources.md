...
1.  Pass the address of a [**NETRESOURCE**](/windows/desktop/api/Winnetwk/ns-winnetwk-netresourcea) structure that represents the resource to the [**WNetOpenEnum**](https://msdn.microsoft.com/en-us/library/Aa385478(v=VS.85).aspx) function.
2.  Allocate a buffer large enough to hold the array of [**NETRESOURCE**](/windows/desktop/api/Winnetwk/ns-winnetwk-netresourcea) structures that the [**WNetEnumResource**](https://msdn.microsoft.com/en-us/library/Aa385449(v=VS.85).aspx) function returns, plus the strings to which their members point.
