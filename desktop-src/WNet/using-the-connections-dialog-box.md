...
The [**WNetConnectionDialog**](/windows/desktop/api/Winnetwk/nf-winnetwk-wnetconnectiondialog) function creates a dialog box that allows the user to browse and connect to network resources. You can also call the [**WNetConnectionDialog1**](/windows/desktop/api/Winnetwk/nf-winnetwk-wnetconnectiondialog1a) function to create a connections dialog box. **WNetConnectionDialog1** requires a [**CONNECTDLGSTRUCT**](/windows/desktop/api/Winnetwk/ns-winnetwk-_connectdlgstructa) structure.

The [**WNetDisconnectDialog**](/windows/desktop/api/Winnetwk/nf-winnetwk-wnetdisconnectdialog) function creates a dialog box that allows the user to disconnect from network resources.
