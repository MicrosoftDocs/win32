...
| [**MF\_MT\_USER\_DATA**](mf-mt-user-data-attribute.md)                                      | Contains the portion of a [**MPEGLAYER3WAVEFORMAT**](dshow.mpeglayer3waveformat) structure that appears after the **wfx** member of the structure. |
...
<td>[<strong>IPropertyStore</strong>](properties.IPropertyStore)
<blockquote>
[!Note]<br />
