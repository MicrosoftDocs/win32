...
Instead of checking each stream for this attribute, you can pass a presentation descriptor to the [**MFRequireProtectedEnvironment**](mfrequireprotectedenvironment.md) function. This function tests whether the presentation descriptor contains any protected streams.
