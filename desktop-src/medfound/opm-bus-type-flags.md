...
The OPM\_BUG\_TYPE\_Xxxx flags and the **OPM\_COPP\_COMPATIBLE\_BUS\_TYPE\_INTEGRATED** flag are equivalent to values from the [**COPP\_BusType**](https://msdn.microsoft.com/windows/desktop/eb3666bd-1987-419f-8d48-0dbca147bf7e) enumeration used in Certified Output Protection Protocol (COPP).
