...
<tr class="even">
<td>c-hostexever</td>
<td>Host program (.exe) version number. The client can send this information to the server in the [<strong>MFNETSOURCE_HOSTVERSION</strong>](mfnetsource-hostversion-property.md) property.<br/> The client sends this information to the server at the end of the connection.<br/></td>
</tr>
</tbody>
</table>
