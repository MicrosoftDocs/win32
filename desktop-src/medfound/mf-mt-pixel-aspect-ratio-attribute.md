...
title: MF\_MT\_PIXEL\_ASPECT\_RATIO attribute
ms.date: 05/31/2018
ms.topic: article
...
To set this attribute, use the [**MFSetAttributeRatio**](/windows/win32/mfapi/nf-mfapi-mfsetattributeratio?branch=master) function. To get this attribute, use the [**MFGetAttributeRatio**](/windows/win32/mfapi/nf-mfapi-mfgetattributeratio?branch=master) function.
