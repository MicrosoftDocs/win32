...
To set this attribute, use the [**MFSetAttributeRatio**](mfsetattributeratio.md) function. To get this attribute, use the [**MFGetAttributeRatio**](mfgetattributeratio.md) function.
