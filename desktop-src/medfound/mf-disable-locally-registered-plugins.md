...
title: MF_DISABLE_LOCALLY_REGISTERED_PLUGINS attribute
ms.topic: reference
ms.date: 05/31/2018
---
...
Set this attribute to **TRUE** to prevent the MF Topology Loader from inserting locally registered transforms.
