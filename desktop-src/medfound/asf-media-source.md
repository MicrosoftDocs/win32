...
| [**IPropertyStore**](e995aaa1-d4c9-475f-b1fa-b9123cd5b653)               | Sets and gets properties on the media source. Each property contains a descriptive name and a value.                                               |
...
| MF\_PROPERTY\_HANDLER\_SERVICE   | By using this identifier, the application can get a pointer to the [**IPropertyStore**](e995aaa1-d4c9-475f-b1fa-b9123cd5b653) interface of the ASF media source. The property store contains all the metadata related to the ASF file. This identifier is new in Windows 7 and replaces MF\_METADATA\_PROVIDER\_SERVICE for getting metadata properties.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
