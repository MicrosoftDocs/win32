...
-   [**IWMResamplerProps**](iwmresamplerpropsinterface.md)
...
-   For the [**IMFTransform**](imftransform.md) interface, initialize the media type as described in [Uncompressed Audio Media Types](uncompressed-audio-media-types.md).
