...
Beginning with Windows 7, the Windows Media Video decoder implements the [**IDMOQualityControl**](dshow.idmoqualitycontrol) interface.
...
<blockquote>
[!Note]<br />
To query this property, use the [<strong>IPropertyBag</strong>](com.ipropertybag_and_ipersistpropertybag) interface.
</blockquote>
<br/></td>
</tr>
</tbody>
