...
title: IDirect3DVideoDevice9GetDXVAGuids method
ms.date: 05/31/2018
ms.topic: article
...
Address of an array of GUIDs or **NULL**. If the value is non-**NULL**, the array receives a list of GUIDs that specify restricted-mode DXVA profiles. These GUIDs are defined in dxva.h, and are documented in the [DXVA 1.0 specification](http://go.microsoft.com/fwlink/p/?linkid=93647).
