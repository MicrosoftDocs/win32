...
To get a reference to the file sink's property store ([**IPropertyStore**](https://msdn.microsoft.com/library/Bb761474(v=VS.85).aspx)), call [**IMFASFContentInfo::GetEncodingConfigurationPropertyStore**](/windows/desktop/api/wmcontainer/nf-wmcontainer-imfasfcontentinfo-getencodingconfigurationpropertystore) on the file sink's ContentInfo object's reference.
