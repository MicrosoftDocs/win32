...
When using Media Foundation, you can construct the correct media type from a [**WAVEFORMATEXTENSIBLE**](dshow.waveformatextensible) structure by using the function [**MFInitMediaTypeFromWaveFormatEx**](/windows/win32/mfapi/nf-mfapi-mfinitmediatypefromwaveformatex?branch=master).
