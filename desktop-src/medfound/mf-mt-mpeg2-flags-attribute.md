...
This attribute corresponds to the **dwFlags** member of the [**MPEG2VIDEOINFO**](https://msdn.microsoft.com/windows/desktop/1a6ab686-99a1-40c2-addf-7fa215e2311a) structure. For a list of valid flags, see the documentation for **MPEG2VIDEOINFO**.
