...
-   Source media type: Media type object, exposes [**IMFMediaType**](/windows/win32/mfobjects/nn-mfobjects-imfmediatype?branch=master) interface, which describes the contents of the input file.
-   Audio profile: Profile object, exposes [**IMFASFProfile**](/windows/win32/wmcontainer/nn-wmcontainer-imfasfprofile?branch=master) interface, which contains only audio streams of the output file.
-   Stream sample: Media sample, exposes [**IMFSample**](/windows/win32/mfobjects/nn-mfobjects-imfsample?branch=master) interface, represents the input file's media data obtained from the encoder in a compressed state.
-   ContentInfo object: [ASF ContentInfo Object](asf-contentinfo-object.md), exposes [**IMFASFContentInfo**](/windows/win32/wmcontainer/nn-wmcontainer-imfasfcontentinfo?branch=master) interface, which represents the ASF Header Object of the output file.
-   Data byte stream: Byte stream object, exposes [**IMFByteStream**](/windows/win32/mfobjects/nn-mfobjects-imfbytestream?branch=master) interface, which represents the entire ASF Data Object portion of the output file.
-   Data packet: Media sample, exposes [**IMFSample**](/windows/win32/mfobjects/nn-mfobjects-imfsample?branch=master) interface, generated by the [ASF Multiplexer](asf-multiplexer.md); represents an ASF data packet that will be written to the data byte stream.
-   Output byte stream: Byte stream object, exposes [**IMFByteStream**](/windows/win32/mfobjects/nn-mfobjects-imfbytestream?branch=master) interface, which contains the contents of the output file.
...
For more information, see [**IMFByteStream::Write**](/windows/win32/mfobjects/nf-mfobjects-imfbytestream-write?branch=master). The following code shows these helper functions:
...
In Media Foundation, encoders (expose the [**IMFTransform**](/windows/win32/mftransform/nn-mftransform-imftransform?branch=master) interface) are implemented as [Media Foundation Transforms](media-foundation-transforms.md) (MFT).
...
1.  Call [**MFCreateASFProfile**](/windows/win32/wmcontainer/nf-wmcontainer-mfcreateasfprofile?branch=master) to create an empty ASF profile object. The ASF profile exposes the [**IMFASFProfile**](/windows/win32/wmcontainer/nn-wmcontainer-imfasfprofile?branch=master) interface. For more information, see [Creating and Configuring ASF Streams](creating-and-configuring-asf-streams.md).
2.  Get the encoded audio format from the `CWmaEncoder` object.
3.  Call [**IMFASFProfile::CreateStream**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfprofile-createstream?branch=master) to create a new stream for the ASF profile. Pass in a pointer to the [**IMFMediaType**](/windows/win32/mfobjects/nn-mfobjects-imfmediatype?branch=master) interface, which represents the stream format.
4.  Call [**IMFASFStreamConfig::SetStreamNumber**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfstreamconfig-setstreamnumber?branch=master) to assign a stream identifier.
...
6.  Call [**IMFASFProfile::SetStream**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfprofile-setstream?branch=master) to add the new stream to the profile.
...
2.  Call [**IMFASFContentInfo::SetProfile**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfcontentinfo-setprofile?branch=master) to set the ASF profile.
...
1.  Call [**MFCreateASFMultiplexer**](/windows/win32/wmcontainer/nf-wmcontainer-mfcreateasfmultiplexer?branch=master) to create the ASF multiplexer.
2.  Call [**IMFASFMultiplexer::Initialize**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfmultiplexer-initialize?branch=master) to initialize the multiplexer. Pass in a pointer to the ASF Content Info object, which was created in the previous section.
3.  Call [**IMFASFMultiplexer::SetFlags**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfmultiplexer-setflags?branch=master) to set the **MFASF\_MULTIPLEXER\_AUTOADJUST\_BITRATE** flag. When this setting is used, the multiplexer automatically adjusts the bit rate of the ASF content to match the characteristics of the streams being multiplexed.
...
1.  Call [**MFCreateTempFile**](/windows/win32/mfapi/nf-mfapi-mfcreatetempfile?branch=master) to create a temporary byte stream to hold the ASF data packets.
...
4.  Call [**IMFASFMultiplexer::ProcessSample**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfmultiplexer-processsample?branch=master) to send the compressed audio samples to the ASF multiplexer for packetization.
...
7.  After all samples are sent to the multiplexer, call [**IMFASFMultiplexer::Flush**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfmultiplexer-flush?branch=master) and pull the remaining ASF packets from the multiplexer.
8.  Call [**IMFASFMultiplexer::End**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfmultiplexer-end?branch=master).
...
Next, write the ASF header to a media buffer by calling [**IMFASFContentInfo::GenerateHeader**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfcontentinfo-generateheader?branch=master). This method converts data stored in the ContentInfo object into binary data in ASF Header Object format. For more information, see [Generating a New ASF Header Object](generating-a-new-asf-header-object.md).
...
Now you can put the previous steps together into a complete application. Before using any of the Media Foundation objects, initialize the Media Foundation platform by calling [**MFStartup**](/windows/win32/mfapi/nf-mfapi-mfstartup?branch=master). When you are done, call [**MFShutdown**](/windows/win32/mfapi/nf-mfapi-mfshutdown?branch=master). For more information, see [Initializing Media Foundation](initializing-media-foundation.md).
