...
| Attribute                                                                                       | Description                                                                                |
|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| [CODECAPI\_AVDecVideoAcceleration\_H264](dshow.avdecvideoacceleration_h264_property)            | Enables or disables hardware acceleration.                                                 |
...
In Windows 8, the H.264 decoder supports the [**ICodecAPI**](dshow.icodecapi) interface. This interface provides an alternativate API for setting the following codec properties.

-   [CODECAPI\_AVDecVideoMaxCodedWidth](codecapi-avdecvideomaxcodedwidth.md)
-   [CODECAPI\_AVDecVideoAcceleration\_H264](dshow.avdecvideoacceleration_h264_property)
