...
Use this property to configure the WTV media source. To set the property, pass an [**IPropertyStore**](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) pointer to the source resolver. For more information, see [Configuring a Media Source](configuring-a-media-source.md).
