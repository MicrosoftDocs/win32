...
Use this property to configure the WTV media source. To set the property, pass an [**IPropertyStore**](properties.IPropertyStore) pointer to the source resolver. For more information, see [Configuring a Media Source](configuring-a-media-source.md).
