...
title: MFSampleExtension_Encryption_ProtectionScheme attribute
...
The value of this attribute is a member of the [**MFSampleEncryptionProtectionScheme**](https://msdn.microsoft.com/en-us/library/Mt804350(v=VS.85).aspx) enumeration. In cases where the media source is MP4-based, the value is set based off the value of the **scheme\_type** field within the scheme type box (‘schm’) in the MP4 header (‘moov’ or ‘moof’).
