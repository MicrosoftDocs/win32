...
If the stream renders data while scrubbing, it sends the event as soon as the data is rendered. If the stream does not render data, it sends the event immediately after [**OnClockStart**](imfclockstatesink-onclockstart.md) is called.
