...
| Value                                          | Description                                                                                                                                                                                                                                                                                                                          |
|------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **MF\_ACTIVATE\_CUSTOM\_PRESENTER\_ALLOWFAIL** | If the [**IMFActivate::ActivateObject**](imfactivate-activateobject.md) method fails to create the application's custom presenter, it uses the default EVR presenter instead. By default, if the [**IMFActivate**](imfactivate.md) object fails when it tries to create the custom presenter, the **ActivateObject** method fails. |
