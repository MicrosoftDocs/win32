...
| [**D3DAUTHENTICATEDCHANNEL\_CONFIGURE\_INPUT**](d3dauthenticatedchannel-configure-input.md)<br/> Contains input data for the [**IDirect3DAuthenticatedChannel9::Configure**](idirect3dauthenticatedchannel9-configure.md) method.<br/>                                                                                                                     |
| [**D3DAUTHENTICATEDCHANNEL\_CONFIGURE\_OUTPUT**](d3dauthenticatedchannel-configure-output.md)<br/> Contains the response to a call to the [**IDirect3DAuthenticatedChannel9::Configure**](idirect3dauthenticatedchannel9-configure.md) method.<br/>                                                                                                        |
...
| [**D3DAUTHENTICATEDCHANNEL\_QUERY\_INPUT**](d3dauthenticatedchannel-query-input.md)<br/> Contains input data for the [**IDirect3DAuthenticatedChannel9::Query**](idirect3dauthenticatedchannel9-query.md) method.<br/>                                                                                                                                     |
| [**D3DAUTHENTICATEDCHANNEL\_QUERY\_OUTPUT**](d3dauthenticatedchannel-query-output.md)<br/> Contains the response to a call to the [**IDirect3DAuthenticatedChannel9::Query**](idirect3dauthenticatedchannel9-query.md) method.<br/>                                                                                                                        |
...
| [**D3DCONTENTPROTECTIONCAPS**](d3dcontentprotectioncaps.md)<br/> Describes the content protection capabilities of a display driver.<br/>                                                                                                                                                                                                                    |
...
| [**D3DOVERLAYCAPS**](d3doverlaycaps.md)<br/> Specifies hardware overlay capabilities for a Direct3D device.<br/>                                                                                                                                                                                                                                            |
| [**DXVABufferInfo**](dxvabufferinfo.md)<br/> Specifies a buffer for the [**IDirect3DDXVADevice9::Execute**](idirect3ddxvadevice9-execute.md) method.<br/>                                                                                                                                                                                                  |
| [**DXVACompBufferInfo**](dxvacompbufferinfo.md)<br/> Specifies the requirements for compressed surfaces for DirectX Video Acceleration (DXVA).<br/>                                                                                                                                                                                                         |
| [**DXVAUncompDataInfo**](dxvauncompdatainfo.md)<br/> Specifies the dimensions and pixel format of the uncompressed surfaces for DXVA video decoding.<br/>                                                                                                                                                                                                   |
