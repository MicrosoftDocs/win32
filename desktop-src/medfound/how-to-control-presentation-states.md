...
-   Call the [**IMFMediaSession::Pause**](imfmediasession-pause.md) method to pause playback.
    ...
    Before calling this method, the application must call the [**IMFMediaSession::GetSessionCapabilities**](imfmediasession-getsessioncapabilities.md) method to discover whether the media source supports the Pause state. If it does, this method returns **MFSESSIONCAP\_PAUSE** in the *pdwCaps* parameter.
...
-   Call the [**IMFMediaSession::Stop**](imfmediasession-stop.md) method to stop playback.
...
-   Call the [**IMFMediaSession::Start**](imfmediasession-start.md) method to start playback or seek to a new position.
