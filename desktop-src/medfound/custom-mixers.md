...
The mixer sends the following events to the EVR, using the EVR's [**IMediaEventSink**](https://msdn.microsoft.com/windows/desktop/50aa04b4-9a04-4d0d-a558-42595a69aef7) interface. This interface is documented in the DirectShow SDK documentation.



| Event                                            | Description                            |
|--------------------------------------------------|----------------------------------------|
| [**EC\_SAMPLE\_NEEDED**](https://msdn.microsoft.com/windows/desktop/f1bf32ba-ecb7-435f-aefc-f60fdd355620) | The mixer requires a new input sample. |
...
-   [**IMediaEventSink**](https://msdn.microsoft.com/windows/desktop/50aa04b4-9a04-4d0d-a558-42595a69aef7)
