...
The [**IMFASFContentInfo::ParseHeader**](imfasfcontentinfo-parseheader.md) method adds this attribute to the media type if the ASF header contains the [**WM/WMADRCAverageTarget**](wmformat.wm_wmadrcaveragetarget) attribute. This attribute is documented in the Windows Media Format SDK documentation.
