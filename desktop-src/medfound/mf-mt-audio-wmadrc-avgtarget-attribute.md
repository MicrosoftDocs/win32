...
The [**IMFASFContentInfo::ParseHeader**](/windows/desktop/api/wmcontainer/nf-wmcontainer-imfasfcontentinfo-parseheader) method adds this attribute to the media type if the ASF header contains the [**WM/WMADRCAverageTarget**](https://msdn.microsoft.com/windows/desktop/8173b5ab-27e4-4af9-aea8-6c1310f065f5) attribute. This attribute is documented in the Windows Media Format SDK documentation.
