...
The ASF *multiplexer* is a WMContainer layer component that works with the [ASF Data Object](https://www.bing.com/search?q=ASF Data Object) and gives an application the ability to generate ASF data packets for a stream that match the requirements defined in the ContentInfo object.
