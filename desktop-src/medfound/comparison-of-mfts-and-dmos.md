...
|-----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| [**IMediaObject::GetInputCurrentType**](https://msdn.microsoft.com/81d5c1b8-086c-422d-b2d7-85728507888d)   | [**IMFTransform::GetInputCurrentType**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getinputcurrenttype)       |
| [**IMediaObject::GetInputMaxLatency**](https://msdn.microsoft.com/f8a18b4c-a59c-4e9d-aff7-62333e9ffda9)     | [**IMFTransform::GetInputStreamInfo**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getinputstreaminfo)         |
| [**IMediaObject::GetInputSizeInfo**](https://msdn.microsoft.com/cce6359a-cd6e-46c9-a1cb-553ae5f83b9c)         | [**IMFTransform::GetInputStreamInfo**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getinputstreaminfo)         |
| [**IMediaObject::GetInputType**](https://msdn.microsoft.com/22693a22-97be-487d-ad17-31a2d8ee874c)                 | [**IMFTransform::GetInputAvailableType**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getinputavailabletype)   |
| [**IMediaObject::GetOutputCurrentType**](https://msdn.microsoft.com/f5ebcf96-d008-448e-852b-39bdf1f39c4b) | [**IMFTransform::GetOutputCurrentType**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getoutputcurrenttype)     |
| [**IMediaObject::GetOutputSizeInfo**](https://msdn.microsoft.com/497bc88e-4e26-409f-9d42-6a214a5d56e9)       | [**IMFTransform::GetOutputStreamInfo**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getoutputstreaminfo)       |
| [**IMediaObject::GetOutputType**](https://msdn.microsoft.com/a7652472-4091-4ecf-b623-5c6eb01be44a)               | [**IMFTransform::GetOutputAvailableType**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getoutputavailabletype) |
...
MFTs do not have the [**IMediaObject::AllocateStreamingResources**](https://msdn.microsoft.com/cd608bf2-50a5-4037-aeb5-c5c380c3d6df) and [**IMediaObject::FreeStreamingResources**](https://msdn.microsoft.com/c4d2dbf1-45c9-47a2-a21f-5eb04f828ec1) methods used with DMOs. To handle allocation and deallocation of resources efficiently, an MFT can respond to the following messages in the [**IMFTransform::ProcessMessage**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-processmessage) method:
...
MFTs do not have a [**Flush**](https://msdn.microsoft.com/c80001b8-5648-430a-b565-e90486c48ac5) method. To flush an MFT, call [**IMFTransform::ProcessMessage**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-processmessage) with the [**MFT\_MESSAGE\_COMMAND\_FLUSH**](mft-message-command-flush.md) message.

### Stream Discontinuities

MFTs do not have a [**Discontinuity**](https://msdn.microsoft.com/1a8e51e2-5d19-423d-acd2-8f1c0a143cf3) method. To signal a discontinuity in a stream, set the [**MFSampleExtension\_Discontinuity**](mfsampleextension-discontinuity-attribute.md) attribute on the input sample.
...
-   There are no MFT equivalents for the following DMO methods:
    -   [**IMediaObject::Lock**](https://msdn.microsoft.com/6923dd91-7bdb-4a0c-833d-4742973825ee)
    -   [**IMediaObject::SetInputMaxLatency**](https://msdn.microsoft.com/45fb0caa-cd12-4847-a646-f6fd90c50b81)
...
DMOs: [**\_DMO\_INPUT\_DATA\_BUFFER\_FLAGS**](https://msdn.microsoft.com/b0217926-ac2d-48e5-a5d0-e31be6ea20ac) enumeration.
...
DMOs: [**\_DMO\_PROCESS\_OUTPUT\_FLAGS**](https://msdn.microsoft.com/7648f975-3753-41fe-a311-e86334ef7071) enumeration.
...
DMOs: [**\_DMO\_OUTPUT\_DATA\_BUFFER\_FLAGS**](https://msdn.microsoft.com/80ce44a7-4b69-4aed-8b28-10e84a658f12) enumeration.
...
DMOs: [**\_DMO\_INPUT\_STREAM\_INFO\_FLAGS**](https://msdn.microsoft.com/96e37678-0325-4569-8491-c8ef23f6c76e) enumeration.
...
DMOs: [**\_DMO\_OUTPUT\_STREAM\_INFO\_FLAGS**](https://msdn.microsoft.com/570dd009-0101-4a01-b064-4f4404fb453f) enumeration.
...
DMOs: [**\_DMO\_SET\_TYPE\_FLAGS**](https://msdn.microsoft.com/e0638668-bbd2-4696-8482-d72438510740) enumeration.
...
The following table shows how to map DMO error codes to MFT error codes. A hybrid MFT/DMO object should return the DMO error codes from [**IMediaObject**](https://msdn.microsoft.com/a3fd17aa-7df2-40f4-8f2c-45bae38e4c0b) methods and the MFT error codes from [**IMFTransform**](/windows/desktop/api/mftransform/nn-mftransform-imftransform) methods. The DMO error codes are defined in the header file MediaErr.h. The MFT error codes are defined in the header file mferror.h.
...
The [**IMFTransform**](/windows/desktop/api/mftransform/nn-mftransform-imftransform) interface is loosely based on [**IMediaObject**](https://msdn.microsoft.com/a3fd17aa-7df2-40f4-8f2c-45bae38e4c0b), which is the primary interface for DirectX Media Objects (DMOs). It is possible to create objects that expose both interfaces. However, this can lead to naming collisions, because the interfaces have some methods that share the same name. You can solve this problem in one of two ways:
...
This changes the declaration of the [**IMFTransform**](/windows/desktop/api/mftransform/nn-mftransform-imftransform) interface so that most of the method names are prefixed with "MFT". Thus, [**IMFTransform::ProcessInput**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-processinput) becomes **IMFTransform::MFTProcessInput**, while [**IMediaObject::ProcessInput**](https://msdn.microsoft.com/f52e9586-f65d-418f-8c1a-c97c0a81d253) keeps its original name. This technique is most useful if you are converting an existing DMO to a hybrid DMO/MFT. You can add the new MFT methods without changing the DMO methods.
...
Declare the DMO version of [**ProcessInput**](https://msdn.microsoft.com/f52e9586-f65d-418f-8c1a-c97c0a81d253) like this:
