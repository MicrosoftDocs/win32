...
title: MF\_MT\_DV\_AAUX\_SRC\_PACK\_1 attribute
...
This attribute corresponds to the **dwDVAAuxSrc1** member of the DirectShow [**DVINFO**](https://msdn.microsoft.com/en-us/library/Dd388639(v=VS.85).aspx) structure.
