...
| [CODECAPI\_AVDecVideoAcceleration\_MPEG2](https://msdn.microsoft.com/2e05f9e5-28a6-48f3-956d-a14eaf3bf4ba)                        | Enables or disables hardware accelerated decoding.                                                         |
...
Of these properties, the following can also be set through the [**ICodecAPI**](https://msdn.microsoft.com/cc3f1bd9-1d36-45e6-94e2-07f2800fd073) interface:

-   [CODECAPI\_AVDecVideoThumbnailGenerationMode](https://msdn.microsoft.com/c640d915-585b-481d-aa49-0d4a559d291c)
-   [CODECAPI\_AVDecVideoAcceleration\_MPEG2](https://msdn.microsoft.com/2e05f9e5-28a6-48f3-956d-a14eaf3bf4ba)
