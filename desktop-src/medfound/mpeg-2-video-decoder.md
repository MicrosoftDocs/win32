...
| [CODECAPI\_AVDecVideoAcceleration\_MPEG2](dshow.avdecvideoacceleration_mpeg2_property)                        | Enables or disables hardware accelerated decoding.                                                         |
...
Of these properties, the following can also be set through the [**ICodecAPI**](dshow.icodecapi) interface:

-   [CODECAPI\_AVDecVideoThumbnailGenerationMode](dshow.avdecvideothumbnailgenerationmode_property)
-   [CODECAPI\_AVDecVideoAcceleration\_MPEG2](dshow.avdecvideoacceleration_mpeg2_property)
