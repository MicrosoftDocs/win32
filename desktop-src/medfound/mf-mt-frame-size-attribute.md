...
To set this attribute, use the [**MFSetAttributeSize**](mfsetattributesize.md) function. To get this attribute, use the [**MFGetAttributeSize**](mfgetattributesize.md) function.
