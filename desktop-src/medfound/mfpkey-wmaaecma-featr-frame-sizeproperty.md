...
After the first call to [**IMediaObject::AllocateStreamingResources**](dshow.imediaobject_allocatestreamingresources) or [**IMediaObject::ProcessOutput**](dshow.imediaobject_processoutput), you can read this property to get the actual frame size in use, even when [**MFPKEY\_WMAAECMA\_FEATURE\_MODE**](mfpkey-wmaaecma-feature-modeproperty.md) is false.
