...
After you set this value to **VARIANT\_TRUE** on the audio encoder, the output types retrieved by using the [**IMediaObject::GetOutputType**](dshow.imediaobject_getoutputtype) method are VBR types.
