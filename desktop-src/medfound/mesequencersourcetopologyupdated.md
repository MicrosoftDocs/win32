...
Raised by the sequencer source when the [**IMFSequencerSource::UpdateTopology**](imfsequencersource-updatetopology.md) method completes asynchronously.
...
| VARTYPE            | Description                                                                                                                                                                                                                        |
|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| VT\_UI4<br/> | Sequencer element identifier of the topology that is being updated. The application specifies this value in the *dwId* parameter of the [**UpdateTopology**](imfsequencersource-updatetopology.md) method.<br/> <br/> |
