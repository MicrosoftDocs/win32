...
You can set this attribute when you create the media sesison by using the *pConfiguration* parameter of the [**MFCreateMediaSession**](mfcreatemediasession.md) or [**MFCreatePMPMediaSession**](mfcreatepmpmediasession.md) function.
