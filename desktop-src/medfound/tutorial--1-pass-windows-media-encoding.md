...
-   Open the ASF file in ASFViewer to see the structure of an ASF file. This tool can be downloaded from this [Microsoft website](https://go.microsoft.com/fwlink/p/?linkid=94626).
