...
-   Get a compatible media type from the Windows Media video encoder by setting the encoding properties and then calling [**IMFTransform::GetOutputAvailableType**](/windows/desktop/api/mftransform/nf-mftransform-imftransform-getoutputavailabletype). This method returns the partial type. Make sure you convert the partial type to a complete type by adding the following information:
    ...
    Because [**IWMCodecPrivateData::GetPrivateData**](https://msdn.microsoft.com/2598e021-aa36-4df8-813e-eba79d30e7e2) checks the bit rate before returning the codec private data, make sure that you set the bit rate before getting the codec private data.
...
6.  Update the leaky bucket parameter for the audio stream.
    ...
    -   Buffer window: you can retrieve it by calling [**IWMCodecLeakyBucket::GetBufferSizeBits**](https://msdn.microsoft.com/a7667fea-8bf9-4f87-bae1-6a32c00e753c).
...
-   [**IWMCodecPrivateData::GetPrivateData**](https://msdn.microsoft.com/2598e021-aa36-4df8-813e-eba79d30e7e2) returns HRESULT 0x80040203 "A syntax error occurred trying to evaluate a query string"
