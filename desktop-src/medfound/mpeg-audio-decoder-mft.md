...
|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**CODECAPI\_AVDecAudioDualMono**](dshow.avdecaudiodualmono_property)                   | Specifies whether 2-channel audio being decoded is dual mono or not. Read-only. Set by the MFT. For more information see [**eAVDecAudioDualMono**](dshow.eavdecaudiodualmono).                                                                                                                               |
| [**CODECAPI\_AVDecAudioDualMonoReproMode**](dshow.avdecaudiodualmonorepromode_property) | Specifies how the decoder reproduces dual mono audio. The default value is **eAVDecAudioDualMonoReproMode\_LEFT\_MONO**.<br/> Read/Write. Applications can set this property to change the default behavior. For more information see [**eAVDecAudioDualMono**](dshow.eavdecaudiodualmono).<br/> |
| [**CODECAPI\_AVEncCommonMeanBitRate**](dshow.avenccommonmeanbitrate_property)           | Specifies the compressed stream bit rate. Read-only. Set by the MFT.                                                                                                                                                                                                                                         |
