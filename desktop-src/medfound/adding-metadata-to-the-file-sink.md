...
1.  Query the ASF file sink object to get a pointer to its implementation of the [**IMFMetadataProvider**](/windows/win32/mfidl/nn-mfidl-imfmetadataprovider?branch=master) interface.
2.  Call [**IMFMetadataProvider::GetMFMetadata**](/windows/win32/mfidl/nf-mfidl-imfmetadataprovider-getmfmetadata?branch=master) to get an [**IMFMetadata**](/windows/win32/mfidl/nn-mfidl-imfmetadata?branch=master) pointer.
...
3.  Call [**IMFMetadata::GetAllPropertyNames**](/windows/win32/mfidl/nf-mfidl-imfmetadata-getallpropertynames?branch=master) to retrieve the list of file-encoding properties set on the media content.
4.  Call [**IMFMetadata::GetProperty**](/windows/win32/mfidl/nf-mfidl-imfmetadata-getproperty?branch=master) to get the property values.
