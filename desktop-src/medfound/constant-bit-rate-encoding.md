...
-   Buffer window: Query the encoder for the [**IWMCodecLeakyBucket**](/windows/desktop/api/wmcodecdsp/nn-wmcodecdsp-iwmcodecleakybucket) interface and then call [**IWMCodecLeakyBucket::GetBufferSizeBits**](https://msdn.microsoft.com/en-us/library/Dd743326(v=VS.85).aspx) (wmcodecifaces.h, wmcodecdspuuid.lib).
