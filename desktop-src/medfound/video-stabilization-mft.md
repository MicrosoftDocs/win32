...
-   [**IMediaExtension**](https://www.bing.com/search?q=**IMediaExtension**)
...
Additionally, the video stabilization DSP supports instantiation using Windows Runtime as a Windows Media Extension. It is defined on the [**Windows.Media.VideoEffects**](https://www.bing.com/search?q=**Windows.Media.VideoEffects**), and its full name is "Windows.Media.VideoEffects.VideoStabilization".
...
[**Windows.Media.VideoEffects**](https://www.bing.com/search?q=**Windows.Media.VideoEffects**)
</dt> </dl>
