...
-   [**IMediaExtension**](https://msdn.microsoft.com/en-us/library/BR240985(v=Win.10).aspx)
...
-   The attribute [MF\_SA\_D3D11\_BINDFLAGS](mf-sa-d3d11-bindflags.md) is used by the pipeline to specify the D3D11 bind flags to create the output samples with. Any combination of values from the [**D3D11\_BIND\_FLAG**](https://msdn.microsoft.com/en-us/library/Ff476085(v=VS.85).aspx) enumeration is valid.
...
Additionally, the video stabilization DSP supports instantiation using Windows Runtime as a Windows Media Extension. It is defined on the [**Windows.Media.VideoEffects**](https://msdn.microsoft.com/en-us/library/Hh700857(v=WIN.10).aspx), and its full name is "Windows.Media.VideoEffects.VideoStabilization".
...
[**Windows.Media.VideoEffects**](https://msdn.microsoft.com/en-us/library/Hh700857(v=WIN.10).aspx)
</dt> </dl>
