...
-   [**IMediaExtension**](https://msdn.microsoft.com/Windows.Media.IMediaExtension)
...
-   The attribute [MF\_SA\_D3D11\_BINDFLAGS](mf-sa-d3d11-bindflags.md) is used by the pipeline to specify the D3D11 bind flags to create the output samples with. Any combination of values from the [**D3D11\_BIND\_FLAG**](https://msdn.microsoft.com/4ffa1714-bd85-4d5a-930d-20526f46e4b9) enumeration is valid.
...
Additionally, the video stabilization DSP supports instantiation using Windows Runtime as a Windows Media Extension. It is defined on the [**Windows.Media.VideoEffects**](https://msdn.microsoft.com/Windows.Media.VideoEffects), and its full name is "Windows.Media.VideoEffects.VideoStabilization".
...
[**Windows.Media.VideoEffects**](https://msdn.microsoft.com/Windows.Media.VideoEffects)
</dt> </dl>
