...
| [Implementing the Asynchronous Callback](implementing-the-asynchronous-callback.md) | How to implement the callback method in the [**IMFAsyncCallback**](imfasynccallback.md) interface. |
...
| [Custom Asynchronous Result Objects](custom-asynchronous-result-objects.md)         | How to provide a custom implementation of the [**IMFAsyncResult**](imfasyncresult.md) interface.   |
...
[**IMFAsyncCallback Interface**](imfasynccallback.md)
</dt> <dt>

[**IMFAsyncResult Interface**](imfasyncresult.md)
</dt> <dt>
