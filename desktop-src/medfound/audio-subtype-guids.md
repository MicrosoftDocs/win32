...
<td>Advanced Audio Coding (AAC).<br/> This subtype is used for AAC contained in an AVI file with an audio format tag equal to 0x00FF. <br/> For more information, see [<strong>AAC Decoder</strong>](aac-decoder.md).<br/> Defined in wmcodecdsp.h<br/></td>
...
<ul>
<li>[<strong>AAC Decoder</strong>](aac-decoder.md)</li>
<li>[MPEG-4 File Source](mpeg-4-file-source.md)</li>
</ul></td>
