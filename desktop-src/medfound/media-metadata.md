...
<td>Property keys are [<strong>PROPERTYKEY</strong>](properties.PROPERTYKEY) values.</td>
</tr>
<tr class="even">
<td>Property values are [<strong>PROPVARIANT</strong>](stg.propvariant) values.</td>
<td>Property values are [<strong>PROPVARIANT</strong>](stg.propvariant) values.</td>
</tr>
</tbody>
</table>
