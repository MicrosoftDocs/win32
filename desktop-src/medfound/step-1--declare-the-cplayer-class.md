...
The code shown here is a fairly standard implementation of **IUnknown**. If you prefer, you can use the Active Template Library (ATL) to implement these methods. However, `CPlayer` does not support [**CoCreateInstance**](https://msdn.microsoft.com/en-us/library/ms686615(v=VS.85).aspx) or any advanced COM features, so there is no overwhelming reason to use ATL here.
