...
To give a more concrete example, the following code converts a 32-bit RGB image into an AYUV image. The RGB pixels are accessed using an [**RGBQUAD**](https://msdn.microsoft.com/windows/desktop/22e0991d-078e-4b44-9f03-004137e31f6c) structure, and the AYUV pixels are accessed using a [**DXVA2\_AYUVSample8**](/windows/desktop/api/dxva2api/ns-dxva2api-_dxva2_ayuvsample8) structure structure.
