...
| **MEDIASUBTYPE\_DVM**                   | Dolby Digital audio; see [**Audio Subtypes**](https://msdn.microsoft.com/windows/desktop/55012be5-2d61-4d38-aab7-0c42f161f555). This subtype can be used interchangeably with **MEDIASUBTYPE\_DOLBY\_AC3**.<br/> | wmcodecdsp.h |
...
|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [CODECAPI\_AVDecAudioDualMono](https://msdn.microsoft.com/windows/desktop/96cb9e17-588c-4a1a-a7ba-7f8439d5b79a)                        | Specifies whether a 2-channel Dolby audio stream is encoded as stereo or dual-mono. Before the first Dolby frame is decoded, the value is **eAVDecAudioDualMono\_UnSpecified**. After decoding begins, the value reflects the most recent Dolby frame.<br/> Read-only. <br/> |
| [CODECAPI\_AVDecAudioDualMonoReproMode](https://msdn.microsoft.com/windows/desktop/3ef1f52c-13b2-4d9f-99fe-3317846be8a0)      | Specifies how the decoder reproduces dual-mono audio. The default value is **eAVDecAudioDualMonoReproMode\_LEFT\_MONO**. The application can set this property at any time.<br/> Read/write.<br/>                                                                            |
| [CODECAPI\_AVDecCommonMeanBitRate](https://msdn.microsoft.com/windows/desktop/11f6b5cb-10c6-470b-870d-b89983dba74e)                         | For Dolby Digital (AC-3) streams, specifies the bit rate of the input stream in bits per second. For Dolby Digital Plus (E-AC3), the value is always zero.<br/> Read only.<br/>                                                                                              |
| [CODECAPI\_AVDecDDDynamicRangeScaleHigh](https://msdn.microsoft.com/windows/desktop/8771a5f9-878b-43fd-8eaa-0bfc276194aa)    | The high-level cut when the decoder performs dynamic range control.<br/> Read/write.<br/>                                                                                                                                                                                    |
| [CODECAPI\_AVDecDDDynamicRangeScaleLow](https://msdn.microsoft.com/windows/desktop/d723c825-f2f1-4ba0-a667-8285009764fd)      | The low-level boost when the decoder performs dynamic range control.<br/> Read/write.<br/>                                                                                                                                                                                   |
| [CODECAPI\_AVDecDDOperationalMode](https://msdn.microsoft.com/windows/desktop/c235f28e-94b2-44ec-9915-c4161b40a71c)                | The compression control mode.<br/> Read/write.<br/>                                                                                                                                                                                                                          |
