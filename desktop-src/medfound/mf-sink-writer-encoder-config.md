...
The value of this attribute is an [**IPropertyStore**](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) pointer.
...
1.  Call [**PSCreateMemoryPropertyStore**](https://msdn.microsoft.com/windows/desktop/6e7a2ac0-2a4a-41ec-a2a8-ddbe8aa45bc9) to create a new property store.
...
4.  Call [**IMFAttributes::SetUnknown**](/windows/desktop/api/mfobjects/nf-mfobjects-imfattributes-setunknown) to set the [**IPropertyStore**](https://msdn.microsoft.com/windows/desktop/e995aaa1-d4c9-475f-b1fa-b9123cd5b653) pointer on the attribute store.
