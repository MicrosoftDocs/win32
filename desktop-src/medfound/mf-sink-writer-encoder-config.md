...
The value of this attribute is an [**IPropertyStore**](https://msdn.microsoft.com/library/Bb761474(v=VS.85).aspx) pointer.
...
1.  Call [**PSCreateMemoryPropertyStore**](https://msdn.microsoft.com/library/Bb776489(v=VS.85).aspx) to create a new property store.
...
4.  Call [**IMFAttributes::SetUnknown**](/windows/desktop/api/mfobjects/nf-mfobjects-imfattributes-setunknown) to set the [**IPropertyStore**](https://msdn.microsoft.com/library/Bb761474(v=VS.85).aspx) pointer on the attribute store.
