...
Set to an IPropertySet that defines a mapping from track type to a [**IRandomAccessStream**](winrt.irandomaccessstream) that contains the Digital Rights Management (DRM) context.
