...
Applications should call [**IOPMVideoOutput::FinishInitialization**](/windows/win32/opmapi/nf-opmapi-iopmvideooutput-finishinitialization?branch=master) instead of calling this function.
