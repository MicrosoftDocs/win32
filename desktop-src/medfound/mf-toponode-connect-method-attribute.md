...
The attribute value is a bitwise **OR** of flags from the [**MF\_CONNECT\_METHOD**](mf-connect-method.md) enumeration. If this attribute is not set, the default value is **MF\_CONNECT\_ALLOW\_DECODER**.
