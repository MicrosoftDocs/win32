...
| [**MFP\_GET\_MF\_EVENT**](/windows/desktop/api/mfplay/nf-mfplay-mfp_get_mf_event)<br/>                                             | Casts an [**MFP\_EVENT\_HEADER**](/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [**MFP\_MF\_EVENT**](https://msdn.microsoft.com/en-us/library/Dd375563(v=VS.85).aspx) pointer.<br/>                                              |
