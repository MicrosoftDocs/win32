...
-   DXVA 1.0: Color-space information is given in the [**DXVA\_ExtendedFormat**](https://www.bing.com/search?q=**DXVA\_ExtendedFormat**) structure.
...
-   DirectShow: Color-space information is given in the [**VIDEOINFOHEADER2**](https://msdn.microsoft.com/windows/desktop/5e3d5bf0-435f-45da-8409-a1463b56a7ae) structure. The information is stored in the upper 24 bits of the **dwControlFlags** field. If color-space information is present, set the **AMCONTROL\_COLORINFO\_PRESENT** flag in **dwControlFlags**. When this flag is set, the **dwControlFlags** field should be interpreted as a [**DXVA\_ExtendedFormat**](https://www.bing.com/search?q=**DXVA\_ExtendedFormat**) structure, except that the lower 8 bits of the structure are reserved for **AMCONTROL\_xxx** flags.
-   Video capture drivers: Color-space information is given in the [**KS\_VIDEOINFOHEADER2**](https://www.bing.com/search?q=**KS\_VIDEOINFOHEADER2**) structure. This structure is identical to the [**VIDEOINFOHEADER2**](https://msdn.microsoft.com/windows/desktop/5e3d5bf0-435f-45da-8409-a1463b56a7ae) structure, and the meaning of the fields is the same.
