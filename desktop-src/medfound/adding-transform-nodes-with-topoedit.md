...
1.  On the **Topology** menu, click **Add Transform**.
    ...
    The **Select Transform** dialog box opens. It displays a categorized list of registered MFTs that is generated by enumerating the registered entries in the registry by calling the [**MFTEnum**](mftenum.md) function.
