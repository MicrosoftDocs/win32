...
An [**IMFSpatialAudioSample**](/windows/win32/mfspatialaudio/nn-mfspatialaudio-imfspatialaudiosample?branch=master) may contain fewer samples than the number specified by this attribute. If a sample contains more audio objects than specified by this attribute, the behavior is undefined.
