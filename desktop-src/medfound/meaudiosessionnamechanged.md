...
This event is sent by the audio renderer's stream sink. The event is triggered when the audio renderer receives an [**IAudioSessionEvents::OnDisplayNameChanged**](https://msdn.microsoft.com/windows/desktop/65d21f0c-b6f1-4506-975c-6d0308b3fc2f) event from the audio session.
