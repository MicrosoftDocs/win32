---
description: Specifies the initialization data for an Encrypted Media Extension object.
title: MF_ENCRYPTEDMEDIAEXTENSIONS_INITIALIZATION_DATA (mfcontentdecryptionmodule.h)
ms.topic: reference
ms.date: 01/27/2026
---
