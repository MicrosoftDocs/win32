...
| MPEG-4 v1/v2/v3                                                                                                | [**Windows Media MPEG-4 V3 Decoder**](https://msdn.microsoft.com/windows/desktop/5143b0cc-c171-46af-8d7f-4d029af71fb4)<br/> [**Windows Media MPEG4 V1/V2 Decoder**](windowsmediampeg4decoder.md)<br/>         | None                                                                                                                                | Windows Vista |
...
> [!Note]  
> The "Requires" column lists the minimum operating system needed to uses these codecs within a Media Foundation application. Some of these codecs were introduced prior to Windows Vista as [DirectX Media Objects](https://msdn.microsoft.com/windows/desktop/e4424740-31b9-4317-8791-6a9aebb0c7e6) (DMOs). If a codec supports DMO functionality, it can be used with [DirectShow](https://msdn.microsoft.com/windows/desktop/75191978-d538-4140-83ed-69334624c6fb) or the [Windows Media Format SDK](https://msdn.microsoft.com/windows/desktop/875e8914-b861-46f1-9391-8724ff77d26b).
