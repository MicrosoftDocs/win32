...
| MPEG-4 v1/v2/v3                                                                                                | [**Windows Media MPEG-4 V3 Decoder**](mf.WindowsMediaMPEG4V3Decoder)<br/> [**Windows Media MPEG4 V1/V2 Decoder**](windowsmediampeg4decoder.md)<br/>         | None                                                                                                                                | Windows Vista |
...
> [!Note]  
> The "Requires" column lists the minimum operating system needed to uses these codecs within a Media Foundation application. Some of these codecs were introduced prior to Windows Vista as [DirectX Media Objects](dshow.directx_media_objects) (DMOs). If a codec supports DMO functionality, it can be used with [DirectShow](dshow.directshow) or the [Windows Media Format SDK](wmformat.windows_media_format_11_sdk).
