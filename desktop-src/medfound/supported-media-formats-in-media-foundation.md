...
| MPEG-4 v1/v2/v3                                                                                                | [**Windows Media MPEG-4 V3 Decoder**](https://msdn.microsoft.com/en-us/library/Ff819503(v=VS.85).aspx)<br/> [**Windows Media MPEG4 V1/V2 Decoder**](windowsmediampeg4decoder.md)<br/>         | None                                                                                                                                | Windows Vista |
...
> [!Note]  
> The "Requires" column lists the minimum operating system needed to uses these codecs within a Media Foundation application. Some of these codecs were introduced prior to Windows Vista as [DirectX Media Objects](https://msdn.microsoft.com/en-us/library/Dd375474(v=VS.85).aspx) (DMOs). If a codec supports DMO functionality, it can be used with [DirectShow](https://msdn.microsoft.com/en-us/library/Dd375454(v=VS.85).aspx) or the [Windows Media Format SDK](https://msdn.microsoft.com/en-us/library/Dd757738(v=VS.85).aspx).
