...
<td>This attribute contains the 12 bytes of the <a href="https://msdn.microsoft.com/en-us/library/Dd390710(v=VS.85).aspx"><strong>MPEGLAYER3WAVEFORMAT</strong></a> structure that follow the <strong>wfx</strong> member of that structure.</td>
</tr>
</tbody>
</table>
