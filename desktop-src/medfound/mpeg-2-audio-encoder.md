...
This attribute can be set to other values. If the value is not valid according to MPEG specifications, the MFT will reject the media type.<br/> You can also set the bit rate by using the <a href="https://msdn.microsoft.com/en-us/library/Dd311953(v=VS.85).aspx"><strong>ICodecAPI</strong></a> interface. See Remarks for more information.<br/></td>
</tr>
</tbody>
</table>
