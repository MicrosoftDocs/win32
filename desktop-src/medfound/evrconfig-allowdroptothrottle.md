...
Setting this attribute has the same effect as setting the **MFVideoRenderPrefs\_AllowOutputThrottling** flag on the EVR. See [**MFVideoRenderPrefs**](/windows/win32/evr/ne-evr-mfvideorenderprefs?branch=master) for a description of this flag.
