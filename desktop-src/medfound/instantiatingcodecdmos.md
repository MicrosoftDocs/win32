...
You can create a codec DMO by calling the [**CoCreateInstance**](com.cocreateinstance) COM function. You must pass the class identifier of the DMO, the interface identifier of **IMediaObject**, and a pointer to an **IMediaObject** pointer.
