...
| [MF\_CAPTURE\_ENGINE\_DEVICE\_TYPE](/windows/win32/mfcaptureengine/ne-mfcaptureengine-mf_capture_engine_device_type?branch=master)                                                                 | Specifies a type of capture device.                                                                                |
...
| [MF\_CAPTURE\_ENGINE\_SINK\_TYPE](/windows/win32/mfcaptureengine/ne-mfcaptureengine-mf_capture_engine_sink_type?branch=master)                                                                     | Specifies a type of capture sink.                                                                                  |
