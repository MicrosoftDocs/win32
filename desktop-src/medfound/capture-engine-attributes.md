...
| [MF\_CAPTURE\_ENGINE\_DEVICE\_TYPE](mf-capture-engine-device-type.md)                                                                 | Specifies a type of capture device.                                                                                |
...
| [MF\_CAPTURE\_ENGINE\_SINK\_TYPE](mf-capture-engine-sink-type.md)                                                                     | Specifies a type of capture sink.                                                                                  |
