...
Setting this attribute has the same effect as setting the **MFVideoMixPrefs\_ForceHalfInterlace** flag on the EVR. See [**MFVideoMixPrefs**](/windows/win32/evr/ne-evr-_mfvideomixprefs?branch=master) for a description of this flag.
