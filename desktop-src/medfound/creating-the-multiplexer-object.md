...
The [**Initialize**](/windows/win32/wmcontainer/nf-wmcontainer-imfasfmultiplexer-initialize?branch=master) method updates the ContentInfo object so that the correct values are reflected in the final ASF Header Object.
