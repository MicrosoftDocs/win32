...
The [**Initialize**](imfasfmultiplexer-initialize.md) method updates the ContentInfo object so that the correct values are reflected in the final ASF Header Object.
