...
Specifies the previous characteristics of the media source. The attribute data is a bitwise **OR** of flags from the [**MFMEDIASOURCE\_CHARACTERISTICS**](mfmediasource-characteristics.md) enumeration.
