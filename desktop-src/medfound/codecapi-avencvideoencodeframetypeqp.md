...
Encoder shall support [**GetValue**](imfmediaevent-getvalue.md), [**SetValue**](dshow.icodecapi_setvalue), and [**GetParameterRange**](dshow.icodecapi_getparameterrange).
