...
Specifies a [Multimedia Class Scheduler Service](base.multimedia_class_scheduler_service) (MMCSS) class for audio-processing threads in the Source Reader or Sink Writer.
