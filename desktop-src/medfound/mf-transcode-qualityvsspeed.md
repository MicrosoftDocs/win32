...
This attribute has the same GUID value as the [AVEncCommonQualityVsSpeed](dshow.avenccommonqualityvsspeed_property) property defined for [**ICodecAPI**](dshow.icodecapi), and has the same interpretation.
