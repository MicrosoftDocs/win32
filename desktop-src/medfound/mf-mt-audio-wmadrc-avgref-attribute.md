...
The [**IMFASFContentInfo::ParseHeader**](/windows/desktop/api/wmcontainer/nf-wmcontainer-imfasfcontentinfo-parseheader) method adds this attribute to the media type if the ASF header contains the [**WM/WMADRCAverageReference**](https://msdn.microsoft.com/994614e3-06e2-48f0-bdac-6de5ab0c0eff) attribute. This attribute is documented in the Windows Media Format SDK documentation.
