...
title: CODECAPI_AVEncVideoMaxNumRefFrame property
ms.topic: article
ms.date: 05/31/2018
---
...
Encoders shall support [**GetValue**](/windows/desktop/api/mfobjects/nf-mfobjects-imfmediaevent-getvalue), [**SetValue**](https://msdn.microsoft.com/library/windows/desktop/dd311966), and [**GetParameterRangee**](https://msdn.microsoft.com/library/windows/desktop/dd311956).
