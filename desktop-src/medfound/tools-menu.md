...
<td>Logs all method calls on a selected transform node or an output node, and saves the results to a text file. For more information, see [Logging Topology Node Activities](logging-topology-node-activities.md)</td>
</tr>
<tr class="even">
