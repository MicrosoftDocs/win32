...
Setting this attribute has the same effect as setting the **MFVideoMixPrefs\_ForceBob** flag on the EVR. See [**MFVideoMixPrefs**](/windows/desktop/api/evr/ne-evr-_mfvideomixprefs) for a description of this flag.
