...
For audio encoder objects, the quality modes are provided in the [**WAVEFORMATEX**](dshow.waveformatex) structure of the output types that you retrieve using the [**IMediaObject::GetOutputType**](dshow.imediaobject_getoutputtype).
