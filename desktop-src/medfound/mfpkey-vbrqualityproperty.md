...
For audio encoder objects, the quality modes are provided in the [**WAVEFORMATEX**](https://www.bing.com/search?q=**WAVEFORMATEX**) structure of the output types that you retrieve using the [**IMediaObject::GetOutputType**](https://msdn.microsoft.com/a7652472-4091-4ecf-b623-5c6eb01be44a).
