...
Contains a pointer to the application's callback interface for the [**IMFBufferListNotify**](/windows/win32/mfmediaengine/nn-mfmediaengine-imfbufferlistnotify?branch=master) interface for the active buffer list.
