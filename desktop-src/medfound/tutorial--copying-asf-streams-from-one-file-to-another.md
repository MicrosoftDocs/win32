...
-   Source byte stream: Byte stream object, exposes [**IMFByteStream**](imfbytestream.md) interface, which contains the contents of the input file.
-   Source ContentInfo object: ContentInfo object, exposes [**IMFASFContentInfo**](imfasfcontentinfo.md) interface, which represents the ASF Header Object of the input file.
-   Audio profile: Profile object, exposes [**IMFASFProfile**](imfasfprofile.md) interface, which contains only audio streams of the input file.
-   Stream sample: Media sample, exposes [**IMFSample**](imfsample.md) interface, generated by the splitter represents the selected stream's media data obtained from the input file in compressed state.
-   Output ContentInfo object: ContentInfo object, exposes [**IMFASFContentInfo**](imfasfcontentinfo.md) interface, which represents the ASF Header Object of the output file.
...
-   Data packet: Media sample, exposes [**IMFSample**](imfsample.md) interface, generated by the multiplexer represents an ASF data packet that will be written to the data byte stream.
...
The `AllocReadFromByteStream` function reads data from a byte stream and allocates a new media buffer to hold the data. For more information, see [**IMFByteStream::Read**](imfbytestream-read.md).
...
The `WriteBufferToByteStream` function writes data from a media buffer to a byte stream. For more information, see [**IMFByteStream::Write**](imfbytestream-write.md).
...
Open the input file by calling the [**MFCreateFile**](mfcreatefile.md) function. The method returns a pointer to the byte stream object that contains the contents of the file. The filename is specified by the user through command line arguments of the application.
...
1.  Call [**MFCreateASFContentInfo**](mfcreateasfcontentinfo.md) to create the ContentInfo object. This function returns a pointer to the [**IMFASFContentInfo**](imfasfcontentinfo.md) interface.
2.  Call [**IMFASFContentInfo::ParseHeader**](imfasfcontentinfo-parseheader.md) to parse the ASF Header. For more information about this step, see [Reading the ASF Header Object of an Existing File](reading-the-asf-header-object-of-an-existing-file.md).
3.  Call [**MFCreateASFSplitter**](mfcreateasfsplitter.md) to create the ASF splitter object. This function returns a pointer to the [**IMFASFSplitter**](imfasfsplitter.md) interface.
4.  Call [**IMFASFSplitter::Initialize**](imfasfsplitter-initialize.md), passing in the [**IMFASFContentInfo**](imfasfcontentinfo.md)pointer. For more information about this step, see [Creating the ASF Splitter Object](creating-the-asf-splitter-object.md).
5.  Call [**IMFASFContentInfo::GeneratePresentationDescriptor**](imfasfcontentinfo-generatepresentationdescriptor.md) to get a presentation descriptor for the ASF file.
...
1.  Get the profile object for the input file from the source ContentInfo object by calling [**IMFASFContentInfo::GetProfile**](imfasfcontentinfo-getprofile.md). The method returns a pointer to a profile object that contains all of the streams in the input file. For more information see [Creating an ASF Profile](creating-an-asf-profile.md).
...
3.  Remove all non-audio streams from the profile, as follows:
    -   Call [**IMFASFProfile::GetStreamCount**](imfasfprofile-getstreamcount.md) to get the number of streams.
    -   In a loop, call [**IMFASFProfile::GetStream**](imfasfprofile-getstream.md) to get each stream by index.
    -   Call [**IMFASFStreamConfig::GetStreamType**](imfasfstreamconfig-getstreamtype.md) to get the stream type.
    -   For non-audio streams, call [**IMFASFProfile::RemoveStream**](imfasfprofile-removestream.md) to remove the stream.
...
1.  Create an empty ContentInfo object by calling [**MFCreateASFContentInfo**](mfcreateasfcontentinfo.md) and populate it with information from the audio profile created in step 3 by calling [**IMFASFContentInfo::SetProfile**](imfasfcontentinfo-setprofile.md). For more information, see [Initializing the ContentInfo Object of a New ASF File](initializing-the-contentinfo-object-of-a-new-asf-file.md).
...
1.  Select the first audio stream on the splitter by calling [**IMFASFSplitter::SelectStreams**](imfasfsplitter-selectstreams.md).
2.  Read fixed-size blocks of media data from the source byte stream into a media buffer.
3.  Collect the stream samples as media samples from the splitter by calling [**IMFASFSplitter::GetNextSample**](imfasfsplitter-getnextsample.md) in a loop as long as it receives the ASF\_STATUSFLAGS\_INCOMPLETE flag in the *pdwStatusFlags* parameter. For more information, see Generating Samples for ASF Data Packets" in [Generating Stream Samples from an Existing ASF Data Object](generating-stream-samples-from-an-existing-asf-data-object.md).
4.  For each media sample, call [**IMFASFMultiplexer::ProcessSample**](imfasfmultiplexer-processsample.md) to send the media sample to the multiplexer. The multiplexer generates the data packets for the ASF Data Object.
5.  Write the data packet generated by the multiplexer to the data byte stream.
6.  After all the data packets have been generated, call [**IMFASFMultiplexer::End**](imfasfmultiplexer-end.md) to update the output ContentInfo object with information collected during ASF data packet generation.
