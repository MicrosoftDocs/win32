...
The [**IMFASFContentInfo::ParseHeader**](imfasfcontentinfo-parseheader.md) method adds this attribute to the media type if the ASF header contains the [**WM/WMADRCPeakReference**](wmformat.wm_wmadrcpeakreference) attribute. This attribute is documented in the Windows Media Format SDK documentation.
