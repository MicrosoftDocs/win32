---
Description: The Win32\_LogicalShareAccess association WMI class relates the security settings of a share and one member of its discretionary access control list (DACL).
audience: developer
author: REDMOND\\markl
manager: REDMOND\\markl
ms.assetid: fb4bd8fc-3ea4-40cf-a61c-0fbec62b040b
ms.prod: windows-server-dev
ms.technology: windows-management-instrumentation
ms.tgt_platform: multiple
title: Win32\_LogicalShareAccess class
ms.author: windowssdkdev
ms.topic: article
ms.date: 05/31/2018
---

# Win32\_LogicalShareAccess class

The **Win32\_LogicalShareAccess** association [WMI class](https://msdn.microsoft.com/library/aa393244) relates the security settings of a share and one member of its discretionary access control list (DACL).
...
``` syntax
[Dynamic, Provider("SECRCW32"), UUID("{8502C593-5FBB-11D2-AAC1-006008C78BC7}"), AMENDMENT]
...
The **Win32\_LogicalShareAccess** class has these types of members:

-   [Properties](#properties)

### Properties

The **Win32\_LogicalShareAccess** class has these properties.
...
Reference to the instance representing the security settings of the file or directory object.
...
The **Win32\_LogicalShareAccess** class is derived from [**Win32\_SecuritySettingAccess**](win32-securitysettingaccess.md).
