...
A GetResponse message is a WS-Transfer message used to respond to a request for metadata. For more information about GetResponse messages, see section 3.1 of the [WS-Transfer Specification](http://go.microsoft.com/fwlink/p/?linkid=87964).
...
<soap:Envelope
    ...
    xmlns:sim="http://schemas.example.org/SimpleService"
    xmlns:att="http://schemas.example.org/AttachmentService"
    xmlns:eve="http://schemas.example.org/EventingService">
<soap:Header>
    <wsa:To>
        ...
        <wsx:MetadataSection Dialect="http://schemas.xmlsoap.org/ws/2006/02/devprof/Relationship">
            <wsdp:Relationship Type="http://schemas.xmlsoap.org/ws/2006/02/devprof/host">
                <wsdp:Host>
                    ...
                    <wsdp:ServiceId>
                        http://testdevice.interop/SimpleDevice
                    </wsdp:ServiceId>
                </wsdp:Host>
                <wsdp:Hosted>
                    <wsa:EndpointReference>
                    ...
                    <wsdp:ServiceId>
                        http://testdevice.interop/SimpleService1
                    </wsdp:ServiceId>
                </wsdp:Hosted>
            </wsdp:Relationship>
        </wsx:MetadataSection>
