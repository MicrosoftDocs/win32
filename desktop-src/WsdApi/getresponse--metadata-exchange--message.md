...
A GetResponse message is a WS-Transfer message used to respond to a request for metadata. For more information about GetResponse messages, see section 3.1 of the [WS-Transfer Specification](https://go.microsoft.com/fwlink/p/?linkid=87964).
