...
In addition to developing the device functionality, device implementers must implement the [Devices Profile for Web Services](http://go.microsoft.com/fwlink/p/?linkid=59069) (DPWS). Devices that use the secure channel for communication must also implement a number of security-related requirements. These requirements are described in the topics [Secure WSD Client Development](secure-wsd-client-development.md) and [Secure WSD Device Development](secure-wsd-device-development.md).
