...
DPWS clients send Get messages. Function Discovery clients, WSDAPI clients calling [**WSDCreateDeviceProxy**](wsdcreatedeviceproxy.md), and WSDAPI clients calling [**WSDCreateDeviceProxyAdvanced**](wsdcreatedeviceproxyadvanced.md) send this message.
