...
To use the configuration file for server development, some modifications are required. If hosting is enabled (i.e., if "all" or "host" mode is selected), modify the contents of the [**ThisModelMetadata**](thismodelmetadata.md) element and its child elements as necessary. Also, modify or remove the [**PnPXDeviceCategory**](https://msdn.microsoft.com/library/windows/desktop/bb410202), [**PnPXHardwareId**](pnpxhardwareid.md), and [**PnPXCompatibleId**](https://msdn.microsoft.com/library/windows/desktop/bb410200) elements inside the **ThisModelMetadata** element or [**Hosted**](hosted.md) elements as necessary.
