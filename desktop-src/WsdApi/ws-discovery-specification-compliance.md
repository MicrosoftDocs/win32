...
[WS-Discovery](http://go.microsoft.com/fwlink/p/?linkid=87841) describes how to perform the following tasks:
...
In SOAP-over-UDP, Section 3.2 specifies that the UDP message must fit in a 64K datagram. WSDAPI will accept 64K UDP messages, but the DPWS constraint of MAX\_ENVELOPE\_SIZE (32K) will constrain the message size. As required by [WS-Discovery](http://go.microsoft.com/fwlink/p/?linkid=87841), WSDAPI supports the message patterns described in Section 4.
