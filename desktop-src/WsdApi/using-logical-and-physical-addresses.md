...
[WS-Discovery](http://go.microsoft.com/fwlink/p/?linkid=87841) defines logical addressing using URIs based on the `urn:uuid:` format. The purpose of this addressing scheme is to differentiate the identity of the device from its current IP address. This scheme essentially provides the functionality of DNS names without requiring a name server. [Devices Profile for Web Services](http://go.microsoft.com/fwlink/p/?linkid=59069) (DPWS) recommends that devices use this addressing scheme.
