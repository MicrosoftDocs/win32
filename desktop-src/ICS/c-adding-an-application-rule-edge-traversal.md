...
This sample only illustrates one of the edge traversal option values. For more information on these values, see [**NET\_FW\_EDGE\_TRAVERSAL\_TYPE**](/windows/previous-versions/Icftypes/ne-icftypes-net_fw_edge_traversal_type_?branch=master).
