...
keywords: ["INetFwV6OpenPort interface ICS/ICF", "INetFwV6OpenPort interface ICS/ICF , described"]
topic_type:
- apiref
api_name:
- INetFwV6OpenPort
...
The **INetFwV6OpenPort** interface inherits from the [**IDispatch**](ebbff4bc-36b2-4861-9efa-ffa45e013eb5) interface. **INetFwV6OpenPort** also has these types of members:
