...
Returns the identifier for the connection in string form. For example, the **AdapterName** member of the [IP\_ADAPTER\_ADDRESSES](https://msdn.microsoft.com/library/windows/desktop/aa366058) structure for this connection.
