...
The following code example iterates through a collection of [**AuthorizedApplications**](/previous-versions/windows/desktop/api/Netfw/nf-netfw-inetfwprofile-get_authorizedapplications) displaying their properties.
