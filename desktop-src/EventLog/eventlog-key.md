...
<td>Restricts access to the event log. This value is of type REG_SZ. The format used is <a href="https://msdn.microsoft.com/library/windows/desktop/aa379567">Security Descriptor Definition Language</a> (SDDL). Construct an ACL that grants one or more of the following rights:<dl> Clear (0x0004)<br />
Read (0x0001)<br />
Write (0x0002)<br />
